...
CREATE TABLE "b36554"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36554
INSERT INTO [b36554] VALUES (1,'<span data-type="title" id=toc-1>المقدمة</span>
...
عبد الملك بن محمد بن عبد الرحمن القاسم',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (2,'<span data-type="title" id=toc-2>مدخل</span>
...
وروى أبو داود والترمذي عن أبى سعيد الخدري - رضي الله عنه - قال',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (3,'رسول الله - صلى الله عليه وسلم -: «من كان له ثلاث بنات أو ثلاث أخوات, أو بنتان أو أختان فأحسن صحبتهن واتقى الله فله الجنة».
...
وروى الإمام أحمد عن عقبة بن عامر الجهني قال: سمعت رسول الله - صلى الله عليه وسلم - يقول «من كانت له ثلاث بنات فصبر عليهن فأطعمهن وسقاهن وكساهن من جدته كن له حجابًا من النار يوم القيامة».',NULL,'4',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (4,'بِسْمِ اللهِ الرَّحْمَنِ الرَّحِيمِ
...
وهذه الرعية أمانةٌ, حذر الله –عز وجل- من إضاعتها والتفريط في القيام بحقها, قال – تعالى- {إِنَّا عَرَضْنَا الأَمَانَةَ عَلَى السَّمَوَاتِ وَالأَرْضِ وَالْجِبَالِ فَأَبَيْنَ أَنْ يَحْمِلْنَهَا وَأَشْفَقْنَ مِنْهَا وَحَمَلَهَا الإِنْسَانُ إِنَّهُ كَانَ ظَلُومًا جَهُولاً} [الأحزاب: ٧٢].
وقال- تعالى-: {يَا أَيُّهَا الَّذِينَ آمَنُوا قُوا أَنْفُسَكُمْ وَأَهْلِيكُمْ نَارًا} [التحريم: ٦].
قال ابن القيم- رحمه الله -: «فمن أهمل تعليم ولده ما',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (5,'ينفعه, وتركه سُدًى, فقد أساء غاية الإساءة؛ وأكثر الأولاد إنَّما جاء فسادهم من قِبَلِ الآباء وإهمالهم لهم, وترك تعليمهم فرائض الدين وُسننه, فأضاعوهم صغاراً, فلم ينتفعوا بأنفسهم, ولم ينفعوا آباءهم كباراً».
وقد سارع الأنبياء إلى تربية أبنائهم وتفقد أحوالهم, هذا يعقوب -عليه السلام- وقد اقترب أجله يسأل بنيه ليطمئن على سيرهم على التوحيد بعد موته: {مَا تَعْبُدُونَ مِنْ بَعْدِي} وقرت عينه عندما أجابوا: {قَالُوا نَعْبُدُ إِلَهَكَ وَإِلَهَ آبَائِكَ إِبْرَاهِيمَ وَإِسْمَاعِيلَ وَإِسْحَاقَ إِلَهًا وَاحِدًا وَنَحْنُ لَهُ مُسْلِمُونَ} [البقرة: ١٣٣].
وهذا إبراهيم وإسماعيل - عليهما السلام- يدعوان الله عز وجل: {رَبَّنَا وَاجْعَلْنَا مُسْلِمَيْنِ لَكَ وَمِنْ ذُرِّيَّتِنَا أُمَّةً مُسْلِمَةً لَكَ} الآية. [البقرة: ١٢٨]، وهذا الدعاء من إبراهيم وإسماعيل - عليهما السلام- كما أخبر الله عن عباده: {رَبَّنَا هَبْ لَنَا مِنْ أَزْوَاجِنَا وَذُرِّيَّاتِنَا قُرَّةَ أَعْيُنٍ وَاجْعَلْنَا لِلْمُتَّقِينَ إِمَامًا} [الفرقان: ٧٤].
قال ابن كثير - رحمه الله -: «وهذا القدر مرغوب فيه شرعًا فمن تمام محبة الله أن يحب أن يكون من صلبه من يعبد الله وحده لا شريك له».
واشتد حرص السلف على مباشرة تربية أبنائهم والقيام بهذه المهمة العظيمة ومن ذلك ما ذكر عن الخليفة العباسي المنصور أنه بعث إلى من في السجن من بنى أمية يقول لهم: «ما أشد ما مر بكم',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (6,'في هذا السجن؟ » قالوا: «ما فقدنا من تربية أبنائنا».
...
قال أحد الحاكمين: {للهِ مُلْكُ السَّمَوَاتِ وَالأَرْضِ يَخْلُقُ',NULL,'7',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (7,'مَا يَشَاءُ يَهَبُ لِمَنْ يَشَاءُ إِنَاثًا وَيَهَبُ لِمَنْ يَشَاءُ الذُّكُورَ * أَوْ يُزَوِّجُهُمْ ذُكْرَانًا وَإِنَاثًا وَيَجْعَلُ مَنْ يَشَاءُ عَقِيمًا إِنَّهُ عَلِيمٌ قَدِير} [الشورى: ٤٩، ٥٠].
...
ورحب أحد العقلاء بابنته فقال: «أهلاً وسهلاً بعقيلة النساء، وأم الأبناء، وجالبة الأصهار، والمبشرة بإخوة يتناسقون، ونجباء',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (8,'يتلاحقون».
...
<span data-type="title" id=toc-5>ثانيًا: الأصل في تربية النشء إقامة عبودية الله -عز وجل- في قلوبهم</span>، وغرسها في نفوسهم وتعاهدها، ومن نعم الله علينا أن المولود يولد على دين الإسلام، دين الفطرة، فلا يحتاج إلا إلى رعايته، ومداومة العناية به؛ حتى لا ينحرف أو يضل وهنا يكون للوالدين أجر الدلالة على الخير كما قال - صلى الله عليه وسلم -: «من دل على خير فله مثل أجر فاعله» [رواه مسلم].
فهؤلاء الأولاد ومن يأتي من ذريتهم في ميزان حسنات الوالدين إذا وفقا إلى التربية الإسلامية الصحيحة فإن الفرع تابع للأصل.

<span data-type="title" id=toc-6>ثالثًا: الأب والأم في عبادة لله -عز وجل- حين التربية</span>، والإنفاق، والسهر، والمتابعة، والتعليم، بل وحتى إدخال السرور عليهم وممازحتهم إذا احتسبوا ذلك، فالأصل تعبد الله -عز وجل-: {وَمَا خَلَقْتُ الْجِنَّ وَالْإِنْسَ إِلَّا لِيَعْبُدُونِ} [الذاريات: ٥٦].
...
وقال -عليه الصلاة والسلام-: «إذا أنفق الرجل على أهله',NULL,'9',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (9,'نفقة يحتسبها فهي له صدقة» [متفق عليه].
...
<span data-type="title" id=toc-7>رابعًا: لا بد من الإخلاص لله -عز وجل- في أمر التربية</span>، فإن أراد المربي الدنيا فقد انثلم إخلاصه، وترى البعض يحرص على تعليم أبنائه؛ لكي يحوزوا على المناصب والشهادات، ولا شك أن الخير في تعليمهم ابتغاء ثواب الله -عز وجل- وما عداه فهو تابع له، ولهذا يركز من يريد الدنيا على التعليم الدنيوي المجرد من خدمة الإسلام والمسلمين، والآخر الموفق يسعى لكسب ابنته شهادة في التعليم مثلاً، لتعليم المسلمات، فهذا له أجر، وذاك ليس له أجر، والنية في هذا الأمر عظيمة، وهي من أسباب صلاح الأبناء وحسن تربيتهم، فما كان لله فهو ينمو ويكبر، وما كان للدنيا فهو يقل ويضمحل. وبعض من الآباء يبر والديه؛ لكي يراه صغاره فيعاملونه إذا كبر وشاخ بمثل ذلك. وهذا فيه حب الدنيا وحظوظ النفس، ولكن المؤمن يخلص لله في بر والديه رغبة في ما عند الله -عز وجل- وطاعة لأمره في بر الوالدين، لا للدنيا والمعاملة بالمثل.
ولهذا يحرص الأب والأم على تربية البنت على حسن معاملة',NULL,'10',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (10,'الوالدين واحترامهما وخدمتهما والبر بهما والاستجابة إلى طلباتهما، ويعلمانها أن ذلك عبادة وقربة.

<span data-type="title" id=toc-8>خامسًا: على المربي استصحاب النية في جميع الأمور التربوية</span>؛ حتى يؤجر. فهو يلزم النية في تعليمهم، وفي النفقة عليهم، وفي ممازحتهم وملاعبتهم، وإدخال السرور عليهم، والصبر حال مرضهم ويعود نفسه على ذلك، ويجدد النية كل حين.
<span data-type="title" id=toc-9>سادسًا: الدعاء هو العبادة</span>، وقد دعا الأنبياء والمرسلون لأبنائهم وزوجاتهم {رَبَّنَا هَبْ لَنَا مِنْ أَزْوَاجِنَا وَذُرِّيَّاتِنَا قُرَّةَ أَعْيُنٍ} [الفرقان: ٧٤]، {وَإِذْ قَالَ إِبْرَاهِيمُ رَبِّ اجْعَلْ هَذَا الْبَلَدَ آَمِنًا وَاجْنُبْنِي وَبَنِيَّ أَنْ نَعْبُدَ الْأَصْنَامَ} [إبراهيم: ٣٥] وغيرها في القرآن كثير. وكم من دعوة اهتدى بسببها ضال، وكم من دعوة اختصرت مسافات التربية. وتحر أوقات الإجابة، وابتعد عن موانعها، وتضرع إلى الله -عز وجل- وانكسر بين يديه أن يهدي ذريتك، وأن يجنبها الشيطان، فأنت ضعيف بجهدك قليل بعملك.
...
<span data-type="title" id=toc-10>سابعًا: على الوالد الحرص على الكسب الحلال</span>، وتجنب الشبه، حتى لا يقع في الحرام؛ فإنه صح عن النبي - صلى الله عليه وسلم - أنه قال: «كل جسم نبت من سحت فالنار أولى به» ولا يظن الأب أو الأم أن الحرام في الربا، والسرقة، والرشوة. فحسب، بل حتى في إضاعة وقت العمل وإدخال مال حرام دون مقابل .. فكثير من الموظفين',NULL,'11',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (11,'والمدرسين يتهاونون في أعمالهم، ويتأخرون عن مواعيد عملهم بضع دقائق .. لو جمعت إذا بها ساعات تضيع في الحديث مع الزملاء، وقراءة المجلات والجرائد، والمكالمات الهاتفية. وهذه الأموال التي يأخذها مقابل هذه الأوقات سحت؛ لأنها أخذ مال بدون وجه حق. وكذلك أكل أموال الناس بالباطل وهضم حقوقهم، فاحذر أخي المسلم أن يدخل جوفك وجوف ذريتك مال حرام، وتحر الحلال على قلته؛ فإن فيه بركة عظيمة.

<span data-type="title" id=toc-11>ثامنًا: لا بد أن يكون في البيت المسلم جلسة إيمانية بين الحين والآخر</span>، إما بعد صلاة العصر أو بعد العشاء يقرأ فيها الأبناء كتابًا في التفسير ومرة في الحديث وثالثة في السيرة، وتحرص الأم على غرس النماذج الحية المتميزة من المسلمات المؤمنات من أمهات المؤمنين والصحابيات والصالحات في كل زمان في قلب ابنتها حتى تتشوق إليهم وتنبذ عنها ما يمجده الإعلام الفاسد من الكافرات والفاجرات.
وأول محاضن التعليم للصغيرة هو حضن الأم التي تسمع صغيرتها ذكر الله -عز وجل- وحمده والثناء عليه!

<span data-type="title" id=toc-12>تاسعًا: القدوة الحسنة من ضروريات التربية</span>، فكيف تحرص البنت على الصلاة وهي ترى والدتها أو والدها مضيعًا لها؟ ! وكيف تبتعد عن الأغاني والمجون وهي ترى والدتها ملازمة لسماعها؟ ! مع ملاحظة الابتعاد عن الغيبة والنميمة والكذب فإنها تقع من بعض القدوات، ثم في صلاح الوالدين حفظ لأولادهما في حياتهما، وبعد مماتهما، وتأملا في قول الله -تعالى-: {وَكَانَ أَبُوهُمَا صَالِحًا فَأَرَادَ',NULL,'12',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (12,'رَبُّكَ أَنْ يَبْلُغَا أَشُدَّهُمَا وَيَسْتَخْرِجَا كَنْزَهُمَا رَحْمَةً مِنْ رَبِّكَ} [الكهف: ٨٢] فصلاح الأب هذا عم أبناءه بعد موته بسنوات. وليكن لك أجر غرس الإسلام في نفس طفلك وحرصه على أداء شعائره فإن «من سن في الإسلام سنة حسنة فله أجرها، وأجر من عمل بها من بعده .. » الحديث.
...
<span data-type="title" id=toc-13>عاشرًا: وجه بعضًا من حرصك على أمور الدنيا ومعرفتها وكشف دقائقها إلى معرقة أفضل السبل في أمر التربية</span>، واستشر من ترى فيه الصلاح، وابحث عن الأشرطة والكتب التي تتحدث عن التربية الإسلامية للطفل المسلم. ولا يكن شراء سيارة أو جهاز كهربائي أهم من تربية ابنتك. فأنت تسأل عن السيارة والجهاز كل من تراه! ثم تهمل فلذة قلبك وثمرة فؤادك ولا تتلمس الطريق السوي لتربيتها!
ومن الحكمة والنباهة: أن الأم إذا رأت أسرة تحسن تربية بناتها أن تسارع إلى سؤالهم عن وسائل التربية وطرقها وكيف هي؟ ولها أن تسأل عما أشكل عليها في أمر التربية.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (13,'<span data-type="title" id=toc-14>الحادي عشر: الصبر </span>.. غفل عنه البعض وهو من أهم عوامل نجاح التربية. فعليكما به، واصبرا على صراخ الصغير ولا تغضبا، واصبرا على مرضه واحتسبا، واصبرا على توجيهه ولا تملا، وليصبر الأب على مسافات بعيدة ليذهب بابنته لمدرسة ناجحة، وفيها المدرسات الأكفاء، واصبر على أن تنتظر ابنتك لتعود بها من المدرسة، وأبشر؛ فإنك في طريق جهاد: {وَالَّذِينَ جَاهَدُوا فِينَا لَنَهْدِيَنَّهُمْ سُبُلَنَا} [العنكبوت: ٦٩] وأنتما مأموران بالتربية، أما الهداية فهي من الله -عز وجل-، فابذلا السبب واصبرا، وستريا من الخير ما يسركما ويؤانس طريقكما.
...
<span data-type="title" id=toc-17>الرابع عشر: اغرس في نفوس صغارك تعظيم الله -عز وجل- ومحبته وتوحيده</span>، ونبههم إلى الأخطاء العقدية التي تراها، وحذرهم من الوقوع فيها واحرص على غرس العقيدة بين الحين والآخر في نفوسهم وقد ورد عن الصحابة -رضي الله عنهم- أنهم كانوا يعلمون أبناءهم علامات الساعة وهذا من الإيمان بالغيب، عدا أن وقوع المغيبات على النحو الذي حدثت به الأخبار ينبت الإيمان به ويقويه ويوجب الاستعداد لقيام الساعة بالتوبة النصوح والعمل الصالح. وأبعدهم عن تعليق التمائم والحروز وقراءة الكف',NULL,'16',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (16,'مثلاً واغرس عقيدة الولاء والبراء في قلوبهم؛ فإن ذلك تحصين لهم، واحرص على أن تعودهم على الأمر بالمعروف والنهي عن المنكر، وتشجعهم عليه؛ فإن ذلك من دواعي ثباتهم على هذا الدين، ولما في ذلك من الوجوب والأجر العظيم.
...
<span data-type="title" id=toc-18>الخامس عشر: احرصا على كتم الغضب والانفعال</span>، وتعوذا من الشيطان إذا داهمكما، ولقد جعل الإسلام للعقوبة حدًا. فجعل ضرب الطفل لا يتجاوز العشر ضربات، وأن يكون عمر الصغير فوق السنوات العشر، وأن يضرب بمسواك أو عصا صغيرة، ويتجنب الوجه والعورة، واحرص على التسمية عليه حال الضرب، ولا تضرب وأنت غضبان هائج، وإن استبدلت بالضرب التشجيع أو الحرمان فهو خير لك ولابنتك.
<span data-type="title" id=toc-19>السادس عشر: نحن في زمن انتشرت فيه الفتن من كل جانب</span>؛ فكن كمن هو قائم يذب عن صغاره السهام، ويحوطهم من الأذى، واحرصا على ذلك أشد الحرص، وكلما اشتدت الفتن لا بد أن يضاعف الوالدان جهودهما في التربية ولو أن زمنًا انتشرت فيه سرقة الأموال فإن ذلك يدفع أصحاب الأموال إلى وضع أموالهم في أماكن آمنة والاحتياط لذلك، وهكذا الأبناء. ومن المؤسف في هذا',NULL,'17',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (17,'الجانب أن البعض ظلموا فلذات أكبادهم .. رحموهم في الدنيا بأن أطلقوا لهم العقال وتركوهم يقعون في المحرمات ولم يرحموهم من نار الآخرة وحرها وسمومها، وليكن لكما حسن توجيه في اختيار رفيقات ابنتكم وجليساتها؛ فإن الصاحب ساحب، والرسول - صلى الله عليه وسلم - يقول: «الرجل على دين خليله، فلينظر أحدكم من يخالل» [رواه أحمد].
...
<span data-type="title" id=toc-20>السابع عشر: الحياء والحشمة علامة بارزة على حسن التربية وطيب المنبت</span>، وكلما زاد حياء وحشمة الفتاة كلما زاد علوها ومقدارها، ومما يعين على زرع الحياة في قلب الصغيرة أن ترى حياة',NULL,'18',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (18,'والديها يكسوها الأدب والحياء، فتنشأ على ذلك بعيدة عن صفيقات الوجه، بذيئات اللسان المتفسخات من الحياء والحشمة!
...
<span data-type="title" id=toc-21>الثامن عشر: أفعال الخير تنشأ الصغيرة وهي تراها فتكتسب فيها مهارة وقبولاً وتميزًا إذا كبرت</span>، ها هي في جانب الصدقة بجوارها حصالة صغيرة تضع فيها كل حين ما تيسر من النقود حتى يذهب الشح من نفسها، وفي الجهة الأخرى تسارع إلى نوافل العبادات من صلاة وقيام وغيرها، فترضع محبة الخير مع ثدي أمها ويرتفع علو كعبها في فعل الخير وخدمة الدين والدعوة إليه، ها هي تنشر عبير الخير في أرجاء المكان، همها ماذا تقدم لهذا الدين؟ وماذا تفعل له؟ وكيف تصل بالدعوة إلى الجيران والزميلات؟ بل وكيف تحث والديها على أعمال ترفع درجاتهم في الجنة؟ وقد ذكرت',NULL,'19',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (19,'معلمة أنها فقدت إحدى طالباتها في ساعة الفسحة فلما تحسست أين هي، فإذا بها في مصلى المدرسة تصلي صلاة الضحى!

<span data-type="title" id=toc-22>التاسع عشر: غالب الآباء والأمهات في بيوتهم هم الذين يتحدثون ويتكلمون</span>، ولا يدعون فرصة للبنت أن تتحدث. وفي فتح باب الحوار والنقاش إشباع لرغبة الحديث ثم معرفة ما يدور في خلدها والمرحلة التالية بعد الاستماع توجيهها على ضوء ما تسمعا منها، وكلما كانت الابنة متحدثة كلما ساقها ذلك إلى تربية نفسها عبر توجيه غير مباشر من والديها، مع ما في ذلك كله من ربط البنت بأسرتها بدلاً من الحديث مع الصديقات أو ربما ينجر إلى الحديث مع شاب أجنبي والعياذ بالله ..
...
<span data-type="title" id=toc-23>العشرون: الكتاب والشريط مادة دسمة وذات فوائد شهية فيها من العلم الشرعي ومن أسلوب الخطاب وجمال العبارة الكثير</span>، ويغنيان عن زميلة وصديقة ودعوة يومية، فليحرص الآباء والأمهات على مد الفتاة بكل ما هو مفيد، مع تلمس جوانب النقص فيها ومحاولة جلب الكتب والأشرطة التي تعالج جوانب الخلل لديها.
<span data-type="title" id=toc-24>الحادي والعشرون: أيها الأب .. وقتك طويل ولديك ساعات كثيرة بعد نهاية عملك فما نصيب أبنائك منها</span>؟ فإن كنت مفرطًا في حقهم فتدارك ما فات، واجعل لهم النصيب الأكبر، وإن',NULL,'20',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (20,'كنت ممن حفظ هذا الوقت وجعله لهم فهنيئًا لك، ولا تغفل أن يكون بيتك ومملكتك الصغيرة واحة إيمانية، تقرأ عليهم فيها من سيرة الرسول - صلى الله عليه وسلم -، وتجعل فيها المسابقات الثقافية والإسلامية والعلمية، واجعل لمن حفظ القرآن جوائز قيمة، واحرص على تلمس سيرة الرسول - صلى الله عليه وسلم - وحسن تعامله وتواضعه وممازحته للصغار.
وما أحسن قول الشاعر:
ليس اليتيم من انتهى أبواه ... من هم الحياة وخلفاه ذليلا
إنما اليتيم من تلق له ... أمًا تخلت وأبًا مشغولا

<span data-type="title" id=toc-25>الثاني والعشرون: إشعار البنت بالأبوة والحنان وقد تكون أكثر من الولد حاجة إلى ذلك</span>؛ فعلى الوالدين العناية بالجانب العاطفي للابنة وإشباعه قدر المستطاع.
...
وكان أبو بكر - رضي الله عنه - يدخل على ابنته أسماء ويقبلها ويسأل عن حالها. قال البراء - رضي الله عنه -: « ... فدخلت مع أبي بكر على أهله فإذا عائشة ابنته مضطجعة قد أصابتها حُمي، فرأيت أباها يقبل خدها،',NULL,'21',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (21,'وقال: «كيف أنت يا بنية» [رواه البخاري].
...
<span data-type="title" id=toc-26>الثالث والعشرون: الهاتف والانترنت والشاشة كلها سلاح ذو حدين</span>، وقد رأينا تأثيرها على كبار وكبيرات السن فما بالكما بالابنة الصغيرة أو التي شبت عن الطوق ودخلت مرحلة المراهقة؟ لا بد من الملاحظة والمتابعة وحسن التوجيه فإن الأمر خطير وربما جر إلى فساد في الأخلاق والعقائد والدين، وهذه الأجهزة بمثابة جلساء للفتاة فلننظر ماذا تتلقف منهم الفتاة! بل والله أشد خطرًا من الصديقة للفتاة! فالصديقة تحاورها وتناقشها، وهذه الأجهزة تلقن وتلقي في القلوب الشبه وفي الحواس الشهوات والفتن، وصدق من نادى الآباء بقوله: «إياكم وإدخال اللصوص إلى بيوتكم فإنهم يسرقون منكم ما هو أغلى من الذهب والفضة! يسلبون الدين والخلق والعفة والحشمة! ».',NULL,'22',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (22,'وصدق آخر حينما قال: «إن الأب الذي أهدى الدش إلى أبنائه إنما هو الذي أهدى أبناءه إلى الدش ليربيهم ويوجههم وفق ما يريد! ».
...
<span data-type="title" id=toc-27>الرابع والعشرون: اختيار الزوج الكفء للابنة والمبادرة بتزويجها في سن مبكرة صيانة لها عن الانحراف</span>؛ فإن من أعظم الإحسان إلى البنت إسعادها بزوج صالح.
...
<span data-type="title" id=toc-28>الخامس والعشرون: من أعظم أنواع التربية التي تبرأ بها الذمة إبعاد الابنة عن مواطن الشبه والمنكرات</span>، فلا يذهب بها الأب أو',NULL,'23',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (23,'الأم إلى الأماكن المختلطة ولا أماكن يعصى الله -عز وجل- فيها من موسيقا أو تبرج أو غير ذلك.
...
<span data-type="title" id=toc-29>السادس والعشرون: الزوج يحب الزوجة المدبرة الحكيمة التي تقوم على شؤون بيتها وتحيطه بالرعاية</span>، وفتاة اليوم هي أم المستقبل، ومما تحتاجه لمواجهة الحياة تعلم فن الطبخ والقيام بالمنزل. والأم الموفقة تحث ابنتها على القيام بأعمال المنزل وتدربها على ذلك حتى تكون زوجة صالحة تقوم برعاية منزلها حق الرعاية وهذا شرف لها وموطن استقرارها، وقد كانت بنات الأنبياء يقمن بذلك فقد كانت فاطمة -رضي الله عنها- تخدم في بيت علي بن أبي طالب - رضي الله عنه -؛ حتى أتعبها الرحى وشق عليها كثرة العمل.
<span data-type="title" id=toc-30>السابع والعشرون: كلما داهمكما الهم والحزن وطال بكما أمد التربية تذكرا ما أعد الله -عز وجل- لكما من الجزاء على حسن التربية والتقويم والدعوة والتوجيه</span>.
سئل: سماحة الشيخ عبد العزيز بن باز -رحمه الله- السؤال التالي:
قال رسول الله - صلى الله عليه وسلم -: «من كانت له ثلاث بنات فصبر',NULL,'24',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (24,'عليهن وسقاهن وكساهن كن له حجابًا من النار» هل يكن حجابًا من النار لوالدهن فقط أم حتى الأم شريكة في ذلك؟ وأنا عندي ولله الحمد ثلاث بنات؟
...
<span data-type="title" id=toc-32>التاسع والعشرون: من مهمة الأم والأب تعليم الابنة تعاليم الشرع خاصة أحكام الطهارة والحيض وما يتعلق بأمور النساء</span>، لأن الفتاة قد تخجل عن السؤال، وبالإمكان التمهيد لذلك قبل مرحلة البلوغ أو إهداؤها مجموعة من الكتب بها تلك الأحكام والفتاوى، وكلما كانت الأم قريبة إلى ابنتها كان التعليم وطرح الأسئلة أسهل للفتاة، خاصة إذا كبرت سنها وبدت عليها علامات البلوغ فإنها أحق بصداقة أمها ورفقتها.
<span data-type="title" id=toc-33>الثلاثون: المساواة بين الذكر والأنثى وعدم المفاضلة بينهما </span>فإن بعض الآباء إذا رزقه الله -عز وجل- الذكور يميل إليهم دون الإناث ويفضلهم في المعاملة والحديث، وقد جاء الإسلام بالعدل والمساواة بينهما؛ حتى جعله الرسول - صلى الله عليه وسلم - أحد أسباب دخول الجنة وذلك في عدم إيثار الصبي على البنت، وإنما هم في الحب سواء وفي العطاء',NULL,'27',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (27,'سواء، وفي تقديم الهدايا والمال سواء، وفي التثقيف وطلب العلم سواء، وفي المعاملة سواء، حتى في القُبلة سواء بسواء.
...
الحادي والثلاثون: انتشرت ولله الحمد في مناطق عدة مدارس تحفيظ القرآن الكريم وحري بكل أب وأم أن يسارعا إلى إدخال',NULL,'28',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (28,'ابنتهما في هذه المدارس التي تقرأ فيها البنت القرآن كل يوم، وتنشأ وتتربى على أيدي معلمات داعيات، ومن لم يتيسر له ذلك صباحًا فلا أقل من إلحاقهن بمدارس التحفيظ المسائية التي جعل الله فيها خيرًا كثيرًا، ففيها تحضر الابنة مجالس القرآن وتتربى على القرآن وتسير على نهجه وتعاليمه وهنيئًا لها الصحبة الطيبة في تلك المدارس.

<span data-type="title" id=toc-35>الثاني والثلاثون: تميزت المرأة المسلمة بلباس ساتر لا تبرز فيه المرأة مفاتنها ولا يرى الرجال منها خصلة شعر</span>! ولما ضعف الدين وانهزم الكثير وركز الإعلام على إفساد المراة انتشرت ألبسة ليست من لباس المسلمات!
...
وقد أرسل عمر - رضي الله عنه - إلى جنوده في بلاد فارس: «إياكم وزي أهل الشرك» وما نراه من عري وتفسخ إنما هو من أولئك وليس من',NULL,'29',NULL,NULL,'0');
INSERT INTO [b36554] VALUES (29,'لباس المسلمات!
...
<span data-type="title" id=toc-36>الثالث والثلاثون: ما نقوم به من عمل تربوي هو من أعمال العبادة لله -عز وجل- وفيه براءة للذمة</span>، ولا بد أن نعلم أن الهادي هو الله -عز وجل- {إِنَّكَ لَا تَهْدِي مَنْ أَحْبَبْتَ وَلَكِنَّ اللَّهَ يَهْدِي مَنْ يَشَاءُ} [القصص: ٢٨].
