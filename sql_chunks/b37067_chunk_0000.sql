...
CREATE TABLE "b37067"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b37067
INSERT INTO [b37067] VALUES (1,'بسم الله الرحمن الرحيم
...
أحمده على نعمه كلها، وجوده على دلها، فأهدت إلي وبلها، وأشهد أن لا إله إلا الله وحده لا شريك له شهادة أستظل ظلها، يوم لا ظل إلا ظلها، وأشهد أن سيدنا محمدا عبده ورسوله الذي أرسله إلى جنود الطغيان ففلها، وإلى ليوث الأوثان فأذلها، صلى الله تعالى عليه وعلى آله وأصحابه صلاة دائمة إلى يوم تضع كل ذات حمل حملها، وبعد:',NULL,'39',NULL,NULL,'0');
INSERT INTO [b37067] VALUES (2,'فأن النحو عبارة عن القصد، والناس مختلفون في المقاصد، ومفترقون في المصادر والموارد، فواحد تقويم لسانه مبلغ علمه، وواحد تقويم جنانه أكثر همه، فالأول صاحب عبارة، والثاني صاحب إشارة، فنقول وبالله التوفيق ولرسوله التصديق.

<span data-type="title" id=toc-1>باب أقسام الكلام</span>
...
<span data-type="title" id=toc-2>باب الأسماء واشتقاقها</span>
...
ولما دخل العباد إلى مكتب التعليم طالع آدم لوح الوجود فقرأ} (وعلم آدم الأسماء كلها) وطالع محمد صلى الله عليه وسلم لوح الشهود، فقيل له بلسان الحال: نحن نطلعك على كل موجود، ثم خوطب بقوله:} (اقرأ باسم ربك الذي خلق) {فلما قرأ وأدب وهذب، قيل يا محمد: قد عرفتنا بالأسماء والصفات فتعرف، إلينا بالذات} (اقرأ وربك',NULL,'40',NULL,NULL,'0');
INSERT INTO [b37067] VALUES (3,'الأكرم)} {(قل الله ثم ذرهم في خوضهم يلعبون). فلما غاب عن الاسم وجد المسمى. ولما اعرض عن الفعل حل الحرف المعمى، أي: المعنى الذي لا يسمى.
...
<span data-type="title" id=toc-4>باب موانع الصرف</span>
موانع الصرف عند أهل العبارة: تسع وهي معروفة، وعند أهل الإشارة (الجمع) - أن يجتنب العالم جمع الدنيا واجتماع الناس عليه. (والصرف) صرف وجوههم إليه. (والوصف) أن يكون قصده أن يوصف بالخير ويعرف به. (والتأنيث) ضعف العزم،',NULL,'41',NULL,NULL,'0');
INSERT INTO [b37067] VALUES (4,'والرضى بالرذائل. (والمعرفة) أن يعرف نعم الله تعالى عليه ثم يقصر عن الشكر. (والعجمة) أن يهمل نعمة الله بكتمان علمه. (والعدل) عدوله عن الطريق القويم. (والتركيب) أن يشوب عمله بأفعال الجهل (والألف) ألف أنا، (والنون) نون العظمة. (ووزن الفعل) أن يزن أعماله معتقدا أن عنده - حاصلا فيحصل العجب. فمتى اجتمعت علتان من هذه العلل لم ينصرف إلى القبول، وانحرف عن باب الوصول.
...
<span data-type="title" id=toc-6><span data-type="title" id=toc-7>فصل</span></span>
...
فصل
المبتدأ: مرفوع لتجرده عن العوامل اللفظية، والفقير المتجرد مرفوع القدر، وخبره مرفوع، لانقطاعه عن العلائق، وتعلقه بالحقائق، الواردة من الخالق.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b37067] VALUES (5,'<span data-type="title" id=toc-8><span data-type="title" id=toc-9><span data-type="title" id=toc-10><span data-type="title" id=toc-11>فصل</span></span></span></span>
...
فصل
الحال: وصف هيئة الفاعل والمفعول، ومن شرطه أن يكون نكرة منصوبة، فالعارف متوجه إلى الله تعالى في إصلاح حاله، مجتهد في تنكير نفسه كي لا يعرف، فأحواله مع الله مستقيمة منتصبة، وهي بستر التورية. والنكرة محتجبة (يحسبهم الجاهل أغنياء من التعفف).',NULL,'43',NULL,NULL,'0');
INSERT INTO [b37067] VALUES (6,'<span data-type="title" id=toc-12>فصل</span>
...
<span data-type="title" id=toc-13>باب البدل</span>
...
تم كتاب (نحو القلوب) بحمد الله وعونه، وصلى الله على سيدنا محمد وعلى آله وصحبه وسلم.',NULL,'45',NULL,NULL,'0');
