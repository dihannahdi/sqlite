...
CREATE TABLE "b584"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b584
INSERT INTO [b584] VALUES (1,'<span data-type="title" id=toc-1>بسم الله الرحمن الرحيم</span>
...
<span data-type="title" id=toc-4><span data-type="title" id=toc-5><span data-type="title" id=toc-6>إفادة</span></span></span>
...
<span data-type="title" id=toc-7><span data-type="title" id=toc-8>إنشادة</span></span>
<span data-type="title" id=toc-9>للفخر الرازي</span>
<span data-type="title" id=toc-10>رواها أبو بكر القرشي</span>
...
إفادة
<span data-type="title" id=toc-11>صحة حديث</span>
...
إفادة
<span data-type="title" id=toc-12>سر تشريع ذبح الحيوان</span>',NULL,'1',NULL,NULL,'0');
INSERT INTO [b584] VALUES (2,'حدثنا الأستاذ الفقيه الجليل الأصولي أبو علي منصور الزواوي رضي الله عنه أن الفخر بن الخطيب سأل سيف الدين الآمدي فقال له لم أجاز الشرع ذبح الحيوان في حق الإنسان، وهو تعذيب له، وتعذيب الحيوان على خلاف المعقول؟ فقال له سيف الدين إتلاف الخسيس في حق النفيس من مناهج العقول، فقال له الفخر لو كان كذلك لجاز أن تذبح أنت في حق ابن سينا.
<span data-type="title" id=toc-13><span data-type="title" id=toc-14><span data-type="title" id=toc-15>إنشادة</span></span></span>
<span data-type="title" id=toc-16>لأبي محمد بن حذلم</span>
...
<span data-type="title" id=toc-17><span data-type="title" id=toc-18><span data-type="title" id=toc-19>إفادة</span></span></span>
<span data-type="title" id=toc-20>تأويل فأقبل بهما</span>
<span data-type="title" id=toc-21>وأدبر من حديث الوضوء</span>
...
إنشادة
<span data-type="title" id=toc-22>لأبي عبد الله المقري</span>
...
إفادة
<span data-type="title" id=toc-23>سند مشابكة للمؤلف</span>
...
إنشادة
<span data-type="title" id=toc-24>لأبي عبد الله بن رشيد</span>
<span data-type="title" id=toc-25>رواها ابن البنا</span>
...
<span data-type="title" id=toc-32><span data-type="title" id=toc-33><span data-type="title" id=toc-34>إفادة</span></span></span>
<span data-type="title" id=toc-35>دعاء للخضر لتفريج الكروب</span>
...
إنشادة
<span data-type="title" id=toc-36>لأبي محمد بن الناظر</span>
...
إفادة
<span data-type="title" id=toc-37>وزن إجازة وتصريفها</span>
...
إنشادة
<span data-type="title" id=toc-38>لأبي عبد الله الشريشي</span>
...
إفادة
<span data-type="title" id=toc-39>وصية ابن الفخار</span>
<span data-type="title" id=toc-40>بعد موته للمؤلف</span>',NULL,'3',NULL,NULL,'0');
INSERT INTO [b584] VALUES (4,'لما توفي شيخنا الأستاذ الكبير العلم الخطير أبو عبد الله محمد بن الفخار، سألت الله عز وجل أن يرينيه في النوم فيوصيني بوصية أنتفع بها في الحالة التي أنا عليها من طلب العلم، فلما نمت تلك الليلة رأيت كأني داخل عليه في داره التي كان يسكن بها، فقلت له يا سيدي أوصني، فقال لي لا تعترض على أحد، ثم سألني بعد ذلك في مسألة من مسائل العربية كالمؤانس لي، فأجبته عنها، ولم أذكرها الآن.
<span data-type="title" id=toc-41><span data-type="title" id=toc-42><span data-type="title" id=toc-43>إنشادة</span></span></span>
<span data-type="title" id=toc-44>لأبي جعفر بن عبد العظيم</span>
...
<span data-type="title" id=toc-45><span data-type="title" id=toc-46><span data-type="title" id=toc-47>إفادة</span></span></span>
<span data-type="title" id=toc-48>سند مصافحة للمؤلف</span>
...
إنشادة
<span data-type="title" id=toc-49>لأبي محمد بن حذلم</span>
...
إفادة
<span data-type="title" id=toc-50>مصادر الرازي في تفسيره</span>
...
إنشادة
<span data-type="title" id=toc-51>لبعض الشعراء في الصحبة والمجاورة</span>
...
<span data-type="title" id=toc-59><span data-type="title" id=toc-60>إفادة</span></span>
<span data-type="title" id=toc-61>سر جعل الكعبة</span>
<span data-type="title" id=toc-62>إلى جهة اليسار في الطواف</span>
...
إفادة
<span data-type="title" id=toc-63>شروط العالم</span>
...
إنشادة
لأبي جعفر بن عبد العظيم',NULL,'5',NULL,NULL,'0');
INSERT INTO [b584] VALUES (6,'أنشدني الفقيه أبو جعفر بن عبد العظيم لنفسه في العشر الأوسط لربيع الأول من عام ستين وسبعمائة:
لا يخدعنك في امرئٍ ... لبس الحلي ولا الحلل
في الناس من تلقاهم ... حمر الوجوه من الخجل
<span data-type="title" id=toc-64><span data-type="title" id=toc-65><span data-type="title" id=toc-66>إفادة</span></span></span>
<span data-type="title" id=toc-67>إعراب كلمة من آية</span>
...
<span data-type="title" id=toc-68><span data-type="title" id=toc-69>إنشادة</span></span>
<span data-type="title" id=toc-70>لأبي بكر القرشي</span>
...
إفادة
<span data-type="title" id=toc-71>إعراب آية</span>
...
إنشادة
<span data-type="title" id=toc-72>لأبي القاسم بن أبي العافية</span>
...
<span data-type="title" id=toc-75><span data-type="title" id=toc-76>إنشادة</span></span>
<span data-type="title" id=toc-77>لأبي عبد الله بن بقي</span>
...
<span data-type="title" id=toc-78>إفادة</span>
<span data-type="title" id=toc-79>خصائص محاح البيض</span>
...
إنشادة
<span data-type="title" id=toc-80>لمحمد بن الرقام</span>
<span data-type="title" id=toc-81>رواها ابن حذلم</span>
...
قال لي الفقيه أبو محمد عبد الله بن حذلم، فقلت له إني أحفظ للإمام الشهير أبي حيان بن يوسف بن حيان النفزي قطعة في هذا المعنى والقافية والتزام التجنيس، وهي بسيط',NULL,'7',NULL,NULL,'0');
INSERT INTO [b584] VALUES (8,'يا نفس مالك تهوين الإقامة في ... أرضٍ تعذر كل من مناك بها
...
وهذا غريب.
؟؟<span data-type="title" id=toc-87><span data-type="title" id=toc-88> إفادة</span></span>
<span data-type="title" id=toc-82>الاسم المعدول في كل العرب</span>
...
<span data-type="title" id=toc-83><span data-type="title" id=toc-84>إنشادة</span></span>
<span data-type="title" id=toc-85>للترجمان من سماع</span>
<span data-type="title" id=toc-86>ابن بقي في النوم</span>
...
إفادة
<span data-type="title" id=toc-89>تصحيف أقوال</span>
...
إنشادة
<span data-type="title" id=toc-90>لأبي جعفر بن عبد العظيم</span>
...
قلت ووجدت أنا موضعاً آخر، قوله تعالى " أم تسألهم أجراً فهم من مغرمٍ مثقلون ". على أني وجدت بعد هذا لأبي علي الفارسي في التذكرة موضعاً آخر، قوله تعالى " هل لكم من ما ملكت أيمانكم من شركاء في ما رزقناكم فأنتم فيه سواء ".',NULL,'8',NULL,NULL,'0');
INSERT INTO [b584] VALUES (9,'؟؟<span data-type="title" id=toc-95><span data-type="title" id=toc-96> إنشادة</span></span>
<span data-type="title" id=toc-91>لأبي عبد الله الشريف</span>
...
<span data-type="title" id=toc-92><span data-type="title" id=toc-93>إفادة</span></span>
<span data-type="title" id=toc-94>أسئلة وجهت لابن خميس بسبتة</span>
...
إنشادة
<span data-type="title" id=toc-97>لابن رشيد رواها</span>
<span data-type="title" id=toc-98>أبو بكر بن القرشي</span>
...
<span data-type="title" id=toc-102><span data-type="title" id=toc-103><span data-type="title" id=toc-104>إفادة</span></span></span>
<span data-type="title" id=toc-105>تخصيص العام المؤكد بمنفصل</span>
...
إنشادة
<span data-type="title" id=toc-110>لأبي القاسم بن أبي العافية</span>
<span data-type="title" id=toc-111>رواها أبو بكر بن القرشي</span>
...
إفادة
<span data-type="title" id=toc-112>الزوائد في أول المضارع</span>
...
إفادة
<span data-type="title" id=toc-113>لغز منظوم</span>
...
إنشادة
<span data-type="title" id=toc-114>لأبي جعفر بن عبد العظيم</span>
أنشدني الفقيه أبو جعفر أحمد بن عبد العظيم، لنفسه كامل
لا تجزعن لما يهولك فقده ... فالدهر منك ولست منه آخذ',NULL,'10',NULL,NULL,'0');
INSERT INTO [b584] VALUES (11,'فلربما تلقى المنية في المنى ... والعيش فيما أنت منه عائذ
...
؟<span data-type="title" id=toc-120><span data-type="title" id=toc-121><span data-type="title" id=toc-122> إفادة</span></span></span>
<span data-type="title" id=toc-115>معاملة غير العاقل معاملة العاقل</span>
<span data-type="title" id=toc-116>في القرآن وكلام العرب</span>
...
<span data-type="title" id=toc-117><span data-type="title" id=toc-118>إنشادة</span></span>
<span data-type="title" id=toc-119>لأبي حفص بن الجياني</span>
...
إفادة
<span data-type="title" id=toc-123>الجمع بين مسألة</span>
<span data-type="title" id=toc-124>فقهية ومسألة في العربية</span>
...
<span data-type="title" id=toc-127>إنشادة</span>
<span data-type="title" id=toc-128>لأبي البركات بن الحاج</span>
<span data-type="title" id=toc-129>ينشدها أبو بكر بن القرشي</span>
...
<span data-type="title" id=toc-130>إفادة</span>
<span data-type="title" id=toc-131>مسألة من علم البيان</span>
سألنا الأستاذ القاضي أبو عبد الله المقري رحمه الله عن معنى هذين البيتين وافر
رأت قمر السماء فأذكرتني ... ليالي وصلنا بالرقمتين
كلانا ناظرٌ قمراً ولكن ... رأيت بعينها ورأت بعيني
فلم نأت بشيء، وقال إن هذا الرجل كان ينظر إليها وهي تنظر إلى قمر السماء، فهي تنظر إلى القمر حقيقة وهو لفرط استحسانه يرى أنها الحقيقة، فقد رأى بعينها لأنها ناظرة للحقيقة، قال وأيضاً فهو ينظر إلى قمر مجازاً وهو لفرط استحسانه يرى ن قمر السماء هو المجاز، فقد رأت بعينه لأنها ناظرة المجاز.
قال القاضي رحمه الله ومن هنا تعلم وجه الفاء في قوله فأذكرتني لأنه لما صارت رؤيتها رؤيته، وصار القمر حقيقة إياها كان قوله رأت قمر السماء فأذكرتني بمثابة قوله رأيتها فاذكرتني فتأمله، فإن بعض من لا يفهم كلام الأستاذ حق الفهم ينشد واذكرتني فالفاء في البيت الأول منبهة على معنى البيت الثاني لأنها مبنية عليه. وهذا النوع يسمى بالإبداع في علم البيان.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b584] VALUES (13,'قال فهذا معنى البيتين، ولا يخلوان من تكلف.
<span data-type="title" id=toc-132><span data-type="title" id=toc-133><span data-type="title" id=toc-134><span data-type="title" id=toc-135>إنشادة</span></span></span></span>
<span data-type="title" id=toc-136>لأبي عبد الله بن بقي</span>
...
<span data-type="title" id=toc-137><span data-type="title" id=toc-138><span data-type="title" id=toc-139><span data-type="title" id=toc-140>إفادة</span></span></span></span>
<span data-type="title" id=toc-141>سند تلقيم للمؤلف</span>
<span data-type="title" id=toc-142>يصل إلى الرسول صلى الله عليه وسلم</span>
...
إنشادة
<span data-type="title" id=toc-143><span data-type="title" id=toc-146>لابن دقيق العيد </span>يرويها</span>
<span data-type="title" id=toc-144>الشريشي</span>
...
إفادة
<span data-type="title" id=toc-145>ضبط عبارة الصحاح</span>
...
إنشادة
لابن دقيق العيد
<span data-type="title" id=toc-147>يرويها الشريشي</span>
...
إفادة
<span data-type="title" id=toc-148>الجزم بأيان</span>
...
إنشادة
<span data-type="title" id=toc-149>لأبي عبد الله بن الفخار</span>
...
إفادة
<span data-type="title" id=toc-150>وجه الكسر في كلمة يومئذ</span>
...
فلما تم له التوجيه قلت له وأنا حينئذ صغير السن هب أن الأمر على ما قاله الأخفش من أن الكسرة إعرابية فما يصنع ببناء الزمان المضاف إلى أن في أحد الوجهين، والإضافة إلى المفرد المعرب تقتضي الإعراب دون البناء؟ فتعجب من صدور هذا السؤال مني لصغر سني، وأجاب عنه بأنه قد يذهب السبب ويبقى حكمه. كما قاله ابن جني في اسم الإشارة في ترجمة سيبويه هذا باب علم ما الكلام من العربية على أن يكون سيبويه وضعه غير مشير به وتركه مبنياً، وإن زال سبب البناء، ونظير ذلك بباب التسوية، على ما هو مقرر في موضعه.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b584] VALUES (14,'قال ونظير ذلك ما قررنا من إضافة حيث إلى المفرد مع بقاء البناء فيما ذكره الزمخشري، وذلك قوله
...
<span data-type="title" id=toc-151><span data-type="title" id=toc-152><span data-type="title" id=toc-153>إنشادة</span></span></span>
<span data-type="title" id=toc-154>لابن دقيق العيد</span>
<span data-type="title" id=toc-155>في مخاطبة إخوان بالحجاز</span>
...
<span data-type="title" id=toc-156><span data-type="title" id=toc-157>إفادة</span></span>
<span data-type="title" id=toc-158>الجمع والتفريق</span>
<span data-type="title" id=toc-159>في بعض الآيات</span>
...
إنشادة
<span data-type="title" id=toc-160>لأبي إسحاق بن الحاج</span>
...
إفادة
<span data-type="title" id=toc-161>إنتاج قضيتين شرطيتين</span>
...
إنشادة
<span data-type="title" id=toc-162>لأبي حيان يرويها</span>
أبو إسحاق إبراهيم بن الحاج',NULL,'14',NULL,NULL,'0');
INSERT INTO [b584] VALUES (15,'أنشدني الشيخ الفقيه الرحلة أبو إسحاق إبراهيم بن الحاج، وقال أنشدني الأستاذ الإمام أبو حيان يوسف بن حيان النفزي لنفسه طويل
عداتي لهم فضل علي ومنةٌ ... فلا أبعد الرحمن عني الأعاديا
هم بحثوا عن زلتي فاجتنبتها ... وهم نافسوني فاكتسبت المعاليا
<span data-type="title" id=toc-163><span data-type="title" id=toc-164><span data-type="title" id=toc-165>إفادة</span></span></span>
<span data-type="title" id=toc-166>تأويل آية</span>
...
وكان رحمه الله يرى هذا الوجه أولى من تفسير ابن عصفور له من أنه حذف الصفة، أي بالحق البين. وكان يحافظ عليه.
<span data-type="title" id=toc-167><span data-type="title" id=toc-168>إنشادة</span></span>
<span data-type="title" id=toc-169>للمؤلف في تقريظ الشفاء</span>
...
هذي رياض يروق العقل مخبرها ... هي الشفا لنفوس الخلق إن دنفت
يجني بها زهر التكريم أو ثمر الت؟ ... عظيم، والفوز للأيدي التي قطفت
؟ أبدت لنا من سناها كل واضحةٍ حسانه دونها الأطماع قد وقفت
وشيد العقل أركاناً موطدة ... بها على متن أصل الشرع قد رصفت
قوت القلوب وميزان العقول متى ... حادت عن الحجة الكبرى أو انحرفت
فيا أبا الفضل حزت الفضل في غرض ... به أقرت لك الأعلام واعترفت
وكنت بحر علوم ظل ساحله ... منه استمدت عيون العلم واغترفت
؟ زارته من جنبات القدس باسمةً فحركت منه موج الفكر حين وفت
حتى إذا ما طمت أمواجه قذفت ... لنا بدرتها الحسناء وانصرفت
إن العناية لا يحظى بنائلها ... حريصها بل على التخصيص قد وقفت
؟ إفادة
<span data-type="title" id=toc-170>قاعدة عدم التشديد</span>
...
إنشادة
<span data-type="title" id=toc-171>لأبي محمد بن حذلم</span>
أنشدني صاحبنا الفقيه الأديب أبو محمد بن حذلم لنفسه متقارب
يقولون لي خل عنك الأسى ... ولذ بالسرور فذا يوم عيد
فقلت لهم والأسى غالب ... ووجدي يحيا وشوقي يزيد
توعدني مالكي بالفراق ... فكيف أسر وعيدي وعيد
إفادة
<span data-type="title" id=toc-172>تأويل آيتين</span>',NULL,'15',NULL,NULL,'0');
INSERT INTO [b584] VALUES (16,'قال لي الأستاذ الجليل أبو سعيد بن لب حفظه الله سئلت عن قوله تعالى في سورة النساء " تلك حدود الله ومن يطع الله ورسوله ندخله جناتٍ تجري من تحتها الأنهار خالدين فيها " الآية فجمع قوله " خالدين " وقال بعد " ومن يعص الله ورسوله ويتعد حدوده ندخله ناراً خالداً فيها " فأفرد قوله " خالداً ".
...
<span data-type="title" id=toc-173><span data-type="title" id=toc-174>إنشادة</span></span>
<span data-type="title" id=toc-175>لبي محمد بن حذلم</span>
...
<span data-type="title" id=toc-176><span data-type="title" id=toc-177>إفادة</span></span>
<span data-type="title" id=toc-178>حوار بين المؤلف</span>
<span data-type="title" id=toc-179>وأحد اليهود في مسألة</span>
<span data-type="title" id=toc-180>خلق عيسى عليه السلام</span>
...
إنشادة
<span data-type="title" id=toc-181>لأبي عبد الله المسفر</span>
<span data-type="title" id=toc-182>عند توديع فاس</span>
...
إفادة
<span data-type="title" id=toc-183>قواعد من علم البيان</span>
...
وأخبرني أن كتاب المغرب يحافظون في شعرهم وكتابتهم على طريقة العرب، ويذمون ما عداها من طرق المولدين، وإنها خارجة عن الفصاحة وهذه المعاني الثلاثة لا توجد إلا فيها.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b584] VALUES (17,'<span data-type="title" id=toc-190><span data-type="title" id=toc-191><span data-type="title" id=toc-192><span data-type="title" id=toc-193>إنشادة</span></span></span></span>
<span data-type="title" id=toc-184><span data-type="title" id=toc-185>لأبي عبد الله المقري</span></span>
...
<span data-type="title" id=toc-186><span data-type="title" id=toc-187><span data-type="title" id=toc-188><span data-type="title" id=toc-189>إفادة</span></span></span></span>
...
إنشادة
<span data-type="title" id=toc-194>لبعض العلماء في القول بالموجب</span>
...
إفادة
<span data-type="title" id=toc-195>وجه من أوجه الضرب في الحساب</span>
...
إنشادة
<span data-type="title" id=toc-196>لابن حذلم في رثاء ابن الفخار</span>
...
إفادة
<span data-type="title" id=toc-197>كراهة المقري للتسمية</span>
<span data-type="title" id=toc-198>بقاضي القضاة</span>
...
<span data-type="title" id=toc-199>وأبي إسحاق بن حكم</span>
...
فعجبت من حسن بديهته.
إفادة
<span data-type="title" id=toc-200>تأليف ابن الحاجب</span>
<span data-type="title" id=toc-201>لمختصره الفرعي</span>',NULL,'17',NULL,NULL,'0');
INSERT INTO [b584] VALUES (18,'حدثنا شيخنا الأصولي أبو علي الزواوي حفظه الله عن شيخه الإمام العالم أبي عبد الله محمد بن يحيى الشهير بالمسفر ونقلت ذلك من خط الأستاذ أبي علي، حدثنا شيخنا الإمام العالم المفتي الصالح الشهير أبو علي منصور ابن الشيخ الصالح الموقر المبرور المرحوم أبي العباس أحمد بن عبد الحق المشدالي رضي الله عنه ونفع به قال حدثنا الشيخ الفاضل المدرس زين الدين الزواوي، قال حدثنا الشيخ أبو عمرو بن الحاجب قال لما كنت مشتغلاً بوضع كتابي هذا كنت أجمع الأمهات ثم أجمع ما اشتملت عليه تلك الأمهات في كلام موجز ثم أضعه في هذا الكتاب حتى كمل. ثم إني بعد ربما أحتاج في فهم بعض ما وضعته إلى فكر وتأمل، قلت يعني بالكتاب مختصره في الفروع.
<span data-type="title" id=toc-202><span data-type="title" id=toc-203><span data-type="title" id=toc-204><span data-type="title" id=toc-205>إنشادة</span></span></span></span>
<span data-type="title" id=toc-206>لأبي جعفر بن عبد العظيم</span>
...
<span data-type="title" id=toc-207><span data-type="title" id=toc-208><span data-type="title" id=toc-209>إفادة</span></span></span>
<span data-type="title" id=toc-210>استنساخ بعض كتب ابن البناء من كبت أخرى</span>
...
إنشادة
<span data-type="title" id=toc-211>لأبي سعيد بن لب</span>
...
إفادة
<span data-type="title" id=toc-212>دلالة اسم الفاعل</span>
...
إنشادة
<span data-type="title" id=toc-213>لأبي عبد الله الشقوري الطبيب</span>
...
إفادة
<span data-type="title" id=toc-214>أنواع الدراهم</span>
<span data-type="title" id=toc-215>وتقديرها في عصر المؤلف</span>
...
إنشادة
<span data-type="title" id=toc-216>لأبي البقاء خالد البلوي</span>
<span data-type="title" id=toc-217>في الشيب</span>',NULL,'18',NULL,NULL,'0');
INSERT INTO [b584] VALUES (19,'أنشدني الشيخ الفقيه القاضي الأعدل أبو البقاء خالد بن عيسى بن أحمد بن إبراهيم بن أبي خالد البلوي حفظه الله لنفسه في السادس والعشرين لرجب عام تسعة وخمسين وسبعمائة:
ومستنكر شيبي وما ذهب الصبا ... ولا جف إيناع الشبيبة من غصني
فقلت فراقي للأحبة مؤذنٌ ... بشيبي وإن كنت ابن عشرين في سني
<span data-type="title" id=toc-218><span data-type="title" id=toc-219>إفادة</span></span>
<span data-type="title" id=toc-220>مسألة نحوية استفادها</span>
<span data-type="title" id=toc-221>ابن الفخار عن شيخه الحضرمي</span>
...
<span data-type="title" id=toc-222><span data-type="title" id=toc-223>إنشادة</span></span>
<span data-type="title" id=toc-224>لأبي البقاء البلوي</span>
<span data-type="title" id=toc-225>أنشدها في رحلته بتونس</span>
...
إفادة
<span data-type="title" id=toc-226>استعمال القلب لفهم</span>
<span data-type="title" id=toc-227>تعبير فقهي</span>
...
إنشادة
<span data-type="title" id=toc-228>لأبي الحسن القرطبي</span>
...
<span data-type="title" id=toc-229>إفادة وإنشادة</span>
<span data-type="title" id=toc-230>نظم ابن لب في القضاء</span>
...
إذا شاء ربي الكفر منه مشيئةً ... فهل أنا راضٍ باتباع المشيئة؟',NULL,'19',NULL,NULL,'0');
INSERT INTO [b584] VALUES (20,'وهل لي اختيار أن أخالف حكمه ... فبالله فاشفوا بالبراهين علتي
وأجاب الأستاذ أجله الله، بعد الحمد والصلاة على النبي صلى الله عليه وسلم بما نصه طويل
...
ثم وقع بعد ذلك ما نصه هذه الأبيات المكتتبة تضمنت جواب الأبيات الستة المكتوبة فوق هذا. نظم هذه كاتب هذا فرج بن لب لطف الله تعالى به وغفر له.
...
والحمد لله تعالى.',NULL,'20',NULL,NULL,'0');
