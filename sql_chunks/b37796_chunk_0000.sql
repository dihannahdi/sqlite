...
CREATE TABLE "b37796"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b37796
INSERT INTO [b37796] VALUES (1,'<span data-type="title" id=toc-1>شرح القواعد المثلى [١]</span>
...
INSERT INTO [b37796] VALUES (2,'<span data-type="title" id=toc-2>أهمية العلم الشرعي</span>
...
فالعلم الشرعي له أهمية كبرى في الإصلاح، وفي الدعوة إلى الله سبحانه وتعالى، وبين الدعوة وبين العلم ارتباط كبير جداً، وقد عني السلف الصالح رضوان الله عليهم بعلم العقيدة بالذات؛ وسبب ذلك: أن علم العقيدة هو الذي يبنى عليه صحة دين الإنسان، يعني: كونه مسلماً أو غير مسلم، وكونه من أهل الجنة الخالدين فيها، أو من أهل النار الخالدين فيها، وهذا مبني على العقيدة؛ ولهذا اعتنوا بها اعتناء كبيراً، وشرحوها ووضحوها في واقعهم العملي وفي مصنفاتهم التي كتبوها للناس.','1','2',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (3,'<span data-type="title" id=toc-3>جوانب عناية السلف بالعقيدة</span>
...
أما تصحيح العقيدة فهو: إزالة الشوائب التي قد تعلق بها سواءً من أهل البدع والضلالات، أو من تسويلات الشيطان ووساوسه التي يحدثها في نفس الإنسان، ولهذا أوضحوا العقائد وبينوها، وصححوها تصحيحاً واضحاً، وتصحيح السلف رضوان الله عليهم لهذه العقيدة اتخذ مسلكين: المسلك الأول: هو مسلك عرض العقيدة.
...
وذكر الشيخ أنه يتضمن الإيمان بوجود الله سبحانه وتعالى، وقد يفرده البعض وتكون أربعة: الإيمان بوجود الله، وبربوبيته، وبألوهية، وبأسمائه وصفاته، وبعضهم يجعل وجود الله عز وجل داخل في توحيد الربوبية، فيجعل الإيمان بالله يتضمن ثلاثة أمور: الإيمان بروبية الله، وبألوهية، وبأسمائه وصفاته.','1','4',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (5,'<span data-type="title" id=toc-5>منزلة العلم بأسماء الله وصفاته من الدين</span>
...
ومن ناحية أخرى أن الأسماء والصفات لها آثار عظيمة جداً على سلوك ودين الإنسان، وعلى آدابه وأخلاقه، ولهذا فالعناية بها لها أهمية كبيرة من ناحية أن الإنسان يتأدب بالآداب التي تتضمنها أسماء الله عز وجل وصفاته.','1','5',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (6,'<span data-type="title" id=toc-6>سبب تصنيف الكتاب</span>
...
ومصدر الشيخ في فصل: قواعد في أسماء الله تعالى هو كتاب بدائع الفوائد، وأكثر القواعد الموجودة في هذا الفصل مأخوذة من كتاب بدائع الفوائد، لـ ابن قيم الجوزية، ففي المجلد الأول ذكر تقريباً عشرين قاعدة في أسماء الله تعالى، منها هذه القواعد التي ذكرها الشيخ.','1','6',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (7,'<span data-type="title" id=toc-7>قواعد في أسماء الله تعالى</span>','1','7',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (8,'<span data-type="title" id=toc-8>قاعدة: أسماء الله كلها حسنى</span>
قال المصنف رحمه الله تعالى: [القاعدة الأولى: أسماء الله تعالى كلها حسنى، أي: بالغة في الحسن غايته، قال الله تعالى: {وَلِلَّهِ الأَسْمَاءُ الْحُسْنَى} [الأعراف:١٨٠]؛ وذلك لأنها متضمنة لصفات كاملة لا نقص فيها بوجه من الوجوه لا احتمالاً ولا تقديراً].
...
والآية الرابعة هي آية الحشر وهي آخر آية في السورة وهي قول الله عز وجل: {هُوَ اللَّهُ الْخَالِقُ الْبَارِئُ الْمُصَوِّرُ لَهُ الأَسْمَاءُ الْحُسْنَى يُسَبِّحُ لَهُ مَا فِي السَّمَوَاتِ وَالأَرْضِ وَهُوَ الْعَزِيزُ الْحَكِيمُ} [الحشر:٢٤].','1','8',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (9,'<span data-type="title" id=toc-9>دلالات وصف أسماء الله بالحسنى</span>
...
وكذلك من الدلالات على أن أسماء الله حسنى: أنه لا يوجد اسم من أسماء الله يتضمن الشر، بل الشر في مفعولاته عز وجل، وليس في فعله، وليس في وصفه، وليس في اسمه سبحانه وتعالى، ويمكن أن نذكر مثالاً يدل على ذلك، يقول الله عز وجل: {إِنَّ بَطْشَ رَبِّكَ لَشَدِيدٌ * إِنَّهُ هُوَ يُبْدِئُ وَيُعِيدُ * وَهُوَ الْغَفُورُ الْوَدُودُ} [البروج:١٢ - ١٤]، انظروا في الاسم سمى نفسه الغفور الودود، وهي أسماء الخير والبركة، وفي مفعوله وصفه بأنه شديد، ومثل قول الله سبحانه وتعالى: {أَنِّي أَنَا الْغَفُورُ الرَّحِيمُ * وَأَنَّ عَذَابِي هُوَ الْعَذَابُ الأَلِيمُ} [الحجر:٤٩ - ٥٠]، فالعذاب نتيجة فعله سبحانه وتعالى وهي آثار فعله وقد توصف بالألم، وبما فيه ضرر بالنسبة للإنسان أو لغيره، لكن أسماء الله سبحانه وتعالى لا يمكن أن ينسب إليها شر بأي وجه من الوجوه.','1','9',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (10,'<span data-type="title" id=toc-10>أمثلة على أسماء الله الحسنى</span>
...
وهذا مثال يدل على أن اسم الله عز وجل الرحمن اسماً حسناً، وبين الشيخ أوجه تضمنه فقال: (لأنه يدل على الرحمة الكاملة)، ثم وصفها بالأحاديث الواردة عن الرسول صلى الله عليه وسلم عليه، وأنها واسعة، وأن الله عز وجل أرحم بعباده من الأم بولدها، وهذا لا شك أنه من الغاية في الحسن والجلال والكمال.','1','11',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (12,'<span data-type="title" id=toc-12>الحسن في أسماء الله باعتبار كل اسم على انفراده وجمعه إلى غيره</span>
...
يدل هذا على أنه إذا اجتمع اسم العزيز واسم الحكيم فإن اجتماعها يدل على معنى عظيم وكبير وهو عز بحكمه، وحكمة بقوة؛ لأنه قد يكون العزيز في بعض الأحيان ليست لديه حكمه كما ذكر، وكذلك الحكيم وهكذا، ومثله أيضاً السميع البصير، كما قال الله عز وجل: {لَيْسَ كَمِثْلِهِ شَيْءٌ وَهُوَ السَّمِيعُ البَصِيرُ} [الشورى:١١]، فإن السميع قد يسمع لكن قد لا يبصر في بعض الأحيان، فقال البصير؛ ولأن البصير قد لا يسمع فوجد السميع، وهكذا يكتمل المعنى بنفس الطريقة التي ذكرها الشيخ رحمه الله تعالى.','1','12',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (13,'<span data-type="title" id=toc-13>الأسئلة</span>','1','13',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (14,'<span data-type="title" id=toc-14>عدم وجود مذهب المعتزلة بأصوله الخمسة مع وجود أفكارهم في الفرق الضالة</span>
...
وكذلك وجدت أفكار المعتزلة عند أصحاب العقلانية المعاصرة، فأفكارهم موجودة وهي ما يسمونها بحرية الإرادة، وقد صنف بعض المصنفين كتباً مثل: محمود قاسم وغيره من الكتاب الذين لهم كتب عن حرية الإرادة، ويقصدون بذلك نفي القدر، وأن الله عز وجل لم يكتب الأشياء، ولم يقدرها، وينفون القدر ويقولون بمقالة المعتزلة، ويعتبرون أن المعتزلة أصحاب ثورة تحريرية عن الفكر السلفي الجامد، وما يزال أصحاب المدرسة العصرية على نفس أفكار المعتزلة في تقديم العقل على النقل، لكن المعتزلة كفرقة تؤمن بالأصول الخمسة التي ذكرها أئمتهم لا توجد الآن.','1','14',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (15,'<span data-type="title" id=toc-15>عدم جواز تسمية الله بالشيء</span>

<span data-type="title">السؤال</span>
  قال تعالى: {قُلْ أَيُّ شَيْءٍ أَكْبَرُ شَهَادَةً قُلِ اللَّهُ} [الأنعام:١٩]، أليس فيها دليل على تسميته بالشيء؟

<span data-type="title">الجواب</span>
  هذه ليس فيها دليل على تسميته بالشيء، وغاية ما فيها أنه يجوز أن يخبر عنه بأنه شيء، وهو سبحانه وتعالى شيء ليس لا شيء، لكن على وجه الخبر وليس على وجه التسمية؛ لأنه لا يصح أن يسمى الله عز وجل باسم لا مدح فيه ولا ثناء ولا حسن.','1','15',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (16,'<span data-type="title" id=toc-16>المريد ليس من أسماء الله</span>

<span data-type="title">السؤال</span>
  ذكر ابن القيم اسم المريد كثيراً في كتاب مدارج السالكين، فهل هو اسم من أسماء الله.

<span data-type="title">الجواب</span>
  عندما يذكر ابن القيم اسم المريد فهو لا يقصد به الله، وإنما يقصد به: العبد، أي: الذي يريد ترقية إيمانه، وهي لفظة يقصد بها أصحاب الإرادة، يعني: الذي يريدون تنمية إرادتهم، حينما يقبلون على الأعمال الصالحة.','1','16',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (17,'<span data-type="title" id=toc-17>عدم جواز الذهاب إلى قبر الرسول لطلب الاستغفار منه</span>
...
<span data-type="title">الجواب</span>
  المقصود باستغفار الرسول في حياته فقط، فيجوز أن يذهبوا إلى الرسول صلى الله عليه وسلم فيستغفر لهم في حياته، ويدعو لهم في حياته، لكن بعد أن مات لا يجوز أن يطلب منه؛ لأن كان في حياته يقدر على الاستغفار، ولكنه بعد موته لا يستطيع فلا يسأل الإنسان إلا شيئاً يقدر عليه، وبالذات أنه فصل بيننا وبينه بحياة أخرى، فنحن في الدنيا وهو في البرزخ صلى الله عليه وسلم؛ ولهذا لا يجوز أن يستغاث بالنبي صلى الله عليه وسلم، أو أن يطلب منه عند قبره شيء.','1','17',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (18,'<span data-type="title" id=toc-18>الحكمة من التقسيمات المذكورة في العقيدة</span>

<span data-type="title">السؤال</span>
  ما رأيكم فيمن يقول: ليس شرطاً أن تعبد الله تعالى بهذه التقسيمات التي في العقيدة؛ لأن هذه التقسيمات أحدثها العلماء، وليست من تقسيمات القرآن أو السنة، يقصد بذلك: توحيد الربوبية، وتوحيد الألوهية، وتوحيد الأسماء والصفات، ويقول: إنني أتعبد بما أمرني الله في كتابه وبما أمرني به الرسول صلى الله عليه وسلم في سنته دون البحث عن هذه الأقسام؟

<span data-type="title">الجواب</span>
  هذه التقسيمات الموجودة عند أهل العلم هي من باب التقريب لا غير، وهي عبارة عن ترتيب لبعض المعاني الذهنية، ولبعض المسائل العقلية، وهذا أمر متفق عليه بين أهل العلم، وليس فيه خلاف، والعبرة بصحة المعنى وليس العبرة بالألفاظ الموجودة، إلا إذا كانت ألفاظاً مجملة تتضمن معان باطلة فترد، فأنت إذا اعتقدت معناه حتى ولو لم تحفظ التقسيم فاعتقادك سليم وصحيح، وإنما ذكرت هذه الأقسام لتقرب المعلومات للناس.','1','18',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (19,'<span data-type="title" id=toc-19>شرح القواعد المثلى [٢]</span>
من القواعد المثلى: أن أسماء الله الكريم أعلام وأوصاف، لا يستحق غيره أن يسمى بها، فقد حازت على ناصية الحسن، وكمال الجمال، وغاية العظمة جل في علاه، وهناك دلالات لأسماء الله الحسنى، وصفاته العلية، وهي تتضمن أموراً يجب الاطلاع عليها وسبر أغوارها','2','1',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (20,'<span data-type="title" id=toc-20>ذكر ما يطلق على الله تعالى من الأسماء والصفات والأخبار</span>
...
ومصدره فيها كتاب بدائع الفوائد، فقد ذكر ابن القيم نفس هذه القاعدة بألفاظها في بدائع الفوائد المجلد الأول صفحة مائة واثنين وستين.','2','2',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (21,'<span data-type="title" id=toc-21>قاعدة: أسماء الله تعالى أعلام وأوصاف</span>
...
هذه قاعدة جليلة يؤخذ منها أن كل اسم من أسماء الله سبحانه وتعالى يدل على صفة من صفاته، وهذا معنى قولنا: إن أسماء الله سبحانه وتعالى مشتقة، فهي مشتقة من معانٍ وهذا من غاية الحسن.','2','3',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (22,'<span data-type="title" id=toc-22>الأدلة على أن أسماء الله تتضمن صفات</span>
...
وهناك دليل واضح أيضاً: وهو أننا نجد في الموجودات مقدورات ومعلومات، وهذه المقدورات تدل على قدرة، وهذه المعلومات تدل على علم، فالمقدورات والمعلومات الموجودة دليل على وجود القدرة والعلم عند الباري سبحانه وتعالى، وأنها مأخوذة من اسمه العليم القدير كما سيأتي إيضاحه وشرحه.','2','4',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (23,'<span data-type="title" id=toc-23>أنواع الصفات التي تتضمنها أسماء الله تعالى</span>
...
والنوع الرابع: هو ما يدل على جملة أوصاف متعددة، وليس له معنى واحد فقط، وإنما يدل على معانٍ متعددة مثل العظيم، فهو العظيم في كل شيء: العظيم في خلقه العظيم في أمره ومثله المجيد، والصمد، ونحو ذلك، وقد شرح ذلك ابن القيم رحمه الله في كتابه بدائع الفوائد شرحاً مطولاً.','2','5',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (24,'<span data-type="title" id=toc-24>عقيدة المعتزلة والمعطلة في صفات الله</span>
...
وكذلك سبق أن بينا أن هذه الشبهة باطلة، والأدلة من القرآن تردها كم','2','6',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (25,'<span data-type="title" id=toc-25>عقيدة الأشاعرة في صفات الله</span>
...
وأما الأشاعرة فإنهم يقولون: أسماء الله عز وجل تتضمن الصفات، ويعنون بذلك الصفات التي يثبتونها هم، وهي الصفات السبع المشهورة: صفة العلم والقدرة والحياة والإرادة والسمع والبصر والكلام؛ فهذه صفات يثبتونها لله عز وجل، لكن إذا دل اسم من الأسماء على معنى لا يثبتونه بل يؤولونه، ويفرغونه من محتواه.','2','7',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (26,'<span data-type="title" id=toc-26>الرد على أهل التعطيل القائلين بأن ثبوت الصفات يستلزم تعدد القدماء</span>
...
وأما المستحيل أو ممتنع الوجود: فهو الأمور التي يستحيل وجودها مثل اجتماع النقائض، كاجتماع الحركة والسكون في جسم واحد، فهذا مستحيل، ولا يمكن أن توجد حركة وسكون في جسم واحد، وهذا ما يسمونه ممتنع الوجود، ولهذا ذكرها الشيخ على أنها من الصفات.','2','8',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (27,'<span data-type="title" id=toc-27>الدهر ليس من أسماء الله تعالى</span>
...
وهذه القاعدة كان مصدر المصنف فيها هو كتاب التنبيهات السنية في شرح العقيدة الواسطية للشيخ عبد العزيز بن ناصر الرشيد، فقد ذكر هذه القاعدة بنفس الطريقة التي ذكرها.','2','9',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (28,'<span data-type="title" id=toc-28>دلالة أسماء الله تعالى على إثبات الاسم والصفة والأثر</span>
...
وهو الوصف الذي يشتق منه الاسم بالميزان.','2','11',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (30,'<span data-type="title" id=toc-30>شرح القواعد المثلى [٣]</span>
أسماء المولى عز وجل توقيفية، لا مجال للعقل فيها، ولا مكان للمنطق والفلسفة والإدراك البشري والإحساس الآدمي في أي منها؛ وذلك لأنها متعلقة بالذات الإلهية التي لا يعرف كنهها إلا هو جل في علاه.
كما أن أسماءه لا حصر لها، فقد جاء في السنة النبوية ما يدل دلالة قاطعة على ذلك','3','1',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (31,'<span data-type="title" id=toc-31>قاعدة: أسماء الله تعالى توقيفية لا مجال للعقل فيها</span>
...
وإذا قال قائل: إن الله عز وجل قديم أو موجد الوجود، أو أن له ذاتاً، وكل هذه لم ترد بألفاظها في النصوص، فإذا أخبر الإنسان عن الله عز وجل بها ف','3','2',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (32,'<span data-type="title" id=toc-32>عقيدة المعتزلة والأشاعرة في توقيف أسماء الله</span>
...
ونوع آخر: وهي التي لم ترد في الكتاب ولا السنة سواءً بنفي أو بإثبات وهذا ما نرده ولا نثبته لله سبحانه وتعالى ما دام أن الخبر لم يرد من الله عز وجل ومن الرسول صلى الله','3','3',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (33,'<span data-type="title" id=toc-33>قاعدة: أسماء الله تعالى غير محصورة بعدد معين</span>
...
وطائفة منها اختلف العلماء هل هي أسماء لله عز وجل أو أنها ليست أسماء، وبناءً على هذا يكون المعنى السابق هو توجيه هذا الحديث الذي ذكرنا.','3','4',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (34,'<span data-type="title" id=toc-34>معنى الإحصاء</span>
...
وهناك عدد من أهل العلم اجتهدوا في جمع أسماء الله سبحانه وتعالى، واختلفوا في هذه الأسماء، فبعضهم يذكر اسماً من أسماء الله عز وجل ويقول: إنه اسم ثابت، وبعضهم ينفيه، وخاصة الأسماء التي وردت','3','5',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (35,'<span data-type="title" id=toc-35>الأسئلة</span>','3','6',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (36,'<span data-type="title" id=toc-36>خطأ مقولة: يعلم الله أني فعلت كذا</span>
...
<span data-type="title">الجواب</span>
  إذا قال الإنسان يعلم الله كذا وكذا فهو يخبر أن الله عز وجل يعلم ذلك الأمر، فإذا كان الأمر على خلاف ما قال فهذا يدل على أنه نسب لعلم الله عز وجل شيئاً وهو ليس ثابتاً وإنما هو كذب محض، فلا شك أن هذا أمر مذموم ومنهي عنه.','3','7',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (37,'<span data-type="title" id=toc-37>كتاب الأسماء والصفات للبيهقي على طريقة الأشاعرة</span>

<span data-type="title">السؤال</span>
  هل كتاب البيهقي في الأسماء والصفات على منهج الأشاعرة؟

<span data-type="title">الجواب</span>
  البيهقي رحمه الله له كتاب اسمه الاعتقاد بناه على طريقة الأشاعرة، وهو محدث رحمه الله إلا أنه في الاعتقاد لا سيما في باب الأسماء والصفات على طريقة الأشاعرة، فكتابه الأسماء والصفات على منهج الأشاعرة لكنه كان يخالفهم في أحيان كثيرة.','3','8',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (38,'<span data-type="title" id=toc-38>الفرق بين دلالة المطابقة والالتزام</span>
...
ويمكن أن يقال: إن الله عز وجل واجب الوجود وأنه سبحانه وتعالى قديم، وأنه أزلي، ونحو ذلك من الأخبار، وهذه الأخبار ليست من أسمائه وليست من صفاته وإنما هي أخبار يخبر بها الإنسان عن الله عز وجل بمعنى صحيح.','3','10',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (40,'<span data-type="title" id=toc-40>أسماء الرسول صلى الله عليه وسلم</span>

<span data-type="title">السؤال</span>
  هل للرسول صلى الله عليه وسلم أسماء غير محمد وأحمد؟

<span data-type="title">الجواب</span>
  له أسماء أخرى غير محمد وأحمد، لكن في بعض المصاحف الشامية يذكرون أسماء للرسول صلى الله عليه وسلم تقارب تسعة وتسعين اسماً، فيزيد في هذه الأسماء وهذا خطأ، لكن الرسول صلى الله عليه وسلم له أسماء أخرى غير محمد وأحمد.','3','11',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (41,'<span data-type="title" id=toc-41>من هم الصوفية</span>؟
...
فقالوا مثلاً: إن الإنسان إذا عبد الله عز وجل بطريقة معينة يذكر ورداً معيناً ويقرأه بآلاف المرات ويجلس بهيئة معينة بعد ذلك يحصل له الكشف، والكشف هو علوم إلهامية تأتيه من الله سبحانه وتعالى، ثم تطورت عقيدتهم ودخلت ضمن عقائد أخرى فأصبحوا يستغيثون بالأولياء، وينذرون، ويذبحون لهم، ونحو ذلك من الأعمال الكثيرة، وهي طائفة أكبر من أن يختصر الكلام عنها في لحظات، لكن هذا جانب من جوانب الحديث عنها.','3','12',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (42,'<span data-type="title" id=toc-42>حكم ترجمة معاني أسماء الله تعالى إلى لغة أخرى</span>

<span data-type="title">السؤال</span>
  هل يجوز ترجمة أسماء الله تعالى وصفاته إلى غير العربية؟

<span data-type="title">الجواب</span>
  يجوز ترجمة معاني الأسماء، وقد يشرح معنى اسم من أسماء الله في سطرين أو ثلاثة ولا يمكن أن يكون اسم في سطرين، فالشرح والترجمة إنما يكونان للمعاني وليس للألفاظ؛ لأن الله عز وجل سمى نفسه ووصف نفسه سبحانه وتعالى بالعربية.','3','13',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (43,'<span data-type="title" id=toc-43>حكم قول: نتعبد الله بمقتضى أسمائه</span>

<span data-type="title">السؤال</span>
  ما هو الإشكال في قولنا: نتعبد الله بمقتضى أسمائه؟

<span data-type="title">الجواب</span>
  هذا ليس فيه إشكال أو انحراف أو خطأ أو ضلال، وإنما الأولى هو الاكتفاء باللفظ الشرعي الوارد وهو الدعاء بأسمائه.','3','14',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (44,'<span data-type="title" id=toc-44>مثال على أسماء الله التي تدل على معنى واحد</span>

<span data-type="title">السؤال</span>
  هل يمكن ذكر مثال على الأسماء التي تدل على معنى واحد؟

<span data-type="title">الجواب</span>
  سبق أن بينت هذا مثل القدير والقادر والمقتدر، فكلها تدل على معنى واحد وهي القدرة، لكن تعتبر ثلاثة أسماء.','3','15',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (45,'<span data-type="title" id=toc-45>أسماء الله تعالى تؤخذ من المعاني لا من الصفات</span>

<span data-type="title">السؤال</span>
  ذكرتم أن الأسماء لا تؤخذ من الصفات وإنما من المعاني، فما معنى ذلك؟

<span data-type="title">الجواب</span>
  أصل الاشتقاق اللغوي هو أن الأعلام تؤخذ من المعاني، وتؤخذ من المصادر، لكن لا يصح للإنسان أن يتتبع صفات الله عز وجل ويأخذ منها أسماء، وإنما يقف عند الأسماء الواردة في النصوص الشرعية ويكتفي بها.','3','16',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (46,'<span data-type="title" id=toc-46>شرح القواعد المثلى [٤]</span>
الإلحاد في أسماء الله تعالى وصفاته من المحرمات، وهو الميل بها عما يجب فيها والعدول عن الحق فيها إلى قول الباطل، ومن ذلك إنكار شيء من أسماء الله تعالى أو مما دلت عليه من الصفات والأحكام، فينبغي للمؤمن الحذر من ذلك، والتحذير من أهل البدع الذي يلحدون في أسماء الله تعالى.','4','1',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (47,'<span data-type="title" id=toc-47>الإلحاد في أسماء الله تعالى</span>
...
والذين ذكروا أنواع الإلحاد في أسماء الله تعالى، بعضهم ذكر نوعين، مثل ابن العربي في (أحكام القرآن)، وبعضهم ذكر خمسة أنواع مثل ابن القيم في (بدائع الفوائد)، والشيخ هنا ذكر أربعة أنواع، فبعضهم يبسطها ويفصلها وبعضهم يجملها، ومن هنا اختلف عدد أنواع الإلحاد في باب أسماء الله الحسنى.','4','2',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (48,'<span data-type="title" id=toc-48>حرمة الإلحاد في أسماء الله الحسنى</span>
...
فقول الله عز وجل: {وَلِلَّهِ الأَسْمَاءُ الْحُسْنَى فَادْعُوهُ بِهَا وَذَرُوا الَّذِينَ يُلْحِدُونَ فِي أَسْمَائِهِ سَيُجْزَوْنَ مَا كَانُوا يَعْمَلُونَ} [الأعراف:١٨٠]، يدل على حرمة الإلحاد في أسماء الله تعالى، وقد سبق أن بينا أنه ليس المقصود بالإلحاد، إنكار وجود الله، وإنما المقصود هو الميل في باب أسماء الله والعدول عن الحق فيها إلى قول الباطل.','4','3',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (49,'<span data-type="title" id=toc-49>أنواع الإلحاد في أسماء الله الحسنى</span>','4','4',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (50,'<span data-type="title" id=toc-50>النوع الأول: إنكار شيء منها أو مما دلت عليه من الصفات</span>
...
وقال قتادة: ((يلحدون في أسمائه)) يكذبون فيها، فهذا نوع من أنواع الإلحاد، وهو داخل في عموم الآية كما سبق.','4','5',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (51,'<span data-type="title" id=toc-51>النوع الثاني: جعل أسماء الله دالة على صفات تشابه صفات المخلوقين</span>
...
يعني: المشبهة عندما يقرءون مثلاً: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه:٥]، يقولون: نثبت اسم (الرحمن) ثم ما يتضمنه (الرحمن) من صفة وهي الرحمة، يجعلونها مشابهة لرحمة المخلوق، فيجعلون الله عز وجل مشابهاً للمخلوق فيما تضمنته أسماء الله سبحانه وتعالى، وكذلك العزة، وكذلك العلم، وكذلك القدرة، وكذلك غيرها من صفات الله سبحانه وتعالى يجعلونها مشابهة للمخلوق.
...
ويدل على دخول هذا النوع في الآية تفسير الأعمش رحمه الله تعالى، حيث قال في قراءة حمزة السابقة (يَلحدون): يُدخلون فيها ما ليس منها، يعني: يدخلون في أسماء الله تعالى ما ليس منها، فيسمون الله عز وجل بأسماء وهي ليست من أسمائه، مثل أهل الكلام عندما سموا الله عز وجل: (القديم)، ولم يرد هذا الاسم من أسماء الله سبحانه وتعالى، وإن كان معناه قد يكون صحيحاً لو أخبر به، لكن كونه اسماً لله عز وجل لم يرد في ذلك نص في الكتاب ولا في السنة.','4','7',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (53,'<span data-type="title" id=toc-53>النوع الرابع: أن يشتق من أسماء الله أسماء للأصنام</span>
مثال ذلك: ما فعله المشركون، فإنهم سموا العزى أخذاً من اسم الله (العزيز)، وسموا اللات أخذاً من (الإله) أو من (الله) على أحد القولين، ويدل على هذا تفسير ابن عباس رضي الله عنهما ومجاهد رحمه الله تعالى لقوله: {وَذَرُوا الَّذِينَ يُلْحِدُونَ فِي أَسْمَائِهِ} [الأعراف:١٨٠]، فإن ابن عباس رضي الله عنه قال: (اشتقوا -يعني: المشركين- العزى من (العزيز) واشتقوا (اللات) من الله)، وثبت مثله عن مجاهد رحمه الله تعالى.
...
قال: [فسموا بها أصنامهم؛ وذلك لأن أسماء الله تعالى مختصة به؛ لقوله تعالى: {وَلِلَّهِ الأَسْمَاءُ الْحُسْنَى فَادْعُوهُ بِهَا} [الأعراف:١٨٠]، ويقول الله عز وجل: {اللَّهُ لا إِلَهَ إِلَّا هُوَ لَهُ الأَسْمَاءُ الْحُسْنَى} [طه:٨]، ويقول: {لَهُ الأَسْمَاءُ الْحُسْنَى يُسَبِّحُ لَهُ مَا فِي السَّمَوَاتِ وَالأَرْضِ} [الحشر:٢٤]، فكما أن الله عز وجل اختص بالعبادة والتأله له وحده سبحانه وتعالى، وكذلك سائر أسمائه وسائر صفاته هي خاصة به سبحانه لا يشركه فيها أحد.
وهذه أنواع من حيث الحكم، وبعضها توصل إلى درجة الشرك، وبعضها تكون مجرد بدعة، وهي أنواع مختلفة ليست نوعاً واحد.
بهذا نكون قد انتهينا من الكلام عن قواعد الأسماء الحسنى السبع، ونشرع إن شاء الله في قواعد صفات الله سبحانه وتعالى.','4','8',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (54,'<span data-type="title" id=toc-54>قواعد في صفات الله عز وجل</span>
...
الموضع الثاني: في المجلد السادس عشر في تفسير سورة العلق، حيث ذكر الطرق التي تدل على إثبات الكمال لله تعالى وسيأتي تفصيلها بإذن الله تعالى.','4','9',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (55,'<span data-type="title" id=toc-55>صفات الله صفات كمال لا نقص فيها بوجه من الوجوه</span>
...
والدقة الموجودة في هذا الكون تدل على صفة العلم والإرادة والحياة لله سبحانه وتعالى، ويمكن أن نضرب على هذا مثالاً، وهو قول الله عز وجل: {أَلا يَعْلَمُ مَنْ خَلَقَ وَهُوَ اللَّطِيفُ الْخَبِيرُ} [الملك:١٤]، هذه الآية تدل على الكمال المطلق لله عز وجل في صفة العلم، يعني: ألا يعلم أن الذي يخلق؟ يعني: كيف لا يعلم وهو الذي يخلق؟ فإن الذي يخلق لابد أن يكون عالماً؛ لأنه لا يمكن أبداً أن يخلق وهو جاهل لا يدري ما يخلق، وليس عنده علم مفصل بما يخلق، بل لابد أن يكون عنده علم مفصل بما يخلقه بكل دقيقة وكبيرة وصغيرة فيه، فإذا كانت هذه المخلوقات كلها غير الله عز وجل هي مخلوقة له سبحانه وتعالى، فهذا يدل على كمال علمه، فإثبات الكمال يمكن أن يؤخذ من مخلوقات الله عز وجل.
...
يعني: لا يصح أن يكون الإله مشتملاً على صفات النقص، وحينئذٍ فالإله اشتمل على صفات الكمال سبحانه وتعالى.','4','11',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (57,'<span data-type="title" id=toc-57>امتناع وصف الله تعالى بصفات النقص التي لا كمال فيها</span>
...
أما إذا كانت الصفة لا تشتمل على كمال بأي وجه من الوجوه، فإنه لا يصح إثباتها لله عز وجل، مثل: الخيانة، فليس فيها كمال بأي وجه من الوجوه، حتى لو خانه غيره، كما قال الله عز وجل: {وَإِنْ يُرِيدُوا خِيَانَتَكَ فَقَدْ خَانُوا اللَّهَ مِنْ قَبْلُ فَأَمْكَنَ مِنْهُمْ} [الأنفال:٧١] قال: {فَأَمْكَنَ مِنْهُمْ} [الأنفال:٧١] ولم يقل: فخانهم؛ لأن الخيانة ليس فيها مدح بأي وجه من الوجوه.','4','12',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (58,'<span data-type="title" id=toc-58>ضابط الصفة المتضمنة للكمال المطلق لله تعالى</span>
عندنا مسألتان في القاعدة الأولى: المسألة الأولى: ضابط الصفة التي هي كمال لا نقص فيها بوجه من الوجوه.
فالضابط فيها يمكن أن يذكر في فقرتين: الفقرة الأولى: أن تكون هذه الصفة كمالاً في ذاتها، بقطع النظر عما نسبت إليه، فإذا كانت هي في ذاتها صفة كمال لا نقص فيها، فهذه تثبت لله سبحانه وتعالى.
...
فبعض الأحيان قد تكون صفة من الصفات كمالاً لكنها بالنسبة للمخلوق نقص، ومثال ذلك: صفة الذرية: فالذي له أولاد تعتبر هذه الصفة كمال بالنسبة له؛ ولهذا يعيبون الذي لا أولاد له، لكن هذه لا يمكن أن تثبت لله؛ لأنها تضمنت الحاجة إلى الغير، والله عز وجل لا يحتاج إلى غيره سبحانه وتعالى، وحينئذٍ هذه تكون صفة كمال بالنسبة للمخلوق، ولا تكون صفة كمال بالنسبة إلى الخالق، هذا هو الضابط في مسألة الصفة التي تكون كمالاً لا نقص فيها بوجه من الوجوه.','4','13',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (59,'<span data-type="title" id=toc-59>حكم إطلاق اسم الكامل على الله عز وجل</span>
...
وهذه المسألة ذكرها شيخ الإسلام رحمه الله تعالى في مجموع الفتاوى والرسائل (٥/ ٤١).','4','14',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (60,'<span data-type="title" id=toc-60>الأسئلة</span>','4','15',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (61,'<span data-type="title" id=toc-61>حكم إطلاق كلمة (فلسفة) على بعض المصطلحات الشرعية</span>
...
الشاهد في الموضوع أنه لا يصح أن يقال عن المصطلحات الشرعية: إنها فلسفة؛ لأن هذه الكلمة نشأت وترعرعت عند اليونان، وإن كان كثير ممن يطلقها لا يقصد الفلسفة القديمة، وإنما يقصد التفكير، يعني: بعض من يستخدم كلمة (فلسفة) للتفكير، لكن الأولى هو ألا تستخدم هذه الكلمة مطلقاً.','4','16',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (62,'<span data-type="title" id=toc-62>مشروعية الدعاء بصفات الله عز وجل</span>

<span data-type="title">السؤال</span>
  هل يجوز الدعاء بصفة من صفات الله تعالى؟

<span data-type="title">الجواب</span>
  يجوز أن يدعو الإنسان بصفة من صفات الله، مثل أن يقول: (اللهم يا منزل الكتاب ومجري السحاب وهازم الأحزاب اهزمهم وانصرنا عليهم) كما قال صلى الله عليه وسلم، وهذه كلها صفات وليست أسماء.','4','17',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (63,'<span data-type="title" id=toc-63>حرمة الاستغاثة بغير الله فيما لا يقدر عليه إلا الله</span>

<span data-type="title">السؤال</span>
  يقول بعض الناس حين يحصل له شيء: يا جبريل، فهل يجوز هذا؟

<span data-type="title">الجواب</span>
  هذه من الألفاظ التي اعتادها كثير من أهل البوادي، فهم يستغيثون بجبريل، وهذه استغاثة شركية؛ لأنه لا يجوز للإنسان أن يستغيث بغير الله عز وجل فيما لا يقدر عليه إلا الله سبحانه وتعالى، فهي لفظة غير مناسبة وهي شركية كما سبق أن بينا.','4','18',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (64,'<span data-type="title" id=toc-64>حقيقة وجود فرقة الجهمية في وقتنا الحاضر وغيرها من الفرق المنحرفة</span>
...
وأما الأشاعرة والماتريدية: فما زالت إلى الآن موجودة، حيث توجد كثير من مناهج التعليم في كثير من أنحاء العالم الإسلامي تتبنى عقائد الأشاعرة، وتقرر لهم المناهج التعليمية، مثل: الأزهر مثلاً، فالأزهر مناهج العقيدة فيه على مذهب الأشاعرة، يدرسون فيه كتاب المواقف للإيجي والشرح للجرجاني، ويقررون عليهم كتاباً اسمه مقرر التوحيد، يقررون فيه عقائد الأشاعرة.','4','19',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (65,'<span data-type="title" id=toc-65>الفرق بين الأسماء والصفات</span>
...
والخوارج: هم الذين يكفرون الناس بالذنوب، فيزني الزاني مثلاً ويكفرونه، ولا يفرقون بين المعاصي وبين الكفريات، وليس عندهم ضابط فيها، فيكفرون الناس بالذنوب.
هؤلاء هم الخوارج: (وهم كلاب أهل النار)، كما قال رسول الله صلى الله عليه وسلم.
...
والقبوريون: هم الذين يعظمون القبور ويطوفون حولها، ويشتغلون بذلك.','4','22',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (68,'<span data-type="title" id=toc-68>ذكر المراجع التي ورد فيها ذكر سلمان المرشد</span>

<span data-type="title">السؤال</span>
  ما اسم الكتاب الذي وردت فيه قصة سلمان المرشد؟

<span data-type="title">الجواب</span>
  يمكن أن يراجع مثلاً كتاب الأعلام للزركلي، ذكر سلمان المرشد، وكتاب اسمه (إسلام بلا مذاهب) لـ مصطفى الشكعة وهذا الكتاب كتاب سيئ، وإن كان عنوانه جذاباً، لكنه مليء بالأخطاء.','4','23',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (69,'<span data-type="title" id=toc-69>صفة الحياة صفة كمال للمخلوق</span>

<span data-type="title">السؤال</span>
  هل صفة الحياة للمخلوق صفة كمال؟

<span data-type="title">الجواب</span>
  صفة الحياة صفة كمال؛ لأن الموت نقص.','4','24',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (70,'<span data-type="title" id=toc-70>حكم إطلاق الجسم على الله تعالى</span>
...
وإن كان المقصود بالجسم أن له صفات، وأن له يداً وقدماً، حتى ولو كانت مثل اسم أعضاء المخلوقات أثبتناها، ولا شك أن لله عز وجل صفات تليق بجلاله، فكلمة (جسم) يجب ألا تستخدم؛ لأنه لم ترد بإثبات ولا بنفي في الشرع، وحينئذٍ نسأل عن معناها، وأي لفظة لم ترد في القرآن ولا في السنة يسأل عن معناها، إذا كان معناها صحيحاً أثبت، وإذا كان معناها باطلاً رد، وإذا كان معناها محتملاً للحق والباطل أخذ الحق ورد الباطل، واستغني عن هذه الكلمة بما ورد في الشرع.','4','25',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (71,'<span data-type="title" id=toc-71>معنى قول السلف: المشبه يعبد وثناً والمعطل يعبد عدماً</span>

<span data-type="title">السؤال</span>
  ما معنى قول السلف: المشبه يعبد وثناً والمعطل يعبد عدماً؟

<span data-type="title">الجواب</span>
  يعني: المشبه يعبد صنماً؛ لأنه شبه الله بمخلوقاته، فكأنه يتخيل أن الله مخلوق أمامه؛ لهذا كأنه يعبد صنماً، والمعطل يعبد عدماً؛ لأنه نفى الصفات، ولم يبق شيئاً، وحينئذٍ كأنه يعبد لا شيء.
هذا هو المقصود بكلام السلف.','4','26',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (72,'<span data-type="title" id=toc-72>معنى تحقيق الكمال</span>

<span data-type="title">السؤال</span>
  ما معنى: تحقيق الكمال؟

<span data-type="title">الجواب</span>
  يعني: إثبات الكمال لله عز وجل، هذا هو المقصود به.','4','27',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (73,'<span data-type="title" id=toc-73>إلى من تنسب فرقة الماتريدية</span>

<span data-type="title">السؤال</span>
  إلى من تنسب الماتريدية، وهل يوافقون أهل السنة في بعض أبواب العقيدة؟

<span data-type="title">الجواب</span>
  الماتريدية ينسبون إلى أبي منصور الماتريدي وهم من الأحناف، ويشبهون الأشاعرة بنسبة (٩٥%) تقريباً، يعني: عقائد الأشاعرة وعقائد الماتريدية واحدة إلا في مسائل معدودة، ومن قلة هذه المسائل صنفت فيها كتب، مثل: كتاب لـ أبي عذبة في الفروق بين الأشاعرة والماتريدية، وجمع فروقاً تصل إلى عشرين فرقاً تقريباً، وبقية المسائل متفقون عليها.
والفرق بين الأشعري والماتريدي: هو أن الماتريدي غالباً يكون حنفياً في الفروع، والأشعري يكون على غير ذلك.','4','28',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (74,'<span data-type="title" id=toc-74>العمدة في معرفة الأحاديث الصحيحة من الضعيفة وحكم الاستدلال بالضعيف في الأصول</span>
...
أما في فضائل الأعمال فيجوز أن يستشهد فيها بالحديث الضعيف، وأن يذكر لأجل ترغيب الناس في الخير، وهذا هو المنقول عن أئمة الحديث وعن السلف، وقد روي عن سفيان وعن غيره قال: (إذا روينا في الحلال والحرام شددنا، وإذا روينا في الفضائل تساهلنا) وهذا في باب الترغيب والترهيب فالأمر فيه واسع؛ بشرط أن يكون ما حواه ذلك الحديث من الترغيب أو من الترهيب لا يناقض أصلاً، أو قاعدة أو آية أو حديثاً، والله أعلم.','4','29',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (75,'<span data-type="title" id=toc-75>الفرق بين المسابقة في عمل الخير والدعوة وبين العجلة المنهي عنها</span>
...
وهذه السبل في داخل الصراط يجمعها سبيل واحد وهو القرآن وهو الإسلام وهو السنة، كما فسر بذلك قوله جل وعلا: {اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ} [الفاتحة:٦] يعني: أن الصراط المستقيم هو الإسلام وهو السنة وهو القرآن، وهذا الصراط في داخله سبل شعب، لكن ليست مخالفة لذلك الصراط وليست مبعدة عنه، بل هي فيه، فكذلك إذا قلنا: إن الحق أنواع، وإن الحق له فروع وشعب، فنريد به فروع الحق الداخلة في السبيل الواحد وفي الحق الواحد.','4','31',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (77,'<span data-type="title" id=toc-77>أقسام العلم والطرق المثلى لتحصيله</span>
...
انتزعها من بعض كتب الفقهاء.','4','32',NULL,NULL,'0');
INSERT INTO [b37796] VALUES (78,'<span data-type="title" id=toc-78>التحذير من الاختلاف المؤدي إلى الفرقة بين المسلمين</span>
