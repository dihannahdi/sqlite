...
CREATE TABLE "b36411"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36411
INSERT INTO [b36411] VALUES (1,'كيف نُحيي قلوبنا
في رمضان؟
مع القرآن في رمضان يومًا بيوم

مجدي الهلالي
www.alemanawalan.com',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b36411] VALUES (2,'جميع الحقوق محفوظة
الطبعة الأولى
١٤٢٧هـ - ٢٠٠٦م
...
INSERT INTO [b36411] VALUES (3,'<span data-type="title" id=toc-1>يا فرحتنا ... اقترب رمضان</span>
...
فلنرفع علم التقوى ولنضعه نصب أعيننا ولنشمر للوصول إليه خلال هذا الشهر الكريم.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (4,'<span data-type="title" id=toc-5>مظاهر النجاح</span>
ومظاهر نجاح الواحد منا في الوصول إلى هذا الهدف هو تغيير سلوكه، فعندما يحيا القلب ويزداد منسوب الإيمان فيه فإن هذا من شأنه أن يدفع صاحبه للسلوك الصحيح و<span data-type="title" id=toc-6>العمل الصالح </span>في كل الاتجاهات والأوقات بتلقائية ودون تكلف ... ألم يقل سبحانه: {ذَلِكَ وَمَن يُعَظِّمْ شَعَائِرَ اللهِ فَإِنَّهَا مِن تَقْوَى الْقُلُوبِ} [الحج:٣٢].
...
والأمر اللافت للانتباه أن هناك ارتباطًا وثيقًا بين رمضان والقرآن، فرمضان هو الشهر الذي فضله الله عز وجل واختصه بنزول أعظم المعجزات فيه {شَهْرُ رَمَضَانَ الَّذِي أُنْزِلَ فِيهِ الْقُرْآنُ هُدًى لِّلنَّاسِ وَبَيِّنَاتٍ مِّنَ الْهُدَى وَالْفُرْقَانِ} [البقرة:١٨٥]
...
العمل الصالح:
ومع القرآن تأتي الأعمال الصالحة التي تزيد الإيمان وترفعه {وَالْعَمَلُ الصَّالِحُ يَرْفَعُهُ} [فاطر:١٠].
...
وكلما استفاد المرء من إيمانه الذي أنشأه القرآن في قلبه وذلك حين يُتبعه بالعمل الصالح فإن هذا شأنه أن يعود بأثر عظيم على القلب؛ فتزداد حياته ومستوى الإيمان فيه، فالعمل الصالح بمثابة الماء للبذر والزيت للسراج {إِنَّ الَّذِينَ يَتْلُونَ كِتَابَ اللهِ وَأَقَامُوا الصَّلاَةَ وَأَنفَقُوا مِمَّا رَزَقْنَاهُمْ سِرًّا وَعَلاَنِيَةً يَرْجُونَ تِجَارَةً لَّن تَبُورَ} [فاطر:٢٩].',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (5,'وسنقترح عليك أخي الكريم أن تقوم معنا بأداء عمل صالح في كل يوم بالإضافة إلى برنامجك الخاص من باب التعاون على البر والتقوى، وستلاحظ أن هناك عملاً جديدًا كل يوم، عليك أن تجتهد في الإتيان به حتى لا يسبقك أحد إلى الله {وَفِي ذَلِكَ فَلْيَتَنَافَسِ الْمُتَنَافِسُونَ} [المطففين:٢٦]
...
واستمرار الكرامة باستمرار الاستقامة {وَلَئِنِ اتَّبَعْتَ أَهْوَاءَهُم بَعْدَ مَا جَاءَكَ مِنَ الْعِلْمِ مَا لَكَ مِنَ اللهِ مِن وَلِيٍّ وَلاَ وَاقٍ} [الرعد:٣٧]',NULL,'4',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (6,'فعُلُو أمتنا وعزها ومجدها مرتبط بمدى إيمان أفرادها واستقامتهم على أمر الله {وَأَنْتُمُ الأَعْلَوْنَ إِنْ كُنْتُم مُّؤْمِنِينَ} [آل عمران:١٣٩]، وكلما ضعف الإيمان بين أفراد الأمة، خرجت الأمة من دائرة المعية والتأييد الإلهي، واستبدلت رضا الله بغضبه .. {وَمَن يَحْلِلْ عَلَيْهِ غَضَبِي فَقَدْ هَوَى} [طه:٨١].
السؤال: اذكر من الجزء الثاني من القرآن آية تؤكد هذا المعنى، وأن الكرامة والولاية من الله على قدر الاستقامة من العبد.
العمل الصالح:

الدعاء هو الطلب من الله واستدعاء معونته، وأهم سبب لاستجابة الدعاء هو إظهار الافتقار إلى الله، والتبرؤ من الحول والقوة، وكلما اشتد الافتقار أسرعت الإجابة {أَمَّن يُجِيبُ الْمُضْطَرَّ إِذَا دَعَاهُ} [النمل:٦٢].
...
العمل الصالح
تهيئة القلب للصلاة: كلما هيأ المرء نفسه للصلاة كانت استفادته منها أكبر، ومن وسائل هذه التهيئة: إنهاء أي شيء معلق يشغل البال، والوضوء، والتبكير للمسجد قبل الأذان ... قال أبو الدرداء: إن من فقه المرء إقباله على حاجته حتى يقبل على صلاته وقلبه فارغ ...',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (7,'والتبكير بصفة خاصة له مفعول عجيب في حضور القلب مع الصلاة، فهو يُصفي الخواطر الدنيوية، ويسكنها ... فلنجتهد اليوم وكل يوم في القيام بهذا العمل، وعلى الأخت المسلمة أن تخصص مكانًا في بيتها تتخذه مسجدًا تبكر في الذهاب إليه قبل الأذان.
...
٥ - رمضان
مع القرآن:
تعامل الجيل الأول مع القرآن على حقيقته ككتاب هداية وتغيير، وكمنبع عظيم للإيمان، فاستقامت حياتهم، وتحررت قلوبهم من أسر الدنيا، فوفَّي الله بعهده معهم، ومكنهم في الأرض خلال سنوات معدودة {وَمَنْ أَوْفَى بِعَهْدِهِ مِنَ اللهِ} [التوبة:١١١].
...
٦ - رمضان
مع القرآن:',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (8,'أنزل الله عز وجل القرآن وجمع فيه بين أمرين عظيمين لم يجتمعا في كتاب من قبل .. الرسالة والمعجزة، فالرسالة تبين للناس وتهديهم للطريق الموصل لرضا الله وجنته {شَهْرُ رَمَضَانَ الَّذِي أُنْزِلَ فِيهِ الْقُرْآنُ هُدًى لِّلنَّاسِ} [البقرة:١٨٥].
...
٨ - رمضان
مع القرآن:',NULL,'7',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (9,'كم ختمة ستختمها في رمضان؟: سؤال يتردد كثيرًا بيننا كلما دخل علينا رمضان، بل إنك تجد الواحد منا يتسابق مع إخوانه في عدد الختمات التي سيختمها، فإن سألته لماذا يفعل ذلك؟ أجابك بأنه يريد تحصيل أكبر قدر من الحسنات.
...
السؤال: يظن البعض أن صلاحه في نفسه فقط كافٍ لنيل رضا الله عز وجل، فيترك دعوة غيره من الشاردين، ولا يفكر إلا في نفسه، ولقد بيَّن القرآن خطأ هذا الفهم وذلك في عرضه لقصة أصحاب السبت في سورة الأعراف .. اذكر ما يؤكد هذا المعنى من الآيات مع تعليق مختصر عليها.
العمل الصالح:
...
١٠ - رمضان
مع القرآن:
قد يقول قائل: لنجعل القراءة الهادئة المتأنية التي تراعي الفهم والتأثر في غير رمضان، أما خلال هذا الشهر فينبغي أن ننتهز فرصة مضاعفة ثواب الأعمال فيه، فنقرأ أكبر قدر ممكن من القرآن ...',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (10,'نعم، رمضان فرصة عظيمة للانطلاقة القوية، وذوق حلاوة الإيمان من خلال القرآن .. نعم، رمضان يصلح كنقطة بداية لمن يشكو عدم وجود همة ورغبة في التعامل مع القرآن بتدبر وتأثر .. أما أن يكون التعامل مع القرآن في رمضان بطريقة تبحث عن الأجر فقط، ومن ثمَّ لا تراعي الهدف الذي نرجوه فهذا معناه أن نظل في أماكننا ندور في حلقة مفرغة، فقراءة القرآن بفهم وتأثر ينبغي أن تصاحبنا طيلة العام، بل إن الحاجة إليها لتشتد أكثر وأكثر في شهر رمضان باعتبار أنه فرصة جيدة ومناخ مناسب لإحياء القلب بالإيمان، ولنعلم جميعًا أننا لو ختمنا القرآن في رمضان ختمة واحدة .. بتفهم وتأثر فإن أثرها، والثواب المترتب عليها سيكون- بمشئية الله- أفضل من عشرات الختمات بدون فهم وتأثر.
...
وفي هذه الأيام التي نعيشها نرى جراح المسلمين قد انتشرت في كل مكان في العالم، فهل لنا أن نعمل على نُصرة هؤلاء، وأن نرفع أكُفَّ الضراعة إلى الله عز وجل الذي هو أكبر من كل كبير أن يخفف عن إخواننا المضطهدين في كل مكان، وأن يكشف غمهم وكربهم، ويعيد لهم حقوقهم المسلوبة؟!

١١ - رمضان
مع القرآن:
أخي القارئ: لا يكن همك أن تنتهي من الجزء أو السورة، بل اجعل همك فهم ما تقرأ والتأثر به قدر المستطاع.
عن أبى جمرة قال: قلت لابن عباس: إني سريع القراءة وإني أقرأ القرآن في ثلاث، فقال: لأن أقرأ البقرة في ليلة فأدبرها وأرتلها أحبُّ إلىَّ من أن أقرأ كما تقول.
ومن وصايا ابن مسعود: «لا تهذوا القرآن هذَّ الشعر، ولا تنثروه نثر الدقل، وقفوا عند عجائبه وحركوا به القلوب ولا يكن هم أحدكم من السورة آخرها»
...
فعلينا أن نكثر من أوقات قراءتنا للقرآن، ولا يكن هم أحدنا بلوغ آخر السورة أو الجزء، بل ليكن همه أن يفهم ما يقرأ، وأن يتأثر به {اللهُ نَزَّلَ أَحْسَنَ الْحَدِيثِ كِتَابًا مُّتَشَابِهًا مَّثَانِيَ تَقْشَعِرُّ مِنْهُ جُلُودُ الَّذِينَ يَخْشَوْنَ رَبَّهُمْ ثُمَّ تَلِينُ جُلُودُهُمْ وَقُلُوبُهُمْ إِلَى ذِكْرِ اللهِ} [الزمر:٢٣].',NULL,'9',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (11,'السؤال: جاء في ختام سورة هود {وَكُلاًّ نَّقُصُّ عَلَيْكَ مِنْ أَنْبَاءِ الرُّسُلِ مَا نُثَبِّتُ بِهِ فُؤَادَكَ وَجَاءَكَ فِي هَذِهِ الْحَقُّ وَمَوْعِظَةٌ وَذِكْرَى لِلْمُؤْمِنِينَ} [هود:١٢٠].
...
كان أبو هريرة يقول: البيت الذي يُقرأ فيه القرآن كالبيت الذي فيه المصباح، والبيت الذي لا يُقرأ فيه القرآن كالحُشَّ. (١)
...
_________
(١) الحُشَّ: هو المكان الذي تجتمع فيه القاذورات والأنجاس.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (12,'العمل الصالح:
قال صلى الله عليه وسلم: «ثلاث أقسم عليهن: ما نقص مال قط من صدقة، فتصدقوا، ولا عفا رجل عن مظلمة ظُلمها إلا زاده الله تعالى بها عزا، فاعفوا يزدكم الله عزًّا، ولا فتح رجل على نفسه باب مسألة يسأل الناس إلا فتح الله عليه باب فقر» [صحيح الجامع] فلنجاهد أنفسنا حتى نتخلق بخلق العفو عمن أساء إلينا، ونتذكر فضل العفو عمن ظلمنا لنعفوا عنهم بنفس راضية، ولنشهد الله على ذلك العفو لعله يعفو عنا {وَلْيَعْفُوا وَلْيَصْفَحُوا أَلاَ تُحِبُّونَ أَن يَّغْفِرَ اللهُ لَكُمْ} [النور: ٢٢] ولأن النفوس قد يصعب عليها ذلك، فما أجمل استغلال ذلك الشهر في ترويضها على هذا الخلق.
...
ومفهوم المسؤولية ليس مقصورًا على توفير الطعام والشراب وسائر النفقات بل الأهم هو تربيتهم على الاستقامة على أمر الله {وَأْمُرْ أَهْلَكَ بِالصَّلاَةِ وَاصْطَبِرْ عَلَيْهَا} [طه: ١٣٢].
ورمضان فرصة عظيمة للجلوس مع الزوجة والأولاد، ومتابعة أعمالهم، وشحذ هممهم، والاشتراك معهم في الإجابة عن الأسئلة، والقيام بالأعمال الصالحة.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (13,'١٧ - رمضان
مع القرآن:
...
١٨ - رمضان
مع القرآن:
القرآن خطاب من الله عز وجل لعباده أجمعين .. هذا الخطاب يتضمن أسئلة علينا أن نجيب عليها مثل قول تعالى: {قُلْ أَرَأَيْتُمْ إِنْ أَصْبَحَ مَاؤُكُمْ غَوْرًا فَمَن يَّأْتِيكُمْ بِمَاءٍ مَّعِينٍ} [الملك: ٣٠] فيجيب: الله رب العالمين. وفي القرآن أوامر للتنفيذ السريع علينا أن نقوم بها مثل قوله تعالى: {سَبِّحِ اسْمَ رَبِّكَ الأعْلَى} [الأعلى: ١] فنسبح، وفيها حديث عن الجنة علينا أن نسأل الله بلوغها، وحديث عن النار فنستعيذ بالله منها.
...
العمل الصالح:
من أهم الأعمال الصالحة التي لا تتوافر إلا في أيام الصيام .. «تفطير الصائمين» قال رسول الله صلى الله عليه وسلم «من فطَّر صائمًا كان له مثل أجره، غير أنه لا ينقصُ من أجر الصائم شيئًا» [صحيح الجامع الصغير]. فحبذا لو قمنا بهذا العمل الصالح، وحبذا لو كان للفقراء والمساكين.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (14,'١٩ - رمضان
مع القرآن:
...
فلنكرر تلك الآية التي نتأثر بها ونحن نقرأ القرآن، ولنعلم أنه كلما كررناها ونحن في حالة التأثر فإن هذا معناه استمرار تدفق النور والإيمان إلى القلب، ومن ثمَّ تدبُّ الحياة في جنباته.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (15,'السؤال: في سورة الروم ولقمان هناك العديد من الآيات التي تتحدث عن دلائل وجود الله وأنه الإله الحق الواحد الذي لا شريك له ولا ندَّ له، ولا صاحبة، ولا ولد .. اذكر خمسة من هذه الدلائل مع الآيات الدالة عليها.
...
٢٢ - رمضان
مع القرآن:
عن عباد بن حمزة قال: دخلت على أسماء رضي الله عنها وهي تقرأ: {فَمَنَّ اللهُ عَلَيْنَا وَوَقَانَا عَذَابَ السَّمُومِ} [الطور: ٢٧]، فوقفت عندها، فجعلت تعيدها وتدعو، فطال علىَّ ذلك فذهبت إلى السوق، فقضيت حاجتي ثم رجعت وهي تعيدها وتدعو ..
...
السؤال: في سورة فاطر جاء الأمر الإلهي {يَا أَيُّهَا النَّاسُ اذْكُرُوا نِعْمَتَ اللهِ عَلَيْكُمْ} [فاطر: ٣] وتحدثت السورة عن الكثير من نِعم الله على عباده .. اذكر خمسًا منها مع الآيات الدالة عليها.
...
وللأخت المسلمة أن تعتكف في مسجد بيتها (١) استناداً إلى رأي الأحناف في جواز ذلك، ولتقتطع من يومها وقتًا تلازم فيه مسجدها، وتقبل فيه على الله عز وجل.

٢٣ - رمضان
مع القرآن:
عن مسروق قال: قال لي رجل من أهل مكة: هذا مقام أخيك تميم الداري، لقد رأيته ذات ليلة حتى أصبح أو كاد أن يصبح يقرأ آية من كتاب الله، يركع ويسجد ويبكي {أَمْ حَسِبَ الَّذِينَ اجْتَرَحُوا السَّيِّئَاتِ أَن نَّجْعَلَهُمْ كَالَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ سَوَاءً مَّحْيَاهُمْ وَمَمَاتُهُمْ سَاءَ مَا يَحْكُمُونَ} [الجاثية: ٢١].
وقرأ عبد الله بن عمر سورة المطففين حتى بلغ {يَوْمَ يَقُومُ النَّاسُ لِرَبِّ الْعَالَمِينَ} [المطففين: ٦] فبكي حتى خرّ، ولم يستطع قراءة ما بعد هذه الآية.
السؤال: اذكر الآية التي تأثرت بها خلال قراءتك للقرآن، واذكر المعنى الإيماني الذي تولد لديك في لحظات التأثر.
العمل الصالح:
قال محمد إقبال: كن مع من شئت في العلم والحكمة، ولكنك لا ترجع بطائل حتى تكون لك أنَّة في السحر.
...
_________
(١) المقصود من مسجد البيت: المكان الذي تخصصه الأخت للصلاة فيه، وحبذا لو كان مكانًا ثابتًا يكفي لصلاتها.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (16,'هل لنا أن نتذكر ذنوبنا السابقة ونهرع إلى المحراب في السحر نُسمع الله أنيننا، ونكتب إليه بدموعنا رسائل الاسترحام والاعتذار؟!!
...
السؤال: في سورة الأحقاف آيات تبين حال نفر من الجن عند استماعهم للقرآن وكيف سارعوا إلى قومهم يصفون لهم القرآن .. اذكر صفتين من هذه الصفات كما بينتها الآيات.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (17,'العمل الصالح:
...
٢٩ - رمضان
مع القرآن:
نزل رجل من العرب على عامر بن ربيعة رضي الله عنه فأكرم عامر مثواه، وكلم فيه رسول الله صلى الله عليه وسلم، فجاء الرجل إليه فقال: إني استقطعت رسول الله صلى الله عليه وسلم واديًا، ما في العرب أفضل منه، ولقد أردت أن أقطع لك منه قطعة تكون لك ولعقبك. فقال عامر: لا حاجة لي في قطعتك، نزلت اليوم سورة أذهلتنا عن الدنيا {اقْتَرَبَ لِلنَّاسِ حِسَابُهُمْ وَهُمْ فِي غَفْلَةٍ مُّعْرِضُونَ} [الأنبياء:١] .. هكذا كان تعاملهم مع القرآن .. وهكذا كان فعل القرآن فيهم.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b36411] VALUES (18,'السؤال: في سورة المُلك هناك آيات كثيرة تعرفنا بالله عز وجل وأنه على كل شيء قدير .. اذكر ثلاثة مظاهر تؤكد هذا المعنى مع الآيات الدالة عليها.
العمل الصالح:
...
والحمد لله الذي هدانا لهذا وما كنا لنهتدي لولا أن هدانا الله.',NULL,'17',NULL,NULL,'0');
