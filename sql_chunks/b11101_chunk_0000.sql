...
CREATE TABLE "b11101"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b11101
INSERT INTO [b11101] VALUES (1,'<span data-type="title" id=toc-1>مقدمة:</span>
...
١-فإنه من الفخر أن يُذكر تبرع خادم الحرمين الشريفين بمبلغ ٣.٠٠٠.٠٠٠ريال لطباعة مصحف (برايل) والتي تشرف عليها الأمانة العامة للتربية الخاصة بوزارة المعارف التي تضع هدفاً لها (مصحف شريف لكل كفيف) .',NULL,'1',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (2,'فهذه اللبنة العظيمة في بناء صرح تعليم القرآن الكريم ليست الأولى ولا هي الأخيرة إن شاء الله تعالى إذ إنه عطاء متجدد منذ خمسة عشر عاماً يؤديه مجمع الملك فهد الذي أتاح للمسلمين في مشارق الأرض ومغاربها الحصول على نسخة صحيحة من القرآن الكريم في وقت أصبح فيه ديننا مستهدفاً.
...
_________
(١) يتم ذلك بمطبعة المجمع التي تعد من أكبر المطابع العالمية إذ تضم ثلاث آلات للطباعة الشريطية تبلغ سرعتها ما بين عشرين ألف إلى ستين ألف ملزمة في الساعة. ويتم صف الحروف بجهاز للحاسب الآلي يمكن استخدامه أيضاً لصف ترجمات معاني القرآن الكريم باللغات المختلفة.
وهناك ستون أله حديثة في قسم التجليد وبينها إحدى عشرة آلة من أفضل آلات الطي في العالم، كما توجد ثلاث آلات لتجميع ملازم المصحف تنجز الواحدة منها ستة آلاف مصحف في الساعة. هذا إلى جانب المقاطع الآلية التي تقوم بتفصيل مختلف أنواع الأغلفة سواء المصنوعة من الورق المقوي أم من الجلود الطبيعية.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (3,'٤-كما اهتم المجمع بالتسجيلات الصوتية حيث تبلغ الطاقة الإنتاجية أربعمائة ألف شريط سنوياً. وتم تسجيل القرآن الكريم كاملاً برواية حفص عن عاصم بأصوات كل من:
...
وهذا قليل من كثير نأمله في المستقبل مما اختطته العناية الإلهية للقرآن الكريم وهذا ما لم ولن يحظ به كتاب قبله ولا بعده؛ لأنه ذو أسلوب مؤثر بليغ، ربى النفوس وارتقت به الهمم حتى فتحت البشرية حافظتها لتسجل، وقلوبها لتفقه، وعقولها لتتدبر وعلى أكتاف حامليه اتسعت البلاد الإسلامية، وارتفعت منارات الحضارة حتى أفاد منها الغربيون وبَنَوْا حضارتهم..',NULL,'3',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (4,'وهاك خطوات البحث في هذا الموضوع: ـ
الباب الأول
...
خاتمة وتوصيات
فهارس عامة',NULL,'4',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (5,'<span data-type="title" id=toc-2>الباب الأول </span><span data-type="title" id=toc-3>أولاً: الإعلام الإسلامي من متطلبات العصر الحديث:</span>
بما أن الإسلام دين عالمي الرسالة،وعالمي الدعوة كما قال الله تعالى {تَبَارَكَ الَّذِي نَزَّلَ الْفُرْقَانَ عَلَى عَبْدِهِ لِيَكُونَ لِلْعَالَمِينَ نَذِيراً} (الفرقان:١) . فإن ذلك الأمر يتطلب إعلاماً واسع النطاق وشخصيات فذة تملأ هذا الوسع.
...
فيقول الدكتور محيي الدين عبد الحليم: (مدلول الإعلام الإسلامي: هو تزويد الإنسان بصفة عامة بحقائق الدين الإسلامي الحنيف المستمدة من القرآن الكريم والسنة النبوية المطهرة، وعرض مشكلات المجتمع الثقافية والاجتماعية والتعليمية من وجهة نظر إسلامية، من خلال رجل الإعلام الذي يتمتع بمعرفة واسعة ومتعمقة في موضوع الرسالة التي يتناولها وصولاً إلى تكوين رأى عام',NULL,'5',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (6,'صائب يعي ويدرك حقائق الدين الإسلامي اعتقاداً وعبادة ومعاملة) (١) . ويقول: الركابي (إنه يتمثل في إعلاء كلمة الله عز وجل من خلال جميع وسائل الاتصال الممكنة في كل عصر من العصور والأزمنة بحيث لا تتعارض تلك الوسائل مع الشريعة الإسلامية السمحة) (٢)
ويعرفه الشنقيطي بأنه: (إعلام يتضمن حياة الناس كافة المحكومة بشرع الله عز وجل ومن ثم يشتمل على مضامين الوحي الإلهي) (٣) . نقول: هذه المعاني المشتركة عند المعرفين هي ارتكاز الإعلام الإسلامي في مضمونه على القرآن الكريم وعلومه والسنة النبوية المطهرة، أضف إلي ذلك الأطر الفكرية، والاجتماعية، والإنسانية والتربوية المنبثقة من روح الإسلام وحقائقه وقيمه وضوابطه الشرعية بدءاً من ترسيخ الجانب العقدي لدى الناس بما يوافق الشرع ومروراً ببيان ما أحله الله سبحانه وأمرنا باتباعه، وبيان ما حرمه -عز وجل _ ونهانا عنه باجتنابه.
...
(٢) أزين الدين الركابي،النظرية الإسلامية في الإعلام والعلاقات الإنسانية ـ بحث منشور مقدم للندوة العالمية للشباب الإسلامي المنعقدة بالرياض ١٣٩٦هـ‍ ٢٢
(٣) الشنقيطي، مفاهيم إعلامية من القرآن الكريم، الرياض دار عالم الكتب ١٤٠٦ هـ‍ صـ١٨',NULL,'6',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (7,'هم لا يعلمون تواكبه مع فطرهم، وقد أذن الله ورسوله لنا بما مكننا أن نبلغهم ونعلمهم حتى تسري حقيقة القرآن والسنة سريان الروح في الجسد في النشاط الإعلامي كله المقروء والمسموع والمرئي، ومن ثم يصبح الإعلام الإسلامي حكماً موضوعياً تتحاكم إليه جميع النشاطات الإعلامية.
وهو في ذاته الوقت يحقق لأبناء الأمة الإسلامية -على الدوام _الاستقرار والتوازن، ويخلصها من التناقض والصراع الذي يعاني منه المسلمون في الغرب وبعض أفراد الأمة كلما ابتعدوا عن منهج الله تعالى. حتى تتجلى لهم الصورة الشاملة للإسلام في علومه وشريعته وأحكامه وخلقه وآدابه وسلوكه.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (8,'<span data-type="title" id=toc-4>ثانياً: وسائل الإعلام أداة تربوية تعليمية:</span>
...
وهذا يعني أن بين التربية والإعلام وشائج قوية، وأرضاً مشتركة إن التربية في جوهرها عملية اتصال، وإن الإعلام بجوهره ومظهره عملية اتصال) . (١)
...
بحث مقدم للاجتماع المشترك بين التربويين والإعلاميين ص٢',NULL,'8',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (9,'١- تغييراً في السلوك.
٢-مساعدة الفرد على التكيف مع واقع الحياة.
ويدل على تكاملهما وتواصلهما بعضهما ببعض نتيجة سعيهما لتحقيق النهوض بأبناء المجتمع وجعلهم أكثر إيجابية في ظل التحديات التي يواجهها الإنسان في هذا العصر. وهذا يدعونا إلى التساؤل عن:_',NULL,'9',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (10,'<span data-type="title" id=toc-5>ثالثاً: كيفية الاستفادة من الإعلام في توجيه الشباب</span>.؟
...
نظراً لما يغلب على الشباب من التوتر والانفعال والاضطراب النفسي والعاطفي في هذه المرحلة.. لذا فإن الإعلام الإسلامي يقوم برسالة تربوية بالغة الأهمية ولا سيما في مرحلة الشباب تتمثل في ضبط الانفعالات وتوجيه',NULL,'10',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (11,'لجانب العاطفي للشباب وصولاً إلى تحقيق الاستقرار النفسي والعاطفي من خلال البرامج الإسلامية التي تعوض الشباب عن ذلك.
...
٩-إبراز الصفة العالمية للدين الإسلامي الحنيف.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (12,'١٠-إبراز صفة التسامح في الإسلام، ومعنى وحقيقة الجهاد في سبيل الله تعالى.
١١-مقاومة الدعاوى الإلحادية التي تستهدف تدمير العقيدة الإسلامية والقيم الفاضلة (١) .
_________
(١) انظر أ/ ماجي الحلواني،الإعلام الإسلامي التحديات والمواجهة ط ١جدة مكتبة مصباح ١٤١١هـ‍ ص٢٤:٢٢',NULL,'12',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (13,'<span data-type="title" id=toc-6>رابعا: وسائل الإعلام بتعليم القرآن الكريم وعلومه</span>
<span data-type="title" id=toc-7>المسجد</span>
...
رابعاً: وسائل الإعلام المرتبطة بتعليم القرآن الكريم وعلومه
...
بخلاف الثلاثة الأخرى (الإذاعة والتلفاز والإنترنت) فإنها تفقد (المباشرة والرؤية واللقاء) وإن كان حاصلاً من طرف واحد وهو المتعلم.
أولاً-المسجد
...
ويعد المسجد مؤسسة تعليمية ومدرسة للعلم والتعليم والثقافة والأدب والتربية إلى جانب وظيفته الأولى،وكونه مكانا ًوموضوعاً طاهراً يتقرب فيه',NULL,'13',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (14,'إلى الله سبحانه وتعالى عن طريق أداء الصلوات الخمس المفروضة على المسلم في اليوم والليلة (١) .
...
(٢) محمد أحمد عبد الهادي، المربي والتربية الإسلامية ط١ جدة دار البيان العربي ١٤٠٤ هـ‍ ص٤',NULL,'14',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (15,'ثانياً:<span data-type="title" id=toc-8> المدرسة</span>
إن وظيفة المدرسة متعددة الجوانب منها الدينية والتربوية والثقافية والاجتماعية إلا أن الجانب الديني يعد أهم الجوانب، لأن الجوانب الأخرى منبثقة عن الدين الإسلامي الذي يرتكز على ما تقوم به المدرسة من إيجابية',NULL,'14',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (16,'وفاعلية وعن تحديد مدلول المدرسة يقول الدكتور/ محمد الفزار: (هي إحدى وسائط أو مؤسسات التنشئة الاجتماعية،وهي مؤسسة اجتماعية ٠تربوية متميزة أنشأها المجتمع بهدف تربية وتنشئة الصغار وتعليمهم وتهيئتهم أو إعدادهم للمواطنة الصالحة لمجتمعهم) (١) .
...
يقع على المدرسة وظيفة هامة هي أن تساير التطور السريع في مختلف المجالات العلمية والثقافية والتقنية تمشياً مع طبيعة هذا العصر شريطة أن يتفق ذلك مع تعاليم الإسلام.
...
(٢) السابق بتصرف واختصار ص٥٤،٥٧',NULL,'15',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (17,'والمدرسة بصفة عامة في المجتمع المسلم تجمع بين علوم الدين التي هي فرض عليها وبين علوم الدنيا التي هي فرض كفاية تعبيراً عن شمول الرسالة الإسلامية وتوازنها',NULL,'16',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (18,'ثالثا:<span data-type="title" id=toc-9> الإذاعة</span>
هي وسيلة التبليغ الصوتية التي تعمل عن طريق الأثير.
والإذاعة: بدأت مع اكتشاف الموجات القصيرة ويرجع اكتشاف هذه الموجات إلى عوامل عدة منها: اهتمام الدول بإيجاد طرق جديدة للاتصال بالعالم الخارجي في حالة تخريب كبلات وأسلاك خدماتها التلغرافية في حالة قيام الحرب.ولكن الفضل الرئيسي لاكتشاف هذه الموجات يرجع إلى هواة الراديو، الذين كانت حكوماتهم قد منعتهم من استخدام الموجات الطويلة والمتوسطة في هوايتهم نظراً لاكتظاظها بالخدمات الإذاعية، فخصصت لهم موجات غير معمول بها في ذلك الحين وهي الموجات القصيرة. وقد اكتشف الهواة في بحثهم عن وسيلة ومخرج يشبعون بها هوايتهم طريقة لاستخدام الموجات القصيرة.
...
_________
(١) الإذاعة الدولية، دراسة مقارنة لنظمها وفلسفتها د/سهير عبد الغني بركات، ١٩٧٨م بدون ط ص٢١',NULL,'16',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (19,'شاملة تخاطب الناس في كل زمان ومكان ومن ثم تخضع في تنشئة أفرادها لأهداف رسالتها السامية. ومن ثم طوعت الإذاعة لخدمة القرآن الكريم وتفسيره وترتيله وتجويده حتى أصبح ضرورة من ضرورات الحياة ولا سيما في المجتمعات المسلمة التي تأمل في مستقبل مشرق ومزدهر بالدعوة إلى الله سبحانه وتعالى وتوحيده والعمل على تنفيذ أوامره واجتناب نواهيه عن طريق نقل المعلومة الصحيحة وتحريك مشاعر الفرد والمجتمع بما يجب عليهم تجاه كتاب ربهم وغرس ذلك في نفوس الناشئة منذ الصغر عن طريق تربيتهم الإعلامية التربية الإسلامية الصحيحة ومن ثم اصبح تقربهم من القرآن سلوكاً طبيعيا مألوفاً يسلكه أفراد المجتمع بكل يسر وسهولة.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (20,'رابعاً<span data-type="title" id=toc-10> التلفاز:</span>
...
فالبث التلفزيوني المباشر لا يتم إلا من خلال قمر صناعي يستقبل البث من أي مركز على الأرض بواسطة هوائيات ذات قدرة عالية، وتحويل هذا البث إلى الأرض لتستقبله تلك الصحون المستديرة أوما يسمى باللغة الإنجليزية بـ (Dich) وهي ذات قدرة تقنية خاصة قادرة على استقبال الترددات العالية جداً من القمر الصناعي مباشرة ً ثم تحويل هذه الترددات إلي ترددات مناسبة للتلفزيون العادي لذا يعد البث التلفزيوني المباشر قضية اليوم والغد وذلك
_________
(١) أ/ ماجي حسن الحلواني، تكنولوجيا الإعلام في المجال التعليمي والتربوي القاهرة دار الفكر العربي ١٩٨٨ م ص٨٠',NULL,'17',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (21,'لاستقبال إرساله من الأقمار الصناعية مباشرةً، دون المرور على محطة أرضية، ومن ثم لا يمكن التحكم فيما يبثه للمشاهدين، سواء كان البث قادماً من المشرق أو المغرب فلماذا لا نوجِّه جهودنا الى قناة:
...
٢- يكون لها قصب السبق في الرد على الجوانب السلبية في القنوات الأخرى وبخاصه التي تهدف إلى إظهار الإسلام بصور سيئة في نفوس الغرب.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (22,'خامساً:<span data-type="title" id=toc-11> الإنترنت</span>
...
وقد يعطيك مقدم الخدمة الذي يربطك مع شبكة الإنترنت مساحة تمكنك من حفظ صفحاتك على الشبكة مجاناً ونستطيع استئجار مساحة يمكن الاتفاق عليها مع مقدم مثل هذه الخدمة.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (23,'- والأمر الذي يجب التنبيه إليه هو وجوب التأكد من صيانة البيانات المعروضة باستمرار.
...
وإنه آن الأوان للدعاة والعاملين في مجال الدعوة الإسلامية التشمير عن ساعد الجد،وتقديم مساهمة فعالة في مجال الدعوة إلى هذا الدين الحق وإعلام الناس بعالميته من خلال شبكة الإنترنت. مع العلم بأن هناك إحصائيات تشير إلى أن هناك (٢٢٥٠٠) موقعاً، وصفحة أو أكثر لخدمة النصرانية.
وأن هناك أكثر من (٥٨٠٠) موقعاً وصفحة أو أكثر لخدمة اليهودية بينما لا تتعدى الواقع إذاقلنا: إن الصفحات التي تتحدث عن دين الإسلام الحق _الصالح والمصلح لكل زمان ومكان _ (٥٠٠) موقع
واللافت للنظر أن أعداء الإسلام ينشطون في تبليغ (الإنجيل) و (التوراة) باستخدام قوائم البريد الإلكتروني بحيث يقدمون للمشتركين (آية واحدة) كل',NULL,'19',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (24,'يوم _أو يتعهدون بتقديم الإنجيل كاملا خلال عام واحد للقراء من خلال الإنترنت،بينما لا تجد من يستغل تلك المعطيات والتقنيات الحديثة لإبلاغ كلام الله الخالد (القرآن الكريم) و (الحديث الشريف) باستخدام هذه الوسيلة التي يستخدمها أكثر من (٦٠٠) مليون شخص في عالمنا المعاصر (١)
_________
(١) مجلة سعودي شوبر، العدد الخامس السنة الثانية يناير٢٠٠٠ مقال بعنوان (إنترنت– خطوة خطوة) ص٣٣',NULL,'20',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (25,'<span data-type="title" id=toc-12>الباب الثاني</span>
...
ب- حوار بين الله وأنبيائه عليهم السلام {يَوْمَ يَجْمَعُ اللَّهُ الرُّسُلَ فَيَقُولُ مَاذَا أُجِبْتُمْ قَالُوا لا عِلْمَ لَنَا إِنَّكَ أَنْتَ عَلَّامُ الْغُيُوبِ} . (المائدة: ١٠٩)
ج‍- حوار بين الرسل وأقوامهم {لَقَدْ أَرْسَلْنَا نُوحاً إِلَى قَوْمِهِ فَقَالَ يَا قَوْمِ اعْبُدُوا اللَّهَ مَا لَكُمْ مِنْ إِلَهٍ غَيْرُهُ إِنِّي أَخَافُ عَلَيْكُمْ عَذَابَ يَوْمٍ عَظِيمٍ. قَالَ',NULL,'21',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (26,'الْمَلَأُ مِنْ قَوْمِهِ إِنَّا لَنَرَاكَ فِي ضَلالٍ مُبِينٍ. قَالَ يَا قَوْمِ لَيْسَ بِي ضَلالةٌ وَلَكِنِّي رَسُولٌ مِنْ رَبِّ الْعَالَمِينَ أُبَلِّغُكُمْ رِسَالاتِ رَبِّي وَأَنْصَحُ لَكُمْ وَأَعْلَمُ مِنَ اللَّهِ مَا لا تَعْلَمُونَ أو عجبتم أَوَعَجِبْتُمْ أَنْ جَاءَكُمْ ذِكْرٌ مِنْ رَبِّكُمْ عَلَى رَجُلٍ مِنْكُمْ لِيُنْذِرَكُمْ وَلِتَتَّقُوا وَلَعَلَّكُمْ تُرْحَمُونَ فَكَذَّبُوهُ فَأَنْجَيْنَاهُ وَالَّذِينَ مَعَهُ فِي الْفُلْكِ وَأَغْرَقْنَا الَّذِينَ كَذَّبُوا بِآياتِنَا إِنَّهُمْ كَانُوا قَوْماً عَمِينَ} . (الأعراف: ٥٩ - ٦٤)
...
أنواع الحوار منها: ـ
الأول: الحوار التعبدي: بأن يوجه القرآن سؤالاً فيجيب العبد المؤمن.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (27,'روى أبو داود والبيهقي: كان رسول الله صلى الله عليه وسلم إذا قرأ {أَلَيْسَ ذَلِكَ بِقَادِرٍ عَلَى أَنْ يُحْيِيَ الْمَوْتَى} (القيامة: ٤٠) قال سبحانك،فبلى (١) .
وقد حث الرسول صلى الله عليه وسلم أصحابه على تلبية هذه الأسئلة.
روى الحاكم عن جابر قال: قرأ رسول الله صلى الله عليه وسلم سورة الرحمن حتى ختمها ثم قال: مالي أراكم سكوتاً؟ الجن كانوا أحسن منكم رداً، ما قرأت عليهم هذه الآية {فَبِأَيِّ آلاءِ رَبِّكُمَا تُكَذِّبَانِ} الرحمن: ١٣) إلا قالوا: ولا بشيء من نعمك ربنا نكذب، فلك الحمد (٢) .
...
فعن حذيفة بن اليمان: " صليت مع النبي صلى الله عليه وسلم ذات ليلة فافتتح البقرة فقلت يركع عند المائة ثم مضى يصلي بها إلى أن قال ثم افتتح بآل عمران يقرأ متر سلا إذا مر بآية فيها تسبيح سبَّح، وإذا مر بسؤال سأل، وإذا مر بتعوذ تعوذ" (٣)
...
(٣) رواه النسائي في المجتبى ج ٣ ص ٢٢٥ والبيهقي ج ١ ص ٤٣٣',NULL,'23',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (28,'٣- إشعار المتعلم والقارئ للقرآن الكريم بمكانته عند الله حتى خاطبهم به. فلما نزل قوله {فَهَلْ أَنْتُمْ مُنْتَهُونَ} (المائدة: ٩١) في آيات تحريم الخمر قالوا: انتهينا يا رب.
الثاني: حوار الخطاب التذكيري
بتذكير المتعلم بما يجب عليه أقتبس من القرآن الكريم تذكيره لنبي إسرائيل بالنعم {يَا بَنِي إِسْرائيلَ اذْكُرُوا نِعْمَتِيَ الَّتِي أَنْعَمْتُ عَلَيْكُمْ} (البقرة: ٤٠) . {يَا أَيُّهَا الَّذِينَ آمَنُوا اذْكُرُوا نِعْمَتَ اللَّهِ عَلَيْكُمْ إِذْ هَمَّ قَوْمٌ أَنْ يَبْسُطُوا إِلَيْكُمْ أَيْدِيَهُمْ فَكَفَّ أَيْدِيَهُمْ عَنْكُمْ وَاتَّقُوا اللَّهَ وَعَلَى اللَّهِ فَلْيَتَوَكَّلِ الْمُؤْمِنُونَ} (المائدة: ١١) وقال لرسوله صلى الله عليه وسلم {أَلَمْ نَشْرَحْ لَكَ صَدْرَكَ وَوَضَعْنَا عَنْكَ وِزْرَكَ} (الشرح: ١،٢) ..
...
فقد يرد التساؤل ويعقبه الجواب للفت الأنظار إلى أمر هام ثم يُشرح هذا الأمر تاركاً أعظم العبر كقوله تعالى {الْقَارِعَةُ مَا الْقَارِعَةُ وَمَا أَدْرَاكَ مَا الْقَارِعَةُ يَوْمَ يَكُونُ النَّاسُ كَالْفَرَاشِ الْمَبْثُوثِ} (القارعة: ١-٣) وقد اتخذ الرسول صلى الله عليه وسلم هذا الأسلوب في قوله صلى الله عليه وسلم "أتدرون من المفلس؟ قالوا: المفلس فينا من لا درهم له ولا متاع قال كلا بل المفلس من يأتي يوم القيامة بحسنات مثل الجبال ويأتي وقد شتم هذا وقذف هذا',NULL,'24',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (29,'فيأخذ هذا من حسناته وهذا من حسناته ..." الخ (٤) وإذا كانت المدرسة الحديثة تستخدم طريق الاستجواب لتثبت المعلومة فإن الإسلام قد وضع هذا الأسلوب منذ خمسة عشر قرناً من الزمان وشتان ما بينهما فالمدرسة الحديثة الاستجواب فيها مقصور على أمور علمية جافة بظن أو يقين لكن الحوار القرآني والنبوي يجدد أفكار السامعين بأمور يقينية جديدة موجهاً لهم الأخذ بخيرها وترك شرها.
الرابع: حوار الخطاب العاطفي
وهو خطاب أو استفهام يعتمد على استثارة العواطف الإنسانية والانفعالات الوجدانية حتى تترك أثراً في تغيير ما كان عليه إلى السلوك الصالح والعمل الطيب مثل قوله تعالى {يَا أَيُّهَا الَّذِينَ آمَنُوا لِمَ تَقُولُونَ مَا لا تَفْعَلُونَ كَبُرَ مَقْتاً عِنْدَ اللَّهِ أَنْ تَقُولُوا مَا لا تَفْعَلُونَ} الصف: ٢،٣)
ومثل قوله تعالى {يَا أَيُّهَا الَّذِينَ آمَنُوا مَا لَكُمْ إِذَا قِيلَ لَكُمُ انْفِرُوا فِي سَبِيلِ اللَّهِ اثَّاقَلْتُمْ إِلَى الْأَرْضِ أَرَضِيتُمْ بِالْحَيَاةِ الدُّنْيَا مِنَ الْآخِرَةِ فَمَا مَتَاعُ الْحَيَاةِ الدُّنْيَا فِي الْآخِرَةِ إِلَّا قَلِيلٌ إِلاّ تَنْفِرُوا يُعَذِّبْكُمْ عَذَاباً أَلِيماً وَيَسْتَبْدِلْ قَوْماً غَيْرَكُمْ وَلا تَضُرُّوهُ شَيْئاً وَاللَّهُ عَلَى كُلِّ شَيْءٍ قَدِيرٌ} التوبة: ٣٨) .
...
_________
(٤) رواه مسلم ٤ / ١٩٩٧ والترمذي ٤/ ٦١٣ ومسند أحمد ٢/ ٣٠٣ وابن حبان ١٠/ ٢٥٩',NULL,'25',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (30,'الخامس: حوار الخطاب التعريضي
...
ومثل قوله تعالى {أَفَرَأَيْتَ الَّذِي كَفَرَ بِآياتِنَا وَقَالَ لَأُوتَيَنَّ مَالاً وَوَلَداً أَطَّلَعَ الْغَيْبَ أَمِ اتَّخَذَ عِنْدَ الرَّحْمَنِ عَهْداً كَلَّا سَنَكْتُبُ مَا يَقُولُ وَنَمُدُّ لَهُ مِنَ الْعَذَابِ مَدّاً وَنَرِثُهُ مَا يَقُولُ وَيَأْتِينَا فَرْداً} (مريم: ٧٧-٨٠)
...
وهذه طريقة تلقين غير مباشر تكون أشد تأثيراً في بعض الأحيان من التلقين المباشر.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (31,'<span data-type="title" id=toc-15>٢.أسلوب القصص القرآني:</span>
...
وللقصة القرآنية أغراض ينبغي للمعلم أن يحققها في نفس مستمعيه وتربية عقولهم وعواطفهم.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (32,'الغرض الأول: إثبات الوحي والرسالة ففي أول سورة يوسف قال تعالى {إِنَّا أَنْزَلْنَاهُ قُرْآناً عَرَبِيّاً لَعَلَّكُمْ تَعْقِلُونَ} (يوسف: ٢،٣)
...
ولا يشك عاقل في أن وظيفة محمد صلى الله عليه وسلم إن هي إلا التبليغ {إِنْ عَلَيْكَ إِلَّا الْبَلاغُ} (الشورى: ٤٨) .
...
الغرض الثالث: الاعتبار بالحوادث التاريخية:',NULL,'27',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (33,'وما أعظم هذه الحوادث التي توجه المتعلم إلى معرفة المغزى:_
...
(ج) معرفة سنة الله في إلحاق الهزيمة بالكافرين إذا تمسك المؤمنون بشرعه {وَلَوْ قَاتَلَكُمُ الَّذِينَ كَفَرُوا لَوَلَّوُا الْأَدْبَارَ ثُمَّ لا يَجِدُونَ وَلِيّاً وَلا نَصِيراً سُنَّةَ اللَّهِ فِي الَّذِينَ خَلَوْا مِنْ قَبْلُ وَلَنْ تَجِدَ لِسُنَّةِ اللَّهِ تَبْدِيلاً} (الفتح: ٢٢،٢٣)
...
(هـ‍) البحث عن أثر إصلاح النفس البشرية وتربيتها في مجرى الحوادث التاريخية {ذَلِكَ بِأَنَّ اللَّهَ لَمْ يَكُ مُغَيِّراً نِعْمَةً أَنْعَمَهَا عَلَى قَوْمٍ حَتَّى يُغَيِّرُوا مَا بِأَنْفُسِهِمْ} (الأنفال: ٥٣)
وأن الغاية من القوة والغلبة والتمكين في الأرض إقامة شرع الله وتحقيق الصلاح ومحو الفساد {الَّذِينَ إِنْ مَكَّنَّاهُمْ فِي الْأَرْضِ أَقَامُوا الصَّلاةَ وَآتَوُا الزَّكَاةَ وَأَمَرُوا بِالْمَعْرُوفِ وَنَهَوْا عَنِ الْمُنْكَرِ وَلِلَّهِ عَاقِبَةُ الْأُمُورِ} الحج:٤١)',NULL,'28',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (34,'<span data-type="title" id=toc-16>٣. أسلوب ضرب الأمثال</span>
...
فيشبه ما يراد تحقيره بالأشياء التي عرفت حقارتها كتشبيه معبودات المشركين وأوليائهم ببيت العنكبوت {مَثَلُ الَّذِينَ اتَّخَذُوا مِنْ دُونِ اللَّهِ أَوْلِيَاءَ كَمَثَلِ الْعَنْكَبُوتِ اتَّخَذَتْ بَيْتاً وَإِنَّ أَوْهَنَ الْبُيُوتِ لَبَيْتُ الْعَنْكَبُوتِ لَوْ كَانُوا يَعْلَمُونَ} (العنكبوت: ٤١)
ولكن بعض المنافقين والمشركين لم يروا في القرآن شيئاً يعاب فتمحلوا بنحو قولهم: إنه لا يليق بالله ضرب المثل بالذباب والعنكبوت ولذا رد الله عليهم بقوله {إِنَّ اللَّهَ لا يَسْتَحْيِي أَنْ يَضْرِبَ مَثَلاً مَا بَعُوضَةً فَمَا فَوْقَهَا} (البقرة: ٢٦)
وليست الأمثال مجرد عمل فني يقصد من ورائه الرونق البلاغي فحسب بل إن لها غايات تعليمية.
١-تقريب المعنى إلى الأفهام {كَذَلِكَ يَضْرِبُ اللَّهُ الْحَقَّ وَالْبَاطِلَ فَأَمَّا الزَّبَدُ فَيَذْهَبُ جُفَاءً وَأَمَّا مَا يَنْفَعُ النَّاسَ فَيَمْكُثُ فِي الْأَرْضِ كَذَلِكَ يَضْرِبُ اللَّهُ الْأَمْثَالَ} الرعد: ١٧)
_________
(١) تفسير القرآن الحكيم /١٦٧ ط المنار',NULL,'29',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (35,'فالباطل يضمحل كالزبد الذي يحمله السيل وإن علا في بعض الأوقات كما يعلو الزبد،والحق ثابت باق يمكث في القلب فينتفع به المؤمن فيثمر عملاً صالحاً كما يمكث الماء في الأرض المنبتة فيثمر عشباً وزرعاً وأعناباً ونخيلاً.
٢ـ إثارة الانفعالات عند ورود المعنى تاركاً أثره في أعماق النفوس بالكراهية لكل معاني الشرك والكفر،وإثارة الرضا بالإيمان والإسلام مع الركون إلى القوة التي لا تضعف والعز الذي لا يزول {إِنَّ الَّذِينَ تَدْعُونَ مِنْ دُونِ اللَّهِ لَنْ يَخْلُقُوا ذُبَاباً وَلَوِ اجْتَمَعُوا لَهُ وَإِنْ يَسْلُبْهُمُ الذُّبَابُ شَيْئاً لا يَسْتَنْقِذُوهُ مِنْهُ ضَعُفَ الطَّالِبُ وَالْمَطْلُوبُ مَا قَدَرُوا اللَّهَ حَقَّ قَدْرِهِ إِنَّ اللَّهَ لَقَوِيٌّ عَزِيزٌ} (الحج: ٧٣) .
٣ـ تربية العقل على التفكير الصحيح والقياس المنطقي السليم: {يَا أَيُّهَا الَّذِينَ آمَنُوا لا تُبْطِلُوا صَدَقَاتِكُمْ بِالْمَنِّ وَالْأَذَى كَالَّذِي يُنْفِقُ مَالَهُ رِئَاءَ النَّاسِ وَلا يُؤْمِنُ بِاللَّهِ وَالْيَوْمِ الْآخِرِ فَمَثَلُهُ كَمَثَلِ صَفْوَانٍ عَلَيْهِ تُرَابٌ فَأَصَابَهُ وَابِلٌ فَتَرَكَهُ صَلْداً} (البقرة:٢٦٤) .
من هنا فينبغي للمعلِّم أن يستعين بأسلوب ضرب المثل قال الماوردي: (من أعظم علم القرآن علم أمثاله والناس في غفلة عنه لاشتغالهم بالأمثال وإغفالهم الممثلات) (١) .
...
_________
(١) انظر السيوطي، الإتقان ج ٢ ص ١٦٧ ط عيسى الحلبي',NULL,'30',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (36,'الأجر، وعلى المدح والذم وعلى الثواب والعقاب وعلى تفخيم الأمر وتحقيره وعلى تحقيق أمر أو إبطاله قال تعالى: {وَضَرَبْنَا لَكُمُ الْأَمْثَالَ} إبراهيم: ٤٥)',NULL,'31',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (37,'<span data-type="title" id=toc-17>ثانياً: تقويم تعليم القرآن الكريم في وسائل الإعلام</span>
...
٣- عرض ما يحتاج إلى توضيح عن طريق الرسم مثل موضوع (مخارج الحروف) وهذا يتوفر في التلفاز والإنترنت.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (38,'٤- عقد اتصال هاتفي أو (فاكس) مباشرة لإزالة الأخطاء التي قد تشكل على المستمع أو المشاهد.
٥- ويجب على المعلم أن يكون صبوراً على معاناة التعليم ويقرب المعلومة إلى الذهن من أيسر طريق، ويكون ذا أداء حسنٍ يُرغب ولا يرهب ولا سيما إذا بدأ برنامجه بمثل هذه الأحاديث.
_________
(١) رواه مسلم ج ٤ ص ٢٠٧٤
(٢) رواه البخاري ج٤ ص ١٨٨٢ ومسلم ١/٥٤٩ والترمذي ٥/١٧١
(٣) رواه الترمذي ج ٥ ص ١٧٥',NULL,'33',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (39,'<span data-type="title" id=toc-19>الترغيب في حفظ القرآن ومذاكرته من السنة النبوية</span>
ونجد في السنة النبوية ما يرغب في حفظ القرآن.
١ـ روى مسلم أن النبي صلى الله عليه وسلم قال:"ما اجتمع قوم في بيت من بيوت الله يتلون كتاب الله ويتدارسونه بينهم إلا نزلت عليهم السكينة وغشيتهم الرحمة،وحفتهم الملائكة، وذكرهم الله فيمن عنده" (١)
٢- وروى الشيخان قال صلى الله عليه وسلم:"الذي يقرأ القرآن وهو ماهر به مع السفرة الكرام البررة، والذي يقرأ القرآن، وهو يتعتع فيه وهو عليه شاق له أجران" (٢)
٣-وروى الترمذي وقال حسن صحيح قال صلى الله عليه وسلم:"من قرأ حرفاً من كتاب الله تعالى فله به حسنة،والحسنة بعشر أمثالها،لا أقول الم حرف، ولكن ألف حرف، ولام حرف، وميم حرف" (٣)',NULL,'33',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (40,'٤- وقال صلى الله عليه وسلم: "لا حسد إلا في اثنتين: رجل آتاه الله القرآن وهو يقوم به آناء الليل وآناء النهار، ورجل آتاه الله مالاً فهو ينفقه آناء الليل وآناء النهار (١) " الشيخان
...
٦-وقال صلى الله عليه وسلم "خيركم من تعلم القرآن وعلمه" (٣) البخاري.
...
(٣) رواه البخاري ٤/١٩١٩',NULL,'34',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (41,'<span data-type="title" id=toc-20>الطريقة العملية للحفظ:</span>
كان الرسول صلى الله عليه وسلم يعلم الصحابة تعليماً عملياً فيردد الصحابي أمام الرسول بطريق الترديد والتسميع بقصد التصحيح.
وفي ذلك ورد حديث الدعاء قبل النوم عن البراء بن عازب قال النبي صلى الله عليه وسلم: "إذا أتيت مضجعك فتوضأ وضوءك للصلاة ثم اضطجع على شقك الأيمن ثم قل: اللهم أسلمت نفسي إليك ووجهت وجهي إليك، وفوضت أمري إليك، وألجأت ظهري إليك، رغبة ورهبة إليك لا ملجأ ولا منجى منك إلا إليك، آمنت بكتابك الذي أنزلت ونبيك الذي أرسلت.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (42,'فإن مت من ليلتك مت وأنت على الفطرة، واجعلهم آخر ما تتكلم به قال: فرددتهن لأستذكرهن فقلت آمنت برسولك الذي أرسلت.
قال: قل آمنت بنبيك الذي أرسلت" (١)
وأما تعليم القرآن فقد أشار إليه الصحابي الجليل جابر بن عبد الله في حديث تعلم الاستخارة قال: كان رسول الله صلى الله عليه وسلم يعلمنا الاستخارة في الأمور كلها كما يعلمنا السورة من القرآن يقول لهم:"إذا هم أحدكم بالأمر فليركع ركعتين من غير الفريضة ثم ليقل: اللهم إني أستخيرك بعلمك..." الخ (٢)
...
(٢) رواه البخاري ٥/٢٣٤٥',NULL,'35',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (43,'وقد اعتنى الصحابة الكرام بكتابة القرآن التي هي وسيلة للحفظ وعدم الاختلاف فكتبوه ونقشوه بمقدار ما سمحت لهم وسائل الكتابة وأدواتها في عصرهم.
...
ويصور لنا السيوطي في كتابه الإتقان (١) في علوم القرآن في النوع الرابع والثلاثين في (كيفية تحمله) أي القرآن قال: اعلم أن حفظ القرآن فرض عين على الأمة والمعنى فيه ألا ينقطع عدد التواتر فيه فلا يتطرق إليه التبديل والتحريف، وتعليمه أيضاً فرض كفاية وهو أفضل القرب.
...
(٢) شعور المتعلم بالمسؤولية عن صحة العمل. وهذا يجعل منهجية التربية الإسلامية منهجية حركية فكرية عاطفية مبنية على الوعي والدقة وصحة الأداء فالدقة في العواطف والاتجاهات والأفكار تتجلى في إخلاص النية وتوجيه العمل نحو إرضاء الله جل جلاله بلا رياء ولا استكبار ولا استهتار. تواكبها الدقة في حركية العمل أو لفظية القول
_________
(١) السيوطي، الإتقان ١/١٧١',NULL,'37',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (45,'كما نقله لنا الصحابة عن رسول الله صلى الله عليه وسلم ثم من بعدهم إلى يومنا هذا.
...
(٤) الكتاني، التراتيب الأدارية٢/٢٩٣',NULL,'38',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (46,'كثيرين حفظوا القرآن في سن مبكرة. ومن ذلك ما ذُكر من أن الشافعي حفظ القرآن وهو ابن سبع سنين (١) .
...
(٦) ابن حجر العسقلاني، الكاف الشاف في تخريج أحاديث الكشاف ص٣',NULL,'39',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (47,'ولذا فإن المادة الرئيسية لدى النشء هو حفظ القرآن مجوداً والذي كان يستطيع ختم القرآن في المدارس والكتاتيب بمنزلة (شتلات) صالحة تنتقل إلى أرض التعليم فيزكو نباتها.
...
(٤) ابن حجر العسقلاني، الدرر الكامنة في أعيان المائة الثامنة ترجمة رقم ٢٠٨٠.',NULL,'40',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (48,'جميع وجوه القراءات بحيث وصلت في الاستحضار إلى غاية لا يشاركها فيها أحد في وقتها (١) .
...
فابن مسعود:أحد كبار الصحابة وأعلام رواة القرآن وتجويده وتحقيقه وترتيله يقول: حفظت من في رسول الله ـ صلى الله عليه وسلم - بضعة وسبعين سورة. (٢)
وعن أنس بن مالك قال صلى الله عليه وسلم لأبيّ: "إن الله أمرني أن أقرأ عليك القرآن قال: الله سماني لك؟ قال:الله سماك لي فجعل أبي يبكي" (٣)
...
(٥) العسكري، شرح ما يقع فيه التصحيف والتحريف ص ١٠',NULL,'41',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (49,'فيه) وأبوه يسمع بدلاً من (لا ريب فيه) فقال له أبوه:دع المصحف وتلقن من أفواه الرجال (١) .
وسمع أعرابي رجلاً يقرأ (ولا تنكحوا المشركين حتى يؤمنوا) بفتح التاء فقال سبحان الله.هذا قبل الإسلام قبيح فكيف بعده؟ فقيل له إنه لحن وإنما القراءة (لا تُنكحوا) فقال قبحه الله إنه يحل ما حرم الله. (٢)
...
ولذا لم يكن غريباً أن يكون الاكتفاء بالأخذ من المصحف بدون مُوّقف أو معلم أمراً لا يجيزه المسلمون ولو كان المصحف مضبوطاً بل إنهم يعدون هذا الاكتفاء منافياً للدين لأنه ترك للواجب وارتكاب للمحرم. (٤)
...
(٤) علي الضباع بحث في التجويد بمجلة كنوز الفرقان عدد مايو١٩٥٠ص١٣',NULL,'42',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (50,'ويقول السيوطي: ولاشك أن الأمة – كما هم متعبدون بفهم معاني القرآن وإقامة حدوده – هم متعبدون بتصحيح ألفاظه وإقامة حروفه على الصفة المتلقاة من أئمة القراء المتصلة بالحضرة النبوية (١) . وقوله (على الصفة المتلقاة) لا يكفي الأخذ من المصحف بدون تلقٍ من أفواه المشايخ المتقنين.
وابن الجزري في تعريفه للمقرئ يقول: إنه العالم بالقراءات رواها مشافهة فلو حفظ التيسير مثلاً ليس له أن يقرئ بما فيه إن لم يشافهه مسلسلاً، لأن من القراءات أشياء لا تحكم إلا بالسماع والمشافهة (٢) .
_________
(١) الإتقان ١/١٠٠
(٢) منجد المقرئين ص٣',NULL,'43',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (51,'<span data-type="title" id=toc-21>ثالثاً: تقويم أساليب علوم القرآن في وسائل الإعلام</span>
...
أما الثاني فإذا رأى اختلاف العلماء ربما أثر ذلك تأثيراً سلبياً في فكره أو عقيدته ولذلك يقول عبد الله بن مسعود: "ما أنت بمحدث قوماً حديثاً لا تبلغه عقولهم إلا كان لبعضهم فتنة" (١) .
...
_________
(١) رواه مسلم في مقدمة الصحيح ص ١٠ وأخرجه ابن عبد البر في جامع بيان العلم وفضله ج ١ ص ١٣٤',NULL,'44',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (52,'يشتمل على أنواع علومه فاستخرت الله تعالى وله الحمد في وضع كتاب في ذلك جامع لما تكلم الناس في فنونه، وخاضوا في نكته وعيونه، وضمنته من المعاني الأنيقة والحكم الرشيقة ما بهر القلوب عجباً ليكون مفتاحاً لأبوابه عنواناً على كتابه، معيناً للمفسر على حقائقه،مطلعاً على بعض أسراره ودقائقه وسميته (البرهان في علوم القرآن) (١) ا. هـ‍ ويحوي سبعة وأربعين نوعاً من علوم القرآن.
٢- وعليه بنى الإمام السيوطي كتابه (الإتقان في علوم القرآن) إذ يقول في مقدمته ولما وقفت على هذا الكتاب ازددت به سروراً، وحمدت الله كثيراً، وقوي العزم على إبراز ما أضمرته ......الخ
...
_________
(١) الزركشي، البرهان في علوم القرآن (المقدمة) ط. التراث العربي بمصر',NULL,'45',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (53,'<span data-type="title" id=toc-23>فوائد معرفة أسباب النزول</span>
...
ولنبين لك ذلك بأمثلة ثلاثة: (الأول) قال تعالى في سورة البقرة: {وَلِلَّهِ الْمَشْرِقُ وَالْمَغْرِبُ فَأَيْنَمَا تُوَلُّوا فَثَمَّ وَجْهُ اللَّهِ إِنَّ اللَّهَ وَاسِعٌ عَلِيمٌ} (البقرة: ١١٥) فهذا اللفظ الكريم يدل بظاهره على أن للإنسان أن يصلى إلى أية جهة شاء، ولا يجب عليه أن يولي وجهه شطر البيت الحرام، لا في سفر ولا حضر. لكن إذا علم أن هذه الآية نازلة في نافلة السفر خاصة، أو فيمن صلى',NULL,'46',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (54,'باجتهاده ثم بان له خطؤه، تبين له أن الظاهر غير مراد، إنما المراد التخفيف على خصوص المسافر في صلاة النافلة أو على المجتهد في القبلة إذا صلى وتبين له خطؤه. عن ابن عمر رضى الله عنهما أن هذه الآية نزلت في صلاة المسافر على الراحلة أينما توجهت. وقيل: عميتُ القبلة على قوم فصلوا إلى أنحاء مختلفة، فلما أصبحوا تبينوا خطأهم فعذروا.وقيل في الآية غير ذلك، ولكن ما ذكرناه يكفيك.
(المثال الثاني) روى في الصحيح أن مروان بن الحكم أشكل عليه معنى قوله تعالى {لا تَحْسَبَنَّ الَّذِينَ يَفْرَحُونَ بِمَا أَتَوْا وَيُحِبُّونَ أَنْ يُحْمَدُوا بِمَا لَمْ يَفْعَلُوا فَلا تَحْسَبَنَّهُمْ بِمَفَازَةٍ مِنَ الْعَذَابِ وَلَهُمْ عَذَابٌ أَلِيمٌ} (آل عمران: ١٨٨)
...
أما عمومها فلأنها تنتظم الإنس والجن في كل عصر ومصر، وفي كل زمان ومكان.قال الله سبحانه: {وَأُوحِيَ إِلَيَّ هَذَا الْقُرْآنُ لِأُنْذِرَكُمْ بِهِ وَمَنْ بَلَغَ} (الأنعام: ١٩) وقال جلت حكمته: {وَهَذَا كِتَابٌ أَنْزَلْنَاهُ مُبَارَكٌ مُصَدِّقُ',NULL,'51',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (59,'الَّذِي بَيْنَ يَدَيْهِ وَلِتُنْذِرَ أُمَّ الْقُرَى وَمَنْ حَوْلَهَا} (الأنعام: ٩٢) ، وقال عز اسمه: {قُلْ يَا أَيُّهَا النَّاسُ إِنِّي رَسُولُ اللَّهِ إِلَيْكُمْ جَمِيعاً} (الأعراف: ١٥٨) وقال عمت رحمته: {وَإِذْ صَرَفْنَا إِلَيْكَ نَفَراً مِنَ الْجِنِّ يَسْتَمِعُونَ الْقُرْآنَ فَلَمَّا حَضَرُوهُ قَالُوا أَنْصِتُوا فَلَمَّا قُضِيَ وَلَّوْا إِلَى قَوْمِهِمْ مُنْذِرِينَ قَالُوا يَا قَوْمَنَا إِنَّا سَمِعْنَا كِتَاباً أُنْزِلَ مِنْ بَعْدِ مُوسَى مُصَدِّقاً لِمَا بَيْنَ يَدَيْهِ يَهْدِي إِلَى الْحَقِّ وَإِلَى طَرِيقٍ مُسْتَقِيمٍ يَا قَوْمَنَا أَجِيبُوا دَاعِيَ اللَّهِ وَآمِنُوا بِهِ يَغْفِرْ لَكُمْ مِنْ ذُنُوبِكُمْ وَيُجِرْكُمْ مِنْ عَذَابٍ أَلِيمٍ وَمَنْ لا يُجِبْ دَاعِيَ اللَّهِ فَلَيْسَ بِمُعْجِزٍ فِي الْأَرْضِ وَلَيْسَ لَهُ مِنْ دُونِهِ أَوْلِيَاءُ أُولَئِكَ فِي ضَلالٍ مُبِينٍ} (الأحقاف: ٢٩-٣٢) .
...
وقال جل جلاله {يَا أَيُّهَا النَّاسُ إِنَّا خَلَقْنَاكُمْ مِنْ ذَكَرٍ وَأُنْثَى وَجَعَلْنَاكُمْ شُعُوباً وَقَبَائِلَ لِتَعَارَفُوا إِنَّ أَكْرَمَكُمْ عِنْدَ اللَّهِ أَتْقَاكُمْ إِنَّ اللَّهَ عَلِيمٌ خَبِيرٌ} (الحجرات: ١٣) وقال عز من قائل {يَا أَيُّهَا الَّذِينَ آمَنُوا كُلُوا مِنْ طَيِّبَاتِ مَا رَزَقْنَاكُمْ وَاشْكُرُوا لِلَّهِ إِنْ كُنْتُمْ إِيَّاهُ تَعْبُدُونَ} (البقرة: ١٧٢) وقال تعالت حكمته {فَإِذَا قُضِيَتِ الصَّلاةُ فَانْتَشِرُوا فِي الْأَرْضِ وَابْتَغُوا مِنْ فَضْلِ اللَّهِ وَاذْكُرُوا اللَّهَ كَثِيراً لَعَلَّكُمْ تُفْلِحُونَ} (الجمعة: ١٠) .
إلى غير ذلك من آيات. كثيرة.',NULL,'52',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (60,'وأما وضوح هذه الهداية: فلعرضها عرضا رائعا مؤثراً توافرت فيه كل وسائل الإيضاح وعوامل الإقناع: أسلوب فذ معجز في بلاغته وبيانه. واستدلال بسيط عميق يستمد بساطته من كتاب الكون الناطق وأمثال خلابة تخرج أدق المعقولات في صورة أجلى الملموسات. وحكم بالغات تبهر الألباب بمحاسن الإسلام وجلال التشريع. وقصص حكيم مختار يقوي الإيمان واليقين ويهذب النفوس والغرائز ويصقل الأفكار والعواطف، ويدفع الإنسان دفعا إلى التضحية والنهضة ويصور له مستقبل الأبرار والفجار، تصويراً يجعله كأنه حاضر تراه الأبصار في رابعة النهار، والأمثلة على ذلك كثيرة في القرآن، يخرجنا استعراضها عما نحن بسبيله الآن.
...
ومنها: استفادة أن الاستعانة في أي شيء لا تستمد إلا من اسم الله وحده، أخذا من إضافة الاسم إلى لفظ الجلالة موصوفا بالرحمن الرحيم، ومن القصر المفهوم من البسملة على تقدير عامل الجار والمجرور متأخراً، ومن تقدير هذا العامل عاما لا خاصا.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (61,'ومنها: استفادة الاستدلال على أن الحمد مستحق لله بأمور ثلاثة: تربيته تعالى للعوالم كلها، ورحمته الواسعة التي ظهرت آثارها وتأصل اتصافه تعالى بها، وتصرفه وحده بالجزاء العادل في يوم الجزاء. وذلك أخذاً من جريان هذه الأوصاف على اسم الجلالة في مقام حمده بقوله سبحانه: {الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ. الرَّحْمَنِ الرَّحِيمِ مَالِكِ يَوْمِ الدِّينِ}
...
فحسبنا في هذا الموضوع بيان دلالة نظم القرآن الكريم باعتباردلالة معانيه الثانوية على هدايات متنوعة من عقائد وأحكام وآداب وأدلة ولطائف،',NULL,'54',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (62,'دقيقة الطرق، لطيفة المسالك. ومن شأن القرآن الكريم على هداياته باعتبار معانيه الأصلية فإنها واضحة قل أن يقع فيها تفاوت أو خلاف، لأن هذه المعاني – كما قررنا يستوي فيها العربي والعجمي، والحضري والبدوي.
إعجاز القرآن:
...
المقصد الثالث من نزول القرآن أن يتعبد الله خلقه بتلاوته، ويقربهم إليه ويأجرهم على مجرد ترديد لفظه ولو من غير فهمه، فإذا ضموا إلى التلاوة فهما زادوا أجر على أجراً، قال الله تعالى: {إِنَّ الَّذِينَ يَتْلُونَ كِتَابَ اللَّهِ',NULL,'55',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (63,'وَأَقَامُوا الصَّلاةَ وَأَنْفَقُوا مِمَّا رَزَقْنَاهُمْ سِرّاً وَعَلانِيَةً يَرْجُونَ تِجَارَةً لَنْ تَبُورَ لِيُوَفِّيَهُمْ أُجُورَهُمْ وَيَزِيدَهُمْ مِنْ فَضْلِهِ إِنَّهُ غَفُورٌ شَكُورٌ} (فاطر:٢٩،٣٠) .
...
أما أول طبعة لهذه الترجمة فقد صدرت في عام ١٩٣٥ م (١٣٥٤ هـ‍) ، ثم تولى طبعها الأستاذ خليل الرواف في أمريكا عام ١٩٤٦م – ١٣٦٦ هـ‍ تخليداً لذكرى وصول الوفد السعودي إلى أمريكا، ثم طبعتها الرابطة في عام ١٩٦٣م (١٣٨٣ هـ‍) .',NULL,'56',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (64,'<span data-type="title" id=toc-26>(ب) – القرآن الكريم يوافق العلم ولا يعارضه</span>
إذا تكلم القرآن على شيء من فنون الطب والصناعة والزراعة فإنما يريد أن يوجه الإنسان إلى الإيمان بوجود خالق مبدع لكل الكائنات وإلى ما فيها من خواص طبيعية وقوانين علمية وترتيبات سببية ويريد أن يحيا معها ضمن عقيدة سليمة وتفكير قويم وأن يستخدمها في أسلوب صحيح وأخلاق سامية.',NULL,'56',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (65,'وهذه آيات قرآنية لها مساس بعلم الطب، تضيء الإيمان في جنبات النفس فيستنير الفكر بإشاعات اليقين بالخالق المبدع جل في علاه.وهي في ذاته الوقت توضح الحقائق التي توصل إليها العلم الحديث وذلك يبث في أعماق النفوس معجزة القرآن المتفجرة في كل آن الخالدة على مر الزمان فكما أن العصر الأول وجد فيه البلاغة في صدق دعواه فإن الناس اليوم يجدون فيه سلسلة لا نهاية لها من الإعجاز سواء في النظام الاجتماعي أو السياسي أو الاقتصادي أو منهجه التربوي والخلقي أو في إشاراته العلمية للكون والخالق مع التنبيه على أن القرآن لم يكن كتاباً في الطب أو في أي فرع من العلوم وإنما هو منهج هداية ضرب الله فيه للإنسان من كل شيء {وَلَقَدْ صَرَّفْنَا فِي هَذَا الْقُرْآنِ لِلنَّاسِ مِنْ كُلِّ مَثَلٍ} (الكهف: ٥٤)
...
قال تعالى في سورة نوح {مَا لَكُمْ لا تَرْجُونَ لِلَّهِ وَقَاراً وَقَدْ خَلَقَكُمْ أَطْوَاراً} (نوح: ١٣-١٤) . يبين تبارك وتعالى أن تخلق الإنسان إنما يتم على أطوار متتالية، ثم يشير في سورة المؤمنين إلى أهم هذه الأطوار حيث يقول: {وَلَقَدْ خَلَقْنَا الْأِنْسَانَ مِنْ سُلالَةٍ مِنْ طِينٍ ثُمَّ جَعَلْنَاهُ نُطْفَةً فِي قَرَارٍ مَكِينٍ ثُمَّ خَلَقْنَا النُّطْفَةَ عَلَقَةً فَخَلَقْنَا الْعَلَقَةَ مُضْغَةً فَخَلَقْنَا الْمُضْغَةَ عِظَاماً فَكَسَوْنَا الْعِظَامَ لَحْماً ثُمَّ أَنْشَأْنَاهُ خَلْقاً آخَرَ فَتَبَارَكَ اللَّهُ أَحْسَنُ الْخَالِقِينَ} (المؤمنون:١٥:١٢) .
...
_________
(١) مع الطب في القرآن الكريم للدكتور / عبد الحميد دياب، د/ أحمد قرقوز مؤسسة علوم القرآن دمشق ص ٨٠ وما بعدها.',NULL,'58',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (67,'خَصَّه هو بهذه الآيات،وإن كانت قد نزلت منذ أربعة عشر قرناً من الزمان، لأنها تخاطبه باللغة التي يتباهى بها اليوم!!
...
وبشكل عام فإن أهم ما يطرأ على الجنين بعد الشهر الثالث هو: الحركة، ونبضان القلب واستقلاله، وتسعى الأجهزة التي تشكلت نحو التكامل، حتى إن بعض الأجهزة تبدأ عملها أثناء الحياة الجنينية، كالقلب وجهاز الهضم، ويقوم نقي العظام بتكوين عناصر الدم ....',NULL,'62',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (71,'وبشكل عام فإن أهم ما يطرأ على الجنين بعد الشهر الثالث هو: الحركة، ونبضات القلب واستقلال فراز المشيمة الغدي، والنمو المتسارع في حجم الجنين وتكامل شكله الخارجي.
...
أما نمو الجنين فيكون سريعاً في هذه المرحلة، فبعد أن كان وزنه في نهاية الشهر الثالث (٥٥) غ، وطوله (١٠) سم، يصبح وزنه عند تمام الحمل حوالي (٣٢٥٠) غ، وطوله (٥٠) سم وخلال هذه الفترة، يتكامل شكله الخارجي، فيصبح لون الجلد أحمر، وتنبسط تجعداته، وتسقط عنه الأوبار، وتنفتح الجفون، وتتكامل الأظافر ....
وبهذا الاستعراض السريع لأهم ميزات هذه المرحلة نجد أن تلك المضغة قد أخذت بعداً آخر، اكتسبت فيه قدرة على الحركة، وابتدأ بها القلب',NULL,'63',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (72,'بالنبضان بلا توقف، ولهذا أشار القرآن بعد عرضه لسلسلة أطوار تخلق الجنين، حيث قال: {ثُمَّ أَنْشَأْنَاهُ خَلْقاً آخَرَ} . ولعل أكثر الناس شعوراً بهذا البعد ليس الطبيب وإنما الأم الحامل التي ما إن تشعر بحركات جنينها حتى تحس بشيء لم تعهده من قبل،إنها تحس أن روحاً أخرى تدب في أعماقها، فتظهر علامات الارتياح على ملامحها، وتعلو البسمة محياها،وإذا ما غابت عنها تلك الحركات مدة بسيطة، قلقت وتأرقت.
...
وبعد أن وقفنا على أطوار خلقنا البديعة المدهشة، هل لنا أن نقدر الله حق قدره؟، هل لنا أن نرجو لله وقاراً؟ .... {مَا لَكُمْ لا تَرْجُونَ لِلَّهِ وَقَاراً وَقَدْ خَلَقَكُمْ أَطْوَاراً} (نوح:١٣-١٤)
ـ تشخيص الحمل اليقيني والعدة:
إن الشعور بحركة الجنين، وسماع نبضات القلب،هما العلامتان اليقينيتان لتشخيص الحمل، وكل العلامات التي تسبقها كانقطاع الطمث، وأعراض الوحام، وحتى إيجابية تفاعل الحمل الحيوي، لا تعد علامات يقينية نستطيع',NULL,'64',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (73,'على أساسها القطع بحصول الحمل، فهناك حالات مرضية، يمكن أن تعطي نفس الأعراض، كالرحى العدارية، والورم الكوريوني البشري، والحمل الهستريائي.
...
٣ـ الوعي بأن إعمار الأرض يعد مسؤولية دينية تحقق إرادة الله الذي أمرنا بذلك في قوله {هُوَ الَّذِي جَعَلَكُمْ خَلائِفَ فِي الْأَرْضِ}
لنعلم من ذلك أن الحضارة فريضة إسلامية.
٤- تغليب المصلحة العامة للمسلمين على المصالح الذاتية للأفراد والجماعات والتنسيق والتكامل والتعاون في جميع المجالات.',NULL,'67',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (76,'٥- التسلح بثقافة رشيدة من شأنها تدفع المسلمين إلى العمل وإتقانه وإلى الإنتاج وتجويده، وإلى تحويل الطاقات المعطلة في بلاد العالم الإسلامي إلى طاقات فعالة تبني وتعمر، وتنشر الخير في كل مكان.',NULL,'68',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (77,'<span data-type="title" id=toc-28>مصادر ومراجع</span>
...
المراجع:
...
- سنن أبي داوود، دار الفكر بيروت مراجعة محمد محيي الدين عبد الحميد',NULL,'69',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (78,'- سنن الترمذي،دار إحياء التراث العربي بيروت مراجعة أحمد محمد شاكر وآخرون
- شرح ما يقع فيه التصحيف والتحريف للعسكري
- صحيح البخاري،دار ابن كثير ـ بيروت ١٤٠٧هـ‍ مراجعة مصطفى ديب البغا
...
- المجتبي للنسائي: مكتب المطبوعات الإسلامية حلب ـ ١٤٠٦ هـ‍ مراجعة عبد الفتاح أبو غدة.
- مجلة سعودي شوبر العدد الخامس السنة الثانية يناير ٢٠٠٠م
- المحاسن والمساوي،للبيهقي
- محاضرات الأدباء،للأصفهاني
- المربي والتربية الإسلامية ا. د/محمد أحمد عبد الهادي دار البيان العربي ـ جده ١٤٠٤هـ‍',NULL,'70',NULL,NULL,'0');
INSERT INTO [b11101] VALUES (79,'- مستدرك الحاكم، دار الكتب العلمية ـ بيروت ١٤١١هـ‍ مراجعة مصطفى عبد القادر عطا
...
-النظرية الإسلامية في الإعلام والعلاقات الإنسانية ا/زين الدين الركابي بحث منشور مقدم للندوة العالمية للشباب الإسلامي المنعقدة بالرياض ١٣٩٦هـ‍',NULL,'71',NULL,NULL,'0');
