...
CREATE TABLE "b9827"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b9827
INSERT INTO [b9827] VALUES (1,'مختصر
...
(وقف لله تعالى)
الطبعة العاشرة
١٤١٠هـ - ١٩٩٠م',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b9827] VALUES (2,'بسم الله الرحمن الرحيم
...
وبعد فبما أن الأسئلة والأجوبة الأصولية مبسطة جامع لأصول كثيرة وقد طلب مني بعض الإخوان اختصارها ونظراً إلى ضعف الهمم وتزاحم الدروس على الطلاب وقد كان عندنا الأساس الأول مختصراً فعزمت على التسبب في طبعه راجياً من الله الحي القيوم العلي العظيم بديع السموات والأرض أن يجعله خالصاً لوجهه الكريم وأن ينفع به من قرأه ومن سمعه وأن يأجر من تسبب في نشره وبثه إنه جواد كريم رؤوف رحيم وصلى الله على محمد وآله وصحبه أجمعين.
عبد العزيز المحمد السلمان
المدرس في معهد
إمام الدعوة بالرياض',NULL,'4',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (3,'بسم الله الرحمن الرحيم

<span data-type="title" id=toc-1>مؤلف العقيدة</span>
...
وصلى الله على محمد وآله وصحبه أجمعين.؟',NULL,'6',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (5,'بسم الله الرحمن الرحيم

<span data-type="title" id=toc-3>س١- ما هو معنى الحمد وما معنى لفظ الجلالة</span>؟
...
<span data-type="title" id=toc-4>س٢- من هو الرسول ومن هو النبي؟ وهل كل رسول نبي</span>؟
...
<span data-type="title" id=toc-8>س٦- بأي شيء تكون معرفة الإنسان لدينه</span>؟
...
<span data-type="title" id=toc-10>س٩- كم شروط لا إله إلا الله وما هي وما الذي ينافيها</span>؟
...
س١٠- هل يكتفي بالنطق بالشهادة أم لابد من العلم بمعناها',NULL,'9',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (8,'والعمل بمقتضاها؟
...
<span data-type="title" id=toc-11>س١١- ما معنى شهادة أن محمداً رسول الله</span>؟
...
<span data-type="title" id=toc-14>س١٤- ما حد التوحيد اذكره بوضوح</span>؟
...
<span data-type="title" id=toc-15>س١٥- ما هي أقسام التوحيد عند من يجعلها ثلاثة أقسام</span>؟
ج- توحيد الربوبية وتوحيد الأسماء والصفات وتوحيد الألوهية.

<span data-type="title" id=toc-16>س١٦- ما هو توحيد الربوبية</span>؟
ج- هو اعتقاد العبد أن الله هو الرب المتفرد بالخلق والرزق',NULL,'11',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (10,'مربي جميع الخلق بالنعم ومربي خواص خلقه وهم الأنبياء بالعقائد الصحيحة والأخلاق الجميلة والعلوم النافعة والأعمال

<span data-type="title" id=toc-17>س١٧- ما هو توحيد الأسماء والصفات</span>؟
...
<span data-type="title" id=toc-18>س١٨- ما هو توحيد الألوهية</span>؟
...
<span data-type="title" id=toc-19>س١٩- هل للتوحيد تقسيم ثان غير ما ذكر</span>؟
...
الثاني: الفعلي وهو المسمى بتوحيد الألوهية وسمي فعلياً لأنه متضمن لأفعال القلوب والجوارح',NULL,'12',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (11,'كالصلاة والزكاة والحج ونحو ذلك.

<span data-type="title" id=toc-20>س٢٠- ما هي أقسام التوحيد القولي</span>؟
...
<span data-type="title" id=toc-21>س٢١- ما ينزه عنه الله ينقسم إلى قسمين متصل ومنفصل، أذكر مثالاً لكل قسم والضابط لكل قسم</span>؟
...
<span data-type="title" id=toc-22>س٢٢- أي أقسام التوحيد الذي جاءت به الرسل وأنزلت به الكتب وضحه مع ذكر دليله</span>؟
ج- هو توحيد الألوهية قال تعالى: (ولقد بعثنا في كل أمة رسولاً',NULL,'13',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (12,'أن اعبدوا الله) وقال تعالى (ولقد أرسلنا نوحاً إلى قومه فقال يا قوم اعبدوا الله) تعالى: (وإلى عاد أخاهم هوداً قال يا قوم اعبدوا الله) وقال: (وإلى ثمود أخاهم صالحاً قال يا قوم اعبدوا الله) وقال: (وإلى مدين أخاهم شعيباً قال يا قوم اعبدوا الله) وقال: (وإبراهيم إذ قال لقومه اعبدوا الله واتقوه) وقال يوسف: (إن الحكم إلا لله أمر ألا تعبدوا إلا إياه) الآية.

<span data-type="title" id=toc-23>س٢٣- ما أركان توحيد الألوهية؟ تكلم عنها بوضوح</span>.
ج- اثنان، الصدق والإخلاص، فالأول توحيد المراد فلا يزاحمه مراد، والثاني توحيد الإرادة ببذل الجهد والطاقة في عبادته وحده.

<span data-type="title" id=toc-24>س٢٤- ما ضد هذا القسم الذي هو توحيد العبادة</span>؟
ج- ضده أمران أولاً الإعراض عن محبته والإنابة إليه والتوكل عليه ثانياً الإشراك به واتخاذ أولياء شفعاء من دونه.

<span data-type="title" id=toc-25>س٢٥- ما ضد توحيد الربوبية</span>؟
ج- أن يجعل لغيره معه تدبيراً فالربوبية منه لعباده والتأله من عباده له.

<span data-type="title" id=toc-26>س٢٦- ما ضد توحيد الأسماء والصفات</span>؟
ج- أمران: التعطيل والتشبيه، فمن نفى صفاته تعالى وعطلها',NULL,'14',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (13,'ناقض تعطيله توحيده وكذّبه ومن شبهه بخلقه ناقض تشبيهه توحيده وكذبه.

<span data-type="title" id=toc-27>س٢٧- ما معنى الصلاة على النبي صلى الله عليه وسلم ومن هم آل النبي صلى الله عليه وسلم ومن هو الصحابي</span>؟
...
<span data-type="title" id=toc-28>س٢٨- ما معنى كلمة أما بعد ولأي شيء يؤتى بها وإلى أي شيء أشار المنصف بقوله هذا أعقاد الفرقة الناجية</span>؟
...
<span data-type="title" id=toc-29>س٢٩- ما معنى الاعتقاد ومن هي الفرقة الناجية</span>؟
ج- هو مصدر اعتقد وهو يطلق على التصديق مطلقاً وعلى ما يعتقده الإنسان من أمور الدين والفرقة الناجية هم أهل السنة والجماعة.

<span data-type="title" id=toc-30>س٣٠- من أين أخذ وصفها بأنها ناجية وضح ذلك</span>؟',NULL,'15',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (14,'ج- من قوله صلى الله عليه وسلم "ستفترق هذه الأمة إلى ثلاث وسبعين فرقة كلهم في النار إلا واحدة" ومن قوله: "لا تزال طائفة من أمتي على الحق منصورة لا يضرهم من خذلهم ولا من خالفهم حتى تقوم الساعة".

<span data-type="title" id=toc-31>س٣١- ما هي السنة ومن هم أهلها ولم نُسبوا إليها</span>؟
...
<span data-type="title" id=toc-33>س٣٢- ما هو الإيمان بالله الذي هو الركن الأول من الإيمان</span>؟
...
<span data-type="title" id=toc-34>س٣٣- ما هو الإيمان بالملائكة الذي هو الركن الثاني من أركان الإيمان</span>؟',NULL,'16',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (15,'ج- هو التصديق الجازم بأن لله ملائكة موجودون مخلوقون من نور وإنهم كما وصفهم الله عباد مكرمون يسبحون الليل لا يفترون وأنهم لا يعصون الله ما أمرهم ويفعلون ما يؤمرون وأنهم قائمون بوظائفهم التي أمرهم الله بالقيام بها.

<span data-type="title" id=toc-35>س٣٤- هل يكفي الإيمان إجمالاً بالملائكة</span>؟
...
<span data-type="title" id=toc-36>س٣٥- ما هو الإيمان بكتب الله الذي هو الركن الثالث من أركان الإيمان</span>؟
ج- هو التصديق الجازم بأن لله كتباً أنزلها على أنبيائه ورسله وهي من كلامه حقيقة وأنها نور وهدى وأن ما تضمنته حق ولا يعلم عددها إلا الله وأنه يجب الإيمان بها جملة إلا ما سمى الله منها وهي التوراة والإنجيل والزبور والقرآن فيجب الإيمان بها على التفصيل ويجب مع الإيمان بالقرآن وأنه منزل من عند الله الإيمان بأن الله تكلم به حقيقة كما تكلم بالكتب المنزلة على أنبيائه وأنه المخصوص',NULL,'17',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (16,'بمزية الحفظ من التبديل والتغيير قال تعالى: (إنا نحن نزلنا الذكر وإنا له لحافظون) وقال (لا يأتيه الباطل من بين يديه ولا من خلفه تنزيل من حكيم حميد)

(الإيمان برسل الله)

<span data-type="title" id=toc-37>س٣٦- ما هو الإيمان برسل الله الذي هو الركن الرابع من أركان الإيمان</span>؟
...
<span data-type="title" id=toc-38>س٣٧- كم عدد المذكورين من الأنبياء والرسل في القرآن ومن هم اذكرهم بوضوح</span>؟
ج- عددهم خمس وعشرون وهم: آدم، إدريس، نوح، هود، صالح، إبراهيم، لوط، يونس، إسماعيل، إسحاق، يعقوب، يوسف،',NULL,'18',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (17,'أيوب، شعيب، موسى، هرون، اليسع، ذو الكفل، داود، زكريا، سليمان، الياس، يحيى، عيسى، محمد صلوات الله وسلامه عليهم أجمعين.

<span data-type="title" id=toc-39>س٣٨- ما موضوع رسالة الرسل وما الحكمة فيها؟ وما الدليل عليها</span>؟
...
<span data-type="title" id=toc-40>س٣٩- من هم أولوا العزم من الرسل وأين ذكروا</span>؟
...
<span data-type="title" id=toc-44>س٤٣- ما هو البعث وما دليله وما حكم الإيمان به</span>؟
ج- هو لغة التحريك والإثارة وشرعاً إعادة الأبدان وإدخال الأرواح فيها قال تعالى (ونفخ في الصور فإذا هم من الأجداث إلى ربهم ينسلون) وقال (ثم نفخ فيه أخرى فإذا هم قيام ينظرون) وقال (فإنما هي زجرة واحدة فإذا هم بالساهرة، يوم يخرجون من الأجداث سراعاً كأنهم إلى نصب يوفضون) فقيام الناس لرب العالمين حق ثابت يجب الإيمان به.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (20,'<span data-type="title" id=toc-45>س٤٤- ما حكم إنكاره وما دليل الحكم</span>؟
...
<span data-type="title" id=toc-46>س٤٠- ما هو الإيمان بالقدر اذكره بوضوح</span>؟
ج- هو التصديق الجازم بأن كل خير وشر فهو بقضاء الله وقدره وأنه الفعال لما يريد لا يكون شيء إلا بإرادته ولا يخرج شيء عن مشيئته وليس في العالم شيء يخرج عن تقديره ولا يصدر إلا عن تدبيره',NULL,'22',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (21,'ولا محيد لأحد عن القدر والمقدور ولا يتجاوز ما خط في اللوح المسطور وأنه خالق أفعال العباد والطاعات والمعاصي ومع ذلك فقد أمر العباد ونهاهم وجعلهم مختارين لأفعالهم غير مجبورين عليها بل هي واقعة بحسب قدرتهم وإرادتهم والله خالقهم وخالق قدرتهم يهدي من يشاء برحمته ويضل من يشاء بحكمته لا يسأل عما يفعل وهم يسألون.

<span data-type="title" id=toc-48>س٤٦- بم يوصف الله عز وجل</span>؟
...
<span data-type="title" id=toc-50>س٤٨- ما هو التعطيل وما الفرق بينه وبين التحريف</span>؟
...
<span data-type="title" id=toc-53>س٥١- بين ما هو التكييف وما هو التمثيل وبين ما فيه من تقاسيم وأمثلة</span>؟
ج- التكييف هو تعيين كنه الصفة يقال كيف الشيء أي جعل له كيفية معلومة وأما التمثيل فهو التشبيه والتشبيه ينقسم إلى قسمين أولاً تشبيه المخلوق بالخالق كتشبيه النصارى المسيح ابن مريم بالله قال تعالى (لقد كفر الذين قالوا إن الله هو المسيح ابن مريم) وكتشبيه اليهود عزيراً بالله وكتشبيه المشركين أصنامهم بالله والقسم الثاني تشبيه الخالق بالمخلوق وذلك كتشبيه المشبهة الذين يقولون له وجه كوجه المخلوق ويد كيد المخلوق وسمع كسمع المخلوق ونحو ذلك تعالى الله عن قولهم علواً كبيراً.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (24,'<span data-type="title" id=toc-54>س٥٢- بين ما تفهمه من معنى قوله تعالى ليس كمثله شيء وهو السميع البصير</span>؟
...
<span data-type="title" id=toc-55>الأسماء الحسنى</span>
<span data-type="title" id=toc-56>س٥٣- ما مثال الأسماء الحسنى</span>؟
...
<span data-type="title" id=toc-57>س٥٤- لم كانت أسماء الله حسنى وهل هي من قبيل المحكم. وهل الوصفية فيها تنافي العلمية. وضح ذلك</span>؟
ج- لدلالتها على أحسن مسمى وأشرف مدلول وأسماؤه سبحانه أعلام وأوصاف الوصفية لا تنافي العلمية بخلاف أوصاف العباد وكل',NULL,'26',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (25,'أسمائه تعالى دالة على معانيها وكلها أوصاف مدح وحمد وثناء وهي من قبيل المحكم لأن معانيها واضحة في لغة العرب إنما الكنه والكيفية من ما استأثر الله بعلمه.

<span data-type="title" id=toc-58>س٥٥- ما هي أركان الإيمان بالأسماء الحسنى ومثل لذلك</span>؟
...
<span data-type="title" id=toc-59>س٥٦- هل أسماء الله توقيفية وإذا كانت توقيفية فما معنى ذلك</span>؟
...
<span data-type="title" id=toc-60>س٥٧- ما هي أنواع دلالة الأسماء الحسنى وضح ذلك بالأمثلة</span>؟
ج- ثلاثة أنواع دلالة مطابقة إذا فسرنا الاسم بجميع مدلوله ودلالة تضمن إذا فسرناه ببعض مدلوله ودلالة التزام إذا استدللنا به على غيره من الأسماء التي يتوقف هذا الاسم عليها فمثلاً لفظة الرحمن على الرحمة والذات دلالة مطابقة وعلى إحداهما دلالة تضمن داخلة في',NULL,'27',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (26,'الضمن ودلالته على الأسماء التي لا توجد الرحمة إلا بثبوتها كالحياة والعلم والقدرة ونحوها دلالة التزام.

<span data-type="title" id=toc-61>س٥٨- هل أسماء الله من قبيل المترادف أم من قبيل المتباين. وضح ذلك</span>؟
ج- هي بالنظر إلى الذات من قبيل المترادف لدلالتها على مسمى واحد وبالنظر إلى الصفات من قبيل المتباين لأن كل صفة غير الأخرى.

<span data-type="title" id=toc-62>س٥٩- هل أسماء الله محصورة بعدد معروف وهل في الحديث إفادة لحصرها</span>؟
...
<span data-type="title" id=toc-63>س٦٠- ما مراتب إحصاء أسماء الله التي من أحصاها دخل الجنة</span>؟
ج- ثلاثة حفظها وفهمها ودعاء الله بها دعاء عبادة ودعاء مسألة.

<span data-type="title" id=toc-64>س٦١- لم كان إحصاء أسماء الله الحسنى والعلم بها أصل للعلم بكل معلوم</span>؟
ج- لأن المعلومات القدرية والشرعية صادرة عن أسماء الله وصفاته ولهذا كانت في غاية الإحكام والإتقان والصلاح والنفع.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (27,'<span data-type="title" id=toc-65>س٦٢- ما هو الاسم الذي ينبغي لمن دعا الله بأسمائه الحسنى أن يدعو الله به</span>؟
...
<span data-type="title" id=toc-66>س٦٣- إذا كان الاسم منقسم إلى مدح وذم فهل يدخل في أسماء الله تعالى؟ وما مثال ذلك</span>.
...
<span data-type="title" id=toc-67>س٦٤- هل يلزم من اتحاد الإسمين تماثل مسماها؟ وضح ذلك بالأمثلة</span>.
ج- لا يلزم ذلك فإن الله سمى نفسه بأسماء تُسمى بها بعض خلقه وكذلك وصف نفسه بصفات وصف بها بعض خلقه فلا يلزم في ذلك التشبيه فقد وصف نفسه بالسمع والبصر والعلم والقدرة، ووصف بذلك بعض خلقه فليس السميع كالسميع ولا البصير كالبصير',NULL,'29',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (28,'فصفات كل موصوف تناسب ذاته وتليق به ولا مناسبة بين الخالق والمخلوق.

<span data-type="title" id=toc-68>س٦٥- ما مثال أسماء الله المزدوجة المتقابلة التي لا يطلق واحد منها بمفرده على الله إلا مقروناً بالاسم الآخر وما المحذور من إفرادها؟ وضح ذلك</span>.
...
<span data-type="title" id=toc-69>س٦٦- إلى كم تنقسم صفات الله ووضح كل قسم منها بما يميزه عن الآخر</span>؟
ج- إلى قسمين صفات ذات وهي التي لا تنفك عن الله وصفات فعل وهي التي تتعلق بالمشيئة والقدرة.

<span data-type="title" id=toc-70>س٦٧- ما مثال الصفات الذاتية والصفات الفعلية</span>؟
ج- مثال صفات الذات العلم والحياة والقدرة والسمع والبصر والوجه واليد والرجل والملك والعظمة والكبرياء والعزة والعلو والإصبع والقدم والغنى والرحمة والكلام.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (29,'وأما الصفات الفعلية كالاستواء والنزول والمجيء والضحك والرضى والعجب والسخط والإتيان والإحياء والإماتة والفرح والغضب والكره والحب فهذه يقال لها قديمة النوع حادثة الآحاد.

<span data-type="title" id=toc-71>س٦٨- هل القول في الصفات يخالف القول بالذات</span>؟
...
<span data-type="title" id=toc-72>الأقسام الممكنة في آيات الصفات وأحاديثها</span>
<span data-type="title" id=toc-73>س٦٩- ما هي الأقسام الممكنة في آيات الصفات وأحاديثها</span>؟
ج- هي ستة أقسام: قسمان يقولون تجري على ظاهرها، فقسم قالوا تجري على ظاهرها اللائق بالله من غير تشبيه، وهؤلاء هم السلف الصالح والقسم الثاني المشبهة الذين غلوا في الإثبات وقالوا تجعل كصفات المخلوقين ومذهبهم باطل أنكره السلف، وقسمان ينفيان ظاهرها وهم الجهمية ومن تفرع عنهم فقسم منهم يؤولونها بمعان أخر، وقسم منهم يقولون الله أعلم بما أراد منها، وقسمان واقفان فقسم يقولون يجوز أن يكون المراد اللائق بالله ويجوز أن لا يكون المراد صفة وهذه طريقة كثير من الفقهاء، وغيرهم وقسم يمسكون عن هذا كله ولا يزيدون على تلاوة القرآن وقراءة الحديث معرضين بقلوبهم وألسنتهم عن هذه التقديرات والصواب في آيات الصفات وأحاديثها القطع بالطريقة السلفية.',NULL,'31',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (30,'<span data-type="title" id=toc-74>الواجب في آيات الصفات وأحاديثها</span>
<span data-type="title" id=toc-75>س٧٠- ما الواجب في آيات الصفات وأحاديثها</span>؟
...
<span data-type="title" id=toc-76>تعريف الإلحاد في الأسماء والصفات</span>
<span data-type="title" id=toc-77>س٧١- ما هو الإلحاد في أسماء الله وصفاته وما هي أقسامه</span>؟
...
خامساً، تشبيه صفاته بصفات خلقه فجمعهم الإلحاد وتفرقت بهم طرقه.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (31,'<span data-type="title" id=toc-78>حكم استعمال الأقيسة في جانب الله</span>
<span data-type="title" id=toc-79>س٧٢- هل يجوز استعمال شيء من الأقيسة في جانب الله عز وجل</span>؟
...
<span data-type="title" id=toc-80>صفة العزة</span>
<span data-type="title" id=toc-81>س٧٣- ما الذي تفهم عن معنى قوله: (سبحان ربك رب العزة عما يصفون وسلام على المرسلين والحمد لله رب العالمين) ولم ساقها المصنف</span>؟
ج- أما سياق المصنف لها في هذا الموضع ففيما يظهر أنه تعليل لما تقدم من كون كلام الله وكلام رسوله صلى الله عليه وسلم أكمل صدقاً وأتم بياناً ونصحاً وأبعد عن العيوب والآفات من كلام كل أحد وأما ما يؤخذ منها فهي أولاً تتضمن تنزيه الله وتقديسه وتبرئته عما يقول الظالمون، ثانياً صحة ما جاء به المرسلون وأنه الحق الذي لا مرية فيه، ثالثاً',NULL,'33',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (32,'إثبات صفة الربوبية، رابعاً إثبات صفة العزة وهي بأقسامها الثلاثة ثابتة له سبحانه عزة القوة وعزة الامتناع وعزة القهر ولما كان التسبيح يتضمن التنزيه من النقص والتبرئة منه بدلالة المطابقة ويستلزم إثبات الكمال كما أن الحمد يدل على إثبات صفات الكمال بالمطابقة ويستلزم التنزيه من النقص قرن بينهما في هذا الموضع وفي هذه الآية إثبات صفة الكلام والرد على المخالفين.

<span data-type="title" id=toc-82>س٧٤- لم كانت هذه الآية تتضمن أنواع التوحيد الثلاثة</span>؟
...
<span data-type="title" id=toc-83>النفي والإثبات</span>
<span data-type="title" id=toc-84>س٧٥- ما هي طريقة أهل السنة والجماعة في النفي والإثبات الواردين في نصوص الصفات</span>؟
ج- طريقتهم في ذلك أنهم ينفون نفياً إجمالياً غالباً على حد قوله تعالى (ليس كمثله شيء) ويثبتون إثباتاً مفصلاً على حد قوله تعالى',NULL,'34',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (33,'وهو السميع البصير فكل ما أثبته الله لنفسه أو أثبته له رسوله صلى الله عليه وسلم من جميع الأسماء والصفات فيثبتونه لله على الوجه اللائق بجلاله وعظمته.

<span data-type="title" id=toc-85>س٧٦- ما الذي يقصد بالنفي وهل فيه كمال أو مدح واذكر مثالاً يوضح ذلك</span>؟
...
<span data-type="title" id=toc-88>سورة الإخلاص تعدل ثلث القرآن</span>
<span data-type="title" id=toc-89>س٧٩- لم كانت سورة الإخلاص تعدل ثلث القرآن</span>؟
...
ثالثاً علوم التوحيد وما يجب على العبد معرفته من أسماء الله وصفاته وهذا هو أشرفها وأجلها، وهذه السورة تضمنت أصول هذا العلم واشتملت عليها إجمالياً فهذا وجه كونها تعدل ثلث القرآن قال شيخ الإسلام رحمه الله في قصيدة له:',NULL,'36',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (35,'والعلم بالرحمن أول صاحب وأهم فرض الله في مشروعه
...
<span data-type="title" id=toc-90>س٨٠- لم سميت هذه السورة (قل هو الله أحد) سورة الإخلاص وما وجه الدلالة منها على أنواع التوحيد الثلاثة</span>؟
...
<span data-type="title" id=toc-91>س٨١- ما الذي تفهمه عن سياق المصنف لهذه السورة وبين ما تعرفه عن معنى الأحد - الصمد- الكفؤ</span>؟
ج- أما سياقها فلما تضمنته من النفي والإثبات الذي هو شاهد للضابط الذي ذكره المصنف من أن الله سبحانه قد جمع فيما وصف وسمى به نفسه بين النفي والإثبات، وأما معنى الأحد أي الواحد',NULL,'37',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (36,'الذي لا نظير له ولا وزير ولا نديد ولا شبيه ولا عديل ولا يطلق هذا اللفظ على أحد في الإثبات إلا على الله لأنه الكامل في جميع صفاته وأفعاله وأما معنى الصمد فهو الذي تصمد إليه الخلائق في حوائجهم ومسائلهم، وأما معنى الكفؤ فهو المكافئ والمساوي.

<span data-type="title" id=toc-92>س٨٢- ما الذي تعرفه من ما يستنبط من سورة الإخلاص</span>؟
...
<span data-type="title" id=toc-95>س٨٤- لم كانت آية الكرسي أعظم آية في كتاب الله</span>؟
ج- لما اشتملت عليه من الأسماء والحسنى والصفات العلى فقد',NULL,'39',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (38,'اجتمع فيها ما لم يجتمع في غيرها فآية احتوت على هذه المعاني الجليلة يحق أن تكون أعظم آية في كتاب الله ويحق لمن قرأها بتدبر وتفهم أن يمتلئ من اليقين والعرفان والإيمان وأن يكون محفوظاً بذلك من الشيطان كما ورد بذلك الحديث الصحيح الذي رواه البخاري عن أبي هريرة رضي الله عنه قال: "وكلني رسول الله صلى الله عليه وسلم بحفظ زكاة رمضان" الحديث بطوله في الكواشف ص١٠٦.

<span data-type="title" id=toc-96>الإحاطة</span>
<span data-type="title" id=toc-97>س٨٥- ما الذي تفهمه عن معنى قوله تعالى (هو الأول والآخر والظاهر والباطن وهو بكل شيء عليم) </span>؟
ج- قد فسر صلى الله عليه وسلم هذه الأسماء الأربعة بقوله أنت الأول فليس قبلك شيء وأنت الآخر فليس بعدك شيء وأنت الظاهر فليس فوقك شيء وأنت الباطن فليس دونك شيء فمدار هذه الأسماء الأربعة على الإحاطة وهي تنقسم إلى قسمين زمانية ومكانية فأحاطت أوليته بالقبل وأحاطت آخريته بالبعد وأحاطت ظاهريته وباطنيته بكل ظاهر وباطن فما من ظاهر إلا والله فوقه وما من باطن إلا والله دونه فالأول قدمه والآخر بقاؤه ودوامه والظاهر علوه وعظمته والباطن قربه ودنوه وفي قوله وهو بكل شيء عليم إثبات صفة العلم وهي من الصفات الذاتية وأحاط علمه بالظواهر والبواطن والسرائر والخفايا والأمور المتقدمة والمتأخرة.',NULL,'40',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (39,'<span data-type="title" id=toc-98>صفة الحياة</span>
<span data-type="title" id=toc-99>س٨٦- ما هو المفهوم من قوله تعالى (وتوكل على الحي الذي لا يموت) </span>؟
ج- فيها أولاً الأمر بالتوكل على الله ومعناه اعتماد القلب على الله في جلب المنافع ودفع المضار مع الثقة بالله وفعل الأسباب.
ثانياً إثبات صفة الحياة وهي من الصفات الذاتية فحياته سبحانه أكمل حياة وأتمها ويستلزم ثبوتها له ثبوت كل كمال يضاد نفيه كمال الحياة وخصص صفة الحياة إشارة إلى أن الحي هو الذي يوثق به في المصالح ولا حياة على الدوام إلا لله سبحانه دون الأحياء المنقطعة حياتهم فإنهم إذا ماتوا ضاع من يتوكل عليهم.

<span data-type="title" id=toc-100>صفة الحكمة</span>
<span data-type="title" id=toc-101>س٨٧- ما الذي تعرفه عن اسمه تعالى الحكيم</span>؟
...
س٨٨- ما أقسام حكمته تعالى؟',NULL,'41',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (40,'ج- هي تنقسم إلى قسمين أحدهما حكمته في خلقه وهي نوعان الأول أحكام هذا الخلق وإيجاده في غاية الإحكام والإتقان، والثاني صدوره لأجل غايات محمودة مطلوبة له سبحانه التي أمر لأجلها وخلق لأجلها.
...
<span data-type="title" id=toc-103>صفة العلم</span>
<span data-type="title" id=toc-104>س٩٠- بين ما تفهم من معاني هذه الآيات قال الله تعالى (يعلم ما يلج في الأرض وما يخرج منها وما ينزل من السماء وما يعرج فيها) (وعنده مفاتح الغيب لا يعلمها إلا هو ويعلم ما في البر والبحر وما تسقط من ورقة إلا يعلمها ولا حبة في ظلمات الأرض ولا رطب ولا يابس إلا في كتاب مبين) (وما تحمل من أنثى ولا تضع إلا بعلمه) (لتعلموا أن الله على كل شيء قدير وأن الله قد أحاط بكل شيء علماً) </span>؟
ج- في الآيات إثبات علم الله وصفة العلم من الصفات الذاتية التي لا تنفك عن الله وإثبات إحاطة علمه سبحانه بالأشياء جملة وتفصيلاً، واختصاصه سبحانه بعلم الخمس المذكورة في آخر سورة لقمان التي هي مفاتيح الغيب وفيها إثبات صفة القدرة وهي من الصفات الذاتية ومن أسمائه تعالى القدير الذي لا يعجزه شيء ومن قدرته تعالى أنه إذا شاء فعل من غير مانع ولا معارض وفيها رد على القدرية الذين يقولون أفعال',NULL,'43',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (42,'العباد غير داخلة في قدرة الله وفيه دليل على أنه سبحانه عالم بعلم هو صفة له قائم بذاته خلافاً للمعتزلة الذين يقولون إنه عليم بلا علم وخلافاً للجهمية المنكرين لعلم الله قال الله تعالى: (لكن الله يشهد بما أنزل إليك أنزله بعلمه) وقال: (فإن لم يستجيبوا لكم فاعلموا أنما أنزل بعلم الله) فعلمه سبحانه محيط بكل شيء فهو يعلم ما في الكون الماضي والحالي والمستقبل والواجب والممكن والمستحيل.

<span data-type="title" id=toc-105>صفة الرزق والقوة والمتانة</span>
<span data-type="title" id=toc-106>س٩١- ما الذي تفهم من معنى قوله تعالى: (إن الله هو الرزاق ذو القوة المتين) </span>؟
ج- في هذه الآية أولاً إثبات صفة الرزق وكثرته وسعته والرزق رزقان الرزق المطلق وهو ما استمر نفعه في الدنيا والآخرة وهو رزق القلوب الذي هو العلم والإيمان والرزق الحلال، والثاني مطلق الرزق وهو الرزق العام لسائر الخلق برهم وفاجرهم والبهائم وغيرها وهو إيصال القوت إلى كل مخلوق وهذا يكون من الحلال والحرام والله رازقه وقوله ذو القوة أي صاحب القوة الكاملة والقدرة التامة فلا يعجزه شيء ولا يخرج عن سلطانه أحد ومن قوته أنه أوصل رزقه إلى جميع العالم وأنه يبعث الأموات بعدما تمزقوا ومنها إيجاد الأجرام العظيمة العلوية والسفلية ومن أسمائه تعالى المتين والمتانة تدل على القوة فالله تعالى بالغ القوة والقدرة قوي من حيث أنه شديد القوة لا ينسب',NULL,'44',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (43,'إليه عجز في حال من الأحوال وصفة القوة وصفة القدرة من الصفات الذاتية التي لا تنفك عن الله.

<span data-type="title" id=toc-107>صفة السمع</span>
<span data-type="title" id=toc-108>س٩٢- ما الذي تعرفه عن معنى قوله تعالى (إن الله كان سميعاً بصيراً) (قد سمع الله قول التي تجادلك في زوجها وتشتكي إلى الله والله يسمع تحاوركما إن الله سميع بصير) (لقد سمع الله قول الذين قالوا إن الله فقير ونحن أغنياء) (أم يحسبون أنا لا نسمع سرهم ونجواهم بلى ورسلنا لديهم يكتبون) (وهو السميع البصير) </span>؟
...
<span data-type="title" id=toc-109>س٩٣- ما الذي يراد بفعل السمع</span>؟
ج- ذكر ابن القيم رحمه الله إنه يراد به أربعة معان أحدها سمع إدراك متعلقة الأصوات الثاني سمع فهم وعقل ومتعلقه المعاني الثالث سمع إجابة وإعطاء ما سئل الرابع سمع قبول وانقياد فمن الأول:',NULL,'45',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (44,'(قد سمع الله قول التي تجادلك في زوجها) (لقد سمع الله قول الذين قالوا) ومن الثاني قوله (لا تقولوا راعنا وقولوا انظرنا واسمعوا) ليس المراد سمع مجرد الكلام بل سمع الفهم والعقل ومنه سمعنا وأطعنا ومن الثالث سمع الله لمن حمده وفي الدعاء المأثور اللهم اسمع أي أجب وأعط ما سألتك وفي الرابع قوله سماعون للكذب أي قابلون له ومنقادون غير منكرين له ومنه على أصح القولين وفيكم سماعون لهم أي قابلون ومنقادون وقيل عيون وجواسيس وليس بشيء.

<span data-type="title" id=toc-110>صفة البصر</span>
<span data-type="title" id=toc-111>س٩٤- قدم تقدم أدلة إثبات صفة البصر لله تعالى مع أدلة إثبات صفة السمع فما الذي تعرفه عن معنى اسمه تعالى البصير</span>؟
...
قال بعضهم:
يا من يرى مد البعوض جناحها في ظلمة الليل البهيم الأليلِ',NULL,'46',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (45,'ويرى منط عروقها في نحرها والمخ في تلك العظام النحل
أمنن عليّ بتوبة تمحو بها ما كان مني في الزمان الأول

<span data-type="title" id=toc-112>الإرادة والمشيئة</span>
<span data-type="title" id=toc-113>س٩٥- ما الذي تفهمه عن معنى قوله تعالى (ولولا إذ دخلت جنتك قلت ما شاء الله لا قوة إلا بالله) وقوله (ولو شاء الله ما اقتتلوا ولكن الله يفعل ما يريد) (فمن يرد الله أن يهديه يشرح صدره للإسلام ومن يرد أن يضله يجعل صدره ضيقاً حرجاً) </span>؟
...
<span data-type="title" id=toc-114>س٩٦- ما دليل الإرادة الدينية الشرعية وبأي شيء تتعلق</span>؟',NULL,'47',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (46,'ج- قوله تعالى (يريد الله بكم اليسر ولا يريد بكم العسر) (ما يريد الله ليجعل عليكم من حرج) (يريد الله أن يخفف عنكم) (والله يريد أن يتوب عليكم) (إن الله يحكم ما يريد) وهذه الإرادة تتعلق بالأمر بأن يريد من العبد فعل ما أمره به والله سبحانه يحبها وقعت أو لم تقع.

<span data-type="title" id=toc-115>س٩٧- ما الفرق بين الإرادتين</span>؟
...
<span data-type="title" id=toc-116>س٩٨- أذكر ما بين الإرادتين من عموم وخصوص</span>؟
ج- الكونية القدرية أعم من جهة تعلقها بما لا يبحه الله ويرضاه من الكفر والمعاصي وأخص من جهة أنها لا تتعلق بمثل إيمان الكافر وطاعة الفاسق والإرادة الدينية الشرعية أعم من جهة تعلقها بكل مأمور واقعاً كان أو غير واقع وأخص من جهة أن الواقع بالإرادة الكونية القدرية قد يكون غير مأمور به.',NULL,'48',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (47,'<span data-type="title" id=toc-117>صفة المحبة</span>
<span data-type="title" id=toc-118>س٩٩- ما الذي تفهمه عن معنى قوله تعالى (واحسنوا إن الله يحب المحسنين) (إن الله يحب المقسطين) (إن الله يحب المتقين) (إن الله يحب التوابين ويحب المتطهرين) (قل إن كنتم تحبون الله فاتبعوني يحببكم الله) (فسوف يأتي الله بقوم يحبهم ويحبونه) (إن الله يحب الذين يقاتلون في سبيله) (وهو الغفور الودود) </span>؟
...
INSERT INTO [b9827] VALUES (48,'الأعمال الصالحة التي تمحو الخطايا والذنوب.
...
<span data-type="title" id=toc-119>صفة الرحمة</span>
<span data-type="title" id=toc-120>س١٠٠- بين ما تفهم من ما تضمنته الآيات التي تلي (بسم الله الرحمن الرحيم) وقوله (ورحمتي وسعت كل شيء) (وهو الغفور الرحيم) (فالله خير حافظاً وهو أرحم الراحمين) وقوله (كتب ربكم على نفسه الرحمة) </span>؟',NULL,'50',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (49,'ج- في هذه الآيات إثبات صفة الرحمة وسعتها وإثبات صفة العلم وسعتها وإثبات صفة المغفرة.
...
وفيه ذم من أحب ما كرهه الله أو كره ما أحبه الله وفي الآية الأخيرة حث على الوفاء بالعهد والنهي عن الخلف في الوعد وغيره وتفاوت مقته تعالى وأن الإنسان قد يكون عدواً لله ثم يكون لله ولياً ويكون الله يبغضه ثم يحبه وهو قول أهل الحق وعليه تدل الأدلة.',NULL,'54',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (53,'<span data-type="title" id=toc-126>المجيء والاتيان</span>
<span data-type="title" id=toc-127>س١٠٤ ما الذي تفهمه من معنى قوله تعالى (هل ينظرون إلا أن يأتيهم الله في ظلل من الغمام والملائكة وقضي الأمر) وقوله (هل ينظرون إلا أن تأتيهم الملائكة أو يأتي ربك أو يأتي بعض آيات ربك) (كلا إذا دكت الأرض دكاً دكاً وجاء ربك والملك صفاً صفاً) (ويوم تشقق السماء بالغمام ونزل الملائكة تنزيلاً) </span>؟
...
<span data-type="title" id=toc-128>الرد على المبتدعة المؤلين للمجيء والإتيان بمجيء الأمر</span>
س١٠٥- بم يرد على المبتدعة القائلين أن المراد بمجيء الله مجيء أمره والإتيان إتيان أمره والنزول نزول أمره؟',NULL,'55',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (54,'ج- ذكر الإمام ابن القيم رحمه الله على قوله تعالى (وجاء ربك) (هل ينظرون أن يأتيهم الله) الآية
...
رابعاً في السياق ما يبطل هذا التقدير وهو قوله وجاء ربك والملك فعطف مجيء الملك على مجيئه سبحانه يدل على تغاير المجيئين وأن مجيئه سبحانه حقيقة كما أن مجيء الملك حقيقة فمجيء الرب سبحانه أولى أن يكون حقيقة من مجيء الملك. وكذلك فمجيء الرب سبحانه أولى أن يكون حقيقة من مجيء الملك. وكذلك قوله (هل ينظرون إلا أن تأتيهم الملائكة أو يأتي ربك أو يأتي بعض آيات ربك) ، ففرق بين إتيان الملائكة وإتيان الرب وإتيان بعض آيات ربك فقسم ونوع ومع هذا يمتنع أن يكون القسمان واحداً فتأمله وذكر وجوهاً أخر يطول ذكرها قال وأما قول من قال يأتي أمره وينزل رحمته فإن أراد أنه سبحانه إذا نزل وأتى حلت رحمته وأمره فهذا حق وإن أراد أن النزول والمجيء والإتيان للرحمة والأمر ليس إلا فهو باطل من وجوه عديدة قد تقدمت ونزيدها وجوهاً أخر منها أن يقال',NULL,'56',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (55,'أتريدون رحمته وأمره صفته القائمة بذاته أم مخلوقاً منفصلاً سميتموه رحمة وأمراً فإن أردتم الأول فنزوله يستلزم نزول الذات ومجيئها قطعاً وإن أردتم الثاني كان الذي ينزل ويأتي لفصل القضاء مخلوقاً محدثاً لا رب العالمين وهذا معلوم البطلان قطعاً وهو تكذيب صريح للخبر فإنه يصح معه أن يقال لا ينزل إلى سماء الدنيا ولا يأتي لفصل القضاء وإنما الذي ينزل ويأتي غيره ومنها كيف يصح أن يقول ذلك المخلوق لا أسأل عن عبادي غيري ويقول من يستغفرني فأغفر له.
...
<span data-type="title" id=toc-129>صفة الوجه</span>
<span data-type="title" id=toc-130>س١٠٦- ما الذي تفهمه من قوله في إثبات الوجه (كل شيء هالك إلا وجهه) (إلا ابتغاء وجه ربه الأعلى) (ويبقى وجه ربك ذو الجلال والإكرام) </span>؟
ج- في هذه الآيات إثبات صفة الوجه من وهو الصفات الذاتية التي لا تنفك عن الله وقد دل على ثبوتها الكتاب والسنة أما أدلة الكتاب',NULL,'57',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (56,'فقد تقدمت وأما الأدلة من السنة فقد صح عن النبي صلى الله عليه وسلم أنه استعاذ بوجه الله وكان يقول في دعائه أسألك لذة النظر إلى وجهك وقول نفاة الصفات أن المراد بالوجه الجهة أو الثواب أو الذات قول باطل والذي عليه الحق أن الوجه صفة غير الذات وقوله ذو الجلال والإكرام أو ذو العظمة والكبرياء المكرم لأنبيائه ورسله وأوليائه وعباده المؤمنين وقيل المستحق لأن يجل والإجلال يتضمن التعظيم والتنزيه والإكرام بتضمن الحمد والمحبة.

<span data-type="title" id=toc-131>المضاف إلى الله</span>
<span data-type="title" id=toc-132>س١٠٧- ما هي أنواع المضاف إلى الله</span>؟
ج- المضاف إلى الله نوعان أعيان قائمة بنفسها كبيت الله وناقة الله وعبد الله وروح الله ورسوله فهذه إضافتها إلى الله تقتضي الاختصاص والتشريف وهي من جملة المخلوقات لله النوع الثاني صفات لا تقوم بنفسها كعلم الله وحياته وقدرته وعزته وسمعه وبصره وإرادته وكلامه ويده ووجهه فهذه إذا وردت مضافة إليه فهي إضافة صفة إلى موصوف بها وكذلك ما أخبر أنه منه فإن كان أعياناً كروح منه قال تعالى (وسخر لكم ما في السموات وما في الأرض جميعاً منه) فهذه منه خلقاً وتقديراً وإن كان ذلك أوصافاً كقوله تنزيل الكتاب',NULL,'58',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (57,'من الله دل على أن ذلك من صفاته لامتناع الصفة بنفسها ولهذا لما اهتدى السلف لهذا الفرق الذي يحصل به الفرقان بين الحق الباطل هدوا إلى الصراط المستقيم.
اليدين

<span data-type="title" id=toc-133>س١٠٨- بين ما تفهمه من قوله تعالى (بل يداه مبسوطتان) (ما منعك أن تسجد لما خلقت بيدي) (والسموات مطويات بيمينه) (أول لم يروا أنا خلقنا لهم مما عملت أيدينا) </span>؟
...
<span data-type="title" id=toc-134>الرد على مؤلي اليدين بالنعمة أو القدرة</span>
<span data-type="title" id=toc-135>س١٠٩- بم يرد على من أول اليد بالنعمة أو القدرة أو نحو ذلك</span>؟
ج- بما ذكره الإمام المحقق ابن القيم رحمه الله في مختصر الصواعق',NULL,'59',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (58,'من الوجوه التي تبطل تحريف الجهمية ومن نحا نحوهم فنذكر بعضها.
...
السادس أنه لو ثبت استعمال ذلك بلفظ التثنية لم يجز أن يكون المراد به هنا القدرة فإنه يبطل تخصيص آدم',NULL,'60',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (59,'فإنه وجميع المخلوقات حتى إبليس مخلوق بقدرة الله سبحانه فأي مزية لآدم على إبليس في قوله (ما منعك أن تسجد لما خلقت بيدي) .
سابعاً: أن هذا التركيب المذكور في قوله (خلقت بيدي) يأبى حمل الكلام على القدرة لأنه نسب الخلق إلى نفسه سبحانه ثم عدى الفعل إلى اليد ثم ثناها ثم أدخل عليها الباء التي تدخل على قوله كتبت بالقلم ومثل هذا نص صريح لا يحتمل المجاز بوجه. وقال بعدما ذكر عشرين وجهاً ورد لفظ اليد في القرآن والسنة وكلام الصحابة والتابعين في أكثر من مائة موضع وروداً متنوعاً متصرفاً مقروناً بما يدل على أنها يد حقيقية من الإمساك والقبض والبسط والمصافحة والحثيات والنضج باليد والنضج باليد والخلق باليدين والمباشرة بهما وكتب التوراة بيده وغرس جنة عدن بيده وتخمير طينة آدم بيده ووقوف العبد بين يديه وكون المقسطين عن يمينه وقيام رسول الله صلى الله عليه وسلم يوم القيامة عن يمينه وتخيير آدم بين ما في يديه فقال اخترت يمين ربي وأخذ الصدقة بيمينه يربيها لصاحبها وكتابته بيده على نفسه أن رحمته تغلب غضبه وأنه مسح ظهر آدم بيده الخ ج ٢ ص ١٧١.

<span data-type="title" id=toc-136>صفة العينين</span>
س١١٠- بين ما تفهمه من معنى هذه الآيات التي تلي (فاصبر لحكم ربك فإنك بأعيننا) (تجري بأعيننا) (واصنع الفلك بأعيننا) (ولتصنع على عيني) ؟',NULL,'61',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (60,'ج- في هذه الآيات الكريمات إثبات العينين لله وهما من الصفات الذاتية التي لا تنفك عن الله فيجب إثباتهما لله حقيقة على ما يليق بجلاله وعظمته لثبوتها بالكتاب والسنة وإجماع أهل الحق والصواب، أما الكتاب فتقدم الدليل منه وأما السنة ففي الصحيحين عن عبد الله بن عمر أن رسول الله صلى الله عليه وسلم قال: "إن الله ليس بأعور ألا أن المسيح الدجال أعور عن اليمنى كأنها عنبة طافية" وفي الحديث الآخر "إذ قام العبد في الصلاة قام بين عيني الرحمن" وأما إفرادها في بعض النصوص وجمعها في البعض الآخر فلا حجة للمبتدعة في ذلك على نفيها ولغة العرب متنوعة في إفراد المضاف وتثنيته وجمعه بحسب أحوال المضاف إليه فإن أضافوا الواحد المتصل إلى مفرده أفردوه وإن أضافوه إلى اسم جمع ظاهر أو مضمر فالأحسن جمعه مشاكلة اللفظ كقوله (تجري بأعيننا) وإن أضيف إلى ضمير جمع جمعت كقوله (أولم يروا أنا خلقنا لهم مما عملت أيدينا) وإن أضافوه إلى اسم مثنى فالأفصح في لغتهم جمعه كقوله (قد صغت قلوبكما) والله أعلم.

<span data-type="title" id=toc-137>ما جاء بلفظ الاسم وما جاء بلفظ الاسم المضاف</span>
<span data-type="title" id=toc-138>س١١١- ما الفرق بين أسماء الله بلفظ الاسم والتي بلفظ الاسم المضاف</span>؟
ج- ما جاء بلفظ الاسم على وجه التسمي به مثل الرحمن الرحيم',NULL,'62',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (61,'العزيز الحكيم السميع العليم ونحو ذلك فهذه أسماء كل واحد منها يدل على صفة من صفات الله ويشتق منها الفعل. وما جاء بلفظ الاسم المضاف كقوله (يخادعون الله وهو خادعهم) (وكذلك أخذ ربك إذا أخذ القرى وهي ظالمة إن أخذه أليم شديد) وقوله (وهو شديد المحال) فهذا الاسم يطلق على الله بلفظ الإضافة كما ورد. وبلفظ الفعل فيقال خادع المنافقين ويخادع من خادعه إن أخذ الله شديد ويأخذ من عصاه ويأخذ الظالمين ولا يشتق لله منها اسم فلا يقال من أسمائه تعالى الخادع ولا المخادع ولا الشديد ولا الآخذ.

<span data-type="title" id=toc-139>ما ورد بلفظ الفعل</span>
<span data-type="title" id=toc-140>س١١٢- ما حكم ما ورد بلفظ الفعل كقوله (ومكروا ومكر الله والله خير الماكرين) (ومكروا مكراً ومكرنا مكراً) (قل الله أسرع مكراً) (ويمكرون ويمكر الله) (إنهم يكيدون كيداً وأكيد كيداً) (وأملي لهم إن كيدي متين) </span>؟
...
وهو ينقسم إلى',NULL,'63',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (62,'قسمين محمود ومذموم فالقبيح إيصاله إلى من لا يستحقه والحسن إيصاله إلى من يستحقه عقوبة له فالأول وهو المحمود منه نسبته إلى الله لا نقص فيها.
...
<span data-type="title" id=toc-141>صفة العفو والقدرة والمغفرة والرحمة</span>
<span data-type="title" id=toc-142>س١١٣- ما الذي تعرفه عن معاني ما يلي من الآيات: (إن تبدوا خيراً أو تخفوه أو تعفوا عن سوءٍ فإن الله كان عفواً قديراً) وقوله: (وليعفوا وليصفحوا ألا تحبون أن يغفر الله لكم والله غفور رحيم) </span>؟
ج- في هذه الآيات إثبات صفة العفو والقدرة والمغفرة والرحمة فالعفو اسمه تعالى وصفته ومعناه المتجاوز عن خطيئات عباده إذا تابوا وأنابوا قال تعالى (وهو الذي يقبل التوبة عن عباده ويعفو عن السيئات) . وهو قريب من الغفور لكنه أبلغ منه فإن الغفران يُنبئ عن الستر والعفو ينبئ عن المحو والمحو أبلغ من الستر ولما كان أكمل العفو ما كان عن مقدرة تامة على الانتقام والمؤاخذة قرن الله به اسمه تعالى العفو واسمه تعالى القدير كما في هذه الآية فلولا عفوه ما ترك على ظهرها من دابة.',NULL,'64',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (63,'قال ابن القيم رحمه الله:
...
<span data-type="title" id=toc-143>صفة العزة</span>
<span data-type="title" id=toc-144>س١١٤- ما الذي تفهمه عن معاني ما يلي من الآيات الكريمات، (ولله العزة ولرسوله) قوله عن إبليس (فبعزتك لأغوينهم أجمعين) (إن العزة لله جميعاً) (هو السميع العليم) واذكر ما في ذلك من تقاسيم</span>؟
ج- تضمنت هذه الآيات إثبات صفة العزة وهي من الصفات الذاتية',NULL,'65',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (64,'التي لا تنفك عن الله. وهي تنقسم ثلاثة أقسام: عزة القوة الدال عليها من أسماء القوي المتين. وعزة الامتناع فإنه الغني فلا يحتاج إلى أحد ولن يبلغ العباد ضره فيضروه ولا نفعه فينفعوه. وعزة القهر والغلبة لكل الكائنات. قال ابن القيم رحمه الله تعالى في النونية:
...
<span data-type="title" id=toc-145>س١١٥- ما الذي تفهمه عن معنى قوله تعالى (تبارك اسم ربك ذي الجلال والإكرام) </span>؟
ج- المعنى تعالت أسماؤه وتعظمت صفاته وتقدست. والجلال',NULL,'66',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (65,'والعظمة صفتان لله جل وعلا وأما ذكره تبارك سبحانه ففي المواضع التي أثنى فيها على نفسه بالجلال والعظمة والأفعال الدالة على ربوبيته وألوهيته وحكمته وسائر صفات كماله من إنزال الفرقان وخلق العالمين وجعله في السماء بروجاً وانفراده بالملك وكمال القدرة وتباركه سبحانه من الصفات الذاتية والدليل على ذلك أنه سبحانه يسند التبارك إلى اسمه.

<span data-type="title" id=toc-146>س١١٦- كم أنواع البركة وما هي</span>؟
...
<span data-type="title" id=toc-147>نفي السمي والشبيه</span>
<span data-type="title" id=toc-148>س١١٧- ما الذي تعرفه عن معنى قوله تعالى: (فاعبده واصطبر لعبادته هل تعلم له سمياً) </span>؟
ج- فيها أولاً الأمر بعبادته تبارك وتعالى ويتضمن النهي عن',NULL,'67',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (66,'عبادة ما سواه. والعبادة اسم جامع لكل ما يحبه الله ويرضاه من الأقوال والأعمال الظاهرة والباطنة. وقوله اصطبر لعبادته أي إذا علمت أنه المسيطر على ما في السموات والأرض وما بينهما. القابض على أعنتهما فاعبده واصبر على مشاق العبادة وشدائدها. والاستفهام هنا بمعنى النفي أي لا تعلم له شبيهاً ولا مثيلاً يقتضي العبادة لكونه منعماً متفضلاً بجليل النعم وحقيرها. ومن ثم يجب تعظيمه سبحانه غاية التعظيم بالاعتراف بربوبيته والخضوع لسلطانه وإخلاص العبادة له وحده لا شريك له. وليس المعنى هل تجد من يتسمى باسمه. إذ بعض أسمائه قد يطلق على غيره لكن ليس معناه إذا استعمل فيه كما كان معناه إذا استعمل في غيره.

<span data-type="title" id=toc-149>نفي الند والكفو</span>
١١٨- ما الذي تفهمه عن معنى قوله تعالى (ومن الناس من يتخذ من دون الله أندادً) وقوله (ولم يكن له كفواً أحد) وقوله (فلا تجعلوا لله أنداداً وأنتم تعلمون) ؟
ج- الأنداد الأمثال والنظراء والكفؤ المكافئ المساوي والنظير المثيل في الآية والأولى بعد أن ذكر سبحانه فيما تقدم من ظواهر الكون ما يدل على توحيده ورحمته وقدرته. أخبر أنه مع هذا الدليل الظاهر قد وجد في الناس من لا يعقل تلك الآيات التي أقامها برهاناً على',NULL,'68',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (67,'وحدانيته فاتخذ معه نداً يعبده من الأصنام كعبادة الله ويساويه به في المحبة والتعظيم، والمحبة المذكورة في الآية هي المحبة الشركية المستلزمة للخوف والتعظيم والإجلال والإيثار على مراد النفس وهذه صرفها لغير الله شرك أكبر ينافي التوحيد بالكلية، وفي الآية الثانية نفي النظير والشبيه من كل وجه لأن أحداً نكرة في سياق النفي فيعم. الآية الثالثة ضمنت أولاً دعوة الخلق إلى عبادة الله بطريقين أحدهما إقامة البراهين بخلقهم وخلق السموات والأرض والمطر والثاني ملاطفة جميلة بذكر ما لله عليهم من الحقوق ومن الإنعام فذكر سبحانه أولاً ربوبيته لهم ثم ذكر خلقته لهم وآبائهم لأن الخالق يستحق أن يعبد ثم ذكر ما أنعم به عليهم من جعل الأرض فراشاً والسماء بناء وإنزال المطر وإخراج الثمرات لأن المنعم يستحق أن يعبد ويشكر وانظر قوله (جعل لكم) (رزقاً لكم) يدلك على ذلك لتخصيصه ذلك بهم في ملاطفة وخطاب بديع.
الثانية المقصود الأعظم من هذه الآية الأمر بتوحيد الله وترك ما عبد من دونه لقوله في آخرها (فلا تجعلوا لله أنداداً) وفي الآية دليل على أن الخلق مفطور على معرفة الله والإقرار به وفيها رد على المشبهة الذين يشبهون خلقه به والذين يشبهونه بخلقه وفيها رد على القدرية وينحوهم من الفرق وقوله (وأنتم تعلمون) أي والحال أنكم تعلمون أنه وحده الذي تفرد بخلقكم ورزقكم والذين من قبلكم وأن آلهتكم لا تخلق ولا ترزق ولا تضر ولا تنفع فاتركوا عبادتها وأفردوه بالعبادة.',NULL,'69',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (68,'<span data-type="title" id=toc-150>أقسام الشرك</span>
<span data-type="title" id=toc-151>س١١٩- ما هي أقسام الشرك وما معنى اتخاذ الند لله</span>؟
...
<span data-type="title" id=toc-152>آية العز</span>
<span data-type="title" id=toc-153>س١٢٠- ما الذي تفهمه من معنى قوله تعالى (وقل الحمدلله الذي لم يتخذ ولداً ولم يكن شريك في الملك ولم يكن له ولي من الذل وكبره تكبيراً</span>.
...
ثالثاً: تنزيه الله عن',NULL,'70',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (69,'الشريك في الملك المتضمن تفرده بالربوبية والألوهية وصفات الكمال.
...
خامساً: تكبيره في أسمائه فلا يذكر إلا بأسمائه الحسنى ولا يوصف إلا بصفاته المقدسة روى الإمام أحمد في مسنده عن معاذ الجهني أن رسول الله صلى الله عليه وسلم كان يقول آية العز (الحمد لله الذي لم يتخذ ولداً) الآية. وفي الآثار أنها ما قرئت في بيت في ليلة فيصيبه سرق أو آفة.',NULL,'71',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (70,'<span data-type="title" id=toc-154>صفة القدرة</span>
<span data-type="title" id=toc-155>س١٢١- ما الذي تفهمه عن معنى قوله تعالى (يسبح لله ما في السموات وما في الأرض له الملك وله الحمد وهو على كل شيء قدير) </span>؟
...
وفي هذه الآية إثبات صفة القدرة لله تعالى وهي من الصفات الذاتية',NULL,'72',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (71,'فلا يعجز شيء.
...
<span data-type="title" id=toc-169>عبارات السلف الأربع</span>
<span data-type="title" id=toc-170>س١٢٩- ما هي العبارات التي تدور عليها تفاسير السلف للاستواء</span>؟
ج- هي: استقر وعلا وصعد وارتفع ومعناها واحد، قال ابن القيم رحمه الله:
ولهم عبارات عليها أربع قد حصلت للفارس الطعان
وهي استقر وقد علا وقد ار تفع الذي ما فيه من نكران
وكذاك قد صعد الذي هو رابع وأبو عبيدة صاحب الشيبان',NULL,'81',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (80,'يختار هذا القول في تفسيره أدرى من الجهمي بالقرآن
والأشعري يقول تفسير استوى بحقيقة استولى على الأكوان

أنواع الاستواء في لغة العرب

<span data-type="title" id=toc-171>س١٣٠- ما هي أنواع الاستواء في لغة العرب الذين نزل القرآن بلغتهم</span>؟
ج- مطلق ومقيد. فالمطلق ما لم يقيد بحرف كقوله تعالى: (ولما بلغ أشده واستوى) ومعناه كمل وتم. وأما المقيد فثلاثة أقسام: مقيد بإلى كقوله (ثم استوى إلى السماء) ومعناه العلو والارتفاع بإجماع السلف.
والثاني مقيد (بعلى) كقوله (لتستووا على ظهوره) وقوله (واستوت على الجودي) وقوله (فاستوى على سوقه) فهذا معناه العلو والارتفاع والاعتدال بإجماع أهل اللغة.
...
س١٣١- ما هو دليل من فسر استواء الله على عرشه باستيلائه عليه ومن أول من عرفت عنه هذه البدعة وبم يرد عليه. وضح ذلك؟',NULL,'82',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (81,'ج- أما أول من عرفت عنه هذه البدعة فبعض الجهمية والمعتزلة وأما دليلهم فقول بعض الشعراء:
...
السادس: أن هذا اللفظ قد اطّرد في القرآن والسنة حيث ورد بلفظ الاستواء دون الاستيلاء. ولو كان معناه استولى لكان استعماله في أكثر موارده كذلك. فإذا جاء في موضع أو موضعين بلفظ استوى حمل على معنى استولى لأنه المألوف المعهود. وأما أن',NULL,'83',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (82,'يأتي إلى لفظ قد اطرد استعماله في جميع موارده على معنى واحد فيدعى صرفه في الجميع. إلى معنى لم يعد استعماله فيه. ففي غاية الفساد ولم يقصده ويفعله من قصد البيان أنهاها ابن القيم إلى اثنين وأربعين وجهاً في مختصر الصواعق ج٢ هذه منها.

<span data-type="title" id=toc-172>العرش والكرسي</span>
<span data-type="title" id=toc-173>س١٣٢- ما الذي تعتقده في العرش والكرسي ودلل على ما تقول</span>؟
...
<span data-type="title" id=toc-174>الجواب السديد لمن سأل عن كيفية صفة من صفات الله</span>
<span data-type="title" id=toc-175>س١٣٣- ما هو الجواب السديد لمن سأل عن كيفية صفة من صفات الله</span>؟
ج- هو جواب الإمام مالك رحمه الله لمن سأله عن كيفية الاستواء كاف شاف وإن كان السؤال عن كيفية صفة من الصفات غير الاستواء فيحذى بها حذو هذا الجواب فمثلاً إذا قال قائل كيف سمع الله فيقال السمع معلوم والكيف مجهول والإيمان به واجب والسؤال عنه بدعة وكذا يقال في بقية الصفات في الجواب لمن سأل عن كيفيتها من بصرٍ',NULL,'84',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (83,'ورضى وعجبٍ ويدٍ ونفس وكرهٍ وسخط وعلم وحياة وقدرةٍ قوةٍ وسائر الصفات والله أعلم.

<span data-type="title" id=toc-176>علو الله على خلقه</span>
<span data-type="title" id=toc-177>س١٣٤- اذكر بعض ما تستحضره من أدلة علو الله على خلقه من الكتاب والسنة</span>؟
ج- قال الله تعالى (وإذ قال الله يا عيسى إني متوفيك ورافعك إليّ) (بل رفعه الله إليه) (إليه يصعد الكلم الطيب والعمل الصالح يرفعه) (يا هامان ابن لي صرحاً لعلي أبلغ الأسباب أسباب السموات فاطلع إلى إله موسى وإني لأظنه كاذباً) (أأمنتم من السماء) (أم أمنتم من في السماء) (وهو القاهر فوق عباده) يخافون ربهم من فوقهم) (تعرج الملائكة والروح إليه) (تنزيل من الرحمن الرحيم) (قل نزله روح القدس من ربك بالحق) (وهو العلي العظيم) وأما الأدلة من السنة فقوله صلى الله عليه وسلم في رقية المريض "ربنا الله الذي في السماء تقدس اسمك أمرك في السماء والأرض كما رحمتك في السماء أجعل رحمتك في الأرض اغفر لنا حوبنا وخطايانا أنت رب الطيبين أنزل رحمة من رحمتك وشفاء من شفائك على هذا الوجع فيبرأ" رواه أبو داود وغيره وقوله ألا تأتمنوني وأنا أمين من في السماء رواه البخاري وغيره وقوله والعرش فوق ذلك والله فوق عرشه وهو يعلم ما أنتم عليه رواه أبو داود والترمذي وغيرهما وقوله للجارية أين الله قالت في السماء قال من أنا',NULL,'85',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (84,'قالت أنت رسول الله قال اعتقها فإنها مؤمنة رواه مسلم إلى غير ذلك من الأدلة الكثيرة الدالة على علو الله.

<span data-type="title" id=toc-178>س١٣٥- اذكر ما تعرفه عن معاني هذه الآيات الدالة على علو الله</span>؟
...
رابعاً: التوسل إلى الله برحمته',NULL,'86',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (85,'وبمغفرة الحوب ثم الخطايا.
...
<span data-type="title" id=toc-183>س١٣٩- هل لغة العرب توجب أن (مع) تفيد اختلاطاً أو امتزاجاً أو مجاورة</span>؟
ج- لغة العرب لا توجب أن مع تفيد اختلاطاً أو امتزاجاً أو مجاورة قال شيخ الإسلام وليس معنى قوله (وهو معكم) أنه مختلط بالخلق فإن هذا لا توجبه اللغة وهو خلاف ما أجمع عليه سلف الأمة وخلاف ما فطر الله عليه الخلق بل القمر آية من آيات الله من أصغر مخلوقاته وهو موضوع في السماء وهو مع المسافر وغير المسافر أينما كان وهو سبحانه فوق العرش رقيب على خلقه مهيمن عليهم مطلع إليهم، إلى غير ذلك من معاني ربوبيته، وكل هذا الكلام الذي ذكره الله من أنه فوق العرش وأن معناه حق على حقيقته لا يحتاج إلى تحريف وتقدم بعضه قريباً. قال ابن القيم ليس ظاهر اللفظ ولا حقيقته أنه مختلط بالمخلوقات ممتزج بها ولا تدل لفظة مع على هذا بوجه من الوجوه، فضلاً عن أن يكون هو حقيقة اللفظ وموضوعه فإن مع في كلامهم للصحبة',NULL,'91',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (90,'اللائعة، وهي تختلف باختلاف متعلقاتها ومصحوبها فكون نفس الإنسان معه لون وكون علمه وقدرته وقوته معه لون وكون زوجته معه لون وكون أميره ورئيسه معه لون وكون ماله معه لون، فالمعية ثابتة في هذا كله مع تنوعها واختلافها فيصح أن يقال: زوجته معه وبينهما شقة بعيدة. وكذا يقال مع فلان دار كذا وضيعته كذا فتأمل نصوص المعية كقوله تعالى: (محمد رسول الله والذين معه أشداء على الكفار) (واركعوا مع الراكعين) (لن تخرجوا معي أبداً) (ينادونهم ألم نكن معكم) (وكونوا مع الصادقين) (وما آمن معه إلا قليل) (فأنجيناه والذين معه) (فلما جاوزه هو والذين معه) (فاكتبنا مع الشاهدين) (ونطمع أن يدخلنا ربنا مع القوم الصالحين) وأضعاف ذلك.
هل يقتضي موضع واحد منها مخالطة في الذوات التصاقاً وامتزاجاً فكيف تكون حقيقة المعية في حق الرب تعالى ذلك حتى يدعى أنها مجاز لا حقيقة. فليس في ذلك ما يدل على أن ذاته تعالى فيهم ولا متلاصقة لهم ولا مخالطة ولا مجاورة بوجه من الوجوه وغاية ما تدل عليه مع المصاحبة والموافقة والمقارنة في أمر من الأمور وذلك الاقتران في كل موضع بحسبه يلزمه لزوم بحسب متعلقة. فإذا قيل: الله مع خلقه بطريق العموم، كان من لوازم ذلك علمه بهم وتدبيره لهم. وإذا كان ذلك خاصاً كقوله (إن الله مع الذين اتقوا والذين هم محسنون) كان من لوازم ذلك معيته لهم بالنصرة والتأييد والمعونة. من مختصر الصواعق ج٢.',NULL,'92',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (91,'<span data-type="title" id=toc-184>صفة الكلام لله</span>
<span data-type="title" id=toc-185>س١٤٠- ما هو الإيمان بصفة الكلام لله</span>؟
...
سادساً: فيه دليل على',NULL,'94',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (93,'أن نوع الكلام قديم والكلام صفة ذات من حيث تعلقها بذاته تعالى واتصافه به ومن الصفات الفعلية حيث كانت متعلقة بالمشيئة والقدرة.
...
<span data-type="title" id=toc-188>س١٤٣- ما مثال أنواع الكلام الذي بواسطة والذي بغير واسطة</span>؟
...
س١٤٦- ما هو الدليل على أن القرآن من كلام الله، وهل يكفر من جحد آية منه أو سورة أو أقر ببعض وجحد البعض الآخر؟',NULL,'96',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (95,'ج- قال تعالى (وإن أحد من المشركين استجارك فأجره حتى يسمع كلام الله) وقال (يريدون أن يبدلوا كلام الله) (وقد كان فريق يسمعون كلام الله) (أتل ما أوحي إليك من كتاب ربك لا مبدل لكلماته) (أتل ما أوحي إليك من الكتاب) (وهذا كتاب أنزلناه مبارك) (لو أنزلنا هذا القرآن على جبل لرأيته خاشعاً متصدعاً من خشية الله) وإذا بدلنا آية مكان آية والله أعلم بما ينزل) (قل نزله روح القدس من ربك بالحق) (وإن كنتم في ريب مما نزلنا على عبدنا فأتوا بسورة من مثله) (بل هو آيات بينات في صدور الذين أوتوا العلم وما يجحد بآياتنا إلا الظالمون) وقال تعالى (طس، حم، يس، ص، وأما السنة فروى الترمذي عن علي رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم "إنها ستكون فتن قلت فما المخرج منها يا رسول الله قال: كتاب الله فيه نبأ ما قبلكم وخبر ما بعدكم وحكم ما بينكم، هو الفصل ليس بالهزل، من تركه من جبار قصمه الله ومن ابتغى الهدى من غيره أضلّه الله وهو حبل الله المتين، وهو الذكر الحكيم وهو الصراط المستقيم، وهو الذي لا تزيغ به الأهواء ولا تلتبس به الألسن ولا تنقضي عجائبه ولا تشبع منه العلماء، من قال به صدق ومن عمل به أُجر، ومن حكم به عدل ومن دعى إليه هُدي إلى صراط مستقيم" وقال صلى الله عليه وسلم "من قرأ القرآن فأعربه فله بكل حرف منه عشر حسنات ومن قرأه ولحن فيه فله بكل حرف حسنة" حديث صحيح، وقال عليه السلام: "إقرؤا القرآن قبل أن يأتي قوم يقيمونه إقامة السهم لا يجاوز تراقيهم',NULL,'97',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (96,'يتعجلون أجره ولا يتأجلونه. وقال أبو بكر وعمر رضي الله عنهما إعراب القرآن أحب إلينا من حفظ بعض حروفه، وقال عليٌ رضي الله عنه من كفر بحرف من القرآن فقد كفر به كله، واتفق المسلمون على عد سور القرآن وآياته وكلماته وحروفه ولا فرق بين المسلمين في أن من جحد من القرآن سورة أو آية أو كلمة أو حرفاً متفقاً عليه أنه كافر وفي هذا حجة قاطعة أنه حروف.

<span data-type="title" id=toc-191>س١٤٧- ما هو القول الحق في القرآن فيما إذا كُتب في الورق أو قرأه القارئ</span>؟
...
س١٤٨- بين أقوال ما يلي من الفرق في مسألة القرآن. الجهمية، المعتزلة، الكلابية، الأشعرية، الكرامية، الماتريدية،',NULL,'98',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (97,'الاتحادية، السالمية، الصابئة، المتفلسفة؟
...
السادس: قوله (فلما تجلى ربه للجبل جعله دكاً) فإذا جاز أن يتجلى للجبل الذي هو جماد لا ثواب له ولا عقاب فكيف يمتنع أن يتجلى لرسوله وأوليائه',NULL,'101',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (100,'في دار كرامته.
...
INSERT INTO [b9827] VALUES (101,'سؤال مائة وستة وفي الحديث إثبات صفة الكلام وفيه دليل على أن ثلث الليل الآخر من أوقات الإجابة للدعاء وإثبات القول لله وعلو الله على خلقه وصفة الربوبية والرد على من زعم أنه حال في كل مكان بذاته وإثبات الأفعال الاختيارية ولطفه بعباده ورحمته بهم. الحديث الثاني: فيه إثبات صفة الفرح وهون من الصفات الفعلية وأن فرحه يتفاضل والحث على التوبة وفضلها. الحديث الثالث: فيه إثبات صفة الضحك وهي من الصفات الفعلية على ما يليق بجلاله وعظمته وفيه دليل على أن للقاتل توبة وفيه فضل الجهاد والحث عليه وأن القتل في سبيل الله يكفر الخطايا. وأن المقتول في سبيل الله يدخل الجنة. الحديث الرابع: فيه إثبات صفة العجب وهي من الصفات الفعلية والضحك وإثبات نظره إلى خلقه فهذه تثبت لله على ما يليق بجلاله وعظمته الحديث الخامس: فيه أن جهنم تتكلم والمتبادر أنه بلسان المقال وقيل بلسان الحال وفيه إثبات صفة الرجل لله على ما يليق بجلاله وفيه رد على المعطلة النافين لها، وفي الرواية الأخرى إثبات القدم. الحديث السادس: فيه إثبات صفة الكلام والرد على من نفاها وهذا الكلام عام لجميع الناس ولا ينافي قوله تعالى (ولا يكلمهم الله) لأن المنفي هنا تكليم المكلم بما يسره والله سبحانه أعلم.

<span data-type="title" id=toc-198>توسط أهل السنة بين فرق الضلال</span>
س١٥٣- كيف كان أهل السنة وسطاً في باب صفات الله بين أهل التعطيل الجهمية وأهل التمثيل المشبهة؟',NULL,'103',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (102,'ج- وجه ذلك أن المعطل هو من ينفي الصفات الإلهية أو بعضها وينكر قيامها بذات الله فهو بالحقيقة مقصر جافي، وأما المشبه فهو من يشبهها أو بعضها بصفات المخلوقين، فهو بالحقيقة متجاوز للحد مغالي، وأما أهل السنة والجماعة فيثبتون الصفات إثباتاً بلا تمثيل وينزهون الله عن مشابهة المخلوقين تنزيهاً بلا تعطيل فهم جمعوا بين التنزيه والإثبات.

<span data-type="title" id=toc-199>توسط أهل السنة في باب أفعال الله بين الجبرية والقدرية</span>
<span data-type="title" id=toc-200>س١٥٤- كيف كان أهل السنة وسطاً في باب أفعال الله بين الجبرية والقدرية ومن هم الجبرية ولم سموا بذلك ومن زعيم القدرية وما مذهبهم</span>؟
ج- الجبرية هم أتباع الجهم بن صفوان الترمذي وسموا جبرية لأن مذهبهم أن العبد مجبور على فعله وحركاته، وأفعاله اضطرارية، فالجبرية يزعمون أن العباد لا يفعلون شيئاً البتة، وأن الفاعل عندهم هو الله حقيقة وإضافة أفعال العباد إليهم عند الجبرية مجاز، ومذهبهم باطل وأما القدرية فهم أتباع معبد الجهني لأنه أول من تكلم بالقدر وحقيقة مذهبهم أنهم يقولون أن أفعال العباد وطاعاتهم ومعاصيهم لم تدخل تحت قضاء الله وقدره فأثبتوا قدرة الله على أعيان المخلوقين وأوصافهم، وقد نفوا قدرته على أفعال المكلفين وقالوا إن الله لم يردها ولم يشأها منهم وهم الذين أرادوها وشاءوها وفعلوها استقلالاً وأنكروا أن يضل من يشاء ويهدي من يشاء، فأثبتوا خالقاً مع الله، ولهذا سموا مجوس هذه الأمة، وهم الذين ورد فيهم الحديث أنهم مجوس هذه الأمة،',NULL,'104',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (103,'ويقال لهم القدرية النفاة ومذهبهم باطل، وأما أهل السنة والجماعة فأثبتوا أن العباد فاعلون حقيقة وأن أفعالهم تنسب إليهم على جهة الحقيقة لا على جهة المجاز، وأن الله خالقهم وخالق أفعالهم قال تعالى (والله خلقكم وما تعملون) وأثبتوا للعبد مشيئة واختياراً تابعين لمشيئة الله قال الله تعالى (لمن شاء منكم أن يستقيم وما تشاءون إلا أن يشاء الله رب العالمين) والله أعلم.

<span data-type="title" id=toc-201>توسط أهل السنة في باب أفعال الله بين المرجئة والوعيدية</span>
<span data-type="title" id=toc-202>س١٥٥- كيف كان أهل السنة وسطاً في باب وعيد الله بين المرجئة والوعيدية من القدرية ووضح المذاهب الثلاثة توضيحاً شافياً كافياً</span>؟
...
وأما الوعيدية من القدرية فهم القائلون بإنفاذ الوعيد، وأن مرتكب الكبيرة إذا مات ولم يتب منها فهو خالد مخلد في النار، وهو أصل من أصول المعتزلة، وبه تقول الخوارج، قالوا لأن الله لا يخلف الميعاد، وقد توعد سبحانه العاصين بالعقوبة، فلو قيل أن المتوعد بالنار لا يدخلها لكان تكذيباً لخبر الله، وأهل السنة توسطوا في ذلك فقالوا إن',NULL,'105',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (104,'مرتكب الكبيرة ناقص الإيمان آثم وهو معرض نفسه للعقوبة، وهو تحت مشيئة الله، وإذا مات من غير توبة، إن شاء الله عفا عنه وأدخله الجنة وإن شاء عذبه بقدر ذنوبه في النار، ولكنه لا يخلد في النار، بل يخرج بعد التطهير والتمحيص من الذنوب والمعاصي. إما بشفاعة وإما بفضل الله ورحمته قال تعالى (إن الله لا يغفر أن يشرك به ويغفر ما دون ذلك لمن يشاء) قال أهل السنة وإخلاف الوعيد كرم ويمدح به بخلاف الوعد.

<span data-type="title" id=toc-203>أسماء الإيمان والدين</span>
<span data-type="title" id=toc-204>س ١٥٦- ما المراد بأسماء الدين والأحكام</span>؟
...
<span data-type="title" id=toc-211>الإيمان باليوم الآخر</span>
س١٦٠- ما هو الإيمان باليوم الآخر؟',NULL,'109',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (108,'ج- هو الإيمان بكامل ما أخبر النبي صلى الله عليه وسلم مما يكون بعد الموت من<span data-type="title" id=toc-212> فتنة القبر </span>وعذابه ونعيمه، والبعث والنشر والحشر والصحف والميزان والحساب والصراط والحوض والشفاعة، وأحوال الجنة والنار وما أعد الله فيهما لأهلهما إجمالاً وتفصيلاً.

فتنة القبر
<span data-type="title" id=toc-213>س١٦١- ما المراد بفتنة القبر</span>؟
ج- المراد بها ما ورد من أن الناس يمتحنون في قبورهم فيقال للرجل من ربك وما يدنك ومن نبيك، فـ (يثبت الله الذين آمنوا بالقول الثابت في الحياة الدنيا وفي الآخرة) فيقول المؤمن ربي الله، والإسلام ديني ومحمد صلى الله عليه وسلم نبيي. وأما المرتاب فيقول هاه هاه لا أدري سمعت الناس يقولون شيئاً فقلته فيضرب بمرزبة من حديد فيصيح صحية يسمعها كل شيء إلا الإنسان ولو سمعها لصعق، وفي الصحيحين من حديث البراء بن عازب رضي الله عنهما عن النبي صلى الله عليه وسلم قال في قوله تعالى (يثبت الله الذي آمنوا بالقول الثابت في الحياة الدنيا وفي الآخرة) نزلت في عذاب القبر زاد مسلم فيقال له من ربك فيقول ربي الله ونبيي محمد فذاك قوله سبحانه (يثبت الله الذين آمنوا بالقول الثابت) وعند أبي داود يأتيه ملكان فيجلسانه فيقولان له من ربك، فيقول: ربي الله فيقولان له ما دينك فيقول ديني الإسلام فيقولان له ما هذا الرجل الذي بعث فيكم فيقول هو رسول الله صلى الله عليه وسلم فيقولان له وما يدريك فيقول قرأت كتاب الله تعالى فآمنت به وصدقت فينادي منادٍ أن صدق عبدي فأفرشوه',NULL,'110',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (109,'من الجنة وافتحوا له باباً إلى الجنة وألبسوه من الجنة ويفسح له مد بصره. وقال في الكافر: فيأتيه ملكان فيجلسانه فيقولان له من ربك فيقول ها هاه لا أدري إلى أن قال فينادي منادٍ من السماء أن كذب عبدي فأفرشوه من النار وافتحوا له باباً إلى النار فيأتيه من حرها وسمومها ويضيق عليه قبره حتى تختلف فيه أضلاعه.
عذاب القبر ونعيمه

<span data-type="title" id=toc-214>س١٦٢- ما هو الدليل على عذاب القبر ونعيمه</span>؟
...
<span data-type="title" id=toc-216>القيامة الكبرى</span>
<span data-type="title" id=toc-217>س١٦٤- ماذا يكون انتهاء بعد مدة البرزخ</span>؟
ج- تقوم القيامة الكبرى فتعاد الأرواح إلى الأجساد التي كانت',NULL,'112',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (111,'تعمرها في الدنيا وهذه القيامة هي التي أخبر الله بها في كتابه وعلى لسان رسول صلى الله عليه وسلم وأجمع عليها المسلمون، فيقوم الناس من قبورهم لرب العالمين، حفاة عراة غرلاً وتدنو منهم الشمس ويلجمهم العرق.
الميزان

<span data-type="title" id=toc-218>س١٦٥- ما هو الميزان وهل هو حقيقي؟ وما هو الدليل على ذلك وما الذي يوزن هل هو العمل أم الشخص أم فيه تفصيل وجمع</span>؟
ج- الميزان حقيقي له لسان وكفتان توزن به أعمال العباد قال تعالى (ونضع الموازين القسط ليوم القيامة) الآية. وقال (فمن ثقلت موازينه فأولئك هم المفلحون ومن خفت موازينه فأولئك الذي خسروا أنفسهم في جهنم خالدون) وقال (والوزن يومئذ الحق فمن ثقلت موازينه فأولئك هم المفلحون ومن خفت موازينه) الآية. وقال (فأما من ثقلت موازينه) الآيتين. قال ابن عباس رضي الله عنهما توزن الحسنات في أحسن صورة والسيئات في اقبح صورة وفي الصحيح أن البقرة وآل عمران يأتيان يوم القيامة كأنهما غمامتان أو غيايتان أو فرقان من طير صواف وفي قصة القرآن وأنه يأتي صاحبه في صورة شاب شاحب اللون الحديث: وفي قصة سؤال القبر فيأتي المؤمن شاب حسن اللون طيب الريح فيقول من أنت فيقول أنا عملك الصالح وذكر عكسه في شأن الكافر والمنافق، وقيل يوزن كتاب الأعمال واستدل له بحديث البطاقة، وقيل يوزن صاحب العمل كما في الحديث يُؤتى بالرجل',NULL,'113',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (112,'السمين فلا يزن عند الله جناح بعوضة ثم قرأ (فلا نقيم لهم يوم القيامة وزناً) وفي مناقب ابن مسعود أن النبي صلى الله عليه وسلم قال أتعجبون من دقة ساقيه والذي نفسي بيده لهما في الميزان أثقل من أحد، والراجح القول الأول. وقيل تارة يوزن العمل وتارة يوزن محلها وتارة يوزن فاعلها.

<span data-type="title" id=toc-219>س١٦٦- هل الميزان واحد أو متعدد، وإذا كان واحداً فما الجواب عن وروده بلفظ الجمع في القرآن</span>؟
...
<span data-type="title" id=toc-220>الدواوين</span>
<span data-type="title" id=toc-221>س١٦٧- ما هي الدواوين وما معنى نشرها</span>؟
...
<span data-type="title" id=toc-222>س١٦٨- ما هو الحساب وما هو الدليل على أنه حق ثابت</span>؟
ج- هو توقيف الله عباده قبل الانصراف من المحشر على أعمالهم خيراً كانت أو شراً قال تعالى (يوم يبعثهم الله جميعاً فينبؤهم بما عملوا أحصاه الله ونسوه) وقال (فوربك لنسألنهم أجمعين عما كانوا يعملون) وقال (فسوف يحاسب حساباً',NULL,'114',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (113,'يسيراً) وقال (ثم إنكم يوم القيامة عند ربكم تختصمون) وقال (ووجدوا ما عملوا حاضراً) وقال (يوم تجد كل نفس ما عملت من خيراً محضراً) الآية فيحاسب الله الخلائق ويخلو بعبده المؤمن فيقرره بذنوبه أخرج الترمذي من حديث أبي برزة رضي الله تعالى عنه أن رسول الله صلى الله عليه وسلم قال: "لا تزول قدما عبد يوم القيامة حتى يسأل عن عمره فيما أفناه، وعن علمه ما عمل به، وعن ماله من أين اكتسبه وفيما أنفقه، وعن جسمه فيما أبلاه.

<span data-type="title" id=toc-223>س١٦٩- هل هنا فرق بين محاسبة المؤمن ومحاسبة الكافر</span>؟
ج- نعم المؤمن توزن حسناته وسيئاته كما تقدم فمن رجحت حسناته على سيئاته دخل الجنة، ومن خفت موازينه بأن رجحت سيئاته بحسناته دخل النار، وأما من تساوت حسناته وسيئاته فقيل: أولئك أصحاب الأعراف. وأما الكفار فلا يحاسبون محاسبة من توزن حسناته',NULL,'115',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (114,'سيئاته فإنه لا حسنات لهم، ولكن تعد أعمالهم فتحصى فيوقفون عليها ويقررون فيعترفون بها. قال تعالى (أولئك لهم سوء الحساب) وقال (وقدمنا إلى ما عملوا من عمل فجعلناه هباء منثوراً) وقال (فلا نقيم لهم يوم القيامة وزناً) وقال عن أعمالهم (كرماد اشتدت به الريح في يوم عاصف) (كسراب بقيعة يحسبه الظمآن ماء حتى إذا جاءه لم يجده شيئاً) الآيتين.

<span data-type="title" id=toc-224>الحوض</span>
<span data-type="title" id=toc-225>س١٧٠- ما هو الإيمان بالحوض المورود، واذكر الدليل على ما تقوم ووضح موضعه وصفته ومسافته وكم آنيته ومن الذي يرده وهل يظمأ من شرب منه وهل يمنع منه أحد؟ وضح ذلك</span>.
...
س١٧١- هل الحوض مختص بنبينا صلى الله عليه وسلم أم لكل نبي حوض؟',NULL,'116',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (115,'ج- الحوض الأعظم مختص به صلى الله عليه وسلم لا يشركه فيه نبي غيره، وأما سائر الأنبياء فقد روى الترمذي في جامعه عن سمرة قال: قال رسول الله صلى الله عليه وسلم إن لكل نبي حوضاً وأنهم يتباهون أيهم أكثر واردة وإني لأرجو أن أكون أكثرهم واردة.

<span data-type="title" id=toc-226>الصراط</span>
<span data-type="title" id=toc-227>س١٧٢- ما هو الصراط وأين موضعه وما حكم الإيمان به وما صفة المرور عليه وما الذي بعده ومتى يؤذن لمن تجاوزه في دخول الجنة</span>؟
ج- هو الجسر المنصوب على متن جهنم بين الجنة والنار، يرده الأولون يمرون عليه على قدر أعمالهم فمنهم من يمر كلمح البصر ومنهم من يمر كالبرق ومنهم من يمر كالريح ومنهم من يمر كالفرس الجواد ومنهم كركاب الإبل ومنهم من يعدو عدواً ومنهم من يمشي مشياً ومنهم من يزحف زحفاً ومنهم يخطف خطفاً ويلقى في جهنم.
...
<span data-type="title" id=toc-228>الشفاعة</span>
س١٧٣- ما هي الشفاعة وما أقسامها بالنسبة إلى خاصة وعامة',NULL,'117',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (116,'ومن الذي ينكرها من طوائف أهل البدع؟
...
<span data-type="title" id=toc-229>س١٧٤- ما هي الشفاعة المثبتة والشفاعة المنفية؟ وما قيود المثبتة</span>.
ج- المثبتة هي التي أثبتها الله في كتابه، وهي لأهل الإخلاص، ولها شرطان: أحدهما: إذن الله للشافع أن يشفع.
والثاني: رضاه عن المشفوع له، ولا يرضى من العمل إلا ما كان خالصاً صواباً، قال تعالى (وكم من ملك في السموات لا تغني شفاعتهم شيئاً إلا من بعد أن يأذن الله لمن يشاء ويرضى) وقال (يومئذ لا تنفع الشفاعة إلا لمن أذن له الرحمن ورضي له قولاً) وقال (إلا من أذن له الرحمن وقال صواباً) وأما المنفية فهي التي من غير الله أو بغير إذنه أو لأهل الشرك به.',NULL,'118',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (117,'<span data-type="title" id=toc-230>انقسام الناس بالشفاعة</span>
<span data-type="title" id=toc-231>س١٧٥- إلى كم انقسم الناس في إثبات الشفاعة ونفيها</span>؟
...
<span data-type="title" id=toc-232>س١٧٦- هل يدخل الجنة أحد بغير شفاعة؟ وضح ذلك مقروناً بالدليل</span>.
...
على النهر في الفردوس تحيا بمائة كحب جميل السيل إذا جاء يطفح',NULL,'119',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (118,'<span data-type="title" id=toc-233>الجنة والنار</span>
<span data-type="title" id=toc-234>س١٧٧- ما هو مذهب أهل السنة والجماعة حول خلق الجنة والنار وبقائهما؟ وأهلهما مع ذكر الدليل</span>.
...
<span data-type="title" id=toc-235>مراتب القدر الأربع</span>
<span data-type="title" id=toc-236>س١٧٨- قد تقدم تعريف الإيمان بالقدر في جواب سؤال ٤٠ فما هي مراتبه وما دليل كل مرتبة من مراتب القدر</span>؟
ج- مراتب القدر أربع:
الأولى: إثبات علم الله الأزلي الأبدي بكل شيء. قال تعالى (إن الله بكل شيء عليم) (وأن الله قد أحاط',NULL,'120',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (119,'بكل شيء علماً) وتقدم أدلة إثبات صفة العلم في سؤال ٩١.
...
التقدير الثالث: هو التقدير السنوي ودليله قوله تعالى (فيها يفرق كل أمر',NULL,'122',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (121,'حكيم) قال ابن عباس يكتب من أم الكتاب في ليلة القدر ما هو كائن في السنة من الخير والشر والأرزاق والآجال، حتى الحجاج يقال يحج فلان ويحج فلان.
...
<span data-type="title" id=toc-239>س١٨٠- هل العرش مخلوق قبل القلم وما الجمع بين حديث ابن عمر وحديث عبادة المتقدم</span>؟
ج- نعم العرش متقدم خلقه على خلق القلم لما في الصحيح من حديث عبد الله بن عمرو قال: قال رسول الله صلى الله عليه وسلم قدر الله مقادير الخلق قبل خلق السموات بخمسين ألف سنة وكان عرشه على الماء،',NULL,'123',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (122,'وأما حديث عبادة بن الصامت المتقدم قريباً، فقال العلماء: إما أن يكون معناه عند أول خلقه قال له أكتب والأعلى أنه أول المخلوقات من هذا العالم ليتفق الحديثان إذ حديث عبد الله بن عمرو صريح في أن العرش سابق على التقدير والتقدير مقارن لخلق القلم.

<span data-type="title" id=toc-240>حكم الاحتجاج بالقدر</span>
<span data-type="title" id=toc-241>س١٨١- ما حكم الاحتجاج بالقدر على ترك أمر أو فعل نهي</span>؟
...
<span data-type="title" id=toc-242>س١٨٢- من الموجه إليه الأمر والنهي واذكر الدليل على ما تقول</span>؟
...
<span data-type="title" id=toc-243>س١٨٣- ما معنى الرضى بالقضاء وما حكم الرضى به وضح ذلك مع ذكر أنواع القضاء مفصلة</span>؟
ج- الرضى هو التسليم وسكون القلب وطمأنينته القضاء الذي هو وصفه سبحانه وفعله القائم بذاته كله خير وعدل وحكمة يجب',NULL,'124',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (123,'الرضى به كله وأما القضاء الذي هو المقضي فهو نوعان ديني شرعي يجب الرضى به كقوله تعالى (وقضى ربك أن لا تعبدوا إلا إياه) وكقوله (فلا وربك لا يؤمنون حتى يحكموك فيما شجر بينهم ثم لا يجدوا في أنفسهم حرجاً مما قضيت ويسلموا تسليماً) وهو أساس الإسلام.
...
<span data-type="title" id=toc-247>س١٨٦- ما هو قول القلب وما دليله</span>؟
...
<span data-type="title" id=toc-252>س١٩١- ما الدليل على أن الإيمان يزيد بالطاعة وينقص بالمعصية</span>؟
...
<span data-type="title" id=toc-253>مراتب المؤمنين</span>
<span data-type="title" id=toc-254>س١٩٢- كم مراتب المؤمنين وما هي وما دليلها</span>؟
ج- ثلاث مراتب: ظالمون لأنفسهم، وهم الذين خلطوا عملاً صالحاً وآخر سيئاً.
القسم الثاني: المقتصدون، وهم الذين اقتصروا على',NULL,'128',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (127,'التزام الواجبات واجتناب المحرمات فلم يزيدوا على ذلك ولم ينقصوا منه.
...
<span data-type="title" id=toc-255>تعريف أهل القبلة</span>
<span data-type="title" id=toc-256>س١٩٣- من هم أهل القبلة؟ وضح ذلك مع ذكر الدليل</span>.
...
<span data-type="title" id=toc-260>س١٩٦- بم استدل أهل السنة والجماعة على أن المؤمن العاصي لا يخرج من الإيمان؟ وما وجه الدلالة</span>.
...
<span data-type="title" id=toc-264>س٢٠٠- لم كان المهاجرون أفضل من الأنصار؟ وضحه مع ذكر الدليل</span>.
...
<span data-type="title" id=toc-265>س٢٠١- ما مناسبة قوله صلى الله عليه وسلم لا تسبوا أصحابي الحديث المتقدم ومن الساب ومن المسبوب</span>؟
ج- المناسبة هو ما ورد عن أبي سعيد الخدري قال كان بين خالد ابن الوليد وعبد الرحمن بن عوف شيء فسبه خالد فقال رسول الله صلى الله عليه وسلم لا تسبوا أصحابي.',NULL,'132',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (131,'<span data-type="title" id=toc-266>س٢٠٢- لم نهى النبي صلى الله عليه وسلم خالداً عن سب أصحابه وخالد أيضاً من أصحابه وقال لو أن أحدكم أنفق مثل أحد ذهباً ما بلغ مد أحدهم ولا نصيفه</span>.
...
<span data-type="title" id=toc-267>س٢٠٣- ما طريقة أهل السنة والجماعة نحو أهل بدر وأهل بيعة الرضوان؟ ج- هو أنهم يؤمنون بأن الله أطلع على أهل بدر وكانوا ثلاثمائة وبضعة عشرة فقال اعملوا ما شئتم فقد غفرت لكم. ويؤمنون بأنه لا يدخل النار من بايع تحت الشجرة. قال الله تعالى (لقد رضي الله عن المؤمنين إذ يبايعونك تحت الشجرة) الآية ولأخباره صلى الله عليه وسلم</span>.
ففي صحيح مسلم من حديث جابر رضي الله عنه أن النبي صلى الله عليه وسلم قال لا يدخل النار أحد بايع تحت الشجرة وكانوا أكثر من ألف وأربع مائة ١٤٠٠.',NULL,'133',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (132,'<span data-type="title" id=toc-268>س٢٠٤- أين موقع بدر وكم عدد القتلى من المشركين وكم عدد الشهداء من المسلمين</span>؟
...
<span data-type="title" id=toc-269>س١٠٥- أين تقع الشجرة ولم سميت المبايعة التي تحتها بيعة الرضوان</span>؟
...
<span data-type="title" id=toc-277>س٢١٤- ما هو موقف أهل السنة والجماعة حول الآثار المروية في مساويهم</span>؟
ج- رأى أهل السنة والجماعة أن هذه الآثار المروية في مساويهم',NULL,'138',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (137,'منها ما هو مكذوب محض ومنها ما هو محرف ومغير عن وجهه إما بزيادة فيه أو نقص يخرجه إلى الذم والطعن والصحيح منه هم فيه معذورون إما مجتهدون مصيبون وإما مجتهدون مخطئون والخطأ مغفور لهم رضوان الله عليهم أجمعين.

<span data-type="title" id=toc-278>س٢١٥- ما رأي أهل السنة حول عصمة الصحابة رضوان الله عليهم أجمعين</span>؟
...
س٢١٦- اذكر شيئاً عن فضائل الصحابة ومحاسنهم؟',NULL,'139',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (138,'ج- أولاً: الإيمان بالله ورسوله والجهاد في سبيله والهجرة والنصرة والعلم النافع والعمل الصالح ومن نظر في سيرة القوم بعلم وبصيرة وما من الله عليهم به من الفضائل علم يقيناً أنهم خير الخلق بعد الأنبياء. لا كان ولا يكون مثلهم وأنهم الصفوة من قرون هذه الأمة التي هي خير الأمم وأكرمها على الله.

<span data-type="title" id=toc-279>الكرامة</span>
<span data-type="title" id=toc-280>س٢١٧- ما هي الكرامة وهل هي تدل على صدق من ظهرت على يديه أو ولايته أو فضله</span>؟
...
<span data-type="title" id=toc-281>س٢١٨- ما الفرق بين المعجزة والكرامة والأحوال الشيطانية</span>؟
ج- المعجزة مقرونة بدعوى النبوة والكرامة غير مقرونة بدعوى النبوة وأما الأحوال الشيطانية فهي التي تظهر على أيدي المنحرفين ممن يدعي مع الله إلهاً آخر وكالسحرة والكهنة والمشعوذين لأن الكرامة لابد أن تكون أمراً خارقاً للعادة أتى ذلك الخارق عن امرئ صالح مواظب على الطاعة وتارك للمعاصي.

س٢١٩- ما هو مذهب أهل السنة ولجماعة في الكرامة؟',NULL,'140',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (139,'ج- التصديق الجازم بكرامات الأولياء وأنها حق وما يجري الله على أيديهم من خوارق العادات في العلوم والمكاشفات وأنواع القدرة والتأثير كالمأثور عن سالف الأمم في سورة الكهف وغيرها وعن صدر هذه الأمة من الصحابة والتابعين وإنما أنكرها أهل البدع من المعتزلة والجهمية ومن تابعهم لكن كثيراً ممن يدعيها يكون ملبوساً عليه.

<span data-type="title" id=toc-282>س٢٢٠- أذكر شيئاً من أنواع العلم والقدرة والتأثير</span>؟
...
<span data-type="title" id=toc-283>س٢٢١- أذكر شيئاً من خوارق العادة لغير الأنبياء من باب العلوم والمكاشفات</span>؟
ج- مثل قول عمر في قصة سارية وهو على المنبر ورؤيته لجيش سارية فقال يا سارية الجبل تحذيراً له من العدو ومكره له من وراء الجبل وسماع سارية مع بعد المسافة لأن عمر بالمدينة والجيش بنهاوند',NULL,'141',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (140,'وكإخبار أبي بكر أن في بطن امرأته أنثى وإخبار عمر عمن يخرج من ولده فيكون عادلاً وقصة صاحب موسى وعلمه بحال الغلام ونحو ذلك.

<span data-type="title" id=toc-284>س٢٢٢- ما مثال ما كان من باب القدرة والتأثير لغير الأنبياء</span>؟
ج- مثل قصة أصحاب الكهف وقصة مريم والذي عنده علم من الكتاب وكما في قصة العلاء بن الحضرمي من الصحابة رضي الله عنهم فإنه لما ذهب إلى البحرين سلكوا مفازة وعطشوا عطشاً شديداً حتى خافوا الهلاك فنزل فصلى ركعتين ثم قال يا حليم يا عليم يا علي يا عظيم اسقنا فجاءت سحابة فأمطرت حتى ملأوا الآنية وسقوا الركاب ثم انطلقوا إلى خليج من البحر ما خيض قبل ذلك اليوم فلم يجدوا سفناً فصلى ركعتين ثم قال جوزوا باسم الله قال أبو هريرة فمشينا على الماء فوالله ما ابتل لنا قدم ولا خف ولا حافر وكان الجيش أربعة آلاف والطيران في الهواء كما في قصة جعفر بن أبي طالب ذو الجناحين رضي الله عنه وكجريان النيل بكتاب أمير المؤمنين عمر رضي الله عنه وكشرب خالد بن الوليد السم من غير أن يحصل ضرر وكما جرى لسعد ابن أبي وقاص في القادسية ومرورهم على الماء بجنودهم وأسيد بن حضير ونزول الظلة عليه بالليل فيها مثل السرج إلى غير ذلك مما يطول ذكره وفي هذا كفاية والله أعلم.

س٢٢٣- هل عدم الكرامة نقص في دين الإنسان ومرتبته عند الله؟',NULL,'142',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (141,'ج- اعلم أن عدم الخارق علماً وقدرة لا يضر المسلم في دينه فمن لم ينكشف له شيء من المغيبات ولم يسخر له شيء من الكونيات لا ينقصه ذلك في مرتبته عند الله بل قد يكون عدم ذلك أنفع له في دينه إذا لم يكن وجود ذلك مأموراً به أمر إيجاب ولا استحباب.

<span data-type="title" id=toc-285>س٢٢٤- ما الذي يستفاد من الكرامة وهل هي مستمرة</span>؟
...
<span data-type="title" id=toc-290>س٢٢٨- لم سموا أهل السنة والجماعة أهل السنة وأهل الجماعة وأهل الكتاب</span>؟
ج- أما تسميتهم أهل الكتاب فلاتباعهم كتاب الله الذي قال الله فيه (اتبعوا ما أنزل إليكم من ربكم) وقال (فمن أتبع هداي فلا يضل ولا يشقى) الآيتين وأما تسميتهم أهل السنة فلاتباعهم لسنة رسول الله صلى الله عليه وسلم عملاً بقوله صلى الله عليه وسلم عليكم بسنتي الحديث وتقدم قريباً وأما تسميتهم أهل الجماعة فللاجتماع على آثار النبي صلى الله عليه وسلم والاستضاءة بأنواره والاهتداء بهديه وتقديمه على هدي كل أحد كائناً ما كان.',NULL,'145',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (144,'<span data-type="title" id=toc-291>الأصول التي تعتمد عليها أهل السنة</span>
<span data-type="title" id=toc-292>س٢٢٩- ما هي الأصول التي يعتمد عليها أهل السنة في العلم والدين ويزنون بها جميع ما عليه الناس من أعمال وأفعال باطنة أو ظاهرة مما له تعلق بالدين</span>؟
...
<span data-type="title" id=toc-293>طرق من محاسن أهل السنة</span>
<span data-type="title" id=toc-294>س٢٣٠- اذكر شيئاً من محاسن أهل السنة والجماعة</span>؟
...
<span data-type="title" id=toc-295>المعروف والمنكر</span>
س٢٣١- ما هو المعروف وما هو المنكر وما الأصل في وجوبهما وهل وجوبهما كفائي؟',NULL,'146',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (145,'ج- المعروف اسم جامع لكل ما يحبه الله من الإيمان والعمل الصالح والمنكر اسم جامع لكل ما يكرهه الله وينهى عنه والأصل في وجوبهما قوله تعالى (ولتكن منكم أمة يأمرون بالمعروف وينهون عن المنكر) .
...
<span data-type="title" id=toc-298>س٢٣٤- ما رأي أهل السنة والجماعة في إقامة الحج والجهاد والجمع مع الأمراء</span>؟
ج- يرون إقامة الحج والجهاد والجمع مع الأمراء أبراراً كانوا أو فجاراً قال الله تعالى (يا أيها الذين آمنوا أطيعوا الله وأطيعوا الرسول وأولي الأمر منكم) وفي الصحيح إن الله ليؤيد هذا الدين بالرجل الفاجر',NULL,'148',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (147,'وعن أبي هريرة مرفوعاً الجهاد واجب عليكم مع كل أمير براً كان أو فاجراً رواه أبو داود، وفي الحديث الآخر الجهاد ماض منذ بعثني الله عز وجل حتى يقاتل آخر أمتي الدجال لا يبطله جور جائر ولا عدل عادل والإيمان بالأقدار رواه أبو داود، وقد كان الصحابة رضي الله عنهم يصلون خلف من يعرفون فجوره كما صلى عبد الله بن مسعود وغيره من الصحابة خلف الوليد بن عقبة ابن أبي معيط وقد كان يشرب الخمر وصلى مرة الصبح أربعاً وجلده عثمان بن عفان على ذلك وكان عبد الله بن عمر وغيره من الصحابة يصلون خلف الحجاج بن يوسف وكان الصحابة والتابعون يصلون خلف أبي عبيد وكان متهماً بالإلحاد وداعياً إلى الضلال.

<span data-type="title" id=toc-299>النصيحة</span>
<span data-type="title" id=toc-300>س٢٣٥- ما معنى النصيحة وما معنى الإدانة بها ولمن هي</span>؟
...
<span data-type="title" id=toc-301>س٢٣٦- م معنى حديث المؤمن للمؤمن كالبنيان يشد بعضه بعضاً الخ</span>؟
ج- الحديث يفيد أن المؤمنين من شأنهم التناصر والتكاتف والتظاهر على مصالحهم الخاصة والعامة وأن يكونوا متراحمين متحابين',NULL,'149',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (148,'متعاطفين كما في الحديث الآخر الذي رواه البخاري ومسلم "لا يؤمن أحدكم حتى يحب لأخيه ما يحب لنفسه" ويفيد أن يكونوا على هذا الوصف فكما أن البنيان المجموع من أساسات وحيطان تحيط بالمنازل وسقوف وعمد كل نوع من ذلك لا يقوم بمفرده قياماً تاماً قوياً حتى ينضم بعضاً إلى بعض وإن قام فهو قيام ضعيف عرضه للعواصف والحوامل التي تزلزله أو تطرحه فيجب على المؤمنين أن يراعوا قيام دينهم وشرائعه وما يقوم ذلك ويقويه ويزيل موانعه وعوارضه متساعدين يرون الغاية واحدة وإن تباينت الطرق والمقصود واحد وإن تعددت الوسائل ومثل صلى الله عليه وسلم اتحاد المسلمين وتعاونهم بالتشبيك بين الأصابع وهو إدخال بعضها في بعض ذلك يزيد في قوة كل من اليدين والأصابع، ويفيد الحديث النهي عن التفرق والاختلاف والتخاذل والتعادي.

<span data-type="title" id=toc-302>الحث على التوادد والتراحم والتعاطف</span>
<span data-type="title" id=toc-303>س٢٣٧- ما معنى قوله صلى الله عليه وسلم مثل المؤمنين في توادهم وتراحمهم وتعاطفهم كمثل الجسد إذا اشتكى منه عضو تداعى له سائر الجسد الحمى والسهر</span>؟
ج- التوادد والتراحم والتعاطف كلها من باب التفاعل الذي يستدعي اشتراك الجماعة في أصل الفعل فالتراحم رحمة بعضهم بعضاً بسبب الأخوة الإيمانية والتواد والتواصل الجالب للمحبة كالتزاور والتهادي والتعاطف إعانة بعضهم بعضاً كما يعطف الثوب على الثوب',NULL,'150',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (149,'تقوية له فالنبي صلى الله عليه وسلم يمثل المؤمنين وأنهم كالجسد الواحد فكما أن الجسد إذا مرض منه عضو تألم له جميع البدن فكذلك المؤمنون حقيقة إذا ناب واحد منهم نائبه شعر بألمها الباقون فسعوا حسب طاقتهم لإزالة ما أصابه فهم كشخص واحد وكل فرد بالنسبة للمجموع كالعضو بالنسبة للشخص قال تعالى (محمد رسول الله والذين معه أشداء على الكفار رحماء بينهم) وفي الحديث " من كان في حاجة أخيه كان الله في حاجته ومن فرج عن مسلم كربة فرج الله عنه كربة من كرب يوم القيامة" الخ وفي الحديث الآخر المؤمن أخو المؤمن يكف عن ضيعته ويحوطه من ورائه ففي الحديث دليل على عظم حق المسلم على أخيه والحث على ما يكون سبباً للثلاث المذكورة في الحديث.

<span data-type="title" id=toc-304>س٢٣٨- بين معاني ما يلي من الكلمات الصبر - البلاء-الرخاء- الشكر الرضى</span>.
...
وكما في آية الحقوق العشرة (واعبدوا الله ولا تشركوا به شيئاً) الآية وآية براءة (إنما الصدقات للفقراء والمساكين) الآية وأما الأحاديث فعن أبي هريرة قال رسول الله صلى الله عليه وسلم الساعي على الأرملة والمسكين كالمجاهد في سبيل الله الحديث وثبت عن النبي صلى الله عليه وسلم أنه جعل يوصي أمته في مرض الموت يقول الصلاة الصلاة وما ملكت إيمانكم والرفق بالمملوك بأن لا يكلفه ما لا يطيق ويلين له الجانب فورد عنه صلى الله عليه وسلم أنه قال',NULL,'156',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (155,'لا يدخل الجنة سيئ الملكة وعن أبي ذر رضي الله عنه عن النبي صلى الله عليه وسلم قال هم إخوانكم خولكم جعلهم الله تحت أيديكم فمن كان أخوه تحت يده فليطعمه مما يأكل وليلبسه مما يلبس ولا تكلفوهم ما يغلبهم فإن كلفتوهم فأعينوهم آخرجاه والله أعلم.

<span data-type="title" id=toc-315>س٢٤٥- بين معاني ما يلي من الكلمات وأدلة أهل السنة على النهي عنها (الفخر- الخيلاء- الاستطالة) </span>؟
...
<span data-type="title" id=toc-320>س٢٤٨- من الصديق ومن الشهيد ومن المراد بأعلام الهدى ومصابيح الدجى</span>؟
ج- الصديق هو الذي صدق في قوله وفعله الكثير الصدق والشهيد هو من قتل في المعركة والمراد بأعلام الهدى العلماء وسمي العالم علماً لأنه يهتدي بعلمه وكذلك مصابيح الدجى وهذا تشبيه لعلماء السنة المهتدين وأهل الخيرات من المصلحين في الأمة بالجبال الشاهقة والعلامات الواضحة التي يعرفون بها طريق الفلاح والفوز وبالمصابيح النيرة التي تضئ الطريق للساكنين.',NULL,'159',NULL,NULL,'0');
INSERT INTO [b9827] VALUES (158,'<span data-type="title" id=toc-321>س٢٤٩- ما هي المناقب وما هي الفضائل ومن هم الأبدال ومن المراد بأئمة الدين</span>؟
ج- المناقب المفاخر والفضائل جمع فضيلة وهي ضد النقيصة وأما الأبدال قيل هم الأولياء والعباد وقيل هم الذين يجددون الدين يخلف بعضهم بعضاً في الذب عنه كما في الحديث يبعث الله لهذه الأمة على رأس كل مائة سنة من يجدد لها أمر دنيها، وأما الأئمة في الدين فهم العلماء المقتدى بهم قال تعالى (وجعلناهم أئمة يهدون بأمرنا لما صبروا وكانوا بآياتنا يوقنون) قال بعض العلماء بالصبر واليقين تنال الإمامة في الدين أخذاً من الآية الكريمة والله أعلم وصلى الله على محمد وعلى آله وسلم.

وكان الفراغ من هذه الأسئلة والأجوبة ضحوة الأربعاء في الساعة الواحدة والنصف في محرم ٣٠/١٣٨١ سبحان ربك رب العزة عما يصفون وسلام على المرسلين والحمد لله رب العالمين.
(الحمد لله الذي لم يتخذ ولداً ولم يكن له شريك في الملك ولم يكن له ولي من الذل وكبره تكبيراً) .
هذا الكتاب المسمى
مختصر الأسئلة والأجوبة الأصولية
على العقيدة الواسطية
وقف لله تعالى، من استغنى عن الانتفاع به فليدفعه إلى من ينتفع به
من طلبة العلم أو غيرهم',NULL,'160',NULL,NULL,'0');
