...
CREATE TABLE "b95662"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b95662
INSERT INTO [b95662] VALUES (1,'التحالف السياسي
في الإسلام
...
مكتبة المنار الأردن - الزرقاء',NULL,'1',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (2,'<span data-type="title" id=toc-1>بين يدي البحث</span>
...
لقد<span data-type="title" id=toc-2> ابتدأت الحركة الإسلامية مسارها الأول </span>في ظل أنظمة تؤمن بالإسلام عقيدة وتخالفه سلوكا. فكان الطرح الإسلامي المناسب لتلك المرحلة. هو طرح المفهوم المتكامل للإسلام بصفته عقيدة وشريعة ونظام حياة.
...
وكأن الشعور الخفي لدى الدعاة أن هؤلاء الحكام الذين يجهلون الإسلام سيسارعون إلى تنفيذه منذ لحظات اطلاعهم على هذه المبادئ. وإذا تلكؤوا.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (3,'فدافعهم لذلك هو الحرص على المصلحة والمنصب. وكان للإمام الرائد حسن البنا فضل في تحديد المسار والمنطلقات للحركة في تلك الظروف.

و<span data-type="title" id=toc-3>كانت المرحلة الثانية </span>من تاريخ الحركة الإسلامية هي مرحلة المحن الرهيبة التي انقضت عليها ليمحص الله الذين آمنوا ويمحق الكافرين. فلقد وصل إلى حكم بعض الدول المسماة بالإسلامية والعربية جهات بدأت تطرح بدائل جديدة عن الإسلام، وحتى تفرض هذه المبادئ فرضا كان لا بد من سحق حملة لواء الإسلام. لأن هذه العقائد أعجز من أن تصل إلى ضمير الأمة بالإقناع. فسلكت طريق الإرهاب الدموي.
...
(ثم<span data-type="title" id=toc-4> كانت المرحلة الثالثة) </span>من حياة الحركة الإسلامية حيث تمكنت الحركة من الخطوة الحاسمة في حياتها. أن تتجاوز هذه المحن الرهيبة. وتنتفض من تحت المطرقة والموت في بعض الأقطار، لتحمل السلاح في وجه عدوها، لا مدافعة عن نفسها فحسب. بل مهاجمة هذا العدو تقض عليه مضجعه وتحاصره. لتنتزع منه قيادته الجاهلية بقوة السلاح.
وانطلق التيار الإسلامي مستعصيا على الإبادة والإفناء ماضيا في طريقه فإنما هي إحدى الحسنيين النصر أو الشهادة.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (4,'ووقف العالم مبهوتا إمام هذه الانطلاقة الإسلامية الواضحة المتميزة التي وصلت أعلى قمم التميز والمفاصلة. حين أعلنت الحرب على الطاغوت في الأرض لتسود شريعة الله.
...
INSERT INTO [b95662] VALUES (5,'<span data-type="title" id=toc-5>أولا: الحلف لغة وشرعا:</span>
...
ـ[الأول]ـ: روى ((مسلم وأبو داود)) عن جبير بن مطعم رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم: «لا حلف في الإسلام، وأيما حلف كان في الجاهلية لم يزده الإسلام إلا شدة» وقال أبوداود: يريد حلف المطيبين.
...
شدة) يريد من المعاقدة على الخير، والنصر للحق، وبذلك يجتمع الحديثان. وقد حالف رسول الله صلى الله عليه وسلم في الإسلام',NULL,'6',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (6,'بين قريش والأنصار، يعني: آخى بينهم. وهذا هو الحلف الذي يقتضيه الإسلام، والممنوع منه: ما خالف حكم الإسلام.
...
(٢) السيرة النبوية لعبد الله بن محمد بن عبد الوهاب [ص:٢٠].',NULL,'8',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (8,'ونلاحظ في هذا الحلف الملاحظات التالية:
...
ونذكر جميعا يوم أخذ رسول الله صلى الله عليه وسلم مفتاح الكعبة من عثمان بن طلحة العبدري الذي انتهت إليه سدانة الكعبة. وصلى فيها ثماني ركعات صلاة الفتح.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (9,'قال علي رضي الله عنه: يا رسول الله اجمع لنا الحجابة مع الرفادة، وحين يجمع الححابة لبني هاشم يعني هذا نقض الاتفاق الذي تم على آثار هذا التحالف فأجابه عليه الصلاة والسلام: اليوم يوم بر ووفاء.
...
وهو درس بليغ لنا نحن الدعاة. بحيث نعرف قيمة العهد والميثاق الذي نعطيه حتى ولو لم نبرمه نحن إذا كان فيه رفع مظلمة أو دفع مأثمة.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (10,'<span data-type="title" id=toc-8>ب - حلف المطيبين</span>
ما قلناه عن حلف الفضول نقوله عن حلف المطيبين. لأن رسول الله صلى الله عليه وسلم ذكر هذا الحلف بقوله: شهدت حلف المطيبين، وما أحب أن أنكثه وأن لي به حمر النعم.
...
وشرح ابن الأثير في كتابه القيم جامع الأصول هذا الحلف على الصورة نفسها كذلك. ولعل نظرة عميقة إلى أحداث السيرة النبوية فيما بعد توضح لنا أثر هذا التحالف على خط سير الدعوة. فلقد وجدنا الأحلاف جميعا وهم عبد',NULL,'11',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (11,'الدار وجمح وسهم ومخزوم وعدي من أشد الناس ضد الإسلام لطبيعة هذا التحالف.
...
<span data-type="title" id=toc-9>حلف أبي طالب مع رسول الله</span>
ولا بد من ذكر هذا الحلف لأنه انطلق في بداية الأمر من العرف الجاهلي ثم اتخذ صيغة محددة ... هذه الصيغة المحددة قد تمت يوم دعا رسول الله صلى الله عليه وسلم عشيرته وطلب منهم النصرة لدين الله وكان هذا على مرحلتين.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (12,'<span data-type="title" id=toc-10>المرحلة الأولى:</span>
وقد أوردها ابن الأثير على الشكل التالي:
(وأول ما فعل رسول الله صلى الله عليه وسلم بعد نزول هذه الآية (١) أنه دعا بني هاشم فحضروا معهم نفر من بني المطلب بن عبد مناف. فكانوا خمسة وأربعين رجلا فبادره أبو لهب وقال: هؤلاء بنو عمومتك وبنو عمك فتكلم ودع الصباة واعلم أنه ليس لقومك بالعرب قاطبة طاقة. وأنا أحق من أخذك فحسبك بنو أبيك. وإن أقمت على ما أنت عليه فهو أيسر عليهم من أن يثب بك بطون قريش وتمدهم العرب.
...
(٢) نقلا عن كتاب: الرحيق المختوم [ص:٩٠] لصفي الدين المباركفوري الأعظمي.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (13,'هذه هي المرحلة الأولى التي أعلن فيها أبو طالب استعداده لمنع الاعتداء عن رسول الله صلى الله عليه وسلم وحمايته بصفته زعيما لبني هاشم.

<span data-type="title" id=toc-11>المرحلة الثانية:</span>
...
أقبل يا ابن أخي، فأقبل رسول الله صلى الله عليه وسلم فقال: اذهب يا ابن أخي فقل ما أحببت. فوالله لا أسلمك لشيء أبدا (١).
_________
(١) تهذيب السيرة لابن هشام ط - دار البحوث العلمية [ص:٥٨].',NULL,'14',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (14,'ونحن هنا أمام صيغة جديدة طلب فيها أبو طالب ربط حمايته للرسول صلى الله عليه وسلم بتقييد حرية الدعوة أو التخلي عن شيء من هذا الدين. فرفض رسول الله صلى الله عليه وسلم النصرة على هذا الأساس وتخلى عنها. وتراجع أبو طالب فوافق على الحماية والمنعة بدون قيد أو شرط.
...
<span data-type="title" id=toc-12>المرحلة الثالثة</span>
...
_________
(١) عن السيرة النبوية لعبد الله بن محمد بن عبد الوهاب [ص:٩٣] ط دار العربية.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (15,'أما قضية القتل فقد طلبت علانية من أبي طالب حين طلب منه أهل مكة أن يسلم محمدا صلى الله عليه وسلم مقابل استلام عمارة بن الوليد فكالت جوابه: تعطوني ابنكم أغذيه لكم وأعطيكم ابني تقتلونه.
...
أخص خصوصا عبد شمس ونوفلا ... هما نبذانا مثل ما ينبذ الجمر',NULL,'16',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (16,'هما أغمرا للقوم في أخويهما ... فقد أصبحا منهم وألفهما صفرا (١).
...
(٢) تهذيب سيرة ابن هشام [ص:٦٤ - ٦٥].',NULL,'17',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (17,'كان لمصلحة النبي صلى الله عليه وسلم ونصرته، دون أي تنازل مبدئي يقدمه لهم؛ إنما كانت حصافتة السياسية وحنكته تدفعهم إلى هذه المواقف.
...
(بسم الله الرحمن الرحيم. حم. تنزيل من الرحمن الرحيم) .. حتى بلغ (فإن أعرضوا فقل أنذرتكم صاعقة مثل صاعقة عاد وثمود). فقال عتبة: حسبك حسبك. ما عندك غير هذا؟ قال لا.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (18,'فرجع إلى قريش فقالوا: ما وراءك؟ قال: ما تركت شيئا إنكم تكلمونه به إلا كلمته (١). فرسول الله صلى الله عليه وسلم لم يخض معركة جانبية حول أفضليته على أبيه وجدة أو أفضليتهما عليه. ولو فعل ذلك لقضي الأمر دون أن يسمع عتبة شيئا.
...
<span data-type="title" id=toc-13>المرحلة الرابعة: </span>حصار الشعب.
...
_________
(١) السيرة النبوية لابن محمد بن عبد الوهاب [ص:٩٣].',NULL,'19',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (19,'قريش ذلك ((من شأن الحلف المذكور)) اجتمعوا وائتمروا أن يكتبوا كتابا على بني هاشم وبني المطلب ألا ينكحوا إليهم ولا ينكحوهم، ولا يبيعوا منهم شيئا ولا يبتاعوا منهم، ولا يقبلوا منهم صلحا أبدا، ولا تأخذهم بهم رأفة حتى يسلموا رسول الله صلى الله عليه وسلم للقتل) (١).
...
و<span data-type="title" id=toc-14>عودة إلى الحلف السابق</span>
...
_________
(١) السيرة النبوية لابن محمد بن عبد الوهاب [ص:٩٣].',NULL,'20',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (20,'ولما رأيت القوم لا ود عندهم ... وقد قطعوا كل العرى والوسائل
...
(٤) ثمال اليتامى: من يتولى أمرهم ويعنى بهم. والصلاصل: المزادات يسمع لها صلصل.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (21,'ولا يدع أبو طالب التعريض بحلفائه السابقين. يستثير فيهم النخوة والحمية بالانضمام إلى حلفهم الأصلي. ويغمز من قناتهم بالتخلي عن نصرته، فيقول عن زعيمي بني عبد شمس:
...
فلقد كان أول من سعى في ذلك هشام بن عمرو، واستجاب المطعم بن عدي زعيم بني نوفل بن عبد مناف، وزهير بن أبي أمية وكان بنو هاشم أخواله لأمه عاتكة بنت عبد المطلب، وأبو البختري بن هشام وزمعة بن الأسود وكانوا',NULL,'22',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (22,'ذوي قرابة في بني هاشم. وشاءت إرادة الله تعالى أن تنصر عبده ونبيه محمدا صلى الله عليه وسلم في تظاهرة عجيبة في مكة.
قال موسى بن عقبة عن ابن شهاب:
...
وغدا زهير بن أبي أمية عليه حلة. فطاف بالبيت سبعا، ثم أقبل على الناس',NULL,'23',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (23,'فقال: يا أهل مكة أنأكل الطعام ونلبس الثياب، وبنو هاشم هلكى لا يباعون ولا يبتاع منهم؟! والله لا أقعد حتى تشق هذه الصحيفة الظالمة القاطعة.
...
(٢) الآية "٤١" الأنفال.
(٣) التفسير ج ٢ [ص:٣١٢] ط دار الفكر.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (25,'والذي حدا بنا إلى اعتبار هذا الحلف مع أبي طالب هو أن أبا طالب كان يمثلهم، وهو الذي حمل العبء باسمهم مع رسول الله صلى الله عليه وسلم، ووافق على بذل الحماية باسم العشيرتين دون قيد أو شرط.
...
<span data-type="title" id=toc-15>جـ - حلف رسول الله صلى الله عليه وسلم والمطعم بن عدي</span>
كانت وفاة أبي طالب بعد نقض الصحيفة بستة أشهر. وقد قلبت وفاته الموازين كلها فكثير ممن كان يشارك في حمايته أو يمتنع عن إيذائه حرمة ومهابة لشخصه. فمع وفاته بدأ الاعتداء العنيف على النبي صلى الله عليه وسلم وبدأت محاولات قتله.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (26,'وكانت وفاة خديجة في العام نفسه، لذلك سمي العام العاشر من البعثة عام الحزن. وقد قال رسول الله صلى الله عليه وسلم: (ما نالت قريش مني شيئا أكرهه حتى مات أبو طالب).
...
وأقام رسول الله صلى الله عليه وسلم بين أهل الطائف عشرة أيام لا يدع أحدا من أشرافهم إلا جاءه وكلمه. فقالوا: اخرج من بلادنا. وأغروا به سفهاءهم. فلما أراد الخروج تبعه سفهاؤهم وعبيدهم يسبونه ويصيحون به.',NULL,'27',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (27,'حتى اجتمع عليه الناس فوقفوا له سماطين (أي صفين) وجعلوا يرمونه بالحجارة. ورجموا عراقيبه حتى اختضب نعلاه بالدماء، وكان زيد بن حارثة يقيه بنفسه حتى أصابه شجاج في رأسه .. وكان هذا في شوال سنة عشر من النبوة (١).
...
_________
(١) الرحيق المختوم للمباركفوري.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (28,'ولنستعرض هؤلاء الثلاثة الذين استجارهم الرسول صلى الله عليه وسلم.
...
على أن هذا الحلف كان ضعيفا. لم تكن مهمته تحمل المسؤوليات الناجمة',NULL,'29',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (29,'عن الدعوة لهذا الدين. إينما كان حماية مؤقتة. والمطعم بن عدي وقومه عاجزون عن تأمين الحماية التامة. والذي طلبه النبي صلى الله عليه وسلم هو بالنص دخوله في جواره، لا ضمان حرية الدعوة له. أي حماية شخصه أكثر من حماية حرية الدعوة له.
...
<span data-type="title" id=toc-16>د - صور من الأحلاف لم تنجح</span>
...
يقول المقريزي في (إمتاع الأسماع): ((ثم عرض صلى الله عليه وسلم نفسه على القبائل أيام الموسم، ودعاهم إلى الإسلام، وهم بنو عامر، وغسان، وبنو فزارة، وبنو مرة، وبنو حنيفة، وبنو سليم، وبنو عبس، وبنو نصر، وثعلبة بن عكابة، وكندة، وكلب، وبنو الحارث بن كعب، وبنو عذرة، وقيس بن الخطيم، وأبو اليسر أنس بن أبي رافع)) وقد اقتص الواقدي أخبار هذه القبائل قبيلة قبيلة. ويقال إنه صلى الله عليه وسلم بدأ بكندة فدعاهم إلى',NULL,'30',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (30,'الإسلام ثم أتى كلبا ثم بني حنيفة ثم بني عامر. وجعل يقول: من رجل يحملني إلى قومه فيمنعني حتى أبلغ رسالة ربي فإن قريشا قد منعوني أن أبلغ رسالة ربي؟! هذا وأبو لهب وراءه يقول للناس: لا تسمعوا منه فإنه كذاب.
...
_________
(١) - الأنعام - ١٥١ -',NULL,'32',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (32,'فقال مفروق: وإلام تدعويا أخا قريش؟ فتلا رسول الله صلى الله عليه وسلم {إِنَّ اللَّهَ يَأْمُرُ بِالْعَدْلِ وَالْإِحْسَانِ وَإِيتَاءِ ذِي الْقُرْبَى ... } (١) الآية. فقال مفروق: دعوت والله يا أخا قريش إلى مكارم الأخلاق، ومحاسن الأعمال، ولقد أفك قوم كذبوك وظاهروا عليك.
...
_________
(١) النحل -٩٠ -',NULL,'33',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (33,'إلا قليلا حتى يورثكم الله أرضهم وديارهم ويفرشكم نساءهم أتسبحون الله وتقدسونه؟ فقال النعمان بن شريك: اللهم لك ذلك، فتلا رسول الله صلى الله عليه وسلم: {يَا أَيُّهَا النَّبِيُّ إِنَّا أَرْسَلْنَاكَ شَاهِدًا وَمُبَشِّرًا وَنَذِيرًا * وَدَاعِيًا إِلَى اللَّهِ بِإِذْنِهِ وَسِرَاجًا مُنِيرًا} (١).
...
فإذا كان رسول الله صلى الله عليه وسلم يريد المنعة، فها هنا مكانها. وقريش لا تزيد عن الألف، ولقد أوعبت ألفا في بدر ولكن المفاوضات دخلت حلقة جديدة فلقد كان مفروق من الذكاء واللباقة ما جعله يكتشف من خلال الأسئلة أن السائل أخو قريش وصاحب مكة. وكان من العقل والحكمة بحيث تجاهل كل الأراجيف عن رسول الله صلى الله عليه وسلم بأنه ساحر أو',NULL,'35',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (35,'شاعر أو كاهن .. وتوجه إلى رسول الله صلى الله عليه وسلم يسأله عن دعتوه ودينه.
...
وزاد مفروق شغفا بحديث رسول الله صلى الله عليه وسلم فاستزاده: (وإلام تدعو أيضا يا أخا قريش)؟.',NULL,'36',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (36,'واختار رسول الله صلى الله عليه وسلم الآية الجامعة المانعة الفذة: {إِنَّ اللَّهَ يَأْمُرُ بِالْعَدْلِ وَالْإِحْسَانِ وَإِيتَاءِ ذِي الْقُرْبَى وَيَنْهَى عَنِ الْفَحْشَاءِ وَالْمُنْكَرِ وَالْبَغْيِ يَعِظُكُمْ لَعَلَّكُمْ تَذَكَّرُونَ} (١).
...
_________
(١) - النحل-٩٠',NULL,'37',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (37,'حسب إمكاناتهم على العرب فقط. أما كسرى فلا، فلقد عاهدوه أن لا يحدثوا حدثا أو يؤووا محدثا. ولعل كسرى يغضب أشد الغضب لو علم بذلك .. فهو أمر تكرهه الملوك.
...
١ - أي مفاوضة أو مساومة تنتهي بالتخلي عن هذا الدين أو تطالبنا بالساومة',NULL,'38',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (38,'على المبدأ أو العقيدة فهي مرفوضة، وكل تحالف يقود إلي هذه النتيجة بأن نقدم جزءا من إسلامنا ونتخلى عن الدعوة لشيء منه ونترك البعض الآخر بصفته شرطا يتوقف عليه التحالف هو مرفوض في الإسلام.
...
عندما يكون الأصل في التحالف السياسي هو النجاح أو تحقيق فوز',NULL,'39',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (39,'على العدو. أو بتعبير أدق عندما يكون الميزان هو أن الغاية تبرر الوسيلة بإطلاق فيعتبر الوقوف عند هذه الجزئيات خطأ سباسيا. أما عندما يكون الهدف هو انتصار الدعوة والعقيدة فالتخلي عن جزئية واحدة منها هو تخل عنها كلها. ومن حقنا هنا أن نتساءل: لماذا سكت رسول الله صلى الله عليه وسلم عن إجابة عتبة، وأجاب عمه أبا لهب.؟
...
ـ[الصورة الأولى]ـ: لدى أبي بكر الصديق عندما أجاره ابن الدغنة. واعترض المشركون على هذا الجوار أن أبا بكر يقرأ القرآن خارج البيت بصوت مؤثر يفتن الصبيان والنساء عن عقيدتهم. فجاء ابن الدغنة إلى أبي بكر وطلب منه أن يدخل بيته ويقرأ القرآن بحيث لا يتأثر به النسوة والصبيان فيفتنهم فرفض ذلك ورد عليه جواره.',NULL,'40',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (40,'لأن قبوله بذلك يعني شل حرية الدعوة لدى أبي بكر رضي الله عنه. ويعني إيثاره سلامته على سلامة دعوته.
...
_________
(١) الإسراء- ٧٣ - ٧٥',NULL,'42',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (42,'المبدأ. ولا بد من تعداد الصور لإيضاح جانب الحق في هذا الموضوع.
...
إن الحركة الإسلامية حين تفاوض عدوا على مستقبل الحكم أو تدعى إلي التحالف معه ... إذا استطاعت أن تصل مع هذا العدو إلى أن',NULL,'44',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (44,'يكون الأمر إلى الله يضعه حيث يشاء من خلال بنود التحالف، فلها حرية الاختيار في ذلك. وحتى تتوضح الصورة أكثر نجد أن بإمكان الحركة الإسلامية أن تتحالف مع عدو على إسقاط عدو آخر. ويكون الحكم بعد ذلك لله يضعه حيث يشاء.
...
° ـ[أولا]ـ: النظام الديمقراطي يقتضي من الحركة الإسلامية أن تقبل بالفئة أو الحزب الذي ينتخبه الشعب. وأن تعترف بشرعيته طالما فاز',NULL,'45',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (45,'بالأكثرية. وقد يكون هذا الحزب أو التجمع معاديا للإسلام أو لا يتبنى الإسلام- على أحسن الاحتمالات- وخروجها عليه خروج على الشرعية التي أعلنت الالتزام بها. فهي تضطر أن تنقض عهدا أبرمته، ولا يحل في ديننا إلا الوفاء.
...
وإن ما نتصوره كسبا سياسيا مؤقتا يعقبه تخل عن التزام أو نقض لعهد، هو- في حقيقة الأمر خسارة كبرى للتصور الإسلامي عند هؤلاء',NULL,'47',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (47,'الناس. فلنحذر دائما من الكسب الرخيص السريع مقابل فقدان الناس ثقتهم بهذا المنهج الرباني الفريد.
...
إن المثنى قد ألمح إلى أن هذا الأمر تكرهه الملوك. وإن موقع الدعوة بجوار فارس يجعلها سهلة المتناول في أي لحظة، وإن العهود والمواثيق املقيدة لشيبان تجعلهم أعجز من أن يستطيعوا حماية هذا الرسول وهذا الدين من بطش كسرى. إن التحالف مع الخصم الأقوى يكون في معظم الأحيان في مصلحة هذا الخصم. فوقع شيبان إذن من جهة غير مناسب ليكون مركزا للدعوة الجديدة، وعهود شيبان- من جهة ثانية- تشل إمكانية الحركة الإسلامية، وكراهة الملوك لهذه الدعوة التي تدعو لإخراج الناس من عبادة العباد إلى عبادة الله هي من جهة ثالثة عنصر غير مشجع لوجود هذه الحركة بحيث تمس مصالحها وتوقع الاحتكاك بينها وبين الحركة',NULL,'49',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (49,'الإسلامية. ويكفي أن نذكر نقطتين اثنتين توضحان عبقرية النظرة السياسية النبوية في هذا المجال:
...
٢ - ° خط حلف الفضول، وكل تحالف على إسقاط نظام طاغ أو مقاومة ظالم مستبد جائز.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (50,'٣ - ° خط حلف أبي طالب على رسول الله صلى الله عليه وسلم في عدم المساس بحرية الدعوة إلى تحقيق الدعوة جائز.
٤ - ° خط حلف رسول الله صلى الله عليه وسلم مع المطعم بن عدي في حماية حرية الدعاة وحياتهم جائز.
٥ - ° خط رفض حلف أبي لهب في التنازل عن أية جزئية من جزئيات هذه العقيدة أو المساومة عليها واجب دعوي.
٦ - ° خط رفض حلف بنى عامر في رفض أية التزامات تؤديها الحركة الإسلامية بالحكم للآخرين. أصل
٧ - ° خط رفض حلف بني شيبان، وذلك في رفض أية أحلاف توقع الحركة الإسلامية تحت سلطان عدوها ملحوظ.
٨ - ° خط الإحاطة لدين الله من كل جانب يجب أن يحكم بالمفاوض السياسي المرن الذكي التقي العبقري.
٩ - ° خط الإحاطة لدين الله في عبقرية التخطيط السياسي، ومرونة العمل السياسي المتعدد يجب أن يكون على ذكر.
١٠ - ° الخط العام الذي يشمل الخطوط السابقة كلها، والذي نسميه الخط المتصاعد الذي نحقق فيه كل يوم كسبا جديدا للإسلام دون أية خسائر في المبدأ أو العقيدة، يجب أن يكون هو سمة العمل.',NULL,'51',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (51,'<span data-type="title" id=toc-17>ثالثا: التحالف في مرحلة تأسيس الدولة</span>
...
وتمت ـ[الخطوة الأولى]ـ بعد جولة صعبة وطويلة قضاها في العرض على القبائل. وليس في هذه المجموعة قيادات مثل قيادات شيبان، لكن خط الهدى لا يتوقف على نوعيات خاصة بل هو مبذول لكل راغب. وقد كانت سورة عبس درسا ربانيا للرسول صلى الله عليه وسلم في أن يدعو الناس كافة.',NULL,'52',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (52,'ثم كانت ـ[الخطوة الثانية]ـ ( ... وقال بعضهم، ومن أهل العلم بالسير: فقال لهم النبي صلى الله عليه وسلم: أتمنعون ظهري حتى أبلغ رسالة ربي؟ فقالوا: يا رسول الله إنما كانت بعاث عام الهول يوما من أيامنا اقتتلنا به. فإن تقدم ونحن كذا لا يكون عليك اجتماع، فدعنا حتى نرجع إلى عشائرنا لعل الله يصلح ذات بيننا وندعوهم إلى ما دعوتنا إليه، فعسى الله أن يجمعهم عليك، فإن جمعهم عليك واتبعوك فلا أحد أعز منك، وموعدك الموسم العام القابل. وانصرفوا إلى المدينة (١).
...
والذي يدفعنا إلى هذه النقاط سبب أساسي- هو الاعتقاد أن مرحلتنا الآن والتي تمر بها الحركة الإسلامية في سورية هي مرحلة تأسيس الدولة. ولا بد أن نترسم في كثير من خطاها. هذه المرحلة النبوية المشابهة. سواء في أحلافها',NULL,'54',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (54,'الخارجية، أو في بنائها الداخلي، ولا يغيب عن ذهننا أن لقاء العقبة الأول والثاني هو بيعة وليس حلفا، وهذا يعني أنه دليلنا في العمل داخل حركتنا الإسلامية الواحدة أو داخل جبهتنا الإسلامية المتحدة. وهذا لعمري هو أحوج ما نكون إليه في مجال القدوة أو الأسوة. ونبادر إلى القول سلفا. أن الحلف الوحيد في هذه المرحلة هو ميثاق المدينة الذي حدد فيه رسول الله صلى الله عليه وسلم طبيعة العلاقة مع الفئات غير المسلمة في دولته الجديدة. وهو ما نحرص على تحديده اليوم. والذي سندرسه إن شاء الله عقب الحديث المختصر الضروري عن بيعتي العقبة.
...

انتظر رسول الله صلى الله عليه وسلم عاما كاملا على الموعد الذي تم بينه وبين النفر الستة من الخزرج، وتم لقاء جديد في العقبة أطلق عليه فيما بعد-<span data-type="title" id=toc-18> بيعة العقبة الأولى</span>- وهو كما رواه ابن إسحاق: (حتى إذا كان العام المقبل وافى الموسم من الأنصار اثنا عشر رجلا. فلقوه بالعقبة وهي العقبة الأولى. فبايعوا رسول الله صلى الله عليه وسلم على بيعة النساء وذلك قبل أن تفترض عليهم الحرب ... ) (١).
وعن عبادة بن الصامت قال: كنت فيمن حضر العقبة الأولى. وكنا اثني عشر رجلا. فبايعنا رسول الله صلى الله عليه وسلم على بيعة النساء. وذلك قبل أن تفترض الحرب. على أن لا نشرك بالله شيئا ولا نسرق ولا نزني ولا نقتل أولادنا، ولا نأتي ببهتان نفتريه بين أيدينا وأرجلنا ولا نعصيه في معروف فإن وفيتم فلكم الجنة. وإن غشيتم من ذلك شيئا فأمركم إلى الله عز وجل إن شاء عذب وإن شاء غفر (٢).
_________
(١) تهذيب السيرة لابن هشام [ص:١٠٢].
(٢) روى البخاري هذه الرواية بهذا المعنى. عن عبادة بن الصامت رضي الله عنه.',NULL,'55',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (55,'والذي يعنينا من هذه البيعة هو النقاط التالية:
...
٣ - وكان التطور الجديد الذي أثمرته بيعة العقبة بعث مصعب بن عمير ممثلا شخصيا للرسول صلى الله عليه وسلم إلي المدينة، يشرف على تطور الموقف، ويفقه المسلمين بهذا الدين الجديد، وكل هذا ضمن النشاط الفكري والسياسي، والاتجاه للتعبئة وتكوين الأنصار المعتنقين لهذه العقيدة.
٤ - واستطاع الدبلوماسي الإسلامي الأول في المدينة بحكمته وحصافته وذكائه السياسي أن يجر أكبر قيادات الأوس للإسلام، أسيد بن حضير وسعد بن',NULL,'56',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (56,'معاذ، خلال العام الجديد، ولم يبق في بني عبد الأشهل- بطن كبير من الأوس- رجل ولا امرأة ولا طفل إلا ودخل في الإسلام.
...
_________
(١) السيرة النبوية لابن الشيخ محمد بن عبد الوهاب في رواية إلى الزبير عن جابر.',NULL,'57',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (57,'والقدرات والإمكانات المتاحة، وكيف تغلغل الإسلام في جميع قطاعات الأوس والخزرج، وأن القوم جاهزون لبيعة جديدة قادرة على حماية رسول الله صلى الله عليه وسلم ومنعته.
...
_________
(١) - الحج- ٣٩ - ٤٢ -',NULL,'58',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (58,'ذنب فيما بينهم وبين الناس وأنهم إذا ظهروا أقاموا الصلاة وآتوا الزكاة وأمروا بالمعروف ونهوا عن المنكر، يعني النبي صلى الله عليه وسلم وأصحابه رضي الله عنهم أجمعين (١).
...
<span data-type="title" id=toc-19>بيعة العقبة الثانية:</span>
...
<span data-type="title" id=toc-21>التأكيد على خطورة البيعة:</span>
وبعد أن تمت المحادثة حول شروط البيعة، وأجمعوا على الشروع في عقدها، قام رجلان من الرعيل الأول ممن أسلموا في مواسم سنتي ((١١ و ١٢)) من النبوة، قام أحدهما تلو الآخر ليؤكد خطورة المسؤولية، حتى لا يبايعوه إلا على جلية من الأمر وليعرفا مدى استعداد القوم للتضحية ويتأكدا من ذلك.
قال ابن إسحاق: لا اجتمعوا للبيعة قال العباس بن عبادة بن نضلة: هل تدرون علام تبايعون هذا الرجل؟ قالوا: نعم. قال: إنكم تبايعونه على حرب الأحمر والأسود من الناس، فإن كنتم ترون أنكم إذا نهكت أموالكم مصيبة، وأشرافكم قتلا أسلمتموه، فمن الآن فهو والله إن فعلتم خزي الدنيا والآخرة، وإن كنتم ترون أنكم وافون له بما دعوتموه إليه على نهكة الأموال وقتل الأشراف فخذوه فهو والله خير الدنيا والآخرة.
قالوا: فإنا نأخذه على مصيبة الأموال وقتل الأشراف، فما لنا بذلك يا رسول الله إن نحن وفينا بذلك؟ قال: الجنة. قالوا: إبسط يدك. فبسط يده فبايعوه.
وفي رواية جابر قال: فقمنا نبايعه، فأخذ بيده أسعد بن زرارة، وهو أصغر السبعين، فقال: رويدا يا أهل يثرب، إنا لم نضرب أكباد الإبل إلا ونحن نعلم',NULL,'61',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (61,'أنه رسول الله، وأن إخراجه اليوم مفارقة العرب كافة، وقتل خياركم وأن تعضكم السيوف، فإما أنتم تصبرون على ذلك فخذوه، وأجركم على الله، وإما أنتم تخافون من أنفسكم خيفة فهو أعذر لكم عند الله ....
فقالوا: يا أسعد. أمط عنا يدك، والله لا نذر هذه البيعة ولا نستقيلها.

<span data-type="title" id=toc-22>اثنا عشر نقيبا:</span>
...
<span data-type="title" id=toc-25>قريش تقدم الاحتجاج إلى رؤساء يثرب:</span>
...
_________
(١) الرحيق المختوم للمباركفوري والصفحات ١٦٤ - ١٧٢ باختصار، وقد استقاها من ابن هشام وزاد المعاد ومسند الإمام أحمد، ومختصر السيرة لابن محمد بن عبد الوهاب وبعض كتب الحديث.',NULL,'64',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (64,'السوار بالمعصم، وسط هذا الخضم انبثقت دولة الإسلام الأولى في التاريخ، ولنتعلم من رسول الله صلى الله عليه وسلم معالم طريقنا الذي نخوضه اليوم وسط بحرين كبيرين، بحر من الدماء، وبحر من الأعداء.
...
وتشير رواية جابر بن عبد الله إلى بعض اللقاءات الثانوية. (فقال له عمه العباس: يا ابن أخي ما أدري ما هؤلاء القوم الذين جاؤوك، إني ذو معرفة بأهل يثرب. فاجتمعنا عنده من رجل ورجلين، فلما نظر العباس في وجوهنا قال: هؤلاء القوم لا نعرفهم، هؤلاء أحداث). أما إسلام أبي جابر الزعيم الثاني فكان يوم اللقاء المقرر كما يقول كعب: فلما فرغنا من الحج وكانت الليلة التي واعدنا رسول الله صلى الله عليه وسلم لها ومعنا عبد الله بن عمرو بن حرام سيد من ساداتنا، وشريف من أشرافنا أخذناه معنا، وكنا نكتم من معنا من قومنا من المشركين أمرنا، فكلمناه وقلنا له: يا أبا جابر. إنك سيد من ساداتنا، وشريف من أشرافنا، وإنا نرغب بك عما أنت فيه أن تكون حطبا للنار غدا، ثم دعوناه إلى الإسلام. وأخبرناه بميعاد رسول الله صلى الله عليه وسلم إيانا العقبة. فأسلم وشهد معنا العقبة، وكان نقيبا. فكم كان نشاط المسلمين إذن. وهم يضمون الفرد تلو الفرد، والقائد تلو القائد إلى صفوفهم ليشارك في بيعة الحرب.',NULL,'66',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (66,'وكانت لقاءات القاعدة مع القائد العظيم صلى الله عليه وسلم أكبر حلم عندها تتعرف عليه وتتلقى منه، وتستجيب لأمره وتوجيهاته.
...
٤ - وكان حضور العباس وحديثه وهو على دين قومه- كما يظهر ضرورة سياسية فهو الذي يحمل عبء الحماية النبوية كما قلنا، فلا بد أن يتوثق من مستوى هذه الحماية الجديدة ليطمئن إليها، وإلا فلن يفرط في ابن أخيه. ولعل هذا يشير إلى إمكانية اشتراك بعض الشخصيات غير الإسلامية إذا كانت مناط ثقة تامة من القيادة في عملية تغيير سياسي لصالح الإسلام أو- على الأقل- يمكن',NULL,'67',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (67,'القول: إنها في ظاهرها موالية للسلطة الحاكمة، أما حقيقة ولائها فللقيادة المسلمة، خاصة إذا كان لها دور رئيسي في التحرك، كقيادة فرقة في عملية انقلاب عسكرية، أو قيادة مجموعة سياسية في عملية تغيير سياسي. بل بإمكانها أن تشارك في رسم الخطة وتنفيذها إذا كانت ذات خبرات عريقة. فلقد شارك العباس رضي الله عنه في تنفيذ هذا اللقاء- كما تشير الرواية- وهو الذي أمر أبا بكر وعليا بالوقوف على الطرق المؤدية للشعب.
إن من حق القيادة- بل من واجبها- أن تستفيد من الخبرات والطاقات الإسلامية وغير الإسلامية عندما تدين لها بالولاء والطاعة.
٥ - ونلاحظ أن الأنصار رضي الله عنهم حرصوا على استماع الخطة من القيادة مباشرة. فقالوا للعباس: قد سمعنا ما قلت، فتكلم يا رسول الله فخذ لنفسك ولربك ما أحببت. ومن أجل هذا قلنا: إننا لسنا أمام حلف سياسي، إنما نحن أمام قيادة واحدة وقاعدة صلبة تنتظر الأوامر، وتريد معرفة إمكانات التنفيذ. وإذا كانت البيعة لم تتم فإن الاستعداد الكامل للتنفيذ قائم. فخذ لنفسك ولربك ما أحببت.
٦ - وكانت البنود الخمسة للبيعة من الوضوح والقوة بحيث لا تقبل التمييع والتراخي. إنه السمع والطاعة في النشاط والكسل، والنفقة في اليسر والعسر، والأمر بالمعروف، والنهي عن النكر، والقيام في الله لا تأخذهم فيه لومة لائم ... ونصر لرسول الله صلى الله عليه وسلم، وحمايته إذا قدم المدينة ...
إن البيعة على الإسلام شيء، والبيعة على إقامة دولة الإسلام شيءآخر.
وإن الرجال الذين يعدون ليكونوا أفرادا مغمورين في عداد المسلمين شيء، والذين يعدون لتقوم دولة الإسلام بسواعدهم وبأرواحهم وبأموالهم وبدمائهم شيءآخر. ويكفي أنها مضت مثلا في التاريح الإسلامي أن البيعة الخالية من',NULL,'68',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (68,'الحرب والجهاد- ومنها بيعة العقبة الأولى- كانت تسمى بيعة النساء. أما هذه البيعة فبيعة الحرب.
...
٧ - وسرعان ما استجاب قائد الأنصار دون تردد- البراء بن معرور قائلا: والذي بعثك بالحق لنمنعنك مما نمنع منه أزرنا فبايعنا يا رسول الله. فنحن والله أبناء الحرب وأهل الحلقة. ورثناها كابرا عن كابر.
...
٨ - والأوامر شيء والمفاوضات شيء آخر. فلقد اعترض أبو الهيثم بن التيهان رضي الله عنه وهو المسلم العظيم على أمر مهم قبل البيعة وكان لا بد من طرحه بصراحة ووضوح: يا رسول الله إن بيننا وبين الرجال حبالا وإنا قاطعوها - يعني يهود- فهل عسيت إن نحن فعلنا ذلك ثم أظهرك الله أن ترجع إلى قومك وتدعنا؟',NULL,'69',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (69,'فتبسم رسول الله صلى الله عليه وسلم ثم قال: بل الدم الدم، والهدم الهدم. أنا منكم وأنتم مني أحارب من حاربتم وأسالم من سالتم.
...
هذا هو مفهوم اعتراض أبي الهيثم بن التيهان رضي الله عنه. لأن قطع العهود مع يهود يعني إعلان الحرب عليهم، فإذا تخلى رسول الله صلى الله عليه وسلم عنهم ومضى إلى قومه في مكة فهذا يعني ترك المسلمين تحت رحمة يهود يفعلون بهم الأفاعيل بل يستأصلون أخضرهم ويابسهم، إذا كان من حق أبي الهيثم أن يناقش رسول رب العالمين بهذا الأمر فأي قيادة في الدنيا مهما ارتفعت لا تناقش فيه؟ وأي قائد في هذا الوجود لا يحاسب عليه.',NULL,'70',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (70,'ألا فليعلم كل جندي في المعركة الإسلامية أن من حقه أن يعترض هذا الاعتراض على قيادته إن انسحبت من المعركة وتركته يتلوى وحده في النار. إن كل قطرة دم تراق بأمر القيادة أو من جراء أمرها هي في عنق هذه القيادة ستسأل عنها يوم الدين. فيم أراقتها، وفيم لم تحافظ عليها من الضياع.
...
٩ - وعلى هذا الأساس من المفاوضات كان لا بد أن يظهر الوجه المقابل للصورة التي عرضها ابن التيهان رضي الله عنه. ولم يحمل لواءها رسول الله صلى الله عليه وسلم. إنما حمل لواءها واحد من طرف المفاوضين.
وإذا رأينا في الفقرة السابقة عظمة القيادة وتضحيتها وواجباتها. فما هي واجبات القاعدة مقابل ذلك؟
يقول العباس بن عبادة بن نضلة: هل تدرون علام تبايعون هذا الرجل؟ إنكم تبايعونه على حرب الأحمر والأسود من الناس. فإن كنتم ترون أنكم إذا نهكت أموالكم مصيبة وأشرافكم قتلا أسلمتموه فمن الآن، فهو والله خزي الدنيا والآخرة. وإن كنتم ترون أنكم وافون له بما دعوتموه إليه على نهكة الأموال وقتل الأشراف فهو والله خير الدنيا والآخرة.',NULL,'71',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (71,'وفي التعبير الآخر لسعد بن زرارة: ... وإن إخراجه اليوم مفارقة العرب كافة، وقتل خياركم.
...
١١ - فقالوا: ابسط يدك، فبسط يده فبايعوه. وقالوا: ربح البيع لا نقيل ولا نستقيل، وقالوا: يا أسعد أمط عنا يدك فوالله لا نذر هذه البيعة ولا نستقيلها. قال جابر: فقمنا إليه رجلا رجلا فأخذ علينا البيعة يعطينا بذلك الجنة.
وأما بيعة المرأتين اللتين شهدتا الوقعة فكانت قولا. ما صافح رسول الله صلى',NULL,'73',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (73,'الله عليه وسلم أمرأة أجنبية قط. وقبل المفاوضون بالبيعة وبايعوه جميعا دون أن يتخلف أحد، حتى المرأتين بايعتا بيعة الحرب. وصدقتا عهدهما. فلقد سقطت أم عمارة في أحد وقد أصابها اثنا عشر جرحا وقد قطع مسيلمة الكذاب ابنها إربا إربا فما وهنت وما استكانت وتحولت النسوة في هذه البيعة إلى رجال يقاتلن ويبايعن على قتل أشرافهن، وحرب الأحمر والأسود من الناس.
١٢ - ولم تنته القضية بعد، فلن يستطيع رسول الله صلى الله عليه وسلم أن يتصل مع كل فرد من هؤلاء المبايعين كل مرة، ولن يستطيع أن يبايع كل أفراد الأمة المسلمة على ذلك فلا بد من انتخاب قيادة مسؤولة أمامه مسؤولية مباشرة عن هذه القواعد.
...
وهذا يذكرنا بدور القيادة القائمة اليوم للحركة الإسلامية. فقد تم انتخابها من مستويات معينة، وأنيط بها أخطر مهمة في هذه الظروف، مهمة تحقيق وحدة الجماعة المبعثرة التي تقطعت أرحامها منذ سنوات عديدة وعاشت في جو محموم من الكراهية والضغينة، وتداركت رحمة الله هذه الحركة عندما أعطت ولاءها لله وارتفعت فوق خصوماتها وصراعاتها، ووحدت طريقها على الجهاد في',NULL,'74',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (74,'سبيل الله، وكانت بركة هذه الدماء الزكية بلسما لجراحها، حتى استطاعت أن تصل إلى قيادة موحدة وأمير واحد بايعته بيعة الحرب.
...
١٣ - وأين كان طواغيت الأرض من هذه البيعة الفريدة في تاريخ الأرض. أين كان مشركو المدينة والبيعة تتم على رؤوسهم. وأين كانت قريش والبيعة تريد أن تحطم طاغوتها وكبرياءها وهي تحاد الله وتكذب رسوله؟ وأين كان الحجيج المشرك كله. والبيعة تريد أن لا يحج بعد العام مشرك ولا يطوف بالبيت عريان. نقول هنا عن العدو القريب الذي كان وضع هؤلاء السبعين بالنسبة لهم كوضع اللقمة بين فكي الأسد؟؟',NULL,'75',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (75,'ولا نذكر ملوك الأرض الأبعدين كسرى وقيصر وحلفاءهما وعبيدهما: أين كان هؤلاء كلهم؟ كانوا يشخرون في نومهم ... وعين الله تكلأ العصبة المؤمنة.
...
١٤ - ووضع المبايعون أيديهم على مقابض السيوف ليستلوها من أغمادها أمام هذا النداء قائلين: لئن شئت يا رسول الله لنميلن غدا على أهل منى بأسيافنا. الاستعداد بالتو لتنفيذ بنود البيعة، وأكثر من البنود. ويأتي الجواب النبوي العظيم: لم نؤمر بذلك، ولكن ارفضوا إلى رحالكم.
بين معركة آنية يسقط بها هؤلاء السبعون شهداء. استجابة لنزوة طارئة وانفعال هائج وبين المسؤولية عن كل قطرة دم تسقط دون تخطيط وتسفح دون',NULL,'76',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (76,'هدف. إن دم المسلم أشد عند الله تعالى حرمة من الكعبة المشرفة. فكيف يسقط هدرا دون مقابل؟
...
فلا تك كالشاة التي كان حتفها ... بحفر ذراعيها فلم ترض محفرا',NULL,'78',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (78,'فهو رد على تحدي ضرار بالمعركة الحربية ولم ينس أن يرد على تحديه في الحرب الإعلامية:
...
١ - النشاط الإسلامي الدؤوب والسري في صفوف قيادات العدو وتحويلها إلى الخط الإسلامي هو هدف استراتيجي. ونجاح كبير للدبلوماسية الإسلامية. البراء، وعبد الله بن عمرو.
٢ - المحافظة على السرية التامة في التحركات أدعى ما يكون لنجاح أية خطة معدة.
٣ - الاستخبارات الإسلامية، أو جهاز الأمن للجماعة هو حاجة ماسة وأساسية في رصد تحركات العدو، والحيلولة بينه وبين اكتشاف أنشطة الحركة الإسلامية واجب تحتمه ظروف المعركة (علي رضي الله عنه. وأبو بكر. وحراستهما للطرق المؤدية للشعب).
٤ - الاستفادة من الطاقات والخبرات لغير المسلمين، والمأمونة الولاء للحركة الإسلامية، هو أمر متاح ومباح للحركة الإسلامية. بل واجب عليها حين لا يوجد إلا هذه الطاقات.',NULL,'79',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (79,'٥ - التمويه السياسي حيث يبقى للحركة الإسلامية رصيدها في التجمعات العادية وموثوقة فيها تستطيع أن تجعل الجماعة المسلمة في الصورة التامة عن أعدائها (٤، ٥ العباس).
...
١٢ - إستجابة القيادات لرغبات قواعدها واتجاهاتهم وربط مصيرها بمصيرهم (أحارب من حاربتم).',NULL,'80',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (80,'١٣ - تحديد أبعاد المعركة ونتائجها الخطيرة واحتمالاتها المتوقعة. وقيام البيعة على ضوء ذلك (حرب الأحمر والأسود من الناس، مفارقة العرب كافة، قتل الأشراف ونهكة الأموال والأعراض).
...
٢١ - تحديد القيادة المسؤولة عن التنفيذ، أو ما يمكن تسميته بالقيادة الميدانية أو مجلس الحرب أمر لا مناص منه لنجاح أي معركة مع العدو ((النقباء)).',NULL,'81',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (81,'٢٢ - ومن مهام القيادة النيابة عن الأمير في أخذ البيعة ممن انتخبها لهذا المركز وأناط بها هذه المسؤولية.
...
٢٩ - ولكن هذا لا يعني إغفال خطره. فمعسكر الشيطان ساهر ليل نهار، وقد يبرز لنا عدو لم يكن بالحسبان في لحظة مفاجئة. وقد يغدر حليف أو تكشف خطة. فالمحنة لا بد أن تأخذ أبعادها ولا تكون ردود الأفعال هي التي تحكم سير القيادة ولا الانشغال بمعركة جانبية أو هدف جزئي عن الهدف الأساسي.',NULL,'82',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (82,'٣٠ - كلما كانت عبقرية التخطيط السياسي أقوى أدت إِلى نجاح المهمات أكثر، وإِخفاء المخططات وتنفيذها عن العدو هو الكفيل بإذن الله بنجاحها. ((ولكن ارفضوا إلى رحالكم)).
...
٣٣ - عدم التصريحات اللامبالية من باب ردود الفعل. فلم نسمع لرسول الله صلى الله عليه وسلم كلمة أو تصريحاً حول سعد.
٣٤ - الإعداد الكامل للمعركة الإعلامية وحاجياتها ((جواب حسان لضرار)) والاستفادة من حرب الأعصاب.
٣٥ - السعي لأقامة دولة الإسلام في أقل ما يمكن من دماء، والاستفادة من كل القوانين والأعراف الدبلوماسية والسياسية المتاحة، ويبقى الهدف الأعلى أن رسول الله صلى الله عليه وسلم أقام دولته من دون أن تراق قطرة دم.

<span data-type="title" id=toc-27>ميثاق الدولة الجديد</span>
دخل رسول الله صلى الله عليه وسلم المدينة وهي ذات طوائف عدة قبلية ودينية شائكة. وتحضرنا اليوم سورية بطوائفها وأقلياتها الدينية والقومية. والحركة الإسلامية واجب عليها أن تعلن موقفها الصريح من هذه الطوائف، فلها بميثاق رسول الله صلى الله عليه وسلم الأسوة والقدوة. تتعلم منه كيف تقود شعبا متعدد العقائد والمشارب والمنازع. ويمكن أن نقسم الميثاق إلى أربعة أقسام أو أبواب:
ـ[الباب الأول]ـ: ميثاق المؤاخاة بين المسلمين.',NULL,'83',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (83,'ـ[الباب الثاني]ـ: ميثاق التناصر بين المسلمين وأتباعهم من غيرهم.
...
<span data-type="title" id=toc-28>الباب الأول</span>
المقدمة:
...
(٣) العاني: الأسير.',NULL,'84',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (84,'٨ - وبنو الأوس على ر بعتهم يتعاقلون معاقلهم الأولى. وكل طائفة منهم تفدي عانيها بالمعروف والقسط بين المؤمنين.
...
(٢) اعتبطه: قتله بلا جناية توجب القتل.',NULL,'85',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (85,'٢٥ - وإنه لا يحل لمؤمن أقر بما في هذه الصحيفة، وآمن بالله واليوم الآخر أن ينصر محدثا ولا يؤويه.
...
<span data-type="title" id=toc-29>الباب الثاني</span>
...
_________
(١) يوتغ: يهلك.',NULL,'86',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (86,'٤١ - وإنه لا يخرج منهم أحد إلا بإذن محمد صلى الله عليه وسلم.
...
٤٦ - وإن على يهود نفقتهم وعلى المؤمنين نفقتهم.
٤٧ - وإن بينهم النصر على من حارب أهل هذه الصحيفة.
٤٨ - وإن بينهم النصح والنصيحة والبر دون الإثم.

أحكام عامة <span data-type="title" id=toc-31>((الباب الرابع))</span>
...
٥٤ - وإنه ما كان بين أهل هذه الصحيفة من حدث واشتجار يخاف فشاده فإن مرده إلى الله عزوجل وإلى محمد رسول الله صلى الله عليه وسلم.
...
٥٩ - وإنهم إذا دعوا إلى مثل ذلك فإن لهم على المؤمنين.',NULL,'87',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (87,'٦٠ - إلا من حارب الدين.
...
ونقدم فيما يلي<span data-type="title" id=toc-32> ملاحظات </span>عامة بين يدي الإيضاح التفصيلي:
...
ـ[الملاحظة السابعة]ـ: كان التجمع الكبير هو الخزرج، ولكل قبيلة حكمها بما فيها من مسلمين ومشركين.',NULL,'88',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (88,'<span data-type="title" id=toc-33>مع الباب الأول: </span>ميثاق المؤاخاة بين المسلمين
١ - الكتاب من محمد رسول الله صلى الله عليه وسلم فهو الرسول المبلغ عن ربه، وهو الحاكم بشريعة الله سبحانه، وأمير المؤمنين من بعده يمثل سلطة التنفيذ.
٢ - الكتاب بين المؤمنين والمسلمين من قريش ويثرب ومن تبعهم فلحق بهم وجاهد معهم، فهو يمثل كتلة المسلمين الواحدة، أو ما نصطلح عليه اليوم بالجبهة الإسلامية.
٣ - ويعني هذا التحديد حرية التنظيم للعمل الإسلامي. فالفئات الإسلامية التي تعلن التزامها بالإسلام والجهاد في سبيله، وترتضي القيادة الجديدة للحكم الإسلامي فلا مساس بتنظيماتها.
٤ - هؤلاء جميعا أمة واحدة من دون الناس، فمفهوم الأمة قائم على أساس الدين.
٥ - المهاجرون من قريش على ربعتهم يتعاقلون بينهم ويفدون عانيهم بالمعروف والقسط بين المؤمنين. وقد ذابت الكيانات القبلية بين المهاجرين. فلا ضير أن تقوم الدولة الإسلامية بتنظيم المسلمين الوافدين إليها من خارج الدولة في تجمع واحد أو تجمعات حتى تحدد حقوقهم وواجباتهم.
٦ - لقد أخذ التنظيم الإسلامي في المدينة طابع القيادات القبلية فأبقى وضع الناس على حاله من هذه الناحية. والتنظيم الإسلامي اليوم يقوم على الارتباط بعالم أو داعية أو حزب ... ولا بأس من بقاء ذلك.
٧ - ونحن هنا إذن أمام ثلاث نماذج من التنظيم:
آ - نموذج التنظيم الحزبي ((قريش)).
ب - نموذج التنظيم القبلي ((بنو ... )).
ج - نموذج التنظيم العفوي ((وهؤلاء يتبعون للدولة مباشرة)).
٨ - وقد حدد الإسلام نوعين من الالتزامات المالية هي من مسؤولية هذا التنظيم،',NULL,'89',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (89,'هما: الدية وفك العاني. الدية تحملها القبيلة وكذلك فك الأسير من هذه القبيلة، وافتداؤه بالمال. والمقصود من هذا الأمر هو القضاء على السؤال والتسكع على الأبواب في المجتمع الإسلامي.
...
١٦ - وكم كان هذا النص ضروريا والمسلمون يخوضون معارك دامية ضد',NULL,'91',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (91,'الكافرين. ولو لم يكن هذا القيد لقتلوا بعضهم حمية وثأرا لآبائهم وإخوانهم. إن هذا النص تحطيم ثالث للقبلية الجاهلية التي قد تدفع بعض أبناء القبيلة للانتقام من كافر فيها استحق القتل، فيستعر القتل بين المؤمنين.
١٧ - والذي يعنينا من هذا النص في واقعنا الإسلامي المعاصر هو القضاء على النزعات الجاهلية الوطنية والقومية والقبلية التي تريدنا أن نثأر للعرب لكونهم عربا فقط ولو كانوا يحاربون الله ورسوله وجماعة المؤمنين. ولا بد حتى يفهم هذا النص على حقيقته من ربطة بالنص السابق، فالمؤمنون كلهم على الباغي والدولة المسلمة هي التي تحقق فتقتل الباغي وتنصر المظلوم.
١٨ - ((وأن ذمة الله واحدة يجير عليهم أدناهم)) فكرامة أدنى فرد من المسلمين وكلمته تسري على جميع المسلمين، وإجارته لشخص ينفذها رئيس الدولة. وجهاز السلطة. فأدنى المسلمين وأكبرهم سواء. وكما قلنا فهذا الميثاق هو في البناء الداخلي الذي يعلمنا قيمة الفرد في الجماعة المسلمة وقيمة المسلم مهما ضؤل شأنه فله حق الأجارة لكافر ويسري هذا الحق على المسلمين جميعا فلا يتعرض له أحد بسوء طالما أنه في إجارة هذا المسلم.
١٩ - والولاء والنصرة بين المؤمنين، إن رابطة الولاء والتناصر قائمة على أساس العقيدة لا على أساس القرابة أو النسب أو الوطنية أو الأرضية المحلية أو القومية الكبيرة.
٢٠ - وليس هذا الولاء فقط للمؤمنين. بل حتى غير المؤمنين الذين ارتضوا ولاءهم وقيادتهم وساروا في مخططاتهم كما يقول النص النبوي ((وأن من تبعنا من يهود فإن له النصر والأسوة غير مظلومين ولا متناصر عليهم)).
فمثل هؤلاء الأفراد الذين يقدمون ولاءهم للحركة الإسلامية رغم اختلافهم معها في العقيدة يعرضون أنفسهم للخطر الماحق من فئاتهم أو',NULL,'92',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (92,'طوائفهم. والحركة الإسلامية مسؤولة عن حمايتهم والدفاع عنهم لهم حق النصر ولكن ليس لهم حق البغي، واحتمال بغيهم كبير لأن منطلقهم الإسلامي ضعيف. فحدد لهم النص النبوي ما لهم وما عليهم، واعتبرهم رسول الله صلى الله عليه وسلم جزءا من البناء الداخلي، يأخذون أحكام الولاء بين المؤمنين.
...
INSERT INTO [b95662] VALUES (93,'المجاهدون في الأرض هم وحدهم على أحسن هدي وأقومه.
٢٤ - ولئن ذكرت الإجارة في البند ١٧ فهذا توضيح لحدودها ونوع جديد لها. فلا إجارة لعدو محارب من مشرك مهادن معنا. ولا أمان له إلا من القيادة مباشرة. ولا أمان لمال عدو محارب إلا من القيادة مباشرة ((وإنه لا يجير مشرك مالا لقريش ولا نفسا ولا يحول دونه على مؤمن)). فعند إباحة دم الكافر المحارب وإباحة ماله فلا يستطيع مشرك مشترك معه في العقيدة أن يحول دونه أو دون ماله.
٢٥ - وقاتل المؤمن عندما يكون مشركا بلا جناية توجب القتل للمؤمن. فالأصل قتل المشرك إلا إذا رضي ولي المقتول. فكرامة المشرك المهادن محفوظة بشرطين: أن لا يكون قد قتل بباطل، أو أن يعفو ولي المقتول. فإذن من انضم للحركة الإسلامية في تنفيذ مهمة من مهماتها له الصلاحيات نفسها التي للمؤمنين، إلا حق الإجارة لغيره إن كان من المحاربين لأن الأصل عنده حنينه لمن هو على عقيدته.
٢٦ - وتأكيد آخر أن المؤمنين على الظالم - مؤمنا كان الظالم أو مشركا- حتى لا يتسكع أحد وراء وساطة بقريب أو متنفذ أو حسيب أو حاكم. ((وأن المؤمنين عليه كافة ولا يحل إلا قيام عليه)).
٢٧ - وطالما أن الأمر في البناء الداخلي، وأنه لا بد أن يعرف أعضاء الحركة الإسلامية وأتباعها ما لهم وما عليهم. فلا بد أن يعرفوا شيئا مهما جدا أن نصر الباغي والدفاع عنه وحمايته باسم قرابة أو سلطان أو صداقة هو خروج على الإيمان بالله واليوم الآخر. وليس نصره وحمايته فقط، بل وإخفاؤه أو إيواؤه أو التستر عليه (( ... أن ينصر محدثا ولا يؤويه)).',NULL,'94',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (94,'٢٨ - وعقوبته لا تحتاج إلي مزيد إيضاح (( ... فإن عليه لعنة الله وغضبه ... )).
...
<span data-type="title" id=toc-34>مع الباب الثاني</span>
...
٣٤ - وعند ذكر يهود بني ثعلبة بالذات تتكر رفقرة ((إلا من ظلم وأثم فإنه لا يوتغ',NULL,'95',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (95,'إلا نفسه)) ولعل هذا يعني أن بني ثعلبة كانوا جميعا يهودا لم يسلم منهم أحد، فأكد في فقرتهم على ذكر الظلم والإثم كما أكد في بند آخر على مواليهم بأنهم مثلهم ولهم نفس حقوقهم، وبين في بند آخر أن جفنة بطن من ثعلبة.
...
<span data-type="title" id=toc-35>مع الباب الثالث</span>
وهو أقرب ما يكون لأن يمثل الحلف السياسي. فاليهود هنا تجمعات كبيرة احتاج إنهاؤهم عندما نقضوا العهد إلى حروب وحصار. لهم سلطانهم الخاص',NULL,'96',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (96,'وأراضيهم وقلاعهم وبيوتهم ورغم أن البنود قصيرة جدا وهي تخصهم بالذات. إلا أن الأحكام العامة في الباب الرابع تكاد تتناولهم كذلك.
...
إنه ليس استطرادا مزاجيا بل هو قواعد مقررة. فحق التناصر قائم، والاستفادة من حرب الحليف للعدو قائم. وهذا ميثاقنا إمامنا وضعه رسول الله صلى الله عليه وسلم ولم ينس حق اليهودي الضائع في قرية، ولا حق يهود المجتمعين في قبيلة. ولا حق اليهود القائمين في دولة. دون أن يفرضه عليه أحد إنما هو تنفيذ لتشريع الله. ومن أصدق من الله قيلا؟ والحركة السياسية المسلمة هي',NULL,'98',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (98,'التي تكون قادرة بذكائها على أن تزج بطاقات حلفائها كلهم في المعركة طالما أن بينهم النصر على من حارب هذه الصحيفة.
...
<span data-type="title" id=toc-36>مع الباب الرابع: </span>أحكام عامة
...
٤٧ - ((وإن الجار كالنفس غير مضار ولا آثم)) فحق الجوار في الإسلام يرتفع إلى حق النفس. على أن لا يقدم هذا الجار ضرارا ولا إثما. وبذلك يكون التكافل في أعلى درجات القوة.
٤٨ - ((وإن النصر للمظلوم)) مبدأ عام يدخل في إطاره آلاف البنود أثناء التفاوض. فكل تخوف قد يبديه المفاوض غير الإسلامي من ظلم في المستقبل فمن واجب المفاوض الإسلامي أن يتعهد له بعدم وقوعه. فلا ظلم في الإسلام. والنصر للمظلوم مهما كان جنسه أو دينه ...
٤٩ - ((وإن يثرب حرام جوفها لأهل هذه الصحيفة)) ويقابل هذا اليوم أن',NULL,'99',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (99,'سورية حرام جوفها لمن أقر بهذا العهد، فلا تنتهك حرمة، ولا يعتدى على عرض، ولا يصادر مال ... إلا بحق الإسلام. وكل مواطن يخضع للإسلام فهو آمن.
...
٥٥ - ((وإذا دعوا إلى صلح يصالحونه، ويلبسونه، فإنهم يصالحونه ويلبسونه)) وحتى تكون سلطة الجماعة المسلمة قائمة فمن حقها أن تشترط على حلفائها أن',NULL,'100',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (100,'يستجيبوا لأي صلح رأت هي ذلك. فلا بد أن يكون الموقف واحدا واضحا. وتعني هذه الفقرة أن من صلاحيات المفاوض الإسلامي أن يجعل أي صلح مع عدو لا يتم إلا بالأكثرية، أولا يتم إلا بالإجماع. فالمشاورات السياسية مستمرة لتحديد الموقف الأفضل من العدو.
...
<span data-type="title" id=toc-37>أولا: ميثاق الجبهة الإسلامية</span>
...
٣ - وأن يكونوا مؤمنين بضرورة الجهاد للقضاء على الطاغوت.',NULL,'102',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (102,'٤ - وهذه الجبهة ومن سار في خطها أمة من دون الناس، وكيان مستقل متميز عن أي كيان آخر.
...
١٤ - وأصدقاء التنظيمات الإسلامية في الجبهة من أفراد عاديين يقدمون الولاء لهذا التنظيم فمن حق الجبهة أن تضمن لهم النصر والحماية والمساعدة إذا وقع',NULL,'103',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (103,'عليهم بغي أو اعتداء بسبب صداقتهم أو تعاونهم مع تنظيمات الجبهة.
...
٢٤ - ولا بد من محكمة إسلامية تختارها الجبهة، تؤول إليها الخلافات وتحلها على ضوء كتاب الله وسنة رسوله. وقرارات هذه المحكمة ملزمة للتنظيم وأفراده.',NULL,'104',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (104,'<span data-type="title" id=toc-38>ثانيا: ميثاق عامة الشعب</span>
...
٣٥ - لا يحق لأي مواطن أن يخل بالأمن العام للأمة أو يثير الشغب أو يعتدي على الحرمات.',NULL,'105',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (105,'٣٦ - المال والدم والوطن محفوظ لكل مواطن. لا يعتدى على أي من الأموال إلا بإذن أهلها.
...
٤٦ - يحق له أن يتصرف بما تبيحه له عقيدته، ويمتنع عما تحرمه عليه هذه العقيدة. ما لم يؤد هذا إلى المساس العام بالنظام الإسلامي، أو يمس حرية وعقيدة الآخرين.',NULL,'106',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (106,'٤٧ - يشارك كل مواطن في اختيار من يمثله في تنظيمه الخاص به. ولا علاقة للدولة بذلك.
٤٨ - يحق للمواطن إبداء أي رأي يراه من خلال تنظيمه الخاص أو من خلال موقفه الفردي.

<span data-type="title" id=toc-39>ثالثا: ميثاق الفئات والتجمعات غير الإسلامية</span>
٤٩ - كل البنود العامة تسري على جميع أبناء الشعب في تجمعاته الإسلامية وتجمعاته غير الإسلامية. والأفراد العاديين في تنظيمهم الخاص.
٥٠ - التجمعات غير الإسلامية لها حق البقاء طالما رضيت الخضوع للنظام الإسلامي، وقبلت بالإسلام مصدرا للتشريع.
٥١ - لهذه التجمعات استقلالها الذاتي فيما يتعلق بالتعليم، والعقيدة، والمحاكم الخاصة فيها. بحيث لا تشكل خطرا على النظام الإسلامي.
٥٢ - المجالس المحلية للحكم تنبثق من هذه التجمعات بحيث يمكن أن تنتهي إلى مجلس واحد شامل يقوم بتنفيذ الحكم على ضوء شريعة الله.
٥٣ - ما يتعلق بالإصلاحات العامة غير المرتبطة بالتحليل والتحريم يمكن أن يشترك فيها ممثلون عن هذه التجمعات.
٥٤ - فيما يتعلق بالسياسة العامة للدولة فبإمكان هذه التجمعات المشاركة فيها. مثل الحرب والسلم ولرأيها وزنه وقيمته. ما لم تقم على أساس محاربة الإسلام ودولة المسلمين. والدعوة إلى مهادنة هؤلاء.
٥٥ - فيما يتعلق بالنظام المدني. فللتجمعات اختيارها في أن تحتكم للنظام الإسلامي أو لنظامها المدني الخاص. ما لم ينص به على ما يخالف النظام الإسلامي العام.
٥٦ - فيما يتعلق بالنظام الجنائي يطبق النظام الجنائي الإسلامي أما في الحدود التي لا تمس النظام الإسلامي العام فيمكن أن تطبق فيها أحكامهم.',NULL,'107',NULL,NULL,'0');
INSERT INTO [b95662] VALUES (107,'٥٧ - فيما يتعلق بالاشتراك في الحكم العام فمن حق الدولة الإسلامية أن تشرك من تشاء أو ترى فيه مصلحة لها. على أن يقوم بتنفيذ أحكام الشريعة الإسلامية وتستفيد الدولة المسلمة من هذه الخبرات على ضوء مصلحتها التي يقررها الإمام المسلم وقيادة المسلمين.
...
وآخر دعوانا أن الحمد لله رب العالمين',NULL,'108',NULL,NULL,'0');
