...
CREATE TABLE "b36405"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36405
INSERT INTO [b36405] VALUES (1,'رسالة إلى أخي في الله

د. مجدي الهلالي

http://www.alemanawalan.com/',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b36405] VALUES (2,'<span data-type="title" id=toc-1>إهداء</span>
...
أهدي هذه الرسالة',NULL,'1',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (3,'بسم الله الرحمن الرحيم
...
ولا تستطيع أي قوة أرضية أن تُنشئ مثل هذه العلاقة لأنها من عند الله {وألف بين وَأَلَّفَ بَيْنَ قُلُوبِهِمْ لَوْ أَنْفَقْتَ مَا فِي الْأَرْضِ جَمِيعًا مَا أَلَّفْتَ بَيْنَ قُلُوبِهِمْ وَلَكِنَّ اللَّهَ أَلَّفَ بَيْنَهُمْ إِنَّهُ عَزِيزٌ حَكِيمٌ} [الأنفال/٦٣].
ولأن هذه العلاقة بدأت من عند الله، كان استمرارها مشروطا بأن تظل من أجل الله، فتكون نهايتها عند الله {وَأَنَّ إِلَى رَبِّكَ الْمُنْتَهَى} [النجم/٤٢]، فصار بحق من أوثق عرى الإيمان كما قال صلى الله عليه وسلم: " أوثق عرى الإيمان الحب في الله والبغض في الله " (١).
...
_________
(١) حديث صحيح: أخرجه ابن أبي شيبة في مصنفه من حديث البراء بن عازب.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (4,'وخلاصة القول: إنه من الواجب علينا أن نحب المرء بمقدار ما فيه من صفات يحبها الله، ونبغضه بمقدار ما فيه من صفات يبغضها الله عز وجل.
...
(٢) متفق عليه.
(٣) حديث صحيح: أخرجه ابن أبي شيبة في مصنفه من حديث البراء بن عازب.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (5,'أخي ..

<span data-type="title" id=toc-3>من ذاق عرف</span>
...
إننا يا أخي غرباء بين الناس، فنحن نعمل على تطبيق الإسلام بيننا في الوقت الذي أصبح فيه الإسلام غريبًا بين أهله كما أخبرنا بذلك المعصوم صلى الله عليه وسلم عندما قال: " بدأ الإسلام غريبا وسيعود غريبا فطوبى للغرباء " (١).
...
****
أخي في الله:
من علامات صدق أخوتنا وحبنا في الله: إعانة كل منا للآخر على التقرب إلى الله، كما كان الصحابي يقول لأخيه: اجلس بنا نؤمن ساعه (٢).
فيُذكر كل منا الآخر بفعل الخيرات، ويعينه على أدائها وينهاه عن فعل المنكرات ويعينه على اجتنابها.
فنذكر الله، ونقرأ القرآن، ونقوم الليل، ونصوم النهار، ونتدارس في كتب العلم سويا، وغير ذلك من الفضائل التي حثنا الله عليها - ما تيسر ذلك - وبهذا يتحقق مقياس الأخوة الذي ذكره الله عز وجل على لسان سيدنا موسى {وَاجْعَلْ لِي وَزِيرًا مِنْ أَهْلِي (٢٩) هَارُونَ أَخِي (٣٠) اشْدُدْ بِهِ أَزْرِي (٣١) وَأَشْرِكْهُ فِي أَمْرِي (٣٢) كَيْ نُسَبِّحَكَ كَثِيرًا (٣٣) وَنَذْكُرَكَ كَثِيرًا (٣٤) إِنَّكَ كُنْتَ بِنَا بَصِيرًا} [طه/٢٩ - ٣٥].
وبذلك يجذب كل منا الآخر إلى أعلى، فتصبح لقاءاتنا على ما يحبه الله، وفراقنا بالتواصي على ذلك أيضًا، فنصير بحق كالرجلين اللذين أشار إليهما النبي صلى الله عليه وسلم في حديث السبعة الذين يظلهم الله بظله يوم لا ظل إلا ظله: " ورجلان تحابا في الله، اجتمعا عليه وتفرقا عليه " (٣).
****
_________
(١) حديث صحيح: أخرجه مسلم برقم ٢٣٤ من حديث أبي هريرة رضي الله عنه.
(٢) إسناده حسن: أخرجه ابن أبي شيبة برقم: (٢٩٧٥٢).
(٣) جزء من حديث صحيح متفق عليه: أخرجه البخاري برقم: (٦٤٠)، ومسلم برقم: (١٧٧٤).',NULL,'4',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (6,'أخي في الله ..
...
(٤) حديث صحيح، متفق عليه: أخرجه البخاري برقم (٥٩٤١)، ومسلم برقم (٤١٤٩) من حديث عبد الله بن مسعود رضي الله عنه.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (7,'وتأمل ما حدث بين الصحابة عندما كانوا يسيرون مع النبى صلى الله عليه وسلم فنام رجل منهم، فانطلق بعضهم إلى حبل معه فأخذه، فقال رسول الله صلى الله عليه وسلم: " لا يحل لمسلم أن يروع مسلمًا " (١).
****
أخى فى الله:
...
(٥) حديث صحيح: أخرجه الترمذي برقم (٢٢٩٥)، وابن ماجه برقم (٣٩٧٤) من حديث أبي هريرة رضي الله عنه.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (8,'يقول الله عز وجل: {وَقُلْ لِعِبَادِي يَقُولُوا الَّتِي هِيَ أَحْسَنُ إِنَّ الشَّيْطَانَ يَنْزَغُ بَيْنَهُمْ} [الإسراء/٥٣]، فليحرص كل منا على انتقاء ألفاظه مع الآخر، فرب كلمة جاءت في غير موضعها تركت آثارًا سيئة للغاية في نفس مستمعها.
...
****
أخي في الله ..
- إذا أسديت إليّ معروفا فلا تحاول أن تمن عليّ به فتجرحني بذلك وتذكر قول الله عز وجل: {يَا أَيُّهَا الَّذِينَ آَمَنُوا لَا تُبْطِلُوا صَدَقَاتِكُمْ بِالْمَنِّ وَالْأَذَى} [البقرة/٢٦٤].',NULL,'7',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (9,'- تعود يا أخي على العطاء بلا مقابل، فالأخوة مغرم وليست مغنمًا، وتذكر معنى الإيثار {وَيُؤْثِرُونَ عَلَى أَنْفُسِهِمْ وَلَوْ كَانَ بِهِمْ خَصَاصَةٌ} [الحشر/٩].
- واستصغر دائمًا ما تقدمه لإخوانك، واستعظم ما يقدمونه لك.
- ليرحم كل منا الآخر، وليحتمله في غضبه، ولنكن كما قال تعالى: {أَذِلَّةٍ عَلَى الْمُؤْمِنِينَ أَعِزَّةٍ عَلَى الْكَافِرِينَ} [المائدة/٥٤].
...
ليعمل كل منا على ألا يحسد الآخر على ما يرى عليه من آثار نعم الله، بل يفرح بذلك، ويحمد الله على ما يرى من النعمة على أخيه، كما يحمده على نعمته على نفسه، كما قال صلى الله عليه وسلم: " لا يؤمن أحدكم حتى يحب لأخيه ما يحب لنفسه " (١).
...
لا تقابلني بعبوس وجه مهما كانت ظروفك ومشاكلك، فأنت لا تعلم مدى تأثير رؤيتك عليّ، فاحرص يا أخي على بشاشة الوجه عند رؤيتي، وتذكر قول الرسول صلى الله عليه وسلم: " كل معروف صدقة، وإن من المعروف أن تلقى أخاك بوجه طلق، وأن تفرغ من دلوك في إناء أخيك " (٢).
ليحرص كل منا على رد المظالم للآخر، فكما قال صلى الله عليه وسلم: " من كانت عنده مظلمة لأخيه من عرضه أو شيء، فليتحلله منه اليوم قبل ألا يكون دينار ولا درهم، إن كان له عمل صالح أخذ منه بقدر مظلمته، وإن لم يكن له حسنات، أخذ من سيئات صاحبه فحُمل عليه " (٣).
...
_________
(١) حديث صحيح، متفق عليه: أخرجه البخاري برقم (١٣)، ومسلم برقم (٨٩) من حديث أنس بن مالك رضي الله عنه.
(٢) قال الشيخ الألباني - رحمه الله -: حديث صحيح لغيره. أخرجه الترمذي برقم (١٩٤٢)، وأحمد برقم (١٤٦١٣) من حديث جابر بن عبد الله رضي الله عنهما.
(٣) حديث صحيح: أخرجه البخاري برقم (٢٣٣٧) من حديث أبي هريرة رضي الله عنه.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (10,'- وقد نكون شركاء في عمل تجاري نتكسب منه؛ فلا يستحي أي منا أن يخبر الآخر بكل ما في نفسه ويتفق معه على الصغيرة والكبيرة منذ البداية.
...
****
أخي ..
يا من أنتظر لقاءه، وأسعى إلى رؤيته، لا تنسني وقت الغروب، واذكرني في دعائك، عسى الله أن يجمع بيننا في الجنة كما جمع بين قلوبنا في الدنيا {إِخْوَانًا عَلَى سُرُرٍ مُتَقَابِلِينَ} [الحجر/٤٧].
ولعله سبحانه يظلنا في ظله يوم لا ظل إلا ظله، ويسوقنا سويًّا مع زُمَر الصالحين إلى الجنة {وَسِيقَ الَّذِينَ اتَّقَوْا رَبَّهُمْ إِلَى الْجَنَّةِ زُمَرًا} [الزمر/٧٣].
...
عن أنس رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم: " إذا دخل أهل الجنة الجنة فيشتاق الإخوان بعضهم إلى بعض، قال: فيسير سرير هذا إلى سرير هذا، وسرير هذا إلى سرير هذا حتى يجتمعا جميعًا، فيقول أحدهما لصاحبه: تعلم متى غفر الله لنا؟ فيقول صاحبه: يوم كنا في موضع كذا وكذا فدعونا الله فغفر لنا " (١).
****
وفي النهاية:
_________
(١) قال الشيخ الألباني - طيب الله ثراه - حديث ضعيف. أخرجه ابن أبي الدنيا في " صفة الجنة " برقم (٢٣٤)، من حديث أنس بن مالك رضي الله عنه.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b36405] VALUES (11,'فإني أكتب هذه الوصايا ولا أرى أحدًا أحوج إليها من نفسي، أسأل الله عز وجل أن يعيننا على القيام بحقوق الأخوة.
وأسأله تعالى أن يتقبل منها، وان يغفر لنا، وأن يثبتنا على طريقه، إنه سميع مجيب،،،
والحمد لله رب العالمين

http://www.alemanawalan.com/',NULL,'10',NULL,NULL,'0');
