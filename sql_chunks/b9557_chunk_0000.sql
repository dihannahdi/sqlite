...
CREATE TABLE "b9557"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b9557
INSERT INTO [b9557] VALUES (1,'<span data-type="title" id=toc-1>التعريف بعلم العلل</span>',NULL,'1',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (2,'بسم الله الرحمن الرحيم
...
السبت ٢٣/٣/١٤٢٤هـ',NULL,'2',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (3,'<span data-type="title" id=toc-3>الفصل الأول: تعريف العلة</span>.

<span data-type="title" id=toc-4>المسألة الأولى: تعريف العلة في اللغة</span>.
...
والثالث: العلة المرض، وصاحبها معتل، قال ابن الأعرابي: (علّ المريض: يعل فهو عليل) .',NULL,'3',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (4,'<span data-type="title" id=toc-5>المسألة الثانية: تعريف العلة في اصطلاح المحدثين</span>.
...
وإنما أراد الحاكم في تعريفه للحديث المعلول بيان أدق صوره وأغمض أنواعه _ وعلى هذا المعنى وردت عبارات للأئمة ذكروا فيها صعوبة هذا العلم وغموضه ودقته _ ولذلك أورد الحاكم بعد تعريفه السابق قول عبد الرحمن بن مهدي: (لئن أعرف علة حديث عندي أحب إلي من أكتب عشرين حديثاً ليس عندي) .
...
وإنما من أجل عدم سماع راو من آخر،كما في علل ابن أبي حاتم: (١٣٨) .

بل وجدت ابن أبي حاتم أورد في كتابه العلل أحاديث لأغراض أخرى!
فأورد أحاديث من أجل الاستفهام عن أحد الرواة الواردين في الإسناد من هو؟! : (٢٩٥، ٦٦٠، ٦٩٣، ١١٠٨ وغيره) .
...
وقد حاول السخاوي أن يخرج وجود العلل التي ليست بخفية في كتب العلل فقال: (ولكن ذلك منهم (أي من أصحاب كتب العلل الذين يذكرون ما ليس بخفي) بالنسبة للذي قبله قليل، على أنه يُحتمل أيضاً أن التعليل بذلك من الخفي، لخفاء وجود طريق آخر ينجبر بها ما في هذا من ضعف، فكأن المعلل أشار إلى تفرده) .',NULL,'4',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (5,'<span data-type="title" id=toc-6>فائدتان:</span>
...
الفائدة الثانية: أفرد المتأخرون ممن كتبوا في علوم الحديث أبواباً ومصطلحات حديثية، وهي في حقيقة الأمر داخلة في العلل، كالاختلاف في الوصل والإرسال والرفع والوقف والمقلوب والمدرج والمضطرب وزيادة الثقة والشاذ.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (6,'<span data-type="title" id=toc-7>المسألة الثالثة: علاقة المعنى اللغوي بالمعنى الاصطلاحي</span>.
...
إلا أن للمعنيين الآخرين علاقة بالعلة عند المحدثين، فالمعنى اللغوي الأول يدخل في وسيلة تحصيل العلة، والمعنى الثاني هو نتيجة وثمرة وجود العلة',NULL,'6',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (7,'<span data-type="title" id=toc-8>المسألة الرابعة: ما هو القياس في الحديث الذي طرأت عليه العلة</span>؟
...
١٠_ وابن عبد البر في التمهيد (١٦/٢٣٧) .
...
_ ابن سيده (ت ٤٥٨هـ) صاحب المحكم حيث قال: (والعلة: المرض. علّ يعِل واعتل، وأعله الله، ورجل عليل.
...
ولعل هذا جائز نظراً لأن أصل الكلمتين واحد، ولوجود علاقة بين معنى الكلمتين، فإن معنى الكلمة الأولى وهو التكرار هو وسيلة لكشف العلة المأخوذ تعريفها من المعنى الثالث وهو المرض.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (8,'<span data-type="title" id=toc-9>فائدة: أيهما أولى استعمال معلول أو معلل</span>؟
...
ولولا خشية الإطالة لذكرت كلامهم.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (9,'<span data-type="title" id=toc-10>الفصل الثاني: طرق معرفة العلة</span>.
...
قال ابن رجب: (حذاق النقاد من الحفاظ لكثرة ممارستهم للحديث ومعرفتهم بالرجال وأحاديث كل واحد منهم، لهم فهم خاص يفهمون به أن هذا الحديث يشبه حديث فلان، ولا يشبه حديث فلان، فيعللون الأحاديث بذلك. وهذا مما لا يعبر عنه بعبارة تحصره، وإنما يرجع فيه إلى أهله، إلى مجرد الفهم والمعرفة التي خصوا بها عن سائر أهل العلم) .',NULL,'9',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (10,'<span data-type="title" id=toc-11>الفصل الثالث: أقسام العلة وأنواعها</span>.

يمكن تقسيم العلة بعدة اعتبارات:

أ_ تقسيم العلة بحسب تأثيرها.
فالعلة بحسب تأثيرها على قسمين:
١_علة قادحة: وهي العلة التي يُضعّف الحديث من أجلها.
٢_وعلة غير قادحة: وهي العلة التي لا يُضعف بها الحديث.
...
وقد قسمها أبوعبد الله الحاكم في كتابه معرفة علوم الحديث (١١٣) إلى عشرة أقسام، ولم يذكر تعريفاً لكل نوع وإنما اكتفى ببيان أمثلة لكل نوع.

وجاء السيوطي بعده في تدريب الراوي (١/٢٥٨) وذكر هذه الأنواع باختصار معرفاً لكل نوع منها، فقال:
...
قال هذا إسناد لا ينظر فيه حديثي إلا ظن أنه من شرط الصحيح، والمدنيون إذا رووا عن الكوفيين زلقوا، وإنما الحديث محفوظ عن رواية أبي بردة عن الأغز المزني.
...
قال الحاكم وبقيت أجناس لم نذكرها وإنما جعلنا هذه مثالا لأحاديث كثيرة.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (11,'<span data-type="title" id=toc-12>الفصل الرابع: أهمية علم علل الحديث</span>.
...
وقال أيضاً: (وبهذا التقرير يتبين عظم موقع كلام الأئمة المتقدمين، وشدة فحصهم، وقوة بحثهم، وصحة نظرهم، وتقدمهم بما يوجب المصير إلى تقليدهم في ذلك، والتسليم لهم فيه) .',NULL,'13',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (14,'<span data-type="title" id=toc-13>الفصل الخامس: مصنفات العلماء في علل الحديث</span>.

نظراً لقيام بعض الباحثين بتتبع المصنفات المؤلفة في علل الحديث الموجود منها والمفقود (١) ، فإنني سأكتفي ببيان المطبوع منها:
١ـ علل الحديث ومعرفة الرجال لعلي بن المديني (ت ٢٣٤هـ) ـ رواية ابن البراء ـ له طبعتان، الأولى: بتحقيق: الدكتور عبد المعطي أمين قلعجي، والثانية: بتحقيق محمد مصطفى الأعظمي.
٢ـ العلل ومعرفة الرجال للإمام أحمد بن حنبل (ت ٢٤١هـ) رواية ابنه عبد الله ـ تحقيق: الدكتور وصي الله عباس.
٣ـ العلل ومعرفة الرجال للإمام أحمد بن حنبل ـ رواية المروذي وغيره ـ له طبعتان، الأولى: بتحقيق الدكتور وصي الله عباس، والثانية بتحقيق صبحي البدري السامرائي.
٤ـ التمييز الإمام مسلم بن الحجاج ـ تحقيق الدكتور محمد الأعظمي.
٥ـ علل الترمذي الكبير ـ بترتيب أبي طالب القاضي ـ (ت ٢٧٩هـ) ، تحقيق حمزة ديب مصطفى.
٦ـ علل الأحاديث في كتاب الصحيح لأبي الفضل ابن عمار الشهيد (ت ٣١٧ هـ) ، تحقيق: علي حسن علي عبد الحميد الحلبي.
٧ـ علل الحديث لابن أبي حاتم (ت ٣٢٧ هـ) ، تحقيق: محب الدين الخطيب وقد شرح جزءً منه ابن عبد الهادي، وقد طبع قريباً.
٨ـ العلل للدارقطني (ت ٣٨٥ هـ) ، تحقيق: الدكتور: محفوظ الرحمن زين الله السلفي.
٩ـ المنتخب من العلل للخلال لابن قدامة، تحقيق: طارق عوض الله.
١٠ـ علة الحديث المسلسل في يوم العيدين للحافظ أبي محمد الجرجاني (ت ٤٨٩هـ) ، تحقيق: الدكتور محمد التركي.
١١ـ العلل المتناهية في الأحاديث الواهية لابن الجوزي (ت ٥٩٧هـ) ، تحقيق: إرشاد الحق الأثري.
١٢ـ شرح علل الترمذي لابن رجب (ت ٧٩٥هـ) ، له ثلاث طبعات، الأولى: تحقيق الدكتور همام عبد الرحيم سعيد، والثانية: تحقيق الدكتور نورالدين عتر، والثالثة: بتحقيق صبحي السامرائي.

وهناك كتب هي مظان للأحاديث المعلة وفيها نقولات عن أئمة العلل، فمنها:
أـ كتب الأحاديث المسندة، مثل:
ـ السنن الكبرى للنسائي (ت ٣١٣هـ)
ـ المسند للبزار (ت ٢٩٢هـ) .
ـ معاجم الطبراني (ت ٣٦٠هـ) .

ب ـ كتب التراجم، مثل:
ـ تواريخ البخاري (ت ٢٥٦هـ) .
ـ الضعفاء للعقيلي (ت ٣٢١هـ) .
ـ الكامل لابن عدي (ت ٣٦٥هـ) .
...
ـ التاريخ الكبير لابن أبي خيثمة (ت ٢٧٩هـ) وهو مخطوط، وطبع منه قسم أخبار المكيين.
ـ تاريخ بغداد للخطيب (ت ٤٦٣هـ) .
ـ تاريخ دمشق لابن عساكر (ت ٥٧١هـ) .
...
وإليك ما وجدته:
١ـ الحديث المعلل، إعداد: الدكتور خليل إبراهيم ملا خاطر.
٢ـ العلل في الحديث، دراسة منهجية في ضوء شرح العلل لابن رجب، مع ترجمة ضافية لابن رجب، للدكتور: همام عبد الرحيم سعيد.
٣ـ الحديث المعلول قواعد وضوابط، للدكتور حمزة عبد الله مليباري.
٤ـ علم علل الحديث من خلال كتاب بيان الوهم والإيهام لابن القطان الفارسي، للدكتور إبراهيم بن الصديق الغماري.
٥ـ شرح علل الحديث مع أسئلة وأجوبة في مصطلح الحديث، تأليف: أبي عبد الله مصطفى ابن العدوي. وهو كتاب للمبتدئين.
٦ـ أثر علل الحديث في اختلاف الفقهاء، تأليف: د/ ماهر ياسن فحل.
٧ـ مرويات الزهري المعلة، للدكتور عبد الله دمفو.
٨ـ أحاديث معلة ظاهرها الصحة، للشيخ مقبل بن هادي الوادعي رحمة الله.
_________
(١) ذكر الدكتور محفوظ الرحمن في مقدمة تحقيقه لعلل الدارقطني (١/٤٧) خمسين كتاباً، أما الدكتور وصي الله عباس فذكر في مقدمة تحقيقه لمعرفة العلل لأحمد (١/٣٩) ستة وخمسين كتاباً، ثم من جاء بعدهما حاول أن يضيف عليهما، فأضاف الدكتور عبد الله دمفو في مقدمة كتابه مرويات الزهري المعلة (١/٨٦) ثمانية كتب، وأضاف الدكتور عبد الله بن عبد المحسن التويجري في مقدمة تحقيقه للقسم الأول من علل ابن أبي حاتم سبعة كتب، وأضاف الدكتور إبراهيم بن الصديق الغماري في مقدمة كتابه علم علل الحديث من خلال كتاب بيان الوهم والإيهام ثمانية كتب، وأضاف الدكتور محمد التركي في مقدمة تحقيقه لقسم من علل ابن أبي حاتم (١/٤٧) ثمانية كتب.
وفي بعض ما ذكروه تكرار، وفي بعضه نظر: لأن بعضهم ذكر بعض الكتب وإنما هي من مظان العلل وليست مخصصة له.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b9557] VALUES (15,'هذا ما تيسر كتابته حول علم العلل، ولعل الله أن ييسر كتابة مسائل أخر حول علم العلل أيضاً تجلي بعض جوانبه وتوضح بعض غوامضه.

أسأل الله أن ينفع بهذا البحث كاتبه وقارئه، وأن يجعل ذلك في موازين حسناتنا.
وصلى الله وسلم على نبينا محمد وعلى آله وصحبه أجمعين.

أخوكم: هشام بن عبد العزيز الحلاف.',NULL,'15',NULL,NULL,'0');
