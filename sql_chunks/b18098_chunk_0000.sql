...
CREATE TABLE "b18098"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b18098
INSERT INTO [b18098] VALUES (1,'العقيدة الواسطية
تصنيف
...
علق حواشيها وأشرف على تصحيحها فضيلة العلامة الشيخ: محمد بن عبد العزيز بن مانع مدير المعارف العام - أجزل الله له الثواب وأدامه ذخراً للعلم وطلابه.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (2,'<span data-type="title" id=toc-1>مقدمة المؤلف</span>
...
<span data-type="title" id=toc-2>الإيمان بما وصف الله به نفسه في كتابه</span>
...
(٤) قوله: من غير تحريف ولا تعطيل، قال الراغب تحريف الشيء إمالته =',NULL,'2',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (3,'فلا ينفون عنه ما وصف به نفسه ولا يحرفون الكلم عن مواضعه، ولا يلحدون في أسماء الله وآياته (١) ولا يكيفون ولا يمثلون صفاته بصفات خلقه (٢) لأنه سبحانه لا سميّ (٣) له، ولا كُفُوَ له، ولا نِدَّ له (٤) ولا يقاس
_________
...
(٤) الأنداد: الأمثال والنظراء، فكل من صرف شيئاً من أنواع العبادة لغير الله رغبة فيه أو رهبة منه فقد اتخذه نداً لله لأنه أشرك مع الله فيما لا يستحقه غيره وذلك كحال عباد الأموات الذين يستعينون بهم وينذرون لهم ويحلفون بأسمائهم.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (4,'بخلقه سبحانه وتعالى فإنه أعلم بنفسه وبغيره، وأصدق قيلا وأحسن حديثا من خلقه. ثم رسله صادقون مصدوقون، بخلاف الذين يقولون عليه ما لا يعلمون، ولهذا قال (سبحان ربك رب العزة عما يصفون، وسلام على المرسلين، والحمد لله رب العالمين) فسبح نفسه عما وصفه به المخالفون للرسل، وسلم على المرسلين لسلامة ما قالوه من النقص والعيب. وهو سبحانه قد جمع فيما وصف وسمىَّ به نفسه بين النفي والإثبات، فلا عدول لأهل السنة والجماعة عما جاء به المرسلون. فإنه الصراط المستقيم، صراط الذين أنعم الله عليهم من النبيين والصديقين والشهداء والصالحين.
...
_________
(١) قوله إنني معكما أسمع وأرى، قال شيخ الإسلام بعد كلام سبق، وهذا شأن جميع ما وصف الله به نفسه لو قال في قوله إنني معكما أسمع وأرى كيف يسمع وكيف يرى، لقلنا السمع والرؤية معلوم والكيف مجهول، ولو قال كيف كلم موسى تكليماً لقلنا التكليم معلوم والكيف غير معلوم اهـ
(٢) وهو شديد المحال أي الأخذ بالعقوبة.

وقال ابن عباس شديد الحول، وقال مجاهد شديد القوة.
(٣) قوله، والله خير الماكرين: قال بعض السلف في تفسير المكر يستدرجهم بالنعم إذا عصوه ويملي لهم، ثم يأخذهم أخذ عزيز مقتدر. قال الحسن من وسَّع الله عليه فلم يَرَ أنه يمكر به فلا رأي له، وقد جاء في الحديث إذا رأيت الله يعطي العبد من الدنيا على معاصيه ما يحب، فإنما هو استدراج والله جل وعلا وصف نفسه بالمكر والكيد، كما وصف عبده بهما لكن ليس المكر كالمكر ولا الكيد كالكيد، ولله المثل الأعلى ليس كمثله شيء وهو السميع البصير.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (7,'وقوله: (ومكروا مكراً ومكرنا مكراً وهم لا يشعرون)، وقوله: (إنهم يكيدون كيداً وأكيد كيداً) وقوله: (إن تبدوا خيراً أو تخفوه أو تعفوا عن سوء فإن الله كان عفواً قديرا) - (وليعفوا وليصفحوا ألا تحبون أن يغفر الله لكم والله غفور رحيم)، وقوله: (ولله العزة ولرسوله وللمؤمنين)، وقوله عن إبليس: (فبعزتك لأغوينهم أجمعين)، وقوله: (تبارك اسم ربك ذي الجلال والإكرام)، وقوله: (فاعبده واصطبر لعبادته، هل تعلم له سميا (١)) - (ولم يكن له
...
_________
(١) قال شيخ الإسلام قال أهل اللغة هل تعلم له سمياً أي نظيراً استحق مثل اسمه ويقال مساميا يساميه وهذا معنى ما يروى عن ابن عباس هل تعلم له سميا مثيلاً أو شبيهاً اهـ. وقد سبق ذكر حاشيته بهذا المعنى مفيدة فلتراجع.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (8,'ما لا تعلمون) وقوله: (الرحمن (١) على العرش استوى) (٢) في سبعة مواضع: في سورة الأعراف قوله: (إن ربكم الله الذي خلق السماوات والأرض في ستة أيام ثم استوى على العرش)، وقال في سورة يونس عليه السلام: (إن ربكم الله الذي خلق السماوات والأرض في ستة أيام ثم استوى على العرش)، وقال في سورة الرعد (الله الذي رفع السماوات بغير عمد ترونها
_________
...
(٢) قال شيخ الإسلام في العقيدة الحموية، وكذلك قوله صلى الله عليه وسلم: إذا قام أحدكم إلى الصلاة، فإن الله قبل وجهه فلا يبصقن قبل وجهه. الحديث حق على ظاهره وهو سبحانه فوق العرش وهو قبل وجه المصلي، بل هذا الوصف يثبت للمخلوق، فإن الإنسان لو أنه يناجي السماء أو يناجي الشمس والقمر، لكانت السماء والشمس والقمر فوقه، وكانت أيضاً قبل وجهه اهـ.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (13,'عليه وسلم: (اللهم رب السماوات السبع والأرض ورب العرش العظيم ربنا ورب كل شيء خالق الحب والنوى منزل التوراة والإنجيل والقرآن أعوذ بك من شر نفسي ومن شر كل دابة أنت آخذ بناصيتها أنت الأول فليس قبلك شيء وأنت الآخر فليس بعدك شيء وأنت الظاهر فليس فوقك شيء وأنت الباطن فليس دونك شيء اقض عني الدين وأغنني من الفقر) رواة مسلم. وقوله لما رفع الصحابة أصواتهم بالذكر: (أيها الناس أربعوا على أنفسكم فإنكم لا تدعون أصم ولا غائبا إنما تدعون سميعاً بصيراً قريباً إن الذي تدعونه أقرب إلى أحدكم من عنق راحلته) متفق عليه. وقوله: (إنكم سترون ربكم كما ترون القمر ليلة البدر لا تضامون في رؤيته فإن استطعتم أن لا تغلبوا على صلاة قبل طلوع الشمس وصلاة قبل غروبها فافعلوا) متفق عليه. إلى أمثال هذه الأحاديث التي يخبر فيها رسول الله صلى الله عليه وسلم عن ربه بما يخبر به فإن الفرقة الناجية أهل السنة والجماعة يؤمنون بذلك (١)
كما يؤمنون بما أخبر الله به في كتابه، من غير تحريف ولا تعطيل، ومن غير تكييف ولا تمثيل، بل هم الوسط في فرقة الأمة كما أن الأمة هي الوسط في الأمم فهم وسط في باب صفات الله سبحانه وتعالى: بين أهل التعطيل الجهمية وأهل التمثيل المشبهة (٢):
_________
...
عرفوا الذي قد قال مع علم بما ... قال الرسول فهم أُولو العرفان',NULL,'15',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (16,'والدين بين الحرورية والمعتزلة وبين المرجئة والجهمية وفي أصحاب رسول الله صلى الله عليه وسلم بين الرافضة والخوارج (١).
_________
(١) فالرافضة كفروهم والخوارج كفروا بعضهم، وأهل الحق عرفوا فضلهم كلهم، وأنهم أفضل هذه الأمة إسلاماً وإيماناً وعلماً وحكمة رضي الله عنهم أجمعين.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (17,'<span data-type="title" id=toc-4>الإيمان بأنه فوق عرشه</span>
...
<span data-type="title" id=toc-5>الإيمان بأنه قريب مجيب</span>
وقد دخل في ذلك الإيمان بأنه قريب مجيب كما جمع بين ذلك في قوله: (وإذا سألك عبادي عني فإني قريب) الآية. وقوله صلى الله عليه وسلم: (إن الذي تدعونه أقرب إلى أحدكم من عنق راحلته) وما ذكر في الكتاب',NULL,'17',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (18,'والسنة من قربه ومعيته لا ينافي ما ذكر من علوه وفوقيته فإنه سبحانه ليس كمثله شيء في جميع نعوته وهو عليُّ في دنوه قريبٌ في علوه.

<span data-type="title" id=toc-6>الإيمان بأن القرآن كلام الله منزل غير مخلوق</span>
...
<span data-type="title" id=toc-7>الإيمان برؤية المؤمنين لربهم</span>
...
_________
(١) قال الراغب: أي عمله الذي طار عنه من خير وشر ..',NULL,'20',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (21,'الشفاعة له ولسائر النبيين والصديقين وغيرهم فيشفع فيمن استحق النار أن لا يدخلها ويشفع فيمن دخلها أن يخرج منها، ويخرج الله من النار أقواماً بغير شفاعة بل بفضله ورحمته ويبقى في الجنة فضل عمن دخلها من أهل الدنيا فينشيء الله لها أقواماً فيدخلهم الجنة. وأصناف ما تضمنته الدار الآخرة من الحساب والثواب والعقاب والجنة والنار وتفاصيل ذلك مذكورة في الكتب المنزلة من السماء والآثار من العلم المأثور عن الأنبياء. وفي العلم الموروث عن محمد صلى الله عليه وسلم من ذاك ما يشفي ويكفي فمن ابتغاه وجده.

<span data-type="title" id=toc-9>الإيمان بالقدر خيره وشره</span>
وتؤمن الفرقة الناجية - أهل السنة والجماعة - بالقدر خيره وشره والإيمان بالقدر على درجتين كل درجة تتضمن شيئين:
(فالدرجة الأولى) الإيمان بأنّ الله تعالى عليم بما الخلق عاملون بعلمه القديم الذي هو موصوف به أزلا وأبدا، وعلم جميع أحوالهم من الطاعات والمعاصي والأرزاق والآجال ثم كتب الله في اللوح المحفوظ مقادير الخلق فأول ما خلق الله القلم (١)
قال له: اكتب. قال: ما أكتب؟ قال: اكتب ما هو كائن إلى يوم القيامة. فما أصاب الإنسان لم يكن ليخطئه، وما أخطأه لم يكن ليصيبه جفت الأقلام وطويت الصحف كما قال تعالى: (ألم تعلم أن الله يعلم ما في السماء والأرض إن ذلك في كتاب، إن ذلك على الله يسير)، وقال: (ما أصاب من مصيبة في الأرض ولا في أنفسكم إلا في كتاب من قبل
_________
(١) اعلم أن العلماء رحمهم الله اختلفوا في العرش والقلم أيهم خلق أولاً، وحكى ابن القيم في ذلك قولين: اختار أن العرش مخلوق قبل القلم، ولهذا قال في النونية:
والناس مختلفون في القلم الذي ... كتب القضاء به من الديان
هل كان قبل العرش أو هو بعده ... قولان عند أبي العلا الهمذاني
والحق أن العرش قبل لأنه ... وقت الكتابة كان ذا أركان

وكتابة القلم الشريف تعقبت ... إيجاده من غير فصل زمان',NULL,'21',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (22,'أن نبرأها، إن ذلك على الله يسير) وهذا التقدير - التابع لعلمه سبحانه - يكون في مواضع جملة وتفصيلا فقد كتب في اللوح المحفوظ ما شاء، وإذا خلق جسد الجنين قبل خلق الروح فيه بعث إليه ملكاً فيؤمر بأربع كلمات فيقال له: اكتب رزقه وأجله وعمله وشقي أم سعيد ونحو ذلك. فهذا التقدير قد كان ينكره غلاة القدرية قديماً ومنكروه اليوم قليل.
(وأما الدرجة الثانية) فهي مشيئة الله النافذة وقدرته الشاملة وهو الإيمان بأن ما شاء الله كان وما لم يشأ لم يكن، وأنه ما في السماوات وما في الأرض من حركة ولا سكون إلا بمشيئة الله سبحانه. لا يكون في ملكه ما لا يريد (١) وأنه سبحانه على كل شيء قدير من الموجودات والمعدومات، فما من مخلوق في الأرض ولا في السماء إلا الله خالقه سبحانه لا خالق غيره ولا رب سواه. ومع ذلك فقد أمر العباد بطاعته وطاعة رسله ونهاهم عن معصيته، وهو سبحانه يحب المتقين والمحسنين والمقسطين ويرضى عن الذين آمنوا وعملوا الصالحات، لا يحب الكافرين، ولا يرضى عن القوم الفاسقين، ولا يأمر بالفحشاء ولا يرضى لعباده الكفر، ولا يحب الفساد (٢).
_________
(١) الإرادة نوعان: إحداهما الإرادة الكونية المستلزمة لوقوع المراد التي يقال فيها ما شاء الله كان وما لم يشأ لم يكن والثانية الإرادة الدينية الشرعية وهذه لا تستلزم وقوع المراد إلا أن يتعلق بها النوع الأول من الإرادة، وفي أوائل فتح المجيد بحث مفيد في الفرق بين الإرادتين فليراجعه طالب التحقيق.
(٢) اعلم أن الذي عليه الأئمة المحققون ودل عليه الكتاب والسنة، أن المشيئة والمحبة ليستا واحداً ولا هما متلازمان، بل قد يشاء ما لا يحبه ويحب ما لا يشاء كونه فالأول: كمشيئته وجود إبليس وجنوده، ومشيئته العامة لجميع ما في الكون مع بغضه لبعضه، والثاني: كمحبته إيمان الكفار وطاعات الفجار وعدل الظالمين وتوبة الفاسقين. ولو شاء ذلك لوجد كله، فإنه ما شاء كان وما لم يشأ لم يكن اهـ.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (23,'والعباد فاعلون حقيقة والله خالق أفعالهم، والعبد هو المؤمن والكافر، والبر والفاجر، والمصلي والصائم. وللعباد القدرة على أعمالهم ولهم إرادة (١)
...
<span data-type="title" id=toc-10>الإيمان قول وعمل يزيد وينقص</span>
...
إلا المجوس فإنهم قالوا بأن ... الشر خالقه إله ثان',NULL,'23',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (24,'تبغي حتى تفيء إلى أمر الله، فإن فاءت فأصلحوا بينهما بالعدل وأقسطوا إن الله يحب المقسطين، إنما المؤمنون اخوة فأصلحوا بين أخويكم).
ولا يسلبون الفاسق المللي (١) الإسلام بالكلية، ولا يخلدونه في النار كما تقوله المعتزلة بل الفاسق يدخل في اسم الإيمان المطلق كما في قوله: (فتحرير رقبة مؤمنه) وقد لا يدخل في اسم الإيمان المطلق كما في قوله تعالى: (إنما المؤمنون الذين إذا ذكر الله وجلت قلوبهم وإذا تليت عليهم آياته زادتهم إيمانا). وقوله صلى الله عليه وسلم: (لا يزني الزاني حين يزني وهو مؤمن، ولا يسرق السارق حين يسرق وهو مؤمن، ولا يشرب الخمر حين يشربها وهو مؤمن، ولا ينتهب نهبة ذات شرف يرفع الناس إليه فيها أبصارهم حين ينتهبها وهو مؤمن) ونقول: هو مؤمن ناقص الإيمان أو مؤمن بإيمانه فاسق بكبيرته فلا يعطى الاسم المطلق ولا يسلب مطلق الاسم.

<span data-type="title" id=toc-11>وجوب حب الصحابة وأهل البيت</span>
...
_________
(١) قال الزمخشري: خم بضم الخاء اسم رجل صباغ أُضيف إليه الغدير الذي بين مكة والمدينة بالجحفة وقيل هو على ثلاثة أميال من الجحفة وذكر صاحب المشارق أن خما اسم غيضة هناك وبها غدير نسب إليها اهـ.

والغيضة: الشجر الملتف.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (26,'وقال: (إن الله اصطفى بني إسماعيل واصطفى من بني إسماعيل كنانة واصطفى من كنانة قريشاً واصطفى من قريش بني هاشم واصطفاني من بني هاشم) ويتولون أزواج رسول الله صلى الله عليه وسلم أمهات المؤمنين ويؤمنون بأنهن أزواجه في الآخرة خصوصاً خديجة رضي الله عنها أم أكثر أولاده أول من آمن به وعاضده على أمره وكان لها منه المنزلة العالية والصِّدّيقة بنت الصّدّيق رضي الله عنها التي قال النبي صلى الله عليه وسلم: (فضل عائشة على النساء كفضل الثريد على سائر الطعام)، ويتبرءون من طريقة الروافض الذين يبغضون الصحابة ويسبونهم وطريقة النواصب الذين يؤذون أهل البيت بقول أو عمل (١)
...
_________
(١) هذا هو الحق الذي يجب المصير إليه ولقد ضل كثير من المؤرخين المتنطعين فجعلوا أنفسهم كأنهم حكام بين أصحاب رسول الله فصوبوا وخطأوا بلا دليل بل باتباع الهوى وضعف الدين، ولقد أحسن ابن عدوان النجدي بقوله حيث قال:
...
<span data-type="title" id=toc-12>وجوب التصديق بكرامات الأولياء</span>
...
نسأل الله الشفاعة والعافية من كل بدعة وضلالة، وأن يثبتنا على الصراط المستقيم بمنه وكرمه.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (31,'<span data-type="title" id=toc-15>خاتمة الطبع</span>
...
وسمت همة الفاضل النجيب الشيخ عمر',NULL,'31',NULL,NULL,'0');
INSERT INTO [b18098] VALUES (32,'عبد الجبار لطبعها فجزاه الله خيراً ووفقه لنشر أمثالها من مؤلفات أهل السنة والجماعة الذين هم الفرقة الناجية الذين لا يضرهم من خذلهم ولا من خالفهم إلى يوم القيامة كما أخبر به النبي الصادق المصدوق صلى الله عليه وسلم تسليماً كثيراً، قاله بلسانه وكتبه ببيانه.
محمد بن عبد العزيز بن مانع',NULL,'32',NULL,NULL,'0');
