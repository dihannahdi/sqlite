...
CREATE TABLE "b1702"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1702
INSERT INTO [b1702] VALUES (1,'بسم الله الرحمن الرحيم
...
_________
(١) الأنفال: ٦٤.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (2,'فهي إلى الأذقان فهم مقمحون. وجعلنا من بين أيديهم سداً ومن خلفهم سداً فأغشيناهم فهم لا يبصرون. وسواء عليهم أنذرتهم أم لم تنذرهم لا يؤمنون. إنما تنذر من اتبع الذكر وخشي الرحمن بالغيب فبشره بمغفرةٍ وأجرٍ كريم} (١) .
...
_________
(١) يس: ٨ - ١١.
(٢) مريم: ٩٠.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (3,'<span data-type="title" id=toc-2>الفصل الأول
(في بيان إشراك صاحب الرسالة الإيمانية بعبادة غير الله)</span>
...
وهذا كما قال بعض السلف: الفاتحة سر القرآن وسرها هذه الكلمة ((إياك نعبد وإياك نستعين)) فالأول تبرؤ من الشرك، والثاني تبرؤ من الحول والقوة وتفويض إلى الله عز وجل، وهذا المعنى في غير آية من القرآن كما قال تعالى {فاعبده وتوكل عليه وما ربك بغافل عما تعملون} (٢) {هو الرحمن آمنا به وعليه توكلنا} (٣)
_________
(١) الفاتحة: ٥.
(٢) هود: ١٢٣.
(٣) الملك: ٢٩.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (4,'{رب المشرق والمغرب لا إله إلا هو فاتخذه وكيلا} (١) وكذلك هذه الآية الكريمة {إياك نعبد وإياك نستعين} )) .
...
_________
(١) المزمل: ٩.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (5,'نزول المطر وإعطاء الأولاد وتفريج الكروب وشفاء المريض وكشف الضر والنصر على العدو وقضاء الدين وإطالة عمر الأولاد وجعل المرأة التي تلد الإناث تلد الذكور ويتقربون إلى آلهتهم بأنواع من العبادات: بالدعاء الذي هو مخ العبادة كما ثبت في الحديث وسيأتي إن شاء الله، والاستغاثة وقد صرح بجوازها المشرك المفتون، وبناء القباب على قبورهم، أو الأمكنة التي جلسوا فيها، والأمكنة التي يزعم بعض المنتحلين الدجالين أنه رأى في المنام شخصاً مشهوراً عندهم بالصلاح يقول له: ابنوا لي قبة في هذا المقام ويتقربون ويتملقون لها بتقبيل العتبات والتوابيت، ويمرغون خدودهم على القبور، ويتمسحون بها، ويهتفون بالأسماء المنسوبة إليها، ويقربون لها القرابين، ويذبحون الذبائح، ويحجون إليها ويطوفون، وينذرون لها النذور ويسمون ذلك بالوعدة، يزعمون أن الدعاء عندها أفضل منه في
المساجد. فهل هؤلاء يؤمنون بقوله تعالى: {إياك نعبد وإياك نستعين} وبقوله تعالى {فاعبده وتوكل عليه} كلا والله هؤلاء ما يعرفون معنى لا إله إلا الله كما قال تعالى: {وما يؤمن أكثرهم بالله إلا وهم مشركون} .',NULL,'7',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (6,'<span data-type="title" id=toc-3>ذكر بعض أنواع العبادة التي يصرفها المشركون لغير الله تعالى</span>
...
فالأول: الدعاء وهو كما في الحديث الآتي ((مخ العبادة)) أي لبابها وخالصها، فكل من دعوته لجلب خير أو دفع ضر فيما لا مجال للأسباب فيه كإعطاء العقيم الأولاد لا بطريقة العلاج بل بطريقة التصرف في الكون بالهمة والحال، وجعل المرأة التي تلد الإناث فقط تتحول إلى ولادة الذكور أو بالعكس، أو كصد الأعداء والسباع الضارية بلا قتال، وشفاء المريض كذلك، وإحياء الميت وإماتة الحي وإنزال المطر وما أشبه ذلك مما لا يقدر عليه إلا الله الذي يقول للشيء ((كن))',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (7,'فيكون وكل من دعوته لشيء من ذلك فقد عبدته.
...
_________
(١) فاطر: ١٣.
(٢) الأحقاف: ٤-٦.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (8,'دعاهم ولو سمعوا دعاءه ما استجابوا له، وأن دعاءه لهم شرك بالله سيكفرون به يوم القيامة، أي يتبرؤون منه.
...
وإن الأبرار لا يرضون بدعاء من دعاهم لأنه عبادة لغير الله وسيكفرون بهم يوم القيامة حين يحشر الناس، يزيد ذلك وضوحاً ما أخرجه الترمذي عن أنس بن مالك قال: قال رسول الله صلى الله عليه وسلم: ((الدعاء هو العبادة، ثم قرأ: {وقال ربكم ادعوني استجب لكم} (١)) ) .
...
(١) البقرة: ٦٧.
(٢) الدخان: ٢٠.
(٣) يوسف: ٢٣.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (11,'قال محمد تقي الدين: وبهذا تعلم أن التعوذ قريب في المعنى من الاستغاثة، فقول الضلال عند قبور الصالحين: أنا في حماك، أنا في رحمتك استعاذة وعبادة، قال الشاعر:
...
_________
(١) البقرة: ٢٧٠.
(٢) الدهر: ٧.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (13,'الخامس: الذبح والنذر لغير الله قال تعالى: {قل إن صلاتي ونسكي ومحياي ومماتي لله رب العالمين لا شريك له وبذلك أمرت وأنا أول المسلمين} (١) . قوله سبحانه: {ونسكي} قال مجاهد: ((النسك الذبح في الحج والعمرة)) .
قال محمد تقي الدين: وكل ذبح قصد به التعظيم فهو عبادة لقوله تعالى: {فصل لربك وانحر} (٢) ، جمع الله سبحانه وتعالى هاتين العبادتين وهما الصلاة والذبح في سورة الأنعام وفي سورة الكوثر وأمر نبيه صلى الله عليه وسلم، وفي ضمنه أمر لأمته، أن يخصوا الله تعالى بهما كما يخصونه بسائر أنواع العبادة.
...
(١) الأنعام: ١٦٣.
(٢) الكوثر: ٢.
(٣) التوبة: ١٨.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (14,'قال في فتح المجيد في ص ٣٤٤: ((خوف السر وهو أن يخاف من غير الله من وثن أو طاغوت أن يصيبه بما يكره قال تعالى في قوم هود إنهم قالوا له {إن نقول إلا اعتراك بعض آلهتنا بسوء قال إني أشهد الله واشهدوا أني برئ مما تشركون من دونه فكيدوني جميعاً ثم لا تنظرون} (١) وقال تعالى: {ويخوفونك بالذين من دونه} (٢) ، وهذا هو الواقع من عباد القبور ونحوها من الأوثان يخافونها ويخوفون أهل التوحيد إذا أنكروا عبادتها وأمروا بإخلاص العبادة لله وهذا ينافي التوحيد وأما الخوف الطبيعي وهو الخوف من عدو أو سبع أو زلزال فليس بعبادة ولا شركاً قال تعالى: {فأوجس في نفسه خيفة موسى} (٣)) ) .
...
فإذا تقرر ذلك عندهم نقلهم منه إلى أن من نهى عن ذلك تنقص أهل هذه الرتب العالية وحطهم عن منزلتهم وزعم أنه لا حرمة لهم ولا قدر، فغضب المشركون واشمأزت قلوبهم كما قال تعالى في سورة الزمر: {وإذا ذكر الله',NULL,'18',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (17,'وحده اشمأزت قلوب الذين لا يؤمنون بالآخرة. وإذا ذكر الذين من دونه إذا هم يستبشرون} (١) وسرى ذلك في نفوس كثير من الجهال والطغاة وكثير ممن ينتسب إلى العلم والدين حتى عادوا أهل التوحيد ورموهم بالفظائع ونفروا الناس عنهم ووالوا أهل الشرك وعظموهم وزعموا أنهم أولياء الله وأنصار دينه ورسوله ويأبى الله ذلك، قال تعالى في سورة الأنفال: {وما كانوا أولياءه إن أولياؤه إلا المتقون} (٢) ، عن أبي واقد الليثي قال: خرجنا مع رسول الله صلى الله عليه وسلم إلى حنين ونحن حدثاء عهد بكفر، وللمشركين سدرة (أي شجرة من السدر) يعكفون عندها وينوطون (أي يعلقون) بها أسلحتهم يقال لها ذات أنواط، فمررنا بسدرة فقلنا يا رسول الله: اجعل لنا ذات أنواط كما لهم ذات أنواط فقال لهم رسول الله صلى الله عليه وسلم: الله أكبر! إنها السنن قلتم – والذي نفسي بيده – كما قالت بنوا إسرائيل لموسى {اجعل لنا إلها كما لهم آلهة} (٣) ، قال: إنكم قوم تجهلون لتركبن سنن من كان قبلكم)) رواه الترمذي وصححه)) .
قال محمد تقي الدين: تأمل أيها الموفق لاتباع كتاب الله
_________
(١) الزمر: ٤٥.
(٢) الأنفال: ٣٤.
(٣) الأعراف: ١٣٨.',NULL,'19',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (18,'وسنة رسوله، المحقق لتوحيد الله هذا الحديث تجد فيه مسائل:
...
الثالثة: أن العبادة غير منحصرة في السجود والركوع والدعاء والاستغاثة والاستعاذة، بل كل قول أو عمل عظم به غير الله تعالى رجاء النفع، وإن كان من الأماكن التي مر بها',NULL,'20',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (19,'نبي صالح، هو عبادة لذلك المكان، ولا ينفع عابده زعمه أنه يتبرك بمكان كان فيه نبي فضلاً عن غيره، فتقبيل التوابيت والقبور والطواف بها والتمسح بها وأخذ ترابها للشفاء كل ذلك عبادة وشرك بالله تعالى.
...
الخامسة: من أعلام نبوته قوله ((إنها السنن لتركبن سنن من كان قبلكم)) ، أي لتتبعن طريقهم في بدعهم ومعاصيهم وشركهم وكفرهم، فتعوذ بالله من العصيان بعد الطاعة،',NULL,'21',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (20,'ومن الخذلان وعمى البصيرة.
...
وذكر ابن القيم رحمه الله مثل ما ذكره أبو شامة ثم قال: ((فما أسرع أهل الشرك إلى اتخاذ الأوثان من دون الله ولو كانت ما كانت ويقولون: إن هذا الحجر وهذه الشجرة وهذه العين تقبل النذر، أي تقبل العبادة من دون الله فإن النذر',NULL,'22',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (21,'عبادة وقربة يتقرب بها الناذر إلى المنذر له، وحديث أبي واقد أيضاً رواه أحمد وأبو يعلى وابن أبي شامة والنسائي وابن جرير وابن المنذر وابن أبي حاتم والطبراني.
...
INSERT INTO [b1702] VALUES (22,'بالسيوف ولعبدوه من دون الله)) .
...
وهذا بالنسبة إلى من يسمون أنفسهم علماء فقليل منهم من يؤدي واجبه ويصدع بالحق. أما العوام فإنهم أقرب إلى',NULL,'24',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (23,'الخير فكثير منهم إذا عرفوا الحق تمسكوا به، فسكوت هؤلاء المنافقين من العلماء أفضى بالناس إلى عبادة الحمير.
...
<span data-type="title" id=toc-4>أمر عمر بن الخطاب بقطع شجرة الرضوان</span>
...
٢- في الصحيحين عن عائشة أيضاً قالت: ((لما نزل برسول الله صلى الله عليه وسلم طفق يطرح خميصة له على وجهه، فإذا اغتم بها كشفها فقال وهو كذلك: لعن الله اليهود والنصارى اتخذوا قبور أنبيائهم مساجد، يحذر',NULL,'28',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (27,'ما صنعوا ولولا ذلك لأبرز قبره غير أنه خشي أن يتخذ مسجدا)) .
...
٣- أخرج مسلم في صحيحه عن جندب بن عبد الله قال سمعت النبي صلى الله عليه وسلم قبل أن يموت بخمس وهو يقول: ((إني أبرأ إلى الله أن يكون لي منكم خليل، فإن الله قد اتخذني خليلاً كما اتخذ إبراهيم خليلا، ولو كنت متخذاً خليلاً لاتخذت أبا بكر خليلا. ألا وإن من كان قبلكم كانوا يتخذون قبور أنبيائهم مساجد، ألا فلا تتخذوا القبور مساجد فإني',NULL,'30',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (29,'أنهاكم عن ذلك)) .
...
قال العلماء: الخلة أعلى درجة من المحبة، ولذلك صرح النبي صلى الله عليه وسلم بالمحبة لأبي بكر وابنته عائشة وعمر بن الخطاب ومعاذ بن جبل، وأبى أن يتخذ أحدا من أهل الأرض خليلا. والله سبحانه وتعالى يحب التوابين ويحب المتطهرين، ويحب الصالحين المتواضعين للمؤمنين، الأشداء على أعداء الإسلام كما قال في سورة المائدة: {يا أيها الذين آمنوا من يرتد منكم عن دينه فسوف يأتي الله بقوم يحبهم ويحبونه. أذلة على المؤمنين أعزة على الكافرين',NULL,'31',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (30,'يجاهدون في سبيل الله ولا يخافون لومة لائم} (١) ومع ذلك لم يتخذ أحداً من خلقه خليلاً إلا إبراهيم ومحمداً صلوات الله وسلامه عليهما وإلى تفوق مرتبة الخلة على المحبة يشير قول الشاعر:

قد تخللت مسلك الروح مني ... وبذا سمي الخليل خليلا

٤- أخرج أحمد وأبو حاتم وابن حبان في صحيحه عن عبد الله بن مسعود قال: قال رسول الله صلى الله عليه وسلم: ((إن من شرار الناس من تدركهم الساعة وهم أحياء والذين يتخذون القبور مساجد)) .
...
_________
(١) المائدة: ٥٤.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (31,'والعجب أن أكثر من يدعي العلم ممن هو من هذه الأمة لا ينكرون ذلك، بل ربما استحسنوه ورغبوا في فعله، فلقد اشتدت غربة الإسلام وعاد المعروف منكراً والمنكر معروفاً، والسنة بدعة والبدعة سنة، نشأ على هذا الصغير وهرم عليه الكبير)) .
...
خلا لك الجو فبيضي واصفري ... ونقري ما شئت أن تنقري',NULL,'33',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (32,'لابد من أخذك يوماً فاحذري
...
٥- روى مالك في الموطأ عن زيد بن أسلم عن عطاء بن يسار أن رسول الله صلى الله عليه وسلم قال: ((اللهم لا تجعل قبري وثناً يعبد، اشتد غضب الله على قوم اتخذوا قبور أنبيائهم
مساجد)) .
...
وأحاطه بثلاثة الجدران',NULL,'34',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (33,'حتى غدت أرجاؤه بدعائه
في عزة وحماية وصيان
...
الثالثة: نهى النبي صلى الله عليه وسلم أمته عن اتخاذ قبره عيدا يحج الناس إليه كالمسجد الحرام ومنى ومزدلفة وعرفات فإنها',NULL,'36',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (35,'أعياد مكانية يعود الناس إليها في كل عام. والأعياد الزمانية هي التي تعود على الناس كعيد الأضحى وعيد الفطر. ومن المعلوم أن الرحال لا تشد إلى بقعة لفضل فيها إلا إلى ثلاثة مساجد، المسجد الحرام، ومسجد النبي والمسجد الأقصى.
...
السادسة: قال شيخ الإسلام رحمة الله عليه عقب تخريج هذا الحديث: ((فانظر إلى هذه السنة كيف أن مخرجها',NULL,'37',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (36,'أهل المدينة وأهل البيت الذين لهم من رسول الله صلى الله عليه وسلم قرب النسب وقرب الدار، لأنهم إلى ذلك أحوج من غيرهم فكانوا له أضبط)) انتهى.
...
الثالثة: لعن النبي صلى الله عليه وسلم لكل من يوقد سراجاً أو شمعة أو نحوهما على قبر تعظيماً له، وكذلك من يعظمه بإهداء الأموال إليه والتصدق لوجه صاحبه إلى غير ذلك مما يفعله المشركون لآلهتهم وأوليائهم الذين اتخذوهم من دون الله ولنقتصر على هذا القدر في الرد على ما جاء في رسالة المفتون من إباحة الشرك والترغيب فيه.',NULL,'38',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (37,'الفصل الثاني
...
اعلم أيها الطالب للحق المتبرئ من الشرك والبدعة وأهلهما! أن الله أرسل رسوله محمداً صلى الله عليه وسلم بالهدى ودين الحق بشيراً ونذيراً، لينذر من كان حياً ويحق القول على الكافرين، فبلغ الرسالة ولم يخص بها أحداً دون أحد وأدى الأمانة على أكمل وجه، وجاهد في الله حق جهاده وعبد الله حتى أتاه اليقين، صلوات الله وسلامه عليه وعلى آله وأصحابه العدول الثقات الذين هم أغزر هذه الأمة علماً، وأقومها سبيلاً، وأطهرها قلوباً وأتقاها لله، اختارهم الله لصحبة نبيه وقال فيهم: {كنتم خير أمة أخرجت للناس} (١) ، وأمر كل من بعدهم
_________
(١) آل عمران: ١١٠.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (38,'باتباعهم فقال تعالى في سورة التوبة: {والسابقون الأولون من المهاجرين والأنصار والذين اتبعوهم بإحسان رضي الله عنهم ورضوا عنه وأعد لهم جنات تجري من تحتها الأنهار خالدين فيها ذلك الفوز العظيم} (١) .
وقال تعالى حاثاً عباده على اتباع رسوله في سورة آل عمران: {قل إن كنتم تحبون الله فاتبعوني يحببكم الله ويغفر لكم ذنوبكم والله غفور رحيم} (٢) وقال تعالى في سورة الأعراف: {ورحمتي وسعت كل شيء فسأكتبها للذين يتقون ويؤتون الزكاة والذين هم بآياتنا يؤمنون الذين يتبعون الرسول النبي الأمي الذي يجدونه مكتوباً عندهم في التوراة والإنجيل} إلى أن قال: {فالذين آمنوا به وعزروه ونصروه واتبعوا النور الذي أنزل معه أولئك هم المفلحون} (٣) وقال تعالى في سورة الأعراف: {اتبعوا ما أنزل إليكم من ربكم ولا تتبعوا من دونه أولياء قليلاً ما تذكرون} (٤) والآيات في هذا المعنى أكثر من أن تحصى.
ثم تحمل الرسالة بعد الصحابة الكرام التابعون، ورعوها
_________
(١) التوبة: ١٠٠.
(٢) آل عمران: ٣١.
(٣) الأعراف: ١٥٦، ١٥٧.
(٤) الأعراف: ٣.',NULL,'40',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (39,'حق رعايتها وكانوا أحق بها وأهلها، ثم حملها تابعوهم من الأئمة المجتهدين والحفاظ المبرزين نفوا عنها تحريف الغالين وانتحال المبطلين وتأويل الجاهلين. ولم يكن في تلك القرون المفضلة تشدد في الدين، ولا تمذهب، ولا تحزب، ولا تعصب، بل كانوا عباد الله إخوانا، وعلى طاعته أعوانا، وكان العامي في تلك العصور إذا عنت له مسألة سأل من يصادفه من العلماء، فكان الواحد يسأل في مسألة أحد الخلفاء الراشدين، وفي الأخرى عبد الله بن عباس، وفي الثالثة عبد الله بن مسعود، وفي الرابعة عبد الله بن عمر وفي الخامسة جابر بن عبد الله. وهكذا ولم يتخذ أحد منهم رجلاً بعينه يخص بالسؤال والاتباع دون غيره كأنه نبي مرسل. حاشاهم من ذلك، وإنما حدث ذلك بعد القرون المفضلة أي في القرون المذمومة على لسان رسول الله صلى الله عليه وسلم.
وسأذكر هنا نبذة يسيرة من البراهين التي تثلج الصدور وترفع الحجب والستور، ومن لم يجعل الله له نوراً فما له من نور.
الأول: كل من اتخذ رجلاً غير النبي صلى الله عليه وسلم حجة يحلل به، ويحرم به، دون أن يسأله عن دليل ما أفتى به، تحسيناً للظن به، واعتقاداً منه أنه لا يخطئ حكم الله أبداً، فقد اتخذ ذلك الشخص رباً دون الله. وإليك برهانه: قال حافظ',NULL,'41',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (40,'المغرب الإمام أبو عمر يوسف بن عبد البر النمري الذي شرح الموطأ ثلاثة شروح في كتابه جامع بيان العلم وفضله ما نصه: ((قد ذم الله تبارك وتعالى التقليد في غير موضع في كتابه فقال: {اتخذوا أحبارهم ورهبانهم أرباباً من دون الله} (١)) ) وروى عن حذيفة وغيره قالوا: ((لم يعبدوهم من دون الله ولكن أحلوا وحرموا عليهم فاتبعوهم)) .
...
(١) التوبة: ٣١.
(٢) المرجع السابق.
(٣) الشورى: ٢١.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (41,'تعالى في سورة المائدة: {وأن احكم بينهم بما أنزل الله ولا تتبع أهواءهم واحذرهم أن يفتنوك عن بعض ما أنزل الله إليك فإن تولوا فاعلم أنما يريد الله أن يصيبهم ببعض ذنوبهم وإن كثيراً من الناس لفاسقون. أفحكم الجاهلية يبغون ومن أحسن من الله حكماً لقوم يوقنون} (١) وقال تعالى في سورة الشورى: {وما اختلفتم فيه من شيء فحكمه إلى الله} (٢) ولا حجة في قول أحد كائناً من كان إلا في كلام الله وكلام رسوله لأنه معصوم. قال تعالى في سورة النجم: {وما ينطق عن الهوى إن هو إلا وحي يوحى} (٣) .
...
(٣) البقرة: ١٦٦، ١٦٧.
(٤) الأنبياء: ٥٢، ٥٣.
(٥) الأحزاب: ٦٧.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (43,'في مسألة دنياه فأخطأ، وجهها كان كل واحد ملوماً على التقليد بغير حجة لأن كل ذلك تقليد يشبه بعضه بعضاً وإن اختلفت الأنام فيه)) .
...
ثم روى بسنده إلى عمر بن الخطاب قال: ((ثلاث يهدمن الدين: زلة عالم، وجدال منافق بالقرآن، وأئمة مضلون)) ، ثم روى بسنده إلى معاذ بن جبل قال: ((الله حكم قسط، هلك المرتابون، إن وراءكم فتنا: يكثر المال ويفتح القرآن حتى يقرأه المؤمن والمنافق، والمرأة والصبي، والأسود والأحمر، فيوشك أحدهم أن يقول: قد قرأت القرآن فيما أظن أن يتبعوني حتى ابتدع لهم غيره، فإياكم وما ابتدع فإن كل بدعة ضلالة، وإياكم وزيغة',NULL,'45',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (44,'الحكيم؟ قال: هي الكلمة تروعكم وتنكرونها وتقولون ما هذه؟ فاحذروا زيغته ولا تصدنكم عنه، فإنه يوشك أن يفئ وأن يراجع الحق، وأن العلم والإيمان مكانهما إلى يوم القيامة. فحسن ابتغاؤهما ووجودهما)) .
...
_________
(١) الأعراف: ٣٣.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (45,'تريد تنام على ذي الشبه
...
حدثنا محمد بن إبراهيم قال حدثنا أحمد بن مطرف قال حدثنا سعيد ابن عثمان وسعيد بن حمير قال حدثنا يونس بن عبد الأعلى قال حدثنا سفيان بن عيينة قال: ((اضطجع ربيعة مقنعاً رأسه وبكى فقيل له ما يبكيك؟ فقال: رياء ظاهر وشهوة خفية، والناس عند علمائهم كالصبيان في حجور أمهاتهم ما نهوهم عنه انتهوا، وما أمروهم ائتمروا وقالوا لا تعرف خطأ معلمك حتى تجالس غيره. وقال عبد الله بن المعتز: ((لا فرق بين بهيمة تنقاد وبين إنسان يقلد)) وهذا كله لغير العامة، فإن العامة لا بد لها من تقليد علمائها عند النازلة تنزل بها لا تتبين موقع الحجة لعدم الفهم لأن العلم درجات لا سبيل إلى أعلاها إلا بنيل أسفلها، وهذا الحائل بين العامة وبين طلب الحجة والله أعلم.',NULL,'47',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (46,'ولم تختلف العلماء أن العامة عليها تقليد علمائها، وأنهم المرادون بقول الله تعالى: {فاسألوا أهل الذكر إن كنتم لا تعلمون} (١) وأجمعوا أن الأعمى لابد له من تقليد غيره ممن يثق بمعرفته بالقبلة – إذا أشكلت عليه – فكذلك من لا علم ولا بصر له بمعنى ما يدين به، لا بد له من تقليد غيره، وكذلك لم يختلف العلماء أن العامة لا يجوز لها الفتيا، وذلك – والله أعلم – لجهلها بالمعاني التي فيها يجوز التحليل والتحريم، والقول في العلم.
...
وقال أبو عبد الله بن خويز منداد البصري المالكي: ((التقليد معناه في الشرع الرجوع إلى قول لا حجة لقائله',NULL,'50',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (49,'عليه، وذلك ممنوع منه في الشريعة، والاتباع ما ثبتت عليه حجة)) وقال في وضع آخر من كتابه: ((كل من اتبعت قوله من غير أن يجب عليك قوله لدليل يوجب ذلك فأنت مقلده، والتقليد في دين الله غير صحيح وكل من أوجب عليك الدليل اتباع قوله فأنت متبعه، والاتباع في الدين مسوغ والتقليد ممنوع)) )) .
...
وقد كتب الإمام الحافظ شمس الدين محمد بن قيم الجوزية في هذا المعنى، وهو الرد على المقلدين الذين فرقوا دينهم وكانوا شيعا، الكثير الطيب في كتابه ((إعلام الموقعين)) ومن أهم ذلك المناظرة العظيمة التي عقدها في المجلد الثاني بثمانين وجهاً. يكفي المؤمن الصادق إذا كان من أهل العلم وجه واحد',NULL,'51',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (50,'ليتوب إلى الله من تمذهبه وتعصبه، ويتبع كتاب الله وسنة رسوله، ولا يتسع المجال في هذه الرسالة المختصرة لذكر شئ من ذلك، غير أني أذكر عبارة من ذلك قليلة الألفاظ كثيرة المعاني. قال رحمه الله وأجزل ثوابه: ((يا لله العجب! ماتت مذاهب أصحاب رسول الله صلى الله عليه وسلم ومذاهب التابعين وتابعيهم إلا أربعة أنفس وهذه بدعة قبيحة)) أ. هـ.
وقال الإمام صالح بن محمد بن نوح الفلاني في كتابه ((إيقاظ همم أولي الأبصار للاقتداء بسيد المهاجرين والأنصار وتحذيرهم عن الابتداع الشائع في القرى والأمصار من تقليد المذاهب مع الحمية والعصبية بين فقهاء الأعصار)) بعد نقله ما مر من كلام ابن عبد البر وأكثر منه كلاما، ما نقله عن ((سند بن عنان)) شارح مدونة سحنون جاء فيه: ((وأما التقليد فلا يرضاه رجل رشيد، ولسنا نقول إنه حرام على كل فرد بل نوجب معرفة الدليل، وأقاويل الرجال، ونوجب على العامي تقليد العالم)) ثم قال ((سند)) بعد ذكره الخلاف في تقليد الميت ما نصه: ((وإنما نقول نفس المقلد ليست على بصيرة، ولا يتصف من العلم بحقيقة، إذ ليس التقليد بطريق إلى العلم بوفاق أهل الآفاق، وإن نازعنا في ذلك برهانه فنقول: قال الله',NULL,'52',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (51,'تعالى: {فاحكم بين الناس بالحق} (١) وقال: {لتحكم بين الناس بما أراك الله} (٢) وقال: {ولا تقف ما ليس لك به علم} (٣) وقال: {وأن تقولوا على الله ما لا تعلمون} (٤) ومعلوم أن العلم هو معرفة المعلوم على ما هو به، فنقول للمقلد: إذا اختلفت الأقوال وتشعبت المذاهب من أين تعلم صحة قول من قلدته دون غيره، أو صحة قولة له على قولة أخرى، ولن يبدي كلاماً في قول إلا انعكس عليه في نقيضه، خاصة إذا عرض له ذلك في قولة لإمام مذهبه الذي قلده، وقولة تخالفها لبعض أئمة الصحابة)) .
وقال الإمام الشاطبي في الاعتصام من جملة كلام طويل في رد التقليد ما نصه (ج٣، ص ٣٠١) : ((ومن معنى كلام مالك: ما كان كلامي موافقاً للكتاب والسنة فخذوا به، وما لم يوافق فاتركوه، هذا معنى كلامه دون لفظه)) .
...
(٢) النساء: ١٠٥.
(٣) الإسراء: ٣٦.
(٤) الأعراف: ٣٣.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (52,'<span data-type="title" id=toc-7>الفصل الثالث
(في بيان أن كل بدعة ضلالة)</span>
...
قال الشاطبي في الرد على القرافي وشيخه ابن عبد السلام اللذين زعما أن البدع تعتريها الأحكام الخمسة (ج١، ص ١٤٧) فمثلا للواجب: بتدوين القرآن والشرائع إذا خيف عليها الضياع، ومثلا للندوب: بصلاة',NULL,'54',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (53,'التراويح، ومثلا للمكروه: بتخصيص الأيام الفاضلة بنوع من العبادة، ومثلا للمباح: باتخاذ المناخل للدقيق.
...
أما المكروه منها والمحرم فمسلم من جهة كونها بدعة لا من جهة أخرى، إذ لو دل دليل على منع أمر أو كراهته لم يثبت ذلك كونه بدعة لإمكان أن يكون معصية كالقتل والسرقة وشرب الخمر ونحوها فلا بدعة يتصور فيها التقسيم البتة، إلا الكراهية والتحريم حسبما ذكر في بابه، فما ذكره القرافي عن الأصحاب من الاتفاق على إنكار البدع فصحيح. وما قسمه فيها غير صحيح، ومن العجب حكاية الاتفاق مع المصادمة بالخلاف، ومع معرفته بما يلزمه في خرق الإجماع، وكأنه إنما اتبع في هذا التقسيم شيخه من غير تأمل، فإن ابن عبد السلام ظاهر منه أنه سمى المصالح',NULL,'55',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (54,'المرسلة بدعاً، لأنها لم تدخل بأعيانها تحت النصوص المعينة، ولكنها تلائم قواعد الشرع. فمن هنالك جعل القواعد هي الدالة على استحسانها مع تسميته لها بلفظ البدع؛ واستحسانها من حيث دخولها تحت القواعد، ولما بني على اعتماد تلك القواعد استوت عنده مع الأعمال الداخلة تحت النصوص المعينة، وصار من القائلين بالمصالح المرسلة وسماها بدعاً في اللفظ كما سمى عمر الجمع في قيام رمضان في المسجد بدعة، وكما سيأتي إن شاء الله.
...
فخرجه أبو داود عن أبي ذر قال: ((ضمنا مع رسول الله صلى الله عليه وسلم رمضان فلم يقم بنا شيئاً من الشهر حتى ذهب ثلث الليل، فلما كانت السادسة لم يقم بنا، فلما كانت الخامسة قام بنا حتى ذهب شطر الليل، فقلنا: يا رسول الله لو نفلتنا قيام هذه الليلة،',NULL,'56',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (55,'قال: قال رسول الله صلى الله عليه وسلم: ((إن الرجل إذا صلى مع الإمام حتى ينصرف حُسب له قيام الليل)) قال: فلما كانت الرابعة لم يقم فلما كانت الثالثة جمع أهله ونساءه والناس، فقام بنا حتى خشينا أن يفوتنا الفلاح قلت: وما الفلاح! قال: السحور، ثم لم يقم بنا بقية الشهر)) ونحوه في الترمذي وقال فيه حسن صحيح. لكنه صلى الله عليه وسلم لما خاف افتراضه على الأمة أمسك عن ذلك. ففي الصحيح عن عائشة: ((أن رسول الله صلى الله عليه وسلم صلى في المسجد ذات ليلة فصلى بصلاته ناس ثم صلى القابلة فكثر الناس ثم اجتمعوا الليلة الثالثة والرابعة فلم يخرج إليهم رسول الله صلى الله عليه وسلم فلما أصبح قال: ((قد رأيت الذي صنعتم فلم يمنعني من الخروج إلا أني خشيت أن يفرض عليكم)) وذلك في رمضان)) . وخرجه مالك في الموطأ.
فتأملوا! ففي هذا الحديث ما يدل على أنها سنة، فإن قيامه أولاً بهم دليل على صحة القيام في المسجد في رمضان، وامتناعه بعد ذلك من الخروج خشية الافتراض لا يدل على امتناعه مطلقاً، لأن زمانه كان زمان تشريع ووحي، فيمكن أن يوحى إليه إذا عمل به الناس الإلزام، فلما زالت علة التشريع بموت رسول الله صلى الله عليه وسلم رجع الأمر إلى أصله وقد ثبت الجواز فلا ناسخ له، وإنما لم يقم بذلك أبو بكر لأحد أمرين، إما لأنه رأى قيام الناس آخر الليل وما هم به عليه كان أفضل',NULL,'57',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (56,'عنده من جمعهم على إمام أول الليل، ذكره الطرطوشي، وإما لضيق زمانه عن النظر في هذه الفروع، مع شغله بأهل الردة وغير ذلك مما هو أوكد من صلاة التراويح.
...
ثم قال أبو إسحاق في القسم الخامس وهو المباح: ((وذكر',NULL,'58',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (57,'في قسم المباح مسألة المناخل وليست في الحقيقة من البدع، بل هي من باب التنعم، ولا يقال فيمن تنعم بمباح إنه قد ابتدع)) .
...
قال محمد تقي الدين: والعجب من القرافي كيف نقل إجماع المالكية وغيرهم من أئمة السلف على أن البدعة كلها ضلالة ثم خرق إجماعهم واستحسن بعضها، وقد رأيت الرد المفحم الذي رد به الإمام الشاطبي وأزيد ذلك وضوحاً فأقول: قال الشاطبي في الاعتصام: ((قال مالك رحمه الله: ((من ابتدع في الإسلام بدعة يراها حسنة فقد زعم أن محمداً صلى الله عليه وسلم خان الرسالة لأن الله يقول: {اليوم أكملت لكم دينكم} (١) وما لم يكن يومئذ ديناً لا يكون اليوم دينا)) )) .
...
_________
(١) المائدة: ٣.',NULL,'59',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (58,'فمن استحسن شيئاً من البدع فإما يزعم أن النبي صلى الله عليه وسلم انتقل إلى الرفيق الأعلى قبل أن يكمل الله الدين ويتم النعمة أو يزعم أن النبي صلى الله عليه وسلم خان الرسالة بكتمان بعض ما أمر بتبليغه، مع أنه لو زعم ذلك واقعاً لا ينفعه زعمه.
...
_________
(١) يونس: ٣٢.
(٢) يس: ٦٠، ٦٢.',NULL,'60',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (59,'الخاصة فأقول: زعمه أن جمع القرآن بدعة واجبة باطل لأنه كان مجموعاً في زمان النبي صلى الله عليه وسلم في العسب واللخاف، أي الحجارة البيض المصفحة، وفي صدور الرجال، وكان النبي صلى الله عليه وسلم إذا نزلت عليه الآية والآيات دعا أحد كتاب الوحي فأمره أن يكتبها في موضعها، فلما توفي صلوات الله وسلامه عليه بقي القرآن مجموعاً في بيت عائشة، فأخذه أبو بكر الصديق منها، وأمر بجمعه في كتاب واحد. ولا فرق بين الجمعين ولا بين الكتابين فأين الإحداث وأين الابتداع؟ .
أما الشاطبي فجعل هذا من المصالح المرسلة التي فهمها أصحاب رسول الله صلى الله عليه وسلم من نصوص القرآن والسنة، ولو فرضنا أن أصحاب رسول الله صلى الله عليه وسلم برئاسة أبي بكر الصديق أحدثوا في الدين أمراً – وحاشاهم من ذلك – فهل يستطيع المبتدع أن يبعثهم من مراقدهم ويأمرهم أن يجمعوا على بدعته حتى يتم له الاحتجاج؟ أم يريد أن يقيس برأيه الفاسد بدعه الخبيثة على ما فعله أصحاب رسول الله صلى الله عليه وسلم؟ فيقال له: بفيك الحصى والجنادل (١) . إن القياس لا يكون إلا على أمر ثبت بنص من نصوص الكتاب والسنة، ونصوصها كلها تغبر في وجهك، ولا يقيس إلا مجتهد وأنت مقلد أعمى، بل بهيمة تقاد، كما تقدم من كلام أبي عمر بن عبد البر.
_________
(١) كناية عن منتهى الفجور والقصور.',NULL,'61',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (60,'أما تمثيلهم للقسم الثاني، وهو المحرم بأخذ المكوس فهو عجيب، لأن البدعة هي أن يتقرب المبتدع إلى الله بزعمه بأمر محدث حقيقة أو شكلاً، ولم يوجد أحد في الإسلام، وإن كان أجهل الجاهلين وأظلم الظالمين، يدعي أن الغصب وأخذ المكوس قربة إلى الله، كيف وهو محرم بالنصوص القاطعة وهو من أكبر الكبائر بالإجماع، فهذا يكون الإفلاس.
...
إضافية.
وتمثيلهم للخامس باتخاذ المناخل، فهو عجيب أيضاً إذ لا ينوي أحد التقرب إلى الله تعالى بطحن الحب ولا بنخله',NULL,'62',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (61,'وخبزه ولا أكله، وإنما ذلك أمر أباحه الله فمن شاء أن يأكله منخولاً أو غير منخول فلا حرج في ذلك.
قال تعالى في سورة الأعراف: {قل من حرم زينة الله التي أخرج لعباده والطيبات من الرزق قل هي للذين آمنوا في الحياة الدنيا خالصة} (١) وفي صحيح مسلم أن النبي صلى الله عليه وسلم لما قدم المدينة وجدهم يلقحون النخل فقال: ((ما هذا؟)) فقالوا شيء نأخذه من الذكر ونجعله في الأنثى يصلح عليه التمر فقال: ((ما أراه ينفع)) ، فتركوا التلقيح ففسد التمر وصار شيصاً فأخبروه بذلك فقال: ((إذا حدثتكم عن الله فخذوا به فإني لا أكذب على الله، وأنتم أعلم بأمور دنياكم)) أو كما قال عليه الصلاة والسلام فأمور الدنيا ليست فيها بدعة.
...
_________
(١) الأعراف: ٣٢.',NULL,'63',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (62,'فهو عفو، فاقبلوا من الله عافيته، فإن الله لم يكن لينسى شيئاً. ثم تلا هذه الآية: {وما كان ربك نسيا} (١) وقال الحاكم صحيح الإسناد. وقال البزار إسناده صالح.
...
_________
(١) مريم: ٦٤.',NULL,'64',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (63,'<span data-type="title" id=toc-8>الفصل الرابع
في مسائل فرعية جاءت في رسالة البوعصامي العامي</span>
...
<span data-type="title" id=toc-9>المسألة الأولى: وضع اليد اليمنى على اليسرى في الصلاة</span>.
...
وحدثني عن مالك عن أبي حازم بن دينار عن سهيل بن',NULL,'65',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (64,'سعد أنه قال: ((كان الناس يؤمرون أن يضع الرجل اليمنى على ذراعه اليسرى في الصلاة. قال أبو حازم: لا أعلم إلا أنه ينهى عن ذلك)) )) . انتهى.
...
وفي رواية لأحمد وأبي داود: ((ثم وضع يده اليمنى على كفه اليسرى والرسغ',NULL,'66',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (65,'والساعد)) .
...
ومالك وغيره من أئمة أهل السنة ينقلون لنا سنة رسول الله صلى الله عليه وسلم فنقلناها منهم إذا صحت بالقبول ونعمل بها ونترحم عليهم ولا نفضل أحداً منهم على أحد، والذي نسأل عنه في قبورنا وفي الحشر هو محمد رسول الله صلى الله عليه وسلم وإنما سقنا',NULL,'68',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (67,'رواية وضع اليمنى على اليسرى عن مالك وأصحابه ليتبين جهل المفتون وجهل متبوعه ((الجكني)) المبتدع.
...
الثالث: منعه فيهما حكاه الباجي، وتبعه ابن عرفة وهو من الشذوذ بمكان، قال الشيخ أبو عبد الله محمد بن أحمد المسناوي في رسالة في القبض: ((وإذا تقرر الخلاف في أصل القبض كما ترى وجب الرجوع إلى الكتاب والسنة كما قال تعالى: {فإن تنازعتم في شيء فردوه إلى الله والرسول} وقد وجدنا سنة رسول الله صلى الله عليه وسلم قد حكمت',NULL,'70',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (69,'بمطلوبية القبض في الصلاة بشهادة ما في الموطأ والصحيحين وغيرهما من الأحاديث السالمة من الطعن، فالواجب الانتهاء إليها والوقوف عندها والقول بمقتضاها)) أ. هـ.
<span data-type="title" id=toc-10>المسألة الثانية: قراءة البسملة في أول سورة الفاتحة وأول كل سورة في الصلاة</span>.
...
(٢) قال راقمه: يظهر أن في الكلام حذفاً ولعل الصواب: ((قاله ... وابن رشد)) .',NULL,'74',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (73,'<span data-type="title" id=toc-11>المسألة الثالثة: قراءة القرآن وإهداء ثوابه إلى الموتى بدعة</span>.
...
(١) النجم: ٣٩، ٤٠.
(٢) النجم: ٣٨.
(٣) فاطر: ١٨.',NULL,'75',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (74,'الأقيسة والآراء. فأما الدعاء والصدقة فمجمع على وصولهما ومنصوص من الشارع عليهما.
...
_________
(١) يس: ١٢.
(٢) التوبة: ١٠٥.',NULL,'76',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (75,'قال محمد تقي الدين: ومن ذلك تعلم أن ما زعمه ((البوعصامي)) العامي من أن عمر رضي الله عنه أوصى بقراءة الفاتحة وخاتمة البقرة (كذا) وعزاه إلى ((المشارق)) (١) كذب وافتراء على عمر، وحقه أن يعزى إلى المغارب لا إلى المشارق لبطلانه فهو غارب وليس بشارق. فمن رواه؟ وأين إسناده؟ ومن صححه أو حسنه؟ ، وهل كتاب المشارق على فرض صحة نسبته إليه قرآن لا يحتاج إلى سنده، أو أحد الصحيحين، أو أحد الكتب الستة وما يقاربها؟ ، فهذا يكون الإفلاس والالتجاء إلى بنيان الطريق.
فإن كنت لا تدري فتلك مصيبة ... وإن كنت تدري فالمصيبة أعظم
------------------
يقولون أقوالاً ولا يعلمونها ... إذا قيل هاتوا حققوا ولم يحققوا

{فمن أظلم ممن افترى على الله كذباً ليضل الناس بغير علم. إن الله لا يهدي القوم الظالمين} (٢) ثم وقفت على الأثر الذي عزاه ((البوعصامي)) إلى عمر بن الخطاب جهلاً منه أو ممن نقل عنه، وجدته مروياً عن عبد الله بن عمر، رواه الخلال في جامعه بإسنادين كلاهما يدور على عبد الرحمن
_________
(١) قال راقمه: لعله كتاب ((مشارق الأنوار)) وهو إما لابن العربي المالكي أو لـ الباجي الأندلسي.
(٢) الأنعام: ٢٤٥.',NULL,'77',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (76,'بن العلاء بن اللجلاج عن أبيه عن عبد الله بن عمر أنه أوصى إذا دفن أن يقرأ عند رأسه بفاتحة البقرة وخاتمتها.
...
والاقتداء بالنبي صلى الله عليه وسلم في أفعاله وأقواله وتروكه فرض على كل مسلم في الأوامر والتروك. أما في الأفعال فإن لم يكن من خصائصه صلى الله عليه وسلم فهو سنة يثاب من فعله ولا يأثم من تركه، أما الأوامر والتروك فلا يسع أحد مخالفتها، ومن فعل التروك فقد ابتدع في دين الله، فهو في النار بنص حديث رسول الله صلى الله عليه وسلم، والعبادات لا مجال فيها للرأي والقياس، وإنما تؤخذ من هدي رسول الله صلى الله عليه وسلم وقد تقدم الكلام',NULL,'78',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (77,'على ذلك في الفصل الثالث.
...
_________
(١) قال راقمه: في الحسام الماحق: بن هرم نصيب.',NULL,'79',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (78,'من حضره الموت لا من مات وقضى نحبه.
...
_________
(١) يس: ٢٦، ٢٧.',NULL,'80',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (79,'الرابع: أن الصحابة لو فهموا من قوله صلى الله عليه وسلم: ((اقرؤوا على موتاكم)) قراءتها، لما أخلوا بها وكان ذلك أمراً معتاداً مشهوراً بينهم.
...
الأول: قال ابن جرير: ((إنما عنى بقوله: {أن لا تزر وازرة وزر أخرى} الذي ضمن للوليد بن المغيرة أن يتحمل عنه عذاب الله يوم القيامة يقول: ألم يخبر قائل هذا القول',NULL,'81',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (80,'وضامن هذا الضمان بالذي في صحف موسى وإبراهيم: مكتوب لا تأثم آثمة إثم أخرى غيرها، وأن ليس للإنسان إلا ما سعى. أي وأنه لا يجازى عامل إلا بعمله خيراً كان أم شراً)) انتهى.
...
أقول: وتحمل الكراهة هنا على كراهة التحريم وهو مقتضى شدة مالك وتمسكه بالسنة وإنكاره للبدعة وغلظته على المبتدعين كما تقدم عنه.',NULL,'82',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (81,'<span data-type="title" id=toc-13>المسألة الرابعة: التأمين والجهر به</span>
...
١- عن أبي هريرة أن رسول الله صلى الله عليه وسلم قال: ((إذا أمَّن الإمام فأمنوا، فإن من وافق تأمينه تأمين الملائكة غفر له ما تقدم من ذنبه)) .
٢- عن ابن شهاب: ((كان رسول الله صلى الله عليه وسلم يقول: آمين)) روى (١) الجماعة إلا أن الترمذي لم يذكر قول ابن شهاب.
...
٤- عن أبي هريرة قال: ((كان رسول الله صلى الله عليه وسلم إذا تلا {غير المغضوب عليهم ولا الضالين} قال: آمين حتى يسمع من يليه من الصف الأول)) . رواه أبو داود وابن ماجة وقال: ((حتى يسمعها الصف الأول فيرتج
_________
(١) قال راقمه: كذا في ((الحسام الماحق)) ولعل الصواب: رواه.',NULL,'83',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (82,'بها المسجد)) .
٥- عن وائل بن حجر قال: ((سمعت النبي صلى الله عليه وسلم قرأ {غير المغضوب عليهم ولا الضالين} ، فقال آمين يمد بها صوته)) . رواه أحمد وأبو داود والترمذي.
...
وقال محمد تقي الدين: وذهب مالك إلى أن الإمام لا يؤمن في الجهرية؛ إذ لم يبلغه شيء من تلك الأحاديث فله أجر واحد ولا لوم عليه، وإنما اللوم والإثم على من بلغه حديث رسول الله صلى الله عليه وسلم في غاية الوضوح والصحة وعمل به',NULL,'84',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (83,'الصحابة والتابعون وأكثر الأئمة المجتهدين، ثم ركب رأسه وتعمد معصية الرسول صلى الله عليه وسلم ولم يقتصر على ذلك حتى أخذ ينهى الناس عن اتباع سنة رسول الله، ويكتب ذلك من بلد إلى بلد ولم يقتصر على إضلال من عنده من الناس، فهكذا تكون الجرأة والوقاحة وقلة الحياء من الله ومن الناس.
يا ليت لي من جلد وجهك رقعة ... فأقد منها حافراً للأدهم

<span data-type="title" id=toc-14>المسألة الخامسة: نسبة السدل إلى الإمام الشافعي</span>.
...
قال المزني في مختصر لكتاب ((الأم)) ما لفظه: ((قال الشافعي: وإذا أحرم إماماً أو وحده نوى صلاته في حال التكبير لا قبله ولا بعده ولا يجزئه إلا قوله، الله أكبر أو الله الأكبر، فإن لم يحسن بالعربية كبر بلسانه، وكذلك الذكر وعليه أن يتعلم، ولا يكبر إن كان إماماً حتى تستوي',NULL,'85',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (84,'الصفوف خلفه ويرفع يديه إذا كبر حذو منكبيه، ويأخذ كوعه الأيسر بكفه اليمنى ويجعلها تحت صدره)) انتهى.
<span data-type="title" id=toc-15>المسألة السادسة: التوسل بالمخلوق</span>.
...
_________
(١) المائدة: ٣٥.
(٢) الإسراء: ٥٧.',NULL,'86',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (85,'فالإقسام على الله بالمخلوق حرام، وهو جهل من فاعله لأن هذا المقسم إما أن يقسم بأجسام المخلوقين وذلك جهل وضلال وباطل، إذ لا يتقرب إلى الله بأجسام عباده، إذ لا علاقة لأجسامهم بما يريده الله من ذلك التوسل، وهو الإيمان والأعمال الصالحة.
...
ويتوسل إلى الله تعالى أيضاً بأسمائه الحسنى؛ قال تعالى في سورة الأعراف: {ولله الأسماء الحسنى فادعوه بها وذروا الذين يلحدون في أسمائه سيجزون ما كانوا يعملون} (١) .
...
وفي جميع متونهم أن قول الداعي المتوسل بحق الأنبياء والأولياء وبحق البيت والمشعر الحرام مكروه كراهة تحريم، وهو كالحرام في العقوبة بالنار عند محمد. وعللوا ذلك كلهم بقولهم: إنه لا حق لمخلوق على الخالق))',NULL,'88',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (87,'ثم قال في صفحة ٢٠٥: ((قال ابن بلدجي في شرح المختار: ويكره أن يدعو الله إلا به ولا يقول أسألك بملائكتك أو بأنبيائك أو نحو ذلك لأنه لا حق للمخلوق على خالقه)) .
...
والوثنية)) .',NULL,'89',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (88,'<span data-type="title" id=toc-16>توسل عمر بالعباس</span>
...
وسأورد هنا مسائل خالف فيها مالك نفسه أهل المدينة والمنقول المحقق عن الصحابة والتابعين مع قيام الدليل على صحته، وأورد بعض المسائل التي عمل بها النبي صلى الله عليه وسلم وأصحابه والتابعين ومالك نفسه، ثم تركها بعض المنتسبين إلى مذهبه اعتماداً على بعض الأقوال الضعيفة السخيفة',NULL,'92',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (91,'المنقولة عن مالك هم ادعوا أن مالكاً ترك العمل بذلك لمخالفته لعمل أهل المدينة.
...
أقول: فهذا عمل أهل المدينة، جهر به الخليفة الثاني عمر بن الخطاب في مسجد رسول الله صلى الله عليه وسلم وقد صح الحديث عن النبي صلى الله عليه وسلم بذلك، وفي الأزمنة المتأخرة نسب مالك إلى تركه، فعصى المقلدون الله ورسوله وعمر بن الخطاب وأصحاب رسول الله صلى الله عليه وسلم والتابعين وعمل أهل المدينة المحقق في أفضل عصورها، وتركوا دعاء الاستفتاح والتعوذ والبسملة.',NULL,'94',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (93,'المسألة الثالثة: العمل بخيار المجلس
...
أما في زمان الصحابة والتابعين والأئمة المجتهدين فحاشاهم من ذلك. كيف وقد تقدم عنهم من حماية حمى التوحيد بإخفاء مدفن ((دانيال)) وقطع شجرة بيعة الرضوان، ما يعلي الله به درجاتهم ويبرئهم من كل مشرك منافق، وإن كان يريد أهل الأزمنة المتأخرة فقد كانت على قبر حمزة قبة عظيمة، وكان الناس يحجون إليها في كل سنة من الآفاق حتى من مصر، فاتخذوها وثناً، فأراد الله تعالى أن يطهر قبر حمزة سيد الشهداء من رجسهم فوفق المجاهدين من رجال حزبه المفلحين فهدموها وقلعوا الرخام حتى صار القبر كما كان على عهد رسول الله صلى الله عليه وسلم وعلى ذلك فما كان يمكن لأحد أن يأخذ تراباً من القبر إن لم يكن هنالك',NULL,'98',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (97,'تراب، وإنما كان هناك رخام وتابوت وستور حرير كما هو شأن أهل الأوثان في أوثانهم، وأما بعد هدمها فلا يتجرأ مشرك من عبدة القبور أن يأخذ تراباً منه لأن من تجرأ على ذلك يعاقب أشد العقاب، والعجب من هذا المفتون كيف لم يستح أن يذكر هذا الخبر الكاذب المفترى دون أن يعزوه إلى أحد أو يذكر مستنده ولكن من خذله الله وأراد فضيحته فلن تملك له من الله شيئا.

<span data-type="title" id=toc-18>(بدعة قراءة القرآن جماعة بنغمة واحدة)</span>
...
لكن الاجتماع لقراءة القرآن الموافقة لسنة النبي صلى الله عليه وسلم وعمل السلف الصالح أن يقرأ أحد القوم والباقون يسمعون، ومن عرض له شك في معنى الآية استوقف القارئ، وتكلم من يحسن الكلام في تفسيرها حتى ينجلي تفسيرها، ويتضح',NULL,'99',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (98,'للحاضرين، ثم يستأنف القارئ القراءة. هكذا كان الأمر في زمان النبي صلى الله عليه وسلم وبعده إلى يومنا هذا في جميع البلاد الإسلامية ما عدا بلاد المغرب في العصر الأخير، فقد وضع لهم أحد المغاربة ويسمى ((عبد الله الهبطي)) وقفاً محدثاً ليتمكنوا به من قراءة القرآن جماعة بنغمة واحدة، فنشأ عن ذلك بدعة القراءة جماعة بأصوات مجتمعة على نغمة واحدة وهي بدعة قبيحة تشتمل على مفاسد كثيرة:
...
الرابعة: أنه يتنفس في المد المتصل مثل: جاء، وشاء، وأنبياء، وآمنوا، وما أشبه ذلك فيقطع الكلمة الواحدة نصفين،',NULL,'100',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (99,'ولا شك في أن ذلك محرم وخارج عن آداب القراءة، وقد نص أئمة القراءة على تحريم ما هو دون ذلك، وهو الجمع بين الوقف والوصل، كتسكين باء ((لا ريب)) ووصلها بقوله تعالى: {فيه هدى} قال الشيخ التهامي بن الطيب في نصوصه:
...
قال أبو إسحاق الشاطبي في ((الاعتصام)) : ((واعلموا أنه حيث قلنا: إن العمل الزائد على المشروع يصير وصفاً له أو كالوصف فإنما يعتبر بأحد أمور ثلاثة: إما بالقصد، وإما',NULL,'101',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (100,'بالعبادة، وإما بالزيادة أو بالنقصان.
...
قال محمد تقي الدين: والعجب من هؤلاء المشركين المبتدعين الضلال، فإنهم يتلونون تلون الحرباء لا يستقرون على حال أبداً، فتارة يدعون أنهم مقلدون لمالك، ويرون من خالف مذهبه كمن خالف القرآن والسنة الثابتة المحكمة، ويغلون في ذلك إلى أن يجعلوا البسملة والتعوذ وقراءة الفاتحة خلف الإمام في الجهرية والجهر بالتأمين ووضع اليمنى على اليسرى ورفع اليدين عند الركوع والرفع منه وبعد القيام من التشهد الأول، والسلام تسليمتين (السلام عليكم ورحمة الله وبركاته) وما أشبه ذلك من السنة الثابتة عن النبي صلى الله عليه وسلم التي يراها من له أدنى إلمام بالفقه في الدين',NULL,'104',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (103,'كالشمس في رابعة النهار كأنه يشاهد النبي صلى الله عليه وسلم يفعلها لا يشك في ذلك ولا يرتاب فيه، يجعلون ذلك من المنكرات التي يجب أن تغير، ويكتب فيها من بلد إلى بلد مع أن مالكاً في الحقيقة قائل ببعضها تفصيلاً وبسائرها إجمالاً، ثم يخالفون فيما ينهى عنه ويكرهه كراهة تحريم من البدع التي لا تسند إلى أي دليل كعبادة القبور وزيارتها زيارة بدعية، وقراءة القرآن على الميت بعد موته وعلى قبره، وقراءة القرآن جماعة بصوت واحد، وقراءة الأذكار والأوراد كذلك، وقد صرح بذلك خليل الذي يعدون مختصره قرآناً يتلى غلواً منهم وضلالاً.
قال في مختصره عاطفاً على المكروهات: ((وجهر بها في مسجد كجماعة)) ، ولا يبالون بخلافه فيما اعتادوه من البدع، فيحلونه عاماً ويحرمونه عاماً، وما أحسن قوله تعالى في سورة القصص يخاطب رسوله صلى الله عليه وسلم: {فإن لم يستجيبوا لك فاعلم أنما يتبعون أهواءهم. ومن أضل ممن اتبع هواه بغير هدىً من الله. إن الله لا يهدي القوم الظالمين} (١) .
_________
(١) القصص: ٥٠.',NULL,'105',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (104,'أحكام آية النجم
...
فما معنى قول النبي صلى الله عليه وسلم لابنته التي هي بضعة منه: ((يا فاطمة بنت محمد أنقذي نفسك من النار، لا أغني عنك من الله شيئا)) إذا كان أبناء المؤمنين يدخلون الجنة اعتماداً على',NULL,'108',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (107,'عمل آبائهم بلا إيمان ولا عمل، أليس قائل هذا القول مفترياً على الله الكذب، فإن كان يعلم هذا الحديث ومعنى الآية فقد كفر لتكذيبه بالقرآن والحديث، ورده ما جاء من الله ورسوله واضحاً – كالشمس في رابعة النهار – وما يتلى في القرآن ويقرأ في الصحيحين بتفسير سيد الأولين والآخرين، وإن كان يجهله فكيف نصب نفسه لدعوة الناس إلى الدين والأمر بالمعروف بزعمه وإنكار المنكر وهو في هذه الدركة من الجهل، ولا غرابة في ذلك فمن لم يعرف معنى (لا إله إلا الله) وأشرك بالله ودعا إلى عبادة غيره بلا حشمة ولا حياء كيف يرجى له أن يعرف معاني الكتاب والسنة، كذلك يطبع الله على قلوب الذين لا يعلمون، فاصبر إن وعد الله حق ولا يستخفنك الذين لا يوقنون.
ثم ذكر ((البوعصامي)) العمي كتباً أحال القارئ لهذيانه على مراجعتها على سبيل الإجمال تمويها وتضليلاً، ومنها ما سماه: كتاب ((الرد على الوهابية)) ولا يعرف كتاب بهذا الاسم يختص به، وقد لفق جماعة من المشركين المبتدعين عباد الأضرحة رسائل سموها بالرد على الوهابية ولا توجد فرقة على وجه الأرض تسمي نفسها (وهابية) ، ولكن المبتدعين والمشركين اخترعوا هذه التسمية ليطلقوها على كل من',NULL,'109',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (108,'يوحد الله ويتبع سنة رسول الله صلى الله عليه وسلم ويتجنب البدع والمحدثات، كما كان المشركون يسمون رسول الله صلى الله عليه وسلم مذمماً، بل المشركون الأولون أعقل من هؤلاء المتأخرين فإنهم سموا النبي صلى الله عليه وسلم باسم يدل على الذم في لغتهم وهم المذمومون، والنبي صلى الله عليه وسلم طاهر مطهر لا يلحق به شيء من ذمهم، وكذلك من اتبعه إلى يوم القيامة مسلمون حنفاء لا يضيرهم ما يقول فيهم أعداؤهم.
...
والقسم الثالث: عامة النصارى، وهذه العقيدة هي التي اتخذها الجهال الذي يزعمون أنهم مسلمون، فالقسم الذي يسميه النصارى قديسين يسمونه هم أولياء الله، ويفعلون معه ما يفعله النصارى مع مقدسيهم ونحن نشهد بالله أن هذا القسم لا وجود له في الإسلام ولا في دين المسيح الحق غير',NULL,'114',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (113,'المبدل، فليس هناك إلا سيد واحد وغيره عبيد خاضعون لأمره مطيعون له، فالسيد هو الله والخلق كلهم عبيد، ولكن الأنبياء فضلهم الله وخصهم بالوحي والرسالة، فهم سادات لسائر العبيد ولا يبلغ مرتبتهم أحد غيرهم ولكنهم لا ينفعون ولا يضرون ولا يدعون ولا يستغاث بهم ومن دعاهم أو صرف لهم شيئاً من العبادة فهو كافر.
...
قال في الوجه الثالث: ((إن هذه الآية في سورة ((الشورى)) وهي مكية باتفاق أهل السنة بل جميع آل ((حم)) وكذلك',NULL,'118',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (117,'آل ((طسم)) ، ومن المعلوم أن علياً إنما تزوج فاطمة بالمدينة بعد غزوة بدر، والحسن ولد في السنة الثالثة من الهجرة والحسين في السنة الرابعة فتكون هذه الآية نزلت قبل الحسن والحسين بسنين متعددة فكيف فسر النبي صلى الله عليه وسلم الآية بوجوب مودة قرابة لا تعرف ولم تخلق.
ثم قال:
...
الوجه الخامس: أنه قال: {لا أسألكم عليه أجراً إلا المودة في القربى} ولو أراد المودة لذوي القربى لقال لذوي القربى كما قال: {واعلموا أنما غنمتم من شيء فإن لله خمسه ولرسوله ولذي القربى} وقال: {ما أفاء الله على رسوله من أهل القرى فلله وللرسول ولذي القربى} وكذلك قوله: {وآت ذا القربى حقه والمسكين وابن السبيل} وقوله:',NULL,'119',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (118,'{وآت المال على حبه ذوي القربى} ، وكذلك في غير موضع فجميع ما في القرآن من التوصية بحقوق ذوي قرابة النبي صلى الله عليه وسلم وذوي قربى الإنسان، إنما قيل فيه ((ذوي القربى)) ولم يقل ((في القربى)) فلما ذكر هنا المصدر دون الاسم دل على أنه لم يرد ذوي القربى.
...
وقد اختلف الناس في ((علي)) ، وهلكت فيه طائفتان. طائفة',NULL,'129',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (128,'غلت فيه حتى جعلته إلهاً، وهي طائفة عبد الله بن سبأ اليهودي، وقد أنكر عليهم قولهم، وبالغ في عقابهم فأحرقهم بالنار ليكونوا عبرة للعالمين، ولا يزال لهم اتباع إلى هذا الزمان لا يقول أحد بإسلامهم لا من أهل السنة ولا من غير أهل السنة.
...
وختم ((البوعصامي)) هذيانه بقوله: ((أنشدك الله يا إمام ((أرفود)) أن تشرح دين الله ولا تخاف في الله لومة لائم: التأمين بعد الفاتحة لا يكون إلا سراً، والجهر به مخالفة لسنة رسول الله صلى الله عليه وسلم وقد قال العلماء: ((الراتب إذا كان',NULL,'130',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (129,'يرى المنكر ولم ينهى (كذا) فهو يحاسب. حاسبوا أنفسكم قبل أن تحاسبوا)) انتهى.
...
قال محمد تقي الدين: هذا ما يسر الله في الرد على ذلك الداعية إلى البدعة والشرك، وقد بدا لي أن أذيله ببعض قصيدة قلتها في مبتدع آخر مثل ((البوعصامي)) في الشرك والبدعة، وقد قضى نحبه ولقي ربه وأفضى إلى ما قدم منذ زمان، وتليها قصيدة أخرى نظمتها منذ شهر في الرد على عباد القبور والزنادقة والملحدين الذين يدعون بدعوى',NULL,'132',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (131,'الجاهلية، والله أسأل أن يؤيدني بروح منه ويعينني على جهادهم أجمعين وآخر دعوانا أن الحمد لله رب العالمين.

<span data-type="title" id=toc-21>((القصيدة الأولى))</span>
لكن ذا زمن به البغاث غدا ... مستنسراً صائلاً في زي عقبان
والذئب أصبح مثل الضأن مرتدياً ... ليبتغي الصيد من أغرار خرفان
...
وكم أهبت بقومي صارخاً أبداً ... أوبوا لهدي نبي الله إخواني
دعوا دجاجلة يبغونها عوجاً ... فلن يقودوكم إلا لخسران
...
ومن يرد حديث المصطفى سفهاً ... يا رب فالعنه من جن وإنسان
...
وانصر بها حزبنا طول الحياة وفي ... يوم الجزا جد لنا طرا بغفران',NULL,'133',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (132,'<span data-type="title" id=toc-22>((القصيدة الثانية))</span>
...
_________
(١) في الحسام الماحق: عمران النجي التميمي.',NULL,'134',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (133,'الله سماهم بنص كتابه ... حنفاء رغم الفاجر المرتاب
...
فيصير عندكم أبو جهل ومن ... والاه من حضر ومن أعراب',NULL,'135',NULL,NULL,'0');
INSERT INTO [b1702] VALUES (134,'مثل النبي محمد وصحابه ... بئس الجزاء لسادة أقطاب
...
وكان الفراغ منه بمدينة مكناس طهرها الله من الأدناس وصانها من كل بأس لعشر خلون من ربيع الأول ١٣٨٥هـ خمس وثمانين وثلاث مائة بعد الألف.',NULL,'136',NULL,NULL,'0');
