...
CREATE TABLE "b11525"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b11525
INSERT INTO [b11525] VALUES (1,'<span data-type="title" id=toc-1>أصول السنة للإمام أحمد [١]</span>
من أشهر المتون المختصرة التي كتبها السلف رضوان الله عليهم في العقيدة: متن (أصول السنة)، لإمام أهل السنة الإمام أحمد رحمه الله تعالى، وقد بين فيه مذهب أهل السنة في أبواب الإيمان والقدر والصحابة وغيرها، ولذا كان جديراً أن يُهتم به، وقد عُني به كثير من العلماء، ومن ذلك ما في هذا الشرح المبارك.','1','1',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (2,'<span data-type="title" id=toc-2>تعريف الأصل المطلوب تحقيقه</span>
...
هذه رسالة للإمام أحمد في أصول السنة، والأصل: هو ما يبنى عليه غيره، أو ما يتفرع عنه غيره كأساس الحيطان وأصول الشجر، والمعنى: أن السنة لها أصول تتفرع عنها، فأصل الأصول هو كتاب الله وسنة نبيه صلى الله عليه وسلم وما نقل عن الصحابة رضي الله عنهم، فإذا حقق الناس هذه الأصول وتمسكوا بالكتاب والسنة وتمسكوا بما كان عليه الصحابة فإنهم بذلك سيكملون ما يتفرع عن هذه الأصول.','1','2',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (3,'<span data-type="title" id=toc-3>السنة مفسرة للقرآن</span>
...
وكذلك -أيضاً- يتجنب الجدل الذي هو الخصومات والمنازعات التي ما أنزل الله بها من سلطان، بل على المؤمن أن يستسلم لما يعرفه، ولا يرد شيئاً إذا ثبت ولم يعرفه، ولا يسأل عن الأشياء الغيبية، فلا يقول: لماذا خلق الله كذا؟ ولماذا أمر الله بكذا؟ بل يقول: سمعنا وأطعنا، دون أن يسأل عن الكيفية في أسماء الله وصفاته، ولا عن العلل بأفعال الله وأحكامه، فما عرف منها قبله، وما لم يعرفه استسلم له.','1','4',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (5,'<span data-type="title" id=toc-5>القرآن كلام الله ليس بمخلوق</span>
...
ويثبتون صفة الكلام -أن الله تعالى متكلم كما يشاء- ويتوقفون عن كيفية كلامه، أو التدخل في الأشياء الغيبية التي لا تبلغها الأفهام، فيقولون: نكل علم ذلك إلى الله تعالى.','1','5',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (6,'<span data-type="title" id=toc-6>وجوب الإيمان برؤية المؤمنين لربهم عز وجل يوم القيامة وفي الجنة</span>
...
وكيفيتها لا نعلمها، إلا أننا نتحقق أن المؤمنين يرون ربهم عياناً مجاهرة بأبصارهم، وأن هذه الرؤيا هي أعظم نعيم الجنة، وفسرت بأنها هي الزيادة في قوله تعالى: {لِلَّذِينَ أَحْسَنُوا الْحُسْنَى وَزِيَادَةٌ} [يونس:٢٦]، وفسر بها المزيد في قوله تعالى: {لَهُمْ مَا يَشَاءُونَ فِيهَا وَلَدَيْنَا مَزِيدٌ} [ق:٣٥]، والأدلة عليها واضحة ومعروفة في كتب أهل السنة.','1','6',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (7,'<span data-type="title" id=toc-7>الخلاف في رؤية النبي صلى الله عليه وسلم لربه في الدنيا</span>
...
فرؤية النبي صلى الله عليه وسلم لربه إنما هي مكاشفات قلبية لا رؤية بصرية، وذلك لضعف الإنسان في هذه الدنيا عن أن يثبت لعظمة الله وجلاله، أما في الآخرة فإن الله يمد أهل الجنة بقوة يتمكنون من رؤيته، ويثبتون أمام رؤيته؛ وليس خلقتهم في الجنة كخلقتهم في الدنيا.','1','7',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (8,'<span data-type="title" id=toc-8>وجوب الإيمان بالميزان الكائن يوم القيامة</span>
...
فهذه أدلة واضحة على ثبوت الميزان، ولا عبرة بمن أنكره كالفلاسفة ونحوهم الذين قالوا: إنما يحتاج إلى الميزان البقالون والباعة ونحوهم، ونحن نقول لهم: إن هذا من إظهار العدل من الله تعالى.','1','8',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (9,'<span data-type="title" id=toc-9>وجوب الإيمان بتكليم الله جل وعلا عباده يوم القيامة</span>
قال المصنف رحمه الله تعالى: [وأن الله تعالى يكلمه العباد يوم القيامة ليس بينهم وبينه ترجمان، والتصديق به].
من جملة ما يدخل في الإيمان بالآخرة وبالبعث بعد الموت، وبالجمع في يوم القيامة أن الله يكلم العباد، كما قال صلى الله عليه وسلم: (ما منكم من أحد إلا سيكلمه ربه ليس بينه وبينه ترجمان) أي: مترجم ينقل الكلام من لغة إلى لغة، بل يكلمه بكلام يفهمه ويعرفه ويتحققه، وهذا واضح في أنه تعالى يكلم عباده كما يشاء.','1','9',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (10,'<span data-type="title" id=toc-10>وجوب الإيمان بأن للنبي صلى الله عليه وسلم حوضاً يوم القيامة</span>
...
وعلى كل حال يجب على الإنسان المؤمن أن يؤمن بما يكون بعد الموت مما ورد في هذه الأحاديث، ويحمله الإيمان على أن يستعد لذلك، وأن يعمل العمل الذي يكون سبباً في نجاته من تلك الأهوال.','1','11',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (12,'<span data-type="title" id=toc-12>وجوب الإيمان بشفاعة النبي صلى الله عليه وسلم</span>
...
وأما الشفاعة التي يشاركه فيها غيره من الأنبياء والملائكة فهي شفاعته لأهل الكبائر من أهل التوحيد أن يخرجوا من النار، فبعدما احترقوا وصاروا فحماً يخرجون من النار بعد مدة الله أعلم بمقدارها، ثم يلقون في نهر في الجنة يقال له: نهر الحياة، فينبتون فيه كما تنبت الحبة في حميل السيل، ثم بعد ذلك يتنعمون بما يتنعم به أهل الجنة، وذلك لأنهم من أهل التوحيد ومن أهل العقيدة.','1','12',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (13,'<span data-type="title" id=toc-13>وجوب الإيمان بوقوع فتنة الدجال وقتل عيسى بن مريم له</span>
...
والأحاديث التي في نزول عيسى متواترة أيضاً، وأنه يقتل الدجال باب لد في الشام، وأن عيسى يقيم في المسلمين فيما بعد، فيكسر الصليب الذي للنصارى، ويقتل الخنزير الذي يأكلونه، ويضع الجزية، فلا يقبل إلا الإسلام أو السيف، وينتشر الإسلام كما يشاء الله؛ وذلك في الوقت المستقبل الله أعلم متى يكون ذلك.','1','13',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (14,'<span data-type="title" id=toc-14>الإيمان قول وعمل يزيد وينقص</span>
...
ثم أفضل الناس بعد هؤلاء أصحاب رسول الله صلى الله عليه وسلم القرن الذي بعث فيهم، كل من صحبه سنة أو شهراً أو يوماً أو ساعة ورآه فهو من أصحابه، له الصحبة على قدر ما صحبه، وكانت سابقته معه وسمع منه ونظر إليه نظر، فأدناهم صحبة أفضل من القرن الذي لم يروه ولو لقوا الله بجميع الأعمال كان هؤلاء الذين صحبوا النبي صلى الله عليه وسلم ورأوه وسمعوا منه أفضل -لصحبتهم- من التابعين ولو عملوا كل أعمال الخير].','1','15',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (16,'<span data-type="title" id=toc-16>سبب كلام أهل السنة في موضوع الصحابة</span>
...
والأحاديث التي في فضله رضي الله عنه كثيرة ذكر أكثرها الإمام أحمد في كتابه الذي سماه (فضائل الصحابة)، وكذلك الأحاديث التي في فضل عمر وعثمان وعلي رضي الله عنهم.','1','16',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (17,'<span data-type="title" id=toc-17>أفضلية الخلفاء الراشدين كترتيبهم في الخلافة</span>
...
ثم بعده بويع عثمان، وصار هو الخليفة بعده، ولم يزل كذلك إلى أن قتله الثوار الذين ثاروا عليه، ولما قتل لم يكن هناك أولى من علي رضي الله عنه، فتمت له البيعة، إلا أن أهل الشام توقفوا عن البيعة حتى يمكنهم من قتلة عثمان، وانفصلوا، وإنما حصل الانفصال بين أهل الشام وبين أهل العراق، وتمت الخلافة لـ علي في العراق وفي الحجاز وفي اليمن وفي خراسان، وانفصلت الشام ثم مصر، وصار في الولاية على الشام ومصر معاوية إلى أن قتل علي رضي الله عنه، ولما قتل تولى بعده ابنه الحسن نصف سنة، ثم إنه تنازل عن الخلافة وسلمها لـ معاوية.','1','17',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (18,'<span data-type="title" id=toc-18>الصحابة خير قرون هذه الأمة</span>
...
وكل من رأى النبي صلى الله عليه وسلم مؤمناً به واستمر على إيمانه إلى أن مات وهو على ذلك فله فضل الصحبة؛ وكذلك من صحب النبي صلى الله عليه وسلم وشهد له بالرسالة وبايعه أو رآه فهو من أصحابه وله هذه الميزة وهذه الفضيلة، وهذه الفضيلة لا يدركها غيرهم.','1','18',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (19,'<span data-type="title" id=toc-19>أفضل هذه الأمة بعد الصحابة رضي الله عنهم التابعون ثم تابعوهم</span>
...
فيعتقد المسلمون فضل الصحابة، ويعتقدون أنهم خير قرون هذه الأمة، وأن هذه الأمة أفضل القرون.','1','19',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (20,'<span data-type="title" id=toc-20>طعن الرافضة على الصحابة والرد عليهم</span>
...
وبكل حال فتلفيقاتهم وأكاذيبهم كل ذلك مما يموهون به على الناس، وهم في الحقيقة أبعد عن أن يكونوا أهل حق وصواب.','1','20',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (21,'<span data-type="title" id=toc-21>وجوب طاعة ولاة الأمر والرد على من أباح الخروج عليهم</span>
...
والحمد لله رب العالمين، وصلى الله على سيدنا محمد، وعلى آله وصحبه أجمعين.','1','21',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (22,'<span data-type="title" id=toc-22>أصول السنة للإمام أحمد [٢]</span>
لا نجاة للعبد ولا فوز ولا فلاح إلا باتباع كتاب الله وسنة رسوله صلى الله عليه وسلم، وإن أهم ما جاء به الكتاب والسنة مسائل الاعتقاد، فيجب على كل مسلم أخذ عقيدته وتوحيده من هذين المصدرين على فهم سلف الأمة، ومن تلك العقائد: عدم الخروج على ولاة الأمر، والصلاة خلفهم وطاعتهم بالمعروف، وقتال البغاة واللصوص، وأن الزاني المحصن يرجم، وأن البعث حق والجنة والنار مخلوقتان.','2','1',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (23,'<span data-type="title" id=toc-23>حكم الخروج على ولاة الأمر</span>
...
وكأنه عرف منه أنه معتدٍ، وأنه جاء لأجل الفساد أو أنه ليس من أهل العصمة، ولكن ما دام أنه قد وردت الأدلة في أنهم يدفعون بالتي هي أحسن، وأنه إذا جرح أحد منهم فلا يجهز عليه، أي: لا يتمم قتله، ولا يتبع مدبرهم، أي: المنهزم منهم لا يتبع بل يترك؛ دل ذلك على أنهم لم يخرجوا من الإسلام، فيهددهم ويخوفهم بعدما يذكرهم، فإذا لم ينفع فيهم التذكير ولا التخويف ولا التهديد أظهر لهم أن عنده من القوة ما يدفعهم وما يردهم، فإذا لم يندفعوا استعمل القوة بأدنى مراتبها، فإن كانوا يُكفون بضربهم بالعصي اكتفى بذلك ولم يستعمل السلاح، فإذا لم يكفوا استعمل السكين دون السيف، وإذا لم يكفوا استعمل السيف أو نحوه مما يقاتل به في هذه الأزمنة، كالرصاص ونحوه، فله أن يستعمل ذلك لدفع كيدهم ولدفع شرهم، وسواء كان اعتداؤهم لأجل قتله أو لأجل ماله أو لأجل محارمه أو ما أشبه ذلك، فكل هؤلاء من اللصوص المعتدين يدفعون بما يندفع به شرهم أو يرفع بأمرهم إلى من يأخذ على أيديهم.','2','3',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (25,'<span data-type="title" id=toc-25>حكم الشهادة لمعين بالجنة أو بالنار</span>
...
كذلك أيضاً قوله صلى الله عليه وسلم: (لا يدخل الجنة من في قلبه مثقال ذرة من كبر) أو قوله: (لا يدخل الجنة قتات) أو نمام، هل نقول: إن هؤلاء من أهل النار؟
...
فالمحصن من السنة أن يرجم حتى يموت إذا قامت عليه البينة، أو اعترف بالزنا أربع مرات وبقي على اعترافه إلى أن يقام عليه الحد.','2','6',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (28,'<span data-type="title" id=toc-28>حكم من انتقص أحداً من صحابة رسول الله صلى الله عليه وسلم</span>
...
وأحاديث الوعيد تُجرى على ظاهرها؛ ليكون أبلغ في الزجر، مع الاعتقاد أنها لا توصل إلى الخروج من الملة، فلا نقول: إن هذا قد كفر وخرج من الإسلام بهذا الذنب، بل نقول: عمله عمل كفر وأما هو فلا يكون كافراً، ففرق بين العمل وبين العامل، فالعمل قد يكون من أعمال الكفار أو من أعمال المنافقين ولا يلزم أن كل من عمل هذا العمل يخرج من الإسلام ويدخل في الكفر، بل أمرهم إلى الله تعالى، ونحثهم على التوبة والرجوع إلى الله.','2','8',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (30,'<span data-type="title" id=toc-30>وجوب الإيمان بخلق الجنة والنار</span>
...
فالمشرك الذي يُعرف منه الشرك وسواء كان قبورياً أو نحوه يعتبر بذلك ليس بمسلم، وليس بموحد، فلا يصلى عليه، وما ورد أيضاً أن الإمام يترك الصلاة على بعض العصاة فذلك لأجل الزجر عن فعله، فلا يصلي الإمام على من قتل نفسه، ولا يصلي على الغالِّ الذي يغل من الغنيمة، زجراً عن مثل هذا الذنب، ولكن يأذن لهم بأن يصلوا عليه حتى ولو كان قاتل نفسه ونحو ذلك، ما دام لم يخرج من الإسلام.','2','10',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (32,'<span data-type="title" id=toc-32>الأسئلة</span>','2','11',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (33,'<span data-type="title" id=toc-33>سبب ذكر الإمام أحمد للرجم وقتال اللصوص في هذه الرسالة التي تتكلم في العقيدة</span>
...
وإذا كان يعتقد وجوب الصوم ولكن تركه تكاسلاً وتفريطاً، فإنه يعامل في الدنيا بما يعامل به الكفار، فيقال له: صم والتزم، فإذا أصر وقال: لا أصوم ولو قتلتموني ولو مزقتموني ولو قطعتم أعضائي، قتل بعد ذلك، ولا يصلى عليه، وأما عقيدته فأمره إلى الله.','2','14',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (36,'<span data-type="title" id=toc-36>بعض الأدلة على فضائل الصحابة</span>
...
فإذاً: التوبة التي تابها الله عليه وعلى الصحابة لا شك أنها إما من شيء من الغفلة كان ينبغي أن يعمروا وقتها بطاعة الله، وإما من الأمور الاجتهادية التي يجتهدونها ويعملونها لأجل رضا الله تعالى، ولكن يكونون فيها مجتهدين مخطئين كما حصل من الاجتهادات التي نبه الله تعالى نبيه على بعضها، كقوله تعالى: {عَبَسَ وَتَوَلَّى} [عبس:١] إلى آخر الآيات، وكقوله: {مَا كَانَ لِنَبِيٍّ أَنْ يَكُونَ لَهُ أَسْرَى حَتَّى يُثْخِنَ فِي الأَرْضِ} [الأنفال:٦٧]، وكقوله: {وَلا تُصَلِّ عَلَى أَحَدٍ مِنْهُمْ مَاتَ أَبَدًا وَلا تَقُمْ عَلَى قَبْرِهِ} [التوبة:٨٤] وما أشبه ذلك.','2','18',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (40,'<span data-type="title" id=toc-40>حكم صلاة العلماني</span>

<span data-type="title">السؤال</span>
  هناك من العلمانيين من يصلي، ولكن أفكارهم كفرية معلومة، فهل يحكم بأنهم مسلمون من أجل صلاتهم؟

<span data-type="title">الجواب</span>
  يعاملون في الدنيا معاملة المسلمين، ونحن إنما نعمل بالظاهر، وأما في الآخرة فأمرهم إلى الله تعالى، لكن إذا ظهر منهم كلمات توجب الردة، فإنهم يعاقبون بما يعاقب به المرتد.','2','19',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (41,'<span data-type="title" id=toc-41>لا يجوز الزيادة في السنة ما ليس منها</span>

<span data-type="title">السؤال</span>
  ذكر الإمام أحمد في الرسالة: (وليس في السنة قياس ولا تضرب لها الأمثال) فما المراد بذلك؟

<span data-type="title">الجواب</span>
  يظهر أن مراده بالقياس هنا: أن يلحق بها ما ليس منها، ولكن لا يلحق بذلك القياس الذي يراد به إلحاق المسائل بما يشابهها عند عدم النص فيها، فيقول: إنه ليس في السنة قياس، بمعنى: أننا لا نلحق بها شيئاً ليس منها ونجعله من السنة ونقول: إنه منصوص عليه.','2','20',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (42,'<span data-type="title" id=toc-42>حكم المال والسلاح الذي أخذه الجنود في حرب الخليج</span>
...
<span data-type="title">الجواب</span>
  أنا أختار أنه يصلي وهو يؤذن حتى يتفرغ لاستماع الخطبة، فإن استماع الخطبة واجب وإجابة المؤذن سنة، فإذا دخل وهو يؤذن صلى ركعتين خفيفتين في حالة الأذان، وأجل إجابة المؤذن إلى ما بعد الأذان أو أجله إلى ما بعد الخطبة، ويستمع إلى الخطبة.','2','27',NULL,NULL,'0');
INSERT INTO [b11525] VALUES (49,'<span data-type="title" id=toc-49>نصيحة عامة للشباب</span>
...
والحمد لله رب العالمين.','2','28',NULL,NULL,'0');
