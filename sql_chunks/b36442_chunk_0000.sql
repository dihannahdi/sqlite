...
CREATE TABLE "b36442"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36442
INSERT INTO [b36442] VALUES (1,'لا تغضب

تأليف
محمد بن أحمد العماري
عضو الدعوة والإرشاد بمكة المكرمة

جميع الحقوق لكل مسلم',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b36442] VALUES (2,'<span data-type="title" id=toc-1>المقدمة</span>
...
الْفَصْلُ الثَّالِثُ: مَعْنَى لاَ تَغْضَبْ إِذْ لاَ يَمْلِكُ أَنْ لاَ يَغْضَب.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (3,'الْفَصْلُ الْرَّابِعُ: الْدَّوَافِعُ عَلَى استمرار الْغَضَبِ.
...
<span data-type="title" id=toc-2>الْفَصْلُ الأَوَّلُ: لاَ تَغْضَبْ</span>.
...
وَقَدْ قِيْل: أَقْرَبُ مَا يَكُونُ الإنْسَان؟ مِنْ غَضَبِ الْرَّحْمَن إِذَا كَانَ غَضْبَان.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (4,'عَنَ عَبْدِ اللهِ بْنِ عَمْرٍو - رضي الله عنه - قَالَ: قُلْتُ: يَا رَسُوْلَ اللهِ: مَاذَا يُبَاعِدُنِي مِنْ غَضَبِ اللهِ؟ قَالَ: (لاَ تَغْضَبْ) رَوَاهُ أَحْمَدُ (١).
وَعَنْ جُنْدَبٍ - رضي الله عنه -: أَنَّ رَسُوْلَ اللهِ - صلى الله عليه وسلم - حَدَّثَ: أنَّ رَجُلاً قَالَ: وَاللهِ لاَ يَغْفِرُ اللهُ لِفُلاَنٍ وَإِنَّ الله َتَعَالَى قَالَ: مَنْ ذَا الْذِي يَتَأَلَّى عَلَيَّ أَنْ لاَ أَغْفِرَ لِفُلاَنٍ فَإِنِّي قَدْ غَفَرْتُ لِفُلاَنٍ وَأَحْبَطتُ عَمَلَكَ أَوْ كَمَا قَالَ. رَوَاهُ مُسْلِمٌ (٢).
قَالَ أَبُو هُرَيْرَةَ - رضي الله عنه -: فَوَالْذِي نَفْسِي بِيَدِهِ لَتَكَلَّمَ بِكَلِمَةٍ أَوْبَقَتْ دُنْيَاهُ وَآخِرَتَهُ). رواه ابن حبان وبن المبارك (٣).
...
وَعَنْ أَبِي هُرِيْرَةَ - رضي الله عنه -: أَنَّ رَجُلاً قَالَ: للنَّبي - صلى الله عليه وسلم -: أَوْصِنِي. قَالَ: (لاَ تَغْضَبْ). فَرَدَدَ مِرَارَاً قَالَ: (لاَ تَغْضَبْ) رَوَاهُ البُخَارِي (٤).
_________
(١) المسند رقم٦٣٤٦ج١٣ص٣٨٤.
(٢) صحيح مسلم رقم ج٤/ص٢٠٢٣ باب تحريم الكبر ٢٦٢١.
(٣) صحيح ا بن حبان ج١٣ص٢٠ومسند ابن المبارك ج١ص٢٠
(٤) صحيح البخاري رقم٥٦٥١ج٩ص٧٤ باب الحذر من الغضب.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (5,'وَعَنْهُ - رضي الله عنه -: أَنَّ جَابِراً - رضي الله عنه - قَالَ: جَاءَ رَجُلٌ إِلى النَّبيِّ - صلى الله عليه وسلم -؟ فَقَالَ: عَلِمْنِي شَيْئَاً يَا رَسُولَ اللهِ: أَدْخُلُ بِهِ الْجَنَّةَ وَلاَ تُكْثِرْ عَلَيَّ لَعَلِّي أَعْقِلُ قَالَ: (لاَ تَغْضَبْ). رواه الْتِّرْمِذِي (١) , وَأَحْمَدُ (٢) , وَالْحَاكِمُ (٣) , وَصَحَّحَهُ , وسَكَتَ عَنْهُ الْذَّهَبِي.
...
<span data-type="title" id=toc-3>الْفَصْلُ الْثَّانِي: أَسْبَابُ الْغَضَبِ</span>.
...
عَنْ أَبِي هُرَيْرَةَ - رضي الله عنه - قَالَ: قَالَ رَسُولُ اللهِ - صلى الله عليه وسلم -: (لَيْسَ الْشَّدِيْدُ بِالْصُّرَعَةِ وإِنَّمَا الْشَّدِيْدُ الْذِي يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ). رواه البخاري (٢) ومسلم (٣)
الْسَّبَبُ الْثَّالِثُ: الْعِلْمُ بِمَا يَكْرَهُ فَإِذَا علم بما يكره داهمه الغضبُ في نفسِ المكان فليمسك اليد واللسان. عَنِ ابْنِ مَسْعُودٍ - رضي الله عنه - عَنِ النَّبِيِّ - صلى الله عليه وسلم - قَالَ: (مَا تَعُدُّوْنَ الْصُّرَعَةَ فِيْكُمْ؟). قُلْنَا: الْذِي لاَ يَصْرَعُهُ الْرِّجَالُ قَالَ: (لَيْسَ ذَلِكَ). وَلَكِنَّهُ الْذِي يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ).رواه مسلم (٤)

<span data-type="title" id=toc-4>الْفَصْلُ الْثَّالِثُ: مَعْنَى لاَ تَغْضَبْ</span>؟
...
(٤) مسلم ج١٣ص١٨باب فضل من يملك نفسه عند الغضب',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (7,'عَنْ أَبِي هُرَيْرَةَ - رضي الله عنه - يَقُوْلُ: سَمِعْتُ رَسُوْلَ اللهِ - صلى الله عليه وسلم - يَقُوْلُ: (اللَّهُمَّ إِنَّمَا مُحَمَّدٌ بَشَرٌ يَغْضَبُ كَمَا يَغْضَبُ الْبَشَرُ). رَوَاهُ مُسْلِمٌ (١).
...
(٦) المسند رقم١٥٠٨٤ج٣١ص٢٣٦',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (8,'عَنْ أَبِي ذَرٍّ - رضي الله عنه - قَالَ: قاَلَ لِي رَسُولُ اللهِ - صلى الله عليه وسلم -: (يَا أَبَا ذَرٍّ إِنَّي أَرَاكَ ضَعِيْفاً, وَإِنِّي أُحِبُّ لَكَ مَا أُحِبُّ لِنَفْسِي فَلاَ تَأَمَّرَنَّ عَلَى اثْنَيِنِ ولا تَولَّيَنَّ مَالَ يَتِيْمٍ). رَوَاهُ مُسْلِمٌ (١).
...
عَنْ أَبِي هُرَيْرَةَ - رضي الله عنه - قَالَ: قَالَ رَسُولُ اللهِ - صلى الله عليه وسلم -: (لَيْسَ الْشَّدِيْدُ بِالْصُّرَعَةِ وإِنَّمَا الْشَّدِيْدُ الْذِي يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ). رواه البخاري (٢) ومسلم (٣)
وَعَنِ ابْنِ مَسْعُودٍ - رضي الله عنه - عَنِ النَّبِيِّ - صلى الله عليه وسلم - قَالَ: (مَا تَعُدُّوْنَ الْصُّرَعَةَ فِيْكُمْ؟). قُلْنَا: الْذِي لاَ يَصْرَعُهُ الْرِّجَالُ قَالَ: (لَيْسَ ذَلِكَ). وَلَكِنَّهُ الْذِي يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ).رواه مسلم (٤).
وَكَانَ النَّبِيُّ - صلى الله عليه وسلم - مِنَ أَقْوَى الْنَّاسِ عِنْدَ الْغَضَبِ؛ إِذ ْ لاَ يُنَفِّذُهُ إِذَا غَضِبَ.
_________
(١) مسلم رقم ١٨٢٦ ج٣ص١٤٥٧ باب كراهة الإمارة بغير ضرورة
(٢) البخاري ٥٦٤٩ج١٩ص٧٢باب الحذر من الغضب
(٣) مسلم رقم٤٧٢٣ج١٣ص١٩باب فضل من يملك نفسه عند الغضب
(٤) مسلم ج١٣ص١٨باب فضل من يملك نفسه عند الغضب.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (9,'عَنْ عَائشَةَ - رضي الله عنها - قَالَتْ: مَا ضَرَبَ رَسُولُ اللهِ - صلى الله عليه وسلم - شَيْئَاً قَطُّ بِيَدِهِ ولا امْرَأَةً وَلاَ خَادِمَاً؛ إلا أَنْ يُجَاهِدَ فِي سَبِيْلِ اللهِ، وَمَا نِيْلَ مِنْهُ شَيءٌ قَطُّ فَانْتَقَمَ مِنْ صاحبِهِ؛ إلا أَنْ يُنْتَهَكَ شيءٌ مِنْ مَحُارُمِ اللهِ, فَيَنْتَقِمَ للهِ عَزَّ وَجَلَّ) رَوَاهُ مُسْلِمٌ (١).
...
<span data-type="title" id=toc-5>الْفَصْلُ الْرَّابِعُ: الْدَّوَافِعُ عَلَى اسْتِمْرَارِ الْغَضَبِ</span>.
<span data-type="title" id=toc-6>الْدَّافِعُ الأَوَّلُ: الْظَّنُ بَأَنَّهُ قُوَّةٌ</span>؛ وَلَيْسَ كَذَلِكَ بَلْ هْوَ ضَعْفٌ؛ فَلاَ أَضْعَفَ مِنْ إِنْسَان لاَ يَمْلِكُ الْيَدَ, وَالِّلسَان.
...
(٤) مسلم رقم٤٧٢٣ج١٣ص١٩باب فضل من يملك نفسه الغضب',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (10,'عَنِ ابْنِ مَسْعُودٍ - رضي الله عنه - عَنِ النَّبِيِّ - صلى الله عليه وسلم - قَالَ: (مَا تَعُدُونَ الْصُّرَعَةَ فِيْكُمْ؟). قُلْنَا: الْذِي لاَ يَصْرَعُهُ الْرِّجَالُ قَالَ: (لَيْسَ ذَلِكَ). وَلَكِنَّهُ الْذِي يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ). رواه مسلم (١).

<span data-type="title" id=toc-7>الْدَّافِعُ الْثَّانِي: مُجَالَسَةُ مَنْ هُوَ كَثِيْرُ الْغَضَبِ؛ الْمُفَاخِرُ بِالْغَضَبِ</span>, الْذِي يَقُولُ: أَنَا لاَ أَعْفُو عَنْ خَطَا، وَلاَ أَتَجَاوَزُ عَمَّنْ هَفَى، وَآخُذُ بِالْصَغِيْرِ، وَأُطَالِبُ بِالْقِطْمِيْرِ؛ فَيَظُنُّ الْسَّامِعُ أَنَّ هَذِهِ مَنْقَبَةٌ وَمَفْخَرَةٌ؛ فَيُحَاوِلُ أَنْ يُقَلِّدَهُ. وَقَدْ قِيْل: أَسْرَعُ الْعَدْوَى سُوءُ الْخُلُقِ.

<span data-type="title" id=toc-8>الْفَصْلُ الْخَامِسُ: مُسَكِّنَاتُ الْغَضَبِ</span>.
<span data-type="title" id=toc-9>الْمُسَكِّنُ الأَوَّلُ: الْسُّكُوتُ</span>. عَنِ ابْنِ عَبَّاسٍ - رضي الله عنه - قَالَ: قَالَ رَسُولُ اللهِ - صلى الله عليه وسلم -: (إِذَا غَضِبَ أَحَدُكُمْ فَلْيَسْكُتْ) قَالَهَا ثَلاَثَاً. رَوَاهُ أَحْمَدُ (٢) , وَصَحَّحَهُ الأَلْبَانِي (٣).
...
وَقَدْ قِيْل:
_________
(١) مسلم ج ١٣ص١٨باب فضل من يملك نفسه الغضب
(٢) المسند رقم٢١٣٦ج١ص٢٣٩
(٣) السلسلة الصحيحة رقم٣٦٣',NULL,'9',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (11,'تَخَالهُمُ فِي الْنَّاسِ صُمَّاً عَنِ الْخَنَا وَخُرْسَاً عَنِ الْفَحْشَاءِ عِنَّدَ الْتَهَاجُرِ
...
<span data-type="title" id=toc-10>الْمُسَكِّنُ الْثَّانِي: أَنْ يُمْسِكَ الْغَضْبَان الْيَدَ وَاللِّسَان</span>.
...
<span data-type="title" id=toc-11>الْمُسَكِّنُ الْثَّالِثُ: الاسْتِعَاذَةُ باِللهِ مِنَ الْشيطانِ</span>.
...
_________
(١) مسلم ج١٣ص١٨ باب فضل من يملك نفسه الغضب',NULL,'10',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (12,'وَعَنْ سُلَيْمَانَ ابْنِ صُرَدٍ - رضي الله عنه - قَالَ: اسْتَبَّ رَجُلاَنِ عِنْدَ النَّبِيِّ - صلى الله عليه وسلم - وَنَحْنُ عِنْدَهُ جُلُوْسٌ وَأَحَدُهُمَا يَسُبُّ صَاحِبَهُ مُغْضَباً قَدِ احْمَرَّ وَجْهُهُ, فَقَالَ: النَّبِيُّ - صلى الله عليه وسلم -: (إِنِّي لأَعْلَمُ كَلِمَةً لَو قَالَهَا لَذَهَبَ عَنْهُ مَا يَجِدُ لَو قَالَ: أَعُوْذُ بِاللهِ مِنَ الْشَّيْطَانِ الْرَّجِيْمِ). فَقَالُوا للرَّجُلِ: ألاَ تَسْمَعُ مَا يَقُولُ النَّبِيّ - صلى الله عليه وسلم - قَالَ: إِنِّي لَسْتُ بِمَجْنُونٍ. رَوَاهُ الْبُخَارِيُّ (١) , وَمُسْلِمُ (٢)

<span data-type="title" id=toc-12>الْمُسَكِّنُ الْرَّابِعُ: مَنْ كَانَ قَائِماً فَلْيَجْلِسْ؛ فَإِنْ ذَهَبَ الْغَضَبُ وَإلا فَلْيَضْطَجِعْ</span>.
عَنْ أَبِي ذَرٍّ - رضي الله عنه - قَالَ: قَالَ رَسُولُ اللهِ - صلى الله عليه وسلم -: (إِذَا غَضِبَ أَحَدُكُمْ وَهُوَ قَائِمٌ فَلْيَجْلِسْ فَإِن ذَهَبَ عَنْهُ الْغَضَبُ وَإِلاَّ فَلْيَضْطَّجِعْ). رَوَاهُ أَحْمَدُ (٣) , وَأَبُو دَاودَ (٤) , وصححه الألباني (٥).
قَالَ ابْنُ رَجَبٍ رَحِمَهُ الله ُ: فَالْقَائِمُ مُتَهَيِّئٌ للشَّرِّ، وَالْقَاعِدُ دُوْنَهُ، وَالْمُضْطَجِعُ أَبْعَدُ
_________
(١) صحيح البخاري رقم ٥٦٥٠ج٩ص٧٢باب الحذر من الغضب.
(٢) مسلم رقم ٤٧٢٥ج١٣ص١٩باب فضل من يملك نفسه عند الغضب
(٣) المسند رقم٢٠٣٨٦ج١٧ص٣٢٢
(٤) السنن رقم٤١٥١ج١٢ص٤٠٢
(٥) الألباني انظر المشكاة رقم٥١١٤',NULL,'11',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (13,'<span data-type="title" id=toc-13>الْمُسَكِّنُ الْخَامِسُ: الْوَضُوءُ</span>.
عَنْ عُرْوَةَ بْنِ مُحَمَّدٍ السَّعْدِي عَنْ أَبِيهِ عَنْ جَدِّهِ عَطِيَةَ: عَنِ النَّبِيِّ - صلى الله عليه وسلم - قال: (إِنَّ الْغَضَبَ مِنَ الْشَّيْطَانِ وَإِنَّ الْشَّيْطَانَ خُلِقَ مِنَ الْنَّارِ , وَإِنَّمَا تُطْفَأُ الْنَّارُ بِالْمَاءِ , فَإِذَا غَضِبَ أَحَدُكُمْ فَلْيَتَوَضَأْ). رَوَاهُ أَبُو دَاودَ (١) , وَضَعَّفَهُ الألباني (٢).

<span data-type="title" id=toc-14>الْمُسَكِّنُ الْسَّادِسُ: تَذَكُّرُ قُدْرَةِ اللهِ عَلَيْهِ</span>عِنْدَ قُدْرَتِهِ عَلَى غَيْرِهِ.
...
قَالَ ابْنُ عَبَاسٍ - رضي الله عنه -: الْطَّائِفُ هُوَ الْغَضَبُ.
...
(٣) الصحيح رقم١٦٥٩ج٣ص١٢٨٦',NULL,'12',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (14,'قَالَ أَبُو مَسْعُوْدٍ - رضي الله عنه - ُ فَقَلْتُ: لاَ أَضْرِبُ مَمْلُوْكاً بَعْدَهُ أَبَداً).رواه مسلم (١)
...
_________
(١) صحيح مسلم رقم ١٦٥٩ج٣ص١٢٨٦.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (15,'<span data-type="title" id=toc-15>الْمُسَكِّنُ الْسَّابِعُ: تَذَكُّرُ ثَوَابِ الْعَفْوِ عِنْدَ الْمَقْدِرَةِ مِنْ الْعِزَّةِ وَالْمَغْفِرَةِ</span>.
...
(٢) صحيح مسلم رقم ٢٥٨٢ج٤ص١٩٩٧باب تحريم الظلم.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (16,'<span data-type="title" id=toc-16>الْفَصْلُ الْسَّادِسُ: مَوَانِعُ الْغَضَبِ</span>.
<span data-type="title" id=toc-17>الْمَانِعُ الأَوَّلُ: الْعِلْمُ بِأَنَّ عِزَّ الْنَفْسِ في ذُلِّهَا، فَمَنْ نَصَرَهَا أَذَلَّهَا، وَمَنْ أَذَلَّهَا أَعَزَّهَا</span>.
...
<span data-type="title" id=toc-18>الْمَانِعُ الْثَّانِي: الْحِلْمُ</span>.
...
INSERT INTO [b36442] VALUES (17,'<span data-type="title" id=toc-19>الْمَانعُِ الْثَّالِثُ: الْتَّحَلُّمُ بِمُخَالَطَةِ مَنْ كَانَ حَلِيْماً لِيَتَعَلَّمَ</span>.
...
وَقاَلَ بَعْضُ الْحُكَمَاءِ: إذا لَمْ تَكُنْ حَلِيْماً فَتَحَلَّمْ. فَقَلَّمَا تَشَبَّهَ رَجُلٌ بِقَوْمٍ إلا كَانَ مِنْهُمْ.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (18,'<span data-type="title" id=toc-20>الْمَانِعُ الْرَّابِعُ: تَذَكُّرُ كَرَاهَةِ الْنَّاسِ لَهُ</span>.
...
طَلَقَ رَجُلٌ زَوْجَتَهُ فَقَالَ: كُنْتِ ثُمَّ بِنْتِ، فَقَالَتْ: واللهِ مَا فَرِحْنَا يومَ كُنَّا، وَلانَدِمْنَا يومَ بِنَّا، فَنَدِمَ. وأَكْثَرَتْ امْرَأَةٌ الْغَضَبَ عَلَى زَوْجِهَا؛ فأَخَرَجَ عَقْدَ الْنِّكَاحِ؛ فَأَخَذَ يَبْحَثُ فيهِ، فَقَالَتْ: عَنْ أَيِّ شَيءٍ تَبْحَثُ؟ قَالَ: عَنْ تَارِيخِ الانْتِهَاء.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (19,'والولَدُ يَفْرَحُ بِالبُلُوغِ والرُّشْدِ، ليخرجَ مِنَ القَيْدِ والشَّدِّ، والموظفُ يَفْرَحُ بِفَصْلِهِ وَنَقْلِهِ، لِيَرْتاحَ مِنْ شَرِّهِ، بخلافِ مَنْ لا يَغْضَبُ؛ فالكُلُّ فيهِ يَرْغَبُ؛ فَالْزَّوْجَةُ إِنْ مَاتَ أَوْ طَلَّقَ بَقْيَتْ عَلَيْهِ تُحَلِّقُ، وَالْوَلَدُ يَرْشُدُ وعَنْهُ لا يَصُدُّ، وَالْمُوَظَّفُ فِي رَاحَه مَادَامَ مَوْجُوْدَاً صَرَاحَه؛ وَمَاذَاكَ إِلاَّ لِتَرْكِ الْغَضَبِ هُنَاكَ؛ فَإِنْ عَاتَبَ عَاتَبَ فِي لِيْنٍ إِنْ لَمْ يَعْفُ وَيَسْتُرْ، وَإِنْ عَاقَبَ كَانَ عَلَى قَدْرِ الْذَنَّبِ إِنْ لَمْ يَغْفِرْ.
...
<span data-type="title" id=toc-21>الْمَانِعُ الْخَامِسُ: تَذَكُّرُ نِهَايةِ الْغَضَبِ؛ مِنْ القَتْلِ وَالْسِّجْنِ، وَالْنَّدَمِ والْحُزْنِ</span>.
...
وَإِنْ ضَرَبَ الأَشْخَاص؛ نَدِمَ مِنَ الاقْتِصَاص. قَالَ تَعَالَى {وَكَتَبْنَا عَلَيْهِمْ فِيهَا أَنَّ النَّفْسَ بِالنَّفْسِ وَالْعَيْنَ بِالْعَيْنِ وَالأَنفَ بِالأَنفِ وَالأُذُنَ بِالأُذُنِ وَالسِّنَّ بِالسِّنِّ وَالْجُرُوحَ قِصَاصٌ فَمَن تَصَدَّقَ بِهِ فَهُوَ كَفَّارَةٌ لَّهُ وَمَن لَّمْ يَحْكُم بِمَا أنزَلَ اللّهُ فَأُوْلَئِكَ هُمُ الظَّالِمُونَ} (المائدة٤٥).
فَإِنْ سَلِمَ فِي الْدُّنْيَا؛ قَدْ لاَ يَسْلَمُ فِي الأُخْرَى.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (20,'عَنْ أَبِي هُرَيْرَةَ - رضي الله عنه - قَالَ: قَالَ رَسُوْلُ اللهِ - صلى الله عليه وسلم -: (لَتُؤَدَّنَّ الْحُقُوْقُ يَوْمَ الْقِيَامَةِ إِلى أَهْلِهَا حَتَى يُقَادَ للشَّاةِ الْجَلْحَاءِ مِنَ الْشَّاةِ الْقَرْنَاءِ) تَفَرَّدَ بِهِ مُسْلِم (١)
وَإِنْ قَتَلَ نَدِمَ مِنَ الْمِثْلِ. قَالَ تَعَالَى {يَا أَيُّهَا الَّذِينَ آمَنُواْ كُتِبَ عَلَيْكُمُ الْقِصَاصُ فِي الْقَتْلَى} (البقرة١٧٨)
وَمَنْ سَلِمَ فِي الْدُّنْيَا قَدْ لاَ يَسْلَمُ فِي الأُخْرَى. قَالَ تَعَالَى: {وَمَن يَقْتُلْ مُؤْمِناً مُّتَعَمِّداً فَجَزَآؤُهُ جَهَنَّمُ خَالِداً فِيهَا وَغَضِبَ اللّهُ عَلَيْهِ وَلَعَنَهُ وَأَعَدَّ لَهُ عَذَاباً عَظِيماً} (النساء٩٣).

<span data-type="title" id=toc-22>الْمَانِعُ الْسَّادِسُ: تَذَكُّرُ آثَارِ الْغَضَبِ</span>.
...
<span data-type="title" id=toc-24>الْفَصْلُ الْثَّامِنُ: الْغَضَبُ الْمَذْمُوْمُ</span>.
وَهُوَ مَا كَانَ لِلْخَلْقِ؛ لاَ لِلْحَقِّ؛ وَهْوَ أَنْوَاعٌ.
الْنَّوْعُ الأَوَّلُ: الْغَضَبُ للنَّفْسِ.',NULL,'20',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (22,'فَلاَ يَسْمَحُ الْغَضْبَانُ. أَنْ يَنَالَهُ إِنْسَانٌ بِقَوْلٍ , أَوْ فِعْلٍ؛ وَإِنْ كَانَ أُمَّاً أَوْ أَباً , أَوْ زَوْجَةً أَوْ أَخاً فَكَيْفَ بِالْغَيْرِ؛ وَخَيْرُ الْهَدِي ِ هَدْيُ الْبَشِيْرِ - صلى الله عليه وسلم -.
عَنْ عَائِشَةَ - رضي الله عنها - قَالَتْ (مَا انْتَقَمَ رَسُوْلُ اللهِ - صلى الله عليه وسلم - لِنَفْسِهِ). رَوَاهُ مُسْلِمُ (١).
...
عَنْ أَبِي هُرَيْرَةَ - رضي الله عنه - أَنَّ رَسُوْلَ اللهِ - صلى الله عليه وسلم - قَالَ: (مَنْ قاتلَ تَحْتَ رَايَةٍ عِمِّيَةٍ يَغْضَبُ لِعَصَبَةٍ , أَوْ يَدْعُو إِلَى عَصَبَةٍ , أَوْ يَنْصُرُ عَصَبَةً فَقُتِلَ , فَقِتْلَةٌ جَاهِلِيَّةٌ). رَوَاهُ مُسْلِمٌ (٢).
...
قَالَ تَعَالَى: {إِذْ جَعَلَ الَّذِينَ كَفَرُوا فِي قُلُوبِهِمُ الْحَمِيَّةَ حَمِيَّةَ الْجَاهِلِيَّةِ فَأَنزَلَ اللَّهُ سَكِينَتَهُ عَلَى رَسُولِهِ وَعَلَى الْمُؤْمِنِينَ وَأَلْزَمَهُمْ كَلِمَةَ التَّقْوَى وَكَانُوا أَحَقَّ بِهَا وَأَهْلَهَا وَكَانَ اللَّهُ بِكُلِّ شَيْءٍ عَلِيماً} (الفتح٢٦)
_________
(١) مسلم رقم٢٣٢٧ج٤ص١٨١٣باب مباعدته للآثام
(٢) صحيح مسلم رقم١٨٤٨ج٣ص١٤٧٦.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (23,'فَبِالْحَمِيَّةِ الْجَاهِلِيَّةِ؛ رَدُّوْا الْرِّسَالَةَ الْرَّ بَّانِيةِ، وَحَارَبُوا نَبِيَّهُ.
...
(٣) سبق تخريجه.
(٤) سبق تخريجه.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (24,'قُلْتُ: فَالْغَضَبُ مِنْ أَجْلِ اللهِ لاَ يُحِلُ مَا حَرَمَ اللهُ؛ مِنَ الأنفسِ والأموالِ، والأعراضِ والأقوالِ، والأعمالِ والأفعالِ. فقدْ غَضِبَ رَسُوْلُ اللهِ - صلى الله عليه وسلم -؛ وَلَمْ يَخْرُجْ عَنْ وَحْي اللهِ.
...
عَنِ ابْنِ عَبَّاسٍ - رضي الله عنه - قَالَ: كَانَتِ امْرَأَةٌ تُظْهِرُ فِي الإِسْلاَم ِ الْسُّوْءَ فَقَالَ الْنَّبِيُّ: - صلى الله عليه وسلم - (لَوْ رَجَمْتُ أَحَداً بِغَيْرِ بَيِّنَةٍ لَرَجَمْتُ هَذِهِ). رَوَاهُ الْبُخَارِي (١).
...
_________
(١) البخاري رقم٤٨٩٨ج١٦ص٣٦٩كتاب الطلاق باب قول النبي - صلى الله عليه وسلم - لو كنت راجماً بغير بينة',NULL,'23',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (25,'فَتَأَمَّلْ حَدِيْثَ الْنَّبِيِّ - صلى الله عليه وسلم -: (لَوْ رَجَمْتُ أَحَداً بِغَيْرِ بِينَةٍ لَرَجَمْتُ هَذِهِ). وَاعْلَمْ أَنَّ الْنَّبِيَّ - صلى الله عليه وسلم - لَمْ يَعْذُرْ صَاحِبَ الْغَيْرَه؛ في كَسْرِ صَحْفَةِ غَيْرِهِ.
...
(٢) صحيح مسلم رقم١٤٢ج١ص٢٦٠',NULL,'25',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (27,'عَنْ نَافِعٍ عَنِ ابْنِ عُمَرَ - رضي الله عنه - أَتَاهُ رَجُلاَنِ فِي فِتْنَةِ ابْنِ الزُّبَيْرِ, فَقَالاَ إِنَّ النَّاسَ صَنَعُوا وَأَنْتَ ابْنُ عُمَرَ وَصَاحِبُ النَّبِيِّ - صلى الله عليه وسلم - , فَمَا يَمْنَعُكَ أَنْ تَخْرُجَ؟ فَقَالَ: يَمْنَعُنِي أَنَّ اللَّهَ حَرَّمَ دَمَ أَخِي, فَقَالا: أَلَمْ يَقُلْ الله: {وَقَاتِلُوهُمْ حَتَّى لَا تَكُونَ فِتْنَةٌ}؟ فَقَالَ: قَاتَلْنَا حَتَّى لَمْ تَكُنْ فِتْنَةٌ وَكَانَ الدِّينُ لله, وَأَنْتُمْ تُرِيدُونَ أَنْ تُقَاتِلُوا حَتَّى تَكُونَ فِتْنَةٌ وَيَكُونَ الدِّينُ لِغَيْرِ الله رواه البخاري (١)

<span data-type="title" id=toc-25>الَفَصْلُ الْتَّاسِعُ: الْغَضَبُ الْمَحْمُوْدُ</span>.
...
_________
(١) البخاري رقم٤١٥٣ (ج ١٣ / ص ٤٥٧)',NULL,'26',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (28,'بِشَرْطِ أَنْ يُضْبَطَ بِالْوَحْيَيْن؛ فَيَحِلُّ مَا أُحِلَّ فِيْهِمَا وَيُحَرِّمُ مَا حُرِّمَ فِيْهِمَا.
قَالَ تَعَالَى: {قَاتِلُوهُمْ يُعَذِّبْهُمُ اللّهُ بِأَيْدِيكُمْ وَيُخْزِهِمْ وَيَنصُرْكُمْ عَلَيْهِمْ وَيَشْفِ صُدُورَ قَوْمٍ مُّؤْمِنِينَ {١٤} {وَيُذْهِبْ غَيْظَ قُلُوبِهِمْ وَيَتُوبُ اللّهُ عَلَى مَن يَشَاءُ وَاللّهُ عَلِيمٌ حَكِيمٌ {١٥} (التوبة ١٤ـ١٥).
وَعَنْ سَعِيْدِ بْنِ زَيْدٍ - رضي الله عنه - قَالَ: سَمِعْتُ الْنبَّيَّ - صلى الله عليه وسلم - يَقَوْلُ: (مَنْ قُتِلَ دَوْنَ دِيْنِهِ فَهْوَ شَهِيْدٌ) رَوَاهُ أَبُو دَاود (١) والترمذي (٢) واللفظ له وقال حديث حسن صحيح.
...
عَنْ عِمْرَانَ بْنِ حُصَيْنٍ - رضي الله عنه - قَالَ: بَيْنَمَا رَسُوْلُ الله ِ - صلى الله عليه وسلم - في بَعْضِ أَسْفَارِهِ وَامْرَأَة ٌمِنَ الأْنَصَارِ عَلَى نَاقَةٍ فَضَجِرَتْ فَلَعَنَتْهَا, فَسَمِعَ ذَلِكَ رَسُوْلُ الله - صلى الله عليه وسلم - فقالَ: (خُذُوْا مَا عَلَيْهَا وَدَعُوْهَا فَإنَّهَا مَلْعُوْنَةٌ) رواه مسلم (٣).
_________
(١) السنن رقم٤١٤٢ج١٢ص٣٨٨
(٢) السنن رقم١٣٤١ج٥ص٣١٥
(٣) صحيح مسلم رقم٢٥٩٥ ج٤/ص٢٠٠٤',NULL,'27',NULL,NULL,'0');
INSERT INTO [b36442] VALUES (29,'قَالَ عِمْرَانُ: فَكَأَنِّي أَرَاهَا الآنَ تَمْشِي فِي الْنَّاسِ مَا يَعْرِضُ لَهَا أَحَدٌ.
...
(٣) سبق تخريجه.',NULL,'29',NULL,NULL,'0');
