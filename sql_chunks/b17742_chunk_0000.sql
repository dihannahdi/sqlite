...
CREATE TABLE "b17742"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b17742
INSERT INTO [b17742] VALUES (1,'لقاء العشر الأواخر بالمسجد الحرام (٦)
...
INSERT INTO [b17742] VALUES (2,'الإنصاف في حُكم الإعتكاف
ويليه
ردع الإخوان عن محدثات آخر جمعة رمضان',NULL,'2',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (3,'حقوق الطبع محفوظة
...
INSERT INTO [b17742] VALUES (4,'بسم الله الرحمن الرحيم',NULL,'4',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (5,'بسم الله الرحمن الرحيم

<span data-type="title" id=toc-1>مقدمة المعتني بالكتاب</span>
...
_________
(١) وفي مقدمتهم: الأخ الفاضل العالم الداعية الشيخ نظام يعقوبي البحريني، والأخ الكريم الباحث الدؤوب الشيخ محمَّد بن ناصر العجمي الكويتي، والأخ الحبيب الناشر المتقن الأستاذ رمزي دمشقية صاحب "دار البشائر الإِسلامية".',NULL,'5',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (6,'فاخترتُ رسالتين من رسائل الإِمام محمَّد عبد الحي اللكنوي رحمه الله تعالى، لهما ارتباط وثيق بمناسبة هذا الشهر المبارك.
...
<span data-type="title" id=toc-4>سببُ تأليف الرسالة وتاريخ كتابتها:</span>
...
<span data-type="title" id=toc-5>مباحث الرسالة:</span>
...
المقام الثالث: هل هو سنَّة مؤكَّدة كفاية أم عينًا؟',NULL,'8',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (9,'المقام الرابع: هل هو سُنَّة كفاية على أهل البلدة، أم على أهل كل محلة؟
...
وانتهى إلى أن: الاعتكاف في نفسه مستحبٌّ، ويجبُ بالنذر وغيره، وهو سنَّة مؤكَّدة كفاية في العشر الأواخر من رمضان على سبيل الاستيعاب.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (10,'<span data-type="title" id=toc-6>حاشية الرسالة "الاِسعاف" وترجمة مؤلِّفها:</span>
...
_________
(١) ٨: ٢٨٩.
(٢) المتوفى سنة ١٣٠١ رحمه الله تعالى، انظر ترجمته في: "النزهة" ٨: ٤٣١ - ٤٣٢.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (11,'ثم سافر إلى (لكنو)، وأخذ عن العلامة عبد الحي بن عبد الحليم الأنصاري اللكنوي، ثم سار إلى (سهارنفور) وأخذ الحديث عن الشيخ أحمد علي بن لطف الله السَّهارنفوري (١) المحدِّث، ثم رجع إلى بلاده.
...
<span data-type="title" id=toc-7>كلمة عن أصول الرسالتين وعملي فيهما:</span>
...
(٢) ص ١٣٦.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (12,'وأما عملي فيهما، فهو بين يدي القاريء، فقد فصَّلت مقاطعهما وجملهما، ونسَّقت الحواشي مع الأصل، واعتنيتُ بعلامات الترقيم والضبط، حتى أصبحت سهلة التناول قريبة الفهم.
...
وفي الختام: أسأل الله عَزَّ وَجَلَّ أن يتقبَّل جهدي اليسير، في خدمة هاتين الرسالتين، ويرزقَني الإِخلاص في العلم والعمل، وكما أسأله سبحانه أن يرحمنا ويرحمَ والدينا ومشايخَنا وسائرَ المسلمين، ويغفرَ لنا ولإِخواننا الذين سبقونا بالإِيمان، ويلحقنا بالصالحين، والحمد لله رب العالمين، وصلَّى الله وسلَّم على سيِّدنا محمَّد وآله وصحبه أجمعين.

وكتبه
مجد بن أحمد مكي
الجمعة ٢٣/ جمادى الأولى ١٤٢٠',NULL,'12',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (13,'بسم الله الرحمن الرحيم
...
هذه تعليقَاتٌ متفرِّقة، مُشْتَمِلَةٌ على فَوَائدَ مُتَشَتِّتة على رسالة المولى المحقِّق، =',NULL,'13',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (14,'قد جَرى النِّزاع (١) بيني وبين بعضِ الفُضَلاء سَنة اثنتين وثمانينَ بعد الألف والمائتين من هجرةِ رسول الثَّقَلَيْن صلَّى عليه وعلى آلِهِ رب المَشْرِقَيْن، في أنَّ الاعتكاف (٢): هل هو سُنَّة مُؤَكَّدةٌ على  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
(١) قوله (قد جَرى النزاع ...) إلخ: كان ذلك في حَيدر آباد من بلاد الدَّكَن مُشَافهةً ومُكالمةً، وذلك بَعْدَمَا عَادَ إليه الأستاذ المُصَنِّف، لا زالتْ شمسُ أفضاله بازغةً، وأقمارُ فيوضِه سَاطعة، عن حجِّ بيت الله الحرام، وزيارةِ مسجدِ النبي عليه الصلاة والسلام مرةً أولى، وكان مُشتغلًا بتحصيلِ العلوم عند والده العلَّام المرحوم هناك.
...
(٣) سورة الفتح، آية ٢٥.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (15,'الكفاية (١)، أو على العَيْن (٢)؟
...
(٣) قوله (مُسْتَحَب): السين والتاء زائدتان، أي: المحبوب فيه، والمحبوب في اللغة: ضد المكروه، واصطلاحًا: ما فعله النبي - صلى الله عليه وسلم - مرةً، وتركَه أخرى، فيثابُ على فعلِهِ، ولا يلامُ على تركه، كما في "شرح الملتقى".
_________
(٤) سورة البقرة، آية ١٢٥.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (16,'وعلى الثاني: هل هو سُنَّة مؤكَّدة أو غيرُ مؤكَّدة (١)؟
...
<span data-type="title" id=toc-9>المقام الأول:
هل الاعتكاف مُسْتَحَبٌّ أو سُنَّة أو مباحٌ أو واجبٌ </span>(٢)؟  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
_________
(٥) في الأصل الثاني في ذكر عبارات الفقهاء والأصوليين الواقعة في تعريف السنَّة المؤكدة مع ما لها وما عليها ص ٦٨ - ٨٦ وأورد عن اثنين وعشرين فقيهًا أقوالهم في تعريفها، وناقشها، وحاكم بينها.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (17,'فَذَهَبَ بعضُ المالكيّة إلى أنَّ الاعتكافَ أمرٌ مباح، وهذا القول ممَّا لا اعتدادَ به.
قال أبو بكر المالكي: قولُ أصحابنا أنَّه جائز (١) جهل.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
=  الترك إن كان ممَّا واظب عليه الرسول - صلى الله عليه وسلم - والخلفاء الراشدون من بعده فسنَّة، وإلَّا فمندوب. ويُطْلب تفصيل هذا البحث من "السعاية في كَشف ما في شرح الوقاية" (٦) للأستاذ.
(١) قوله (قول أصحابنا أنَّه جائز): قال الحافظ ابن حجر في "الفتح": ومن كلام مالك (٧) أَخذ بعض أصحابه أنَّ الاعتكاف جائز، وأنكر ذلك عليهم ابن العربي (٨)، وقال: إنه سُنَّةٌ مؤكَّدة، وكذا قال ابن بطَّال: في مواظبة النبي - صلى الله عليه وسلم عليه ما يدلُّ على تأكُّده (٩)، وقال أبو داود عن أحمد: لا أعلم عن أحدٍ من العلماء خلافًا أنه مسنون (١٠). انتهى.
_________
(٦) ١: ١٦٤ - ١٦٩.
(٧) وهو قوله: "ما رأيت صحابيًّا اعتكف، وقد اعتكف - صلى الله عليه وسلم - حتى قُبض، وهم أشدُّ الناس ... فلم أزل أفكر حتى أخذ بنفسي أنَّه لشدته؛ نهاره وليله سواء؛ كالوصال المنهي عنه مع وصاله المنهي عنه"، نقله ابن رشد في "بداية المجتهد" ١: ٣١٢ وعلَّله بأنَّه كرهه مخافة أنْ لا يوفي بشرطه.
...
(٩) قال ابن عبد البر في "التمهيد" ٢٣: ٥١ - ٥٢: "في هذا الحديث، أي حديث أبي سعيد الخدري: كان رسول الله - صلى الله عليه وسلم - يعتكف العشر الوسط من رمضان ... وهو من أصح حديث يُروى في هذا الباب، دليل على أن الاعتكاف في رمضان سنَّة مسنونة؛ لأن رسول الله - صلى الله عليه وسلم - كان يعتكف في رمضان، ويواظب على ذلك، وما واظب عليه فهو سنَّة لأمته، وأجمع علماء المسلمين على أنَّ الاعتكاف ليس بواجب، وأن فاعله محمودٌ عليه مأجور فيه. وهكذا سبيل السُّنن كلها ليست بواجبة فرضًا، ألا ترى إلى إجماعهم على قولهم: هذا فرض، وهذا سنَّة، أي هذا واجب، وهذا مندوب إليه، وهذه فريضة، وهذه فضيلة انتهى.
(١٠) فتح الباري ٤: ٢٧٢.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (18,'ولم أطَّلع على مَنْ قال بوجوب الاعتكاف مُطْلقًا (١)، بل قد ادَّعى النووي (٢) في "شرح صحيح مسلم" الإِجماعَ على عدم وجوبه (٣).
...
(١٢) شرح صحيح مسلم للنووي ٦٧:٨.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (19,'فذهب القُدُوري (١) في "مختصره" إلى استحبابه، حيث قال: "ويُسْتَحب"، وغيرُه إلى أنه سُنَّة مُؤَكَّدة.
قال المَرْغيناني (٢) في "الهداية": الصحيحُ أنَّه سُنَّةٌ مؤكَّدة؛ لأنَّ النبيَّ - صلى الله عليه وسلم - واظَبَ عليه في العَشْر الأواخر من رمضان (٣)، والمواظَبَةُ دليلُ  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
(٣) قوله (وَاظَب عليه ...): أخرج الأئمة الستة في كتبهم، واللفظُ للبخاريِّ عن عائشةَ زوجِ النبي - صلى الله عليه وسلم -: "أنَّ النبي - صلى الله عليه وسلم - كان يعتكفُ العشرَ الأواخر من رمضان =',NULL,'19',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (20,'السُّنِّيَّة، وهكذا ذكر في "المحيط" (١) و"البدائع" (٢)  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
=  حتى توفَّاه الله، ثم اعتكف أزواجه من بعده" (١٣)، إلَّا ابن ماجه فإنَّه أخرجه عن أُبيِّ بن كَعب قال: "كان النبي - صلى الله عليه وسلم - يعتكفُ العَشْر الأواخرَ من رمضان، فَسَافَر عامًا، فلمَّا كان العام القَابل، اعتكف عشرين يومًا" (١٤)، وأخرجه أبو داود والنسائي أيضًا، ولفظُهما: "ولم يعتكف عامًا" (١٥).
...
(١٥) أخرجه أبو داود (٢٤٥٥)، والنسائي في "الكبرى" ٢: ٢٥٩ (٣٣٤٤).',NULL,'20',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (21,'و"التحفة" (١).
وقال الزاهديُّ في "المُجْتبى" (٢): "قال أستاذنا: الصحيح أنَّه سُنَّة"، ولم أجد في غير مختصر القُدُوريِّ أنه مُسْتَحبٌ، فالظَّاهرُ أنَّه أرادَ بهِ السُّنَّة، كما أنَّه أرادَ أوَّل الكتاب هذا حيث قال: "ويُسْتَحَبُّ للمتوضيء أن ينوي الطَّهارة، ويَسْتَوعبَ رأسَه بالمسْح"، فسمَّاها مُسْتَحَبةً مع أنها من السُّننَ". انتهى.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
(١)  قوله (والتُّحفة): لمحمد بن أحمد بن أبي أحمد أبي بكر علاء الدين السَّمرقندي، أستاذ صاحب "البدائع" المتوفَّى سنة سبع وثمانين وخمسمائة (١٦).
(٢) قوله (قال الزاهدي في المُجْتبى): شرح مُختصر القُدُوري، وهو لمختار بن محمود بن محمَّد أبي الرَّجاء، نجم الدين الزَّاهدي الغَزْمِيْني، نسبة إلى غَزْمِيْن -بفتح الغين المعجمة وسكون الزاي المعجمة ثم الميم المكسورة ثم الياء التحتانية المثنَّاة الساكنة ثم النون- قَصَبة من قَصَبات خُوارزم، مات سنة ثمان وخمسين وستمائة، وقيل: سنة ست وستين وستمائة، ومن تصانيفه: "قُنْيَةُ المُنْيَة لتتميم الغُنْيَة"، و"الرسالة النَّاصِرية"، و"زادُ الأئمة"، و"الجامعُ في الحيض"، وكتاب في الفرائض، و"الحاوي" وغير ذلك، كان معتزلي الاعتقاد، حنفيَّ الفروع، قال ابن عابدين صاحب "رد المحتار" في "تنقيح الفتاوى الحامدية": "نَقْلُ الزاهدي يعارِضُ نَقْلَ المعتَبرات، فإنَّه ذكر ابن وَهْبان: أنَّه لا يُلتفت إلى ما نَقَلَه صاحب "القنية" مخالفًا للقواعد ما لم يعضُد النقل من غيره، ومثله في "النَّهر" أيضًا. وإنْ شئتَ الاطلاع على الكتبِ غير المعْتبَرة فارجع إلى "النافع الكبير لمن يُطالع الجامع الصغير" (ص ٢٧ - ٣١)، ومقدمة "عمدة الرعاية في حلِّ شرح الوقاية " كلاهُما للأستاذ.
_________
(١٦) وكانت وفاة علاء الدين السمرقندي سنة ٥٣٩ كما ذكر السمعاني في "التحبير في المعجم الكبير" ٢: ٨٤ - ٨٥، وقال: "كتب إليَّ الإجازة، وتوفي غُرَّة جمادى الأولى سنة ٥٣٩ ببخارى". انتهى. ولم يذكر السمعاني نسبة السمرقندي في "الأنساب".',NULL,'21',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (22,'وقال النَّسَفي (١) في "المنافع شرح الفقه النافع": ثم قال في "الكتاب": إنَّه مُستحب، والصحيح: أنَّه سُنَّةٌ، لمواظبةِ النبيِّ - صلى الله عليه وسلم - على ذلك، وقضائِهِ في شوال حيث تركه (٢). فهذان قولان.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
(٢) قوله (وقضائه ...) إلخ: لما أخرجه البخاري عن عائشة قالت: "كان النبي - صلى الله عليه وسلم - يعتكفُ في العشرِ الأواخر من رمضان، فكنت أضرب له خِباءَ (١٧) فيُصلِّي الصُّبحَ =
_________
(١٧) قال ابن الأثير في "جامع الأصول" ١: ٣٢٧: الخِباء: واحد الأخبية من وَبَرٍ أو صوف، ولا يكون من شعر، وهو على عمودين أو ثلاثة، وما فوق ذلك فهو بيت". انتهى.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (23,'وههنا قول ثالث، وهو التفصيل: بأنَّه سُنَّة مؤكَّدة في العَشْر الأواخر من رمضان، ويكون واجبًا بالنذر بلسانه (١)، ولا يكفي مجرَّد النيَّة، وبالشُّروع (٢)، وبالتعليق (٣)،  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
فقال النبي - صلى الله عليه وسلم -: "آلبرَّ تَرَوْن (١٨) بهنّ، فتركَ الاعتكافَ ذلك الشَّهرَ، ثم اعتكفَ عشرًا من شوّال" (١٩).
قال الحافظ في "الفتح": وفي اعتكافه في شَوَّال دَليلٌ على أنَّ النوافِلَ المعتادة إذا فاتَتْ تُقْضَى استحبابًا، واستدلَّ به المالكية على وجوبِ قضاءِ العملِ لمنْ شَرَع فيه ثم أبطله، ولا دلالة فيه لما سيأتي" (٢٠).
(١) قوله (بالنَّذر بلسانه): كقوله: لله عَليَّ أن أعتكفَ ثلاثةَ أيام مثلًا.
(٢) قوله (وبالشُّروع): عطفٌ على قوله بالنَّذْر، ولكنَّه ضعيف، حيث قال الحَصْكَفيُّ وغيره: فلو شَرَع في نفله ثمَّ تركَهُ لا يلزمه قضاؤه على الظاهر، وما في بعض المعتَبَرات: أنَّه يلزم بالشُّروع مفرَّع على القول الضعيف (٢١).
(٣) قوله (وبالتعليق): عطفٌ على قوله: بالنَّذْر، وهذا يقتضي أنَّ صورة التعليق ليست بنذر؛ لأنَّ العطفَ يقتضي المغايرة مع أنَّها نذر، فالأَوْلى أن يقول: واجبٌ =
_________
(١٨) في سنن أبي داود (٢٤٥٦)، والنسائي (٧٠٩): "آلْبرَّ تُردْنَ"، قال السندي في حاشيته على النسائي ٢: ٤٥: "بمد الهمزة مثل: {آللهُ أَذِنَ لَكُمْ}، والاستفهام للإِنكار، و"آلبرَّ" بالنصب مفعول "يُرِدْنَ"، أي: ما أرَدْنَ البر وإنما أرَدْنَ قضاءَ مقتضى الغَيْرة، والله تعالى أعلم.
(١٩) أخرجه البخاري في كتاب الاعتكاف، باب اعتكاف النساء ٤: ٢٧٥ (٢٠٣٣).
(٢٠) فتح الباري ٤: ٢٧٦ - ٢٧٧.
(٢١) الدر المختار ٢: ٤٤٤، وهو وإن لم يلزمه القضاءُ لكن يُستحبُّ له، وهناك قول آخر عن الحنفية: أنه يقضي المسنون المؤكَّد وهو العشر الأواخر دون غيرها. حاشية ابن عابدين ٢: ٤٤٥.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (24,'ذكره ابن الكمال (١)، ومُسْتَحَبٌ في غيرِهِ من الأزمنة.
...
(٢٤) واسمه: "المُسْتَجمع في شرح المجمع والمنتقى في شرح الملتقى" وهو شرح لكتاب "مجمع البحرين وملتقى النهرين" لابن الساعاتي المتوفى سنة ٦٩٤ كما في "الجواهر المضية" ١: ٨٠.',NULL,'24',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (25,'"قال الشيخ: إنَّه سُنَّةٌ، وقال القُدُوري: إنه مُسْتَحَبٌّ، وقال صاحب "الهداية": الصحيحُ أنَّه سُنَّة مؤكَّدة، قلت: الصحيحُ التفصيل، فإن كان منذورًا: فواجب، وفي العشر الأواخر من رمضان: سُنَّة، وفي غيره: مستحب". انتهى.
...
واعلم أن صاحبَ الترجمة غيرُ الزيْلعي المخرِّج لأحاديث الهداية، فإنَّ اسمَهُ جمال الدين عبد الله بن يُوسف بن محمَّد، وقيل: ابن يونس بن محمَّد، أخذ عن الزَّيْلَعي صاحبِ الترجمة، مات في المحرم سنة اثنتين وستين وسبعمائة، هكذا حققه الأستاذ في تصانيفه، ولقد أخطأ الفاضل القِنَّوْجي نزيل بهوفال في "إتحاف النبلاء" حيث سماه بيوسف. وليطلب تفصيله من "إبراز الغي الواقع في شفَاء العي"، و"تذكرة الراشد برد تَبْصرة الناقد"، كلاهما للأستاذ العلام.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (26,'واختاره أيضًا ابن الهُمَام (١) في "فتح القدير"، وجَزَمَ به الشُّرُنْبُلالي (٢) في "نور الإِيضاح"، والتُّمُرْتَاشي (٣) في "تنوير الأبْصار"،  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
يقول العبد: وقد طَالعتُ من مصنَّفاته: حاشيته على "الدُّرر والغُرر" (٢٦)، أولها: الحمدُ لله الذي أظهر في هذه الدار ببديع قدرته ... إلخ، مات رحمه الله في رمضان سنة تسع وستين بعد الألف.
...
(٢٦) "درر الحكام شرح غُرر الأحكام" كلاهما لمنلا خسرو بن فراموز المتوفى سنة ٨٨٥ بالقسطنطينية رحمه الله تعالى.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (27,'وإليه مَالَ الحَصكَفي (١).  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
=  إبراهيم الخطيب التُّمُرْتاشي الغَزِّي، نسبة إلى تُمُرْتاش -بضم التاء المثنَّاة الفوقيَّة الأولى وضمِّ الميم وسكون الراء المهمَلة-، قريةٌ من قرى خُوارزم، كذا ذكره الطَّحْطاوي في "حواشي الدر المختار"، وذكر ابن عابدين في حاشيته عليه، نسبة إلى جده المسمَّى به، والغَزِّي نسبة إلى غَزَّة البلد المعلوم، ومن تصانيفه: "تنوير الأبصار"، وشرحُه "فتح الغفار"، ورسالة في علم الصرْف، ومنظومة في التوحيد، وشرحُها، و"شرح زاد الفقير" لابن الهُمَام، و"شرح قصيدة بَدْء الأمالي"، و"شرح مختصر المنار"، و"شرح المنار" إلى باب السُّنَّة، و"شرح قطعة من الوقاية"، و"شرح الكنز" إلى باب الأَيْمان، و"حاشية الدرر شرح الغرر" إلى باب الحج، و"تحفة الأقران"، منظومة في الفقه، وشرحها "مواهب الرحمن"، و"رسالة في خصائص العشرة المبشَّرة"، و"رسالة في عصمة الأنبياء"، و"رسالة في جواز الاسْتِنابة في الخطبة"، و"رسالة في القراءة خَلْف الإِمام"، و"النفائس في أحكام الكنائس"، و "مُسْعِف الحكام على الأحكام"، و"رسالة في مسح الخُفيْن"، و"رسالة في دخول الحمَّام"، و"رسالة في النكاح بلفظ: جوَّزْتُك"، و"رسالة في أحكام الدروز"، وغير ذلك، وكانت وفاته في رجب سنة أربع وألف. وليُطْلَب البَسْط في ترجمته، وترجمة مؤلِّف "الدّر المختار شرح تنوير الأبصار" من "طَرَب الأماثل بتراجم الأفاضل" (ص ٣٠٤ - ٣٠٥)، للأستاذ العلَّامة، ومن "فرحة المدرسين".
(١) قوله (الحَصْكَفي): هو علاء الدين محمَّد بن علي بن محمَّد بن علي بن عبد الرحمن الحَصْكَفي الدمشقي الحنفي، والحَصْكَفي -بفتح الحاء وسكون الصَّاد، وفي بعض النسخ: بالسين المهملة، وفتح الكاف بعدها فاء- نسبة إلى حِصْن كيفا على خلاف القياس، والقياس: الحِصْني، وهي بَلدةٌ من بلاد ديار بكر، ألَّف "شرح تنوير الأبصار" المسمَّى بـ "خزائن الأسرار"، ومختصره "الدر المختار"، و"شرح المُلْتَقى" المسمَّى بـ "المنتقى"، و"شرح المنار" المسمى =',NULL,'27',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (28,'قلت: لا يبعد أن يُحمَل الاستحبابُ في قولِ القُدوري على استحبابه في نفسِهِ، والسُّنيَّة في قولِ صاحب "الهدايةِ" على الاعتكاف في العشر الأواخر بمقْتضى دليله، فلم يَبْق إلَّا قولٌ واحد، وهو الأصح.

<span data-type="title" id=toc-10>المقام الثاني:
هل هو سُنَّةٌ مؤكَّدة أو غيرُ مؤكَّدة</span>؟ وعرفتَ من المرغيناني والعيني والزَّيْلعي تصحيح أنَّه سُنَّةٌ مؤكَّدة، واسْتَدلُّوا عليه بأَنَّ النبيَّ - صلى الله عليه وسلم - قد واظَبَ عليه (١). رواه الشيخان.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
=  بـ "إفاضة الأنوار"، و"تعليقات على صحيح البخاري"، وغير ذلك، توفي في شوال سنة ثمان وثمانين بعد الألف بدمشق، وعمره ثلاث وستون سنة.
(١) قوله (قد واظَبَ عليه): قال الحافظ في "الفتح،: "أورد المصنفُ ثلاثةَ أحاديث: أحدها: حديث ابن عمر: "كان رسول الله - صلى الله عليه وسلم - يعتكف العشر الأواخر من رمضان"، وأخرجه مسلم من هذا الوجه، وزاد: "قال نافع: وقد أراني عبد الله بن عمر المكانَ الذي كان رسول الله - صلى الله عليه وسلم - يعتكفُ فيه من المسجد، (٢٧)، وزادَ ابنُ ماجه من وجهٍ آخر: عن نافع عن ابن عمرَ أنَّ النبي - صلى الله عليه وسلم - كان إذا اعتكفَ، طُرِح له فراشه أو يوضع له سريره وراءَ أُسطوانة التوبة (٢٨).
ثانيهما: حديث عائشة مثل حديث ابن عمر، وزاد: "حتى توفَّاه الله، ثم اعتكف أزواجه من بعده" (٢٩)، فيُؤْخَذُ من الأول: اشتراط المسجد له، ومن الثاني: أنه لم يُنْسخ، وليس من الخصائص" (٣٠). انتهى بقدر الحاجة. =
_________
(٢٧) أخرجه البخاري في كتاب الاعتكاف (٢٠٢٥)، ومسلم في الاعتكاف (١١٧١)، وأخرجه أبو داود بزيادة مسلم في الاعتكاف ٣: ١٩٥ (٢٤٥٧).
(٢٨) أخرجه ابن ماجه في كتاب الصيام ١: ٥٦٤ (١٧٧٤).
(٢٩) أخرجه البخاري في كتاب الاعتكاف ٤: ٢٧١ (٢٠٢٦).
(٣٠) فتح الباري ٤: ٢٧٢.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (29,'فإنْ قلتَ: المواظَبةُ دليلُ الوجوبِ.
قلتُ: هذا إذا كان مع الإِنكار على التَّرك، وأمَّا المواظَبةُ مع عَلَمِ الإِنكار على مَنْ تَرَكَهُ فهي دليلُ السُّنِّيَّة (١)، ولم يثبتْ إنكارُهُ - صلى الله عليه وسلم - على مَنْ تَركَه من الصَّحابة.
فإنْ قلتَ: لو كان سُنَّةً مؤكَّدةً لما تركه الصَّحابة (٢) مع أنه لم يعتكف الخلفاءُ الأربعة.
...
(١) قوله (فهي دليل السُّنِّيَّة): واستدلَّ ابن الهُمَام في "فتح القدير" على عدم كون الاعتكاف واجبًا بتركِهِ - صلى الله عليه وسلم - في العَشْرِ الأخير بسببِ ما وَقَع من أزواجه، واعتكافه - صلى الله عليه وسلم - بدله عشرًا من شوال، واعترض عليه بحر العلوم في "رسائل الأركان" بقوله: ففيه أنَّ القضاءَ بعد الترك دليل الوجوب. قلتُ: قد مرَّ من قبل من كلام الحافظ ابن حجر أنَّ القضاء في شوال كان على سبيل الاستحباب، ولو كان على سبيل الوجوب لاعتكف معه نساؤه أيضًا في شوال، والله أعلم.
(٢) قوله (لما تركه الصحابة): لأنَّ الصحابةَ رضي الله عنهم كانوا أشدَّ النَّاس حِرصًا على اتباع النبي - صلى الله عليه وسلم -، وما كانوا تاركي سنةً من سُنَنِهِ إلَّا ما مُنعوا عنه، فلا يُتَصَوَّر أن يتركوا الاعتكافَ مع كونِهِ سُنَّةً مؤكَّدة.',NULL,'29',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (30,'اعتكف إلَّا أبو بكر بن عبد الرحمن (١)، وأراهم تركوه لِشَدَّتِهِ (٢)؛ لأنَّ ليلَه ونهارَه سواء".
قال السُّيوطي (٣) في "التوشيح شرح صحيح البخاري":  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
(١)  قوله (إلَّا أبو بكر بن عبد الرحمن) (٣١): تعقَّب الحافظ ابن حجر في "الفتح" قول مالك: أنَّه لم يعتكف من السَّلف إلَّا أبو بكر بن عبد الرحمن، وقال: "لعله أرادَ صفةً مخصوصةً، وإلَّا فقد حكي عن غير واحد من الصَّحابة أنه اعتكف" (٣٢).
(٢) قوله (وأراهم تركوه لشدته): قال ابن بطَّال: مواظبةُ النبي - صلى الله عليه وسلم - على الاعتكافِ يدلُّ على أنَّه من السُّنَنِ المؤكَّدةِ، وقد روى ابن المنذر عن ابن شِهَاب أنَّه قال: عَجَبًا للمسلمين تركوا الاعتكاف، والنبيُّ - صلى الله عليه وسلم - لم يتركه منذ دخل المدينة حتى قَبَضَهُ الله تعالى. انتهى. وقد تَقَدَّم قولُ مالك: إنَّه لم يعلم أن أحدًا من السَّلف اعتكفَ إلَّا أبا بكر بن عبد الرحمن، وأنَّ تركهم لذلك لما فيه من الشدَّة، كذا في "الفتح" (٣٣) للحافظ.
(٣) قوله (السُّيوطي): هو مُجَدِّد المائة التاسعة خاتم الحفَّاظ، جلال الدين عبد الرحمن بن كمال الدين الأَسْيوطي الشافعي، المتوفى سنة أحد عشر وتسعمائة، وتصانيفُه قد زادت على خمسمائة، وشُهرتُه تُغني عن وصفِهِ.
_________
(٣١) أبو بكر بن عبد الرحمن بن الحارث، الإِمام، أحدُ الفقهاء السبعة بالمدينة النبويَّة المنورة، أبو عبد الرحمن، والصحيح أنَّ اسمه كنيتُه، وهو من سادة بني مخزوم، وكان يقال له: واهب قريش. لكثرة صلانه، وكان مكفوفًا، توفي سنة أربع وتسعين بالمدينة. قال الذهبي: "كان أبو بكر بن عبد الرحمن ممَّن جمع العلم والعمل والشرف، وكان ممَّن خلف أباه في الجلالة".
"سير أعلام النبلاء" ٤: ٤١٦ - ٤١٩.
(٣٢) فتح الباري ٤: ٢٧٢.
(٣٣) فتح الباري ٤: ٢٨٥.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (31,'قلت (١): تمامه أن يقال: مع اشتغالهم بالكسب لعيالهم، والعمل في أراضيهم، فيشقُّ عليهم تركُ ذلك، وملازمةُ المسجد. انتهى.
...
_
[الإِسعاف بتحشية الإِنصاف]</span>
(١)  قوله (قلت): تعقَّبَ الأستاذ العلامة لا زالت شمسُ أفضاله طالعة في "تعليقه على موطأ الإِمام محمَّد" رحمه الله قول السيوطي وقال: "قلت: وهو مع تمامه ليس بتام؛ لعدمِ كونه وجْهًا لترك سُنَّةٍ من سُنن النبي - صلى الله عليه وسلم - والأَوْلى أن يقال: إنَّ الاعتكاف في العشر من رمضان، وإن كان سُنَّةً مؤكَّدة لكنه على الكفاية لا على العين، وقد كانت أزواج النبي - صلى الله عليه وسلم - بعده يعتكفن، فكفى ذلك" (٣٤).
(٢) قوله (العشر الأواخر): قال النووي: "المشهورُ في الاستعمال: تأنيثُ العَشْر ... وتذكيره أيضًا لغة صحيحة باعتبار الأيام أو الوقت والزمان" (٣٥)، ووصفُها بالجميع؛ لأنَّه يَتَصَوَّرُ في كل ليلةٍ من ليالي العشر الأخير ليلة القدر.
_________
(٣٤) التعليق الممجَّد على موطأ محمَّد ٢: ٢٢٤.
(٣٥) شرح صحيح مسلم ٨: ٦١ - ٦٢، وقال: ويكفي في صحتها ثبوت استعمالها في هذا الحديث من النبي - صلى الله عليه وسلم -. وللسبكي بحث في "الفتاوى" ٢: ٦٤١: هل يجوز أن يقال العشر الأخير أو لا؟',NULL,'31',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (32,'القُدُوري في "مختصره"، حيث قال: إنه يُستحب. وقد عَرَفْتَ ما له وما عليه، وأطْلَق النَّسَفِيُّ في"الكَنْز"، حيث قال: "سُنَّ لبثٌ في مسجدٍ بصوم ونيّة". ولا يمكن أن يكونَ المرادُ السنَّة الغير المؤكَّدة؛ لأنَه ردَّ هو القول بالاستحباب في "المنافع" كما قد نقلتُه سابقًا.
ثم رأيتُ في "رسائل الأركان" لبحر العلوم (١) ما نصُّه: اعلم أنَّه لا شكَّ في مُواظَبةِ النبيّ - صلى الله عليه وسلم - على اعتكافِ العَشْر الأواخرِ من رمضان، لكن قد ثَبَت من الصَّحابة العِظَام تركُ الاعتكاف، ومنهم الخلفاءُ الراشدون، فللاعتكاف نوعُ اختصاصٍ به (٢)، وهو أنَّهُ يَلقَى جبريلَ فيدارسُهُ  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
(٢) قوله (فللاعتكافِ نوعُ اختصاص به ...): أقول: هذا غير صحيح من وجهين: الأول: لما عرفتَ من "الفتح" من أنَّ الاعتكاف ليس من خصائص النبيِّ - صلى الله عليه وسلم - والثاني: لما تحقَّق من أنَّ مدار الاعتكاف لم يكن على التدارس؛ لأن جبريلَ =',NULL,'32',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (33,'القرآن، ومُدَارَسَةُ القرآن كانت مُختصَّةً به، فلذا كان للاعتكافِ اختصاصٌ به، فتاركُ الاعتكافِ من الأئمة لا يلحقُهُم الإِسَاءة؛ ولذا كان النبيُّ - صلى الله عليه وسلم -  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
وأقوى من ذلك: أنَّه إنما اعتكفَ في ذلك العام عشرين؛ لأنَّه كان في العام الذي قبله مُسافرًا، ويدل له ما أخرجه النسائي -واللفظ له- وأبو داود وصححه ابن حبان وغيرُه من حديث أبي بن كعب: "أن النبي - صلى الله عليه وسلم - كان يعتكفُ العَشر الأواخِر من رمضانَ، فسافَرَ عامًا فلم يَعْتكف، فلما كانَ العامُ المُقْبِلِ، اعتكفَ عِشْرِين" (٣٦)، كذا في "الفتح" (٣٧).
_________
(٣٦) أخرجه أحمد ٥: ١٤١، وأبو داود في كتاب الصيام (٢٤٥٥)، والنسائي في الكبرى (٣٣٤٤)، وابن ماجه في الصيام (١٧٧٠)، وابن خزيمة (٢٢٢٥)، وابن حبان (٣٦٦٣)، والحاكم ١: ٤٣٩ وصححه، والبيهقي ٤: ٣١٤.
(٣٧) فتح الباري ٤: ٢٨٥.',NULL,'33',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (34,'لا يؤكِّد في الاعتكافِ تأكيده في غيره من السننِ، ولا يعيبُ أحدًا من الصَّحابة على ترك الاعتكاف، فإنَّ الاعتكاف إمَّا سُنَّةٌ مُخْتَصَّةٌ به غيرُ مُؤَكَّدة على الأمة، بل بقي في حَقِّهم مثل السُّنن الغير المؤكَّدة، أو كان واجبًا عليه مُختَصًّا به فَفَعَلَهُ؛ لامتثال الوجوب، فلا يكون على الأمَّة سُنَّة، بل مندوبًا مُحْضًا، وهذا غير بعيد. انتهى.
قلت: هذا التحقيق كله من عند نفسِهِ (١)، والحق عندي هو الذي ذَكَرتُ (٢).

<span data-type="title" id=toc-11>المقامُ الثالث:
هل هو سنَّة مؤكَّدة كفايةً، أم عينًا</span>؟
فعامَّتهم على أنَّه سُنَّة (٣) كفاية؛ لأنَّ النبي - صلى الله عليه وسلم - لم يُنكر على مَنْ تركه من الصحابة، بخلاف السُّنَن المؤكَّدة، فدلَّ ذلك (٤) على أنه سُنَّة كفاية، وبه جَزَم الشُّرُنْبُلالي في "مراقي الفَلاح"، والعلامة  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
(١)  قوله (من عند نفسه): لأن كونَ الاعتكاف مختصًّا بالنبى - صلى الله عليه وسلم - لم يثبُت بعد، وأما كونه مندوبًا محضًا، فمخالفٌ لكلامهم.
(٢) يعني: أنه سنة مؤكَّدة كفاية، ولا وَجْهَ للقولِ بالاختصاص به، وقد بينْتُ ما في ذلك الكلام من الخَلَل بوجوهٍ في حواشي المتعلقة بشرح الوقاية لصَدْر الشريعة، فَلْتُطَالع، فإنَّها كافيةٌ لتحقيق المُهِمِّات. (منه) عَمَّ فَيْضُه.
(٣) قوله "على أنَّه سُنَّة": أي مُؤَكَّدة؛ لأنَّ النبي - صلى الله عليه وسلم - لم يتركه إلَّا بسبب ما وقع من أزواجه، لكنه اعتكف بدلَه عَشْرًا من شوال.
(٤) قوله (فدلَّ ذلك): أي عدم إنكاره - صلى الله عليه وسلم - على تاركي الاعتكاف على أنَّه -أي الاعتكاف-: سُنَّةُ كفاية، إذا قام به البعضُ ولو فردًا سقطت مَلامَةُ ترك السنَّة المؤكَّدة عن الباقين.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (35,'الطَّرابُلُسي (١) في "البرهان في شرح مواهب الرحمن"، وَتَبِعَهُ الحَصكَفيُّ وغيره.
...
_________
(٣٨) هكذا في الأصلين، وقوله: "وهو العوارض في ذم الروافض" اسم كتاب لعلي القاري، نقل منه ما يتعلق بالكتب غير المعتمدة في رسالته "ردع الإِخوان" فانظر عبارته هناك.',NULL,'35',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (36,'لكنه لم يعيِّن الرادَّ حتى يُبْحَث عن حالِهِ، والحقُّ: أنَّ قوله: الحق، ليس بحق (١).
...
_________
(١) قوله (ليس بحق): لأنَّ الاعتكاف لو كان سُنَّة العين لما تَرَكَه الصحابة رضي الله عنهم، ولأَنكَرَه - صلى الله عليه وسلم - على مَنْ تركه بغير عذرٍ، كإنكاره على تاركي السنن.
...
(٥) قوله (كصلاة التراويح بالجماعة): قيل: إنَّ الجماعةَ فيه سُنَّة لأهل كلِّ مسجد من البلدة، وقيل: لأهل مسجد واحد منها، وقيل: من المحلة، فظاهر كلام =',NULL,'36',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (37,'فظاهِرُ عباراتهم يَقْتضي الأول، ففي "مَجْمَع الأَنْهُر شرحُ مُلْتَقَى الأَبْحُر" (١) عند ذكر الأقوال: وقيل: سنَّةٌ على الكفاية، حتى لو تَرَكَ أهل بلدة بأَسْرِهم يلحقهم الإِسَاءَة، وإلَّا فلا، كالتأْذين (٢). انتهى.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
(١) قوله (مجمع الأنْهُر): لعبد الرحمن بن شيخ محمَّد بن سليمان المدعو بشيخ زاده، المتوفى سنة ثمان وسبعين بعد الألف، كما ذكره في "الكشف" (٢: ١٨١٥)، وهو مشتَمِلٌ على المجلَّدين، كتب في آخر المجلَّد الأول: وقد انتهى هذا النِّصْف الأول من شرح "مُلتقى الأبحر" (٣٩) في يوم الخميس رابع عشر من ذي القعدة الشريفة لسنة سبعين وألف، وكتب في خاتمةِ المجلد الثاني: وقد انتهى هذا الشَّرح، وتمَّ بفضله تعالى ببلدة أَدَرْنة قاضيًا بعساكر في ولاية روم إِيلي في ليلةِ الخميس في اليوم التاسع عشر من جُمادى الآخرة من شهور سنة سبع وسبعين وألف من هجرةِ مَنْ له العزُّ والشَّرف. انتهى ملخصًا.
(٢) قوله (كالتأذين): فإنَّه ليس بواجب على الأصح، بل هو سُنَّةٌ كفاية، بمعنى: أنَّ الواحدَ يكفي عن أهل البلدِ لا عن البلاد كلِّها، لعدم حُصولِ الإِظْهارِ به.
...
_________
(٣٩) "ملتقى الأبحر" للإمام إبراهيم بن محمَّد الحلبي المتوفى سنة ٩٥٦ رحمه الله تعالى.',NULL,'37',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (38,'وقال الطَّحْطَاويُّ (١) في شرح قول الحَصْكَفي: أي سُنَّة كفاية، إذا قام بها البعض، ولو فردٌ أُسْقِطَتْ عن الباقين. انتهى.
...
(٤١) هو الأمير صديق حسن خان القنُّوجي البهوبالي الأثري المولود سنة ١٢٤٨، والمتوفى سنة ١٣٠٧ رحمه الله تعالى، ولعصريِّه أبي الحسنات اللكنوي تعقُّبات وردودٌ عليه، منها: "إبراز الغي الواقع في شفاء العي"، و"تذكرة الراشد بردِّ تبْصرة الناقد"، و"تنبيه أرباب الخِبْرة على مسامحات مؤلِّف الحِطَّة"، وكلها مطبوعة.',NULL,'38',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (39,'<span data-type="title" id=toc-13>المقام الخامس:
هل هو سُنَّة مؤكَّدة مُطْلقًا؟ أم في العشر الأواخر من رمضان</span>؟
قولان نقلهما في "مَجْمَعِ الأنْهُر"، وقد مَال إلياس زادَه في "شرح النُّقاية" (١) إلى الأول، وتفصيل الزَّيْلعي الذي دَارَ عليه مَدَار الحق يقتضي أنَّه سُنَّة مُؤَكَّدةٌ في العَشْرِ الأواخرِ من رمضان، ومُسْتَحَبٌّ في غيره.
وقال العلامة الهدّاد الجُونفوري (٢) في "حاشيَة الهداية": لا شَكَّ أنَّ الاعتكافَ في نفسِ الأمر مُسْتَحَب، إنَّما السُّنَّة في العَشْر الأواخر من رمضان.

<span data-type="title" id=toc-14>المقام السادس:
هل السنَّة اسْتيعابُ العشر الأواخر من رمضان بالاعتكاف</span>؟ أم  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
=  و"تذكرة الراشِد" وغيرهما.
ومن تصانيفه: "فتح باب العناية في شرح النُّقاية"، وغير ذلك من التصانيف النافعة المذكورة في "التعليقات السنية" (ص ٨ - ٩) للأستاذ.
(١) قوله "شرح النُّقَاية": لمحمود بن إلياس الرُّومي، أتمَّه في ذي الحجة سنة إحدى وخمسين وثمانمائة، كذا في "كشف الظنون" (٢: ١٩٧١).
(٢) قوله (الهداد الجُونْفُوري): هو من مريدي راجي أحمد شاه، وهو من مشايخ جونفُور في زمان السُّلطان إسكندر، وقد طَلَبه من جُونْفُور إلى دِهلي، وأقامَ هناك مدةً إلى أنْ تُوفي في ربيع الأول سنة تسع وتسعمائة، وهو مِن تلامذةِ القاضي شِهاب الدين الدَّوْلت آبادي بواسطة واحدة، كذا في "أخبار الأخيار" للشيخ الدهلوي، وفي "سُبْحة المرجان" لغلام علي آزاد البلجرامي: أنَّه من تلامذةِ عبد الله التُّلنبي (٤٢)، مؤلِّف "بديع الميزان"، ومن مصنَّفاته: "حاشية الهداية"، و"الحاشية على تفسير المدارك"، و"حاشية البزدوي".
_________
(٤٢) نسبة إلى تُلنبه بضم الفوقية، قرية من أعمال ملتان، توفي سنة ٩٢٢، كما في "نزهة الخواطر"٤: ١٨٢.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (40,'الاعتكاف في جُزْء منه؟
الظاهر هو الأول؛ لأنَّ النبيَّ - صلى الله عليه وسلم - فعلَ كذلك دائمًا.
ثم رأيتُ في حاشية "الهداية" للجُونفوري، قال: الظاهر أنَّ السنَّة هو استيعابُ العَشْرِ الأواخر مِن رمضان بالاعتكاف، لا الاعتكاف في العَشْر، ولو في جُزءٍ منه، روى به الإِمام شِهَاب المِلَّة والدين (١)، نوَّرَ الله مرقَدَه؛ إذ المواظَبَة من النبيِّ - صلى الله عليه وسلم - كانت على سبيلِ الاستيعاب، فيكون سنةً مع وصفِ الاستيعاب، ثم قال: ولقائلٍ أن يقول: إنَّه وإنْ واظَبَ بصفَة الاستيعابِ، فالقولُ بِسُنية استيعابِ العَشْر الأوَاخِرِ من رمضان بالاعتكاف يؤدِّي إلى الحَرَج؛ لظهور أنَّ الرجالَ لو اعتكفُوا في المساجد، والنِّساء في دُورِهنَّ لم يكن مَنْ يقوم بأمر معاشِهِم، وفيه من الحَرَج ما لا يَخْفى، فَلِهَذِهِ الضَّرورة جَعَلنَا السُّنَّةَ وهو اللُّبْثُ في العَشْر، ولو بِجُزْء منه (٢) دونَ الاستيعاب.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
وهناك رواية ثانية عن أبي حنيفة أن أقل مدة الاعتكاف: يوم (الهداية ٢: ٣٩١، والاختيار ١: ١٣٦)، وبه قال بعض المالكية، وهو وجْهٌ عند الشافعية (روضة الطالبين ٢: ٣٩١).',NULL,'41',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (42,'ويجبُ بالنَّذْرِ وغيره، وهو سُنَّةٌ مؤكَّدةٌ كفاية في العَشْر الأواخر من رمضان على سبيلِ الاستيعاب.
فإن قلت: ما السرُّ في اعتكاف النبي - صلى الله عليه وسلم - في العَشْر الأواخر استيعابًا دونَ غيره من الأزمنة (١)؟
قلت: لأخذِ فضيلةِ ليلة القدر (٢)، فإنَّها في العَشْرِ الأواخر من  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
(١)  قوله (فإن قلتَ: ما السرُّ ...): فإن قلتَ: ما الحكمةُ في إخفاء ليلة القدر، قلتُ: لتحصيل الاجتهاد في التماسها، بخلاف ما لو عُيِّنَتْ لها ليلة لاقْتُصر عليها، كما في ساعةِ الإِجابةِ من يوم الجمعة، وهذه الحكمةُ مُطَّرِدةٌ عندَ من يقول: إنَّها في طول السَّنة، أو في جميع رمضان، أو في جميعِ العشرِ الأخير، أو في أوتاره خاصة، كذا في "الفتح" (٤٤).
(٢) قوله (ليلة القَدْر): بفتح القاف وسكون الدال، سُمِّيت بذلك لِعِظَم قدْرها؛ أي: ذات القَدْر العظيم؛ لأن القرآن قد نَزَل فيها؛ ولأن الله تعالى قد وَصَفها في كتابه القديم بأنَّها {خَيْرٌ مِنْ أَلْفِ شَهْرٍ}، ولأنَّ منْ أحيَاها بالعبادةِ يحصل له من القَدْر الجسيم، أو لأنَّ الأشياء تُقَدَّر فيها وتُقْضَى، كما قال الله تعالى: {فِيهَا يُفْرَقُ كُلُّ أَمْرٍ حَكِيمٍ}.
وقيل: بفتح الدال على أنَّه مصدر قَدَّر الله الشيء قَدْرًا وقَدَرًا، وفيه لغتان، كالنَّهْر والنَّهَر، كذا في "إرشاد السَّاري" (٤٥) للعلَّامة القَسْطَلاني المتوفى سنة تسعمائة وثلاث وعشرين لا سنة تسعمائة وعشرين كما صَدَر عن غيرِ مُلْتَزِمِ الصحة القِنَّوجي البُهوفالي في بعض تصانيفه، فإنَّه غَلَطٌ صريح، كما أنَّ قوله في "أبجد العلوم": إنَّ ابن حجر صاحب "فتح الباري" مات سنة ٨٥٨ غلطٌ قبيح، فإنَّ وفاتَه كانت سنة ٨٥٢.
_________
(٤٤) فتح الباري ٤: ٢٦٦.
(٤٥) إرشاد الساري ٣: ٤٢٩.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (43,'رمضان على القول الأصحِّ الأشْهَرِ، وفي تعيينها اختلافٌ كثير على أكثر من أربعين قولًا (١)، بَسَطَها الحافظ ابن حجر  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
السابع: أنَّها أولُ ليلةٍ من رمضان، حكي عن أبي رَزينِ العُقيلي الصحابي، ورواه ابن أبي عاصم عن أنس. =',NULL,'43',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (44,'...............................................  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
السابع عشر: أنَّها ليلة ثلاث وعشرين، رواه مسلم عن عبد الله بن أُنيس مرفوعًا، ورواه ابن أبي شيبة عن معاوية، ورواه إسحاق في مسنده من طريق أبي حازم، وعبد الرزاق عن مَعْمَر، ومن طريق يونس بن سيف أيضًا. =',NULL,'44',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (45,'..........................................................  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
_________
(٤٦) روى البخاري (٢٠٢٢) عن ابن عباس رضي الله عنهما: "التمسوا في أربع وعشرين" يعني ليلة القدر.
قال العراقي في "طرح التثريب" ٤: ١٥٥: "ذَكَرَهُ عَقِبَ حديثه: "هي في العشر في سبع تمضين أو سبع تبقين" وظاهرُه أنَّه تفسيرٌ للحديث، فيكون عمدة. وفي مسند أحمد عن بلال أن رسول الله - صلى الله عليه وسلم - قال: "ليلة القدر ليلة أربع وعشرين".',NULL,'45',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (46,'. . . . . . . . . . . . . . . . . . . .  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
_________
(٤٧) في قوله - صلى الله عليه وسلم -: "فمن كان متحريها فلْيَتَحرَّها في السبع الأواخر". قال الحافظ ٤: ٢٥٦: الظاهر أنَّ المرادَ به أواخر الشهر.
وقيل: المراد به السبع التي أوَّلها ليلة الثاني والعشرين، وآخرها: ليلة الثامن والعشرين، فعلى الأول: لا تدخل ليلة إحدى عشرين ولا ثالث عشرين، وعلى الثاني: تدخل الثانية فقط، ولا تدخل ليلة التاسع والعشرين". انتهى.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (47,'..........................................................  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
_________
(٤٨) في قوله - صلى الله عليه وسلم -: "فالتمسوها في التاسعة والسابعة والخامسة" رواه البخاري في فضل ليلة القدر ٤: ٢٦٧ (٢٠٢٣).
(٤٩) في قوله - صلى الله عليه وسلم -: "فمن كان متحرِّيَها فَلْيَتَحَرَّها في السبع الأواخر" رواه البخاري (٢٠١٥).',NULL,'47',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (48,'العسقلاني (١) في "فتح الباري شرح صحيح البخاري" فعليكَ بِهِ، والله أعلم.  
<span data-type="title">
_________
_
[الإِسعاف بتحشية الإِنصاف]</span>
...
هذا جملة ما ذكره الحافظ في "الفتح" (٥٠)، أوردْناه مُخْتَصرًا.
(١) قوله (الحافظ ابن حجر): هو إمام الحفاظ، أبو الفَضْل أحمد بن علي بن محمَّد العسقلاني المصري الشافعي، وُلد سنة ثلاث وسبعين وسبعمائة، وتوفي في ذي الحجة سنة اثنتين وخمسين وثمانمائة على ما ذكره السُّيوطي في "حُسْن المُحَاضَرة".
وقال الأستاذ في "التعليقات السنية" (ص ١٦): وقد طالعتُ من تصانيفه: "الدُّرر الكامنة في أعيان المائة الثامنة"، و"المجمع المؤسَّس"، و"تهذيب التهذيب"، و"تقريب التهذيب"، و"لسان الميزان"، و"الإِصابة في أحوال الصحابة"، و"نخبة الفكر"، وشرحه، و"التلخيص الحبير في تخريج أحاديث شرح الوجيز الكبير"، و"تخريج أحاديث الأذكار"، و"تخريج أحاديث الهداية" واسمه: "الدراية"، و"بذل الماعُون في فضل الطاعون"، و"القول المُسَدَّد في الذبِّ عن مُسْند أحمد"، و"فتح البَاري شرح صحيح البخاري"، ومقدمته: "الهدي الساري"، و"الخصال المكفرة للذنوب المقدَّمة والمؤخَّرة"، ورسالة في تعدد الجمعة ببلد واحد، وله "نكت على مقدمة ابن الصلاح"، و"رجال الأربعة"، و"تقريب المنهج بترتيب المدرج" وغير ذلك. انتهى.
وقد أخطأ بعض أفاضل قنوج في بعض رسائله، وبعض علماء دهلي في فتوى
_________
(٥٠) فتح الباري ٤: ٢٦٢ - ٢٦٦.',NULL,'48',NULL,NULL,'0');
INSERT INTO [b17742] VALUES (49,'قال مؤلِّفُهُ: هذا آخر ما ألهمني ربي للتحرير في هذا المطْلَب المُنيف، ولم يَسْبِقْني أحدٌ في تَنْقيح هذا المَبْحث الشَّريف، فَلِلَّهِ الحمدُ.
...
وأسال الله سبحانه وتعالى أن ينفع بهما عباده الصالحين وأن يوفقني للعمل الصالح الذي يرضيه، ويُحسن ختامنا، ويصلح أحوالنا، ويمنَّ علينا بالقَبول والرحمة والرضوان وصلَّى الله على نبيِّنا وسيِّدنا محمدٍ وآلهِ وسلَّم تسليمًا كثيرًا.',NULL,'49',NULL,NULL,'0');
