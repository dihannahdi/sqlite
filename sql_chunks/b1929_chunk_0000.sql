...
CREATE TABLE "b1929"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1929
INSERT INTO [b1929] VALUES (1,'مسألة الإيمان
دراسة تأصيلية
...
الشيخ عبد الله بن محمد الغنيمان',NULL,'1',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (2,'تقريظ بقلم
فضيلة الشيخ الدكتور
...
في ٢٢/٢/١٤٢٢هـ',NULL,'2',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (3,'تقريظ بقلم
فضيلة الشيخ
...
والله المستعان
في ١٣/٣/١٤٢٢هـ',NULL,'3',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (4,'تقريظ بقلم
فضيلة الشيخ
...
قاله
عبد الله بن محمد الغنيمان',NULL,'4',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (5,'<span data-type="title" id=toc-4>المقدمة</span>
...
موصياً - ومؤكداً في الوصية - بلزوم كتاب الله وسنة نبيه صلى الله عليه وسلم، والتفقه بفقه السلف الصالح، ورد الإشكال إلى أهل العلم المعتبرين ليحلوه ويوضِّحوه ويبينوه كما في آيتي النحل والأنبياء: {فَسْئَلُواْ أَهْلَ الذِّكْرِ إِن كُنْتُمْ لاَ تَعْلَمُونَ} [الأنبياء:٧] .
_________
...
هذا وقد سميت الموضوع: ((مسألة الإيمان دراسة تأصيلية)) .',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (6,'((مسألة الإيمان دراسة تأصيلية))
...
٤.المطلب الرابع: بيان فساد أقوال الطوائف إجمالاً.
...
... ... ... ... ... ... ... فاكس ٢٤١٧٤٣٨',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (7,'<span data-type="title" id=toc-5>أهمية مسألة الإيمان</span>
...
ولأهمية هذه المسائل ضمَّنها أهل السنة والجماعة في مباحث العقيدة الكبار (١) وقال الحافظ ابن رجب مبيناً أهمية هذه المسألة: ((وهذه المسائل، أعني مسائل الإسلام والإيمان، والكفر والنفاق مسائل عظيمة جداً)) .
...
وقد صنَّف العلماء قديماً وحديثاً في هذه المسائل تصانيف متعددة، وممن صنَّف في الإيمان من أئمة السلف: الإمام أحمد، وأبو عبيد القاسم بن سلاَّم، وأبو بكر أبي شيبة، ومحمد بن أسلم الطوسي، - رحمهم الله تعالى- وكثرت فيه التصانيف بعدهم من جميع الطوائف)) .اهـ. (٢) .
...
(٢) من جامع العلوم والحكم-شرح الحديث الثاني-حديث جبريل المشهور (٣٠٠) .',NULL,'7',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (8,'-بدعة الخوارج الوعيدية ومن تبعهم في مسائل الإيمان، ومقابلة المرجئة بطوائفها لهم ببدعتهم، والحق وسط بينهما!
...
واختُلف فيما يقع عليه اسم الإيمان، وما يُراد به اختلافاً كثيراً (١) ، أعرض هاهنا لمجمل الأقوال في المسألة التي لها شهرة، وينبني عليها فهم أهلها واعتقادهم بالمراد بالإيمان.
...
_________
(١) ينظر في هذه الأقوال المقالات للأشعري ١/١٢٥، ١٤٩، ٢٠٤، ٢٢٣، ٣٢٩، وتبصرة الأدلة لأبي المعين النسفي ٢/٧٨٩ وما بعدها، والفرقان بين الحق والباطل ضمن المجموع ١٣/٤٧-٥١، والإيمان الكبير لابن تيمية ٧٢، والإيمان الأوسط له ٥٠٩-٥١١،٥٤٣-٥٥٠، وشرح الطحاوية ٤٥٩ وما بعدها.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (9,'أـ المرجئة المحضة وهم الجهمية ومن وافقهم من القدرية وغيرهم: والإيمان عندهم هو المعرفة بالله، والكفر الجهل به، وفساد هذا القول بيِّن ظاهر جداً.
...
وهي:
* الأصل الأول:
قال رحمه الله في الإيمان الأوسط: ((وأصل نزاع هذه الفرق في الإيمان من الخوارج والمرجئة والمعتزلة والجهمية وغيرهم أنهم جعلوا الإيمان شيئاً واحداً، إذا زال بعضه زال جميعه، وإذا ثبت بعضه ثبت جميعه.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (10,'فلم يقولوا بذهاب بعض وبقاء بعض، كما قال النبي صلى الله عليه وسلم: ((يخرج من النار من كان في قلبه مثقال حبة من خردل من الإيمان)) .اهـ (١) .
* الأصل الثاني:
ما ضمَّنه شرحه للأصفهانية حيث قال:
((وأصل هؤلاء أنهم ظنوا أن الشخص الواحد لا يكون مُستحقاً للثواب والعقاب، والوعد والوعيد، والحمد والذم. بل إما لهذا وإما لهذا، فأحبطوا جميع حسناته بالكبيرة التي فعلها..)) اهـ (٢) .
...
(٢) في شرح الأصفهانية (١٣٧-١٣٨) ، وانظر الفرقان بين الحق والباطل (١٣-٤٨) .',NULL,'10',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (11,'أن الإيمان وكذا الكفر، كل منهما خصالٌ وشعبٌ عديدة، ومراتب متعددة، فمن الإيمان شعب إذا زالت زال الإيمان كله كالصدق في الحديث والحياء. وكذلك الكفر منه شعب إذا وقعت وقع الكفر الأكبر كالاستهزاء والسب لله ولدينه ولرسوله، ومنه شعب إذا وقعت لم يقع الكفر الأكبر المخرج عن الملة، كسب المسلم وقتاله والنياحة وغير ذلك، وإنما يكون مقترفها واقعاً في الكفر الأصغر، وهو الكفر العملي، وهو لا يخرج من الملة (١) .

* * *

<span data-type="title" id=toc-7>بيان فساد أقوال الطوائف إجمالاً: </span>...
...
_________
(١) انظر اقتضاء الصراط المستقيم (١/٢٣٧) ، وتعظيم قدر الصلاة للمروزي (٢/٥١٦-٥٢٠) ، وكتاب الصلاة لابن القيم (٥٤-٦١) ، والرسائل المفيدة للشيخ عبد اللطيف بن عبد الرحمن بن حسن (٢٧/٢٩) ، وأعلام السنة المنشورة للحافظ الحكمي (٧٣-٧٥) وغيرها كثير!',NULL,'11',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (12,'ب- وقوله صلى الله عليه وسلم: يخرج من النار من كان في قلبه مثقال ذرة من إيمان)) متفق عليه من حديث أنس رضي الله عنه)) (١) .
ج- كيف وقد وعد سبحانه أن يغفر لمن شاء ممن لم يشرك به شيئاً كما في آيتي النساء {إِنَّ اللَّهَ لاَ يَغْفِرُ أن يُشْرَكَ بِهِ وَيَغْفِرُ ماَدُونَ ذَلِكَ لِمَن يَشَآءُُ} [النساء:٤٨] .
...
_________
(١) الأحاديث التي أغفل تخريجها هنا يعني أنه سيأتي تخريجها في التعليق على الكتاب المحقق ((الرسالة الواضحة)) بحول ربي وقوته.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (13,'ج- ومن لوازم قولهم الفاسد أن فرعون الجاحد لربوبية الله ظاهراً مؤمن كامل الإيمان لأنه عارف بالله في قلبه غير جاهل به، لقول أصدق القائلين سبحانه في آخر سورة الإسراء {قاَلََ لَقَدْ عَلِمْتَ مَآ أَنزَلَ هَؤُلاءِ إلاَّ رَبُّ السَمَوَاتِ وَالأَرْضِ بَضَآئَّرَ وَإِنِّى لأَظَنُّكَ يَا فِرْعَوْنَ مَثْبُوراً} [الإسراء:١٠٢] ، وقوله في أول سورة النمل {وَجَحَدُوا بِهاَ وَاسْتَيْقَنَتْها أَنفُسُهُمْ ظُلْماً وَعُلُواًّ فَانظُرْ كَيْفَ كاَنَ عَقِبَةُ الْمُفْسِدِينَ} [النمل:١٤] .
...
INSERT INTO [b1929] VALUES (14,'وكذا كل من أبطن في قلبه كفراً أو ناقضاً من نواقض الدين يكون عندهم مؤمناً مادام مُقراً بلسانه (١) .
...
_________
(١) فإن المرجئة سلَّموا أن المكذب في الباطن، المصدق في الظاهر مؤمن، لكنه مُعذب مخلد في النار، فنازعوا في اسمه لا في حكمه، ومن حكي عنهم أنهم جعلوهم من أهل الجنة فهو غلط عليهم، ومع هذا فتسميتهم له مؤمناً بدعة ابتدعوها مخالفة للكتاب والسنة وإجماع سلف الأمة، وهذه البدعة الشنعاء هي التي انفرد بها الكرامية دون سائر مقالاتهم. ذكره أبو العباس ابن تيمية في الإيمان الأوسط (٧/٤٧٥-٤٧٦) .',NULL,'14',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (15,'أ-ما ورد تسميته إيمان من الأعمال والأقوال في النصوص الشرعية، كقوله تعالى في سورة السجدة: {إِنَّماَ يُؤْمِنُ بِئَايَتِناَ الَّذِّينَ إِذَا ذُكِّرُوا بِهَا خَرُّوا سُجَّداً وَسَبَّحُوا بِحَمْدِ رَبِّهِمْ وَهُمْ لاَ يَسْتَكْبِرُونَ} [السجدة: ١٥] .
...
ولما رواه مسلم عن النبي صلى الله عليه وسلم أنه قال ((من غشنا فليس منا ومن حمل علينا السلاح فليس منا)) (١) .
...
_________
(١) رواه مسلم في كتاب الإيمان- باب قوله صلى الله عليه وسلم: (من غشنا فليس منا)) (١٠١) .
(٢) ولذا فإن أضبط حدٍّ للكبيرة: أنها كل ذنب تُوعِّد عليه بالحدِّ في الدنيا والغضب أو اللعنة أو النار، أو البراءة من صاحبه، أو نفي الإيمان عنه. كما اختاره المحققون.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (16,'كما روى مسلم أيضاً في حديث أنواع المجاهدة أن النبي صلى الله عليه وسلم قال: ((فمن جاهدهم بيده فهو مؤمن، ومن جاهدهم بلسانه فهو مؤمن، ومن جاهدهم بقلبه فهو مؤمن، وليس وراء ذلك من الإيمان حبة خردل)) . فسمَّى النبي صلى الله عليه وسلم عمل القلب واللسان والجوارح إيماناً.
...
د-كذلك يُردُّ عليهم بالنصوص التي نفت الإيمان عمن ارتكب بعض الكبائر – وهي النصوص التي يستدل بها الوعيدية على خروج هؤلاء من الإيمان مثل:',NULL,'16',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (17,'قوله صلى الله عليه وسلم: ((لا يزني الزاني حين يزني وهو مؤمن، ولا يشرب الخمر حين يشربها وهو مؤمن، ولا يسرق السارق حين يسرق وهو مؤمن، ولا ينهب نهبة ذات شرف فيرفع الناس إليه فيها بأبصارهم حين ينتهبها وهو مؤمن)) الحديث متفق عليه عن أبي هريرة (١) رضي الله عنه.
وأمثاله من نصوص نفي الإيمان ((الكامل)) عن بعض الأعمال من الكبائر كالغلول، وامتهان الجار، وإهانة الكبير..
... هـ-ثبوت التصديق للجوارح في قوله صلى الله عليه وسلم: ((إن الله كتب على ابن آدم نصيبه من الزنى، مدركٌ ذلك لا محالة، فالعينان زناهما النظر، والأذنان زناهما الاستماع، واللسان زناه الكلام، واليد زناها البطش، والرِّجْل زناها الخطى، والقلب يهوى ويتمنى، ويَصَّدق ذلك الفرج ويكذبه)) متفق عليه من حديث أبي هريرة وهذا لفظ مسلم (٢) .

<span data-type="title" id=toc-8>معنى الإيمان لغة:</span>
ذهب كثير من المتكلمين وغيرهم؛ بل هو العُمدة عند جماهير المرجئة أن الإيمان في مفهوم اللغة العربية هو مجرد التصديق، استدلالاً بقوله تعالى في أول سورة يوسف: {وَمَآ أَنتَ بِمُؤْمِنٍ لَّناَ وَلَوْ كُنَّا صَادِقِينَ} [يوسف:١٧] .
...
_________
(١) رواه البخاري موصولاً في كتاب المظالم – باب النهي بغير إذن صاحبه (٢٤٧٥) ، ومسلم في كتاب الإيمان (٧٥) .
(٢) رواه البخاري موصولاً في مواضع منها الاستئذان – باب زنا الجوارح دون الفرج (٦٣٤٣) ، ومسلم في كتاب القدر – باب قُدِّر على ابن آدم حظه من الزنى وغيره (٢٦٧٥) .',NULL,'17',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (18,'أن لفظة الإيمان يقابلها الكفر، وهو ليس التكذيب فقط بل قدر زائد عليه، وإنما الكذب يقابل لفظة التصديق.
...
_________
(١) هذه الأوجه وغيرها بسطها أبو العباس ابن تيمية في مواضع من كتبه: في الإيمان الأوسط (٧/٥٢٩-٥٣٦) ، وشرك الأصفهانية (١٤٢-١٤٣) ، والمجموع (١٠/٢٦٩-٢٧٦) ، والإيمان الكبير (١٢٦-١٣٤، ٢٧٤-٢٨١) .',NULL,'19',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (20,'فقالت الوعيدية: إن الإسلام هو الإيمان والعكس صحيح (١) .
...
(٢) وهو قول أبي بكر الباقلاني نقله عنه بلفظه شيخ الإسلام في الإيمان الكبير (١٤٧) وما بعدها وقال قبله: ((فصل: قال الذين نصروا مذهب جهم في الإيمان من المتأخرين كالقاضي أبي بكر وهذا لفظه..)) اهـ، فذكره.',NULL,'20',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (21,'وأركان الإسلام الخمسة أعمال ظاهرة، وأصول الإيمان الستة أعمال باطنة، ولا بد منهما جميعاً.
...
ولا شك أن معنى الحديث صحيح ثابت في الصحيحين وغيره مما يشهد لهذا الحديث ويقوي جانب ثبوته.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (22,'ومن هنا قال الحافظ بن رجب في جامع العلوم والحكم:
...
وليس كل مسلم مؤمناً، فإنه قد يكون الإيمان ضعيفاً فلا يتحقق القلب به تحقيقاً تاماً، مع عمل جوارحه أعمال الإسلام فيكون مسلماً، وليس بمؤمن الإيمان التام)) اهـ (١) .
...
-وحديث أبي هريرة رضي الله عنه عن النبي صلى الله عليه وسلم أنه قال: ((الإيمان بضع وستون شعبة، والحياء شعبة من الإيمان)) متفق عليه واللفظ للبخاري (٢) وفي لفظ آخر لهما ((الإيمان بضع وسبعون)) .
_________
(١) جامع العلوم والحكم، شرح الحديث الثاني: حديث جبريل المشهور (٢٨) ، وانظر منهج الحافظ ابن رجب (٤٢٨) وما بعدها.
(٢) أخرجه البخاري موصولاً في كتاب الإيمان – باب أمور الإيمان (٩) ، ومسلم في الإيمان أيضاً – باب بيان شعب الإيمان وأفضلها وأدناها (٣٥) .',NULL,'22',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (23,'فإن الإيمان هنا متناول للإسلام لاشتماله على الصلاة والصيام والحج والزكاة.
-ولما في الصحيحين – واللفظ للبخاري- من حديث عبد الله بن عمر رضي الله عنهما يرفعه إليه صلى الله عليه وسلم: ((المسلم من سلم المسلمون من لسانه ويده، والمهاجر من هجر ما نهى الله عنه)) (١) .
-وعن أبي سعيد رضي الله عنه عن النبي صلى الله عليه وسلم أنه قال: ((يوشك أن يكون خير مال المسلم غنم يتبع بها شغف الجبال ومواقع القطر، يفر بدينه من الفتن)) رواه البخاري (٢) .
ففى كلا الحديثين المسلم يشمل المؤمن، مما يدل على أنهما بمعنى واحد عند الاجتماع.
-ومن أصرح الأدلة من السنة على كون افتراقهما يُصِّيرُ معناهما واحداً حديث وفد عبد القيس، المتفق على صحته من حديث أبي هريرة رضي الله عنه، أنهم جاؤوا إلى النبي صلى الله عليه وسلم فقالوا: يا رسول الله، إن بيننا وبينك هذا الحي من مضر ولا نستطيع أن نأتيك إلا في الأشهر الحرم، فمرنا بأمر فصل نخبر به من وراءنا، وندخل به الجنة؟ فقال صلى الله عليه وسلم: ((آمركم بالإيمان بالله وحده، أتدرون ما الإيمان بالله وحده؟)) قالوا: الله ورسوله أعلم! قال: ((تشهدوا ألا إله إلا الله وأن محمداً رسول الله، وتقيموا الصلاة، وتؤتوا الزكاة، وتصوموا رمضان، وأن تعطوا من المغنم الخمس)) الحديث (٣) .
_________
(١) أخرجه البخاري موصولاً في الإيمان – باب المسلم من سلم المسلمون من لسانه ويده (١٠) ، ومسلم في الإيمان أيضاً – باب بيان تفاضل الإسلام وأي أموره أفضل (٤٠) .
(٢) رواه البخاري وهذا لفظه متصلاً في كتاب الإيمان – باب من الدين الفرار من الفتن (١٩) .
(٣) الحديث أخرجه بطوله البخاري في أحد عشر موضعاً في صحيحه كلها متصلة هذا أولها في كتاب الإيمان – باب أداء الخمس من الإيمان (٥٣) وهذا لفظه، وأخرجه مسلم في الإيمان أيضاً – باب الأمر بالإيمان بالله تعالى ورسوله صلى الله عليه وسلم وشرائع الدين (١٧) .',NULL,'23',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (24,'فإن النبي صلى الله عليه وسلم أخبرهم في الحديث – في هذا الحال المهم، والسؤال الأهم – عن الإيمان بأركان الإسلام، فدل على أنهما بمعنى واحد، مما يفيد أن أحدهما يغني عن الآخر عند الإفتراق.
وفي الباب أحاديث غير هذه كثيرة جداً تدل على هذا المقصد، وفيما نقلت الكفاية إن شاء الله (١) .
* * *
...
فمن ذلك:
_________
(١) ومثل الإسلام والإيمان، مثل البر والتقوى، والفسوق والعصيان، والفقير والمسكين، والإثم والعدوان، والكفر والنفاق، والتوبة والاستغفار، وهكذا كل لفظتين شرعيتين بينهما اشتراك في العموم والخصوص.. والله أعلم.',NULL,'24',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (25,'قوله تعالى في أول الأنفال: {إِنَمَا الْمُؤْمِنُونَ الَّذِينَ إِذَا ذُكِرَ اللهُ وَجِلَتْ قُلُوبُهُمْ وَإِذَا تُلِيَتْ عَلَيْهِمْءَايَتُهُ زَادَتْهُمْ إِيمَانًا وَعَلَى رَبِّهِمْ يَتَوَكَّلُونَ} [الأنفال:٢] .
وقوله سبحانه في أواخر آل عمران: {الَّذِينَ قَالَ لَهُمُ النَّاسُ إِنَّ النَّاسَ قَدْ جَمَعُوا لَكُمْ فَاخْشَوْهُمْ فَزَادَهُمْ إِيمَانًا وَقالُوا حَسْبُنَا اللهُ وَنِعْمَ الْوَكِيلُ} [آل عمران: ١٧٣] .
...
وفي سورة الأحزاب: {وَلَمَّا رَءَا الْمُؤْمِنُونَ الأَحْزَابَ قَالُوا هَذَا مَا وَعَدَنَا اللهُ وَرَسُولُهُ وَصَدَقَ اللهُ وَرَسُولُهُ وَمَا زَادَهُمْ إِلاَّ إِيمَانَا وَتَسْلِيمًا} [الأحزاب:٢٢] .
وفي أول الفتح: {هُوُ الَّذِى أَنزَلَ السَّكِينَةَ فِى قُلُوبِ الْمُؤْمِنِينَ لِيَزْدَادُوا إِيماَنًا مَّعَ إِيمَنِهِمْ} [الفتح:٤] .
وفي سورة المدثر: {لِيَسْتَيْقِنَ الَّذِينَ أُوتُوا الْكِتَابَ وَيَزْدَادَ الَّذِينَءَامَنُوا إِيمَانًا} [المدثر:٣١] .
وكما يزيد الإيمان – كما رأينا فيما مضى من نصوص، فإنه يزيد بزيادة أفراده كالخشوع كما في آية السجدة من الإسراء: {وَيَخِرُّونَ لِلأَذْقَانِ يَبْكُونَ وَيَزِيدُهُمْ خُشُوعًا} [الإسراء:١٠٩] .',NULL,'25',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (26,'وزيادة الهدى والهداية كما في قوله في سورة مريم: {وَيَزِيدُ اللهُ الَّّذِينَ اهْتَدَوْا هدًى} [مريم:٧٦] .
وفي سورة محمد: {وَالَّذِينَ اهْتَدَوْا زَادَهُمْ هُدًى وَءَاتَهُمْ تَقْوَاهُمْ} [محمد:١٧] .
وقوله عن الفتية أصحاب الكهفِ: {إِنَّهُمْ فِتْيَةٌءَامَنُوا بِرَبِّهِمْ وَزِدْنَاهُمْ} [الكهف:١٣] .
فما زاد شيء إلا نقص، بدليل كونه قبل الزيادة أنقص منه بعدها.
وكما أن الكفر يزيد كما في قوله تعالى في آيتي المائدة: {وَلَيَزِيدَنَّ كَثِيرًا مِّنْهُم مَّآ أُنزِلَ إِلَيْكَ مِن رَّبِّكَ طُغْيَنًا وَكُفْرًا} [المائدة:٦٤] . {قُلْ يَأَهْلَ الْكِتَبِ لَسْتُمْ عَلَى شَىْءٍ حَتَّى تُقِيمُوا التَّوْرَاةَ وَالإِنْجِيلَ وَمَآ أُنزِلَ إِلَيْكُم مِّن رَّبِّكُمْ وَلَيَزِيدَنَّ كَثيِرًا مِّنْهُم مَّآ أُنزِلَ إِلَيْكَ مِن رَّبِّكَ طُغْيَنًا وَكُفْرًا فَلاَ تَأْسَ عَلَى الْقَوْمِ الْكَفِرِينَ} [المائدة:٦٨] .
وقوله في الإسراء: {وَمَا جَعَلْنَا الرُّءْيَا الَّتِى أَرَيْنَكَ إِلاَّ فِتْنةً لِّلنَّاسِ وَالشَّجَرَةَ الْمَلْعُونَةَ فِي الْقُرْءَانِ وَنُخَوِّفهُمْ فَمَا يَزِيدُهُمْ إِلاَّ طُغْياَنًا كَبِيرًا} [الإسراء:٦٠] .
وفي آل عمران: {إِنَّ الَّذِينَ كَفَرُوا بَعْدَ إِيمَانِهِمْ ثًمَّ ازْدَادُوا كُفْرًا لَّن تُقْبَلَ تَوْبَتُهُمْ وَأُولَئِكَ هُمُ الضَّآلُّونَ} [آل عمران:٩٠] .
وفي النساء: {إِنَ الَّذِينَءَامَنُوا ثُمَّ كّفَرُوا} [النساء:١٣٧] .
...
كما قال سبحانه عن الأنبياء: {وَلَقَدْ فَضَّلْنَا بَعْضَ النَّبيِيِّنَ عَلَى بَعْضٍ} [الإسراء:٥٥] .',NULL,'26',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (27,'وفي البقرة: {تَلْكَ الرُّسُلُ فَضَّلْنَا بَعْضَهُمْ عَلَى بَعْضٍ مِّنهُم مَّن كَلَّمَ اللهُ وَرَفَعَ بَعْضَهُمْ دَرَجَتٍ وَءَاتَيْنَا عِيسَى ابْنَ مَرْيَمَ الْبَيِنَتِ وَأَيَّدْنَهُ بِرُوحِ الْقُدُسْ} [البقرة:٢٥٣] .
وفي الإسراء: {انْظُرْ كَيْفَ فَضَّلْنَا بَعْضَهُمْ عَلَى بَعْضٍ وَلَلأَخِرَةُ أَكْبَرُ دَرَجَتٍ وَأَكْبَرُ تَفْضِيلاً} [الإسراء:٢١] .
وفاضل سبحانه بين الصحابة في آية الحديد: {لاَيَسْتَوْي مْنكُم مَّنْ أَنفَقَ مِن قَبْلِ الْفَتْحِ وَقاَتَلَ أُولَئِكَ أَعْظَمُ دَرَجَةً مِّنَ الَّذينَ أَنفَقَوا مِن بَعْدُ وَقَاتَلُوا} [الحديد:١٠] .
وفاضل بين المجاهدين وغيرهم في سورة النساء: {لاَّ يَسْتَوِي الْقَاعِدُونَ مِنَ الْمُؤْمِنِينَ غَيْرُ أُوْلِي الضَّرَرِ وَالْمُجَاهِدُونَ فِي سَبِيلِ اللهِ بِأَمْوَالِهِمْ وَأَنفُسِهِمْ فَضَّلَ اللهُ الْمُجَاهِدِينَ بِأَمْوَالِهِمْ وَأَنفُسِهِمْ عَلَى الْقَاعِدِينَ دَرَجَةً وَكُلاًّ وَعَدَ اللهُ الْحُسْنَى وَفَضَّلَ اللهُ الْمُجَاهِدِينَ عَلَى الْقَاعِدِينَ أَجْرًا عَظِيمًا * دَرَجَاتٍ مِّنْهُ وَمَعْفِرَةً وَرَحْمَةَ وَكَانَ اللهُ غَفُورًا رَّحِيمًا} [النساء:٩٥-٩٦] .
ومن ذلك قوله: {الَّذِينَءَامَنُوا وَهَاجَرُوا وَجَهَدُوا فِي سَبِيلِ اللهِ بِأَمْوَالِهِمْ وَأَنفُسِهِمْ أَعْظَمُ دَرَجَةَ عِندَ اللهِ وَأولَئِكَ هُمُ الْفَائِزُونَ} [التوبة:٢٠] .
وفاضل بين درجات العلماء أهل الإيمان بقوله في سورة المجادلة: {يَرْفَعِ اللهُ الَّذِينَءَامَنُوا مِنكُمْ وَالَّذِينَ أُوتُوا الْعِلْمَ دَرَجَتٍ وَاللهُ بِمَا تَعْمَلُونَ خَبِيرٌ} [المجادلة:١١] .',NULL,'27',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (28,'ومايز سبحانه بين أهل الطاعة والمعصية بقوله في سورة الجاثية: {أَمْ حَسِبَ الَّذِينَ اجْتَرَحُوا السَّيِّئاتِ أَن نَّجْعَلَهُمْ كَالَّذِينَءَامَنُوا وَعَمِلُوا الصَّالِحَاتِ سَوَآءً مَّحْيَاهُمْ وَمَمَاتُهُمْ سَآءَ مَا يَحْكُمُونَ} [الجاثية:٢١] ، وفي سورة الواقعة ذكر أصحاب اليمين، ثم أصحاب الشمال، ثم السابقين. وكل هذه المفاضلات للتمايز في زيادة الإيمان

<span data-type="title" id=toc-11>الأدلة من السنة على زيادة الإيمان ونقصانه:</span>
فهي أيضاً متنوعة:
١-فمنها ما في الصحيحين من حديث أبي هريرة رضي الله عنه أن النبي صلى الله عليه وسلم قال: ((لا يزني الزاني حين يزني وهو مؤمن، ولا يسرق السارق حين يسرق وهو مؤمن ولا يشرب الخمر حين يشربها وهو مؤمن، ولا ينهب نُهبة ذات شرف يرفع الناس إليه فيها بأبصارهم حين ينتهبها وهو مؤمن)) وهذا لفظ مسلم.
...
٢-ومنها ما عقده البخاري في صحيحه من كتاب الإيمان باباً في تفاضل أهل الإيمان بالأعمال وذكر فيه:
...
٣-وحديث أبي سعيد رضي الله عنه أيضاً أن النبي صلى الله عليه وسلم قال: ((بينا أنا نائم، رأيت الناس يُعرضون عليَّ وعليهم قمص، منها ما يبلغ الثدي، ومنها ما دون ذلك، وعرض عليَّ عمر بن الخطاب وعليه قميص يجره قالوا: فما أوَّلت ذلك يا رسول الله؟ قال: الدين)) متفق عليه.
ورؤيا الأنبياء حق، فدل على زيادة الإيمان في أقوام، ونقصانه في آخرين.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (29,'٤-حديث أبي سعيد الخدري وابن عمر وأبي هريرة رضي الله عنهم، أن النبي صلى الله عليه وسلم قال: ((ما رأيت من ناقصات عقل ودين أذهب للبِّ الرجل الحازم من إحداكن، قلن وما نقصان ديننا وعقلنا يا رسول الله؟ قال: أليس شهادة المرأة مثل نصف شهادة الرجل، قلن: بلى؟ قال: فذلك من نقصان عقلها، أليس إذا حاضت لم تصلِّ ولم تصم، قلن: بلى قال: فذلك من نقصان دينها)) وهذا لفظ البخاري (١) .
...
٥-حديث ابن مسعود رضي الله عنه – عند مسلم في المجاهدة –وفيه: ((فمن جاهدهم بيده فهو مؤمن، ومن جاهدهم بلسانه فهو مؤمن، ومن جاهدهم بقلبه فهو مؤمن، وليس وراء ذلك من الإيمان حبة خردل)) . ويفسره ويبين مدلوله حديث أبي سعيد الخدري رضي الله عنه عن النبي صلى الله عليه وسلم: ((من رأى منكم منكراً فليغيره بيده، فإن لم يستطع فبلسانه، فإن لم يستطع فبقلبه وذلك أضعف الإيمان)) رواه مسلم (٢) .
فدل على أن الإيمان لا يزال يضعف بتخلف تلك المراتب وهو النقصان، وتحصيلها هو زيادته.
_________
(١) أخرجه البخاري في مواضع متصلاً أولها في كتاب الحيض- باب ترك الحائض الصوم (٢٩٨) ، ومسلم في الإيمان – باب بيان نقصان الإيمان بنقص الطاعات (٧٩، ٨٠) .
(٢) رواهما في كتاب الإيمان- باب كون النهي عن المنكر من الإيمان (٤٩،٥٠) .',NULL,'29',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (30,'٦-ومثله حديث أبي أمامة رضي الله عنه أن النبي صلى الله عليه وسلم قال: ((من أحب لله وأبغض لله، وأعطى لله، ومنع لله، فقد استكمل الإيمان)) (١) .
...
_________
(١) رواه عنه الإمام أحمد في المسند (٣/٤٣٨، ٤٤٠) ، وأبو داود في السنة (٤٦٨١) . وله شاهد عن معاذ بن أنس رضي الله عنه عند الترمذي (٢٥٢١) ، والطبراني في الكبير (٢٠/١٨٨) ، وعن البراء رضي الله عنه عند أحمد في المسند (٤/٢٨٦) ، وابن أبي شيبة في المصنف ١١/٤١ (هندية) ، وعن أبي ذر رضي الله عنه عند أحمد في المسند (٥/١٤٦) ، وأبي داود (٤٥٩٩) .',NULL,'30',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (31,'٦-وقال عمير بن حبيب الخطمي وغيره من الصحابة: ((الإيمان يزيد وينقص، فقيل له وما زيادته ونقصانه؟ فقال: إذا ذكرنا الله وحمدناه وسبحناه فتلك زيادته، وإذا غفلنا ونسينا وضيعنا فذلك نقصانه)) (١) . وعنهم في الباب كثير، وعمَّن بعدهم أكثر.
٧-ولذا روى اللالكائي بسند صحيح عن الإمام البخاري أنه قال: ((لقيت أكثر من ألف رجل من العلماء بالأمصار، فما رأيت أحداً منهم يختلف في أن الإيمان: قول وعمل ويزيد وينقص)) اهـ (٢) .
...
(٢) في شرح أصول السنة ٢/١٧٢ (٣٢٠) ، وانظر الفتح (١/٦٠-٦١) ، وكلام السلف الصالح – رضي الله عنهم- منثور في كتب السنة والآثار، وكتاب الإيمان من الإبانة لابن بطة، وتعظيم قدر الصلاة للمروزي، وكتاب السنة للخلال المتضمن للإيمان للإمام أحمد، والإيمان لأبي عبيد القاسم بن سلام، ولابن أبي شيبة، والآجري في الشريعة، وابن أبي عاصم في السنة وغيرهم، رحمهم الله وجزاهم خيراً.
(٣) من التمهيد له (٩/٢٣٨) .',NULL,'31',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (32,'١-التقرب إلى الله والتعرف إليه بتحقيق التوحيد بألوهيته وربوبيته وأسمائه الحسنى وصفاته العلى.
...
٣-ترك المعاصي والمنهيات تقرباً إلى الله وابتغاء وجهه سبحانه.
...
٦-التزام السنة النبوية والعض عليها بالنواجذ، ولو مع قلة المعاون علماً وفهماً وعملاً ودعوة.
...
(٢) ذكر هذين القولين هاهنا أبو جعفر ابن جرير في التبصير في معالم الدين ١٩٥ وما بعدها، وقول الخوارج قالت به الإباضية كما في جامع البسيوي (١/٢٣٧-٢٣٩) ،والمشارق للنور السالمي (١/٣١٢) ، وانظر متشابه القرآن للقاضي عبد الجبار (١/٣١٢) .',NULL,'32',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (33,'والحق كما سبق أن الإيمان يزيد بالطاعات حتى يكتمل، وينقص بالمعاصي والذنوب حتى يزول بالمكفر منها.
...
٢-توقف مالك بالنقصان لئلا يكون شكاً مخرجاً عن اسم الإيمان.
...
٤-ربما كان قوله ذلك قديماً، رجح عنه بعد ذلك ولاسيما بعد تأمله لحال المرجئة وبدعتهم، لما عُرف عنه بعدُ من ردِّه عليهم، وإنكاره عليهم كما أنكر على حماد بن أبي حنيفة وغيره منهم.
_________
(١) ذكره الشيخ أبو العباس ابن تيمية في الإيمان الوسط (٧/٥٠٦-٥٠٧) ،وقال معقباً على قول ابن المبارك: ((وكان مقصوده الإعراض عن لفظ وقع فيه النزاع إلى معنى لا ريب في ثبوته)) اهـ، مما يفيد أن المسألة لفظية لا طائل من النزاع فيها. وقول ابن المبارك: ((إن الإيمان قول وعمل ويتفاضل)) ، رواه عبد الله بن أحمد في السنة (١/٣١٦) .
(٢) في شرح صحيح مسلم (١/١٤٦) .',NULL,'33',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (34,'٥-وربما هو وَهْمٌ من ناقليه، لما يعرض للمدرس في درسه من التوقف في مسائل، لا لعدم الجواب فيها عنده، وإنما لزيادة تأمل فيها ونظر وبحث، أو لعارض يعرض له في خاطره يسترسل معه.. ونحو ذلك.
...
حقيقة الخلاف مع مرجئة الفقهاء:',NULL,'35',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (36,'وهو خلاف أهل السنة والجماعة مع مرجئة الفقهاء الذين قالوا ((إن الإيمان قول وتصديق)) ، فأخرجوا العمل عن مسمى الإيمان كما هو المشهور عن الإمام أبي حنيفة وحماد بن أبي سليمان وأتباعهما – وهم الذين يقال لهم: مرجئة الفقهاء أو مرجئة الكوفة أو مرجئة العراق.
...
في حين يرى البعض أن الاختلاف حقيقي وليس لفظياً كما قال به الألوسي محمود وعبيد الله المباركفوري (٢) وغيرهما، وهذا أيضاً له وجهه.
...
قال رحمه الله في شرح الأصفهانية: ((.. وإنما المقصود أن فقهاء المرجئة خلافهم مع الجماعة خلاف يسير، وبعضه لفظي، ولم يُعرف بين الأئمة المشهورين بالفتيا خلاف إلا في هذا، فإن ذلك قول طائفة من فقهاء الكوفيين كحماد بن أبي سليمان وصاحبه أبي حنيفة وأصحاب أبي حنيفة)) (٣) .
وحصر هذا النزاع في موطن آخر بكونه من بدع الأقوال والأفعال، لا بدع العقائد فقال في الإيمان: ((.. إنه لم يكفر أحد من السلف مرجئة الفقهاء، بل جعلوا هذا من بدع الأقوال والأفعال، لا بدع العقائد، فإن كثيراً من النزاع فيها لفظيٌّ، لكن اللفظ المطابق للكتاب والسنة هو الصواب)) اهـ (٤) .
_________
...
(٤) من الإيمان ص (٣٣٧) .',NULL,'36',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (37,'وقال في الإيمان الأوسط: ((فصل: ثم بعد ذلك تنازع الناس في اسم المؤمن والإيمان نزاعاً كثيراً منه لفظيٌّ، وكثير منه معنوي. فإن أئمة الفقهاء لم ينازعوا في شيء مما ذكرناه من الأحكام، وإن كان بعضهم أعلم بالدين وأقوم به من بعض، ولكن تنازعوا في الأسماء..)) اهـ (١) .
...
فليس بين فقهاء الملة نزاع في أصحاب الذنوب إذا كانوا مقرين باطناً وظاهراً بما جاء به الرسول صلى الله عليه وسلم، وما تواتر عنه أنهم من أهل الوعيد، وأنه يدخل النار منهم من أخبر الله ورسوله بدخوله إليها، ولا يُخلد منهم فيها أحد، ولا يكونون مرتدين مباحي الدماء)) اهـ (٢) .
...
(٢) من كتاب الإيمان (٢٨١-٢٨٢) ، وانظر المجموع نفسه (٧/٢٩٧) .',NULL,'37',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (38,'ولكن من نظر إلى بعض المسائل المترتبة على الخلاف مع مرجئة الفقهاء:
-مسائل زيادة الإيمان ونقصانه.
-واستواء الناس في أصل الإيمان.
-وتحريم الاستثناء في الإيمان مطلقاً، كما تقول مرجئة الفقهاء، يكون الخلاف والحالة هذه حقيقياً (١) .
...
_________
(١) وانظر بحث مفهوم الإيمان عند السلف وغيرهم للعبد الفقير (١٠١-١٠٥) .',NULL,'38',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (39,'ولذا فالخوارج يكفِّرون بالذنب في الدنيا، ويخلدون صاحبه في النار في الآخرة. والمعتزلة لا يجعلون مؤمناً في الدنيا؛ بل إنه في منزلة بين المنزلتين، فهو خرج من الإيمان ولما يدخل إلى الكفر، لكنهم يخلدونه في الآخرة في النار، موافقين في الحكم الأخروي الخوارج.
...
<span data-type="title" id=toc-16>أهمية الموضوع:</span>',NULL,'39',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (40,'١-وأهمية البحث في موضوع الكفر وبيانه تكمن في وجوب الحذر منه والبعد عنه، فهو علامة شقاوة العبد في الدنيا والآخرة. وهو أيضاً أعظم الذنوب والآثام وأشدها خطراً وأعظمها وقعاً وأثراً وهو أخوف ما يخافه ويحذره المؤمنون، وفي ذلك نصوص من الوحيين كثيرة جداً منها قوله تعالى في سورة المائدة: {وَمَن يَكْفُرْ بِالإِيمَانِ فَقَدْ حَبِطَ عَمَلُهُ وَهُوَ فِى الآخِرَةِ مِنَ الْخِاسِرِينَ} [المائدة:٥] . وفي سورة النساء يقول عز وجل: {يَا أيُّهَا الَّذِينَءَامَنُواءَامِنُوا بِاللهِ وَرَسُولِهِ وَالْكِتَابِ الَّذِى نَزَّلَ عَلَى رَسُولِهِ وَالْكِتَابِ الَّذِى أَنزَلَ مِن قَبْلُ وَمَن يَكْفُرْ بِاللهِ وَمَلائِكَتِهِ وَكُتُبِهِ وَرُسُلِهِ وَالْيَوْمِ الأَخِرِ فَقَدْ ضَلَّ ضَلالآً بَعِيداً} [النساء:١٣٦] . ويقول سبحانه في سورة البقرة: {وَمَن يَتَبَدَّلِ الْكُفْرَ بِالإِيمَانِ فَقَدْ ضَلَّ سَوَآءَ السَبِيلِ} [البقرة:١٠٨] .
٢-ومن أهمية موضوع الكفر أن عاقبته في الآخرة خلود صاحبه في النار، ودوام عذاب جهنم عليه فيها أبداً، حيث نصَّ الله على ذلك الخلود المؤبد لهم في عذابه في ثلاثة مواضع من كتابه المنزل:
* أولها في آخر سورة النساء، حيث قال عز وجل: {إِنَّ الَّذِينَ كَفَرُوا وَصَدُّوا عَن سَبِيلِ اللهِ قَدْ ضَلُّوا ضَلالاً بَعِيداً * ِإنَّ الَّذِينَ كَفَرُوا وَظَلَمُوا لَمْ يَكُنِ اللهُ لِيَغْفِرَ لَهُمْ وَلاَ لِيَهْدِيَهُمْ طَرِيقًا * إِلاَّ طَرِيقَ جَهَنَّمَ خَالِدِينَ فِيهَآ أَبَداً وَكَانَ ذَلِكَ عَلَى اللهِ يَسِيراً} [النساء: ١٦٧-١٦٩] .',NULL,'40',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (41,'* وثانيهما في آخر سورة الأحزاب يقول سبحانه: {يَسْئَلُكَ النَّاسُ عَنِ السَّاعَةِ قُلْ إِنَّمَا عِلْمُهَا عِندَ اللهِ وَمَا يُدْرِيكَ لَعَلَّ السَّاعَةَ تَكُونُ قَرِيباً * إِنَّ اللهَ لَعَنَ الْكَافِرِينَ وَأَعَدَّ لَهُمْ سَعِيرَا * خَالِدِينَ فِيهَآ أَبَدًا لاَّيَجِدُونَ وَلِيًّا وَلاَنَصِيرًا} [الأحزاب:٦٣-٦٥] .
...
يقول شيخ الإسلام ابن تيمية في (الكيلانية:١٢/٤٦٨) ضمن الفتاوى في معرض بيانه لموضوع الكفر والتكفير وعلاقته بالهدى، وأسبابه ودواعيه، ومنهج المبتدعة فيه.',NULL,'41',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (42,'((فصل: إذا تبين ذلك فاعلم أن مسائل التكفير والتفسيق هي من مسائل الأسماء والأحكام التي يتعلق بها الوعد والوعيد في الدار الآخرة، وتتعلق بها الموالاة والمعاداة، والقتل والعصمة وغير ذلك في الدار الدنيا؛ فإن الله سبحانه أوجب الجنة للمؤمنين، وحرم الجنة على الكافرين، وهذا من الأحكام الكلية في كل وقت ومكان..)) .
...
بعد تبين أهمية معرفة الكفر وتأكده على المسلم الحريص على نجاته وسلامة دينه وعاقبته، اعلم- رحمك الله- أن الكفر له في أصل معناه عدة معانٍ.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (43,'-منها الستر والتغطية، ومنه سُمي الزُّرَّاع كفاراً لأنهم يغطون البذر في الأرض، كما قال تعالى: {كَمَثَلِ غَيْثٍ أَعْجَبَ الْكُفَّارَ نَبَاتُهُ ثُمَ يَهِيجُ فَتَرَاهُ مُصْفَرًّا} [الحديد:٢٠] .
...
وفي سورة الإسراء يقول الله عز وجل عن موسى لفرعون: {قَالَ لَقَدْ عَلِمْتَ مَآ أَنزَلَ هَؤُلآءِ إِلاَّ رَبُّ السَّمَوَاتِ وَالأَرْضِ بَصَآئِرَ وَإِنِّى لأَظُنُّكَ يَا فِرْعَوْنُ مَثْبُورًا} .',NULL,'44',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (45,'وكذا اليهود وأهل الكتاب يعلمون صدق الرسول صلى الله عليه وسلم: بل ويعرفونه أشد من معرفتهم لأبنائهم، كما يقول عز وجل في سورة البقرة: {الَّذِينَءَاتَيْنَاهمُ الْكِتَابَ يَعْرِفونَهُ كَمَا يَعْرِفُونَ أَبْنَاءَهُمْ وَإِنَّ فَرِيقًا مِّنْهُمْ لَيَكْتُمُونَ الْحَقَّ وَهُمْ يَعْلَمُونَ} .
فالكفر يكون بالتكذيب والجحود ويكون بغيره من الإعراض والشك والاستكبار....)) اهـ.
٥-ويقول – رحمه الله- في أول ((الكيلانية)) من مجموع الفتاوى ١٢/٣٣٥:
...
-وممن كُفِّر جنساً: المشركون واليهود والنصارى والمجوس ونحوهم.',NULL,'45',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (46,'-وممن كُفِّر وصفاً: المستهزئ بالله أو بآياته أو برسوله، والمحكِّم لغير ما أنزل الله، والساحر والكاهن ومدعي علم الغيب ونحوهم.
٢- أن الكفر كالإيمان له شعب كثيرة، فكما صحَّ في الصحيحين من حديث أبي هريرة رضي الله عنه يرفعه إلى النبي صلى الله عليه وسلم أنه قال: ((الإيمان بضع وسبعون شعبة، أعلاها قول لا إله إلا الله، وأدناها إماطة الأذى عن الطريق، والحياء شعبة من شعب الإيمان)) .
...
٥-أن الكفر ورد في موارده المعتبرة في نصوص الوحيين الشريفين: كتاب الله وسنة رسوله صلى الله عليه وسلم يرد على صورتين:
...
وهذا المعنى هو ما قرَّره الشيخ أبو العباس ابن تيمية في كتابه ((اقتضاء الصراط المستقيم)) (١/٢٣٧-٢٣٨) حيث يقول:',NULL,'49',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (50,'((وروى مسلم في صحيحه عن الأعمش عن أبي صالح عن أبي هريرة رضي الله عنه قال، قال رسول الله صلى الله عليه وسلم: ((اثنتان في الناس هما بهم كفر)) .
...
٦-أن أهل السنة والجماعة يعظمون لفظ التكفير جداً، ويجعلونه حقاً لله ولرسوله صلى الله عليه وسلم فقط، فلا يجوز ولا يسوغ عندهم تكفير أحدٍ إلا من كفره الله أو كفره رسوله.
...
((فصل، ومن أصل أهل السنة: أن الدين والإيمان قول وعمل: قول القلب واللسان وعمل القلب واللسان والجوارح، وأن الإيمان يزيد بالطاعة، وينقص بالمعصية.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (51,'وهم مع ذلك لا يكفرون أهل القبلة بمطلق المعاصي والكبائر، كما يفعله الخوارج؛ بل الأخوة الإيمانية ثابتة مع المعاصي..)) إلى آخر الفصل.
...
أو يقرُّون الجميع على مناهجهم المختلفة، كما يُقرَّ العلماء في مواضع الاجتهاد التي يسوغ فيها النزاع، وهذه الطريقة قد تغلب على كثير من المرجئة وبعض المتفقهة والمتصوفة والمتفلسفة، كما تغلب الأولى على كثير من أهل الأهواء والكلام، وكلا هاتين الطريقتين منحرفة خارجة عن الكتاب والسنة)) أهـ.',NULL,'51',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (52,'والمقصود أن المبتدعة على تنوع مشاربهم وتباين أصولهم ومناهجهم يروج عندهم تكفير مخالفيهم عند أدنى مخالفة.
...
الموضوع: الصفحة
تقريظات كبار العلماء ... ... ... ... ... ... ٣',NULL,'52',NULL,NULL,'0');
INSERT INTO [b1929] VALUES (53,'المقدمة ... ... ... ... ٦
...
المطلب الرابع: بيان فساد أقوال الطوائف إجمالاً ١٦
...
فهرس المحتوى ٥٧',NULL,'53',NULL,NULL,'0');
