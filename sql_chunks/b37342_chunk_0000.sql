...
CREATE TABLE "b37342"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b37342
INSERT INTO [b37342] VALUES (1,'كيف نغير ما بأنفسنا؟

دكتور
مجدي الهلالي
_________
http://www.alemanawalan.com/',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b37342] VALUES (2,'<span data-type="title" id=toc-1>المقدمة</span>
...
هذه الأسئلة وغيرها تتردد في أذهان الكثير من أبناء الأمة، منطلقة من يقينها بأن الله عز وجل قادر على تغيير ما نزل بساحتنا وحاق بنا في لمح البصر .. أليس هو القائل: {إِنَّمَا أَمْرُهُ إِذَا أَرَادَ شَيْئًا أَنْ يَقُولَ لَهُ كُنْ فَيَكُونُ} [يس/٨٢]؟.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (3,'أليس هو - سبحانه - الذي أغرق فرعون وجنده، وأهلك عادا وثمود؟، {أَلَمْ تَرَ كَيْفَ فَعَلَ رَبُّكَ بِعَادٍ (٦) إِرَمَ ذَاتِ الْعِمَادِ (٧) الَّتِي لَمْ يُخْلَقْ مِثْلُهَا فِي الْبِلَادِ (٨) وَثَمُودَ الَّذِينَ جَابُوا الصَّخْرَ بِالْوَادِ (٩) وَفِرْعَوْنَ ذِي الْأَوْتَادِ (١٠) الَّذِينَ طَغَوْا فِي الْبِلَادِ (١١) فَأَكْثَرُوا فِيهَا الْفَسَادَ (١٢) فَصَبَّ عَلَيْهِمْ رَبُّكَ سَوْطَ عَذَابٍ (١٣) إِنَّ رَبَّكَ لَبِالْمِرْصَادِ} [الفجر/٦ - ١٤].
أليس هو - سبحانه وتعالى - الذي استنصره نوح عليه السلام فاستجاب له ونصره نصرا مؤزرا: {فَفَتَحْنَا أَبْوَابَ السَّمَاءِ بِمَاءٍ مُنْهَمِرٍ (١١) وَفَجَّرْنَا الْأَرْضَ عُيُونًا فَالْتَقَى الْمَاءُ عَلَى أَمْرٍ قَدْ قُدِرَ (١٢) وَحَمَلْنَاهُ عَلَى ذَاتِ أَلْوَاحٍ وَدُسُرٍ (١٣) تَجْرِي بِأَعْيُنِنَا جَزَاءً لِمَنْ كَانَ كُفِرَ} [القمر/١١ - ١٤]؟
...
{قَالُوا سُبْحَانَكَ لَا عِلْمَ لَنَا إِلَّا مَا عَلَّمْتَنَا إِنَّكَ أَنْتَ الْعَلِيمُ الْحَكِيمُ} [البقرة/٣٢].',NULL,'2',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (4,'<span data-type="title" id=toc-2>القادر المقتدر</span>
أخبرنا الله عز وجل في كتابه وعلى لسان نبيه صلى الله عليه وسلم بأنه: " حي قيوم "، ومن مظاهر وآثار قيوميته أنه - سبحانه وتعالى - قائم على جميع شئون خلقه: {وَمِنْ آَيَاتِهِ أَنْ تَقُومَ السَّمَاءُ وَالْأَرْضُ بِأَمْرِهِ} [الروم/٢٥].
فلا يستطيع أحد في السماوات أن يُقيم نفسه بنفسه، أو يتولى تصريف أموره ولو طرفة عين .. فالسماوات مرفوعة بغير عمد، يمسكها سبحانه وتعالى، ولو تركها لسقطت على الأرض: {وَيُمْسِكُ السَّمَاءَ أَنْ تَقَعَ عَلَى الْأَرْضِ إِلَّا بِإِذْنِهِ} [الحج/٦٥].
...
<span data-type="title" id=toc-5>ما شاء الله كان:</span>
لإذن فكل ما يحدث لنا من ذل وهوان وهزائم ونكسات فبعلم الله وإذنه: {وَلَوْ شَاءَ رَبُّكَ مَا فَعَلُوهُ} [الأنعام/١١٢].
فما فعله فرعون ببني إسرائيل ما كان ليحدث لو لم يأذن به الله: {وَإِذْ نَجَّيْنَاكُمْ مِنْ آَلِ فِرْعَوْنَ يَسُومُونَكُمْ سُوءَ الْعَذَابِ يُذَبِّحُونَ أَبْنَاءَكُمْ وَيَسْتَحْيُونَ نِسَاءَكُمْ وَفِي ذَلِكُمْ بَلَاءٌ مِنْ رَبِّكُمْ عَظِيمٌ} [البقرة/٤٩].',NULL,'4',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (6,'وعندما كلف الله عز وجل موسى وأخاه هارون - عليهما السلام - بالرسالة خافا من بطش فرعون بهما وطغيانه عليهما: {قَالَا رَبَّنَا إِنَّنَا نَخَافُ أَنْ يَفْرُطَ عَلَيْنَا أَوْ أَنْ يَطْغَى} [طه/٤٥]، فماذا قال الله لهما: {لَا تَخَافَا إِنَّنِي مَعَكُمَا أَسْمَعُ وَأَرَى} [طه/٤٦].
أخرج الإمام أحمد في الزهد عن ابن عباس رضي الله عنهما قال: لما بعث الله عز وجل موسى وهارون عليهما السلام إلى فرعون قال: لا يغركما لباسه الذي ألبسته، فإن ناصيته بيدي، ولا ينطق ولا يطرف إلا بإذني (١).
...
<span data-type="title" id=toc-6>القدرة الإلهية:</span>
...
_________
(١) الزهد للإمام أحمد، ص ٦١ - ط دار الكتب العلمية - بيروت - لبنان.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (7,'ومن الذي أرسل الطير الأبابيل على أصحاب الفيل الذين أرادوا هدم الكعبة؟
...
<span data-type="title" id=toc-7>البداية من العبد:</span>
...
والقدرة الإلهية كذلك لا تتنزل بالمدد والنصر على الفئة المؤمنة إلا إذا استوفت الشروط المؤهلة لذلك، والتي يأتي على رأسها: أن يتغير حالها إلى الحال الذي يرضي الله عز وجل، وتترك ما يبغضه، كما قال سبحانه: {إِنَّ اللَّهَ لَا يُغَيِّرُ مَا بِقَوْمٍ حَتَّى يُغَيِّرُوا مَا بِأَنْفُسِهِمْ} [الرعد/١١].',NULL,'6',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (8,'<span data-type="title" id=toc-8>تأملات في آية التغيير:</span>
...
فما مناسبة وجود آية التغيير بين هذه الآيات؟ وما الرابط بينها؟',NULL,'7',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (9,'هناك بلا شك دلالات كثيرة من وجود هذه الآية وسط الآيات التي تتحدث عن القدرة الإلهية المطلقة، ولعل من هذه الدلالات أنها تحمل لنا جميعا رسالة تقول: إن الله عز وجل ذو قدرة مطلقة، وعلم لا حدود له، وقوة لا يمكن تخيلها، ومشيئة نافذة، والدليل على ذلك ما نراه بأعيننا من سماء مترامية الأطراف مرفوعة بلا عمد، ومن الأرض الممدودة، ومن البرق والصواعق المخيفة.
...
<span data-type="title" id=toc-9>الأمل في الله وحده:</span>
...
فلابد إذن من وجود السبب لتتنزل من خلاله القدرة الإلهية، وفي نفس الوقت فإن السبب لا قيمة له بدون المدد الإلهي: {فَلَمْ تَقْتُلُوهُمْ وَلَكِنَّ اللَّهَ قَتَلَهُمْ وَمَا رَمَيْتَ إِذْ رَمَيْتَ وَلَكِنَّ اللَّهَ رَمَى} [الأنفال/١٧].',NULL,'10',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (12,'تأمل معي ما حدث للصحابة وقد نفد ماؤهم وأرادوا الوضوء والشرب، فذهبوا إلى رسول الله صلى الله عليه وسلم يخبرونه بذلك، فماذا فعل عليه الصلاة والسلام؟
...
<span data-type="title" id=toc-11>نأخذ بالأسباب ولا نتعلق بها:</span>
...
_________
(١) أحاديث نبع الماء من بين أصابع الرسول صلى الله عليه وسلم كثيرة منها: ما رواه البخاري عن ابن مسعود رضي الله عنه قال: بينما نحن مع رسول الله صلى الله عليه وسلم وليس معنا ماء، فقال لنا رسول الله صلى الله عليه وسلم: " اطلبوا من معه فضل ماء " فأتى بماء فصبه في إناء، ثم وضع كفه فيه، فجعل الماء ينبع من بين أصابع رسول الله صلى الله عليه وسلم.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (13,'نعم قد يتعرض الواحد منا لمواقف تقل فيها الأسباب أو تنعدم دون إرادة منه، كمن لم يستطع النوم ويريد إنجاز الكثير من المهام التي تحتاج إلى تركيز وصفاء ذهن .. هنا انعدمت أسباب الراحة أو قلت دون إرادة منه، فماذا يفعل؟ هل يقول: لأني لم أنم فلن أستطيع القيام بهذه الأعمال، أم يتجاوز الأسباب التي لم تتح له ويتوجه مباشرة إلى الله عز وجل، طالبا منه العون والمدد بالقدرة على التركيز وحسن إنهاء هذه الأعمال؟
...
وعندما تُترك هذه القوانين يتعلق العبد بالأسباب المادية ولا يتعلق بالله عز وجل، فإنه يُخذل ولا يوفق، كما حدث للمسلين في غزوة حنين: {وَيَوْمَ حُنَيْنٍ إِذْ أَعْجَبَتْكُمْ كَثْرَتُكُمْ فَلَمْ تُغْنِ عَنْكُمْ شَيْئًا وَضَاقَتْ عَلَيْكُمُ الْأَرْضُ بِمَا رَحُبَتْ ثُمَّ وَلَّيْتُمْ مُدْبِرِينَ} [التوبة/٢٥].
...
<span data-type="title" id=toc-13>الخلاصة:</span>
...
هل سنظل في دائرة الإحباط التي ندور فيها؟ أم سنبدأ من الآن في تغيير ما بأنفسنا؟؟',NULL,'13',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (15,'قال تعالى: {فَقَاتِلْ فِي سَبِيلِ اللَّهِ لَا تُكَلَّفُ إِلَّا نَفْسَكَ وَحَرِّضِ الْمُؤْمِنِينَ عَسَى اللَّهُ أَنْ يَكُفَّ بَأْسَ الَّذِينَ كَفَرُوا وَاللَّهُ أَشَدُّ بَأْسًا وَأَشَدُّ تَنْكِيلًا} [النساء/٨٤].

<span data-type="title" id=toc-14>ما المقصود بالتغيير</span>؟
خلقنا الله عز وجل وكرمنا على سائر خلقه، وأسجد الملائكة لأبينا آدم، وأعد لنا الجنة لتكون لنا دارا: {وَلَقَدْ كَرَّمْنَا بَنِي آَدَمَ وَحَمَلْنَاهُمْ فِي الْبَرِّ وَالْبَحْرِ وَرَزَقْنَاهُمْ مِنَ الطَّيِّبَاتِ وَفَضَّلْنَاهُمْ عَلَى كَثِيرٍ مِمَّنْ خَلَقْنَا تَفْضِيلًا} [الإسراء/٧٠].
ولقد خلقنا الله سبحانه وتعالى وكرمنا هذا التكريم، وأسكننا الأرض وسخرها لنا، لنقوم بأداء مهمة جليلة ألا وهي عبادته {وَمَا خَلَقْتُ الْجِنَّ وَالْإِنْسَ إِلَّا لِيَعْبُدُونِ} [الذاريات/٥٦].
فنحن إذن لم نخرج إلى الأرض لنأكل أو لنشرب أو لنتزوج، بل خرجنا لأداء وظيفة محددة .. وظيفة العبودية لله عز وجل.

<span data-type="title" id=toc-15>معنى العبودية:</span>
...
ومنها: دعوة الخلق إليه وتحبيبهم فيه، وجهادهم من أجل نشر دينه، وإعلاء رايته.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (16,'امتحان العبودية:
...
والتحقق بمعاني العبودية، وتغيير ما بالنفس، يشمل المفاهيم والتصورات، والمشاعر والوجدانات، والسر والعلانية، والأقوال والأفعال.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (17,'وفي المقابل، فكما خلع العبد رداء عبوديته لربه، وسار وراء هواه وازداد تعلقه بالدنيا، وحبه لها، ابتعد عن ولاية ربه واستدعى بأفعاله تلك غضبه سبحانه وتعالى، واستحق عقابه: {ذَلِكَ بِأَنَّ اللَّهَ لَمْ يَكُ مُغَيِّرًا نِعْمَةً أَنْعَمَهَا عَلَى قَوْمٍ حَتَّى يُغَيِّرُوا مَا بِأَنْفُسِهِمْ وَأَنَّ اللَّهَ سَمِيعٌ عَلِيمٌ (٥٣) كَدَأْبِ آَلِ فِرْعَوْنَ وَالَّذِينَ مِنْ قَبْلِهِمْ كَذَّبُوا بِآَيَاتِ رَبِّهِمْ فَأَهْلَكْنَاهُمْ بِذُنُوبِهِمْ وَأَغْرَقْنَا آَلَ فِرْعَوْنَ وَكُلٌّ كَانُوا ظَالِمِينَ} [الأنفال/٥٣، ٥٤].

<span data-type="title" id=toc-16>شروط الولاية:</span>
...
وماذا لو احتاجا مساعدة .. فلأيهما ستكون؟! فمن البديهي أن الذي يقوم بمهمته هو الذي سيحظى برعاية رؤسائه وإجابة مطالبه، ومساعدته وقت الحاجة .. أما الآخر فلن يتبناه أحد، ولن يُلتفت إلى طلباته، بل العكس سيحدث، فالعقوبات والجزاءات تنتظره.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (18,'ولله المثل الأعلى، فلقد كلفنا الله عز وجل بأداء مهمة محددة على الأرض، فمن اجتهد في القيام بها، فقد عرض نفسه لرضا مولاه، ومن ثمَّ عونه ومدده، أما من ترك مهمته وانشغل بشهواته، فقد عرض نفسه لغضب مولاه، ومن ثمَّ حرمانه من المدد والتوفيق: {فَأَمَّا مَنْ أَعْطَى وَاتَّقَى (٥) وَصَدَّقَ بِالْحُسْنَى (٦) فَسَنُيَسِّرُهُ لِلْيُسْرَى (٧) وَأَمَّا مَنْ بَخِلَ وَاسْتَغْنَى (٨) وَكَذَّبَ بِالْحُسْنَى (٩) فَسَنُيَسِّرُهُ لِلْعُسْرَى} [الليل/٥ - ١٠].
...
<span data-type="title" id=toc-17>الكرامة والاستقامة:</span>
...
فالولاية والكرامة على قدر الاستقامة، واستمرارها مرتبط ببقاء حالة تلك الاستقامة، فعلى سبيل المثال: إن الله عز وجل فضل بني إسرائيل على العالمين في فترة من الفترات بسبب صبرهم وتحملهم الأذى في سبيله: {وَتَمَّتْ كَلِمَةُ رَبِّكَ الْحُسْنَى عَلَى بَنِي إِسْرَائِيلَ بِمَا صَبَرُوا} [الأعراف/١٣٧].',NULL,'17',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (19,'وعندما أساءوا استقبال نعم ربهم عليهم، وقابلوها بالجحود والطغيان واحدة تلو أخرى، كان العقاب الأليم من الله عز وجل، والذي وصل مداه بأن جعل منهم قردة وخنازير: {فَبِمَا نَقْضِهِمْ مِيثَاقَهُمْ لَعَنَّاهُمْ وَجَعَلْنَا قُلُوبَهُمْ قَاسِيَةً يُحَرِّفُونَ الْكَلِمَ عَنْ مَوَاضِعِهِ وَنَسُوا حَظًّا مِمَّا ذُكِّرُوا بِهِ} [المائدة/١٣].
...
<span data-type="title" id=toc-18>نظرة على الواقع:</span>
...
وماذا ... وماذا؟',NULL,'18',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (20,'وليت الأمر وصل إلى هذه الدرجة، بل قد انتشر الفساد في كل الاتجاهات، ولم يعُد مقصورا على طبقة دون أخرى، فالمنكرات تملأ بلدان المسلمين .. تفشى الظلم والفساد والغش والكذب بين الناس.
...
<span data-type="title" id=toc-19>حب الدنيا:</span>
لقد ملأ حب الدنيا قلوبنا، فأصبحت تصوراتنا وأحلامنا منبثقة منها .. اتجهت أعيننا إلى الأرض وتصارعنا على ما فيها، فوقعنا فيما حذرنا منه رسول الله صلى الله عليه وسلم بقوله: " إذا تبايعتم بالعينة، وأخذتم أذناب البقر، ورضيتم بالزرع، وتركتم الجهاد: سلط الله عليكم ذلا لا ينزعه حتى ترجعوا إلى دينكم " (١).
...
_________
(١) صحيح: أخرجه أبو داود في سننه (ج ٣ / ص ٢٩١). وأورده الشيخ الألباني في صحيح الجامع برقم (٤٣٢).',NULL,'19',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (21,'تأمل معي خطاب الترهيب الإلهي للمؤمنين من الوقوع في فعل شيئ واحد مما نفعله: {يَا أَيُّهَا الَّذِينَ آَمَنُوا اتَّقُوا اللَّهَ وَذَرُوا مَا بَقِيَ مِنَ الرِّبَا إِنْ كُنْتُمْ مُؤْمِنِينَ (٢٧٨) فَإِنْ لَمْ تَفْعَلُوا فَأْذَنُوا بِحَرْبٍ مِنَ اللَّهِ وَرَسُولِهِ} [البقرة/٢٧٨، ٢٧٩].
...
<span data-type="title" id=toc-20>الجسد الواحد:</span>
فإن قلت: ولكن أنا لا أفعل هذه الموبقات، وأعمل جاهدا على إصلاح نفسي، والاستقامة على أمر الله، فلماذا أُعاقب بما يعاقب به العاصون؟',NULL,'20',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (22,'يجيب عن هذا التساؤل أبو بكر الصديق رضي الله عنه بقوله: يا أيها الناس إنكم تقرأون هذه الآية وتضعونها على غير مواضعها، وقرأ: {يَا أَيُّهَا الَّذِينَ آَمَنُوا عَلَيْكُمْ أَنْفُسَكُمْ لَا يَضُرُّكُمْ مَنْ ضَلَّ إِذَا اهْتَدَيْتُمْ} [المائدة/١٠٥]، وإني سمعت رسول الله صلى الله عليه وسلم يقول: " إن الناس إذا رأوا الظالم فلم يأخذوا على يديه أوشك أن يعمهم الله بعقاب منه " (١).
...
(٢) الدر المنثور للسيوطي (٣/ ٣٢٢)، دار الكتب العلمية، بيروت - لبنان.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (23,'وذكر ابن أبي الدنيا عن إبراهيم بن عمرو الصنعاني قال: أوحى الله إلى يوشع بن نون: إني مهلك من قومك أربعين ألفا من خيارهم، وستين ألفا من شرارهم. قال: يارب، هؤلاء الأشرار فما بال الأخيار؟! قال: إنهم لم يغضبوا لغضبي، وكانوا يؤاكلونهم ويشاربونهم (١).
...
<span data-type="title" id=toc-21>أين أثر الدعاء:</span>
...
_________
(١) الداء والدواء لابن القيم ص ٩٠ - دار ابن كثير، بيروت - لبنان.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (24,'ولا ينبغي لمن وقع في المخالفة وارتكب الذنب أن يستغرب العقوبة: {ذَلِكَ بِمَا قَدَّمَتْ أَيْدِيكُمْ وَأَنَّ اللَّهَ لَيْسَ بِظَلَّامٍ لِلْعَبِيدِ} [آل عمران/١٨٢].
...
وليس أهل قرية ولا أهل بيت ولا رجل يكونون لله عز وجل على معصية، فيتحولون إلى طاعة الله عز وجل، إلا تحول الله عز وجل لهم مما يكرهون إلى ما يحبون (١).
...
<span data-type="title" id=toc-22>أستاذية العالم:</span>
...
_________
(١) العقوبات لابن أبي الدنيا ص ٥٢، ٥٣، دار ابن حزم - بيروت.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (25,'إذن فنحن لا نريد انتصارا وقتيا في معركة من المعارك ثم يعود الحال إلى ما كان عليه، كما حدث في أفغانستان.
...
يقينا سيحدث هذا، وستفتح روما، وسيعود الأقصى، وتأتي خلافة أخرى كأختها الراشدة الأولى، ولكن بمن؟: {يَا أَيُّهَا الَّذِينَ آَمَنُوا مَنْ يَرْتَدَّ مِنْكُمْ عَنْ دِينِهِ فَسَوْفَ يَأْتِي اللَّهُ بِقَوْمٍ يُحِبُّهُمْ وَيُحِبُّونَهُ أَذِلَّةٍ عَلَى الْمُؤْمِنِينَ أَعِزَّةٍ عَلَى الْكَافِرِينَ يُجَاهِدُونَ فِي سَبِيلِ اللَّهِ وَلَا يَخَافُونَ لَوْمَةَ لَائِمٍ ذَلِكَ فَضْلُ اللَّهِ يُؤْتِيهِ مَنْ يَشَاءُ وَاللَّهُ وَاسِعٌ عَلِيمٌ} [المائدة/٥٤].
ولكي نكون نحن وأبناؤنا من هؤلاء القوم، ولكي يعود مجد الإسلام من جديد، لابد من التغيير.
_________
(١) صحيح: أخرجه أحمد (٤/ ١٠٣، رقم ١٦٩٩٨)، والطبراني (٢/ ٥٨، رقم ١٢٨٠)، قال الهيثمي (٦/ ١٤): رجال أحمد رجال الصحيح. والحاكم (٤/ ٤٧٧، رقم ٨٣٢٦)، وقال: صحيح على شرط الشيخين. والبيهقي (٩/ ١٨١، رقم ١٨٤٠٠).',NULL,'24',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (26,'<span data-type="title" id=toc-23>عوائق التغيير</span>
...
<span data-type="title" id=toc-24>كيف يتم السلوك</span>؟
...
ثالثا: صدور أمر من القلب إلى الجوارح بالتنفيذ.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (27,'هذه المراحل الثلاث جمعها قوله تعالى: {وَلِتَصْغَى إِلَيْهِ أَفْئِدَةُ الَّذِينَ لَا يُؤْمِنُونَ بِالْآَخِرَةِ وَلِيَرْضَوْهُ وَلِيَقْتَرِفُوا مَا هُمْ مُقْتَرِفُونَ} [الأنعام/١١٣].
...
<span data-type="title" id=toc-25>المحور الأول: العقل</span>
...
<span data-type="title" id=toc-26>الشعور واللاشعور:</span>
...
أما العقل غير المدرك أو ما يسمى باللاشعور أو اليقين. ففيه تُختزن المعلومات الراسخة لدى الإنسان (عن نفسه وعائلته ومفاهيمه وتصوراته وعقائده ... ).',NULL,'26',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (28,'هذه المنطقة تشكل المنطلق الأساسي للأفعال التلقائية التي تتم بدون تفكير، ولا يوجد إنسان على ظهر الأرض إلا ولديه منطقة يقين خاصة به .. هذا اليقين قد يكون صحيحا، وقد يكون خاطئا، ولكنه يبقى يقينا ليس فيه شك.
...
<span data-type="title" id=toc-27>كيف يتكون اليقين</span>؟
...
فعلى سبيل المثال: عند طرح موضوع الذكور والإناث أيهما تريد أن تلده زوجتك؟! تجدنا نتبارى في إظهار استسلامنا لله عز وجل، وأننا سنرضى بما يقسمه لنا من هذا الرزق.',NULL,'27',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (29,'هذا في ميدان القول، أم في الواقع فالأمر قد يختلف، فالبعض لن يستقبل مولودته الأنثى بهذا الرضا الذي أظهره أثناء المناقشة، فإذا ما أنجبت زوجته أنثى للمرة الثانية ازداد ضيقه .. هذا الضيق قد يتصاعد في المرة الثالثة لينطلق متهما زوجته بأنها السبب في ذلك، وقد يتوعدها إن تكرر الأمر مرة أخرى!!
...
كذلك فالذي يرى أباه يتعامل بجفاء مع أمه ولا ينكر ذلك، فإن هذه الصورة من التعامل سترسخ في يقينه ليطبقها بعد ذلك في التعامل مع زوجته.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (30,'<span data-type="title" id=toc-28>وسائل تكوين اليقين:</span>
...
<span data-type="title" id=toc-29>خطورة التلفاز</span>
ومن وسائل تكوين اليقين داخل الإنسان كذلك:',NULL,'29',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (31,'وسائل الإعلام بصورها المختلفة وأهمها جهاز التلفاز والذي يعد من أخطر عوامل بناء اليقين داخل الإنسان سواء كان صحيحا أم خاطئا، فما يعرض في هذا الجهاز الخطير وبصورة متكررة وبشكل شبه يومي من أفلام ومسلسلات وإعلانات له دور كبير في تكوين اليقين الخاطئ داخل الإنسان وبخاصة عند الصغر، فتكرار عرض صور النساء العارية والمناظر الخليعة واختلاط النساء بالرجال والصداقة بين الجنسين وما تنشئه من علاقات محرمة مع عرض كل هذا بأسلوب محبب - وفكاهي أحيانا - له دور كبير في قبول العقل لهذه الأفكار، ومن ثم مرورها إلي اليقين ورسوخها فيه بدوام تكرار عرضها، مع الأخذ في الاعتبار أن للصورة المرئية تأثيرا مباشرا على اللاشعور، فالعقل المدرك غالبا ما يتركها تمر دون تفكير (١).
...
_________
(١) نقلت مجلة (بث) السعودية أن من أغرب الأساليب الإعلانية التي استخدمتها شركة كوكاكولا أنها كانت تستأجر لقطات متفرقة لا تزيد عن ١/ ٢٤ من الثانية في أهم الأفلام الأمريكية لتمرر صورة مشروبها، وهي عملية دعائية مدروسة ترسخ صورة المشروب في العقل الباطن للمشاهد دون مرورها على عقله الواعي، فلو سألته: هل شاهدت زجاجة (كوكاكولا) سيجيبك بالنفي ولكنه سيتوجه بعد مشاهدة الفيلم لشراء (كوكاكولا)، وقد مُنعت الشركة لاحقا من استخدام هذا الأسلوب الدعائي باعتباره أداة للغش التجاري - نقلا عن مجلة (بث) العدد، (١٦)، ذي القعدة ١٤٢٤ هـ.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (32,'كل هذه العوامل تشترك في تكوين اليقين بشقيه الصحيح والخاطئ والذي يختلف من شخص لآخر بناء على طبيعة العوامل التي تعرض لها. ولكي يتم التغيير الصحيح في الاهتمامات والتصورات، ومن ثم السلوك لابد أولا من إعادة بناء منطقة اللاشعور واستبدال اليقين الخاطئ بيقين صحيح تنطلق منه الخواطر والاهتمامات والأفعال التلقائية في حياة الإنسان.

<span data-type="title" id=toc-30>المحور الثاني: القلب</span>
...
_________
(١) صحيح: متفق عليه، البخاري (١/ ٢٨، رقم ٥٢)، ومسلم (٣/ ١٢١٩، رقم ١٥٩٩).',NULL,'31',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (33,'الذي يحول بينه وبين ذلك تمكن الهوى منه وسيطرته عليه. فالقلب هو مجمع المشاعر والعواطف داخل الإنسان .. هذه العواطف يتجاذبها طرفان .. الطرف الأول: الإيمان بما في العقل من عقائد وأفكار، والثاني: الهوى وما تميل إليه النفس.
فالعقل يريد من القلب تنفيذ مقتضيات أفكاره وقناعاته، والنفس تريد من القلب تنفيذ ما تهواه وتميل إليه من شهوات وحظوظ.
فالصراع بين الإيمان والهوى يتم قبل كل فعل يقوم به العبد، وأيهما أقوى سينتصر ويستولي على إرادة القلب، ومن ثم يكون الفعل من نصيبه هو: {فَإِنْ لَمْ يَسْتَجِيبُوا لَكَ فَاعْلَمْ أَنَّمَا يَتَّبِعُونَ أَهْوَاءَهُمْ} [القصص/٥٠].
فلحظة المعصية تعكس انتصار الهوى على الإيمان، ولحظة الطاعة تعكس انتصار الإيمان على الهوى في القلب كما قال صلى الله عليه وسلم:" لا يزني العبد حين يزني وهو مؤمن، ولا يسرق حين يسرق وهو مؤمن، ولا يشرب الخمر حين يشربها وهو مؤمن، ولا يقتل وهو مؤمن " (١).
...
_________
(١) صحيح: أخرجه البخاري (٦/ ٢٤٩٧ رقم ٦٤٢٤)، وغيره.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (34,'<span data-type="title" id=toc-31>التشخيص:</span>
...
<span data-type="title" id=toc-32>المحور الثالث: النفس</span>
...
ولأن هواها في الراحة فإنها تلح على صاحبها بعدم القيام بالطاعة لما فيها من مشقة.',NULL,'33',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (35,'فإن قاومها العبد وألزمها فعل الطاعة فإنها لا تستسلم له بل تحاول أن تأخذ حظها من هذا الفعل، وذلك من خلال الإلحاح عليه لكشف عمله أمام الناس لتعلو منزلته عندهم فيعظموه ويمدحوه، فتُسقى من خلال ذلك شراب النشوة والسعادة.
...
<span data-type="title" id=toc-33>الصنم الداخلي:</span>
إذن فليس معنى أن الشخص يؤدي ما عليه من واجبات، ويحرص على الانضباط في سلوكه وتعاملاته ... ليس معنى هذا أنه قد ارتدى رداء العبودية، وأصبح في مظان الرضا والتوفيق الإلهي. فقد يكون هذا الشخص راضيا عن نفسه، فرحا بها، ينظر إليها بعين الإعجاب ويعتقد أنه مميز عن غيره بما يفعله من أعمال، وتراه دوما يقارن نفسه بغيره، ويرى انه أفضل من جميع من حوله، ولما لا وهو يصلي بالليل وهم نائمون، ويعمل للإسلام وهم قاعدون ... منضبط في سلوكه وهم مفرطون .. يعتقد أن عنده أشياء وملكات ذاتية ليست عند غيره، يمكنه ان ستدعيها ويستعين بها وقتما شاء، فتتضخم بذلك نفسه، وتكبر داخله وتصبح كالصنم يستعين به في تصريف أموره، فيشرك بذلك بالله عز وجل، ويتعرض للهلاك كما قال صلى الله عليه وسلم: " ... فأما المهلكات: فشح مطاع، وهوى متبع، وإعجاب المرء بنفسه " (١).
_________
(١) حديث حسن: رُوي عن ابن عمر وأنس رضي الله عنهم.
حديث ابن عمر: أخرجه الطبراني في المعجم الأوسط (٦/ ٤٧، رقم ٥٧٥٤)، قال الهيثمي (١/ ٩١): فيه ابن لهيعة ومن لا يُعرف. وحديث أنس: أخرجه البزار كما في مجمع الزوائد (١/ ٩١) قال الهيثمي: فيه زائدة بن أبى الرقاد وزياد النميري وكلاهما مختلف في الاحتجاج به. وحسنه الشيخ الألباني فقال في "الجامع الصغير وزيادته ": حسن، وقال في " صحيح الترغيب والترهيب ": حسن لغيره.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (36,'فإذا تعرض العبد لمقت الله تباعد عنه التوفيق الإلهي، ومن ثَمَّ النصر والتأييد، قال صلى الله عليه وسلم: " النادم ينتظر الرحمة، والمعجب ينتظر المقت " (١).
...
<span data-type="title" id=toc-34>الخلاصة:</span>
أنه إذا كان المطلوب أن نغير ما بأنفسنا حتى يغير الله عز وجل ما بنا فإن هذا التغيير لابد أن يشمل:
١ - الاهتمامات والتصورات والأفكار، وهذا يستدعي تغيير اليقين الخاطئ في العقل الباطن.
٢ - زيادة الإيمان وتمكنه التام من القلب، وطرد الهوى منه.
٣ - جهاد النفس وترويضها وإلزامها الصدق والإخلاص لله عز وجل.

<span data-type="title" id=toc-35>من أين نبدأ</span>؟
...
كل هذا لابد أن يتم ليكون النتاج عبدا مخلصا لله عز وجل، يتمثل فيه قوله تعالى: {قُلْ إِنَّ صَلَاتِي وَنُسُكِي وَمَحْيَايَ وَمَمَاتِي لِلَّهِ رَبِّ الْعَالَمِينَ} [الأنعام/١٦٢].
_________
(١) شعب الإيمان - البيهقي - (ج ٥ / ص ٤٥٣ برقم ٧٢٥٤) ... . وأورده ابن طاهر المقدسي في تذكرة الموضوعات (ص ١٥٢، رقم ١١١٦).',NULL,'35',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (37,'<span data-type="title" id=toc-36>صعوبة التغيير:</span>
...
<span data-type="title" id=toc-37>لكل داء دواء:</span>
ومع هذه الصعوبة الشديدة التي تبدو أمامنا في كيفية التغيير، إلا أننا نوقن بأن هناك حلا لذلك ... ألم يقل صلى الله عليه وسلم: " ما أنزل الله داء إلا أنزل له الدواء " (١).
...
_________
(١) حديث صحيح: أخرجه ابن ماجه (٢/ ١١٣٨، رقم ٣٤٣٨). قال البوصيري (٤/ ٥٠): هذا إسناد صحيح رجاله ثقات، وصححه الألباني في صحيح الجامع برقم (٥٥٥٨).',NULL,'36',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (38,'وباستقراء تاريخ الأمة الإسلامية نجد فيها صفحات مشرقة لجيل من الأجيال كانوا قبل إسلامهم غاية في الغرابة والجاهلية، ثم تبدل حالهم وتغير تغييرا جذريا ليصبحوا عبيدا لله عز وجل ويعملون من أجله، ويضحون في سبيل مرضاته بالغالي والنفيس .. ذلكم هو جيل الصحابة رضوان الله عليهم.
...
<span data-type="title" id=toc-38>نماذج عملية:</span>
...
_________
(١) تفسير القرآن العظيم لابن كثير ١/ ٢٤ - مكتبة العبيكان.',NULL,'37',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (39,'وانظر إلى الخنساء التي ملأت الأفاق بكاء وعويلا عند وفاة أخيها "صخر" وذلك قبل إسلامها، هذه المرأة هي نفسها التي دفعت بأولادها الأربعة - فلذات كبدها - إلى الموت طلبا للشهادة في سبيل الله، وذلك بعد إسلامها وتَغيُّرها وعودتها إلى حظيرة العبودية لله عز وجل.
وعندما بلغها نبأ استشهاد الأربعة قالت: الحمد لله الذي شرفني بقتلهم، وأرجو من ربي أن يجمعني بهم في مستقر رحمته.

<span data-type="title" id=toc-39>كيف حدثت المعجزة</span>؟
...
يُجيب القرآن عن هذا السؤال بقوله تعالى: {قَدْ جَاءَكُمْ مِنَ اللَّهِ نُورٌ وَكِتَابٌ مُبِينٌ (١٥) يَهْدِي بِهِ اللَّهُ مَنِ اتَّبَعَ رِضْوَانَهُ سُبُلَ السَّلَامِ وَيُخْرِجُهُمْ مِنَ الظُّلُمَاتِ إِلَى النُّورِ بِإِذْنِهِ وَيَهْدِيهِمْ إِلَى صِرَاطٍ مُسْتَقِيمٍ} [المائدة/١٥، ١٦].',NULL,'38',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (40,'فالقرآن إذن هو الدواء الذي تناوله هؤلاء فتغيروا هذا التغيير: {يَا أَيُّهَا النَّاسُ قَدْ جَاءَتْكُمْ مَوْعِظَةٌ مِنْ رَبِّكُمْ وَشِفَاءٌ لِمَا فِي الصُّدُورِ وَهُدًى وَرَحْمَةٌ لِلْمُؤْمِنِينَ} [يونس/٥٧].
...
وجواب الشرط هنا محذوف تقديره " لكان<span data-type="title" id=toc-41> هذا القرآن </span>".
<span data-type="title" id=toc-40>المربي:</span>
ومع القرآن وقدرته الفذة والعجيبة في التأثير والتغيير كان المربي العظيم صلى الله عليه وسلم هو الذي يشرف على عملية التغيير ويتابعها ويوجهها: {كِتَابٌ أَنْزَلْنَاهُ إِلَيْكَ لِتُخْرِجَ النَّاسَ مِنَ الظُّلُمَاتِ إِلَى النُّورِ بِإِذْنِ رَبِّهِمْ إِلَى صِرَاطِ الْعَزِيزِ الْحَمِيدِ} [إبراهيم/١].
...
لو تأملنا هذه الآية بدون اسم الإشارة (هذا) لوجدناها تؤدي نفس المعنى، ولكن وجود هذه الكلمة أعطى للرسالة التي تحملها هذه الآية آفاقا ودلالات جديدة منها:',NULL,'39',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (41,'إن " هذا " القرآن الذي بين يديك الآن وتقرأ فيه هذه الآية - أيها القارئ - له قدرة فذة وعظيمة على تغييرك، فإن كنت في شك من ذلك فانظر إلى جبل من الجبال القريبة منك وتأمل صلابتها وشموخها ثم تخيلها وقد انهارت وأصبحت حطاما وأنقاضا ...
كل هذا يمكن أن يحدث لو رُكِّب لهذا الجبل عقل كعقلك فيستقبل به القرآن، فكيف يمكنه أن يفعل بقلبك وهو ألين من هذا الجبل؟!

<span data-type="title" id=toc-42>طريق الاستقامة:</span>
إن القرآن هو القادر - بإذن الله - على تغييرنا وإعادة صياغتنا من جديد، ولم لا وهو يمكنه تغيير طبيعة الجبال الصلبة القاسية.
والقرآن كذلك هو الطريق للاستقامة الدائمة على أمر الله، كما قال الله تعالى: {إِنَّ هَذَا الْقُرْآَنَ يَهْدِي لِلَّتِي هِيَ أَقْوَمُ} [الإسراء/٩]، والملاحظ الآية تضمنت أيضا اسم الإشارة ... (هذا) فهذا القرآن الذي بين يديك يستطيع أن يقوِّم مسارك ويعدل سلوكك ليجعلك تستقيم على أمر الله وصراطه المستقيم: {إِنْ هُوَ إِلَّا ذِكْرٌ لِلْعَالَمِينَ. لِمَنْ شَاءَ مِنْكُمْ أَنْ يَسْتَقِيمَ} [التكوير/٢٧، ٢٨].

<span data-type="title" id=toc-43>مصنع التغيير:</span>
...
ما ذنبها، وما الجريمة التي ارتكبتها؟!',NULL,'40',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (42,'وتمضي الأيام، ويبزغ فجر الإسلام لينشرح صدر هذا الرجل للدين الجديد، فيدخل إلى مصنع التغيير القرآني، ويخرج منه رجلا آخر ... أتدرون من هو هذا الرجل؟! إنه عمر بن الخطاب رضي الله عنه.
فماذا تقول بعد ذلك عن قدرة القرآن على التغيير؟!

<span data-type="title" id=toc-44>القرآن وجمع الكلمة:</span>
...
الذي حدث أن هناك حبلا قد نزل من السماء فأمسكوا به جميعا فجذبهم من على الأرض وارتفع بهم إلى السماء فوق الشهوات والأهواء والطين .. هذا الحبل هو القرآن، الذي استطاع أن يجمع شمل الجميع كما قال تعالى: {وَاعْتَصِمُوا بِحَبْلِ اللَّهِ جَمِيعًا وَلَا تَفَرَّقُوا} [آل عمران/١٠٣]، وكما قال صلى الله عليه وسلم: " كتاب الله، هو حبل الله الممدود من السماء إلى الأرض " (١).
_________
(١) حديث صحيح: صححه الشيخ الألباني وقال في " السلسلة الصحيحة " ٥/ ٣٧: رواه الترمذي (٣٧٩٠) وأحمد (٣/ ١٤، ١٧، ٢٦، ٥٩) والطبري (ج ٧ رقم ٧٥٧٢ صفحة ٧٢).',NULL,'41',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (43,'فبالقرآن توحد المسلمون الأوائل على هدف واحد، وبه ارتفعوا إلى السماء وتخلصوا من جواب الأرض، ولقد أكد على هذا المعنى رسول الله صلى الله عليه وسلم بقوله: " أبشروا، فإن هذا القرآن طرفه بيد الله وطرفه بأيديكم، فتمسكوا به، فإنكم لن تهلكوا ولن تضلوا بعده أبدا" (١).
...
<span data-type="title" id=toc-45>حالنا مع القرآن:</span>
...
_________
(١) حديث صحيح: أخرجه ابن أبى شيبة (٦/ ١٢٥، رقم ٣٠٠٠٦)، والطبراني (٢٢/ ١٨٨، رقم ٤٩١)، وابن حبان (١/ ٣٢٩، رقم ١٢٢). قال الهيثمي (١/ ١٦٩): رجاله رجال الصحيح. وأخرجه أيضاً: عبد بن حميد (ص ١٧٥، رقم ٤٨٣)، وابن أبى عاصم في الآحاد والمثاني (٤/ ٢٨٢، رقم ٢٣٠٢)، ومحمد بن نصر المروزي (كما في مختصر قيام الليل للمقريزي ص ٢٩٣، رقم ٢٢١)، والبيهقي في شعب الإيمان (٢/ ٣٢٧، رقم ١٩٤٢)، وصححه الألباني في السلسلة الصحيحة (ج ٢ / ص ٣٣٠).',NULL,'42',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (44,'بلا شك أنهم سيقعون على الأرض ويتمرغون في أدناسها، ويتصارعون على ما فيها من دنايا .. وهذا ما حدث معنا عندما تركنا القرآن - حبل الله المتين - فوقعنا على الأرض، وتمرغنا في شهواتها، وأصبحت الدنيا هي أكبر همنا، ومبلغ علمنا، فاشتد الصراع بيننا وتفتت وحدتنا، وصار بأسنا بيننا شديدا، فتكالب علينا أعدائنا كما تتكالب الأكلة قصعتها، وأصبحنا أذل أهل الأرض .. تحت أقدام الكفار لا اعتبار لنا، ولا قيمة لوجودنا، بل إن اليهود الذين كتب الله عليهم الذلة والمسكنة باتوا يتفننون في إذلالنا، وهدم بيوتنا، وانتهاك حرماتنا: {أَوَلَمَّا أَصَابَتْكُمْ مُصِيبَةٌ قَدْ أَصَبْتُمْ مِثْلَيْهَا قُلْتُمْ أَنَّى هَذَا قُلْ هُوَ مِنْ عِنْدِ أَنْفُسِكُمْ} [آل عمران/١٦٥].

<span data-type="title" id=toc-46>ضرورة العودة إلى القرآن:</span>
...
بل نعني بالعودة: الدخول إلى دائرة تأثره، والتعرض الحقيقي لمعجزاته، وتشغيل مصنعه وماكيناته، ليتم من خلاله التغيير المنشود، فنكون من بعده عبيدا لله عز وجل: {يَا أَيُّهَا النَّاسُ قَدْ جَاءَكُمْ بُرْهَانٌ مِنْ رَبِّكُمْ وَأَنْزَلْنَا إِلَيْكُمْ نُورًا مُبِينًا. فَأَمَّا الَّذِينَ آَمَنُوا بِاللَّهِ وَاعْتَصَمُوا بِهِ فَسَيُدْخِلُهُمْ فِي رَحْمَةٍ مِنْهُ وَفَضْلٍ وَيَهْدِيهِمْ إِلَيْهِ صِرَاطًا مُسْتَقِيمًا} [النساء/١٧٤، ١٧٥].',NULL,'43',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (45,'<span data-type="title" id=toc-47>كيفية التغيير القرآني</span>
...
<span data-type="title" id=toc-48>ألا يكفي وصف الله لكتابه</span>؟!
نعم، نحن لسنا طالبين بمعرفة كيفية التغيير القرآني، فيكفي ما أخبرنا به الله عز وجل عن هذا الكتاب، ووصفه له بأنه نور يُخرج الناس من الظلمات على النور، ودواء لما يعانون منه من أدواء: {قُلْ هُوَ لِلَّذِينَ آَمَنُوا هُدًى وَشِفَاءٌ} [فصلت/٤٤].
...
<span data-type="title" id=toc-49>القرآن والعقل:</span>
في الصفحات السابقة استعرضنا معا الأسباب التي تحول بيننا وبين أن نكون عبيدا مخلصين لله عز وجل، والتي تنطلق من محاور ثلاثة: العقل، والقلب، والنفس. ومن ثَمَّ فإن التغيير الحقيقي في ذات الإنسان ينبغي أن يشمل هذه المحاور الثلاثة.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (46,'فإذا ما نظرنا إلى العقل وجدنا أن بداية التغيير الحقيقي فيه تأتي من خلال فكر الإنسان وقناعاته واهتماماته وتصوراته ... وهذا يشمل العقل المدرك، والعقل الباطن غير المدرك، بل إن التغيير في العقل الباطن هو الأهم باعتباره مصدرا للأفعال التلقائية والتي قد تتناقض مع قول المرء وما يدعو إليه. من هنا كان من الضروري استبدال الأفكار الخاطئة الراسخة في اللاشعور بأخرى صحيحة .. وهنا يأتي دور القرآن.
...
<span data-type="title" id=toc-50>تكوين العقلية المتوازنة:</span>
...
<span data-type="title" id=toc-51>بناء اليقين الصحيح:</span>
فإذا تم الاقتناع بكل القضايا التي يقوم عليها التصور الإسلامي للحياة والكون، وعالم الغيب والشهادة، تأتي السمة الأخرى للقرآن وهي قدرته الفريدة في ترسيخ هذه الأفكار والتصورات وبناء اليقين الصحيح عنها في العقل الباطن من خلال عرضها بأساليب مختلفة: {وَلَقَدْ صَرَّفْنَا فِي هَذَا الْقُرْآَنِ لِلنَّاسِ مِنْ كُلِّ مَثَلٍ} [الكهف/٥٤].',NULL,'46',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (48,'تأمل معي عرض القرآن لموضوع الجهاد في سبيل الله، أو الرزق، أو قيمة الدنيا وابحث عن عدد المرات التي تم فيها عرض هذه الموضوعات.
...
<span data-type="title" id=toc-52>القرآن والقلب:</span>
...
وكان من دعائه صلى الله عليه وسلم: " اللهم اقسم لنا من خشيتك ما يحول بيننا وبين معاصيك " (١)
...
_________
(١) حديث حسن: سنن الترمذي - (ج ٥ / ص ٥٢٨)، وقال: حديث حسن غريب، وقال الشيخ الألباني في " السلسلة الصحيحة ": حسن.',NULL,'47',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (49,'وإذا ما تأثرت المشاعر وتجاوبت مع أمر يخدم الهوى - كحال البعض عند ما يسمى بالأغاني العاطفية - فإن ذلك يؤدي إلى زيادة الهوى في القلب.
...
<span data-type="title" id=toc-53>القرآن والنفس:</span>
...
ومن وسائلها كذلك: تضخيم العمل في عين صاحبها بعد قيامه به، فتزين له العمل وأنه يستحق به الدرجات العلى عند ربه، وأنه قد أصبح مميزا عن أقرانه بهذا العمل!!',NULL,'48',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (50,'ومنها: أنها تُشعر صاحبها بأن إمكاناته ومواهبه ملك ذاتي له، متى استدعاها وجدها واستعان بها على ما يريد فعله، فتُصور له مثلا أن ذكاءه ذكاء ذاتي يستطيع أن يغلب به غيره وقتما شاء ... وتُصور له أنه سريع الحفظ، وأنه يمكنه متى شاء أن يحفظ أي كلام يريد حفظه في وقت قصير.
...
_________
(١) مصنف عبد الرزاق - (ج ١١ / ص ٤٥١)، وحياة الصحابة للكاندهلوي ١/ ٣، دار صادر، بيروت - لبنان.',NULL,'49',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (51,'<span data-type="title" id=toc-54>معرفة الله:</span>
...
من هنا تبرز أهمية معرفة الله عز وجل معرفة صحيحة وعميقة لتتغير معاملاتنا له وتتجه في الاتجاه الصحيح، فخشية الله - وهي صورة من صور المعاملة معه سبحانه - ثمرة من ثمرات العلم به: {إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ} [فاطر/٢٨].
إذن فلكي نخلص أعمالنا لله كصورة من صور تعاملنا معه، فإن هذا يستلزم منا معرفته - سبحانه وتعالى - وبخاصة في جوانب معينة .. منها:
التعرف على الله القوي، الجبار لتورث هذه المعرفة خوفا وخشية منه، تدفع لصدق التوجه إليه، كما قال تعالى: {وَيُطْعِمُونَ الطَّعَامَ عَلَى حُبِّهِ مِسْكِينًا وَيَتِيمًا وَأَسِيرًا (٨) إِنَّمَا نُطْعِمُكُمْ لِوَجْهِ اللَّهِ لَا نُرِيدُ مِنْكُمْ جَزَاءً وَلَا شُكُورًا} [الإنسان/٨، ٩]، ما الذي دفعهم لذلك: {إِنَّا نَخَافُ مِنْ رَبِّنَا يَوْمًا عَبُوسًا قَمْطَرِيرًا} [الإنسان/١٠].
...
معرفة الله الغني الحميد وأنه لا يحتاج إلى أعمالنا، وأن حجم ما نقوم به من طاعات لا يساوي شيئا بجوار تسبيح الكون المتواصل لله عز وجل .. فيؤدي ذلك إلى استصغار واستقلال أعمالنا، فنؤدي الطاعة ونستغفر الله بعدها كقوله تعالى: {ثُمَّ أَفِيضُوا مِنْ حَيْثُ أَفَاضَ النَّاسُ وَاسْتَغْفِرُوا اللَّهَ ... } [البقرة/١٩٩].',NULL,'50',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (52,'معرفة الله المنعم ومعرفة صور إنعامه علينا، وأننا مطالبون بشكر هذه النعم مما يؤدي إلى عدم رؤية العمل، واستشعار ان دخول الجنة هو محض فضل من الله عز وجل.
...
فعلى سبيل المثال: القرآن يُعرفك بربك المنتقم ويُعدد لك صور عقابه للمسيء، فإذا ما أُسقطت هذه المعرفة على واقع حياتك فستجد أن هناك عقوبات تُجرى عليك نظير إساءتك كوحشة في الصدر أو تعسير في الأمور، فيؤدي ذلك إلى مسارعتك بالاستغفار والتوبة لتوقف تلك العقوبات: {وَمَا كَانَ اللَّهُ مُعَذِّبَهُمْ وَهُمْ يَسْتَغْفِرُونَ ... } [الأنفال/٣٣].',NULL,'51',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (53,'<span data-type="title" id=toc-55>معرفة النفس:</span>
وكما أن القرآن يُعرف المرء بربه فيثمر ذلك معاملة صحيحة فإنه كذلك يُعرِّفه بنفسه فيتعامل معها بما ينبغي أن يكون.
ومن جوانب تلك المعرفة: التعرف على حقيقة الإنسان وأصله: {أَلَمْ نَخْلُقْكُمْ مِنْ مَاءٍ مَهِينٍ} [المرسلات/٢٠]، وأنه ضعيف عاجز: {وَخُلِقَ الْإِنْسَانُ ضَعِيفًا} [النساء/٢٨] .. لا يملك لنفسه نفعا ولا ضرا: {قُلْ لَا أَمْلِكُ لِنَفْسِي نَفْعًا وَلَا ضَرًّا إِلَّا مَا شَاءَ اللَّهُ} [الأعراف/١٨٨].
يحتاج إلى مولاه مع كل طرفة عين ملايين ملايين المرات ..
ومع تعريف القرآن للمرء بهذه الحقائق، فإنه يُعرفه كذلك طبيعة نفسه، وحبها للشهوات، وميلها للفجور، وأنها لو تُركت لما أمرت بخير: {إِنَّ النَّفْسَ لَأَمَّارَةٌ بِالسُّوءِ} [يوسف/٥٣] .. كل ذلك ليشتد حذر الإنسان منها، فلا يركن إليها ولا يرضى أو يفرح بها، بل يفرح بفضل ربه ويركن إليه وحده: {قُلْ بِفَضْلِ اللَّهِ وَبِرَحْمَتِهِ فَبِذَلِكَ فَلْيَفْرَحُوا هُوَ خَيْرٌ مِمَّا يَجْمَعُونَ} [يونس/٥٨].

<span data-type="title" id=toc-56>الخلاصة:</span>
...
٢ - بتغير الأفكار والتصورات تتغير الاهتمامات تبعا لذلك، ليصبح هم الفرد وأحلامه وتطلعاته فيما يُرضي الله عز وجل.
٣ - نتيجة لتغيير الاهتمامات تتغير طريقة تعامل الشخص مع كل من حوله، فتصغر الدينا في عينه فلا تراه يتنافس مع المتنافسين في أمورها .. يُربي أولاده على حب الله والتعلق به .. يتعامل مع زوجته وأهله من منطلق إيماني يسعى فيه لرضا الله عز وجل.',NULL,'52',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (54,'٤ - ومن صور التغيير القرآني أنه يُشعر صاحبه بقيمته في الكون، وأنه قائد له، فينطلق فيه فاتحا مستكشفا لأسراره، منتفعا بتسخير قوانين تسخيره له.
...
١٠ - والقرآن كذلك يعرفنا بحجم أنفسنا، وقيمتها، وخطورتها، فتصغر في أعيننا وتتحطم أصنامنا ليجد العمل الصالح بعد ذلك طريقه إلى الله عز وجل يزينه الصدق والإخلاص.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (55,'فهذه وغيرها صور التغيير الذي يُحدثه القرآن في الشخص الذي يدخل إلى ماكيناته ويُسلم له قياده ليخرج بعد ذلك من مصنعه شخصا آخر قد ارتدى رداء العبودية لله، وبدأ في ممارسة الوظيفة التي نزل على الأرض من اجل القيام بها، قال تعالى: {إِنْ هُوَ إِلَّا ذِكْرٌ لِلْعَالَمِينَ (٢٧) لِمَنْ شَاءَ مِنْكُمْ أَنْ يَسْتَقِيمَ} [التكوير/٢٧، ٢٨].

<span data-type="title" id=toc-57>كيف ننتفع بالقرآن</span>؟
...
(٢) حديث ضعيف: أخرجه الترمذي (٥/ ١٧٢، رقم ٢٩٠٦)، وقال: إسناده مجهول. والبيهقي في شعب الإيمان (٢/ ٣٢٦، رقم ١٩٣٥)، وضعفه الشيخ الألباني في السلسلة الضعيفة (ج ٢٤ / ص ٨٨٣ برقم ٦٣٩٣).',NULL,'54',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (56,'<span data-type="title" id=toc-58>مشروع النهضة:</span>
...
فلابد - إذن - أن نعود جميعا إلى القرآن، فالعودة إليه تُمثل طوق النجاة، ومشروع النهضة للأمة جمعاء، ولم لا وقد جعله الله عز وجل ميسرا للذكر فيسع بذلك جميع أفراد أمتنا الإسلامية برجالها ونسائها .. بشبابها وشيوخها .. بعربها وعجمها (١).

<span data-type="title" id=toc-59>وسائل مقترحة:</span>
...
<span data-type="title" id=toc-60>أولا: الانشغال بالقرآن والتجرد له</span>.
...
ألا تستحق السعادة التي سنجني ثمارها في نفوسنا وبيوتنا وأمتنا هذا الانشغال؟',NULL,'56',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (58,'<span data-type="title" id=toc-61>وصية أبي الدرداء:</span>
...
<span data-type="title" id=toc-62>دفع شبهة:</span>
...
بهذا المفهوم لن يكون هناك تعارض بين القرآن وبين كتابات العلماء، مع الوضع في الاعتبار أن جُلّ وقتنا ينبغي أن يكون للقرآن لنسمح له ونمكنه من إجراء التغيير المنشود داخلنا.',NULL,'57',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (59,'ولقد كان الصحابة شديدي الحرص على تبليغ هذه الوصية لمن بعدهم، فعندما جاء اثنان من التابعين لعبد الله بن مسعود رضي الله عنه بصحيفة فيها كلام حسن ويريدان منه الإطلاع عليه، فما كان منه إلا أن نادى على الخادم ليُحضر الطست، ثم سكب عليها الماء وجعل يمحوها بيده ويقول: {نَحْنُ نَقُصُّ عَلَيْكَ أَحْسَنَ الْقَصَصِ} [يوسف/٣]، فقالوا له: أنظر فيها، فإن فيها حديثا عجبا، فجعل يمحوها ويقول: عن هذه القلوب أوعية فاشغلوها بالقرآن، ولا تشغلوها بغيره.
وهذا هو المطلوب: أن لا نشغل القلوب بشيء غير القرآن وبخاصة في البداية.
:

ومع الانشغال ا<span data-type="title" id=toc-63>ثانيا: التهيئة الذهنية والقلبية</span>ليومي بالقرآن ينبغي أن نهيئ الجو المناسب لاستقباله ولقائه، فلا يصح أن نلتقي به في مكان تملؤه الشواغل والضوضاء مما يشوش على الذهن ولا يجمع القلب مع القراءة ...
...
هذا من ناحية التهيئة الذهنية والنفسية، أما من ناحية التهيئة القلبية، فكلما كانت المشاعر في حالة من الاستثارة والخشية، كان تأثر القلب بالقرآن أقوى كما قال تعالى: {سَيَذَّكَّرُ مَنْ يَخْشَى} [الأعلى/١٠].',NULL,'58',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (60,'وفي قصة إسلام عمر بن الخطاب رضي الله عنه ما يؤكد هذا المعنى، فعندما ضرب أخته فاطمة وسال الدم على وجهها، رق قلبه واستُثيرت مشاعره، فلما استمع إلى القرآن وهو بهذه الحالة الشعورية انجذب القلب له ودخل نوره إليه بإذن الله.
...
<span data-type="title" id=toc-64>ثالثا: سلامة النطق والقراءة الهادئة:</span>
...
ولقد سئل الإمام مجاهد عن رجل قرأ البقرة وآل عمران، ورجل قرأ البقرة، قراءتهما واحدة، وركوعهما وسجودهما وجلوسهما، أيهما أفضل؟ قال: الذي قرأ البقرة، ثم قرأ: {وَقُرْآَنًا فَرَقْنَاهُ لِتَقْرَأَهُ عَلَى النَّاسِ عَلَى مُكْثٍ} [الإسراء/١٠٦].',NULL,'60',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (62,'<span data-type="title" id=toc-65>رابعا: التركيز في القراءة وعدم السرحان:</span>
...
<span data-type="title" id=toc-66>لماذا يُقرأ القرآن بدون فهم</span>؟
...
إذن فبداية الدخول إلى عالم القرآن ودائرة تأثيره تنطلق من ضرورة فهم ما نقرأ من آيات، وهذا بلا شك يستدعي منا التركيز عند القراءة وعدم السرحان: {وَإِذَا قُرِئَ الْقُرْآَنُ فَاسْتَمِعُوا لَهُ وَأَنْصِتُوا لَعَلَّكُمْ تُرْحَمُونَ} [الأعراف/٢٠٤].',NULL,'61',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (63,'ولأن الهدى والسعادة والتغيير وسائر الثمار المترتبة على الدخول لعالم القرآن تستلزم هذه النقطة فإن الشيطان سيعمل جاهدا على صرف الذهن إلى أمور أخرى ليُبعدنا عن فهم القرآن، فعلينا ألا يتسرب إلينا الشعور باليأس أو الإحباط لدينا كلما شرد الذهن في أمور الدنيا بل نثابر ونثابر ونستعين بالله، ونستعيذ به من الشيطان حتى نتعود على التركيز مع القراءة .. أما الآيات التي شرد الذهن فيها فعلينا إعادتها مرة أخرى كما نفعل عند القراءة في أي كتاب آخر.

<span data-type="title" id=toc-67>خامسا: التجاوب مع القراءة:</span>
...
يقول ابن مسعود رضي الله عنه: عن للقرآن منار كمنار الطريق، فما عرفتم منه فتمسكوا به، وما يشبه عليكم - أو قال: شُبّه عليكم - فكلوه إلى عالمه.',NULL,'63',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (65,'<span data-type="title" id=toc-69>متى نرجع للتفسير</span>؟
...
<span data-type="title" id=toc-70>سابعا: ترديد الآية التي تؤثر في القلب:</span>
...
علينا أن نستثمر الفرصة التي جاءتنا أحسن استثمار، فهذه اللحظات من أهم لحظات حياتنا .. مواسمنا وأعيادنا، ولم لا وأوقات حياة القلب هي أوقت الحياة الحقيقية، وبها يُقاس عمر الإنسان الفعلي.',NULL,'64',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (66,'فإن كان الأمر كذلك فلنعمل على دخول أكبر قدر من النور إلى القلب، من خلال ترديد تلك الآية مرات ومرات طالما وُجد التجاوب، ولقد كان هذا هو هدي رسول الله صلى الله عليه وسلم وصحابته الكرام.
لو علم الناس!!
...
وقد ثبت عن النبي صلى الله عليه وسلم أنه قام بآية يرددها حتى الصباح، وهو قوله: {إِنْ تُعَذِّبْهُمْ فَإِنَّهُمْ عِبَادُكَ وَإِنْ تَغْفِرْ لَهُمْ فَإِنَّكَ أَنْتَ الْعَزِيزُ الْحَكِيمُ} [المائدة/١١٨].
...
فإذا ما واظبنا على ذلك فستزداد بمرور الوقت عدد الآيات التي تؤثر في القلب مع كل تلاوة أو سماع للقرآن، فيزداد بذلك الإيمان أكثر وأكثر، ويتنور لقلب حتى تدب الحياة في جميع جنباته ليصبح قلبا حيا سليما خاشعا لربه خاضعا له.',NULL,'65',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (67,'ومما يساعد على زيادة الخشوع في القلب واستسلامه لله: حُسن التعبير عن المعاني التي تتولد داخلنا عند تأثرنا بالآيات، وذلك من خلال البكاء والدعاء ومناجاة الله عز وجل: {إِنَّ الَّذِينَ أُوتُوا الْعِلْمَ مِنْ قَبْلِهِ إِذَا يُتْلَى عَلَيْهِمْ يَخِرُّونَ لِلْأَذْقَانِ سُجَّدًا (١٠٧) وَيَقُولُونَ سُبْحَانَ رَبِّنَا إِنْ كَانَ وَعْدُ رَبِّنَا لَمَفْعُولًا (١٠٨) وَيَخِرُّونَ لِلْأَذْقَانِ يَبْكُونَ وَيَزِيدُهُمْ خُشُوعً} [الإسراء/١٠٧ - ١٠٩].
...
<span data-type="title" id=toc-71>ثامنا: تعلم الآيات والعمل بها:</span>
...
ومع هذا كله كانت الوسيلة الثامنة التي إن استخدمناها حَسُن انتفاعنا بالقرآن، ألا وهي تعلم الآيات وحفظها والعمل بها، وذلك بالتوازي مع الوسائل السابقة.',NULL,'66',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (68,'فكما أننا نُخصص وقتا يوميا لتلاوة القرآن، علينا كذلك أن نخصص وقتا آخر بين الحين والحين، ولو مرة كل أسبوع، نتعلم فيه بضع آيات من القرآن ثم نجتهد في حفظها، والعمل بما دلت عليه من خُلق وسلوك، أو ما اشتملت عليه من أوامر ونواه، ولا ننتقل إلى غيرها إلا بعد التأكد من ممارسة العمل بما في تلك الآيات .. وهذا ما كان يفعله الصحابة رضوان الله عليهم.
...
<span data-type="title" id=toc-75>ثانيا: ضبط الفهم الصحيح عند الأفراد لمراتب الأحكام وفقه الأولويات مع النظرة الشاملة للإسلام:</span>
تأمل معي قوله صلى الله عليه وسلم وهو يوصي معاذ بن جبل رضي الله عنه لما أرسله داعيا على اليمن: " إنك تأتي قوما أهل كتاب فليكن أول ما تدعوهم إليه أن يوحدوا الله، فإن هم أطاعوك لذلك فأخبرهم أن عليهم خمس صلوات في يومهم وليلتهم، فإن هم أطاعوك لذلك فأخبرهم أن الله قد فرض عليهم صدقة في أموالهم، تؤخذ من أغنيائهم وترد على فقرائهم ".',NULL,'69',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (71,'فقه الأولويات والموازنات من أهم الأمور التي ينبغي أن يُعلمها المُربي لمن معه .. فكثيرا ما سيجد الفرد نفسه أما مصلحتين متعارضتين إن قام بواحدة فاتت الأخرى، فماذا يُقدم وماذا يؤخر؟! .. هنا يأتي دور المربي الذي يُحسن توجيه من معه للتعامل الصحيح في مثل هذه المواقف، فعلى سبيل المثال: عند التعارض بين السعي في خدمة الناس مع عبادة مثل الاعتكاف .. أيهما نُقدم؟
...
<span data-type="title" id=toc-76>ثالثا: حُسن توجيه الطاقات المتولدة لدى الأفراد نتيجة تعاملهم مع القرآن ومنابع الإيمان</span>، وذلك بفتح مجالات العمل أمامهم، وتنظيم حركتهم بين الناس:
...
_________
(١) البخاري (٥/ ٢٢٤٠، رقم ٥٦٧٣)، ومسلم (١/ ٦٩، رقم ٤٨)',NULL,'70',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (72,'<span data-type="title" id=toc-77>رابعًا: شحذ همم الأفراد:</span>
...
<span data-type="title" id=toc-78>خامسًا: المحافظة على الأفراد:</span>
...
<span data-type="title" id=toc-79>سادسًا: التذكير الدائم بحقيقة الدنيا:</span>
...
_________
(١) رواه مسلم.',NULL,'72',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (74,'وعندما أُتي لرسول الله صلى الله عليه وسلم بمثل بيضة من الدجاج من ذهب من بعض المغازي، فقال صلى الله عليه وسلم: " ما فعل الفارس المكاتب؟ " قال: فدعيت له، فقال: " خذ هذه فأد بها ما عليك يا سلمان ".

<span data-type="title" id=toc-81>مفهوم المتابعة:</span>
...
<span data-type="title" id=toc-82>الإيمان هو الضامن:</span>
...
والناظر إلى سيرة رسول الله صلى الله عليه وسلم وطريقة تربيته لأصحابه يجد أنه كان يوجههم لأعمال الخير ثم يتركهم لإيمانهم، فيدفعهم هذا الإيمان للقيام بهذه الأعمال والاستمرار عليها، فعندما بلغ عبد الله بن عمر قوله صلى الله عليه وسلم في شأنه: " نعم الرجل عبد الله لو كان يصلي بالليل " قال سالم: فكان عبد الله بعد ذلك اليوم لا ينام من الليل إلا قليلا.',NULL,'73',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (75,'وعندما قال صلى الله عليه وسلم لعلي وفاطمة رضي الله عنهما: " ألا أدلكما على ما هو خير لكما من خادم، إذا أويتما إلى فراشكما فسبحا ثلاثا وثلاثين واحمدا ثلاثا وثلاثين وكبرا أربعا وثلاثين " قال علي: فما تركتهن منذ سمعتهن من رسول الله صلى الله عليه وسلم، فقيل له: ولا ليلة صفين؟ قال: ولا ليلة صفين.
...
<span data-type="title" id=toc-84>أي النماذج أصح</span>؟
...
وبالنسبة لتلاميذ المدرس الثاني فنتائجهم غير مضمونة واحتمالية وقوعهم في أخطاء كبيرة، فلقد تركهم مدرسهم يجتهدون بمفردهم دون أن يعمل على تقويم مسارهم.',NULL,'75',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (77,'أما تلاميذ المدرس الثالث فقد نجحوا في تقديم أبحاث قسمة مع اكتسابهم خبرة كيفية البحث بمفردهم والوصول إلى معلومة ووضعها في مكانها الصحيح .. كل ذلك حدث لأن مدرسهم تركهم يقومون بأداء العمل بمفردهم مع متابعتهم كل فترة وتقييمه لأعمالهم، وتوجيههم لكيفية تصويبها وتقويمها.
...
من هنا يتضح لنا أن المربي الناجح هو الذي يدل الناس على الله ويدعوهم إلى الدخول لمأدبة القرآن، ويأخذ بأيديهم إليها، ويتركهم أمامها ليذوقوا حلاوتها بأنفسهم.',NULL,'77',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (79,'فالمربي إذن دلال يدل من حوله على منابع الإيمان وعلى ما تذوَّقه من القرآن، ففيوضات القرآن لا حدود لها، وتسع جميع الخلق. بل إن من علامة صدق المربي: انطلاق الأفراد في التعامل مع القرآن وتعرفهم على أشياء لم يعرفها ولم يسبق له هو معرفتها.
...
أما إذا أفسح لهم الطريق وأخذ بأيديهم حتى يجدوا أنفسهم وجها لوجه مع القرآن ينهلون من نبعه، ويتمتعون بحلاوته، ويدخلون إلى دائرة تأثيره .. كل ذلك يحدث لهم، وهو بينهم يوجه الطاقات، ويضبط الفهم ويشحذ الهمم .. فإنه عن فعل ذلك فقد قام بمهمته خير قيام، وأنتج للأمة نواة الجيل القرآني الذي انتظرته طويلا، فتجتمع حوله، وتسير وراءه تحرر الأوطان، وتعيد الخلافة وتسود العالم، وما ذلك على الله بعزيز: {وَلَقَدْ كَتَبْنَا فِي الزَّبُورِ مِنْ بَعْدِ الذِّكْرِ أَنَّ الْأَرْضَ يَرِثُهَا عِبَادِيَ الصَّالِحُونَ (١٠٥) إِنَّ فِي هَذَا لَبَلَاغًا لِقَوْمٍ عَابِدِينَ} [الأنبياء/١٠٥، ١٠٦].',NULL,'78',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (80,'<span data-type="title" id=toc-85>الأيمان أولا:</span>
...
أما اكتساب المهارات التي يحتاج إليها الفرد، كتعلم مهارة فن الإلقاء، أو إتقان مهارة إدارية، أو تعلم لغة من اللغات فإنها بالفعل تتطلب تدريبا وتربية عليها حتى يتم اكتسابها مع الأخذ في الاعتبار أن الإيمان يدفع صاحبه لبذل المزيد من الجهد الذي يختصر فترة التدريب، وكذلك يصحح النية لذلك ويجعلها خالصة لله عز وجل.',NULL,'80',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (82,'<span data-type="title" id=toc-86>المحاضن التربوية</span>
...
<span data-type="title" id=toc-87>وظيفة المحاضن:</span>
إذن فالمحاضن التربوية يمكن أن تقوم بدور المربي، مع الأخذ في الاعتبار أنه مع وجود القرآن كمحور أساسي لها، فإن المطلوب منها كذلك أن تقوم بضبط الفهم وحُسن توجيه طاقات الأفراد المتولدة من معايشة القرآن للقيام بأعمال البر المختلفة في شتى المجالات مع مراعاة ظروف الفرد وإمكاناته.',NULL,'81',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (83,'وفي المحاضن التربوية يتم تدارس بعض كتب العلم النافع التي تعين الفرد على تعميق فهمه للقرآن، وتضبط له عملية التغيير على أن يتم ربط هذه الكتب بالقرآن قدر المستطاع، وألا تطغى عليه ... فالقرآن أولا، أما تلك الكتب فما هي إلا مراجع بجواره نستخدمها من أجل أن تخدمه وتخدم عملية التغيير، فالسيرة النبوية على سبيل المثال تُدرس كنموذج تطبيقي للآيات .. والسنة تُدرس كشارحة للقرآن مبينة لما أُجمل فيه ... وهكذا.
هذا الشكل المقترح للمحاضن التربوية والتي يمكن أن تتم في البيت بين الأب وأبنائه، أو بين الأصدقاء بعضهم مع بعض، لها امتداد عبر تاريخ الأمة، فقد بدأها رسول الله صلى الله عليه وسلم في مكة، في دار الأرقم بن أبي الأرقم، وكان القرآن هو المنهج الذي يتدارسونه ويعيشون معه، أما توجيهاته صلى الله عليه وسلم فكانت بمثابة الشرح والبيان لآيات القرآن، مع ضبط الفهم، وتنظيم حركة الأفراد، وكيف يتعاملون مع مستجدات الحياة.',NULL,'82',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (84,'<span data-type="title" id=toc-88>الدعوة إلى القرآن:</span>
...
<span data-type="title" id=toc-89>هيا إلى العمل</span>
إن كان القرآن هو مشروع الأمة الإسلامية القومي للنهضة، وهو السبيل لعودة مجدها وعزها، فلبد أن ينتفض كل غيور ويبدأ بنفسه ويعود إلى القرآن، ويُقبل عليه بكيانه كله، حتى إذا ذاق حلاوته، وازداد تحرك قلبه مع آياته، وشعر بنوره يسري في كيانه، وأصبح لا يستطيع الاستغناء عنه، فهو بذلك قد وضع قدمه في بداية الطريق فعليه حينئذ أن يتحرك بهذه الدعوة - دعوة العودة إلى القرآن - في كل مكان، ومع كل من يعرفه ... مع أبيه وأمه، وزوجته وأولاده، وأقاربه وجيرانه، ومعارفه وزملائه.',NULL,'83',NULL,NULL,'0');
INSERT INTO [b37342] VALUES (85,'<span data-type="title" id=toc-90>عودة الروح:</span>
