...
CREATE TABLE "b37724"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b37724
INSERT INTO [b37724] VALUES (1,'<span data-type="title" id=toc-1>شرح لمعة الاعتقاد [١]</span>
لمعة الاعتقاد من أحسن متون العقيدة السلفية وأشملها، وقد ضمنها الموفق ابن قدامة رحمه الله كثيراً من القواعد الشرعية والأصول الدينية التي تفيد المسلم في معرفة طريقة السلف في التعامل مع النصوص المتعلقة بأسماء الله تعالى وصفاته.','1','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (2,'<span data-type="title" id=toc-2>كيفية طلب العلم</span>
...
والشيخ رحمه الله له مصنفات عظيمة نفع الله بها الأمة إلى يومنا هذا وإلى أن تقوم الساعة، ومن أعظمها هذا الكتاب، وله كتب في الفقه ومن أشهرها وأعظمها كتاب المغني وهو مغن كاسمه، فهو موسوعة فقهية كبيرة وليس مجرد شرح، وهو صاحب روضة الناظر الكتاب المشهور في أصول الفقه الحنبلي.','1','3',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (4,'<span data-type="title" id=toc-4>قواعد في الأسماء والصفات</span>
...
قوله: (لا تمثله)، بمعنى أنها لا يمكن أن تحيط به ولا بمثله؛ لأن الله عز وجل ليس كمثله شيء.','1','4',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (5,'<span data-type="title" id=toc-5>قاعدة الإثبات والنفي في الأسماء والصفات</span>
قال المصنف رحمه الله تعالى: [ولا تتوهمه القلوب بالتصوير، ليس كمثله شيء، وهو السميع البصير].
هنا ذكر الشيخ قاعدة ولعلنا نجعلها القاعدة الأولى؛ لأننا بإذن الله سنضبط أكثر القواعد التي أشار إليها الشيخ، بعضها ستأتي على شكل إشارات وبرقيات سريعة؛ لأن الإمام كان يكتب في وقته للناس وكانوا في استيعابهم للعقيدة أكثر من استيعاب المعاصرين، ونحتاج الآن في هذا العصر الذي كثر فيه تشقيق العلم وتفصيله إلى أن نيسر الانتفاع بهذه القواعد، ففي قوله: [ليس كمثله شيء وهو السميع البصير] إشارة إلى القاعدة التي قررها الله عز وجل في كتابه الكريم، وهي قاعدة في أسماء الله وصفاته كلها، وهي قاعدة الإثبات والنفي، وهنا بدأ بالنفي {لَيْسَ كَمِثْلِهِ شَيْءٌ} [الشورى:١١] لدفع توهم المشابهة قبل تقرير الإثبات، وهذا نهج تفرد به أهل السنة والجماعة والسلف عن بقية الفرق التي هلكت، بمعنى أنهم يقررون نفي المماثلة والمشابهة لئلا ينصرف الذهن عند سماع صفات الله وأسمائه وأفعاله إلى التشبيه والتمثيل، فإذا استقر في ذهن المسلم أن الله ليس كمثله شيء ثم سمع قوله عز وجل: {وَهُوَ السَّمِيعُ البَصِيرُ} [الشورى:١١] اندفع التشبيه واندفع التمثيل وتوهم ذلك.
...
وقوله: {وَهُوَ السَّمِيعُ البَصِيرُ} [الشورى:١١] فيها إثبات، وهذه القاعدة الأساسية التي ينبني عليها توحيد الأسماء والصفات.','1','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (6,'<span data-type="title" id=toc-6>لله الأسماء الحسنى والصفات العلى</span>
...
ويتبين هذا فيما جاء في حديث الشفاعة العظمى أنه صلى الله عليه وسلم يسأل ربه بمحامد يلهمه الله إياها كان لا يعرفها في الدنيا.','1','7',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (8,'<span data-type="title" id=toc-8>الإيمان بكل ما صح عن المصطفى عليه السلام من صفات الرحمن</span>
...
إذاً: ما جاء في القرآن وصح عن المصطفى صلى الله عليه وسلم من أسماء الله وصفاته وأفعاله وذاته فلا بد من الوقوف عنده إيماناً وتسليماً وقبولاً، ثم يترتب على ذلك ما سيقوله الشيخ رحمه الله.','1','8',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (9,'<span data-type="title" id=toc-9>التسليم والقبول لما ورد من الأسماء والصفات وعدم التأويل والرد لها</span>
قال المصنف رحمه الله تعالى: [وتلقيه بالتسليم والقبول، وترك التعرض له بالرد والتأويل والتشبيه والتمثيل].
وهذه قاعدة خامسة ترك التعرض له بالرد والتأويل والتشبيه والتمثيل، وقصده بذلك أن ما ورد من أسماء الله وصفاته يمر كما جاء مع الإيمان بأنه حق على حقيقته كما يليق بجلال الله عز وجل، ولا يُتعرض لألفاظ أسماء الله وصفاته وأفعاله، لا بتشكيك ولا باعتراض ولا بسؤال تعنّت ولا بسؤال عن الكيفية، ولا برد للفظ ولا للفظ والمعنى، ولا للمعنى، الرد يشمل اللفظ، ويشمل المعنى، ويشمل المعنى واللفظ جميعاً فإن من رد اللفظ وآمن بالمعنى فقد اختل تسليمه كما يفعل المؤولة والأشاعرة الماتريدية، فمثلاً إذا جاء قوله: {يَدُ اللَّهِ} [الفتح:١٠] قالوا: المقصود به النعمة، إذاً فقد نفوا كلمة (يد) فهم يردون اللفظ ويثبتون المعنى وهذا خلل، والعكس عند المفوضة إذ يقولون: نؤمن بأن هذا اللفظ قاله الله عز وجل لكن لا نعرف أن له معنى ولا له حقيقة، وهذا تفويض بمعنى التعطيل، وقد قال السلف بأنه كفر، والأول ضلالة وخطأ، أي التسليم بالمعنى دون اللفظ.
...
اللفظ وحقيقته ومعناه لا بد من الإيمان بهما على ما يليق بجلال الله عز وجل مع استحضار القاعدة الأصلية وهي أن الله عز وجل ليس كمثله شيء سبحانه فقوله: (وجب إثباته لفظاً) أي: إقرار أن لفظه مقصود، وأن له معنى وحقيقة، لا كما يقول المؤولة بأن اللفظ غير مراد إنما هو من باب تقريب المعنى إلى الأذهان! فهذا غير صحيح؛ لأن الله عز وجل له الكمال المطلق، ويستطيع أن يعبّر لنا بتعبير لا يكون فيه هذا الإشكال الذي يرد ويوقع الناس في الحرج، ويوقعهم في تأويلات لا تنتهي، ويخرجون عن العقيدة السليمة إلى عقائد لا نهاية لها كما فعل المؤولة.','1','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (11,'<span data-type="title" id=toc-11>معنى قول المصنف: (وترك التعرض لمعناه)</span>
...
إذاً إمام المؤولة رجع عن التأويل وأوصى كل من جاء بعده بأن يتركوه، ثم جاء بعده من الأئمة كـ الشهرستاني','1','12',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (13,'<span data-type="title" id=toc-13>قاعدة الإيمان بالسمعيات والتصديق بها</span>
...
هذه القاعدة السابعة، وهي: أن الله عز وجل لا يوصف بأكثر مما وصف به نفسه ووصفه به رسوله صلى الله عليه وسلم، بمعنى: لا يأتينا متحذلق بألفاظ جديدة ويقول: هذه كمالات وأنا أثبت لله الكمالات، نعم الكمال يثبت لله لكن يرد إلى ألفاظ الشرع، ولنأخذ على هذا مثالاً: بعض المتكلمين زعموا أن من أسماء الله عز وجل الموجود، وزعموا أن من أسماء الله القديم، ونحن نقول: إن الله عز وجل موجود، لكن يُغنى عنها قوله عز وجل: {الْحَيُّ الْقَيُّومُ} [البقرة:٢٥٥] فلا داعي لكلمة موجود لأنها لم ترد في ألفاظ الشرع.
كذلك القديم، والقديم ورد ما يغني عنها وزيادة وهو قوله عز وجل: {هُوَ الأَوَّلُ} [الحديد:٣]، وشرحها النبي صلى الله عليه وسلم وفسّرها في حديث صحيح بمعنى الأول الذي ليس قبله شيء، فالأول تغني عن قديم؛ لأن كلمة قديم فيها معنى سلبي، فأحياناً يُطلق في لغة العرب على الشيء المتهالك المستخدم الذي تنتهي مدته، فلا يليق هذا.
فكلمة (القديم) إن كانت بمعنى شرح اللفظ فلا مانع، أما بمعنى إثبات الاسم فلا يجوز، والسلف الذين أطلقوها قصدهم شرح معنى قول الله عز وجل: {هُوَ الأَوَّلُ} [الحديد:٣] فيقال: إذا قال إنسان: ما معنى الأول؟ نقول: هو القديم الذي ليس قبله شيء في معنى شرح لمعنى الأول، لكن لا نثبتها مستقلة.
...
وصلى الله وسلم وبارك على نبينا محمد، وآله، وصحبه أجمعين.','1','15',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (16,'<span data-type="title" id=toc-16>الأسئلة</span>','1','16',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (17,'<span data-type="title" id=toc-17>المقصود من قول المؤلف: (بلا حد ولا غاية)</span>
...
ويقال للنافي: وأنت إن نفيت هذه الأمور على أساس أنها حد وغاية فأنت ظالم ومبتدع وزائغ، فمن نفى الاستواء على أنه حد، ومن نفى الفوقية على أنها حد أو جهة أو غاية، ومن نفى كون الله عز وجل في السماء بمعنى أنه في العلو، ومن نفى أن الله يُرى يوم القيامة بدعوى أن هذه حدود وغايات، فهو مبطل ولا نوافق على كلامه هذا معنى قول الشارح (بلا حد وغاية)، بمعنى أن الله عز وجل ليس كالمخلوقات التي تحدها الحدود ولها نهايات كالنهايات التي ترى وتبصر وتلمس.','1','17',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (18,'<span data-type="title" id=toc-18>أفضل شروح لمعة الاعتقاد</span>

<span data-type="title">السؤال</span>
  ما هي أفضل الشروح على هذا المتن المبارك؟

<span data-type="title">الجواب</span>
  الشروح الميسورة الآن والمتبادلة في أيدي الناس أفضلها من حيث العنصرة والتبويب والترتيب، ومعالجة الكثير من القضايا التي يحتاجها طلاب العلم اليوم شرح فضيلة الشيخ محمد بن صالح العثيمين، وهو بحمد الله متوفر.','1','18',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (19,'<span data-type="title" id=toc-19>معنى قول الإمام أحمد: (لا كيف ولا معنى)</span>

<span data-type="title">السؤال</span>
  ما معنى قول الإمام أحمد رحمه الله: (لا كيف ولا معنى)؟

<span data-type="title">الجواب</span>
  يقصد أن أسماء الله وصفاته مثل النزول والاستواء وكون الله يُرى نؤمن بها بدون أن نعتقد الكيفية، والكيفية هي أن نتصور شيئاً ونعتقد أنه هو الحقيقة اللائقة أو التي عليها صفات الله عز وجل فالمقصود بلا كيف من حيث الاعتقاد ولا من حيث التصور ولا من حيث السؤال، فلا نقول: كيف ينزل؟ ولا نتحكم بعقولنا في تصوير الكيفية التي ينزل بها الله عز وجل، ولا نثير الإشكال في الكيفية ونطمح إلى معرفة تفاصيلها.','1','19',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (20,'<span data-type="title" id=toc-20>القول الفصل في متقدمي الأشاعرة ومتأخريهم</span>
...
إذً المعنيان اللذان يريدهما الشافعي وهما الكيفية أو معنى إثبات الحقيقة هو ظاهر كلامه، أما المعنى التفويضي الذي هو بمعنى إنكار المعنى، أو عدم الإقرار به، أو التنصل منه كما يفعل المفوضة فهذا لا يليق أن يكون من الشافعي، ثم لو كان منه لا يمكن أن يتركه الأئمة بدون تنبيه.','1','21',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (22,'<span data-type="title" id=toc-22>معنى قول ابن قدامة: (الذي لا يخلو من علمه مكان)</span>
...
فرداً لهذه المقولة التي يزعم أصحابها أنه قد يحدث العباد أفعال الشر دون علم الله ولا تقديره، أراد أن ينفي هذه المقولة بمثل هذا القول أن الله علمه في كل مكان وفي كل زمان {أَحَاطَ بِكُلِّ شَيْءٍ عِلْمًا} [الطلاق:١٢] وأن الله عز وجل علم كل ما يكون، كيف يكون، ومتى يكون، وما هو كائن كذلك.','1','22',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (23,'<span data-type="title" id=toc-23>التفريق بين الفرق الزائغة ومراتبها</span>
...
وصلى الله وسلم وبارك على نبينا محمد، وعلى آله، وصحبه أجمعين.','1','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (24,'<span data-type="title" id=toc-24>شرح لمعة الاعتقاد [٢]</span>
طلب العلم ضرورة ملحة في حق الشباب المسلم؛ حتى يتمكن من خدمة أمته ونفع نفسه ومجتمعه، وطلب العلم له أصول وضوابط وآداب، يجب على طالب العلم أن يعلمها ويعمل بها؛ حتى يكون علمه نافعاً له في دنياه وأخراه.','2','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (25,'<span data-type="title" id=toc-25>كيفية إحياء العلم الشرعي وبيان أهميته</span>
...
أما الكلام عن الدرس الأصلي وهو كتاب العمدة وما حوله وكيفية أدائه وشرحه وحفظه، فهذا أتركه للشيخ حفظه الله معكم في الأسبوع القادم إن شاء الله.','2','2',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (26,'<span data-type="title" id=toc-26>طلب العلم ضروري لكل مسلم</span>
...
فينبغي لكل سالك لطريق العلم أن يعرف كيف ينتقي العلم المناسب وكيف ينتقي الكتاب المناسب، ثم كيف يتدرج في هذا العلم وفي هذه الكتب.','2','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (29,'<span data-type="title" id=toc-29>الضابط لضمان تحصيل العلم على أصوله السليمة</span>
...
فالخوارج يجتمعون في أصلين أو ثلاثة أما بقية ال','2','6',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (30,'<span data-type="title" id=toc-30>موقف طالب العلم من الخلاف بين العلماء</span>
...
هذا ما أحسبه وما أعرفه.','2','9',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (33,'<span data-type="title" id=toc-33>الكتب التي ينصح طالب العلم باقتنائها</span>
...
والحاصل أنه ينبغي أن ينوع فلا يسلك ما يسلكه بعض الشباب بأن يملأ مكتبته بنوع من التخصص وتكون فقيرة للتخصصات الأخرى، فهذا لا ينبغي.','2','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (34,'<span data-type="title" id=toc-34>الأمور التي تعين على طلب العلم</span>
...
أما الاستمرار في العلم والتبحر فيه فلا شك أنه موهبة؛ لكن موهبة تغذيها قوة الاستعداد وقوة الإرادة والاستعانة بالله عز وجل، وكثرة دعائه ومجالسة طلاب العلم والصالحين.','2','11',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (35,'<span data-type="title" id=toc-35>التوفيق بين التخصص غير الشرعي وطلب العلم الشرعي</span>
...
والسبب أن التلقي على أسلوب غير صحيح، فتلقي هذه العلوم والتي تؤصل وترجع الأمور إلى مناهجها وأصول الاستنباط وأصول الاستدلال، يجب أن يكون على طلاب العلم والعلماء.','2','16',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (40,'<span data-type="title" id=toc-40>الموقف من جماعة التبليغ</span>
...
والمعتزلة عندهم نوع تعطيل وهو إنكار الصفات وإثبات الأسماء.','2','19',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (43,'<span data-type="title" id=toc-43>أسماء الله توقيفية</span>
...
لكن الفضل من حيث العمل قد يوجد، فقد يوجد من يعمل عملاً أفضل من عمل بعض الصحابة، كما ورد في الحديث أنه قد يوجد من هذه الأمة من يأتي في آخر الزمان ويكون أجره أجر خمسين من الصحابة، فهذا يتعلق بالأجر، والأجر لا يلزم منه مطلق الأفضلية كما ذكر شيخ الإسلام، واتفق أهل العلم في ذلك.','2','21',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (45,'<span data-type="title" id=toc-45>التوفيق بين طلب العلم ومتطلبات الحياة</span>
...
إذاً: المسألة مسألة شعور نفسي وعدم جدية في ضبط الوقت، ولو ضبط طالب العلم وقته في هذا العصر لوجد من الوقت الشيء الكثير ووجد عنده الفراغ الذي كان لا يوجد عند السابقين، هذا ما يظهر لي، والله أعلم.','2','22',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (46,'<span data-type="title" id=toc-46>الأمور المعينة على الجرأة في الإلقاء</span>
...
هذه الأمور تعالج الحياء وتعالج القلق وتعالج الهيبة من المواقف الجريئة.','2','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (47,'<span data-type="title" id=toc-47>الموقف الصحيح من اختلاف العلماء في المسألة</span>
...
<span data-type="title">الجواب</span>
  هذا التذبذب دليل قلة الفقه في الدين، فعلى من هذا حاله أن يضع ثقته بعالم من العلماء أو طالب علم وإذا أفتاه بشيء واطمأن إليه شرعاً فعليه أن يذهب إلى قول من يطمئن إليه ويترك الرأي المخالف، ثم يعرف أن هذه مسائل خلافية، بمعنى أن كثيراً من المسائل الخلافية وإن كان فيها راجح ومرجوح فهذا لا يعني أن هناك باطلاً محضاً وحقاً محضاً، فليتسع صدره لهذه الأمور ولا يقلق، ويعمل بقول من يثق به من أهل العلم ويستريح ويترك عنه كلام الناس والجدال معهم، ولا عليه أن يقنع الآخرين، بل عليه أن يعمل بما يسعه شرعاً ولا يهمه الآخرون الذين يخالفونه ما دام ليس من أهل العلم المتمكنين.','2','24',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (48,'<span data-type="title" id=toc-48>سؤال الناس عن صفات الله</span>
...
وصلى الله وسلم وبارك على نبينا محمد وعلى آله وصحبه.','2','25',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (49,'<span data-type="title" id=toc-49>شرح لمعة الاعتقاد [٤]</span>
لقد دلت آيات القرآن وأحاديث السنة على ثبوت صفة الكلام لله عز وجل، فالله تعالى يتكلم بما شاء كما شاء متى شاء، والقرآن العظيم من كلام الله تعالى الذي تكلم به على الحقيقة، وقد أنكرت الفرق كثير من الفرق الكلامية صفة الكلام، وبعضهم أولوها وفسروها بمعانٍ تخالف ما عليه مذهب السلف.','3','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (50,'<span data-type="title" id=toc-50>كلام الله تعالى</span>
قال المؤلف رحمه الله تعالى: [فصل في كلام الله عز وجل: ومن صفات الله تعالى أنه متكلم بكلام قديم، يسمعه من شاء من خلقه، سمعه موسى عليه السلام منه من غير واسطة، وسمعه جبريل عليه السلام ومن أذن له من ملائكته ورسله، وأنه سبحانه يكلم المؤمنين في الآخرة ويكلمونه، ويأذن لهم فيزورونه، قال الله تعالى: {وَكَلَّمَ اللَّهُ مُوسَى تَكْلِيماً} [النساء:١٦٤]، وقال سبحانه: {يَا مُوسَى إِنِّي اصْطَفَيْتُكَ عَلَى النَّاسِ بِرِسَالاتِي وَبِكَلامِي} [الأعراف:١٤٤]، وقال سبحانه: {مِنْهُمْ مَنْ كَلَّمَ اللَّهُ} [البقرة:٢٥٣]، وقال سبحانه: {وَمَا كَانَ لِبَشَرٍ أَنْ يُكَلِّمَهُ اللَّهُ إِلاَّ وَحْياً أَوْ مِنْ وَرَاءِ حِجَابٍ} [الشورى:٥١]، وقال تعالى: {فَلَمَّا أَتَاهَا نُودِي يَا مُوسَى * إِنِّي أَنَا رَبُّكَ} [طه:١١ - ١٢]، وقال سبحانه: {إِنَّنِي أَنَا اللَّهُ لا إِلَهَ إِلاَّ أَنَا فَاعْبُدْنِي} [طه:١٤]، وغير جائز أن يقول هذا إلا الله].','3','2',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (51,'<span data-type="title" id=toc-51>الكلام صفة من صفات الله تعالى</span>
...
قوله: يَسمَعه (من شاء من خلقه)، أو يُسمِعه، أي: يسمعه الله عز وجل من شاء من خلقه، فالله عز وجل قد أسمع موسى من غير واسطة، وسمعه جبريل عليه السلام، ومن أذن له من ملائكته، كما ورد في صحيح مسلم وغيره أن الملائكة يسمعون كلام الله عز وجل حينما يتنزل الوحي.','3','3',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (52,'<span data-type="title" id=toc-52>تكليم المؤمنين في الآخرة</span>
...
ثانياً: أن كلام الله يسمع من قبل من يكلمهم، يسمعه الله عز وجل من يشاء من عباده، فقد أسمع بعض رسله، وأسمع ملائكته، ويسمع عباده يوم القيامة، ويسمع من يشاء في الدنيا ممن ورد فيهم النص، أما دعوى السماع من الله عز وجل بغير نص فهي ضلالة، فمن ادعى أنه سمع من الله عز وجل بغير وحي فإنه بذلك كاذب، ومن ادعى أنه يسمع كلام الله عز وجل من غلاة الصوفية ونحوهم؛ فقد كذب على الله وأعظم عليه الفرية، إنما يثبت ما ورد في النصوص، وقد انقطع الوحي؛ فلا سبيل إلى إثبات ما لم يثبت عن النبي صلى الله عليه وسلم.','3','4',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (53,'<span data-type="title" id=toc-53>الأدلة على كلام الله</span>
أما ما ورد في دلالة الآيات فإن الآية الأولى: {وَكَلَّمَ اللَّهُ مُوسَى تَكْلِيمًا} [النساء:١٦٤]، ومعنى هذا: أن الله عز وجل هو الذي كلم موسى، وليس موسى هو الذي كلم الله؛ هذا من ناحية.
الناحية الأخرى: أن التكليم لا يمكن أن يحمل على معنىً آخر؛ لأن الآية قاطعة ومحكمة في التصريح بالتكليم؛ لأن الله عز وجل أشار إلى المصدر على جهة التأكيد فقال: ((وَكَلَّمَ اللَّهُ مُوسَى))، ثم قال: {تَكْلِيمًا} [النساء:١٦٤]؛ لئلا يقال: كلمه وحياً غير مباشر، أو كلمه إلهاماً، أو كلمه برؤيا، أو كلمه بالشجرة، أو كلمه بحروف وأصوات مخلوقة؛ كل ذلك -أي: ما تأول به المتأولون- باطل قطعاً بنص الآية وصريح نطقها.
ثم قال: {قَالَ يَا مُوسَى إِنِّي اصْطَفَيْتُكَ عَلَى النَّاسِ بِرِسَالاتِي وَبِكَلامِي} [الأعراف:١٤٤]، وهذا يعني أن الله عز وجل نادى موسى، وهذا ينفي أن يكون الكلام جاء من الشجرة؛ لأن المنادي هو الله، ولو كان الكلام كلام الشجرة، أو كلاماً خلقه الله في الشجرة، أو حروفاً وأصواتاً اجتمعت فتوافرت على الكلام؛ لكان المنادي هو هذا المخلوق، ولا يليق بأن يكون المنادي هو المخلوق باسم الله عز وجل؛ لأنه قال: {إِنِّي اصْطَفَيْتُكَ عَلَى النَّاسِ بِرِسَالاتِي وَبِكَلامِي} [الأعراف:١٤٤]، والمرسل هو الله والمصطفي هو الله والمتكلم هو الله؛ إذاً لا يمكن أن يكون الكلام إلا كلام الله.
كذلك قوله عز وجل: {مِنْهُمْ مَنْ كَلَّمَ اللَّهُ} [البقرة:٢٥٣]، وهذا يعني أن الله خص البعض بالتكليم، ومعناها: منهم من كلمه الله، لا كما يفهم بعض المبتدعة بأن منهم من كلم ربه، فكل الناس يخاطبون ربهم بالدعاء والعبادة.
وقوله: {وَمَا كَانَ لِبَشَرٍ أَنْ يُكَلِّمَهُ اللَّهُ إِلَّا وَحْيًا أَوْ مِنْ وَرَاءِ حِجَابٍ} [الشورى:٥١]، بمعنى أن الله عز وجل يكلم بعض عباده بأنواع التكليم، منها ما هو وحي مباشر، ومنها ما هو من وراء حجاب، فكلام الله عز وجل لموسى من أنواع الوحي المباشر، وكلام الله لمحمد صلى الله عليه وسلم الأرجح أنه من وراء حجاب، أي كلامه له عند الإسراء والمعراج.
وكذلك الآية التي بعدها: {فَلَمَّا أَتَاهَا نُودِيَ يَا مُوسَى} [طه:١١]، يعني: المنادي هو الله عز وجل، إذاً هو المتكلم؛ لأنه قال: {إِنِّي أَنَا رَبُّكَ} [طه:١٢]، فلو كان الكلام من الشجرة، أو من مخلوق، أو حروفاً وأصواتاً اجتمعت وهي مخلوقة؛ لما جاز أن تقول هذه الحروف وهذه المخلوقات: {إِنِّي أَنَا رَبُّكَ} [طه:١٢]، فلا بد أن يكون المتكلم هو الله عز وجل، وكذلك قوله: {إِنَّنِي أَنَا اللَّهُ لا إِلَهَ إِلَّا أَنَا فَاعْبُدْنِي} [طه:١٤].
...
وما ورد هنا في آخر المقطع من القصة التي فيها أن موسى ليلة رأى النار فهالته إلخ، هذا','3','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (54,'<span data-type="title" id=toc-54>القرآن كلام الله تعالى</span>
...
(وحروف وكلمات)، وهذا فيه إشارة إلى أن الله تكلم بالقرآن بحرف وصوت على ما يليق بجلال الله عز وجل.','3','6',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (55,'<span data-type="title" id=toc-55>أجر قراءة القرآن وبعض صفات القرآن</span>
...
فالوسائل والمادة لا شك أنها مخلوقة، أما المتلو والمقروء المسموع المحفوظ في الصدور فهو كلام الله عز وجل، لكنهم لبسوا على الناس في ذلك فوقع في مذاهبهم بعض من وقع من جهلة الناس وقليلي العلم وأصحاب الأهواء.','3','7',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (56,'<span data-type="title" id=toc-56>الأدلة على أن القرآن كلام الله</span>
...
والأمر الثاني: أنهم شعروا بالتحدي الكبير، والتحدي غالباً يستثير المواهب والقدرات في البشر، فإنهم شعروا بتحد عظيم من النبي صلى الله عليه وسلم، ومن هذا الوحي الذي أنزله ا','3','8',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (57,'<span data-type="title" id=toc-57>حكم من أنكر حرفاً من القرآن</span>
...
فالإشارة إلى تكفير من أنكر حرف دليل على أن الله تكلم بالقرآن بهذه الحروف التي بين أيدينا على ما يليق بجلال الله عز وجل، بكلام ليس ككلام البشر؛ لأن الله سبحانه: {لَيْسَ كَمِثْلِهِ شَيْءٌ} [الشورى:١١].','3','9',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (58,'<span data-type="title" id=toc-58>اتفاق المسلمين على عد سور القرآن وآياته وكلماته وحروفه</span>
...
وبعضهم جعل الكلمة الواحدة ليست آية مثل قوله عز وجل: {مُدْهَامَّتَانِ} [الرحمن:٦٤].
...
وصلى الله وسلم وبارك على نبينا محمد، وعلى آله وصحبه أجمعين.','3','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (59,'<span data-type="title" id=toc-59>الأسئلة</span>','3','11',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (60,'<span data-type="title" id=toc-60>الجمع بين تكليم موسى بغير حجاب وحجبه عن الرؤية</span>

<span data-type="title">السؤال</span>
  ورد أن الله كلم موسى عليه السلام بغير حجاب، وورد أن موسى سأل الله الرؤية في الدنيا فمنعه، فكيف نجمع بينهما؟

<span data-type="title">الجواب</span>
  الكلام بين موسى وبين ربه بغير حجاب، لكن لا يعني أنه ليس بينه وبينه حجاب بالنسبة للرؤية، فلا شك أن موسى عليه السلام لم ير ربه، لكنه سمع كلام ربه بواحاً، وكما قال أهل العلم: هذا النوع يختلف عن نوع التكليم الذي كلم الله به محمداً صلى الله عليه وسلم.','3','12',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (61,'<span data-type="title" id=toc-61>وجه الدلالة من الحروف المقطعة على أن القرآن كلام الله</span>
...
هذا أقرب قول في وجه ذكر الحروف المقطعة.','3','13',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (62,'<span data-type="title" id=toc-62>معنى قول الطحاوي: (له معنى الربوبية ولا مربوب)</span>
...
وكذلك الله عز وجل متصف بأنه هو الخالق قبل أن يخلق المخلوقات، وليس بوجود الخلق اتصف بالخلق وسمي بالخالق، أو اكتسب صفة الخلق، وهذا يعني أن جميع صفات الله عز وجل يتصف الله بها قبل وجود الموصوفات التي تدل عليها، فالخلق صفة لله عز وجل، والله عز وجل هو الخالق، حتى قبل أن توجد المخلوقات.','3','14',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (63,'<span data-type="title" id=toc-63>حكم قول الصحابي في الأمور الغيبية</span>
...
هذا هو الغالب، ومع ذلك لا نقطع؛ لأن الصحابي قد يظن وقد يتوهم أن الأمر كذا وهو غير ذلك.','3','15',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (64,'<span data-type="title" id=toc-64>تسمية سور القرآن وترتيب سوره وآياته</span>
...
إذاً: فالسور من حيث الترتيب الواقع الآن في المصحف من اجتهاد الصحابة، وبعضها توقيفي كما ذكر أهل العلم، كذلك الترقيم ليس توقيفياً؛ لأن بعض أهل العلم لا يزال يرى أن الترقيم تدخل فيه {بِسْمِ اللَّهِ الْرَّحمَنِ الْرَّحَيمِ} [الفاتحة:١]، وبعضهم لا يدخل فيه: (بسم الله الرحمن الرحيم).
وبعضهم أيضاً دمج بعض الآيات ببعض، وبعضهم جعلها آية واحدة إلى آخره.
ولا يزال الأمر محل خلاف من الناحية العلمية، ولكن من ناحية إخراج القرآن كما عليه المصحف الآن اتفق عليه المسلمون؛ فيجب أن يحترم، ويكون موضع إجماع.','3','16',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (65,'<span data-type="title" id=toc-65>التخيل في صفات الله تعالى</span>
...
فإذاً لا يضرك أن تتصور وتتخيل، إنما يضرك أن تعتقد ما تتصور أو تتخيل، بحيث تجزم أن ما في ذهنك من الخيالات هو الحقيقة اللائقة بالله، أو هو الصفة التي يوصف بها الله، فهذا لا يجوز، أما مجرد التخيل والتصور فلا يمكن أن تفهم المعاني إلا بالتخيل والتصور، لكن استبعد في عقيدتك ما تتخيله وتتصوره، واعلم أن الحقيقة والكيفية التي عليها صفات الله أعظم وأجل مما نتخيله.','3','17',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (66,'<span data-type="title" id=toc-66>معنى (لا يمسه إلا المطهرون)</span>

<span data-type="title">السؤال</span>
  ألا يحمل قوله: {لا يَمَسُّهُ إِلاَّ الْمُطَهَّرُونَ} [الواقعة:٧٩] على القرآن الذي بين أيدينا؟
...
الثاني: (لا يمسه إلا المطهرون)، أي الملائكة الذين كتبوا القرآن في الكتاب في السماء.','3','18',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (67,'<span data-type="title" id=toc-67>حكم حضور ندوات العلمانيين وأمسيات الشعر الحداثي</span>
...
فإذاً: من هنا يهدم الدين، فلا فرق بين العقيدة وغيرها، والتفريق حادث، فلا يجوز أن يقال: أحاديث الآحاد لا يؤخذ بها في العقيدة ولا في الصفات.','3','20',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (69,'<span data-type="title" id=toc-69>الجمع بين تكليم موسى وأن الله لا يكلم بشراً إلا بالوحي</span>

<span data-type="title">السؤال</span>
  كيف نجمع بين قوله تعالى: {وَمَا كَانَ لِبَشَرٍ أَنْ يُكَلِّمَهُ اللَّهُ إِلاَّ وَحْياً أَوْ مِنْ وَرَاءِ حِجَابٍ} [الشورى:٥١]، وقوله: {وَكَلَّمَ اللَّهُ مُوسَى تَكْلِيماً} [النساء:١٦٤]؟

<span data-type="title">الجواب</span>
  قول الله عز وجل: {وَمَا كَانَ لِبَشَرٍ أَنْ يُكَلِّمَهُ اللَّهُ إِلاَّ وَحْياً} [الشورى:٥١] يدخل فيه تكليم موسى عليه السلام، كلام الله لموسى وحي؛ فلا تعارض بين الآيتين أبداً، والوحي أنواع: منه ما هو كفاح، ومنه ما هو عن طريق جبريل عليه السلام، ومنه ومنه إلخ.
بل إن الآية التي فصل فيها هذه الأنواع من الوحي تفيد أن الوحي هو التكليم الكفاح الذي ليس فيه واسطة، هذا الظاهر من نص الآية.','3','21',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (70,'<span data-type="title" id=toc-70>حكم إطلاق مادة القرآن الكريم</span>

<span data-type="title">السؤال</span>
  هل يصح أن يقال للقرآن: مادة كما يقال في المدارس: مادة القرآن الكريم؟

<span data-type="title">الجواب</span>
  أولاً: المفهوم من كلمة (مادة) معنى درس أو حصة، ومجلس أو نحو ذلك، فإذا كانت المادة تعني درس قرآن؛ فلا مانع، لكن يظهر لي والله أعلم من باب التورع ومن باب الاحتياط أن الاستغناء عنها أولى، فيقال: درس القرآن؛ لأن كلمة (مادة) موهمة، وأكثر المقررات التي يدرسها الطلاب مادية، وإن كان القصد صحيحاً، ولا نستطيع أن نجزم بأن هناك أحداً قصده غير المعنى المتبادر، وهو أنه يقصد مادة الدرس، ورغم صحة القصد إلا أن الأولى اجتناب هذه الكلمة؛ دفعاً للبس.','3','22',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (71,'<span data-type="title" id=toc-71>حكم تقبيل المصحف وقول صدق الله العظيم بعد الانتهاء من التلاوة</span>
...
ومثله قول: صدق الله العظيم، إن جاء لمناسبة أو أحياناً فلا مانع، أما التزامه بعد كل قراءة فهو بدعة.','3','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (72,'<span data-type="title" id=toc-72>حكم القول بأن القرآن كلام الله لفظاً ومعنى</span>
...
وأحياناً قد يقصد باللفظ: الصوت المنبثق من اللسان والشفتين، الذي هو المخلوق والذي هو من فعل البشر أنفسهم؛ فهذا لا شك أنه مخلوق، لكن ينبغي أن لا يقال في اللفظ شيء، لا نفي ولا إثبات، يقال: القرآن كلام الله فقط، ونقف عندها؛ لاشتباه الكلام في مسألة اللفظ.','3','24',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (73,'<span data-type="title" id=toc-73>الدعاء بمستقر الرحمة</span>

<span data-type="title">السؤال</span>
  أين مستقر الرحمة؟ وهل يصح الدعاء بـ (اللهم اجمعنا في مستقر رحمتك)؟

<span data-type="title">الجواب</span>
  أما الدعاء فأظنه صحيحاً؛ لأن المقصود به الجنة، ورحمة الله سبقت عذابه، ورحمة الله وسعت كل شيء، وأعظم رحمة الله عز وجل أو من أعظم رحمة الله: الجنة، لكن هل وردت؟ هذه ليس عندي الآن فيها خبر، فلا أدري، أما أين مستقر الرحمة؟ فربما قصد: ما المقصود بمستقر الرحمة هنا؟ والجواب: مستقر الرحمة هو الجنة، لكن قد يكون لها معنىً آخر لا أعلمه، فلا أجزم بذلك، ولا أدري هل وردت في النص أو لم ترد.','3','25',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (74,'<span data-type="title" id=toc-74>ضعف حديث: (أنا الله أمامك ومن خلفك)</span>

<span data-type="title">السؤال</span>
  كلام موسى عليه السلام قد يحتج به من قال بوحدة الوجود، أعني قوله: أنا الله أمامك وعن يمينك وعن شمالك؟

<span data-type="title">الجواب</span>
  قلت -كما ذكر أهل العلم-: إن هذا لا يصح كحديث؛ فلا داعي أن نعول عليه، واستدلال الاتحادية بمثل هذه الأمور بناء على قاعدتهم أنهم لا يعرفون الصحيح من السقيم، بل يعرجون على الأحاديث الضعيفة والموضوعة، ويعرفونها أكثر مما يعرفون الصحيحة.','3','26',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (75,'<span data-type="title" id=toc-75>كلام المخلوقين المحكي في كلام الله</span>
...
<span data-type="title">الجواب</span>
  قصده: هل قول موسى هو قوله بحروفه ومعانيه، وكذلك قول فرعون أو قول غيره؟ أولاً: الله عز وجل حينما يتكلم وينسب الكلام، أو يذكر كلام من سبقوا أو من لحقوا من خلقه؛ فإنما يذكره على وجه صحيح قطعاً، ولا نفصل: هل هذا كلامه بحروفه أو بغير حروفه؛ لأن هذا أمر غيبي من ناحية، ومن ناحية أخرى قد يكون بعض هذا الكلام ليس بالعربية أصلاً، والقرآن جاء بلسان عربي مبين، لكن كلام الله هو الحق والصدق، ولا بد أن يكون ما تكلم الله به عن هؤلاء القوم هو عين كلامهم، ولو لم يكن بحروفه وبلغته.','3','27',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (76,'<span data-type="title" id=toc-76>وجه الدلالة على أن القرآن كلام الله من قوله تعالى: (سأصليه سقر)</span>

<span data-type="title">السؤال</span>
  ما الشاهد من إيراد المؤلف لقوله تعالى: {إِنْ هَذَا إِلاَّ قَوْلُ الْبَشَرِ} [المدثر:٢٥]، فقال سبحانه: {سَأُصْلِيهِ سَقَرَ} [المدثر:٢٦]؟

<span data-type="title">الجواب</span>
  الشاهد فيه على أن القرآن كلام الله، أنه حينما قال هذا المشرك بأن هذا القرآن ما هو إلا قول البشر، أي أنه مخلوق، وأنه ليس كلام الله، هدده الله عز وجل بأنه سيصليه سقر، ولو كان كما يقول الجهمية والمعتزلة: ليس بكلام الله عز وجل، إنما هو كلام المخلوق؛ لما جاز أن يتوعد الله عليه.','3','28',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (77,'<span data-type="title" id=toc-77>الكلام والشبهات عن سيد قطب</span>
...
وصلى الله وسلم وبارك على نبينا محمد، وعلى آله وصحبه أجمعين.','3','29',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (78,'<span data-type="title" id=toc-78>شرح لمعة الاعتقاد [٥]</span>
رؤية الله عز وجل من المسائل العقدية التي أثبتها أهل السنة والجماعة وأنكرها المبتدعة مع تواتر الأحاديث فيها، ومن المسائل العظيمة التي يختلف فيها أهل السنة مع المبتدعة مسألة القضاء والقدر، فإن أهل السنة يتبعون منهج السلف في ذلك، والمبتدعة من القدرية وغيرهم ينكرون القدر ويدعون أنهم خالقو أفعالهم بأنفسهم، تعالى الله عن ذلك علواً كبيراً.','4','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (79,'<span data-type="title" id=toc-79>رؤية الله عز وجل</span>
...
النوع الثاني: الرؤية الخاصة، وهي رؤية المؤمنين لربهم في الجنة بأبصارهم.','4','2',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (80,'<span data-type="title" id=toc-80>أنواع الرؤية في المحشر</span>
الرؤية الأولى العامة تحدث على ثلاث مراحل، وهي في المحشر كلها: المرحلة الأولى: رؤية الخلائق جميعاً لربهم عز وجل على ما يليق بجلاله سبحانه، وهذه الرؤية تكون للمؤمنين رؤية غبطة ولذة وسرور وتنعم، وتكون للكافرين والمنافقين رؤية حسرة وندم، فلا يتمتعون بهذه الرؤية ولا يسرون بها، بل إن رؤيتهم ليست كرؤية المؤمنين.
...
واختلف أهل العلم في نوع هذه الرؤية، هل هي رؤية بصرية أو رؤية قلبية، وما حقيقتها، كل ذلك لا يزال أمر غيب، والله أعلم به، لكنها تختلف عن رؤية المؤمنين لربهم في الجنة، وهي رؤية خاصة.','4','3',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (81,'<span data-type="title" id=toc-81>الرؤية الخاصة بالمؤمنين</span>
...
فإن الله تعالى ليس له شبيه ولا نظير.','4','4',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (82,'<span data-type="title" id=toc-82>مسألة الزيارة</span>
...
كثير من أهل العلم أشار إلى الزيارة، لكن هل هي على ما ورد في بعض النصوص الضعيفة، أو على ما ورد في نصوص أخرى صحيحة بمعنى الزيادة، وهل الزيارة بمعنى الرؤية أو هي أمر زائد على الرؤية؟! كل ذلك يحتاج إلى مزيد بحث، وقد أورد كثير من أهل العلم هذه المسألة كما قلت، لكن أغلب الروايات والأحاديث التي أوردوها فيها ضعف.','4','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (83,'<span data-type="title" id=toc-83>مسألة تكليم الله للمؤمنين</span>
...
ثم أورد الآية: {وُجُوهٌ يَوْمَئِذٍ نَاضِرَةٌ * إِلَى رَبِّهَا نَاظِرَةٌ} [القيامة:٢٢ - ٢٣]، وهي في إثبات الرؤية قطعاً، لأن السلف فسروها بذلك، وأجمعوا على تفسيرها به.
...
وقال تعالى: {وَخَلَقَ كُلَّ شَيْءٍ فَقَدَّرَهُ تَقْدِيراً} [الفرقان:٢].
...
وقال تعالى: {فَمَنْ يُرِدْ اللَّهُ أَنْ يَهدِيَهُ يَشْرَحْ صَدْرَهُ لِلإِسْلامِ وَمَنْ يُرِدْ أَنْ يُضِلَّهُ يَجْعَلْ صَدْرَهُ ضَيِّقاً حَرَجاً كَأَنَّمَا يَصَّعَّدُ فِي السَّمَاءِ} [الأنعام:١٢٥].
وروى ابن عمر أن جبريل عليه السلام قال للنبي صلى الله عليه وسلم: (ما الإيمان؟ قال: أن تؤمن بالله وملائكته وكتبه ورسله واليوم الآخر وبالقدر خيره وشره، فقال جبريل: صدقت) انفرد مسلم بإخراجه].','4','7',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (85,'<span data-type="title" id=toc-85>مسائل القدر</span>
في هذا الفصل بين المؤلف رحمه الله مسائل عديدة من مسائل القدر، بعضها متعلقة بمراتب القدر، وبعضها فروع عنها، وبعضها في مسائل أخرى مهمة، نأخذها على النحو التالي:','4','8',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (86,'<span data-type="title" id=toc-86>المسألة الأولى: ارتباط القدر بصفات الله وأسمائه وأفعاله</span>
...
هذه المسألة الأولى.','4','9',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (87,'<span data-type="title" id=toc-87>المسألة الثانية: (لا يكون شيء إلا بإرادته، ولا يخرج شيء عن مشيئته)</span>
بمعنى أنه لا يحدث في هذا الكون شيء بما في ذلك أفعال العباد أو أفعال المكلفين وأفعال الملائكة والجن والإنس، فالملائكة مسخرون لا يعصون الله، لكن الجن الإنس فيهم العاصون، فالله عز وجل خلق جميع أفعال العباد بما فيها أفعال العصاة وأفعال المطيعين كما سيأتي.','4','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (88,'<span data-type="title" id=toc-88>المسألة الثالثة: لا يخرج شيء عن تقدير الله تعالى</span>
المسألة الثالثة: (وليس في العالم شيء يخرج عن تقديره، ولا يصدر إلا عن تدبيره).
هذا فيه إشارة إلى الرد على الذين زعموا أن العبد مستقل بفعله، أو أن العبد مستقل ببعض أفعاله عند طائفة منهم، فإن الله عز وجل لا يخرج عن تقديره شيء، ولا يصدر شيء إلا عن تدبيره سبحانه، بما في ذلك أفعال العباد جميعها، خيرها وشرها.','4','11',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (89,'<span data-type="title" id=toc-89>المسألة الرابعة: لا محيد عن القدر المقدور</span>
...
هذا بالنسبة للقدر نفسه، أما آثار القدر التي هي بكسب الإنسان وفعله فإنه محاسب عليها، كالأمور التي تتعلق بالأمر والنهي، والطاعة والمعصية، فإن الإنسان مسئول عنها؛ لأن الله عز وجل علق القدر في الأمر والنهي على أفعال العباد، بمعنى أنه جعل أفعال العباد مناط التكليف ومناط الحساب والجزاء.','4','12',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (90,'<span data-type="title" id=toc-90>المسألة الخامسة: مراتب القدر</span>
...
والمرحلة الرابعة: الخلق، فإن الله خلق كل شيء، وهذه آخر مراتب القدر.','4','13',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (91,'<span data-type="title" id=toc-91>المسألة السادسة: أنواع الإرادة</span>
...
إذاً: القدر خيره وشره كله من الله من حيث المشيئة العامة والتقدير العام، أما من حيث فعل الإنسان فإن الشر إنما يفعله الإنسان بإرادته، فلذلك إذا زال عقل الإنسان لم يحاسب على أفعاله التي يفعلها وإن كانت شراً.','4','16',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (94,'<span data-type="title" id=toc-94>ما يحاسب عليه الإنسان من الأفعال</span>
...
فعلى هذا فإن على المسلم أن يفرق بين الدرجتين أو بين المرحلتين، أعني بين المسألة الغيبية التي مبناها على التسليم ولا نزيد عما جاء فيها من النصوص، والدرجة الثانية وهي مناط التأمل والتفكير والتدبر، ومحاولة الوصول إلى طريق السلامة، فإنه لا محيد للإنسان، الذي يريد النجاة أن يفكر في أن الله عز وجل أرسل الرسل، فيبحث عن الحكمة في ذلك، وعن الفائدة في ذلك، وأن الله أنزل الكتب، وبين الشرائع، وأحل الحلال وحرم الحرام، وأعطى الإنسان القدرة وهداه النجدين، وأن مصيره مرتبط بإرادته في هذه الأمور وبفعله، فلذلك أي إنسان لا يستطيع أن يختار الطريق المستقيم، إما لزوال','4','17',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (95,'<span data-type="title" id=toc-95>الأسئلة</span>','4','18',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (96,'<span data-type="title" id=toc-96>معنى قوله تعالى: (يحفظونه من أمر الله)</span>

<span data-type="title">السؤال</span>
  الأخ يسأل عن قوله عز وجل عن الملائكة: {يَحْفَظُونَهُ مِنْ أَمْرِ اللَّهِ} [الرعد:١١]؟

<span data-type="title">الجواب</span>
  يعني: يحفظونه بأمر الله، فحفظهم له كائن من أمر الله.','4','19',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (97,'<span data-type="title" id=toc-97>أنواع التقدير وعدم تناقضها</span>
...
ثم استدل ببيت لا صحة له: إن الكلام لفي الفؤاد وإنما جعل اللسان على الفؤاد دليلا وهذا كلام يتعلق بأفعال البشر، ثم هذا الكلام ليس دليلاً على المقصود هنا، وكذلك قوله: (ما قصدوا إلا التمثيل من حيث الحرف والصوت)، هذا فيه نظر يحتاج إلى تفصيل إلى آخر كلامه، وأكثره كلام الأشاعرة وليس من كلام السلف، فلننتبه له.','4','21',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (99,'<span data-type="title" id=toc-99>معنى قوله صلى الله عليه وسلم: (إنكم ترون ربكم كما ترون القمر)</span>
...
ذكر السائل كلاماً آخر لا ينبغي، وأرجو من السائل إذا بقي عنده إشكال أن يسأل سؤالاً خاصاً، لأن مثل هذه الأسئلة لا تثار على العموم.','4','22',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (100,'<span data-type="title" id=toc-100>دخول مشيئة العبد تحت مشيئة الله</span>

<span data-type="title">السؤال</span>
  درسنا في المرحلة المتوسطة أن مشيئة العبد داخلة في مشيئة الله، فهل هذا الصحيح؟

<span data-type="title">الجواب</span>
  نعم، فمشيئة العبد لا تخرج عن مشيئة الله عز وجل، قال تعالى: {وَمَا تَشَاءُونَ إِلَّا أَنْ يَشَاءَ اللَّهُ} [الإنسان:٣٠].','4','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (101,'<span data-type="title" id=toc-101>الفرق بين السلف والخلف</span>
...
وكل من كان على نهج السلف فهو من السلف، وإن كان معاصراً حياً بين الناس إلى يوم القيامة، ومذهب الخلف هو مذهب أهل البدع إلى يوم القيامة.','4','24',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (102,'<span data-type="title" id=toc-102>عدم انحصار مفهوم الخلف في العصاة وحدهم</span>

<span data-type="title">السؤال</span>
  هل الخلف هم العصاة؟

<span data-type="title">الجواب</span>
  لا، العصاة إن كانوا في عقيدتهم على مذهب أهل السنة والجماعة، فهم يدخلون في أهل السنة والجماعة، لكن يسمون عصاة، ويسمون فسقة.','4','25',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (103,'<span data-type="title" id=toc-103>الاحتجاج على المعاصي بأن الله هو الهادي</span>
...
الله عز وجل هو الهادي بمعنى أنه يهدي العباد، فهو الذي يهدي من يشاء ويضل من يشاء، لكن الاحتجاج بهذه الكلمة على المعاصي لا يجوز، حينما يفعل الإنسان شيئاً من المعاصي ثم يقول: الله هو الهادي، هذا ليس باحتجاج صحيح؛ لأن الله عز وجل أعطى الإنسان عقلاً وبين له بالشرع ما يقيم عليه الحجة.','4','26',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (104,'<span data-type="title" id=toc-104>مصير القرآن يوم القيامة وعلى من تقوم الساعة</span>
...
والساعة تقوم على شرار الخلق كما ورد في الحديث الصحيح، وذلك أن من آخر ملاحم يوم القيامة أن الله عز وجل يبعث ريحاً تقبض أرواح المؤمنين، فلا يبقى إلا شرار الخلق، وعليهم تقوم الساعة.','4','27',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (105,'<span data-type="title" id=toc-105>مقدار يوم القيامة</span>
...
والله أعلم بما بين ذلك من المقادير.','4','28',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (106,'<span data-type="title" id=toc-106>الفرق بين القضاء والقدر</span>
...
فالقضاء يرادف القدر، والقدر يرادف القضاء.','4','29',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (107,'<span data-type="title" id=toc-107>معنى قول الله تعالى: (إنا كل شيء خلقناه بقدر)</span>
...
فكل ذلك يدخل في معنى القدر، بمعنى أنا خلقنا كل شيء بعلم سابق وتقدير سابق وبإرادة ومشيئة سابقة، وكذلك بحكمة، وبموازين، فهذا كله يدخل بمعنى الآية.','4','30',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (108,'<span data-type="title" id=toc-108>قول لشيخ الإسلام وابن القيم في محاجة آدم وموسى</span>
...
فمن هنا حج آدم موسى، وهذا الإطار العام أو الكلام العام لم يخرج عنه كلام ابن القيم وابن تيمية في العموم، لكن هناك تفصيلات تدخل في هذه الجزئيات قد يختلف فيها أهل العلم.','4','31',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (109,'<span data-type="title" id=toc-109>الرد على احتجاج العصاة بالقدر</span>
...
INSERT INTO [b37724] VALUES (111,'<span data-type="title" id=toc-111>تكليم الله للبشر</span>

<span data-type="title">السؤال</span>
  يقول رسول الله صلى الله عليه وسلم: (ما منكم من أحد إلا سيكلمه ربه ليس بينه وبينه ترجمان) فهل سيكلم كل فرد من البشر؟

<span data-type="title">الجواب</span>
  نعم، ورد في الأحاديث الصحيحة أن الله عز وجل سيكلم كل فرد بمفرده، ويحاسب العباد جميعاً حساب رجل واحد في مقام واحد.','4','34',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (112,'<span data-type="title" id=toc-112>المقصود بالأشاعرة والمعطلة والمرجئة والقدرية والجبرية</span>
...
إذاً: السيئة لها وجهان، وجه كونها مقدرة، فهذه لا تخرج عن تقدير الله عز وجل، ووجه فعلها من العبد الذي علم أنها سيئة ثم ارتكبها، فلا شك أنه يعاتب عليها ويقال: هي من نفسك، ومن ذلك العقوبات على السيئات التي تنسب إلى العباد؛ لأنهم أخذوا جزاء بسبب ما ارتكبوه من ذنوب أو تقصير في حق الله.','4','36',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (114,'<span data-type="title" id=toc-114>بيان من هو المرئي في قوله تعالى: (ولقد رآه بالأفق المبين)</span>
...
والكلام فيها طويل.','4','37',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (115,'<span data-type="title" id=toc-115>الحداثة والحداثيون</span>
...
فالاتجاه واحد وهو أن الحداثة الأدبية تخدم الحداثة العقدية خدمة جليلة عظيمة، وتروج الزندقة باسم الأدب، وتروج الانحراف الخلقي والفساد في الأرض باسم الأدب وباسم الحرية الشخصية وباسم التحديث والحداثة، المهم أن الحداثة في حقيقتها الزندقة والباطنية، لكن قد يدخل في الحداثة تيارات أدبية تخدم الحداثة من حيث تشعر أو لا تشعر، فمن هنا يجب أن نفهم حقيقة الحداثيين من خلال الكتب التي كتبت فيهم، وبدأت الآن تتوفر بحمد الله.','4','38',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (116,'<span data-type="title" id=toc-116>الجمع بين سبق القدر والدعاء بجلب الخير ودفع الشر</span>
...
<span data-type="title">الجواب</span>
  هذا داخل فيما سبق، لأن الله عز وجل جعل الدعاء سبباً لكسب الخير ولدفع الشر، فعلى الإنسان أن يبحث عن الأسباب ومنها الدعاء.','4','39',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (117,'<span data-type="title" id=toc-117>حكم قول: أمر الله من ساعته</span>

<span data-type="title">السؤال</span>
  ما حكم هذه العبارة السائدة عند العوام، أمر الله من ساعته؟

<span data-type="title">الجواب</span>
  لا بأس بها، وهم يقصدون بها أن الأمر يؤخذ بسعة علم الله وحكمته ورحمته، فهي من العبارات التي تحمل على المحمل الحسن؛ لأن أغلب الذين يطلقونها يقصدون بها المعنى الحسن.','4','40',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (118,'<span data-type="title" id=toc-118>شرح لمعة الاعتقاد [٦]</span>
الإيمان عند أهل السنة قول باللسان واعتقاد بالجنان وعمل بالجوارح والأركان، وقد خالف في ذلك كثير من الفرق فضلوا وأضلوا، ومن الإيمان الواجب على العبد الإيمان بالغيب، فهو من أركان الدين العظيمة الدالة على صدق المؤمنين، ويدخل في الإيمان بالغيب الإيمان بأشراط الساعة، وحياة البرزخ، والبعث والنشور، ونحو ذلك مما يتعلق باليوم الآخر.','5','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (119,'<span data-type="title" id=toc-119>مسائل الإيمان</span>
...
ويكتفون به؛ لأن هذه الكلمة جامعة لقول اللسان، وعمل القلب وعمل الجوارح والأركان والأعضاء، لكنهم فصّلوا وجاءوا بهذه الأركان الثلاثة: القول والعمل والتصديق لما كثر الخوض في الإيمان وتعريفه خاصة من قبل مرجئة الفقهاء الذين سايروا بعض أهل الأهواء في مفهوم الإيمان، ذلك أن السلف ما كانوا يبحثون هذه المسائل لأنهم كانوا بإجماع يرون أن الإيمان هو مجموع هذا الدين سواء الأمور القلبية الاعتقادية وهو ما يسمى عمل القلب، أو نطق اللسان، أو عمل الأعضاء، كل ذلك ما كان السلف يتنازعون بأنه من الإيمان، لا في عهد الصحابة ولا التابعين ولا تابعي التابعين.','5','3',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (121,'<span data-type="title" id=toc-121>ظهور الإرجاء</span>
...
إذاً: فالمرجئة يقولون إن الإيمان هو التصديق، ويرون أن الأعمال من لوازم الإيمان وليست من الإيمان، والسلف ردوا على هذه المقولة بردود كثيرة.','5','4',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (122,'<span data-type="title" id=toc-122>زيادة الإيمان ونقصه</span>
...
إذاً فيزيد بالطاعة سواء كانت قلبية أو عملية، وينقص بالعصيان سواء كان قلبياً أو عملياً.','5','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (123,'<span data-type="title" id=toc-123>أدلة دخول الأعمال في مسمى الإيمان</span>
...
الأمر الآخر: أنه ذكر شيئاً من مسائل الإيمان هنا، وترك أشياء بناء على أنها تدخل بالتبع، ذكر تعريف الإيمان وهو أنه القول باللسان والعمل بالأركان والعقد بالجنان، وقلت إن السلف كان يختصرون هذا التعريف بقولهم: الإيمان قول وعمل، والقول هو قول اللسان، والعمل عمل القلب وعمل الأعضاء، وذكر أيضاً الزيادة والنقصان.','5','7',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (125,'<span data-type="title" id=toc-125>الاستثناء في الإيمان</span>
...
ومن ذلك أشراط الساعة].','5','9',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (127,'<span data-type="title" id=toc-127>الإيمان بالأمور الغيبية</span>
...
فعلى هذا فإن أمور الغيب والسمعيات هي القضايا الأصولية العامة، ويتفرع عنها أمور أخرى قطعية ثبتت في القرآن وثبتت في السنة، كما سيأتي في التفسير شيء منها.','5','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (128,'<span data-type="title" id=toc-128>ضوابط في موقف المؤمن من الغيبيات</span>
...
وجانب آخر من الحقيقة وهو الكيفية، فهذا مما لا تدركه العقول إذاً بعض أهل العلم ينفي الحقيقة ويقصد به نفي الكيفية، وبعضهم يثبت الحقيقة ويقصد به الإيمان بأصل الشيء، وأنه على معنى صحيح على مراد الله عز وجل، وأن الله عز وجل ما أخبرنا بأمر إلا وهو حق، وليس مجرد خيالات ولا ألغاز ولا تصويرات وهمية كما يظن كثير من الفلاسفة والعقلانيين.','5','11',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (129,'<span data-type="title" id=toc-129>الإيمان بالإسراء والمعراج</span>
...
إذاً الإسراء والمعراج حق وكل ما فيه كان يقظة لا مناماً، وهو من معجزاته صلى الله عليه وسلم.','5','12',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (130,'<span data-type="title" id=toc-130>الإيمان بقصة لطم موسى لملك الموت</span>
...
فهذا من الأمور السمعية التي يُبتلى بها العباد، وهي حق وصدق، وهي التي يختبر بها إيمان الناس، فمن آمن بمثل هذه الأمور وصدّق فهو من المؤمنين بالغيب الذين مدحهم الله عز وجل وامتازوا عن غيرهم، وإن شك أو ارتاب أو أثار الإشكالات فإنه إنما يرتد ريبه وإشكاله عليه نسأل الله السلامة.','5','13',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (131,'<span data-type="title" id=toc-131>أشراط الساعة</span>
...
أشراط الساعة هنا لم ترتب حسب ورودها أو حسب تسلسلها الزمني، مع أن أهل العلم اختلفوا اختلافاً كبيراً في ترتيبها وأيها يبدأ وأيها ينتهي وما بين ذلك.','5','14',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (132,'<span data-type="title" id=toc-132>خروج الدجال ونزول عيسى ابن مريم عليه السلام</span>
...
والثانية: نزول عيسى.','5','15',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (133,'<span data-type="title" id=toc-133>خروج يأجوج ومأجوج</span>
...
ويأجوج ومأجوج أيضاً من أشراط الساعة الكبرى التي أعدت للحديث، وهي الثالثة.','5','16',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (134,'<span data-type="title" id=toc-134>خروج الدابة</span>
والرابعة: خروج الدابة: والدابة غاية ما يقال إنها حيوان يدب، وتقيم الحجة على الناس وتبين لهم أنهم لا يؤمنون بآيات الله عز وجل كما ورد في ظاهر الآية، لكن ما صفة هذه الدابة؟ ماذا تعمل في الناس؟ هذا أمر لم يثبت فيما أعلم فيه شيء تفصيلي.','5','17',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (135,'<span data-type="title" id=toc-135>طلوع الشمس من مغربها</span>
...
قول المؤلف: (وأشباه ذلك)، يقصد مثل الدخان الذي يظهر في السماء، وقد ورد في سورة الدخان، وقيل إن هذا الدخان مر وانتهى، وقيل إنه لم يأت بعد.','5','18',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (136,'<span data-type="title" id=toc-136>النار التي تسوق الناس إلى أرض المحشر</span>
...
فأقول: من القرائن ما يدل على أن هذه الخسوف هي المنابع الرئيسية للبترول والله أعلم وهذا ظن والظن لا يغني من الحق شيئاً! قال: (وأشباه ذلك مما صح به النقل)، يعني مما صح في الكتاب والسنة.','5','19',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (137,'<span data-type="title" id=toc-137>عذاب القبر ونعيمه</span>
...
والميزان له كفتان ولسان كما ورد في النصوص، وهذا رد على أفراخ الفلاسفة وأفراخ العقلانيين قديماً وحديثاً من الذين زعموا أن الميزان أمر معنوي وليس بحقيقي، وأنه يعني العدل.','5','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (141,'<span data-type="title" id=toc-141>حوض النبي صلى الله عليه وسلم والصراط</span>
...
قال: (يجوزه الأبرار)، بمعنى يتجاوزونه ويمرون به، (ويزل عنه الفجار) بمعنى أنهم يتكردسون في نار جهنم.','5','24',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (142,'<span data-type="title" id=toc-142>الإيمان بالشفاعة</span>
...
وورد أن الصيام له شفاعة، وورد أن أطفال المسلمين الذين يموتون قبل سن البلوغ إذا احتسبهم والدوهم فإنهم يشفعون لهم، وهذا ثابت في الحديث عن النبي صلى الله عليه وسلم.','5','25',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (143,'<span data-type="title" id=toc-143>الإيمان بالجنة والنار</span>
...
والحديث كما ترون رواه البخاري ورواه مسلم، والأحاديث في ذلك كثيرة.','5','26',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (144,'<span data-type="title" id=toc-144>الأسئلة</span>','5','27',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (145,'<span data-type="title" id=toc-145>وجود الدجال وقبول التوبة بعد خروجه</span>
...
وكثير من الصحابة كانوا يرون أنه هو الدجال فتنوا به وأن الله عصمهم من فتنته وهناك أدلة وقرائن أخرى كثيرة، وبعضهم قال: لا، إنه يقال له الدجال بمعنى أنه دجال من الدجالين.','5','28',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (146,'<span data-type="title" id=toc-146>معنى القول بأن الأعمال من لوازم الإيمان</span>

<span data-type="title">السؤال</span>
  ما معنى قول مرجئة الجهمية إن الأعمال من لوازم الإيمان؟

<span data-type="title">الجواب</span>
  هؤلاء ليسوا مرجئة الجهمية، مرجئة الجهمية لا يقولون الأعمال من لوازم الإيمان، والذين يقولون الأعمال من لوازم الإيمان مرجئة الفقهاء، وإذا كنت قد قلت مرجئة الجهمية فهذه زلّة مني، أو سبق لسان فالذين يقولون الأعمال من لوازم الإيمان مرجئة الفقهاء وهم غير مرجئة الجهمية، أما مرجئة الجهمية فإنهم لا يدخلون الأعمال في الإيمان أبداً، ويرون أن الإيمان التصديق، والعمل لا أثر له لا في خير ولا في شر، وهؤلاء يسمون غلاة المرجئة.','5','29',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (147,'<span data-type="title" id=toc-147>حكم وعظ الناس بعد دفن الميت</span>

<span data-type="title">السؤال</span>
  هل يصح أن يوعظ الناس بعد دفن الميت استدلالاً بالحديث؟

<span data-type="title">الجواب</span>
  نعم يجوز وعظ الناس لكن بقدر، أي أنه لا يأخذ الوعظ ترتيبات خطابية وأن يقوم خطيب وراء خطيب، وجمهرة أو استعمال مكبرات إنما يوعظون بكلمات معدودات لا يكون لها شيء من الإجراءات التي ربما تكون وسيلة لعمل البدع، والجنائز دائماً من وسائل انتشار البدع، بإضافة الأعمال حولها مما لم يُشرع في السنة، وأعظم من ذلك الكلمات التي تُلقى عند انتظار الجنازة في المساجد، هذا في الحقيقة يُخشى أن يكون بداية البدع، فلا ينبغي أن تُستغل تجمعات الناس للصلاة على الجنازة للخطابة والكلام، فإن هذه بدايات البدع؛ لأنه يأتي يوم من الأيام يقول الناس: ما دام فلان اجتُمع له وتكلم الشيخ الفلاني عند جنازته، إذاً صاحبنا من الأموات أولى وله حق علينا، فيستدعون الشيخ فلاناً والواعظ فلاناً فتبدأ مسألة المآتم التي حدثت في البلاد الأخرى إذاً فينبغي سد هذا الباب إلا الوعظ المحدود الذي ورد مثله عن النبي صلى الله عليه وسلم، على نحو ما ورد بلا زيادة مع الاحتياط الشديد؛ لأن الناس الآن توفرت لديهم الوسائل، ممكن أن يأخذ بشكل أوراق ومنشورات أو مكبرات أو حفلات خطابية إلى آخره، فينبغي لطلاب العلم أن يتنبهوا فلا يُترك الوعظ إطلاقاً ولا يُفتح الباب على مصراعيه.','5','30',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (148,'<span data-type="title" id=toc-148>معنى ورود يأجوج ومأجوج من كل حدب وصوب</span>
...
أما أنهم لا يستنبتون من الأرض فنعم، لأنهم شعب من الشعوب من ذرية آدم والله أعلم.','5','31',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (149,'<span data-type="title" id=toc-149>حياة البرزخ للذين تقوم عليهم الساعة</span>

<span data-type="title">السؤال</span>
  هل الذين تقوم عليهم الساعة في أرض المحشر في الشام يكون لهم حياة برزخية؟

<span data-type="title">الجواب</span>
  نعم، أن لهم حياة برزخية لأنه يوجد بين الحياة الأولى والأخرى زمن، وبين النفختين زمن.','5','32',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (150,'<span data-type="title" id=toc-150>أنواع الناس في أخذ الصحف في أرض المحشر</span>
...
فإذاً هم من حيث السعادة والشقاوة صنفان، ومن حيث نوع الأخذ ثلاثة أصناف.','5','33',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (151,'<span data-type="title" id=toc-151>وصف الله تعالى بأنه كتب بيده</span>

<span data-type="title">السؤال</span>
  هل يصح أن أقول اللفظة التالية: أن من صفات الله أنه كتب بيده؟

<span data-type="title">الجواب</span>
  هذا فعل من أفعال الله وليس من صفاته، نعم اليد صفة من صفات الله عز وجل تُثبت له كما يليق بجلاله، أما الكتابة باليد فقد ورد عن الله عز وجل أنه كتب كذا بيده كما كتب الصحف وكتب التوراة، فعلى هذا يكون إضافة الكتب إضافة فعل من أفعال الله عز وجل ليست إضافة صفة، واليد صفة.','5','34',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (152,'<span data-type="title" id=toc-152>قرائن القول بأن الخسف يكون في منابع البترول</span>
...
أما القرائن فإن الإشارة إلى أن الخسوف في ثلاثة أماكن واضحة أن المقصود بها الأماكن التي تشمل أقصى الشرق وأقصى الشمال، وأقصى الغرب وأقصى الشرق والوسط، وإذا تأملنا منابع البترول وجدناها في هذه الأماكن الثلاثة، والمنابع كما يذكر كثير من المختصين الآن قد تؤثر على الأرض فيما بعد إذا كثر استنفاذ البترول من الأرض، وأُخذت كميات ضخمة هائلة.','5','35',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (153,'<span data-type="title" id=toc-153>عذاب القبر لقوم فرعون</span>

<span data-type="title">السؤال</span>
  هل الآية الواردة في قوم فرعون: {يُعْرَضُونَ عَلَيْهَا غُدُوًّا وَعَشِيًّا} [غافر:٤٦] تدل على عذاب القبر؟ وما هي وجه الدلالة؟

<span data-type="title">الجواب</span>
  طبعاً ورد في الحديث صحيح أنهم يعذبون في قبورهم، وأن هذا نوع من عذاب القبر لهم.','5','36',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (154,'<span data-type="title" id=toc-154>مصطلح السمعيات</span>
...
<span data-type="title">الجواب</span>
  نعم، من حيث إنه مصطلح يلتزم أو يُعتقد ليس بذلك، لكنه مصطلح متعارف عليه في إطلاقه على الأمور التي وردت في النص في القرآن والسنة، ولا مشاحة في الاصطلاح، والسلف أطلقوه بعد شهرته على الأمور الغيبية لأنه وصف صادق عليها، وكونه يوافق مصطلحات المتكلمين فهذا لا يضر إذا كان المصطلح صحيحاً وليس عليه غبار؛ لأنه حتى عند المتكلمين مفهوم السمعيات مفهوم يوافق ما جاء به الشرع، فإذاً: لا حرج في إطلاقه.','5','37',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (155,'<span data-type="title" id=toc-155>رؤية النبي صلى الله عليه وسلم ربه في حادثة المعراج</span>

<span data-type="title">السؤال</span>
  هل رأى النبي صلى الله عليه وسلم ربه في حادثة الإسراء والمعراج؟

<span data-type="title">الجواب</span>
  نعم رأى ربه؛ لكن الراجح أنها رؤية قلبية بفؤاده كما ثبت عن ابن عباس وكثير من الصحابة، وأن النبي صلى الله عليه وسلم لما سئل: هل رأيت ربك؟ قال: (نور أنى أراه) في حين أنه أثبت رؤية ربه في أحاديث أخرى في المعراج، وفي النوم حينما قال: (رأيت ربي البارحة)، ولذلك ما ورد عن الصحابة وعن السلف من إنكار الرؤية ينصرف إلى إنكار الرؤية البصرية، وما ورد من ثبوت الرؤية يصرف إلى الرؤية القلبية.','5','38',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (156,'<span data-type="title" id=toc-156>استخدام عبارة (تحقيقاً لا تعليقاً)</span>

<span data-type="title">السؤال</span>
  هل يجوز لأحد أن يستخدم هذه الجملة: تحقيقاً لا تعليقاً، أم أن لها شروطاً؟

<span data-type="title">الجواب</span>
  أي: كأن يقول: المسلمون سينتصرون إن شاء الله تحقيقاً لا تعليقاً، فهذا جزم بوعد الله وبالنصر مثلاً، وهذا كلام من عندي، لكن هو جعل السؤال مجملاً: هل يجوز لأحد أن يستخدم هذه الجملة: (تحقيقاً لا تعليقاً)؟ والجواب: حسب المقام، أما دائماً فلا، أما إذا كان المقام يقتضيها كأن يؤكد على أمر عنده يقين به لكن لا بد من الاستثناء فيه فيجعل الاستثناء استثناءً راجعاً إلى مشيئة الله لا إلى وعده، فيقصد به الجزم بوعد الله، وتعليق المشيئة على الله عز وجل، فهذا لا مانع منه لكن بشرط ألا يكون استعمالها دائماً، لأن فيه نوع تأل على الله عز وجل.','5','39',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (157,'<span data-type="title" id=toc-157>موت إسرافيل</span>

<span data-type="title">السؤال</span>
  في النفخ الأول في الصور هل يموت إسرافيل؟ وإن كان يموت فمن الذي ينفخ النفخة الثانية؟

<span data-type="title">الجواب</span>
  يظهر من النصوص أنه يموت، ويحيا بإذن الله ثم ينفخ النفخة الثانية، وذلك كله راجع إلى قدرة الله عز وجل، على أي حال ما عندي في هذا ما أتذكره من النصوص، لكن عموم النصوص تدل على أنه يموت، وأن الله عز وجل يحييه فينفخ في الصور.','5','40',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (158,'<span data-type="title" id=toc-158>من هم الذين يخرجون من النار</span>
...
وقيل: بل هذا أمر راجع إلى مشيئة الله عز وجل، وقد يشمل ذلك الكفار الخلّص، والله على كل شيء قدير، ليبين لعباده أنه يفعل ما يشاء، وأنه لا يتألى عليه أحد.','5','41',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (159,'<span data-type="title" id=toc-159>حكم الاستثناء في الإسلام</span>

<span data-type="title">السؤال</span>
  هل يجوز الاستثناء في الإسلام؟

<span data-type="title">الجواب</span>
  لا؛ لأن الإسلام عمل الاستثناء يكون في الإيمان، مع أن بعض أهل العلم قال: إن حكم الإيمان وحكم الإسلام واحد، يقول: أنا مسلم إن شاء الله أو مؤمن إن شاء الله، لكن الغالب أن الإسلام لا يرد فيه الاستثناء؛ لأنه أمر ظاهر، أما الإيمان فأغلبه متعلق بالأمر الباطن، فلذا أغلب الاستثناء إنما يكون في الإيمان.','5','42',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (160,'<span data-type="title" id=toc-160>استثناء الشفاعة لأبي طالب من بين الكفار</span>

<span data-type="title">السؤال</span>
  يقول المؤلف: (ولا تنفع الكافر شفاعة الشافعين)، وقد ذكرت الشفاعة لأبي طالب وهو كافر؟

<span data-type="title">الجواب</span>
  نعم، لا تنفع الكافر شفاعة الشافعين، أما ما ورد في حق أبي طالب فهو مخصوص به وليس لغيره، لذلك قال بعض أهل العلم: إنه لا يجوز أن نقول: إن من شفاعة النبي صلى الله عليه وسلم أنه يشفع لبعض أهل النار، وإنما نقول: يشفع لعمه أبي طالب، وهذا هو الراجح.','5','43',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (161,'<span data-type="title" id=toc-161>الفرق بين العرض والحساب</span>

<span data-type="title">السؤال</span>
  ما هو الفرق بين العرض والحساب؟

<span data-type="title">الجواب</span>
  الفرق بين العرض والحساب، أن الحساب جزء من العرض، والعرض أشمل من الحساب، فالعرض يشمل الوقوف والحساب، أما الحساب فهو بعد الوقوف.','5','44',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (162,'<span data-type="title" id=toc-162>سماع أهل القبور من يزورهم ويدعو لهم</span>

<span data-type="title">السؤال</span>
  هل أهل القبور يسمعون من يزورهم ويدعو لهم؟

<span data-type="title">الجواب</span>
  من يأتي القبور فيسلم عليهم يردون عليه السلام ويسمعونه، أما من يدعو لهم خارج القبور فإنهم لا يسمعونه، إلا أنه ورد أشياء محدودة لا تدل على استمرار سماعهم لما يفعل غيرهم، أما من يزورهم فإنهم ترد عليهم أرواحهم ويردون عليه السلام ويسمعون ما يقول.','5','45',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (163,'<span data-type="title" id=toc-163>شرح لمعة الاعتقاد [٧]</span>
لقد فضل الله تعالى نبينا محمداً صلى الله عليه وسلم على جميع الخلق، وجعله خاتم النبيين وسيد المرسلين، وخصه بخصائص كثيرة تدل على فضله وعلو منزلته، وكذلك فضل أصحابه وأزواجه على سائر أصحاب الأنبياء من قبله، فهم خير الناس بعد الأنبياء عليهم السلام.','6','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (164,'<span data-type="title" id=toc-164>بعض خصائص النبي صلى الله عليه وسلم وخصائص أمته</span>
...
في هذا المقطع ذكر شيئاً من خصائص النبي صلى الله عليه وسلم وخصائص أمته.','6','2',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (165,'<span data-type="title" id=toc-165>محمد صلى الله عليه وسلم خاتم النبيين</span>
...
وهذا أمر بدهي من ضرورات الدين، أي معلوم من الدين بالضرورة؛ لأنه متواتر في النصوص وأجمعت عليه الأمة، ومعلوم من الدين بالضرورة من حيث إن الله عز وجل أقام الحجة برسالته، وبما أنزل إليه من القرآن والسنة، وبإقامة الحجة بالطائفة الظاهرة المنصورة على الأمم إلى قيام الساعة، فلا حاجة إلى النبوة بعده، وهو نبي لجميع الأمم عربها وعجمها.','6','3',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (166,'<span data-type="title" id=toc-166>محمد صلى الله عليه وسلم سيد المرسلين</span>
...
وسيادة النبي صلى الله عليه وسلم تعني تقدمه المطلق على جميع الناس؛ لأن المرسلين هم أفضل الناس وإذا كان هو سيدهم في الدنيا والآخرة، فإذاً هو سيد الناس جميعاً بما فضله به الله عز وجل.','6','4',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (167,'<span data-type="title" id=toc-167>لا يصح إيمان عبد حتى يؤمن برسالة محمد صلى الله عليه وسلم</span>
...
وقوله: (ويشهد بنبوته) تابع لما قبله.','6','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (168,'<span data-type="title" id=toc-168>الشفاعة العظمى</span>
رابعاً: (ولا يقضى بين الناس يوم القيامة إلا بشفاعته) وهي الشفاعة العظمى، وهي من المقام المحمود الذي سيأتي ذكره، بمعنى أن الناس يوم القيامة يبقون في الحشر يموج بعضهم في بعض، ولا يجدون من يشفع لهم، حتى يتصدى للشفاعة محمد صلى الله عليه وسلم، فيشفع عند ربه بذلك المقام العظيم.','6','6',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (169,'<span data-type="title" id=toc-169>دخول أمة محمد صلى الله عليه وسلم الجنة قبل الأمم</span>
خامساً: (أنه لا يدخل الجنة أمة إلا بعد دخول أمته) يعني أن هذه الأمة أمة النبي صلى الله عليه وسلم هي أول الأمم دخولاً للجنة.','6','7',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (170,'<span data-type="title" id=toc-170>محمد صلى الله عليه وسلم صاحب لواء الحمد</span>
سادساً: (أنه صلى الله عليه وسلم صاحب لواء الحمد) ولواء الحمد ورد ذكره في السنة، والمقصود به أن النبي صلى الله عليه وسلم يوم القيامة يتقدم بأمته جميع الأمم وجميع المرسلين، للواء يرفعه وتكون اللواءات كلها بعده، واللواء هو علم كما هو معروف يرفعه النبي صلى الله عليه وسلم وتكون وراءه أمته، ويكون هو المقدم أو صاحب اللواء في هذا المقام.','6','8',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (171,'<span data-type="title" id=toc-171>محمد صلى الله عليه وسلم صاحب المقام المحمود</span>
سابعاً: (أنه صلى الله عليه وسلم صاحب المقام المحمود) وهو بمعنى الشفاعة التي مر ذكرها، لكن المقام المحمود قد يتفرع إلى مقامات، من ضمنها الشفاعة العظمى، وبعضهم يدخل في ذلك شفاعته صلى الله عليه وسلم لأهل الجنة أن تفتح لهم أبوابها.','6','9',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (172,'<span data-type="title" id=toc-172>محمد صلى الله عليه وسلم صاحب الحوض المورود</span>
...
وعلى أي حال فالنبي صلى الله عليه وسلم ورد في حوضه صفات مميزة في طوله وعرضه، وفي آنيته وفيمن يرد إلى آخره، كما أنه ورد أن لكل نبي حوضاً، لكن حوض النبي صلى الله عليه وسلم هو أعظمها.','6','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (173,'<span data-type="title" id=toc-173>محمد صلى الله عليه وسلم إمام النبيين</span>
تاسعاً: (أنه إمام النبيين) والإمامة أخص من السيادة من جانب؛ لأن الإمامة تعني الإمامة في الدين، والسيادة تعني السيادة في الدين والدنيا، فهو صلى الله عليه وسلم إمام النبيين من كل وجه، حتى في الصلاة فقد صلى بهم صلى الله عليه وسلم في بيت المقدس في أثناء الإسراء كما هو معلوم، كما أنه إمامهم ومقدمهم أيضاً في الدنيا والآخرة.','6','11',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (174,'<span data-type="title" id=toc-174>محمد صلى الله عليه وسلم خطيب النبيين</span>
العاشر: (وخطيبهم) كما ورد في السنة أيضاً وذلك يوم القيامة.','6','12',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (175,'<span data-type="title" id=toc-175>محمد صلى الله عليه وسلم صاحب شفاعتهم</span>
...
هي المقدمة ابتداء بمعنى أنه هو الذي يبدأ الشفاعات صلى الله عليه وسلم، كما أنه شفاعته مقدمة على غيرها، ويستجاب له في شفاعته قبل أن يستجاب لغيره.','6','13',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (176,'<span data-type="title" id=toc-176>أمة محمد صلى الله عليه وسلم خير الأمم</span>
...
كما أن أمته ميزت بخصائص تشريعية كثيرة، كأن جعلت لهم الأرض مسجداً وطهوراً وغير ذلك مما هو معلوم.','6','14',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (177,'<span data-type="title" id=toc-177>فضل أصحاب رسول الله صلى الله عليه وسلم وترتيبهم في الفضل</span>
...
وكل من شهد له النبي صلى الله عليه وسلم بالجنة شهدنا له بها، كقوله: (الحسن والحسين سيدا شباب أهل الجنة)، وقوله لـ ثابت بن قيس: (إنه من أهل الجنة)].','6','15',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (178,'<span data-type="title" id=toc-178>أصحاب محمد صلى الله عليه وسلم خير أصحاب الأنبياء</span>
...
وهذا نستنتج منه عقيدة من عقائد السلف التي تميزوا بها عن غيرهم، في أنه يجب أن يحفظ لأصحاب رسول الله صلى الله عليه وسلم حقهم في الأفضلية، وفي العدالة، وفي وجوب حبهم وعدم جواز القدح واللمز فضلاً عن القول بما هو أعظم من ذلك فيهم.','6','16',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (179,'<span data-type="title" id=toc-179>أفضل الأمة أبو بكر ثم عمر ثم عثمان ثم علي</span>
...
ثم علي المرتضى، ولا أدري ما وجه تسميته بالمرتضى، فمن عرف في هذا قولاً فلا مانع أن يأتينا به ولو في الدرس القادم.','6','17',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (180,'<span data-type="title" id=toc-180>الأدلة على أفضلية الخلفاء الأربعة</span>
...
ثم ذكر أفضلية أبي بكر رضي الله عنه على وجه الخصوص، كقول النبي صلى الله عليه وسلم: (ما طلعت الشمس ولا غربت بعد النبيين والمرسلين على أفضل من أبي بكر) هذا يؤخذ منه -كما قلت- الدلالة القاطعة على أن أصحاب النبي صلى الله عليه وسلم هم أفضل أصحاب الأنبياء؛ لأنه إذا كان أفضل من طلعت عليه الشمس بعد النبيين، فهذا يدل بمنطوقه ومفهومه على أن أصحاب النبي صلى الله عليه وسلم أفضل أصحاب الأنبياء.','6','18',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (181,'<span data-type="title" id=toc-181>أحقية الخلفاء الأربعة للخلافة على الترتيب</span>
...
ومعاوية خال المؤمنين، وكاتب وحي الله، أحد خلفاء المسلمين رضي الله عنهم].','6','21',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (184,'<span data-type="title" id=toc-184>لا نجزم لأحد من أهل القبلة بجنة ولا نار</span>
...
القاعدة الثانية: أنا نرجو للمحسن أن يثيبه الله عز وجل على إحسانه، ونخاف على المسيء أن يقع عليه الوعيد.','6','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (186,'<span data-type="title" id=toc-186>لا نكفر أحداً من أهل القبلة بذنب</span>
...
كذلك في مماته لا يحكم عليه إذا مات على هذه الكبيرة بأنه كافر، وبعد مماته كذلك لا نقول إنه في الآخرة حكمه حكم الكفار، ولا نقول بأنه من المخلدين في النار، بل نقول إنه تحت مشيئة الله إذا مات على كبيرته وذنبه، إن شاء غفر له وإن شاء عذبه، ثم يجزم بأنه من عذب فيخرج بشفاعة النبي صلى الله عليه وسلم لأهل الكبائر من أمة الإسلام.','6','24',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (187,'<span data-type="title" id=toc-187>معنى الحج والجهاد مع كل إمام</span>
...
(مع كل إمام براً كان أو فاجراً) وهذه ستأتي فيما بعد.','6','25',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (188,'<span data-type="title" id=toc-188>الصلاة خلف الأئمة</span>
...
(ولا نخرجه من الإسلام بعمل، والجهاد ماض منذ بعثني الله عز وجل حتى يقاتل آخر أمتي الدجال، لا يبطله جور جائر، ولا عدل عادل، والإيمان بالأقدار)، كل هذه وردت مستقلة في أحاديث أخرى، وإن كان هذا السياق ضعيف وسياق متنه يدل على ضعفه.','6','26',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (189,'<span data-type="title" id=toc-189>تولي أصحاب رسول الله صلى الله عليه وسلم</span>
ثم رجع إلى أصحاب رسول الله صلى الله عليه وسلم، فبعدما ذكر خصوصهم ذكر عمومهم.','6','27',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (190,'<span data-type="title" id=toc-190>الأسئلة</span>','6','28',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (191,'<span data-type="title" id=toc-191>خلافة الحسن بن علي رضي الله عنه</span>
...
أما من تركها كسلاً وتهاوناً مع اعتقاده بوجوبها، فهو يصليها أحياناً ويتركها أحياناً، فهذا والله أعلم أن كفره كفر غير مخرج من الملة، لكن تجرى عليه الأحكام الأخرى.','6','30',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (193,'<span data-type="title" id=toc-193>حكم وضع نقاط بعد كتابة بعض الآيات</span>

<span data-type="title">السؤال</span>
  هل صحيح أنه لا يصح عند كتابة آية قرآنية وضع نقط عند عدم إرادة تكملة الآية، ذكر مثالاً: {قُلْ هُوَ اللَّهُ أَحَدٌ} [الإخلاص:١] الآية؟

<span data-type="title">الجواب</span>
  والله لا أدري، هل يجوز بعد ذكر بعض الآية أو آية من الآيات وضع نقط على أنه تليها الآية الأخرى، فهذا يحتاج إلى مراجعة.','6','31',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (194,'<span data-type="title" id=toc-194>الدليل على أن الخلفاء الراشدين هم الأربعة فقط</span>
...
فعلى أي حال المسألة خلافية ليس فيها قطع.','6','32',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (195,'<span data-type="title" id=toc-195>إطلاق الكفر على من مات كافراً</span>

<span data-type="title">السؤال</span>
  هل يجوز أن يقال لشخص كافر قد مات بأنه كافر؟

<span data-type="title">الجواب</span>
  نعم، إذا مات الإنسان على الكفر يقال إنه كافر بناء على أصل حاله في الدنيا، كمن مات يهودياً أو نصرانياً، أما إذا كان مسلماً ووقع في المكفرات من الكبائر، فإنا لا نحكم بأنه مات على الكفر.
واليهودي والنصراني كافر قطعاً وليس عندنا في هذا شك، والحكم لهم بالنار هذا في العموم، نقول اليهود والنصارى من أهل النار جزماً، لكن لا نستطيع أن نقول بذلك لشخص بعينه فنحن نحكم على الكافر أنه من أهل النار، لكن لا نجزم بذلك في عينه.','6','33',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (196,'<span data-type="title" id=toc-196>حكم من لم يصلهم الإسلام</span>

<span data-type="title">السؤال</span>
  ما حكم التوقف في حال من لم يصلهم الإسلام، فلم نجزم لهم بنار ولا بجنة؟

<span data-type="title">الجواب</span>
  المهم أن هؤلاء الذين يموتون لا ندري عن حالهم، بلغتهم الحجة أو ما بلغتهم، وإذا كان يظهر من القرائن أنه لم تبلغهم الحجة وهذا نادر جداً، فنقول: إن الأصل فيهم أنهم كفار لكن مآلهم في القيامة إلى الله عز وجل.
والذي يموت على غير ملة نقول: مات على غير الإسلام، مات على الكفر، حتى لو لم تبلغه الحجة مثل أهل الفترة، لكن الكلام في مصيرهم في القيامة هو الذي لا نحكم به.','6','34',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (197,'<span data-type="title" id=toc-197>حكم إطلاق لفظ (سيدنا) على الرسول صلى الله عليه وسلم</span>

<span data-type="title">السؤال</span>
  قرأت في فتاوى اللجنة الدائمة أنه لا يجوز أن يقال للرسول صلى الله عليه وسلم (سيدنا)، لكن نجد في مقدمة بعض الكتب هذه الكلمة، سيدنا محمد صلى الله عليه وسلم، فما رأيكم؟

<span data-type="title">الجواب</span>
  على أي حال هذه مسألة خلافية، والنبي صلى الله عليه وسلم نهى أن يقال له سيد، فالأولى هو الأدب مع كلام النبي صلى الله عليه وسلم، لكن إذا ورد في كلام أهل العلم في الكتاب نقرؤها على ما وردت، على أساس أننا نقول بأن هذا العالم اجتهد ورجح جواز إطلاق كلمة (سيد) وقال بها.
...
فمن هنا تبقى المسألة خلافية، والراجح عدم إطلاق هذه الكلمة امتثالاً لأمر النبي صلى الله عليه وسلم.','6','35',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (198,'<span data-type="title" id=toc-198>تكفير من مات تاركاً للصلاة</span>

<span data-type="title">السؤال</span>
  إذا ثبت عندي أن فلاناً لا يصلي ومات على ذلك، فهل يجوز لي أن أقول هذا كافر؟

<span data-type="title">الجواب</span>
  هذه كلمة مجملة، فكثيراً ما يظن بعض الناس أن الحكم يأتي بسهولة من خلال الأسئلة، بعضهم يقول: عندي جار أو أخ لا يصلي، فنسأله كيف عرفت أنه لا يصلي، قال: ما رأيته مرة يصلي، فرق بين كونك ما رأيته وكونك تحققت بأنه لا يصلي، فقد يصلي في قعر بيته، قد يصلي إذا خلا بربه، قد يصلي إذا انفرد عن الناس في أي مكان في البيت أو في غير البيت، هذه مسألة تحتاج إلى نوع من التفصيل، أما إذا ثبت أنه لا يصلي على الإطلاق، فالراجح كفره، وتجرى عليه أحكام الكفر في التعامل والدفن والإرث وغير ذلك.','6','36',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (199,'<span data-type="title" id=toc-199>نهي النبي صلى الله عليه وسلم عن تفضيله على يونس بن متى</span>

<span data-type="title">السؤال</span>
  قرأت في قصص الأنبياء لـ ابن كثير قصة يونس، وفيها قوله صلى الله عليه وسلم: (لا تفضلوني على الرسل ولا يونس بن متى)؟

<span data-type="title">الجواب</span>
  ورد أن النبي صلى الله عليه وسلم قال: (لا تفضلوني على يونس بن متى) لكن هذا محمول على التواضع منه صلى الله عليه وسلم، أما كونه أفضل الأنبياء فقد صرح به في نصوص أخرى، كقوله صلى الله عليه وسلم: (فضلت على النبيين بست) وفي رواية: (بخمس).','6','37',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (200,'<span data-type="title" id=toc-200>حكم الخوض فيما شجر بين الصحابة</span>

<span data-type="title">السؤال</span>
  ما حكم الخوض فيما وقع بين الصحابة رضي الله عنهم أجمعين من خلاف، وخصوصاً ما وقع بين علي ومعاوية، وتخطئة أحدهما وتصويب الآخر؟
...
هذه مسألة لا نخوض فيها، ونعلم أن الذين أخطئوا أخطئوا عن اجتهاد ولهم أجر، فلا يقدح ذلك في ذممهم؛ لأنهم يريدون الخير، وإلا فالأقرب أن الفئة التي مع علي رضي الله عنه كانت هي الفئة المحقة، والفئة التي مع معاوية رضي الله عنه هي الفئة المخطئة، لكنهم لم يعرفوا أنهم على خطأ إلا فيما بعد، حتى أن بعضهم صرح، بل بعضهم أدرك أنه على خطأ أثناء الفتنة، كما حصل من طلحة والزبير، فكل منهما لما ذكره بعض الصحابة بأحاديث نسيها عن النبي صلى الله عليه وسلم عرف أنه على خطأ، فهربوا من المعركة، ولحقهم أهل البدع وقتلوهم، وهذه من سمات الفتن.','6','38',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (201,'<span data-type="title" id=toc-201>حكم من يوالي اليهود والنصارى ويأخذ بتشريعاتهم</span>

<span data-type="title">السؤال</span>
  هل يكفر من يوالي اليهود والنصارى، ويأخذ تشريعاتهم، ويهنئهم على كل شيء؟

<span data-type="title">الجواب</span>
  الولاء للكفار قد يكون كفراً وقد يكون معصية، وهذه مسألة لا بد من التفصيل فيها، فليس كل ولاء للكفار كفراً، بل الموالاة القلبية العامة بجملتها كفر، لكن صور الولاء ومفردات الولاء وجزئيات الولاء ليست كلها كفراً، بدليل ما حدث في عهد الصحابة أنفسهم وما بعده، كما حصل في قصة الصحابي حاطب بن أبي بلتعة رضي الله عنه الذي كتب للمشركين يخبرهم بأن النبي صلى الله عليه وسلم وأصحابه قادمون إليهم، وكما حدث من بعض الخلفاء وغير الخلفاء في عهد بني أمية، وعهد بني العباس، بل حدث من بعض الذين يعدون من أهل التقوى والصلاح، أنه اضطر يوماً من الأيام بأن يفعل ما يظنه بعض الناس ولاء للكفار، وحدث من أناس قاتل معهم المسلمون في عهد الدويلات، فالمسألة تحتاج إلى شيء من التفصيل.','6','39',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (202,'<span data-type="title" id=toc-202>حكم إطلاق صفة الشهيد من باب الرجاء</span>

<span data-type="title">السؤال</span>
  هل يصح قول: (الشهيد فلان) من باب الرجاء والتمني؟

<span data-type="title">الجواب</span>
  لا تطلق كلمة شهيد إلا على من مات في معركة شرعية أو بإحدى طرق الشهادة التي ذكرها النبي صلى الله عليه وسلم، أما ما عدا ذلك فلا يجوز الحكم على فلان بمجرد أنه مات أو قتل أي قتلة أنه شهيد، فالتجوز في هذا فيه نظر.','6','40',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (203,'<span data-type="title" id=toc-203>حكم من ادعى النبوة وعنده انفصام في الشخصية</span>

<span data-type="title">السؤال</span>
  ما الحكم في رجل يدعي أنه نبي في الوقت الحاضر مع أنه يقال أنه مصاب بمرض انفصام الشخصية؟

<span data-type="title">الجواب</span>
  على أي حال، هذا إن كان مريضاً فهو مجنون ويعامل معاملة المجانين، لكن قد لا يكون مريضاً، فيترك الإجراء في حقه إلى المحاكم الشرعية.','6','41',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (204,'<span data-type="title" id=toc-204>خلافة الراشدين خلافة نبوة</span>

<span data-type="title">السؤال</span>
  الخلفاء الراشدون المهديون، هل هذه خلافة نبوة أم خلافة ملك؟

<span data-type="title">الجواب</span>
  الخلفاء الراشدون خلفاء نبوة، كانوا يسمون أبا بكر خليفة رسول الله صلى الله عليه وسلم، وسموا عمر خليفة خليفة رسول الله صلى الله عليه وسلم، لكن لما طالت الإضافات تركوها، وإلا فالمقصود خلافة النبي صلى الله عليه وسلم في أمته بحق وعدل ورشد.
فالخلفاء الراشدون هم خلفاء النبي صلى الله عليه وسلم بأمته بحق وعدل، وليست خلافة ملك.','6','42',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (205,'<span data-type="title" id=toc-205>أفضلية الصحابة على غير الأنبياء</span>

<span data-type="title">السؤال</span>
  ما معنى قولك: (وأصحابه خير أصحاب الأنبياء من قبله ومن بعده)؟!

<span data-type="title">الجواب</span>
  إذا كنت قلت: (من بعده)، فهو سهو مني، نعم أصحاب النبي صلى الله عليه وسلم خير أصحاب الأنبياء جميعاً بدون كلمة (من قبله ومن بعده)، فالأنبياء كلهم من قبله وهو آخر الأنبياء، فهذا سهو مني أرجو أن لا تأخذوا به.
...
وصلى الله وسلم وبارك على نبينا محمد وعلى آله وصحبه أجمعين.','6','43',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (206,'<span data-type="title" id=toc-206>شرح لمعة الاعتقاد [٨]</span>
من أصول أهل السنة والجماعة السمع والطاعة لأولي الأمر وأئمة المسلمين وإن جاروا، وذلك في غير معصية، ومن أصولهم هجر المبتدعة، وترك النظر في كتبهم، وعدم الإصغاء إلى كلامهم، وعدم التسمي بغير الإسلام والسنة.','7','1',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (207,'<span data-type="title" id=toc-207>السمع والطاعة لأئمة المسلمين</span>
...
في هذا المقطع يقرر المؤلف رحمه الله أصلاً من أصول السنة.','7','2',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (208,'<span data-type="title" id=toc-208>من السنة طاعة أئمة المسلمين في غير معصية</span>
...
وعلى أي حال كل هذه الألفاظ هي ولاية للمسلمين، الخليفة والإمام والسلطان والملك والأمير والرئيس، أو ما اصطلح الناس على اسمه، فالعبرة بوصفه، ما دام وصفه أن يكون أميراً أو والياً لأمر المسلمين بأي وصف وبأي اسم، فإن له حق السمع والطاعة ما لم يأمر بمعصية.','7','3',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (209,'<span data-type="title" id=toc-209>وجوب طاعة ولي الأمر براً كان أو فاجراً</span>
ثم قال: (برهم وفاجرهم).
...
والمعاصي تتفاوت فإن السمع والطاعة بالمعروف لا يعني ترك إنكار المنكر كما يفهم بعض الناس، فهذا أيضاً فهم معكوس كفهم من ظن أن من عصى لا يُطاع مطلقاً، فإنه لا طاعة لأحد في معصية الله، وإن كان خليفة أو سلطاناً أو أميراً أو والياً أو ملكاً، لكن لا تنزع منه يد الطاعة.','7','4',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (210,'<span data-type="title" id=toc-210>طاعة من ولي الخلافة ورضي به الناس أو غلبهم بسيفه</span>
...
وهذه القواعد كلها أيضاً مبنية على نصوص وقد أجمع عليها السلف، ولذلك عدوا من خالف في أمر من هذه الأمور من أهل الأهواء.','7','5',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (211,'<span data-type="title" id=toc-211>الحكم على ولاة الأمر من حيث البر والفجور</span>
...
إذاً: من ضمن هذا أيضاً ما يتعلق بالولاية والعزل والسلطة وغيرها، فهذه ترجع إلى أهل الحل والعقد من العلماء ومن كان في سبيلهم ممن يعرف للعلماء اعتبارهم من أهل الرأي والمشورة من الرؤساء والقواد وغيرهم هؤلاء لهم اعتبارهم لأنهم يرجعون إلى العلماء، فإذا لم يرجعوا للعلماء فلا اعتبار لهم.','7','7',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (213,'<span data-type="title" id=toc-213>منهج أهل السنة في معاملة أهل الأهواء</span>
...
في هذا المقطع ذكر منهج أهل السنة والجماعة في معاملة أهل الأهواء، وذكر من ذلك أصولاً أولها: هجران أهل البدع.','7','8',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (214,'<span data-type="title" id=toc-214>أنواع الهجر</span>
...
بمعنى أنه ليس كل من حمل راية الثقافة أو حصل على الشهادة أو على كذا من الألقاب نركن إليه في ديننا ونطمئن إلى مشورته، فيما نقرأ وما نترك؟ بل الغالب أن هذا النوع يحتاج إلى توجيه، ولو بلغ الستين والسبعين وما فوق ذلك من عمره، كما يحتاج صبياننا في الكتاتيب.','7','10',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (216,'<span data-type="title" id=toc-216>ترك الإصغاء إلى كلام المبتدعة</span>
...
أما اللمز والرمي والاتهام فلا يقع على صاحبه، لذلك المشركون لما عيّروا النبي صلى الله عليه وسلم بغير ما هو عليه لم يكن لهذا التعيير أي أثر فلم يصدقه أحد ولا صدقوه هم أنفسهم، أليسوا سموا النبي صلى الله عليه وسلم -وحاشاه من ذلك- بمذمم؟ هل هو في الحقيقة مذمم؟ إذاً ما وقع عليه الاسم لا شرعاً ولا عقلاً ولا عرفاً، فهذا الاسم لم يكن له أثر، وكأن الله عز وجل صرفهم عن تعييره أو أن يقع عليه السب، فكذلك أسماء أهل السنة أو ألقابهم التي عيرهم بها خصومهم ما دامت لا تقع شرعاً ولا عقلاً ولم يلتزمها أهل السنة فإنها لا تؤثر، إنما الكلام على غير ذلك مما ذكرت.','7','14',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (220,'<span data-type="title" id=toc-220>التعريف بالشيعة والرافضة</span>
...
ومن هذه الفئة الثانية من سيخرج في آخر الزمان، كما ذكر النبي صلى الله عليه وسلم في الحديث الصحيح: (سيخرج أناس حدثاء الأسنان سفهاء الأحلام، يقولون من خير قول البرية) ثم قال في آخره: (فإذا لقيتموهم فاقتلوهم فإن لمن قتلهم الجنة) فلذلك احتسب الصحابة قتال الخوارج عند الله عز وجل، وفرحوا عندما علموا أنهم هم الذين ينطبق عليهم حديث النبي صلى الله عليه وسلم، حتى يشملهم الوعد الذي ذكره النبي صلى الله عليه وسلم في الجنة.','7','17',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (223,'<span data-type="title" id=toc-223>التعريف بالقدرية والمرجئة</span>
...
على أي حال هذا النوع بدعة لكن ليست بدعة مغلّظة.','7','18',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (224,'<span data-type="title" id=toc-224>التعريف بالمعتزلة</span>
...
وكل صاحب هوى يصر على هواه ويخالف أهل الحق والسنة، فإنه لا بد وأن يبتلى بأهواء أخرى، فلذلك واصل بن عطاء وعمرو بن عبيد ليس عندهم في أول الأمر من المخالفات إلا هذه فقط، لكنهم فيما بعد صاروا أصحاب أصول خمسة كلها تخالف أهل السنة والجماعة، منها التعطيل وإنكار الصفات، ومنها مفهوم الأمر بالمعروف والنهي عن المنكر، قالوا: إنه لا يؤخذ من الأمر بالمعروف والنهي عن المنكر إلا الخروج على الحكام فقط.','7','19',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (225,'<span data-type="title" id=toc-225>التعريف بالكرامية</span>
قال: (والكرامية)، وهم أتباع ابن كرام وقد نُسب إليه المبالغة في إثبات الصفات، حتى وصفه خصومه بأنه مشرّك، ومما نسب إلى الكرامية القول بأن الإيمان هو قول اللسان فقط، فهذه من أشنع أقوال الكرّامية.','7','20',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (226,'<span data-type="title" id=toc-226>التعريف بالكلابية</span>
...
ثم قال: (ونظائرهم) أي: من فرق الضلال ممن جاءوا بعدهم أو عاصروهم، وطوائف البدع ممن لم يسمهم كالسالمية والمشبهة والأشاعرة والماتريدية ونحوهم كلهم أهل كلام وأهل بدع بحسب ما عندهم.','7','21',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (227,'<span data-type="title" id=toc-227>حكم الاختلاف في الفروع</span>
...
ونسأل الله أن ينفعنا بما علمنا، وأن يجعل ذلك في موازين أعمالنا، وصلى الله وسلم وبارك على نبينا محمد، وعلى آله وصحبه أجمعين.','7','22',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (228,'<span data-type="title" id=toc-228>الأسئلة</span>','7','23',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (229,'<span data-type="title" id=toc-229>أكثر الجرائد والمجلات في سبيل البدعة</span>

<span data-type="title">السؤال</span>
  هل الجرائد والمجلات من كتب المبتدعة؟

<span data-type="title">الجواب</span>
  أغلب الجرائد والمجلات في سبيل البدعة.','7','24',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (230,'<span data-type="title" id=toc-230>الفرق بين النهي عن المنكر والخروج على الحاكم</span>

<span data-type="title">السؤال</span>
  ما تقول فيمن لا يفرق بين الأمر بالمعروف والنهي عن المنكر والإصلاح، وبين الخروج على الحاكم؟

<span data-type="title">الجواب</span>
  على أي حال لا شك أن هذه أمور بينها حد يعرفه أهل العلم قديماً وحديثاً وليست جديدة، فالأمر بالمعروف والنهي عن المنكر له حد، وهو داخل في مفهوم الإصلاح، والخروج على الحاكم له حد أيضاً يفهمه أهل العلم، ولو رجع المتنازعون إلى أهل العلم لوجدوا في ذلك جواباً، مع أنه قد تبقى بعض المسائل يشتبه الأمر فيها هل هي داخلة في الخروج أو داخلة في الأمر بالمعروف والنهي عن المنكر؟ وهذه مسائل يحسم فيها أهل العلم.','7','25',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (231,'<span data-type="title" id=toc-231>التوفيق بين كون فعل العبد مخلوقاً لله وكسباً للعبد</span>

<span data-type="title">السؤال</span>
  قرأت في أحد شروح اللمعة من كلام ابن قدامة فقرة (٤٩) يقول: أقول: على أن للعبد فعلاً وكسباً، قال آخره: وهو واقع بقضاء اللَّه وقدره، كيف نوفق بين كون فعل العبد مخلوقاً لله وكونه كسباً للفاعل؟

<span data-type="title">الجواب</span>
  القول بالكسب ليس قول أهل السنة والجماعة، فأهل السنة والجماعة يقولون إن الإنسان مجبول، وإن فعله لا يخرج عن فعل الله عز وجل من ناحية، لكن عنده قدرة واستطاعة قبل الفعل وبعده، فإن وجدت العزيمة والإرادة والصحة فعل، وإن لم توجد لم يفعل، فأما القائلون بالكسب فيرون أن القدرة على الفعل لا توجد إلا أثناء الفعل تماماً وهذا هو الفارق بين أهل السنة وبينهم.
على أي حال لا تناقض على مفهوم السلف، أما على مفهوم المتكلمين الذين يقولون بالكسب فإن هناك نوعاً من التعارض عندهم.','7','26',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (232,'<span data-type="title" id=toc-232>زيارة المؤمنين لربهم في الجنة لم يثبت فيها حديث صحيح</span>
قبل أن أنسى المسألة التي ذكرناها في المرات الماضية وهي ما ذكره الشارح من زيارة المؤمنين لربهم في الجنة: فمن خلال البحث توصلت إلى أن الزيارة لم يرد فيها نص صحيح، لكن بعض أهل العلم استوحاها من نصوص الرؤية، ففهموا منها أنها تقتضي الزيارة بمفهوم اللقاء وبمفهوم تكرر الرؤية، وأضيف إلى هذا بعض الأحاديث الضعيفة التي استأنس بها بعض أهل العلم فأثبتوا من خلالها القول بالزيارة، لكن هذا ليس له دليل قاطع، فبعض أهل العلم يدخلها تبعاً للرؤية على أنها من فرعيات العقيدة، وبعضهم لا يدخلها أصلاً ويقول: لم يثبت في ذلك نص.','7','27',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (233,'<span data-type="title" id=toc-233>حكم سماع الإذاعات من الراديو</span>

<span data-type="title">السؤال</span>
  نهيتم عن الاستماع لآراء أهل البدع، فما رأيكم في من يستمع لبعض الإذاعات كالإذاعة البريطانية لقصد معرفة الأخبار فقط؟

<span data-type="title">الجواب</span>
  الاستماع لهذه الأجهزة والوسائل مما عمّت به البلوى، لكن سددوا وقاربوا، لا ينبغي للإنسان أن يدمن الاستماع لهذه الإذاعات، ومن أدمن تضرر، لكن أن يستمع الأخبار أحياناً وبعض البرامج التي يجد فيها فائدة بشرط ألا يتمادى، هذا القدر قد يفيد طالب العلم بحيث يكون على اطلاع على أحوال الأمة وأحوال العالم، وهذا يفيده في أمور الدعوة وفي التصورات عن أحوال الناس، هذا بقدر، لكن الإدمان على الإذاعات والصحف أظنه كقراءة كتب أهل البدع.','7','28',NULL,NULL,'0');
INSERT INTO [b37724] VALUES (234,'<span data-type="title" id=toc-234>تسمية أهل السنة بالسلفية</span>
...
وصلى الله وسلم وبارك على نبينا محمد، وعلى آله، وصحبه أجمعين.','7','34',NULL,NULL,'0');
