...
CREATE TABLE "b151138"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b151138
INSERT INTO [b151138] VALUES (1,'الكلام على قوله تعالى {إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ}','2','769',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (2,'بسم الله الرحمن الرحيم
...
{إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ}</span>
...
وذهبت طائفة من الأصوليين وأهل البيان إِلَى أن "ما" هذه نافية واستدلوا بذلك عَلَى إفادتها الحصر، وأن "إنَّ" أفادت الإثبات في المذكور و"ما" أفادت النفي فيما عداه، وهذا باطل باتفاق أهل المعرفة باللسان، فإن "إنَّ" إِنَّمَا تفيد توكيد الكلام إثباتًا كان أو نفيًا، لا تفيد الإثبات، و"ما"، زائدة','2','771',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (3,'كافة، لا ناقية، وهي الداخلة عَلَى سائر أخوات "إن": "لكن، وكأن، وليت، ولعل" وليست في دخولها عَلَى هذه الحروف نافية بالاتفاق، فكذلك الداخلة على "إن" و"أن".
...
INSERT INTO [b151138] VALUES (4,'أيضًا: هل دلالتها عَلَى النفي بطريق النص أو الظاهر؟
...
وأيضًا: فورودها لغير الحصر كثير جدًّا كقوله تعالى: {إِنَّمَا الْمُؤْمِنُونَ الَّذِينَ إِذَا ذُكِرَ اللَّهُ وَجِلَتْ قُلُوبُهُمْ وَإِذَا تُلِيَتْ عَلَيْهِمْ آيَاتُهُ زَادَتْهُمْ إِيمَانًا وَعَلَى رَبِّهِمْ','2','773',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (5,'يَتَوَكَّلُونَ} (١).
...
(٥) آل عمران: ٦٢.
(٦) الأعراف: ٥٩
(٧) البقرة: ١٩٨.','2','775',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (7,'للإخراج من الحكم لكن صار حقيقة عرفية في مناقضة المستثنى منه، وهذا يشبه بقل اللفظ عن المعنى الخاص إِلَى العام، إذا صار حقيقة عرفية فيه. كقولهم "لا أشرب له شربة ماء" ونحو ذلك، وكنقل الأمثال السائرة ونحوها مما ليس هذا موضع بسطه.
...
(١) الأنفال: ٢.
(٢) المائدة: ٦٨.
(٣) أخرجه البخاري (٦٢١٣، ٥٧٦٢، ٧٥٦١)، ومسلم (١٢٢، ١٢٣، ٢٢٢٨) من حديث عائشة وعندهما: "الكهان" بدلاً من "الكفار".','2','776',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (8,'ليس بشيء، إذا لم يكن مما ينتفع به في الرواية لظهور كذبه عمدًا أو خطأ.
ويقال أيضاً لمن خرج عن موجب الإنسانية في الأخلاق ونحوها: هذا ليس بآدمي ولا إنسان، وما فيه إنسانية، ومنه قول النسوة عن يوسف - صلى الله عليه وسلم -: {مَا هَذَا بَشَرًا إِنْ هَذَا إِلَّا مَلَكٌ كَرِيمٌ} [يوسف: ٣١]، وكذلك قول الله تعالى: {فَإِنَّهَا لَا تَعْمَى الْأَبْصَارُ وَلَكِنْ تَعْمَى الْقُلُوبُ الَّتِي فِي الصُّدُورِ} (١).
وقول النبي صلى الله عليه وسلم: «لَيْسَ الْمِسْكِينُ بِهَذَا الطَّوَّافِ الَّذِي تَرُدُّهُ اللُّقْمَةُ وَاللُّقْمَتَانِ، وَالتَّمْرَةُ وَالتَّمْرَتَانِ، إِنَّمَا الْمِسْكِينُ الَّذِي لَا يَجِدُ مَا يُغْنِيهِ، وَلَا يُفْطَنُ لَهُ فَيُتَصَدَّقَ عَلَيْهِ، وَلَا يَسْأَلُ النَّاسَ إِلْحَافًا» (٢).
...
وكذلك قوله - صلى الله عليه وسلم -: "لَيْسَ الشَّدِيدُ بِالصُّرعَةِ، وَلَكِنَّ الشَّدِيد الَّذِى يَمْلِكُ نَفْسَهُ عِنْدَ الْغَضَبِ" (٥).
وقوله - صلى الله عليه وسلم -: "لَيْسَ الْغِنَى عَنْ كَثْرَةِ الْعَرْضِ، وَإِنَّمَا الْغِنَى غِنَى النَّفْسِ" (٦). وأمثال ذلك.
_________
(١) الحج: ٤٦.
...
(٢) تقدم تخريجه.
(٣) (٢/ ١٠٩) وذكر الهيثمي في المجمع (٤/ ١١٣) وقال: وفيه أبو جناب، وهو ثقة ولكنه مدلس.','2','778',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (10,'فلهذا قيل: "إِنَّمَا الربا في النسيئة" و"لا ربا إلا في النسيئة"، فإن المستحق لاسم الربا في الحقيقة هو ربا النسيئة، وكذلك نفي الأسماء الشرعية لانتفاء بعض واجباتها، كقوله: {إِنَّمَا الْمُؤْمِنُونَ الَّذِينَ إِذَا ذُكِرَ اللَّهُ وَجِلَتْ قُلُوبُهُمْ} إِلَى قوله: {أُولَئِكَ هُمُ الْمُؤْمِنُونَ حَقًّا} (١).
...
(٥) أخرجه الترمذى (١٦٢١)، وأحمد (٦/ ٢١) من حديث فضالة بن عبيد، وقال الترمذي: حسن صحيح.','2','779',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (11,'الإنسان، وقد يموت قبل التمكن، فلا يكون الإسلام في حقه إلا ما تكلم به.
وحاصل الأمر:
...
(١) النساء: ١٧١.
(٢) الرعد: ٧.
(٣) طه: ٩٨.','2','780',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (12,'وكذلك قوله: {إِنَّمَا يُوحَى إِلَيَّ أَنَّمَا إِلَهُكُمْ إِلَهٌ وَاحِدٌ} (١)، فإن المراد به أنَّه لم يُوحَ إليَّ في أمر الإلهية إلا التوحيد لا الإشراك.
...
(٢) النازعات: ٤٥.
(٣) الرعد: ٤٠.
(٤) الغاشية: ٢١ - ٢٢.','2','781',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (13,'البشر، وإنَّما كان الَّذِي أوتيته وحيًا أوحاه الله إلي فأرجو أن أكون أكثرهم تبعًا يوم القيامة" (١).
...
(٢) الأنعام: ١٩.
(٣) آل عمران: ١٤٤.
(٤) النازعات: ٤٥.','2','782',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (14,'الرُّسُلُ} (١) ومثل ذلك كثير.
...
وأما دلالة الآية عَلَى الثالث، وهو نفي العِلْم عن غير أهل الخشية فمن جهة الحصر أيضًا، فإن الحصر المعروف المطرد هو حصر الأول في الثاني، وهو هاهنا حصر الخشية في العُلَمَاء، وأما حصر الثاني في الأول فقد ذكره الشيخ أبو العباس ابن تيمية -رحمه الله- وأنه قد يكون مرادا أيضاً فيصير الحصر من الطرفين، ويكونان متلازمين، ومثل ذلك كقوله: {إِنَّمَا تُنْذِرُ مَنِ اتَّبَعَ الذِّكْرَ وَخَشِيَ الرَّحْمَنَ بِالْغَيْبِ} (٣). {إِنَّمَا أَنْتَ مُنْذِرُ مَنْ يَخْشَاهَا} (٤). {إِنَّمَا يُؤْمِنُ بِآيَاتِنَا الَّذِينَ إِذَا ذُكِّرُوا بِهَا خَرُّوا سُجَّدًا وَسَبَّحُوا بِحَمْدِ رَبِّهِمْ وَهُمْ لَا يَسْتَكْبِرُونَ * تَتَجَافَى جُنُوبُهُمْ عَنِ الْمَضَاجِعِ} (٥).
...
(٤) النازعات: ٤٥.
(٥) السجدة: ١٥ - ١٦.
(٦) فاطر: ٢٨.','2','783',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (15,'وبيان الحصر الَّذِي ذكره الشيخ -رحمه الله- في هذه الآيات أن قوله: {إِنَّمَا تُنْذِرُ مَنِ اتَّبَعَ الذِّكْرَ وَخَشِيَ الرَّحْمَنَ بِالْغَيْبِ} (١) فيه الحصر من الطرفين، فإنَّه اقتضى أن إنذاره مختص بمن اتبع الذكر، وخشي الرحمن بالغيب، فإن هذا هو المختص بقبول الإنذار والانتفاع به، فلذلك نفي الإنذار عن غيره، والقرآن مملوء بأن الإنذار إِنَّمَا هو للقائل له خاصة، ويتقضي أنَّه لا يتبع الذكر ويخشى الرحمن بالغيب إلا من أنذره، أي: من قِبَل إنذاره، وانتفع به، فإن اتباع الذكر وخشية الرحمن بالغيب مختصة بمن قبل الإنذار، كما يختص قبول الإنذار والانتفاع به بأهل الخشية واتباع الذكر.
وكذلك قوله: {إِنَّمَا أَنْتَ مُنْذِرُ مَنْ يَخْشَاهَا} (٢).
وقوله: {إِنَّمَا يُؤْمِنُ بِآيَاتِنَا الَّذِينَ إِذَا ذُكِّرُوا بِهَا خَرُّوا سُجَّدًا} (٣).
فإن انحصار الإنذار في أهل الخشية والإنذار، كانحصار أهل الخشية في أهل الإنذار والذين خروا سجدًا في أهل الإيمان، ونحو ذلك، فكذلك قوله: {إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ} (٤).
وقد فسرها السَّلف بذلك أيضاً كما سنذكره إن شاء الله تعالى ونذكر شواهده.
وهاهنا نكتة حسنة:
وهي أن قول تعالى: {إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ} (٤) قد علم أنَّه يقتضي ثبوت الخشية للعلماء، لكن هل يقتضي ثبوتها لجنس العُلَمَاء، كما يقال: إِنَّمَا يحج المسلمون أو لا يحج إلا مسلم، فيقتضي ثبوت الجح لجنس المسلمين لا لكل فرد منهم؟
...
والمقصود هنا: أن العِلْم إذا كان سببًا مقتضيًا للخشية كان ثبوت الخشية تمامًا لجميع أفراد العُلَمَاء، لا تتخلف إلا لوجود مانع ونحوه.','2','785',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (17,'<span data-type="title" id=toc-2>فصل</span>
...
(٢) البقرة: ٢٦٩.
(٣) في "السنن" برقم (٣٣٣).','2','786',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (18,'ولا يجاوز تراقيهم، يخالف علمهم عملهم، وتخالف سريرتهم علانيتهم، يجلسون حِلَقًا فيباهي بعضهم بعضًا، حتى أن الرجل ليغضب عَلَى جليسه أن يجلس إِلَى غيره ويدعه، أولئك لا تصعد أعمالهم في مجالسهم تلك إِلَى الله عز وجل" (١).
وعن مسروق قال: "كفى بالمرء علمًا أن يخشى الله عز وجل، وكفى بالمرء جهلاً أن يعجب بعمله".
وعن ابن عمر رضي الله عنهما قال: "لا يكون الرجل عالمًا حتى لا يحسد من فوقه، ولا يحقر من دونه، ولا يبتغي بعلمه ثمنًا" (٢).
وعن أبي حازم نحوه.
...
ويشهد لهذا قوله تعالى: {أَمَّنْ هُوَ قَانِتٌ آنَاءَ اللَّيْلِ سَاجِدًا وَقَائِمًا يَحْذَرُ الْآخِرَةَ وَيَرْجُو رَحْمَةَ رَبِّهِ قُلْ هَلْ يَسْتَوِي الَّذِينَ يَعْلَمُونَ وَالَّذِينَ لَا يَعْلَمُونَ} (٤).
...
(٤) الزمر: ٩.','2','787',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (19,'يَتُوبُونَ مِنْ قَرِيبٍ} (١).
...
(٢) الأنعام: ٥٤.
(٣) النحل: ١١٩.
(٤) النساء: ١٧.','2','788',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (20,'وعن الحسن البصري أنَّه سئل عنها، فَقَالَ: هم قوم لم يعلموا ما لهم وما عليهم.
...
ويشهد لهذا قول النبي صلّى الله عليه وسلم: "إني لأعلمكم بالله وأشدكم له خشية" (١).
وكذلك قوله - صلى الله عليه وسلم -: "لو تعلمون ما أعلم لضحكتم قليلاً ولبكيتم كثيرًا" (٢).
...
(٥) برقم (٤١٩٠).','2','789',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (21,'وما تلذذتم بالنساء علي الفرش، ولخرجتم إِلَى الصُّعدات (١) تجأرون (٢) إِلَى الله عز وجل".
...
_________
(١) الطرق.
(٢) ترفعون أصواتكم بالدعاء.','2','790',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (22,'ومثل هذا كثير جداً، والمقصود: أن العِلْم بالله وأسمائه وصفاته وأفعاله من قدره، وخلقه، والتفكير في عجائب آياته المسموعة المتلوة وآياته المشاهدة المرئية مع عجائب مصنوعاته، وحكم مبتدعاته ونحو ذلك، مما يوجب خشية الله وإجلاله، ويمنع من ارتكاب نهيه، والتفريط في أوامره، وهو أصل العِلْم النافع.
...
_________
(١) الكهف: ٢٨.','2','791',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (23,'عليه يُزيد الإيمان، والغفلة والإعراض عن ذلك يُضعفه ويُنقصه، كما كان يقول من يقول من الصحابة: "اجلسوا بنا نؤمن ساعة" (١).
...
وفي مسند الإمام أحمد (٣)، والبزار من حديث أبي هريرة، أن النبي - صلى الله عليه وسلم - قال: "جددوا إيمانكم".
قالوا: وكيف نجدد إيماننا يا رسول الله؟
قال: "قولوا: لا إله إلا الله".
_________
(١) ذكره البخاري تعليقًا في كتاب الإيمان -باب قول النبي صلّى الله عليه وسلم بني الإسلام عَلَى خمس".
...
وأما العقل فلا يقدم عَلَى ما يضره مع علمه بما فيه من الضرر إلا لظنه أن منفعته راجحة إما بأن يجزم بأن ضرره مرجوح، أو يظن أن خيره راجح، كالذي يركب البحر، ويسافر الأسفار الخطرة للربح، فإنَّه لو جزم بأنه يغرق أو يخسر لما فعل ذلك، وإنَّما أقدم عليه لترجيح السلامة عنده والربح، وإن كان قد يكون مخطئًا في هذا الظن، وكذلك الزاني والسارق ونحوهما، لو حصل لهم جزم بإقامة الحدود عليهم من الرجم والقطع ونحو ذلك لم يقدموا','2','794',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (26,'عَلَى ذلك، فإذا علم هذا فأصل ما يوقع الناس في السيئات الجهل وعدم العِلْم بأنها تضرهم ضررًا راجحًا، أو ظنّ أنها تنفعهم نفعًا راجحًا، وذلك كله جهلٌ إما بسيط وإما مركب، ولهذا يسمى حال فعل السيئات الجاهلية، فإن صاحبها في حال جاهلية، ولهذا كان الشيطان يزين السيئات ويأمر بها، ويذكر ما فيها من المحاسن التي يظن أنا منافع لا مضار، كما أخبر الله عنه في قصة آدم أنَّه قال: {يَا آدَمُ هَلْ أَدُلُّكَ عَلَى شَجَرَةِ الْخُلْدِ وَمُلْكٍ لَا يَبْلَى * فَأَكَلَا مِنْهَا فَبَدَتْ لَهُمَا سَوْآتُهُمَا} (١).
وقال: {مَا نَهَاكُمَا رَبُّكُمَا عَنْ هَذِهِ الشَّجَرَةِ إِلَّا أَنْ تَكُونَا مَلَكَيْنِ أَوْ تَكُونَا مِنَ الْخَالِدِينَ} (٢).
وقال تعالى: {وَمَنْ يَعْشُ عَنْ ذِكْرِ الرَّحْمَنِ نُقَيِّضْ لَهُ شَيْطَانًا فَهُوَ لَهُ قَرِينٌ * وَإِنَّهُمْ لَيَصُدُّونَهُمْ عَنِ السَّبِيلِ وَيَحْسَبُونَ أَنَّهُمْ مُهْتَدُونَ} (٣).
وقال تعالى: {أَفَمَنْ زُيِّنَ لَهُ سُوءُ عَمَلِهِ فَرَآهُ حَسَنًا} (٤).
وقال: {كَذَلِكَ زَيَّنَّا لِكُلِّ أُمَّةٍ عَمَلَهُمْ ثُمَّ إِلَى رَبِّهِمْ مَرْجِعُهُمْ فَيُنَبِّئُهُمْ بِمَا كَانُوا يَعْمَلُونَ} (٥).
وتزيين أعمالهم يكون بواسطة الملائكة والأنبياء والمؤمنين للخير، وتزيين شياطين الإنس والجن للشر.
وقال تعالى: {وَكَذَلِكَ زَيَّنَ لِكَثِيرٍ مِنَ الْمُشْرِكِينَ قَتْلَ أَوْلَادِهِمْ شُرَكَاؤُهُمْ لِيُرْدُوهُمْ وَلِيَلْبِسُوا عَلَيْهِمْ دِينَهُمْ} (٦).
ومثل هذا كثير.
...
(٤) فاطر: ٨.
(٥) الأنعام: ١٠٨.
(٦) الأنعام: ١٣٧.','2','795',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (27,'يزين له ما فيه من اللذة التي يظن أنها مصلحة، ولا يجزم بوقوع عقوبته بل يرجو العفو بحسنات أو توبة أو بعفو الله ونحو ذلك.
...
_________
(*) كتب فوقها: كذا وكتب في الهامش: لعلها الخالصة.','2','796',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (28,'ولذا قال الحسن: ترك الذنب أيسر من طلب التوبة.
...
_________
(١) الجاثية: ٢١.
(٢) ص: ٢٨.','2','797',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (29,'المنازل، لتقطعت {قلوب} (*) أصحاب اليمين حسرات مما فاتهم من منازل المقربين مع إمكان مشاركتهم لهم في أعمالهم التي نالوا بها منازلهم العالية، وقد جاء في الأحاديث والآثار أنهم يَقُولُونَ: ألم نكن مع هؤلاء في الدُّنْيَا؟ فيقال: كنتم تفطرون وكانوا يصومون، وكنتم تنامون وكانوا يقومون وكنتم تبخلون، وكانوا ينفقون، ونحو ذلك.
...
(٢) أخرجه عبد الله بن أحمد في "السنة" (١٢٠٣)، والطبراني في "الكبير" (٩/ ٩٧٦٣)، ومحمد بن نصر المروزي في "تعظيم قدر الصلاة" (٢٧٨)، والحاكم في "المستدرك" (٤/ ٥٩٠ - ٥٩٣) وقال: صحيح الإسناد عَلَى شرط مسلم، ولم يخرجاه. والحديث=','2','798',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (30,'حتى تنادي الخلائق بعضها بعضًا: طوبى لهذا العبد الَّذِي لم يعص الله قط، ولا يدرون ما قد لقي فيما بينه وبين الله عز وجل مما قد وقفه عليه".
...
(٢) الكهف: ٤٩.','2','799',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (31,'وذكر ابن أبي الدُّنْيَا عن بعض السَّلف أنَّه قال: "ما يمر علي أشد من الحياء من الله عز وجل".
...
الوجه السابع وهو: أن المقدم عَلَى موافقة المحظور إِنَّمَا أوجب إقدامه عليه ما فيه من اللذة الحاصلة له به فظن أنَّه تحصل له لذَّته العاجلة ورجى أن يتخلص من تبعته بسبب من الأسباب ولو بالعفو المجرد فينال به لذَّة ولا يلحقه به مضرة وهذا من أعظم الجهل، والأمر بعكس باطنه فإن الذنوب يتبعها ولابد من الهموم والآلام وضيق الصدر والنكد وظلمة القلب وقسوته أضعاف أضعاف ما فيها من اللذة، ويفوت بها من حلاوة الطاعات وأنوار الإيمان وسرور القلب ببهجة الحقائق والمعارف ما لا يوازي الذَّرة منه جميع لذات الدُّنْيَا، فيحصل لصاحب المعصية العيشة الضنك وتفوته الحياة الطيبة فينعكس قصده بارتكاب المعصية؛ فإن الله ضمن لأهل الطاعة الحياة الطيبة ولأهل المعصية العيشة الضنك قال تعالى: {وَمَنْ أَعْرَضَ عَنْ ذِكْرِي فَإِنَّ لَهُ مَعِيشَةً ضَنْكًا وَنَحْشُرُهُ يَوْمَ الْقِيَامَةِ أَعْمَى} (١) وقال: {وَإِنَّ لِلَّذِينَ ظَلَمُوا عَذَابًا دُونَ
_________
(١) طه: ١٢٤.','2','800',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (32,'ذَلِكَ وَلَكِنَّ أَكْثَرَهُمْ لَا يَعْلَمُونَ} (١) وقال: {وَلَنُذِيقَنَّهُمْ مِنَ الْعَذَابِ الْأَدْنَى دُونَ الْعَذَابِ الْأَكْبَرِ لَعَلَّهُمْ يَرْجِعُونَ} (٢). وقال في أهل الطاعة: {مَنْ عَمِلَ صَالِحًا مِنْ ذَكَرٍ أَوْ أُنْثَى وَهُوَ مُؤْمِنٌ فَلَنُحْيِيَنَّهُ حَيَاةً طَيِّبَةً} (٣). قال الحسن وغيره من السَّلف "لنرزقنه عبادةً يجد حلاوتها في قلبه".
...
وقال تعالى: {وَأَنِ اسْتَغْفِرُوا رَبَّكُمْ ثُمَّ تُوبُوا إِلَيْهِ يُمَتِّعْكُمْ مَتَاعًا حَسَنًا إِلَى أَجَلٍ مُسَمًّى وَيُؤْتِ كُلَّ ذِي فَضْلٍ فَضْلَهُ} (٤).
وقال: {فَآتَاهُمُ اللَّهُ ثَوَابَ الدُّنْيَا وَحُسْنَ ثَوَابِ الْآخِرَةِ وَاللَّهُ يُحِبُّ الْمُحْسِنِينَ} (٥). كما قال عن إبراهيم عليه السلام: {وَآتَيْنَاهُ فِي الدُّنْيَا حَسَنَةً وَإِنَّهُ فِي الْآخِرَةِ لَمِنَ الصَّالِحِينَ} (٦) ومثل هذا كثير في القرآن فما في الطاعات من اللذة والسرور والابتهاج والطمأنينة وقرة العين أمر ثابت بالنصوص المستفيضة وهو مشهور محسوس يدركه بالذوق والوجد من حصل له، ولا يمكن التعبير بالكلام عن حقيقته، والآثار عن السَّلف والمشايخ العارفين في هذا الباب كثيرة موجودة، حتى كان بعض السَّلف يقول: "لو يعلم الملوك وأبناء الملوك ما نحن فيه لجالدونا عليه بالسيوف".
...
(٤) هود: ٣.
(٥) آل عمران: ١٤٨.
(٦) النحل: ١٢٢.','2','801',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (33,'ولولا الليل ما أحببت البقاء في الدُّنْيَا". وقال: "إنه ليمرُّ عَلَى القلب أوقات يضحك فيه ضحكًا".
...
وروى ابن المنادي وغيره عن الحسن قال: "إن للحسنة ثوابًا في الدُّنْيَا وثوابًا في الآخرة، وإن للسيئة ثوابًا في الدُّنْيَا وثوابًا في الآخرة؛ فثواب الحسنة في الدُّنْيَا: البصر في الدين، والنور في القلب، والقوة في البدن مع صحبة حسنة جميلة؛ وثوابها في الآخرة: رضوان الله عز وجل، وثواب السيئة في الدنيا: العمى في الدين، والظلمة في القلب، والوهن في البدن مع عقوبات ونقمات، وثوابها في الآخرة: سخط الله عز وجل والنار.','2','802',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (34,'وروى ابن أبي الدُّنْيَا بإسناده عن مالك بن دينار قال: "إن لله عقوبات فتعاهدوهن من أنفسكم في القلوب والأبدان وضنك في المعيشة ووهن في العبادة وسخط في الرزق".
...
وأيضًا فإذا علموا أن من اشتراه ما له في الآخرة من خلاق فقد علموا أنَّه يستحق العقوبة؛ لأنّ الخلاق: النصيب من الخير فإذا علم أنَّه ليس له نصيب في الخير بالكلية فقد علم أن له نصيبًا من الشر؛ لأنّ أهل التكليف في الآخرة لا يخلو واحد منهم عن أن يحصل له إما خيرٌ أو شرٌّ لا يمكن انفكاكه عنهما جميعًا البتة.','2','805',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (37,'وقالت طائفة: علموا أن من اشتراه فلا خلاق له في الآخرة لكنهم ظنوا أنهم ينتفعون به في الدُّنْيَا، ولهذا اختاروه وتعوضوا به عن ثواب الآخرة وشروا به أنفسهم وجهلوا أنَّه في الدُّنْيَا يضرهم أيضاً ولا ينفعهم فبئس ما شروا به أنفسهم لو كانوا يعلمون.
...
(٢) غير واضحة بالأصل، واستدركتها من مصادر التخريج.','2','807',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (39,'<span data-type="title" id=toc-3>فصل</span>
...
(٣) البقرة:١٧١.
(٤) الأعراف: ١٧٩.','2','809',NULL,NULL,'0');
INSERT INTO [b151138] VALUES (41,'نقل من نسخة مكتوبًا عليها ما صورته:
