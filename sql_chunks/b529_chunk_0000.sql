...
CREATE TABLE "b529"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b529
INSERT INTO [b529] VALUES (1,'[نصيحة لطالب الحق]
...
وعسى أن يكون بذلك قد أخذ بحظ وافر من التقوى المعنية بقول الله عزَّ وجلَّ: {يَاأَيُّهَا الَّذِينَ آمَنُوا إِنْ تَتَّقُوا اللَّهَ يَجْعَلْ لَكُمْ فُرْقَانًا وَيُكَفِّرْ عَنْكُمْ سَيِّئَاتِكُمْ وَيَغْفِرْ لَكُمْ وَاللَّهُ ذُو الْفَضْلِ الْعَظِيمِ} [الأنفال: ٢٩].','22','259',NULL,NULL,'0');
