...
CREATE TABLE "b9261"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b9261
INSERT INTO [b9261] VALUES (1,'<span data-type="title" id=toc-1>بسم الله الرحمن الرحيم</span>
...
أحمده حمد من رأى آيات قدرته وقوته، وشاهد الشواهد من فردانيته ووحدانيته، وطرق طوارق سره وبره، وقطف ثمار معرفته من شجر مجده وجوده، وأشكره شكر من اخترق واغترف من نهر فضله وإفضاله، وأومن به إيمان من آمن بكتابه وخطابه، وأنبيائه وأصفيائه، ووعده ووعيده، وثوابه وعقابه.. وأشهد أن لا إله إلا الله وحده لا شريك له، وأشهد أن محمداً عبده ورسوله: بعثه لأصلاب الفسقة والفجرة قاسماً، ولعرى الجاحدين والمارقين فاصماً، ولباغي الشك والشرك قاهراً، ولأتباع الحق والإحسان ناصراً؛ فصلوات الله عليه، وعلى آله، وأصحابه أجمعين.',NULL,'121',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (2,'<span data-type="title" id=toc-2>فصل في معرفة النفس</span>
...
<span data-type="title" id=toc-3>فصل كيف تعرف نفسك</span>؟
...
ومعرفة حقيقته، ومعرفة صفاته، مفتاح معرفة الله سبحانه وتعال؛ فعليك بالمجاهدة حتى تعرفه؛ لأنه جوهر عزيز من جنس جوهر الملائكة، وأصل معدنه من الحضرة الإلهية، من ذلك المكان جاء، وإلى ذلك المكان يعود.',NULL,'125',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (4,'<span data-type="title" id=toc-4>ما حقيقة القلب</span>؟
...
ومعرفة الروح صعبة جداً؛ لأنه يرد في الدين طريق إلى معرفته؛ لأنه لا',NULL,'126',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (5,'حاجة في الدين إلى معرفته؛ لأن الدين هو المجاهدة، والمعرفة علامة الهداية كما قال سبحانه وتعال: (وَالَّذينَ جاهَدوا فينا لَنَهدِيَنَّهُم سُبُلَنا) . ومن لم يجتهد حق اجتهاده لم يجز أن يتحدث معه في معرفة حقيقة الروح. وأول أس المجاهدة أن تعرف عسكر القلب؛ لأن الإنسان إذا لم يعرف العسكر لم يصح له الجهاد.

<span data-type="title" id=toc-5>فصل لماذا خُلق القلب</span>؟
اعلم أن النفس مركب قلب، وللقلب عساكر، كما قال سبحانه وتعالى: (وَما يَعلَمُ جُنودَ رَبِّكَ إِلّا هُوَ) .
والقلب مخلوق لعمل الآخرة طلبا لسعادته، وسعادته معرفة ربه عز وجل، ومعرفة ربه تعالى تحصل له من صنع الله، وهو من جملة عالمه، ولا تحصل له معرفة عجائب العالم إلا من طريق الحواس، والحواس من القلب، والقالب مركبه. ثم معرفة صيده، ومعرفة شبكته، والقالب لا يقوم إلا بالطعام، والشراب، والحرارة، والرطوبة. وهو ضعيف على خطر من الجوع والعطش في الباطن، وعلى خطر من الماء والنار في الظاهر، وهو مقابل أعداء كثيرة.',NULL,'127',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (6,'<span data-type="title" id=toc-6>فصل معرفة عساكر القلب</span>
...
وهؤلاء طائعون للقلب، كما أن الملائكة طائعون للرب سبحانه وتعالى لا يخالفون أمره.',NULL,'128',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (7,'<span data-type="title" id=toc-7>فصل في معرفة القلب وعسكره</span>
...
<span data-type="title" id=toc-8>فصل وظيفة القلب</span>
...
معناه: إنا خلقنا القلب، وأعطيناه الملك والعسكر، وجعلنا',NULL,'129',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (8,'النفس مركبة؛ حتى يسافر عليه من عالم التراب إلى أعلى عليين.
...
<span data-type="title" id=toc-9>فصل ثلاثة أشياء تبنى عليها السعادة</span>
تمام السعادة مبني على ثلاثة أشياء: قوة الغضب، قوة الشهوة، قوة العلم.
فيحتاج أن يكون أمرها متوسطاً؛ لئلا تزيد قوة الشهوة فتخرجه إلى الرخص',NULL,'130',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (9,'فيهلك، أو تزيد قوة الغضب فتخرجه إلى الجموح فيهلك.
...
<span data-type="title" id=toc-10>فصل أحوال القلب مع عسكره</span>
...
وكذلك أعمال العقل؛ التي هي الرحمة، والعلم، والخير؛ هي أخلاق الملائكة.',NULL,'131',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (10,'<span data-type="title" id=toc-11>فصل الأخلاق الحسنة والأخلاق القبيحة</span>
...
<span data-type="title" id=toc-14>فصل القلب مثل المرآة</span>
...
وإذا أغلق باب الحواس كان بعده الخيال؛ لذلك يكون الذي يبصره تحت ستر القشر، وليس كالحق الصريح مكشوفا فإذا مات - أي القلب - بموت صاحبه لم يبق خيال ولا حواس. وفي ذلك الوقت يبصر بغير وهم وغير خيال، ويقال له: (فَكَشَفنا عَنكَ غِطاءَكَ فَبَصَرُكَ اليَومَ حَديد) .',NULL,'135',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (13,'<span data-type="title" id=toc-15>فصل متى يحجب القلب عن مطالعة عالم الملكوت</span>؟
...
<span data-type="title" id=toc-16>فصل متى يطالع القلب عالم الملكوت</span>؟
...
فإذا جلس في مكان خال، وعطل طريق الحواس، وفتح عين الباطن وسمعه، وجعل القلب في مناسبة عالم الملكوت، وقال دائما:) الله - الله - الله (بقلبه، دون لسانه، إلى أن يصير لا خير معه من نفسه، ولا من العالم، ويبقى لا يرى شيئا إلا الله سبحانه وتعالى انفتحت تلك الطاقة، وأبصر في اليقظة',NULL,'136',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (14,'الذي يبصره في النوم؛ فتظهر له أرواح الملائكة، والأنبياء، والصور الحسنة الجملية، وانكشف له ملكوت السماوات والأرض، ورأى ما لا يمكن شرحه ولا وصفه، كما قال النبي صلى الله عليه وسلم:) زويت لي الأرض، فرأيت مشارقها ومغربها (وقال الله عز وجل: (وَكَذلِكَ نُري إِبراهيمَ مَلَكوتَ السَماواتِ وَالأَرض) . لأن علوم الأنبياء عليهم السلام كلها كانت من هذا الطريق، لا من طريق الحواس، كما قال سبحانه وتعالى: (وَاِذكُرِ اِسمَ رَبِّكَ وَتَبَتَّل إِلَيهِ تَبتيلاً) ، معناه: الانقطاع عن كل شيء، وتطهير القلب من كل شيء، والابتهال إليه سبحانه وتعالى بالكلية.
...
وهذه الطريق لا تفهم إلا بالتجربة، وإن لم تحصل',NULL,'137',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (15,'بالذوق لم تحصل بالتعليم. والواجب التصديق بها حتى لا تحرم شعاع سعادتهم، وهو من عجائب القلب. ومن لم يبصر لم يصدق، كما قال سبحانه وتعالى: (بَل كَذَّبوا بِما لَم يُحيطوا بِعِلمِهِ وَلَمّا يَأتِهِم تَأويلُهُ) ، وقوله: (وَإِذ لَم يَهتَدوا بِهِ فَسَيَقولونَ هَذا إِفكٌ قَديم) .

<span data-type="title" id=toc-17>فصل من طلب وجد</span>
...
فكل من زرع حصد، ومن مشى وصل، ومن طلب وجد، والطلب لا يحصل إلا بالمجاهدة: طلب شيخ بالغ عارف قد مشى في هذا الطريق وإذا حصل هذان الشيئان لأحد، فقد أراد الله له التوفيق والسعادة بحكم أزلي حتى يبلغ إلى هذه الدرجة.',NULL,'138',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (16,'<span data-type="title" id=toc-18>فصل ما هي أعظم اللذات</span>؟
...
وكل ما لم يعرفه ابن آدم إذا عرفه فرح به، مثل لعبة الشطرنج، إذا عرفها فرح بها، ولو نهى عنها لم يتركها ولا يبقى له عنها صبر. وكذلك إذا وقع في معرفة الله',NULL,'139',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (17,'سبحانه وتعالى، وفرح بها، ولم يصبر عن المشاهدة؛ لأن لذة القلب المعرفة.
...
<span data-type="title" id=toc-19>فصل النفس مختصرة من العالم</span>
واعلم أن نفس ابن آدم مختصرة من العالم، وفيها من كل صورة في العالم أثر منه؛ لأن هذه العظام كالجبال، ولحمه كالتراب، وشعره كالنبات، ورأسه',NULL,'140',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (18,'كالسماء، وحواسه مثل الكواكب. وتفصيل ذلك طويل.
...
<span data-type="title" id=toc-20>فصل في معرفة تركيب الجسد</span>
<span data-type="title" id=toc-21>ومنافع الأعضاء التي يقال عنها في علم التشريح</span>
...
الثالثة: أن تعلم أن لطفه ورحمته وعنايته متعلقة بالأشياء كلها، وأنها لا نهاية لها؛ لما ترى في النبات والحيوان والمعادن من سعة القدرة وحسن الصور والألوان.',NULL,'141',NULL,NULL,'0');
INSERT INTO [b9261] VALUES (19,'<span data-type="title" id=toc-22>فصل في تفصيل خلقة بني آدم</span>
...
<span data-type="title" id=toc-23>فصل متى تفضل البهائم ابن آدم</span>؟
