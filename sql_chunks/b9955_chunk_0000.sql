...
CREATE TABLE "b9955"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b9955
INSERT INTO [b9955] VALUES (1,'<span data-type="title" id=toc-1>مدخل</span>
...
بدر الكبرى
...
ولا نُبعد إذا قلنا أن تلك الخطة منوه عنها قبل الهجرة في قوله تعالى: {سَيُهْزَمُ الْجَمْعُ وَيُوَلُّونَ الدُّبُرَ} . وكان عمر رضي الله عنه يقول: "لم أعلم أي جمع حتى رأيت رسول الله صلى الله عليه وسلم يوم بدر يثب في الدرع ويقرأ {سَيُهْزَمُ الْجَمْعُ وَيُوَلُّونَ الدُّبُرَ} " ولكن أحداث مكة وطريق الهجرة غطت على هذا التنويه. ثم جاء الوعد الصريح في العهد القريب. {وَإِذْ يَعِدُكُمُ اللَّهُ إِحْدَى الطَّائِفَتَيْنِ أَنَّهَا لَكُمْ} تحقيقا للخطة السابقة. وهاهو التوجيه',NULL,'30',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (2,'الإلهي لتحقيق ذلك وتنفيذه على أيدي المسلمين بتوجيه رب العالمين.
...
١- الأسباب الدافعة عليها.
٢- الإعداد لها مسبقا من:
...
٣- سير المعركة ونوع القتال:
دفاع أو هجوم. ولكل تنظيمه وعتاده.
كر وفر، أو الزحف في صفوف، الحصار، الإمدادات والتموين.
٤- النتائج: تحقيق الغرض الذي قامت لأجله. تحقيق غرض آخر، أو فشلها والهزيمة.
٥- المخلفات: تصفية أعمال المعركة وبقايا آثارها في الأمة من الجهتين المتقاتلتين.
تلك هي الجوانب الأساسية التي تواكب كل غزوة وتلازمها ولا بد لها من إعداد وتقدير قبل خوض المعركة والتورط مع العدو. كما كان في غزوات الأحزاب وأحد وتبوك وخيبر وفتح مكة. فكانت خطة الأحزاب حفر الخندق ومفاجأة العدو بها. وخطة أحد: الرماة والمقاتلة. وخيبر حصار العدو. وكلها واضحة المعالم للمسلمين.',NULL,'31',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (3,'<span data-type="title" id=toc-2>الدوافع على الغزوة:</span>
...
فالدافع إلى الخروج هو الرغبة في',NULL,'31',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (4,'العير لعل الله يغنمهموها وهذا أمر عادي فيما بين المسلمين والمشركين. فالمسلمون خرجوا من ديارهم فرارا بدينهم وتركوا أموالهم بمكة. وهذا صهيب عند الهجرة قالوا له بمكة: "جئتنا صعلوكا لا مال لك حتى أثريت والآن تريد أن تخرج بأهلك ومالك" فنزل لهم عن ماله وخرج.
...
وإلى هنا أمر عادي وسير للخطة',NULL,'32',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (5,'على وجهتها الطبيعية.
...
وتكلم كلا الفريقين من المهاجرين والأنصار كما تقدم. وخرج المؤتمر وانفض المجلس على قرار موحد حاسم: القتال.',NULL,'33',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (6,'<span data-type="title" id=toc-3>بقي تحديد المكان:</span>
...
ولكن الخطة والتوجيه الإلهي يحدد مكان المعركة وزمانها: {إِذْ أَنْتُمْ بِالْعُدْوَةِ الدُّنْيَا وَهُمْ بِالْعُدْوَةِ الْقُصْوَى وَالرَّكْبُ أَسْفَلَ مِنْكُمْ وَلَوْ تَوَاعَدْتُمْ لاخْتَلَفْتُمْ فِي الْمِيعَادِ} وبيَّن تعالى أن ذلك جُزءا من الخطة العامة ليقضي الله أمرا كان مفعولا. {لِيَهْلِكَ مَنْ هَلَكَ عَنْ بَيِّنَةٍ وَيَحْيَى مَنْ حَيَّ عَنْ بَيِّنَةٍ وَإِنَّ اللَّهَ لَسَمِيعٌ عَلِيمٌ} .',NULL,'33',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (7,'و<span data-type="title" id=toc-4>جها لوجه:</span>
لقد أصبح المسلمون مع المشركين وجها لوجه في الميدان. وهناك مرة أخرى يأتي التوجيه الإلهي لتنفيذ الخطة بمغايرة جديدة حول العدد الذي هو ميزان القوة والقتال. فيقلل كلا الطائفتين في نظر الأخرى، {وَإِذْ',NULL,'33',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (8,'يُرِيكُمُوهُمْ إِذِ الْتَقَيْتُمْ فِي أَعْيُنِكُمْ قَلِيلاً وَيُقَلِّلُكُمْ فِي أَعْيُنِهِمْ لِيَقْضِيَ اللَّهُ أَمْراً كَانَ مَفْعُولاً وَإِلَى اللَّهِ تُرْجَعُ الأُمُورُ} أي لا إلى تقديراتكم وخطئكم.
...
إنه تحقيق لما قلنا من التوجيه الإلهي لمعركة بدر. وبهذا كله يتم تهيئة أرض المعركة. وبتثبيتها تحت أقدام المسلمين وتوفير الماء لهم.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (9,'وانزلاق الأرض تحت أقدام المشركين ولا ماء عندهم. وذلك لصالح المسلمين وما كان ليتم ذلك إلا بتوجيه إلهي للخطة وعناية بالمسلمين وفي الصباح يلتقي الجمعان على تلك الحال ولم يبق إلا القتال.',NULL,'35',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (10,'<span data-type="title" id=toc-5>قبل بدء المعركة:</span>
...
وقد جاء ما يؤيِّد هذا عن عبد الله بن عمر رضي الله عنهما. فقال عمر: "يا أيها الناس لا تغرنكم هذه الآية فإنما كانت يوم بدر وأنا فئة لكل مسلم". وقال نافع: "سألت بن عمر قلت إنا قوم لا نثبت عند قتال عدونا ولا ندري من الفئة. إمامنا أو عسكرنا؟ " فقال: "إن الفئة رسول الله',NULL,'35',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (12,'صلى الله عليه وسلم". فقلت: "إن الله يقول: {إِذَا لَقِيتُمُ الَّذِينَ كَفَرُوا زَحْفاً..} الآية " فقال: "إنما أنزلت في يوم بدر لا قبلها ولا بعدها".
...
الثاني: إنزال الملائكة. {إِذْ تَسْتَغِيثُونَ رَبَّكُمْ فَاسْتَجَابَ لَكُمْ أَنِّي مُمِدُّكُمْ بِأَلْفٍ مِنَ الْمَلائِكَةِ مُرْدِفِينَ وَمَا جَعَلَهُ اللَّهُ إِلا بُشْرَى وَلِتَطْمَئِنَّ بِهِ قُلُوبُكُمْ وَمَا النَّصْرُ إِلا مِنْ عِنْدِ اللَّهِ إِنَّ اللَّهَ عَزِيزٌ حَكِيمٌ} .',NULL,'36',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (13,'وكان لإنزال الملائكة في غزوة بدر حالة خاصة وتوجيه مستقل مغاير لنزولهم في غيرها. ولقد أنزل الله جنودا من الملائكة في ثلاثة مواضع سوى بدر:
...
وقوله: {سَأُلْقِي فِي قُلُوبِ الَّذِينَ كَفَرُوا الرُّعْب} تقوية معنوية بما يسمى',NULL,'38',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (15,'حرب الأعصاب مع أن هذا حقيقة بذاته كما قالوا: كنا نسمع كصوت الحصاة على طشت نحاس يدوي في القلوب من شدة الخوف. وكان مقابل ذلك السكينة في قلوب المؤمنين.
...
٢- مشاركته صلى الله عليه وسلم في المعركة برمي الحصباء في وجوه القوم وقال: "شاهت الوجوه" فلم يبق رجل مشرك إلا أصابه منها ما شغله في عينه وفمه.
...
وهنا نواجه سؤالا وهو في جملته يتلخص في أن المعركة في سيرها وتوجيهها من الله وملائكته وأن المسلمين ما كانوا ليملكوا شيئا من سيرها. وما يقدرون على شيء من نتائجها. وما كانوا إلا سائرين وفق خطة مرسومة وكان يكفي لهزيمة المشركين ملك واحد. فلم كثر عدد الملائكة. وكان الأسر بيد المسلمين؟ والجواب كما نص عليه تعالى من جهتين:',NULL,'39',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (16,'-١ابتلاء للمؤمنين هل يمتثلون ويثبتون أم لا قال تعالى: {وَلِيُبْلِيَ الْمُؤْمِنِينَ مِنْهُ بَلاءً حَسَناً إِنَّ اللَّهَ سَمِيعٌ عَلِيمٌ} .
-٢كان المسلمون مستضعفين وكانوا ذوي حقوق عند المشركين وقد عانوا منهم شدة وقسوة فأراد الله أن يشفي صدورهم. ويخزي عدوهم الذي قال: "لا نرجع حتى نرد ماء بدر وتسمع بنا العرب وتعزف علينا القيان" وكان خزيهم على أيدي المسلمين أشد منه على أيدي الملائكة {قَاتِلُوهُمْ يُعَذِّبْهُمُ اللَّهُ بِأَيْدِيكُمْ وَيُخْزِهِمْ وَيَنْصُرْكُمْ عَلَيْهِمْ وَيَشْفِ صُدُورَ قَوْمٍ مُؤْمِنِينَ} .',NULL,'40',NULL,NULL,'0');
INSERT INTO [b9955] VALUES (17,'<span data-type="title" id=toc-7>تصفية المعركة:</span>
...
"لعل الله اطلع على أهل بدر فقال اعملوا ما شئتم فقد غفرت لكم" وقال جبريل لرسول الله صلى الله عليه وسلم: "ما تعدون أهل بدر فيكم؟ " قال:"أفضلنا". قال: "وكذلك من حضرها من الملائكة". أو كما قال صلى الله عليه وسلم.',NULL,'41',NULL,NULL,'0');
