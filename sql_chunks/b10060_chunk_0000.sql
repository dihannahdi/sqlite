...
CREATE TABLE "b10060"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b10060
INSERT INTO [b10060] VALUES (1,'<span data-type="title" id=toc-1>ترجمة الشيخ عبد الرحمن الإفريقي</span>
<span data-type="title" id=toc-2>لفضيلة الشيخ عمر بن محمد فلاته</span>
...
فإن حديثي معكم في هذه الليلة ١ يتعلق بترجمة شخصية كريمة، اتصفت بالعلم والحلم، والفضل والنُّبل، وامتازت بخصال فريدة هيأها الله تعالى لها، وحديثي عنها يعتبر غيضاً من فيض.
...
وليس بدعاً أن أقوم بترجمة لعالم حري أن تظهر آثاره، وتنشر أخباره, وقد شحنت المكتبات
_________
١ ألقيت هذه المحاضرة بقاعة المحاضرات بالجامعة الإسلامية في الموسم الثقافي لعام ٩٧-٩٨هـ.',NULL,'163',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (2,'الإسلامية بتراجم وسير الأعلام من الرجال من عصر الصحابة رضوان الله عليهم، بل إن الحفاظ من النسابين في الجاهلية قد حفظوا الأنساب، وسير أبطالهم، وأفذاذهم, وأخيار أيامهم، وأذاعوا ذلك وأشاعوه في محافلهم ومنابر أسواقهم، فنقل ذلك عنهم الرواة، ودوّن ذلك الكتاب والأدباء والإخباريون.
...
<span data-type="title" id=toc-3>ميلاده ونشأته:</span>
ولد رحمه الله عام ١٣٢٦هـ في بلاد مالي من قارة إفريقيا الغربية، بقرية تسمى (فَفَا) من أبوين كريمين أنجبا من الأولاد الكثير من الذكور والإناث لم يعش منهم غير المترجم له وأخوه الأكبر، وكان أبوه من بيت الإمارة والحكم الذي لم يزل حتى اليوم يتداوله آله. ونشأ في تلك الربوع',NULL,'164',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (3,'مع أترابه يستنشق هواء الصحراء، ويمتع ناظريه بالفضاء الواسع الذي لا يردهما إلا النهر الذي جعل القرية جزيرة. وكانت هذه الفترة فترة بؤس وبلاء على أهل تلك الديار؛ لأن المستعمر الفرنسي قد قبض بكلتا يديه على هذه البلاد، وانقض عليها انقضاض الأسد على الفريسة, بعد أن جرت بينه وبين الأهالي العزل من السلاح حروب انتهت باستعماره البلاد والعباد، وفرض سلطته عليهم قهراً شأن غيرها من البلاد التي اقتسمها الأوربيون من الانجليز والبلجيكيين والبرتغاليين والألمان.
...
٢- إرسال القسيس والرهبان ليشرفوا',NULL,'167',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (6,'عليها.
٣- غسل اذهان أبناء المسلمين وتشكيكهم في دينهم.
٤- الهيمنة على برامج التعليم في البلاد الإسلامية.
٥- إحياء الحضارات القديمة القومية لإبعاد المسلم عن حضارته الإسلامية.
٦- تشويه التاريخ الإسلامي والتشكيك في حوادثه والطعن فيها.
٧- العمل على إخراج المرأة المسلمة من بيتها بدعوى الحرية والتقدمية، وأنها شقيقة الرجل.
٨- إشغال الرجال بها، وإخراجهم من مثلهم وآدابهم وأعرافهم وأخلاقهم بواسطتها.
٩- تشجيع الطرق المنحرفة وإلباس مقدميها هالة من التقديس والتقدير وإعطائهم الصدارة والرفع من شأنهم.
١٠- الإكثار من المؤتمرات المسيحية لمكافحة الإسلام.
١١- الإكثار من المناسبات المختلفة في بلاد المسلمين باسم الذكرى والعبرة لإيقاعهم في المشابهات المذمومة، والابتداع في شرع الله.
١٢- محاربة القرآن العظيم كتاب الله الذي لا يأتيه الباطل من بين يديه ولا من خلفه بطبعه محرفاً، وترجمة معانية ترجمة باطلة لإثارة الجدل ونقده.
١٣- شن الافتراءات الباطلة على الإسلام لتشويه حقائقه تحت ستار العلم والبحث التكنولوجي المجرد. وغير ذلك كثير وكثير.
...
إنها لهمة عالية ونية صادقة، وغيرة لله خالصة انبعثت من شاب مسلم لم يبلغ يومها العشرين عاماً، يصبر على مفارقة الآباء والأقرباء، والأنداد والأحباء, والوطن والمنصب، والحال أنه أصبح شخصاً مرموقاً يشار إليه بالبنان، قد ينال في المجتمع مرتبة يغبطه عليها أترابه من أبناء الزمان، ولكن الأمر كما قال الله تعالى: {وَمَنْ يَهْدِ اللهُ فَمَا لَهُ مِنْ مُضِلٍّ..} الآية, (الزمر: ٣٧) .',NULL,'168',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (7,'<span data-type="title" id=toc-4>وصول الشيخ إلى الحرمين الشريفين</span>
...
بعد ذلك حن إلى وطنه، وظن أنه قد حاز من العلم ما يهيئ له مقارعة الأعداء بالحجة والبيان، واستأذن شيخه في العودة إلى البلاد بعد أدائه الحجة الثانية وهو لا يدري ما سبق في قدر الله من الخير - ولما فرغ من أداء المناسك اجتمع بشيخ جليل من بني قومه يقيم بجدة وجرى نقاش علمي في مسألة فقهية فأدلى دلوه، وتقدم في الحديث على جلسائه، وسرد النصوص التي يحفظها من الكتب التي قرأها فقال له الشيخ: يا بني - وبكل بساطة وهدوء - "إن هذه المسألة ورد فيها حديث عن رسول الله صلى الله عليه وسلم يخالف النصوص التي ذكرت، ويدل على غير ما قرأت"، وقرأ عليه حديثاً ملك مجامع قلبه، وألجم لسانه، وفند حجته، وامتلأ مهابة, وقال: إذاً, علام خالفت المتون هذا الحديث؟! فقال الشيخ: "يا بني, إن جميع المتون وكل الكتب تابعة لأقوال رسول الله صلى الله عليه وسلم، أما سمعت ما قال الإمام مالك، وهو يرد فتوى سمعها',NULL,'169',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (8,'عن أمير المؤمنين عمر: "كل كلام فيه مقبول ومردود سوى كلام صاحب هذا القبر وأشار إلى حجرة النبي صلى الله عليه وسلم، والله تعالى يقول: {فَإِنْ تَنَازَعْتُمْ فِي شَيْءٍ فَرُدُّوهُ إِلَى اللهِ وَالرَّسُولِ إِنْ كُنْتُمْ تُؤْمِنُونَ بِاللهِ وَالْيَوْمِ الآخِر} . (النساء: ٥٩) ".
...
وعندما افتتحت مدرسة دار الحديث بالمدينة عام ١٣٥٠هـ وعين الشيخ مدرساً فيها, دعاه إلى الالتحاق بها، وكانت يومها مدرسة معنية بتدريس الحديث النبوي، وعلومه على أوسع نطاق، ويدرس',NULL,'170',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (9,'فيها كبار العلماء، ومنهم الشيخ سعيد فوجد فيها بغيته، وكان مؤسسها العلامة الشيخ أحمد بن محمد الدهلوي رحمه الله - معنياً بالحديث، ومحدثاً مشهوراً أراد من تأسيس هذه الدار إنشاء جيل في حرم رسول الله صلى الله عليه وسلم بصير بالحديث دراية ورواية, شأن مدارس الحديث في الهند إذ ذاك.
...
دينك لا تقلد الرجالا ... حتى ترى أولاهما مقالا',NULL,'171',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (10,'فاسمع مقالات الهداة الأربعة ... واعمل بها فإن فيها منفعة
...
وقد ظل المسجد إلى عهد قريب هو المدرسة لكل العلوم، وكانت أسطواناته وسواريه مسنداً لظهور العلماء والفقهاء، والمحدثين والمفسرين يتحلق حولهم الطلاب، وينهلون من علمهم وفقههم العديد من الطبقات وعلى مختلف الأعمار والفئات.',NULL,'173',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (12,'يتجول المرء في المسجد ليستمع إلى تلك الدروس ومتى أصغى إلى شيخ وأعجب من أسلوبه، وتمكن من الفهم منه جلس مع الملتفين حول الشيخ وأخذ ما شاء الله له من الفوائد وانصرف.
...
فخاض الشيخ الأفريقي فيه ورتع، وأخذ من الثمار ما قدر له وكان للإخلاص والتقوى مفعولهما بعد توفيق الله وهو يقول: {وَاتَّقُوا اللهَ وَيُعَلِّمُكُمُ اللهُ} (البقرة: ٢٨٢) .',NULL,'174',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (13,'<span data-type="title" id=toc-5>شيوخه وتلاميذه:</span>
...
وهنا ينبغي للداعية أن يعلم أن أسلوب الفظاظة والغلظة والجفاء والشدة لا يسعد على خدمة الدعوة، وإنما يؤدي إلى العكس, لذا قال الله تعالى لنبيه صلى الله عليه وسلم: {وَلَوْ كُنْتَ فَظّاً غَلِيظَ الْقَلْبِ لانْفَضُّوا مِنْ حَوْلِكَ} (آل عمران:١٥٩) ، وقال: {خُذِ الْعَفْوَ وَأْمُرْ بِالْعُرْفِ وَأَعْرِضْ عَنِ الْجَاهِلِينَ} (الأعراف:١٩٩)',NULL,'175',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (14,'ولا أريد هنا أن أعدد أسماء طلابه المبرزين, أو أشيد بأعمالهم وآثارهم وأذكر مناصبهم ومكانتهم الاجتماعية فإن ذكر ذلك لا يغني فتيلاً ولا ينفع نقيراً، ولا يزيد من قدر الشيخ رحمه الله شيئاً.
...
١ - وافق أنني تخلفت عن حج عام ١٣٦٧ هـ ولما كان يوم عيد الأضحى رأيت أن أتناول طعام الغداء في منزل الشيخ، ووافق أنّ كثيراً من الطلاب ذهبوا للحج، فدخلت عليه والطعام بين يديه, ومعه أولاده, وعندما ألقيت السلام رفع رأسه وقال من غير تأمل أو تفكير: "الحمد لله الذي لم يُرني اليوم الذي آكل فيه وحدي ومع أولادي فقط"..
٢ - جاء في نظام أعمال دار الحديث التي وضعها دليلاً لدار الحديث بعد أن آل أمر نظارة مكتبتها وإدارة مدرستها إليه، وفي الفقرة (خ) وقع في خارطة البناء شقة للناظر أعلن من يومي هذا',NULL,'176',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (15,'وأنا الناظر حالياً أنني متنازل عن سكناها لتسكنها أسرة الشيخ أحمد الدهلوي المؤسس، وأطلب ممن تولى النظارة بعدي من أبنائي وأحبابي أن يدعوا سكناها للمذكورين ما دام شرط النظارة لا ينطبق عليهم.
...
وفي أواخر عام ١٣٧٠هـ اختاره جلالة الملك عبد العزيز ليكون ضمن المدرسين في المعهد العلمي بالرياض، ثم بكلية الشريعة فكان يمكث بالرياض مدة الدراسة ويقضي عطلة الصيف بالمدينة المنورة',NULL,'177',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (16,'ليشرف على أعمال دار الحديث، ويواصل تدريسه بالمسجد النبوي الذي كان يتمنى أن يكون بجوار معظم سواريه طلاب يعقلون عن الله، وعن رسول الله صلى الله عليه وسلم ويقومون بتبليغ رسالة الله.
...
ومن أشهر ما ألف من الكتب في هذه الطرقة هو كتاب جواهر المعاني للشيخ علي حرازم، وكتاب',NULL,'178',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (17,'الرماح للشيخ عمر الفوني، وكتاب الإفادة الأحمدية لمريد السعادة الأبدية، للشيخ محمد الطيب الشهير بالسفياني والمتوفى عام ١٢٥٩هـ وهو من خاصة الخاصة من أصحاب الشيخ أحمد التجاني.
...
"أقول لهم كما قيل في علي بن أبي طالب رضي الله عنه هو قسم (١) النار من أحبنا يقال له أدخله الجنة، ومن أبغضنا ومات دخل النار"..
...
_________
(١) المعنى غير واضح وظاهر الكلام غير مستقيم.',NULL,'179',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (18,'"نهاني صلى الله عليه وسلم عن التوجه بالأسماء وأمرني بالتوجه بصلاة الفاتح لما أغلق" صفحة (٥٧) .
...
كما أنه قد قام بالرد على هذه الطائفة جماعة من أهل العلم أذكر منهم العالم الجليل مفتي المالكية بالمدينة سابقاً الشيخ محمد الخضر بن سيدي عبد الله بن ما يابي الشنقيطي في كتابه (مشتهى الخارف الجاني في رد زلعات التجاني الجاني) بلغت صفحاته أربعمائة صفحة.',NULL,'180',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (19,'وفضيلة الدكتور محمد تقي الدين الهلالي في رسالته الهدية الهادية، والتي بلغت صفحاتها ٨٠ صفحة تقريباً، وقد ألف جماعة من علماء أفريقيا الغربية رسائل تضمنت الرد على معتقدات هذه الطائفة منها ما جرى الاطلاع عليه، والبعض لم أطلع عليه حتى الآن.
...
وقال: "أما عبارات الكتاب فهي في متناول الجميع لا لبس فيها ولا إيهام يتفهمها العام قبل الخاص، ويعقلها المتعلم قبل العالم فجاء جزيل النفع كثير الفائدة".',NULL,'181',NULL,NULL,'0');
INSERT INTO [b10060] VALUES (20,'ولفضيلته رحمه الله مجموعة من الفتاوى لم تطبع ومسودات لبعض المذكرات في الحديث والمصطلح ألقاها على طلابه في المعهد العلمي وفي كلية الشريعة بالرياض.

<span data-type="title" id=toc-8>وفاته:</span>
توفي رحمه الله تعالى في ليلة الثلاثاء الموافق ٢٨/٣/١٣٧٧هـ بعد أن انتابته أمراض كثيرة لم تكن سبباً لتوقفه عن الدعوة والجهاد في سبيل الله، بعد خدمة جليلة للسنة شهد له بها القاصي والداني.
...
كتبه: عمر محمد فلاته',NULL,'182',NULL,NULL,'0');
