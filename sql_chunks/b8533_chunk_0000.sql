...
CREATE TABLE "b8533"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b8533
INSERT INTO [b8533] VALUES (1,'<span data-type="title" id=toc-1>كتاب القلب والإبدال</span>
<span data-type="title" id=toc-2>باب النون واللام</span>
...
كتاب القلب والإبدال
...
قال أبو الفوارس: إذا كانت المزادة من أديمين فهي شعيب',NULL,'3',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (2,'وإذا كانت من أديم واحد فهي سطيحة، وقال العجاج في التهتال:
...
قوله مستوزيا أي منتصبا مرتفعا، قال أبو زياد الكلابي المستوزي المتنحي يقول الدحل لصاحبه مالك مستوزيا لا تدلو، قال المهلبي المستوزي المنتصب قال وحكى أبو عمرو الشيباني المستوزي الذي ليس بمطمئن كالمستوفز وقال أبو الحسن الاثرم سألت أبا عمرو الشيباني عن المستوزي فقال هو النافر، والشكير الشعر الضعيف والشكير أيضا الشعار الصغار تحت الكبار، كتن أي لزق به أثر خضرة العشب، ويقال رأيت في أرض بني فلان لعاعة حسنة ونعاعة',NULL,'4',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (3,'حسنة وهو بقل ناعم في أول ما يبدو رقيق لم يغلظ، وجاء في الحديث إنما الدنيا لعاعة، ويقال تعليت اللعاعة إذا اجتنيتها، وأنشد لابن مقبل:
...
ويروى أصيلالا وأصيلال تصغير أصيل وجائز على غير قياس كما صغروا عشية عشيشية قال الفراء جمعوا أصيلا أصيلانا كما يقال بعير وبعران ثم صغروا الجمع وأبدلوا النون لاما، ويقال: لعلها ولعنها وعلها، قال الفرزدق:',NULL,'5',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (4,'هل أنتم عائجون بنا لعنا ... نرى العرصات أو أثر الخيام
...
قال وقوم يحولون اللام نونا فيقولون قد أصن اللحم، أبو عمرو الشيباني الغريل والغرين ما يبقى من الماء في الحوض والغدير الذي',NULL,'6',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (5,'تبقى فيه الدعاميص لا يقدر على شربه، الأصمعي الغرين إذا جاء السيل فثبت على الارض فجف فترى الطين قد جف ورق فهو الغرين، أبو عمرو الدمال السرجين ويقال الدمان، الفراء هو شثن الأصابع وشثلها وقد شثنت كفه شثونة وشثانة ويقال شثلت وهو الغليظ الخشين ويقال للأسد شثن البراثن، اللحياني يقال هو كبن الدلو وكبلها، الأصمعي الكبن ما ثني من الجلد عند شفة الدلو، وكل كف كبن يقال كبنت عنك لساني أي كففته، وقد كبنت ثوبي في معنى ثنيته وغبنته ولم يعرفها باللام، ويقال رجل [كبن و] كبنة إذا كان منقبضا، الفراء أتن الرجل يأتن وأتل يأتل وهو الأتلان والأتنان وهو أن يقارب خطوه في غضب، قال وأنشدني أبو ثروان العكلي:
...
ذو ذألان كذآليل الذئب',NULL,'7',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (6,'وحكى اللحياني عن الكسائي يقال أتاني هذا الأمر وما مأنت مأنه وما مألت مأله أي ما تهيأت له، وهو حنك الغراب وحلكه لسواده وقال الفراء قلت لأعرابي أتقول مثل حنك الغراب فقال لا ولكني أقول مثل حلكه، وقال أبو زيد الحلك اللون والحنك المنسر، الكسائي يقال هو العبد زلمة وزلمة وزنمة وزنمة أي قد قد العبد، الفراء هو العبد زلما أي قدا وهو العبد زلمة معناه إذا رأيته رأيت أثر العبد فيه، أبو عمرو واللحياني يقال أبنته وأبلته إذا أثنيت عليه بعد موته، قال متمم ابن نويرة:
...
من أبيه وآسال من أبيه وأعسان من أبيه يريد على طرائق من أبيه وشمائله وقد تأسن أباه وتأسله إذا نزع إليه في الشبه، وقال الفراء هو عنوان الكتاب وعلوان الكتاب وعنيانه وعنوانه إذا كان باللام فبالضم لا غير، وحكى عن بعض بني كلب عنيان الكتاب، ويقال',NULL,'8',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (7,'عنونت الكتاب وعنيته ويكره عننت، قال وقال الكسائي لم أسمع علونت وكان ينبغي لها أن تكون عليت الكتاب في القياس، اللحياني يقال عتلته إلى السجن وعتنته وأنا أعتله وأعتله وأعتنه وأعتنه، ويقال ارمعل الدمع وارمعن، وقال [مدرك بن حصن] الأسدي
...
أبو زيد نمق اسمه ينمقه نمقا ولمقه يلمقه لمقا وكتبه يكتبه',NULL,'9',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (8,'كتبا وهو واحد في لغة عقيل وسائل قيس يقولون لمق اسمه من الكتاب لمقا إذا محاه والنمق هو الكتاب، ويقال هي قنة الجبل وقلته لأعلاه',NULL,'10',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (9,'<span data-type="title" id=toc-3>باب الباء والميم</span>
...
والظأب والظأم أيضا سلف الرجل يقال قد تظاءبا وتظاءما إذا تزوجا أختين، ويقال للرجل إذا كبر ويبس من الهزال ما هو إلا عشمة وعشبة، ويقال قد عشم الخبز وعشب إذا يبس وقد عشم الشجر، ويقال ساب فلان فلانا فأربى عليه وأرمى عليه إذا زاد عليه في سبابه، ويقال قد أرمى على الخمسين أي زاد عليها، وجاء في الحديث إني أخاف عليكم الرماء أي الربا، قال الفراء يقال منه قد أرميت ورميت وكذا يقال أرميت على السبعين ورميت وأربيت أي',NULL,'10',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (10,'زدت، وأنشد لبعض العرب يصف الرمح [وهو حاتم بن عبد الله الطائي]
...
وقوله جذيلها المحكك يقول أنا في الامور مما قد جرستني مثل هذا الجذل الذي تحتك به الإبل الجربى، ويقال معناه يشتفى برأيي كما تشتفي الابل الجربى إذا احتكت به، وقال [مالك بن خالد الخناعي] الهذلي',NULL,'11',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (11,'رجال برتنا الحرب حتى كأننا ... جذال حكاك لوحتها الدواجن
...
قال وقال بعضهم الإيماء أن تشير برأسك والإيباء أن ترفع رأسك ثم تنكسه إلى صدرك، اللحياني يقال للعجوز قحمة وقحبة، أبو عبيدة قال أبو العاج إذا شربت بطرف فم السقاء ثنيته أو لم',NULL,'12',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (12,'تثنه أو شربت من وسط السقاء قيل قد اقتبعت السقاء قال وقال أبو مسمع اقتبع واقتمع واحد لأن الباء أخت الميم، اللحياني بقال أتانا وما عليه طحربة وطحرمة أي خرقة، وكذلك يقال ما في السماء طحربة أي لطخ من غيم، ويقال ما في نحي فلان عبقة ولا عمقة أي لطخ ولا وضر، ويقال هو يرمي من كثب ومن كثم أي من قرب وتمكن، وحكاها لي أبو عمرو أيضا، وحكى لي أبو عمرو قئمت في الشراب وقئبت، وصئمت وصئبت، اللحياني يقال صئم من الماء وصئب إذا امتلا وروي، قال والقرهم والقرهب السيد، وهو أيضا الثور المسن، أبو عبيدة عن يونس قال رجمته بقول سئ ورجبته يعنون صككته، قال ابن دريد المراجم قبيح الكلام يقال تراجم القوم بينهم بمراجم قبيحة أي بكلام قبيح وكلام مرجم على غير يقين، الفراء يقال اطمأننت إليه ولغة بني أسد اطبأننت، وأنشد:
...
وشذرت أقراني جميعا وواحدا ... وأصردت فيهم مثل ما يصرد النبل',NULL,'13',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (13,'أبو زيد الرميز من الرجال العاقل الثخين وقال بعضهم الربيز وقد رمز رمازة وربز ربازة، أبو عبيدة العقمة والعقبة ضرب من الوشي، الفراء يقال تعرف فيه عقبة الكرم والسرو وعقمة أيضا، قال عمرو بن شأس الأسدي:
...
وقال كثير:
فما ورق الدنيا بباق لأهله ... ولا شدة البلوى بضربة لازم',NULL,'14',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (14,'ويقال ثوب شبارق وشمارق ومشبرق ومشمرق إذا كان ممزقا، قال ذو الرمة:
...
رددنا الكتيبة مفلولة ... بها أفنها وبها ذأنها',NULL,'15',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (15,'وقال كناز الجرمي:
...
قال ويسمى كل داء استتر في الجوف مما لا يظهر الكبان، وقال',NULL,'16',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (16,'أبو صاعد العطاميل هي البكرات التوام الخلق يعني العطابيل.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (17,'<span data-type="title" id=toc-4>باب الميم والنون</span>
...
أي ملبس، [قال] وسمعت أبا عمرو يقول الغيم العطش يقال غيم وغين وقد غامت وغانت أي عطشت وهي تغيم وتغين، قال الراجز:',NULL,'17',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (18,'ما زالت الدلو لها تعود ... حتى أفاق غيمها المجهود
وقال آخر:
...
فالذ بيح الذي قد صلح أن يذبح للنسك والحلان الجدي الصغير الذي لا يصلح للنسك، ويقال في الضب حلان وفي اليربوع',NULL,'18',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (19,'جفرة والجفرة التي قد انتفخ جنباها وأكلت وشربت حتى سمنت، ويقال غلام جفر حين تحرك، وقال أبو عبيدة في قول مهلهل:
...
ويروى دهانج، قوله بين الضحى وبين قيل القيال يريد الوقت',NULL,'20',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (21,'الذي يشتد فيه توهج الشمس والسراب دهانج يعني بعيرا يقارب الخطو وإنما شبه الرعن إذا قمص في الآل ببعير عليه أعدال تمشي بها، وأنشد [للعجاج] في مثله:
...
الكسائي يقال عراهمة وعراهنة للعظيمة، وأنشد [للأعلم الهذلي]',NULL,'21',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (22,'تراها الضبع أعظمهن رأسا ... عراهنة لها حرة وثيل
...
الكلابي يقال أطم يده وأطنها',NULL,'22',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (23,'<span data-type="title" id=toc-5>باب العين والهمزة</span>
...
ولقد أضاء لك الطريق وأنهجت ... سبل المسالك والهدى يعدي',NULL,'22',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (24,'طريق نهج بإسكان الهاء أي واضح والجمع نهوج، يقول إبصارك الهدى يقويك على طريقك ومعنى يعدي يقوي، ومن هذا أعداني السلطان، وقوله أضاء لك أي أبصرت أمرك وتبين لك وأنهجت صارت نهجا واضحة بينة، قال وسمعت أبا ثعلب ينشد بيت طفيل:
...
يريد لعلني، وقال أبو عمرو قال أبو الحصين العبسي إن بينهم لعهنة أي إحنة، وسمعته يقول الأسن قديم الشحم وبعضهم يقول العسن، أبو عبيدة قوم يحولون حاء حتى فيجعلونها عينا كقولك قم عتى',NULL,'23',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (25,'آتيك، وقوم يجعلو نها ألفا كقولك أتى آتيك، الأصمعي يقال التمى لونه والتمع لونه، وهو السأف والسعف، وقال الفراء سمعت بعض بني نبهان من طيئ يقول دأني يريد دعني، وقال تئاله يريد تعاله فيجعلون مكان العين همزة كما جعلوا مكان الهمزة عينا في قوله لعنك قائم، وأشهد عنك رسول الله، وهي لغة في تميم وقيس كثيرة، ويقال ذأته وذعته إذا خنقه.',NULL,'24',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (26,'<span data-type="title" id=toc-6>باب العين والحاء</span>
...
ويروى تعنظي بك وتخنذي بك، وقال غيره تخنظي بالخاء [المعجمة] ، ويقال رجل خنظيان إذا كان فاحشا، ويقال نزل بحراه وعراه أي قريبا منه، أبو عبيدة يقال لا وحهد الله يريدون وعهد الله.',NULL,'24',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (27,'<span data-type="title" id=toc-7>باب الهاء والهمزة</span>
...
وقد كنت في الحرب ذا تدرإ ... فلم أعط شيئا ولم أمنع',NULL,'25',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (28,'وبعض العرب يقول ذا تدره. ويقال في فلان دراء أي خروج يعني يخرج عليك ويتدرأ.
ودروء الجبل جروف شاخصة منه. أبو عمرو يقال درأ علينا ودره علينا، الفراء يقال ازمأرت عينه وازمهرت إذا احمرت. وهيهات الشر وهيهات وحكى أيهات الشر وأيهات. ويقال قد أبزت له وهبزت له وهو الوثب.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (29,'<span data-type="title" id=toc-8>باب الهاء والحاء</span>
...
إنما أصله من الحقحقة وهو السير الشديد حتى ينقطع ثم قلب الحاء إلى الهاء لأنها أختها ثم قلبوا الهقهقة إلى القهقهة، وبقال في مثل شر السير الحقحقة، قال وقال مطرف بن الشخير لابن له يا عبد الله عليك بالقصد وإياك وسير الحقحقة، يريد الإتعاب،',NULL,'27',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (31,'ويقال للقصير بهتر وبحتر. ويقال نهم ينهم ونحم ينحم ونأم ينئم بمعنى واحد وهو صوت كأنه زحير، وقد أنح يأنح وأنه يأنه، وأنشد لرؤبة:
رعابة يخشي نفوس الأنه
وصف فحلا يقول يرعب نفوس الذين يأنهون. وقال غير الأصمعي يقال في صوته صحل وصهل أي بحوحة، ويقال هو يتفيهق في كلامه ويتفيحق في كلامه إذا توسع فيه وتنطع وأصله من الفهق وهو الامتلاء، أبو زيد أهمتني الحاجة إهماما وأحمتني إحماما وهما واحد، وقال الأصمعي يقال أحمني الأمر إذا أخذه له الزمع، وقال أبو عمرو بقال طريق منفحق ومنفهق وهو الواسع.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (32,'<span data-type="title" id=toc-9>باب الجيم والياء</span>
...
تطير عنها الوبر الصهابجا',NULL,'28',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (33,'يريد الصهابي من الصهبة، قال وبعض العرب إذا شدد الياء جعلها جيما، وأنشد عن ابن الأعرابي [لأبي النجم]
...
يريد حجتي ويأتيك بي وينزي وفرتي',NULL,'29',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (34,'<span data-type="title" id=toc-10>باب الخاء والجيم</span>
...
قال ودخل أعرابي على أمير فضربه فقال وجدته قد خلع وجلع والله مخزيه ومغير ما به ومسلمه شر مسلم.',NULL,'29',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (35,'<span data-type="title" id=toc-11>باب الحاء والجيم</span>
الأصمعي يقال تركت فلانا يجوس بني فلان ويحوسهم يقول يدوسهم ويطلب فيئهم، الكسائي يقال أحم الأمر وأجم إذا حان',NULL,'29',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (36,'وقته، ويقال رجل محارف ومجارف، ويقال هم يحلبون عليه ويجلبون عليه في معنى واحد أي يعينون عليه، وقال الأصمعي ما كان معناه قد حان وقوعه فهو أجم يقال قد أجم ذلك الأمر أي قد حان، وأنشد:
...
وإذا قلت أحم فهو قدر، ولم يعرف أحم',NULL,'30',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (37,'<span data-type="title" id=toc-12>باب الخاء والحاء</span>
...
أي لساني أطلقه، ويقال خبج وحبج إذا ضرط، وقد فاحت منه رائحة طيبة وفاخت، أبو زيد يقال خمص الجرح يخمص خموصا وحمص يحمص حموصا، وانحمص انحماصا إذا ذهب ورمه، أبو عبيدة المخسول والمحسول المرذول وقد خسلته وحسلته، أبو عمرو الشيباني الجحادي والجخادي الضخم، قال ويقال طحرور وطخرور للسحابة.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (38,'قال الأصمعي الطخارير من السحاب قطع مستدقة رقاق والواحدة طخرورة، والرجل طخرور إذا لم يكن جلدا ولا كثيفا، ولم يعرفه بالحاء، [قال] وسمعت الكلابي يقول ليس على السماء طحرور وليس على الرجل طحرور ولا يتكلم به إلا مع الجحد، والطخارير من السحاب شيء قليل في نواحي السماء واحدها طخرور يتكلم به بجحد وبغير جحد، اللحياني يقال شرب حتى اطمحر وحتى اطمخر أي امتلا، وقد دربح ودربخ إذا حنى ظهره، ويقال هو يتحوف مالي ويتخوفه أي يتنقصه ويأخذ من أطرافه، قال الله عز وجل أو يأخذهم على تخوف أي تنقص، ثم قال الشاعر [وهو ابن مقبل]
...
قال أبو عبيدة يقال أتانا بطعام فخططنا فيه أي أكلناه أكلا يسيرا وعذرنا، ويقال حططنا مذ اليوم في طعام فلان وذاك إذا أكلوا أكلا شديدا.',NULL,'31',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (39,'<span data-type="title" id=toc-13>باب الغين والخاء</span>
...
قال ويرويها بعضهم الخطريف، وحكى عن بعضهم أرى دجلة قد زغرت يريد زخرت إذا جاءت بالماء الكثير، وحكي خط يخط في معنى غط يغط، الأصمعي [يقال] اغبن من ثوبك واخبن.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (40,'<span data-type="title" id=toc-14>باب الهاء والخاء:</span>
...
كأنهن الصخر الصيخود ... يرفت عقر الحوض والعضود',NULL,'32',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (41,'<span data-type="title" id=toc-15>باب العين والغين</span>
...
فقلت امكثي حتى يسار لو اننا ... نحج فقالت لي أعام وقابله',NULL,'33',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (42,'يريد لعلنا، الفراء يقال سمعت وغاهم ووعاهم وهي الضجة، ويقال مالك عن هذا وعل وما لك عن هذا وغل في معنى ملجإ، اللحياني يقال ارمعل دمعه وارمغل إذا قطر وتتابع، وقد بعثر متاعه وبغثره، أبو عمرو الشيباني يقال نشعت به ونشغت به، وإنه لمنشوغ بأكل اللحم، وأنشد لذي الرمة:
إذا مرئية ولدت غلاما ... فألأم مرضع نشع المحارا
أبو عبيدة يقال غما والله وعما والله، وقد يجمعون بينهما في قافيتين، قال رؤبة:
قبحت من سالفة ومن صدغ ... كأنها كشية ضب في صقع',NULL,'34',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (43,'<span data-type="title" id=toc-16>باب الفاء والثاء</span>
...
وهي الأثافي والأثاثي لغة لبعض بني تميم، وهو الضلال بن فهلل وثهلل، ويقال عفنت في الجبل وعثنت إذا صعدت وأنا أعفن وأعثن، ويقال الشيخ يدلف ويدلث إذا مشى مشيا ضعيفا، ويقال ثم وفم في حروف النسق، والنكاف والنكاث داء يأخذ الإبل، ويقال هو فروغ الدلو وثروغها، ويقال هو اللفام واللثام، قال الفراء اللثام على الفم واللفام على الأرنبة، ويقال فلان ذو ثروة وذو فروة أي كثرة، ويقال قد جئث الرجل وجئف وزئد إذا فزع.',NULL,'36',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (46,'<span data-type="title" id=toc-17>باب الفاء والكاف</span>
قال الأصمعي [يقال] في صدره علي حسيفة وحسيكة أي غل وعداوة، وقال ابن الأعرابي الحساكل والحسافل الصغار، الأصمعي وأبو عمرو السلفان والسلكان أولاد الحجل يقال للذكر والأنثى سلف ولم نسمع سلفة ولو قلته لكان جيدا، ويقال سلك وسلكة، أبو صاعد سلفان الحجل وأسلاف الحجل [أولاده] الواحد سلف للذكر والأنثى.',NULL,'36',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (47,'<span data-type="title" id=toc-18>باب القاف والكاف:</span>
...
وهو السهك والسهج يقال سهكه وسهجه وسحقه، قال أبو عمرو المسهك والمسهج ممر الريح.',NULL,'38',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (50,'<span data-type="title" id=toc-20>باب السين والثاء:</span>
الأصمعي يقال الوطس والوطث الضرب الشديد بالخف يقال وطس',NULL,'38',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (51,'الأرض بخفه وقد وطث، ويقال ناقة فاسج وفاثج وهي الفتية الحامل، وأنشد لهميان:
...
فوق كل شيء يعلون به المشط وقوله ماء الضالة أراد ماء الآس شبه خضرته بخضرة السدر، وقال غيره يغسلن رؤوسهن بالسدر ثم يعلينها بالمرزنجوش واللجن المتلزج، ويقال ساخت رجله في الأرض وثاخت، ويقال أتيته ملث الظلام وملس الظلام أي حين اختلط الظلام.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (52,'<span data-type="title" id=toc-21>باب الثاء والذال:</span>
الأصمعي يقال لتراب البئر الذي يخرج منها النبيثة والنبيذة، ويقال قرب حذحاذ وحثحاث إذا كان سريعا، ويقال قذم له من ماله وقثم وغذم وغثم إذا دفع إليه منه دفعة فأكثر، ويقال قرأ فما تلعثم وما تلعذم، اللحياني يقال خرجت غثيثة الجرح وغذيذته إذا خرجت مدته وما فيه، وقد غث يغث وغذ يغذ، ويقال جذوت وجثوت وهي القيام على أطراف الأصابع، وأنشد الأصمعي للنعمان ابن نضلة العدوي:',NULL,'39',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (53,'إذا شيءت غنتني دهاقين قرية ... وصناجة تجذو على كل منسم
ويقال جذوت على أطراف أصابعي إذا قمت على أصابعك وجثوت على ركبتي ويقال جذوة وجذوة وجذوة في قوله عز وجل: {أَوْ جَذْوَةٍ مِنَ النَّارِ} وقال اللحياني يقال جثوة وجثوة وجثوة، أبو عمرو الشيباني يلوذ ويلوث سواء، الفراء يقال ما له ثفروق وما له ذفروق.',NULL,'40',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (54,'<span data-type="title" id=toc-22>باب السين والشين:</span>
...
أبو عمرو يقال سئفت أصابعه وشيءفت وهو تشقق يكون في أصول الأظفار. قال ويقال السوذق',NULL,'40',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (55,'والشوذق للسوار. اللحياني يقال حمس الشر وحمش الشر إذا اشتد. وقد احتمش الديكان واحتمسا إذا اقتتلا. وعطس فسمته وشمته، ويقال غبس وغبش للسواد، وقد غبس الليل واغتبس وغبش واغتبش، ويقال خرجنا بغبش وغبس أي بسواد من الليل. الفراء يقال أتيته بسدفة من الليل وشدفة وسدفة وشدفة وهو السدف والشدف، وقد يجمعون بين السين وألشين في الشعر. قال الفراء أنشدني النميري:
...
وليلة قد جعلت الصبح موعدها ... بصدرة العنس حتى تعرف السدفا',NULL,'41',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (56,'<span data-type="title" id=toc-23>باب السين والتاء</span>
قال الأصمعى يقال هو على سوسه وتوسه أي خليقته ويقال رجل',NULL,'41',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (57,'حفيسأ وحفيتأ إذا كان ضخما ضخم البطن إلى القصر ما هو. وأنشدنا الفراء لعلباء بن أرقم:
...
فتركن نهدا عيلا أبناؤها ... وبني كنانة كاللصوت المرد',NULL,'42',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (58,'<span data-type="title" id=toc-24>باب السين والصاد</span>
...
ويقال مغسا بالتخفيف وكذلك بالصاد أيضا. قال ويقال الرسغ والرصغ. قال أبو عبيدة وقوم يقولون للبساط بصاط. ويقال جاءني يضرب أسدريه وأصدر به وأزدريه.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (59,'<span data-type="title" id=toc-25>باب السين والزاي:</span>
...
ويروى تزلعا، ويقال غمل النبت إذا ركب بعضه بعضا حتى يسود ويعفن، ويقال ضربه وسلع رأسه أي شقه، ويقال رأيت في رجله سلوعا أي شقوقا، ويقال اذهب إلى ذلك السلع فانزل فيه وهو',NULL,'43',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (60,'الشق في الجبل، ويقال قد خزقه وخسقه، أبو عبيدة يقال هو معجس القوس وعجس وعجس ومعجز وعجز وعجز للمقبض، ويقال قعدت إلى لزق دار فلان ولسق دار فلان، أبو زيد يقال تملس من الأمر تملسا وتملز منه تملزا إذا خرج منه، الفراء الرجس والرجز بمعنى واحد، ويقال الأزد والأسد، يونس يقال تحوست منه وتحوزت إذا حدت، ويقال تحوست وتحوزت أي انقبضت.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (61,'<span data-type="title" id=toc-26>باب الزاي والصاد:</span>
...
أي ناشزا. والشرز والشرص واحد وهو الغلظ. قال وسمعت خلفا يقول سمعت أعرابيا يقول لم يحرم من فزد له. أراد فصد له فخفف وأبدل الصاد زايا. والمعنى لم يحرم من أصاب بعض حاجته وإن لم ينلها أحد كلها، وقال أبو عبيدة قالوا لم يحرم من فصد له.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (62,'وبعضهم يسكن الصاد وبعضهم يحولها زايا، بفال للذي لم يصب جميع حاجته وما طلب ولاصاب دون ذلك، وذلك لان رجلين ضافا رجلين فلما أصبحا فالتقيا تذاكرا ما قريا فقال أحدهما قريت طائلا إنما فصد لي فقال صاحبه لم يحرم من فصد له، وذلك أن العرب إذا أتاهم ضيف وليس عندهم ما يأكله فصدوا له بعيرا أو حيوانا وأخذوا ذلك الدم وشووه له في شيء وأطعموه، ويقال فز الجرح يفز فزيزا وفص يفص فصيصا إذا سال، ويقال ما يفص من يد فلان شيء أي ما يخرج من يده شيء، قال الفراء أنشدني بعض بني تميم:
...
يريد به القصائص وهو شجر توجد الكمأة في أصله، الفراء يقال شصره برمحه وبقرنه وشزره بمعنى واحد إذا طعنه شزرا، ويقال ما بها مصدة من برد، وقال النميري مزدة، ويقال ما وجدنا العام مصدة ولا مزدة أي ما وجدنا بردا، أبو عبيدة يقال جاءنا بضرب أسدريه وأزدريه وأصدريه، ويقال بصقت وأحدون يقولون بزقت',NULL,'45',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (63,'<span data-type="title" id=toc-27>باب التاء والطاء</span>
...
فمن ضم فواحدها تخم، يقال هو على تخم من الأرض، قال وسمعت أبا عمرو يقول هي تخوم الأرض بالفتح.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (64,'<span data-type="title" id=toc-28>باب اللام والدال:</span>
...
الخارب اللص والجمع الخراب، معدا اختلسا.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (65,'<span data-type="title" id=toc-29>باب الطاء والدال:</span>
...
ولا أطيق البكرات الشردا',NULL,'47',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (66,'فجاوز بين الطاء والدال في قافيتين، وقال أبو النجم:
...
إذا عدلت نجبين حول عجانها ... وحثت برجليها الحمار فقرمدا',NULL,'48',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (67,'<span data-type="title" id=toc-30>باب الصاد والطاء:</span>
الأصمعي يقال للناقة إذا ألقت ولدها ولم يشعر أي لم ينبت شعره قد أملصت وأملطت، وألقته مليصا ومليطا، وهي ناقة مملص ومملط وإبل مماليص ومماليط، فإذا كان ذلك من عادتها قيل هي مملاص ومملاط، ويقال اعتاطت رحمها واعتاصت وهما سواء إذا لم تحمل أعواما وهى ناقة عائط [وعائص] والجميع عيط [وعيص]',NULL,'48',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (68,'<span data-type="title" id=toc-31>باب الطاء والجيم:</span>
...
وتيماء لم يترك بها جذع نخلة ... ولا أجما إلا مشيدا بجندل',NULL,'49',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (69,'<span data-type="title" id=toc-32>باب الصاد والضاد:</span>
...
فيقال للشمس قد تضيفت إذا مالت للغروب ودنت منه، ومنه اشتق الضيف، وقد ضافني الرجل إذا دنا منك ونزل بك، أبو عمرو يقال ما ينوص لحاجة وما يقدر على أن ينوص أي يتحرك لشيء، ومنه قوله تعالى ولات حين مناص، [ويقال ما ينوض لحاجة',NULL,'49',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (70,'وما يقدر أن ينوض أيضا،] قال وقد انقاض الشيء وانقاض بمعنى واحد، وقال الأصمعي المنقاض المنقعر والمنقاص المنشق طولا، وانقاصت الركية وانقاصت السن إذا انشقت طولا، وأنشد [لأبي ذؤيب الهذلي]
...
ويروى وحصحص في صم الصفى ثفناته، اللحياني يقال تصافوا على الماء وتضافوا عليه، ويقال صلاصل الماء وضلاضله وهي بقاياه، ويقال قبضت قبضة وقرئ [في] هذا الحرف فقبضت قبضة من أثر الرسول، وقبصت قبصة، وزعم غيره أن القبصة أصغر من القبضة وأنها بأطراف الاصابع، وقال اللحياني سمعت أبا زياد يقول تضوك فلان في خرءه، وقال الأصمعي تصوك بالصاد إذا تلطخ.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (71,'<span data-type="title" id=toc-33>باب اللام والراء:</span>
أبو عبيدة المجلف والمجرف واحد [وهو] الذي قد ذهب ماله، ويقال هي التلاتل والتراتر، ويقال تلتله وترتره، ويقال سهم',NULL,'50',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (72,'أملط وأمرط إذا لم يكن له ريش، وقد تملط وتمرط، قال الشاعر [وهو نويفع بن نفيع الفقعسي]
...
وذكاء يعني الشمس، ويقال للنار ابن ذكاء. والكافر الليل. يقول ابتدأت في المغيب. ويقال هدم ملدم ومردم. ويقال ردم ثوبه إذا رقعه. وأنشد [لعنترة]',NULL,'51',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (73,'هل غادر الشعراء من متردم ... أم هل عرفت الدار بعد توهم
...
إلى ظعن فيها يمينه علقت ... تهاويل رقم فوق عيدية بزل',NULL,'52',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (74,'إذا احتثها البيض الأوانس أو وحى ... إليهن حاد بالإشاحة والزجر
...
يعني الرحي التي تطحن بها حجارة تخرج من المعادن ليستخرجوا منها الذهب.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (75,'<span data-type="title" id=toc-34>باب الدال والتاء:</span>
...
من أعتد فهو معتد. ويقال سبنداة وسبنتاة للجريئة. ويقال للنمر سبندى وسبنتى. ويقال هرت فلان الثوب وهرده إذا خرقه. وكذلك يقال هرت عرضه وهرده. والتولج والدولج الكناس. وقد مد في السير ومت، وهو الدفتر وبنو أسد يقولون التفتر.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (76,'<span data-type="title" id=toc-35>باب الدال والذال:</span>
...
[قال] وسمعت خالد بن كلثوم يقول الذحاذح والدحادح القصار والواحدة [ذحذاحة و] دحداحة.',NULL,'54',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (77,'<span data-type="title" id=toc-36>باب الهمزة والياء:</span>
الأصمعي يقال رجل يلمعي وألمعي إذا كان ظريفا، ويقال يلملم وألملم اسم جبل أو موضع، الفراء يقال لآفة تصيب الزرع اليرقان',NULL,'54',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (78,'والأرقان، وهذا زرع مأروق وقد أرق وهذا زرع ميروق وقد يرق، ويقال للرجل الشديد الخصومة رجل يلندد وألندد، قال طرفة:
...
وأثربي سنخه مرصوف
قال الأصمعي يقال رمح يزني وأزني ويزأني وأزأني منسوب إلى ذي يزن ملك من ملوك حمير، اللحياني يقال هذه أذرعات وبذرعات، وبقال لدويبة تنسلخ قصير فراشة يسروع وأسروع.',NULL,'55',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (79,'وقال الأعراب هي دودة تكون في البقل فيها خضرة وصفرة وحمرة وإنما تقع في البقل قبل أن يهيج بنحو من شهر، ويقال قطع الله يديه، وحكى اللحياني عن الكسائي أنه سمع بعضهم يقول قطع الله أديه، الفراء ويقال للرجل الرفيق اليدين إنه ليدي وأدي، ويقال ولدته أمه يتنا وأتنا إذا خرجت رجلاه قبل رأسه، ويقال عباءة وعظاءة وصلاءة وسحاءة وبنو تميم يقولون عباية وعظاية وصلاية وسحاية، قال المستوغر بن ربيعة:
ولاعب بالعشي بني بنيه ... كفعل الهر ينتهس العظايا
فلا ظفرت يداه ولا يؤبي ... ولا يسقى من الداء الشفايا
ويروى فلا ذاق النعيم ولا يؤبى، ويقال يعصر وأعصر، ويقال ما في سيره أتم ويتم أي إبطاء، وقوم يجعلون [في] ما كان من ضرب سقاءة وقراءة مكان الهمزة ياء كقولك امرأة سقاية وقراية أي تقرأ.',NULL,'56',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (80,'<span data-type="title" id=toc-37>باب الواو والهمزة:</span>
الأصمعي يقال أرخ الكتاب وورخه، وقد أكفت الدابة ووكفتها، قال وكان رؤبة ينشد:
كالودن المشدود بالوكاف
وقد أكدت العهد ووكدته، أبو عبيدة يقال آصدت الباب وأوصدته إذا أطبقته، وأوسدت الكلب وآسدته إذا أغريته بالصيد. الأصمعي يقال ذأى البقل يذأى بلغة أهل الحجاز ويقول أهل نجد',NULL,'56',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (81,'ذوى وهو يذوي ذويا، قال وقولهم ذوي خطأ وحكاها أبو عبيدة عن يونس، الفراء يقال ما أبهت له وما وبهت له، قال الأصمعي أبهت له آبه فطنت له، وقال أبو زيد وبهت له بفتح الباء أبه وبها. ويقال آخيته وواخيته، ويقال وشاح وإشاح، ووسادة وإسادة. وولدة وإلدة. قال الهذلي:
...
فهذا الباب كله بعضهم يهمزه وبعضهم لا يهمزه. ويقال هو من أهل وج ويحول قوم الواو ألفا فتقول أج.',NULL,'57',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (82,'<span data-type="title" id=toc-38>باب الزاي والذال:</span>
الأصمعي يقال زرق الطائر وذرق، أبو عبيدة يقال زبرت الكتاب وذبرته إذا كتبته، قال الأصمعي زبرت الكتاب إذا كتبته وذبرته إذا قرأته قراءة خفيفة، قال ويقال أنا أعرف تزبرتي أي كتابتي.',NULL,'58',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (83,'<span data-type="title" id=toc-39>باب حروف المضاعف التي تقلب إلى الياء:</span>
...
بعد ذاك أي مع ذاك، ولبيب مقيم، قال وقول الله عزوجل: {وَقَدْ خَابَ مَنْ دَسَّاهَا} إنما هو من دسيت، [قال] وسمعت أبا عمرو',NULL,'58',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (84,'الشيباني يقول قوله تعالى لم يتسن أي لم يتغير وهو من قوله [تعالى] {مِنْ حَمَأٍ مَسْنُونٍ} أي متغير، وقال ليس قوله عزوجل: {مِنْ مَاءٍ غَيْرِ آسِنٍ} أي غير متغير منه، فقلت له يتسن من ذوات الياء ومسنون من ذوات التضعيف، فقال هو مثل تظنيت وهو من الظن، وقال الأصمعي في قول العجاج:
تقضي البازي إذا البازي كسر
...
أراد فيأتم من قولك ائتممت بفلان أي اتخذته إماما، أبو عبيدة [يقال] كععت تكع تقديرها تقر ويقال كعت أكيع، قال الفراء ومما قلب تشديده إلى الياء حكى الكسائي عن العرب جاء ساتا وجاء ساتيا يريد سادسا فلما ثقلت تشديده بدلت بالياء وكانت خلفا من التاء وأخرجت الدال لأنها من الأصل، ومن قال ساتا فعلى لفظ ستة وستين ومن قال سادسا فعلى الأصل، قالوا جاء سادسهم وساتهم وساديهم وساديتهن للمرأة، قال وزعم الكسائي',NULL,'59',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (85,'أنه سمع أعرابيا يقول فكانت آخر ناقة نحرها والدي أو جدي سادية ستين، قال وأنشدني بعض العرب [لامرأة من بني الحارث ابن كعب]
...
ونهر إذا فاض طم وطما، الأصمعي يقال طمى يطمي طميا و [طما] يطموا طموا.',NULL,'60',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (86,'<span data-type="title" id=toc-40>باب ما تزاد فيه الميم آخرا:</span>
قال الأصمعي العرب تزيد الميم في أشياء، وقالوا رجل فسحم إذا كان واسع الصدر، وهو من الانفساح، ورجل زرقم إذا كان أزرق، وستهم إذا كان عظيم الاست [أي أسته] ، ويقال شدقم إذا كان واسع الشدق، قال وجلهمة نرى أنه من جلهة الوادي، وجلهته ما استقبلك منه، قال ويقال ناب دلقم وهي المسنة التي قد انكسرت أسنانها من الكبر، وهو من الا ندلاق والا ندلاق الاسترخاء، يقال اندلق السيف إذا جرى من غمده، ويقال غارة دلق، وسيف دالق إذا كان يخرج من غمده وكذلك دلوق، ويقال اندلق بطنه إذا خرج وعظم، ويقال طعنه فاندلقت أقتاب بطنه إذا خرجت أمعاؤه، ويقال ناقة ضرزم إذا كانت قليلة اللبن، قال ونرى أنه من قولهم رجل ضرز إذا كان بخيلا، قال وكرشم اسم رجل يصلح أن يكون من الكرش والميم زائدة.',NULL,'61',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (87,'<span data-type="title" id=toc-41>باب ما تزاد فيه النون:</span>
قال الأصمعي زادت العرب النون في أربعة أحرف من الأسماء وقالوا رعشن للذي يرتعش، وللضيف ضيفن، وقال غير الأصمعي',NULL,'61',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (88,'الضيفن الذي يحضر مع الضيف ليأكل ما يقرى الضيف، قال الشاعر:
...
كالذئب وسط العنه
ألا تره تظنه
ويقال في خلق فلان خلفنة يعني به الخلاف.',NULL,'62',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (89,'<span data-type="title" id=toc-42>باب الواو تقلب تاء وهي أول الحرف:</span>
التكلان أصله من وكلت وكان أصله وكلان فأبدلت الواو',NULL,'62',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (90,'تاء. وكذلك التخمة أصلها وخمة لأنها من الوخامة، يقال طعام وخيم إذا كان غير مرئ، وتقوى أصلها وقوى لأنها من وقيت، وتترى أصلها وترى لأنها من المواترة، وتراث أصله وراث لأنه من ورثت، وتجاه أصله من الوجه، وتا لله أصلها والله، وتلاد من المال، والتليد أصله من الواو أي [ما] ولد عندهم.',NULL,'63',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (91,'<span data-type="title" id=toc-43>باب إبدال من حروف مختلفة:</span>
...
لجاءت كأن القسور الجون بجها ... عساليجه والثامر المتناوح
والقسور نبت، والجون يضرب إلى السواد من شدة خضرته، بجها أي تنفتق من السمن، والعساليج جمع عسلوج وهي هنوات تنبسط على وجه الأرض كأمثال العروق، والأطم والأجم كل بيت مربع مسطح، الأصمعي يقال نبض العرق ينبض ونبذ ينبذ إذا ضرب',NULL,'63',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (92,'ويقال مرث خبزه ومرذه، وقد مرث الشي ومرذه إذا لينه بيده وكل شيء مرث فقد مرذ، يقال أمرث الثريد فيفته ثم يصب عليه اللبن ثم يماث حتى يصير كأنه آردهالج ثم يتحسى. قال النابغة الجعدي:
...
ويقال عليه أمشاج من الغزل وأوشاج أي داخلة بعضها في بعض، ويقال قد تفكن وتفكه إذا تندم، ويقال قد شاكله وشاكهه، ويقال قد سفح ما في إنائه وقد سفكه وقد سفح دمه وسفكه،',NULL,'64',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (93,'ويقال قرطاط وقرطان للبرذعة، وأنشد الجرمازي:
...
تم الكتاب والحمد لله رب العالمين وصلى الله على محمد النبي وآله وسلم وحسبنا الله ونعم الوكيل',NULL,'65',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (94,'<span data-type="title" id=toc-44>كتاب الإبل عن الأصمعي</span>
...
أمارت أجالت، والكراض حلق الرحم ولم يعرف لها واحدا، فإذا ضربها الفحل قيل قد قاع عليها وقعا والمصدر القياع ومن قال قعا فالمصدر القعو يقال قعا يقعو قعوا وقاع يقوع قياعا، قال العجاج:',NULL,'66',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (95,'ولو نقول دربخوا لدربخوا ... لفحلنا إن سره التنوخ
...
آل خثر يقول يبول مثل الدم حين يطعن بالمد ية في تريبة البعير، فإذا استبان حمل الناقة قيل قد قرحت تقرح قروحا يقال كان ذلك عند قروحها [وقروحها] ابتداء حملها، فإذا ثبت اللقاح فهي خلفة والجماع المخاض فلا تزال خلفة حتى تبلغ عشرة أشهر، فإذا بلغت عشرة أشهر فهي عشراء وقد عشرت وهي إبل عشار، فإذا',NULL,'68',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (97,'عظم البطن واستبان فيه الولد قيل قد أرأت فهي مرء كما ترى، فإن رجعت ولم تكن حاملا فهي راجع والجماع الرواجع يقال رجعت ترجع رجاعا، فإذا عرضت على الفحل لينظر أحامل هي أم حائل فذلك البور يقال قد انطلق بالناقة تبار على الفحل، قال مالك ابن زغبة:
...
اعجل بغرب مثل غرب طارق ... ومنجنون كأتان الفارق',NULL,'70',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (99,'شبه الغرب بالأتان الفارق في ضخم الجنبين وهي أعظم ما تكون بطنا إذا تهيأت للنتاج، يقال ناقة فارق وإبل فوارق وفرق، وقال عبد بني الحسحاس وشبه نتاج الغنم بنتاج الإبل وذكر غيما:
...
قال وحدثنا عيسى بن عمر قال قالت أم تأبط شرا لما بكت عليه',NULL,'71',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (100,'والله ما حملته وضعا ولا ولدته يتنا ولا أرضعته غيلا، فإذا دنا ولاد الناقة فخرج رأس الحوار مست ذفراه ومجتمع لحييه فيعرف أذكر هو أم أنثى فذلك التذمير والمذمر الذفر يان ومجتمع اللحيين، ويقال لمجتمع اللحيين الشجر، والرجل الذي يذمر يقال له مذمر، قال ابن مرداس:
...
فإذا قام ومشى وتحرك قيل رشح وهو راشح، وهى المطفل ما دام ولدها صغيرا، فإذا ارتفع عن الرشح وانطوى خلقه وقوي ومشى',NULL,'73',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (102,'مع أمه قيل قد جدل وهو حوار جادل. فإذا نبت في سنامه شيء من شحم قيل قد أكعر وهو مكعر، وهو في هذا كله حوار، فإذا كان من نتاج الربيع فهو ربع والأم مربع. قال جرير:
...
من كل كوماء السنام فاطم ... تشحى بمستن الذنوب الراذم',NULL,'75',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (104,'شدقين في رأس لها صلادم
...
يعصل يعوج، فإذا أتت عليه بعد البزول سنة فهو مخلف عام، فإذا',NULL,'76',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (105,'أتت عليه سنتان فهو مخلف عامين، فإذا أتت عليه ثلاثة أعوام فهو مخلف ثلاثة أعوام، ويقال للناقة بازل وبزول. وشارف وشروف. قال إهاب بن عمير:
...
وقال ابن لجإ:',NULL,'77',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (106,'حتى ترى كل علاة صلدم ... شابت من الحمض ولما تهرم
تنوش منه بجران سرطم
...
الضواة السلعة، فإذا ارتفعت وتكسرت أسنانها وعابت أي دخلها عيب قيل ناقة لطلط وناقة كحكح وناقة دردح وناقة كاف في الأناث والذكور، فإذا سال لعابها قيل ناقة ماجة وجمل ماج، ويقال عمر البعير أن ينتج مع الغلام فينحر في عرسه، فإذا ذبح أو مات أو وهب ولدها فهي عجول وسلوب ومفرق. قال ابن رعلاء الغساني:',NULL,'78',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (107,'ما وجد ثكلى كما وجدت ولا ... وجد عجول أضلها ربع
وقال لقيط بن زرارة:
...
منى لك قدر لك، قال وأنشدني عيسى بن عمر لدريد بن الصمة يصيد أحدان الرجال وإن يجد ثناءهم يفرح بهم ثم يزدد فإذا مات الولد في بطن أمه ويبس قيل أحشت وهي ناقة محش.',NULL,'79',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (108,'والولد حشيش، قال والحشيش اليابس ومن قال للرطب حشيش فقد أخطأ إلا أن يكون يابسا، فإذا نتجت من العام المقبل ألقته مع الولد الآخر، فإذا ألقت ولدها ناقصا قيل لذلك روبع ويقال جاءت به روبعا ويقال فصيل روبع وحائل روبعة، قال رؤبة بن العجاج:
...
ويقال بنو فلان لا يزالون يضوون إلى فلان أي لا يزالون يرجعون إليه ويقال فلانة تضوي إليها أخبار الناس أي ترجع وقد ضوت تضوي ضويا، ويقال ما ضوى إليك من خبر فلان، ويقال ضوي يضوى ضوى شديدا إذا ضعف من تقارب النسب، ويقال استغربوا لا تضووا يقول انكحوا البعاد النسب لا تصغر عظام أولادكم، ويقال غلام فيه ضاوية وغلام ضاوي، وبقال لولد كل بهيمة إذا أسيئ',NULL,'80',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (109,'غذاؤه جحن ومحثل وجدع، وكلما غذي بغير أمه يقال له عجي ويقال عند بني فلاحوار يعاجونه بغير أمه، قال النمر بن تولب:
...
ويقال للبعير إذا حسن غذاؤه كانت له درة أمه وعلالتها وعفافتها، فأما الدرة فما ينزل من صلبها إلى ضرتها، وأما العلالة فلبن ينزل',NULL,'81',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (110,'بعد لبن وأصل ذلك من قولك نهل البعير وعل، فأما النهل فالشربة الأولى وأما العلل فالثانية، وأما العفافة فأن يحلب الرجل الناقة أو الشاة ويلقي ولدها عليها فما أنزلت بعد ذلك فهي العفافة، قال الاعشى وذكر ظبية ترضع ولدها.
...
يصف امرأة يقول لم تكن تخاف فيوضع عليها رقيب ولم تكن ممن',NULL,'83',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (112,'يهون على أهله فيتر كوها فهي بين ذلك، وقوله في خلايا أربع أي مع خلايا أربع كقول النابغة الجعدي:
...
والقلع الخف الخلق أو جلدة شبه الزنفالجة، ينوء [بقلع] راعيها يقول تثقل فيه التوادي حتى يميل، فإذا صرت الناقة فخشي عليها إذا حفلت أو يضيق الصرار جعل بين الخيط والخلف بعرة من بعرها فذلك البعر الذيار، قال الراجز:',NULL,'84',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (113,'حرقها من النجيل أشهبه ... ومرتع من ذي الفلاة يطلبه
...
فظل حولا في رضاع نرجله',NULL,'86',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (115,'فإذا درت الناقة على غير ولدها أو على غير ما تعطف عليه فهي مري كما ترى، ويقال درت تدر درورا إذا أنزلت اللبن، ودر الخراج إذا كثر، وجمع مري مرايا، ومسح الضرع لتدر المرية مضموم وإنما سميت مرايا أنها تدر على المسح، والمسح المري، قال أبو زبيد:
...
ويقال حشك الوادي بملء جنبيه إذا دفع، والصرف صبغ أحمر.',NULL,'87',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (116,'قال أنشدنا أبو عمرو بن العلاء [لسلمة بن الخرشب الأنماري]
...
والعمل المصر، فإذا اتسع الشخب فهي ثرة يقال ناقة ثرة بينة الثرور، ويقال للطعنة الكثيرة الدم ثرة، فإذا أسرع انقطاع لبن الناقة فلم يبق إلا قليلا حتى يحف فهي قطوع، فإذا دام غزرها فهي مكود [ومنوح] وإبل مكائد ومنائح ويقال ما نحت ناقة فلان العام أجمع، قال الراجز:',NULL,'88',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (117,'إن شرك الغزر المكود الدائم ... فاعمد براعيس أبوها الرائم
...
رأوا نعما يقول يجاء بهذه الإبل قرب البيوت فتلتف فيراها أهل الحوار فيعجبون بها، فإذا كانت الناقة سريعة الاستعطاش',NULL,'89',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (118,'قيل ناقة هافة وناقة مهياف، والعسوس شيئان في الإبل فأحدهما أن الناقة إذا ضجرت عند الحلب قيل ناقة عسوس وفيها عسس وهو سوء الخلق، ويقال بئس العسوس أي بئست مطلب الدرة، وطلب الدرة أن يدخل فيروز ويمسح الضرع، قال ابن أحمر:
...
والضريب لبن يحلب بعضه على بعض حتى يتلبد ولا يكون إلا من إبل شتى لا يكون من واحدة، ويقال أكفأ فلان فلانا وهو',NULL,'90',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (119,'أن يعطيه أولادها وأوبارها وألبانها تلك السنة كلها كما قال ذو الرمة:
...
ويقال الصيد والصاد ويقال أخذه صيد وصاد إذا أخذه ورم في أنفه، فشبه الورم باليربوع، وقوله تنفضان أي تذهبان، ويقال أنفض بنو فلان إذا ذهب زادهم ويقال أصبح بنو فلان منفضين إذا لم يبق معهم زاد، والمقلات التي لا يعيش',NULL,'91',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (120,'لها ولد، قال والقلت الهلاك، قال وسمعت شيخا من بلعنبر يقول إن ابن آدم ومتاعه لعلى قلت إلا ما وقى الله، وقال [أبو المثلم] الهذلي:
...
أي مثل تشقيق الرهاط، ويقال ما في إبله قاضية أي ليس فيها ما يجوز عند أصحاب الصدقة ولا في الديات، والقاضية التي تقضي عنه، قال ابن أحمر:',NULL,'92',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (121,'لعمرك ما أعان أبو حكيم ... بقاضية ولا بكر نجيب
...
قد عريت زمنا حتى استطف لها ... كتر كحافة كير القين ملموم',NULL,'93',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (122,'قال ولم أسمع بالكتر إلا في هذا البيت، واستطف ارتفع، فإذا كانت الناقة مفترشا سنامها في جنبيها وليس بمشرف قيل ناقة دكاء كما ترى وهو الدكك، فإذا كانت مشرفة السنام فهي مسنمة وسنمة، قال رجل من أهل البادية يذكر الطعام في اليوم البارد * جزور سنمة وموسى خذمة في غداة شبمة *، فإذا عظم جنبا السنام وجريا بالشحم على الأضلاع قيل جزور شطوط وهن جزر شطائط، ويقال جزور عظيمة الشطين أي عظيمة جنبي السنام، قال الراجز [وهو أبو النجم]
شط أمر فوقه بشط ... لم ينز في البطن ولم ينحط',NULL,'94',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (123,'<span data-type="title" id=toc-46>ومما يذكر به غزارة الإبل:</span>
يقال ناقة رهشوش إذا كانت رقيقة خوارة غزيرة والغزر مع الخؤورة، قال رؤبة بن العجاج:
أنت الجواد رقة الرهشوش
ويقال ناقة خبر إذا كانت غزيرة وأصل ذلك من المزادة تسمى الخبر، قال النابغة يذكر إبلا الماء للخيل في المزادة مقرنة بالأدم والصهب كالقطا عليها الخبور محقبات المراجل ويقال ناقة برعيس إذا كانت رقيقة غزيرة، ويقال ناقة صفي وهن الصفايا إذا كن غزارا، وناقة لهموم إذا كانت غزيرة وإبل لهاميم، وناقة خنجور وهي الغزيرة،',NULL,'94',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (124,'<span data-type="title" id=toc-47>ما يذكر به البكء</span>
...
عطفنا لهم عطف الضروس من الملا ... بشهباء لا يأتي الضراء رقيبها',NULL,'95',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (125,'الملا أرض مستوية، ويقال ناقة نخور وهي التي لا تدر حتى يضرب أنفها، وناقة عصوب وهي التي لا تدر حتى يعصب فخذاها، قال الحطيئة:
...
وقال الطرماح:',NULL,'96',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (126,'نزيعان من جرم بن زبان إنهم ... أبوا أن يريقوا في الهزاهز محجما
وقال العجير:
...
كانت نجائب منذر ومحرق ... أماتهن وطرقهن فحيلا',NULL,'97',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (127,'الفحيل من الإبل الذي يصلح للضراب، ويقال بعير للرحلة إذا أريد للركوب، ويقال بعير ذو رحلة إذا كان قويا على الركوب، ويقال بعير ذو فحلة إذا كان يصلح للافتحال، ويقال بعير مسدم إذا حبس عن آلافه ولا يكون إلا في الذكور، والفأيل ابن مخاض وابن لبون والأنثى أفيلة، قال إهاب بن عمير:
...
ويقال بعير أركب وناقة ركباء إذا كان وارم الركبة، ويقال',NULL,'98',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (128,'ناقة حلبانة ركبانة إذا كانت تصلح للركوب وللحلب. وحلباة ركباة مثلها، ويقال بعير أحرد وناقة حرداء إذا كان بنفض إحدى يديه إذا سار، قال أبو نخيلة:
...
وقال النمر بن تولب:
كأن بهو ذراعيه وبركته ... إذا توجه يمشي مقبلا باب',NULL,'99',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (129,'ويقال ناقة طرفة إذا كانت تتبع المرعى وتستطرفه، ويقال ناقة أزية إذا كانت لا تشرب إلا عند مصب الدلو، ومهراق الدلو يسمى الإزاء، قال ابن لجإ:
...
ويقال ناقة تاجرة إذا كانت نافقة إذا أدخلت السوق، ويقال ناقة وذمة وهي التي في حيائها مثل الثآليل فيقال وذموها فيقطع ذلك فتلقح، ويقال ناقة عائط وهي تعتاط رحمها لا تحمل أعواما، ويقال اعتاطت أعواما لا تحمل، واعتاطت رحمها',NULL,'100',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (130,'واعتاصت سواء، ويقال ناقة ممارن إذ كثر ضراب الفحل إياها وليس تلقح، ويقال ناقة خنجور وهي الغزيرة، قال الراجز:
...
وبقال ناقة علاة وعليان إذا كانت مشرفة، وإذا قيل كعلاة القبن إنما يراد الشدة، ويقال ناقة عبسور إذا كانت شديدة. وناقة عيسجور إذا كانت كذلك، ويقال بعير صلخد إذا كان شديدا،',NULL,'101',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (131,'ومثله صلاخد وصلخد، ويقال ناقة جلعد إذا كانت عظيمة غليظة شديدة، ويقال بعير جلاعد، قال الراجز [وهو أبو محمد الفقعسي]
...
وقال [العجاج]
أنت وهبت الهجمة الجرجورا',NULL,'102',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (132,'ويقال أيضا جراجير، ويقال للبعير قد أبل يأبل إذا اجترأ بالرطب عن الماء، ويقال للناقة إذا أسنت وفيها بقية عيضموز وجلفزيز، والناقة العيطموس الحسناء التامة، قال النابغة الجعدي:
سديس لديس عيطموس شملة ... تبار إليها المحصنات النجائب
...
[بأسفل ذات الدير أفرد حجشها] ... فقد ولهت يومين فهي خلوج',NULL,'105',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (135,'وناقة زبون وهي التي تدفع الحالب، وناقة مبخانة وهي [التي] تمد عنقها عند الحلب ولنعس وتفاج، ومثل من الأمثال ما اختلفت الدرة والجرة، والشاة تدر على الجرة، وبعير ثفال إذا كان بطيئا ثقيلا، وناقة خلؤ وقد خلأت تخلا خلاء إذا بركت فربضت فلم تقم، قال زهير:
...
ويقال بعير وهم إذا كان ضخما ذلولا وناقة وهمة، ويقال بعير مكر إذا كان يتلقف بيده [في] المشي، قال القطامى:',NULL,'106',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (136,'[وكل ذلك منها كلما رفعت] ... منها المكري ومنها الزالج السادي
...
الوغرة شدة الحر، ومذلا مسترخية قد ذهب انقباض الشتاء',NULL,'107',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (137,'فاسترخت فلانت، ويقال فلان مذل بماله إذا استرخى عنه وكان سحي النفس عنه ويقال ناقة جيدة الأرض يراد بذلك شديدة القوائم، وأرض البعير قوائمه، قال العجاج:
...
والكفل كساء يشد على البعير ليركبه الردف يقال اكتفل بعيره يكتفله اكتفالا، قال أبو ذؤيب:',NULL,'110',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (140,'فجاء به من آل بصرى وغزة ... على جسرة مرفوعة الذيل والكفل
...
والمثمل الذي فيه الثمالة والثمالة الرغوة، ومثله قول الراعي:',NULL,'111',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (141,'إذا غر المحالب أتأقته ... يمج على مناكبه الثمالا
...
ويقال خف مشعر، وقد أشعره ذلك الأمر هما أي أدخله، والشعار ما استدخل، ويقال نعوذ بالله من الدين شعارا ودثارا، ويقال ما شعرت بذلك الأمر شعرة حتى كان كذا وكذا، ويقال طاروا شعارير في الأرض أي متفرقين، ويقال أشعر ناقته إشعارا إذا',NULL,'112',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (142,'طعن في عرض سنامها بمشقص حتى يدميه لتصير بدنة، قال وحدثنا حماد بن زيد عن يحيى بن عتيق قال قلت للحسن من أين أشعر بدنتي قال من الشق الأيسر قلت أحفظ الآن أنه قال من حيث أركب، قال وحدثنا العمري أظنه ذكر عن نافع أنه قال كان ابن عمر إذا أشعر بدنه أشعرها من الشق الأيسر والأخرى من الشق الأيمن، ويقال نزلنا بأرض شعراء إذا كانت كثيرة الشجر، قال الطرماح:
...
فإذا كان ذلك من عادتها فهي معجال. والمعجال من الإبل التى إذا وضع الرجل رجله في غرزها قامت ووثبت. قال الراعي:',NULL,'113',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (143,'ولا تعجل المرء قبل الورو ... ك وهي بركبته أبصر
...
والمبرق التي تشول بذنبهو تقطع بولها وتجمع قطريها وهو أن ترفع عجزها ورأسها، ومثل من الأمثال لست من تكذابك وتأثامك شولان البروق أي إنك تبرق مثل هذه فيظن الناس أنك صادق فتكذب كما كذبت هذه فزعمت أنها لاقح وليست بلاقح، قال ذو الرمة:',NULL,'114',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (144,'وللشول أتباع مقاحيم برحت ... به وامتحان المبرقات الكواذب
...
إذا سمعن صوت فحل شقشاق ... قطعن مصفرا كزيت الأنفاق',NULL,'115',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (145,'<span data-type="title" id=toc-48>ومما يذكر من أسماء الإبل</span>
...
أي يصيرون إلى غيرها وذو الحق يحيد عنها وذلك أنها لا يصاب منها ولا يقرى فيها ضيف، والقرن الحبل يشد به القرينتان، فإذا قال يصد عن القرن علم أنه يصد عنها، والصبة فوق ذلك، ويقال على آل فلان صبة من الإبل',NULL,'115',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (146,'وهي من العشرين إلى الثلاثين إلى الأربعين، قال بعض الشعراء:
...
وقال أبو ذؤيب:
كأن ثقال المزن بين تضارع ... وشابة برك من جذام لبيج',NULL,'116',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (147,'لبيج ضارب بنفسه. وإذا عظمت الإبل وكثرت قيل أتانا بمائة من الإبل مدفئة، وإذا كثرت وبر الناقة وكانت جلدة قيل ناقة مدفأة. قال الشماخ:
وكيف يضيع صاحب مدفآت ... على أثباجهن من الصقيع',NULL,'117',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (148,'<span data-type="title" id=toc-49>ومما يذكر من أدواء الإبل</span>
...
ومن أدوائها الشك يقال بعير شاك وقد شك يشك إذا ظلع ظلعا خفيفا والظلع الشك وبه شك يسير، فإذا أخذ البعير مثل الحمى فسخن جلده وكثر شربه للماء حتى نحل جسمه فذلك الهيام يقال بعير هيمان وإبل هيام كقولك عطشان وعطاش وناقة هيمى، فإذا برأ من ذلك قيل قد تجفر تجفرا، فإذا أخذه ربو',NULL,'118',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (150,'قيل حشي يحشى حشى شديدا وهو بعير حشيان، قال أبو جندب الهذلي:
...
والعرر أن لا يكون للبعير سنام وبعير أعر وناقة عراء بينة العرر، فإذا أصاب السنام دبر وداء فقطع فهو بعير أجب وناقة',NULL,'119',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (151,'جباء وهو الجبب، وإذا أصاب الغارب دبرة فخرج منها عظم وبقي مكانه مطمئنا فهو الجزل يقال بعير أجزل وناقة جزلاء، ومن أدوائها المغلة وهو أن تأكل البقل مع التراب يقال مغل البعير يمغل مغلة شديدة، ومن أدوائها الحقلة يقال حقل يحقل حقلة شديدة، قال رؤبة:
...
يقال انقعف الكثيب إذا وقعت منه قطعة. يقول شدا على سرتي',NULL,'120',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (152,'لا تندلق. وإذا أخذ البعير سعال في صدره سعال جشب جاف قيل بعير مجشور وناقة مجشورة.
...
ومن أدوائها الخفج يقال بعير أخفج وناقة خفجاء وقد خفج يخفج خفجا وهو أن تعجل رجلاه عند رفعهما كأن به رعدة،',NULL,'121',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (153,'ومن أدوائها القرع وأكثر ما يكون في القوائم والعنق والمشافر وسائر الجسد وهو بثر، فإذا اجتمع واتصل تقوب الوبر عنه، [و] يقال قرع بعيرك فينضح الفصيل بالماء ثم يلقى في التراب فيجر فيه، قال أوس بن حجر:
...
و [يقال] رجل به طريقة شديدة، وبعير أنكب وناقة نكباء ويقال نكب ينكب نكبا إذا أصابه ظلع فيمشي متحرفا،',NULL,'122',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (154,'ونكب ينكب نكوبا ونكبا إذا تحرف عن الطريق، قال العجاج:
وأم أوعال كها أو أقربا ... ذات اليمين غير ما إن ينكبا',NULL,'123',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (155,'<span data-type="title" id=toc-50>ومما يذكر من سير الإبل</span>.
...
يا ابن التي على قعود حفاد',NULL,'123',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (156,'وإذا استدخل رجليه فهملج بهما ودحا بيديه فذلك المشي يعني به الهملجة، فإذا ارتفع عن ذلك فهو المرفوع ويقال رفع يرفع وهو بعير رافع، فإذا ارتفع عن ذلك حتى يكون عدوا يراوح فيه بين يديه قيل خب يخب خبيبا، فإذا ارتفع عن ذلك قيل دأدأ يد أدئ دأدأة، قال الشاعر [وهو أبودؤاد الرؤاسي]
...
كأن راكبها غصن بمروحة ... إذا تدلت به أو شارب ثمل',NULL,'124',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (157,'ويروى:
...
دويقال نعب ينعب نعبا، وأنشدنا أبو عمرو:',NULL,'125',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (158,'تواهق بالركبان أما نهارها ... فسعم وأما ليلها فهي تنعب
...
والمناقلة تكون في الخيل والإبل إذا عدا في الحجارة ناقل وضع رجله في موضع ليس فيه حجارة، والمواهقة المسايرة يقال مرا يتواهقان، والمواغدة مثلها.',NULL,'126',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (159,'<span data-type="title" id=toc-51>ومما يذكر من ألوان الإبل</span>.
...
فإذا شربت يوما غدوة ويوما عشية فاسم ذلك الظمء [العريجاء،',NULL,'128',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (162,'فإذا شربت كل يوم نصف النهار فاسم ذلك الظمء] الظاهرة يقال إبل بني فلان ترد الظاهرة وهي إبل ظواهر والقوم مظهرون، فإذا شربت يوما وغبت يوما فذلك الغب يقال جاءت إبل بني فلان غابة وبنو فلان مغبون، فإذا شربت يوما غبت يومين فذلك الربع يقال جاءت إبل بني فلان رابعة والقوم مربعون، قال العجاج:
...
ظلت بمندح الرحى مثولها ... ثامنة ومعولا أفيلها
فإذا زيد في الظمء يوم فوردت يوم التاسع فذلك الظمء التسع',NULL,'129',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (163,'والإبل تواسع وتاسعة والقوم متسعون، فإذا زيد في الرعي يوم ووردت في اليوم العاشر فذلك الظمء العشر والإبل عواشر والقوم معشرون، فإذا بلغ العشر فلا ظمء فوق العشر يسمى إلا أنه يقال رعت عشرا وغبا وعشرا وربعا وكذلك إلى العشرين، فإذا بلغت عشر وعشرا فليس إلا الجزء والقوم مجزئون، قال أبو النجم:
...
متى ما يسف خيشومه فوق تلعة ... مصامة أعيار من الصيف ينشج',NULL,'132',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (166,'<span data-type="title" id=toc-53>ومما يذكر في المواسم والتزنيم</span>.
...
تبين تستبين العنق، والخطاف أن يخط خط حيثما كان ثم يعوج له رأس كذا ورأس كذا كأنه كلاب رحل، والمشط ثلاثة خطوط يفترق رؤوسها من أعلى ثم تجتمع، والخطام ميسم على أنف البعير يقال ناقة مخطومة، والمحلق الذي في عنق حلقتان، قال الشاعر [وهو عوف بن الخرع التيمي]',NULL,'133',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (167,'وذكرت من لبن المحلق شربة والخيل بالصعيد بداد والمحلق ميسم بني فزارة وبنو زرارة يحلقون أيضا، وقال بعض الرجاز في المعلوط والمخبوط:
...
وأنشدنا أبو مهدي:',NULL,'134',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (168,'تربعت أرعل كالنقال ... [و] مظلما بات على دمال
...
ويقال في أصوات الخف والظلف البغام وهي تبغم وتبغم وذلك أن تخرج الصوت فلا تقطعه، فإذا ضجت فهو الرغاء، فإذا طربت في أثر ولدها قيل حنت، فإذا مدت الحنين وطربته قيل سجرت تسجر سجرا، فإذا بلغ الهدير فأوله الكشيش يقال كش يكش كشيشا، قال رؤبة:',NULL,'135',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (169,'هدرت هدرا ليس بالكشيش
...
تم كتاب الإبل',NULL,'136',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (170,'<span data-type="title" id=toc-54>كتاب الإبل عن أبي سعيد عبد الملك بن قريب الأصمعي</span>
...
فإذا تحرك ولدها قيل قد أركضت، فإذا نبت على ولدها الشعر وأخذها لذلك وجع وحكه قيل أكلت، فإذا ورم حياؤها قيل قد أبلمت، فإذا بلغت عشرة أشهر قيل قد عشرت وهي عشراء والجماع العشار، ويكون الإبلام عند النتاج وعند الضبعة، وإذا كان بعضهن في عشرة أشهر وبعضهن قد نتج قيل عشار كلهن، فإذا نتج أولهن وبقي آخرهن فالبواقي متال، وإن لم ينتجن كلهن وما بقي لحقه فدخل في المتالي، والواحدة متلية، وإذا أشرف ضرعها فوقع فيه اللبن فهي الملمع، فإذا وقع فيه اللبأ قبل النتاج فهي المبسق، فإذا دنا النتاج فهي مدنية، فإذا',NULL,'141',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (175,'ضربها المخاض فندت في الأرض فهي الفارق، فإذا ألقت ولدها فهو ساعة يقع سليل، فإذا وقع عليه اسم التذكير والتأنيث فإن كان ذكرا فهو سقب وإن كان أنثى فهو حائل، قال أبو ذؤيب:
[فتلك التي لا يبرح القلب حبها ... ولا ذكرها] ما أرزمت أم حائل
وقال الأسدي:
...
وافى بها الموسم دلاج نقل ... من سدس أو من رباع قد بزل',NULL,'142',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (176,'فإذا أتى عليه عام بعد ذلك فهو مخلف عام، ويقال للناقة بازل وبزول وشارف وشروف، فإذا غلظ نابه واشتد فهو عود، فإذا ارتفع عن ذلك فهو قحر، قال ذو الرمة:
...
فإذا ارتفع [عن] ذلك حتى يكون عدوا يراوح فيه بين يديه قيل خب يخب خببا، فإذا ارتفع عن ذلك قيل دأدأ يد أدئ دأدأة، وبعض العرب يقول دأدأ يد أدئ دئداء. فإذا ارتفع عن ذلك فضرب بقوئمه كلها فتلك الربعة يقال هو يرتبع ارتباعا وربعة، فإذا جعل كأنه يضرب بقوائمه كلها فتلك اللبطة يقال مر يلتبط التباطا، فإذا ازداد فلم يدع جهدا قيل تشغر تشغرا. قال العجاج:',NULL,'147',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (182,'قد أعطت الشعواء والشغورا ... أمورها والشارف القذورا
...
ألا هزئت بنا قرشية يهتز موكبها
والوخدان والوخيد والوخد أن يرمي بقوائمه كأنه يزج بها شبيه بمشي النعام وخد يخد وخدا ووخدانا، وخود يخود تخويدا وهو أن يرتفع عن العنق حتى يهتز في السير كأنه يضطرب. والتهوس مشي المثقل في الأرض اللينة يقال مر يتهوس. ويقال بات يهوس الأرض ليلته. ويقال مر ينأل بجملة نألا ونيلا وهي مشية المثقل بتدافع بحمله. ويقال مر يزعب بحمله. ويقال رسم يرسم رسيما وهو فوق الذميل. ويقال نعب ينعب نعبا. ويقال',NULL,'148',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (183,'عسج يعسج عسجا. ووسج يسج وسيجا ووسجا وهو سير صالح، ويقال أل يئل وهو مشي مدارك سريع، ويقال مر يمتل امتلالا وهو مر سريع سهل، ويقال مر يتغيف تغيفا وهو أن يتثنى في شقه من اللين والسبوطة، وقال العجاج:
يكاد يرمي القاتر المغلفا ... منه أجاري إذا تغيفا
...
ويقال وضع البعير يضع وضعا وهو دون الشديد وأوضعته أنت توضعه إيضاعا، ووجف يجف وجيفا وأوجفته أنت، ويقال نصصت البعير فأنا أنصه نصا ولا يكون منه فعل البعير، ويقال رفع البعير رفعا وقد رفعته رفعا.',NULL,'149',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (184,'<span data-type="title" id=toc-57>ألوان الإبل</span>.
...
INSERT INTO [b8533] VALUES (188,'قال وأنشدنا أبو عمرو بن العلاء قال رؤبة كان أبي يعجبه هذا البيت [لامرئ القيس]
يثير ويذري تربها ويهيله ... إثارة نباث الهواجر مخمس
...
فإذا زيدت في الرعي يوما فذلك الظمء التسع والإبل تواسع وتاسعة، فإذا زيدت في الرعي يوما فذلك الظمء العشر والإبل عواشر وعاشرة، فإذا بلغت العشر فلا ظمء فوق العشر يسمى إلا أنه يقال رعت عشرا وغبا وربعا فكذلك إلى العشرين، فإذا استغنت بأكل الرطب قيل قد جزأت تجزأ جزوءا والإبل جوازئ والقوم مجزئون، ويقال لكل شيء من هذه الإبل فواعل والقوم مفعلون إلى العشرة.',NULL,'152',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (189,'<span data-type="title" id=toc-59>أدواء الإبل</span>.
المغلة وهو أن تأكل البقل مع التراب فيقال مغل يمغل مغلة شديدة، ومن أدوائها الحقلة يقال حقل يحقل حقلة شديدة وقال رؤبة:',NULL,'152',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (190,'ذاك ونشفي حقلة الأمراض
وقال آخر:
داء بهم غمر من الأمغال
...
حتى إذا كن من التسكير ... من ساعل كسعلة المجشور',NULL,'155',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (193,'ومن أدوائها الصاد والصيد وهو داء يأخذ الإبل في رؤوسها فيلوي أحدها رأسه فيقال بعير أصيد إذا أخذه ذلك، قال رؤبة:
إذا استعيرت من جفون الأغماد ... فقأن بالصقع يرابيع الصاد
...
[أدنى تقاذفه التقريب أو خبب] ... كما تدهدى من العرض الجلاميد',NULL,'156',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (194,'أسماء عدد الإبل.
...
ولا شارف حبشاء ريعت فرجعت ... حنينا فأبكى شجوها البرك أجمعا
تم كتاب الإبل عن الأصمعي والحمد لله رب العالمين وصلواته على سيدنا محمد النبي وعلى آله الطيبين الطاهرين صلاة وسلاما دائمين إلى يوم الدين.',NULL,'157',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (195,'<span data-type="title" id=toc-60>كتاب خلق الإنسان</span>
<span data-type="title" id=toc-61>ما يذكر من حمل المرأة وولادتها والمولود</span>
...
كتاب خلق الإنسان.
...
تمليتهم أي تمتعت بهم، ويقال من هذا لبست جديدا وتمليت حبيبا أي تمتعت به، فإذا احتلم فهو حالم، فإذا خرج وجهه فهو طار',NULL,'160',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (199,'ويقال قد طرشاربه، قال الشاعر [وهو أبو قيس بن رفاعة] :
...
تهوي رؤوس القاحرات القحر ... إذا هوت بين اللها والحنجر',NULL,'161',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (200,'ويقال جمل قحر وقحارية مثل قراسية والقراسية الضخم من الإبل الكبير، فإذا أخلق فهو إنقحل ويقال رجل إنقحل وامرأة إنقحلة، قال الراجز:
...
ظلت ثلاثا لا تراع من الشذى ... ولو ظل في أوصالها العل يرتقي',NULL,'162',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (201,'والعل هاهنا القراد الصغير الجائع وهو أعض ما يكون وأخبثه، وكل مسن صغير الجرم فهو عل، والشذى مقصور الأذى.',NULL,'163',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (202,'<span data-type="title" id=toc-63>هذا ما تسمي العرب من جماعة خلق الأنسان</span>.
...
طى الليالي زلفا فزلفا ... سماوة الهلال حتى احقوقفا',NULL,'163',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (203,'ويقال رأيت سماوة كذا وكذا لشخص أعلاه، قال طفيل:
...
ويقال للإنسان إذا كان راكبا إنه لحسن القمة على الرحل أي حسن الشخص عليه. والجثمان الشخص. والجسمان الجسم، ويقال',NULL,'164',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (204,'جاءنا بثريدة مثل جثمان القطاة، وجماعة جسم الإنسان يقال لها الجسمان. تقول العرب نحل جسمان فلان.
...
الصلب والصلب واحد في لغة العجاج وذلك أن المؤدم اللين، ومثل من الأمثال إنما امرأة فلان المبشرة المؤدمة، يراد بذلك',NULL,'165',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (205,'التامة في كل وجه. ويقال للرجل الكامل إنه لمبشر مؤدم إذا جمع لينا وشدة وذلك لأنه جمع لين الأدمة وخشونة البشرة. ويقال في مثل آخر إنما يعاتب الأديم ذو البشرة أي إنما من الرجال من يرجى ومن به مسكة وقوة. وقوله يعاتب أي يعاد في الدباغ.
...
بضرب في الجماجم ذي فروغ ... وطعن مثل تعطيط الرهاط',NULL,'166',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (206,'وفي الجمجمة القبائل وهي أربع وهي قطعه المشعوب بعضها إلى بعض الواحدة قبيلة، قال الهذلي:
...
وفي الرأس الدائرة وهي الشعر الذي يستدير على القرن يقال ما',NULL,'168',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (208,'تقشعر دائرته. والمسائح ما بين الأذن والحاجب واحده مسيحة يتصعد حتى يكون دون اليأفوخ، قال كثير:
...
ويقال إنه للئيم المقذين إذا كان هجين ذلك الموضع، ومن الرؤوس الأكبس وهو المستدير العظيم، وهامة كبساء وكباس، ورجل أكبس وهو العظيم الرأس، ولذلك قيل قفاف كبس أي ضخام، ويقال رجل كروس إذا كان عظيم الرأس، ومنها المصفح [والمصفح]',NULL,'169',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (209,'وهو الذي يضغط من قبل صدغيه فيطول ما بين جبهته وقفاه، وفيه الصعل يقال رجل صعل وامرأة صعلة وهو دقة في الرأس وخفة، ومنها المؤوم وهو المستدير، قال الشاعر يصف ناقته وسرعة سيرها:
...
وهو المسمع مكسور الأول، والمسمع مفتوح المكان من قوهم هو مني مرأى ومسمعا، ومنه يقال جدع الله مسامعه، وفي الأذن الصماليخ وهي مثل القشور يخرج منها والواحد صملاخ ويقال صملوخ، ومن الآذان الصمعاء وهي اللطيفة الصغيرة وفيه اضطمار ولصوق بالرأس يقال لمن كان كذلك رجل أصمع وأمرأة صمعاء',NULL,'170',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (210,'ويقال إنه لأصمع الفؤاد إذا كان حميز الفؤاد منقبضه، والحميز الشديد، وفي الأذن الخذا والسكك والغضف والقنف، فأما الخذا فهو اشترخاؤها وانكسارها مقبلة على الوجه يقال لمن كان كذلك رجل أخذى وامرأة خذواء، وكذلك ينمة خذواء إذا كانت مسترخية، يريدون بذلك أنها تمت حتى استرخت، والينمة نبت من البقل، وأما السكك فهو صغر الأذن ولزوقها وقلة إشرافها يقال لمن كان كذلك رجل أسك وامرأة سكاء. قال النابغة:
...
والجثل الكثير الملتف. وكذلك من النبت والشجر يقال جثل بين الجثولة',NULL,'171',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (211,'قال الأخطل:
...
وما نهنهت عن سبط كمي ... ولا عن مقلعط الرأس جعد',NULL,'172',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (212,'ويقال شعر جعد، فإذا اشتدت جعودته قيل قطط، قال الشاعر [وهو المتنخل الهذلي]
...
ويقال أسود محلولك وقد احلولك يحلو لك احليلا كا شديدا وإنما أخذ من جلك الغراب. ويقال أسود فاحم من الشعر ومن كل شيء وإنما اشتق من الفحم، والأصبح من الشعر الذي يخلط',NULL,'175',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (215,'بياضا بغبرة. والأمغر الذي هو في لون المغرة، والأصهب الذي يخلط بياضا بحمرة
...
ومن اللحى الكثة وهو يصرف يقال كثت لحيته تكث كثاثة وكثوثة، والعارض من اللحية ما نبت على عرض اللحى فوق الذقن، ويقال قد شابت لحيته وقد شمطت وقد وخطها الشيب',NULL,'176',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (216,'وخيط فيها الشيب، قال الشاعر [وهو بدر بن عامر الهذلي] أصبحت لا أنسى منيحة واحد حتى تخيط بالبياض قروني وقال الآخر:
...
قد حصت البيضة رأسي فما ... أطعم نوما غير تهجاع',NULL,'177',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (217,'وكل شيء من شعر لحية أو رأس يقال له فليلة، ويقال للرجل إنه لعظيم فلائل اللحية وفلائل الرأس، قال ساعدة [بن جؤية] الهذلي:
...
فإذا انحسر الشعر عن الرأس من مقدمه فذلك الجله والجلا والجلح يقال رجل أجله ورجال جله ورجل أجلى ورجال جلو كما ترى وقد جلي الرأس يجلى جلا شديدا وجله يجله جلها شديدا وجلح يجلح',NULL,'178',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (218,'جلحا، قال رؤبة:
...
ثم الحجاجان، والحجاجان العظمان المشرفان على غاري العينين يقال رجل غائر الحجاجين. ورجل مشرف الحجاجين، والحاجبان الشعر النابت على حروف الحجاجين، وفي الحاجبين القرن وهو أن يطول',NULL,'179',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (219,'الحاجبان حتى يلتقي طرفاهما. وفيهما الزجج وهو طول الحاجبين ودقتهما وسبوغهما إلى مؤخر العين. يقال نظر إلي بمؤخر عينه مكسور الخاء مخففة وهي لغة وإن شيءت ثقلت، وفي الحاجبين البلج وهو أن ينقطع الحاجبان فيكون ما بينهما نفيا من الشعر فذلك البلج وذلك الموضع يسمى بلجة، والعرب تستحب البلج وتمدح به ويكرهون الغمم، يقال رجل أبلج وامرأة بلجاء.
...
وفيها الأجفان وهي غطاء المقلة من أعلى وأسفل والواحد جفن، وجماع لحم الأجفان يقال له اللخص، وإذا تغضن أعلى العين من الجفن وكثر تغضن لحمه فذلك اللخص يقال رجل ألخص وامرأة لخصاء، ويقال لخص يلخص لخصا إذا ورم الجفن وغلظ، والتغضن هو التكسر أن يتكسر ما حولها، ويقال كمنت عينه تكمن كمنة شديدة، والجرب كالصدإ يركب باطن الجفن وربما ألبسه أجمع وربما ركب بعضه، وفيها الأشفار وهي حروف الأجفان التي تلتقي',NULL,'180',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (220,'عند التغميض والواحد منها شفر، والشعر الذي ينبت فيها الهدب والواحدة هدبة مخففة، فإذا طالت الأهداب قيل رجل أهدب وامرأة هدباء. ورجل أوطف وامرأة وطفاء وهو مثل الهدب، وكذلك أذن هدباء إذا كانت كثيرة الشعر كل ذلك طول، والمحجر ما خرج من النقاب من الجفن الأسفل لا يكون من الأعلى.
...
وفي العين الحوص وهو ضيق في مؤخرها يقال حوصت عينه تحوص حوصا ورجل أحوص وامرأة حوصاء، والحوص خياطة العين يقال حصن عين صقرك وحص شقاقا في رجلك، وفيها الخوص وهو صغرها وغؤورها يقال خوصت تخوص خوصا، وفيها النجل وهو سعة العين وعظم المقلة وكثرة البياض، وفيها الغطش وهو ضعف في النظر وتغميض العين، ومثله الخفش ونرى أن الخفاش اشتق من',NULL,'181',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (221,'ذلك لأنه يشق عليه ضوء النهار، وفيها الدوش وهو ضعف البصر وضيق العين يقال دوشت عينه تدوش دوشا، ويقال بعينه هدبد إذا كان بها عشاء، ويقال غشيت عيني سمادير إذا غشيها كالغشاوة من مرض أو جوع أو غير ذلك ومن ذلك يقال اسمدرت عيني تسمدر اسمدرارا، قال الكميت:
...
ويقال في عينه كوكب وهى النقطة تبقى من بياض، ومثلها',NULL,'182',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (222,'الودقة مخففة يقال ودقت عينه تيدق ودقا، قال رؤبة:
...
وفيها الخزر وهو أن يكون الرجل كأنما بنظر في أحد شقيه يقال للرجل تخازر. ويقال نظر إلي شزرا وذلك إذا نظر إليه عن يمينه وعن شماله ولم يستقبله بنظره. ويقال للرجل إذا طعن',NULL,'184',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (224,'عن يمينه وعن شماله طعن شزرا. قال العجاج:
...
وفي العين الظفرة وهي جلدة تجري من الموق فإذا غشيت الحدقة ألبستها، ويقال أجد في عيني حثرا وهو خشونة من الرمص ويقال حثرت عينه إذا وجد فيها خشونة ويقال حثرت عينه تحثر حثرا، ومنه حثر العسل يحثر حثرا إذا أخذ يتحبب ليتغير، ويقال حثر فمه إذا حثر فيه الريق، ويقال قدحت عينه وقدحت مشددة فهي قادحة ومقدحة. ويقال جاءنا قادحة عينه يريد غارت وماجت. قال رجل من آل النعمان بن بشير [وهو إبراهيم بن النعمان بن بشير الأنصاري]',NULL,'185',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (225,'[و] العين قادحة واليد سابحة والرجل ضارحة والمتن ملحوب ومعنى ملحوب ليس عليه لحم، قال زهير:
...
بنت عليه الملك أطنابها ... كأس رنوناة وطرف طمر.',NULL,'186',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (226,'وقال العجاج:
...
ذي خنزوانات ولماح شفن',NULL,'187',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (227,'والخنزوانة الكبر يقال إن في رأسه كبرا وخنزوانة،
...
وقال أبو كبير في الروثة:',NULL,'188',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (228,'حتى انتهيت إلى فراش عزيزة ... سوداء روثة أنفها كالمخصف
...
وفي الأنف الفغم يقال رجل أفغم وامرأة فغماء وهو طمأنينة مؤخره مما يلي العينين يقال فغم يفغم فغما، وفي الأنف الخنس',NULL,'189',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (229,'وهو تأخره إلى الرأس وارتفاعه عن الشفة وليس بطويل ولا مشرف يقال إنه لشديد الخنس ورجل أخنس وامرأة خنساء، قال زهير:
...
وفي الأنف الخرم وهو أن ينشق الوترة التي بين المنخرين أو يتخرم الأنف من عرضه يقال رجل أخرم وامرأة خرماء.',NULL,'190',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (230,'ثم الفم، وفي الفم الثنايا والر باعيات والأنياب والضواحك والنواجذ، فالضواحك أربعة أضراس من ذلك تلي الأنياب إلى جنب كل ناب من أسفل الفم وأعلاه ضاحك، وأما الأرحاء فهي ثمانية أضراس من كل شق من أسفل الفم وأعلاه، وقال الراعي يصف السيوف:
...
وقال آخر:
وا بأبي أنت وفوك الأشنب ... كأنما ذر عليه زرنب',NULL,'191',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (231,'أو زنجبيل عاتق مطيب
...
تيس تيوس إذا يناطحها ... يألم قرنا أرومه نقد',NULL,'192',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (232,'يعني أصله قد نقد أي انكسر مما يناطح، وفيها القضم يقال قضم فم فلان يقضم قضما وذلك إذا انكسرت أطراف أسنانه وتفللت واسودت وانفلجت، قال الشاعر [وهو راشد بن شهاب اليشكري:
...
وفيها الثعل وهو أن تكون أسنان زوائد عن عدة الأسنان، وكذلك شاة ثعول إذا كان فوق خلفها خلف صغير يقال لذلك الخلف الثعل فيقال فيها ثعل، قال يحيى بن عباد عن بعض قومه يهجو امرأته:',NULL,'193',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (233,'إذا أتت جارتها تستفلي ... تفتر عن مختلفات ثعل
...
ثم اللثة وهي اللحم الذي ركز فيه الأسنان، والشرف التي تصعد بين اللحم والأسنان يقال لها العمور واحدها عمر، وفي اللثة اللمى مخفف مقصور وهو سمرة في اللثة يضرب إلى السواد وليست بحمراء وكذلك الحوة والحمة يقال لثة لمياء ولثة حواء ولثة حماء، وفي اللثة البثع وهو حمرة اللثة وورمها يقال رجل أبثع',NULL,'194',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (234,'وامرأة بثعاء ورجل بثع ويقال بثع يبثع بثعا شديدا، وفي الفم الضجم وهو ميل في الفم فيما يليه من الوجه يقال رجل أضجم وامرأة ضجماء، قال زهير:
...
والطرامة الريق الذي ييبس على الفم من العطش وتدعوه العرب',NULL,'195',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (235,'الدواية، قال سحيم بن وثيل:
...
ثم اللسان، وفيه عذبته وهي طرفه تقول العرب إذا نعتت خفة اللسان ما أرق عذبة لسانه، وفيه العكدة والعكرة وهما أصل.',NULL,'196',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (236,'اللسان ومعظمه، وفيه الصردان وهما عرقان يستبطنان اللسان، قال الشاعر [وهو النابغة الذبياني]
...
ثم الحلقوم، وهو موضع النفس، والشعب التي تشعب منه فتفرق في الرئة يقال لها القصب، والرئة يقال لها السحر يقال انتفخ سحره إذا فرق، والمرئ هو مجرى الطعام والشراب، قال ولم',NULL,'197',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (237,'أسمع سحر مضموما، قال أبو عبيدة يقال سحر وسحر.
...
الدأي أيضا ضلوع الصدر ملتقاه وملتقى الجنب، قال أبو ذؤيب [كأن عليها بالة لطمية] لها من خلال الدأيتين أريج والأرج توهج ريح طيبة أو شمس أو نار، والقصرة أصل العنق ومغرزها في الكاهل، وفيه النخاع وهو الخيط الأبيض الذي يجري في الفقار حتى يسقي الدماغ، ويقال للدابة والإنسان إذا قطع ذلك منه قد نخع، وفي العنق الأخدعان وهما عرقان في موضع الحجامة وربما اعتراه الوجع عند الكبر، ويقال للرجل إذا امتنع وأبى إنه',NULL,'198',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (238,'لشديد الأخدع، وإذا لان واسترخى قيل قد لان أخدعه، قال الشاعر [وهو رؤبة بن العجاج]
...
ظعائن ما يضحكن إلا تبسما ... وميض غمام الصيف غر السوالف',NULL,'199',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (239,'وقال آخر [وهو امرؤ القيس] :
...
يقال أشب يأشب إذا لصق بالشيء واختلط به، ليا عطفا، ويروى منه نجلت أي ولدت، وفي العنق الجيد والوقص والصعر والهنع والغلب والرقب والتلع، فأما الجيد فهو طول الجيد والجيد اسم يقع',NULL,'200',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (240,'على طول العنق، قال الشاعر [وهو قيس بن الخطيم الأنصاري] :
...
والرقب عظم الرقبة يقال إنه لأرقب وإنها لرقباء بينة الرقب،',NULL,'201',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (241,'والغلب غلظ العنق، والدرواس الغليظ العنق من الناس والكلاب، والتلع إشراف العنق يقال رجل أتلع وامرأة تلعاء، والبتع شدة العنق، قال الشاعر:
كل علاة بتع تليلها
...
والماء في مريئها إذا اتصل ... جار كثعبان الأتي المنسحل',NULL,'202',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (242,'المنسحل الجاري، وفي العنق القدر وهو قصر يقال رجل أقدر وامرأة قدراء، قال الشاعر [وهو أبو خراش بن مرة الهذلي]
...
ثم المنكب، وهو مجمع رأس العضد في الكتف، وفي المنكب',NULL,'203',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (243,'الحدل وهو استرخاؤه يقال رجل أحدل وامرأة حدلاء، قال رؤبة أو غيره:
...
وقد رأى من دقها وضوحا ... حيث تلاقي الإبرة القبيحا',NULL,'205',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (245,'والعظمان المجتمعان هما الزندان والواحد زند، ورأسهما الكوع والكرسوع، والكرسوع رأس الزند الذي يلي الخنصر وهو الوحشي. قال العجاج:
على كراسيعي ومرفقيه
...
المكرب المملو. والصميم العظم نفسه، وأما ما يمشي على رجلين فلا مفصلان في كل يد ورجل فخذ وساق ثم قدم وعضد',NULL,'206',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (246,'وذراع ثم كف، ورأس الزند من إنسي اليد يسمى الكوع، قال الشاعر:
...
فإذا عمل بيديه جميعا قيل أضبط بين الضبط. فإذا كانت قوة يديه سواء قيل أعسر يسر ولا يقال أعسر أيسر.',NULL,'207',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (247,'ثم الكف. وفي الكف الراحة وهي باطن الكف. وفي الراحة الأسرار وهي الخطوط التي فيها والواحد سرر قال الأعشى:
...
وفي الكف البراجم والوا حدة منها برجمة وهي ملتقى رؤوس السلاميات من ظهر الكف إذا قبض الإنسان كفه نشزت وارتفعت. [و] بها سميت البراجم من بني تميم. وفي الكف الأشاجع وهي العصبات التي على ظهر الكف تتصل ببطون الأصابع والواحد',NULL,'208',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (248,'أشجع، قال ذو الرمة:
...
يقال إذا أصابه ذلك عسم يعسم عسما، ويقال ما في قدحه معسم أي مغمز، وفي الكف الكوع وهو أن تعوج الكف من قبل الكوع يقال رجل أكوع وامرأة كوعاء، ويقال للكلب إذا رمض مر يكوع أي يطأ على كوعه وذلك إذا أصابه حر شديد فيرفع إحدى',NULL,'209',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (249,'رجليه من شدة الحر، قال رؤبة:
...
ثم الظهر، وتسمي العرب الظهر المطى مقصو ر. يقال ما له قطع الله مطاه أي ظهره. فموصله في العنق الكاهل. وهو الكتد، والصلب عظم من لدن الكاهل إلى عجب الذنب. وفي الصلب الفقار والواحدة فقا رة وفقرة وهي ما بين كل مفصلين. والدأي فقار الظهر والعنق والواحدة دأية. وهي الطبق والواحدة طبقة وكل فقرة طبقة. والقرى الظهر. والقردودة أعلى الظهر وهي من كل دأية القرى. والصلوان الفجوتان اللتان تبتدان أصل الذنب',NULL,'210',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (250,'بينه وبين الجاعرتين والواحد صلا منقوص قال النابغة:
...
وفي الظهر القعس وهو دخول الظهر وخروج البطن، وفيه',NULL,'211',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (251,'الحدب وهو خروج الظهر ودخول البطن، قال أبو الأسود الدؤلي:
...
والواحد كشح وقرب والجماع الكشوح والأقراب، وفي الجنب الفريصتان وهما المضيغتان اللتان فيما بين مرجع الكتف إلى الثدي إذا فزع الإنسان أو الدابة',NULL,'212',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (252,'أرعدتا منه يقال جاء فلان ترعد فرائصه والواحدة فريصة. والقصيرى وبعضهم يقول القصرى وهي مختلف فيها فبعض العرب يجعلها الضلع القصيرة التي تلي الترقوة وبعضهم يجعلها الضلوع مما يلي الطفطفة، قال أوس:
...
وقال امرؤ القيس:
وكشح لطيف كالجديل مخصر ... وساق كأنبوب السقي المذلل',NULL,'213',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (253,'وقال آخر:
...
وقال زهير:',NULL,'214',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (254,'[تنازعها المها شبها ودر النحور وشاكهت فيه الظباء]
...
وقال العجاج:
تمشي كمشي الوحل المبهور ... على خبندى قصب ممكور',NULL,'215',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (255,'وكل عظم لا يكسر ولا يخلط به غيره فهو جدل، وهو كسر، وهو وصل، ويقال رجل عظيم الاوصال وصغير الأوصال، ويقال ضربه فاختلف وصلاه إذا قطعه باثنين، والصدر ما احتزم به يقال له الحيزوم والجوشوش، قال رؤبة:
...
وقال العجاج:',NULL,'216',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (256,'في جبل صتم إذا ما اصلخمما ... يفل حيداه الرؤوس الصدما
...
وكنت والله العلى الامجد ... أذنيك من قصي ولما تفقد',NULL,'217',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (257,'والجنف أن يكون أحد شقي زوره داخلا منهضما والآخر معتدلا، والمسربة الشعر الذي على الصدر إلى السرة إذا كان مستطيلا. قال الحارث بن وعلة:
...
ثم البطن، فالبطن فيه الكبد، وفي الكبد الزوائد وهي الهنية',NULL,'218',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (258,'المعلقة فيها، وفي الكبد القصب وهي شعبها التي تتفرق فيها. وفيها عمودها وأظنه المشرف الذي في وسطها.
...
وفي البطن الأعفاج والواحد عفج جميعا بكسر الفاء وفتحها. وهي الأقتاب والواحدة قتب وتصغيرها قتيبة وبها سمي الرجل قتيبة. وإليها تصير الطعام بعد المعدة، [و] يقال لذلك كله القصب',NULL,'219',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (259,'مخفف يقال رجل مضطمر القصب أي ضامر البطن، قال ذو الرمة:
...
والأجد موثقة الخلق. والمصلق الشديد الصوت، والشميذر الغليظ الضخم. يصف إبلا، ومن البطون الأهيف وهو الضامر، ومنها الأثجل وهو استرخاء أسفل البطن، وفيه القبب وهو حمصه يقال خمص وحمص وهو انطواؤه، وفيه اللخى وهو استرخاء شقي.',NULL,'221',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (261,'البطن يقال رجل ألخى وامرأة لخواء ورجال ونساء لخو. والعانة منبت الشعر من الركب وإنما كني بالعانة عن الشعر، والركب ما انحدر عن البطن فصار على العظم، وفي الإنسان القحقح وهو العظم الذي عليه مغرز الذكر من أسفل الركب، وفي الانسان الخوران وهو الهواء الذي فيه الدبر ومخرج الذكر وموضع القبل من المرأة يقال للرجل طعن الحمار فخاره وطعن الصيد فخاره، والعصعص طرف عجب الذنب الناتى، وفي الجوف من الأدواء الغاشية، والحبن، والمحنجر، والقداد، والعلوص، والشغاف، والجحاف.
...
شتيمين قبيحي المنظر. والمغابن المراق وهى أصول الفخذين وما',NULL,'224',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (264,'احتزم بذلك المكان يراد بما احتزم به ما أطاف حوله، وواحد المغابن مغبن بكسر الباء، قال زهير:
...
وفي الفخذين الغران والواحد منهما غر وهو العكنة التي تكون في باطن الفخذ، وكل كسر في جلد يقال له غر. وفي الفخذين اللفف يقال رجل ألف وامرأة لفاء وهو عظم الفخذين. وفي الفخذين النهش وهو قلة لحمها يقال إنه لمنهوش الفخذين، والفحج تباعد ما بين الفخذين يقال رجل أفحج وامرأة فحجاء، فإذا كثر لحم الفخذين فتباعد ما بينهما فذلك البدد بقال رجل أبد وامرأة بداء',NULL,'225',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (265,'ثم الركبة، والركبة ملتقى الساق والفخذ. وفي الركبة الداغصة وهي عظم عليه شحم داخل فيها رهل تقول العرب للرجل إذا سمن سمن حتى كأنه داغصة. وفي الركبة الرضفة وهي عظم مطبق على رأس الساق والفخذ، وفي الركبة العين وهي النقرة التي فيها يقال رماه الله على عين ركبته. وهي إحدى القلات التي في الجسد، وباطن الركبة المأبض مهموز.
...
ومنها الكرواء وهى الدقيقة الحمشة، ويقال ذلك في الساعدين إذا',NULL,'226',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (266,'كانا دقيقين. ومنها الخدلجة وهي الرياء الممتلئة، قال العجاج:
...
وفيها العرقوب وهي العصبة التي وصلت بين العقب والساق من ظاهر، وفي القدم القفد وهو أن يخلق رأس القدم مائلا إلى وحشي الرجل. وكذلك القفد في الكف يقال للرجل إذا شتم يا ابن القفداء، وفي القدم الوكع يقال رجل أوكع وامرأة وكعاء وهو أن تركب الإبهام السبابة حتى تزول فيرى أصلها خارجا، وفي القدمين الحنف',NULL,'227',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (267,'وهو أن تميل كل واحدة بإبهامها على صاحبتها، ويقال في القدم إذا كانت مائلة لا أدري أعن يمين أو شمال رجل أصدف وامرأة صدفاء. ويقال للقدم إذا كانت عريضة إنها لشرحاف من الأقدام. فإذا كانت قصيرة الأصابع مجتمعة قيل إنها لكزمة وكزماء بينة الكزم. وفي الرجل الفلج وهو تباعد ما بين الساقين. والفلج في الأسنان وهو تباعد ما بين السنين. ويقال رجل أفلج وامرأة فلجاء. ويدعى مثل ذلك الفنجلة يقال مر مفنجلا فنجلة قبيحة. وفي الرجل الصكك وهو أن تصطك الركبتان من باطن. وفي الرجل الرجز وهو أن ترعد الرجل إذا أراد أن يركب يقال إن فلانا لأرجز. وفي اليد الأكحل. وفي الرجل النسا وهما عرقان.
وفي الرجل الصافن. وفي الإنسان الميل وهو أن يكون مائلا إلى أحد شقيه من خلقة خلق عليها، فإذا زاغت القدم من أصلها من عند طرف الساق فذلك الفدع يقال رجل أفدع وامرأة فدعاء، فإذا أقبلت القدم على القدم الأخرى فذلك القعولة يقال مر مقعولا إذا مر يمشي تلك المشية. وإذا كانت القدم إذا مشى صاحبها نبث بها الترب من خلفها فتلك النقثلة يقال مر نقثلة قبيحة. إذا مر يضطرب في خلقه كله قيل مر مسنطلا، وفي الرجل العرج والقزل، فالقزل أسوأ العرج يقال عرج يعرج عرجا إذا حدث فيه عرج، وعرج يعرج عرجانا إذا مشى مشية العرجان.',NULL,'228',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (268,'ومما يكون في النساء دون الرجال الإسكتان، والأشعران، وهما ما يلي الشفرين من الشعر، والقرنتان وهما رأسا الرحم اللذان يتعقفان يقع فيهما الولد، والحلقتان فإحداهما [الحلقة] التي في فم الرحم عند طرف الفرج والأخرى الحلقة التي تنضم على الماء وتنفتح للحيض، وما بينهما المهبل، والملاقي مضائق الرحم مما يلي الفرج، والكين لحم ذلك المكان، ومما يخلق في الرحم المشيمة وهي من الصبي بمنزلة السلى من الشاة والبعير، والماسكة وهي القشرة تكون على وجه الصبي، والسقي وهو جلدة فيها ماء تنشق على رأس الولد عند خروجه، وهو من الناقة السخت والسابياء. والمخاض في البهائم والناس ولا يكون الطلق إلا في الناس.
آخر الكتاب، قال أبو سعيد الضرب من الرجال الخفيف، [و] إذا كان الرجل ليس بالغليظ ولا بالقضيف قيل له صدع، وكل وسط من الرجال والظباء صدع. والنعنع الطويل المضطرب، والقاق والقوق أسوأ ما يكون من الطول، والهجرع الطويل القبيح الطول، والسلب والسلهب الطويل، والسلجم الطويل، والخلجم الطويل، والمخن الطويل. والشنخف الطويل بالشين، والمتماحل الطويل، والهجنع الطويل، والشرمح الطويل، والشناحي الطويل، والشناحية مثله وهو الرجل الطويل الجسم، والسمسام الخفيف الجسم، والشخت والنحيف الدقيقان من الأصل ليسا من الهذال، والخشخاش.',NULL,'229',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (269,'الخفيف من الرجال، قال طرفة:
أنا الرجل الضرب الذي تعرفونه ... خشاش كرأس الحية المتوقد
...
فدعى لبني لحيان أمي فإنهم] ... أطاعوا رئيسا منهم غير عوق',NULL,'230',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (270,'والكفل الذي لا يثبت على الدابة، والاميل الذي لا تستوي ركبته على الدابة. والصتم المجتمع الخلق، والاعزل الذي لا سلاح معه. وأنشد:
...
ويقال غيث غيداق أي واسع كثير، والثبط الثقيل البطئ، وهو الوخم، والهلباجة الثقيل، والطمل والطملال الاطلس الخلقة والخفي الشأن، والأورع الجميل يقال رجل أورع وامرأة روعاء، وناقة روعاء الفؤاد إذا كانت حديدة الفؤاد. والابلج الحسن الوجه، ويقال رجل أبزى وامرأة بزواء وهو الذي تأخر عجيزته والهبهبي الخفيف من',NULL,'231',NULL,NULL,'0');
INSERT INTO [b8533] VALUES (271,'الرجال، يقال حبحبي من الرجال والدواب [وهو الصغير الجسم] ، والسريس العنين، قال أبو زبيد الطائي:
...
تم الكتاب بأسره',NULL,'232',NULL,NULL,'0');
