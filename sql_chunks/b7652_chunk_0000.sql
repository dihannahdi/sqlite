...
CREATE TABLE "b7652"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b7652
INSERT INTO [b7652] VALUES (1,'<span data-type="title" id=toc-1>الشيخ عبد العزيز بن باز رحمه الله نموذج من الرعيل الأول</span>

<span data-type="title" id=toc-2>محاضرة ألقاها: عبد المحسن بن حمد العباد البدر</span>
في الجامعة الإسلامية
بسم الله الرحمن الرحيم
الحمدُ لله نحمدُه ونستعينُه، ونستغفرُه ونتوبُ إليه، ونعوذُ بالله من شرور أنفسنا وسيِّئات أعمالنا، من يهدِ اللهُ فلا مُضلَّ له، ومن يُضلل فلا هاديَ له، وأشهدُ أن لا إله إلاّ اللهُ وحده لا شريكَ له، وأشهدُ أنّ محمّداً عبدُه ورسولُه، وخليلُه وخيرتُه من خَلْقِه، أرسلهُ اللهُ تعالى بين يدي السّاعة بشيراً ونذيراً، وداعياً إلى الله بإذنه وسراجاً منيراً، فدلَّ أمّتَهُ على كلِّ خير، وحذّرها من كلِّ شرّ، اللهمّ صلِّ وسلِّم وبارك عليه، وعلى آله وأصحابه، ومن سلكَ سبيلَهُ واهتدى بهديه إلى يوم الدِّين.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (2,'أمّا بعدُ:
...
_________
١ هي محاضرة ألقيت ليلة الجمعة السّادس من شهر صفر عام ١٤٢٠هـ في مسجد الجامعة الإسلاميّة بالمدينة المنوّرة، وقد فُرّغت من شريط التّسجيل وأُدخل عليها بعضُ التّعديلات.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (3,'أُدْلِيَ بدَلْوي مع الدِّلاء، وأن أذكُرَ شيئاً ممّا يتعلّقُ بهذا الرّجُل العظيم، ولكي تكون المعلوماتُ عن هذا الرّجُل العظيم محصورةً فأنا أوجزُها في عشر نقاطٍ وهي:
...
هذه هي النِّقاطُ التي سيدورُ حولها الكلامُ عن هذا الرّجل الإمام العظيم رحمه الله.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (4,'أوّلاً: أقولُ كما أسلفتُ:
...
وبعد انتقاله من المدينة إلى الرّياض كان له دروسٌ في جامع الإمام تركي بن عبد الله، وفي أحد المساجد القريبة من منزله، وأخذ عنه العلم فيها كثيرون من',NULL,'7',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (8,'أساتذة الجامعات وغيرهم، فهؤلاء أيضاً من تلاميذه الذين أخذُوا عنه العلمَ.
...
وكان رحمه الله عالِماً بالحديث والفقه، له عنايةٌ بالدّليل، وحرصٌ على الرُّجوع إلى الأدلّة والتّمسُّك بها، والحثِّ على سلوك هذا المسلك، فكان معنيّاً بالحديث، ومعرفة صحيحه وضعيفه، ورجاله، ومن',NULL,'10',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (11,'يُتكلَّمُ فيه منهم، وكان في فتاواه وفي دروسه يذكرُ ذلك فيقول: الحديثُ الفلانيُّ صحيحٌ، أو ضعيفٌ؛ لأنّ في سنده فلاناً، أو أنّه منقطعٌ، أو أنّه مرسلٌ، أو أنّه كذا، أو أنّه كذا.
...
وكان رحمه اللهُ في تعقّبه على القول الذي يرى أنّه خلافُ الصّواب في غاية الأدب مع أهل العلم، فيقول: هذا القولُ فيه نظرٌ، والصّوابُ هو كذا وكذا، ومن يطّلع على حاشيته على فتح الباري التي تقع في الثّلاثة المجلّدات الأُولى يجد ذلك واضحاً جليّاً، فإنّه',NULL,'11',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (12,'عندما يتعقّبُ الحافظَ ابن حجرٍ أو من ينقل عنه في بعض المسائل يبدأُ بقوله: هذا القولُ فيه نظرٌ، والصّوابُ هو كذا وكذا، ويذكرُ الدّليلَ على ذلك، أمّا إذا كان القولُ ساقطاً أو باطلاً ظاهرَ البطلان مجانباً للحقِّ ومخالفاً للدّليل فإنّه يقول: هذا القولُ ظاهرُ البطلان، أو هذا القولُ غيرُ صحيحٍ، أو لا يصحُّ، قولٌ باطلٌ، أو ما إلى ذلك من العبارات.
...
وإذا كانت النّفوسُ كباراً ... تعبتْ في مرادها الأجسادُ',NULL,'12',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (13,'فلم ينل ما نال بعد توفيق الله إلاّ بالجِّدِّ والاجتهاد، والتّعب والنَّصَب والمشقّة، وبذل الجهد والصحّة والعافية في الاشتغال بالعلم، ونفع النّاس، رحمه الله.
...
وقد كان رحمه الله صابراً محتسباً، جادّاً مُجِدّاً في جميع مراحل حياته، إلى أن توفّاهُ اللهُ عزّ وجلّ، وكان عاملاً في محلِّ العمل الرّسميّ، وفي المسجد، وفي الطّريق، وفي البيت، لا يعرفُ وقتاً للرّاحة إلاّ الشّيء اليسير، فبابُه مفتوحٌ رحمه الله لاستقبال النّاس للاستفتاء،',NULL,'13',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (14,'وطلب الشّفاعة والمُساعدة والنُّصح، وغير ذلك من الأمور التي يحتاجُ إليها النّاسُ.
فهو إنّما حصّلَ هذا السُّؤددَ وهذه المنزلةَ العاليةَ الرّفيعةَ بالجِّدِّ والاجتهاد، وبذل النّفس والنّفيس، رحمه الله وغفرَ له.
خامساً: عمومُ نفعِه
...
وكان يقوم بتعيين الدُّعاة في خارج المملكة على نفقة بعض المحسنين.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (15,'ومن عموم نفعه كثرةُ فتاويه سواءً عن طريق المقابلة واللِّقاء المباشر، أو عن طريق المهاتفة، أو عن طريق المراسلة، كلُّ ذلك كان يحصلُ من سماحته رحمه اللهُ في نفع النّاس.
...
وكان حريصاً على مساعدة المحتاجين، وتعمير المساجد، في داخل المملكة وخارجها، وفي مكتبه الخاصّ في بيته سجلاّتٌ بأشخاصٍ وبجهاتٍ مختلفةٍ',NULL,'15',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (16,'يتلقّون المساعدات، سواءً كانوا من الفقراء أو من الدُّعاة، في داخل المملكة وخارجها.
...
وفي حجّ عام ألف وأربعمائة وتسعة عشر وهو العام الذي تخلّف فيه عن الحجّ في آخر حياته لمرض نصحه الأطبّاء بعدم السّفر للحجّ من أجله كلّف من',NULL,'16',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (17,'يقومُ بفتح بيته في مكّة، ومخيّمه في منى، وصُنْعِ الولائم وتقديمها للنّاس الذين اعتادُوا أن يأتُوا إليه ليستفيدوا من علمه، ويشاركوه في طعامه، وكان يتّصلُ بمن كلّفه بذلك بالهاتف للاطمئنان على ذلك.
وكان يبذلُ جاهَهُ في الشّفاعة للنّاس وفي مساعدتهم في تحصيل مطالبهم وقضاء حوائجهم.
ثمّ إنّه كان يتيسّرُ لي أن أزورهُ في وقت الحجِّ في منزله وفي المخيّم في منى، وفي هذه السَّنَة لمّا تخلّف عن الحجِّ سافرتُ إلى مكّة لَمَّا كان فيها قبل ذهابه إلى الطّائف بيومين، وذلك في يوم الخميس الموافق التّاسع والعشرين من شهر ذي الحجّة، ذهبتُ أنا وبعضُ أبنائي خصِّيصاً لزيارته، ولَمَّا جئنا إليه وسلّمنا عليه كعادته يبادرُ إلى السُّؤال عن الحال وعن الوالدين، ويدعُو إلى تناول طعام الغداء، فقلتُ له: إنّا قد جئنا من المدينة خصِّيصاً لزيارتك، ونتناولُ طعامَ الغداء معك ثمّ نرجعُ',NULL,'17',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (18,'إلى المدينة، فقال رحمه الله: قال اللهُ عزّ وجلّ: "وجبتْ محبّتي للمتحابِّين والمُتزاورين فِيَّ".
...
ولَمَّا أُذّن لصلاة الظّهر سأل كم عددُ الذين بقيت معاملتهم؟ قيل: إنّه بقي ثمانيةٌ، فقال: إن شاء اللهُ بعد الصّلاة ننهي معاملاتهم، وبعد الصّلاة رجعَ وأنهى ما بقي وجلسَ إلى أن قُدّم طعامُ الغداء، فقام الجميعُ لتناول طعامَ الغداء، وكان الطّعامُ كثيراً كعادته لأنّ الذين يحضرُون كثيرون، وكان عددُ الصّحون التي تحلّق',NULL,'18',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (19,'عليها النّاسُ في ذلك اليوم ستّة صحون كبيرة، رحمه اللهُ وغفرَ له.
ولم يكتف رحمه الله في بذله النّفعَ للنّاس وحرصه على مساعدتهم فكتبَ كتاباً لأحد المشايخ الكبار وذلك في اليوم الثّامن من الشّهر الثّالث من عام ثمانية عشر وأربعمائة وألف، قال فيه: يسرُّني أن أخبركم بأنّه منذ زمنٍ طويلٍ وأنا قائمٌ بالعمل على مساعدة كثيرٍ من المحتاجين في داخل المملكة وخارجها، وتعمير المساجد في داخل المملكة وخارجها، وتعيين الدُّعاة في خارج المملكة وذلك على نفقه خادم الحرمين الشّريفين ووليّ عهده وعدد من الأمراء وأصحاب الخير والتُّجّار، ثمّ قال بعد ذلك: والدّوامُ لله، {كُلُّ نَفْسٍ ذَائِقَةُ الْمَوْتِ} فإذا حدثَ بي حادثُ الموت أرجُو أن تتولّوا هذه الأعمالَ، وأن تحتسبُوا الأجرَ عند الله عزّ وجلّ.',NULL,'19',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (20,'سادساً: عبادتُه
...
ومِمَّا وقفتُ عليه مِمَّا يدلّ على عظم عنايته بالعبادة والاشتغال بها أنّه في عام سبعةٍ وتسعين وثلاثمائة وألفٍ',NULL,'20',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (21,'في آخر شهر ذي القعدة ذهبتُ من المدينة إلى مكّة لحاجةٍ تتعلّقُ بالعمل إذ كنتُ نائبَه في الجامعة الإسلاميّة، وبتُّ عنده تلك اللّيلة في منزله، وكان في بيته مكان مستطيل، فكان يمشي فيه ذاهباً آيباً ويقرأُ القرآنَ، يريدُ أن يتحرّك ويقرأ القرآنَ الكريم.
...
فكان رحمه الله ملازماً لما هو الأكملُ والأفضلُ، وينبِّهُ ويرشدُ ويلفتُ النّظرَ إلى تحصيل الأكمل والأفضل رحمه الله.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (22,'وأذكرُ أيضاً لمّا ذهب إلى القصيم في عام خمسةٍ وثمانين وثلاثمائة وألف ليتزوّج من هناك كنتُ مع المشايخ الذين ذهبُوا معه، ولمّا كنّا في أثناء الطّريق في وادٍ من الأودية فيه شجرٌ، وفي وسط النّهار كسفت الشّمسُ فقام فصلّى بنا صلاةَ الكسوف في ذلك الوادي، رحمه الله.
سابعاً: مؤلّفاتُه
مؤلّفاتُ الشّيخ رحمه الله كثيرةٌ، وهي رسائلُ مفيدةٌ وعظيمةٌ، وقد بدىء بجمع هذه الرّسائل وكذا الفتاوى، وطُبع منها حتّى الآن اثنا عشر مجلَّداً، تسعةُ مجلّداتٍ تتعلّق بالعقيدة والدّعوة إلى الله في موضوعات مختلفة، ثمّ المجلّدُ العاشرُ والحادي عشر والثّاني عشر بدىء فيها بالفقه بكتاب الطّهارة وإلى نهاية كتاب الجمعة من كتاب الصّلاة.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (23,'ومن مؤلّفاته:
...
وكان ذلك في الزّمن الذي حصلت فيه هذه الفتنةُ، وكثُر الكلامُ فيها في الإذاعات والصّحف، فكان منه رحمه الله أن ألّف كتاباً عظيماً نافعاً في ذلك وطبع طبعته الأُولى عام خمسةٍ وثمانين وثلاثمائة وألف، مع أنّ بعض الشّباب في هذا العصر يتكلّمُون في كبار العلماء',NULL,'23',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (24,'ويقولون عنهم: إنّهم لا يفقهون الواقع، وهذا الكتابُ الذي كتبه اسمُه: "نقدُ القوميّة العربيّة على ضوء الإسلام والواقع"، وكان ذلك قبل أن يُولد كثيرٌ من هؤلاء الذين يقولون: إنّهم يعرفُون الواقع، ومن اطّلع عليه عرفَ ما فيه من الفقه والفهم على ضوء الكتاب والسُّنّة والواقع.
...
وأذكرُ أنّ الحافظَ ابن حجرٍ رحمه اللهُ ذكرَ في "الإصابة" في ترجمة قيس بن عاصمٍ المنقري التّميمي رضى الله عنه من أصحاب رسول الله صلى الله عليه وسلم،',NULL,'31',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (32,'وكان سيّداً في قومه، وقد رثاهُ عبدةُ بن الطّيّب في قصيدةٍ منها قولُه:
...
وقد خلف رحمه اللهُ أربعةً من البنين وستّاً من البنات، وأحدُ البنين وهو أحمد من طلبة العلم، أصلحَ اللهُ بنيه، وبارك فيهم، وغفرَ للشّيخ ولنا جميعاً، ولكنّه خلّفَ الألوفَ من البنين الذين يستفيدون من علمه ويدعون له، وقد قال عليه الصّلاةُ والسّلامُ: "إذا مات ابنُ آدم انقطعَ عملُه إلاّ من ثلاثٍ، صدقةٍ جارية، أو',NULL,'32',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (33,'علم ينتفعُ به، أو ولد صالح يدعُو له"، فأبناؤُه من نسبه وأبناؤُه في العلم كلُّهم يدعون له، والمسلمُون يدعون له رحمه الله وغفر له.
...
رابعاً: من المعلوم أنّ الجامعةَ الإسلاميّةَ بالمدينة المنوّرة عالميّةُ النّفعِ، والشّيخُ عبدُ العزيز بن باز عالميُّ النّفع، وهو الذي باشر تأسيسها، وتولّى غرسها منذ',NULL,'35',NULL,NULL,'0');
INSERT INTO [b7652] VALUES (36,'افتتاحها واستمرّ فيها خمسةَ عشرَ عاماً، وإنّ اسمَ الجامعة الإسلاميّة اسمٌ جميلٌ، ويزدادُ جمالاً إذا أطلق عليها اسمُ: "جامعة الشّيخ عبد العزيز بن باز الإسلاميّة"، وقد بذلتُ لذلك أسباباً نفع اللهُ بها.
هذه بعضُ الأمنيّات والمقترحات التي في ذهني يسّر الله تحقيقها، وأسألُ الله عزّ وجلّ أن يغفر لسماحة الشّيخ، وأن يجزيهُ أحسنَ الجزاء، وأن يبارك في علمه، وأن يثيبهُ على ما قدّم، وعلى ما حصل منه من الصّدقات الجارية، وأن يعظم له الجزاء، وأن يوفّقنا جميعاً لما يرضيه، ولما فيه تحصيل العلم النّافع والعمل به، إنّه سبحانه وتعالى جوادٌ كريمٌ، وصلّى اللهُ وسلّم وبارك على عبده ورسوله نبيّنا محمّدٍ، وعلى آله وأصحابه أجمعين',NULL,'36',NULL,NULL,'0');
