...
CREATE TABLE "b36553"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36553
INSERT INTO [b36553] VALUES (1,'<span data-type="title" id=toc-1>المقدمة</span>
...
فالحمد لله الذي من علينا بأعظم النعم وأجلها وهي نعمة الإسلام؛ فكم من أمم تتخبط في ظلام الشرك والكفر، وكم من حسيب ووجيه وغني ورئيس لم تدركه رحمة الله؛ ها هو فرعون يحكم ويدير مملكة مترامية الأطراف لم تغن عنه شيئًا، وها هو قارون أغنى الأغنياء في زمانه ولم تمنعه أمواله عن النار، وها هو فلذة الكبد لم تغنه محبة أبيه شيئا كما في حال ابن نوح عليه السلام، وها هو سيد ووجيه قريش وعم النبي - صلى الله عليه وسلم - أبو طالب في النار، لم تنفعه القرابة، ولم تنفعه عراقة النسب؛ وأبو لهب وأبو جهل .. والقائمة طويلة، فاللهم لك الحمد على ما تفضلت به علينا، ونسألك الثبات حتى نلقاك ...
...
وما يراه القارئ الفاضل إنما هي قطرات في بحر خدمة الدين ورفعة رايته، وليس لمثلي أن يستقصي الأمر ولكني أدليت بدلوي ونزعت نزعا لا أدعي كماله، والدعوة إلى الله عز وجل ليست',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (2,'خاصة بفئة معينة من الناس لكنها شأن الأمة كلها.
اللهم انصرنا بالإسلام وانصر الإسلام بنا، واجعلنا ممن يحمل هم هذا الدين ونشره، وارزقنا الشهادة تحت رايته مقبلين غير مدبرين.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (3,'<span data-type="title" id=toc-2>مستشفى طائر للتنصير
بتكلفة ٢٥ مليون دولار </span>...
...
_________
(١) الأولى إطلاق كلمة (النصرانية والنصارى).',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (5,'أسبوع أو عشرة أيام، ويقال: إنه أكبر مستشفى جوي في العالم وهو مزود بكل التسهيلات الممكنة للعمليات الجراحية والعلاجية.
انتهى الخبر، والله أعلم كم مسلمًا تحول فكره إلى النصرانية؟ وكم مسلمة أثيرت الشبه في قلبها عن دين الإسلام؟',NULL,'7',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (6,'<span data-type="title" id=toc-3>وهم يعملون</span>
...
نعم ما أرادوا لأنهم بذلوا وعملوا.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (7,'<span data-type="title" id=toc-4>كيف أخدم الإسلام</span>؟
...
قال ابن القيم رحمه الله: «فالدعوة إلى الله تعالى هي وظيفة',NULL,'9',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (8,'المرسلين وأتباعهم».
...
_________
(١) الزهد للإمام أحمد ٤٥١.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (9,'<span data-type="title" id=toc-5>ماذا يعود علي إذا خدمت الإسلام</span>؟
...
٢ - التسديد والتوفيق .. قال عز وجل {وَالَّذِينَ جَاهَدُوا فِينَا لَنَهْدِيَنَّهُمْ سُبُلَنَا وَإِنَّ اللهَ لَمَعَ الْمُحْسِنِينَ}.
٣ - حفظ الذرية قال تعالى: {وَلْيَخْشَ الَّذِينَ لَوْ تَرَكُوا مِنْ خَلْفِهِمْ ذُرِّيَّةً ضِعَافًا خَافُوا عَلَيْهِمْ فَلْيَتَّقُوا اللهَ وَلْيَقُولُوا قَوْلاً سَدِيدًا}.
...
وأنت تعمل تلمس فجرًا يبزغ في وسط ظلام حالك .. إنه ضوء الفجر يبدو باهتا ثم يظهر شيئا فشيئا، حتى يعم النور، ويظهر قرص الشمس، وتنتشر أشعة الحق ونور الإسلام.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (10,'<span data-type="title" id=toc-6>أين أثرك</span>؟
...
ومن أمثلة خدمة الدين: طرح الآراء النيرة والأفكار الجيدة على أهلها، ومتابعة تنفيذها، وقد ألقى أحد الموفقين قبل سنوات كلمة إلى أحد الدعاة وقال له: هذه الجالية التي تقدر أعدادها',NULL,'12',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (11,'بالملايين لماذا لا يجعل لها مكان يختص بدعوتها وتعليمها الإسلام؟ ألقى هذه الكلمات على الداعية وخرج .. ولا يعرف من هو حتى الآن؟ بعد حين سعى الداعية إلى تنفيذ هذه الفكرة الجيدة وطرق الأبواب لإصدار ترخيص لأول مكتب جاليات في المملكة وكان له ما أراد، وزاد اليوم عدد تلك المكاتب عن مائة وعشرين مكتبا نفع الله بها نفعا عظيما.
...
أما توزيع الكتب على صوالين الحلاقة، والمستشفيات الحكومية الخاصة، وإدارات الجوازات والمرور وأماكن المراجعين فيها، فهي ولله الحمد منتشرة وبكثرة لكنها تشكو من الفتور والغفلة وكل موظف يستطيع أن يجعل رفًّا من هذه الكتب كإهداء ويتعاهدها باستمرار ولا تكلف شيئا يذكر من مرتبة.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (12,'وفي مجال طبع الكتب ونشرها أذكر أن بعض الكتب التي نشرت هي من اقتراحات القراء مثل كتاب: (ماذا تفعل في ١٠ دقائق) وكتاب: (إلى من حجبته السحب) وكذلك فكرة كتيبات الجيب الدعوية المتدرجة مثل (إشراقات) وغيرها فهي فكرة من إحدى الأخوات فانظر أيها الحبيب إلى ثمرتها وكثرة النفع لهذه الاقتراحات.
...
فالدعوة تحتاج إلى قيام وجهد وتعب ونصب، يقول الله جل وعلا: {يَا أَيُّهَا الْمُدَّثِّرُ * قُمْ فَأَنْذِرْ} فأمره الله عز وجل بالقيام والجهاد في سبيل هذا الدين.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (13,'وقال الله عز وجل حاكيا عن أهل النار: {أَلَمْ يَأْتِكُمْ نَذِيرٌ * قَالُوا بَلَى قَدْ جَاءَنَا نَذِيرٌ}.
فالنذير يذهب ويكد ويكدح في سبيل الوصول إلى الناس وتعليمهم وإرشادهم، ونبينا عليه الصلاة والسلام في كل مكان يسعى إلى الدعوة فصعد الصفا، وذهب إلى الطائف، وهاجر إلى المدينة، كل ذلك في سبيل نشر هذا الإسلام.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (14,'<span data-type="title" id=toc-7>كيف تخدم الإسلام</span>
١ - تخدم الإسلام: إذا صح منك العزم وصدقت النية: فإن الله عز وجل يبارك في العمل الخالص لوجهه الكريم حتى وإن كان قليلا، والإخلاص إذا تمكن من طاعة ما حتى وإن كانت قليلة أو يسيرة في عين صاحبها ولكنها خالصة لله تعالى يكمل فيه إخلاصه وعبوديته لله، فيغفر الله به كبائر كما في حديث البطاقة.
٢ - تخدم الإسلام: إذا عرفت الطريق وسرت معه: الطريق المستقيم هو سلوك طريق نبينا محمد - صلى الله عليه وسلم - في أمر الدعوة ومبتدئها ووسائلها وطرقها والصبر على ذلك مع الرفق بالناس ورحمتهم فهم مرضى المعاصي والذنوب.
٣ - تخدم الإسلام: إذا استفدت من جميع الظروف المتاحة والإمكانات المتوفرة: وهذه نعمة عظيمة فكل الوسائل مباحة إلا ما حرمها الله عز وجل، ونحن ندعو بكل الوسائل المشروعة مراعين الأدلة الشرعية والآداب المرعية.
...
٥ - تخدم الإسلام: إذا سلكت سبل العلماء والدعاة والمصلحين: فاستصحب الصبر وتحمل التعب والنصب فأنت في',NULL,'16',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (15,'عبادة عظيمة هي مهمة الأنبياء والمرسلين ومن سار على أثرهم.
...
٧ - تخدم الإسلام: إذا ربطت قلبك بالله عز وجل وأكثرت من الدعاء والاستغفار ومداومة قراءة القرآن، فليس أنفع في جلاء القلوب وصقل الأرواح وجعلها تعمل ولا تكل، وتكدح ولا تمل من الإكثار من ذكر الله عز وجل والتقرب إليه بالطاعات ونوافل العبادات.
...
١٠ - تخدم الإسلام: إذا وهبته جزءًا من همك، وأعطيته جزءًا من وقتك وعقلك وفكرك ومالك، وأصبح هو شغلك',NULL,'17',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (16,'الشاغل وهمك وديدنك، فإن قمت فللإسلام، وإن سرت فللإسلام، وإن فكرت فللإسلام وإن دفعت فللإسلام، وإن جلست فللإسلام.
١١ - تخدم الإسلام: كلما وجدت بابا من أبواب الخير سابقت إليه وسرت إلى الإسهام بالعمل فيه .. لا تتردد ولا تؤخر ولا تسوف ...',NULL,'18',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (17,'<span data-type="title" id=toc-8>تأمل نعمة الله عليك</span>
...
وقفة:
يرى سماحة الشيخ عبد العزيز بن باز رحمه الله أن الدعوة إلى الله تصير فرض عين عند تغير الأحوال حيث يقول: «فعند قلة الدعاة، وعند كثرة المنكرات وعند غلبة الجهل كحالنا تكون الدعوة فرض عين على كل واحد بحسب طاقته» (١).
_________
(١) الدعوة إلى الله وما ينبغي أن يتحلى به الدعاة (١٦).',NULL,'19',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (18,'<span data-type="title" id=toc-9>الدعوة إلى الله</span>
...
ويقول - صلى الله عليه وسلم -: "من دعاء إلى هدى كان له من الأجر مثل أجور من تبعه، لا ينقص ذلك من أجورهم شيئًا" [رواه مسلم].',NULL,'20',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (19,'والدعوة لا تحدها الحدود ولا تردها القيود؛ هذا نبي من أعظم الدعاة إلى الله عز وجل يدعو وهو في السجن، الأبواب فيه موصدة، والجدران سميكة، والحراس أعينهم لا تنام، ومع هذا فهو يستفيد من كل الوسائل ويدعو من حوله: {يَا صَاحِبَيِ السِّجْنِ أَأَرْبَابٌ مُتَفَرِّقُونَ خَيْرٌ أَمِ اللهُ الْوَاحِدُ الْقَهَّارُ}.
...
أين الداعية الذي يبخل ويشح بقليل الدراهم، وها هو أبو بكر رضي الله عنه يخرج من ماله كله؟ أين الذي يبخل ولا يخرج إلى الرديء وأبو طلحة رضي الله عنه لما سمع قول الله عز وجل:',NULL,'21',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (20,'{لَنْ تَنَالُوا الْبِرَّ حَتَّى تُنْفِقُوا مِمَّا تُحِبُّونَ} خرج من أحب أمواله إليه (بيرحاء) وهو بستان مورق به ماء بارد؟
أين من يقدم نفسه ويقول بإيمان صادق: فزت ورب الكعبة؟
أين الذين يقولون: اللهم خذ من دمائنا حتى ترضى؟ فهل قدمنا أرواحنا وهل خرجنا من أحب أموالنا، أم من أردئها وأقدمها؟',NULL,'22',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (21,'<span data-type="title" id=toc-10>كيف نصل بالدعوة</span>؟
...
وقبل أن تبدأ العمل تأمل في حديث أبي موسى الأشعري وما',NULL,'23',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (22,'لاقوه من الشدائد والصعاب، حيث قال: خرجنا مع رسول الله - صلى الله عليه وسلم - في غزاة ونحن ستة نفر بيننا بعير نعتقبه، فنقبت أقدامنا ونقبت قدمي، وسقطت أظافري فكنا نلف على أرجلنا الخرق ..
[متفق عليه].

<span data-type="title" id=toc-11>كيف أخدم الإسلام</span>؟
...
فاللهم لا تجعلنا من أولئك واجعلنا من عبادك الصالحين.',NULL,'24',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (23,'أخي المسلم:
يكفى أنه تحرك بداخلك شعور طيب جعلك تتساءل كيف أخدم الإسلام؟
بقي الجواب منك، وليكن جوابًا عمليًّا.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (24,'<span data-type="title" id=toc-12>متى تعمل</span>؟
...
قالت صفية بنت سيرين: "يا معشر الشباب خذوا من أنفسكم وأنتم شباب، فإني ما رأيت العمل إلا في الشباب".',NULL,'26',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (25,'<span data-type="title" id=toc-13>من خدمة الإسلام</span>
...
فانظر أخي القارئ إلى الأثر الكبير .. والتحول السريع من',NULL,'28',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (27,'لاعبات كرة طائرة، سافرات كاشفات، إلى متحجبات متسترات.
...
وآخر فرغ نفسه لمتابعة السلال التي توضع في حوائط المستشفيات وذلك لإمدادها بالكتب والمطويات .. وكان العبء',NULL,'29',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (28,'كبيرا لكن الهمة العالية تقطع الطرق وتشتري الكتب وتصبر على الحر والقر إنه توفيق من الله عز وجل الذي جعله يعمل في طاعته واستعمله في مرضاته.
وأخرى لا تذهب لأقاربها إلا ومعها مشروع خيري تطرحه .. مرة كفالة داعية، وأخرى كفالة يتيم، وفي مواسم رمضان تفطير صائم، وفي شهر ذي الحجة تطرح مشروع الأضاحي، وفي الصيف حفر الآبار، وفي الشتاء بطانية الشتاء وهكذا.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (29,'<span data-type="title" id=toc-14>لقد فتح لك الباب</span>
...
قال الغزالي: والقلب بيت هو منزل الملائكة ومهبط أثرهم، ومحل استقرارهم، والصفات الرديئة مثل: الغضب والشهوة والحقد، والحسد والكبر والعجب وأخواتها، كلاب نابحة، فأنى تدخله الملائكة وهو مشحون بالكلاب.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (31,'ابتعد عن الاندفاع والعجلة: من عمل في المجال الدعوي يرى أن الساحة تحتاج إلى أضعاف الجهود المبذولة وقد يدفع هذا بالبعض إلى التسرع والعجلة رغبة في تحصيل الخير وسد الثغرات، والعمل الدعوي يحتاج إلى الأناة وعدم العجلة والتريث وإعطاء الأولويات حقها.
...
إنه بعث الأمل وإشاعة التفاؤل في المجتمع وبين الناس وأثره واضح جلي.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (33,'<span data-type="title" id=toc-16>في جنب هؤلاء</span>
...
ثم إن أصابك شيء من الأمر فأنت مبتلى يضاعف الله لك الأجر، ويمحص دينك، ويطهر قلبك، ويرفع درجتك، انظر إلى الفجار والفساق كيف هم يعانون ومع هذا يصبرون ويواصلون المسير؟ {وَانْطَلَقَ الْمَلَأُ مِنْهُمْ أَنِ امْشُوا وَاصْبِرُوا عَلَى آلِهَتِكُمْ إِنَّ هَذَا لَشَيْءٌ يُرَادُ}.',NULL,'35',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (34,'<span data-type="title" id=toc-17>وقفات</span>
...
قال أبو إسماعيل عبد الله بن محمد الهروي كما في تذكرة الحفاظ (٩ م ١١٨٤) «عرضت على السيف خمس مرات، لا يقال لي: ارجع عن مذهبك، لكن يقال لي: اسكت عما خالفك فأقول: لا أسكت.
أخي المسلم:
أسهم لرفع راية هذا الدين وليكن همك وتفكيرك في كل حين كيف أخدم هذا الدين؟ وأنت إنما تخدم نفسك بجمع الحسنات،',NULL,'36',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (35,'وتكفير السيئات ورفع الدرجات.
واعلم أن من إعراض الله عن العبد أن يستغله فيما لا فائدة تعود عليه، وانظر في حالك وساعاتك وأيامك.',NULL,'37',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (36,'<span data-type="title" id=toc-18>همسة</span>
...
١ - تصيد الأخطاء: وهذا منهج والعياذ بالله ابتلى الله به بعض الناس من الذين لا هم لهم ولا عمل سوى تصنيف الناس والبحث عن زلاتهم وأخطائهم ومعلوم أن كل من يعمل يخطئ ويقع منه هنات، ولكن من لا يعمل لا يخطئ مطلقا، ولقد رأيت من يتحدثون في المجالس ليس لهم عمل دعوي إطلاقا وصرفهم الله عز وجل إلى الغيبة والتثبيط والوقوع في الأعراض.
...
قال ابن القيم رحمه الله: «ومن العجب أن الإنسان يهون عليه التحفظ والاحتراز من أكل الحرام، والظلم، والزنا والسرقة، وشرب الخمر، ومن النظر المحرم وغير ذلك، ويصعب عليه التحفظ من حركة لسان، حتى يرى الرجل يشار إليه بالدين والزهد والعبادة، وهو يتكلم بالكلمة من سخط الله لا يلقي لها بالا يزل منها أبعد مما بين المشرق والمغرب، وكم ترى من رجل متورع عن الفواحش والظلم ولسانه يفري في أعراض الأحياء والأموات لا',NULL,'38',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (37,'يبالي ما يقول.
...
ولكن هنا ملاحظة مهمة وهي حرصك على قبول النصيحة من الناصحين إذا أخطأت وزلت بك قدم، وعليك بالعودة والرجوع عن خطئك طلبا لمرضاة الله عز وجل.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (38,'<span data-type="title" id=toc-19>في منتصف الطريق</span>
يقول ابن القيم رحمه الله:
إن لم يكن العبد في تقدم فهو في تأخر ولا بد، فالعبد سائر ولا واقف، فإما إلى فوق، وإما إلى أسفل، وإما إلى أمام، وإما إلى وراء وليس في الطبيعة ولا في الشريعة وقوف البتة، ما هو إلا مراحل تطوى أسرع طي إما إلى الجنة أو إلى النار، فمسرع ومبطئ، ومتقدم ومتأخر، وليس في الطريق واقف البتة، وإنما يتخالفون في جهة المسير وفي السرعة والبطء {إِنَّهَا لَإِحْدَى الْكُبَرِ * نَذِيرًا لِلْبَشَرِ * لِمَنْ شَاءَ مِنْكُمْ أَنْ يَتَقَدَّمَ أَوْ يَتَأَخَّرَ} ولم يذكر واقفا إذ لا منزل بين الجنة والنار ولا طريق لسالك غير الدارين البتة، فمن لم يتقدم إلى هذه بالأعمال الصالحة، فهو متأخر إلى تلك بالأعمال السيئة.',NULL,'40',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (39,'<span data-type="title" id=toc-20>الدعوة في بيوتنا</span>
...
الأول: الرفق واللين، فإن الرفق ما كان في شيء إلا زانه، ويقول الله تعالى عن نبينا محمد - صلى الله عليه وسلم -: {لَقَدْ جَاءَكُمْ رَسُولٌ مِنْ أَنْفُسِكُمْ عَزِيزٌ عَلَيْهِ مَا عَنِتُّمْ حَرِيصٌ عَلَيْكُمْ بِالْمُؤْمِنِينَ رَءُوفٌ',NULL,'41',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (40,'رَحِيمٌ}.
الثاني: الاستمرار والمداومة، فإن البعض يدعو مرة ثم يتوقف، والأمر ليس بذاك، بل هو أمر مستمر ودعوة قائمة حتى يموت الإنسان؛ ونوح عليه السلام مضى عمرًا طويلاً يقارب الألف عام، وهو يدعو والنبي - صلى الله عليه وسلم - مكث سنوات وليس معه إلا الرجل والرجلان، وما وهن، أو تراجع، أو توقف.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (41,'<span data-type="title" id=toc-21>فتوى</span>
سئلت اللجنة الدائمة للبحوث العلمية والإفتاء بالمملكة العربية السعودية هذا السؤال وأجابت عليه بالفتوى رقم ٢٠٠٦٢.
هل طباعة الكتب الشرعية الصحيحة ينتفع بها الإنسان بعد موته ويدخل في العلم الذي ينتفع به كما جاء في الحديث؟
الجواب: طباعة الكتب المفيدة التي ينتفع بها الناس في أمور دينهم ودنياهم هي من الأعمال الصالحة التي يثاب الإنسان عليها في حياته ويبقى أجرها ويجري نفعها له بعد مماته ويدخل في عموم قوله - صلى الله عليه وسلم - فيما صح عنه من حديث أبي هريرة رضي الله عنه أن رسول الله - صلى الله عليه وسلم - قال: "إذا مات الإنسان انقطع عمله إلا من ثلاث: إلا من صدقة جارية، أو علم ينتفع به، أو ولد صالح يدعو له" رواه الإمام مسلم في صحيحه، والترمذي والنسائي والإمام أحمد، وكل من ساهم في إخراج هذا العلم النافع يحصل على هذا الثواب العظيم سواء كان مؤلفا أو معلما أو ناشرا له بين الناس، أو مخرجا أو مساهما في طباعته كل بحسب جهده ومشاركته في ذلك [فتوى رقم ٢٠٠٦٢].
أخي المسلم:
هذا باب خير عظيم أمامك .. فالأموال متيسرة ولله الحمد، والكتيبات متوفرة بأسعار زهيدة، والبريد قائم والقبول من الناس واضح جلي فماذا تنتظر؟',NULL,'43',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (42,'<span data-type="title" id=toc-22>من يحمل هم هذا الدين</span>؟
...
ومنهم من كان خطيبا مفوها وشاعرا مقدما مثل حسان بن ثابت رضي الله عنهم أجمعين.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (43,'<span data-type="title" id=toc-23>لا تطلب الجزاء</span>
...
وقال بعض السلف: إذا قال لك السائل: بارك الله فيك، فقل: وفيك بارك الله فمن عمل خيرا مع المخلوقين سواء كان المخلوق نبيا أو رجلا صالحا أو ملكا. من الملوك أو غنيا من الأغنياء فهذا العامل للخير مأمور بأن يفعل ذلك خالصا لله يبتغي به وجه الله، لا يطلب به من المخلوق جزاء ولا دعاء ولا غيره، لا من نبي ولا رجل صالح ولا من الملائكة فإن الله أمر العباد كلهم أن يعبدوه مخلصين له الدين (١).
_________
(١) مجموع الفتاوى (١/ ١٨٠).',NULL,'45',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (44,'<span data-type="title" id=toc-24>تيسر أمر الدعوة</span>
من نعم الله عز وجل أن وسائل الدعوة وسبلها سهلة ميسرة لكل فرد، ومما نراه من ذلك:
١ - قبول الناس للحق بشكل منقطع النظير وهذا ملاحظ مشاهد، وأحيانا تغيب فترة عن رجل ما وتقابله بعد حين فإذا حاله قد تبدلت، والبعض تلقي إليه بكلمة فإذا به يتمسك بك كالغريق يريدك أن تزيده، ولهذا سمى الكثير هذه السنوات بسنوات العودة إلى الله عز وجل.
٢ - نعمة الحياة التي أنت فيها من أعظم النعم للقيام بأمر الدعوة، وعمرك سنوات قلائل فإن استثمرتها وإلا ضاعت عليك سدى، وأنت اليوم في دار مؤقتة فاعمل لدار باقية خالدة.
٣ - أنعم الله علينا بأموال طائلة كثيرة، ونصرف منها على توافه الأمور والكماليات الشيء الكثير، وأمر الدعوة أوجب وألزم وأبقى وأدوم وقد وعد الله عز وجل بمضاعفة الأجر للمنافقين: {مَنْ ذَا الَّذِي يُقْرِضُ اللهَ قَرْضًا حَسَنًا فَيُضَاعِفَهُ لَهُ أَضْعَافًا كَثِيرَةً ....... }.
٤ - الصحة والعافية نعمتان تعينان على العمل دون عوائق، وقد رأيت مريضا في الطائف لا يتحرك سوى رأسه فقط، ويعمل -وفقه الله- في الدعوة داخل المستشفى وأسلم على يديه بعض الكفار من الممرضين والممرضات، ويناصح كل من يقابله أو يراه، بل ويخاطب المسئولين في أمور عامة.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (45,'٥ - العلم الشرعي نعمة عظيمة ولا حد لنشر الدعوة
...
* أحدهم ذهب إلى موقف النقل الجماعي وسلم للإدارة',NULL,'49',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (48,'مجموعة كبيرة من أشرطة القرآن الكريم واشتراط عليهم جعلها في الحافلات المغادرة حتى يسمع الركاب كتاب الله عز وجل، وزودهم بعد حين بأشرطة العلماء والمشايخ وخص الحافلات المسافرة إلى مكة بأشرطة توضح صفة العمرة والحج.
...
* إحداهن تسعى إلى إسعاد الفقراء والمساكين وتفريج كربهم، وإدخال السرور على نفوسهم، يوما قالت لأحد أبنائها: هذه مئتا ريال اشتر مطبقا (نوع من الأكل) واذهب به إلى هذه البيوت بعد صلاة العشاء مباشرة حتى يفرح الفقراء مع أطفالهم بهذه',NULL,'50',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (49,'الوجبة التي ربما لم يسمعوا عنها، أو سمعوا عنها ولم يأكلوها.
...
بمعنى أن هناك فرص كثيرة متاحة، لكن من يعملون قلة وقلة جدا، وقارن واسأل لتتأكد، ثم الطامة الكبرى أين يذهب الملتزمون الذين لا يعملون في الدعوة، إنه ضياع أوقات وجلسات غيبة ونميمة وقل منهم من استفاد من وقته في تحصيل علم، أو بر والدين، أو عمل دعوي فردي، أو غير ذلك.',NULL,'51',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (50,'<span data-type="title" id=toc-27>إمام المسجد</span>
...
وفي نهاية الحفل حدد موعدا بعد شهر لإلقاء محاضرة ومسابقات مثل هذه؛ قال الإمام: اجتمع أناس لم أرهم من قبل واكتظ المسجد بالمصلين أكثر من يوم الجمعة .. وهكذا الصغار',NULL,'52',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (51,'يأتون بآبائهم.
الثانية: إمام مسجد موفق اقترح على بعض الجيران وضع مظروف بلاستيكي كبير يوضع فيه مجلد في العلم الشرعي مضافا إلى ذلك كتاب وشريط ومجلة شهرية يوزع باشتراك شهري مخفض، ليصل إلى كل بيت في السنة ١٢ مجلدًا متنوع العلوم، منها في التفسير، والحديث والفقه، والسيرة، وغيرها وبهذا يتكون في كل بيت مكتبة إسلامية صغيرة، هذا عدا الأشرطة والكتيبات والمجلات الإسلامية، ووضع أيضا اشتراكا ممتازا لمن أراد أن يسهم في الخير؛ ويرسل هذا الإهداء إلى جيران لم يشتركوا في هذا البرنامج.
...
ج- تنظيم دورية لأهل الحي كل نصف شهر وتكون بعيدة',NULL,'53',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (52,'عن الإسراف والتبذير ويتخللها بعض الفوائد النافعة، ويعالج من خلالها أوضاع الحي المختلفة.
...
وزيارة أصحاب التموينات والأسواق التجارية وتذكيرهم بحرمة بيع الدخان والمجلات الفاسدة، وإعطاؤهم الفتاوى الصادرة بهذا الشأن، ومقاطعتهم حتى ينتهوا عن بيع ما حرم الله، وكذا أصحاب محلات بيع الشيش وأشرطة الغناء، وصوالين الحلاقة وتذكيرهم بالحديث النبوي: "كل جسد نبت من السحت فالنار أولى به" والسحت هو الحرام.
وأعمال إمام المسجد لا حصر لها من متابعة الأيتام والأرامل والمحتاجين وغيرها كثير.',NULL,'54',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (53,'<span data-type="title" id=toc-28>الدعوة في المدارس</span>
...
١ - القيام بعمل نشاط ثقافي شهري تبذل فيه الهدايا القيمة، ويوضع كتاب كل شهر مع مسابقة تكون جوائزها كتابا وأشرطة أو غيرها من الهدايا المرغوبة لكل عمر من الأعمار وهكذا يكون في كل عدد زيادة في المشتركين والمشتركات مع ما يصل إلى البيوت من الهدايا الدعوية القيمة.
٢ - التركيز حين الدرس على الدعوة وإشعار الطلاب والطالبات بأهمية المحافظة على الواجبات والبعد عن المحرمات وربط ذلك بواقع الناس، وفي كتاب أمانة التعليم، من ذلك الكثير خاصة للمدرسين والمدرسات.
٣ - استقطاب المحاضرين والمحاضرات من خارج المدرسة؛ رغبة في التغيير والتجديد على الطلاب، ويختار بعناية المواضيع التي تعود بالنفع على الجميع وتطعم بالقصص والمشاهدات.
٤ - إقامة علاقات مودة لكسب قلوب الطلاب والطالبات وإشعارهم بأهميتهم وحل مشاكلهم والقرب منهم.
وأذكر أن أحد أئمة المساجد ذكر لي أن سبب حفظه لكتاب الله عز وجل أن أحد المدرسين سأله: كم تحفظ من كتاب الله؟',NULL,'55',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (54,'يقول فأجبته: أربعة أجزاء، فقال: هذا لا يليق بك، وبدأ يراجع ويسمع لي حتى تيسر لي حفظ كتاب الله عز وجل.
...
أما ذلك الفقير المحروم والشخص الذي لا يقرأ ولا يكتب ويعيش في رمال الصحراء بعيدًا عن الناس .. فإن معه سلاحا نفاذا وسهاما لا تخطئ، يستطيع أن يخدم الإسلام وأهله والعلماء والدعاة وشباب ونساء المسلمين برفع يديه إلى السماء في كل وقت يتضرع إلى الله بإصلاح حال الأمة، ورفع كيد الأعداء وشر المفسدين وإن خلت يداه من أموال الدنيا، فإنها لن تخلو بإذن الله من دعوة صادقة لهذا الدين.',NULL,'57',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (56,'<span data-type="title" id=toc-30>من أعمال السائرين</span>
...
* أحدهم فرغ نفسه لكتابة مقتطفات من المطويات المجودة وإرسالها إلى الصحف. يقول: لا يهمني أن تنشر كلها، يكفي',NULL,'58',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (57,'البعض، وقد بدأ بإرسال كلمات عن أضرار التدخين، ووصايا لتربية الأبناء، وحقوق الزوج وحقوق الزوجة، وفضل يوم عاشوراء، والتحذير من البدع التي تحدث في رجب وشعبان وهكذا مواضيع كثيرة. فقط يجرد قلمه ويسجل على ورقة أو يطبع على جهاز الكمبيوتر، ويرسل للصحف والمجلات.
...
أحد المدرسين ذكر أنه طرح على زملائه المدرسين مشروعًا خيريًّا جيدًا عن طريق إحدى المؤسسات الخيرية قال: فتحمس المدرسون وأثنوا على المشروع ووعدوا بالتبرع، قال المدرس: قلت لهم: لعله أدعى للإخلاص وأبعد عن الرياء أن نجعل صندوقا يمر به',NULL,'59',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (58,'أحد الطلبة عليكم فكان كذلك.
...
INSERT INTO [b36553] VALUES (60,'<span data-type="title" id=toc-31>تأمل معي</span>
...
أبواب الدعوة كثيرة، ولم نر من يشتكي من إغلاق الأبواب كلها، فإن الله عز وجل متم نوره وإذا أغلق باب، فتحت أبواب',NULL,'62',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (61,'ولله الحمد.
كم هي حاجتك إلى هذا الدين، إنها كالهواء والماء والطعام بل هي أعظم، ماذا قدمت من عمل للحصول على الشراب والطعام. ثلث وقتك، أو نصفه اجعل لهذا الدين ما تراه يفي بفضل الله عليك ولن تستطيع لكنه تبارك وتعالى بمنه وكرمه يقبل القليل ويبارك فيه! .',NULL,'63',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (62,'<span data-type="title" id=toc-32>يا باغي الخير أقبل</span>
...
ومع التفاوت في الأعمال إلا أن الإسلام جعل الأجر والمثوبة لكل عمل تقوم به، ولا تعلم ماذا يتقبل من الأعمال؟ وما هي أرجى أعمالك عند الله وأكثرها قبولا؟ فلا تحقرن من العمل شيئا قل أو كثر.',NULL,'64',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (63,'<span data-type="title" id=toc-33>ما الذي يمنعك</span>؟
...
١ - الكسل والفتور: وهذا لا نراه إلا في هذا الجانب الدعوي، أما في الجوانب الأخرى فأنت صاحب همة ونشاط .. رحلة صيد، لعب كرة .. الذهاب إلى الاستراحة لديك همة وعزيمة، إذا لديك همة وعزيمة، لكنك لم تصرفها لصالح هذا الدين ولذا أصابك الكسل والفتور.
٢ - تلبيس إبليس: يلبس إبليس على الكثير بأمور كثيرة؛ منها الخوف من أهل الدنيا وهذا مردود عليك لأمور منها.
...
وتأمل في حديث النبي - صلى الله عليه وسلم -: "لقد كان من قبلكم ليمشط بمشاط الحديد، ما دون عظامه من لحم أو عصب، ما يصرفه ذلك عن دينه، ويوضع المنشار على مفرق رأسه فيشق باثنين، ما يصرفه ذلك عن دينه" [الفتح: ٧/ ٢٠٢].',NULL,'66',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (65,'<span data-type="title" id=toc-34>وقفات دعوية</span>
...
* من يكتب يحتاج إلى توجيه واستدراك، فالمحسن يقال له: أحسنت ويثبت على ما هو عليه من الخير، والمسيء يوجه للصواب وترسل له فتاوى العلماء والكتب النافعة فإن في هدايته خيرًا عظيمًا، وإن لمن ينفع فلا أقل من أن يشعر أن القراء يتابعون زلله، وربما رفعوا في أمره للجهات المسئولة فبهذا يخف شره ويقل.
* تنظيم مسابقة عائلية سواء للأسرة الصغيرة أو للعائلة حين اجتماعها نهاية الأسبوع، وتوزيع الجوائز وعمل اشتراك للأسرة في المجلات الإسلامية: كالدعوة والأسرة والشقائق، لما في ذلك من',NULL,'67',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (66,'النفع والتنوع والاستمرار.
...
* إذا أتى الخير ونزل، رحل الشر وولى، وأوجه دلالة الناس على الخير كثيرة جدًّا منها: الدلالة على مواعيد ومكان المحاضرات والدروس، الدلالة على السنن وما فيها من الأجر، الدلالة على',NULL,'68',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (67,'الفقراء والمساكين والأرامل والغارمين، الدلالة على مدارس تحفيظ القرآن الصباحية وما فيها من حفظ كتاب الله عز وجل، والدلالة على حلق التحفيظ في المساجد، وعلى المدارس النسائية المسائية لتحفيظ القرآن.
...
جعلني الله وإياكم وجميع المسلمين مفاتيح للخير مغاليق للشر!',NULL,'69',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (68,'<span data-type="title" id=toc-35>النبي القدوة</span>
نبينا محمد عليه أفضل الصلاة وأتم التسليم هو النموذج القدوة في الدعوة إلى الله عز وجل.
{لَقَدْ كَانَ لَكُمْ فِي رَسُولِ اللهِ أُسْوَةٌ حَسَنَةٌ} [الأحزاب: ٢١]. وقد قال عليه الصلاة والسلام: "مثلي ومثلكم كمثل رجل أوقد نارا، فجعل الجنادب والفراش يقعن فيها، وهو يذبهن عنها، وأنا آخذ بحجزكم عن النار، وأنتم تفلتون من يدي" [رواه مسلم].
...
أخي الداعية: أذكرك بقول النبي - صلى الله عليه وسلم -: "من أراد أن يعلم ما له عند الله، فلينظر ما له عنده" السلسلة الصحيحة (٢٣١٠).
وقال - صلى الله عليه وسلم -: "من خاف أدلج، ومن أدلج بلغ المنزل، ألا إن سلعة الله غالية، ألا إن سلعة الله الجنة" [السلسلة الصحيحة ٦٢٢٢].
وقال عليه الصلاة والسلام: "من دل على خير فله مثل أجر فاعله" [رواه مسلم].',NULL,'70',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (69,'قال النووي: وفيه فضيلة الدلالة على الخير والتنبيه عليه والمساعدة لفاعله.
والمراد بمثل أجر فاعله: أن له ثوابا بذلك الفعل، كما أن لفاعله ثوابًا.
فكم من الثمار غرست لتزهر وتورق لك فتستظل بها يوم لا ينفع مال ولا بنون إلا من أتى الله بقلب سليم، جعلني الله وإياكم من أولئك بمنه وكرمه.',NULL,'71',NULL,NULL,'0');
INSERT INTO [b36553] VALUES (70,'<span data-type="title" id=toc-36>وفي الختام</span>
أيها المسلم وأيتها المسلمة، أكثرت من الحديث وزادت الحروف، والله إنا نتوق إلى ألسن بكم وأيد وضاح.
وخير من ذلك قوله تعالى: {مَنْ عَمِلَ صَالِحًا فَلِنَفْسِهِ وَمَنْ أَسَاءَ فَعَلَيْهَا وَمَا رَبُّكَ بِظَلَّامٍ لِلْعَبِيدِ}.',NULL,'72',NULL,NULL,'0');
