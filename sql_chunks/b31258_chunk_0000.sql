...
CREATE TABLE "b31258"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b31258
INSERT INTO [b31258] VALUES (1,'<span data-type="title" id=toc-1>[المقدمة]</span>
حكم شرب الدخان وإمامة من يتجاهر به',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b31258] VALUES (2,'بسم الله الرحمن الرحيم
...
سماحة الشيخ عبد العزيز بن باز " رحمه الله " وقد صدر في مجلة: (باحث الكونجرس) الفصلية (١) .
...
* أثبتت التقارير أن التدخين يكلف الدولة مبالغ طائلة، فقد صرف في أمريكا عام ١٩٩٣م مبلغ (٥٠) بليون دولار، لعلاج المتضررين من التدخين، وأن كل علبة سجائر تُدخن يدفع مقابلها (٣. ٩٠)',NULL,'6',NULL,NULL,'0');
INSERT INTO [b31258] VALUES (7,'دولار خدمات صحية.
...
* أثَّر ذلك في مكاسب شركات التدخين. ويتوقع الاقتصاديون في سوق المال الأمريكي أن احتمالات نمو صناعة التدخين في أمريكا ضئيلة، وغير مجدية للشركات، وقد تُفلس، ولذلك بدأت شركات التبغ الأمريكية في العمل الجاد للدخول في مجالات تجارية جديدة غير التدخين، كما فعلت شركة (فليب موريس) ، وهي أكبر شركة سجائر في العالم، وتصنع سجائر (مارلبورو) الشهيرة. فقد دخلت في مجالات تجارية جديدة لدرجة أن استحوذت على أسهم شركات',NULL,'7',NULL,NULL,'0');
INSERT INTO [b31258] VALUES (8,'أغذية مشهورة مثل (شركة جبن كرافت) ، (وحوليات جيللو) وغيرها، حتى إن مبيعاتها من قسم الأغذية بلغت في سنة واحدة (٢١) بليون دولار، مقارنة بمبيعاتها التي بلغت (١٠) بليون دولار من السجائر.
...
* الحرب على هذه الشركات من طرف واحد، هو: الشعب الأمريكي ممثلا في منظمات مكافحة التدخين، ومن يناصرها من أعضاء الكونجرس وهم الأغلبية، أما دول العالم الثالث فتظل في موقف المتفرج، واستهلاكها في ازدياد تصاعدي.',NULL,'8',NULL,NULL,'0');
