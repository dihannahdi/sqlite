...
CREATE TABLE "b21633"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b21633
INSERT INTO [b21633] VALUES (1,'الكتاب: الكلام على حديث الاستلقاء - مخطوط
المؤلف: أبو موسى محمد بن أبي بكر بن أبي عيسى المديني الأصبهاني
المتوفى: ٥٨١ هـ',NULL,'1',NULL,NULL,'0');
INSERT INTO [b21633] VALUES (2,'ق ٦ (ب)
...
قال الإمام أبو موسى رواه ابن الأصفر عن............ (١)
_________
(١) انتهى ما لدينا من المخطوط.',NULL,'1',NULL,NULL,'0');
