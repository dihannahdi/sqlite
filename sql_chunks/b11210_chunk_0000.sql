...
CREATE TABLE "b11210"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b11210
INSERT INTO [b11210] VALUES (1,'رسائل وفتاوى الشيخ حمد بن ناصر
<span data-type="title" id=toc-1>رسالة الاجتهاد والتقليد</span>
...
لا ريب أن الله سبحانه- فرض على عباده طاعته وطاعة رسوله صلى الله عليه وسلم قال الله تعالى: {اتَّبِعُوا مَا أُنْزِلَ إِلَيْكُمْ مِنْ رَبِّكُمْ وَلا تَتَّبِعُوا مِنْ دُونِهِ أَوْلِيَاءَ} ١، وقال تعالى: {قُلْ أَطِيعُوا اللَّهَ وَالرَّسُولَ} ٢ إلى قوله: {وَإِنْ تُطِيعُوهُ تَهْتَدُوا} ٣.
...
٢ سورة النور آية: ٥٤.
٣ سورة النور آية: ٥٤.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (2,'واتفق العلماء على أنه ليس أحد معصوما إلا رسول الله صلى الله عليه وسلم.
...
٣ "المغني في فقه المذاهب الإسلامية" للشيخ موفق الدين بن قدامة الحنبلي، المتوفى في سنة ٦٢٠.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (3,'الحنفية، وقال بعضهم: يجوز أن يكون عاميا فيحكم بالتقليد؛ لأن الغرض فصل الخصومات، فإذا أمكنه ذلك بالتقليد جاز كما يحكم بقول المقومين، ولنا قوله تعالى: {وَأَنِ احْكُمْ بَيْنَهُمْ بِمَا أَنْزَلَ اللَّهُ} ١، ولم يقل بالتقليد، وقال: {لِتَحْكُمَ بَيْنَ النَّاسِ بِمَا أَرَاكَ اللَّهُ} ٢، وقال: {فَإِنْ تَنَازَعْتُمْ فِي شَيْءٍ فَرُدُّوهُ إِلَى اللَّهِ وَالرَّسُولِ} ٣.
...
٧ الظاهر أنه معطوف على محذوف منصوب.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (4,'وذكر القاضي أن ابن شاقلا اعترض عليه بقول الإمام أحمد: "لا يكون فقيها حتى يحفظ أربعمائة ألف حديث"، فقال: إن كنت لا أحفظه فإنني أفتي بقول من يحفظ أكثر منه.
...
(أحدها) : التقليد بعد قيام الحجة وظهور الدليل، على خلاف قول',NULL,'5',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (5,'المقلد، فهذا لا يجوز، وقد اتفق السلف والأئمة على ذمه وتحريمه، قال الشافعي -رحمه الله-: أجمع المسلمون على أنه من استبانت له سنة رسول الله صلى الله عليه وسلم لم يكن له أن يدعها لقول أحد من الناس.
(النوع الثاني) : التقليد مع القدرة على الاستدلال والبحث عن الدليل، فهذا مذمومٌ أيضا لأنه عمل على جهل، وإفتاء بغير علم، مع قدرته وتمكنه من معرفة الدليل المرشد، والله تعالى- قد أوجب على عباده أن يتقوه بحسب استطاعتهم، فقال تعالى: {فَاتَّقُوا اللَّهَ مَا اسْتَطَعْتُمْ} ١، وقال النبي صلى الله عليه وسلم "إذا أمرتكم بأمر فأتوا منه ما استطعتم" ٢.
...
٢ البخاري: الاعتصام بالكتاب والسنة (٧٢٨٨) , ومسلم: الحج (١٣٣٧) , والنسائي: مناسك الحج (٢٦١٩) , وابن ماجه: المقدمة (١,٢) , وأحمد (٢/٢٥٨,٢/٣٥٥,٢/٤٢٨,٢/٤٥٦,٢/٤٨٢,٢/٤٩٥) .',NULL,'6',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (6,'التقليد أيضا، إذ لا يجب عليه إلا ما يقدر عليه، و {لا يُكَلِّفُ اللَّهُ نَفْساً إِلاَّ وُسْعَهَا} ١.
ونصوص العلماء على جواز التقليد لمثل هذا كثيرة مشهورة؛ وذلك لقوله تعالى: {فَاسْأَلوا أَهْلَ الذِّكْرِ إِنْ كُنْتُمْ لا تَعْلَمُونَ} ٢، وفي الحديث عن النبي صلى الله عليه وسلم-: "ألا سألوا إذ لم يعلموا، فإنما شفاء العي السؤال" ٣.
...
قال الشيخ تقي الدين في الأخذ برخص المذهب وعزائمه: "طاعة٤ غير النبي صلى الله عليه وسلم- في كل أمره ونهيه، وهو خلاف الإجماع، وتوقف أيضا في جوازه".
...
_________
١ ابن عقيل من كبار فقهاء الحنابلة والثلاثة الذين ذكروا بعده من كبار الشافعية.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (8,'تتبع الرخص ويفسق به. وإن اختلف مجتهدان بأن أفتاه أحدهما بحكم والآخر بخلافه، تخير في الأخذ بأيهما شاء على الصحيح، اختاره القاضي والمجد وأبو الخطاب، وذكر أنه ظاهر كلام أحمد. وقيل: يأخذ بقول الأفضل منهما علما ودينا، وهذا اختيار الموفق في الروضة.
...
_________
١ أي التساهل.
٢ هو من كبار المالكية.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (9,'<span data-type="title" id=toc-2>معرفة الدليل ولو للمتعلم</span>
...
(جوابه) : يعلم مما تقدم، وهو أن عليه أن يتقي الله بحسب استطاعته، فيلزمه من ذلك ما يمكنه، ويسقط عنه ما يعجز عنه، ولا يكلف الله نفسا إلا وسعها. فلا يهجم على التقليد ويخلد إلى أرضه مع قدرته على معرفة الدليل، لا سيما إذا كان قاضيا أو مفتيا وله ملكة قوية يقوى بها على الاستدلال ومعرفة الراجح؛ فإن الرجل النبيه -الذي له فهم وفيه ذكاء- إذا سمع اختلاف العلماء وأدلتهم في الكتب التي يذكر فيها أقوال العلماء وأدلتهم -ك"المغني" و"الشرح"١ و"التمهيد" لابن عبد البر ونحو هذه الكتب- يحصل عنده في الغالب- ما يعرف به رجحان أحد القولين.
...
_________
١ يعني أبو العباس أن نصب الدليل على الحكم ثابت في الشرع قطعا، ولا يريد أنه واجب على الله face="courier new" size=٢&gt;- size=٥&gt;تعالى-؛ فإنه سني سلفي لا معتزلي.
٢ البخاري: العلم (٧١) , ومسلم: الزكاة (١٠٣٧) , وابن ماجه: المقدمة (٢٢١) , وأحمد (٤/٩٣,٤/٩٥) , ومالك: الجامع (١٦٦٧) , والدارمي: المقدمة (٢٢٤,٢٢٦) .',NULL,'11',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (11,'مسألة: تنازع فيها العلماء، ورأى مع أحد القولين نصوصا لم يعلم لها معارضا بعد نظر مثله فهو بين أمرين:
...
بخلاف من يقول: قد يكون للقول الآخر حجة راجحة على هذا النص وأنا لا أعلمها، فهذا يقال له: قد قال الله تعالى: {فَاتَّقُوا اللَّهَ مَا اسْتَطَعْتُمْ} ١، وقال النبي صلى الله عليه وسلم "إذا أمرتكم بأمر فأتوا منه ما استطعتم" ٢.
...
_________
١ أبو داود: السنة (٤٦٤٣) .
٢ البخاري: الاعتصام بالكتاب والسنة (٧٢٨٨) , ومسلم: الحج (١٣٣٧) , والنسائي: مناسك الحج (٢٦١٩) , وابن ماجه: المقدمة (١,٢) , وأحمد (٢/٢٥٨,٢/٣٥٥,٢/٤٢٨,٢/٤٥٦,٢/٤٨٢,٢/٤٩٥) .',NULL,'12',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (12,'أيضا- فمثل هذا لا يكون عذرا في ترك النص؛ فقد بيَّنا فيما كتبناه في "رفع الملام عن الأئمة الأعلام" نحوا من عشرين عذرًا للائمة في ترك العمل ببعض الحديث، وبيَّنا أنهم يعذرون في الترك لتلك الأعذار.
...
وقد ترك الناس قول عمر وابن مسعود في مسألة "تيمم الجنب"، وأخذوا بقول من هو دونهما، كأبي موسى الأشعري وغيره لما احتج بالكتاب والسنة، وتركوا قول عمر في "دية الأصابع"، وأخذوا بقول معاوية لما كان معه السنة أن النبي صلى الله عليه وسلم قال: "هذه وهذه سواء" ١.
_________
وقد كان بعض الناس يناظر ابن
١ البخاري: الديات (٦٨٩٦) , والترمذي: الديات (١٣٩٢) , والنسائي: القسامة (٤٨٤٧) , وأبو داود: الديات (٤٥٥٨) , وابن ماجه: الديات (٢٦٥٢) , وأحمد (١/٢٢٧,١/٣٣٩) .',NULL,'13',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (13,'عباس في "المتعة"، فقال له: إن أبا بكر وعمر يقولان.. فقال ابن عباس: يوشك أن تنزل عليكم حجارة من السماء، أقول: قال رسول الله صلى الله عليه وسلم وتقولون: قال أبو بكر وعمر؟!
...
ولو فُتح هذا الباب لوجب أن يعرض عن أمر الله ورسوله صلى الله عليه وسلم ويبقى كل إمام في أتباعه بمنزلة النبي في أمته، وهذا تبديل للدين يشبه ما عاب الله به اليهود والنصارى في قوله تعالى: {اتَّخَذُوا أَحْبَارَهُمْ وَرُهْبَانَهُمْ أَرْبَاباً مِنْ دُونِ اللَّهِ} ١. انتهى كلام الشيخ -رحمه الله تعالى.
تقليد نقاد الحديث
...
_________
١ سورة التوبة آية: ٣١.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (14,'له الرجوع إلى أهل الحديث في الخبر، وكون سنده صحيحا أو فاسدا، ولا يلزمه أن يتعلم ذلك بالإجماع، انتهى.
...
وقال أبو الحسن البكري الشافعي في كتابه "كنز المحتاج على المنهاج" -لما ذكر أن من شروط القاضي أن يكون مجتهدا إلا إذا فوضت إليه واقعة خاصة-: فيكفي الاجتهاد في تلك الواقعة بناء على تجزئ الاجتهاد وهو الأصح ... إلى أن قال: وقد يحصل الاجتهاد في باب دون باب آخر، ولا حاجة لتتبع الأحاديث، بل يكفي أصل مصحح اعتني فيه بجمع أحاديث الأحكام -كسنن أبي داود- ولا أن يعرف مواقع كل باب فيراجعه عند الحاجة، ولا إلى البحث عن رواة حديث أجمع السلف على قبوله أو تواترت عدالة',NULL,'15',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (15,'رواته ويقظتهم، وما عداه يكتفي في رواته بتعديل إمام مشهور عرفت صحة مذهبه جرحا وتعديلا، ولا إلى ضبط جميع مواضع الإجماع والاختلاف، بل يكفي معرفته بعدم مخالفة قوله الإجماع لموافقته بتقدم عليه أو غلبة ظن بتوليها في عصره، وكذا في معرفة الناسخ والمنسوخ، انتهى.
...
فتبين -بما ذكرناه من النقول- جواز الاعتماد على نقل الأحاديث من الكتب المصححة، وكذلك التقليد لأهل الجرح والتعديل في تصحيح الحديث أو تضعيفه، والله سبحانه- أعلم.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (16,'<span data-type="title" id=toc-3>تقليد الأئمة الأربعة</span>
...
ثم قال: والصحيح في هذه المسألة أن قول من قال: لا يجوز تولية قاض حتى يكون من أهل الاجتهاد، فإنه -إنما عنى به- ما كانت الحال عليه قبل استقرار هذه المذاهب الأربعة التي أجمعت الأمة أن كل واحد منها يجوز العمل به لأنه مستند إلى سنة رسول الله صلى الله عليه وسلم.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (17,'فالقاضي الآن، وإن لم يكن من أهل الاجتهاد، ولا يسعى في طلب الأحاديث وابتغاء طرقها، ولا عرف من لغة الناطق بالشريعة صلى الله عليه وسلم ما لا يعوزه معه معرفة ما يحتاج إليه فيه، وغير ذلك من شروط الاجتهاد، فإن ذلك مما قد فرغ منه، ودأب له فيما سواه، وانتهى له الأمر من هؤلاء الأئمة المجتهدين إلى ما أراحوا به من بعدهم، وانحصر الحق في أقاويلهم، ودونت العلوم، وانتهت إلى ما اتضح فيه الحق.
...
INSERT INTO [b11210] VALUES (18,'فيتبعون أحسنه.
...
ثم يذكر من شروط الاجتهاد أشياء ليست موجودة في الحكام، فإن هذا كالإحالة والتناقض، وكأنه تعطيل للأحكام وسد لباب الحكم، وأن لا ينفذ حق، ولا يكاتب به، ولا يقام بينة، إلى غير ذلك من القواعد الشرعية، وهذا غير صحيح، بل الصحيح في المسألة أن ولاة الحكام جائزة، وأن حكوماتهم اليوم صحيحة نافذة، وولاياتهم جائزة شرعا. انتهى كلام ابن هبيرة رحمه الله١.
_________
١ في هذا الكلام نظر من وجوه، ومما ينبغي التنبيه عليه في هذا المقام أن من أصول الشريعة اليسر ورفع الحرج، ومن هدي النبي "ص" أنه ما ُخيِّرَ بين أمرين إلا اختار أيسرهما، وهذا أفضل مرجح بين ما اختلف فيه الأربعة أو غيرهم، "ومنها" الترجيح بقوة الدليل، "ومنها" أن كتب هذه المذاهب وغيرها لا تغني عن الاجتهاد؛ لأن الناس يحدث لهم أقضية بما أحدثوا من أمور الكسب والعمران والنظم المالية، ومن الفجور أيضا كما قال الإمام عمر بن عبد العزيز "رض"، ويناسب هذا ما قاله الفقهاء في تعليق بعض الأعمال بالعرف الذي يختلف باختلاف الزمان والمكان، وكتبه محمد رشيد رضا.',NULL,'19',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (19,'فقد تضمن هذا الكلام أن تولية المقلد جائزة إذا تعذرت تولية المجتهد، لأنه ذكر أن شروط الاجتهاد ليست موجودة في الحكام، وأن هذا كالإحالة، وكأنه تعطيل للأحكام وسد لباب الحكم، فينفذ قضاء المقلد للحاجة لئلا تتعطل الأحكام.
...
بل صرح بأن القاضي لا ينبغي له الاقتصار على مذهب واحد منهم لا يفتي إلا به، بل ذكر أن الأولى للقاضي أن يتوخى مواطن الاتفاق',NULL,'20',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (20,'إن وجده، وإلا توخى ما عليه الأكثر، فيعمل بما قاله الجمهور، لا بما قاله الواحد منهم مخالفا الأكثر.
...
_________
١ سورة الزمر آية: ١٨.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (21,'طالب العلم يمكنه معرفة الراجح من الكتب الكبار
...
INSERT INTO [b11210] VALUES (22,'صريح في ضد ذلك.
...
واستقرت هذه الشبهة في قلوب كثير، حتى آل الأمر بهم إلى أن {فَتَقَطَّعُوا أَمْرَهُمْ بَيْنَهُمْ زُبُراً كُلُّ حِزْبٍ بِمَا لَدَيْهِمْ فَرِحُونَ} ١. وزعموا أن هذا هو الواجب عليهم، وأن من انتسب إلى مذهب إمام فعليه أن يأخذ بعزائمه ورخصه، وإن خالف نص كتاب أو سنة؛ فصار إمام المذهب عند أهل مذهبه كالنبي في أمته، لا يجوز الخروج عن قوله، ولا تجوز مخالفته.
التعصب للمذهب
...
٢ سورة النساء آية: ٥٩.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (23,'اللحم: أنت أعلم بهذه الأحاديث من الإمام الشافعي؟ فقد سمعها ولم يأخذ بها.
...
_________
١ سورة النساء آية: ٥٩.',NULL,'24',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (24,'أو محرم بمجرد هواه، وذلك مثل أن يكون طالبا للشفعة بالجوار، فيعتقدها أنها حق، ويقول: مذهب أبي حنيفة في هذه المسألة أرجح من مذهب الجمهور. ثم إذا طلبت منه الشفعة بالجوار اعتقد أنها ليست ثابتة، وقال: مذهب الجمهور في هذه المسألة أرجح.
...
وتجد كتب المتقدمين من أصحاب أحمد مهجورة عندهم، بل قد هجروا كتب المتأخرين، ف"المغني" و"الشرح" و"الإنصاف" و"الفروع"، ونحو هذه الكتب التي يذكر فيها أهلها خلاف الأئمة أو خلاف الأصحاب',NULL,'25',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (25,'لا ينظرون فيها.
...
_________
١ سورة المؤمنون آية: ٥٣.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (26,'دليلا من الجانبين أخذ بما عليه الجمهور، فإن لم يجد ذلك، بل قوي الخلاف عنده من الجانبين التزم قول إمامه إذا لم يترجح عنده خلافه.
...
فقال جعفر الفريابي: حدثني أحمد بن إبراهيم الدورقي، حدثني الهيثم ابن جميل (قال) : قلت لمالك بن أنس: يا أبا عبد الله، إن عندنا قوما وضعوا كتابا يقول أحدهم: حدثنا فلان عن عمر بن الخطاب رضي الله عنه- بكذا وكذا، وفلان عن إبراهيم بكذا. ويأخذ بقول إبراهيم، قال مالك: وصح عندهم قول عمر؟ قلت:',NULL,'27',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (27,'إنما هي رواية كما صح عندهم قول إبراهيم، فقال: هؤلاء يستتابون.
...
فإن قال: قلدته؛ لأنه أعلم الناس. قيل له: فهو إذًا أعلم من الصحابة. فكفى بقول مثل هذا قبحا١،.
...
وقد ذكر ابن مدين، عن
_________
١ إنه -على قبحه بمخالفة إمامه وسائر الأئمة على تفضيل الصحابة على أنفسهم- باطل بالبداهة، فإن المجتهد لا يمكنه أن يعرف أعلم الناس على الإطلاق، فضلا عن المقلد الذي لا يعرف أدلة أحد منهم.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (28,'عيسى بن دينار، عن القاسم عن مالك قال: ليس كلما قال الرجل قولا -وإن كان له فضل- يتبع عليه؛ لقوله عز وجل-: {الَّذِينَ يَسْتَمِعُونَ الْقَوْلَ فَيَتَّبِعُونَ أَحْسَنَهُ} ١.
...
٥ البخاري: النكاح (٥١٤٤) , ومسلم: البر والصلة والآداب (٢٥٦٣) , والترمذي: البر والصلة (١٩٨٨) , وأحمد (٢/٢٤٥,٢/٢٨٧,٢/٣١٢,٢/٣٤٢,٢/٥١٧,٢/٥٣٨) , ومالك: الجامع (١٦٨٤) .',NULL,'29',NULL,NULL,'0');
INSERT INTO [b11210] VALUES (29,'دليلا يخالفه، لأن الإمام صاحب المذهب أعلم بمعناه، ويجعل هذا عذرا له في رد الحديث، أو ترك العمل به.
...
ونسأل الله أن يهدينا لما اختلف فيه من الحق بإذنه، فإنه يهدي من يشاء إلى صراط مستقيم، وصلى الله على نبينا محمد وآله وصحبه وسلم تسليما كثيرا، والحمد لله رب العالمين. آمين.',NULL,'30',NULL,NULL,'0');
