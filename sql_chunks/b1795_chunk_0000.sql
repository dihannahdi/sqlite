...
CREATE TABLE "b1795"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1795
INSERT INTO [b1795] VALUES (1,'بسم الله الرحمن الرحيم
الحمد لله والصلاة والسلام على رسول الله وعلى آله وصحبه ومن اهتدى بهداه........أما بعد:
فهذه بعض الأسئلة التي عرضت على فضيلة الشيخ / عبد العزيز بن عبد الله الراجحي -حفظه الله - في مسائل الإيمان والكفر وأجاب عليها بهذه الأجوبة نسأل الله أن ينفع بها وأن يجعلها في موازين حسناته.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (2,'السؤال الأول:
...
١- إذا فعل الكفر جادا فهذا يكفر.
٢- إذا فعل الكفر هازلا فهذا يكفر.
٣- إذا فعل الكفر خائفا فهذا يكفر.
٤- إذا فعل الكفر مكرها واطمئن قلبه بالكفر فهذا يكفر.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (6,'٥- إذا فعل الكفر مكرها واطمئن قلبه بالإيمان فهذا لا يكفر لقول الله تعالى {مَنْ كَفَرَ بِاللَّهِ مِنْ بَعْدِ إِيمَانِهِ إِلَّا مَنْ أُكْرِهَ وَقَلْبُهُ مُطْمَئِنٌّ بِالْإِيمَانِ وَلَكِنْ مَنْ شَرَحَ بِالْكُفْرِ صَدْرًا فَعَلَيْهِمْ غَضَبٌ مِنَ اللَّهِ وَلَهُمْ عَذَابٌ عَظِيمٌ} {ذَلِكَ بِأَنَّهُمُ اسْتَحَبُّوا الْحَيَاةَ الدُّنْيَا عَلَى الْآخِرَةِ وَأَنَّ اللَّهَ لَا يَهْدِي الْقَوْمَ الْكَافِرِينَ} .',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (7,'السؤال الثاني:
هناك من يقول: <span data-type="title" id=toc-3>(الإيمان قول وعمل </span>واعتقاد لكن العمل شرط كمال فيه) ، ويقول أيضا: (لا كفر إلا باعتقاد) ، فهل هذا القول من أقوال أهل السنة أم لا؟
...
١- قول اللسان وهو النطق باللسان.
٢- قول القلب وهو الإقرار والتصديق.
٣- عمل القلب وهو النية والإخلاص.
٤- عمل الجوارح.
فالعمل جزء من أجزاء الإيمان الأربعة، فلا يقال: العمل شرط كمال أو أنه لازم له فإن هذه أقوال المرجئة، ولا نعلم لأهل السنة قولا بأن العمل شرط كمال.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (8,'وكذا قول من قال: (لا كفر إلا باعتقاد) فهذا قول المرجئة، ومن أقوالهم: (الأعمال والأقوال دليلٌ على ما في القلب من الاعتقاد) وهذا باطل، بل نفس القول الكفري كفر ونفس العمل الكفري كفر كما مر في قول الله تعالى {قُلْ أَبِاللَّهِ وَآيَاتِهِ وَرَسُولِهِ كُنْتُمْ تَسْتَهْزِئُونَ} {لَا تَعْتَذِرُوا قَدْ كَفَرْتُمْ بَعْدَ إِيمَانِكُمْ} أي: بهذه المقالة',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (9,'السؤال الثالث:
هل<span data-type="title" id=toc-4> الأعمال ركن في الإيمان وجزء منه أم هي شرط كمال فيه</span>؟

الجواب:
الإيمان قول باللسان وقول بالقلب وعمل بالقلب وعمل بالجوارح كما سبق.
ولا يقال: إنها شرط كمال أو إنها خارجة عن الإيمان أو إنها لازم من لوازم الإيمان أو من مقتضى الإيمان أو هي دليل على الإيمان إذ كل هذه من أقوال المرجئة.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (10,'السؤال الرابع:
...
١- عقيدة نفي الصفات وأخذها عنه الجهمية.
٢- عقيدة الإرجاء وأخذها عنه المرجئة.
٣- عقيدة الجبر - أي أن العبد مجبور على أعماله - وأخذها عنه الجبرية.
٤- عقيدة القول بفناء الجنة والنار.
...
الطائفة الثانية: مرجئة الفقهاء وهم أهل الكوفة كأبي حنيفة - رحمه الله - وأصحابه وأول من قال بأن الأعمال غير داخلة في مسمى الإيمان هو حماد بن أبي سليمان شيخ الإمام أبي حنيفة، وأبو حنيفة له روايتان في حد الإيمان:',NULL,'11',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (12,'الأولى: أنه تصديق القلب وقول اللسان، وهذه الرواية عليها أكثر أصحابه.
...
فأخبر الله بأن لهم حظًّا من الدنيا فقدَّموا حظ الدنيا، فالآية نصٌ في هذا الصنف من الناس وأنه إنما فعل الكفر تفضيلًا وإيثارًا للدنيا على الآخرة فيكون داخلًا في هذه الآية.',NULL,'29',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (30,'السؤال الحادي عشر:
...
الجواب:',NULL,'42',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (43,'لا أعلم أن هذا القول قالت به المرجئة ولكن لا بد من العمل كما سبق لأن من أقر بالشهادتين فلا بد أن يعمل لأن النصوص التي فيها الأمر بالنطق بالشهادتين وأن من نطق بالشهادتين فهو مؤمن مقيّدة بقيود لا يمكن معها ترك العمل وقد ثبت في الحديث الصحيح عنه صلى الله عليه وسلم أنه قال: «من قال: لا إله إلا الله خالصًا من قلبه دخل الجنة» وقوله: «خالصًا من قلبه» هذا ينفي الشرك؛ لأن الإخلاص ينافي الشرك ومن ترك العمل فهو مشرك لأنه عابدٌ للشيطان ولأنه معرض عن دين الله؛ ومن أعرض عن دين الله كفر؛ وكذلك جاء في الأحاديث: «من قال لا إله إلا الله مخلصًا» وفي بعضها: «صادقًا من قلبه» وفي بعضها: «مستيقنًا بها قلبه» وفي بعضها: «وكفر بما يعبد من دون الله» فهذه النصوص التي فيها أن من نطق بالشهادتين فهو مؤمن مقيدة بهذه القيود التي لا يمكن معها ترك العمل فلا بد أن يكفر بما يعبد من دون الله؛ ومن لم يعمل فإنه معرض عن دين الله وهذا نوع من أنواع الردة؛ فمن لم يعمل مطلقًا وأعرض عن الدين لا يتعلمه ولا يعبد الله فهذا من نواقض الإسلام قال تعالى: {وَالَّذِينَ كَفَرُوا عَمَّا أُنْذِرُوا مُعْرِضُونَ} فلا',NULL,'43',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (44,'بد أن يعمل فإذا قال: لا إله إلا الله مستيقنًا بها قلبه وقالها عن إخلاص وفي بعضها «وهو غير شاك» فلا بد أن يعمل ولا يمكن أن يتكلم بكلمة التوحيد عن صدق وإخلاص ولا يصلي أبدًا وهو قادر لأنه إذا ترك الصلاة دل على عدم إخلاصه ودل على عدم صدقه ودل على أن قلبه ليس مستيقنًا بها ولو كان قلبه مستيقنًا بها وكان عنده يقين وإخلاص وصدق لا بد أن يعمل فإن لم يعمل دل على عدم إيمانه وعدم يقينه وعدم إخلاصه وعدم صدقه ودل على ريبه وشكه وهذا واضح من النصوص.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (45,'السؤال الثامن عشر:
...
الجواب:',NULL,'45',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (46,'هذه مسألة فيها كلام لأهل العلم وقد ذكر الحافظ ابن كثير - رحمه الله - أن من بدَّل الشريعة بغيرها من القوانين فإن هذا من أنواع الكفر ومثَّل لذلك بالمغول الذين دخلوا بلاد الإسلام وجعلوا قانونًا مكونًا من عدة مصادر يسمى (الياسق) وذكر كفرهم وذكر هذا أيضًا الشيخ محمد بن إبراهيم آل الشيخ - رحمه الله - فقد قال في أول رسالته (تحكيم القوانين) : (إن من الكفر المبين استبدال الشرع المبين بالقانون اللعين) فإذا بدَّل الشريعة من أولها إلى آخرها كان هذا كفرًا من أنواع الكفر والردة، وقال آخرون من أهل العلم: إنه لا بد أن يعتقد استحلاله ولا بد أن تقام عليه الحجة وذهب إلى هذا سماحة شيخنا عبد العزيز بن باز -رحمه الله- وقال: إنه لا بد أن تقوم عليه الحجة لأنه قد يكون جاهلًا بهذا الأمر وليس عنده علم؛ فلا بد أن يبين له حتى تقوم عليه الحجة فإذا قامت عليه الحجة فإنه يحكم بكفره، والمقصود أن هذه المسألة مسألة خطيرة وهذا إذا لم يكن لمن وضع القانون أعمال كفرية أخرى أما إذا كان تلبَّس بأنواع من الكفر الأخرى فهذا لا إشكال فيه، لكن هذا مفروض في شخص لم يتلبَّس بشيء من أنواع الكفر؛ فهل يكون هذا كفرًا أكبر بمجرد',NULL,'46',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (47,'تبديله الدين كما ذكر هذا الحافظ ابن كثير والشيخ محمد بن إبراهيم - رحمهما الله - وغيرهما من أهل العلم، أو أنه لا بد من إقامة الحجة وبيان أن هذا الأمر كفر فإذا قامت عليه الحجة حكم بكفره.',NULL,'47',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (48,'السؤال التاسع عشر:
هل تكفير السلف - رضوان الله عليهم - للجهمية كفر أكبر مخرج من الملة أم هو كفر دون كفر ويراد منه الزجر والتغليظ فقط؟

الجواب:
<span data-type="title" id=toc-20>تكفير العلماء والأئمة والسلف للجهمية تكفير أكبر </span>مخرج عن الملة؛ وذكر العلَّامة ابن القيِّم - رحمه الله تعالى - أنه كفرهم خمسمائة عالم فقال:

ولقد تقلد كفرهم خمسون في ... عشر من العلماء في البلدان
واللالكائي الإمام قد حكاه عنهُم ... بل قد حكاه قبله الطبراني',NULL,'48',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (49,'وقد قال العلماء: إن الجهمية خارجون من الثنتين والسبعين فرقة الذين قال فيهم النبي صلى الله عليه وسلم: «وستفترق أمتي على ثلاث وسبعين فرقة كلها في النار إلا واحدة» وكونهم خارجين عن الثنتين والسبعين فرقة يدل على أن مرادهم الكفر الأكبر لأن فرق الأمة الثنتين والسبعين فرقة متوعدة بالنار وهي فرقٌ مبتدعة،وقالوا: الجهمية خارجون عن الفرق الثنتين والسبعين وكذلك القدرية الغلاة وكذلك الرافضة فهذه الفرق الثلاث خارجون من الثنتين والسبعين فرقة؛ لأن الجهمية نفوا الأسماء والصفات؛ ونفي الأسماء والصفات ينتج العدم؛ فشيء لا اسم له ولا صفة؛ لا وجود له إلا في الذهن نسأل الله العافية، فشيء لا داخل العالم ولا خارجه ولا فوقه ولا تحته ولا مباين له ولا محايث له ولا منفصل عنه وليس له سمع ولا بصر ولا قدرة ولا إرادة ولا علم ماذا يكون؟!! هذا مستحيل؛ ولهذا كان كفرهم كفرًا أكبر مخرجًا عن الملة.',NULL,'49',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (50,'السؤال العشرون:
ما وجه قولهم: (إنه تكفير للزجر) ؟

الجواب:
يعني أنه كفر أصغر، زجر عن العمل وإن كان ليس بمخرج من الملة؛ أي يُنهى عنه صاحبه ويقال له: إنه كفر، حتى يرتدع عن هذا العمل لا أنه كفر أكبر.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (51,'السؤال الحادي والعشرون:
...
الجواب:
الظاهر أن المراد تكفير أعيانهم لما خصوهم بالذكر، وكذلك الشافعي ظاهره أنه ناظره وأقام عليه الحجة، أما لو أريد التكفير بالعموم فهو مثل قول بعضهم: الجهمية كفار، أما تخصيص أعيان بعينهم يقابلون الأئمة ويناظرونهم فهذا تكفير بأعيانهم والعلماء لهم في تكفير الجهمية أقوال فمنهم من كفر الغلاة ومنهم من كفرهم بإطلاق ومنهم من بدّعهم بإطلاق، فهؤلاء الأفراد الذين وقفوا أمام الأئمة وناظروهم؛ الظاهر أنهم كفروهم بأعيانهم؛ لأن الحجة تكون قد قامت عليهم.',NULL,'51',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (52,'السؤال الثاني والعشرون:
...
والامتناع: أي يمتنع عما أمر الله به؛ وهذا فيه تفصيل فإذا امتنع عن شيء يكون تركه كفرًا يكون كفرا وإن امتنع عن شيء لا يصل لحد الكفر يكون معصية، ومن كفر الامتناع امتناع إبليس عن السجود لآدم قال تعالى: {وَإِذْ قُلْنَا لِلْمَلَائِكَةِ اسْجُدُوا لِآدَمَ فَسَجَدُوا إِلَّا إِبْلِيسَ أَبَى وَاسْتَكْبَرَ وَكَانَ مِنَ الْكَافِرِينَ} فإبليس إباؤه كفر.
وكفر الإعراض: كما سبق معناه الإعراض عن دين الله لا يتعلمه ولا يعبد الله.',NULL,'52',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (53,'السؤال الثالث والعشرون:
ما معنى قول الشيخ محمد بن عبد الوهاب في الناقض الثالث من نواقض الإسلام: <span data-type="title" id=toc-24>(من لم يكفر المشركين أو شك في كفرهم أو صحَّح مذهبهم </span>فهو مثلهم) ؟
...
وهذا هو معنى: (لا إله إلا الله) وأن معناها: لا معبود بحقٍ إلا الله.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (54,'(لا إله) كفر بالطاغوت (إلا الله) إيمان بالله، فمن لم يكفر المشركين أو اليهود أو النصارى أو الوثنيين أو توقف في كفرهم فهو كافر بالله، لا بد أن يجزم ويعتقد كفرهم فمن قال: (إن اليهود والنصارى على دين سماوي وكذلك المسلمون على دين سماوي وكلهم على حق) فهذا كافر؛ لأنه لم يكفِّر المشركين فلا بد أن يعتقد أن اليهود والنصارى كلهم على باطل وأنهم كفار فإن شك أو توقَّف كان هذا الشك أو التوقف منه ناقضا من نواقض الإسلام ويكون كافرا بالله؛ وكذلك لو صحَّح مذهبهم وقال: النصارى على حق واليهود على حق ومن أحب أن يتدين باليهودية أو النصرانية أو بالإسلام فله ذلك فهذا كافر لأنه صحَّح مذهبهم.',NULL,'54',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (55,'السؤال الرابع والعشرون:
من قال: (إن<span data-type="title" id=toc-25> اليهود والنصارى بلغتهم دعوة الإسلام </span>مشوَّهة فما نكفرهم) فما حكم هذا القول؟

الجواب:
ليس ذلك بصحيح؛ بل بلغتهم الدعوة على عهد النبي صلى الله عليه وسلم وبلَّغهم النبي صلى الله عليه وسلم بنفسه والصحابة بلغوهم بأنفسهم والدعاة بلغوهم بأنفسهم والأئمة؛ فشيخ الإسلام بلغهم بنفسه، فالقول بأنه لم تبلغهم الدعوة باطل.',NULL,'55',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (56,'السؤال الخامس والعشرون:
من قال: (إخواننا النصارى) !!! فما حكم هذا القول؟

الجواب:
إذا كان يعتقد أن دينهم صحيح وأن مذهبهم صحيح وأنهم على حق وأنه يوافقهم في دينهم فهذا كفر وردة، وأما لو قال: (إخواننا النصارى) غلطة أو سبقة لسان أو خطأ أو له شبهة فقد لا يكفر؛ فهذا فيه تفصيل.',NULL,'56',NULL,NULL,'0');
INSERT INTO [b1795] VALUES (57,'السؤال السادس والعشرون:
