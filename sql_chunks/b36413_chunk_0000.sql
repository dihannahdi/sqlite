...
CREATE TABLE "b36413"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36413
INSERT INTO [b36413] VALUES (1,'ماذا نريد
من رمضان؟؟

مجدي الهلالي',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b36413] VALUES (2,'<span data-type="title" id=toc-1>مقدمة</span>
...
INSERT INTO [b36413] VALUES (3,'<span data-type="title" id=toc-2>شهر المغفرة</span>
...
هيا بنا نجيب داعي الله: {اسْتَجِيبُوا لِرَبِّكُمْ مِنْ قَبْلِ أَنْ يَأْتِيَ يَوْمٌ لَا مَرَدَّ لَهُ مِنَ اللَّهِ مَا لَكُمْ مِنْ مَلْجَأٍ يَوْمَئِذٍ وَمَا لَكُمْ مِنْ نَكِيرٍ (٤٧)} (الشورى)
...
وهناك صنف من الناس اعتبر رمضان فرصة نادرة لإحياء القلب وإيقاظه من رقدته وإشعال فتيل التقوى وجذوة الإيمان فيه. نظر إلى مستهدف الصيام فوجده في قول الله عز وجل: {يَا أَيُّهَا الَّذِينَ آَمَنُوا كُتِبَ عَلَيْكُمُ الصِّيَامُ كَمَا كُتِبَ عَلَى الَّذِينَ مِنْ قَبْلِكُمْ لَعَلَّكُمْ تَتَّقُونَ (١٨٣)} (البقرة) فتقوى الله عزوجل هي مقصود العبادات {يَا أَيُّهَا النَّاسُ اعْبُدُوا رَبَّكُمُ الَّذِي خَلَقَكُمْ وَالَّذِينَ مِنْ قَبْلِكُمْ لَعَلَّكُمْ تَتَّقُونَ (٢١)} (البقرة) وعلى قدرها في القلب يكون قرب العبد أو بعده من الله عز وجل {إِنَّ أَكْرَمَكُمْ عِنْدَ اللَّهِ أَتْقَاكُمْ إِنَّ اللَّهَ عَلِيمٌ خَبِيرٌ (١٣)} (الحجرات) وعلم هذا الصنف أن شهر رمضان ما جاء إلا ليقرب الناس من ربهم ويزيد من صلاتهم به، ويقطع عن قلوبهم صلتها بالدنيا فهو يزود القلوب بخير زاد {وَتَزَوَّدُوا فَإِنَّ خَيْرَ الزَّادِ التَّقْوَى وَاتَّقُونِ يَا أُولِي الْأَلْبَابِ (١٩٧)} (البقرة)',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (4,'فشمر عن سواعد الجد وأحسن استخدام الوسائل التي وضعها الإسلام في هذا الشهر المبارك وجمع بين عمل القلب وعمل الجوارح .. ومما لا شك فيه أن الصنف الأخير هو الفائز الأكبر من رمضان فلقد أصلح من خلاله قلبه وانطلق به في طريق السائرين إلي الله ....
...
فلا بد من وجود الأمرين معا ليشكل كل منهما طرفا تنعقد به العروة الوثقى كما قال الله تعالى: {وَمَنْ يُسْلِمْ وَجْهَهُ إِلَى اللَّهِ وَهُوَ مُحْسِنٌ فَقَدِ اسْتَمْسَكَ بِالْعُرْوَةِ الْوُثْقَى} (لقمان:٢٢).',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (5,'<span data-type="title" id=toc-6>القسم الأول
...
٣ - القراءة من المصحف و بصوت مسموع وبترتيل: فالترتيل له وظيفة كبيرة في الطرق على المشاعر ومن ثم إستثارتها وتجاوبها مع الفهم الذي سيولده التدبر، لينشأ بذلك الإيمان حينما يتعانق الفهم مع التأثير.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (7,'٤ - القراءة الهادئة الحزينة: علينا ونحن نرتل القرآن أن نعطي الحروف والغنات والمدود حقها حتى يتيسر لنا معايشة الآيات وتدبرها والتأثر بها، وعلينا كذلك أن نقرأ القرآن بصوت حزين لإستجلاب التأثر.
...
فأقرب ما يكون العبد من ربه وهو ساجد .. ففي السجود يتم إخراج معاني الذل والإنكسار وإظهار الفقر والمسكنة لمن بيده ملكوت السماوات والأرض.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (8,'وهنا لفتة طيبة ذكرها د. عبد الستار فتح الله، وهي أن الله عز وجل فرض علي رسوله قيام الليل بنزول سورة المزمل .. وسورة المزمل من أوائل ما نزل من القرآن .. فكيف يحيى ما يقرب من نصف الليل بآيات قليلة هي كل ما نزل من القرآن في هذه الفترة؟
...
- سادساً:<span data-type="title" id=toc-12> الإعتكاف</span>
...
وللأخت المسلمة أن تعتكف في مسجد بيتها استناداً على رأى الأحناف في جواز ذلك ولتقتطع من يومها وقتاً تلازم فيه مسجدها وتقبل فيه على الله عز وجل.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (10,'- سابعا:<span data-type="title" id=toc-13> الدعاء:</span>
...
وللصدقة فضل عظيم في الدنيا والآخرة فهي تداوى المرضى وتدفع البلاء وتيسر الأمور وتجلب الرزق وتقي مصارع السوء وتطفيء غضب الرب وتزيل أثر الذنوب، وهى ظل لصاحبها يوم القيامة وتحجبه عن النار وتدفع عنه العذاب .. وللصدقة علاقة وثيقة بالسير إلي الله، يقول تعالى: {فَآَتِ ذَا الْقُرْبَى حَقَّهُ وَالْمِسْكِينَ وَابْنَ السَّبِيلِ ذَلِكَ خَيْرٌ لِلَّذِينَ يُرِيدُونَ وَجْهَ اللَّهِ} (الروم: ٣٨) ولا عذر لأحد في تركها، فالله عز وجل لم يحدد لنا قدر معيناً نتصدق به، فالباب مفتوح أمام الجميع كل حسب استطاعته.
...
وعلينا بعد كل جلسة من هذه الجلسات الإكثار من الاستغفار، ولو أمكن الصلاة - ولتكن صلاة التوبة - قال تعالى: {وَالَّذِينَ إِذَا فَعَلُوا فَاحِشَةً أَوْ ظَلَمُوا أَنْفُسَهُمْ ذَكَرُوا اللَّهَ فَاسْتَغْفَرُوا لِذُنُوبِهِمْ وَمَنْ يَغْفِرُ الذُّنُوبَ إِلَّا اللَّهُ وَلَمْ يُصِرُّوا عَلَى مَا فَعَلُوا وَهُمْ يَعْلَمُونَ} (آل عمران: ١٣٥)',NULL,'10',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (12,'<span data-type="title" id=toc-17>خلاصة القسم الأول</span>
...
وعلينا أن نستفيد من أوقات استجابة الدعاء فنلح فيها علي الله عز وجل وندعوه دعاء المضطر المشرف على الغرق لنا ولأهلنا ولإخواننا وللمسلمين أجمعين، ولنتحين الفرصة المناسبة التي نخلو بأنفسنا ولنحاسبها على ما مضى ...',NULL,'11',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (13,'<span data-type="title" id=toc-18>القسم الثاني
مع الناس</span>
...
وعلينا كذلك إطعام المساكين ففي ذلك خير عظيم، قال صلى الله عليه وسلم للرجل الذي أشتكي له من قسوة قلبه: ((إن أحببت أن يلين قلبك فأطعم المسكين وأمسح رأس اليتيم)).',NULL,'13',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (15,'فلنجهز وجبات الإفطار للفقراء والمساكين ونجلس معهم نشاركهم طعامهم ونشعرهم بإخوتنا لهم .. ومع تذكرنا لهؤلاء علينا ألا ننسي إخواننا المكروبين في كثير من بلدان العالم والتي يعاني أهلها من الظلم والإضطهاد والجوع والحرمان، ولنتذكر بشرى رسول الله صلى الله عليه وسلم: ((من فطر صائما كان له مثل أجره غير أنه لا ينقص من أجر الصائم شيئا)).
...
هل لنا أن نستفيد من أجواء رمضان حيث النفوس طيعة والشياطين مصفدة؟',NULL,'14',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (16,'يقول صلي الله عليه وسلم: ((لئن يهدي الله بك رجلاً واحداً خير لك مما طلعت عليه الشمس)) فهيا بنا نجتهد لنكون سبباً في هداية وإنقاذ غيرنا.
هيا بنا نوقظ غافلاً، ونهدي حائراً، ونرشد ضالاً.

هيا بنا نبدأ بالأقربين فنعمل على تبصيرهم بحقيقة الدنيا ونجذبهم معنا إلى المسجد. هيا بنا نتخير بعضاً ممن يقبلون على المسجد في رمضان فنصحح له فهمه ونبصره بطريق صحيح إلي الله .. هيا نردد دعاء الرسول صلي الله عليه وسلم: ((اللهم اجعلنا هداة مهتدين)).',NULL,'15',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (17,'<span data-type="title" id=toc-26>خلاصة القسم الثاني</span>
...
ومن صور الإحسان أيضا: صلة الرحم وإطعام الطعام ومداومة البذل والعطاء والسعي في قضاء حوائج الناس وإصلاح ذات بينهم ودعوتهم إلى الله.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (18,'<span data-type="title" id=toc-27>أتعهد</span>
وأخيراً، فهلا وافقتني يا أخي أن يأخذ الواحد منا العهد على نفسه للقيام بهذه الأمور، فلقد قال تعالى: {إِنْ يَعْلَمِ اللَّهُ فِي قُلُوبِكُمْ خَيْرًا يُؤْتِكُمْ خَيْرًا} (الأنفال: ٧٠) وقال صلى الله عليه وسلم في الحديث (( .. ومن يتحر الخير يعطه))، فلعل الله سبحانه وتعالى يرى صدقنا فيعطينا سؤالنا ويبلغنا مرادنا، فكما قيل: الإمداد على قدر الإستعداد.
...
٢ - عدم الإكثار من الطعام و الشراب.
٣ - عدم الإكثار من الكلام و الضحك.
٤ - تدبر القرآن وإعادة ما أقراه وأنا غافل.
٥ - الإكثار من ذكر الموت.
٦ - طول المكث في المسجد.
٧ - التبكير إلى صلاة الجماعة.
٨ - تخصيص مسجد في البيت للزوجة و الأولاد.
٩ - الجلوس مع الزوجة و الأولاد يومياً للإطمئنان على الأحوال مع القراءة النافعة.
١٠ - التهجد و الدعاء و الإستغفار في الجزء الأخير من الليل (قبل الفجر).
١١ - اغتنام الأوقات الفاضلة في اليوم وعدم إضاعتها بالنوم أو الغفلة.
١٢ - كثرة الدعاء -بحضور قلب -بخاصة في الأوقات المندوب فيها.
١٣ - وضع صندوق في البيت للصدقة و التبكير بها يومياً.
١٤ - ربط عبادة الذكر بالفكر، والعمل على حضور القلب ما استطعت.
١٥ - الإعتكاف ولو لساعة يومياً والإجتهاد في الإعتكاف في العشر الأواخر.
١٦ - محاسبة النفس عن الفترة الماضية في المجالات المختلفة.
١٧ - الإكثار من عمل الخير.
١٨ - إطعام الطعام للأصدقاء و المساكين.
١٩ - السعي في قضاء حوائج الناس.
٢٠ - العفو والصفح والحلم وسعة الصدر.
٢١ - الدعوة إلى الله.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (19,'برنامجي في رمضان
...
- وما الوسائل التي سأستخدمها في الدعوة (كتاب- شريط .. )؟ ..........',NULL,'18',NULL,NULL,'0');
INSERT INTO [b36413] VALUES (20,'أعمال أسبوعية
...
والحمد لله رب العلمين',NULL,'19',NULL,NULL,'0');
