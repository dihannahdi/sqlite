...
CREATE TABLE "b14275"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b14275
INSERT INTO [b14275] VALUES (1,'اشتقاق أسماء الله
...
INSERT INTO [b14275] VALUES (2,'بسم الله الرحمن الرحيم
...
حدثني أبو عبد الله الحسين بن محمد الرازي الفقيه قال: حدثني أبو بكر',NULL,'19',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (3,'محمد بن عمير الرازي قال: حدثني أبو الفضل عبد الرحمن بن معاوية العتبي بمصر قال: حدثني حبان بن نافع بن صخر بن جويرية قال: حدثني سفيان عن أبي الزناد عن الأعرج عن أبي هريرة أن رسول الله صلى الله عليه وسلم قال: «إن لله تسعة وتسعين اسمًا مائة إلا واحدًا من أحصاها دخل الجنة».
قال حبان: فحدثني داود بن عمرو بن قنبل المكي قال: سألنا سفيان أن يملي علينا التسعة والتسعين اسمًا التي لله عز وجل من القرآن فوعدنا أن يخرجها لنا، لما أبطأ علينا اتينا أبا زيد فأملى علينا هذه الأسماء، فأتينا سفيان فعرضناها',NULL,'20',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (4,'عليه فنظر فيها أربع مرات فقال: هي هذه فقلنا له: اقرأها علينا، فقرأها علينا سفيان: في فاتحة الكتاب: يا الله، يا رب، يا رحمن، يا رحيم، يا ملك، وفي البقرة ستة وعشرون اسمًا: يا محيط يا قدير، يا عليم، يا تواب، يا حكيم، يا بصير، يا واسع، يا بديع، يا سميع، يا كافي، يا رؤوف، يا شاكر، يا إله، يا واحد، يا غفور، يا حليم، يا قابض، يا باسط، يا لا إله إلا هو، يا حي، يا قيوم، يا علي، يا عظيم، يا ولي، يا غني، يا حميد. وفي آل عمران أربعة أسماء: يا قائم، يا وهاب، يا سريع، يا خبير. وفي النساء ستة أسماء: يا رقيب، يا حسيب، يا شهيد، يا عفو، يا مقيت، يا وكيل. وفي الأنعام خمسة أسماء: يا باطن، يا ظاهر، يا قدير، يا لطيف، يا خبير. وفي الأعراف اسمان: يا محيي، يا مميت، وفي الأنفال اسمان: يا نعم المولى، ويا نعم النصير. وفي «هود» سبعة أسماء: يا حفيظ، يا قريب، يا مجيب، يا قوي، يا مجيد، يا ودود، يا فعال. وفي الرعد اسمان: يا كبير، يا متعال. وفي «إبراهيم» اسم: يا منان. وفي «الحجر» اسم: يا خلاق. وفي «النحل» اسم: يا باعث. وفي «مريم» اسمان: يا صادق، يا وارث. وفي «المؤمنون» اسم: يا كريم. وفي «النور» ثلاثة أسماء: يا حق، يا مبين، يا نور. وفي «الفرقان» اسم: يا هادي. وفي «سبأ» اسم: يا فتاح. وفي «المؤمن» أربعة أسماء: يا غافر، يا قابل، يا شديد، يا ذا الطول. وفي «الذاريات» ثلاثة أسماء: يا رزاق، يا ذا القوة، يا متين. وفي «الطور» اسم: يا بار. وفي «اقتربت» اسم: يا مقتدر. وفي «الرحمن» ثلاثة أسماء: يا باقي، يا ذا الجلال، يا ذا الإكرام. وفي «الحديد» ثلاثة أسماء: يا أول، يا آخر، يا باطن. وفي «الحشر» عشرة أسماء: يا قدوس، يا سلام، يا مؤمن، يا مهيمن، يا عزيز، يا جبار، يا متكبر، يا خالق، يا بارئ، يا مصور. وفي «البروج» اسمان: يا مبدئ، يا معيد. وفي «قل هو الله أحد» اسمان: يا أحد، يا صمد.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (5,'<span data-type="title" id=toc-2>القول في اشتقاقها، وتصاريفها، واللغات
فيها، ومصادرها على مذاهب أهل العربية</span>
<span data-type="title" id=toc-3>الله</span>
عز وجل في اشتقاقه أربعة أقوال:
قال يونس بن حبيب، والكسائي، والفراء وقطرب، والأخفش: أصله الإله ثم حذفت الهمزة تخفيفًا فاجتمعت لامان، فأدغمت الأولى في الثانية فقيل:',NULL,'23',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (6,'«الله». فاله «فعال» بمعنى «مفعول» كأنه مألوه أي معبود مستحق للعبادة يعبده الخلق ويؤلهونه.
...
فيا الغلامان اللذان فرا ... إياكما أن تكسبانا شرا',NULL,'25',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (8,'وكان يقول: لو روي «فيا غلامان» لاستقام وزن البيت. وليست الألف واللام في «الله» كالألف واللام في النجم إذا أردت الثريا لأن الألف واللام تخرجان منه فيصير نجمًا من النجوم نكرة، وهذا اسم ليس كمثله اسم، ولا معرفة أعرف منه لا يشارك فيه. وليست الألف واللام في «الله» بمنزلتها في «الناس» لأنه قد يقال: «الأناسُ» على الأصل.
...
وقال الخليل بن أحمد: أصل إله ولاه من الوله والتحير وقد أبدلت الواو',NULL,'26',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (9,'همزة لانكسارها فقيل: «اله» كما قيل في وعاء اعاء، وفي شاح اشاح ثم أدخلت عليه الألف واللام وحذفت الهمزة فقيل «الله» على الشرح الذي مضى، وكأن معناه على هذا المذهب أن يكون الوله من العباد إليه كما كان في المذهب الأول أيضًا مألوهًا كذلك يكون في هذا المذهب أيضًا: الوله والتحير من العباد إليه.
...
لاه ابن عمك لا افضلت في حسبت ... دوني ولا أنت دياني فتخزوني',NULL,'27',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (10,'تخزوني: تسوسني وتقهرني. يريد: لله ابن عمك، فقال المخالفون له: إنما هذا محذوف من الأول، ألا ترى أن تأويل: لاه ابن عمك: لله ابن عمك؟. وقد اختلفوا في اللام المحذوفة من «لاه ابن عمك» فقال قوم: المحذوفة اللام الأصيلة، والباقية لام الخفض لأن الاسم مخفوض بها، وحروف الخفض لا تضمر. وقال الآخرون: الباقية الأصلية لئلا يحذف حرف من أصل الكلمة، فقال الأولون: الحذف غير مستنكر في الكلام فقد قالوا: «لم يك»، «ولا أدر»، «ولم أبل»، يريدون: لم يكن، ولم أبال، ولا أدري. فقال الآخرون: وحرف الجر أيضًا قد أضمر في قول رؤبة حين قال له: كيف أصبحت؟
...
: إن قولنا «الله» إنما هو اسم هكذا موضوع لله عز وجل وليس أصله «إله» ولا «ولاه» ولا «لاه» كما فسرنا قبل.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (11,'قال: والدليل على ذلك إني أرى لقولي «الله» فضل مزية على «إله» وأني اعقل به ما لا اعقل بقوله «إله».
...
وأنشد:
أقبل سيل جاء من أمر الله ... يحرد حرد الجنة المغلة',NULL,'29',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (12,'ومنهم من يقول: «واه لا أفعل ذلك».
...
وقال بعض أهل العلم: إنما فخم اللفظ به فقيل «الله» ولم تظهر اللام على لفظها ليفرق بينه وبين اللات والعزى لأن من العرب من كان يقول: اللات والعزى ثم إذا وقف قال: «اللاه» فوقف بالهاء قياسًا لأنها تاء التأنيث، وكذلك أيضًا كتب «الله» بحذف الألف التي بعد اللام الثانية ليفرق في الخط أيضًا بينهما',NULL,'31',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (14,'واختلف البصريون والكوفيون في قولهم: «اللهم اغفر لنا»، فقال سيبويه وأصحابه: زادوا الميم في آخره مثقلة عوضًا من حرف النداء في أوله فلا يجمع بينهما، لا يقال: «يا اللهم» لأن العوض والمعوض منه لا يجتمعان. قال: وجرى مجرى الأصوات فبني لذلك. ولذلك لا يوصف، فلا يقال: «اللهم العزيز». فأما قوله: {قل اللهم فاطر السموات والأرض} «هو عندهم على نداءين».
...
<span data-type="title" id=toc-4>الرب</span>
الربُّ: المصلح للشيء، يقال: «رببت الشيء أربه ربا وربابة»: إذا أصلحته وقمت عليه، ورب الشيء، مالكه، فالله عز وجل مالك العباد ومصلحهم. ومصلح شؤونهم. ومصدر الرب: الربوبية، وكل من ملك شيئًا فهو ربه، يقال: «هذا رب',NULL,'32',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (15,'الدار ورب الضيعة». ولا يقال: «الرب» معرفًا بالألف واللام مطلقًا إلا لله عز وجل لأنه مالك كل شيء.
...
فإن كنت مني أو تريدين صحبتي ... فكوني له كالسمن ربت به الادم',NULL,'33',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (16,'وسقاء مربوب: إذا أصلح بالرب، والربابة: العبد، والمعاهدون: اربه قال الهذلي:
...
وقال الأصمعي: الربابة: رقعة تجمع فيها القداح، قداح الميسر، وسميت بذلك من قولهم: «فلان يرب أمره ويجمعه» ولذل سميت «الرباب» لاجتماعهم',NULL,'34',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (17,'وتحالفهم وهم: ضبة بن أد، وتيم، وعدي، وعكل، وثور بنو عبد مناة بن أد.
...
قال المبرد: ورب للشيء قليلاً، يقع بعدها الاسم [إلا] منكورًا [لأنه واحد] يدل على أكثر منه، وفيه سبع لغات: يقال: رب، ورب بالتشديد، ورب',NULL,'35',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (18,'بالتخفيف، وربت، وربت، وتزاد فيه «ما» فيقال: ربما، وربما. أنشدنا ابن دريد:
...
وقال المثقب العبدي:
أجدك ما يدريك أن رب بلدة ... إذ الشمس في الأيام طال ركودها',NULL,'36',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (19,'<span data-type="title" id=toc-5>مسألة في رب من النحو:</span>
...
قيل له: خفض بها لإضافتها المعنى الذي ذكرناه إلى المذكور بعدها ولم يجز رفع ما بعدها لأن رفع الاسم إنما يكون بمعنى الحديث عنه، وليس ما بعد رب بمحدث عنه',NULL,'37',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (20,'إنما الحديث عن فاعل الفعل المذكور بعدها: «ورب» وما اتصلت به من تمام الحديث. ولم يجز نصب ما بعدها لمنع الإضافة من النصب، فلم يبق إلا الخفض فخفض بها.
فإن قال قائل: فقد قلت: إن «رب» تدل على الشيء الذي يقع مثله قليلاً، وقد قال الله عز وجل {ربما يود الذين كفروا لو كانوا مسلمين} فهذا لما [لا]
يقع قليلاً.
...
<span data-type="title" id=toc-6>الرحمن الرحيم</span>
صفتان لله عز وجل مشتقتان من الرحمة، فالرحمن فعلان، والرحيم فعيل.
قال أبو عبيدة معمر بن المثنى: قد يبنون الكلمتين من أصل واحد لمعنى واحد',NULL,'38',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (21,'للمبالغة وهما بمنزلة نديم، وندمان. يذهب إلى أن معناهما واحد كما أن معنى النديم والندمان عنده واحد. وأنشد:
...
وروي عن ابن عباس: أنه قال: الرحمن: ذو الرحمة، والرحيم: الراحم.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (22,'وقيل: إنه قال: رحمن الدنيا ورحيم الآخرة، والرحمن اسم خاص، والرحيم اسم عام، فلذلك قدم الرحمن على الرحيم فقيل: بسم الله الرحمن الرحيم، ولذلك أيضًا قيل: رجل رحيم، ولم يقل: رحمن.
...
والقول في هذا عندي - والله أعلم - أن من رحم من الآدميين غيره فتحنن عليه، ورق له فعل به ما يصلح شأنه، وأفضل عليه، وأزال عنه أذى إذا وجد إلى ذلك سبيلاً، والله عز وجل يفعل بمن رحمه من عباده من الفضل، والإنعام، وإصلاح',NULL,'41',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (24,'شأنه مثل ذلك وإن كانت الرحمة منه جل اسمه بغير ضعف ولا رقة تعالى عن ذلك علوًا كبيرًا.
...
وقال آخر:
................. ... وما يشاء الرحمن يعقد ويطلق',NULL,'42',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (25,'وإنما ذهب ثعلب ومن قال بقوله إلى قول جرير:
...
<span data-type="title" id=toc-7>المالك</span>
...
فأما الملك، فتأويله: ذو الملك في يوم الدين، ويوم الدين هو يوم الجزاء والحساب، فوصف نفسه جل وعز بأنه الملك يوم لا ملك سواه، ولا يدعي الملك معه',NULL,'43',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (26,'أحد كما يدعي ذلك في الدنيا. وشاهد ذلك قوله: {لمن الملك اليوم؟ لله الواحد القهار}
...
والملكوت والملك سواء ووزنه «فعلوت» ومثله جبروت من الجبرية وهي العظمة. وفي الملك ثلاث لغات: ملك، ومليك، وملك. قال ابن كثلوم:',NULL,'44',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (27,'وأيام لنا غر طوال ... عصينا الملك فيها أن ندينا
قال آخر:
...
فكان سبيله أن يقال: مألك ثم قلب فقيل: ملاك، ثم استعمل بطرح الهمزة كما استعمل يرى، وترى، ونرى، وأرى بغير همز وأصله الهمز وكما ترك همز النبي والبرية وما أشبه ذلك. والدليل على أن أصله ما ذكرنا قول علقمة:',NULL,'45',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (28,'فلست لانسي ولكن لملأك ... تنزل من جو السماء يصوب
...
<span data-type="title" id=toc-8>المحيط</span>
المحيط في اللغة اسم الفاعل من قولهم: أحاط فلان بالشيء فهو محيط به إذا استولى عليه، وضم جميع أقطاره ونواحيه، حتى لا يمكن التخلص منه، ولا فوته، فالله عز وجل محيط بالأشياء كلها لأنها تحت قدرته، لا يمكن شيئًا منها الخروج عن إرادته فيه، ولا يمتنع عليه منها شيء.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (29,'وقد قال الله تعالى عز وجل {أحاط بكل شيء علمًا} أي علم كل شيء على حقيقته بجميع صفاته فلم يخرج شيء منها عن علمه.
...
خازم:
فحاطونا القصاء وقد رأونا ... قربًا حيث يستمع السرار',NULL,'47',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (30,'يقول:
تباعدوا عنا وهم حولنا، والقصا: الناحية يمد ويقصر ورواه بعضهم
فحاطونا القصا ولقد رأونا ... ..........

<span data-type="title" id=toc-9>القدير</span>
...
فأما القادر فاسم الفاعل من قدر يقدر، فهو قادر، ويتعدى إلى مفعول بحرف خفض كقولك: «قدر زيد على الركوب، وعلى الخروج» وما أشبه ذلك، ولا يتعدى بغير حرف خفض، ولا دليل فيه على مفعول. وكل فعل لا دللي فيه على مفعول لا يتعدى إلا بحرف خفض. ويقال: «قدرت أقدر قدرة، وقدرانا، ومقدرة، وقدرًا» «وقدرت الشيء من التقدير قدرًا»، «وقدر وقدرته تقديرًا»، «واقتدرت عليه اقتدارًا». وقد قرئ {وما قدروا الله حق قدره} و «قدره».',NULL,'48',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (31,'وبعضهم يقول: المسكن مصدر، والمحرك اسم.
...
والصفيف من اللحم: ما رقق وصف على الجمر أو الرضف، والقدير: ما طبخ في قدر. وخفض القدير عطفًا على وضع صفيف لو ترك تنوين منضج كأنه في تقدير: «من بين منضج صفيف شواء أو قدير»، وهو من ضرورة الشعر. ومثله مما حمل على الموضع قول الآخر أنشده سيبويه:',NULL,'49',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (32,'بدالي أني لست مدرك ما مضى ... ولا سابق شيئًا إذا كان جائيًا
...
حمله على موضع «وفضة» لو نون «معلقًا» كأنه قال: «معلقًا وفضة وزناد راع» وبعضهم يقول: نصبه بإضمار فعل كما قال عز وجل {وجعل الليل سكنا والشمس والقمر حسبانا} تقديره: فالشمس والقمر حسبانا.
العليم
قول القائل من العرب: العليم والعالم صفتان مشتقان من العلم. فالعالم اسم الفاعل من علم يعلم فهو عالم، والعليم من أبنية المبالغة في الوصف بالعلم وهو بمنزلة قدير من القادر.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (33,'وقد يتعلق عليم بالمفعول بحرف خفض كما قال عز وجل: {عليم بذات الصدور} فهذا في التأويل بمنزلة قولك: عالم بذات الصدور أي يعلمها، وذات الصدور أسرارها. فعليم وعالم في هذا سواء. وعلى مذهب سيبويه الذي ذكرناه لو قيل: عليم ذات الصدور في الكلام فعدي بغير حرف كان جائزًا، كما يجيز «هذا ضريب زيدًا» كما تقول «ضارب زيدًا».
...
وقد يكون علمت بمعنى «عرفت» فيتعدى إلى مفعول واحد كما قال عز وجل',NULL,'52',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (35,'{وآخرين من دونهم لا تعلمونهم الله يعلمهم} تأويله: لا تعرفونهم الله يعرفهم، وكذلك تقول لصاحبك: «قد علمت خبرك» تريد: قد عرفت خبرك.
...
وقد يقع موقع المصدر كالمعقول، والميسور الواقعين مكان العقل واليسار. ومثل ذلك الخلق قد يكون مصدرًا وقد يكون المخلوق نفسه. وقد استعملت العامة في كلامها جمع علم قياسًا فقالوا: علم وعلوم. وقال أبو عمر الجرمي: لم تجمع العرب',NULL,'53',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (36,'العلم علومًا وهذا كلام مولد.
...
وحكى الجرمي: «رجال ظروف» وهذا شاذ وقد كسر منه شيء في المونث على فعائل قالوا: امرأة صبيحة، ونسوة صبائح، وظريفة وظرائف، وصحيحة وصحائح. وما كان منه مضاعفًا كسر على «فعال» و «أفعلاء». قالوا: شديد، وشداد، وأشداء. قال الله عز وجل: {عليها ملائكة غلاظ شداد لا يعصون}. وقالوا: «شحيح، وأشحاء؛ وشحاح، وأشحة». وقال: أشحة عليكم. وقالوا: لبيب، وألباء فلم يجاوزوا ذلك. وما كان معتلاً كسر على «أفعلاء» ولم يجاوز ذلك كقولك: غني، وأغنياء، وشقي، وأشقياء.',NULL,'54',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (37,'قال سيبويه: وليس يمتنع شيء من هذا إذا كان للآدميين المذكرين من أن يجمع بالواو والنون، ولا من الألف والتاء إذا كان لمؤنث نحو قولك: عليمون، وحليمون، ولبيون. وفي المؤنث حليمات، وعليمات.
...
السلم: الدلو.',NULL,'55',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (38,'وقالوا في المضاعف: سرير، وأسرة، وسرر. وحزيز، وأحزة والكثير حزان بكسر أوله، وهو ما غلظ من الأرض. وحكى سيبويه: حزان بضم الحاء، وقال الجرمي: سألت الأصمعي عنه فلم يعرفه. فهذا قياس جمع عليم وما كان في وزنه اسمًا ونعتًا.
...
فإن كان مؤنثًا جمع على «فواعل» نحو: ضاربة، وضوارب، وقاتلة وقواتل، وقد قيل في المذكر فارس، وفوارس، وهالك في الهوالك. في كسر عالم على أحد هذه الوجوه لقيل: علام، وعلم أو سائر ذلك من الوجوه التي ذكرنا، ولكنه لم يجمع جمع',NULL,'56',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (39,'التكسير فيما أعلمه، فلا نقدم عليه إلا بأن تثبت به رواية صحيحة، ولا يجمع غلا جمع السلامة كما استعملته العرب.
...
وقال الخليل: والعلام: الباشق الذي يصاد به.',NULL,'57',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (40,'والعلم بفتح العين واللام: شق في وسط الشفة العليا، يقال منه: علم الرجل يعلم علمًا فهو أعلم، وامرأة علماء، وينشد بيت عنترة:
...
واختلف العلماء في العالمين فقال بعضهم: هم كل ذي روح يعقل نحو الإنس،',NULL,'58',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (41,'والجن، والملائكة، والشياطين. وقيل أهل كل عصر عالم ذلك العصر، والعالمون جمعه وقيل: هو واقع على جميع المخلوقات.
...
وحكى سيبويه: إن من العرب من يكسر أوائل الفعل المستقبل فيما كان على فعل يفعل طلبًا لكسرة «فعل» إلا الياء فيقول: «أنت تعلم»، «وأنا أعلم»، «ونحن نعلم»، وكذلك يقول: أخال، وتخال، وما أشبه ذلك. وينشد:',NULL,'59',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (42,'عمدًا فعلت ذاك بيد أني ... أخال إن هلكت لم تزني
وكذلك ينشد أيضًا:
...
<span data-type="title" id=toc-11>الحكيم</span>
...
وقال بعض أهل اللغة: إنما سمي القرآن حكمة لامتناعه عن المعارضة كأنه ممتنع من أن يؤتي بمثله أو يعارض. كما قال عز وجل: {قل لئن اجتمعت الإنس',NULL,'60',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (43,'والجن على أن يأتوا بمثل هذا القرآن لا يأتون بمثله ولو كان بعضهم لبعض ظهيرا}.
...
وكذلك سائر ما يتشعب من هذا إنما أصله هذا ثم يتسع ويستعمل في مقاربه ومجانسه، وكذلك أكثر كلام العرب إنما له أصل منه تشعبه ثم يستعمل في أشياء كثيرة مقاربة له ومجانسة، ولذلك قال أبو العباس المبرد: «كلام العرب إذا تقاربت ألفاظه',NULL,'61',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (44,'فبعضه آخذ برقاب بعض».
...
<span data-type="title" id=toc-12>التواب</span>
التواب فعال من تاب يتوب أي يقبل توبة عباده كما قال عز وجل: {وهو الذي',NULL,'62',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (45,'يقبل التوبة عن عباده}، وقال: {غافر الذنب وقابل التوب}. فالله تعالى يقبل توبة عباده.
...
وقد قال الله عز وجل: {لقد تاب الله على النبي والمهاجرين والأنصار}. وقال في موضع آخر {وهو الذي يقبل التوبة عن عباده} فقد جاء الفعل منه على فعل يفعل',NULL,'63',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (46,'وما نطق منه بفعل يفعل فاسم الفاعل منه قياسًا فاعل، كقولك: ضرب زيد يضرب فهو ضارب، وذهب يذهب فهو ذاهب، فكذلك يقال قياسًا تاب زيد يتوب فهو تائب.
...
وكذلك قيل في قوله عز وجل {إنه أواب} أي رجاع تواب فكأن توابًا فعال من آب يؤوب فأبدلت من الهمزة تاء لما أريد به فضل معنى على الرجوع إذا لم يرد به رجوع فقط وأريد به الرجوع إلى أمر الله أو الرجوع عن الذنوب والمعاصي. ليفرق بين المعنيين بإبدال الهمزة تاء، وهو مذهب حسن في التأويل، إلا إن إبدال التاء من',NULL,'64',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (47,'الهمزة لا يكاد يوجد في كلامهم، فجائز أن [يكون]
...
<span data-type="title" id=toc-13>البصير</span>
...
قال ابن الإعرابي: البصيرة هاهنا ثقل الدم على أكتافهم حين أخذوا الدية ولم يأخذها هو.',NULL,'67',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (50,'والبصيرة أيضًا: بصيرة الرجل في دينه واستبصاره. يقال من ذلك: بصرت بالشيء أي: علمت به فأنا به بصير، وذو بصيرة كما تقول: ظرف فلان فهو ظريف، وشرف فهو شريف.
...
أزمان ليلى عام ليلى وحمى',NULL,'68',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (51,'أي شهوتي.
...
وذهب بعضهم إلى أن الضرير إنما أريد به مقابلة البصري في الوزن وإنما أريد به أنه قد أصيب في بصره بضر وسوء فقيل له ضرير بتأويل مضرور، والضرير: جانب الوادي.',NULL,'69',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (52,'قال الشاعر:
...
قال: ويقال لها بصرة بالهاء وفتح الباء، وأنشد في فتح الباء وزيادة الهاء:',NULL,'70',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (53,'تداعين باسم الشيب في متثلم ... جوابنه من بصرة وسلام
...
قال غيره لما نسب إليها وجب حذف الهاء، فإذا حذفت الهاء وجب كسر الباء والرجوع إلى اللغة الأخرى.',NULL,'71',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (54,'<span data-type="title" id=toc-14>الواسع</span>
...
يقال: أوسع الرجل إذا كان ذا سعة في المال، وفرس وساع ندب: سريع واسع الشحوة. فالله عز وجل غني عن خلقه وهم فقراء إليه. فقيل له: يا واسع بذلك المعنى.',NULL,'72',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (55,'فإن قال قائل: فإذا كان معنى الواسع عندك والغني سواء فما الوجه في تكرارهما؟
...
<span data-type="title" id=toc-15>البديع</span>
...
فالله عز وجل مبدع الأشياء ومبتدعها وخالقها ابتداء من غير شيء ولا على مثال عز وجل.',NULL,'73',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (56,'ويقال من غير هذا: أبدع بالرجل إذا كلت راحلته وعطبت وبقي منقطعًا به.
وحدثنا أبو عبد الله الحسين بن محمد الرازي عن علي بن عبد العزيز عن أبي عبيد القاسم بن سلام قال: حدثنا أبو اليقظان عمار بن محمد بن الأعمش عن أبي عمرو الشيباني عن ابن مسعود عن النبي صلى الله عليه وسلم أن رجلاً أتاه فقال: يا رسول الله، إني أبدع بي فاحملني.',NULL,'74',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (57,'قال أبو عبيدة معمر بن المثنى: يقال للرجل إذا كلت راحلته أو عطبت وبقي منقطعًا به قد أبدع به، وقال الكسائي مثل ذلك وزاد فيه. ويقال: أبدعت الركاب إذا كلت أو عطبت.

<span data-type="title" id=toc-16>السميع</span>
...
أي لا يجيب دعائي. ويقال: سمعت الشيء أسمعه سمعًا وسماعًا، والسمع مصدر سمعت، والسمع أيضًا سمع الإنسان وهي الجارحة المسموع بها سميت بالمصدر كما ذكرت لك في البصير.',NULL,'76',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (59,'وقال العلماء: في قول الله عز وجل: {ختم الله على قلوبهم وعلى سمعهم وعلى أبصارهم غشاوة}: في توجيه السمع ثلاثة أقوال: «أحدها أن السمع في الأصل مصدر سميت به الجارحة فوحد كما يوحد المصدر كقولك: حديثكم يعجبني، وعلم إخوتك ينفعني وما أشبه ذلك».
...
وقال آخر في مثله:
لا تنكر القتل وقد سبينا ... في حلقكم عظم وقد شجينا',NULL,'77',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (60,'يريد في حلقوكم. ومثله قول الآخر:
...
والمصادر ينوب بعضها عن بعض كما يقال: العطية بمعنى الإعطاء والكرامة بمعنى',NULL,'78',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (61,'الإكرام، والموعظة بمعنى الوعظ، كذلك يكون المسع بمعنى التسمع والاستماع.
...
واستسمعت استسماعًا، واستسمعت: تطلبت الاستماع. وقد يكون التسمع بمعنى الاستماع. وأسمعت غيري الخبر وغيره إسماعًا، وقد يكون أسمعته في مجاز الاستعمال يجري مجرى السب والشتيمة كما استعمل السماع في الغناء، وإنما هو في الأصل مصدر. قال لبيد في التسمع بمعنى الاستماع يصف بقرة وحشية:',NULL,'79',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (62,'وتسمعت دار الأنيس فراعها ... عن ظهر غيب والأنيس سقامها
...
فإذا كانت الأذن لطيفة يقال لها: صمعاء وحشر، فإذا كانت عظيمة قيل لها: شرافية، ويقال لداخل الأذن الصماليخ ولوسخها الأنف، ولوسخ الظفر المجتمع بينه وبين لحم الأصبع التف، ويقال فلان أصم أصلخ إذا كان لا يسمع',NULL,'80',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (63,'شيئًا، ورجل أقطع إذا كان أصم، فإذا كانت الأذن عظيمة فهي الحذنة وأنشد أبو عبيدة:
...
العناج: الحبل الأول، والكرب: الحبل الثاني، ويقال للصخرة التي يقوم عليها',NULL,'81',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (64,'الساقي: القبيلة والمنزعة، فإذا كانت تزلق قيل لها مدحض، وزرنح، ويقال للصخرة التي تكون في أسفل البئر: الراعوفة، ويقال للصخرة التي في الشطوط يغمرها الماء الاتان ويقال أيضًا: الحنضل، ويقال لطي البئر: الزبر والضرس لها ويقال للخزف الذي يجعل في طيها ليقوي الأعقاب الأجر، ويقال لرأس البئر إذا كان ضيقًا: السك، فإذا كان واسعًا فهو جلواخ وإذا كانت البئر فوق رابية قيل لها جمجمة، فإذا كانت مندفنة فهي سدم.

<span data-type="title" id=toc-17>الكافي</span>
...
وكفاية الإنسان من المعاش قدر بلغته وقوام أمره، وتقول: كفيت الرجل الأمر',NULL,'82',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (65,'أكفيه كفيًا وكفاية إذا قمت به دونه، وأزلت عنه الاهتمام به.
...
ومن العرب من يعرب هذا الجنس من الأسماء في كل حال ولا يستثقل الكسرة فيه فيقول: هذا القاضي والداعي والرامي يجريه مجرى الصحيح، ويقول مررت',NULL,'83',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (66,'بالقاضي والداعي والرامي كما يقول مررت بالضارب والقاعد وما أشبه ذلك، ومن هذه اللغة أنشد سيبويه:
قد عجبت مني ومن يعيليا ... لما رأتني خلقًا مقلوليًا
أراد تصغير يعلي وكان سبيله أن يقول: يعيل فأجراه مجرى الصحيح.
وقال الفرزدق:
فلو كان عبد الله مولى هجوته ... ولكن عبد الله مولى مواليا
وقال آخر:
خريجع دوادي في ملعب ... تأزر طورًا وتلقى الازارا',NULL,'84',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (67,'ومن العرب من يترك إعراب المنصوب أيضًا فيجعله ساكن الآخر، كما فعل ذلك بالمخفوض والمرفوع فيجعله في الأحوال الثلاثة ساكن الآخر فيقول: رأيت القاضي والغازي والكافي والداعي وما أشبه ذلك.
...
ومن كان هذا من لغته فإنه يجعله في حال النصب إذا لم تكن فيه الألف واللام وكان غير مضاف بلفظ المخفوض أيضًا فتقول: رأيت قاض وكسوت عار ولقيت غاز',NULL,'85',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (68,'لأنه ينوي إسكان آخره إذ ليس من شأنه إعرابه، ثم يلحقه التنوين فتسقط الياء لالتقاء الساكنين. وهما الياء والتنوين. ويبقى ما قبلها على كسرته وهو قبيح من كلام الشعر في حال الضرورة. وأنشدوا في ذلك:
...
<span data-type="title" id=toc-18>الرؤوف</span>
الرؤوف: الراحم، والرأفة: الرحمة. يقال: رؤفت به أرؤف رأفة. وفلان رؤف ورؤوف. وهو متعلق بالمفعول كتعلق رحيم، وقد مضى القول في ذلك وفي تعدي فعول وفعيل وما في ذلك من الاختلاف بين النحويين. وما كان على فعول كان بغير هاء، لمذكر كان أو مؤنث، كقولك: رجل شكور، وامرأة شكور، ورجل',NULL,'86',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (69,'قتول، وامرأة قتول، وكذلك صبور وغدور وجهول وما أشبه ذلك، وقال الخطيئة:
ألا آل ليلى آذنوا بقفول ... وما آذنوا ذا حاجة برحيل
تنادوا فحثوا للترحل غيرهم ... فبانوا بجماء العظام قتول

<span data-type="title" id=toc-19>الشاكر</span>
...
ومعنى شكر العباد لله عز وجل هو كما ذكرنا من الآدميين اعترافهم بطوله عز وجل، وإنعامه ومقابلة ذلك بالإقرار والخضوع والطاعة له، ولذلك قال عز وجل: {لئن شكرتم لأزيدنكم ولئن كفرتم إن عذابي لشديد}. فأخذ المتمثلون والخطباء',NULL,'87',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (70,'هذا المعنى من القرآن فقالوا: «من شكر فقد استحق الزيادة».
...
فإن تولني منك الجميل فأهله ... وإلا فإني عاذر وشكور',NULL,'88',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (71,'ومن رأى الشكر يفوق الإنعام الآخر حيث يقول عبد الصمد بن المعذل:
...
وإنما هو لائث.',NULL,'92',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (75,'قال: وجائز أن يكون لما كان بعد العقد متقدمًا لما بعده إلى العقد الثاني صار كالحادي عشر والحادية عشرة لأن الحادي أبدًا متقدم ما يحدوه ويسوقه فقيل: الحادي عشر.
...
<span data-type="title" id=toc-22>الغفور</span>
الغفور: الستور يقال: غفرت الشيء أغفره غفرًا إذا سترته فأنا غافر وهو مغفور أي مستور، ومنه سمي جنة الرأس المغفر لأنه يستر الرأس. فالله عز وجل',NULL,'93',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (76,'غفور لذنوب عباده أي يسترها ويتجاوز عنها لأنه إذا سترها فقد صفح عنها وعفا وتجاوز وكذلك الله غفور لعباده والمعنى غفور لذنوب عباده.
...
خليلي إن الدار غفر لذي الهوى ... كما يغفر المحموم أو صاحب الكلم',NULL,'94',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (77,'ومعناه: أن المحب إذا كان قد سلا فرأى ديار حبيبه وآثاره جدد ذلك عليه حبه فكأنه مريض قد نكس. ومنه قول مرار بني أسد:
...
ويقال: «جاء القوم الجماء الغفير» و «جاءوا جماءً غفيرًا» و «جاءوا جماء غفيرًا» و «جاءوا جماء الغفير» أي: «جاءوا جميعًا يغطي الأرض جمعهم».',NULL,'95',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (78,'والغفر: ولد الأروية وهي أنثى الوعل، وإذا كان معها ولدها فهي مغفر، كما يقال لكل ذات طفل مطفل.
...
<span data-type="title" id=toc-23>الحليم</span>
...
حلمت بكم في نومتي فغضبتم ... ولا ذنب لي إن كنت في النوم أحلم',NULL,'96',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (79,'وحليم الأديم بكسر اللام على وزن فعل يحلم بفتحها في المستقبل بوزن جهل يجهل وعلم يعلم وذلك إذا تثقب وفسد. والمصدر الحلم بفتح اللام.

<span data-type="title" id=toc-24>القابض</span>
...
والقبض: السرعة، ويقال أيضًا: «رجل قبيض وقباضة» إذا كان سريعًا شديد السوق للإبل. وأنشد لرؤبة:',NULL,'97',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (80,'قباضة بين العنيف واللبق ... مقتدر الضيعة وهواه الشفق
...
والقبض أيضًا: قبض المتاع، والقبض أيضًا: قبض المال وأصله من القبضة وهو ما حواه الكف. ومنه قوله عز وجل حكاية عن السامري: {فقبضت قبضة من أثر الرسول} هذا أصله، ثم يستعمل فيما حواه الرجل وحازه، فيقال: «قبضت',NULL,'98',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (81,'من فلان المال» وإن لم يكن بيده. ومنه قيل قد قبضت الضيعة من فلان والثياب والعبيد وما أشبه ذلك.
...
<span data-type="title" id=toc-25>الباسط</span>
...
والبسط: مصدر بسطت الشيء أبسطه بسطًا فأنا باسط وهو مبسوط وبسيط.',NULL,'99',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (82,'والبساط: اسم الشيء المبسوط بكسر الواو، والباسط أيضًا بكسر الأول جمع بسيط ومنه قوله عز وجل: {وجعلنا الأرض بساطا} أي فراشًا ومهادًا ولم يجعلها حزنة لا يمكنهم التصرف فيها، فقولهم: بسيط وبساط كقولهم كريم وكرام، وظريف وظراف، يقال: رجل بسيط الوجه إذا لم يكن كزا عبوسًا. وقال الأعشى يذم رجلاً بقيض الوجه والعبوس:
...
وقالوا: «طردته فذهب» ولم يقولوا: «فانطرد»، ولا يستعمل في كل شيء إلا فيما',NULL,'100',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (83,'سمع، ولا يجوز أن يقال على هذا: «رميته فانرمى» ولا «ضربته فانضرب» ولكن فيما سمع.

<span data-type="title" id=toc-26>يا لا إله إلا هو</span>
...
ونظير الأول قول الشاعر أنشده سيبويه:',NULL,'101',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (84,'يا لعنة الله والأقوام كلهم ... والص<span data-type="title" id=toc-27>الحي</span>ن على سمعان من جار
...
وقد نرى إذ الحياة حي ... وإذ زمان الناس دغفلي',NULL,'102',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (85,'قال بعضهم: حي جمع الجمع، يقال: حياة وحيوات وحي جمع الجمع. وقال الفراء: أصله فعل مثل بدنة وبدن فكان حي جمعًا للحياة ثم كسر حين أدغمت الياء.
...
وإذا قلت: «قد حيي في هذا المكان» بالإظهار ثم أردت الإدغام فإن شئت قلت: «قد حيي في هذا المكان» بضم أوله على الأصل وإن شئت قلت: «قد حي في هذا المكان» فكسرت أوله. قال أبو عثمان: «والكسر أكثر لأنه أخف».',NULL,'103',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (86,'قال: «ومن كلام العرب قرن ألوى وقرون لي ولي والكسر أكثر وأخف». قال: وإن نسبت إلى الحياة قلت: «حيوي» بقلب الألف واوًا لمجيء ياء النسب كما تقول في رحى وفتى «فتوي» و «رحوي» وذلك حكم كل مقصور على ثلاثة أحرف من أي قبيل كان.
...
قال المازني: وليس القول عندي في «حيوان» كما قال الخليل ولكن هذا',NULL,'104',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (87,'كقولهم فاظ البت يفيظ فيظًا وفوظًا ولا يشتقون من فوظ فعلاً وكذلك ويل، وويح، وويس مصادر ليس لهن فعل كراهية أن يكثر في كلامهم ما يستثقلون ولاستغنائهم بالشيء عن الشيء حتى يكون المستغني عنه مسقطًا كأن المازني ذهب إلى أن الحيوان الواو فيه أصل ليست منقلبة من ياء، وأن الياء فيه أيضًا أصل من باب اللغتين. ثم يجوز أن يكون استعمل الفعل من اللغة التي تكون فيها العين واللام ياءين ولم يستعمل من اللغة التي تكون لامه واوًا لثقل ذلك عليهم، ويجوز أن يكون استعمل من اللغة التي تكون اللام فيه واوًا فقلبت ياء للكسرة التي قبلها حين قالوا: «حييت» فجاءوا به على فعل يفعل مثل علم يعلم.

<span data-type="title" id=toc-28>القيوم</span>
...
وقام ميزان النهار فاعتدل',NULL,'105',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (88,'ويقال «قمت بالشيء» إذا وليته، ويقال: «قد قام هذا الأمر بعد ميل» إذا استوى وصلح، «وقام المريض من علته»: إذا صلح وبرأ، «وقام البناء والحائط» إذا كمل بنيانه وتناهى، «وقام فلان بالأمر» إذا جد عزمه فيه ولم يفتر.
...
ويكون أيضًا إقامة الصلاة إتمامها وترك القصر فيها، كما قال بعد ذكر القصر في',NULL,'106',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (89,'الصلاة: {فإذا اطمأننتم - يعني من السفر والخوف - فأقيموا الصلاة - أي أتموها - إن الصلاة كانت على المؤمنين كتابا موقوتا} أي فرضًا مؤقتًا، يقال: وقت الله عليه الشيء، ووقته أي جعله عليه في أوقات.
...
<span data-type="title" id=toc-29>العلي</span>
...
أو منعتم ما تسألون فمن حد ... ثتموه له علينا العلاء',NULL,'108',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (91,'يقول: أو منعتم ما تسألون من النصفة فيما بيننا وبينكم فيمن حدثتموه له علينا العلاء في سافل الدهر يعني الرفعة والاعتلاء.
...
وكذلك قيل في قوله عز وجل: {إن فرعون علا في الأرض} قالوا: معناه: قهر أ÷لها وغلبهم واستولى عليهم، وكذلك قوله عز وجل: {ما اتخذ الله من ولد وما كان معه من إله إذًا لذهب كل إله بما خلق ولعلا بعضهم على بعض} أي',NULL,'109',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (92,'لغلب بعضهم بعضا وقهره، فالله عز وجل العلي العالي ذو العلاء والجلال والرفعة والسناء، الغالب القاهر للأشياء كلتها، والله عز وجل العلي العالي جل وتقدست أسماؤه.
...
والمعلى من قداح الميسر التي كانت تستعمل في الجاهلية السابع، وكان أفضلها عندهم وأكثرها حطًا لأن له سبعة أنصاب، وليس لغيره منها إلا أقل من سبعة لأن ذوات الحظوظ منها سبعة وهي: ألفذ، والتوأم، والرقيب والحلس، والنافس،',NULL,'110',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (93,'والمسبل، والمعلى. فللفذ نصيب، وللتوأم نصيبان، وللرقيب ثلاثة، كذلك نصيب كل واحد منها على موقعه من العدد حتى يبلغ إلى المعلى فيصير حظه سبعة أسهم لأنه السابع. ويقال: استعلى الفرس على الغاية في الرهان: إذا استولى عليها.
...
<span data-type="title" id=toc-30>العظيم</span>
...
وقالوا في قوله عز وجل: {لولا نزل هذا القرآن على رجل من القريتين',NULL,'111',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (94,'عظيم} تأويله: هلا أنزل هذا القرآن على رجل من رجلين عظيمين من القريتين؟ أي كان سبيله أن ينزل على عظيم رئيس، ولم يريدوا به عظم الخلقة.
...
قال أبو بكر بن شقير: قال أبو جعفر أحمد بن عبيد. قوله: «ومن يستبح كنزًا من المجد يعظم: أي من يجد كنزًا مباحًا فيأخذه لنفسه». يعظم: أي يصير',NULL,'112',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (95,'عظيمًا في الناس جليلاً، ورواه بعضهم، يعظم: أي يأتي بأمر عظيم، كما يقال: «أكبرت يا فلان» أي أتيت بأمر كبير. ورواه بعضهم «يعظم» على ما لم يسم فاعله أي: يعظمه الناس. وكذلك قالوا في قوله أيضًا:
...
<span data-type="title" id=toc-31>الولي</span>
...
فالله عز وجل ولي المؤمنين أي ناصرهم ومصلح شؤونهم والمثنى عليهم، كما قال الله عز وجل: {الله ولي الذين آمنوا يخرجهم من الظلمات إلى النور، والذين كفروا أولياؤهم الطاغوت يخرجونهم من النور إلى الظلمات} وقال: {إن ولي الله الذي نزل الكتاب وهو يتولى الصالحين} إلى غير ذلك من الآيات المذكورة في التنزيل على',NULL,'113',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (96,'ما ذكرنا من معاني الولي وما يقارب ذلك.
...
وتقول: «فلان ولي فلان» أي صاحب نعمته التي قد أسداها إليه وأنعم بها عليه كقول القائل لمن هو فوقه في الحال والمنزلة وكثرة المال، وقد أحسن إليه: «أنا وليك» أي أنا ولي نعمتك التي اصطنعتها إلي. وربما قال له ذلك طمعًا في نيل حظ منه مجازًا وإن لم يكن أحسن إليه قط أي اجعلني في جملة أوليائك الذين أحسنت إليهم لأستحق هذه الصفة.',NULL,'114',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (97,'وتقول: «فلان ولي فلان» أي مواليه ومتابعه على أموره، فأمرهما وشأنهما واحد كما قال عز وجل: {والذين آووا ونصروا أولئك بعضهم أولياء بعض}. وقال: {والذين كفروا بعضهم أولياء بعض} أي بعضهم موال بعضًا. فأمرهم وشأنهم واحد ويقال: فلان ولي فلان أي قريبه ونسيبه كأنه لا حاجز بين نسبيهما.
...
يقال: «ولي بين الولاء» بفتح الواو، ووال بين الولاية بكسر الواو، ومولى بين المولوية، حكاه أبو عمرو الشيباني. وغيره «وفي فلان مولويه». والولي في غير هذا. مطر الربيع الثاني، يقال للأول «السومي» لأنه يسم الأرض بالنبات، والثاني «الولي» لأنه يلي الأول، كأنه من الموالاة والمتابعة، فهذه عشرة أوجه في الولي كلها ترجع إلى ما ذكرته لك أولاً فتدبرها لأن كلام العرب - كما قال أبو العباس المبرد - إذا اتفقت ألفاظه فبعضه آخذ برقاب بعض.',NULL,'115',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (98,'وتقول «ولي فلان مدينة كذا» من الولاية يليها ولاية، «وولاه فلان إياها تولية»، «ووليت الأمر والبلاد» كذلك إليه ولاية. وإذا أمرت قلت «له» يا هذا فزدت في آخره هاء للوقوف وليست من أصل الكلمة لكثرة ما لحقه من الإجحاف والحذف، وذلك أنه قد ذهبت فاؤه ولامه. وأصله من ولي، ففاؤه واو ولامه ياء فوجب سقوط الواو في المستقبل كما تسقط من «وعد يعد» و «وزن يزن». والأمر لا يكون إلا مستقبلاً، ووجب سقوط لامه للأمر كما تسقط من قولك في الأمر: «اقض» و «ارم» و «امض» فبقيت عين الفعل وهي اللام من ولي فقلت: «ل» «يا هذا»، فلما بقي على حرف واحد كثر بها الوقف، فإن اتصلت بها فاء أو الواو ونابت عن الهاء في التكثير فقلت: «فل عملك» أو «ول عملك». وكذلك تقول: «شه ثوبك» من الوشي، وإن دخلت الفاء والواو جري مجرى «فل عملك».
...
وتقول للجماعة: «يا هندات لين عملكن» بياء ثابتة وليست بياء التأنيث هذه',NULL,'116',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (99,'لام الفعل ولا تثبت ياء التأنيث مع النون التي هي إضمار جميع المؤنث، فقسه على قولك: «يا هذه اضربي» و «يا هاتان اضربا» و «يا هؤلاء اضربن».
...
<span data-type="title" id=toc-32>الغني</span>
...
هذا أصل الغني في كلام العرب، وهو أن لا تكون بالإنسان حاجة إلى غيره وإنما سمي ذو اليسار والمال غنيًا لاستغنائه بالمال الذي عنده عن غيره وحاجة الناس',NULL,'117',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (100,'إلى ما عنده، وهذا مجاز. وليس في العالم أحد غنيًا في الحقيقة لأن بكل من فيه حاجة إلى غيره - كان ذا يسار أو معدمًا كبيرًا كان أو صغيرًا - لا بد له من الحاجة إلى غيره في معونة أو تصرف أو غير ذلك من أمور الدنيا التي بعضها منوط ببعض.
...
سخى بنفسي أني لا أرى أحدًا ... يموت هزلاً ولا يبقى على حال',NULL,'118',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (101,'فقد كشف لك عن معنى الغنى، وأوضحه ألا ترى أنه قال: «أني عنه في سعة وفي غنى غير أني لست ذا مال» فقد عرفك أنه غني وهو غير ذي مال. فليس الغني بالمال فقط وكم من ذي مال مكثر لا يتصرف فيه ولا يستغني به ويتصدى لمعروف من هو دونه في اليسار، ويتضرع إليه فيصير هو الفقير وإن كان ذا مال، والمسؤول غنيًا وإن كان دونه في اليسار.
...
فمد الغني كما ترى، وكان الزجاج ينشده «ولا غناء» بفتح أوله ويخرجه إلى معنى النفع، وقال: «النفع غير خارج عن معنى الغنى» وليس هذا بشيء لأن بين الغنى في اليسار والنفع بونًا بعيدًا.',NULL,'119',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (102,'ويجيز البصريون قصر الممدود للشاعر ولا يجيزون له مد المقصور، وفي هذا كلام طويل، وقد أملينا هذه المسألة بحججها وعللها في كتاب «المسائل الصغير» فكرهنا تطويل الكتاب بذكرها.
...
ويقال: «إنه لذو ثراء وثروة» يراد أنه لذو عدد وكثرة.',NULL,'120',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (103,'ويقال: «إنه لذو وفر وذو دثر، وقد استوثن من المال واستوثج»، و «إنه لمترب»: له مال مثل التراب كثرة، وإن له لمالا جما أي كثيرًا، و «رجل مال وميل»، كثير المال. و «قد أمر ماله يأمر أمرًا»: إذا كثر، و «قد ضفا ماله يضفوا ضفوًا وضفوًا» كذلك.
...
والحلق، المال الكثير، وكذلك الدبر، و «قد أحرف فلان»: كثر ماله ويقال: «جاء فلان بالطم والرم»: إذا جاء بالكثر، والطم: الرطب، والرم: اليابس. والفنع: كثرة المال، و «وقع فلان في الاهيغين»: أي في الطعام والشراب،',NULL,'121',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (104,'و «فلان عريض البطان»: إذا أثرى وكثر ماله، و «رخي اللبب» كذلك يصنع ما شاء، ويقال: «جاء بالضح والريح» في موضع الكثرة أي بما طلعت عليه الشمس وجرت عليه الريح. «وفلان مليء زكاة»: أي حاضر النقد.
...
والضفف: قلة ذات اليد وكثرة العيال وكذلك الوبد: الضيق وكثرة العيال، «والحور بعد الكور»: القلة بعد الكثرة، قال الأصمعي: مثله: «العنوق بعد النوق»، «والمجرف»: الذي قد ذهب ماله، والمجلف: الذي ذهب أكثر ماله، وهذا باب يكثر جدًا، وفي هذا المقدار منه كفاية في هذا الموضوع، ونعود لتمام القول في معنى الغنى.',NULL,'124',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (107,'ويقال: غنيت عن كذا وكذا غنى، وأنا عنه غان، ومنه قول طرفة:
...
<span data-type="title" id=toc-33>الحميد</span>
الحميد: المحمود ذو الحمد المستحق لذلك، وقد ذكرنا الفرق بين الحمد والشكر في ذكرنا معنى الشاكر فيما مضى من الكتاب.',NULL,'125',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (108,'<span data-type="title" id=toc-34>القائم</span>
القائم: «هو القائم على كف نفس بما كسبت» والقائم بأمور عباده وقد شرحناه مستقصي في ذكر اشتقاق القيوم.

<span data-type="title" id=toc-35>الوهاب</span>
...
ويقال: وهبت أهب هبة، وأصله أوهب وهبة. وكذلك وهب زيد لفلان هبة يهب، والأصل يوهب فوقعت الواو بين ياء وكسرة فحذفت لذلك، ثم ذهب بيفعل إلى يفعل لمكان حرف الحلق وهو الهاء ففتح المستقبل لذلك، فقيل: «يهب» كما ترى وحمل سائر المضارع عليه لئلا يختلف الباب، وقيل في المصدر: «هبة» وكان أصله «وهبة» فكرهوا الكسرة في الواو لاعتلال الفعل منه فحذفوها، وألقوا حركتها على',NULL,'126',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (109,'الحرف الذي بعده لأنهم لو تركوها بعد سلب حركتها فلا يمكن النطق بها إلا باجتلاب ألف الوصل لها فكانت تجيء ألف الوصل مكسورة وبعدها الواو ساكنة كان يلزم قلبها ياء، فكان يصير «إيهبة فكانوا يصيرون إلى أثقل مما هربوا منه فرفضوا ذلك، وحذفوا الواو وألقوا حركتها على ما بعدها فكان ذلك أخف عليهم».

<span data-type="title" id=toc-36>السريع</span>
...
<span data-type="title" id=toc-37>الخبير</span>
الخبير: العالم بالشيء، يقال: «خبرت الشيء واختبرته» إذا علمته، والخبر:',NULL,'127',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (110,'مخبرة الإنسان إذا أخبر أي جرد فبدت أخلاقه.
...
<span data-type="title" id=toc-38>الرقيب</span>
...
في الحديث: «ليس الرقوب الذي لا ولد له إنما الرقوب الذي لا فرط له». والرقبي والعمري يقال منهما: أعمرته دارًا وأرقبته دارًا فالعمري: أن يسكن الرجل آخر',NULL,'128',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (111,'في منزله عمره، ثم يسترجعه صاحبه عند موت الساكن، والرقبى: أن يسكنه فيه فإذا مات المسكن ارتجعه ورثته.

<span data-type="title" id=toc-39>الحسيب</span>
...
وجائز أن يكون «من» في وضع رفع عطفًا على الله عز وجل، والتقدير {حسبك الله ومن اتبعك من المؤمنين} أي يكفيك الله والمؤمنون الذين اتبعوك. وفيه وجه ثالث على مذهب من أجاز من الكوفيين «مررت به وزيد» و «دخلت إليك وعمرو» فأجاز',NULL,'129',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (112,'العطف على المضمر المخفوض بغير إعادة الخافض، وعلى مذهب حمزة في قراءته {واتقوا الله الذي تساءلون به والأرحام} بالخفض أن تكون «من» في موضع خفض عطفًا على الكاف في قوله «حسبك». ومثله قول الشاعر:
...
وتقول: «أحسبت الرجل» أي أعطيته ما يكفيه، ومنه قوله عز وجل: {عطاء',NULL,'130',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (113,'حسابا} أي كثيرًا كافيًا. ويقال أيضًا: «أحسبت فلانًا» أي أكثرت له. قال الشاعر:
...
وتقول: «ما كان ذلك في حسباني» -بكسر الحاء- أي في ظني. وقد أجاز بعض أهل اللغة أن يقال: «ما كان ذلك في حسابي» أي فيما أحسبه من أموري، وأعده.',NULL,'131',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (114,'والحسبان أيضًا - بضم الحاء - العذاب من قوله عز وجل: {يرسل عليها حسبانا من السماء}. قال الضحاك: الحسبان: العذاب، وقال أهل اللغة: الحسبان: المرامي التي يرمى بها، الواحدة حسبانة، والحسبانة أيضًا: المخدة.

<span data-type="title" id=toc-40>الشهيد</span>
...
اللغة العفو عن الذنب، إذهابه وإبطاله كما يقال: عفت الريح المنزل: أي محت معالمه ودرست آثاره. فالعافي عن الذنب كأنه مبطل له، مذهب، فإذا عفا عن الذنب فقد أبطله وذهب به فيكون اشتقاقه من هذا.',NULL,'134',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (117,'والعفاء بالمد: التراب، تقول العرب في السب: «بفيه العفاء». والعفاء أيضًا بالمد: الدروس كما ذكرنا، قال زهير يصف دارًا.
...
والعفا بالمد: ما كثر من الوبر والريش، ويقال: عفا القوم إذا كثروا، وعفوا إذا قلوا، وهو من الأضداد.',NULL,'135',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (118,'<span data-type="title" id=toc-42>المقيت</span>
...
<span data-type="title" id=toc-43>الوكيل</span>
...
والوكيل: الكفيل أيضًا كذلك قالوا في قوله تعالى عز وجل في سورة يوسف:',NULL,'136',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (119,'{والله على ما نقول وكيل} أي كفيل. ويقال رجل وكلة تكلة إذا كان يكل أمره إلى غيره.

<span data-type="title" id=toc-44>الباطن والظاهر</span>
...
<span data-type="title" id=toc-45>القدير</span>
القدير: القادر، وهو من أبنية المبالغة في الوصف، وقد مضى شرحه في أول الكتاب في ذكر القادر.',NULL,'137',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (120,'<span data-type="title" id=toc-46>اللطيف</span>
...
وربما حذفت الهاء منه إذا كان مضافًا يكون المضاف إليه كالعوض منها كما قال عز وجل: {وإقام الصلاة وإيتاء الزكاة} فحذف الهاء منه كما ترى لما كان مضافًا.',NULL,'138',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (121,'وقد مضى القول في الحياة وتصريف فعلها في ذكر الحي فيما مضى من الكتاب.
...
واختلف العلماء في الفرق بين «ميت» و «ميت» بالتشديد والتخفيف، فقال بعضهم: «ميت» بالتشديد لما سيموت و «ميت» بالتخفيف لما قد مات وتعلقوا بقول عر',NULL,'139',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (122,'فرفعت الأسماء بها استعارة كما جاز استعمالها استعارة لمن ليست هي له.
...
وقال آخر:
........... ... إلى ملك أظلافه لم تشقق',NULL,'140',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (123,'وقال أبو دؤاد الأيادي:
...
أحدهما أن يكون المعنى «يا ألله نعم المولى أنت» و «يا الله نعم النصير أنت» لأنه',NULL,'141',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (124,'وجل للنبي صلى الله عليه وسلم: {إنك ميت وإنهم ميتون} أي إنك ستموت وإنهم سيموتون. وذهب الأكثر إلى أن الميت والميت سواء لما قد مات وما سيموت وإنما هو تخفيف، وأنشدوا لابن الرعلاء الغساني:
...
وقال آخرون «مات زيد» و «تحركت النخلة» و «سقط الحائط» وما أشبه ذلك أفعال مستعارة مضافة لفظًا إلى غير فاعلها في الحقيقة، وقد علم المقصد والمراد بها',NULL,'143',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (126,'قد علم أن الداعي لله في حال دعائه وندائه مخاطب له مناد فجاز الإضمار لذلك.
...
وأما دخول حروف الخفض عليهما فلذلك على الحكاية. وأما دخول حرف النداء فقد مضى القول فيه أن النداء واقع بغيرهما من المضمر المنوي به في النية. وأما بناؤهما فأصلهما «نعم» و «بئس» ثم قيل «نعم» و «بئس» ثم أسكنا من ذلك',NULL,'144',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (127,'كما قالوا: «كرم زيد «يريدون» كرم زيد»، وكما قال الشاعر:
...
وقال عز وجل: {وإني خفت الموالي من ورائي}. والمولى: معتق العبد، والمولى: العبد المعتق، والمولى: الحليف، والمولى: الولي والوارث، وقالوا في قوله عز',NULL,'145',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (128,'وجل: {ولكل جعلنا موالي} أي أولياء، ورثة وعصبة.
وقد ذكرنا من تصريف فعل الولي فيما مضى من الكتاب ما فيه كفاية.

<span data-type="title" id=toc-49>الحفيظ</span>
...
<span data-type="title" id=toc-50>القريب</span>
القريب في اللغة على أوجه، القريب: الذي ليس ببعيد، فالله عز وجل قريب ليس ببعيد، كما قال عز وجل: {وإذا سألك عبادي عني فإني قريب أجيب دعوة الداع إذا دعان} أي أنا قريب الإجابة. وهو مثل قوله عز وجل: {وهو معكم أينما كنتم} وكما قال عز وجل: {ما يكون من نجوى ثلاثة إلا هو',NULL,'146',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (129,'رابعهم ولا خمسة إلا هو سادسهم ولا أدنى من ذلك ولا أكثر إلا هو معهم أينما كانوا} وكما قال عز وجل: {ونحن أقرب إليه من حبل الوريد}. وكما قال {وهو الذي في السماء إله وفي الأرض إله}.
...
وقال آخر:',NULL,'147',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (130,'يبكي عليه غريب ليس يعرفه ... وذو قرابته في الحي مسرور
...
<span data-type="title" id=toc-51>يا مجيب</span>
المجيب: اسم الفاعل من أجاب يجيب فهو مجيب، فالله عز وجل مجيب دعاء عباده إذا دعوه كما قال عز وجل: {وإذا سألك عبادي عني فإني قريب أجيب دعوة الداع إذا دعان} فالإجابة والاستجابة سواء تقول: «أجاب الله',NULL,'148',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (131,'دعاءك واستجاب منك» وأصل «مجيب» «مجوب» لأنه من الجواب [فنقلت حركة الواو إلى الجيم]
...
INSERT INTO [b14275] VALUES (133,'زعم البوارح أن رحلتنا غدا ... وبذاك خبرنا الغداف الأسود
...
لما رأت ماء السلا مشروبا ... والفرث يعصر في الإناء أرنت',NULL,'151',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (134,'فعروض البيت الأول «مستفعلن» منحطة من «متفاعلن» وعروض البيت الثاني «مفعول» فنقصها حرفًا وذلك غير جائز، لأن «مفعولن» لا تقع في عروض الكامل، ولو قال: «لما رأت ماء السلا مشروبها» لاستقام وزن البيت.
...
<span data-type="title" id=toc-53>المجيد</span>
...
<span data-type="title" id=toc-54>الودود</span>
...
<span data-type="title" id=toc-55>الفعال</span>
الفعال: اسم مبني لمبالغة الفعل فهو يجري في ضروب من صفاته عز وجل نحو',NULL,'152',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (135,'جبار، وعلام، وخلاق، ورزاق، ووهاب، وتواب، ومنان، وما أشبه ذلك لأن وزن كل هذا «فعال»، وإنما يراد به المبالغة في الفعل فيجوز أن يوصف بالفعال من كل فعل أصله على ثلاثة أحرف على ما أطبقت عليه الأمة وجاء في التنزيل نحو {خلاق} لأنه من خلق و {علام} لأنه من علم و «{جبار} لأن أصله من الجبرية فهو ثلاثي الأصل وإن لم ينطق منه بفعل غير مزيد فيه.
...
قال أبو عثمان المازني في قول الناس: «رجل لآل»: إذا كان يبيع اللؤلؤ لأن اللؤلؤ رباعي ولامه همزة، وبناء الثلاثي من الرباعي غير جائز لاختلال المعنى بسقوط حرف منه، ألا ترى أن قولهم: «لآل» باللام في آخره يدلك على أنه ليس من',NULL,'153',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (136,'اللؤلؤ لأن لام الفعل من اللؤلؤ همزة ومن لآل لام.
...
يمشي كمشي نعائم ... يشتالهن أشق شاخص',NULL,'154',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (137,'بنات عم المرشقات: البقر، والمرشقات: الظباء فهن بنات عم المرشقات لأنه وحش مثلهن، هكذا فسره ابن قتيبة في كتاب «معاني الشعر»، وهذه الأبيات الأول شيء ذكره في كتابه ولم نلق أحدًا يروي عن ابن قتيبة كتابه في معاني الشعر ولا كتابه «في عيون الشعر». والبصابص: بصبصة الأذناب وهي حركتها كما قال رؤبة:
...
<span data-type="title" id=toc-56>الكبير</span>
...
وكبير في صفات الله عز وجل: من الصفات التي لم ينطق من لفظها بغيرها ولم',NULL,'155',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (138,'تصرف نحو قريب، وجليل، وعظيم، وكبير، وكريم. فأما كبير في كلام العرب فقد يتصرف على أوجه، يقال: «رجل كبير» أي مسن «ورجل كبير» أي كبير الخلق والجسم، «ورجل كبير» أي عظيم القدر جليل، ولا يجوز أن يضاف إلى الله غير الوجه الذي قدمنا ذكره، وهو على هذا التأويل الأخير وقد مضى شرحه.
...
والكبر - بالضم -: أكبر ولد الرجل يقال: «الولاء للكبر»، وقد يقال المكبر بمعنى الكبر في السن، يقال: «علاه المكبر»، ويقال: «الله أكبر»، وتأويله الله أكبر من كل شيء أي أعظم وأجل، فعرف موقعه فأضمر لذلك، وقيل: تأويله الله أكبر أي الله كبير، كما قيل: أوجل أي وجل. قال الشاعر:',NULL,'156',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (139,'لعمرك ما أدري وإني لاوجل ... على أينا تعدو المنية أول
...
قال الأخفش: إنما كان موحدًا لأنه بمعنى البعض، فكما لا يثنى البعض ولا يجمع في قولك: «زيد بعض القوم»، «والزيدان بعض القوم»، «والزيدون بعض القوم» كذلك فعل بما كان في معناه.',NULL,'158',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (141,'وقال المازني: إنما لم يؤنث ولم يثن ولم يجمع لأنه بمعنى المصدر، فقولك: «زيد أكرم من عمرو» معناه كرمه يزيد على كرم عمرو، وكذلك «محمد أفضل من زيد» معناه فضله يزيد على فضله فوحد كما يوحد المصدر.
...
قتلنا مخلدًا وابني حراق ... وآخر جحوشًا فوق الفطيم',NULL,'159',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (142,'فإذا ارتفع عن ذلك وخدم وقوي فهو «حزور» قال النابغة:
...
الطبن: اللعب والواحدة طبنة، والجرن: الأرض الغليظة وهي من الجرل',NULL,'161',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (144,'ويقال: «رجل مختال وخال وذو خيلا وذو خال» بمعنى واحد، ويقال: «أطمخ الرجل بأنفه إكماخًا وأقمخ إقماخًا وزمخ بأنفه»: إذا تكبر، ويقال «فخر الرجل، وجخف، وجفخ، واطرخم اطرخمامًا، واطلخم اطلخمامًا»: إذا شمخ بأنفه، «ورجل متفجس» إذا كان متكبرًا. وهذا باب يطول جدًا، وفي هذا منه كفاية.

<span data-type="title" id=toc-57>المتعالي</span>
...
فيا ساسة هاتوا لنا من جوابكم ... ففيكم لعمري ذو أفانين مقول',NULL,'163',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (146,'وتقول للمرأة: «هاتي يا هند» وللمرأتين «هاتيا»، وللجماعة «هاتين» وقياسه في الحذف قياس ما تقدم ذكره».

<span data-type="title" id=toc-58>المنان</span>
...
حدثنا أبو عبد الله إبراهيم بن محمد بن عرفة الأزدي نفطويه قال: حدثني محمد ابن موسى الساوي قال: حدثني وهب بن جرير بن حازم قال حدثني شعبة',NULL,'164',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (147,'عن علي بن مدرك قال: سمعت أبا زرعة يحدث عن خرشة عن أبي ذر الغفاري رحمه الله قال: قال رسول الله صلى الله عليه وسلم: «ثلاثة لا ينظر الله إليهم يوم القيامة». قلت: من هم يا رسول الله خابوا وخسروا. قال: «المسبل إزاره، والمنان، والمختال، فأما المسبل إزاره فإن أهل الجاهلية كانوا يسحبون إزرهم إذا مشوا كبرًا أو يجرونها فكان يفعل ذلك منهم المتكبر والمتجبر فيكون ذلك علامة لكبره وتجبره». قال زهير:
...
ثم راحوا عبق المسك بهم ... يلحفون الأرض هداب الأزر',NULL,'165',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (148,'وقال آخر:
...
<span data-type="title" id=toc-59>الخلاق والخالق</span>
...
قال زهير:
ولأنت تفري ما خلقت ... وبعض القوم يخلق ثم لا يفري',NULL,'166',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (149,'أي أنت تقطع ما قدرته على ما أردت للإصلاح، وبعضهم يخلق: أي يقدر ثم لا يقطع على ما قدر فيفسد، وهذا أمثل.
...
<span data-type="title" id=toc-61>الصادق</span>
الصادق في خبره: الذي لا تكذيب له، فالله عز وجل الصادق في جميع ما أخبر به عباده. قال الفراء: الصدق: قوة الخبر، والكذب: ضعف الخبر ومنه قيل: حمل فلان على القوم فما كذب أو ما ضعف، وكذلك قوله عز وجل: {ليس لوقعتها',NULL,'168',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (151,'كاذبة} أي ليس لها مردود، وقد يقال أيضًا: «حمل فلان على القوم فما كذب»: أي فما رجع عنهم، وهذا راجع إلى ذلك لأنه إنما يرجع عن حملته عن القوم ضعفًا وجبنًا.
...
وقالوا أيضًا: والصدق والكذب إنما يكونان في الإخبار خاصة، وفرقوا بين',NULL,'169',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (152,'الكذب والخلف، فقالوا: الكذب فيما مضى وهو أن تقول: «فعلت كذا» ولم تفعله، والخلف فيما يستقبل وهو أن تقول: «سأفعل كذا» ولا تفعله. فيقال خلف وعده، ولو قيل في ذلك: «كذب فلان في وعده» لم يكن بعيدًا أي لم يأت به على ما وعده وضعف فيه.
...
فإن قال قائل: «شربت ماء البحر» وهو يريد بعضه فذلك سائغ في كلام العرب وهو خارج من هذا المقصد. وهذا مذهب سيبويه ومن تابعه في محال الكذب.',NULL,'170',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (153,'وأما الأخفش فكان يدفع المحال الكذب ويقول: المحال ما لا يصح له معنى ولا يجوز أن يقال فيه «صدق» و «كذب» فكيف يكون المحال كذبًا؟
...
فأما التعظيم لله عز وجل: نحو قولك: «ما أعظم الله» والعرض كقولك: «ألا',NULL,'172',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (155,'تأكل، ألا تجلس عندنا فتحدث» فداخلان تحت الخبر والطلب.
...
فما أحد يعد ليوم خير ... ولا أحد يرد على حميم',NULL,'177',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (160,'ويعجبني الفتى وأظن خيرًا ... فأكشف منه عن رجل لئيم
...
والحق من أولاد الإبل دون الجذع بسنة وذلك حين يستحق الركوب والحمل عليه، والأنثى حقة وذلك إذا استحق الفحل، والجمع: الحقاق، قال عبيد:',NULL,'179',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (162,'أي قوم قومي إذا عزت الخمـ ... ـر وقامت زقاقهم والحقاق
...
المبين
المبين: اسم الفاعل من أبان يبين فهو مبين إذا أظهر وبين إما قولاً وإما فعلاً،',NULL,'180',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (163,'فالله تبارك وتعالى<span data-type="title" id=toc-65> المبين </span>لعباده سبيل الرشاد، والموضح لهم الأعمال الموجبة لثوابه والأعمال الموجبة لعقابه، والمبين لهم ما يأتونه ويذرونه، يقال: «أبان الرجل في كلامه ومنطقه» فهو مبين. والبيان: الكلام. كذلك فسر قوله عز وجل: {خلق الإنسان. علمه البيان}. قالوا: البيان: الكلام، ويقال: «بان الكلام» وأبان بمعنى واحد فهو بين وبمين. وأنشدوا بيت لبيد بن ربيعة العامري يصف ديارًا:
...
بسرو حمير أبوال البغال به ... أتى تسديت وهنًا ذلك البينا',NULL,'181',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (164,'«والبينونة» أيضًا: الفراق، والمباينة: المعاداة من ذلك أيضًا. ويقال تبينت الشيء تبينًا واستنبته استبانة، وأبنته إبانة وبيانًا، وباينت الرجل في العداوة مباينة.

<span data-type="title" id=toc-66>النور</span>
...
ثم قال: {يوقد من شجرة مباركة} فمن قرأ هكذا «توقد» بالرفع أراد تتوقد ذهب إلى الزجاجة فحذف إحدى التاءين لاجتماعهما، والوجه أن تكون المحذوفة الثانية لأن الأولى دليل الاستقبال، وعلى ذلك إجماع النحويين إلا هشام بن معاوية',NULL,'183',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (166,'فإنه قال: المحذوفة الأولى، وليس ذلك بشيء. ومن قرأ «توقد» على لفظ المضي أو «يوقد» بالياء ذهب إلى المصباح.
...
والنور نور النبات وزهره، قال ابن الأعرابي: النور من النبات: الأبيض، والزهر الأصفر يكون أبيض قبل ثم يصفر.',NULL,'184',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (167,'والنور: النفر من الضباء وغيرها، يقال: نارت تنور نوارًا، وامرأة نوار: إذا كانت تنفر من الريبة. وانشد ابن السكيت:
أنورًا سرع ماذا يا فروق ... وحبل الوصل منتكث حذيق
...
فإن قال: كيف يبنى منه «فعل» مثل ظرف وشرف؟ قلنا: نار أيضًا وذلك أن أصله نور فتحركت الواو وقبلها فتحة فانقلبت ألفًا.',NULL,'185',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (168,'فإن قال: كيف يبنى منه «فعل» مثل جهل وعلم؟ قلنا: نار أيضًا، والعلة واحدة.
...
<span data-type="title" id=toc-67>الهادي</span>
...
والهادي: الدليل، ويقال: هديته الطريق، وهديته للطريق، وهديته إلى الطريق بثلاث لغات قد جاءت في التنزيل، قال عز وجل: {اهدنا الصراط المستقيم} وقال: {إن هذا القرآن يهدي للتي هي أقوم}. وقال: {وهديناه النجدين}',NULL,'187',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (170,'{وإنك لتهدي إلى صراط مستقيم}. ويقال: هديت العروس إلى زوجها هداء قال زهير:
...
والهدى: البيان، والاهتداء: اتباع الهدى، والمهتدي: «مفتعل» منه وقوله: {أمن لا يهدي إلا أن يهدي} أصله يهتدي فأدغمت التاء في الدال فصارت دالاً مثلها، ونقلت حركتها إلى الهاء. فأما من قال «يهدي» بإسكان الهاء على الجمع بين ساكنين فذلك متعذر النطق به ولكنه تختلس الحركة فيه اختلاسًا، وكذلك قوله: {إن الله نعما يعظكم به} في اختلاس الحركة في مذهب من يرى ذلك. فأما الإسكان على الحقيقة فغير ممكن لتعذر الجمع بين الساكنين.',NULL,'188',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (171,'والمستهدي: طالب الهدية.

<span data-type="title" id=toc-68>الفتاح</span>
...
وقبيل من لكيز شاهد ... رهط مرجوم ورهط ابن المعل',NULL,'190',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (173,'والقبائل: قبائل الرأس وهي القطع المشعوب بعضها إلى بعض «وقبل فلان لي حق»: أي عنده، «وقعدت قبالة فلان»: أي حذاءه، «واقتبلت الأمر اقتبالاً»، «وفلان مقتبل الشباب»: أي مستأنف الشاب، وتقبلت بالأمر تقبلا. والقبلة: خرزة كانت تؤخذ بها نساء العرب في الجاهلية، والقبل والدبر معروفان، «وفلان لا يعرف قبيله من دبيره». قال الأصمعي: أصله من الاقبالة والادبارة: وهي شق في أذن الشاة يفعل بها ذلك علامة تعرف به، ثم يفتل ذلك، فإذا أقبل به فهو الاقبالة، وإذا أدبر به فهو الادبارة، والجلدة المعلقة هي الاقبالة والادبارة.
...
ويروى «عريفهم».',NULL,'191',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (174,'ويقال: «نحن في قبالة فلان»: أي في عرافته. والقبل: ما قابلك من جبل أو علو من الأرض، وأنشد:
...
<span data-type="title" id=toc-71>الشديد</span>
...
والشديد في غير هذا يقع في صفات الآدميين بمعنى: البخيل، يقال: «فلان شديد» أي: بخيل ممسك، وكذلك فسروا قوله: {وإنه لحب الخير لشديد} أي: إنه لحب المال لبخيل، أي: هو من أجل حب المال بخيل.',NULL,'192',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (175,'ويقال: «شددت الحبل وغيره أشده شدًا» بضم الشين في المستقبل، وشددت على القوم في الحرب أشد شدًا كذلك أيضًا.
...
ذو الطول
الطول: الفضل، يقال: «طال فلان علينا طولاً»: إذا أفضل عليهم، والطول: خلاف العرض. ويقال: «لا أكلمك طوال الدهر» أي: أبدًا. وينشد:',NULL,'193',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (176,'إنا محيوك فاسلم أيها الطلل ... وإن بليت وإن طالبت بك الطيل
والطول: الحبل. فأما قوله:
تعرض المهرة في الطول
فإنما شدده للقافية.

<span data-type="title" id=toc-73>الرزاق</span>
فعال من قولك: «رزق عباده فهو رازقهم». والرزاق. فعال للمبالغة.

<span data-type="title" id=toc-74>ذو القوى</span>
قد مضى شرح ذلك في ذكر القوي.

<span data-type="title" id=toc-75>المتين</span>
...
والمتن متن الظهر، يقال: «متنت الإنسان»: ضربت متنه، وقال الأصمعي المتنتان: اللحمتان عن يمين الفقار ويساره، والمتن: ما غلظ من الأرض وصلب وجمعه متان، قال الأصمعي: والمتن: الرجل الجليد يقال: «فلان متن من الرجال»، فأما قول امرئ القيس:',NULL,'194',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (177,'لها متنتان خظاتا كما ... أكب على ساعدبه النمر
...
في بدنه خظوان لحمه زيم ... وذو بقية ألواح إذا شزبا',NULL,'195',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (178,'ويروى: «إذا شسيا». وقوله: «كما أكب على ساعديه النمر» فإنما أراد أن يقول: كساعدي نمر فقال: كما أكب على ساعديه النمر، والشعراء تفعل ذلك كثيرًا. قال الراعي:
...
أراد: كلون الذئب من كثرة مائه [يصف] لبنًا مزج بالماء. قال الأصمعي: أساء امرئ القيس في وصفه المتن بكثرة اللحم، إنما يستحب عرق متن الفرس ونحفه وهو أن يقل لحمه، وكذلك الوجه، قال طفيل:',NULL,'196',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (179,'معرقة الألحي كأن متونها ... زحاليف ولدان عفت بعد ملعب
...
فقال امرؤ القيس:
كأن هزيزه بوراء غيب',NULL,'197',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (180,'فقال التوأم:
عشار وله لاقت عشارا
فقال امرؤ القيس:
...
يبكي علينا ولا نبكي على أحد ... لنحن أغلظ أكبادًا من الإبل',NULL,'198',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (181,'قال: وبعضهم يصف الإبل بالرقة، قال متمم بن نويرة:
...
<span data-type="title" id=toc-76>البار</span>
البار: اسم الفاعل من قولك: «بر فهو بار»، وبره بعباده: إنعامه وإفضاله عليهم، يقال: «بررت الرجل أبره، وأنا بار وهو مبرور، ورجل بار وبر»، «وبر حج فلان فهو مبرور».',NULL,'199',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (182,'<span data-type="title" id=toc-77>المقتدر</span>
اسم الفاعل من قولك: «اقتدر فهو مقتدر»، وقد مضى شرح ذلك في ذكر القدير.

<span data-type="title" id=toc-78>الباقي</span>
...
وأبقيت الشيء: تركته، وأبقيت من الشيء بقية وبقيت منه كذلك. وجمع بقية بقايا وبقيات، قال الشاعر:',NULL,'200',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (183,'يا كعب صبرًا على ما كان من حدث ... يا كعب لم يبق منا غير أجساد
...
<span data-type="title" id=toc-79>ذو الجلال</span>
...
فلا ذا جلال هبنه لجلاله ... ولا ذا ضياع هن يتركن للفقر',NULL,'201',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (184,'قال الأصمعي: ويقال: «فعلت ذلك من جلل كذا وكذا، ومن جلال ذلك»: أي من عظمته في صدري. قال جميل:
...
أي: لم يقل صغيرًا.
والجلى: الأمر العظيم وجمعها جلل، والجلة: الإبل المسان، ويقال: «مشيخة',NULL,'202',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (185,'جلة». وجلة بالفتح: البعر، والجلالة: الإبل التي تأكل العذرة، والجليل: الثمام قال الشاعر:
...
<span data-type="title" id=toc-80>ذو الإكرام</span>
الإكرام: مصدر من: «أكرمت إكرامًا»: يراد بذلك أنه يكرم عباده المؤمنين، كما',NULL,'203',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (186,'يهين الكفار. يقال: «أكرمت إكرامًا»، والكرامة: الاسم، والمكرمة: الفضيلة. وقد شرحنا الكريم والكرم فيما مضى.

<span data-type="title" id=toc-81>الأول والآخر</span>
...
قال أبو عثمان: فأما ضيون فتقول في جمعه ضياون فلا تهمز لأن الواو في الواحد صحت فلم تعتل ولم تدغم، فلذلك صحت في الجمع وإذا كان في مثل هذا الجمع بين الياء والواو التي بعد الألف ياء تحول بينهما وبين آخر الكلمة لم تهمز وذلك نحو: طواويس ونواويس، والباقي نحو قولك: سابور وسوابير فلا تهمز في مثل هذا لأنها بعدت من الطرف. وشبهوا هذا بقولهم: «صوام» في جمع صائم حين',NULL,'204',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (187,'صحح الواو من يقول: صويم فلا يقوم «صيام» لأنها بعدت من الطرف. فأما قول الشاعر:
...
وتقول: «زيد أولى بهذا الأمر من فلان»، «والزيدان أولى منه»، «والزيدون أولى منه». ولا يثنى ولا يجمع. وكذلك جميع الباب «أفعل» إذا صحبته «من» ولا تؤنثه. وقد مضى ذكر هذا فيما مضى من الكتاب.',NULL,'205',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (188,'فإن أدخلت عليه الألف واللام ثنيت وجمعت وأنثت كما فعلت ذلك بالأفضل، والفضلى، والأكبر والكبرى، والأول والأولى، فتقول: «زيد الأولى» «والزيدان الأوليان» كما قال: {من الذين استحق عليهم الأوليان} ردًا على {فآخران يقومان مقامهما} على تقدير: «هما الأوليان». ومن قرأ «الأولين» رد الأولين على «الذين».
...
<span data-type="title" id=toc-82>مسألة من هذا الباب:</span>
...
<span data-type="title" id=toc-84>الباطن</span>
الله عز وجل الظاهر والباطن كما وصف نفسه بذلك، هو الظاهر لظهور آياته ودلائله الدالة عليه ووضوحها وبيانها، وقد مضى القول على ذلك فيما تقدم. وهو',NULL,'208',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (191,'الباطن لأنه غير مدرك بالحواس كالأشياء المخلوقات التي تدرك بالحواس نحو اللمس، والحس [] (١) والباطن خلاف الظاهر، والباطن أيضًا في كلام العرب: الخبير العالم بما بطن من أمور بعض من يصحبه، ويداخله كقولك: «قد بطن فلان أمر فلان»: أي اختبر باطنه ووقف منه على ما لم يقف عليه غيره.
...
_________
(١) هكذا بياض بالأصل.',NULL,'209',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (192,'فكان مجنى دون من كنت أتقي ... ثلاث شخوص كاعبان ومعصر
...
وإنما ذهب الفراء في قوله: قد تكون الظهارة بطانة والباطنة ظهارة في قوله: «بطائنها من استبرق» فيما أرى إلى أن الظهارة والبطانة متساويان في الجلالة ليس',NULL,'211',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (194,'لأحدهما فضل على الآخر والله أعلم بالمراد من ذلك، ولكنه قد ذكر في هذه السورة التي ذكر فيها هذا الحرف وهي السورة التي يذكر فيها الرحمن شيئًا ما أحسب له مخرجًا في تأويل ولا تفسير، ولا يصح بوجه ولا تقدير، وذلك أنه قال في قوله عز وجل: {ولمن خاف مقام ربه جنتان} إنه قد يكون في العربية جنة واحدة فقيل: «كجنتان» كما قال الشاعر:
...
وقال أبو عمرو الشيباني: إنما أراد بالفقر من الفقر وسوء الحال. وكذلك يقال: «رجل مصدر»: شديد الصدر، و «مصدور»: يشتكي صدره ومنه قولهم:',NULL,'213',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (196,'لا بد للمصدور من أن ينفث
...
<span data-type="title" id=toc-85>القدوس</span>
القدوس: «فعول» من القدس وهو الطهارة ومنه قيل: «الأرض المقدسة» يراد المطهرة بالتبرك، ومنه قوله عز وجل حكاية عن الملائكة: {ونحن نسبح بحمدك ونقدس لك} أي ننسبك إلى الطهارة ونقدسك ونقدس لك، ونسبحك ونسبح لك بمعنى واحد. وما جاء على «فعول» فهو مفتوح الأول نحو كلوب، وسمور، وشبوط، وتنور وما أشبه ذلك إلا سبوح وقدوس فإن الضم فيهما أكثر، وقد يفتحان.',NULL,'214',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (197,'<span data-type="title" id=toc-86>السلام</span>
...
عفا واسط من آل رضوى فنبتل ... فمجتمع الحرين فالصبر أجمل',NULL,'215',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (198,'فرابية السكران قفر فما بها ... لهم شبح إلا سرم وحرمل
...
والسلم بفتح السين واللام: الاستسلام. وقالوا في قوله عز وجل: {والله يدعوا إلى دار السلام}. السلام: الله وداره الجنة، وجائز أن يكون التأويل: والله يدعو إلى دار السلامة لأن السلامة والسلام سواء كما ذكرنا فسمي الجنة',NULL,'216',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (199,'دار السلامة لأن الصائر إليها يسلم فيها من كل ما يكون في الدنيا من المرض والضعف والهرم والموت وما أشبه ذلك، وكذلك قوله عز وجل: {لهم دار السلام عند ربهم}.
...
وقيل: معنى اسم السلام عليكما: إغراء منه لهما بذكر الله، وكأنه قال: إلى',NULL,'217',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (200,'الحول أبكياني حولاً ثم اسم السلام عليكما: أي إلزما اسم الله عز وجل وذكره ودعا البكاء علي لأن من بكى ميتًا حولاً فقد بلغ النهاية في ذلك.
...
وقد تجيء في كلام العرب أشياء منصوبة على الإغراء بغير حرف إغراء إلا بإضمار فعل وذلك شاذ. نشد ابن الأعرابي عن علي بن صالح عن المفضل:',NULL,'218',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (201,'ألا قالت حذام وجارتاها ... كبرت ولا يليق بك النعيم
...
أنك قد يكفيك بغي الفتى ... ودرأه أن تركض العاليه',NULL,'219',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (202,'مطعنة يجري لها عاند ... كالماء من غائلة الجابيه
...
وقوله: «تركض العاليه»: يريد تدفع، يعني عالية الرمح أعلاه، والعاند من الدم: المائل، والجابية: الحوض، وغائلته: ما انخرق منه، والأوطف: الكثير شعر العينين والأذنين فأراد أنه لا قلب له كالجمل الأوطف. والعرب تقول:',NULL,'220',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (203,'«كل أزب نفور»، وبنو جارية: من طيء، والشق: المشقة والشدة، وقوله: «تنبض أحرادها»: أي تضطرب أمعاؤها، وأحرادها: أمعاؤها، ومتغناة: متغنية. هذا كله قول ابن الأعرابي ورواه أبو زيد: تنبذ أحرادها: من النبذ والالقاء، قال: «وواحد الأحراد وهو الغيظ والغضب». قال أبو زيد: سنان: اسم رجل، ومحلب: معين، والوانية: المبطئة.
...
<span data-type="title" id=toc-87>المؤمن</span>
المؤمن في صفات الله عز وجل على وجهين: أحدهما أن يكون من الأمان',NULL,'221',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (204,'أي: يؤمن عباده المؤمنين من بأسه وعذابه فيأمنون ذلك كما تقول: «آمن فلان فلانًا» أي: أعطاه أمانًا ليسكن إليه ويأمن. فكذلك أيضًا يقال: «الله المؤمن» أي: يؤمن عباده المؤمنين فلا يأمن إلا من آمنه. ومنه قول النابغة الذبياني:
...
وهذا تقوية للمذهب الأول وشرح للمؤمن، أن تأويله: الذي آمن الطير في الحرم. قال: والغيل والسعد: أجمتان كانتا مناقع ما بين مكة ومنى، يقال لأحدهما',NULL,'222',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (205,'الغيل والآخرى السعد. وقال الأصمعي: لا يقال غيل لأن الغيل الغيضة، والغيل الماء الجاري، وقال: كان ماء يجري في أصل أبي قبيس يغسل عليه القصارون، وروايته الغيل بالفتح على هذا التأويل الذي ذكرته، ومن روى «بين الغيل» بالكسر فقال: الغيل هاهنا مكان، والسند: سند الجبل.
...
ويقال: «ما أومن بشيء مما يقول فلان» أي: ما أصدق به، وإيمان العبد بالله عز وجل: تصديقه به قولاً، وعقدًا، وعملاً. وقد سمى الله عز وجل الصلاة إيمانًا في',NULL,'223',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (206,'قوله: {وما كان الله ليضيع إيمانكم} أي: صلاتكم إلى بيت المقدس.
...
تقديره أأنت أحسن أم أم سالم؟. وأنشد أبو زيد الأنصاري:',NULL,'224',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (207,'حزق إذا ما القوم أبدوا فكاهة ... يفكر آإياه يعنون أم قردا؟
...
ونظير الجمع بين همزتين في كلمة واحدة وتحقيقهما في الشذوذ وإن كان هو الأصل إثبات بعضهم الهمزة في يرى، وترى، ونرى، وأرى لأن إجماع العرب على حذف الهمزة من مستقبل «رأيت» وإثباتها في الماضي كما ترى فصار هذا المستعمل المستقبل المجمع عليه كالأصل، وصار الأصل وهو إثبات الهمز كالفرع الشاذ',NULL,'225',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (208,'للإجماع على غيره فصار استعماله شاذًا فمن العرب من يثبت الهمز في يرى وترى وما أشبه ذلك فيقول: «أنت ترأى زيدًا» و «أنا أرأيتك إياه»، وأنشد الجماعة لسراقة البارقي.
...
قال أبو زيد: وكل هؤلاء حقق الهمزة وهو قليل في الكلام، والتحقيق الأصل.',NULL,'226',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (209,'وتقول في اسم الفاعل من آمن: مؤمن بتحقيق الهمز وهو الأصل، والمفعول مؤمن به كذلك بالتحقيق وإن شئت خففت فلم تهمزه.
...
<span data-type="title" id=toc-88>المهيمن</span>
فسر المهيمن على وجهين: قيل: المهيمن: الشاهد، قال الله عز وجل:',NULL,'227',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (210,'{وأنزلنا إليك الكتاب بالحق مصدقًا لما بين يديه من الكتاب ومهيمنًا عليه} أي: شاهدًا عليه. كذلك روي عن ابن عباس وروي عنه من وجه آخر أنه قال: المهيمن: الأمين فكأنه قال: مصدقًا لما بين يديه من الكتاب وأمينًا عليه، والتفسيران متقاربان.
...
فالبيطر والمبيطر والبيطار بمعنى واحد. ومما جاء على هذا الوزن مهيمن ومبيطر ومسيطر ومبيقر. قالوا: فكأن أصله «مؤيمن» فأبدلت الهمزة هاء لأن الهمزة والهاء',NULL,'228',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (211,'لقرب مخرجيهما قد تبدل إحداهما من الآخرى. قالوا «في أرقت الماء» «هرقت الماء» و «ماء مهراق». يقال: «أرقت الماء» وهو الأصل، و «هرقته» و «أهرقته» ثلاث لغات حكاها سيبويه وغيره. وهو «ماء مراق» بحذف الهمزة و «مهراق» بإسكان الهاء و «مهراق» بفتح الهاء تجعل مكان الهمزة وتفتح كما كانت مفتوحة، وأنشدوا:
...
وحدثنا إبراهيم الصائغ قال: حدثني عبد الله بن مسلم بن قتيبة قال: حدثني يزيد',NULL,'230',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (213,'ابن عمرو الغنوي قال: حدثني زكريا بن يحيى الكوفي قال: حدثنا عم أبي زحر بن حصين عن جده حميد بن منهب قال: سمعت جدي خريم بن أوس بن حارثة يقول: هاجرت إلى رسول الله صلى الله عليه وسلم المدينة منصرفه من تبوك فسمعت العباس بن عبد المطلب يقول: يا رسول الله إني أريد أن امتدحك. فقال: قل: لا يفضض الله فاك فقال العباس:
من قبلها طبت في الظلال وفي ... مستودع حيث يخصف الورق
ثم هبطت البلاد لا بشر ... أنت ولا مضغة ولا علق
بل نطفة تركب السفين ... وقد ألجم نسرًا وأهله الغرق',NULL,'231',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (214,'تنقل من صالب إلى رحم ... إذا مضى عالم بدا طبق
...
وسويت بين الناس في الحق فاستووا ... فعاد صباحًا حالك اللون مظلم',NULL,'232',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (215,'أتاك أبو ليلى يجوب به الدجى ... دجى الليل جواب الفلاة عثمثم
...
فلما بلغ قوله:
علونا العباد عفة وتكرما ... وإنا لنرجو فوق ذلك مظهرا',NULL,'233',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (216,'غضب رسول الله صلى الله عليه وسلم وقال: أين المظهر يا أبا ليلى؟ فقال: إلى الجنة يا رسول الله فقال: أجل إن شاء الله. ثم قال: أنشدني، قال: فأنشدته:
...
فلأحشونك مشقصًا ... أوسًا أويس من الهبالة',NULL,'234',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (217,'[الهبالة]: نعجة.
ويروى: فلأحشأنك.
...
في صلب مثل العنان المؤدم ...',NULL,'235',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (218,'والطبق: القرن من الناس، وكذلك الطبقة، وإنما سموا بذلك لأنهم طبق للأرض. ومثله قول امرئ القيس في وصف المطر:
...
مالي إذا أنزعها صبيت ... أكبر قد غالني أم بيت',NULL,'236',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (219,'وقوله: «وضاءت بنورك الأفق»: يقال ضاء الشيء وأضاء لغتان.

<span data-type="title" id=toc-89>العزيز</span>
...
والعزيز: الجليل الشريف، ومنه قولهم: «إذا عز أخوك فهن» وقولهم: «فلان يعتز بفلان: أي يتجالل به ويتشرف ويتكبر. وكذلك قوله عز وجل: {لئن رجعنا إلى المدينة ليخرجن الأعز منها الأذل}: أي ليخرجن الجليل الشريف منها الذليل.',NULL,'237',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (220,'وذكر صاحب العين أنه يؤثر عن بعض السلف أنه قرأ «ليخرجن الأعز منها الأذل» أي ليخرجن الأعز منها ذليلاً. وهذه القراءة في مذاهب العربية رديئة مردودة لأن في الأذل الألف واللام فلا تكون حالاً لأنها معرفة والحال لا تكون إلا نكرة، وإنما القراءة التي عليها الجماعة: «ليخرجن الأعز منها الأذل» أي ليخرجن العزيز الذليل من المدينة، وهذا قول المنافقين للنبي صلى الله عليه وسلم وأصحابه - رحمهم الله -».
...
والوجه الثالث: أن يكون العزيز بمعنى القوي، يقال: «عز فلان بعد ضعف»',NULL,'238',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (221,'أي قوي يعز عزًا، و «أعزه الله بولده» أي: قواه بهم. كذلك حكى الخليل عن العرب.
...
وأخبرنا نفطويه عن ثعلب عن ابن الأعرابي قال: تقول العرب: «ما أدري أغار أم مار»، غار: أتى الغور، ومار: أتى نجدًا.',NULL,'239',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (222,'والعزوز: الشاة الضيقة الأحليل تحلب بجهد. يقال: «قد تعززت» وهو من الامتناع أيضًا. والعزازة: مصدر في القلة. ويقال: «عازني فلان فعززته»: أي غالبني فغلبته. والعزاء: السنة الشديدة. و «المطر يعزز الأرض تعزيزًا»: إذا لبدها.

<span data-type="title" id=toc-90>الجبار</span>
...
قو: موضع، واللعاع: أول البقل وهو الرطب، والربة: تروح النبت والشجر، وتروح النبت: خروجه بعد يبسه يكون له أصل يحمل الماء ويبقى على الحر إذا دخل القيظ',NULL,'240',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (223,'فإذا مضى القيظ وبدا سهيل وبرد الزمان قليلاً اخضر وأورق. وقوله: تجبر أي: طال وغلظ بعدما أكل. ويقال: «فلان يتنمص من شاربه»: أي يأخذ منه.
...
<span data-type="title" id=toc-91>المتكبر</span>
...
<span data-type="title" id=toc-92>الخالق</span>
قد مضى شرحه في ذكر الخلاق.',NULL,'241',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (224,'البارئ
...
قال: ويقال في لغة أهل الحجاز وغيرهم: «برئت إليك من فلان ومن الدين وأنا أبرأ غليك براءة»، و «تبرأت منه تبرؤًا»، ويقال: «فلان برئ من فلان» و «وهما بريئان»، و «هم بريئون وبرآء» على «فعلاء» مثل ظرفاء وكرماء في الوزن، وفيه لغة أخرى، يقال: «أنا البراء منك» و «نحن البراء منك» بلفظ واحد في الواحد والاثنين',NULL,'242',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (225,'والجمع والمؤنث تجري مجرى المصدر الموصوف به، ومنه قوله: {إنني براء مما تعبدون}.
...
<span data-type="title" id=toc-94>المصور</span>
...
ومثل ذلك قوله عز وجل: {فسيقولونه من يعيدنا؟ قل: الذي فطركم أول',NULL,'245',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (228,'مرة} وإنما احتج عليهم بخلقهم لأنهم كانوا مقرين بأنهم مخلوقون، وإن الله خالقهم ولا يمكن لأحد منهم أن يقول: أنا غير مخلوق، ولا إني خالق لنفسي، ولا إن لي خالقًا غير الله. فخوطبوا على حسب إقرارهم، وجعل ذلك دليلاً لهم على الإعادة.
...
قال أبو زيد: ويقال: «أبدأت من أرض إلى أخرى»: إذا خرجت إليها',NULL,'246',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (229,'إبداءً، ويقال: «بدئ بالرجل فهو مبدوء به»: إذا أخذه الجدري أو الحصبة.
...
قد كن يخبأن الوجوه تسترًا ... فالآن حين بدون للنظار',NULL,'247',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (230,'كيف تروي «بدأن» أو «بدين»؟ فسبقه لسانه ولم ينعم الفكر فقال: «بدأن». فلما وقفه عليه قال: هذا عاقبة البغي.
...
والعيد: ما اعتادكم من هو وشوق وطيف. قال تأبط شرًا:',NULL,'249',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (232,'يا عيد مالك من شوق وإيراق ... ومر طيف على الأهوال طراق
...
وقال بعضهم: اشتقاق العيد من عاد يعود كأنهم عادوا إليه، والياء فيه أيضًا من الواو هذا المذهب أيضًا، وتقول: «عدت المريض عيادة» فأنا عائد [و] هو معود، وجمع عائد عواد، والمرأة عائدة وجمعها عوائد في التكسير وعائدات في السالم. قال كثير:',NULL,'250',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (233,'أغاضر لو شهدت غداة بتنم ... جنوء العائدات على وسادي
وقال عويف:
...
ومعاد الرجل: بلده لأنه يعود إليه حيث كان، ويقال: «هذا الرجل معيد لهذا الأمر»: أي مطيق له لأنه قد اعتاده. ويقال للشجاع: «بطل معاود» يقال في الدعاء: «اللهم أنت العواد بالمغفرة» كذلك حكاه الخليل كأنه يعود على عباده بالمغفرة مرة بعد أخرى، ويعودهم الغفران. وإن لم تكن هذه الصفة مما جاءت في التنزيل فهي صحيحة الاشتقاق ولم يكن ليحكي إلا ما سمعه ممن يوثق به يأثره عن السلف.',NULL,'251',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (234,'ويقال للفحل من فحول الإبل «معيد» أي معتاد للضراب. والعيدية: إبل نسبت إلى فحل كريم يقال له «عيد»، والعود: السؤدد القديم والجمل المسن الذي فيه بقية. وتقول العرب لكل شيء قديم «عادي» والأنثى «عادية» كأنهم ينسبونه إلى عاد قوم [هود] لقدم زمانه عندهم.

<span data-type="title" id=toc-96>الأحد</span>
قد ذكرنا اشتقاقه وتصريفه في باب شرح اشتقاق «الواحد».

<span data-type="title" id=toc-97>الصمد</span>
الصمد: السيد الذي قد انتهى سودده، فالناس يصمدونه في حوائجهم: أي يقصدونه ويعتمدونه، قال الشاعر:
................. ... خذها حذيف فأنت الواحد الصمد
وقال أوس بن حجر:
ألا بكر الناعي بخير بني أسد ... بعمرو بن مسعود وبالسيد الصمد',NULL,'252',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (235,'ويقال: «صمدت صمده» أي: قصدت قصده. وقال عكرمة ومجاهد: هو الذي لا جوف له. وروي عن ابن عباس أنه قال: هو الذي ليس بأجوف وكأنه ذهب إلى نفي التجسيم والتحديد عند جل وعز فتكون الدال على هذا التقدير مبدلة من تاء في تقدير العربية. والوجه الأول أنفذ في مقاييس العربية وأشهر، وأحرى بإضافته إلى الله وهو أن الصمد: السيد.
هذا آخر القول في هذه الصفات واشتقاقها وما اتصل بها من اللغات والتصاريف، والمصادر، وما تعلق بها حسب ما حضرني. ونقول الآن في اشتقاق الاسم والصفات والأسماء والفرق بينها، [و] مواقعها ومجاريها [في] كلام العرب حسب ما شرطناه في أول الكتاب، والله المعين والموفق للصواب، وهو حسبنا ونعم الوكيل.',NULL,'253',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (236,'<span data-type="title" id=toc-98>باب
القول في اشتقاق الاسم</span>
...
ووغد وقال الشاعر',NULL,'256',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (238,'لا تقلواها وادلواها دلو ... إن مع اليوم أخاه غدوا
...
مما لا يجوز نعته</span>
اعلم أن من الأسماء ما يجوز أن ينعت في حال وينعت به في أخرى، ومنها ما ينعت ولا يجوز أن ينعت به البتة، ومنها [ما]
لا يجوز أن ينعت ولا ينعت به. وأما ما ينعت ولا ينعت به فالأسماء الأعلام نحو: محمد وجعفر وزيد وما أشبه ذلك، والنكرات الأصول التي ليست بمشتقة نحو: رجل وفرس وثوب ودار وما أشبه ذلك تنعت هذه',NULL,'259',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (241,'الأسماء ولا ينعت بها، وما يجري من المضاف إليها مجراها فهذا سبيله نحو «ثوب زيد» و «دار أخيك» وما أشبه ذلك. فأما رجل إذا أريد به من الرجولية فخارج عن هذا الباب وجائز في امتناع هذه الأسماء من أن ينعت بها أنها ليست بمشتقة من الأفعال ولا متضمنة معناها، ولا يكون النعت إلا كذلك.
...
فإن قال قائل من البصريين المحتجين لمذهب سيبويه: فقد نعتنا بالذي، واللذين، والتي، واللتين، واللاتي وليست متضمنة معنى فعل؟ قيل له: هذه مغالطة لأن الذي، والتي وتثنيتهما وجمعهما إنما صارت نعوتًا بما يقع في صلاتها من',NULL,'261',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (243,'الأفعال والظروف والجمل المؤدية معنى الأفعال فلذلك وقعت نعوتًا كقولك: «جاءني زيد الذي أكرم عمرًا» و «الذي أمامك» و «الذي أخوه عاقل» وما أشبه ذلك فإنما أفاد الجملة المتصلة بـ «الذي» الفائدة فوقعت «الذي» نعتًا لذلك.
...
فإذا أريد وصف هذه الأسماء وصلت فدخل الوصف في الصلة، ويفرق بين',NULL,'262',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (244,'«الذي» و «من» و «ما» أن «الذي» يصلح لكل موصوف ما يعقل وما لا يعقل، وللواحد العلم، وللجنس وهو يقوم مقام الصفة في كل موضع و «من» مخصوصة بما يعقل ولا تقع موقع الصفة، و «ما» مخصوصة لغير ما يعقل ولا يوصف بها. هذا مذهب الكوفيين.
...
ومما لا يجوز أن ينعت ولا ينعت به: كل وبعض في حال الإفراد كقولك: «مررت بكل راكبًا» و «ببعض جالسًا» ولا يجوز أن تقول: «بكل جالس» أو «جالسين» أو «الجالس» أو «الراكب» أو «الراكبين». كل ذلك غير جائز على النعت، ولا «ببعض راكب» ولا أن ينعت به فتقول: «جاءني قوم بعض» ولا «كل». كذلك قال سيبويه ونحن نقول: نفرد له بابًا نشرحه فيه بعلله لما فيه من المنازعة.',NULL,'264',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (246,'تعقيب هذا الباب إن شاء الله تعالى

<span data-type="title" id=toc-101>باب
ذكر امتناع بعض وكل في حال الإفراد من أن ينعتا
أو ينعت بهما وذكر علة استحالة استعمال
البعض والكل معرفين بالألف واللام إلا مجازًا</span>
...
اعلم أن سيبويه قد أتى في هذا الفصل على جمع ما فيه وعلله ولكنه كلام مجمل وأنا أشرحه ليبين لك مغزاه إن شاء الله: أما قوله: ينتصب خبره لأنه معرفة فكما تنتصب أخبار المعارف في قولك: «مررت بزيد جالسصا» و «هذا محمد راكبًا» فقد بان لك في قوله: «بكل قائمًا» و «ببعض جالسًا» أن «كلا» و «بعضًا» عنده معرفتان لانتصاب خبرهما كما ينتصب خبر محمد وزيد.',NULL,'265',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (247,'ثم قال: «ولا يجوز لك أن تقول: «بكل الصالحين» ولا «ببعض الصالحين» فمثل لك نعتهما لو جاز أن ينعتا بما فيه الألف واللام لأنهما معرفتان، فلو نعتا لنعتا بما فيه الألف واللام أو ما جرى مجراه.
...
فإن قال قائل فقد ذكرت معنى قول سيبويه وشرحته في امتناع «كل» و «بعض»',NULL,'267',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (249,'من إدخال الألف واللام عليهما ولم يذكر سيبويه ولا أنت العلة التي من أجلها لم تبن «كل» و «بعض» في حال الإفراد وهما في معنى المضاف معرفتان، وسبيلهما أن يبنيا كما بني «قبل» و «بعد»؟
...
الفرق بين الاسم والنعت لفظًا ومعنى</span>
...
فالأسماء تنقسم أولاً قسمين: معرفة ونكرة نحو: رجل، وفرس، وزيد، وعمرو وهذا أول انقسام الأسماء ثم تتنوع بعد ذلك فتصير ستين نوعًا يجمعها كلها التنكير والتعريف. والتنكير أول والتعريف بعد، فالمنكور الاسم الشائع في جنسه، والمعروف: المخصوص من النكرات ما هو إلى المعارف أقرب. كما أن من المعارف ما',NULL,'268',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (250,'هو أكثر عمومًا. فأبعد النكرات من المعارف «شيء» وأقربها إلى المعارف رجل وفرس، وأقرب من هذا إليها ما قرن بنعت ففارق الإشاعة في أشباهه فإذا نزلت من فوق إلى أسفل قربت من التعريف، وإذا صعدت من أسفل إلى الفوق بعدت من التعريف.
...
INSERT INTO [b14275] VALUES (253,'في إجرائها مجرى الفعل في عمله وامتناعها من ذلك في بعض الأحوال ليس هذا موضع ذكره.
...
والضرب السابع: ما كان جنسًا مضافًا إليه وربما نعت به كقولك: «هذا خاتم حديد»، و «ثوب خز»، و «باب ساج». هذا وجه الكلام يضاف إلى جنسه ليوضحه، وقد يجريه بعض العرب على أوله موضحًا له فيقول: «هذا باب حديد»، و «خاتم فضة»، و «سرج خز». ومنهم من ينصبه على التمييز فيقول: «هذا خاتم حديدًا»، و «جبة خزا»، يذهب إلى المقدار، ويقول في ضرب من هذا الباب: «مررت بسرج خز',NULL,'272',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (254,'صفته» بالخفض إذا لم تكن صفته الخز بعينه وإنما أردت التشبيه، فكأنك قلت: «كالخز صفته» وإن كانت صفته من الخز قلت: «مررت بسرج خز صفته» بالرفع، وكذلك «مررت بدار ساج [بابها، وساج بابها]» وكذلك «مررت برجل عسل شرابه، وعسل شرابه» وعلى هذا فقس.
...
وللنعوت خصائص تنفرد بها من الأسماء التي ليست بنعوت من جموع وأبنية ليس هذا موضع ذكرها.',NULL,'274',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (256,'<span data-type="title" id=toc-103>باب
القول في صفات الله التي تقدم ذكرها
وكيف مجراها عليه تبارك وتعالى</span>
...
الظاعنون ولما يظعنوا أحدًا ... والقائلين لمن دار نحليها',NULL,'275',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (257,'وأنشد:
...
وجميع ما ذكرنا من أهل اللغة قد تكلم في الاشتقاق أما في كتاب له مفرد بالاشتقاق أو في عرض كلامه في اللغات والتصاريف والأبنية والجموع وما ينصرف وما لا ينصرف والمقصور والممدود والمهموز وسائر ذلك مما لا بد لهم فيه من المقايسة وذكر',NULL,'277',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (259,'الأصول والزوائد والملحق وغير الملحق وما أشبه ذلك.
...
ومنها أسماء وضعت أعلامًا اتفاقًا يدل كل اسم منها على شخص بعينه نحو: زيد وجعفر وبكر وما أشبه ذلك. ولم يجب أن تقع فيها مشاركة، فلما طال الزمان وقعت المشاركة اتساعًا، ووقع الفصل بالنعوت.',NULL,'281',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (263,'ومنها أسماء مبهمة ومضمرة وفصلوا سائر أنواع الأسماء.
...
وكذلك الصلاة إنما كانت تعرفها [العرب] الدعاء فقط ثم قيل لهم: سموا هذا النوع من الفعل صلاة. وليس لأحد أن يزعم أن العرب كانت تفعل الصلاة على ما تدين به اليوم، فلما وقفت على ذلك سميت صلاة. فهذا اسم موضوع لمعنى أوجبه على أصل من أصولهم قد تقدمه فليس باسم لم يزالوا به عارفين، فهذا تأويل الاشتقاق.',NULL,'282',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (264,'وكذلك الزكاة إنما كانت تعرفه العرب التكثير للشيء فتقول: زكا الشيء: إذا كثر وزاد ثم تعبدوا بأن قيل لهم سموا ما يرصد من أموالكم طاعة لله زكاة لأنكم إذا فعلتم ذلك زاد الله في أموالكم وبارك فيها وكثرها، فسميت زكاة لما يكون بعقبها من الزيادة والنماء في المال. فهذا هو معنى الاشتقاق من أن يوضع شيء مستأنفًا على أصل سابق له. وكيف يكون في الاشتقاق شيء أوضح من هذا.
...
وكذلك القرآن ليس لأحد أن يزعم أن العرب كانت تعرفه اسمًا لهذا الكتاب، بل كانت تعرف معنى القرء الذي منه أخذ القرآن فقيل لهم: هذا هو القرآن فعرفوه.',NULL,'283',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (265,'فقرآن: اسم لهذا الكتاب خاصة موضوع على معنى قد عرفه العرب من لفظة كانت تستعملها قبله. فقد بان أنها لفظة مشتقة من أصل متقدم.
...
وقد جاءت ألفاظ من كلام العجم في أشعار الفصحاء من العرب نحو الأعشى والعجاج ورؤبة وغيرهم. ولهذه العلة فسدت لغات من خالط من الأعراب أهل الحضر لأنهم سمعوا كلام غيرهم فاختلط عليهم كلامهم. ولو كانوا مخلوقين على النطق',NULL,'284',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (266,'بكلامهم خلقة لما أمكنهم الانتقال عنه، ولكن في طبع الإنسان النطق وأن يتكلم بكلام ما فهو يتكلم بكلام من نشأ بينهم ويعتاده حتى يصير كالمنطبع عليه. فإن انتقل إلى قوم آخرين كان جائزًا أن يتكلم بكلامهم كما ترى الواحد منا يتكلم بألسنة كثيرة، وهذا بين واضح.
...
وسميت غياظًا ولست بغائظ ... عدوًا ولكن الصديق تغيظ',NULL,'287',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (269,'فأخبر أن غياظًا وغائظًا من الغيظ. وقد قال بعضهم: «إنما سميت هانئًا لتهنأ».
...
وقال في قوله عز وجل: {نسوق الماء إلى الأرض الجرز} قال: الأرض الجرز: التي لا تنبت شيئًا، ومنه سيف جراز: يأتي على كل شيء ورجل جرز: كثير',NULL,'291',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (273,'الأكل يأتي على كل شيء، فجعل كما ترى الأصل الأرض الجرز ورد عليها ما سواها من لفظها ومعناها، وهو قول الاشتقاق.
...
ومن دفع الاشتقاق فقد خرج عن مذاهب أهل اللغة في الجموع، والمصادر، وما ينصرف وما لا ينصرف، والتصريف، وأزال عن نفسه مرونة النعت في تحصيل هذه الأشياء ومعرفة حقائقها المحتاج فيها إلى الاشتقاق.',NULL,'292',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (274,'<span data-type="title" id=toc-105>باب
القول في اشتقاق النبي
صلى الله عليه وسلم
ومذاهب العلماء في ذلك</span>
...
وكنت أذل من وتد بقاع ... يشجج رأسه بالفهر واج',NULL,'293',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (275,'يريد: واجئًا فقل الهمزة ياء.
...
وقال هؤلاء: والدليل على صحة مذهبنا ما روي عن النبي صلى الله عليه وسلم أن رجلاً قال له: «يا نبيء الله» فهمزه فقال له عليه السلام: «لست نبيء الله ولكني نبي الله» فقال القائلون بالمذهب الأول هذا حديث مرسل رواه حمزة عن حمدان.',NULL,'294',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (276,'والثابت عنه أن العباس بن مرداس أنشده:
...
وقد حكى سيبويه أن من العرب من يهمز النبئ والبريئة على الأصل.',NULL,'295',NULL,NULL,'0');
INSERT INTO [b14275] VALUES (277,'فكل هذا دليل على أنه مهموز في الأصل ترك همزه على طريق البدل.
...
وأيضًا كتب:
بلغت القراءة على الشيخ أبي بكر علي بن الخضر بن المؤدب، وأحمد بن محمد الفياضي. وصح.',NULL,'296',NULL,NULL,'0');
