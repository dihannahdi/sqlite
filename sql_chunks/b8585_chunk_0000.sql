...
CREATE TABLE "b8585"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b8585
INSERT INTO [b8585] VALUES (1,'التحفة المدنية
في العقيدة السلفية
تأليف
الشيخ العالم العلامة حمد بن ناصر بن عثمان آل معمر
(١١٦٠ هـ - ١٢٢٥ هـ)
تحقيق
عبد السلام بن برجس بن ناصر آل عبد الكريم',NULL,'20',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (2,'بسم الله الرحمن الرحيم
الحمد لله رب العالمين.
والصلاة والسلام على محمد، وعلى آله وصحبه أجمعين.
ما قولكم أدام الله النفع بعلوكم في آيات الصفات، والأحاديث الواردة في ذلك: مثل قوله تعالى: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، ومثل قوله: {يَدُ اللَّهِ فَوْقَ أَيْدِيهِمْ} [الفتح: ١٠] ، وقول النبي صلى الله عليه وسلم: «ينزل ربنا كل ليلة إلى سماء الدنيا» ،',NULL,'21',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (3,'وقوله صلى الله عليه وسلم: «قلب المؤمن بين إصبعين من أصابع الرحمن» ، إلى غير ذلك مما ظاهره يوهم التشبيه؟!
...
[وصلى الله على سيدنا محمد، وآله، وصحبه وسلم] .',NULL,'22',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (4,'الجواب
الحمد لله رب العالمين.
...
من غير تحريف ولا تعطيل، ومن غير تكييف ولا تمثيل.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (5,'بل نؤمن بأن الله سبحانه: {لَيْسَ كَمِثْلِهِ شَيْءٌ وَهُوَ السَّمِيعُ الْبَصِيرُ} [الشورى:١١] .
...
فمذهبنا مذهب السلف: إثبات بلا تشبيه، وتنزيه بلا تعطيل، وهو مذهب أئمة الإسلام، كمالك والشافعي، والثوري، والأوزاعي، وابن المبارك، والإمام أحمد، وإسحاق بن راهويه، وهو اعتقاد المشايخ المقتدى بهم، كالفضيل بن عياض، وأبي سليمان الداراني، وسهل بن عبد الله التستري، وغيرهم. فإنه ليس بين هؤلاء الأئمة نزاع',NULL,'24',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (6,'في أصول الدين، وكذلك أبو حنيفة رضي الله عنه، فإن الاعتقاد الثابت عنه موافق لاعتقاد هؤلاء، وهو الذي نطق به الكتاب والسنة:
...
فإن المعاني المفهومة من الكتاب والسنة لا ترد بالشبهات، فيكون ردها من باب تحريف الكلم عن مواضعه، ولا يقال: هي ألفاظ لا تعقل معانيها، ولا يعرف المراد منها فيكون ذلك مشابهة للذين لا يعلمون الكتاب إلا أماني، بل هي آيات بينات، دالة على أشرف المعاني وأجلها، قائمة حقائقها في صدور الذين أوتوا العلم والإيمان',NULL,'25',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (7,'إثباتا بلا تشبيه، وتنزيها بلا تعطيل، كما قامت حقائق سائر صفات الكمال في قلوبهم كذلك؛ فكان الباب عندهم بابا واحدا، قد اطمأنت به قلوبهم، وسكنت إليه نفوسهم، فأنسوا من صفات كماله، ونعوت جلاله، بما استوحش منه الجاهلون المعطلون، وسكنت قلوبهم إلى ما نفر منه الجاحدون، وعلموا أن الصفات حكمها حكم الذات، فكما أن ذاته سبحانه لا تشبه الذوات، فصفاته لا تشبه الصفات، فما جاءهم من الصفات عن المعصوم تلقوه بالقبول، وقابلوه بالمعرفة والإيمان والإقرار، لعلمهم بأنه صفة من لا شبيه لذاته ولا لصفاته.
...
وهو -سبحانه- موصوف بصفات الكمال، منزه عن كل نقص وعيب، وهو -سبحانه- في صفات الكمال لا يماثله شيء، فهو حي، قيوم، سميع، بصير، عليم، خبير، رءوف، رحيم.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (8,'{خَلَقَ السَّمَاوَاتِ وَالْأَرْضَ وَمَا بَيْنَهُمَا فِي سِتَّةِ أَيَّامٍ ثُمَّ اسْتَوَى عَلَى الْعَرْشِ}
...
فإذا كانت المخلوقات الغائبة ليست مثل هذه الموجودة، مع',NULL,'27',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (9,'اتفاقهما في الأسماء فالخالق -جل وعلا- أعظم علوا ومباينة لخلقه من مباينة المخلوق للمخلوق، وإن اتفقت الأسماء.
...
قال الله سبحانه وتعالى: {اللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ} [البقرة: ٢٥٥] .
...
وقال: {وَبَشَّرُوهُ بِغُلَامٍ عَلِيمٍ} [الذاريات: ٢٨] .',NULL,'28',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (10,'وقال الله تعالى: {إِنَّ اللَّهَ كَانَ سَمِيعًا بَصِيرًا} [النساء: ٥٨] .
...
وقد أجمع سلف الأمة وأئمتها على أن الله سبحانه فوق سماواته، على عرشه، بائن من خلقه، والعرش وما سواه فقير إليه، وهو غني عن كل شيء، لا يحتاج إلى العرش ولا غيره، ليس كمثله شيء، لا في ذاته، ولا في صفاته، ولا في أفعاله.',NULL,'29',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (11,'فمن قال: إن الله ليس له علم ولا قدرة ولا كلام، ولا يرضى ولا يغضب ولا استوى على العرش فهو معطل ملعون.
...
- قال الله سبحانه وتعالى: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] .',NULL,'30',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (12,'- وقال تعالى: {اللَّهُ الَّذِي خَلَقَ السَّمَاوَاتِ وَالْأَرْضَ وَمَا بَيْنَهُمَا فِي سِتَّةِ أَيَّامٍ ثُمَّ اسْتَوَى عَلَى الْعَرْشِ}
[الفرقان: ٥٩، والسجدة: ٤] .
...
- وقال: {أَأَمِنْتُمْ مَنْ فِي السَّمَاءِ أَنْ يَخْسِفَ بِكُمُ الْأَرْضَ فَإِذَا هِيَ تَمُورُ أَمْ أَمِنْتُمْ مَنْ فِي السَّمَاءِ أَنْ يُرْسِلَ عَلَيْكُمْ حَاصِبًا فَسَتَعْلَمُونَ كَيْفَ نَذِيرِ} [الملك:١٦ و١٧] .',NULL,'31',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (13,'وأخبر عن فرعون أنه قال: {يَاهَامَانُ ابْنِ لِي صَرْحًا لَعَلِّي أَبْلُغُ الْأَسْبَابَ أَسْبَابَ السَّمَاوَاتِ فَأَطَّلِعَ إِلَى إِلَهِ مُوسَى وَإِنِّي لَأَظُنُّهُ كَاذِبًا} [غافر: ٣٦ و٣٧] .
...
[الحديد: ٤] .
فقوله: {هُوَ الَّذِي خَلَقَ السَّمَاوَاتِ وَالْأَرْضَ فِي سِتَّةِ أَيَّامٍ}',NULL,'32',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (14,'يتضمن إبطال قول الملاحدة القائلين بقدم العالم وأنه لم يزل وأنه لم يخلقه بقدرته ومشيئته، ومن أثبت منهم وجود الرب جعله لازما لذاته أزلا وأبدا غير مخلوق؛ كما هو قول ابن سينا وأتباعه الملاحدة.
وقوله تعالى: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} يتضمن إبطال قول المعطلة الذين يقولون: ليس على العرش سوى العدم، وإن الله ليس مستويا على عرشه ولا ترفع إليه الأيدي، ولا تجوز الإشارة إليه بالأصابع إلى فوق كما أشار النبي صلى الله عليه وسلم في أعظم مجامعه في حجة الوداع، وجعل يرفع إصبعه إلى السماء، وينكبها إلى الناس، ويقول: " اللهم اشهد". وسيأتي الحديث إن شاء الله تعالى؛ فأخبر في هذه الآية الكريمة أنه على عرشه، وأنه: {يَعْلَمُ مَا يَلِجُ فِي الْأَرْضِ وَمَا يَخْرُجُ مِنْهَا وَمَا يَنْزِلُ مِنَ السَّمَاءِ وَمَا يَعْرُجُ فِيهَا} ، ثم قال: {وَهُوَ مَعَكُمْ أَيْنَ مَا كُنْتُمْ}',NULL,'33',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (15,'فأخبر أنه مع علوه على خلقه وارتفاعه ومباينته لهم معهم بعلمه أينما كانوا.
...
وأخبر تعالى أنه ذو المعارج، تعرج الملائكه والروح إليه، وأنه',NULL,'34',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (16,'القاهرفوق عباده، وأن ملائكته يخافون ربهم من فوقهم، فكل هذا الكلام الذي ذكره الله من أنه فوق عباده على عرشه وأنه معنا حق على حقيقته، لا يحتاج إلى تحريف، ولكن يصان عن الظنون الكاذبة.
...
وقال النبي صلى الله عليه وسلم: «إن الذي تدعونه أقرب إلى أحدكم من عنق راحلته» .',NULL,'35',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (17,'وقوله تعالى: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ وَلَا خَمْسَةٍ إِلَّا هُوَ سَادِسُهُمْ وَلَا أَدْنَى مِنْ ذَلِكَ وَلَا أَكْثَرَ إِلَّا هُوَ مَعَهُمْ أَيْنَ مَا كَانُوا} [المجادلة: ٧] .
...
وسيأتي هذا الكلام مع زيادة عليه من كلام الإمام أحمد وغيره إن شاء الله تعالى.',NULL,'36',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (18,'<span data-type="title" id=toc-3>إثبات صفة العلو من السنة</span>
...
وفي صحيح البخاري عن أنس بن مالك رضي الله عنه قال: كانت',NULL,'37',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (19,'زينب تفخر على أزواج النبي صلى الله عليه وسلم وتقول: زوجكن أهاليكن، وزوجني الله من فوق سبع سماوات.
...
وفي صحيح مسلم عن أبي موسى، قال: «قام فينا رسول الله صلى الله عليه وسلم بخمس كلمات، فقال: إن الله لا ينام، ولا ينبغي له أن ينام، يخفض القسط ويرفعه، يرفع إليه عمل الليل قبل النهار»',NULL,'38',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (20,'«وعمل النهار قبل الليل، حجابه النور، لو كشفه لأحرق سبحات وجهه ما انتهى إليه بصره من خلقه» ".
...
وعن أبي الدرداء قال: سمعت رسول الله صلى الله عليه وسلم يقول: «من اشتكى منكم أو اشتكى أخ له فليقل: ربنا الله الذي في السماء تقدس اسمك، أمرك في السماء والأرض، كما رحمتك في السماء اجعل رحمتك في الأرض، واغفر لنا حوبنا وخطايانا أنت رب الطيبين، أنزل رحمة من رحمتك وشفاء من شفائك على هذا الوجع، فيبرأ» أخرجه أبو داود.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (21,'وفي الصحيحين في قصة المعراج، وهي متوترة: " «وتجاوز النبي صلى الله عليه وسلم السماوات سماء سماء حتى انتهى إلى ربه تعالى، فقربه وأدناه، وفرض عليه خمسين صلاة، فلم يزل يتردد بين موسى وبين ربه، ينزل من عند ربه إلى موسى، فيسأله: كم فرض عليك؟ فيخبره، فيقول: ارجع إلى ربك فسله التخفيف» ".
وذكر البخاري في كتاب التوحيد من صحيحه حديث أنس حديث الإسراء، وقال فيه: " «ثم علا به - يعني جبريل - فوق ذلك بما لا يعلم إلا الله حتى جاوز سدرة المنتهى، ودنا الجبار رب العزة، فتدلى حتى كان قاب قوسين أو أدنى، فأوحى إليه فيما أوحى خمسين صلاة كل يوم وليلة، ثم هبط حتى بلغ موسى، فاحتبسه موسى، فقال: يا محمد، ماذا عهد إليك ربك؟ قال: عهد إلي خمسين صلاة كل يوم وليلة، قال: إن أمتك لا تستطيع ذلك فارجع فليخفف عنك ربك وعنهم، فالتفت النبي صلى الله عليه وسلم إلى جبريل كأنه يستشيره في ذلك، فأشار إليه»',NULL,'40',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (22,'«جبريل أن نعم إن شئت، فعلا به إلى الجبار تبارك وتعالى فقال وهو في مكانه: يا رب خفف عنا» . وذكر الحديث.
...
وفي الصحيحين من حديث أبي سعيد قال: «بعث علي بن أبي طالب إلى النبي صلى الله عليه وسلم بذهيبة في أديم مقروض»',NULL,'41',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (23,'«لم تحصل من ترابها، قال: "فقسها بين أربعة: بين عيينة بن حصن بن بدر، والأقرع بن حابس، وزيد الخيل، والرابع إما علقمة، وإما عامر بن الطفيل "، فقال رجل من أصحابه: كنا نحن أحق بهذا من هؤلاء، فبلغ ذلك النبي صلى الله عليه وسلم فقال: ألا تأمنوني، وأنا أمين من في السماء، يأتيني خبر السماء صباحا ومساء» .
وفي سنن أبي داود من حديث جبير بن مطعم، قال: «جاء أعرابي إلى رسول الله صلى الله عليه وسلم فقال: يا رسول الله، نهكت الأنفس، وجاع العيال، وهلكت الأموال، فاستسق لنا ربك، فإنا نستشفع بالله عليك وبك على الله، فقال النبي صلى الله عليه وسلم: "سبحان الله، سبحان الله"، فما زال يسبح حتى عرف ذلك في وجوه أصحابه، فقال: "ويحك، أتدري ما الله؟ إن شأنه أعظم من ذلك، إنه لا يستشفع به على أحد من خلقه، إنه لفوق سماواته على عرشه، وإنه عليه لهكذا، وإنه ليئط به أطيط الرحل بالراكب» . وقد ساق الذهبي',NULL,'42',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (24,'هذا الحديث في كتاب العلو من رواية محمد بن إسحاق، ثم قال: (هذا حديث غريب جدا، وابن إسحاق حجة في المغازي إذا أسند، وله مناكير وعجائب، فالله أعلم قال النبي صلى الله عليه وسلم هذا أم لا؟ والله عز وجل ليس كمثله شيء جل جلاله وتقدست أسماؤه ولا إله غيره.
...
وفي صحيح مسلم عن أبي هريرة رضي الله عنه أن النبي صلى الله عليه وسلم قال: «والذي نفسي بيده ما من رجل يدعو امرأته»',NULL,'45',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (27,'«إلى فراشه فتأبى عليه إلا كان الذي في السماء ساخطا عليها حتى يرضى عنها» .
...
وصح عن أبي هريرة بإسناد مسلم قال: قال رسول الله صلى الله عليه وسلم: «إن لله ملائكة سيارة يتتبعون مجالس الذكر، فإذا وجدوا مجلس ذكر جلسوا معهم، فإذا تفرقوا صعدوا إلى ربهم» . وأصل الحديث في صحيح مسلم، ولفظه: «فإذا تفرقوا صعدوا إلى السماء، فيسألهم الله عز وجل، وهو أعلم بهم: من أين جئتم؟» الحديث.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (28,'والأحاديث في هذا الباب كثيرة جدا لا يتسع هذا الجواب لبسطها، وفيما ذكرنا كفاية لمن هداه الله وألهمه رشده، وأما من أراد الله فتنته فلا حيلة فيه، بل لا تزيده كثرة الأدلة إلا حيرة وضلالا؛ كما قال تعالى: {وَلَيَزِيدَنَّ كَثِيرًا مِنْهُمْ مَا أُنْزِلَ إِلَيْكَ مِنْ رَبِّكَ طُغْيَانًا وَكُفْرًا} [المائدة:٦٤ و٦٨] .
وقال: {وَنُنَزِّلُ مِنَ الْقُرْآنِ مَا هُوَ شِفَاءٌ وَرَحْمَةٌ لِلْمُؤْمِنِينَ وَلَا يَزِيدُ الظَّالِمِينَ إِلَّا خَسَارًا}
[الإسراء:٨٢] .
وقال جل ذكره: {يُضِلُّ بِهِ كَثِيرًا وَيَهْدِي بِهِ كَثِيرًا} [البقرة: ٢٦] .
وقال تبارك وتعالى: {وَأَمَّا الَّذِينَ فِي قُلُوبِهِمْ مَرَضٌ فَزَادَتْهُمْ رِجْسًا إِلَى رِجْسِهِمْ وَمَاتُوا وَهُمْ كَافِرُونَ} [التوبة:١٢٥] .
وقال سبحانه وتعالى: {قُلْ هُوَ لِلَّذِينَ آمَنُوا هُدًى وَشِفَاءٌ وَالَّذِينَ لَا يُؤْمِنُونَ فِي آذَانِهِمْ وَقْرٌ وَهُوَ عَلَيْهِمْ عَمًى أُولَئِكَ يُنَادَوْنَ مِنْ مَكَانٍ بَعِيدٍ} [فصلت: ٤٤] .',NULL,'47',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (29,'<span data-type="title" id=toc-4>[الكلام في الكيفية]</span>
...
قيل له: كيف هو؟ فإذا قال: أنا لا أعلم كيفيته. قيل: ونحن لا نعلم كيفية نزوله إذ العلم بكيفية الصفة يستلزم العلم بكيفية الموصوف، وهو فرع له، فكيف تطالبني بكيفية استوائه على عرشة وتكليمه ونزوله وأنت لا تعلم كيفية ذاته؟ وإذا كنت تقر بأن له ذاتا حقيقة ثابتة في نفس الأمر مستوجبة لصفات الكمال لا يماثلها شيء، فاستواؤه ونزوله وكلامه ثابت في نفس الأمر، ولا يشابهه فيها استواء المخلوقين وكلامهم ونزولهم، فإن الله تعالى ليس كمثله شيء، لا في ذاته ولا في صفاته ولا في أفعاله، فإذا كان له ذات حقيقة لا تماثل',NULL,'48',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (30,'الذوات، فالذات متصفة بصفات حقيقية لا تماثل، صفات سائر الذوات، فإن الكلام في الصفات فرع على الكلام في الذات. فإذا كانت ذاته لا تشبه ذوات المخلوقين فصفات الخالق لا تشبه صفات المخلوقين.
...
ومنها: أن يصف الرب بنقيض تلك الصفات من صفات الجمادات أو صفات المعدومات، فيكون قد عطل صفات الكمال التي يستحقها',NULL,'49',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (31,'الرب، ومثله بالمنقوصات والمعدومات، وعطل النصوص عما دلت عليه من الصفات، وجعل مدلولها هو التمثيل بالمخلوقات، فجمع في الله وفي كلام الله بين التعطيل والتمثيل، فيكون ملحدا في أسمائه وآياته.
[الاستواء ومعناه]
...
فلو قال القائل: العرش في السماء أو في الأرض؟ لقيل: في السماء، ولو قيل: الجنة في السماء أم في الأرض؟ لقيل: في السماء،',NULL,'51',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (33,'ولم يلزم من ذلك أن يكون العرش داخل السماوات، بل ولا الجنة، فإن السماء يراد به العلو سواء كان فوق الأفلاك أو تحتها.
...
وإذا قيل: العلو - فإنه يتناول ما فوق المخلوقات كلها، فما فوقها كلها هو في السماء، ولا يقتضي هذا أن يكون هناك ظرف وجودي يحيط به، إذ ليس فوق العالم إلا الله، كما لو قيل العرش في السماء كان المراد أنه عليها.',NULL,'52',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (34,'كما قال تعالى: {فَسِيرُوا فِي الْأَرْضِ} [آل عمران: ١٣٧، والنحل: ٣٦] .
...
والله تعالى قد فطر العباد عربهم وعجمهم على أنهم إذا دعوا',NULL,'53',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (35,'الله توجهت قلوبهم إلى العلو، ولهذا قال بعض العارفين: ما قال عارف قط بالله: يالله، إلا وجد في قلبه قبل أن يتحرك لسانه معنى يطلب العلو، لا يلتفت يمنة ولا يسرة. بل قد فطر الله على ذلك جميع الأمم في الجاهلية والإسلام؛ إلا من اجتالته الشياطين عن فطرته.
...
وهذا هو الذي أراده يزيد بن هارون الواسطي المتفق على إمامته وجلالته وفضله، وهو من أتباع التابعين، حيث قال: من زعم أن',NULL,'54',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (36,'"الرحمن على العرش استوى" خلاف ما يقر في نفوس العامة، فهو جهمي.
...
بل قد ثبت في الصحيح عن جابر بن عبد الله رضي الله تعالى عنهما أن النبي صلى الله عليه وسلم لما خطب خطبته العظيمة يوم عرفات، في أعظم مجمع حضره رسول الله صلى الله عليه وسلم جعل يقول: «ألا هل بلغت؟ فيقولون: نعم، فيرفع إصبعه إلى السماء وينكبها إليهم، ويقول: اللهم اشهد» ، وقد تقدمت الإشارة إلى هذا الحديث.',NULL,'55',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (37,'<span data-type="title" id=toc-7>[معنى: ظاهرها غير مراد]</span>
...
ومن ظن أن نصوص الصفات لا يعقل معناها ولا يدري ما أراد الله',NULL,'56',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (38,'ورسوله منها، ولكن يقرؤها ألفاظا لا معاني لها، ويعلم أن لها تأويلا لا يعلمه إلا الله وأنها بمنزلة {كهيعص} ، {حم عسق} ، {المص} ، وظن أن هذه طريقة السلف، وأنهم لم يكونوا يعرفون حقائق الأسماء والصفات، ولا يعلمون حقيقة قوله تعالى: {وَالْأَرْضُ جَمِيعًا قَبْضَتُهُ يَوْمَ الْقِيَامَةِ وَالسَّماوَاتُ مَطْوِيَّاتٌ بِيَمِينِهِ} [الزمر: ٦٧] ، وقوله: {مَا مَنَعَكَ أَنْ تَسْجُدَ لِمَا خَلَقْتُ بِيَدَيَّ} [ص: ٧٥] ، وقوله: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، ونحو ذلك - فهذا الظان من أجهل الناس بعقيدة السلف.
...
بل السلف -رضي الله عنهم- أثبتوا لله حقائق الأسماء والصفات، ونفوا عنه مماثلة المخلوقات، فكان مذهبهم مذهبا بين مذهبين وهدى',NULL,'57',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (39,'بين ضلالين، خرج من مذهب المعطلين والمشبهين كما خرج اللبن: {مِنْ بَيْنِ فَرْثٍ وَدَمٍ لَبَنًا خَالِصًا سَائِغًا لِلشَّارِبِينَ} [النحل: ٦٦] .
...
والناطقون بهذه الألفاظ قد يريدون معنى صحيحا، وقد يريدون معنى فاسدا، فإذا قال: إن الله في جهة، قيل له: ما تريد بذلك؟ أتريد أن الله سبحانه في جهة تحصره وتحيط به؟ أم تريد أمرا عدميا، وهو',NULL,'60',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (42,'ما فوق العالم، فإنه ليس فوق العالم شيء من المخلوقات؟
...
وجاء مجموعا كقوله: {عَمِلَتْ أَيْدِينَا} [يس: ٧١] .',NULL,'63',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (45,'فحيث ذكر اليد مثناة أضاف الفعل إلى نفسه بضمير الإفراد، وعدى الفعل بالباء إليها، فقال: {خَلَقْتُ بِيَدَيَّ} .
...
وأما قوله: {خَلَقْتُ بِيَدَيَّ} فلو كان المراد منه مجرد الفعل لم يكن لذكر اليد بعد نسبة الفعل إلى الفاعل معنى، فكيف وقد دخلت الباء، فالفعل قد يضاف إلى يد',NULL,'64',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (46,'ذي اليد، والمراد الإضافة إليه؛ كقوله: {فَبِمَا كَسَبَتْ أَيْدِيكُمْ} .
...
وقد صح عن النبي صلى الله عليه وسلم: «إن أهل الموقف يأتون آدم، فيقولون: أنت أبو البشر، خلقك الله بيده ونفخ فيك من روحه، وأسجد لك ملائكته، وعلمك أسماء كل شيء» فذكروا أربعة أشياء كلها خصائصه.',NULL,'65',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (47,'وكذلك «قال آدم لموسى -عليهما السلام- في محاجته له: (اصطفاك الله بكلامه، وخط لك الألواح بيده» ) . وفي لفظ آخر: ( «كتب الله لك التوراة بيده» ) وهو من أصح الأحاديث.
...
وأيضا فإن لو كان قوله {خَلَقْتُ بِيَدَيَّ} - مثل قوله {عَمِلَتْ أَيْدِينَا} ؛ لكان آدم والأنعام سواء، وأهل الموقف قالوا: «أنت أبو البشر خلقك الله بيده» ، فعلموا أن لآدم تخصيصا وتفضيلا بكونه مخلوقا باليدين.',NULL,'66',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (48,'وقد ثبت في الصحيح عن النبي صلى الله عليه وسلم: «يقبض الله سماواته بيده اليمنى والأرض بيده الأخرى» .
...
وقال عبد الله بن الحارث: قال النبي صلى الله عليه وسلم: «خلق الله ثلاثة أشياء بيده: خلق آدم بيده، وكتب التوراة بيده، وغرس الفردوس بيده، قال: وعزتي لا يسكنها مدمن خمر ولا ديوث» . وفي الصحيح عنه صلى الله عليها وسلم: «تكون الأرض يوم القيامة خبزة واحدة، يتكفأها الجبار كما يتكفأ أحدكم خبزته في السفر؛ نزلا لأهل الجنة» .',NULL,'67',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (49,'وفي الصحيح مرفوعا: «إن الله يبسط يده بالليل ليتوب مسيء النهار، ويبسط يده بالنهار ليتوب مسيء الليل» .
...
وعن أبي هريرة رضي الله عنه عن النبي صلى الله عليه وسلم قال: «ما تصدق أحد بصدقة من كسب طيب -ولا يقبل الله إلا طيبا- إلا أخذها الرحمن بيمينه، فتربو في كف الرحمن حتى تكون»',NULL,'68',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (50,'«أعظم من الجبل» متفق على صحته.
...
وقال ابن وهب، عن أسامة، عن نافع، عن ابن عمر أن النبي صلى الله عليه وسلم قرأ على المنبر: {وَالْأَرْضُ جَمِيعًا قَبْضَتُهُ يَوْمَ الْقِيَامَةِ وَالسَّماوَاتُ مَطْوِيَّاتٌ بِيَمِينِهِ} [الزمر: ٦٧]',NULL,'69',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (51,'قال: «مطوية في كفه يرمي بها كما يرمي الغلام بالكرة» .
وهذه النصوص التي ذكرنا هي غيض من فيض، وفيما ذكرنا كفاية لمن هداه الله. {وَمَنْ لَمْ يَجْعَلِ اللَّهُ لَهُ نُورًا فَمَا لَهُ مِنْ نُورٍ} [النور: ٤٠] .',NULL,'70',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (52,'<span data-type="title" id=toc-10>فصل
في ذكر بعض ما ورد عن الصحابة والتابعين وأتباع
التابعين في مسألة علو الرب تبارك وتعالى </span>على
...
وروى ابن أبي شيبة عن قيس، قال: لما قدم عمر الشام استقبله الناس وهو على بعيره، فقالوا: يا أمير المؤمنين، لو ركبت برذونا يلقاك',NULL,'71',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (53,'عظماء الناس ووجوهم، فقال عمر رضي الله عنه: ألا أراكم هاهنا؟ إنما الأمر من هاهنا. وأشار بيده إلى السماء.
...
وأن العرش فوق الماء طاف ... وفوق العرش رب العالمينا',NULL,'72',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (54,'وتحمله ملائكة شداد ... ملائكة الإله مسومينا
...
وروى الدارمي عن نافع، قال: قالت عائشة: وأيم الله لو كنت أحب قتله لقتلته -يعني عثمان - وقد علم الله فوق عرشه أني لا أحب قتله.',NULL,'73',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (55,'وفي الصحيحين: أن زينب كانت تفتخر على أزواج رسول الله صلى الله عليه وسلم، تقول: زوجكن أهاليكن، وزوجني الله من فوق سبع سماوات. وقد تقدم ذلك، وفي لفظ لغيرهما: كانت تقول: زوجني الرحمن من فوق عرشه، كان جبرائيل السفير بذلك، وأنا ابنة عمتك.
...
وقال مقاتل في قوله تعالى: {وَلَا أَدْنَى مِنْ ذَلِكَ وَلَا أَكْثَرَ إِلَّا هُوَ مَعَهُمْ أَيْنَ مَا كَانُوا} [المجادلة: ٧] .',NULL,'74',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (56,'قال: بعلمه يعلم نجواهم ويسمع كلامهم، وهو فوق عرشه وعلمه معهم.
...
وقال أبو عمر بن عبد البر في التمهيد: علماء الصحابة والتابعين الذين حمل عنهم التأويل قالوا في تأويل قوله تعالى: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ وَلَا خَمْسَةٍ إِلَّا هُوَ سَادِسُهُمْ} الآية [المجادلة: ٧]',NULL,'75',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (57,'هو على العرش وعلمه في كل مكان، وما خالفهم في ذلك أحد يحتج بقوله.
...
وقال سفيان الثوري في قوله: {وَهُوَ مَعَكُمْ أَيْنَ مَا كُنْتُمْ} ، قال: علمه.',NULL,'76',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (58,'وروى الخلال بإسناد، كل رجاله أئمة، عن سفيان بن عيينة قال: سئل ربيعة بن أبي عبد الرحمن عن قوله {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] : كيف استوى؟ قال: "الاستواء غير مجهول، والكيف غير معقول، ومن الله الرسالة، وعلى الرسول البلاغ، وعلينا التصديق". وهذا الكلام مروي عن مالك تلميذ ربيعة، كما سيأتي بيانه إن شاء الله تعالى.
...
وقال عباد بن العوام أحد أئمة الحديث بواسط: كلمت بشرا المريسي وأصحابه، فرأيت آخر كلامهم: ليس على العرش شيء، أرى والله ألا يناكحوا ولا يوارثوا.',NULL,'77',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (59,'وقال علي بن عاصم شيخ الإمام أحمد: احذروا من المريسي وأصحابه، فإن كلامهم الزندقة، وأنا كلمت أستاذهم، فلم يثبت أن في السماء إلها.
...
وذكر ابن أبي حاتم بإسناده، عن الأصمعي، قال: قدمت امرأة جهم، فقال رجل عندها: الله على عرشه، فقالت: محدود على محدود،',NULL,'80',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (62,'فقال الأصمعي: هذه كافرة بهذه المقالة، أما هذا الرجل وامرأته فما أولاهما بأن {سَيَصْلَى نَارًا ذَاتَ لَهَبٍ وَامْرَأَتُهُ حَمَّالَةَ الْحَطَبِ} [المسد: ٣-٤] .
...
وقال قتيبة بن سعيد: هذا قول أئمة الإسلام والسنة والجماعة:',NULL,'81',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (63,'نعرف ربنا بأنه في السماء السابعة على عرشه؛ كما قال: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] .
...
وقال عبد الرحمن بن أبي حاتم: سألت أبي وأبا زرعة عن مذهب أهل السنة في أصول الدين وما أدركا عليه العلماء في جميع الأمصار وما يعتقدون من ذلك؟ فقالا: أدركنا العلماء في جميع الأمصار حجازا وعراقا ومصرا وشاما ويمنا، فكان مذهبهم أن الله تبارك وتعالى على عرشه؛ بائن من خلقه؛ كما وصف نفسه وعلى لسان رسوله صلى الله عليه وسلم بلا كيف، وأحاط بكل شيء علما.',NULL,'82',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (64,'وقال أبو زرعة أيضا: هو على العرش استوى، وعلمه في كل مكان، من قال غير هذا فعليه لعنة الله.
...
فقيل له: ما تقول في قوله تعالى: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ} [المجادلة: ٧] ، فقال: اقرأ أول الآية، يعني بالعلم؛ لأن أول الآية {أَلَمْ تَرَ أَنَّ اللَّهَ يَعْلَمُ} .
...
وقال نعيم بن حماد الخزاعي الحافظ في قوله تعالى: {وَهُوَ مَعَكُمْ أَيْنَ مَا كُنْتُمْ} [الحديد: ٤] : معناه أنه لا يخفي عليه خافية بعلمه، ثم تلى قوله تعالى: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ} الآية [المجادلة: ٧] .',NULL,'83',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (65,'وقال محمد بن إسماعيل البخاري: سمعت نعيم بن حماد، يقول: من شبه الله بخلقه فقد كفر، ومن جحد ما وصف الله به نفسه فقد كفر، وليس ما وصف به نفسه ولا رسوله تشبيها.',NULL,'84',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (66,'<span data-type="title" id=toc-11>فصل
في ذكر أقوال الأئمة الأربعة
رضي الله عنهم</span>
<span data-type="title" id=toc-12>ذكر قول الإمام أبي حنيفة </span>رضي الله عنه
روى البيهقي في كتاب الصفات عن نعيم بن حماد، قال: سمعت نوح بن أبي مريم، يقول: كنت عند أبي حنيفة أول ما ظهر؛ إذ جاءته امرأة من ترمذ، وكانت تجالس جهما، فدخلت الكوفة، فأظنني أقل ما رأيت عليها عشرة آلاف نفس، فقيل لها: إن هاهنا رجلا قد نظر في المعقول يقال له أبو حنيفة، فأتته، فقالت: أنت الذي تعلم الناس المسائل، وقد تركت دينك، أين إلهك الذي تعبد؟ فسكت عنها، ثم مكث سبعة أيام لا يجيبها، ثم خرج إلينا، وقد وضع كتابا: أن الله عز وجل في السماء دون الأرض، فقال له رجل: أرأيت قول الله تعالى: {وَهُوَ مَعَكُمْ أَيْنَ مَا كُنْتُمْ} [الحديد: ٤] .
قال: هو كما تكتب إلى الرجل إني معك، وأنت غائب عنه.
ثم قال البيهقي: لقد أصاب أبو حنيفة رحمه الله فيما نفى عن الله',NULL,'85',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (67,'عز وجل من الكون في الأرض، وأصاب فيما ذكر من تأويل الآية، واتبع مطلق السمع بأن الله تعالى في السماء.
وفي كتاب الفقه الأكبر المشهور المروي بالأسانيد عن أبي مطيع الحكم بن عبد الله البلخي، قال: سألت أبا حنيفة عمن يقول لا أعرف ربي في السماء أو الأرض؟ قال: قد كفر، إن الله تعالى يقول: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، وعرشه فوق سماواته. فقلت: إنه يقول: أقول إنه على العرش، ولكنه قال: لا أدري العرش في السماء أم في الأرض! قال: إذا أنكر أنه في السماء فقد كفر؛ لأن الله تعالى في أعلى عليين، وأنه يدعى من أعلى لا من أسفل.
وفي لفظ: سألت أبا حنيفة عمن يقول: لا أعرف ربي في السماء أو في الأرض، قال: قد كفر؛ لأن الله تعالى يقول: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، وعرشه فوق سبع سماواته.
روى هذا شيخ الإسلام أبو إسماعيل الأنصاري في كتاب (الفاروق) .',NULL,'86',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (68,'وقال الإمام أبو محمد موفق الدين بن قدامة: بلغني عن أبي حنيفة رحمه الله أنه قال: من أنكر أن الله عز وجل في السماء فقد كفر.
...
وكذلك أصحاب أبي حنيفة من بعده كأبي يوسف ومحمد؛ كما قدمنا ما روي عنهم، وكذلك هشام بن عبيد الله؛ كما روى ابن أبي حاتم وشيخ الإسلام بإسنادهما أن هشام بن عبيد الله صاحب',NULL,'87',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (69,'محمد بن الحسن قاضي الري حبس رجلا في التجهم، فتاب، فجيء به ليمتحنه، فقال: الحمد الله على التوبة، فامتحنه هشام فقال: أتشهد أن الله على عرشه بائن من خلقه؟ فقال أشهد أن الله على عرشه، ولا أدري "ما بائن من خلقه"، فقال: ردوه إلى الحبس فإنه لم يتب.
...
وقال في الفقه الأكبر أيضا: وله تعالى يد ووجه ونفس، بلا كيف ذكر الله تعالى في القرآن، وغضبه ورضاه وقضاه وقدرته من صفاته تعالى بلا كيف، ولا يقال غضبه عقابه، ولا رضاه ثوابه. انتهي.',NULL,'88',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (70,'<span data-type="title" id=toc-13>ذكر قول الإمام مالك بن أنس</span>
...
وأيضا فإن من ينفي الصفات',NULL,'89',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (71,'لا يحتاج أن يقول بلا كيف، فلو كان مذهب السلف نفي الصفات في نفس الأمر؛ لما قالوا: بلا كيف، فمن قال: إن الله ليس على العرش لا يحتاج أن يقول بلا كيف.
...
وقال أبو حاتم الرازي: حدثني ميمون بن يحيى البكري، قال: قال مالك: من قال القرآن مخلوق يستتاب، فإن تاب وإلا ضربت عنقه.',NULL,'90',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (72,'<span data-type="title" id=toc-14>ذكر قول الإمام محمد بن إدريس الشافعي</span>
رضي الله عنه
...
وقال حنبل: قيل لأبي عبد الله: ما معنى قوله {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ} [المجادلة: ٧] ،',NULL,'92',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (74,'وقوله: {وَهُوَ مَعَكُمْ} [الحديد: ٤] ؟
...
قال: علمه في كل مكان، وعلمه معهم، وقال: أول الآية يدل على أنه علمه.',NULL,'93',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (75,'وقال في موضع آخر: وإن الله عز وجل على عرشه فوق السماء السابعة، يعلم ما تحت الأرض السفلى، وإنه غير مختلط بشيء من خلقه، هو تبارك وتعالى بائن من خلقه، وخلقه بائنون منه.
...
قال أحمد: فقلنا: قد عرف المسلمون أماكن كثيرة ليس فيها من عظمة الرب شيء؛ أجسامكم وأجوافكم والحشوش والأماكن القذرة ليس فيها شيء من عظمته، وقد أخبرنا الله عز وجل أنه في السماء، فقال: {أَأَمِنْتُمْ مَنْ فِي السَّمَاءِ أَنْ يَخْسِفَ بِكُمُ الْأَرْضَ} الآيتين [الملك: ١٦ و ١٧] .',NULL,'94',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (76,'وقال: {إِلَيْهِ يَصْعَدُ الْكَلِمُ الطَّيِّبُ} [فاطر: ١٠] ، {إِنِّي مُتَوَفِّيكَ وَرَافِعُكَ إِلَيَّ} [آل عمران: ٥٥] ، {بَلْ رَفَعَهُ اللَّهُ إِلَيْهِ} [النساء: ١٥٨] .
وقال أيضا في الكتاب المذكور: ومما أنكرت الجهمية الضلال أن الله على العرش، وقد قال تعالى: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه:٥] ، وقال: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} [الأعراف: ٥٤، وغيرها] .
ثم ساق أدلة القرآن، ثم قال: ومعنى قوله {وَهُوَ اللَّهُ فِي السَّمَاوَاتِ وَفِي الْأَرْضِ} [الأنعام:٣] ، يقول: هو إله من في السماوات وإله من في الأرض، وهو على العرش، وقد أحاط علمه بما دون العرش، لا يخلو من علمه مكان، ولا يكون علم الله في مكان دون مكان، وذلك لقوله تعالى: {لِتَعْلَمُوا أَنَّ اللَّهَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ وَأَنَّ اللَّهَ قَدْ أَحَاطَ بِكُلِّ شَيْءٍ عِلْمًا} [الطلاق: ١٢] .',NULL,'95',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (77,'قال الإمام أحمد: ومن الاعتبار في ذلك لو أن رجلا كان في يده قدح من قوارير، وفيه شيء، كان نظر ابن آدم قد أحاط بالقدح من غير أن يكون ابن آدم في القدح، فالله سبحانه وله المثل الأعلى قد أحاط بجميع ما خلق علما من غير أن يكون في شيء مما خلق.
...
قال أحمد: وقلنا للجهمية: حين زعمتم أن الله في كل مكان أخبرونا',NULL,'96',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (78,'عن قول الله عز وجل {فَلَمَّا تَجَلَّى رَبُّهُ لِلْجَبَلِ جَعَلَهُ دَكًّا} [الأعراف:١٤٣] : أكان في الجبل بزعمكم، فلو كان فيه كما تزعمون لم يكن تجلى له، بل كان سبحانه على العرش، فتجلى لشيء لم يكن فيه، ورأى الجبل شيئا ما رآه قط قبل ذلك.
...
وقال حنبل في موضع آخر عن أحمد: (ليس كمثله شيء) في ذاته كما وصف نفسه، قد أجمل الله الصفة لنفسه، فحد لنفسه صفة "ليس',NULL,'97',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (79,'يشبهه شيء"، وصفاته غير محدودة ولا معلومة، إلا بما وصف به نفسه، قال: فهو سميع بصير، بلا حد ولا تقدير، ولا يبلغ الواصفون صفته، ولا نتعدى القرآن والحديث، فنقول كما قال، ونصفه بما وصف نفسه، ولا نتعدى ذلك، ونؤمن بالقرآن كله، محكمه ومتشابهه، ولا نزيل صفة من صفاته لشناعة شنعت، وما وصف به نفسه من كلام ونزول وخلوة بعبده يوم القيامة ووضع كنفه عليه، فهذا كله يدل على أن الله سبحانه يرى في الآخرة، والتحديد في هذا كله بدعة، والتسليم فيه بغير صفة ولا حد، إلا بما وصف به نفسه، سميع بصير، لم يزل متكلما، عليم غفور، {عَالِمُ الْغَيْبِ وَالشَّهَادَةِ} [الأنعام: ٧٣، وغيرها] ، {عَلَّامُ الْغُيُوبِ} [المائدة: ١١٦ و١٠٩، وغيرها] .
فهذه صفات وصف بها نفسه لا تدفع ولا ترد، وهو على العرش بلا حد؛ كما قال تعالى: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} [الأعراف: ٥٤] ، {لَيْسَ كَمِثْلِهِ شَيْءٌ} [الشورى: ١١] ، وهو: {خَالِقُ كُلِّ شَيْءٍ} [الأنعام: ١٠٢ وغيرها] ، وهو سميع',NULL,'98',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (80,'بصير، بلا حد ولا تقدير، ولا نتعدي القرآن والحديث، تعالى الله عما تقول الجهمية والمشبهة.
...
رضي الله عنه وعن إخوانه من أئمة الدين.',NULL,'99',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (81,'فصل
...
وقد اتفقت الكلمة من المسلمين على أن الله فوق عرشه فوق سماواته، لا ينزل قبل يوم القيامة إلى الأرض.....، ولم يشكوا أنه ينزل يوم القيامة ليفصل بين عباده ويحاسبهم وتشقق السماوات لنزوله.....، فلما لم يشك المسلمون أن الله لا ينزل إلى الأرض قبل يوم القيامة لشيء من أمور الدنيا علموا يقينا أن ما يأتي الناس من العقوبات إنما هو أمره وعذابه، فقوله {فَأَتَى اللَّهُ بُنْيَانَهُمْ مِنَ الْقَوَاعِدِ} [النحل: ٢٦] ، وإنما هو أمره وعذابه.',NULL,'105',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (85,'وقال في موضع آخر من هذا الكتاب وقد ذكر الحلول:
...
وقال في موضع آخر، وقد ذكر حديث البراء بن عازب الطويل في شأن الروح وقبضها، وفيه: فتصعد روحه حتى تنتهي إلى السماء السابعة،',NULL,'106',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (86,'وذكر الحديث، ثم قال: وفي قوله: {لَا تُفَتَّحُ لَهُمْ أَبْوَابُ السَّمَاءِ} [الأعراف: ٤٠] دلالة ظاهرة أن الله فوق السماء؛ لأنه لو لم يكن فوق السماء لما عرج بالأرواح والأعمال، ولما أغلقت أبواب السماء عن قوم، وفتحت لآخرين.
...
وقال أيضا في قول رسول الله صلى الله عليه وسلم للجارية [أين الله؟] : فيه تكذيب لمن يقول هو في كل مكان، وأن الله لا يوصف بأين، بل يستحيل أن يقال "أين هو؟ "، والله فوق سماواته بائن من خلقه، فمن لم يعرفه بذلك لم يعرف إلهه الذي يعبده.',NULL,'107',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (87,'هذا كله كلام عثمان بن سعيد في كتابه المذكور، وهو قال فيه أبو الفضل القراب: ما رأيت مثل عثمان بن سعيد، ولا رأى عثمان مثل نفسه، أخذ الأدب عن ابن الأعرابي، والفقه عن البويطي، والحديث عن يحيى بن معين، وعلي بن المديني، وأثنى عليه أهل العلم.
...
وهكذا قول أهل العلم من أهل السنة والجماعة، وأما الجهمية فأنكرت هذه الروايات، وقالوا: هذا تشبيه، وفسروها على غير ما فسرها أهل',NULL,'108',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (88,'العلم، وقالوا: إن الله لم يخلق آدم بيده، وأن معنى اليد هاهنا النعمة.
وقال إسحاق بن راهويه: إنما يكون التشبيه إذا قال يد كيدي أو مثل يدي أو سمع كسمعي، فهذا التشبيه، وأما إذا قال كما قال الله يد وسمع وبصر، ولا يقول كيف، ولا يقول مثل سمع وكسمع، فهذا لا يكون تشبيها، قال الله تعالى: {لَيْسَ كَمِثْلِهِ شَيْءٌ وَهُوَ السَّمِيعُ الْبَصِيرُ} [الشورى: ١١] . هذا كله كلام الترمذي.
وقال الإمام
...
وقال في تفسيره الكبير في قوله تعالى: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} [الأعراف: ٥٤] ، قال: علا وارتفع.
وقال في قوله تعالى: {ثُمَّ اسْتَوَى إِلَى السَّمَاءِ} [فصلت: ١١] ،',NULL,'109',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (89,'عن الربيع بن أنس: إنه يعني ارتفع. وقال في قوله عز وجل: {وَقَالَ فِرْعَوْنُ يَاهَامَانُ ابْنِ لِي صَرْحًا لَعَلِّي أَبْلُغُ الْأَسْبَابَ أَسْبَابَ السَّمَاوَاتِ فَأَطَّلِعَ إِلَى إِلَهِ مُوسَى وَإِنِّي لَأَظُنُّهُ كَاذِبًا} [غافر: ٣٦، ٣٧] ، يقول: وإني لأظن موسى كاذبا فيما يقول ويدعي أن له ربا في السماء أرسله إلينا.
وتفسيره هذا مشحون بأقوال السلف على الإثبات.
وقال في كتاب (التبصير في معالم الدين) : القول فيما أدرك علمه من الصفات خبرا، وذلك نحو إخباره أنه سميع بصير، وأن له يدين بقوله {بَلْ يَدَاهُ مَبْسُوطَتَانِ} [المائدة: ٦٤] ، وأن له وجها بقوله {وَيَبْقَى وَجْهُ رَبِّكَ ذُو الْجَلَالِ وَالْإِكْرَامِ} [الرحمن: ٢٧] ، وأن له قدما بقول النبي صلى الله عليه وسلم: «حتى يضع رب العزة فيها قدمه» ، وأنه يضحك بقوله: «لقي الله وهو يضحك إليه» ،',NULL,'110',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (90,'وأنه " «يهبط إلى سماء الدنيا» "، يخبر النبي صلى الله عليه وسلم بذلك، وأن له إصبعا بقوله صلى الله عليه وسلم: «ما من قلب إلا وهو بين إصبعين من أصابع الرحمن» ؛ فإن هذه المعاني التي وصفت ونظائرها مما وصف الله به نفسه ورسوله مما لا يثبت حقيقة علمه بالفكر والروية - لا نكفر بالجهل بها أحدا إلا بعد انتهائها.
ذكر هذا الكلام عنه أبو يعلى في كتاب (إبطال التأويل) .
ومن أراد معرفة أقوال السلف التي حكاها عنهم في تفسيره فليطالع كلامه عند تفسير قوله تعالى: {فَلَمَّا تَجَلَّى رَبُّهُ لِلْجَبَلِ} [الأعراف: ١٤٣] ، وقوله: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} [الأعراف: ٥٤] ، وقوله: {تَكَادُ السَّمَاوَاتُ يَتَفَطَّرْنَ مِنْ فَوْقِهِنَّ} [الشورى: ٥] .',NULL,'111',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (91,'وقال إمام الأئمة
...
سألت -أيدك الله بتوفيقه- بيان ما صح لدي من مذهب السلف وصالحي الخلف في الصفات الواردة في الكتاب والسنة، فاستخرت الله وأجبت عنه بجواب بعض الأئمة الفقهاء، وهو أبو العباس بن سريج رحمه الله، وقد سئل عن مثل هذا السؤال، فقال:',NULL,'112',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (92,'أقول وبالله التوفيق:
...
وكان من أعظم الناس إثباتا للصفات والفوقية وعلو الله على عرشه، منكرا لقول الجهمية، وهو أول من عرف عنه إنكار قيام الأفعال الاختيارية بذات الرب، وأن القرآن معنى قائم بالذات، وهو أربع معان، وَنَصَرَ',NULL,'117',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (97,'طريقته: أبو العباس القلانسي، وأبو الحسن الأشعري، وخالفه في بعض الأشياء، ولكنه على طريقته في إثبات الصفات والفوقية وعلو الله على عرشه، كما سيأتي حكاية كلامه بألفاظه، إن شاء الله تعالى.
...
جملة قولهم الإقرار بالله وملائكته وكتبه ورسله وبما جاء عن الله',NULL,'119',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (99,'وما رواه الثقات عن رسول الله صلى الله عليه وسلم، لا يردون من ذلك شيئا، وأن الله على عرشه كما قال: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، وأن له يدين بلا كيف كما قال: {لِمَا خَلَقْتُ بِيَدَيَّ} [ص:٧٥] ، وكما قال: {بَلْ يَدَاهُ مَبْسُوطَتَانِ} [المائدة: ٦٤] .
...
ويقرون أن الله يجيء يوم القيامة كما قال: {وَجَاءَ رَبُّكَ وَالْمَلَكُ صَفًّا صَفًّا} [الفجر: ٢٢] ، وأن الله يقرب من خلقه كيف شاء.',NULL,'120',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (100,'إلى أن قال: فهذا جملة ما يأمرون به ويستعملون ويروونه، وبكل ما ذكرنا من قولهم نقول، وإليه نذهب، وما توفيقنا إلا بالله.
...
ثم قال: وقالت المعتزلة: "استوى على عرشه" بمعنى استولى، وتأولوا اليد بمعنى النعمة، وقوله {تَجْرِي بِأَعْيُنِنَا} [القمر: ١٤] أي: بعلمنا. وقال أبو الحسن الأشعري في كتاب جمل المقالات:',NULL,'121',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (101,'هذه حكاية جملة قول أصحاب الحديث وأهل السنة:
...
ثم ساق بقية قولهم. وقال في هذا الكتاب: وقالت المعتزلة: إن الله استوى على عرشه بمعنى استولى. هذا نص كلامه.',NULL,'122',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (102,'وقال في الكتاب أيضا: وقالت المعتزلة في قوله {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] : يعني استولى. قال: وتأولت اليد بمعنى النعمة، وقوله {تَجْرِي بِأَعْيُنِنَا} [القمر: ١٤] أي: بعلمنا.
...
وقال حكاية عن فرعون: {يَاهَامَانُ ابْنِ لِي صَرْحًا لَعَلِّي أَبْلُغُ الْأَسْبَابَ أَسْبَابَ السَّمَاوَاتِ فَأَطَّلِعَ إِلَى إِلَهِ مُوسَى وَإِنِّي لَأَظُنُّهُ كَاذِبًا} [غافر: ٣٦ - ٣٧] ،',NULL,'123',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (103,'كذب موسى في قوله إن الله فوق السماوات.
وقال عز وجل: {أَأَمِنْتُمْ مَنْ فِي السَّمَاءِ أَنْ يَخْسِفَ بِكُمُ الْأَرْضَ فَإِذَا هِيَ تَمُورُ} [الملك: ١٦] ، فالسماوات فوقها العرش، فلما كان العرش فوق السماوات، قال: {أَأَمِنْتُمْ مَنْ فِي السَّمَاءِ} [الملك: ١٦] ؛ لأنه مستو على العرش الذي فوق السماوات، وكان كل ما علا فهو سماء، فالعرش أعلى السماوات، وليس إذا قال: {أَأَمِنْتُمْ مَنْ فِي السَّمَاءِ} يعني جميع السماوات؛ وإنما أراد العرش الذي هو أعلى السماوات.
قال: ورأينا المسلمين جميعا يرفعون أيديهم إذا دعوا نحو السماء لأن الله مستو على العرش الذي هو فوق السماوات، فلولا أن الله على العرش لم يرفعوا أيديهم نحو العرش، وقد قال قائلون من المعتزلة والجهمية والحرورية: إن معنى "استوى" استولى وملك وقهر، وأنه تعالى في كل مكان، وجحدوا أن يكون على عرشه، وذهبوا في الاستواء إلى',NULL,'124',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (104,'القدرة، فلو كان كما قالوا؛ كان لا فرق بين العرش وبين الأرض السابعة، لأنه قادر على كل شيء، وكذا لو كان مستويا على العرش بمعنى الاستيلاء لجاز أن يقال هو مستو على الأشياء كلها، ولم يجز عند أحد من المسلمين أن يقول أن الله مستو على الأخلية والحشوش، فبطل أن يكون الاستواء على العرش الاستيلاء.
...
قال الإمام الذهبي في كتاب (العلو) : قال الأستاذ أبو القاسم',NULL,'127',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (107,'القشيري: سمعت أبا علي الدقاق، يقول: سمعت زاهر بن أحمد الفقيه، يقول: مات الأشعري رحمه الله ورأسه في حجري، فكان يقول شيئا في حال نزعه: لعن الله المعتزلة موهوا ومخرقوا.
...
قيل له: قولنا الذي به نقول، وديانتنا التي بها ندين: التمسك بكتاب الله وسنة نبيه صلى الله عليه وسلم وما وري عن الصحابة',NULL,'128',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (108,'والتابعين وأئمة الحديث، ونحن بذلك معتصمون، وبما كان عليه أحمد بن حنبل نضر الله وجهه قائلون، ولمن خالف قوله مجانبون، لأنه الإمام الفاضل، والرئيس الكامل، الذي أبان الله به الحق عند ظهور الضلال، وأوضح به المنهاج وقمع به بدع المبتدعين، وزيغ الزائغين، وشك الشاكين، فرحمة الله عليه من إمام مقدم، وكبير مفهم، وعلى جميع أئمة المسلمين.
وجملة قولنا أنا نقر بالله وملائكته وكتبه ورسله، وما جاء من عند الله، وما رواه الثقات عن رسول الله صلى الله عليه وسلم، لا نرد من ذلك شيئا، وأن الله إله واحد أحد، فرد صمد، لا إله غيره، لم يتخذ صاحبة ولا ولدا، وأن محمدا عبده ورسوله؛ وأن الجنة حق، والنار حق، وأن الساعة آتية لا ريب فيها، وأن الله يبعث من في القبور، وأن الله تعالى مستو على عرشه كما قال: {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، وأن له وجها كما قال: {وَيَبْقَى وَجْهُ رَبِّكَ ذُو الْجَلَالِ وَالْإِكْرَامِ} [الرحمن: ٢٧] ، وأن له يدين كما قال: {بَلْ يَدَاهُ مَبْسُوطَتَانِ} [المائده: ٦٤] ، وأن له عينين بلا كيف كما قال: {تَجْرِي بِأَعْيُنِنَا} [القمر: ١٤] ، وأن من زعم أن اسم الله غيره',NULL,'129',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (109,'كان ضالا، وأن الله علما كما قال: {أَنْزَلَهُ بِعِلْمِهِ} [النساء: ١٦٦] ، ونثبت لله قدرة، ونثبت له السمع والبصر، ولا ننفي ذلك كما نفته المعتزلة والخوارج والجهمية.
...
ثم قال ابن عساكر: فتأملوا رحمكم الله هذا الاعتقاد ما أوضحه وأبينه، واعترفوا بفضل هذا الإمام الذي شرحه وبينه. انتهي.',NULL,'131',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (111,'قال شمس الدين الذهبي رحمه الله: فلو انتهى أصحابنا المتكلمون إلى مقالة أبي الحسن ولزموها لأحسنوا، ولكنهم خاضوا كخوض حكماء الأوائل في الأشياء، ومشوا خلف المنطق، فلا حول ولا قوة إلا بالله.
...
فإن قيل: ما تقولون في قول الله تعالى: {وَهُوَ اللَّهُ فِي السَّمَاوَاتِ وَفِي الْأَرْضِ} [الأنعام:٣] ؟',NULL,'133',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (113,'قيل له: إن بعض القراء يجعل الوقف في "السماوات"، ثم يبتدئ: {وَفِي الْأَرْضِ يَعْلَمُ سِرَّكُمْ} ، وكيفما كان، فلو أن قائلا قال: فلان بالشام والعراق ملك، لدل على ملكه بالشام والعراق، لا أن ذاته فيهما.
...
ثم إن ابن بطة سرد بأسانيده أقوال من قال إنه علمه، فذكره عن',NULL,'134',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (114,'الضحاك، والثوري، ونعيم بن حماد، وأحمد بن حنبل، وإسحاق بن راهويه.
...
وأنه تعالى فوق عرشه المجيد بذاته، وأنه في كل مكان بعلمه. قال الإمام أبو بكر محمد بن وهب المالكي شارح رسالة ابن أبي زيد لما ذكر قوله "وأنه تعالى فوق عرشه المجيد": معنى "فوق" و"على" واحد عند جميع العرب، ثم ساق الآيات والأحاديث، إلى أن قال: وقد تأتي لفظة "في" في لغة العرب بمعنى "فوق"؛ كقوله: {فَامْشُوا فِي مَنَاكِبِهَا} [الملك: ١٥] ، {أَأَمِنْتُمْ مَنْ فِي السَّمَاءِ} [الملك: ١٦] .
قال أهل التأويل: يريد فوقها. وهو قول مالك مما فهمه عن التابعين، مما فهموه عن الصحابة، مما فهموه عن النبي صلى الله عليه وسلم: أن الله في السماء، يعني فوقها، فكذلك قال الشيخ أبو محمد أنه',NULL,'135',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (115,'فوق عرشه، ثم بين أن علوه فوق عرشه إنما هو بذاته بائن عن جميع خلقه، بلا كيف، وهو بكل مكان بعلمه لا بذاته، فلا تحويه الأماكن؛ لأنه أعظم منها. انتهى كلام الشارح.
...
وكان ابن أبي زيد من العلماء العاملين بالمغرب، وكان يلقب بمالك الصغير، وكان غاية في معرفة الأصول، وقد نقموا عليه في قوله بذاته، فليته تركه.',NULL,'137',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (117,'انتهى كلام الذهبي.
ذكر قول القاضي
...
ثم قال في قوله تعالى: {وَهُوَ الَّذِي فِي السَّمَاءِ إِلَهٌ وَفِي الْأَرْضِ إِلَهٌ} [الزخرف: ٨٤] : المراد أنه إله عند أهل السماء، وإله عند أهل الأرض؛ كما تقول العرب: فلان نبيل مطاع في المصرين، أي عند أهلهما، وليس يعنون أن ذات المذكور بالحجاز والعراق موجودة.',NULL,'138',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (118,'وقوله: {إِنَّ اللَّهَ مَعَ الَّذِينَ اتَّقَوْا وَالَّذِينَ هُمْ مُحْسِنُونَ} [النحل: ١٢٨] : يعني بالحفظ والنصر والتأييد، ولم يرد أن ذاته معهم تعالى.
...
ولا يجوز أن يكون معنى استوائه على العرش هو استيلاؤه، كما قال الشاعر: قد استوى بشر على العراق؛ لأن الاستيلاء هو القدرة والقهر، والله تعالى لم يزل قادرا قاهرا. وقوله:',NULL,'139',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (119,'{ثُمَّ اسْتَوَى} [الأعراف: ٥٤] يقتضي استفتاح هذا الوصف بعد أن لم يكن، فبطل ما قالوه. ثم قال: باب، فإن قال قائل: ففصلوا لنا صفات ذاته من صفات أفعاله لنعرف ذلك.
...
إلى أن قال: وقد بينا دين الأئمة وأهل السنة أن هذه الصفات تمر كما جاءت بغير تكييف ولا تحديد ولا تجنيس ولا تصوير؛ كما روي عن',NULL,'140',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (120,'الزهري، وعن مالك في الاستواء، فمن تجاوز هذا فقد تعدى وابتدع وضل. انتهى.
...
وقال في هذا الكتاب أيضا: أجمع أهل السنة على أن الله على العرش على الحقيقة لا على',NULL,'141',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (121,'المجاز. ثم ساق بسنده عن مالك قوله: الله في السماء وعلمه في كل مكان.
...
وكان الطلمنكي هذا من كبار الحفاظ وأئمة القراء بالأندلس، عاش بضعا وثمانين سنة، وتوفي سنة تسع وعشرين وأربعمائة.',NULL,'142',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (122,'ذكر قول شيخ الإسلام أبي عثمان إسماعيل
...
كان الصابوني هذا فقيها محدثا، وصوفيا واعظا، كان شيخ نيسابور في زمانه، له تصانيف حسنة، سمع من أصحاب ابن خزيمة والسراج، وتوفي سنة تسع وأربعين وأربعمائة.',NULL,'143',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (123,'ذكر قول الإمام العالم العلامة حافظ المغرب إمام
...
ومعنى {مَنْ فِي السَّمَاءِ} يعني على العرش. وقد تكون "في" بمعنى "على". ألا ترى إلى قوله: {فَسِيحُوا فِي الْأَرْضِ} [التوبة: ٢]',NULL,'144',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (124,'أي على الأرض، وكذلك قوله: {وَلَأُصَلِّبَنَّكُمْ فِي جُذُوعِ النَّخْلِ} [طه: ٧١] .
...
قال أبو عبيدة في قوله {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] ، قال: علا، وتقول العرب استويت فوق الدابة، واستويت فوق البيت. وقال غيره: استوى أي استقر، واحتج بقوله:',NULL,'145',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (125,'{وَلَمَّا بَلَغَ أَشُدَّهُ وَاسْتَوَى} [القصص: ١٤] ، أي: انتهى شبابه واستقر، فلم يكن في شبابه مزيد.
قال ابن عبد البر: والاستواء الاستقرار في العلو، وبهذا خاطبنا الله عز وجل في كتابه، فقال: {لِتَسْتَوُوا عَلَى ظُهُورِهِ} الآية [الزخرف: ١٣] ، وقال: {فَإِذَا اسْتَوَيْتَ أَنْتَ وَمَنْ مَعَكَ عَلَى الْفُلْكِ} [المؤمنون: ٢٨] ، وقال: {وَاسْتَوَتْ عَلَى الْجُودِيِّ} [هود: ٤٤] .
وأما من نزع منهم بحديث يرويه عبد الله بن داود الواسطي، عن إبراهيم بن عبد الصمد، عن عبد الله بن مجاهد، عن أبيه، عن ابن عباس في قوله {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] : "استولى على جميع بريته، فلا يخلو منه مكان".',NULL,'146',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (126,'فالجواب: أن هذا حديث منكر، ونقلته مجهولون ضعفاء. فأما عبد الله بن داود الواسطي، وابن مجاهد، فضعيفان، وإبراهيم بن عبد الصمد مجهول لا يعرف، وهم لا يقبلون أخبار الآحاد العدول، فكيف يسوغ لهم الاحتجاج بمثل هذا الحديث لو عقلوا؟! أما سمعوا قول الله تعالى: {وَقَالَ فِرْعَوْنُ يَاهَامَانُ ابْنِ لِي صَرْحًا لَعَلِّي أَبْلُغُ الْأَسْبَابَ أَسْبَابَ السَّمَاوَاتِ فَأَطَّلِعَ إِلَى إِلَهِ مُوسَى وَإِنِّي لَأَظُنُّهُ كَاذِبًا} [غافر: ٣٦، ٣٧] .
...
قيل لهم: لا خلاف بيننا وبينكم وبين سائر الأمة أنه ليس في',NULL,'147',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (127,'الأرض دون السماء بذاته، فوجب حمل هذه الآيات على المعنى الصحيح المجمع عليه، وذلك أنه في السماء إله معبود أهل السماء، وفي الأرض إله معبود أهل الأرض، وكذا قال أهل العلم بالتفسير، وظاهر التنزيل يشهد أنه على العرش، فالاختلاف في ذلك ساقط، وأسعد الناس به من ساعد الظاهر.
...
قال: وأما احتجاجهم بقوله: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ} [المجادلة: ٧]',NULL,'148',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (128,'فلا حجة لهم في ظاهر هذه الآية.
...
وقال أبو عمر أيضا: أجمع علماء الصحابة والتابعين الذين حُمل عنهم التأويل، قالوا في تأويل قوله تعالى: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ} [المجادلة:٧] : هو على العرش، وعلمه في كل مكان، وما خالفهم في ذلك أحد يحتج بقوله.',NULL,'149',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (129,'وقال أيضا: أهل السنة مجمعون على الإقرار بالصفات الواردة في الكتاب والسنة، وحملها على الحقيقه لا على المجاز، إلا أنهم لم يكيفوا شيئا من ذلك. وأما الجهمية والمعتزلة والخوارج فكلهم ينكرها، ولا يحمل منها شيئا على الحقيقة، ويزعمون أن من أقر بها مشبه، وهم عند من أقر بها نافون للمعبود.
...
ولقد كان أبو عمر بن عبد البر من بحور العلم ومن أئمة الأثر، قل أن ترى العيون مثله، واشتهر فضله في الأقطار. مات سنة ثلاث وستين وأربعمائة عن ست وتسعين سنة.',NULL,'150',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (130,'ذكر قول الإمام أبي القاسم
...
قال الحافظ الذهبي: المراد بظاهرها أي لا باطن لألفاظ الكتاب والسنة غير ما وضعت له؛ كما قال مالك وغيره: الاستواء معلوم. وكذلك القول في السمع والبصر والكلام والإرادة والوجه ونحو ذلك، هذه الأشياء',NULL,'154',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (134,'معلومة، فلا يحتاج إلى بيان وتفسير، لكن الكيف في جميعها مجهول عندنا.
...
قال الإمام أبو الفتح محمد بن علي: دخلنا على الإمام أبي المعالي الجويني نعوده في مرض موته،',NULL,'157',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (137,'فقال لنا: اشهدوا علي أني قد رجعت عن كل مقالة قلتها أخالف فيها ما قال السلف الصالح، وأني أموت على ما تموت عليه عجائز نيسابور.
...
قال: وزعم هؤلاء أن معنى {الرَّحْمَنُ عَلَى الْعَرْشِ اسْتَوَى} [طه: ٥] أي: ملكه، وأنه لا اختصاص له بالعرش أكثر مما له بالأمكنة، وهذا إلغاء لتخصيص العرش وتشريفه.',NULL,'158',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (138,'قال أهل السنة: استوى على العرش بعد خلق السماوات والأرض على ما ورد به النص، وليس معناه المماسة، بل هو مستو على عرشه بلا كيف، كما أخبر عن نفسه.
...
وقد أخبر عن فرعون أنه قال: {يَاهَامَانُ ابْنِ لِي صَرْحًا لَعَلِّي أَبْلُغُ الْأَسْبَابَ أَسْبَابَ السَّمَاوَاتِ فَأَطَّلِعَ إِلَى إِلَهِ مُوسَى} [غافر: ٣٦ - ٣٧] ، فكان فرعون قد فهم عن',NULL,'159',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (139,'موسى أنه يثبت إلها فوق السماء، حتى رام بصرحه أن يطلع إليه، واتهم موسى بالكذب في ذلك.
...
إلى أن قال: وقد كان السلف الأول رضي الله عنهم لا يقولون بنفي الجهة ولا ينطقون بذلك، بل نطقوا هم والكافة بإثباتها لله تعالى كما نطق كتابه وأخبرت رسله، ولم ينكر أحد من السلف الصالح أنه استوى على العرش حقيقة، وخص عرشه بذلك؛ لأنه أعظم المخلوقات، وإنما جهلوا كيفية الاستواء، فإنه لا تعلم حقيقته؛ كما قال الإمام مالك: الاستواء معلوم -يعني في اللغة- والكيف مجهول، والسؤال عن ذلك بدعة.',NULL,'160',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (140,'قال الحافظ الذهبي: وقال القرطبي أيضا في الاستواء: الأكثر من المتقدمين والمتأخرين المتكلمين، يقولون: إذا وجب تنزيه الباري جل جلاله عن الجهة والتحيز، فمن ضرورة ذلك ولواحقه اللازمة أنه متى اختص بجهة أن يكون في مكان وحيز، ويلزم على المكان والحيز الحركة والسكون للتحيز والتغير والحدوث. هذا قول المتكلمين.
...
فهذان القولان هما اللذان كانا في زمن التابعين وتابعيهم. فأما القول الثالث للتولد بآخره بأنه تعالى ليس في الأمكنة ولا خارجا عنها، ولا فوق عرشه، ولا هو متصل بالخلق، ولا بمنفصل عنهم، ولا ذاته المقدسة متميزة ولا بائنة عن مخلوقاته، ولا في الجهات، ولا خارجا عن الجهات، ولا، ولا، فهذا شيء لا يعقل ولا يفهم مع ما فيه من مخالفات',NULL,'161',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (141,'الآيات والأخبار. ففر بدينك، وإياك وآراء المتكلمين، وآمن بالله وما جاء عن الله على مراد الله، وفوض أمرك إلى الله، ولا حول ولا قوة إلا بالله. انتهى كلام الذهبي.
ذكر قول الإمام محيي السنة أبي محمد الحسين بن
مسعود البغوي صاحب معالم التنزيل
قال عند قوله تعالى: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} [الأعراف: ٥٤] :
...
وقال في قوله تعالى: {ثُمَّ اسْتَوَى إِلَى السَّمَاءِ} [البقرة: ٢٩] :
قال ابن عباس وأكثر المفسرين من السلف: ارتفع إلى السماء.
وقال في قوله: {هَلْ يَنْظُرُونَ إِلَّا أَنْ يَأْتِيَهُمُ اللَّهُ فِي ظُلَلٍ مِنَ الْغَمَامِ} [البقرة: ٢١٠] : الأولى في هذه الآية وما شاكلها أن يؤمن الإنسان بظاهرها، ويكل علمها إلى الله، ويعتقد أن الله منزه عن سمات الحدوث، على ذلك مضت أئمة السلف وعلماء السنة.
وقال في قوله: {مَا يَكُونُ مِنْ نَجْوَى ثَلَاثَةٍ إِلَّا هُوَ رَابِعُهُمْ} [المجادلة: ٧] : بالعلم.',NULL,'162',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (142,'كان محيي السنة من كبار أئمة مذهب الشافعي، زاهدا ورعا. توفي سنة عشر وخمسمائة، وقد قارب الثمانين.
...
قال في تفسيره في سورة الأعراف: وأما قوله: {ثُمَّ اسْتَوَى عَلَى الْعَرْشِ} [الأعراف: ٥٤]- فللناس في ذلك المقام مقالات كثيرة جدا، ليس هذا موضع بسطها، وإنما نسلك في هذا المقام مذهب السلف الصالح: مالك والأوزاعي والثوري والليث بن سعد والشافعي وأحمد بن حنبل وإسحاق بن راهويه وغيرهم من أئمة المسلمين قديما وحديثا، وهو إمرارها كما جاءت من غير تكييف، ولا تشبيه، ولا تعطيل، والظاهر للتبادر إلى',NULL,'163',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (143,'أذهان المشبهين منفي عن الله، فإن الله لا يشبهه شيء من خلقه؛ و {لَيْسَ كَمِثْلِهِ شَيْءٌ وَهُوَ السَّمِيعُ الْبَصِيرُ} [الشورى: ١١] .
...
فالمعطلون لم يفهموا من صفات الله إلا ما هو اللائق بالمخلوق، فشرعوا في نفي تلك المفهومات بأنواع التأويل، فعطلوا حقائق الأسماء والصفات، وشبهوا الرب تبارك وتعالى بالجمادات العارية عن صفات الكمال، ونعوت الجلال، فجمعوا بين التعطيل والتمثيل، عطلوا أولا ومثلوا آخرا.',NULL,'165',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (145,'والممثلون عطلوا حقيقة ما وصف الله به نفسه من صفات الكمال، ونعوت الجلال، وشبهوا صفاته بصفات خلقه، فمثلوا أولا وعطلوا آخرا.
...
فهؤلاء نفاة الصفات، ومذهبهم مأخوذ عن جهم بن صفوان، فإن أول من حفظ عنه إنكار الصفات هو الجعد بن درهم، وأخذها عنه الجهم بن صفوان، وأظهرها، فنسبت مقالة الجهمية إليه، والجعد أخذ مقالته عن أبان بن سمعان، وأخذها أبان عن طالوت ابن أخت لبيد بن الأعصم، وأخذها طالوت عن لبيد بن الأعصم اليهودي، الساحر الذي سحر النبي صلى الله عليه وسلم. وكان انتشار مقالة الجهمية في المائة الثانية بسبب بشر بن غياث المريسي وطبقته. وكلام',NULL,'166',NULL,NULL,'0');
INSERT INTO [b8585] VALUES (146,'الأئمة، مثل: مالك، وسفيان بن عيينة، وأبي يوسف، والشافعي، وأحمد، وإسحاق، وغيرهم في ذمه وتضليله - كثير جدا.
...
وصلى الله على سيدنا محمد وعلى آله وصحبه وسلم تسليما كثيرا.',NULL,'167',NULL,NULL,'0');
