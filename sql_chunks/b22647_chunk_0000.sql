...
CREATE TABLE "b22647"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b22647
INSERT INTO [b22647] VALUES (1,'بِسم الله الرَّحْمَن الرَّحِيم وَبِه نستعين
...
أما بعد: فقد سُئِلَ شيخ الْإِسْلَام وَعلم الْأَعْلَام نَاصِر السّنة وقامع الْبِدْعَة أَحْمد بن عبد الْحَلِيم ابْن تَيْمِية رَحمَه الله عَن قَوْله عز وَجل [٢١ الْبَقَرَة] : {يَا أَيهَا النَّاس اعبدوا ربكُم} فَمَا الْعِبَادَة؟ وَمَا فروعها؟ وَهل مَجْمُوع الدَّين دَاخل فِيهَا أم لَا؟ وَمَا حَقِيقَة الْعُبُودِيَّة؟ وَهل هِيَ أَعلَى المقامات فِي الدُّنْيَا وَالْآخِرَة أم فَوْقهَا شَيْء من المقامات؟ وليبسط لنا القَوْل فِي ذَلِك.',NULL,'43',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (2,'فَأجَاب رَحمَه الله:
...
ونعت صفوة خلقه بالعبودية لَهُ فَقَالَ تَعَالَى [٦ الْإِنْسَان] : {عينا يشرب بهَا عباد الله يفجرونها تفجيرا} وَقَالَ [٦٣-٧٧ الْفرْقَان] : {وَعباد الرَّحْمَن الَّذين',NULL,'45',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (4,'يَمْشُونَ على الأَرْض هونا وَإِذا خاطبهم الجاهلون قَالُوا سَلاما} الْآيَات.
...
فالدين كُله دَاخل فِي الْعِبَادَة وَقد ثَبت فِي " الصَّحِيح " أَن جِبْرِيل لما جَاءَ إِلَى النَّبِي صلى الله عَلَيْهِ وَسلم فِي صُورَة أَعْرَابِي',NULL,'47',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (6,'وَسَأَلَهُ عَن الْإِسْلَام قَالَ: " الْإِسْلَام أَن تشهد أَن لَا إِلَه إِلَّا الله وَأَن مُحَمَّدًا رَسُول الله وتقيم الصَّلَاة وتؤتي الزَّكَاة وتصوم رَمَضَان وتحج الْبَيْت إِن اسْتَطَعْت إِلَيْهِ سَبِيلا " قَالَ: فَمَا الْإِيمَان؟ قَالَ: " أَن تؤمن بِاللَّه وَمَلَائِكَته وَكتبه وَرُسُله والبعث بعد الْمَوْت وتؤمن بِالْقدرِ خَيره وشره " قَالَ: فَمَا الْإِحْسَان؟ قَالَ: " أَن تعبد الله كَأَنَّك ترَاهُ فَإِن لم تكن ترَاهُ فَإِنَّهُ يراك " ثمَّ قَالَ فِي آخر الحَدِيث: " هَذَا جِبْرِيل جَاءَكُم يعلمكم دينكُمْ " فَجعل هَذَا كُله من الدَّين.
...
فالإله هُوَ الَّذِي يألهه الْقلب بِكَمَال الْحبّ والتعظيم والاجلال وَالْإِكْرَام وَالْخَوْف والرجاء وَنَحْو ذَلِك.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (12,'وَهَذِه الْعِبَادَة هِيَ الَّتِي يُحِبهَا الله ويرضاها وَبهَا وصف المصطفين من عباده وَبهَا بعث رسله.
...
وَإِلَى هَذَا أَشَارَ الشَّيْخ عبد الْقَادِر رَحمَه الله فِيمَا ذكر عَنهُ فبيّن أَن كثيرا من الرِّجَال (إِذا وصلوا إِلَى الْقَضَاء',NULL,'54',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (13,'وَالْقدر أَمْسكُوا إِلَّا أَنا فَإِنِّي انفتحت لي فِيهِ روزنة فنازعت أقدار الْحق بِالْحَقِّ للحق وَالرجل من يكون منازعا للقدر لَا من يكون مُوَافقا للقدر) .

وَالَّذِي ذكره الشَّيْخ رَحمَه الله هُوَ الَّذِي أَمر الله بِهِ وَرَسُوله وَلَكِن كثير من الرِّجَال غلطوا فِيهِ فَإِنَّهُم قد يشْهدُونَ مَا يقدّر على أحدهم من الْمعاصِي والذنُوب أَو مَا يقدّر على النَّاس من ذَلِك بل من الْكفْر وَيشْهدُونَ أَن هَذَا جَار بِمَشِيئَة الله وقضائه وَقدره دَاخل فِي حكم ربوبيته وَمُقْتَضى مَشِيئَته فيظنون الاستسلام لذَلِك وموافقته وَالرِّضَا بِهِ وَنَحْو ذَلِك دينا وطريقا وَعبادَة فيضاهئون الْمُشْركين الَّذين قَالُوا [١٤٨ الْأَنْعَام] : {لَو شَاءَ الله مَا أشركنا وَلَا آبَاؤُنَا وَلَا حرمنا من شَيْء} وَقَالُوا [٤٧ يس] : {أنطعم من لَو يَشَاء الله أطْعمهُ} وَقَالُوا [٢٠ الزخرف] : {لَو شَاءَ الرَّحْمَن مَا عبدناهم} وَلَو هُدوا لعلموا أَن الْقدر أُمرنا أَن نرضى بِهِ وَنَصْبِر على مُوجبه فِي المصائب الَّتِي تصيبنا كالفقر وَالْمَرَض وَالْخَوْف قَالَ الله تَعَالَى [١١ التغابن] : {مَا أصَاب من',NULL,'55',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (14,'مُصِيبَة إِلَّا بِإِذن الله وَمن يُؤمن بِاللَّه يهد قلبه} قَالَ بعض السّلف: هُوَ الرجل تصيبه الْمُصِيبَة فَيعلم أَنَّهَا من عِنْد الله فيرضى وَيسلم. وَقَالَ تَعَالَى [٢٢-٢٣ الْحَدِيد] : {مَا أصَاب من مُصِيبَة فِي الأَرْض وَلَا فِي أَنفسكُم إِلَّا فِي كتاب من قبل أَن نبرأها إِن ذَلِك على الله يسير * لكَي لَا تأسوا على مَا فاتكم وَلَا تفرحوا بِمَا آتَاكُم} .

وَفِي " الصَّحِيحَيْنِ " عَن النَّبِي صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " احْتج آدم ومُوسَى فَقَالَ مُوسَى: أَنْت آدم الَّذِي خلقك الله بِيَدِهِ وَنفخ فِيك من روحه وأسجد لَك مَلَائكَته وعلمك أَسمَاء كل شَيْء فلماذا أخرجتنا ونفسك من الْجنَّة؟ فَقَالَ آدم: أَنْت مُوسَى الَّذِي اصطفاك الله بِرِسَالَاتِهِ وبكلامه فَهَل وجدت ذَلِك مَكْتُوبًا عَليّ قبل أَن أخلق؟ قَالَ: نعم " قَالَ: " فحج آدم مُوسَى ".

وآدَم عَلَيْهِ السَّلَام لم يحْتَج على مُوسَى بِالْقدرِ ظنا أَن المذنب يحْتَج',NULL,'56',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (15,'بِالْقدرِ فَإِن هَذَا لَا يَقُوله مُسلم وَلَا عَاقل وَلَو كَانَ هَذَا عذرا لَكَانَ عذرا لإبليس وَقوم نوح وَقوم هود وكل كَافِر وَلَا مُوسَى لَام آدم أَيْضا لأجل الذَّنب فَإِن آدم قد تَابَ إِلَى ربه فاجتباه وَهدى وَلَكِن لامه لأجل الْمُصِيبَة الَّتِي لحقتهم بالخطيئة وَلِهَذَا قَالَ: فلماذا أخرجتنا ونفسك من الْجنَّة؟ فَأَجَابَهُ آدم: إِن هَذَا كَانَ مَكْتُوبًا عليّ قبل أَن أُخلق.
...
وَأما الذُّنُوب فَلَيْسَ للْعَبد أَن يُذنب وَإِذا أذْنب فَعَلَيهِ أَن يسْتَغْفر وَيَتُوب، فيتوب من صنوف المعايب ويصبر على المصائب قَالَ تَعَالَى [٥٥ غَافِر] : {فاصبر إِن وعد الله حق واستغفر لذنبك} وَقَالَ تَعَالَى [١٢٠ آل عمرَان] : {وَإِن تصبروا وتتقوا لَا يضركم كيدهم شَيْئا} وَقَالَ [١٨٦ آل عمرَان] : {وَإِن تصبروا وتتقوا فَإِن ذَلِك من عزم الْأُمُور} وَقَالَ يُوسُف عَلَيْهِ السَّلَام [٩٠ يُوسُف] : {إِنَّه من يتق ويصبر فَإِن الله لَا يضيع أجر الْمُحْسِنِينَ} .

وَكَذَلِكَ ذنُوب الْعباد يجب على العَبْد فِيهَا أَن يَأْمر بِالْمَعْرُوفِ وَينْهى عَن الْمُنكر بِحَسب قدرته ويجاهد فِي سَبِيل الله الْكفَّار وَالْمُنَافِقِينَ ويوالي أَوْلِيَاء الله ويعادي أَعدَاء الله وَيُحب فِي الله وَيبغض فِي الله كَمَا قَالَ تَعَالَى [١-٤ الممتحنة] :',NULL,'57',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (16,'{يَا أَيُّهَا الَّذِينَ آمَنُوا لَا تَتَّخِذُوا عَدُوِّي وَعَدُوَّكُمْ أَوْلِيَاء تُلْقُونَ إِلَيْهِم بِالْمَوَدَّةِ وَقَدْ كَفَرُوا بِمَا جَاءكُم مِّنَ الْحَقِّ يُخْرِجُونَ الرَّسُولَ وَإِيَّاكُمْ أَن تُؤْمِنُوا بِاللَّهِ رَبِّكُمْ إِن كُنتُمْ خَرَجْتُمْ جِهَاداً فِي سَبِيلِي وَابْتِغَاء مَرْضَاتِي تُسِرُّونَ إِلَيْهِم بِالْمَوَدَّةِ وَأَنَا أَعْلَمُ بِمَا أَخْفَيْتُمْ وَمَا أَعْلَنتُمْ وَمَن يَفْعَلْهُ مِنكُمْ فَقَدْ ضَلَّ سَوَاء السَّبِيلِ * إِن يَثْقَفُوكُمْ يَكُونُوا لَكُمْ أَعْدَاء وَيَبْسُطُوا إِلَيْكُمْ أَيْدِيَهُمْ وَأَلْسِنَتَهُم بِالسُّوءِ وَوَدُّوا لَوْ تَكْفُرُونَ * لَن تَنفَعَكُمْ أَرْحَامُكُمْ وَلَا أَوْلَادُكُمْ يَوْمَ الْقِيَامَةِ يَفْصِلُ بَيْنَكُمْ وَاللَّهُ بِمَا تَعْمَلُونَ بَصِيرٌ * قَدْ كَانَتْ لَكُمْ أُسْوَةٌ حَسَنَةٌ فِي إِبْرَاهِيمَ وَالَّذِينَ مَعَهُ إِذْ قَالُوا لِقَوْمِهِمْ إِنَّا بُرَاء مِنكُمْ وَمِمَّا تَعْبُدُونَ مِن دُونِ اللَّهِ كَفَرْنَا بِكُمْ وَبَدَا بَيْنَنَا وَبَيْنَكُمُ الْعَدَاوَةُ وَالْبَغْضَاء أَبَداً حَتَّى تُؤْمِنُوا بِاللَّهِ وَحْدَهُ} وَقَالَ تَعَالَى [٢٢ المجادلة] : {لَا تَجِد قوما يُؤمنُونَ بِاللَّه وَالْيَوْم الآخر يوادون من حاد الله وَرَسُوله وَلَو كَانُوا آبَاءَهُم أَو أَبْنَاءَهُم أَو إخْوَانهمْ أَو عشيرتهم أُولَئِكَ كتب فِي قُلُوبهم الْإِيمَان وأيدهم بِروح مِنْهُ} وَقَالَ تَعَالَى [٣٥ الْقَلَم] : {أفنجعل الْمُسلمين كالمجرمين} وَقَالَ [٢٨ ص] : {أم نجْعَل الَّذين آمنُوا وَعمِلُوا الصَّالِحَات كالمفسدين فِي الأَرْض أم نجْعَل الْمُتَّقِينَ كالفجار} وَقَالَ تَعَالَى [٢١ الجاثية] : {أم حسب الَّذين اجترحوا السَّيِّئَات أَن نجعلهم كَالَّذِين آمنُوا وَعمِلُوا الصَّالِحَات سَوَاء محياهم ومماتهم سَاءَ مَا يحكمون} وَقَالَ تَعَالَى [١٩-٢٢ فاطر] : {وَمَا يَسْتَوِي الْأَعْمَى والبصير * وَلَا الظُّلُمَات وَلَا النُّور * وَلَا الظل وَلَا الحرور * وَمَا يَسْتَوِي الْأَحْيَاء وَلَا الْأَمْوَات} وَقَالَ تَعَالَى [٢٩ الزمر] : {ضرب الله مثلا رجلا فِيهِ شُرَكَاء متشاكسون ورجلا سلما لرجل هَل يستويان مثلا} وَقَالَ تَعَالَى [٧٥-٧٦ النَّحْل] {ضرب الله مثلا عبدا',NULL,'58',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (17,'مَمْلُوكا لَا يقدر على شَيْء وَمن رزقناه منا رزقا حسنا فَهُوَ ينْفق مِنْهُ سرا وجهرا هَل يستوون الْحَمد لله بل أَكْثَرهم لَا يعلمُونَ * وَضرب الله مثلا رجلَيْنِ أَحدهمَا أبكم لَا يقدر على شَيْء وَهُوَ كل على مَوْلَاهُ أَيْنَمَا يوجهه لَا يَأْتِ بِخَير هَل يَسْتَوِي هُوَ وَمن يَأْمر بِالْعَدْلِ وَهُوَ على صِرَاط مُسْتَقِيم} وَقَالَ تَعَالَى [٢٠ الْحَشْر] : {لَا يَسْتَوِي أَصْحَاب النَّار وَأَصْحَاب الْجنَّة أَصْحَاب الْجنَّة هم الفائزون} .
...
وَهَؤُلَاء يصل بهم الْكفْر إِلَى أَنهم لَا يشْهدُونَ أَنهم عباد الله لَا بِمَعْنى أَنهم معبّدون وَلَا بِمَعْنى انهم عَابِدُونَ إِذْ يشْهدُونَ أنفسهم هِيَ الْحق كَمَا صرح بذلك طواغيتهم كَابْن عَرَبِيّ',NULL,'59',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (18,'صَاحب " الفصوص " وَأَمْثَاله من الْمُلْحِدِينَ المفترين كَابْن سبعين وَأَمْثَاله وَيشْهدُونَ أَنهم هم العابدون والمعبودون.
...
وَأما الْمُؤْمِنُونَ بِاللَّه وَرَسُوله عوامهم وخواصهم الَّذين هم أهل الْقُرْآن كَمَا قَالَ النَّبِي صلى الله عَلَيْهِ وَسلم: " إِن لله أهلين من النَّاس " قيل: من هم يَا رَسُول الله؟ قَالَ: " أهل الْقُرْآن هم أهل الله وخاصته " فَهَؤُلَاءِ يعلمُونَ أَن الله رب كل شَيْء ومليكه وخالقه وَأَن الْخَالِق سُبْحَانَهُ مباين للمخلوق لَيْسَ هُوَ حالاًّ فِيهِ وَلَا متّحدًا بِهِ وَلَا وجودُه وجودَه. وَالنَّصَارَى إِنَّمَا كفّرهم الله إِذْ قَالُوا بالحلول واتحاد الرب بالمسيح خَاصَّة فَكيف من جعل ذَلِك عَاما فِي كل مَخْلُوق؟ ويعلمون مَعَ ذَلِك أَن الله أَمر بِطَاعَتِهِ وَطَاعَة رَسُوله وَنهى عَن مَعْصِيَته ومعصية رَسُوله وَأَنه لَا يحب الْفساد وَلَا يرضى لِعِبَادِهِ الْكفْر وَأَن على الْخلق أَن يعبدوه فيطيعوا أمره',NULL,'60',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (19,'ويستعينوا بِهِ على ذَلِك كَمَا قَالَ فِي فَاتِحَة الْكتاب: {إياك نعْبد وَإِيَّاك نستعين} .

وَمن عِبَادَته وطاعته: الْأَمر بِالْمَعْرُوفِ وَالنَّهْي عَن الْمُنكر بِحَسب الْإِمْكَان وَالْجهَاد فِي سَبيله لأهل الْكفْر والنفاق فيجتهدون فِي إِقَامَة دينه مستعينين بِهِ رافعين مزيلين بذلك مَا قدر من السَّيِّئَات دافعين بذلك مَا قد يخَاف من آثَار ذَلِك كَمَا يزِيل الْإِنْسَان الْجُوع الْحَاضِر بِالْأَكْلِ وَيدْفَع بِهِ الْجُوع الْمُسْتَقْبل وَكَذَلِكَ إِذا آن أَوَان الْبرد دَفعه باللباس وَكَذَلِكَ كل مَطْلُوب يدْفع بِهِ مَكْرُوه كَمَا قَالُوا للنَّبِي صلى الله عَلَيْهِ وَسلم: يَا رَسُول الله أَرَأَيْت أدوية نتداوى بهَا ورقى نسترقي بهَا وتقى نتقي بهَا هَل ترد من قدر الله شَيْئا؟ فَقَالَ: " هِيَ من قدر الله " وَفِي الحَدِيث: " إِن الدُّعَاء وَالْبَلَاء ليلتقيان فيعتلجان بَين السَّمَاء وَالْأَرْض ".',NULL,'61',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (20,'فَهَذَا حَال الْمُؤمنِينَ بِاللَّه وَرَسُوله العابدين لله وكل ذَلِك من الْعِبَادَة.
...
وَأَصْحَاب هَذَا القَوْل الَّذين يحتجون بِالْحَقِيقَةِ الكونية لَا',NULL,'62',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (21,'يطردون هَذَا القَوْل وَلَا يلتزمونه وَإِنَّمَا هم يتبعُون آراءهم وأهواءهم كَمَا قَالَ فيهم بعض الْعلمَاء: أَنْت عِنْد الطَّاعَة قدَري وَعند الْمعْصِيَة جَبْري أيُّ مَذْهَب وَافق هَوَاك تمذهبت بِهِ.
...
وَقد يفرقون بَين من يعلم ذَلِك علما وَبَين من يرَاهُ شُهُودًا فَلَا يسقطون التَّكْلِيف عَمَّن يُؤمن بذلك ويعلمه فَقَط وَلَكِن [يسقطونه] عَمَّن يشهده فَلَا يرى لنَفسِهِ فعلا أصلا وَهَؤُلَاء',NULL,'63',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (22,'يجْعَلُونَ الْجَبْر وَإِثْبَات الْقدر مَانِعا من التَّكْلِيف على هَذَا الْوَجْه.
...
وَقَول هَؤُلَاءِ كفر صَرِيح وَإِن وَقع فِيهِ طوائف لم يعلمُوا أَنه كفر فَإِنَّهُ قد علم بالاضطرار من دين الْإِسْلَام أَن الْأَمر وَالنَّهْي لازمان لكل عبد مَا دَامَ عقله حَاضرا إِلَى أَن يَمُوت',NULL,'64',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (23,'لَا يسقطان عَنهُ لَا بشهوده الْقدر وَلَا بِغَيْر ذَلِك فَمن لم يعرف ذَلِك عُرِّفه وبيِّن لَهُ فَإِن أصر على اعْتِقَاد سُقُوط الْأَمر وَالنَّهْي فَإِنَّهُ يُقتل.
...
وَلَا ريب أَن الْمُشْركين الَّذين كذبُوا الرَّسُول يَتَرَدَّدُونَ بَين الْبِدْعَة الْمُخَالفَة لشرع الله وَبَين الِاحْتِجَاج بِالْقدرِ على مُخَالفَة أَمر الله فَهَذِهِ الْأَصْنَاف فِيهَا شبه من الْمُشْركين؛ إِمَّا أَن يبتدعوا',NULL,'65',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (24,'وَإِمَّا أَن يحتجوا بِالْقدرِ وَإِمَّا أَن يجمعوا بَين الْأَمريْنِ كَمَا قَالَ تَعَالَى عَن الْمُشْركين [٢٨ الْأَعْرَاف] : {وَإِذا فعلوا فَاحِشَة قَالُوا وجدنَا عَلَيْهَا آبَاءَنَا وَالله أمرنَا بهَا قل إِن الله لَا يَأْمر بالفحشاء أتقولون على الله مَا لَا تعلمُونَ} وكما قَالَ تَعَالَى عَنْهُم [١٤٨ الْأَنْعَام] : {سَيَقُولُ الَّذين أشركوا لَو شَاءَ الله مَا أشركنا وَلَا آبَاؤُنَا وَلَا حرمنا من شَيْء} .

وَقد ذَكَرَ عَن الْمُشْركين مَا ابتدعوه من الدَّين الَّذِي فِيهِ<span data-type="title" id=toc-34> تَحْلِيل الْحَرَام وَعبادَة الله بِمَا لم يشرع الله </span>فِي مثل قَوْله تَعَالَى [١٣٨ الْأَنْعَام] : {وَقَالُوا هَذِه أنعام وحرث حجر لَا يطْعمهَا إِلَّا من نشَاء بزعمهم وأنعام حرمت ظُهُورهَا وأنعام لَا يذكرُونَ اسْم الله عَلَيْهَا افتراء عَلَيْهِ} إِلَى آخر السُّورَة وَكَذَلِكَ فِي سُورَة الْأَعْرَاف [٢٧-٣٣] : {يَا بني آدم لَا يفتننكم الشَّيْطَان كَمَا أخرج أبويكم من الْجنَّة} إِلَى قَوْله: {وَإِذا فعلوا فَاحِشَة قَالُوا وجدنَا عَلَيْهَا آبَاءَنَا وَالله أمرنَا بهَا قل إِن الله لَا يَأْمر بالفحشاء أتقولون على الله مَا لَا تعلمُونَ * قل أَمر رَبِّي بِالْقِسْطِ وَأقِيمُوا وُجُوهكُم عِنْد كل مَسْجِد} إِلَى قَوْله: {وكلوا وَاشْرَبُوا وَلَا تسرفوا إِنَّه لَا يحب المسرفين * قل من حرم زِينَة الله الَّتِي أخرج لِعِبَادِهِ والطيبات من الرزق} إِلَى قَوْله: {قل إِنَّمَا حرم رَبِّي الْفَوَاحِش مَا ظهر مِنْهَا وَمَا بطن وَالْإِثْم وَالْبَغي بِغَيْر الْحق وَأَن تُشْرِكُوا بِاللَّه مَا لم ينزل بِهِ سُلْطَانا وَأَن تَقولُوا على الله مَا لَا تعلمُونَ} .

وَهَؤُلَاء قد يسمّون مَا أحدثوه من الْبدع حَقِيقَة كَمَا يسمّون مَا يشْهدُونَ من الْقدر حَقِيقَة وَطَرِيق الْحَقِيقَة عِنْدهم هُوَ السلوك الَّذِي لَا يتَقَيَّد صَاحبه بِأَمْر الشَّارِع وَنَهْيه وَلَكِن بِمَا',NULL,'66',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (25,'يرَاهُ ويذوقه ويجده فِي قلبه مَعَ مَا فِيهِ من غَفلَة عَن الله جلّ وَعلا وَنَحْو ذَلِك.
...
فَأهل الْإِيمَان لَهُم من الذَّوْق والوجد مثل مَا بيّنه النَّبِي صلى الله عَلَيْهِ وَسلم',NULL,'67',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (26,'بقوله فِي الحَدِيث الصَّحِيح: " ثَلَاث من كن فِيهِ وجد حلاوة الْإِيمَان: من كَانَ الله وَرَسُوله أحب إِلَيْهِ مِمَّا سواهُمَا وَمن كَانَ يحب الْمَرْء لَا يُحِبهُ إِلَّا لله وَمن كَانَ يكره أَن يرجع فِي الْكفْر بعد إِذْ أنقذه الله مِنْهُ كَمَا يكره أَن يلقى فِي النَّار " وَقَالَ صلى الله عَلَيْهِ وَسلم: " ذاق طعم الْإِيمَان من رَضِي بِاللَّه رَبًّا وَبِالْإِسْلَامِ دينا وَبِمُحَمَّدٍ نَبيا ".
...
فعبّاد الْأَصْنَام يحبونَ آلِهَتهم كَمَا قَالَ تَعَالَى [١٦٥ الْبَقَرَة] : {وَمن النَّاس من يتَّخذ من دون الله أندادا يحبونهم كحب الله وَالَّذين آمنُوا أَشد حبا لله} وَقَالَ [٥٠ الْقَصَص] : {فَإِن لم يَسْتَجِيبُوا لَك فَاعْلَم أَنما يتبعُون أهواءهم وَمن أضلّ مِمَّن اتبع هَوَاهُ بِغَيْر هدى من الله} وَقَالَ [٢٣ النَّجْم] : {إِن يتبعُون إِلَّا الظَّن وَمَا تهوى الْأَنْفس وَلَقَد جَاءَهُم من رَبهم الْهدى} .

وَلِهَذَا يمِيل هَؤُلَاءِ ويغرمون بِسَمَاع الشّعْر والأصوات الَّتِي تهيج الْمحبَّة الْمُطلقَة الَّتِي لَا تخْتَص بِأَهْل الْإِيمَان بل',NULL,'68',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (27,'يشْتَرك فِيهَا محب الرَّحْمَن ومحب الْأَوْثَان ومحب الصلبان ومحب الأوطان ومحب الإخوان ومحب المردان ومحب النسوان وَهَؤُلَاء الَّذين يتبعُون أذواقهم ومواجيدهم من غير اعْتِبَار لذَلِك بِالْكتاب وَالسّنة وَمَا كَانَ عَلَيْهِ سلف الْأمة.
...
فَهَذِهِ الْأُمُور وَنَحْوهَا كثيرا مَا تعرض لأهل السلوك والتوجه وَإِنَّمَا ينجو العَبْد مِنْهَا بملازمة أَمر الله الَّذِي بعث بِهِ رَسُوله فِي كل وَقت كَمَا قَالَ الزُّهْرِيّ: كَانَ من مضى من سلفنا يَقُولُونَ:<span data-type="title" id=toc-43> الِاعْتِصَام بِالسنةِ نجاة</span>. وَذَلِكَ أَن السّنة كَمَا قَالَ مَالك رَحمَه الله: مثل سفينة نوح من ركبهَا نجا وَمن تخلف عَنْهَا غرق.
...
فَإِن قيل: فَإِذا كَانَ جَمِيع مَا يُحِبهُ الله دَاخِلا فِي اسْم الْعِبَادَة فلماذا عطف عَلَيْهَا غَيرهَا كَقَوْلِه فِي فَاتِحَة الْكتاب [٥ الْفَاتِحَة] :',NULL,'72',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (31,'{إياك نعْبد وَإِيَّاك نستعين} وَقَوله لنَبيه [١٢٣ هود] : {فاعبده وتوكل عَلَيْهِ} وَقَول نوح [٣ نوح] : {اعبدوا الله واتقوه وأطيعون} وَكَذَلِكَ قَول غَيره من الرُّسُل؟
...
وَتارَة ت<span data-type="title" id=toc-47>تنوع دلَالَة الِاسْم بِحَال الِانْفِرَاد والاقتران </span>فَإِذا أفرد عَم وَإِذا قرن بِغَيْرِهِ خص كاسم الْفَقِير والمسكين لما أفرد أَحدهمَا فِي مثل قَوْله [٢٧٣ الْبَقَرَة] : {للْفُقَرَاء الَّذين أحْصرُوا فِي سَبِيل الله} وَقَوله [٨٩ الْمَائِدَة] : {إطْعَام عشرَة مَسَاكِين} دخل فِيهِ الآخر وَلما قرن بَينهمَا فِي',NULL,'73',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (32,'قَوْله [٦٠ التَّوْبَة] : {إِنَّمَا الصَّدقَات للْفُقَرَاء وَالْمَسَاكِين} صَارا نَوْعَيْنِ.
...
وَمن هَذَا الْبَاب قَوْله تَعَالَى [٤٥ العنكبوت] : {اتل مَا أُوحِي إِلَيْك من الْكتاب وأقم الصَّلَاة} وَقَوله [١٧٠ الْأَعْرَاف] : {وَالَّذين يمسّكون',NULL,'74',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (33,'بِالْكتاب وَأَقَامُوا الصَّلَاة} وتلاوة الْكتاب هِيَ اتِّبَاعه وَالْعَمَل بِهِ كَمَا قَالَ ابْن مَسْعُود فِي قَوْله تَعَالَى [١٢١ الْبَقَرَة] : {الَّذين آتَيْنَاهُم الْكتاب يتلونه حق تِلَاوَته} قَالَ: يحلّون حَلَاله ويحرمون حرَامه ويؤمنون بمتشابهه ويعملون بمحكمه. فاتباع الْكتاب يتَنَاوَل الصَّلَاة وَغَيرهَا لَكِن خصها بِالذكر لمزيتها وَكَذَلِكَ قَوْله لمُوسَى [١٤ طه] : {إِنَّنِي أَنا الله لَا إِلَه إِلَّا أَنا فاعبدني وأقم الصَّلَاة لذكري} وَإِقَامَة الصَّلَاة لذكره من أجلِّ عِبَادَته وَكَذَلِكَ قَوْله تَعَالَى [٧٠ الْأَحْزَاب] : {اتَّقوا الله وَقُولُوا قولا سديدا} وَقَوله [٣٥ الْمَائِدَة] : {اتَّقوا الله وابتغوا إِلَيْهِ الْوَسِيلَة} وَقَوله [١١٩ التَّوْبَة] : {اتَّقوا الله وَكُونُوا مَعَ الصَّادِقين} فَإِن هَذِه الْأُمُور هِيَ أَيْضا من تَمام تقوى الله وَكَذَلِكَ قَوْله [١٢٣ هود] : {فاعبده وتوكل عَلَيْهِ} فَإِن التَّوَكُّل هُوَ الِاسْتِعَانَة وَهِي من عبَادَة الله لَكِن خصت بِالذكر ليقصدها المتعبد بخصوصها فَإِنَّهَا هِيَ العون على سَائِر أَنْوَاع الْعِبَادَة إِذْ هُوَ سُبْحَانَهُ لَا يُعبد إِلَّا بمعونته.

إِذا تبين هَذَا فكمال الْمَخْلُوق فِي تَحْقِيق عبوديته لله وَكلما ازْدَادَ العَبْد تَحْقِيقا للعبودية ازْدَادَ كَمَاله وعلت دَرَجَته وَمن توهم أَن الْمَخْلُوق يخرج من الْعُبُودِيَّة بِوَجْه من الْوُجُوه أَو أَن الْخُرُوج عَنْهَا أكمل فَهُوَ من أَجْهَل الْخلق بل من أضلهم قَالَ تَعَالَى [٢٦-٢٨ الْأَنْبِيَاء] :',NULL,'75',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (34,'{وَقَالُوا اتخذ الرَّحْمَن ولدا سُبْحَانَهُ بل عباد مكرمون * لَا يسبقونه بالْقَوْل وهم بأَمْره يعْملُونَ * يعلم مَا بَين أَيْديهم وَمَا خَلفهم وَلَا يشفعون إِلَّا لمن ارتضى وهم من خَشيته مشفقون} وَقَالَ تَعَالَى [٨٨-٩٥ مَرْيَم] : {وَقَالُوا اتخذ الرَّحْمَن ولدا * لقد جئْتُمْ شَيْئا إدا * تكَاد السَّمَاوَات يتفطرن مِنْهُ وتنشق الأَرْض وتخر الْجبَال هدا * أَن دعوا للرحمن ولدا * وَمَا يَنْبَغِي للرحمن أَن يتَّخذ ولدا * إِن كل من فِي السَّمَاوَات وَالْأَرْض إِلَّا آتِي الرَّحْمَن عبدا * لقد أحصاهم وعدهم عدا * وَكلهمْ آتيه يَوْم الْقِيَامَة فَردا} وَقَالَ تَعَالَى فِي الْمَسِيح [٥٩ الزخرف] : {إِن هُوَ إِلَّا عبد أنعمنا عَلَيْهِ وجعلناه مثلا لبني إِسْرَائِيل} وَقَالَ تَعَالَى [١٩-٢٠ الْأَنْبِيَاء] : {وَله من فِي السَّمَاوَات وَالْأَرْض وَمن عِنْده لَا يَسْتَكْبِرُونَ عَن عِبَادَته وَلَا يستحسرون * يسبحون اللَّيْل وَالنَّهَار لَا يفترون} وَقَالَ تَعَالَى [١٧٢-١٧٣ النِّسَاء] : {لن يستنكف الْمَسِيح أَن يكون عبدا لله وَلَا الْمَلَائِكَة المقربون وَمن يستنكف عَن عِبَادَته ويستكبر فسيحشرهم إِلَيْهِ جَمِيعًا * فَأَما الَّذين آمنُوا وَعمِلُوا الصَّالِحَات فيوفيهم أُجُورهم ويزيدهم من فَضله وَأما الَّذين استنكفوا واستكبروا فيعذبهم عذَابا أَلِيمًا وَلَا يَجدونَ لَهُم من دون الله وليا وَلَا نَصِيرًا} وَقَالَ تَعَالَى [٦٠ غَافِر] : {وَقَالَ ربكُم ادْعُونِي أَسْتَجِب لكم إِن الَّذين يَسْتَكْبِرُونَ عَن عبادتي سيدخلون جَهَنَّم داخرين} وَقَالَ تَعَالَى [٣٧-٣٨ فصلت] : {وَمن آيَاته اللَّيْل وَالنَّهَار وَالشَّمْس وَالْقَمَر لَا تسجدوا للشمس وَلَا للقمر واسجدوا لله الَّذِي خَلقهنَّ إِن كُنْتُم إِيَّاه تَعْبدُونَ * فَإِن استكبروا فَالَّذِينَ عِنْد رَبك يسبحون لَهُ بِاللَّيْلِ وَالنَّهَار وهم لَا يسأمون} وَقَالَ تَعَالَى [٢٠٥-٢٠٦ الْأَعْرَاف] : {وَاذْكُر رَبك فِي نَفسك تضرعا وخيفة وَدون الْجَهْر من',NULL,'76',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (35,'القَوْل بِالْغُدُوِّ وَالْآصَال وَلَا تكن من الغافلين * إِن الَّذين عِنْد رَبك لَا يَسْتَكْبِرُونَ عَن عِبَادَته ويسبحونه وَله يَسْجُدُونَ} .

وَهَذَا وَنَحْوه مِمَّا فِيهِ<span data-type="title" id=toc-52> وصف أكَابِر الْخلق بِالْعبَادَة </span>وذم من خرج عَن ذَلِك مُتَعَدد فِي الْقُرْآن وَقد أخبر أَنه أرسل جَمِيع الرُّسُل بذلك فَقَالَ تَعَالَى [٢٥ الْأَنْبِيَاء] : {وَمَا أرسلنَا من قبلك من رَسُول إِلَّا نوحي إِلَيْهِ أَنه لَا إِلَه إِلَّا أَنا فاعبدون} وَقَالَ تَعَالَى [٣٦ النَّحْل] : {وَلَقَد بعثنَا فِي كل أمة رَسُولا أَن اعبدوا الله وَاجْتَنبُوا الطاغوت} وَقَالَ تَعَالَى لبنى إِسْرَائِيل [٥٦ العنكبوت] : {يَا عبَادي الَّذين آمنُوا إِن أرضي وَاسِعَة فإياي فاعبدون} [٤١ الْبَقَرَة] : {وإياي فاتقون} وَقَالَ [٢١ الْبَقَرَة] : {يَا أَيهَا النَّاس اعبدوا ربكُم الَّذِي خَلقكُم وَالَّذين من قبلكُمْ لَعَلَّكُمْ تَتَّقُون} وَقَالَ [٥٦ الذاريات] : {وَمَا خلقت الْجِنّ وَالْإِنْس إِلَّا ليعبدون} وَقَالَ تَعَالَى [١١-١٥ الزمر] : {قل إِنِّي أمرت أَن أعبد الله مخلصا لَهُ الدَّين * وَأمرت لِأَن أكون أول الْمُسلمين * قل إِنِّي أَخَاف إِن عصيت رَبِّي عَذَاب يَوْم عَظِيم * قل الله أعبد مخلصا لَهُ ديني * فاعبدوا مَا شِئْتُم من دونه} .

وكل رَسُول من الرُّسُل افْتتح دَعوته بِالدُّعَاءِ إِلَى عبَادَة الله كَقَوْل نوح وَمن بعده عَلَيْهِم السَّلَام فِي سُورَة الشُّعَرَاء وَغَيرهَا [٥٩ الْأَعْرَاف] : {اعبدوا الله مَا لكم من إِلَه غَيره} .',NULL,'77',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (36,'وَفِي " الْمسند " عَن ابْن عمر عَن النَّبِي صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " بعثت بِالسَّيْفِ بَين يدى السَّاعَة حَتَّى يُعبد الله وَحده لَا شريك لَهُ وَجعل رِزْقِي تَحت ظلّ رُمْحِي وَجعل الذلة وَالصغَار على من خَالف أمرى ".

وَقد بَين أَن عباده المخلصين هم الَّذين ينجون من السَّيِّئَات الَّتِي زيّنها الشَّيْطَان قَالَ الشَّيْطَان [٣٩-٤٠ الْحجر] : {قَالَ رب بِمَا أغويتني لأزينن لَهُم فِي الأَرْض ولأغوينهم أَجْمَعِينَ * إِلَّا عِبَادك مِنْهُم المخلصين} قَالَ تَعَالَى [٤١-٤٢ الْحجر] : {هَذَا صِرَاط عَليّ مُسْتَقِيم * إِن عبَادي لَيْسَ لَك عَلَيْهِم سُلْطَان إِلَّا من اتبعك من الغاوين} وَقَالَ [٨٢-٨٣ ص] : {فبعزتك لأغوينهم أَجْمَعِينَ * إِلَّا عِبَادك مِنْهُم المخلصين} وَقَالَ فِي حق يُوسُف [٢٤ يُوسُف] : {كَذَلِك لنصرف عَنهُ السوء والفحشاء إِنَّه من عبادنَا المخلصين} وَقَالَ تَعَالَى [١٥٩-١٦٠ الصافات] : {سُبْحَانَ الله عَمَّا يصفونَ * إِلَّا عباد الله المخلصين} وَقَالَ تَعَالَى [٩٩-١٠٠ النَّحْل] : {إِنَّه لَيْسَ لَهُ سُلْطَان على الَّذين آمنُوا وعَلى رَبهم يَتَوَكَّلُونَ * إِنَّمَا سُلْطَانه على الَّذين يتولونه وَالَّذين هم بِهِ مشركون} .',NULL,'78',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (37,'وبالعبودية نعت كل من اصْطفى من خلقه فِي قَوْله [٤٥-٤٧ ص] : {وَاذْكُر عبادنَا إِبْرَاهِيم وَإِسْحَاق وَيَعْقُوب أولي الْأَيْدِي والأبصار * إِنَّا أخلصناهم بخالصة ذكرى الدَّار * وَإِنَّهُم عندنَا لمن المصطفين الأخيار} وَقَوله [١٧ ص] : {وَاذْكُر عَبدنَا دَاوُد ذَا الأيد إِنَّه أواب} . وَقَالَ عَن سُلَيْمَان [٣٠ ص] : {نعم العَبْد إِنَّه أواب} . وَعَن أَيُّوب [٤٤ ص] : {نعم العَبْد} . وَقَالَ عَنهُ [٤١ ص] : {وَاذْكُر عَبدنَا أَيُّوب إِذْ نَادَى ربه} . وَقَالَ عَن نوح عَلَيْهِ السَّلَام [٣ الْإِسْرَاء] : {ذُرِّيَّة من حملنَا مَعَ نوح إِنَّه كَانَ عبدا شكُورًا} . وَقَالَ عَن خَاتم رسله [١ الْإِسْرَاء] : {سُبْحَانَ الَّذِي أسرى بِعَبْدِهِ لَيْلًا من الْمَسْجِد الْحَرَام إِلَى الْمَسْجِد الْأَقْصَى} - وَهُوَ أولى الْقبْلَتَيْنِ، وَقد خصّه الله بِأَن جعل الْعِبَادَة فِيهِ بخمسمئة ضعف، وَالْمَقْصُود بمضاعفة الْحَسَنَات هُوَ الْمَسْجِد الَّذِي حرقه الْيَهُود، عَلَيْهِم لعنة الله، ويظن الْبَعْض أَن الْمَسْجِد الْأَقْصَى هُوَ الصَّخْرَة والقبة المحيطة بهَا، وَلَيْسَ كَذَلِك - وَقَالَ [١٩ الْجِنّ] : {وَأَنه لما قَامَ عبد',NULL,'79',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (38,'الله يَدعُوهُ} وَقَالَ [٢٣ الْبَقَرَة] : {وَإِن كُنْتُم فِي ريب مِمَّا نزلنَا على عَبدنَا} وَقَالَ [١٠ النَّجْم] : {فَأوحى إِلَى عَبده مَا أوحى} وَقَالَ [٦ الْإِنْسَان] : {عينا يشرب بهَا عباد الله} وَقَالَ [٦٣ الْفرْقَان] : {وَعباد الرَّحْمَن الَّذين يَمْشُونَ على الأَرْض هونا} وَمثل هَذَا كثير مُتَعَدد فِي الْقُرْآن.
...
وَهَذِه حَال من إِذا أَصَابَهُ شَرّ لم يخرج مِنْهُ وَلم يفلح لكَونه',NULL,'80',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (39,'تعس وانتكس فَلَا نَالَ الْمَطْلُوب وَلَا خلص من الْمَكْرُوه وَهَذِه<span data-type="title" id=toc-58> حَال من عبد المَال </span>وَقد وصف ذَلِك بِأَنَّهُ إِذا أعطي رَضِي وَإِن منع سخط كَمَا قَالَ تَعَالَى [٥٨ التَّوْبَة] : {وَمِنْهُم من يَلْمِزك فِي الصَّدقَات فَإِن أعْطوا مِنْهَا رَضوا وَإِن لم يُعْطوا مِنْهَا إِذا هم يسخطون} فرضاهم لغير الله وسخطهم لغير الله.
...
الْعِشْق لَا يستفيق الدهرَ صاحبُه ... وَإِنَّمَا يُصرع الْمَجْنُون فِي حِين',NULL,'89',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (48,'وَمن أعظم أَسبَاب هَذَا الْبلَاء إِعْرَاض الْقلب عَن الله فَإِن الْقلب إِذا ذاق طعم عبَادَة الله وَالْإِخْلَاص لَهُ لم يكن عِنْده شَيْء قطّ أحلى من ذَلِك وَلَا ألذ وَلَا أمتع وَلَا أطيب وَالْإِنْسَان لَا يتْرك محبوبا إِلَّا بمحبوب آخر يكون أحب إِلَيْهِ مِنْهُ أَو خوفًا من مَكْرُوه فالحب الْفَاسِد إِنَّمَا ينْصَرف الْقلب عَنهُ بالحب الصَّالح أَو بالخوف من الضَّرَر.
...
وَالتَّحْقِيق أَن كِلَاهُمَا فِيهِ عبودية للْآخر وَكِلَاهُمَا تَارِك لحقيقة عبَادَة الله وَإِذا كَانَ تعاونهما على الْعُلُوّ فِي الأَرْض',NULL,'91',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (50,'بِغَيْر الْحق كَانَا بِمَنْزِلَة المتعاونين على الْفَاحِشَة أَو قطع الطَّرِيق فَكل وَاحِد من الشخصين لهواه الَّذِي استعبده واسترقه مستعبد للْآخر.

وَهَكَذَا أَيْضا طَالب المَال فَإِن ذَلِك يستعبده ويسترقه.

وَهَذِه الْأُمُور نَوْعَانِ:

مِنْهَا مَا يحْتَاج العَبْد إِلَيْهِ كَمَا يحْتَاج إِلَيْهِ من طَعَامه وَشَرَابه ومسكنه ومنكحه وَنَحْو ذَلِك فَهَذَا يَطْلُبهُ من الله ويرغب إِلَيْهِ فِيهِ فَيكون المَال عِنْده يَسْتَعْمِلهُ فِي حَاجته بِمَنْزِلَة حِمَاره الَّذِي يركبه وبساطه الَّذِي يجلس عَلَيْهِ بل بِمَنْزِلَة الكنيف الَّذِي يقْضى فِيهِ حَاجته من غير أَن يستعبده فَيكون {هلوعا * إِذا مَسّه الشَّرّ جزوعا * وَإِذا مَسّه الْخَيْر منوعا} [١٩-٢١ المعارج] .

وَمِنْهَا مَا لَا يحْتَاج العَبْد إِلَيْهِ فَهَذَا لَا يَنْبَغِي لَهُ أَن يعلق قلبه بِهِ فَإِذا علق قلبه بِهِ صَار مستعبَدا لَهُ وَرُبمَا صَار مُعْتَمدًا على غير الله فَلَا يبْقى مَعَه حَقِيقَة الْعِبَادَة لله وَلَا حَقِيقَة التَّوَكُّل عَلَيْهِ بل فِيهِ شُعْبَة من الْعِبَادَة لغير الله وَشعْبَة من التَّوَكُّل على غير الله وَهَذَا من أَحَق النَّاس بقوله صلى الله عَلَيْهِ وَسلم: " تعس عبد الدِّرْهَم تعس عبد الدِّينَار تعس عبد القطيفة تعس عبد الخميصة " وَهَذَا هُوَ عبد هَذِه الْأُمُور فَإِنَّهُ لَو',NULL,'92',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (51,'طلبَهَا من الله فَإِن الله إِذا أعطَاهُ إِيَّاه رَضِي وَإِن مَنعه إِيَّاه سخط وَإِنَّمَا عبد الله من يرضيه مَا يُرْضِي الله ويسخطه مَا يسْخط الله وَيُحب مَا أحبه الله وَرَسُوله وَيبغض مَا أبغضه الله وَرَسُوله ويوالي أَوْلِيَاء الله ويعادي أَعدَاء الله تَعَالَى وَهَذَا هُوَ الَّذِي اسْتكْمل الْإِيمَان كَمَا فِي الحَدِيث: " من أحب لله وَأبْغض لله وَأعْطى لله وَمنع لله فقد اسْتكْمل الْإِيمَان ". وَقَالَ: "<span data-type="title" id=toc-73> أوثق عرى الْإِيمَان </span>الْحبّ فِي الله والبغض فِي الله ".

وَفِي " الصَّحِيح " عَنهُ صلى الله عَلَيْهِ وَسلم: " ثَلَاث من كن فِيهِ وجد حلاوة الْإِيمَان: من كَانَ الله وَرَسُوله أحب إِلَيْهِ مِمَّا سواهُمَا وَمن كَانَ يحب الْمَرْء لَا يُحِبهُ إِلَّا لله وَمن كَانَ يكره أَن يرجع إِلَى الْكفْر بعد إِذا أنقذه الله مِنْهُ كَمَا يكره أَن يلقى فِي النَّار ". فَهَذَا وَافق ربه فِيمَا يُحِبهُ وَمَا يكرههُ فَكَانَ الله وَرَسُوله أحب إِلَيْهِ مِمَّا سواهُمَا وَأحب الْمَخْلُوق لله لَا لغَرَض آخر فَكَانَ هَذَا من تَمام حبه لله فَإِن محبَّة مَحْبُوب',NULL,'93',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (52,'المحبوب من تَمام محبَّة المحبوب فَإِذا أحب أَنْبيَاء الله وأولياء الله لأجل قيامهم بمحبوبات الْحق لَا لشَيْء آخر فقد أحبهم لله لَا لغيره وَقد قَالَ تَعَالَى [٥٤ الْمَائِدَة] : {فَسَوف يَأْتِي الله بِقوم يُحِبهُمْ وَيُحِبُّونَهُ أَذِلَّة على الْمُؤمنِينَ أعزة على الْكَافرين} .

وَلِهَذَا قَالَ تَعَالَى [٣١ آل عمرَان] : {قل إِن كُنْتُم تحبون الله فَاتبعُوني يحببكم الله} فَإِن الرَّسُول لَا يَأْمر إِلَّا بِمَا يحب الله وَلَا ينْهَى إِلَّا عَمَّا يبغضه الله وَلَا يفعل إِلَّا مَا يُحِبهُ الله وَلَا يخبر إِلَّا بِمَا يحب الله التَّصْدِيق بِهِ.
...
نعم قد يسْلك الْمُحب لضعف عقله وَفَسَاد تصَوره طَرِيقا لَا يحصل بهَا الْمَطْلُوب فَمثل هَذِه الطَّرِيق لَا تحمد إِذا كَانَت الْمحبَّة صَالِحَة محمودة فَكيف إِذا كَانَت الْمحبَّة فَاسِدَة وَالطَّرِيق غير موصل؟! كَمَا يَفْعَله المتهورون فِي طلب المَال الرِّئَاسَة والصور من حب أُمُور توجب لَهُم ضَرَرا وَلَا',NULL,'96',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (55,'تحصل لَهُم مَطْلُوبا، وَإِنَّمَا الْمَقْصُود الطّرق الَّتِي يسلكها الْعقل السَّلِيم لحُصُول مَطْلُوبه.
...
وَهَذَا لَا يحصل لَهُ إِلَّا باعانة الله لَهُ فَإِنَّهُ لَا يقدر على تَحْصِيل ذَلِك لَهُ إِلَّا الله فَهُوَ دَائِما مفتقر إِلَى حَقِيقَة {إياك نعْبد وَإِيَّاك نستعين} فَإِنَّهُ لَو أعين على حُصُوله كل مَا يُحِبهُ ويطلبه ويشتهيه ويريده وَلم يحصل لَهُ عبَادَة لله فَلَنْ يحصل إِلَّا على الْأَلَم وَالْحَسْرَة وَالْعَذَاب وَلنْ يخلص من آلام الدُّنْيَا ونكد عيشها إِلَّا بإخلاص الْحبّ لله بِحَيْثُ يكون الله هُوَ غَايَة مُرَاده وَنِهَايَة مَقْصُوده وَهُوَ المحبوب لَهُ بِالْقَصْدِ الأول وكل مَا سواهُ',NULL,'97',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (56,'إِنَّمَا يُحِبهُ لأَجله لَا يحب شَيْئا لذاته إِلَّا الله وَمَتى لم يحصل لَهُ هَذَا لم يكن قد حقق حَقِيقَة (لَا إِلَه إِلَّا الله) وَلَا حقق التَّوْحِيد والعبودية والمحبة لله وَكَانَ فِيهِ من نقص التَّوْحِيد وَالْإِيمَان بل من الْأَلَم وَالْحَسْرَة وَالْعَذَاب بِحَسب ذَلِك.
...
وَلِهَذَا كَانَ شعار الصَّلَاة وَالْأَذَان والأعياد هُوَ التَّكْبِير وَكَانَ مُسْتَحبا فِي الْأَمْكِنَة الْعَالِيَة كالصفا والمروة',NULL,'99',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (58,'وَإِذا علا الْإِنْسَان شرفا أَو ركب دَابَّة وَنَحْو ذَلِك وَبِه يطفأ الْحَرِيق وَإِن عظم وَعند الْأَذَان يهرب الشَّيْطَان قَالَ تَعَالَى [٦٠ غَافِر] : {وَقَالَ ربكُم ادْعُونِي أَسْتَجِب لكم إِن الَّذين يَسْتَكْبِرُونَ عَن عبادتي سيدخلون جَهَنَّم داخرين} .

وكل من استكبر عَن عبَادَة الله لَا بُد أَن يعبد غَيره فَإِن الْإِنْسَان حساس يَتَحَرَّك بالإرادة وَقد ثَبت فِي " الصَّحِيح " عَن النَّبِي صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " أصدق الْأَسْمَاء حَارِث وَهَمَّام " فالحارث الكاسب الْفَاعِل والهمام فعال من الْهم والهم أول الْإِرَادَة فالإنسان لَهُ إِرَادَة دَائِما وكل إِرَادَة فَلَا بُد لَهَا من مُرَاد تنتهى إِلَيْهِ فَلَا بُد لكل عبد من مُرَاد مَحْبُوب هُوَ مُنْتَهى حبه وإرادته فَمن لم يكن الله معبوده ومنتهى حبه وإرادته بل استكبر عَن ذَلِك فَلَا بُد أَن لَهُ مُرَاد مَحْبُوب يستعبده غير الله فَيكون عبدا لذَلِك المُرَاد المحبوب إِمَّا المَال وَإِمَّا الجاه وَإِمَّا الصُّور وَإِمَّا مَا يَتَّخِذهُ إِلَهًا من دون الله كَالشَّمْسِ وَالْقَمَر وَالْكَوَاكِب والأوثان',NULL,'100',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (59,'وقبور الْأَنْبِيَاء وَالصَّالِحِينَ أَو من الْمَلَائِكَة والأنبياء الَّذين يتخذهم أَرْبَابًا أَو غير ذَلِك مِمَّا عبد من دون الله.

وَإِذا كَانَ عبدا لغير الله يكون مُشْركًا وكل مستكبر فَهُوَ مُشْرك وَلِهَذَا كَانَ فِرْعَوْن من أعظم الْخلق استكبارا عَن عبَادَة الله وَكَانَ مُشْركًا قَالَ تَعَالَى [٢٣-٣٥ غَافِر] : {وَلَقَد أرسلنَا مُوسَى بِآيَاتِنَا وسلطان مُبين * إِلَى فِرْعَوْن وهامان وَقَارُون فَقَالُوا سَاحر كَذَّاب} إِلَى قَوْله: {وَقَالَ مُوسَى إِنِّي عذت بربي وربكم من كل متكبر لَا يُؤمن بِيَوْم الْحساب} إِلَى قَوْله: {كَذَلِك يطبع الله على كل قلب متكبر جَبَّار} . وَقَالَ تَعَالَى [٣٩ العنكبوت] : {وَقَارُون وَفرْعَوْن وهامان وَلَقَد جَاءَهُم مُوسَى بِالْبَيِّنَاتِ فاستكبروا فِي الأَرْض وَمَا كَانُوا سابقين} . وَقَالَ تَعَالَى [٤ الْقَصَص] : {إِن فِرْعَوْن علا فِي الأَرْض وَجعل أَهلهَا شيعًا يستضعف طَائِفَة مِنْهُم يذبح أَبْنَاءَهُم ويستحيي نِسَاءَهُمْ} . وَقَالَ [١٤ النَّمْل] : {وجحدوا بهَا واستيقنتها أنفسهم ظلما وعلوا فَانْظُر كَيفَ كَانَ عَاقِبَة المفسدين} . وَمثل هَذَا فِي الْقُرْآن كثير.

وَقد وصف فِرْعَوْن بالشرك فِي قَوْله [١٢٧ الْأَعْرَاف] : {وَقَالَ الْمَلأ من قوم فِرْعَوْن أتذر مُوسَى وَقَومه ليفسدوا فِي الأَرْض ويذرك وآلهتك} بل الاستقراء يدل على أَنه كلما كَانَ الرجل أعظم استكبارا عَن عبَادَة الله كَانَ أعظم إشراكا بِاللَّه لِأَنَّهُ كلما استكبر عَن عبَادَة الله ازْدَادَ فقرا وحاجة إِلَى المُرَاد المحبوب',NULL,'101',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (60,'الَّذِي هُوَ الْمَقْصُود مَقْصُود الْقلب بِالْقَصْدِ الأول فَيكون مُشْركًا بِمَا استعبده من ذَلِك.
...
وَقَالَ تَعَالَى [١٢٠ النَّحْل] : {إِن إِبْرَاهِيم كَانَ أمة قَانِتًا لله حَنِيفا وَلم يَك من الْمُشْركين} وَالْأمة هُوَ معلم الْخَيْر الَّذِي يؤتم بِهِ',NULL,'105',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (64,'كَمَا أَن الْقدْوَة الذى يقْتَدى بِهِ.
...
وَقد ثَبت فِي " الصَّحِيح " عَن النَّبِي صلى الله عَلَيْهِ وَسلم: أَن " إِبْرَاهِيم خير الْبَريَّة " فَهُوَ أفضل الْأَنْبِيَاء بعد النَّبِي صلى الله عَلَيْهِ وَسلم وَهُوَ خَلِيل الله تَعَالَى.

وَقد ثَبت فِي " الصَّحِيح " عَن النَّبِي صلى الله عَلَيْهِ وَسلم من غير وَجه أَنه قَالَ: " إِن الله اتخذنى خَلِيلًا كَمَا اتخذ إِبْرَاهِيم',NULL,'106',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (65,'خَلِيلًا ". وَقَالَ: " لَو كنت متخذا من أهل الأَرْض خَلِيلًا لاتخذت أَبَا بكر خَلِيلًا وَلَكِن صَاحبكُم خَلِيل الله " يعْنى نَفسه.
...
وَلَفظ الْعُبُودِيَّة يتَضَمَّن كَمَال الذل وَكَمَال الْحبّ فَإِنَّهُم',NULL,'107',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (66,'يَقُولُونَ قلب متيم إِذا كَانَ متعبدا للمحبوب والمتيم المتعبد وتيم الله عبد الله وَهَذَا على الْكَمَال حصل لإِبْرَاهِيم وَمُحَمّد صلى الله عَلَيْهِمَا وَسلم.

وَلِهَذَا لم يكن لَهُ صلى الله عَلَيْهِ وَسلم من أهل الأَرْض خَلِيل إِذْ الْخلَّة لَا تحْتَمل الشّركَة فَإِنَّهُ كَمَا قيل فِي الْمَعْنى:
قد تخللت مَسْلَك الرّوح مني ... وبذا سُمي الْخَلِيل خَلِيلًا

بِخِلَاف أصل الْحبّ فَإِنَّهُ صلى الله عَلَيْهِ وَسلم قد قَالَ فِي الحَدِيث الصَّحِيح فِي الْحسن وَأُسَامَة: " اللَّهُمَّ إنى أحبهما فأحبهما وَأحب من يحبهما ". وَسَأَلَهُ عَمْرو بن الْعَاصِ: أَي النَّاس أحب إِلَيْك؟ قَالَ: " عَائِشَة ".',NULL,'108',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (67,'قَالَ: فَمن الرِّجَال؟ قَالَ: "أَبوهَا ". وَقَالَ لعَلي رَضِي الله عَنهُ: " لَأُعْطيَن الرَّايَة غَدا رجلا يحب الله وَرَسُوله وَيُحِبهُ الله وَرَسُوله ". وأمثال ذَلِك كثير.
...
وَالْمَقْصُود هُوَ أَن الْخلَّة والمحبة لله تَحْقِيق عبوديته وَإِنَّمَا يغلط من يغلط فِي هَذِه من حَيْثُ يتوهمون أَن الْعُبُودِيَّة مُجَرّد ذل وخضوع فَقَط لَا محبَّة مَعَه وَأَن الْمحبَّة فِيهَا',NULL,'111',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (70,'انبساط فِي الْأَهْوَاء أَو إدلال لَا تحتمله الربوبية وَلِهَذَا يذكر عَن ذِي النُّون أَنهم تكلمُوا عِنْده فِي مَسْأَلَة الْمحبَّة فَقَالَ: أَمْسكُوا عَن هَذِه الْمَسْأَلَة لَا تسمعها النُّفُوس فتدعيها.

وَكره من كره من أهل الْمعرفَة وَالْعلم مجالسة أَقوام يكثرون الْكَلَام فِي الْمحبَّة بِلَا خشيَة.

وَقَالَ من قَالَ من السّلف: من عبد الله بالحب وَحده فَهُوَ زنديق وَمن عَبده بالرجاء وَحده فَهُوَ مرجئ وَمن عَبده بالخوف وَحده فَهُوَ حروري وَمن عَبده بالحب وَالْخَوْف والرجاء فَهُوَ مُؤمن موحد.',NULL,'112',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (71,'وَلِهَذَا وجد فِي الْمُتَأَخِّرين من انبسط فِي دَعْوَى الْمحبَّة حَتَّى أخرجه ذَلِك إِلَى نوع من الرعونة وَالدَّعْوَى الَّتِي تنَافِي الْعُبُودِيَّة وَتدْخل العَبْد فِي نوع من الربوبية الَّتِي لَا تصلح إِلَّا لله فيدعي أحدهم دعاوى تتجاوز حُدُود الْأَنْبِيَاء وَالْمُرْسلِينَ أَو يطْلب من الله مَا لَا يصلح بِكُل وَجه إِلَّا لله لَا يصلح للأنبياء وَلَا للمرسلين.
...
فَمن كَانَ الله يُحِبهُ اسْتَعْملهُ فِيمَا يُحِبهُ ومحبوبه لَا يفعل مَا يبغضه الْحق ويسخطه من الْكفْر والفسوق والعصيان',NULL,'113',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (72,'وَمن فعل الْكَبَائِر وأصر عَلَيْهَا وَلم يتب مِنْهَا فَإِن الله يبغض مِنْهُ ذَلِك كَمَا يحب مِنْهُ مَا يَفْعَله من الْخَيْر إِذْ حبه للْعَبد بِحَسب إيمَانه وتقواه.
...
وَالثَّانِي جعل مريده يمْنَع أهل الْكَبَائِر من دُخُول النَّار.',NULL,'114',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (73,'وَيَقُول بَعضهم: إِذا كَانَ يَوْم الْقِيَامَة نصبت خَيْمَتي على جَهَنَّم حَتَّى لَا يدخلهَا أحد.
...
بل قد جعل الله أساس محبته ومحبة رَسُوله الْجِهَاد فِي سَبيله وَالْجهَاد يتَضَمَّن كَمَال محبَّة مَا أَمر الله بِهِ وَكَمَال بغض مَا نهى الله عَنهُ وَلِهَذَا قَالَ فِي صفة من يُحِبهُمْ وَيُحِبُّونَهُ [٥٤ الْمَائِدَة] :',NULL,'115',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (74,'{أَذِلَّة على الْمُؤمنِينَ أعزة على الْكَافرين يجاهدون فِي سَبِيل الله وَلَا يخَافُونَ لومة لائم} .
...
وَفِي التَّوْرَاة وَالْإِنْجِيل من التَّرْغِيب فِي محبَّة الله مَا هم متفقون عَلَيْهِ حَتَّى إِن ذَلِك عِنْدهم أعظم وَصَايَا الناموس.',NULL,'117',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (76,'فَفِي الْإِنْجِيل أعظم وَصَايَا الْمَسِيح: (أَن تحب الله بِكُل قَلْبك وعقلك ونفسك) وَالنَّصَارَى يدعونَ قيامهم بِهَذِهِ الْمحبَّة وَأَن مَا هم فِيهِ من الزّهْد وَالْعِبَادَة هُوَ من ذَلِك وهم بُرَآء من محبَّة الله إِذْ لم يتبعوا مَا أحبه بل {اتبعُوا مَا أَسخط الله وكرهوا رضوانه فأحبط أَعْمَالهم} [٢٨ مُحَمَّد] .
...
وَقد أخبر الله سُبْحَانَهُ أَنه يحب الْمُتَّقِينَ والمحسنين وَالصَّابِرِينَ وَيُحب التوابين وَيُحب المتطهرين بل هُوَ يحب من فعل مَا أَمر بِهِ',NULL,'118',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (77,'من وَاجِب ومستحب كَمَا فِي الحَدِيث الصَّحِيح: " لَا يزَال عَبدِي يتَقرَّب إِلَيّ بالنوافل حَتَّى أحبه فَإِذا أحببته كنت سَمعه الَّذِي يسمع بِهِ وبصره الَّذِي يبصر بِهِ " الحَدِيث، وَكثير من المخطئين الَّذين ابتدعوا أَشْيَاء فِي الزّهْد وَالْعِبَادَة وَقَعُوا فِي بعض مَا وَقع فِيهِ النَّصَارَى من دَعْوَى الْمحبَّة لله مَعَ مُخَالفَة شَرِيعَته وَترك المجاهدة فِي سَبيله وَنَحْو ذَلِك ويتمسكون فِي الدَّين الَّذِي يَتَقَرَّبُون بِهِ إِلَى الله بِنَحْوِ مَا تمسك بِهِ النَّصَارَى من الْكَلَام الْمُتَشَابه والحكايات الَّتِي لَا يعرف صدق قَائِلهَا وَلَو صدق لم يكن قَائِلهَا مَعْصُوما فيجعلون متبوعيهم شارعين لَهُم دينا كَمَا جعل النَّصَارَى قسيسيهم وَرُهْبَانهمْ شارعين لَهُم دينا ثمَّ إِنَّهُم ينتقصون الْعُبُودِيَّة وَيدعونَ أَن الْخَاصَّة يتعدونها كَمَا يَدعِي النَّصَارَى فِي الْمَسِيح والقساوسة ويثبتون لخاصتهم من الْمُشَاركَة فِي الله من جنس مَا تثبته النَّصَارَى فِي الْمَسِيح وَأمه والقسيسين والرهبان إِلَى أَنْوَاع أخر يطول شرحها فِي هَذَا الْموضع.

وَإِنَّمَا الدَّين الْحق هُوَ تَحْقِيق الْعُبُودِيَّة لله بِكُل وَجه وَهُوَ تَحْقِيق محبَّة الله بِكُل دَرَجَة وبقدر تَكْمِيل الْعُبُودِيَّة تكمل محبَّة',NULL,'119',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (78,'العَبْد لرَبه وتكمل محبَّة الرب لعَبْدِهِ وبقدر نقص هَذَا يكون نقص هَذَا وَكلما كَانَ فِي الْقلب حب لغير الله كَانَت فِيهِ عبودية لغير الله بِحَسب ذَلِك وَكلما كَانَ فِيهِ عبودية لغير الله كَانَ فِيهِ حب لغير الله بِحَسب ذَلِك.
...
فَلَا بُد من الْعَمَل الصَّالح وَهُوَ الْوَاجِب وَالْمُسْتَحب وَلَا بُد أَن يكون خَالِصا لوجه الله تَعَالَى كَمَا قَالَ تَعَالَى [١١٢ الْبَقَرَة] : {بلَى من أسلم وَجهه لله وَهُوَ محسن فَلهُ أجره عِنْد ربه وَلَا خوف عَلَيْهِم وَلَا هم يَحْزَنُونَ} . وَقَالَ النَّبِي صلى الله عَلَيْهِ وَسلم: " من عمل عملا لَيْسَ عَلَيْهِ أمرنَا فَهُوَ رد " وَقَالَ صلى الله عَلَيْهِ وَسلم: " إِنَّمَا',NULL,'120',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (79,'الْأَعْمَال بِالنِّيَّاتِ وَإِنَّمَا لكل امْرِئ مَا نوى فَمن كَانَت هجرته إِلَى الله وَرَسُوله فَهجرَته إِلَى الله وَرَسُوله وَمن كَانَت هجرته لدُنْيَا يُصِيبهَا أَو امْرَأَة يَتَزَوَّجهَا فَهجرَته إِلَى مَا هَاجر إِلَيْهِ ".
...
وَعَن كَعْب بن مَالك عَن النَّبِي صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " مَا ذئبان جائعان أرسلا فِي زريبة غنم بأفسد لَهَا من حرص الْمَرْء على المَال والشرف لدينِهِ " قَالَ التِّرْمِذِيّ: حَدِيث حسن صَحِيح.',NULL,'122',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (81,'فَبين صلى الله عَلَيْهِ وَسلم أَن الْحِرْص على المَال والشرف فِي إِفْسَاد الدَّين لَا ينقص عَن إِفْسَاد الذئبين الجائعين لزريبة الْغنم وَذَلِكَ بيّن فَإِن الدَّين السَّلِيم لَا يكون فِيهِ هَذَا الْحِرْص وَذَلِكَ أَن الْقلب إِذا ذاق حلاوة عبوديته لله ومحبته لَهُ لم يكن شَيْء أحب إِلَيْهِ من ذَلِك حَتَّى يقدمهُ عَلَيْهِ وَبِذَلِك يصرف عَن أهل الْإِخْلَاص لله السوء والفحشاء كَمَا قَالَ تَعَالَى [٢٤ يُوسُف] : {كَذَلِك لنصرف عَنهُ السوء والفحشاء إِنَّه من عبادنَا المخلصين} .

فَإِن المخلص لله ذاق من حلاوة عبوديته لله مَا يمنعهُ عَن عبوديته لغيره وَمن حلاوة محبته لله مَا يمنعهُ عَن محبَّة غَيره إِذْ لَيْسَ عِنْد الْقلب السَّلِيم أحلى وَلَا ألذ وَلَا أطيب وَلَا أسر وَلَا أنعم من حلاوة الْإِيمَان المتضمن عبوديته لله ومحبته لَهُ وإخلاص الدَّين لَهُ وَذَلِكَ يَقْتَضِي انجذاب الْقلب إِلَى الله فَيصير الْقلب منيبا إِلَى الله خَائفًا مِنْهُ رَاغِبًا رَاهِبًا كَمَا قَالَ تَعَالَى [٣٣ ق] : {من خشِي الرَّحْمَن بِالْغَيْبِ وَجَاء بقلب منيب} إِذْ',NULL,'123',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (82,'الْمُحب يخَاف من زَوَال مَطْلُوبه أَو حُصُول مرغوبه فَلَا يكون عبد الله ومحبه إِلَّا بَين خوف ورجاء كَمَا قَالَ تَعَالَى [٥٧ الْإِسْرَاء] : {أُولَئِكَ الَّذين يدعونَ يَبْتَغُونَ إِلَى رَبهم الْوَسِيلَة أَيهمْ أقرب ويرجون رَحمته وَيَخَافُونَ عَذَابه إِن عَذَاب رَبك كَانَ محذورا} .
...
وَمن لم يكن خَالِصا لله عبدا لَهُ قد صَار قلبه معبدًا لرَبه وَحده لَا شريك لَهُ بِحَيْثُ يكون الله أحب إِلَيْهِ من كل مَا سواهُ وَيكون ذليلا لَهُ خاضعا وَإِلَّا استعبدته الكائنات',NULL,'124',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (83,'واستولت على قلبه الشَّيَاطِين فَكَانَ من الغاوين إخْوَان الشَّيَاطِين وَصَارَ فِيهِ من السوء والفحشاء مَا لَا يُعلمهُ إِلَّا الله.

وَهَذَا أَمر ضَرُورِيّ لَا حِيلَة فِيهِ.

فالقلب إِن لم يكن حَنِيفا مُقبلا على الله معرضًا عَمَّا سواهُ وَإِلَّا كَانَ مُشْركًا قَالَ تَعَالَى [٣٠-٣٢ الرّوم] : {فأقم وَجهك للدّين حَنِيفا فطْرَة الله الَّتِي فطر النَّاس عَلَيْهَا لَا تَبْدِيل لخلق الله ذَلِك الدَّين الْقيم وَلَكِن أَكثر النَّاس لَا يعلمُونَ * منيبين إِلَيْهِ واتقوه وَأقِيمُوا الصَّلَاة وَلَا تَكُونُوا من الْمُشْركين * من الَّذين فرقوا دينهم وَكَانُوا شيعًا كل حزب بِمَا لديهم فَرِحُونَ} .

وَقد جعل الله سُبْحَانَهُ إِبْرَاهِيم وَآل إِبْرَاهِيم أَئِمَّة لهَؤُلَاء الحنفاء المخلصين أهل محبَّة الله وعبادته وإخلاص الدَّين لَهُ كَمَا جعل فِرْعَوْن وَآل فِرْعَوْن أَئِمَّة الْمُشْركين المتبعين أهواءهم قَالَ تَعَالَى فِي إِبْرَاهِيم [٧٢-٧٣ الْأَنْبِيَاء] : {وَوَهَبْنَا لَهُ إِسْحَاق وَيَعْقُوب نَافِلَة وكلا جعلنَا صالحين * وجعلناهم أَئِمَّة يهْدُونَ بأمرنا وأوحينا إِلَيْهِم فعل الْخيرَات وإقام الصَّلَاة وإيتاء الزَّكَاة وَكَانُوا لنا عابدين} وَقَالَ فِي فِرْعَوْن وَقَومه [٤١-٤٢ الْقَصَص] : {وجعلناهم أَئِمَّة يدعونَ إِلَى النَّار وَيَوْم الْقِيَامَة لَا ينْصرُونَ * وأتبعناهم فِي هَذِه الدُّنْيَا لعنة وَيَوْم الْقِيَامَة هم من المقبوحين} وَلِهَذَا يصير أَتبَاع فِرْعَوْن أَولا إِلَى أَلا يميزوا بَين مَا',NULL,'125',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (84,'يُحِبهُ الله ويرضاه وَبَين مَا قدر الله وقضاه بل ينظرُونَ إِلَى الْمَشِيئَة الْمُطلقَة الشاملة ثمَّ فِي آخر الْأَمر لَا يميزون بَين الْخَالِق والمخلوق بل يجْعَلُونَ وجود هَذَا وجود هَذَا.
...
وَهَؤُلَاء الْمُشْركُونَ الضالون يسوون بَين الله وَبَين خلقه والخليل يَقُول [٧٥-٧٧ الشُّعَرَاء] : {أَفَرَأَيْتُم مَا كُنْتُم تَعْبدُونَ * أَنْتُم وآباؤكم الأقدمون * فَإِنَّهُم عَدو لي إِلَّا رب الْعَالمين} ويتمسكون بالمتشابه من كَلَام الْمَشَايِخ كَمَا فعلت النَّصَارَى.
...
وَهَذَا الْموضع زلت فِيهِ أَقوام وظنوا أَنه اتِّحَاد وَأَن الْمُحب يتحد بالمحبوب حَتَّى لَا يكون بَينهمَا فرق فِي نفس وجودهما وَهَذَا غلط فَإِن الْخَالِق لَا يتحد بِهِ شَيْء أصلا بل لَا يُمكن يتحد شَيْء بِشَيْء إِلَّا إِذا استحالا وفسدت حَقِيقَة كل مِنْهُمَا وَحصل من اتحادهما أَمر ثَالِث لَا هُوَ هَذَا',NULL,'128',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (87,'وَلَا هَذَا كَمَا إِذا اتَّحد المَاء وَاللَّبن وَالْمَاء وَالْخمر وَنَحْو ذَلِك وَلَكِن يتحد المُرَاد والمحبوب وَالْمرَاد وَالْمَكْرُوه ويتفقان فِي نوع الْإِرَادَة وَالْكَرَاهَة فيحب هَذَا مَا يحب هَذَا وَيبغض هَذَا مَا يبغض هَذَا ويرضى مَا يرضى ويسخط مَا يسْخط وَيكرهُ مَا يكره ويوالي من يوالي ويعادي من يعادي.
...
فَإِن الصَّحَابَة رَضِي الله عَنْهُم كَانُوا أكمل وَأقوى وَأثبت فِي الْأَحْوَال الإيمانية من أَن تغيب عُقُولهمْ أَو يحصل لَهُم غشي أَو صعق أَو سكر أَو فنَاء أَو وَله أَو جُنُون.

وَإِنَّمَا كَانَ مبادئ هَذِه الْأُمُور فِي التَّابِعين من عباد الْبَصْرَة فَإِنَّهُ كَانَ فيهم من يغشى عَلَيْهِ إِذا سمع الْقُرْآن وَمِنْهُم من يَمُوت كَأبي جهير الضَّرِير',NULL,'129',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (88,'وزرارة بن أوفى قَاضِي الْبَصْرَة.

وَكَذَلِكَ صَار فِي شُيُوخ الصُّوفِيَّة من يعرض لَهُ من الفناء وَالسكر مَا يضعف مَعَه تَمْيِيزه حَتَّى يَقُول فِي تِلْكَ الْحَال من الْأَقْوَال مَا إِذا صَحا عرف أَنه غالط فِيهِ كَمَا يحْكى نَحْو ذَلِك عَن مثل أبي يزِيد وَأبي الْحُسَيْن النوري وَأبي بكر الشبلي وأمثالهم بِخِلَاف أبي سُلَيْمَان الدَّارَانِي ومعروف الْكَرْخِي والفضيل بن',NULL,'130',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (89,'عِيَاض بل وَبِخِلَاف الْجُنَيْد وَأَمْثَاله مِمَّن كَانَت عُقُولهمْ وتمييزهم يصحبهم فِي أَحْوَالهم فَلَا يقعون فِي مثل هَذَا الفناء وَالسكر وَنَحْوه بل الكمل تكون قُلُوبهم لَيْسَ فِيهَا سوى محبَّة الله وإرادته وعبادته وَعِنْدهم من سَعَة الْعلم والتمييز مَا يشْهدُونَ [بِهِ] الْأُمُور على مَا هِيَ عَلَيْهِ بل يشْهدُونَ الْمَخْلُوقَات قَائِمَة بِأَمْر الله مُدبرَة بمشيئته بل مستجيبة لَهُ قانتة لَهُ فَيكون لَهُم فِيهَا تبصرة وذكرى وَيكون مَا يشهدونه من ذَلِك مؤيدا وممدا لما فِي قُلُوبهم من إخلاص الدَّين وَتَجْرِيد التَّوْحِيد لَهُ وَالْعِبَادَة لَهُ وَحده لَا شريك لَهُ.

وَهَذِه هِيَ الْحَقِيقَة الَّتِي دَعَا إِلَيْهَا الْقُرْآن وَقَامَ بهَا أهل تَحْقِيق الْإِيمَان والكمل من أهل الْعرْفَان وَنَبِينَا صلى الله عَلَيْهِ وَسلم إِمَام هَؤُلَاءِ وأكملهم وَلِهَذَا لما عرج بِهِ إِلَى السَّمَاوَات وعاين مَا هُنَاكَ من الْآيَات وأوحي إِلَيْهِ مَا أُوحِي من أَنْوَاع الْمُنَاجَاة أصبح فيهم وَهُوَ لم يتَغَيَّر حَاله وَلَا ظهر عَلَيْهِ ذَلِك بِخِلَاف',NULL,'131',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (90,'مَا كَانَ يظْهر على مُوسَى من التغشي صلى الله عَلَيْهِم وَسلم أَجْمَعِينَ.
...
والمشايخ الصالحون رَضِي الله عَنْهُم يذكرُونَ شَيْئا من تَجْرِيد التَّوْحِيد وَتَحْقِيق إخلاص الدَّين كُله بِحَيْثُ لَا يكون العَبْد ملتفتا إِلَى غير الله وَلَا نَاظرا إِلَى مَا سواهُ لَا حبا لَهُ وَلَا خوفًا مِنْهُ وَلَا رَجَاء لَهُ بل يكون الْقلب فَارغًا من الْمَخْلُوقَات خَالِيا مِنْهَا لَا ينظر إِلَيْهَا إِلَّا بِنور الله، فبالحق يسمع وبالحق',NULL,'132',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (91,'وبالحق يبصر، وبالحق يبطش وبالحق يمشي فيحب مِنْهَا مَا يُحِبهُ الله وَيبغض مِنْهَا مَا يبغضه الله ويوالي مِنْهَا مَا وَالَاهُ الله ويعادي مِنْهَا مَا عَادَاهُ الله وَيخَاف الله فِيهَا وَلَا يخافها فِي الله ويرجو الله فِيهَا وَلَا يرجوها فِي الله فَهَذَا هُوَ الْقلب السَّلِيم الحنيف الموحد الْمُسلم الْمُؤمن الْمُحَقق الْعَارِف بِمَعْرِِفَة الْأَنْبِيَاء وَالْمُرْسلِينَ وتحقيقهم وتوحيدهم.
...
وكل الْمَشَايِخ الَّذين يقْتَدى بهم فِي الدَّين متفقون على مَا اتّفق عَلَيْهِ سلف الْأمة وأئمتها من أَن الْخَالِق سُبْحَانَهُ مباين',NULL,'133',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (92,'للمخلوقات وَلَيْسَ فِي مخلوقاته شَيْء من ذَاته وَلَا فِي ذَاته شَيْء من مخلوقاته وَأَنه يجب إِفْرَاد الْقَدِيم عَن الْحَادِث وتمييز الْخَالِق عَن الْمَخْلُوق وَهَذَا فِي كَلَامهم أَكثر من أَن يُمكن ذكره هُنَا.
...
فَيكون نافيا لألوهية كل شَيْء من الْمَخْلُوقَات مثبتا لألوهية رب الْعَالمين وَرب الأَرْض وَالسَّمَاوَات وَذَلِكَ يتَضَمَّن اجْتِمَاع الْقلب على الله وعَلى مُفَارقَة مَا سواهُ فَيكون مفرقا فِي علمه وقصده فِي شَهَادَته وإرادته فِي مَعْرفَته ومحبته بَين الْخَالِق والمخلوق بِحَيْثُ يكون عَالما بِاللَّه تَعَالَى ذَاكِرًا لَهُ عَارِفًا بِهِ وَهُوَ مَعَ ذَلِك عَالم بمباينته لخلقه وانفراده عَنْهُم وتوحده دونهم وَيكون محبا لله مُعظما لَهُ عابدا لَهُ راجيا لَهُ خَائفًا مِنْهُ محبا فِيهِ مواليا فِيهِ معاديا فِيهِ مستعينا بِهِ متوكلا عَلَيْهِ مُمْتَنعا عَن عبَادَة غَيره والتوكل عَلَيْهِ',NULL,'135',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (94,'والاستعانة بِهِ وَالْخَوْف مِنْهُ والرجاء لَهُ والموالاة فِيهِ والمعاداة فِيهِ وَالطَّاعَة لأَمره وأمثال ذَلِك مِمَّا هُوَ من خَصَائِص إلهية الله سُبْحَانَهُ وَتَعَالَى.
...
وَلم يذكر ذَلِك أحد من سلف الْأمة وَلَا شرع ذَلِك رَسُول الله صلى الله عَلَيْهِ وَسلم وَلَا يُعْطي القلبَ بِنَفسِهِ معرفَة مفيدة وَلَا حَالا نَافِعًا وَإِنَّمَا يُعْطِيهِ تصورا مُطلقًا وَلَا يُحكم عَلَيْهِ بِنَفْي وَلَا إِثْبَات فَإِن لم يقْتَرن بِهِ من معرفَة الْقلب وحاله مَا يُفِيد',NULL,'137',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (96,'بِنَفسِهِ وَإِلَّا لم يكن فِيهِ فَائِدَة والشريعة إِنَّمَا تشرع من الْأَذْكَار مَا يُفِيد بِنَفسِهِ لَا مَا تكون الْفَائِدَة حَاصِلَة بِغَيْرِهِ.
...
وَمَا يذكر عَن بعض الشُّيُوخ من أَنه قَالَ: أَخَاف أَن أَمُوت بَين النَّفْي وَالْإِثْبَات، حَال لَا يقْتَدى فِيهَا بصاحبها فَإِن فِي ذَلِك من الْغَلَط مَا لَا خَفَاء بِهِ إِذْ لَو مَاتَ العَبْد فِي هَذِه الْحَال لم يمت إِلَّا على مَا قَصده ونواه إِذْ الْأَعْمَال بِالنِّيَّاتِ وَقد ثَبت أَن النَّبِي صلى الله عَلَيْهِ وَسلم أَمر يتلقين الْمَيِّت: " لَا إِلَه إِلَّا الله " وَقَالَ: " من كَانَ آخر كَلَامه: لَا إِلَه إِلَّا الله دخل الْجنَّة " وَلَو كَانَ مَا ذكره محذورا لم يلقن الْمَيِّت كلمة يخَاف أَن يَمُوت فِي أَثْنَائِهَا موتا غير مَحْمُود بل كَانَ يلقن مَا اخْتَارَهُ من ذكر الِاسْم الْمُفْرد.

وَالذكر بِالِاسْمِ الْمُضمر الْمُفْرد أبعد عَن السّنة وَأدْخل فِي الْبِدْعَة وَأقرب إِلَى ضلال الشَّيْطَان فَإِن من قَالَ: يَا هُوَ يَا',NULL,'138',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (97,'هُوَ أَو هُوَ هُوَ وَنَحْو ذَلِك لم يكن الضَّمِير عَائِدًا إِلَّا إِلَى مَا يصوره قلبه وَالْقلب قد يَهْتَدِي وَقد يضل.

وَقد صنف صَاحب " الفصوص " كتابا سَمَّاهُ كتاب " الهو " وَزعم بَعضهم أَن قَوْله [٧ آل عمرَان] : {وَمَا يعلم تَأْوِيله إِلَّا الله} مَعْنَاهُ: وَمَا يعلم تَأْوِيل هَذَا الِاسْم الَّذِي هُوَ الهو، وَإِن كَانَ هَذَا مِمَّا اتّفق الْمُسلمُونَ بل الْعُقَلَاء على انه من أبين الْبَاطِل فقد يظنّ ذَلِك من يَظُنّهُ من هَؤُلَاءِ، حَتَّى قلت مرّة لبَعض من قَالَ شَيْئا من ذَلِك: لَو كَانَ هَذَا مَا قلتَه لكُتبت الْآيَة: وَمَا يعلم تَأْوِيل (هُوَ) مُنْفَصِلَة.

ثمَّ كثيرا مَا يذكر بعض الشُّيُوخ أَنه يحْتَج على قَول الْقَائِل: (الله) بقوله [٩١ الْأَنْعَام] : {قل الله ثمَّ ذرهم} ويظن أَن الله أَمر نبيه بِأَن يَقُول الِاسْم الْمُفْرد وَهَذَا غلط بِاتِّفَاق أهل الْعلم فَإِن قَوْله: {قل الله} مَعْنَاهُ: الله الَّذِي أنزل الْكتاب الَّذِي جَاءَ بِهِ مُوسَى وَهُوَ جَوَاب لقَوْله: {قل من أنزل الْكتاب الَّذِي جَاءَ بِهِ مُوسَى نورا وَهدى للنَّاس تجعلونه قَرَاطِيس تبدونها وتخفون كثيرا وعلمتم مَا لم تعلمُوا أَنْتُم وَلَا آباؤكم قل الله} أَي: الله الَّذِي أنزل الْكتاب الَّذِي جَاءَ بِهِ مُوسَى، رد بذلك قَول من قَالَ: {مَا أنزل الله على بشر من شَيْء} فَقَالَ: {من أنزل الْكتاب',NULL,'139',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (98,'الَّذِي جَاءَ بِهِ مُوسَى} ثمَّ قَالَ: {قل الله} أنزلهُ ثمَّ ذَر هَؤُلَاءِ المكذبين {فِي خوضهم يَلْعَبُونَ} .
...
وَ<span data-type="title" id=toc-138>الِاسْم الْمُجَرّد لَا يُفِيد شَيْئا من الْإِيمَان </span>بِاتِّفَاق أهل الْإِسْلَام وَلَا يُؤمر بِهِ فِي شَيْء من الْعِبَادَات وَلَا فِي شَيْء من المخاطبات.
...
وَمَا فِي الْقُرْآن من قَوْله [٨ المزمل] : {وَاذْكُر اسْم رَبك وتبتل إِلَيْهِ تبتيلا} وَقَوله [١ الْأَعْلَى] : {سبح اسْم رَبك الْأَعْلَى} وَقَوله [١٤-١٥ الْأَعْلَى] : {قد أَفْلح من تزكّى * وَذكر اسْم ربه فصلى} وَقَوله [٧٤ الْوَاقِعَة] : {فسبح باسم رَبك الْعَظِيم} وَنَحْو ذَلِك لَا يقتضى ذكره مُفردا.',NULL,'140',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (99,'بل فِي " السّنَن " أَنه لما نزل قَوْله: {فسبح باسم رَبك الْعَظِيم} قَالَ: " اجْعَلُوهَا فِي ركوعكم " وَلما نزل قَوْله: {سبح اسْم رَبك الْأَعْلَى} قَالَ: " اجْعَلُوهَا فِي سُجُودكُمْ ". فشرع لَهُم أَن يَقُولُوا فِي الرُّكُوع: (سُبْحَانَ رَبِّي الْعَظِيم) وَفِي السُّجُود (سُبْحَانَ رَبِّي الْأَعْلَى) . وَفِي " الصَّحِيح " أَنه كَانَ يَقُول فِي رُكُوعه: " سُبْحَانَ رَبِّي الْعَظِيم " وَفِي سُجُوده " سُبْحَانَ رَبِّي الْأَعْلَى " وَهَذَا هُوَ معنى قَوْله: " اجْعَلُوهَا فِي ركوعكم وسجودكم " بِاتِّفَاق الْمُسلمين.

فتسبيح اسْم ربه الْأَعْلَى وَذكر اسْم ربه وَنَحْو ذَلِك هُوَ بالْكلَام التَّام الْمُفِيد كَمَا فِي " الصَّحِيح " عَنهُ صلى الله عَلَيْهِ وَسلم: أَنه قَالَ: " أفضل الْكَلَام بعد الْقُرْآن أَربع وَهن من الْقُرْآن: سُبْحَانَ الله وَالْحَمْد لله وَلَا إِلَه إِلَّا الله وَالله أكبر ". وَفِي " الصَّحِيح "',NULL,'141',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (100,'عَنهُ صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " كلمتان خفيفتان على اللِّسَان ثقيلتان فِي الْمِيزَان حبيبتان إِلَى الرَّحْمَن: سُبْحَانَ الله وَبِحَمْدِهِ سُبْحَانَ الله الْعَظِيم ".

وَفِي " الصَّحِيحَيْنِ " عَنهُ صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " من قَالَ فِي يَوْمه مائَة مرّة: لَا إِلَه إِلَّا الله وَحده لَا شريك لَهُ لَهُ الْملك وَله الْحَمد وَهُوَ على كل شَيْء قدير، كتب الله لَهُ حرْزا من الشَّيْطَان يَوْمه ذَلِك حَتَّى يُمْسِي وَلم يَأْتِ أحد بِأَفْضَل مِمَّا جَاءَ بِهِ إِلَّا رجل قَالَ مثل مَا قَالَ أَو زَاد عَلَيْهِ ". و " من قَالَ فِي يَوْمه مائَة مرّة: سُبْحَانَ الله وَبِحَمْدِهِ سُبْحَانَ الله الْعَظِيم، حطت عَنهُ خطاياه وَلَو كَانَت مثل زبد الْبَحْر ". وَفِي " الْمُوَطَّأ " وَغَيره عَن النَّبِي صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " أفضل مَا قلته أَنا والنبيون من قبلي: لَا إِلَه إِلَّا الله وَحده لَا شريك لَهُ لَهُ الْملك وَله الْحَمد وَهُوَ على كل شَيْء قدير "',NULL,'142',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (101,'وَفِي " سنَن ابْن مَاجَه " وَغَيره عَنهُ صلى الله عَلَيْهِ وَسلم أَنه قَالَ: " أفضل الذّكر لَا إِلَه إِلَّا الله وَأفضل الدُّعَاء الْحَمد لله ".

وَمثل هَذِه الْأَحَادِيث كَثِيرَة فِي أَنْوَاع مَا يُقَال من الذّكر وَالدُّعَاء.

وَكَذَلِكَ مَا فِي الْقُرْآن من قَوْله تَعَالَى [١٢١ الْأَنْعَام] : {وَلَا تَأْكُلُوا مِمَّا لم يذكر اسْم الله عَلَيْهِ} وَقَوله [٤ الْمَائِدَة] : {فَكُلُوا مِمَّا أمسكن عَلَيْكُم واذْكُرُوا اسْم الله عَلَيْهِ} إِنَّمَا هُوَ قَول: بِسم الله، وَهَذِه جملَة تَامَّة، إِمَّا اسمية على أظهر قولي النُّحَاة، أَو فعلية وَالتَّقْدِير: ذبحي بِسم الله أَو أذبح بِسم الله. وَكَذَلِكَ قَول الْقَارئ: بِسم الله الرَّحْمَن الرَّحِيم، فتقديره قراءتي بِسم الله أَو اقْرَأ باسم الله. وَمن النَّاس من يضمر فِي مثل هَذَا: ابتدائي بِسم الله أَو ابتدأت بِسم الله، وَالْأول أحسن؛ لِأَن الْفِعْل كُله مفعول باسم الله لَيْسَ مُجَرّد ابْتِدَائه، كَمَا أظهر الْمُضمر فِي قَوْله [١ العلق] :',NULL,'143',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (102,'{اقْرَأ باسم رَبك الَّذِي خلق} وَفِي قَوْله [٤١ هود] : {بِسم الله مجريها وَمرْسَاهَا} وَفِي قَول النَّبِي صلى الله عَلَيْهِ وَسلم: " من كَانَ ذبح قبل الصَّلَاة فليذبح مَكَانهَا أُخْرَى وَمن لم يكن ذبح فليذبح باسم الله ". وَمن هَذَا الْبَاب قَول النَّبِي صلى الله عَلَيْهِ وَسلم فِي الحَدِيث الصَّحِيح لربيبه عمر بن أَبى سَلمَة: " يَا غُلَام سم الله وكل بيمينك وكل مِمَّا يليك " فَالْمُرَاد أَن يَقُول: باسم الله، لَيْسَ المُرَاد أَن يذكر الِاسْم مُجَردا وَكَذَلِكَ قَوْله فِي الحَدِيث الصَّحِيح لعدي بن حَاتِم: " إِذا أرْسلت كلبك الْمعلم وَذكرت اسْم الله فَكل " وَكَذَلِكَ قَوْله صلى الله عَلَيْهِ وَسلم: " إِذا دخل الرجل منزله فَذكر اسْم الله عِنْد دُخُوله وَعند خُرُوجه وَعند طَعَامه قَالَ الشَّيْطَان: لَا مبيت لكم وَلَا عشَاء " وأمثال ذَلِك كثير.

وَكَذَلِكَ مَا شرع للْمُسلمين فِي صلَاتهم وأذانهم وحجهم وأعيادهم من ذكر الله تَعَالَى إِنَّمَا هُوَ بِالْجُمْلَةِ التَّامَّة كَقَوْل الْمُؤَذّن: (الله أكبر الله أكبر أشهد أَن لَا إِلَه إِلَّا الله أشهد أَن مُحَمَّدًا رَسُول الله) وَقَول الْمُصَلِّي: (الله أكبر سُبْحَانَ رَبِّي',NULL,'144',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (103,'الْعَظِيم سُبْحَانَ رَبِّي الْأَعْلَى سمع الله لمن حَمده رَبنَا وَلَك الْحَمد التَّحِيَّات لله) وَقَول الملبي: (لبيْك اللَّهُمَّ لبيْك) وأمثال ذَلِك.

فَجَمِيع مَا شَرعه الله من الذّكر إِنَّمَا هُوَ كَلَام تَامّ لَا اسْم مُفْرد وَلَا مظهر وَلَا مُضْمر.

وَهَذَا هُوَ الَّذِي يُسمى فِي اللُّغَة (كلمة) كَقَوْلِه: " كلمتان خفيفتان على اللِّسَان ثقيلتان فِي الْمِيزَان حبيبتان إِلَى الرَّحْمَن: سُبْحَانَ الله وَبِحَمْدِهِ سُبْحَانَ الله الْعَظِيم " وَقَوله: " أفضل كلمة قَالَهَا الشَّاعِر كلمة لبيد: أَلا كل شَيْء مَا خلا الله بَاطِل " وَمِنْه قَوْله تَعَالَى [٥ الْكَهْف] : {كَبرت كلمة تخرج من أَفْوَاههم} الْآيَة وَقَوله [١١٥ الْأَنْعَام] : {وتمت كلمة رَبك صدقا وعدلا} .

وأمثال ذَلِك مِمَّا اسْتعْمل فِيهِ لفظ (الْكَلِمَة) من الْكتاب وَالسّنة بل وَسَائِر كَلَام الْعَرَب فَإِنَّمَا يُرَاد بِهِ الْجُمْلَة التَّامَّة',NULL,'145',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (104,'كَمَا كَانُوا يستعملون الْحَرْف فِي الِاسْم فَيَقُولُونَ: هَذَا حرف غَرِيب أَي لفظ الِاسْم غَرِيب.
...
وَلَفظ الْحَرْف يتَنَاوَل هَذِه الْأَسْمَاء وَغَيرهَا كَمَا قَالَ النَّبِي صلى الله عَلَيْهِ وَسلم: " من قَرَأَ الْقُرْآن فأعربه فَلهُ بِكُل حرف عشر حَسَنَات أما إِنِّي لَا أَقُول {ألم} حرف وَلَكِن ألف حرف وَلَام حرف وَمِيم حرف " وَقد سَأَلَ الْخَلِيل بن أَحْمد أَصْحَابه عَن النُّطْق بِحرف الزَّاي من زيد؟ فَقَالُوا: (زَاي) فَقَالَ: جئْتُمْ بِالِاسْمِ وَإِنَّمَا الْحَرْف (زَ) .

ثمَّ إِن النُّحَاة اصْطَلحُوا على أَن هَذَا الْمُسَمّى فِي اللُّغَة',NULL,'146',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (105,'بالحرف يُسمى كلمة وَأَن لفظ الْحَرْف يخص لما جَاءَ لِمَعْنى لَيْسَ باسم وَلَا فعل كحروف الْجَرّ وَنَحْوهَا.
...
كَمَا قد بسط الْكَلَام عَلَيْهِ فِي غير هَذَا الْموضع.',NULL,'147',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (106,'فصل

و<span data-type="title" id=toc-148>جماع الدَّين أصلان: </span>أَلا نعْبد إِلَّا الله وَلَا نعبده إِلَّا بِمَا شرع لَا نعبده بالبدع.
...
وَقد بَين لنا مَا نعْبد الله بِهِ ونهانا عَن محدثات الْأُمُور وَأخْبر أَنَّهَا ضَلَالَة قَالَ تَعَالَى [١١٢ الْبَقَرَة] : {بلَى من أسلم وَجهه لله وَهُوَ محسن فَلهُ أجره عِنْد ربه وَلَا خوف عَلَيْهِم وَلَا هم يَحْزَنُونَ} .

وكما أننا مأمورون أَلا نَخَاف إِلَّا الله وَلَا نتوكل إِلَّا على الله وَلَا نرغب إِلَّا إِلَى الله وَلَا نستعين إِلَّا بِاللَّه وَألا تكون عبادتنا إِلَّا لله فَكَذَلِك نَحن مأمورون أَن نتبع الرَّسُول ونطيعه ونتأسى بِهِ فالحلال مَا حلله وَالْحرَام مَا حرمه.',NULL,'148',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (107,'وَالدّين مَا شَرعه قَالَ الله تَعَالَى [٥٩ التَّوْبَة] : {وَلَو أَنهم رَضوا مَا آتَاهُم الله وَرَسُوله وَقَالُوا حَسبنَا الله سيؤتينا الله من فَضله وَرَسُوله إِنَّا إِلَى الله راغبون} فَجعل الإيتاء لله وَلِلرَّسُولِ كَمَا قَالَ [٧ الْحَشْر] : {وَمَا آتَاكُم الرَّسُول فَخُذُوهُ وَمَا نهاكم عَنهُ فَانْتَهوا} وَجعل التَّوَكُّل على الله وَحده بقوله: {وَقَالُوا حَسبنَا الله} وَلم يقل: وَرَسُوله - كَمَا قَالَ فِي وصف الصَّحَابَة رَضِي الله عَنْهُم فِي الْآيَة الْأُخْرَى [١٧٣ آل عمرَان] : {الَّذين قَالَ لَهُم النَّاس إِن النَّاس قد جمعُوا لكم فَاخْشَوْهُمْ فَزَادَهُم إِيمَانًا وَقَالُوا حَسبنَا الله وَنعم الْوَكِيل} وَمثله قَوْله [٦٤ الْأَنْفَال] : {يَا أَيهَا النَّبِي حَسبك الله وَمن اتبعك من الْمُؤمنِينَ} أَي حَسبك وَحسب الْمُؤمنِينَ كَمَا قَالَ [٣٦ الزمر] : {أَلَيْسَ الله بكاف عَبده} - ثمَّ قَالَ: {سيؤتينا الله من فَضله وَرَسُوله} فَجعل الإيتاء لله وَلِلرَّسُولِ وَقدم ذكر الْفضل لله لِأَن {الْفضل بيد الله يؤتيه من يَشَاء وَالله ذُو الْفضل الْعَظِيم} وَله الْفضل على رَسُوله وعَلى الْمُؤمنِينَ وَقَالَ: {إِنَّا إِلَى الله راغبون} فَجعل الرَّغْبَة إِلَى الله وَحده كَمَا فِي قَوْله [٧-٨ الشَّرْح] : {فَإِذا فرغت فانصب * وَإِلَى رَبك فارغب} .

وَقَالَ النَّبِي صلى الله عَلَيْهِ وَسلم لِابْنِ عَبَّاس: " إِذا سَأَلت فاسأل الله وَإِذا استعنت فَاسْتَعِنْ بِاللَّه " وَالْقُرْآن يدل على مثل هَذَا فِي غير مَوضِع.',NULL,'149',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (108,'فَجعل الْعِبَادَة والخشية وَالتَّقوى لله وَجعل الطَّاعَة والمحبة لله وَرَسُوله كَمَا فِي قَول نوح عَلَيْهِ السَّلَام [٣ نوح] : {أَن اعبدوا الله واتقوه وأطيعون} وَقَوله [٥٢ النُّور] : {وَمن يطع الله وَرَسُوله ويخش الله ويتقه فَأُولَئِك هم الفائزون} وأمثال ذَلِك.
...
وَهدى الله الْمُؤمنِينَ المخلصين لله<span data-type="title" id=toc-151> أهل الصِّرَاط الْمُسْتَقيم </span>الَّذين عرفُوا الْحق واتبعوه فَلم يَكُونُوا من المغضوب عَلَيْهِم وَلَا الضَّالّين فأخلصوا دينهم لله وَأَسْلمُوا وُجُوههم لله وأنابوا إِلَى رَبهم وأحبوه ورجوه وخافوه وسألوه وَرَغبُوا إِلَيْهِ وفوضوا أُمُورهم إِلَيْهِ وتوكلوا عَلَيْهِ وأطاعوا رسله وعزروهم ووقروهم وأحبوهم ووالوهم واتبعوهم واقتفوا آثَارهم واهتدوا بمنارهم.',NULL,'150',NULL,NULL,'0');
INSERT INTO [b22647] VALUES (109,'وَذَلِكَ هُوَ دين الْإِسْلَام الَّذِي بعث الله بِهِ الْأَوَّلين والآخرين من الرُّسُل وَهُوَ الدَّين الَّذِي لَا يقبل الله من أحد دينا إِلَّا إِيَّاه وَهُوَ حَقِيقَة الْعِبَادَة لرب الْعَالمين.

فنسأل الله الْعَظِيم أَن يثبتنا عَلَيْهِ ويكمله لنا ويميتنا عَلَيْهِ وَسَائِر إِخْوَاننَا الْمُسلمين.

وَالْحَمْد لله وَحده وَصلى الله على سيدنَا مُحَمَّد وَآله وَصَحبه وَسلم.',NULL,'151',NULL,NULL,'0');
