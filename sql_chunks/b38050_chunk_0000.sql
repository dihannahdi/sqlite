...
CREATE TABLE "b38050"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b38050
INSERT INTO [b38050] VALUES (1,'<span data-type="title" id=toc-1>المقدمة:</span>
...
<span data-type="title" id=toc-2>١ - أحكام الاستعاذة والبسملة:</span>
لكل من الاستعاذة والبسملة أحكام خاصة، كما أن هناك أحكاما أخرى لاجتماعهما معا، وسوف نبين هذه الأحكام فيما يلي:
آ- حكم الاستعاذة: الاستعاذة سنة مستحبة. وهي مطلوبة عند تلاوة القرآن الكريم، على الرغم من أنها ليست منه.',NULL,'608',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (2,'وقال بعضهم: إنها واجبة، خصوصا عند البدء بالقراءة، سواء أكانت القراءة من أول السورة، أو من خلالها، والدليل على ذلك هو قوله تعالى: فَإِذا قَرَأْتَ الْقُرْآنَ فَاسْتَعِذْ بِاللَّهِ مِنَ الشَّيْطانِ الرَّجِيمِ.
...
إذا ابتدأ القارئ القراءة، فله الخيار بين واحد من الأوجه الأربعة التالية:',NULL,'609',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (3,'١ - قطع الجميع: أي قطع الاستعاذة عن البسملة، وقطع البسملة عن بداية السورة.
...
<span data-type="title" id=toc-3>٢ - أحكام النون الساكنة والتنوين:</span>
...
والغنة: صوت لذيذ، يخرج من خرق الأنف المنجذب إلى داخل الفم، المركب فوق غار الحنك الأعلى، لا عمل للسان فيه. ويغن هذا الحرف بمقدار حركتين، والحركة هي بمقدار بسط الإصبع أو قبضها (بمقدار ثانية).',NULL,'610',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (4,'٢ - الإدغام بلا غنة (الكامل): يكون مع أحد الحرفين التاليين: ل- ر، مثال ذلك:
...
مثال ذلك: عَنْ صَلاتِهِمْ- وَانْصُرْنا*- رِيحاً صَرْصَراً*- مِنْ ذَهَبٍ*- وَأَنْذِرْهُمْ*- ظِلٍّ ذِي.',NULL,'611',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (5,'وكما يبدو من الأمثلة، فإننا لونا النون الساكنة أو التنوين باللون الأخضر دلالة على وقوع حكم الإخفاء على كل منهما.
د- الإظهار:
...
<span data-type="title" id=toc-4>٣ - أحكام الميم الساكنة:</span>
...
وكما يبدو من الأمثلة، فإننا لونا الميم باللون الأخضر، دلالة على وقوع الإخفاء عليها. ومما ينبغي التنبه له هو أنه يجب إطباق الشفتين عند الإخفاء الشفوي، دون انفراج بينهما.',NULL,'612',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (6,'ج- الإظهار:
...
<span data-type="title" id=toc-5>٤ - أحكام الميم والنون المشددتين:</span>
...
<span data-type="title" id=toc-6>٥ - أحكام الإدغام:</span>
...
١ - الدال مع التاء، مثل: قَدْ تَبَيَّنَ*- وَجَدْتُمْ*- أَرَدْتُمْ*.
٢ - التاء مع الدال، مثل: أُجِيبَتْ دَعْوَتُكُما أَثْقَلَتْ دَعَوَا اللَّهَ.',NULL,'613',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (7,'٣ - التاء مع الطاء، مثل: قالَتْ طائِفَةٌ* وَدَّتْ طائِفَةٌ.
٤ - الذال مع الظاء، مثل: إِذْ ظَلَمُوا أَنْفُسَهُمْ إِذْ ظَلَمْتُمْ.
٥ - الباء مع الميم، مثل: ارْكَبْ مَعَنا.
٦ - الطاء مع التاء، مثل: بَسَطْتَ أَحَطْتُ فَرَّطْتُمْ.
ج- إدغام المتقاربين وهو أن يكون الحرفان المتتاليان متقاربين في المخرج والصفة. وهو منحصر في حرفين، هما:
١ - اللام مع الراء، مثل بَلْ رَفَعَهُ- قُلْ رَبِّ*.
٢ - القاف مع الكاف، مثل: نَخْلُقْكُمْ. وذلك بحذف صفة الاستعلاء عن القاف، وهو الوجه الأرجح.
...
<span data-type="title" id=toc-7>٦ - أحكام اللام الساكنة:</span>
...
طب ثم صل رحما تفز ضف ذا نعم ... دع سوء ظن زر شريفا للكرم',NULL,'614',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (8,'ويسمى هذا الإدغام ب (الإدغام الشمسي)، ويتحقق بدمج هذه اللام بالحرف الذي يليها، بحيث يصيران حرفا واحدا مشددا، وهو الحرف الذي بعدها، بحيث لا يظهر أي أثر لهذه اللام، مثال ذلك: الطَّامَّةُ- الثَّوابِ*- الظَّالِمِينَ*- اللَّطِيفُ*.
...
وكما يبدو من الأمثلة، فإننا لونا لام: (هل) و (بل) باللون الأحمر، دلالة على إدغامها بما بعدها، ولونا الشدة الواقعة على الحرف بعدها باللون الأخضر، دلالة على أن الإدغام دون غنة.',NULL,'615',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (9,'٢ - الإظهار: تظهر اللام، إذا وقع بعدها أي حرف من أحرف الهجاء، ما عدا اللام والراء، مثال ذلك: هَلْ أَتاكَ* بَلْ تُؤْثِرُونَ بَلْ نَحْنُ* هَلْ يَسْتَوِي*.
وكما يبدو من الأمثلة، فإننا أبقينا اللام باللون الأسود، دلالة على إظهارها.
...
١ - التفخيم: يجب تفخيم الراء إذا كانت مفتوحة أو مضمومة، سواء أكانت في أول الكلمة أم في وسطها أم في آخرها، مثال ذلك: رَؤُفٌ*- بِالصَّبْرِ*- نَغْفِرْ*- رُزِقُوا- يَتَذَكَّرُ*- يَشْكُرُ*.',NULL,'616',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (10,'ويلحق بذلك الراء الساكنة التي قبلها مفتوح أو مضموم، مثل: الْعَرْشِ*- تَرْمِيهِمْ- الْقُرْآنُ*- تُرْجِي.
...
<span data-type="title" id=toc-8>٨ - أحكام المدود وأقسامها:</span>
...
٣ - الياء الساكنة المكسور ما قبلها.',NULL,'617',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (11,'وقد اجتمعت هذه المدود في كلمة: (نوحيها).
...
٢ - مدّ الصلة الصغرى: وهو حرف مدّ زائد، يتحصل من إشباع الحركة على هاء الضمير، الواقعة بين متحركين، ثانيهما غير مهموز.
...
٣ - مدّ البدل: هو أن يأتي همز، وبعده مد، في كلمة واحدة.
...
٤ - مدّ التمكين: وهو المدّ الواقع على الياء الساكنة، المسبوقة بياء مشددة مكسورة، وسمي بذلك لأن الشدة قبله مكنته، وهو يمد بمقدار حركتين.',NULL,'618',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (12,'مثال ذلك: حُيِّيتُمْ- النَّبِيِّينَ*- الْأُمِّيِّينَ*.
...
وكما يبدو من الأمثلة، فإننا لونا شارة المد باللون الأخضر، الذي لونا به المد المنفصل، دلالة على جواز مده أربعا، أو خمسا.',NULL,'619',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (13,'٢ - المدود التي سبب زيادتها السكون: وهي مدان، المد العارض للسكون، والمد اللازم، وسوف نتكلم عن كل منهما فيما يلي:
...
١ - مد لازم كلمي: وهو المد اللازم الذي يقع في كلمة، وليس في حرف، وهذا المد ينقسم بدوره إلى قسمين.
- مد لازم كلمي مثقل: وهو الذي يأتي فيه بعد حرف المد حرف مشدد، نحو: الْحَاقَّةُ*- الصَّاخَّةُ- الضَّالِّينَ*.',NULL,'620',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (14,'- مد لازم كلمي مخفف: وهو الذي يأتي فيه بعد حرف المد حرف ساكن، وهو لا يوجد إلّا في كلمة الْآنَ* في موضعين من سورة يونس.
...
مد الفرق: وهو أن تدخل همزة الاستفهام على اسم معرف ب (أل) التعريف، فتبدل همزة (أل) التعريف ألفا دية، ليفرق بين الاستفهام والخبر، فيتكون من',NULL,'621',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (15,'ذلك مد نسميه مد الفرق، نمده ست حركات، وهو نادر الوقوع في القرآن، فلا يوجد إلّا في الكلمات الثلاث التالية: الضَّالِّينَ* آلذَّكَرَيْنِ* اللَّهُ*.
...
لكن هناك من يعتبرها ٢٨ حرفا فلا يدخل الألف ضمن الأحرف الهجائية لأنها لا تكون إلّا حرف علة.',NULL,'622',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (16,'المخرج الثالث: وسط الحلق، ويخرج منه حرفان، هما: العين والحا المخرج الرابع: أدنى الحلق، أي أقربه إلى الفم، ويخرج منه حرفان، ....
والخاء.
...
المخرج الخامس عشر: من بين باطن الشفة السفلى وأطراف الثنيتين العلويتين، ويخرج منه حرف واحد وهو: الفاء.',NULL,'623',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (17,'المخرج السادس عشر: من بين الشفتين معا، ويخرج منه ثلاثة أحرف، هي:
...
١ - صفات لها أضداد، وهي خمس صفات، وأضدادها خمس كذلك، فيكون المجموع عشرا.
٢ - صفات ليس لها أضداد، هي سبع.
ونحن سوف نتناول الكلام بالتفصيل عن كل من هذين القسمين.
الصفات التي لها أضداد:
١ - الهمس: وهو جريان النّفس، عند النطق بالحرف، لضعف الاعتماد على مخرجه، وهو من صفات الضعف، ويتحقق الهمس، بإخراج نفس مع كل حرف من أحرفه العشرة المجموعة في قولك (فحثّه شخص سكت).
...
وأحرف الجهر هي الأحرف الثمانية عشر المتبقية من أحرف الهجاء (١).
_________
(١) سرنا هنا على رأي من يعتبر الأحرف الهجائية ثمانة وعشرين، متغاضيا عن حرف الألف لأنه لا يكون إلّا حرف علة.',NULL,'624',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (18,'٢ - الشدة: وهي امتناع جريان الصوت، عند النطق بالحرف، لقوة الاعتماد على مخرجه، وأحرفها ثمانية، مجموعة في قولك: (أجدك قطبت).
وضد الرخاوة والتوسط.
...
٣ - الاستعلاء: وهو ارتفاع اللسان، إلى الحنك الأعلى، عند النطق بالحرف، وهو صفة من صفات القوة.
...
٤ - الاطباق: وهو تلاصق كل من اللسان والحنك الأعلى، عند النطق بالحرف. وهو صفة من صفات القوة. وأحرفه أربعة هي: الصاد- الضاد- الطاء- الظاء، وهي أقوى أحرف التفخيم.
...
٥ - الإذلاق: وهو خفة النطق بالحرف، لخروجه من طرف اللسان أو الشفة، وهو صفة بين القوة والضعف.',NULL,'625',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (19,'وضده الإصمات: وهو ثقل النطق بالحرف ثقلا يؤدي إلى الامتناع عن انفراد حروفه أصولا، في الكلمة الرباعية أو الخماسية.
...
٤ - الانحراف: هو ميل الحرف عن مخرجه، حيث يتصل بمخرج غيره، وأحرفه اثنان، هما: اللام والراء، فاللام تنحرف إلى طرف اللسان، والراء تنحرف إلى ظهر اللسان.',NULL,'626',NULL,NULL,'0');
INSERT INTO [b38050] VALUES (20,'٥ - التكرير: هو ارتجاف رأس اللسان، عند النطق بحرف (الراء)، وهو عيب يجب الابتعاد عنه. وإن ذكر هذه الصفة يراد منه تجنبها لا فعلها، إذ أن اللسان كلما ارتجف بها مرة خرجت راء جديدة، الأمر الذي يؤدي إلى غير المطلوب.
...
<span data-type="title" id=toc-9>١١ - أحكام السكتات:</span>
...
شاكرين لك تعاونك معنا لصيانة كتاب الله الكريم من كل نقص أو شائبة ... والله ولي التوفيق.',NULL,'627',NULL,NULL,'0');
