...
CREATE TABLE "b1841"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1841
INSERT INTO [b1841] VALUES (1,'<span data-type="title" id=toc-1>محاضرات في علوم الحديث</span>
د. ماهر ياسين الفحل
...
والضبط ضبطان: ضبط صدرٍ، وضبط كتاب، ويلخص مما ذكر في الضبط بقولنا: أنْ يكون الراوي حافظاً عالماً بما يرويه، إن حدث من حفظه، فاهماً إن حدث على المعنى، وحافظاً لكتابه من دخول التحريف أو التبديل، أو النقص عليه إن حدث من كتابه.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (2,'وفي اشتراط الضبط احترازٌ عن حديث المغفل، وكثير الخطأ، وسيئ الحفظ، والذي يقبل التلقين. وهذه الشروط (الاتصال، العدالة، الضبط) الثلاثة تتعلق بالإسناد.
أما الشرط الرابع: فهو عدم الشذوذ، والحديث الشاذ (١) هو الذي خالف فيه راويه من هو أوثق منه عدداً أو حفظاً.
أمّا الشرط الخامس: فهو عدم العلة هو أنْ لا يكون الحديث معلاً، والحديث المعل (٢)
_________
(١) مثاله ما رواه عبد الواحد بن زياد قال: حدثنا الأعمش، عن أبي صالح، عن أبي هريرة، قال: قال رسول الله - صلى الله عليه وسلم -: ((إذا صلى أحدكم ركعتي الفجر فليضطجع على يمينه)) فقد أخطأ عبد الواحد بن زياد وشذّ حينما جعل الحديث من قول النبي - صلى الله عليه وسلم - والصواب أنه من فعله هكذا رواه سهيل بن أبي صالح، عن أبيه عند ابن ماجه (١١٩٩) ، والنسائي في الكبرى (١٤٥٦) ، وكذا رواه محمد بن إبراهيم، عن أبي صالح عند البيهقي ٣/٤٥.
وقد صرح جمع من الأئمة بشذوذ رواية عبد الواحد بن زياد منهم البيهقي في السنن الكبرى ٣/٤٥ فقال عن رواية الفعل: ((وهذا أولى أن يكون محفوظاً لموافقته سائر الروايات عن عائشة وابن عباس)) ، وكذا نقل الحكم بالشذوذ ابن القيم عن شيخه ابن تيمية في زاد المعاد ١/٣٠٨ فقال: ((هذا باطل وليس بصحيح، وإنما الصحيح عنه الفعل لا الأمر بها، والأمر تفرد به عبد الواحد بن زياد وغلط فيه)) . وبنحو هذا قال الذهبي في الميزان ٢/٦٧٢. وهذا الشذوذ في جميع المتن، وهناك شذوذ ببعض المتن كزيادة التسمية في حديث أنس في الوضوء.
(٢) مثاله ما رواه شعبة عن سلمة بن كهيل، عن حجر أبي العنبس، عن علقمة بن وائل، عن أبيه: ((أن النبي - صلى الله عليه وسلم - قرأ {غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلا الضَّالِّينَ} فقال: آمين، وخفض بها صوته)) .
وهذا الحديث فيه ثلاث علل نص عليها البخاري فيما نقله عنه الترمذي في الجامع عقب (٢٤٨) فقال: ((سمعت محمداً - يعني البخاري - يقول: حديث سفيان أصح من حديث شعبة في مواضع من هذا الحديث، فقال: عن حُجر أبي العنبس، وإنما هو حجر بن عنبس، ويكنى ابا السكن، وزاد فيه: عن علقمة بن وائل، وليس فيه عن علقمة، وإنما هو حجر بن عنبس، عن وائل بن حجر، وقال: ((وخفض بها صوته)) وإنما هو ((ومدّ بها صوته)) .
...
: ((وسألت أبا زرعة عن هذا الحديث؟ فقال: حديث سفيان في هذا أصح، وقال: وروى العلاء بن صالح الأسدي عن سلمة بن كهيل نحو رواية سفيان)) .',NULL,'2',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (3,'هو ما اطلع فيه على علةٍ خفيةٍ تقدح في صحته، مع أنْ الظاهر سلامة الحديث من العلة.
...
ويستفاد من قوله: (الصحيح) أنه احترز عن إدخال الضعيف في كتابهِ، وقد صح عن الإمام البخاري أنّه قال: ((ما أدخلت في كتابي الجامع إلا ما صح)) .',NULL,'3',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (4,'ومن قوله: (المسند) أن مقصوده الأصلي تخريج الأحاديث المتصل إسنادها بالصحابةِ إلى رسول الله - صلى الله عليه وسلم - من قولٍ، أو فعلٍ، أو تقريرٍ، وأنّ ما وقع في الكتاب من غير ذلك فإنما وقع تبعاً وعرضاً لا أصلاً ومقصوداً، وذكر للاستشهاد والاستئناس ليكون الكتاب جامعاً لمعاني الإسلام.
...
وعلى صحيح مسلم: مستخرج أبي عوانة، ومستخرج أبي جعفر بن حمدان، ومستخرج أبي بكر محمد بن رجاء النيسابوري، ومستخرج أبي بكر الجوزقي، ومستخرج أبي حامد',NULL,'4',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (5,'الشاذلي، ومستخرج أبي الوليد حسّان بن محمد القُرشي، ومستخرج أبي عمران موسى بن عباس الجويني، ومستخرج أبي نصر الطوسي، ومستخرج أبي سعيد بن أبي عثمان الحيري.
...
مثال الحديث الصحيح',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (6,'ما رواه الترمذي في شمائل النبي - صلى الله عليه وسلم - (٢٠٨) قال: حدثنا علي بن حجر، قال: حدثنا ابن
...
أما عبد الله بن المبارك فقد قال عنه الحافظ في التقريب (٣٥٧٠) : ((ثقة ثبت فقيه عالم جواد مجاهد، جمعت فيه خصال الخير)) . فهذا أيضاً قد جمع بين العدالة والضبط.
أما عاصم بن سليمان الأحول فقد قال عنه الحافظ بالتقريب (٣٠٦٠) : ((ثقة)) . فكذلك قد جمع بين العدالة والضبط.
أما الشعبي فهو عامر بن شراحيل الشعبي فقد قال عنه الحافظ ابن حجر في التقريب (٣٠٩٢) : ((ثقة مشهور فقيه فاضل)) . فكذا قد جمع بين العدالة والضبط.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (7,'فالحديث الآن قد استكمل ثلاثة شروط، وهي: الاتصال والعدالة والضبط؛ فصار إسناد الحديث صحيحاً، وبقي علينا أنَّ نبحث هل في الحديث شذوذاً أو علة؟ فبعد البحث لم نجد في الحديث شذوذ ولا علة فصار الحديث صحيحاً.
...
(الموقظة: ٢٨) .',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (9,'وللحافظ ابن حجر محاولةٌ جيّدةٌ في وضعه تحت قاعدة كليةٍ فقد قال في النخبة: ((وخبر الآحاد بنقل عدلٍ تامّ الضبط، متصل السند غير معللٍ ولا شاذٍ: هو الصحيح لذاته ... فإن خفّ الضبط، فالحسن لذاته)) . (النخبة ٢٩، ٣٤) .
...
ولذا نجد الحافظ ابن عدي في الكامل، والإمام الذهبي في الميزان يسوقان أحياناً ما أنكر على الراوي الوسط ثم يحكمان بحسن رواياته الأخرى، والله أعلم.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (11,'وعلى هذا فالحديث الحسن: ما رواه عدل خف ضبطه عن مثله إلى منتهاه ولم يكن شاذاً ولا معلاً. وهذا هو الحسن لذاته. وهو يستوفي نفس شروط الصحيح خلا الضبط فراوي الصحيح تام الضبط وراوي الحسن خفيف الضبط.
...
ومثاله أيضاً ما رواه الترمذي في شمائل النبي - صلى الله عليه وسلم - (٢٣٧) ، قال: حدثنا عباس بن محمد الدُّوري، قال: حدثنا علي بن الحسن بن شقيق، قال: أنبأنا عبد الله بن المبارك، عن أسامة بن زيد، عن سعيد المَقْبُري، عن أبي هريرة، قال: قالوا: يا رسول الله، إنك تداعبنا. قال: ((إني لا أقولُ إلا حقاً)) .
وهذا حديثٌ حسنٌ لذاته من أجل أسامة بن زيد الليثي فهو خفيف الضبط، وهو صدوقٌ حسن الحديث.
أما الحسن لغيره فمثاله: فمثاله ما رواه الترمذي في شمائل النبي - صلى الله عليه وسلم - (٢٤٧) قال: حدثنا علي بن حُجْر، قال: حدثنا شَرِيك، عن سِماك بن حرب، عن جابر بن سَمُرة، قال: جالستُ النبيَّ - صلى الله عليه وسلم - أكثر من مئة مرة وكان أصحابه يتناشدونَ الشِّعْرَ ويتذاكرون أشياءَ من أمر الجاهلية، وهو ساكتٌ وربما تَبَسَّمَ معهم.
...
مظان الحديث الحسن:',NULL,'11',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (12,'كثيرٌ من كتب الحديث هي مظان الحديث الحسن، ومنها: سنن أبي داود وجامع الترمذي، وقد أكثر الترمذي من ذكره، وقد ظن بعضهم أنَّ كل حديثٍ سكت عنه أبو داود فهو حديثٌ حسن أو صحيح، وهذا خطأ وقد اعتمدوا في ذلك على ما نسبه بعضهم لأبي داود: ((وما سكت عنه فهو حسن)) وهذا لم يصح عن أبي داود إنما قال أبو داود: ((ذكرتُ في كتابي هذا الصحيح وما يشابهه وما يقاربه وما كان في كتابي من حديثٍ فيه وهنٌ شديدٌ فقد بينته، وما لم أذكر فيه شيئاً فهوصالح)) وكلمة صالح تشمل صلاحية الاحتجاج وصلاحية الاعتبار، ويستفاد من قوله: ((وهن شديد)) أن ما كان وهناً يسيراً لا يبينه، ثم إنه يضعف راوياً فإذا تكرر في حديثٍ آخر يسكت عنه لسبقه الكلام عنه، ثم إنَّ روايات السنن مختلفة وفي بعضها من الكلام على الأحاديث والرواة ما لا يوجد في الأخرى، وأبو عبيد الآجري في سؤالاته ينقل تضعيف أبي داود لبعض الأحاديث، وهو قد سكت عنها في السنن.
...
وصفات القبول: ١_ الاتصال. ٢_ العدالة. ٣_ الضبط إن كان تاماً أو خفيفاً. ٤_ عدم الشذوذ.
٥ ـ عدم العلّة. ٦_ وجود العاضد إن احتيج إليه.
...
ليس كل حديث ضعيف يتقوى بالمتابعات والشواهد؛ فإنَّ بعض الأحاديث يتقوى بذلك، إذا كان الضعف يسيراً؛ مثل: الغفلة، وكثرة الغلط لمن كان حديثه كثيراً، وسوء الحفظ، والاختلاط، وغيرها من أسباب الضعف غير الشديدة.',NULL,'12',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (13,'ونستطيع أن نُقَعّد لذلك قاعدة، وهو: أنّ كل ما كان ضعفه بسبب عدم ضبط راويه الصدوق الأمين _ الذي لم تثلم عدالته _ فإنّ كثرة الطرق تقويه؛ فتنفعه المتابعات والشواهد، ويجبر ضعفه بمجيئه من طريق آخر، ونستفيد من تلك الطرق المقوية أنَّ حفظ الراوي الأول لم يختلَّ في هذا لحديث خاصة، بل إنَّه حفظ هذا الحديث؛ بدليل المتابعات، أو الشواهد، وبهذا يرتقي من درجة الضعيف إلى درجة الحسن لغيره.
...
لا يلزم من ضعف الإسناد ضعف المتن، كما إنه لا يلزم من صحة الإسناد صحة المتن.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (15,'أما مظان الحديث الضعيف: ١-كامل ابن عدي ٢- الضعفاء للعقيلي ٣- المجروحين لابن حبان ٤- ميزان الاعتدال ٥- المراسيل لأبي داود ٦- المراسيل لابن أبي حاتم ٧- العلل للدارقطني ٨- العلل لابن أبي حاتم ٩- العلل لابن المديني ١٠- نوادر الأصول للحكيم الترمذي ١١- كتب الخطيب البغدادي ١٢- مسند الفردوس ١٣- تاريخ ابن النجار.
...
* أما الطريقة الثالثة: فهي عن طريق معرفة كلمة مشتقة من فعل ثلاثي. مثل ((إنما الأعمال بالنيات)) فالأعمال أصلها ((عمل)) والنيات أصلها ((نوى)) ونستعين على هذه الطريقة بفهارس صحيح مسلم للمرصفي. والمعجم المفهرس لألفاظ الحديث لونسك، ولمسند أبي يعلى لحسين سليم أسد فهرس في مجلدين.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (16,'* أما الطريقة الرابعة: فهي عن طريق معرفة موضوع الحديث. وهو أن نبحث عن الحديث في بابه الفقهي. ونلجأ إليها بالكتب المؤلفة على هذه الطريقة. مثل الجوامع والمستخرجات والمستدركات والسنن. وأحسن شيء لهذه الطريقة. الرجوع لكتب شملت عدة كتب. مثل جامع الأصول، ومجمع الزوائد والمطالب العالية.
...
رابعاً: إسناده ضعيف جداً، إذا كان في السند أحد المتروكين أو من اتهم بالكذب.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (18,'<span data-type="title" id=toc-8>المحاضرة السادسة أقسام الضعيف </span>٢٢/جمادى الآخرة /١٤٢٥
...
((حدَّثنا الحميدي (١) ، قال: حدَّثنا سفيان (٢) ، قال: حدَّثنا يحيى (٣) بن سعيد الأنصاري، قال: أخبرني محمد (٤) بن إبراهيم التيمي: أنه سمع علقمة (٥) بن وقّاص الليثي يقول: سمعت عمر (٦) بن الخطاب - رضي الله عنه - على المنبر قال: سمعت رسول الله - صلى الله عليه وسلم - ...)) .
فهذا سند متصل، فلو فرضنا أن سقطاً في الإسناد حصل، وسقط أحد الرواة، فماذا يسمّى هذا النوع من الانقطاع؟ .
نقول: إذا سقط رقم (١) يسمى الحديث معلّقاً، وإذا سقط رقم (٦) يسمّى الحديث مرسلاً، وإذا سقط رقم (٢) يسمّى الحديث منقطعاً، وإذا سقط رقم (٤ و ٥) يسمّى معضلاً، هكذا نوّع المحدّثون أنواع الانقطاعات؛ لفوائد يدركها الناقد.
وسأبدأ مفصلاً لكل نوع من أنواع الانقطاعات:
ألاً: المنقطع: ما سقط من سنده راو واحد، أو أكثر من واحد لا على التوالي.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (19,'مثال ذلك: ما رواه الدارقطني ٢/٧ من طريق الزهري، عن أم عبد الله الدوسية، قالت: سمعت رسول الله - صلى الله عليه وسلم - يقول: ((الجمعة واجبة على أهل كل قرية، وإن لم يكونوا إلا ثلاثة، رابعهم إمامهم)) .
...
وقد أضاف بعض العلماء أن الإبهام في الإسناد يسمّى انقطاعاً أيضاً، مثال ذلك: ما أخرجه أبو داود (٣٩١٧) قال: ((حدّثنا موسى بن إسماعيل، قال: حدّثنا وهيب، عن سهيل، عن رجل، عن أبي هريرة: أنَّ رسول الله- صلى الله عليه وسلم - سمع كلمة فأعجبته، فقال: ((أخذنا فألك من فيك)) .
والحديث الذي في إسناده رجل مبهم ضعيف عند المحدّثين؛ لأنّنا اشترطنا في الراوي العدالة والضبط، ونحن لا نعلم هذين الشرطين؛ لسبب الإبهام، فضُعف الحديث بسبب ذلك، فكان وجوده كعدمه؛ ولهذا سمّاه بعضهم منقطعاً.',NULL,'19',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (20,'وهذا المبهم وما في معناه ربَّما كان ثقةً، وربَّما كان مجروحاً، ويرجَّح الأخير؛ لأنه لو كان ثقة معلوم القدر والمنزلة، مقبولاً عند من من سمع بذكره لما أبهمه تلميذه، ففي تصرفه ما يشعر بكونه ليس بثقة، ومن خلال استقراء كثير من المبهمات وُجد أغلبها عن ضعفاء، حتى قال الخطيب البغدادي: ((قلَّ من يروي عن شيخ فلا يسمّيه، بل يكنّي عنه، إلاّ لضعفه، وسوء حاله)) .
...
والأصل في الحديث المنقطع: أنه ضعيف عند المحدّثين؛ لأنه فقد شرط الاتصال؛ وللجهالة بحال الساقط الذي لم تعرف عدالته، ولا ضبطه. قال الشوكاني: (ولا تقوم الحجّة بالحديث المنقطع، وهو الذي سقط من رواته واحد ممَّن دون الصحابي؛ وذلك للجهل بحال المحذوف من حيث عدالته وضبطه؛ لأنَّ ثبوت هذا شرط لقبول الحديث) .',NULL,'20',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (21,'ثانياً: المعضل: وهو عبارة عمّا سقط من إسناده اثنان فصاعداً على التوالي، وهو أسوأ حالاً من المنقطع، والمنقطع أسوأ حالاً من المرسل، والمرسل لا تقوم به حجَّة، كما نصَّ عليه بعض العلماء.
...
<span data-type="title" id=toc-9>المحاضرة السابعة تتمَّات أقسام الضعيف </span>٢٩/جمادى الآخرة /١٤٢٥
...
ومن هؤلاء: إبراهيم النّخعي، والأعمش.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (22,'فإبراهيم النّخعي لقي عائشة، ولم يسمع منها شيئاً، والأعمش رأى أنساً، ولم يسمع منه شيئاً.
...
وهو قول أبي حنيفة، ومالك، ورواية عن أحمد.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (24,'والقول الصحيح هو الأول؛ لأنَّ المرسل فقد شرط الاتصال، والاتصال شرطٌ رئيسيٌ في صحة الحديث، وليس هناك فرق بين القول الأول والثاني؛ لأنَّ أصحاب القول الأول متَّفِقون على أن المرسل ليس من الضعف الشديد، يتقوى بالمتابعات والشواهد، فالقول الثاني ليس هو ناف للقول الأول، إلا أن الفرق أن الشافعي خصه بكبار التابعين، وسبب جعله قسيماً للقول الأول؛ أنَّنا لم نجد من فصَّله بهذا التفصيل الرائع، وعُد هذا من مآثر الإمام الشافعي، زيادة على أنَّ قضية تقوية الأحاديث تدرك بالمباشرة، وجعل ذلك تحت قاعدة كلِّية، يتورع عنها كثير من الناس، إذ لكل حديث حالته الخاصة لاسيما قضية تقوية الحديث بعمل أهل العلم به يتوقف فيها كثير من الناس.
مثال المرسل: ما رواه أبو داود في سننه (١٠٥) ، قال: حدَّثنا محمد بن سليمان الأنباري، حدَّثنا كثير بن هشام، عن عمر بن سليم الباهلي، عن الحسن، قال: قال رسول الله- صلى الله عليه وسلم -: ((حصِّنوا أموالكم بالزكاة، وداووا مرضاكم بالصدقة، واستقبلوا أمواج البلاء بالدعاء والتضرع)) .
...
ومن أقوى المراسيل: مراسيل سعيد بن المسيب، فقد تتبعت فوجد غالبها مسانيد، ومن المراسيل الجيدة: مراسيل عروة بن الزبير؛ لشدَّة تحرِّيه، وكذلك مراسيل الحسن البصري عند بعضهم، وكذا مراسيل عامر بن شراحيل الشعبي.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (26,'أمَّا مراسيل الصحابة: وهو ما وقع لبعض الصحابة، ممّا لم يسمعوه من النبي- صلى الله عليه وسلم - مباشرة، إنما سمعوه من صحابة آخرين، وهذا يحصل لصغار الصحابة، مثل ابن عباس، وأنس بن مالك، فهذا مقبول عند جمهور المحدِّثين؛ لأنَّ ما لم يسمعوه من النبي- صلى الله عليه وسلم - مباشرة، فإنَّما سمعوه من صحابة آخرين، والصحابة كلّهم عدول.
...
تنبيه: هذا النوع من التدليس قَدْ سماه القدماء تجويداً. فتح المغيث ١/١٩٩،وتدريب الرَّاوِي ١/٢٢٦،وشرح ألفية السيوطي: ٣٦ - أي يذكر فيه الجياد من أهل الإسناد، أو أنه جعل ظاهر الإسناد جيداً بهذا الصنع القبيح، أو لأن المدلس يبقي جيد رواته -. وسماه صاحب ظفر الأماني: ٣٧٧ بـ: " التحسين " - أي أن المدلس يحسن ظاهر الإسناد.
...
السادس: تدليس القطع:',NULL,'27',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (28,'وَهُوَ أن يحذف الصيغة ويقتصر عَلَى قوله مثلاً: الزهري عَنْ أنس.
...
ومن الأمثلة عَلَى ذَلِكَ ما رَوَاهُ ابن حبان في صحيحه (١٤٢٣) من طريق ابن جريج، عَنْ نافع، عَن ابن عمر، قَالَ: قَالَ رَسُول الله - صلى الله عليه وسلم -: ((لا تَبُلْ قائماً)) .
...
وإذا تقرر هَذَا، فما حكم حَدِيْث من عرف بِهِ؟ للعلماء فِيْهِ أربعة مذاهب:',NULL,'30',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (31,'الأول: لا تقبل رِوَايَة المدلس، سواء صرح بالسماع أم لا، حكاه ابن الصَّلاَحِ عن فريق من أهل الْحَدِيْث والفقه، وهذا مبني عَلَى القَوْل بأنّ التدليس نفسه جرح تسقط بِهِ عدالة من عُرِف بِهِ. وهذا الَّذِي استظهره عَلَى أصول مذهب الإمام مالك القاضي عَبْد الوهاب في الملخص.
...
إذن: الشذوذ هو مخالفة الثقة للأوثق حفظاً أو عدداً، وهذا هو الذي استقر عليه الاصطلاح (وإنما قلنا هكذا؛ لأن للشاذ تعريفين آخرين، أولهما: وهو ما ذكر الحاكم النيسابوري - أن الشاذ هو الحديث الذي ينفرد به ثقة من الثقات، وليس له أصل متابع لذلك الثقة. معرفة علوم الحديث: ١١٩.
...
وقال أبو بكر بن زياد النيسابوري - شيخ الدارقطني -: ((قوله: " اصطدته لك "، وقوله: " ولم يأكل منه "، لا أعلم أحداً ذكره في هذا الحديث غير معمر)) .',NULL,'36',NULL,NULL,'0');
INSERT INTO [b1841] VALUES (37,'وقال البيهقي: ((هذه لفظة غريبة لم نكتبها إلا من هذا الوجه، وقد روينا عن أبي حازم بن دينار، عن عبد الله بن أبي قتادة في هذا الحديث أن النبي - صلى الله عليه وسلم - أكل منها، وتلك الرواية أودعها صاحبا الصحيح كتابيهما دون رواية معمر وإن كان الإسنادان صحيحين)) .
...
جامعة الأنبار maher_fahl@hotmail.com',NULL,'38',NULL,NULL,'0');
