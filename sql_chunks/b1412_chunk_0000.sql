...
CREATE TABLE "b1412"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1412
INSERT INTO [b1412] VALUES (1,'بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
الكتاب: عقوبة الارتداد عن الدين بين الأدلة الشرعية وشبهات المنكرين
...
INSERT INTO [b1412] VALUES (2,'بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
...
* وزوروا على الفقهاء أقوالاهم منها برآ ... ؟',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (5,'* ونسبوا إليهم مواقف لم ولن تصح عنهم ... ؟
...
* والحفاظ على النسل، وحده رجم الزاني أو جلده.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (6,'* والحفاظ على العرض والشرف، وحده جلد الرامي للناس في أعراضهم وشرفهم.
...
* وحد البغي، وقد ورد كذلك في القرآن الكريم.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (7,'* وحد شرب الخمر، وقد ورد في السنة الطاهرة قولاً وعملاً، وفي السنة العملية للخلفاء الراشدين ولك أن تضحك - أو تبكي إن شئت - حين تقف على طريقة استدلال منكري هذه الحدود، إن مستندهم الوحيد أن هذه الحدود الأربعة التي أنكروها خلا منها كتاب الفقه على المذاهب الأربعة....؟
...
{وَإِنْ طَائِفَتَانِ مِنَ الْمُؤْمِنِينَ اقْتَتَلُوا فَأَصْلِحُوا بَيْنَهُمَا فَإِنْ بَغَتْ إِحْدَاهُمَا عَلَى الْأُخْرَى فَقَاتِلُوا الَّتِي تَبْغِي حَتَّى تَفِيءَ إِلَى أَمْرِ اللَّهِ ... } (الحجرات ٩) .',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (8,'ثم ماذا يصنعون بالأحاديث النبوية الواردة في عقوبة شارب الخمر، والقاضية بقتله إذا شرب مرة رابعة بعد تأديبه في المرات الثلاث السابقة إذا لم يتب ويقلع؟
...
وفي الشطر الثاني ذكرنا "توضيحات لابد منها" وضحنا فيها جوانب مهمة، منها:',NULL,'9',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (9,'لماذا شرع الإسلام قتل المسلم إن ارتد؟ وهل هذا التشريع ينافي حرية الاعتقاد في الإسلام.
والله نسأل أن يجعل عملنا خالصاً لوجهه الكريم وأن ينفع به طلاب الحق وصالحي المؤمنين.
عبد العظيم إبراهيم المطعنى
القاهرة - الظاهر
الخميس غرة ربيع الأول ١٤١٤ هـ
الموافق ١٨ / أغسطس ١٩٩٣ م
عفا الله عنه',NULL,'10',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (10,'<span data-type="title" id=toc-2>الشبهة الأولى</span>
<span data-type="title" id=toc-3>خطأ الاستدلال بالنصوص القرآنية</span>
وقع منكرو حد الردة في أخطاء عديدة وهم يستدلون على إنكاره بأيات من القرآن الكريم، ويمكن تصنيف أخطائهم في هذا المجال فيما يأتي:
الأول: خطأ عام شمل استدلالهم بكل ما ذكروه من آيات حكيمة.
الثاني: خطأ يتعلق باستدلالهم ببعض الآيات دون بعضها الأخر.
الخطأ العام:
من الحقائق المسلمة أن حد الردة، وهو القتل، لم يرد صراحة في الآيات التي تحدثت عن الردة، حيث قصرت تلك الآيات عقوبة المرتد على العذاب الأخروي، ومنكرو حد الردة اتخذوا من خلو القرآن من عقوبة دنيوية محددة دليلاً على إنكار حد الردة الذي ورد في السنة الصحيحة قولاً وعملاً، وفي سنة الراشدين، ووقع الإتفاق عليه بين الفقهاء، وهذا انزلاق خطر، وقصور شنيع في الفهم والاستدلال؛ لإنه يقوم على إهدار دور السنة في التشريع، وهي بإجماع الأصوليين والفقهاء وجميع فرق الأمة، المصدر الثاني في',NULL,'11',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (11,'التشريع الإسلامي وسنبين هذا في إيجاز ووضوح بعد قليل.
الخطأ الخاص باستدلالهم ببعض الايات
أما الخطأ الخاص باستدلالهم بآيات دون أخرى فكان سببه الوقوف عند ظاهر تلك الآيات، دون البحث عن المراد منها. وها نحن نذكر الايات التي استدلوا بها، ونكشف وجوه الخطأ في ذلك الاستدلال:
{يَا أَيُّهَا الَّذِينَ آمَنُوا مَنْ يَرْتَدَّ مِنْكُمْ عَنْ دِينِهِ فَسَوْفَ يَأْتِي اللَّهُ بِقَوْمٍ يُحِبُّهُمْ وَيُحِبُّونَهُ....} المائدة (٥٤٩
...
هاتان الآيتان عن جريمة الردة وتوعد الله في أولاهما المرتدين بقطع دابرهم والآيتان يقوم آخرين يحبهم ويحبونه وفي الثانية توعدهم بحبوط أعمالهم العاجلة والآجلة، وتخليدهم في النار يوم يقوم الحساب.
وفد خلت الآيتان من النص على عقوبة دنيوية محددة وهذا أغرى منكري حد الردة وزعموا أنه حد مزعوم ورموا جميع فقهاء الأمة القائلين بأن عقوبة المرتد هي القتل رموهم بالادعاء الكاذب؟! وورطوا أنفسهم في منكر من القول وزوّر جارين وراء أهواء رخيصة',NULL,'12',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (12,'وعواطف هوجاء، وقصور في النظر والاستدلال.
ثم استدلوا - كذلك - بالآيات الأتية:
{كَيْفَ يَهْدِي اللَّهُ قَوْمًا كَفَرُوا بَعْدَ إِيمَانِهِمْ وَشَهِدُوا أَنَّ الرَّسُولَ حَقٌّ....} . آل عمران: (٨٦) .
...
{إِنَّ الَّذِينَ كَفَرُوا بَعْدَ إِيمَانِهِمْ ثُمَّ ازْدَادُوا كُفْرًا لَنْ تُقْبَلَ تَوْبَتُهُمْ وَأُولَئِكَ هُمُ الضَّالُّونَ} آل عمران: (٩٠) .
...
وجه استدلالهم:
استدل منكرو حد الردة بالآيات الثلاث الأولى مما ذكرناه آنفاً على أن هذه الآيات تتحدث عن ردة ظاهرة، وفي بعضها ورد الحديث عن الردة مرتين لقوم مخصوصين {إِنَّ الَّذِينَ آمَنُوا ثُمَّ كَفَرُوا ثُمَّ آمَنُوا ثُمَّ كَفَرُوا ... } وفهموا من هذا أن المرتد لو كانت عقوبته القتل لما بقى حياً حتى يرتد مرة أخرى؟ وأنه لم يرد أن النبي - صلى الله عليه وسلم - عاقب هؤلاء المرتدين بالقتل فكيف يقال أن عقوبة المرتد هي القتل؟',NULL,'13',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (13,'خطأ هذا الاستدلال:
...
وعلى كلا المذهبين لا دليل في الآية لمنكري حد الردة - القتل - فعلى',NULL,'14',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (14,'المذهب الأول لم يعاقب النبي - صلى الله عليه وسلم - هؤلاء المرتدين، لأنهم فروا هاربين إلى أهل الشرك ساعة ارتدوا. ثم عادوا تائبين.
...
١- نطقهم بالشهادتين وحضورهم الصلوات في المساجد ... إلخ.
٢- إن الردة التي تحدث عنها القرآن - هنا - ليست ردة ظاهرة وإنما هي أحوال نفسية كانت تعتريهم، واعتقادات قلبية لم يجر بها إنسان.
٣- إن المنافقين كانوا شديدى الحرص على إخفاء كفرهم والتظاهر',NULL,'15',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (15,'بأنهم مسلمون، فحكمهم لله وحده. وقد حكى القرآن عنهم قلقهم وتقلبهم من حال إلى حال فقال تعالى {مُذَبْذَبِينَ بَيْنَ ذَلِكَ لَا إِلَى هَؤُلَاءِ وَلَا إِلَى هَؤُلَاءِ....} النساء: (١٤٣) .
وقد أساء منكرو الردة فهم هذه الآية فحسبوها تتحدث عن قوم آمنوا ثم أعلنوا الكفر ثم آمنوا ثم أعلنوا الكفر مرة اخرى ثم ازدادوا كفراً عياناً جهاراً ولم يعاقبهم صاحب الدعوة على ردتهم، وهذا ما أوقعهم في الجرأة والتطاول على فقهاء الأمة سلفاً وخلفاً، ثم ملأوا الدنيا ضجيجاً قائلين: أن الردة لا تبيح القتل وأن حدَّ الردة لا وجود له بل هو حدَّ مزعوم، ورموا من يقول به بأهم مضللون. هكذا والله.؟!
وأما قوله تعالى {إِنَّ الَّذِينَ كَفَرُوا بَعْدَ إِيمَانِهِمْ ثُمَّ ازْدَادُوا كُفْرًا لَنْ تُقْبَلَ تَوْبَتُهُمْ وَأُولَئِكَ هُمُ الضَّالُّونَ} آل عمران: (٩٠) .
فهي كما قال المفسرون تتحدث عمن ارتد وأوغل في كفره ومات وهو كافر سواء مات حتف أنفه أو قتل كفراً. والذي حمل المفسرين على تخصيص هذه الآية بمن ارتد ومات كافراً أن المرتد مهما عظمت ردته أو تكررت إذا تاب قبل موته توبة نصوحاً ومات على الإيمان قبلت توبته إذن فنفى قبول التوبة - هنا - خاذ بتالمرتد الذي يموت كافراً مصراً على كفره. وهذه الآية لا تعني قوماً منخصوصين بل كل من تحقق فيه هذا الوصف فتوبته لا تقبل.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (16,'والآية التي بعدها تؤكد هذا المعنى وفيها يقول الحق تبارك اسمه:
...
اختلاف الأقوال:
ومن الؤسف حقاً أن أحد منكري حد الردة نقل هذه الآية وقال إن ابن كثير - صاحب التفسير المعروف - علق على هذه الآية فقال:',NULL,'17',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (17,'" إنها ردة جماعية ظاهرة عن اليهود في المدينة، ومع هذا لم يعاقب النبي - صلى الله عليه وسلم - هؤلاء المرتدين الذين يرمون إلى فتنة المؤمنين في دينهم وصدهم عنه".
...
"لا ألفين أحدكم - أي لا أجدن أحدكم - متكئاً على أريكته يأتيه الأمر من أمري مما نهيت عنه أو أمرت به، فيقول: لا أدري؟ ما وجدنا في كتاب الله اتبعناه".',NULL,'20',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (20,'وروى الحاكم بسنده أن النبي - صلى الله عليه وسلم - قال:
...
<span data-type="title" id=toc-5>صلة السنة بالكتاب</span>
...
والله يقول لرسوله: {وَأَنْزَلْنَا إِلَيْكَ الذِّكْرَ لِتُبَيِّنَ لِلنَّاسِ مَا نُزِّلَ إِلَيْهِمْ ... } النحل (٤٤) .',NULL,'21',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (21,'وقد وضح الإمام الشافعي في كتابه: "جماع العلم" صلة السنة بالكتاب وجعلها أقساماً ثلاثة, ثم تابعه علماء الأصول من بعده، وتلك الأقسام في إيجاز:
...
فالسنة بمنزلة المذكرات التفسيرية لنصوص القوانين الكلية مثلما هو معروف بين رجال القانون الآن مع فارق كبير بين السنة وما تفسره، وبين القوانين ومايوضع لها من شروح وتفسيرات. وإنما قلنا إن السنة بمنزلة المذكرات الشارحة للقوانين قصداً للتوضيح لا المماثلة من كل وجه.',NULL,'22',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (22,'ولسنا ندري ايجهل منكرو حد الردة الوارد في السنة الصحيحة هذه الصلة بين الكتاب العزيز وبين السنة الطاهرة أم هم يتجاهلونها عمداً؟
...
{قُلْ لِلْمُخَلَّفِينَ مِنَ الْأَعْرَابِ سَتُدْعَوْنَ إِلَى قَوْمٍ أُولِي بَأْسٍ شَدِيدٍ تُقَاتِلُونَهُمْ أَوْ يُسْلِمُون ... } الفتح: (١٦) .
...
إذن فالقرآن لم يخل تماماً من النص على أن عقوبة المرتد هي المقاتلة والقتل. وبهذا يندفع ما تمسك به منكرو السنة حد الردة من أن القرآن لم يحدد عقوبة دنيوية عاجلة للمرتدين سوى حبوط أعمالهم في الدنيا، مع توعدهم بالمصير الأليم يوم القيامة. نقول هذا لا لنرتب عليه تأسيس',NULL,'23',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (23,'حد الردة، إذ يكيفينا تحديدها في السنة القولية والعملية، وإنما نقوله في مواجهة منكري هذا الحد استناداً إلى أن القرآن لم يشر إليه لا من قريب ولا من بعيد.
* * *',NULL,'24',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (24,'<span data-type="title" id=toc-6>الشبهة الثانية دعوى التناقض بين الكتاب والسنة</span>
...
وبنوا على ذلك أن الحديث: "من بدَّل دينه فاقتلوه" يتناقض مع قوله تعالى: {لَا إِكْرَاهَ فِي الدِّينِ} البقرة: (٢٥٦)
ولذلك فإنهم يردون هذا الحديث ولا يقبلونه دفعاً لما توهموه من تناقض بينه وبين القرآن الحكيم.
ولو أن منكري حد الردة تريثوا قليلاً وفحصوا الموضوع فحصاً دقيقاً لما جرأوا على القول بالتناقض، ولما ورطوا أنفسهم في هذه المزالق الحرجة، ولكنهم القوا القول على عواهنه فكانوا كحابط ليل لا يميز بين الحطب والثعابين. كان عليهم أن يرجعوا إلى كتب أصول الفقه، ويقفوا على ما أضنى فيه الأصوليون أنفسهم من درس أدلة الأحكام من الكتاب والسنة معاً، وتحديدهم - بكل وعي ودقة - لمعاني المفردات والتراكيب، ودور السنة في تبيين المراد من آيات الأحكام.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (25,'فالسنة الشارحة لها وجوه كثيرة في صلتها بآيات الأحكام ومن تلك الوجوه أن يكون النص القرآني مطلقاً فتأتي السنة بتقييده.
...
وفي الحج قال: "خذوا عني مناسككم".',NULL,'26',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (26,'والوجه الثالث: أن يكون النص القرآني عاماً فتأتي السنة بتخصيصه.
...
كما خصصت السنة هذا العموم مرة أخرى يتحريم الجمع في النكاح',NULL,'27',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (27,'بين البنت وعمتها، وبين البنت وخالتها.
...
<span data-type="title" id=toc-7>الانسجام التام بين السنة والكتاب:</span>
وكل ما أضافته السنة إلى القرآن تفصيلاً وتقييداً، وتخصيصاً قائم على الإنسجام التام بين الكتاب والسنة خذ إليك مثلاً تحريم الجمع في النكاح بين البنت وعمتها أو خالتها. هذا التحريم مستند إلى القياس على ما ورد في القرآن نفسه، وهو قوله تعالى: {وَأَنْ تَجْمَعُوا بَيْنَ الْأُخْتَيْنِ} (النساء: ٢٣) .
فقد حرَّم القرآن الجمع بين نكاح الأختين في وقت واحد وعلة هذا الحكم هو حدوث العداوة بين الأختين الضرتين كما ورد الحديث',NULL,'28',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (28,'الذي سنذكره. وهذه العلة موجودة بين البنت وعمتها أو خالتها لو جمع بينهما في الزواج رجل واحد، لذلك حرَّم النبي هذا النكاح فقال: "لا تنكح المرأة على عمتها ولا على خالتها ولا على أبنة أخيها، ولا على أبنة أختها؛ فإنكم إن فعلتم قطعتم أرحامكم".
...
* * *',NULL,'29',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (29,'<span data-type="title" id=toc-8>الشبهة الثالثة دعوى عدم صلاحية الحديث النبوي</span>
...
٣- إن الحنفية قالوا لا يمكن قبول هذا الحديث على عمومه؛ لإن المرأة إذا ارتدت لا تقتل.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (30,'٤- ويرى آخرون أنه لا يقبل - كذلك - على عمومه، لإن النصراني إذا بدَّل دينه فصار يهودياً يدخل تحت حكم المرتد فيقتل وهذا لا يقبله منطق؟
رد هذه الطعون
...
وليس لمنكري حد الردة - كذلك - اي دليل في قول من قال أن عموم الحديث يشمل اليهودي والنصراني إذا تنصر اليهودي أو تهود',NULL,'31',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (31,'النصراني، لإن هذا القول يمنع عموم الدلالة ولا ينازع في أصل العقوبة التي هي قتل المرتد.
...
فصاحب الدعوة يخاطب بهذا مسلمين، والدين الذي يعينه هو الإسلام لا محالة، وذلك لقوله تعالى: {إِنَّ الدِّينَ عِنْدَ اللَّهِ الْإِسْلَامُ} (آل عمران: ١٩) .
وقوله: {وَمَنْ يَبْتَغِ غَيْرَ الْإِسْلَامِ دِينًا فَلَنْ يُقْبَلَ مِنْهُ وَهُوَ فِي الْآخِرَةِ مِنَ الْخَاسِرِينَ} (آل عمران: ٨٥) فالحديث وإن كان في صياغته عاماً فهو خاص في معناه فلا دليل فيه لمنكري حد الردة مهما تحمسوا وتعسفوا.
<span data-type="title" id=toc-9>حديث آحاد</span>
...
* فقد أخرجه الإمام البخاري في كتاب الجهاد في استتابة المرتدين من حديث ابن عباس: قال: رسول الله - صلى الله عليه وسلم -: "من بدل دينه فاقتلوه".',NULL,'32',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (32,'* وأخرجه الطبراني في معجمه الكبير من حديث معاوية بن حيدة قال قال رسول الله - صلى الله عليه وسلم -: "من بدَّل دينه فاقتلوه....".
...
<span data-type="title" id=toc-10>شروط العمل بخبر الآحاد</span>
وجملة ما ذكروه من شروط العمل بحديث الآحاديث ما يأتي:
١- أن لا يعمل به في العقائد؛ لإن العقائد لا تبنى إلا على اليقين وحديث الآحاد لا يفيد اليقين.',NULL,'33',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (33,'٢- إن تتحقق في حديث الآحاد شروط الرواية الصحيحة من العدالة والضبط والإتصال بين رواته وسلامته، من العلل القادحة والشذوذ.
...
ثانياً: أورد علماء الأصول وقائع كثيرة عُمِلَ فيها بخبر الواحد في عهد رسول الله - صلى الله عليه وسلم -، وفي عهد الخلفاء الراشدين بما لا يدع محالاً للريب في أن خبر الواحد إذا تحققت فيه شروط الصحة، وسلم من المعارض الأقوى منه سنداً إنما هو دليل من أدلة الأحكام المعتبرة شرعاً.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (34,'ثالثاً: إن هذا الحديث: "من بدَّل دينه فاقتلوه" له شواهد أخرى من السنة القولية والسنة العملية.
...
ومن السنة القولية كذلك أن رسول الله - صلى الله عليه وسلم - قال في شأن امرأة ارتدت يقال لها: أم مروان: فأمر أن يعرض عليها الإسلام فإن تابت وإلا قتلت" وغير ذلك يضيق المقام عن ذكره.',NULL,'35',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (35,'<span data-type="title" id=toc-11>شواهد من السنة العملية:</span>
...
والخلاصة أن حديث: "من بدَّل دينه فاقتلوه" لم يعد مع كل هذه الشواهد القولية والعملية حديث آحاد. بل هو من التواتر المعنوي فضلاً',NULL,'36',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (36,'عن أن صلاحيته لإثبات الحدود لا ينازع فيها منصف قط ومما تقدم يرى القارئ الكريم إلى أي مدىً هوى منكرو حد الردة في طعونهم السخيفة في هذا الحديث الذي رواه عن صاحب الدعوة إمام مشهود له بالأمانة والصدق وهو الصحابي الجليل عبد الله بن عباس - رضي الله عنهما - الذي دعا له الرسول فقال: "اللهم فقهه في الدين وعلمه التأويل" ثم أخرجه عند الإمام المحدث الجليل صاحب الصحيح المعروف الإمام البخاري - رضي الله عنه -، إمام المحدثين الورعين الثقات وكان الإمام البخاري لا يثبت حديثاً في صحيحه إلا بعد أن يصلي ركعتين ثم يدعو بدعاء الإستخارة، وقد تلقت الأمة صحيحة وصحيح الإمام مسلم بالرضا والقبول.
...
ومن المبالغات الممقوتة أن منكري حد الردة في هذا الأيام يدعون أن كثيراً من الفقهاء شكك في هذا الحديث. وهذه فرية بلغاء لاستدلها. إن فقهاء الأمة جميعاً سلموا به واعتمدوه ولم يشغب حوله إلا نفر من المعاصرين: اثنان أو ثلاثة وهذا لا يقدح في صحة الحديث أو صلاحيته',NULL,'37',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (37,'دليلاً على عقوبة المرتد؛ لإن إجماع السلف حجة، والأمة لا تجتمع على ضلالة كما جاء في الحديث الشريف من عدة طرق. وكفى بإجماع اصحاب رسول الله على قبوله والعمل به حجة ودليلاً لا يرتاب فيه من أدلة الأحكام.
الثيب الزاني
...
أحداهما: أن صياغة الحديث نفسه واضحة لا تحتاج إلى تأويل، لإن مثل هذا النص غنى عن التأويل، وعلماء الأمة متفقون على أن النص',NULL,'39',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (39,'الواضح الذي لا يمنع من العمل بظاهره مانع شرعي أو عقلي يجب بقاؤه على ظاهره ولا يجوز صرفه عن ظاهره أبداً.
...
* * *',NULL,'42',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (42,'<span data-type="title" id=toc-12>الشبهة الثالثة وقائع من عصر النبوة أساءوا فهمها</span>
...
ولست أدري إن كان هؤلاء المنكرون لحد الردة جاهلين أم متجاهلين والمتبادر إلى الذهن أنهم معاندون يعرفون الحق ثم ينكرونه. وهم',NULL,'43',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (43,'يخضعون النصوص والوقائع طوعاً لهواهم على طريق من يستدل على أن الصلاة حرام بقوله تعالى: {لَا تَقْرَبُوا الصَّلَاةَ....} ولا يذكر {وَأَنْتُمْ سُكَارَى} ؟!
...
والثانية: إنه لو كان مرتداً لما حرص على الحصول على الإذن من',NULL,'44',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (44,'رسول الله، ولخرج غير عابئٍ بشيء مهما لغط اللاغطون، هذا هو الحق الذي لا محيص عنه.
<span data-type="title" id=toc-13>الاختلاق والافتراء:</span>
...
"إنه رغم كونها حالة ردة ظاهرة ومع ذلك لم يعاقبه الرسول ولا أمر بعقابه، بل تركه يخرج من المدينة دون أن يعرض له أحد"؟!',NULL,'45',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (45,'ويعلم الله، وتشهد ملائكته وصالحو المؤمنين أن الإمام النووى لم يقل هذا الكلام قط، ولا ذكر منه حرفاً واحداً، وليرجع القارئ إلى الجزء التاسع من شرح النووى لصحيح مسلم، الصفحة (١٥٥) وما بعدها، ليتأكد بنفسه خلو شرح النووى تماماً من هذا القول الذي نسبوه إليه زوراً وبهتاناً؟!
...
<span data-type="title" id=toc-14>النصراني الذي أسلم ثم ارتد</span>
...
هذه الواقعة صحيحة لورودها في أصح كتب الحديث. ولكن منكري حد الردة حرفوها وصاغوها في عبارات مدلسة غاية التدليس ليطوعوها لأهوائهم زوراً وبهتاتاً. ونضع أمام القارئ الكريم الصورة التي عرضوها فيها. فقد قالوا بالحرف الواحد:',NULL,'46',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (46,'"روي عن البخاري: جـ ٤ ص ٢٤٦ كتاب الشعب: أن رجلاً نصرانياً أسلم، ثم ارتد نصرانياً مرة أخرى، فأماته الله، فدفنوه ولم يعاقبه الرسول على ردته".
...
"كان رجل نصرانياً فاسلم، وقرأ البقرة وآل عمران، فكان يكتب للنبي - صلى الله عليه وسلم -، فعاد نصرانياً، فكان يقول: ما يدري محمد إلا ما كتبت له، فأماته الله فدفنوه، فأصبح وقد لفظته الأرض. فقالوا: هذا فعل محمد وأصحابه نبشوا عن صاحبنا لما هرب منهم فألقوه خارج القبر. فحفروا',NULL,'47',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (47,'له فأعمقوا فأصبح وقد لفظته الأرض، فقالوا: هذا فعل محمد وأصحابه نبشوا عن صاحبنا لما هرب منهم فألقوه خارج القبر. فحفروا له وأعمقوا في الأرض ما استطاعوا، فأصبح قد لفظته الأرض. فعلموا أنه ليس من الناس فألقوه".
...
رابعاً: إن هذا المرتد لما دفنه المشركون أخرجته الأرض فألقته فوق ظهرها ثلاث مرات. وكان المشركون يتعهمون النبي واصحابه في كل مرة بأنهم هم الذين نبشوا قبره وأخرجوه لما هرب منهم. وفي المرة الثالثة أيقنوا أن اخرجه من الأرض ليس من فعل الناس؛ لإنهم كانوا قد عمقوا له الحفر فلم يغن عنه شيئاً. وحينئذ تركوه.',NULL,'48',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (48,'<span data-type="title" id=toc-15>تعقيب</span>
مما تقدم ندرك في وضوح أن منكري حد الردة، لم يكونوا أمناء في النقل، وهذه سقطة تهوى بهم إلى الحضيض.
ويضاف إلى هذا ما أشرنا إليه من قبل عند الحديث عن هاتين الواقعتين من أن منكرس حد الردة تعمدوا الاختلاق والتزوير والتحريف إما بالزيادة، وإما بالنقص. وهذا هو شأن كل من يخاصم الحق ويناصر الباطل. ومعلوم علم اليقين أن مناصرة الباطل لا تكون إلا بباطل مثله، أنظر مثلاً كيف أخفوا مسألة هروب المرتد وفراره إلى شيعته المشلاكين ليوهموا القراء أن الرجل أعلن ردته على مرأى ومسمع من الرسول وأصحابه ليرتبوا على ذلك زعمهم أن الرسول لم يقتله؟
ثم أنظر كيف أخفوا مسألة لفظ الرض لجثة هذا المرتد ثلاث مرات، وكأنهم بذلك يريدون أن يخففوا من قبح الردة حتى في الجزاء الأخروي؟
ألم يعلموت أن هذا يدخل في باب الكذب على رسول الله، الذي ورد فيه هذا الوعيد الشديد:
"من كذَّب عليّ متعمداً فليتبوأ مقعده من النار".
* * *',NULL,'49',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (49,'<span data-type="title" id=toc-16>الشبهة الرابعة تحريف أسباب حروب الردة</span>
...
{الْأَعْرَابُ أَشَدُّ كُفْرًا وَنِفَاقًا وَأَجْدَرُ أَلَّا يَعْلَمُوا حُدُودَ مَا أَنْزَلَ اللَّهُ عَلَى رَسُولِهِ ... } (التوبة: ٩٧) .',NULL,'50',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (50,'وكان المرتدون نوعين:
...
المرتدون ردة كاملة بالخروج عن الإسلام كلية.',NULL,'51',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (51,'والمرتدون ردة غير كاملة الذين طلبوا من أبي بكر أن يقيموا الصلاة ويعفيهم من إخراج الزكاة.
...
وللقارئ الكريم أن يرجع إلى أمهات كتب السيرة والتاريخ الإسلامي كتاريخ الطبري، والبداية والنهاية وغيرهما، وسيرى أن أجماع الصحابة على قتال المرتدين كان قبل أي تحرك من المرتدين ضد',NULL,'53',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (53,'المسلمين. إنه قتال من أجل الردة المجردة، وليس قتالاً في مواجهة قتال كما يدعي هؤلاء المدافعون عن الإجرام والمجرمين؟!
<span data-type="title" id=toc-17>قصة ثعلبة:</span>
...
يقول منكرد حد الردة في توظيف هذه القصة لمدعياتهم:
: ولنا في قصة ثعلبة الدليل على ذلك - أي أن المرتد لا يقتل - حيث رفض ثعلبة دفع الزكاة في وقت سيدنا رسول الله، فأمر الرسول بعدم',NULL,'54',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (54,'أخذها منه، ولما عرض ثعلبة دفعها في زمن سيدنا أبي بكر رفض أخذها منه، كما رفض ذلك أيضاً سيدنا عمر من بعده، وقد مات ثعلبة أيام خلافة سيدنا عمر، دون أن ينادى أحد بوجوب قتله باعتباره مرتداً لرفضه دفع الزكاة".
هذا الذي استنتجه منكرو حد الردة من قصة ثعلبة وَهْمٌ من الأوهام فثعلبة منع دفع الزكاة بخلاً لا ارتداداً ولما أنزل الله فيه تلك الآيات جاء تائباً إلى رسول الله - صلى الله عليه وسلم - وأخذ يضع التراب على رأسه لما لم يقبل الرسول توبته. ومما يؤكد عدم ارتداده تردده على الخلفاء بعد وفاة النبي - صلى الله عليه وسلم - ليأخذوا منه الزكاة، والمرتد لا يفعل ذلك أبداً. وحتى لو قلنا أن ثعلبة منع الزكاة ارتداداً فإنه أسرع إلى التوبة ومثل بين يدى رسول الله - صلى الله عليه وسلم - معتذراً ونادماً وأصدق ما يقال فيه إنه منافق، بدليل أن القرآن قال فيه: {فَأَعْقَبَهُمْ نِفَاقًا فِي قُلُوبِهِمْ إِلَى يَوْمِ يَلْقَوْنَهُ} .
ومن قبل قال عاطفاً لقصته على قصص المنافقين: {وَمِنْهُمْ مَنْ عَاهَدَ اللَّهَ ... } أي: ومن المنافقين.
وحتى لو قلنا أن ثعلبة كان كافراً في الباطن مظهراً للإيمان فإن أحكام الإسلام في الدنيا تجري على الظاهر دون الباطن. وهذا هو الموقف الذي وقفه النبي - صلى الله عليه وسلم - من المنافقين جميعاً، وكان ينهي عن قتلهم إذا',NULL,'55',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (55,'بدت منهم بذاءات؛ لأنهم ينطقون بكلمة التوحيد، ويشهدون بصدق الرسول ويصلون ويصومون ويحجون ويشهدون المعارك والجمع والجماعات.
<span data-type="title" id=toc-18>تعقيب:</span>
...
* * *',NULL,'56',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (56,'<span data-type="title" id=toc-19>الشبهة الخامسة الادعاء بأن النبي - صلى الله عليه وسلم - لم يقتل مرتداً</span>
ادعى منكرو حد الردة أن النبي لم يقتل أي مرتد في حياته ولا مرة واحدة. وإلى القراء ما قالوه بالحرف الواحد:
"وعندما نتدبر سنة سيدنا رسول الله - صلى الله عليه وسلم - نجد أن حد الردة المزعوم (هكذا) لم يطبق ايام سيدنا رسول الله، ولا مرة واحدة"
المرحظ أن منكري حد الدرة كثيراً ما يرسلون القول على عواهنه، ولا يكلفون أنفسهم بالرجوع إلى المصادر الوثيقة الت يتحيم على الباخث الموضوعي الرجوع إليها وهم - دائماً - يجزمون بالأحكام التي تناسب مدعياتهم ثم يصورونها في صورة أحكام عامة، ولم يلتزموا كذلك بأدنى ضوابط أو أحتياطات يمكن أن تكون بمثابة أعذار لهم إذا ووجهوا بما غاب عنهم أو غابوا هم عنه من حقائق لا سبيل لإنكارها.
تأمل وصفهم لحد الردة بنه "مزعوم" أي مكذوب مفترىً ثم تأمل الحكم الجازم في قولهم: "ولا مرة واحدة"؟!',NULL,'57',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (57,'<span data-type="title" id=toc-20>دحض هذه الدعوى</span>
...
ورحم الله امراً عرف قدر نفسه',NULL,'59',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (59,'<span data-type="title" id=toc-21>الشبهة السادسة اختلاف الفقهاء</span>
...
فليس كل خرف يترتب عليه إنكار الحكم الذي نشأ حوله خلاف في بعض فروعه. فما أكثر الفقهى حول أركان الإسلام العملية',NULL,'60',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (60,'من صلاة وزكاة وحج وصيام، ومع هذا لم يقل أحد - ولن يقول - أن هذه الأمور ليست أركاناً للإسلام أو ليست واجبة على المسلم.
...
والخلاف الذي نشأ حول دليل حد الردة هو النوع الثاني. أي أن الفقهاء جميعاً مسلمون بصحة الدليل هو "من بدَّل دينه فاقتلوه"',NULL,'61',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (61,'ثم: "لا يحل دم امرئ مسلم إلا بإحدى ثلاث....".
...
<span data-type="title" id=toc-22>نماذج من الخلاف حول فرعيات الردة:</span>
...
وقليل منهم قال إن الاستتابة مستحبة وليست بواجبة. فإذا قتل المرتد فور العلم بردته فلا خرج في ذلك ولا تقصير، كل ما في الأمر أننا تركنا أمراً مستحباً ومنهم من قال: إنه يُقتل فوراً فلا تجب استتابته',NULL,'62',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (62,'ولا تستحب. والراجح هو الرأي الأول.
...
{تَمَتَّعُوا فِي دَارِكُمْ ثَلَاثَةَ أَيَّامٍ ذَلِكَ وَعْدٌ غَيْرُ مَكْذُوبٍ} (هود: ٦٥) .
...
وأخذ الحنفية بقياس المسلمة إذا ارتدت على المرأة الكافرة كفراً',NULL,'63',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (63,'أصلياً، لإن النبي نهى المسلمين عن قتل النساء الحربيات إذا نشب بين قومهن وبين المسلمين حرب، فجعلوا النهي عن قتل الحربيات مخصصاً للعموم الوارد في "من بدَّل دينه فاقتلوه" ثم قاسوا المرتدة على الحربية.
...
<span data-type="title" id=toc-24>تعقيب:</span>
...
فالتوبة هي الإقلاع عن الذنوب، مهما كانت، والندم على فعلها، وعدم العود إليها، وهي عقد وعزم قلبي لا يطلع عليه إلا الله، فإذا كانت',NULL,'66',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (66,'التوبة نصوحاً وخالصة لوجه الله قبلت وكوفئ التائب عليها من ربه الغفور الرحيم.
...
عجيب - والله - أمر هؤلاء الناس.',NULL,'67',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (67,'<span data-type="title" id=toc-25>الشبهة الثامنة الاستتابة لا أساس لها في الدين</span>
كانت آخر شبهة يتشبت بها منكرو حد الردة أن زعموا بأن الاستتابة لا أساس لها في الدين. وإليك قولهم بالحرف:
"ذكر الشيخ الغزالي في شهادته أن المرتد يجب استتابته قبل معاقبته، وهو ادعاء ليس له أساس في الدين أو الشرع". ثم يصفون الاستتابة بأنها تشريع بما لم يأذن الله به؟ ويبنون على هذا الزعم كثيراً من الأوهام.
<span data-type="title" id=toc-26>تعقيب:</span>
القول باستتابة المرتد قبل معاقبته ليس من "عنديات" الشيخ الغزالي حفظه الله، ولكنه سنة صاحب الدعوة - صلى الله عليه وسلم -، وسنة الخلفاء الراشدين من بعده، وإجماع علماء الأمة سلفاً وخلفاً.
إن التشريع بغير ما لم يأذن به الله هو إنكار حد الردة وما تعلق به من فروع فقهية. فمن هو الذي له شركاء شرعوا له من الدين ما لم يأذن به الله؟ أة الشيخ الغزالي الذي لم يقل إلا بسنة خاتم الرسل وخلفائه وعلماء الأمة؟ أم الذين أنكروا حد الردة جملة وتفصيلاً؟ ما أصدق المثل العربي الذي قال:',NULL,'68',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (68,'"رمتني بدائها وانسلت"
ويقول الحق - عز وجل -: {وَمَنْ يَكْسِبْ خَطِيئَةً أَوْ إِثْمًا ثُمَّ يَرْمِ بِهِ بَرِيئًا فَقَدِ احْتَمَلَ بُهْتَانًا وَإِثْمًا مُبِينًا} النساء: (١١٢) .
<span data-type="title" id=toc-27>أدلتها من الشريعة</span>
...
وقد حررت الكتب الأحد عشرة في صيغة واحدة، وأمرهم الصديق',NULL,'69',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (69,'أبو بكر أن يتلوها على القبائل المرتدة قبل أن تبدأ الجيوش الإسلامية في قتالهم وكان ذلك على مرأى ومسمع من جميع أصحاب رسول الله - صلى الله عليه وسلم - فلم يعارضه أحد منهم فصار إجماعاً من رجال خير القرون - رضي الله عنهم -.
<span data-type="title" id=toc-28>نصوص الكتب التي بعث بها:</span>
...
<span data-type="title" id=toc-29>تعقيب:</span>
...
وهذه الوثيقة نموذج رائع للاستتابة الجماعية، التي تحدث لأول مرة في الإسلام في عهد أول الخلفاء الراشدين. ونستخلص منها الحقائق الآتية:',NULL,'72',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (72,'أولاً: أن المرتد لا يقاتل ولا يقتل حتى يُعْرض عليه الإسلام ثم يأبى الرجوع إليه.
...
فأنت ترى من ذها كله أن الفقهاء حين ذهبوا إلى استتابة المرتد لم يكن لهم شركاء شرعوا لهم من الدين ما لم يأذن به الله كما يدعي',NULL,'73',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (73,'منكرو حد الردة. بل هم أدرى الناس بما شرع الله ورسوله وبما أجمع عليه صحبه وخلفاؤه الراشدون.
<span data-type="title" id=toc-30>وثيقة أخرى لأبي بكر:</span>
...
ثالثاً: إن أموال المرتدين الذين يصرون على كفرهم إذا غنمها',NULL,'75',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (75,'المسلمون توزع على المقاتلين إلا الخمس فيوضع في بيت مال المسلمين (الخزانة العامة) ينفق منها عليهم.
...
{قُلْ إِنَّ الَّذِينَ يَفْتَرُونَ عَلَى اللَّهِ الْكَذِبَ لَا يُفْلِحُونَ (٦٩) مَتَاعٌ فِي الدُّنْيَا ثُمَّ إِلَيْنَا مَرْجِعُهُمْ ثُمَّ نُذِيقُهُمُ الْعَذَابَ الشَّدِيدَ ... } (يونس ٦٩ - ٧٠) .
* * *',NULL,'76',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (76,'<span data-type="title" id=toc-32>توضيحات لا بد منها</span>
* بين الردة والزندقة
* ضوابط تنفيذ حد الردة
* قتل المرتد لا يصادر حرية الاعتقاد
* حكمة التشريع في قتل المرتد
* عمن يدفعون',NULL,'77',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (77,'<span data-type="title" id=toc-33>التوضيح الأول بين الردة والزندقة</span>
...
أما الزنديق فالمراد به مَنْ يبطن الكفر ويظهر الإيمان تقية وتستراً ثم يكون حرباً على الله ورسوله، فيروج الأفكار السيئة عن الإسلام ويسخر من قيمه وأحكامه، يكون هذا دأبة في كل وادٍ ونادٍ وشغله الشاغل في كل وقت. ويسخر من صحابة رسول الله ورجالات الإسلام من متكلمين ومفسرين وأصوليين وفقهاء.',NULL,'78',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (78,'وهو - بهذا - أشد خطراً من المرتد صراحة وإن تظاهر بأنه مؤمن وصلى وصام وزعم أنه مسلم.
...
* * *',NULL,'80',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (80,'<span data-type="title" id=toc-34>التوضيح الثاني ضوابط تنفيذ حد الردة</span>
...
* إن كان الشهود من غير اهل العلم عُرِضَ أمره على العلماء أهل الاختصاص لإنهم أدرى بما يُخْرج من الدين وما لا يخرج منه. ولا تكون الردة بمجرد الاتهام، فلابد من تحقيق الدعوى بما يُجَلَّى حقيقة الأمر.',NULL,'81',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (81,'* أن يمهمل المرتد مدة لا تقل عن ثلاثة أيام ويعرض عليه الرجوع إلى الإسلام وتزال الشبهات التي أدت إلى الردة ويوعظ ويرشد بلا تخويف ولا تهديد ويطعم ما يكيفيه - هكذا قال الفقهاء - ولا بأس من إطالة مدة الإمهال إن طلب المرتد ذلك أو رجا الناصحون فيه خيراً.
...
* * *',NULL,'84',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (84,'<span data-type="title" id=toc-35>التوضيح الثالث قتل المرتد لا يصادر حرية الاعتقاد في الإسلام</span>
...
وقوله تعالى لرسوله الكريم: {فَإِنَّمَا عَلَيْكَ الْبَلَاغُ وَعَلَيْنَا الْحِسَابُ} (الرعد: ٤٠) . وجين أجهد النبي نفسه واشتد حرصه على أن يدخل الناس في الدين نزل عليه قوله تعالى:',NULL,'85',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (85,'{طه (١) مَا أَنْزَلْنَا عَلَيْكَ الْقُرْآنَ لِتَشْقَى (٢) إِلَّا تَذْكِرَةً لِمَنْ يَخْشَى}
وقوله:
{وَإِنْ كَانَ كَبُرَ عَلَيْكَ إِعْرَاضُهُمْ فَإِنِ اسْتَطَعْتَ أَنْ تَبْتَغِيَ نَفَقًا فِي الْأَرْضِ أَوْ سُلَّمًا فِي السَّمَاءِ فَتَأْتِيَهُمْ بِآيَةٍ وَلَوْ شَاءَ اللَّهُ لَجَمَعَهُمْ عَلَى الْهُدَى فَلَا تَكُونَنَّ مِنَ الْجَاهِلِينَ} الأنعام: (٣٥) .
وقوله: {أَفَمَنْ زُيِّنَ لَهُ سُوءُ عَمَلِهِ فَرَآهُ حَسَنًا فَإِنَّ اللَّهَ يُضِلُّ مَنْ يَشَاءُ وَيَهْدِي مَنْ يَشَاءُ فَلَا تَذْهَبْ نَفْسُكَ عَلَيْهِمْ حَسَرَاتٍ إِنَّ اللَّهَ عَلِيمٌ بِمَا يَصْنَعُونَ} فاطر: (٨) .
وقوله تعالى:
...
وقوله: {وَلَوْ شَاءَ رَبُّكَ لَآمَنَ مَنْ فِي الْأَرْضِ كُلُّهُمْ جَمِيعًا أَفَأَنْتَ تُكْرِهُ النَّاسَ حَتَّى يَكُونُوا مُؤْمِنِينَ} يونس: (٩٩) .
وفي عهد رسول الله - صلى الله عليه وسلم - أسلم رجل كان نصرانياً، وكان له ابنان ظلاً على نصرانيتهما. فأراد الرجل أن يجبرهما على الدخول معه في الإسلام لما له عليهما من ولاية الأبوة، ولما استشار في ذلك رسول الله - صلى الله عليه وسلم - نهاه عنه وأمره لا يجبرهما.',NULL,'86',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (86,'أما الحروب والغزوات فلم تكن للإجبار على الدين، وإنما كانت مرحلة متأخرة عن الدعوة إليه.
...
إن من سمات عالمية الإسلامة كفالة حرية الاعتقاد بين الناس، وأنه لا يضيق بمخالفيه في العقيدة، ولو عاش العالم كله في شبر واحد من الأرض تحت ولاية الإسلام، ولو كان المخالف له في العقيدة ملحداً أو مجوسياً.',NULL,'87',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (87,'ومن سمات عالمية الإسلام بعد كفالة حرية الاعتقاد أنه أرجأ الفصل بين الطوائف الدينية إلى يوم القيامة، ونهى الناس عن الجدل في العقيدة في هذه الحياة إلا بالتي هي أحسن، لإنه يؤدي إلى نشوب الفتن الدينية، وهي أخطر أنواع الفتن على الإطلاق وإذا أرخى لها العنان دمَّرت الحياة تدميراً.
من أجل ذلك قل جل في علاه:
...
{وَلِكُلٍّ وِجْهَةٌ هُوَ مُوَلِّيهَا فَاسْتَبِقُوا الْخَيْرَاتِ أَيْنَ مَا تَكُونُوا يَأْتِ بِكُمُ اللَّهُ جَمِيعًا إِنَّ اللَّهَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ} (البقرة: ١٤٨) .',NULL,'88',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (88,'{وَلَوْ شَاءَ اللَّهُ لَجَعَلَكُمْ أُمَّةً وَاحِدَةً وَلَكِنْ لِيَبْلُوَكُمْ فِي مَا آتَاكُمْ فَاسْتَبِقُوا الْخَيْرَاتِ إِلَى اللَّهِ مَرْجِعُكُمْ جَمِيعًا فَيُنَبِّئُكُمْ بِمَا كُنْتُمْ فِيهِ تَخْتَلِفُونَ} المائدة: (٤٨) .
...
مهمة الدعاة في الإسلام
وفي هذا الإطار تحددث مهمة الدعاة في الإسلام بدءاً من خاتم الرسل إلى أن تقوم الساعة. تلك المهمة هي البلاغ عن الله وبيان ما أنزل الله إلى الناس.
وليس من سلطة أحد رسولاً كان أو صحابياً أو تابعياً أو حكماً أو عالماً، ليس من سلطة أحد أن يجبر أحداً على اعتناق الإسلام، لا بقوة السلاح، ولا بأي وسيلة من وسائل الضغط. فالله يقول لإمام الدعاة - صلى الله عليه وسلم -. {فَذَكِّرْ إِنَّمَا أَنْتَ مُذَكِّرٌ (٢١) لَسْتَ عَلَيْهِمْ بِمُصَيْطِرٍ....} الغاشية (٢١- ٢٢) .
ضابط حرية الاعتقاد
لكن حرية الاعتقاد لها ضابط ينبغي أن نفهمه. فهي:
أولاً: مقصورة على الناس بعضهم بعضاً. فليس لأحد كما قلنا سلطة',NULL,'89',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (89,'إجبار غيره على اعتناق عقيدة معينة، ولو كانت عقيدة الإسلام وإنما عليهم فيما بينهم النصح والإرشاد.
وثانياً: يجب أن نستحضر دائماً أنها حرية ليست مستوية الطرفين أمام الله لا في الدنيا ولا في الآخرة. فليس من كفر كمن آمن، بل هم في الآخرة:
{فَرِيقٌ فِي الْجَنَّةِ وَفَرِيقٌ فِي السَّعِيرِ} الشورى: (٧) .
وهم في الدنيا والآخرة كما جاء في قوله تعالى:
...
وعلى هذه الأسس فرَّق الفقهاء - رضي الله عنهم - بين الكفر الأصلي غير المسبوق بالإسلام، والكفر الطارئ المسبوق بالإسلام (الردة) فمع أن الكفرين سواء في المصير الآخروي، وهما ذنبان لا يغفران أبداً فإن الكفر الأصلي غير المسبقو بالإسلام لا يهدر دم صاحبه، بل دمه مصون شرعاً، ومجرد كفره لا يوجب عليه عقوبة عاجلة. بل يتمتع بكل حرياته الدينية والإجتماعية تماماً كما يتمتع بها المسلم. فدمه',NULL,'90',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (90,'مصون وماله مصون، وعرضه مصون، لا يتعرض له أحد بأذى في أي مجتمع يسوده الإسلام، اللهم إلا إذا حارب المسلمين أو ظاهر على حربهم أو طعن في دينهم عياناً جهاراً بمثل معاملته.
...
والمسلم إذا ارتد وترك يروح ويجئ بين أفراد المجتمع الإسلامي كان مظنة أن يسرى الفساد منه إلى غيره، وضعاف الإيمان لا يخلو منهم مجتمع مسلم.',NULL,'91',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (91,'والمرتد هو الذي جنى على نفسه قبل الاستتابة والنصح بالردة، وبعد الاستتابة بالإصرار على الردة، لقد ظلم نفسه ولم يظلمه الإسلام.
فعلام إذن هذه الضجة والصخب، والإفتراء على الله ورسوله وعلى صالحي المؤمنين؟
أفيقوا أيها المنكرون قبل فوات الأوان. وتذكروا قول الله في أمثالكم ممن دافع عن الباطل:
{هَا أَنْتُمْ هَؤُلَاءِ جَادَلْتُمْ عَنْهُمْ فِي الْحَيَاةِ الدُّنْيَا فَمَنْ يُجَادِلُ اللَّهَ عَنْهُمْ يَوْمَ الْقِيَامَةِ أَمْ مَنْ يَكُونُ عَلَيْهِمْ وَكِيلًا} (النساء: ١٠٩) .
* * *',NULL,'92',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (92,'<span data-type="title" id=toc-36>التوضيح الرابع حكمة التشريع في قتل المرتد</span>
...
قال سبحانه:
{وَدَّ كَثِيرٌ مِنْ أَهْلِ الْكِتَابِ لَوْ يَرُدُّونَكُمْ مِنْ بَعْدِ إِيمَانِكُمْ كُفَّارًا حَسَدًا مِنْ عِنْدِ أَنْفُسِهِمْ....} (البقرة: ١٠٩) .',NULL,'93',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (93,'وقال:
...
وقال: {وَدَّتْ طَائِفَةٌ مِنْ أَهْلِ الْكِتَابِ لَوْ يُضِلُّونَكُمْ وَمَا يُضِلُّونَ إِلَّا أَنْفُسَهُمْ وَمَا يَشْعُرُونَ} (آل عمران: ٦٩) .
وقال: {يَا أَيُّهَا الَّذِينَ آمَنُوا إِنْ تُطِيعُوا فَرِيقًا مِنَ الَّذِينَ أُوتُوا الْكِتَابَ يَرُدُّوكُمْ بَعْدَ إِيمَانِكُمْ كَافِرِينَ} (آل عمران: ١٠٠) .
...
وهكذا شأن المرتد الذي لا يرجى اهتداؤه:',NULL,'94',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (94,'* إنه صار عضواً فاسداً أشنع ما يكون الفساد.
...
* * *',NULL,'95',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (95,'<span data-type="title" id=toc-37>التوضيح الخامس عمن يدافعون</span>؟
...
وهذا الموقف الذي يقفونه من حد الردة، لإنه في زعمهم لا وجود له في الدين أو الشريعة، وهي حيلة زينها لهم الشيطان، يقفونه أمام كل الحدود الإسلامية حتى التي ورد ذكرها في القرآن الكريم، اللهم الاَّحد البغى فإنهم يتحمسون له لحاجة في نفس يعقوب وقد نادوا به من قبل لقمع الشغب الذي قام به جنود الأمن المركزي في أواخر الثمانينات أما ما عدا هذا فهو عندهم مرفوض.
فالزاني لا يجلد ولا يرجم، والسارق لا يقطع، ومدمن الخمور لا يجلد',NULL,'96',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (96,'والوالغ في أعراض الناس لا يجلد. ولهم في ذلك حيل عجيبة قال ببعضها المستشرقون والمبشرون من قبل.
فالحدود كلها عندهم "موديل قديم" انتهى عصره، أو عملة ترجع إلى عهد أهل الكهف علاها الصدأ وتآكلت ... ؟
وكراهية الحدود الإسلامية هي السبب في كراهية تطبيق الشريعة فكلما نودي بتطبيق الشريعة تصدوا للنداء وخوَّفوا من الرجوع إلى الوراء: إلى عصور الظلام والجهل والرجعية، والجمود والتخلف؛ لإن الإسلام عند هؤلاء، كما قال أحدهم عام ١٩٩١م كان يناسب عقلية القرن الأول من الهجرة، أما في القرن الخامس عشر فلم يعد الإسلام قادراً على قيادة العقل المعاصر في القرن العشرين؛ لإنه عقل زكي ومثقف ووليد حضارات إنسانية زاهرة.
وهذا بالضبط قاله من قبل عام ١٩٨٥م أحد الكارهين لما أنزل الله حيث وصف القرآن الكريم بأنه "كتاب متخلف"؟! أي غير صالح للعمل به الآن.
وكانت ثالثة الأثافى أن وصف كاره آخر لما أنزل الله في هذا العام: ١٩٩٣م كتاب الله العزيز بأنه "كتاب جبان" كبرت كلمة تخرج من أفواههم إن يقولون إلا كذباً.',NULL,'97',NULL,NULL,'0');
INSERT INTO [b1412] VALUES (97,'فالمسألة إذن ليست مسألة حدود إسلامية، بل هي عداء سافر للإسلام كله جملة وتفصيلاً؟!
...
* * *
القاهرة الظاهر: صبيحة الأربعاء ٧ - ربيع الأول ١٤١٤ هـ
٢٥ - أغسطس ١٩٩٣ م',NULL,'98',NULL,NULL,'0');
