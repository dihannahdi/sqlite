...
CREATE TABLE "b36406"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36406
INSERT INTO [b36406] VALUES (1,'صبرًا آل ياسر
فالعاقبة للمتقين

تأليف
مجدي الهلالي',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b36406] VALUES (2,'جميع الحقوق محفوظة
الطبعة الأولى
...
١٠١٠ ش أحمد عمارة - بجوار حديقة الفسطاط
القاهرة ت: ٢٥٣٢٦٦١٠ ... محمول:٠١٠٢٣٢٧٣٠٢ - ٠١٢٦٣٤٤٠٤٣
www.iqraakotob.com
E-mail:info@iqraakotob.com',NULL,'1',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (3,'<span data-type="title" id=toc-1>المقدمة</span>
...
ولقد أكرمنا الله عز وجل وتفضل علينا بأن دفعنا للكتابة عن كيفية التحليل المتكامل لحدث الابتلاء في رسالة سابقة (١).
...
_________
(١)  بعنوان: الابتلاء وكيف تستفيد منه الدعوات.',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (4,'<span data-type="title" id=toc-2>إجابة غير متوقعة</span>
...
وقد كان أحرج موقف يقفه المسلمون، فلم يكن يحول بينهم وبين قريظة شيء يمنعهم من ضربهم من الخلف، بينما كان أمامهم جيش عرمرم لم يكونوا يستطيعون الانصراف عنه، وكانت ذراريهم ونساؤهم بمقربة من هؤلاء الغادرين في غير منعة وحفظ، وصاروا كما يقول الله تعالى: {وَإِذْ زَاغَتِ الأبْصَارُ وَبَلَغَتِ الْقُلُوبُ الْحَنَاجِرَ وَتَظُنُّونَ بِاللهِ الظُّنُونَا - هُنَالِكَ ابْتُلِيَ الْمُؤْمِنُونَ وَزُلْزِلُوا زِلْزَالاً شَدِيدًا} [الأحزاب: ١٠، ١١].',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (5,'فماذا كان رد فعل رسول الله صلى الله عليه وسلم تجاه هذا الخبر؟!
يقول المباركفوري: أما رسول الله صلى الله عليه وسلم فتقنع بثوبه حين أتاه غدر قريظة، فاضطجع ومكث طويلاً حتى اشتد على الناس البلاء، ثم نهض يقول: «الله أكبر أبشروا يا معشر المسلمين بفتح الله ونصره» (١).
...
«ومن لطائف أسرار اقتران الفرج باشتداد الكرب، أن الكرب إذا اشتد وعظم وتناهى وُجدَ الإياس من كشفه من جهة المخلوق ووقع التعلق بالخالق وحده، ومن انقطع عن التعلق بالخلائق وتعلق بالخالق؛ استجاب الله له» (٢).
* * *
_________
(١) الرحيق المختوم ص ٣٤٨، ٣٤٩ - مؤسسة علوم القرآن - بيروت.
(٢) مجموع رسائل الحافظ ابن رجب ٣/ ١٧٣ - الفاروق الحديثة - القاهرة.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (6,'<span data-type="title" id=toc-3>منحة في طيات المحنة</span>
...
والذي سيمكنها وينصرها هو الله {إِنَّ الأَرْضَ للهِ يُورِثُهَا مَن يَشَاءُ مِنْ عِبَادِهِ وَالْعَاقِبَةُ لِلْمُتَّقِينَ} [الأعراف: ١٢٨].',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (7,'إن مقتضى هذه الحقائق يؤكد على أن جهد أبناء الدعوة ينبغي أن يتجه أولاً وقبل أي شيء، نحو الله سبحانه وتعالى لاستجلاب رضاه ومعيته وكفايته.
...
_________
(١) الرحيق المختوم.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (8,'<span data-type="title" id=toc-4>لا سفينة تحملنا ولا خشبة نتعلق بها</span>
...
اذكرني عند ربك:
لقد أنسى الشيطان نبي الله يوسف - عليه السلام - في لحظة من اللحظات هذه الحقيقة فقال لصاحبه الذي كان يتأهب للخروج من السجن، والالتحاق بخدمة الملك: {اذْكُرْنِي عِنْدَ رَبِّكَ} [يوسف: ٤٢].
فكان الرد الإلهي لهذا القول: {فَلَبِثَ فِي السِّجْنِ بِضْعَ سِنِينَ} [يوسف: ٤٢].
وكذلك أصحاب الدعوات: إن تعلقت قلوبهم بأحد من الناس فسيكون الرد الإلهي مثلما حدث ليوسف عليه السلام.
ومما يلفت النظر أن سورة يوسف قد نزلت أيام حصار المسلمين في شعب أبي طالب .. نزلت لتؤكد لهم أن الناصر هو الله، وأنه سبحانه يريد منهم تعلقًا تامًا به، وعدم التعلق بالناس، واليأس منهم في أنهم يملكون كشف الضر، وتفريج الكرب، والسورة كذلك نزلت لتؤكد أن الذي مكَّن يوسف -عليه السلام- هو الله عز وجل، وأن الذي حرك الأحداث في اتجاه هذا التمكين هو الله عز وجل {وَقَالَ يَا أَبَتِ هَذَا تَأْوِيلُ رُؤْيَايَ مِن قَبْلُ قَدْ جَعَلَهَا رَبِّي حَقًّا وَقَدْ أَحْسَنَ بِي إِذْ أَخْرَجَنِي مِنَ السِّجْنِ وَجَاءَ بِكُم مِّنَ الْبَدْوِ مِن بَعْدِ أَن نَّزَغَ الشَّيْطَانُ بَيْنِي وَبَيْنَ إِخْوَتِي إِنَّ رَبِّي لَطِيفٌ لِّمَا يَشَاءُ إِنَّهُ هُوَ الْعَلِيمُ الْحَكِيمُ} [يوسف: ١٠٠].',NULL,'7',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (9,'هذه هي أهم الحقائق التي نزلت سورة يوسف لتؤكدها من خلال سياق الأحداث التي حدثت والنتائج التي تحققت، وحتى لا تُنسى هذه الحقائق في خضم أحداث القصة: جاءت نهاية السورة لتقررها بصورة مباشرة، وتقول لنا بأنه كلما تزلزلت تصوراتنا عن إمكانية وقوع الفرج وانكشاف الضر، ومجيء النصر من أحد دون الله، ويئسنا تمامًا من ذلك، واتجهت القلوب بكليتها إلى ربها، كان الفرج والنصر أقرب مما يتخيله الجميع ومن خلال أهون الأسباب {حَتَّى إِذَا اسْتَيْأَسَ الرُّسُلُ وَظَنُّوا أَنَّهُمْ قَدْ كُذِبُوا جَاءَهُمْ نَصْرُنَا} [يوسف: ١١٠].
هل نترك الأسباب؟!
وليس معنى هذا هو ترك الأخذ بالأسباب، وعدم بذل الجهد مع الناس، أو الانفصال عنهم، بل المقصد هو عدم التعلق القلبي بهم، أو الاعتقاد بأنهم يملكون كشف الضر عنا، أو أنهم يملكون القدرة على فك الحصار عن الدعوة ولو يسيرًا .. فالأمر كله لله {وَإِن يَمْسَسْكَ اللهُ بِضُرٍّ فَلاَ كَاشِفَ لَهُ إِلاَّ هُوَ} [الأنعام: ١٧].
إن إقامة المشروع الإسلامي والتمكين لدين الله في الأرض لن يتم إلا من خلال التعلق التام بالله عز وجل، مع بذل غاية الجهد واستنفاد جميع الأسباب المتاحة، ومد جسور التعاون مع الجميع، وكيف لا ونحن مأمورون بذلك: {وَجَاهِدُوا فِي اللهِ حَقَّ جِهَادِهِ} [الحج: ٧٨].
...
جهد البشر:
ومع التأكيد القرآني الدائم على أن الناصر هو الله، وأن كاشف الضر، وفارج الكرب هو الله، وأن الذي يمكن للعباد هو الله، إلا أنه يؤكد أيضًا على أن الفرج والنصر وكشف الضر يحتاج إلى ستار من الأسباب يتنزل عليه .. تأمل معي قوله تعالى: {قَاتِلُوهُمْ يُعَذِّبْهُمُ اللهُ بِأَيْدِيكُمْ وَيُخْزِهِمْ وَيَنْصُرْكُمْ عَلَيْهِمْ وَيَشْفِ صُدُورَ قَوْمٍ مُّؤْمِنِينَ - وَيُذْهِبْ غَيْظَ قُلُوبِهِمْ} [التوبة: ١٤، ١٥].
إن هذا الدين لن يقام إلا بجهد الفئة المؤمنة، وجهادها المرير، واستنفادها لجميع الأسباب المتاحة أمامها، مع يقينها بأن هذا كله لا يشكل سوى ستارًا يستدعي قدر الله بالنصر والتمكين، ولو تعلقت قلوب الفئة المؤمنة بهذا الستار ولو يسيرًا لتأخر الفرج والنصر حتى يخلص تعلقها بالله وحده.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (10,'<span data-type="title" id=toc-5>الفرج قريب فكيف نبلغه</span>؟!
من هنا يتأكد لدينا بأن تفريج الكرب الذي ألم بنا، وفك الحصار عن الدعوة بيد الله وحده، وأن الفرج قريب قريب، فما من عسر ينزل بنا إلا وينزل معه يسران، وما من بلاء إلا والفرج المضاعف يلاحقه كما قال صلى الله عليه وسلم: «وأن الفرج مع الكرب، وأن مع العسر يسرًا» (١).
وتذكر- أخي الحبيب- قوله صلى الله عليه وسلم: «إن الله يُنزل المعونة على قدر المؤنة، وينزل الصبر على قدر البلاء». (٢)
...
{فَإِنَّ مَعَ الْعُسْرِ يُسْرًا - إِنَّ مَعَ الْعُسْرِ يُسْرًا} [الشرح]. (٣)
...
_________
(١) أخرجه الإمام أحمد في مسنده.
(٢) صحيح الجامع الصغير (١٩١٩).
(٣) أخرجه البزار والحاكم.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (11,'ويستلزم كذلك أن نعود إلى القرآن ونمكث معه طويلاً ونقرأه بفهم وتدبر لنتعرف على الله من خلاله، ونزداد يقينًا به، ومن ثم تتحول هذه الحقائق النظرية إلى إيمان راسخ يصدقه العمل.
...
القرآن وعودة الروح:
تأمل معي- أخي الحبيب- قول الإمام حسن البنا: ولكنكم روح جديد يسري في قلب هذه الأمة فيحييه بالقرآن. (١)
...
(عرف سلفنا الصالح رضوان الله عليهم فضل القرآن وتلاوته، فجعلوه مصدر تشريعهم، ودستور أحكامهم، وربيع قلوبهم، وورد عبادتهم، وفتحوا له قلوبهم، وتدبروه بأفئدتهم، وتشربت معانيه السامية أرواحهم، فأثابهم الله في الدنيا سيادة العالم، ولهم في الآخرة عظيم الدرجات، وأهملنا القرآن فوصلنا إلى ما وصلنا إليه من ضعف في الدنيا ورقة في الدين). (٢)
* * *
_________
(١) رسالة بين الأمس واليوم.
(٢) نظرات في كتاب الله- ص٣٧، دار التوزيع والنشر الإسلامية.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (12,'<span data-type="title" id=toc-6>معركتنا تربوية</span>
...
إن مشروع الدعوة يدعو إلى تكوين أمة، وتربية شعب وتحقيق آمال، وهذا كله يتطلب نفسية عظيمة تتمثل في إرادة قوية، وإيمان راسخ، وقلب وجل مشفق، وتضحية مستمرة. (١)
...
إن غاية الإخوان تنحصر في تكوين جيل جديد من المؤمنين بتعاليم الإسلام الصحيح، يعمل على صبغ الأمة بالصبغة الإسلامية الكاملة في كل مظاهر حياتها، وأن وسيلتهم تنحصر في تغيير العرف العام، وتربية أنصار الدعوة على هذه التعاليم حتى يكونوا قدوة لغيرهم في التمسك بها، والحرص عليها، والنزول على حكمها. (٢)
ومن أقواله كذلك:
إن العمل مع أنفسنا هو أول واجباتنا فجاهدوا أنفسكم، واحملوها على تعاليم الإسلام وأحكامه، ولا تتهاونوا معها في ذلك بأي وجه من الوجوه. (٣)
* * *
_________
(١) المسألة التركية وتوضيح المفاهيم، لجمعة أمين- بتصرف يسير.
(٢) رسالة بين الأمس واليوم.
(٣) أوراق من تاريخ الإخوان المسلمين، جمعة أمين ٤/ ٣١١.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (13,'<span data-type="title" id=toc-7>هيا بنا نعُجُّ إلى الله ونستغيث به</span>
...
فالمطلوب هو تضرع واستغاثة تُظهر وتؤكد عدم تعلق قلوبنا بشيء سوى الله، وأنه لا ملجأ لنا ولا منجى مما نحن فيه إلا هو سبحانه وتعالى، وأن نلح في ذلك، ونلح، ونتضرع، ونستغيث، ونعجُّ (١) إلى الله، ولا نترك هذا كله حتى يأتي الفرج، وما هو ببعيد كما وعد سبحانه {أَمَّن يُجِيبُ الْمُضْطَرَّ إِذَا دَعَاهُ وَيَكْشِفُ السُّوءَ وَيَجْعَلُكُمْ حُلَفَاءَ الأَرْضِ أَإِلَهٌ مَّعَ اللهِ} [النمل].
...
يقول راوي القصة- الحسن بن محمد-: والله لقد أشرفت مع جماعة فرأينا الروم قد قوضوا، وركبوا مراكبهم، وانطلقوا في البحر، وفتحنا الحصن فوجدنا قومًا من بقاياهم، فسألناهم عن خبرهم فقالوا: كان الراهب المحبوب عميد الجيش بأفضل سلامته اليوم، حتى سمع ضجتكم بالمدينة، فوضع يديه على قلبه وقال: قلبي، قلبي، ثم مات، فانصرف من كان معه من الجيش إلى بلاد الروم، قال الحسن: ووجدنا في الأبنية من محلتهم من القمح والشعير ما وسع أهل المدينة، وكفى الله جماعتهم بأس الروم من غير قتال والحمد لله. (١)
فهيا بنا يا أخي نتوب إلى الله، ونستصرخه ونستغيث به .. قال صلى الله عليه وسلم: «من انقطع إلى الله عز وجل كفاه الله كل مؤنة، ورزقه من حيث لا يحتسب، ومن انقطع إلى الدنيا وكله الله إليها». (٢)
_________
(١) المستغيثين بالله تعالى للإمام ابن بشكوال ص ٥٠، دار الرسالة- القاهرة.
(٢) أخرجه الطبراني في الصغير والبيهقي في الشعب.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b36406] VALUES (15,'<span data-type="title" id=toc-8>من الرابح</span>؟!
وأخيرًا؛ أخي الحبيب:
...
* * *
_________
(١) رواه الإمام أحمد.',NULL,'14',NULL,NULL,'0');
