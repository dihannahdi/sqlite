...
CREATE TABLE "b781"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b781
INSERT INTO [b781] VALUES (1,'<span data-type="title" id=toc-1>نص الكتاب</span>
...
ذكر أسماء الكلب: الكلب معروف، والأنثى كلبة، وجمعه أكلب وكلاب وكليب وأكالب وكلابات وجمعها كلبات.
...
والحمدُ للهِ هنا تمامُ ... ثمَّ على نبيّهِ السلامُ',NULL,'1',NULL,NULL,'0');
