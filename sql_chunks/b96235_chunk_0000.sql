...
CREATE TABLE "b96235"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b96235
INSERT INTO [b96235] VALUES (1,'خَبَرُ الوَاحِدِ الصَّحِيحِ وَأَثَرُهُ فِي العَمَلِ وَالعَقِيدَةِ

الدكتور نور الدين عتر.

" مجلة التراث العربي " - مجلة فصلية تصدر عن اتحاد الكتاب العرب - دمشق.
العددان: ١١ - جمادى الآخر ١٤٠٣ هـ / نيسان (أبريل) السنة الثالثة
و١٢ - رمضان ١٤٠٣ هـ / تموز (يوليو) ١٩٨٣ م.
...
ملاحظة: ذكر الدكتور نور الدين عتر - حَفِظَهُ اللهُ تَعَالَى - الحواشي في صفحة ١٧٦ من المجلة، وقد أدرجت كل حاشية في الصفحة المناسبة لها تسهيلا على الباحث.',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b96235] VALUES (2,'خبر الواحد الصحيح وأثره في العمل والعقيدة
...
وألفت النظر إلى أمر آخر في تقديم هذا البحث يرجع إلى الناحية العلمية الموضوعية بخصوص هذا العلم العظيم علم الحديث، ذلك الأمر هو إبراز دقة المنهج العلمي لأصول هذا العلم، دقة تعتز بها هذه الأمة، حيث اختصت من بين سائر الأمم بإبداع هذا المنهج الدقيق المتكامل في فحص النقول والروايات الذي هو منهج علم مصطلح الحديث، أو علم الحديث (١).
_________
(١) وقد كان هناك من يظن هذه القواعد متفرقة لا ترتبط مع بعضها برباط التكامل، حتى تكلم بعض أهل الفرق المبتدعة طعناً على أهل الحديث، ثم جاء المستشرقون يدندنون حول هذا المنحى في العصور المتأخرة. وقد قمنا بدراسة هذا العلم دراسة مبتكرة على أسلوب منهجي جديد، أثبتنا فيه تكامل هذه القواعد وأنها تشكل نظرية نقدية متكاملة، تحيط بجميع ما يحتاج إليه البحث النقدي للروايات وتأخذ بزمام الحيطة والحذر. وذلك في كتابنا "منهج النقد في علوم الحديث"، وتوصلنا بذلك إلى بيان بطلان ما أورده الناقدون على منهج المحدثين، بإقامة الحجج والبراهين الدامغة على تلك الانتقادات.',NULL,'158',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (3,'إن الحديث الصحيح يعتبر نقطة الارتكاز التطبيقية الأولى لعلوم الحديث، لأنه يقع في الدرجة الأولى من غايات وضع هذا العلم بقواعده وفنونه الكثيرة المتشعبة التي تبلغ أصولها خمسة وثمانين نوعاً.

قَالَ الشَّيْخُ عِزُّ الدِّينِ بْنُ جَمَاعَةَ: «عِلْمُ الْحَدِيثِ: عِلْمٌ بِقَوَانِينَ يُعْرَفُ بِهَا أَحْوَالُ السَّنَدِ وَالْمَتْنِ ... وَغَايَتُهُ: مَعْرِفَةُ الصَّحِيحِ مِنْ غَيْرِهِ» (٢).
...
<span data-type="title" id=toc-2>الشَّرْطُ الأَوَّلُ: أَنْ يَكُونَ كُلُّ وَاحِدٍ مِنْ رُوَاةِ الحَدِيثِ عَدْلاً:</span>
...
وتتضمن العدالة خصالاً عدة كما هو ظاهر لمن تأمل في تعريفها، قد فصلها العلماء (٤) وفرعوا أحكام العدالة في الرواية على هذه الخصال (٥). ويجب أن يتنبه إلى أن العدالة لا تعني العصمة من الخطأ، لكن تستلزم تغلب عنصر الاستقامة بحيث لا يكاد يحيد عنه حتى يثوب ويرجع إليه، لذلك قالوا: من غلب نقصه على فضله وهب نقصه لفضله.

<span data-type="title" id=toc-3>الشَّرْطُ الثَّانِي: أَنْ يَكُونَ الرَّاوِي ضَابِطاً لِمَا يَرْوِيهِ:</span>
...
_________
(٢) " تدريب الراوي شرح تقريب النواوي " للسيوطي: ج١ ص ٤١.
(٣) انظر التعريف في مطلع كتاب " علوم الحديث " للإمام أبي عمرو ابن الصلاح.
(٤) منذ عصر الأولى كما نجده عند الشافعي في " الرسالة ": ص ٣٧٠.
(٥) انظر على سبيل المثال " علوم الحديث " لابن الصلاح ص ٩٤ و" شرح الألفية في علم الحديث " للحافظ عبد الرحيم بن الحسين العراقي: ج٢ ص ٢ - ٨ وكتابنا " منهج النقد في علوم الحديث ": ص ٧٩ وما بعد.
----------------------
[تَعْلِيقُ مُعِدِّ الكِتَابِ لِلْمَكْتَبَةِ الشَّامِلَةِ]:
(*) هذا العنصر من وضعي أدرجته لتناسق البحث.',NULL,'159',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (4,'وللضبط مقياس دقيق وضعه العلماء، عَوَّلُوا عليه في كشف مستوى حفظ الراوي للحديث، وهو كما لخصه الإمام ابن الصلاح (٦): «أَنْ نَعْتَبِرَ - أي نقايس - رِوَايَاتِهِ بِرِوَايَاتِ الثِّقَاتِ الْمَعْرُوفِينَ بِالضَّبْطِ وَالإِتْقَانِ، فَإِنْ وَجَدْنَا رِوَايَاتِهِ مُوَافِقَةً - وَلَوْ مِنْ حَيْثُ الْمَعْنَى - لِرِوَايَاتِهِمْ، أَوْ مُوَافِقَةً لَهَا فِي الأَغْلَبِ وَالْمُخَالَفَةُ نَادِرَةُ، عَرَفْنَا حِينَئِذٍ كَوْنَهُ ضَابِطًا [ثَبْتًا]، وَإِنْ وَجَدْنَاهُ كَثِيرَ المُخَالَفَةِ لَهُمْ، عَرَفْنَا اخْتِلاَلَ ضَبْطِهِ، وَلَمْ نَحْتَجَّ بِحَدِيثِهِ».
...
<span data-type="title" id=toc-4>الشَّرْطُ الثَّالِثُ: الاِتِّصَالُ:</span>
...
<span data-type="title" id=toc-5>الشَّرْطُ الرَّابِعُ: أَلاَّ يَكُونَ الحَدِيثُ شَاذًّا:</span>
الحديث الشَاذُّ هو ما رواه الثقة مُخَالِفًا لمن هو أوثق منه بمزيد ضبط، أو كثرة عدد.
وينقسم إلى قسمين: شاذ المتن، وشاذ السند.
_________
(٦) في كتاب " علوم الحديث ": ص ٩٥، ٩٦.',NULL,'160',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (5,'والسبب في اشتراط عدم الشذوذ أن الثقة إذا خالفه من هو أقوى منه كان ذلك دليلاً على أن هذا الثقة قد وهم في رواية هذا الحديث.
...
<span data-type="title" id=toc-6>الشَّرْطُ الخَامِسُ: أَلاَّ يَكُونَ الحَدِيثُ مُعَلاًّ:</span>
...
<span data-type="title" id=toc-7>تَقْسِيمُ الخَبَرِ مِنْ حَيْثُ عَدَدِ رُوَّاتِهِ:</span>
يقسم المحدثون الخبر من حيث عدد رواته إلى أربعة أقسام: (٧)

١ - الفرد المطلق، وهو الذي ليس له إلا راو واحد، ويسمى أَيْضًا الغريب سنداً ومتناً.
...
<span data-type="title" id=toc-8>القِسْمُ الأَوَّلُ: الخَبَرُ المُتَوَاتِرُ:</span>
وقد عرفته.

<span data-type="title" id=toc-9>القِسْمُ الثَّانِي: خَبَرُ الوَاحِدِ أَوْ الآحَادِ:</span>
وهو ما لم يبلغ درجة التواتر، فيشمل أنواع الفرد والعزيز والمشهور.

وأضاف الحنفية قسمًا ثالثًا هو المشهور، وهو عندهم الخبر الذي كان آحادي الأصل، متواتراً في القرن الثاني والثالث مع قبول الأُمَّةِ كما في " مسلم الثبوت ". قال في شرحه " فواتح الرحموت ": «وَإِنْ لَمْ يَكُنْ كَذَلِكَ فَهُوَ خَبَرُ الوَاحِدِ» (٨).
...
_________
(٧) " شرح نخبة الفكر " للحافظ ابن حجر العسقلاني ص ١٨ - ٣٧ نسخة شرحه للقاري.
(٨) ج ٢ ص١١١.',NULL,'162',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (7,'<span data-type="title" id=toc-10>أَثَرُ خَبَرِ الآحَادِ الصَّحِيحِ فِي العَمَلِ:</span>
...
قال الإمام السرخسي - رَحِمَهُ اللهُ - (٩): «وَقَالَ بَعْضُ مَنْ لَمْ يُعْتَدَّ بِقًوْلِهِ: خَبَرُ الوَاحِدِ لاَ يَكُونُ حُجَّةً فِي الدِّينِ أَصْلاً» انتهى. وهذا القائل الذي أشار إليه السرخسي هو الجُبَّائِي من المعتزلة، وبعض أهل الابتداع الخارجين على السُنَّةِ (١٠).
...
_________
(٩) " أصول الفقه " للسرخسي: ج١ ص ٣٢١.
(١٠) صرح بهم العلامة الأصولي المحقق محب الله بن عبد الشكور في " شرح مسلَّم الثبوت ": ج ٢ ص ١٣١.',NULL,'163',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (8,'أخرى أصرح: إسلام بلا دين إلا مجرد التسمية .. !!. ونبين فيما يلي الخطأ في هذه الاستدلالات، ثم نبين كيف اطرح هذا المذهب المخالف كل دلائل الشرع القطعية من الكتاب وَالسُنَّةِ والإجماع، وخرقوا بداهة المنطق الذي تسير عليه الحياة.
...
_________
(١١) ج ١ ص ١٥٤ - ١٥٥.
(١٢) ج ١ ص ٦٩٢ بهامش شرحه " كشف الأسرار ".',NULL,'164',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (9,'١ - قوله تعالى: {فَلَوْلاَ نَفَرَ مِنْ كُلِّ فِرْقَةٍ مِنْهُمْ طَائِفَةٌ لِيَتَفَقَّهُوا فِي الدِّينِ وَلِيُنْذِرُوا قَوْمَهُمْ إِذَا رَجَعُوا إِلَيْهِمْ لَعَلَّهُمْ يَحْذَرُونَ} [التوبة: ١٢٢].
...
وهو دليل جَلِيٌّ جِدًّا على الموضوع، استدل به الإمام السرخسي الحنفي على وجوب قبول حديث الواحد الصحيح، قال يوجه استدلاله (١٨): «ثم أن مَنْ بعثه رسول الله - صَلََّى اللهُ عَلَيْهِ وَسَلَّمَ - خليفته في التبليغ - يعني واجب الامتثال - فكل من سمع شَيْئًا في أمر الدين فهو خليفته في التبليغ، مأمور من جهته بالبيان». يعني فيكون واجب القبول أيضًا، فثبت بذلك وجوب العمل بخبر الواحد.
...
(١٩) انظر " توضيح الأفكار ": ج ٢ ص ٤٦٧.',NULL,'165',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (10,'وغير ذلك كثير لا نطيل به، فقد بلغ مبلغ التواتر المعنوي، فضلاً عن تواتر الحديث الأول بنفسه كَمَا بَيَّنَّا، نحيل القارئ للتوسع فيه إلى المراجع.
...
<span data-type="title" id=toc-11>اشْتِبَاهُ تَرْكِ الفَقِيهِ لِلْحَدِيثِ:</span>
...
وأسرد لذلك ثلاثة أمثلة أشرح بها للأخوة القرّاء مواقف المجتهدين، فيتذكروا بذلك ما يجب تجاه أئمة هذا الدين، ولا يغتر أحد بما يردد من القيل حول هذه القضية من هجر الفقيه للحديث الصحيح، أو ادعاء أنه لم يطلع على الحديث. وهي أمثلة لفقهاء كبار من الصحابة والتابعين وأتباع التابعين.',NULL,'167',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (12,'المثال الأول: حديث فاطمة بنت قيس أن زوجها طلقها ثلاثًا، فلم يجعل رسول الله - صَلََّى اللهُ عَلَيْهِ وَسَلَّمَ - لها سكنى ولا نفقة، قال عمر رضي الله عنه: «لاَ نَتْرُكُ كِتَابَ اللهِ وَسُنَّةَ نَبِيِّنَا صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ لِقَوْلِ امْرَأَةٍ، لاَ نَدْرِي لَعَلَّهَا حَفِظَتْ، أَوْ نَسِيَتْ، لَهَا السُّكْنَى وَالنَّفَقَةُ لَهَا السُّكْنَى وَالنَّفَقَةِ، قَالَ اللهُ - عَزَّ وَجَلَّ -: {لاَ تُخْرِجُوهُنَّ مِنْ بُيُوتِهِنَّ وَلاَ يَخْرُجْنَ إِلاَّ أَنْ يَأْتِينَ بِفَاحِشَةٍ مُبَيِّنَةٍ} [الطلاق: ١]» متفق عليه (٢٥).
...
(٢٨) انظر تخريج الحديث ودراسته في كتابنا " دراسات تطبيقية ": ص ١٥٧ - ١٦٠.',NULL,'168',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (13,'وحاصله أنه لم يَدْرِ كَمْ يَسْتَمِرُّ المَجْلِسُ، فلو توقف الملك على التفرق لأدى إلى الغرر، وقد ثبت تحريم بيع الغرر بالسنن الصحيحة والإجماع. لذلك قالوا: إن المراد من الحديث إلا أن يتفرقا بأقوالهما، وذلك بأن يتم الإيجاب والقبول، ولفظ الحديث يتحمل هذا المعنى فعملوا بالحديث عليه للأدلة التي عرفتها، وهذا لا يجوز أن يجعل تَرْكًا لِلْسُنَّةِ النَّبَوِيَّةِ.

<span data-type="title" id=toc-12>أَثَرُ الخَبَرِ الآحَادِي الصَّحِيحِ فِي العَقِيدَةِ:</span>
...
<span data-type="title" id=toc-13>عِبَارَاتٌ مُوهِمَةٌ فِي أَثَرِ الحَدِيثِ الصَّحِيحِ:</span>
وقع في بعض النشرات التي صدرت في بيان حكم الحديث الصحيح عِبَارَاتٌ مُوهِمَةٌ، تحتاج إلى تحرير المراد منها، نسوق للقارئ بعض النماذج منها فيما يلي:',NULL,'169',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (14,'١ - «فكما كان لا يجوز للصحابي مثلاً أن يرد حديث النبي - صَلََّى اللهُ عَلَيْهِ وَسَلَّمَ - إذا كان في العقيدة بحجة أنه خبر آحاد سمعه عن صحابي مثله عنه - صَلََّى اللهُ عَلَيْهِ وَسَلَّمَ -، فكذلك لا يجوز لمن بعده أن يرده بالحجة نفسها ما دام أن المخبر به ثقة عنده، وهكذا ينبغي أن يستمر الأمر إلى أن يرث الله الأرض ومن عليها، وقد كان الأمر كذلك في عهد التابعين والأئمة المجتهدين، كما سيأتي النص بذلك عن الإمام الشافعي - رَحِمَهُ اللهُ - تعالى.
...
١ - إيهام أن المتأخرين من علماء المذاهب لم يأخذوا بالحديث الآحادي الصحيح في العقائد، كما قد يفهم من العبارتين رقم / ١ و ٢/ وأنهم خالفوا مذاهب أئمتهم، في هذا الأمر، وأسلوب العبارة قد يؤخذ منه',NULL,'170',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (15,'التعميم، كما أنه لم يميز بين ما احتف بالقرائن وبين ما لم يحتف، ولم يوضح الوجه الذي حصل به عدم أخذهم بالحديث الصحيح الآحادي في العقائد؟!
...
<span data-type="title" id=toc-14>أَثَرُ الخَبَرِ الصَّحِيحِ المُجَرَّدِ فِي العَقِيدَةِ:</span>
...
يقول الإمام السرخسي الحنفي - رَحِمَهُ اللهُ - بعد بيان نحو ما قدمناه (٣١): «فأما الآثار المروية في عذاب القبر ونحوها فبعضها مشهورة وبعضها آحاد، وهي توجب عقد القلب عليه، والابتلاء بعقد القلب على الشيء بمنزلة الابتلاء بالعمل به أو أهم ... ».
...
(٣١) ج ١ ص ٣٢٩، ٣٣٠.
(٣٢) ج ١ ص ٦٩٦.
(٣٣) ص ٤٦٠، ٤٦١.',NULL,'172',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (17,'معصومين من الخطأ والكذب، وإن كان ذلك مُسْتَبْعَدًا كما ذكرنا، لكن ذلك أورث شبهة منعت من الحكم عليه بالكفر.
...
<span data-type="title" id=toc-15>أَثَرُ الحَدِيثِ الصَّحِيحِ المُحْتَفِّ بِالقَرَائِنِ فِي العَقِيدَةِ:</span>
...
_________
(٣٤) " المستصفى ": ج ١ ص ١٣٥.
(٣٥) ص١٣٦، لكن الغزالي يتوقف عن إفادة الخبر الآحادي الفرد للعلم، كما هو صريح كلامه بعد هذا.
----------------------
[تَعْلِيقُ مُعِدِّ الكِتَابِ لِلْمَكْتَبَةِ الشَّامِلَةِ]:
(*) ما بين [ ..... ] لم أجده في " المستصفى " للإمام الغزالي.',NULL,'173',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (18,'وخالف في أصل المسألة صاحبا " مُسلِّمِ الثبوت " وشرحه " فواتح الرحموت " من الحنفية، وقالا: إنه لا يفيد العلم، وفي " المُسلَّم " و" شرحه " مناقشة مطولة متسلسلة حول هذه القضية، يمكن أن تتبلور فكرتها أمام القارئ بهذا النقاش الموجز نسوقه من المتن والشرح (٣٦):
...
<span data-type="title" id=toc-16>الفَرْقُ بَيْنَ العِلْمِ القَطْعِيِّ وَالعِلْمِ النَّظَرِيِّ:</span>
...
يقول الإمام الغزالي (٣٧): «النَّظَرِيُّ هُوَ الذِي يَجُوزُ أَنْ يَعْرِضَ فِيهِ الشَّكُّ، وَتَخْتَلِفُ فِيهِ [الأَحْوَالُ] فَيَعْلَمُهُ بَعْضُ النَّاسِ دُونَ بَعْضٍ [وَلاَ يَعْلَمُهُ النِّسَاءُ وَالصِّبْيَانُ] وَمَنْ لَيْسَ مِنْ أَهْلِ النَّظَرِ وَلاَ يَعْلَمُهُ مَنْ تَرَكَ النَّظَرَ قَصْدًا، وَكُلُّ عِلْمٍ نَظَرِيٍّ فَالْعَالِمُ بِهِ قَدْ يَجِدُ نَفْسَهُ [فِيهِ] شَاكًّا ثُمَّ طَالِبًا».
ويقول الحافظ ابن حجر في " شرح النخبة " (٣٨): «وهذه الأنواع التي ذكرناها لا يحصل العلم بصدق الخبر منها إلا للعالم بالحديث المتبحر فيه العارف بأحوال الرواة المطلع على العلل. وكون غيره لا يحصل له العلم بصدق ذلك لقصوره عن الأوصاف المذكورة لا ينفي حصول العلم للمتبحر المذكور».

<span data-type="title" id=toc-17>حُكْمُ العِلْمِ النَّظَرِيِّ:</span>
...
١ - أن الحكم على الحديث إذا بلغ إفادة القطع يختلف من شخص إلى آخر، لأن القضية قضية بحث، وما يكون كافيًا عند بعض أهل العلم قد لا يكفي عند غيره، فلا يجوز الإنكار فيه على من لم يجد البحث كافيًا لإثبات أن الدليل الفلاني بعينه لا يبلغ درجة العلم.

٢ - أن من أنكر قضية ثابتة بدليل يفيد العلم النظري يأثم، بل يضلل عِيَاذًا بِاللهِ تَعَالَى، وهو حكم أشد من حكم المنكر للخبر الآحادي المجرد، لكنه لا يكفر اتفاقًا. قال العلامة محب الله بن عبد الشكور في الكلام على الحديث المشهور (٣٩): «وجعله الجصاص قسمًا من المتواتر مفيدًا للعلم نظرًا، والاتفاق على أن جاحده لا يكفر، بل يضلل».

قال المحقق عبد العلي الأنصاري في " شرحه " يعلق على قوله: «جَاحِدُهُ لاَ يُكَفَّرُ» -:
_________
(٣٦) ج ٢ ص ١٢١.
(٣٧) " المستصفى ": ج ١ ص ١٣٢، ١٣٣.
(٣٨) " نسخة شرح الشرح ": للقاري ص ٤٦.
(٣٩) في " مسلم الثبوت ":ج ٢ ص ١١، ١١٢.',NULL,'174',NULL,NULL,'0');
INSERT INTO [b96235] VALUES (19,'«أما عند غير الشيخ أبي بكر الجصاص فظاهر، وأما عنده فلأن قطعيته نظرية، فقد دخل في حيز الإشكال، وما قيل إنه لم يبق على هذا ثمرة للخلاف، ففيه أن الثمرة عنده لما كان قَطْعِيًّا يعارض الكتاب وينسخه جميع أنحاء النسخ، بخلاف الجمهور ... ».
...
<span data-type="title" id=toc-18>أَنْوَاعٌ مِنَ الحَدِيثِ تُفِيدُ العِلْمَ النَّظَرِيَّ:</span>
وفي الختام نذكر للقارئ أنواعًا من حديث الآحاد الذي يفيد العلم النظري لاحتفافه بالقرائن:

١ - الخبر الذي تلقته الأمة بالقبول، كما مر في أكثر من موضع. وألحق به الإمام أبو بكر الجصاص الحنفي الخبر المشهور كما ذكرنا، وذلك بمعنى الشهرة عند الحنفية. واستدل لرأيه باستحالة أن تتفق عليه الأمة ويكون خطأ لأنه يصير مُجْمَعًا عَلَيْهِ (٤٠)، وغيره من الحنفية يقولون إنه يفيد علم الطمأنينة بسبب هذا التواتر والتلقي، وهذا قريب جِدًّا من القول بأنه يفيد العلم النظري، لأنهم قالوا إنه قد يعرض فيه الشك كما سبق.

ومن هنا نجد للحنفية مُسْتَمْسَكًا بجعل المشهور قِسْمًا مُنْفَرِدًا، لأنه استقل بهذه المزية في قوة الاحتجاج.

٢ - المشهور عند علماء الحديث، وقد سبق تعريفه، وذلك إذا كانت له طرق متباينة سالمة من ضعف الرواة والعلل.

٣ - المسلسل بالأئمة الحفاظ المتقنين حيث لا يكون غَرِيبًا، مثل حديث مالك عن نافع عن ابن عمر، وهي سلسلة الذهب. فإنه يفيد العلم عند سامعه بالاستدلال من جهة جلالة رواته، بما يقوم مقام العدد الكثير من غيرهم.

فإذا انضاف إليه من هو في تلك الدرجة ازداد قوة وبعد عما يخشى عليه، وصار مُفِيدًا للعلم عند العالم المتبحر كما ذكرنا من قبل (٤١).
...
الدكتور نور الدين عتر.
_________
(٤٠) " فواتح الرحموت " ج ٢ ص ١١١ وهذا المستند تبناه بعد ذلك ابن القيم في الاستدلال على إفادة الحديث الذي تلقته الأمة بالقبول للعلم النظري.
(٤١) " نزهة النظر شرح نخبة الفكر " للحافظ ابن حجر: ٤٥، ٤٦.',NULL,'175',NULL,NULL,'0');
