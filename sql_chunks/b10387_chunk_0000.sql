...
CREATE TABLE "b10387"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b10387
INSERT INTO [b10387] VALUES (1,'<span data-type="title" id=toc-1>مدخل</span>
...
الرشوة
...
فهذه عجالة في موضوع الرشوة تلبية لطلب (الإعلام) ؛ لتقدم في حلقات (تلفزيونية) ، سطرتها كبحث ليساعد على تقديمها على حلقات. وبالله التوفيق ومنه العون والرشاد.',NULL,'123',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (2,'<span data-type="title" id=toc-2>الرشوة لغة:</span>
...
قال ابن الأثير: الرشوة الوصلة إلى الحاجة بالمصانعة، وأصله من الرشاء الذي يتوصل به إلى الماء؛ فالراشي الذي يعطي من يعينه على الباطل، والمرتشي الآخذ، والرائش الذي يسعى بينهما يستزيد لهذا ويستنقص لهذا.',NULL,'123',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (3,'<span data-type="title" id=toc-3>ألفاظ مرادفة للرشوة:
منها </span>السحت والبرطيل:
والسحت لغة: الحرام، أو ما خبث من المكاسب فلزم عنه العار؛ سمي بذلك لأنه يسحت البركة ويذهبها، يقال: (سحته الله) أي أهلكه، ويقال: (أسحته) ، وقرئ بهما في قوله تعالى: {فَيُسْحِتَكُمْ بِعَذَابٍ} أي يستأصلكم ويهلككم.',NULL,'123',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (4,'واستدل له بقول الفرزدق:
وعض زمان يا ابن فروان لم يدع ... من المال إلا مستحثا أو مجلف
وأصله كلب الجوع، يقال: (فلان سحوت المعدة) إذا كان لا يلقي أبدا إلا جائعا، قاله الفراء i.
...
وفي القاموس: الترطيل: تليين الشعر بالدهن وتكسيره وإرخاؤه وإرساله.',NULL,'124',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (5,'<span data-type="title" id=toc-4>مناقشة تلك الأقوال:</span>
...
_________
i أبو حيان.
ii المجموع ج ٢٨ ص ٣٠٤',NULL,'124',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (6,'ولو سلمنا أن الرشوة نوع منه - كجعل على باطل - فإن مسمى الجعل أعمّ من الرشوة.
...
وهذا ما يجعلنا نقول: إنه تعريف للرشوة بالمعنى العام، وسيأتي إيضاح المعنى الخاص بها عند الكلام على نصوص القرآن في الموضوع إن شاء الله.',NULL,'125',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (7,'<span data-type="title" id=toc-5>الرشوة في الاصطلاح:</span>
...
ب - وقيل: كل مال دفع ليبتاع به من ذي جاه عونا على مالا يحل، ذكرهما في فتح الباري i.
ج - وقال صاحب الإنصاف: الرشوة ما يعطى بعد طلبه، والهدية ما يدفع إليه ابتداء ii.
...
_________
i ج ١١ ص ٢١٢.
ii ج١١ ص٢١٢.',NULL,'125',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (8,'وعلى كل فإن لما عرفوا به الرشوة لغة واصطلحوا عليه شرعا صلة كبيرة في الصورة والمنطلق، فالتكلم به إظهار للصورة بصفة عامة.',NULL,'126',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (9,'<span data-type="title" id=toc-6>الصلة بين المعنى اللغوي والمعنى الاصطلاحي:</span>
...
وبإمعان النظر تجد أن حقارة المرتشي ومهانته تأتي أول ما تأتي من الراشي نفسه؛ لأنه قاسه بمقياس الإنسانية فوجده لا إنسانية عنده، وبمقياس الأمانة والدين فوجده خاليا منهما، وما تقدم إليه بالرشوة إلا بعد اليأس منه، وإن ألان له القول وتلطف في السؤال، وقد أحسن من قال في نظير ذلك وقريب منه:',NULL,'126',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (10,'وإذا امرؤ مدح امرأ لسؤاله ... وأطال فيه فقد أراد هجاءه
...
ولكن المحققين من علماء اللغة ينفون الترادف في اللغة العربية، ويقولون إن الترادف بمعنى وجود عدة صفات للمسمى، وكل لفظ يكون ملحوظا فيه بعض تلك الأوصاف؛ كالسيف مثلا للجنس، مميزا له عن السكين وأنواع السلاح الأخرى، والمهند يراعى جودة صنعه مثل المصنوع في الهند فعلا، والصمصام يراعى فيه نوع حديده ومعدنه وهكذا.',NULL,'127',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (11,'وقد أيد شيخ الإسلام ابن تيمية رحمه الله ذلك، ومثّل له في قوله تعالى: {يَوْمَ تَمُورُ السَّمَاءُ مَوْراً} ؛ فقال: يقول العلماء (المور) الحركة من قبيل الترادف، ولكن المور فيه معنى زائد على مطلق الحركة، ألا وهو كونها بسرعة، فالمور الحركة بسرعة.
...
وينفرد السحت حينما يكون العمل محرما من جانب واحد، وهو جانب الأخذ فقط؛ فيأكله فيأكل ما أخذه سحتا، والله أعلم.',NULL,'128',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (12,'<span data-type="title" id=toc-7>الرشوة في القرآن الكريم:</span>
...
وبدراسة هذه النصوص في تلك المواضع الثلاثة بالتفصيل ستجد حقيقة معنى الرشوة ومعنى السحت وموضوع كل منهما، وبالتالي خطورة وجودهما ومدى تحذير القرآن الكريم منهما، وبأي صورة صوَّر القرآن مَن يتعاطى شيئا مِن ذلك.',NULL,'129',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (14,'<span data-type="title" id=toc-8>دراسة النص الأول:</span>
...
وهنا يأتي السؤال: لماذا آية النهي عن أكل أموال الناس بالباطل في أثناء مجيء آيات الصيام؛ لأن السؤال عن الأهلة وبيان مهمتها ألصق بالصيام؛ لأنه آخر الحج في التوقيت، كما قال فيه: "صوموا لرؤيته وأفطروا لرؤيته".',NULL,'129',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (15,'والجواب على ما يظهر - والله تعالى أعلم - أنه لتمام الارتباط بين فريضة الصوم وبين تحريم أموال الناس؛ للآتي:
...
ولكن عطف الرشوة بخصوصها على ذلك العموم، وهو ما يعلم عند المفسرين بشدة الاهتمام بهذا الخاص من بين أفراد العام، كقوله تعالى: {تَنَزَّلُ الْمَلائِكَةُ وَالرُّوحُ فِيهَا} ، أي جبريل مع دخوله في عموم الملائكة؛ لاختصاصه فيهم.',NULL,'130',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (16,'وقد صورها النص بصورة مطابقة لصورة الراشي والمرتشي بطرفيها؛ حيث قال: {وَتُدْلُوا بِهَا إِلَى الْحُكَّامِ} ، والإدلاء إرسال الدلو إلى ماء البئر، ولا يكون إلا بالحبل، وحبل الدلو يسمى رشاء؛ فالرشاء والرشوة من مادة واحدة، والمدلي هو الراشي، والمدلى إليه هو المرتشي، وما في الدلو هو الرشوة.
...
نسأل الله تعالى السلامة والعافية.',NULL,'132',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (18,'ب-<span data-type="title" id=toc-9> الموطن الثالث:</span>
...
ثم في هذا السياق من زيادة في المنهج بيان من عليه مسؤولية محاربة هذا الداء العضال، ألا وهم الأحبار والربانيون؛ فالأحبار هم العلماء والربانيون هم من جمعوا بين العلم',NULL,'133',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (20,'والإنارة، وهذا بيان في تخصيص لولاة الأمر أن عليهم القيام بنهي من تسول له نفسه بأكل السحت، وقدم الربانيون لأنهم أقدر على ذلك لما رجع لهم من الولاية والعلم، وكما في الحديث: "إن الله ليزع بالسلطان.." الخ.',NULL,'134',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (21,'<span data-type="title" id=toc-10>الفرق بين الرشوة والسحت:</span>
...
ويشهد لهذا ما رواه البيهقي i بسنده عن مسروق قال: سألت ابن مسعود عن السحت أهو رشوة في الحكم؟ قال: لا؛ {وَمَنْ لَمْ يَحْكُمْ بِمَا أَنْزَلَ اللَّهُ فَأُولَئِكَ هُمُ الْكَافِرُونَ} ، و {الظَّالِمُونَ} و {الْفَاسِقُونَ} ، ولكن السحت أن يستعينك رجل على مظلمة فيهدي لك فتقبله، فذلك السحت.',NULL,'134',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (22,'<span data-type="title" id=toc-11>الرشوة في نصوص الحديث:</span>
...
_________
i ج ١٠ ص ١٣٩.',NULL,'134',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (23,'عند أحمد بمعناه، وزيادة: "والرائش"، أي وهو الساعي بينهما يستزيد هذا ويستنقص هذا.
...
وروى عن عمر بن عبد العزيز أنه اشتهى يوما التفاح فلم يجد ما يشتري به من ماله، وبينما هو سائر مع بعض أصحابه أهديت إليه أطباق من التفاح؛ فتناول واحدة فشمها ثم رده',NULL,'135',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (24,'إلى مهديه، فقيل له في ذلك، قال: (لا حاجة لي فيه) ، فقيل له: إن رسول الله صلى الله عليه وسلم كان يقبل الهدية، وأبو بكر وعمر! فقال: (إنها لأولئك هدية وهي للعمال رشوة) .
...
وقد وقع مثله لعمر رضي الله عنه؛ كان رجل يهدي إليه رِجل جزور كل عام؛ فخاصم إليه يوما فقال: يا أمير المؤمنين اقض بيننا قضاء فصلا، أي كما تفصل الرِّجل من سائر الجزور؛ فقضى عمر وكتب إلى عماله: ألا أن الهدايا الرشا؛ فلا تقبلن من أحد هدية.',NULL,'136',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (25,'<span data-type="title" id=toc-12>دراسة تلك النصوص:</span>
...
كما تجد التنصيص على الرشوة في الحكم لما لهذا النوع منها من أكبر الخطر على صاحبه، كما قال مسروق عن ابن مسعود: أنه يخشى عليه الكفر؛ وذلك لأنه قد يحكم بغير ما أنزل الله فيدخل تحت قوله تعالى: {وَمَنْ لَمْ يَحْكُمْ بِمَا أَنْزَلَ اللَّهُ فَأُولَئِكَ هُمُ الْكَافِرُونَ} .',NULL,'136',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (26,'أما حديث ابن اللتبية فهو درس عملي من الرسول صلى الله عليه وسلم لكل من ولي عملا للمسلمين وأخذ فيه الهدية؛ لأنها في واقع الأمر ليست بهدية خالصة وإنما معها مراعاة حالة العامل، ومن ورائها انتظار ما يترجاه المهدي، وكما قال صلى الله عليه وسلم: "هل جلس في بيت أبيه وأمه فينظر أيهدى إليه أم لا".
...
ولذا قال العلماء: لا ينبغي للقاضي أن يتولى الشراء لنفسه خشية المحاباة، ولا يشتري له من يعلم أنه من طرفه؛ حفاظا على القاضي من ريبة الرشوة.',NULL,'137',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (27,'<span data-type="title" id=toc-13>عوامل تفشي الرشوة والبيئة التي تساعد على انتشارها:</span>
ما دامت الرشوة على غير العادة فإن عوامل تفشيها هي أيضا عوامل غير عادية:
- وأهمها وأساسها هو ضعف الوازع الديني للآتي:
١- ما ظهر من ربطها بالصوم.
٢- ما ظهر من أنها من عمل المنافقين واليهود.
٣- ما ظهر من أن منهجها الأساسي هو الاستماع للكذب والمسارعة للعدوان والإثم.
...
وإذا تصورنا عوامل تفشي الرشوة والبيئة التي تساعد على انتشار الرشوة فيها فإنه بقي علينا تصوير وبسط نماذج مضار الرشوة وسط هذه العوامل، ومن خلال تلك البيئة بإيجاز.',NULL,'138',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (28,'<span data-type="title" id=toc-14>مضار الرشوة:</span>
...
د: وبالتالي ينقلب منهج الإصلاح الاجتماعي، فبدلا من أن يتعاون الناس على البر والتقوى في الأمر بالمعروف والنهي عن المنكر، يكون على العكس من ذلك كله، وفي هذا',NULL,'139',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (29,'مضيعة للأمة كلها كما ضاعت أمة بني إسرائيل كما قال تعالى في موجب لعنهم: {كَانُوا لا يَتَنَاهَوْنَ عَنْ مُنْكَرٍ فَعَلُوهُ لَبِئْسَ مَا كَانُوا يَفْعَلُونَ} .
...
وفي الثاني حرمان الأمة مما هو من حقها أن ترتفق به وتتوسع في استعماله؛ فيتيح الفرصة للمهربين وتحصيلهم مصلحة أنفسهم في اتجارهم في ضروريات الأمة.',NULL,'140',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (30,'رابعا: قد تكون في إجراء تعاقد مع العاملين، فقد يتعاقد مع غير الأكفاء بسبب ما يقدمونه من الرشوة، ويترك الأكفاء لتعففهم وعزة نفوسهم، واعتدادهم بكفاءتهم.
...
وقد تكون في إفشاء سر الدولة أيا كان موضوعه؛ فيقع على الأمة من الخسارة بقدر موضوع ذلك السر الذي أفشاه؛ فقد يكون عسكريا فيفوت الفرصة على الجيش أو يوقع الجيش في مهلكة ويمكن العدو منه.',NULL,'141',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (31,'وقضية حاطب بن أبي بلتعة عندما همّ بإفشاء سر تحركات المسلمين إلى مكة معروفة، لولا أن تدارك الله المسلمين بمجيء جبريل عليه السلام بالجنود وتدارك الظعينة بالخطاب قبل أن تصل العدو.
كل هذا من المفاسد على عامة الأمة والمجتمع حكومة وشعبا، وهناك المضار الفردية، وهي بالتالي تعود على المجتمع؛ لأن الفرد جزء منه، وما يؤثر على الجزء يؤثر بالتالي على الكل.',NULL,'142',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (32,'<span data-type="title" id=toc-15>تأثيرها على الفرد:</span>
...
ومن كل ما تقدم يظهر خطر تفشيها ومضار وجودها، مما يحتم محاربتها ومعالجة المجتمع من دائها.',NULL,'142',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (33,'<span data-type="title" id=toc-16>طريقة علاجها:</span>
طريق علاج أي داء إنما تبدأ من تشخيصه، ثم بمنع مسبباته، ثم علاج أعراضه ومضاعفاته.',NULL,'142',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (34,'وإذا كان التشخيص قد وضح فيما تقدم، والأسباب قد وضحت، والأغراض ملموسة والمضاعفات تتزايد فلم يبق إلا منهج العلاج.
...
رابعا: ما جاء في نص القرآن الكريم: {لَوْلا يَنْهَاهُمُ الرَّبَّانِيُّونَ وَالأَحْبَارُ} ، والربانيون هم ولاة الأمر العالمون بحدود الله، والأحبار هم العلماء والمعلمون فيجتمع الوازع الديني من العلماء والوازع السلطاني من الحكام.',NULL,'143',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (35,'<span data-type="title" id=toc-17>الفرق بين الهدية والرشوة:</span>
...
وهناك ما هو أعم، وهو كل عطاء بغير مسألة سواء قصد بذلك الإهداء والمحبة أو قصد به العطف والمساعدة،',NULL,'144',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (37,'كما في حديث عائشة رضي الله عنها عند أحمد والبيهقي أن عبد الله بن عامر بعث إليها بنفقة وكسوة فردته، ثم استدعت الرسول بها وقالت: إني ذكرت شيئا قال لي رسول الله صلى الله عليه وسلم: "يا عائشة من أعطاك عطاء بغير مسألة فاقبليه، فإنما هو رزق الله تعالى إليك".
وعن أبي هريرة رضي الله عنه عن النبي صلى الله عليه وسلم قال: "من عرض له من هذا الورق شيء من غير مسالة ولا إشراف نفس فليتوسع به في رزقه، فإن كان غنيا فليوجهه إلى من هو أحوج إليه منه"، رواه أحمد والبيهقي وإسناد أحمد جيد قوي i.
...
وهنا ينظر في كيفية الإسراع لما أعطيته ابتداء منك: هل كان على حساب تأخير معاملات الآخرين أم هو ضمن نطاق عمله وفي نطاق المعتاد؟ فإن كان على حساب تأخير الآخرين فهذا ألصق بالرشوة، بل إنك ستغريه وتدفعه إلى تعطيل المعاملات الأخرى حتى يتقدم إليه أصحابها بمثل ما تقدمت أنت إليه به.',NULL,'146',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (39,'وإن كان في نطاق عمله وليس على حساب تأخير معاملات الآخرين فلأي شيء دفعت؟ ولأي شيء هو أخذ؟ ولكنها أخفّ مما قبلها إلا إذا كانت ستجعله يتطلع إلى مثل ذلك منك أو من غيرك؛ فتمنع سدا للذريعة.
١- أشخاص يعملون في دوائر أو مكاتب مختلفة وتمرّ بهم معاملات لك، وتأخذ طريقها مع غيرها بدون تمييز لها ولا تخصيصها باهتمام من أجل صاحبها، وهو لا يقدم شيئا على تلك المعاملات لكثرتها أو لكثرة من تمر عليهم، ولكنه في المناسبات كالأعياد أو العودة من سفر ربما يقدم هدايا لبعض الناس أو يقدم مساعدات لبعض الأشخاص، فقدم لهؤلاء مع غيرهم من حيث حاجتهم أو صداقتهم لكثرة التعامل معهم.
...
ولكن هناك مجال آخر، وهو ما إذا كان العطاء لا عن طيب نفس بل عن اضطرار، ومن الجانب الآخر بطلب وإصرار؛ فماذا يكون الحكم بالنسبة لعطاء المعطي في حالات اضطراره وبالنسبة للأخذ في حالات سؤاله واضطراره؟',NULL,'147',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (40,'<span data-type="title" id=toc-18>أقوال العلماء فيمن صانع بماله عند اضطراره:</span>
أولا: عند المفسرين وبإيجاز:
قال القرطبي - عند آية المائدة الأولى {سَمَّاعُونَ لِلْكَذِبِ أَكَّالُونَ لِلسُّحْتِ} -: وروي عن وهب بن منبه أنه قيل له: الرشوة حرام في كل شيء؟ فقال: إنما يكره من الرشوة أن ترشي لتعطي ما ليس لك أو تدفع حقا قد لزمك،',NULL,'147',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (41,'فأما أن ترشي لتدفع عن دينك ودمك ومالك فليس بحرام. قال أبو الليث السمرقندي الفقيه: وبهذا نأخذ؛ أن يدفع الرجل عن نفسه وماله بالرشوة، وهذا كما روي عن عبد الله ابن مسعود أنه كان بالحبشة فرشا دينارين وقال: إنما الإثم على القابض دون الدافع.. ا?.
ثانيا: المحدثون:
جاء في تحفة الأحوذي i على سنن الترمذي - عند حديث أبي هريرة في لعن الراشي والمرتشي المتقدم ذكره - قال: فأما ما يعطي توصلا إلى أخذ حق أو دفع ظلم فغير داخل فيه، وساق خبر ابن مسعود في الحبشة، ثم قال: وروي عن جماعة من أئمة التابعين قالوا: لا بأس أن يصانع الرجل عن نفسه وماله إذا خاف الظلم. وهذا نقلا منه عن ابن الأثير، ثم نقل عن صاحب المرقاة شرح المشكاة كلام الفقهاء عن ابن الأثير.
...
وفي العارضة لابن العربي على صحيح الترمذي ii ما يقرب مما تقدم لفظا ويتفق معه معنى.
وعند الشوكاني iii فيها نقاش طويل، من ذلك نقله عن المنصور بالله قول أبي جعفر وبعض أصحاب الشافعي: إنّه إنْ طلب حقا مجمعا عليه جاز، قيل وظاهر المذهب المنع لعموم الخبر..الخامس.
ثم ناقش هذا القول لعدم قيام دليل عليه، ولعمومات النهي عن أكل أموال الناس بالباطل.
_________
i ج٤ ص٥٦٥
ii ج ٦ ص ٨٠.
iii ج ٨ ص ٢٨٨.',NULL,'148',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (42,'والملاحظ أن كل ما ذكره يصدق على الآخذ، وهذا لا خلاف فيه، إنما البحث في الدافع أيضا؛ فهو يتفق مع الجمهور في تحريمه على الآخذ، وخالف الجمهور في حق الدافع مع الاضطرار، وهو محل البحث.',NULL,'149',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (43,'<span data-type="title" id=toc-19>كلام الفقهاء:</span>
الحنابلة: ابن قدامة في المغني؛ يظهر أن ابن قدامة من أشدّ الناس في باب الرشوة، وقد ذكرها في موضوعين:
الأول: في باب الحج i في فصل إمكان السير، قال: فإن كان في الطريق عدو يطلب خفارة فقال القاضي: لا يلزمه السعي وإن كانت يسيرة؛ لأنها رشوة فلا يلزم بذلها في العبادة كالكبيرة، وقال: ابن حامد: إن كان ذلك مما لا يجحف بماله لزمه الحج؛ لأنها غرامة يقف إمكان الحج على بذلها؛ فلم يمنع الوجوب مع إمكان بذلها كثمن الماء وعلف البهائم.
...
والموضع الثاني: في آداب القاضي ii، فيما نقله قتادة عن كعب: وإن رشاه ليدفع ظلمه ويجزيه على واجبه فقد قال عطاء وجابر بن زيد والحسن: لا بأس أن يصانع عن نفسه، وقال جابر بن زيد: رأينا في زمن زياد أنفع لنا من الرشا، ولأنه يستنقذ ماله كما يستنقذ الرجل أسيره، فإن ارتشى الحاكم أو قبل هدية ليس له قبولها فعليه ردها إلى أربابها.
وعند المالكية: قال في الشرح الصغير على أقرب المسالك iii:
...
i ج ٣ ص ٢١٩.
ii ج ٩ ص ٢٧٧- ٢٧٨.
iii ج ٣ ص ٢٩٤.',NULL,'149',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (44,'عند الأحناف i:
...
وعند ابن تيمية رحمه الله في المجموع - أي مجموع الفتاوى - في موضعين الأول منهما ج ٢٩ ص ٢٥٨ أثناء الجواب على المطعومات التي تؤخذ عليها المكس ومحتكرة هل يحرم شراؤها؟.
...
_________
i شرح النهاية ج ٥ ص ٤٥٥، فتح القدير.',NULL,'150',NULL,NULL,'0');
INSERT INTO [b10387] VALUES (45,'ثم قال: وكذلك الأسير والعبد المعتق إذا أنكر سيده عتقه، ومثل كذلك بالزوجة يطلقها زوجها فينكر طلاقها، فكل منهما يفتدي نفسه بالمال ليحق حقا وهو العتق والطلاق، ومعلوم أنهما حق لله تعالى وإلا بقيت الزوجة على غير عصمة.
...
وذكر الأثر الأول في إعطائه صلى الله عليه وسلم عن ملح في مسألة المتقدم إبداءه، وذكر أيضا موضوع العتق والطلاق من أسر خيرا وكان ظالما للناس فأعطوه جاز للمعطي حرام على الآخذ، وساق كلاما طويلا في هذا المعنى.',NULL,'151',NULL,NULL,'0');
