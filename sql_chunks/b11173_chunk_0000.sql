...
CREATE TABLE "b11173"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b11173
INSERT INTO [b11173] VALUES (1,'<span data-type="title" id=toc-1>خصائص التفكير الفقهي عند الشيخ محمد بن عبد الوهاب</span>
...
ويعتمد البحث في هذا الجانب منه على فحص وبحث التراث العلمي الذي ورثنا عنه بطريقة استقرائية واستنتاجية في نفس الوقت، مهتما بالخصائص والموضوعات الرئيسية دون الوقوف لدى المسائل الجزئية إلا بالقدر الذي توضح فيه الفكرة الأساسية.',NULL,'379',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (2,'الحالة الفقهية في العالم الإسلامي بعامة ونجد بخاصة:
...
_________
١ الفكر السامي في تاريخ الفقه الإسلامي, خرج أحاديثه وعلق عليه عبد العزيز بن عبد الفتاح القاري (المدينة المنورة المكتبة العلمية ١٣٩٧هـ/١٩٧٧م ص١٦٣) .',NULL,'380',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (3,'عباراتها دون مجاوزة لها إلى غيرها من كتب الفقه فضلا عن الكتاب والسنة.
...
INSERT INTO [b11173] VALUES (4,'الآمال، ولو بأقل الأعمال، وهو فرض كفاية قد أهملوه وملوه ولم يعقلوه ليفعلوه"١.
...
٢ علماء نجد خلال ستة قرون, الطبعة الأولى (مكة المكرمة- مكتبة ومطبعة النهضة الحديثة ١٣٩٨ جـ١ ص١٧) .',NULL,'382',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (5,'ثم حريملاء، وكذلك جده من قبل الشيخ سلمان بن علي، انتهت إليهم الرئاسة في العلم والفقه في نجد١.
...
_________
١ عثمان بن عبد الله بن بشر, عنوان المجد في تاريخ نجد الطبعة الثانية (الرياض: وزارة المعارف السعودية, ١٣٩١ جـ١ ص١١٤) .',NULL,'383',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (6,'وإذا كانت كافة الدلائل تشير إلى هذا فإنه مما يستحق البحث تحديد الفترة التي تعرف بها على فكر هذين العالمين الجليلين، هل حدث له هذا أيام طلبه العلم ببلدته العيينة وقبل رحيله إلى الحجاز والبصرة، أم أن اهتمامه بفكرهما جاء صدى ونتيجة تنقله واحتكاكه بالعلماء في تلك البلاد؟
...
٣ انظر المصدر نفسه جـ١ , ص٢.',NULL,'387',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (10,'في تاريخ الدعوة السلفية، ومن ثم ستكون رواية ابن بشر موضع الفحص والدراسة في تعرف الشيخ محمد بن عبد الوهاب على فكر ابن تيمية.
...
٢ السوابق, ص١٩٧,١٩٨.',NULL,'389',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (12,'الحنابلة في الوسط العلمي للحنابلة، ولم تكن شهرتهم لدى علماء الحنابلة بنجد بأقل من أي وسط حنبلي آخر.
...
_________
١ أبو يعلى محمد بن الحسين بن محمد الفرا, العمدة في أصول الفقه. مصور.',NULL,'390',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (13,'ويأتي شيخ الإسلام ابن تيمية ليقرر هذا المبدأ ويؤكده في أكثر من مؤلف فينقل نص القاضي أبي يعلى فيقره لفظا ومضمونا١، ويعرض هذا الموضوع في فتاويه بأسلوبه وطريقته الخاصة فيقول:
...
٣ شرح الكوكب المنير, الطبعة الأولى (مصر: مطبعة السنة المحمدية ١٣٧٢-١٩٥٣) ص٤٠٦.',NULL,'391',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (14,'لا إلى كلام أصحابه، ولا إلى الراجح المرجح من الروايتين والقولين، خطأ قطعا١، وقد يكون صوابا، وقولك: إذا استدل كل منهما بدليل فالأدلة الصحيحة لا تتناقض بل يصدق بعضها بعضا، لكن قد يكون أحدهما أخطأ الدليل لأنه إما استدل بحديث لم يصح، وإما لأنه فهم من كلمة صحيحة مفهوما مخطأ.
...
٣ مؤلفات الشيخ محمد بن عبد الوهاب, الرسائل الشخصية القسم الخاص, ص٢٥٤.',NULL,'392',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (15,'شرطا أساسيا في بلوغ درجة الاجتهاد حتى قيل (لا ثقة بفقه لا يعتمد على أصول) ، ومظاهر هذا عنده تتجلى في أمرين اثنين:
...
٢ المصدر نفسه, القسم الثاني (الفقه) , جـ٢ ص٣٥.',NULL,'394',NULL,NULL,'0');
...
_________
١ رفع الملام عن الأعلام بنهاية الإنصاف في معرفة الراجح من الخلاف. الطبعة الأولى, جـ١٢-ص٢٩٩- ٣٠٠.',NULL,'395',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (18,'الكتاب والسنة على وجوب متابعتهم، وتنازعوا في مسائل علمية اعتقادية كسماع الميت صوت الحي، وتعذيب الميت ببكاء أهله، ورؤية محمد صلى الله عليه وسلم ربه قبل الموت مع بقاء الجماعة والألفة.. ومذهب أهل السنة والجماعة أنه لا إثم على من اجتهد وإن أخطأ.
...
٢ مجموعة فتاوى ابن تيمية، جـ١٩ , ص١٢٢.',NULL,'396',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (19,'والعمل بذلك، ويحترم أهل العلم ويوقرهم ولو أخطأوا، ولكن لا يتخذهم أربابا من دون الله، هذا طريق المنعم عليهم، أما اطراح كلامهم وعدم توقيرهم فهو طريق المغضوب عليهم..) ١.
...
٢ مؤلفات الشيخ محمد بن عبد الوهاب. القسم الخامس, الرسائل الشخصية ص٤٠.',NULL,'397',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (20,'"وأما ما ذكرتم من حقيقة الاجتهاد فنحن مقلدون الكتاب والسنة وصالح سلف الأمة وما عليه الاعتماد من أقوال الأئمة الأربعة أبي حنيفة النعمان بن ثابت، ومالك بن أنس، ومحمد بن إدريس، وأحمد بن حنبل رحمهم الله تعالى.."١.
...
"ولعل أبعد تطور للفقه الإسلامي في مسألة اقتران الشرط بالعقد كان في مذهب',NULL,'402',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (25,'الإمام أحمد بن حنبل لاسيما إذا استكملنا هذا المذهب بما أضافه إليه ابن تيمية، وهو من أكبر فقهائه.
...
٢ المصدر نفسه, جـ٣, ص١٧٢.',NULL,'403',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (26,'أما الجانب الأول فموقفه من مسائل الخلاف التي لم يتبين فيها وجه الصواب أنه لا يجوز الإنكار على المخالف أو الاعتراض عليه، وهذا النوع من الاختلاف هو الذي يمكن أن ينطبق عليه الحديث "اختلاف أمتي رحمة" وعلى العكس من ذلك- ما تبين فيه وجه الصواب.
...
_________
١ مؤلفات الشيخ محمد بن عبد الوهاب القسم الثاني (الفقه) جـ١ ,ص٥.',NULL,'406',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (29,'في زمنه من الحاجة لذلك هذا الإنصاف في معرفة الراجح من الخلاف، على مذهب الإمام أحمد بن حنبل ومؤلفه الفقيه علاء الدين علي بن سلمان المرداوي الحنبلي (٨١٧- ٨٨٥ هـ) .
...
٢ عبد القادر بن بدران, المدخل إلى مذهب الإمام أحمد (مصر إدارة الطباعة المنيرية) ص٢٢٢.',NULL,'407',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (30,'"إن طريقتي في هذا الكتاب النقل عن الإمام أحمد والأصحاب، أعزو إلى كل كتاب ما نقلت منه وأضيف إلى كل عالم ما أروي عنه، فإن كان المذهب ظاهرا أو مشهورا، أو قد اختاره جمهور الأصحاب وجعلوه منصورا، فهذا لا إشكال فيه، وإن كان بعض الأصحاب يدعي خلافه.."١.
...
٢ ابن بدران, ص٢٢٢.',NULL,'408',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (31,'ويكون بتقليل المسائل وحذف بعضها أو بتقليل الألفاظ مع تأدية المعنى كاملا كما يكون أحيانا بكلتا الطريقتين معا تقليل المسائل والألفاظ مع استكمال المعنى. يقول موفق الدين ابن قدامة:
...
_________
١ المغني, المدينة المنورة، منشورات المكتبة السلفية جـ١ , ص٤ تصوير.',NULL,'409',NULL,NULL,'0');
...
ومنهجه في هذا الكتاب عرض المسائل المختلفة في الموضوع الفقهي في عبارة',NULL,'410',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (33,'مختصرة على أنه وإن كان اختصارا من الكشاف فإنه لم يخل من ذكر أدلة الأحكام في أسلوب موجز، لا يحرم الدارس من معرفة الحكم مع الدليل المستنبط منه. وهذه أحسن الأحوال التي يكون عليها التقليد الفقهي فهو تقليد ولكن تقليد المتبصر المدرك للدليل الذي يعتمد عليه الحكم، وتدرج بالمقلد إلى أفق أوسع.
...
"فهذا كتاب الطهارة للإمام الشيخ محمد بن عبد الوهاب - رحمه الله - استندنا في نسبته إليه إلى فهارس المكتبة السعودية المدون فيها باسمه تحت رقم ٥٢٠/٨٦ حيث لم يرد في صلب المخطوطة ما يشير إلى ذلك إلا عبارة نعتقد أن فيها شيئا من التحريف، حيث قال في نهاية المخطوطة، ولهذا سئل الشيخ محمد بن عبد الوهاب، ولعل صحة العبارة: وعن هذا سئل الشيخ محمد بن عبد الوهاب، ثم إن أسلوب المخطوطة يتطابق تماما مع أساليب كتاباته وتصانيفه ورسائله رحمه الله، وخاصة كثرة الإشارة إلى اختيارات شيخ الإسلام"١.
كتاب شروط الصلاة وأركانها:
هو استكمال للتأليف في موضوع الصلاة، فيكون هذا الكتاب كالتتمة للموضوع
_________
١ مؤلفات الشيخ محمد بن عبد الوهاب, القسم الثاني (الفقه) جـ٢ , ص٣.',NULL,'411',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (34,'السابق وهو في نفسه موضوع تمهيدي سابق على (كتاب آداب المشي إلى الصلاة) ، ولهذا فإنه يمكن اعتبار الكتب الثلاثة (كتاب الطهارة، وكتاب شروط الصلاة وأركانها، وكتاب آداب المشي إلى الصلاة) مؤلفا واحدا في موضوع فقهي واحد.
...
_________
١ المرجع السابق.',NULL,'413',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (36,'<span data-type="title" id=toc-2>مصادر ومراجع</span>
...
مصادر البحث
ابن قدامة، موفق الدين محمد
المغني، المدينة المنورة: منشورات المكتبة السلفية، تصوير.
ابن تيمية، أحمد بن عبد الحليم
مجموعة فتاوى شيخ الإسلام ابن تيمية، الطبعة الأولى، الرياض. رفع الملام عن الأئمة الأعلام، الطبعة الأولى.
ابن حمدان، أحمد
صفة المفتي والمستفتي
الطبعة الأولى، بيروت، منشورات
المكتب الإسلامي، الطبعة الأولى.
ابن عبد الوهاب، محمد، مؤلفات محمد بن عبد الوهاب، الرياض: جامعة الإمام محمد بن سعود.
ابن بدران، عبد القادر
المدخل إلى مذهب الإمام أحمد
مصر: إدارة المطبعة المنيرية.
ابن بشر، عثمان بن عبد الله
عنوان المجد في تاريخ نجد، الطبعة الثانية الرياض: وزارة المعارف السعودية.
السوابق: الطبعة الثانية.
الرياض: وزارة المعارف السعودية.',NULL,'414',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (37,'أبو طامي، أحمد بن حجر بن محمد
الشيخ محمد بن عبد الوهاب عقيدته السلفية ودعوته الإصلاحية وثناء العلماء عليه.
مكة المكرمة: مطبعة الحكومة، ١٣٩٥هـ.
المسودة، تحقيق محيي الدين بعد الحميد
مصر: مطبعة المدني.
البسام، عبد الله
علماء نجد خلال ستة قرون، الطبعة الأولى.
بيروت: منشورات المكتب الإسلامي، ١٣٨٠ هـ.
الحجوي، محمد بن الحسن الثعالبي
الفكر السامي في تاريخ الفقه الإسلامي
تحقيق: عبد العزيز بن عبد الفتاح القاري
المدينة المنورة: المكتبة العلمية ١٣٩٧ هـ /١٩٧٧م.
الرويشد، عبد الله بن سعد
الإمام الشيخ محمد بن عبد الوهاب في التاريخ
مصر: مكتبة عيسى البابي الحلبي.
السنهوري، عبد الرزاق
مصادر الحق في الفقه الإسلامي، الطبعة الثالثة جامعة الدول العربية: معهد البحوث والدراسات العربية ١٩٦٧ م.
العطار، أحمد عبد الغفور
محمد بن عبد الوهاب الطبعة الرابعة.',NULL,'415',NULL,NULL,'0');
INSERT INTO [b11173] VALUES (38,'بيروت: منشورات مكتبة العرفان ١٣٩٢هـ/١٩٧٢م.
العثيمين، عبد الله صالح
الشيخ محمد بن عبد الوهاب حياته وفكره
الرياض: دار العلوم
الفراء، أبو يعلى محمد بن الحسين بن محمد
العدة في أصول الفقه، مصورة خاصة
الفتوحي، أحمد بن عبد العزيز
الكوكب المنير
مصر: مطبعة السنة المحمدية ١٣٧٢هـ/١٩٥٣م.
المرداوي، أبو سليمان علاء الدين
الإنصاف في معرفة الراجح من الخلاف.
الطبعة الأولى ١٩٧٤م.',NULL,'416',NULL,NULL,'0');
