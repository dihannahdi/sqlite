...
CREATE TABLE "b36398"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b36398
INSERT INTO [b36398] VALUES (1,'القرآن وعودة المجد
...
_________
(١) ١ - نشرت بمجلة المجتمع الكويتية عدد ١٦٠٥',NULL,'1',NULL,NULL,'0');
INSERT INTO [b36398] VALUES (2,'<span data-type="title" id=toc-2>إندونيسيا:</span>
...
<span data-type="title" id=toc-4>لماذا تركنا الله عز وجل</span>؟:
...
فالأمر واضح وجلي .. إن أردنا استجلاب النصر الإلهي فلا بديل عن تنفيذ أوامر الله ونصرته سبحانه على أنفسنا"إن تنصروا الله ينصركم ويثبت أقدامكم" [محمد:٧]',NULL,'2',NULL,NULL,'0');
INSERT INTO [b36398] VALUES (3,'وفي المقابل فإن ما يحدث لنا ما هو إلا عقوبة من الله عز وجل ونتيجة طبيعية لما فعلناه"أولما أصابتكم مصيبة قد أصبتم مثليها قلتم أنَّى هذا قل هو من عند أنفسكم" [آل عمران: ١٦٥]
فالمعاصي التي نرتكبها، والأوامر التي نخالفها ... كل هذا أدى إلى غضب الله علينا، ومن ثمَّ استدعاء العقوبة"وتذوقوا السوء بما صددتم عن سبيل الله" [النحل: ٩٤]
...
وجدت الإجابة في قوله تعالى"وكذلك جعلناكم أمة وسطاً لتكونوا شهداء على الناس" [البقرة:١٤٣] فالله عز وجل اختص هذه الأمة بالرسالة الخاتمة وائتمنها عليها، وطالبها بأن تقوم بما فيها، وتبلغها لسائر الأمم لاستنقاذها من الضلال والنار.
مهمة عظيمة حمّلها الله لأمة الإسلام ألا وهي القيام بدور الشهادة على الناس ودعوتهم إلى الله، ومن أجل ذلك فضل الله الأمة الإسلامية على سائر الأمم "كنتم خير أمة أخرجت للناس تأمرون بالمعروف وتنهون عن المنكر و تؤمنون بالله " [آل عمران: ١١٠]
...
معنى ذلك أنه لن يتم حل المشكلة التي نعاني منها، والخروج من النفق المظلم الذي نسير فيه إلا إذا استبدلنا غضب الله برضاه، حتى يوقف سبحانه عقوبته عنا "عسى الله أن يكف بأس الذين كفروا والله أشد بأساً وأشد تنكيلاً" [النساء: ٨٤]
فكيف لنا أن نفعل ذلك؟!
ما الذي يريده الله منا كي يرضى عنا وينصرنا؟',NULL,'3',NULL,NULL,'0');
INSERT INTO [b36398] VALUES (4,'عدت إلى القرآن ثانية وبحثت فيه عن إجابة لهذه التساؤلات فوجدت أن الأمر واضح تمام الوضوح ... فالله عز وجل يريد منا عدم الشرك به ... يريد أن نخلص أعمالنا كلها له، فلا نتعلق بغيره، ولا نعتقد أن هناك من يملك نفعنا أو ضرنا سواه ...
...
_________
(١) ١ - صحيح الجامع الصغير (٤٢٣)',NULL,'4',NULL,NULL,'0');
INSERT INTO [b36398] VALUES (5,'لقد طبقنا كل ما في هذا الحديث .. رضينا بالزرع وتاقت أنفسنا لتملك الأراضي والضياع والعقار، وتبايعنا بالدّين والسلف لشراء مستلزمات الحياة العصرية المرفهة .. حلم الثراء يسيطر علينا، ويقيدنا ببنود تحقيقه .. تركنا الجهاد والتضحية في سبيل الله .. فماذا كانت النتيجة؟
...
لم أصدق نفسي، فالقرآن بين أيدينا، وفي بيوتنا، وتنطلق به إذاعاتنا ليل نهار ومع ذلك فحالنا لم يتغير .. هذا من ناحية، ومن ناحية أخرى فإن آياته تؤكد تأكيداً قاطعاً بأنه الدواء الناجع لما نعاني منه من أمراض"يا أيها الذين آمنوا قد جاءتكم موعظة من ربكم وشفاء لما في الصدور وهدى ورحمة للمؤمنين" [يونس:٥٧]
...
إنه باختصار مصنع التغيير .. تغيير كل من يدخل إليه مهما كان حاله، ومهما كان حجم الإعوجاج به ... وهذا هو سر معجزته"وكذلك أوحينا إليك روحاً من أمرنا" [الشورى:٥٢]',NULL,'5',NULL,NULL,'0');
INSERT INTO [b36398] VALUES (6,'<span data-type="title" id=toc-14>القرآن هو الحل:</span>
...
نعم، هذا هو قدْر القرآن الذي قال الله عنه"لو أنزلنا هذا القرآن على جبل لرأيته خاشعاً متصدعاً من خشية الله وتلك الأمثال نضربها للناس لعلهم يتفكرون" [الحشر: ٢١]
