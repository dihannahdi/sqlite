...
CREATE TABLE "b9068"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b9068
INSERT INTO [b9068] VALUES (1,'نصائح منهجية
...
إعداد: أبو عبد الرحمن حاتم بن حسن الحسيني - ملتقى أهل الحديث',NULL,'1',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (2,'<span data-type="title" id=toc-1>مقدمة</span>
...
فإن عجب أحد من هذا الثناء القليل، في طالب العلم الجليل؛ سألته بالله:',NULL,NULL,NULL,NULL,'0');
INSERT INTO [b9068] VALUES (3,'هل دبت على وجه الأرض خطى أشرف من خطى طالب علم؟!
...
أخبروني؟ بالله عليكم!!!
ثم أسألكم بالله: هل تعلمون خيراً من شاب في هذا العصر، هجر الدنيا وزهد ملذاتها، ونأى بعيداً عن شهواتها، وانعزل عن فتنها التي تستفز الحليم، وانقطع عن إغواءاتها التي تستخف بالرزين، وترك الناس على دنياهم يتكالبون، وهجر من أهله وإخوانه',NULL,'2',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (4,'تنافسهم على القصور والأموال والمناصب، فإن مر على اللغو مر مر الكرام، وإن تعرض له الجاهلون أعرض وقال: سلام؛ وهو مع ذلك شاب في عنفوان الشباب، أمامه مستقبل عريض، وعليه مسئولية بناء جديد، وينظر إلى الأفق البعيد نظرة ملؤها الآمال والأحلام، تفور فيه غرائز الشهوات، ويجيش فؤاده بالعواطف، وتتفجر دماؤه حماساً؛ ثم هو هو ذلك الذي تجاوز هذا كله!! وجعله وراءه ظهرياً!! وأقبل على العلم.. على مرارته، وانكب على الكتاب.. على ملالته، وإذا حن إلى عناق كاعب..خالفته يدا كاتب، وإذا اشتهت شفتاه أن يرتشف الرضاب.. تمتم ملتذاً بقراءة كتاب؛ قطع الأيام في التحصيل، وسهر الليالي على الدرس والترتيل؛ يقرأ حتى تزوغ عينه، ويكتب حتى تكل يده، ويدرس حتى يكد ذهنه!!!
...
ولست أنا بالذي يذكر فضل طالب العلم، إذ قد رددت ذلك المحاريب وأصداؤها، وضجت به أروقة المساجد وقبابها، وتعبد بترتيله المتهجدون، وتقرب بتدبره أهل العلم الراسخون؛ وقبل ذلك نزل به الروح الأمين، على قلب سيد المرسلين صلى الله عليه وسلم؛ وقبل ذلك تكلم به الله الذي لا إله إلا هو الرحمن الرحيم؛ فقال تعالى: في الحث على سؤال التعلم - الذي هو أول درجاته - (فسئلوا أهل الذكر إن كنتم لا',NULL,'3',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (5,'تعلمون) [النحل: ٤٣] ، وقال عز وجل في الأمر بالرحلة لطلب العلم: (وما كان المؤمنون لينفروا كافة فلولا نفر من كل فرقة منهم طائفة ليتفقهوا في الدين ولينذروا قومهم إذا رجعوا إليهم لعلهم يحذرون) [التوبة:١٢٢] ، وما أمر سبحانه نبيه صلى الله عليه وسلم بطلب الزيادة في شيء في الدنيا، إلا من العلم، فقال تعالى: (وقل رب زدني علماً) [طه:١١٤] ؛ وأشاد سبحانه - أيما إشادة! - بفضل أهل العلم، ورفع من شأنهم، وأعلى من قدرهم، بما يعجز عن بيانه إلا البيان المبين، من كلام رب العالمين، فقال عز من قائل (شهد الله أنه لا إله إلا هو والملائكة وأولوا العلم قائماً بالقسط لا إله إلا هو العزيز الحكيم) [آل عمران: ١٨] ، وقال سبحانه وتعالى: (إنما يخشى الله من عباده العلماء) [فاطر: ٢٨] ، وقال سبحانه (يرفع الله الذين ءامنوا والذين أوتوا العلم درجات) [المجادلة: ١١] ، وقال عز شانه (قل هل يستوى الذين يعلمون والذين لا يعلمون) [الزمر: ٩] .
...
وتم ما أعددته لتلك الكلمة في الشهر الأول من عام (١٤١٨هـ) ، وألقيتها في هذا التاريخ.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (6,'ثم تكرر إلى الطلب بنشرها مكتوبة، حسن ظن من الطالبين، فرأيت أن إجابة سؤالهم فيه تحقيق فائدة وإن صغرت، وتوجيه نصيحة لطلبة العلم لا تخلو من نفع.
...
وكتب
الشريف حاتم بن عارف بن ناصر العبدلي العوني',NULL,'5',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (7,'<span data-type="title" id=toc-2>تمهيد</span>
...
وإليك الإجابة (بعون الله تعالى) .',NULL,'7',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (9,'<span data-type="title" id=toc-3>شرف علم الحديث وشرف حملته</span>
...
وهذا من إعجاز القرآن في الإشادة بمكانة السنة من القرآن، وفي التأكيد على عدم استغناء القرآن عنها، بل وعلى بطلان مثل ذلك الاستغناء.. إن زعم!!',NULL,'8',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (10,'ولهذه المنزلة العليا للسنة، ولعلاقتها القوية الوشائج والصلات بالقرآن الكريم، كان يقول غير واحد من السلف، منهم مكحول الشامي (ت ١١٨ هـ) : (القرآن أحوج للسنة من السنة للقرآن) (١) . وذلك لأن إجمال القرآن يحتاج إلى تفصيل السنة، ومتشابه القرآن تفسره السنة؛ في حين أن السنة - غالباً - مفصلة مبينة واضحة.
ولهذا يصح أن يقال عمن يتعلم السنة: إنه يتعلم القرآن، ولمن يقرأ السنة: إنه يقرأ تفسير القرآن!!
وقد كان ذلك واضحاً تمام الوضوح عند السلف، ولهذا لما قيل لمطرف بن عبد الله بن الشخير (ت ٩٥ هـ) : (لا تحدثونا إلا بالقرآن، قال مطرف: والله ما نريد بالقرآن بدلاً، ولكن نريد من هو أعلم بالقرآن منا) (٢) .
ويجب التنبه إلى أن تفسير السنة للقرآن ليس هو وحده التفسير الصريح لمعانيه من النبي صلى الله عليه وسلم، كأن يذكر النبي صلى الله عليه وسلم آية ثم يشرحها شرحاً مباشراً. نعم هذا من تفسير السنة للقرآن، لكن الخضم الأعظم منه هو جميع سنة النبي صلى الله عليه وسلم القولية والفعلية والتقريرية وسيرته ومغازيه وحياته. ولهذا لما سئلت عائشة - رضي الله عنها - عن خلق النبي صلى الله عليه وسلم، أرشدت السائل إلى النظر في القرآن، عندما قالت: (كان خلقه القرآن) (١) وعلى هذا يحق لمن سأل عن القرآن أن يحال إلى سنة النبي صلى الله عليه وسلم، كما أحالت عائشة السائل عن السنة إلى القرآن!
وهذا أكبر ما يبين مكانة السنة، وعظم أهميتها، وأولويتها على غيرها من العلوم.
ولقد بين الله عز وجل مكانة السنة وشرفها في القرآن العظيم، في آيات كثيرات؛ منها آيات كثيرة في الأمر بطاعة النبي صلى الله عليه وسلم والتحذير من مخالفته عليه أفضل الصلاة وأتم التسليم. كقوله تعالى: (وأطيعوا الله والرسول لعلكم ترحمون) [آل عمران: ١٣٢ [، وكقوله عز وجل: (من يطع الرسول فقد أطاع الله) [النساء: ٨٠] ، وكقوله سبحانه: (فلا وربك لا يؤمنون حتى يحكموك فيما شجر بينهم ثم لا يجدوا في
_________
...
وقد جاءت السنة نفسها ببيان فضل أهل الحديث وشرفهم، في أحاديث كثيرة وآثار ذوات عدد؛ حتى صنف الخطيب البغدادي (ت ٤٦٣هـ) كتاباً في ذلك بعنوان (شرف أصحاب الحديث) .
ومن هذه الأحاديث قول النبي صلى الله عليه وسلم: (لا تزال طائفة من أمتي على الحق ظاهرين، لا يضرهم من خذلهم، حتى تقوم الساعة) (١) .
_________
(١) حديث صحيح متفق عليه، صح عن جمع من الصحابة رضي الله عنهم.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (12,'قال عبد الله بن المبارك (ت ١٨١ هـ) ، ويزيد بن هارون (ت ٢٠٦هـ) ، وعلي ابن المديني (ت٢٣٤ هـ) ، وأحمد بن حنبل (ت ٢٤١هـ) ، والبخاري (ت ٢٥٦ هـ) ؛ قال هؤلاء الأئمة كلهم في بيان الطائفة المنصورة: (هم أصحاب الحديث) (١) . بل عبارة الإمام أحمد، وقبله يزيد بن هارون: (إن لم يكونوا أصحاب الحديث فلا أدري من هم) .
...
ولما قال النبي صلى الله عليه وسلم: (إن أولى الناس بي يوم القيامة أكثرهم علي صلاة) (٢) ، وذكر أهل العلم أن أسعد الناس بهذا الحديث هم المحدثون!
قال ابن حبان (ت ٣٥٤هـ) بعد إخراجه هذا الحديث في صحيحه: (في هذا الخبر دليل على أن أولى الناس برسوله صلى الله عليه وسلم في القيامة أصحاب الحديث، إذ ليس من هذه الأمة قوم أكثر صلاة عليه صلى الله عليه وسلم منهم) (٣) .
وقال أبو نعيم الأصبهاني (ت ٤٣٠هـ) : (وهذه منقبة شريفة يختص بها رواة الآثار ونقلتها، لأنه لا يعرف لعصابة من العلماء من الصلاة على رسول الله صلى الله عليه وسلم أكثر مما يعرف لهذه العصابة نسخاً وذكراً) (٤) .
ومن تردد في هذا الذي ذكراه (عليهما رحمة الله) ، فليوازن بين صفحة أو صفحات من صحيح البخاري مثلاً وصفحة أو صفحات من أي كتاب في أحد العلوم الفاضلة (مما سوى الحديث) ، كالتفسير والفقه وأصوله والعقيدة، لتظهر مصداقية قول
_________
...
(٤) شرف أصحاب الحديث للخطيب (٣٥) .',NULL,'11',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (13,'ذينك الإمامين (عليهما رحمة الله) ، ليعرف حقاً أن أهل الحديث هم أولى الناس بالنبي صلى الله عليه وسلم يوم القيامة!!
...
_________
(١) شرف أصحاب الحديث للخطيب (رقم ١٦٣) .',NULL,'12',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (14,'(فإنه من يعش منكم بعدي فسيرى اختلافاً كثيراً، فعليكم بسنتي وسنة الخلفاء الراشدين المهدبين، تمسكوا بها، وعضوا عليها بالنواجذ، وإياكم ومحدثات الأمور، فإن كل محدثة بدعة، وكل بدعة ضلالة) (١) .
ويقول أحد أتباع التابعين، وهو يحيى بن يمان (ت ١٨٩هـ) : (ما كان طلب الحديث خيراً منه اليوم. قيل له: يا أبا عبد الله، إنهم يطلبونه وليس لهم نية؟ قال: طلبهم إياه نية) (٢) .
...
(٣) انظر الجامع الخطيب (رقم ٧٨٠-٧٨٢) ، والمدخل إلى السنن للبيهقي (رقم٥٢٠ - ٥٢٢) ، والموقظة للذهبي (٦٥) .',NULL,'13',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (15,'<span data-type="title" id=toc-4>أهم مميزات علم الحديث
وأوضح خصائصه</span>
...
_________
(١) انظر: تأويل مختلف الحديث لابن قتيبة (٦٤) ، والمحدث الفاصل للرامهرمزي (١٧٩ رقم ٣١ - ٣٢) ، والمجروحين لابن حبان (١/٦٢) ، والكامل لابن عدي (١/٥٨ -٥٩) ، والمدخل إلى الإكليل للحاكم (٢٧) ، وحلية الأولياء لأبي نعيم (٣/٣٦٥) ، وشرف أصحاب الحديث للخطيب (رقم١٥٠، ١٥١) ، ومسألة العلو والنزول لابن طاهر (رقم ٩) ، وترجمة الزهري من تاريخ دمشق - الترجمة المطبوعة المفردة - (١٥٠)',NULL,'14',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (16,'وحزمه وإصراره وقوته، ولا ينفع معه العقل الضعيف المتردد المتحير الملول؛ وهذا غير الذكاء وسرعة الفهم، فربما كان العقل ذكياً لكنه ليس ذكراً!!
...
ولهذا العمق في علم الحديث نهى نقاد الحديث عن شرح كثر من علل الروايات إلا عند أهل الحديث، لما يخشى من شرح ذلك على غير أهل الحديث أن يكون سبباً في أن يفتتنوا أو يفتنوا!! من باب: (حدثوا الناس بما يعقلون، أتريدون أن يكذب الله ورسوله) (٣) ، وباب: (إنك لست محدثاً قوماً بحديث لا تبلغه عقولهم، إلا كان لبعضهم فتنة) (٤) !!
...
(٣) أثر صحيح عن علي بن أبي طالب - رضي الله عنه -: أخرجه البخاري (رقم ١٢٧) ، والبيهقي في المدخل إلى السنن (رقم ٦١٠) ، والخطيب في الجامع (رقم ١٣٥٥) .
(٤) أثر صحيح عن عبد الله بن مسعود - رضي الله عنه -: أخرجه مسلم في مقدمة صحيحة (١/١١) ، والبيهقي في المدخل إلى السنن (رقم ٦١١) وابن عبد البر في جامع بيان العلم (رقم ٨٨٨) ، والخطيب في الجامع (رقم ١٣٥٨) .
(٥) رسالة أبي داود إلى أهل مكة (٣١-٣٢)',NULL,'15',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (17,'يعرفه الناقد عند المعاينة، فيعرف البهرج الزائف والخالص والمغشوش. وكذلك تمييز الحديث، فإنه علم يخلقه الله تعالى في القلوب، بعد طول الممارسة له، والاعتناء به) (١) .
وقلبهما يقول عبد الرحمن بن مهدي (ت ١٩٨هـ) : (معرفة الحديث إلهام) (٢) ، ويقول أيضاً: (إنكارنا الحديث عند الجهال كهانة) (٣) . ولما أنكر ابن مهدي حديثاً رواه رجل، غضب للرجل جماعة، وقالوا لابن مهدي: (من أين قلت هذا في صاحبنا؟!) فلم يبين لهم العلة الحديثية التي جعلته ينكر على ذلك الرجل، وإنما قال لهم: (أرأيت لو أن رجلاً أتى بدينار إلى صيرفي، فقال: انتقد لي هذا، فقال الصيرفي: هو بهرج، يقول له: من أين قلت لي إنه بهرج؟ (فأجاب ابن مهدي على لسان الصيرفي) : الزم عملي هذا عشرين سنة حتى تعلم منه ما أعلم) (٤) .
ويؤكد أيضاً أحمد بن صالح المصري (ت ٢٤٨هـ) أن علم الحديث لا يفهمه إلا أهله، عندما قال: (معرفة الحديث بمنزلة معرفة الذهب، إنما يبصره أهله) (٥) .
...
(٥) الجامع للخطيب (رقم ١٨٣٩)',NULL,'16',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (18,'اصبر على مضض الإدلاج بالسحر ... وبالرواح على الحاجات والبكر
...
إنها شهوة الحديث: التي حفظ الله تعالى بها الدين، وحمى بها السنة!!',NULL,'17',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (19,'يقول سفيان الثوري (ت ١٦١هـ) : (فتنة الحديث أشد من فتنة الذهب والفضة) (١) .
فأنعم بهذه الفتنة التي يحتقر معها الدينار والدرهم!!!
ولصعوبة علم الحديث قل أهله العارفون به كما سبق!
يقول الإمام البخاري (ت ٢٥٦هـ) : (أفضل المسلمين رجل أحيى سنة من سنن رسول الله صلى الله عليه وسلم قد أميتت؛ فاصبروا يا أصحاب السنن (رحمكم الله) ، فإنكم أقل الناس) .
...
وقد كنا نعدهم قليلاً ... فقد صاروا أقل من القليل (١)
وأقول: رحم الله الخطيب! فقد قامت المناحة على أهل الحديث من قرون!!! وما عادوا قليلاً ولا أقل من القليل، بل هم عدم من دهور، تكاد - والله - آثارهم تنمحي، وأخبارهم تنسى: (والله غالب على أمره ولكن أكثر الناس لا يعلمون) [يوسف: ٢١] .
...
(٢) الجامع للخطيب (١/١٦٨ رقم ٩١) .',NULL,'18',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (20,'الحديث وشدة مأخذه، لا يواجهها إلا التخصص، ولا يجاوزنا عقبتها إلا جمع الهمة كلها في تحصيله والتفرغ الكامل له.
...
وقد نبه العلماء قديماً على أهمية التخصص في العلوم، فقال الخليل ابن أحمد الفراهيدي (ت ١٧٠هـ) : (إذا أردت أن تكون عالماً فاقصد لفن من العلم، وإذا أردت أن تكون أديباً فخذ من كل شيء أحسنه) (١) .
وقال أبو عبيد القاسم بن سلام (ت ٢٢٤هـ) : (ما ناظرني رجل قط وكان مفنناً في العلوم إلا غلبته، ولا ناظرني رجل ذو فن واحد إلا غلبني في علمه ذلك) (٢) .
...
(٢) جامع بيان العلم لابن عبد البر (رقم ٨٥٢) .',NULL,'19',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (21,'أكثر!!! أولئك كانت حياتهم كرامة، ووجهدهم معجزة خارقة للعادات!!! فأين نحن من أن نحوي علومهم؟! وأنى لنا أن نستوعب علم ما خلفوه لنا؟! ومع ذلك فقد تكلم هؤلاء أنفسهم عن فضل التخصص في العلم، فما أجهلنا إن حسبنا أننا بغير التخصص سنفهم علماً من العلوم!!!
...
يقول الحسن بن محمد بن الصباح الزعفراني تلميذ الشافعي (ت ٢٦٠هـ) : (سمعت الشافعي يقول: من تعلم علماً فليدقق، لكيلا يضيع دقيق العلم) (١) .
...
_________
(١) الأنساب المتفقة لابن طاهر المقدسي (٣) .',NULL,'21',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (23,'وما أجمل وصية خالد بن يحيى بن برمك (ت ١٦٥هـ) لابنه، عندما قال له: (يا بني، خذ من كل علم بحظ، فإنك إن لم تفعل جهلت، وإن جهلت شيئاً من العلم عاديته، وعزيز علي أن تعادي شيئاً من العلم) (١) .
...
_________
(١) جامع بيان العلم لابن عبد البر (رقم ٨٥٣) .',NULL,'22',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (24,'من مراجعة مطولات تلك الفنون، فيما إذ أحوجه علمه الذي تخصص فيه إلى ذلك، كما سبق التمثيل له. وعليه أيضاً أن لا يقطع صلته بعلماء تلك العلوم المتخصصين فيها، وأن يصوب فهمه من علومهم عليهم، وأن لا يستبد بشيء من علمهم دون الرجوع إليهم.
...
وقد تعقب الرامهرمزي (ت ٣٦٠هـ) هذا الحديث في كتابه (المحدث الفاصل بين الراوي والواعي) بقوله: (ففرق النبي صلى الله عليه وسلم بين ناقل السنة وواعيها، ودل على فضل الواعي بقوله: (فرب حامل فقه إلى من هو أفقه منه، ورب حامل فقه غير فقه) . وبوجوب الفضل لأحدهما يثبت الفضل للآخر (٢) ؛ ومثال ذلك أن تمثل بين مالك
_________
(١) حديث صحيح مشهور، أخرجه أصحاب السنن، وصححه ابن حبان والحاكم وغيرهما. وروي من حديث نحو ثلاثين صحابياً. ولأبي عمرو أحمد بن محمد بن إبراهيم بن حكيم المديني (ت٣٣٣هـ) جزء حديثي عنون به. وللشيخ عبد المحسن العباد (دراسة حديث (نضر الله أمرأ سمع مقالتي) رواية ودراية) .
(٢) ما أحسن قوله: (وبوجوب الفضل لأحدهما يثبت الفضل للآخر) ! فإنك إن ذكرت فضل الفقيه، قلنا لك: وهل تفقه الفقيه إلا بما رواه له المحدث وميز له صحيحه من سقيمه؟! وإن ذكرت فضل المحدث، قلنا لك: وهل يكون للرواية فائدة إلا بفقهها للعمل بما فيها؟!',NULL,'23',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (25,'بن أنس وعبيد الله العمري، وبين الشافعي وعبد الرحمن بن مهدي، وبين أبي ثور وابن أبي شيبة (١) ، فإن الحق يقودك إلى أن تقضي لكل واحد منهم بالفضل.
...
(٦) الجامع للخطيب (رقم ١٥٦٩) .',NULL,'24',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (26,'يقول أبو يوسف القاضي (ت١٨٢هـ) : "العلم شيء لا يعطيك بعضه حتى تعطيه كلك وأنت إذا أعطيته كلك من إعطائه البعض على غرر" (١) .
ويقول أبو أحمد نصر بن أحمد العياضي الفقيه السمرقندي: "لا ينال هذا العلم إلا من عطل دكانه، وخرب بستانه، وهجر إخوانه، ومات أقرب أهله إليه فلم يشهد جنازته" (٢) .فإن كانت هاتان العبارتان حقاً في العلوم جميعها، فهي في علم الحديث أولى أن تقال وأحق. وهذا هو ما قصده الخطيب، عندما ساقها في ذلك السياق.
...
_________
(١) التكاثر (١) .
(٢) جامع بيان العلم لابن عبد البر (رقم ١٩٨٨) .',NULL,'26',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (28,'فهذا يحيى بن معين الذي رآه حمزة الكناني يذم فعله في ذلك، يقول يحيى بن معين هذا: "لو لم نكتب الحديث من ثلاثين وجها ما عقلناه" (١) .
ويقول الإمام أحمد: "الحديث إذا لم تجمع طرقه لم تفهمه، والحديث يفسر بعضه بعضاً" (٢) .
...
وقال الخطيب أيضاً: "ولو لم يكن في الاقتصار على سماع الحديث وتخليده الصحف، دون التمييز بمعرفة صحيحة من فاسده، والوقوف على اختلاف وجوهه، والتصرف في أنواع علومه، إلا تلقيب المعتزلة القدرية من سلك تلك الطريقة بالحشوية؛ لوجب على الطالب الأنفة لنفسه، ودفع ذلك عنه وعن أبناء جنسه" (٥) .
_________
...
_________
(١) شرف أصحاب الحديث للخطيب (رقم ٣٠٤) .',NULL,'28',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (30,'ولا تعلم الفقه؛ ولذلك عاب عليهم الخطيب انشغالهم عن الفقه بما هم فيه، فالفقه أجل وأشرف بكثير مما هم فيه.
...
(٣) معرفة علوم الحديث للحاكم (٢٥٠ - ٢٥٤) .',NULL,'29',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (31,'وخلاصة ما سبق، فيما يلام عليه طالب الحديث وما لا يلام عليه من التدقيق في العلم، هو أنه يلام في قضاء العمر: في جمع الأباطيل والمناكير، وعدم تمييزها عن الصحاح المشاهير؛ وفي تتبع أسانيد حديث صحيح بأحد تلك الطرق، ولا فائدة في تتبع الأسانيد الأخرى، إلا انقضاء الحياة دون معرفة قدر كبير من صحيح السنة وتعلم علوم الحديث.
...
لكنها تستلزم اتباع أسلوب معين في التخصص، واستخدام طريقة خاصة في التعلم.',NULL,'30',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (32,'فإن تشعب أطراف العلم وكثرتها، مع قوة ترابط ما بينها، وتداخلها بأصول العلم وقواعده؛ لا يواجه ذلك ويتجاوز هذه العقبة إلا الاستحضار الواسع في الذهن لتلك الأطراف والأصول الكثيرة المتشعبة، وهذا مالا يكون إلا بالحفظ والفهم.
...
ولذلك تميز المحدثون بالحفظ دون علماء الفنون الأخرى جميعاً؛ ويقول الخطيب في التدليل لذلك: (الوصف بالحفظ على الإطلاق ينصرف إلى أهل الحديث خاصة، وهو سمة لهم لا تتعداهم، ولا يوصف به أحد سواهم؛ لأن الراوي يقول: حدثنا فلان الحافظ، فيحسن منه إطلاق ذلك، إذ كان مستعملاً عندهم يوصف به علماء أهل النقل ونقاده. ولا يقول القارئ: لقنني فلان الحافظ، ولا يقول الفقيه: درسني فلان الحافظ، ولا يقول النحوي: علمني فلان الحافظ. فهي أعلى صفات المحدثين، وأسمى درجات الناقلين" (١) .
وحث المحدثون على الحفظ، حتى قال عبد الرزاق الصنعاني (ت ٢١١هـ) : "كل علم لا يدخل مع صاحبه الحمام (يعني يكون محفوظاً في الصدر) ، فلا تعده علماً" (٢) .
وأنشد قائلهم:
...
(٢) الجامع للخطيب (رقم ١٨١٨) .',NULL,'31',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (33,'وأورد الخطيب في هذا الباب أثر ابن عباس - رضي الله عنهما - أنه قال: (إنما يحفظ الرجل على قدر نيته) (١) .
وقال معمر بن راشد (ت ١٥٤هـ) : "كان يقال: إن الرجل ليطلب العلم لغير الله فيأبى عليه العلم، حتى يكون لله عز وجل" (٢) .
<span data-type="title" id=toc-9>الثاني: اجتناب ارتكاب المحرمات ومواقعة المحظورات:</span>
قال عبد الله بن مسعود - رضي الله عنه -: "إني لأحسب الرجل ينسى العلم، بالخطيئة يعلمها" (٣) .
...
(٦) انظر جامع بيان العلم لابن عبد البر (رقم ١٢٨٤، ١٢٨٦) ، والجامع للخطيب (رقم ١٨٥١، ١٨٥٢) .',NULL,'32',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (34,'وأهم من ذلك أن العمل بالعلم سبب لتوفيق الله تعالى إلى العلم والزيادة منه، وكما قال تعالى: (واتقوا الله ويعلمكم الله) (١) .
...
ومن جميل الوصايا في ذلك، ما ذكر من أن المنذر قال للنعمان ابنه "يا بني، أحب لك النظر في الأدب بالليل، فإن القلب بالنهار طائر، وبالليل ساكن، وكلما أوعيت فيه شيئاً علقه" (٢) .
...
وقال إسماعيل بن أبي أويس: "إذا هممت أن تحفظ شيئاً، فنم، ثم قم عند السحر، فأسرج، وانظر فيه، فإنك لا تنساه - بعد إن شاء الله") (٤) (.
...
(٦) انظر: المدخل إلى السنن للبيهقي (رقم ٦٤١) ، وجامع بيان العلم لابن عبد البر (رقم ٤٨١) .',NULL,'33',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (35,'ولذلك كان السلف يبكرون بأولادهم إلى مجالس الحديث، حتى قال عبد الله بن داود الخريبي (ت ٢١٣هـ) : "ينبغي للرجل أن يكره ولده على سماع الحديث" (١) .
...
وصفة المكان المناسب: أن يكون مريحاً، لا يشق على النفس المكث به. وأن يكون هادئاً، بعيداً عن الأصوات العالية. وأن يكون خالياً من الملهيات وما يلفت الأنظار؛ فلا يجلس في حديقة، ولا في ممر الناس وأسواقهم. بل يختار مقصورة أو حجرة في منزله، يتحفظ فيها (٣) .
<span data-type="title" id=toc-14>السابع: الجهر بقراءة ما يراد حفظه:</span>
ولذلك حكمة، بينها والد الزبير بن بكار القرشي (ت ٢٥٦هـ) عندما رأى ابنه يتحفظ سرا، فقال له: " إنما لك من روايتك هذه (أي: تحفظك سراً) ما أدى بصرك إلى قلبك. فإذا أردت الرواية (أي: الحفظ) ، فانظر إليها، واجهر بها؛ فإنه يكون لك ما أدى بصرك إلى قلبك، وما أدى سمعك إلى قلبك" (٤) .
...
(٥) تعليق للدكتور محمد عجاج الخطيب على المصدر السابق.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (36,'يحفظ إلا بعد التكرار الكثير. وكان أبو إسحاق الشيرازي (ت٤٧٦هـ) يعيد الدرس مائة مرة، وكان إلكيا الهراسي (٥٠٤هـ) يعيد سبعين مرة. وقال لنا الحسن بن أبي بكر النيسابوري الفقيه: لا يحصل الحفظ إلي حتى يعاد خمسين مرة. وحكى لنا الحسن أن فقيها أعاد الدرس في بيته مراراً كثيرة، فقالت له عجوز في بيته: قد - والله - حفظته أنا! فقال: أعيديه، فأعادته؛ فلما كان بعد أيام، قال: يا عجوز، أعيدي ذلك الدرس، فقالت: ما أحفظه، قال: إني أكرر عند الحفظ لئلا يصيبني ما أصابك" (١) .
...
وعلى طالب العلم أن يجعل له جدولاً معيناً لمراجعة محفوظة؛ فمثلاً: يجعل في نهاية كل أسبوع يوماً لمراجعة ما حفظة في ذلك الأسبوع، وفي نهاية كل شهر يوماً أو يومين لمراجعة محفوظه خلال الشهر كله، وفي نهاية السنة أسبوعاً أو أسبوعين لمراجعة محفوظه خلال السنة جميعها .... وهكذا.<span data-type="title" id=toc-17> العاشر: المذاكرة:</span>
...
(٤) انظر: معرفة علوم الحديث للحاكم (١٤٠-١٤٦) ، والجامع للخطيب (٢/٤٠٤-٤٢١) .',NULL,'35',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (37,'وللمذاكرة مع الأقران وغيرهم - على المعنى السابق - فائدة عظيمة في تثبيت الحفظ، من جهة أنه تعهد للمحفوظ بتكريره ومراجعته خلال المذاكرة، وتذكير لما نسي منه، ودون إملال أو إضجار، بل في جو من النشاط والتنافس العلمي البناء.
ولذلك قال عبد الله بن بريدة: " قال لي علي بن أب طالب - رضي الله عنه -: تزاوروا، وتذاكروا هذا الحديث، فإنكم أن لم تفعلوا يدرس علمكم" (٢) ، أي: يبلى ويخلق.
وقال أبو سعيد الخدري - رضي الله عنه - "تحدثوا، فإن الحديث يهيج الحديث" (٣) .
وقال جماعة من السلف عبارة أصبحت شعاراً للمذاكرة، وهي قولهم: "إحياء الحديث مذاكرته" (٤) .
...
(٤) الجامع للخطيب (رقم ١٩٠٠) .',NULL,'36',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (38,'شدة شهوتهم له. وتذاكر وكيع وعبد الرحمن ليلة في المسجد الحرام، فلم يزالا حتى أذن المؤذن أذان الصبح " (١) .
...
يقول عبد الله بن المبارك: "إن أول منفعة الحديث: أن يفيد بعضكم بعضاً" (٢) .
ويقول الإمام مالك: "بركة الحديث: إفادة بعضهم بعضاً" (٣) .
ويقول سفيان الثوري: "يا معشر الشباب، تعجلوا بركة هذا العلم، فإنكم لا تدرون، لعلكم لا تبلغون ما تؤملون منه، ليفد بعضكم بعضاً" (٣) .
...
(٤) الجامع للخطيب (رقم ١٤٩٢) .',NULL,'37',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (39,'ولكن مما ينبغي التنبيه عليه هنا، هو أن<span data-type="title" id=toc-18> للحفظ طريقتين</span>، لا يعجز عن إحداهما جميع الناس. ولكل طريقة منهما مميزاتها وعيوبها؛ فيحسن أن نذكرهما، بما لهما من محاسن وعيوب.<span data-type="title" id=toc-19> الطريقة الأولى </span>(وهي أشهر الطريقتين) :
وهي أنفع للصغار والشباب ومن أوتي موهبة الحفظ: وهي بأن يقرر الطالب على نفسه لكل يوم جزءاً يسيراً من العلم، كأن يكون حديثاً أو حديثين أو أكثر، ويستحسن أن يكون قدراً يسيراً، فإن القليل يثبت والكثير لا يحصل (٢) ؛ فيتحفظ هذا المقرر يومياً، حتى يغيبه في صدره؛ ويستمر على ذلك فترة طويلة، هي سنوات طلبه للعلم؛ مع تعهد المحفوظ دائماً، على المنهج الذي ذكرناه سابقاً في التعهد.
...
_________
(٢) انظر: الحث على حفظ العلم لابن الجوزي (٥٠) .',NULL,'38',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (40,'ولذلك لما قيل للإمام البخاري: ما البلاذر؟ وهو دواء كانوا يظنون قديماً أنه يقوي الذاكرة وينشط الذهن على الحفظ، فأجاب الإمام البخاري، صارفاً لهم إلى البلاذر حقاً، حيث قال: "هو إدامة النظر في الكتب" (١) .
...
"تعلموا العلم، فإنكم صغار قوم، يوشك أن تكونوا كبارهم غداً، فمن لم يحفظ منكم فليكتب" (٤) .
وقال الخليل بن أحمد الفراهيدي: " ما سمعت شيئاً إلا كتبته، ولا كتبته إلا حفظته، ولا حفظته إلا نفعني " (٥) .
...
(٥) جامع بيان العلم لابن عبد البر (رقم ٤٤٧) .',NULL,'39',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (41,'ومن عيوبها: أن صاحبها لا يستطيع الجزم بأنه يحفظ كتاباً ما، خاصة المطولات. وأيضاً لا يستطيع في كثير من الأحيان أن يؤدي ما حفظ باللفظ، وإنما يؤديه بالمعنى؛ وللرواية بالمعنى شروط، وتحوم حولها أخطار.
...
وليس عدم شمول قواعد علم الحديث لجميع جزئياته، ولا عدم وجود قواعد أصلاً لبعض مسائله، بسبب تقصير في تقنين هذا العلم وفي تأصيله من علماء الأمة؛ بل سببه هو بلوغهم به أقصى غايات التقعيد السليم والتأصيل الصحيح!! وذلك أن علم الحديث مادته الخام هي البشر ونقولهم وأخبارهم، وللبشر باختلاف مواهبهم الخلقية، وبتباين دوافعهم وعقائدهم وسلوكياتهم، وباضطراب أحوالهم من وقت لآخر، وبما يطرأ عليهم من عوامل تغيير نفسية وخارجية؛ بذلك كله لا يمكن أن يكون لنقول هؤلاء وأخبارهم ضوابط حسابية وموازين رياضية، بل لابد من التعامل مع تلك المادة المتباينة الأجزاء، الكثيرة التغيرات في كل جزء منها، بما يتناسب وذلك؛ وهذا هو ما فعله أئمة الحديث في عصور تكوين علمهم .... رضي الله عنهم وأرضاهم!!',NULL,'40',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (42,'المهم أن تعلم أن هذه إحدى أعظم مميزات علم الحديث.
...
يقول الخطيب البغدادي، منبها على أهمية الممارسة العملية في علم الحديث: "قل ما يتمهر في علم الحديث، ويقف على غوامضه، ويستنير الخفي من فوائده، إلا من جمع بين متفرقه، وألف متشتته، وضم بعضه إلى بعض، وانشغل بتصنيف أبوابه، وترتيب أصنافه. فإن ذلك الفعل مما يقوي النفس، ويثبت الحفظ، ويذكي القلب، ويشحذ الطبع، ويبسط اللسان، ويجيد البيان، ويكشف المشتبه، ويوضح الملتبس، ويكسب أيضاً جميل',NULL,'41',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (43,'الذكر، وتخليده إلى آخر الدهر ". ثم أسند الخطيب إلى عبد الله بن المبارك، أنه قال: "صنفت من ألف جزء جزءاً، ومن نظر في الدفاتر فلم يفلح، فلا أفلح هو أبداً" (١) .
...
(٢) جامع بيان العلم وفضله لابن عبد البر (رقم ٥٠٥، ٥٠٦) .',NULL,'42',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (44,'وابتدأ ابن عساكر تصنيف (تاريخ دمشق) بمجلداته الثمانين من صباه، واستمر في جمعه إلى أن شاخ.
...
ولذلك فعلى طالب العلم أن يتحلى بالبذل والسخاء في اقتناء الكتب، وأن يقدم شراء الكتاب على طعامه وملبسه وملذاته، وأن يحرص كل الحرص على أن لا يفوت كتاباً صغر أو كبر في علم الحديث، في أي فن من فنونه.',NULL,'43',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (45,'ومن نصائح ذي النون المصري (ت ٢٤٥هـ) في ذلك: "ثلاثة من أعلام الخير في المتعلم: تعظيم العلماء بحسن التواضع لهم، والعمى عن عيوب الناس بالنظر في عيب نفسه، وبذل المال في طلب العلم إيثاراً له على متاع الدنيا" (١) .
ولذلك قال غير واحد من أهل العلم، منهم شعبة بن الحجاج: "من طلب الحديث أفلس" (٢) ، وقال الفضل بن موسى السيناني: "طلب الحديث حرفة المفاليس" (٣) ، ولما سأل سفيان بن عيينة رجلاً عن حرفته فأجابه الرجل بأنها طلب الحديث، فقال سفيان: "بشر أهلك بالإفلاس" (٤) ، وقال شعبة: "إذا رأيت المحبرة في بيت إنسان فارحمه، وإن كان في كمك شيء فأطعمه" (٥) ، ولما أثنت امرأة على رجل بخير، وقالت في ثنائها: "لا يتخذ ضرة، ولا يشتري جارية"، أجابتها زوج ذلك الرجل بقولها: "والله لهذه الكتب أشد علي من ثلاث ضرائر" (٦) .
...
(٦) الجامع للخطيب (رقم ٦١) .',NULL,'44',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (46,'الأسواق، فمن لم يبادر بشرائها فاتته، وسيندم حين لا ينفع الندم، وسيندم إن كان فيه بقية من طالب علم.
...
ومن عجائب ذلك قصة الحافظ أبي العلاء الحسن بن احمد بن سهل الهمذاني العطار (ت ٥٦٩هـ) ، وكان قد جمع كتباً كثيرة، ورحل إلى البلدان من أجل ذلك، وعمل داراً للكتب وخزانة، ووقف جميع كتبه فيها لطلبة العلم!
...
_________
(١) وفي كتاب (صفحات من صبر العلماء) لعبد الفتاح أبو غدة أمثلة وافرة من ذلك.',NULL,'45',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (47,'فقال له المنادي: تبلغ أكثر من ذلك، فلم ينتظر خشية أن ينتهي أمد وفاء ثمن الكتب، فباع داره، ثم ركب إلى بغداد، فوفى الثمن، ولم يشعر أحد بحاله إلا بعد مدة!!!
...
فعلى طلبة الحديث أن يبدؤوا في تكوين مكتبة من بداية طلبهم، شيئاً فشيئاً؛ فإنهم إن استمروا في الطلب فسيجدون غب ما جمعوا خيراً وفائدة واستغناء وسعادة!',NULL,'46',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (48,'<span data-type="title" id=toc-23>منهج القراءة والتعلم لكتب الحديث والمصطلح</span>
...
(٣) معيد النعم ومبيد النقم للسبكي (٨٢-٨٣) .',NULL,'47',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (49,'فأول ما يلزم طالب الحديث: هو إدمان النظر في الصحيحين (صحيح البخاري وصحيح مسلم) ، بل ينبغي أن يضع الطالب لنفسه مقداراً معيناً من الصحيحين يقرؤه كل يوم، ليختم الصحيحين قراءة في كل سنة مرة في أقل تقدير، ويستمر على ذلك أربع سنوات مثلاً، خلال دراسته الجامعية أو الثانوية؛ فلا يتخرج إلا وقد قرأ الصحيحين عدة مرات، ليكون مستحضراً غالب متون الصحيحين.
...
فإذا وصل طالب الحديث إلى هذه المرحلة، فلابد أن رأسه قد أمتلأ بالمشاريع العلمية والبحوث الحديثية، التي تزيده تعمقاً في علم الحديث. فليبدأ (على بركة الله) مشوار العلم الطويل، منتفعاً ونافعاً مستفيداً مفيداً.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b9068] VALUES (52,'فإن بلغ طالب الحديث هذه الرتبة، وأسبغ الله عليه نعم توفيقه وتسديده، ومد عليه عمره في عافية، وطالت ممارسته لهذا العلم؛ فيا بشرى العالم الإسلامي، فقد ولد له محدث!!
...
وكتب
الشريف حاتم بن عارف بن ناصر العبدلي العوني',NULL,'51',NULL,NULL,'0');
