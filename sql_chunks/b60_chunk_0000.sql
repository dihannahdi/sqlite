...
CREATE TABLE "b60"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b60
INSERT INTO [b60] VALUES (1,'بسم الله الرحمن الرحيم
...
عضو هيئة التدريس بكلية الشريعة جامعة القصيم',NULL,'3',NULL,NULL,'0');
INSERT INTO [b60] VALUES (2,'<span data-type="title" id=toc-3>القسم الأول
آداب طالب العلم</span>',NULL,'4',NULL,NULL,'0');
INSERT INTO [b60] VALUES (3,'الأدب قبل الطلب:
...
(¬٤) أخرجه الرَّامَهُرْمُزِي في المحدث الفاصل ص (٥٥٩).',NULL,'5',NULL,NULL,'0');
INSERT INTO [b60] VALUES (4,'وكذلك كان ابن المبارك (¬١)، والليث بن سعد (¬٢) يقولان هذا الكلام لطلاب العلم.
...
(¬٣) أخرجه ابن المبارك في الزهد والرقائق (١/ ٢٦) رقم (٧٩)، والبيهقي في المدخل إلى السنن الكبرى ص (٣٢١) رقم (٥٠٢)، وابن عبد البر في جامع بيان العلم (١/ ٢٥٨) رقم (٣١٥)، وأبو نعيم في حلية الأولياء (٧/ ٦٢)، والخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (١/ ١٤٢) رقم (١٧٥).',NULL,'6',NULL,NULL,'0');
INSERT INTO [b60] VALUES (5,'<span data-type="title" id=toc-4>النوع الأول: أدب طالب العلم مع نفسه:</span>
...
(أولاً:<span data-type="title" id=toc-5> إخلاص النية لله عز وجل:</span>
...
قال الحسن البصري - رحمه الله -: «لَا يَزَالُ الْعَبْدُ بِخَيْر؛ ٍ إِذَا قَالَ قَالَ لله، وَإِذَا عَمِلَ يَعْمَلُ لله - عز وجل -» (¬١)؛ ولهذا ينبغي أن تكون مقاصد الطلب كما يلي:
...
_________
(¬١) أخرجه ابن المبارك في الزهد (٢/ ١٧)، و ابن أبي شيبة في مصنفه (٧/ ١٩٦).',NULL,'7',NULL,NULL,'0');
INSERT INTO [b60] VALUES (6,'وَالْقُرْبَ مِنْ الله تَعَالى يَوْمَ القِيَامَةِ، وَالتَّعَرُّضَ لِمَا أَعَدَّ اللهُ لأَهْلِهِ مِنْ رِضْوَانِهِ وَعَظِيمِ فَضْلِهِ» (¬١).
...
(¬٢) أخرجه ابن عبد البر في جامع بيان العلم (١/ ٦٥٥) رقم (١١٣٦).',NULL,'8',NULL,NULL,'0');
INSERT INTO [b60] VALUES (7,'وعن أبي يوسف - رحمه الله - قال: «يا قوم أريدوا بعلمكم الله؛ فإني لم أجلس مجلسًا قط أنوي فيه أن أتواضع، إلا لم أقم حتى أعْلُوهم، ولم أجلس مجلسًا قط أنوي فيه أن أعْلُوهم، إلا لم أقم حتى أفتضح» (¬١).
معالجة النية:
...
(¬٢) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (١/ ٣١٧) رقم (٦٩٢).',NULL,'9',NULL,NULL,'0');
INSERT INTO [b60] VALUES (8,'يا ابن أخي، حدثنا سفيان، عن حبيب بن أبي ثابت، قال: طلبنا هذا العلم، وما لنا فيه نية، ثم جاءت النية والعمل بعد» (¬١).
...
فعن أبي برزة الأسلمي، قال: قال رسول الله - صلى الله عليه وسلم -: «لَا تَزُولُ قَدَمَا عَبْدٍ يَوْمَ القِيَامَةِ حَتَّى يُسْأَلَ عَنْ عُمُرِهِ فِيمَ أَفْنَاهُ، وَعَنْ عِلْمِهِ فِيمَ فَعَلَ، وَعَنْ مَالِهِ مِنْ أَيْنَ اكْتَسَبَهُ وَفِيمَ أَنْفَقَهُ، وَعَنْ جِسْمِهِ فِيمَ أَبْلَاهُ» (¬٢).
قال علي بن أبي طالب - رضي الله عنه - قال: «هتف العلم بالعمل، فإن أجابه، وإلا ارتحل» (¬٣)، ومعنى: (هتف)؛ أي نادى وصاح (¬٤).
قال أبو قلابة - رحمه الله -: «إذا أحدث الله لك علمًا فأحدث لله عبادةً، ولا يكن همك أن تحدث به الناس» (¬٥).
_________
...
(¬٥) أخرجه أبو نعيم في حلية الأولياء (٢/ ٢٨٣)، والبيهقي في المدخل إلى السنن الكبرى ص (٣٢٩) رقم (٥٢٧)، والخطيب البغدادي في اقتضاء العلم العمل ص (٣٤، ٣٥) رقم (٣٨).',NULL,'11',NULL,NULL,'0');
INSERT INTO [b60] VALUES (10,'وإذا عَمِلَ المسلم بعلمه فاز برضا الله تعالى، ونال جنته:
...
(¬٢) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (١/ ١٤٤) رقم (١٨٤).',NULL,'13',NULL,NULL,'0');
INSERT INTO [b60] VALUES (12,'عن النبي - صلى الله عليه وسلم - قال: «يُؤْتَى بِالرَّجُلِ يَوْمَ الْقِيَامَةِ، فَيُلْقَى فِي النَّارِ، فَتَنْدَلِقُ (¬١) أَقْتَابُ بَطْنِهِ (¬٢)، فَيَدُورُ بِهَا كَمَا يَدُورُ الْحِمَارُ بِالرَّحَى، فَيَجْتَمِعُ إِلَيْهِ أَهْلُ النَّارِ، فَيَقُولُونَ: يَا فُلَانُ مَا لَكَ؟ أَلَمْ تَكُنْ تَأْمُرُ بِالْمَعْرُوفِ، وَتَنْهَى عَنِ الْمُنْكَرِ؟ فَيَقُولُ: بَلَى، قَدْ كُنْتُ آمُرُ بِالْمَعْرُوفِ وَلَا آتِيهِ، وَأَنْهَى عَنِ الْمُنْكَرِ وَآتِيهِ» (¬٣).
قال أبو الدرداء - رضي الله عنه -: «إنك لن تكون عالمًا حتى تكون متعلمًا، ولن تكون متعلمًا حتى تكون بما علمت عاملًا» (¬٤).
وقال ابن رسلان - رحمه الله -:
وَعَالِمٌ بِعِلْمِهِ لَمْ يَعْمَلَنْ ... مُعَذَّبٌ مِنْ قَبْلِ عُبَّادِ الصَّنَمْ
(ثالثًا:<span data-type="title" id=toc-7> خشية الله والخوف منه:</span>
...
(¬٥) موارد الظمآن لدروس الزمان (٤/ ٥١٦) بتصرف.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b60] VALUES (13,'«أي إنما يخشاه حق خشيته العلماء العارفون به؛ لأنه كلما كانت المعرفة للعظيم القدير العليم الموصوف بصفات الكمال المنعوت بالأسماء الحسنى، كلما كانت المعرفة به أتم والعلم به أكمل كانت الخشية له أعظم وأكثر» (¬١).
...
(رابعًا:<span data-type="title" id=toc-8> البعد عن المعاصي:</span>
...
(¬٤) أخرجه الرَّامَهُرْمُزِي في المحدث الفاصل ص (٥٥٨)، والخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (٢/ ١٧٤) رقم (١٥٢٦).',NULL,'15',NULL,NULL,'0');
INSERT INTO [b60] VALUES (14,'قال ابن الجوزي - رحمه الله -: «واعلم أن المعاصي تسد أبواب الرزق، وأن من ضيع أمر الله ضيعه الله» (¬١).
وليس شيء أنفع لطالب العلم في حفظ علمه، وقوة فهمه واستحضاره وإدراكه من خشية الله والابتعاد عن المعاصي.
قال وكيع - رحمه الله -: «استعينوا على الحفظ بترك المعصية» (¬٢).
وقال ابن حبان - رحمه الله -: «وإن من أجود ما يستعين المرء به على الحفظ الطبع الجيد مع الهمة، واجتناب المعاصي» (¬٣).
...
قال ابن مسعود - رضي الله عنه -: «إني لأحسب العبد ينسى العلم كان يعلمه بالخطيئة يعملها» (¬٥).
...
(¬٥) أخرجه الدارمي في مسنده (١/ ٣٧٩) رقم (٣٨٨)، وأبو داود في الزهد ص (١٦٨) رقم (١٦٩)، وابن عبد البر في جامع بيان العلم (١/ ٦٧٥) رقم (١١٩٥)، وزهير بن حرب في كتاب العلم ص (٣١) رقم (١٣٢)، والخطيب البغدادي في اقتضاء العلم العمل ص (٦١).',NULL,'16',NULL,NULL,'0');
INSERT INTO [b60] VALUES (15,'شَكَوتُ إِلى وَكيعٍ سوءَ حِفظي ... فَأَرشَدَني إِلى تَركِ المَعاصي
وَأَخبَرَني بِأَنَّ العِلمَ نورٌ ... وَنورُ الله لا يُهدى لِعاصي
(خامسًا:<span data-type="title" id=toc-9> العبادة والذكر:</span>
...
_________
(¬١) الوابل الصيب ص (١٣٩ - ١٤٠).',NULL,'17',NULL,NULL,'0');
INSERT INTO [b60] VALUES (16,'فوضعه، فلما أصبح نظر إلى الماء فإذا هو كما كان، فقال: سبحان الله! رجل يطلب العلم لا يكون له وِرْدٌ مِن الليل؟!» (¬١).
...
(سادسًا:<span data-type="title" id=toc-10> الإقبال على الله بكثرة الدُّعاء:</span>
...
(¬٢) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (١/ ١٤٣) رقم (١٧٧).',NULL,'18',NULL,NULL,'0');
INSERT INTO [b60] VALUES (17,'ويَحْسنُ بالداعي أن يدعو بدعاء الراسخين في العلم؛ لأنه سبحانه حينما أثنى عليهم ذكر دعوتهم: {رَبَّنَا لَا تُزِغْ قُلُوبَنَا بَعْدَ إِذْ هَدَيْتَنَا وَهَبْ لَنَا مِنْ لَدُنْكَ رَحْمَةً إِنَّكَ أَنْتَ الْوَهَّابُ} [آل عمران:٨]، فتوسلوا إلى الله بربوبيته أن يمنحهم استقامة القلوب وثباتها على مراضي الله، وحفظها من الزيغ، والنكوص عن الهداية (¬١).
(سابعًا:<span data-type="title" id=toc-11> استحضار مِنَّة الله وفضله:</span>
...
(¬٣) أخرجه مسلم (٤/ ٢٠٢٣) رقم (٢٦٢١) من حديث جندب - رضي الله عنه -.',NULL,'20',NULL,NULL,'0');
INSERT INTO [b60] VALUES (19,'(ثامنًا:<span data-type="title" id=toc-12> التحلي بخصال المروءة:</span>
...
(تاسعًا:<span data-type="title" id=toc-13> الوسطية وعدم الغلو:</span>
...
ثم جاء تحذيرنا عن هذا المرض العُضَال الذي وقع فيه اليهود والنصارى، عن ابن عباس - رضي الله عنه - قال: قال رسول الله - صلى الله عليه وسلم -: «إِيَّاكُمْ وَالْغُلُوَّ فِي الدِّينِ، فَإِنَّمَا أَهْلَكَ مَنْ كَانَ قَبْلَكُمُ الْغُلُوُّ فِي الدِّينِ» (¬٢).
_________
(¬١) حلية طالب العلم ص (١٤٩) بتصرف.
(¬٢) أخرجه النسائي (٥/ ٢٦٨) رقم (٣٠٥٧)، وابن ماجه (٢/ ١٠٠٨) رقم (٣٠٢٩)، وأحمد (٣/ ٣٥١) رقم (١٨٥١)، وابن خزيمة (٤/ ٢٧٤) رقم (٢٨٦٧)، والحاكم في المستدرك (١/ ٦٣٧) رقم (١٧١١)، وقال: «صحيح على شرط الشيخين».',NULL,'21',NULL,NULL,'0');
INSERT INTO [b60] VALUES (20,'ذلك لأن الغلو مُهلكٌ ويؤدي بالإنسان إلى الضلال والانحراف عن جادة الحق، فعن عبد الله بن مسعود - رضي الله عنه - قال: قال رسول الله - صلى الله عليه وسلم -: «هَلَكَ الْمُتَنَطِّعُونَ، قَالَهَا ثَلَاثًا» (¬١).
...
(¬٣) أخرجه مسلم (٤/ ٢٠٠٤) رقم (٢٥٩٤).',NULL,'22',NULL,NULL,'0');
INSERT INTO [b60] VALUES (21,'(عاشرًا:<span data-type="title" id=toc-14> رحابة الصدر في مسائل الخلاف:</span>
...
٣ - ألا يتصدر الفتوى ولا يتجرأ عليها:
وقد كان السلف من أورع الناس في الفتوى، وقد ضربوا لذلك أجمل النماذج، حتى صنف ابن الجوزي كتابًا أسماه (تعظيم الفتيا) ذكر فيه صورًا رائعة عن السلف في حذرهم من التصدر للفتوى.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b60] VALUES (22,'وفي زماننا ربما تجشم الصغير الإفتاء في مسألة شائكة لو عُرِضَت على أكابر السلف لتورعوا عن الإجابة عنها.
...
(¬٤) كتاب العلم ص (٢٣، ٢٤).',NULL,'24',NULL,NULL,'0');
INSERT INTO [b60] VALUES (23,'٥ - ألا يرتب على الخلاف تكفير أو تبديع أو تضليل:
...
(¬٣) تبيين كذب المفتري لابن عساكر ص (٢٩).',NULL,'25',NULL,NULL,'0');
INSERT INTO [b60] VALUES (24,'<span data-type="title" id=toc-15>النوع الثاني: أدب طالب العلم مع شيخه:</span>
...
(¬٤) تعليم المتعلم طريق التعلم ص (٢٦).',NULL,'26',NULL,NULL,'0');
INSERT INTO [b60] VALUES (25,'ومن روائع الأدب مع المعلم ما يلي:
أولًا:<span data-type="title" id=toc-16> الأدب في مخاطبته:</span>
...
_________
(¬١) ينظر: حلية طالب العلم ص (١٦٢)، وموسوعة الأخلاق للخراز ص (٣٢٧).
(¬٢) بحر العلوم (٢/ ٥٢٧).',NULL,'27',NULL,NULL,'0');
INSERT INTO [b60] VALUES (26,'ثانيًا:<span data-type="title" id=toc-17> الأدب في السؤال:</span>
...
(¬٥) المجموع شرح المهذب (١/ ٣٧).',NULL,'28',NULL,NULL,'0');
INSERT INTO [b60] VALUES (27,'٣ - عدم الإلحاح في السؤال:
...
(¬٦) المجموع شرح المهذب (١/ ٣٧).',NULL,'29',NULL,NULL,'0');
INSERT INTO [b60] VALUES (28,'كما ينبغي له إذا قال له الشيح: أفهمت؟ ألا يقول: نعم، حتى يتضح له المقصود إيضاحًا جليًا؛ لئلا يكذب ويفوته الفهم: ولا يستحي من قوله: لم أفهم؛ لأن استثباته يحصل له مصالح عاجلة وآجلة: فمن العاجلة؛ حفظه المسألة، وسلامته من الكذب بإظهاره فهم ما لم يكن فهمه (¬١).
ثالثًا:<span data-type="title" id=toc-18> احترام الشيخ:</span>
...
(¬٢) الأخلاق والسير في مداواة النفوس ص (٩٢).',NULL,'30',NULL,NULL,'0');
INSERT INTO [b60] VALUES (29,'قال الشعبي - رحمه الله -: «كان أبو سلمة (¬١) يماري ابن عباس؛ فحرم بذلك علمًا كثيرًا» (¬٢)، وحرم الاستفادة منه، وقد اعترف أبو سلمة بذلك وتَحَسَّرَ على سلوكه وندم على ما كان منه، وقال في آخر حياته: «لو رفقتُ بابن عباس؛ لأصبتُ منه علمًا كثيرًا» (¬٣).
...
(¬٥) هو عبد الله بن عمرو اليشكري، المعروف بـ (ابن الكواء)، من رؤوس الخوارج، مشهور بصحبته لعلي وبكثرة أسئلته له. وقد شهد معه صفين، وذُكِر أنه رجع عن مذهب الخوارج فيما بعد. قال ابن عساكر في تاريخ دمشق (١/ ٣٦٠): (لا يعتمد على ما يرويه). ينظر ترجمته في لسان الميزان (٣/ ٣٢٩).',NULL,'31',NULL,NULL,'0');
INSERT INTO [b60] VALUES (30,'[الذاريات:٢] قال: ثكلتك أمك سل تفقهًا، ولا تسل تعنتًا، سل عما يعنيك، ودع ما لا يعنيك» (¬١).
...
(¬٤) الجامع لأخلاق الراوي وآداب السامع (١/ ٢٢٢).',NULL,'32',NULL,NULL,'0');
INSERT INTO [b60] VALUES (31,'اصْبِرْ عَلى مُرِّ الْجَفَا مِنْ مُعَلِّمٍ ... فَإِنَّ رُسُوبَ الْعِلْمِ فِي نَفَرَاتِه
وَمَنْ لَمْ يَذُقْ مُرَّ التَّعَلُّمِ سَاعَةً ... تَجَرَّعَ ذُلَّ الْجَهْلِ طُولَ حَيَاتِه
...
رابعًا:<span data-type="title" id=toc-19> شكره على إحسانه إليه:</span>
قال تعالى: {وَلَا تَنْسَوُا الْفَضْلَ بَيْنَكُمْ} [البقرة:٢٣٧]، وقال النبي - صلى الله عليه وسلم -: «لَا يَشْكُرُ الله مَنْ لَا يَشْكُرُ النَّاسَ» (¬١).
...
قال شيخ الإسلام - رحمه الله -: «وإذا كان الرجل قد علمه أستاذ عرف قدر إحسانه إليه وشكره» (¬٢).
وقال أيضًا: «وعلى المتعلم أن يعرف حرمة أستاذه ويشكر إحسانه إليه؛ فإنه من لا يشكر الناس لا يشكر الله، ولا يجحد حقه ولا ينكر معروفه» (¬٣).
_________
(¬١) أخرجه أبو داود (٤/ ٢٥٥) رقم (٤٨١١)، والترمذي (٤/ ٣٣٩) رقم (١٩٥٤)، وقال: (حديث صحيح).
(¬٢) مجموع الفتاوى (٢٨/ ١٧).
(¬٣) مجموع الفتاوى (٢٨/ ١٣).',NULL,'33',NULL,NULL,'0');
INSERT INTO [b60] VALUES (32,'كما ينبغي للمتعلم أن يحمد الله إذ يسر له من يُعلمه من جهله، و يحييه من موته، و يوقظه من سِنَتِهِ، وينتهز الفرصة كل وقت في الأخذ عنه، ويكثر من الدعاء له حاضرًا أو غائبًا، فإن النبي - صلى الله عليه وسلم - قال: «مَنْ صَنَعَ إِلَيْكُمْ مَعْرُوفًا فَكَافِئُوهُ، فَإِنْ لَمْ تَجِدُوا مَا تُكَافِئُونَهُ، فَادْعُوا لَهُ حَتَّى تَرَوْا أَنَّكُمْ قَدْ كَافَأْتُمُوهُ» (¬١)، وأي معروف أعظم من معروف العلم، وكلُّ معروف ينقطع إلا معروف العلم والنصح والتربية.
فكل مسألة استفيدت عن الإنسان فما فوقها - حصل بها نفع لمتعلِّمها و غيره- فإنه معروف و حسنات تجري لصاحبها (¬٢).
ومن لطائف ما نُقِلَ عن السلف في هذا ما قاله يحيى بن سعيد القطان: «إني لأدعو الله - عز وجل - للشافعي في كل صلاة، أو في كل يوم»، يعني: لما فتح الله - عز وجل - عليه من العلم، ووفقه للسداد فيه (¬٣).
عن محمد بن إسحاق بن راهويه قال: «قال أبي رحمه الله: قَلَّ ليلة إلا وأنا أدعو لمن كتب عنا ولمن كتبنا عنه» (¬٤).
خامسًا: أن ينسب الفضل إليه:
وهذا أدب ينبغي لطالب العلم أن يتحلى به، وأن يحفظ معروف شيخه وفضله عليه، قال شعبة - رحمه الله -: «كل من كتبت عنه حديثًا فأنا له عبد» (¬٥).
_________
(¬١) أخرجه أبو داود في سننه (٢/ ١٢٨) رقم (١٦٧٢)، والنسائي في سننه (٥/ ٨٢) رقم (٢٥٦٧)، وإسناده صحيح.
(¬٢) الفتاوى السعدية (ص:١٠١، ١٠٢) بتصرف.
(¬٣) أخرجه ابن أبي حاتم في آداب الشافعي ومناقبه ص (٣١، ٣٢)، وفي الجرح والتعديل (٧/ ٢٠٢).
(¬٤) أخرجه البيهقي في المدخل إلى السنن الكبرى ص (٣٧٧) رقم (٦٤٨).
(¬٥) أخرجه ابن الجعد في مسنده ص (٢٠) رقم (١٢).',NULL,'34',NULL,NULL,'0');
INSERT INTO [b60] VALUES (33,'وقد نص العلماء على ذلك في كتبهم التي احتوت على مثل هذه الآداب:
...
(¬٢) أخرجه أبو نعيم في حلية الأولياء (٩/ ٩٨).',NULL,'35',NULL,NULL,'0');
INSERT INTO [b60] VALUES (34,'<span data-type="title" id=toc-20>النوع الثالث: أدب طالب العلم مع زملائه:</span>
هناك بعض الآداب ينبغي أن يراعيها طالب العلم مع زملائه وإخوانه، منها:
أولاً:<span data-type="title" id=toc-21> اجتناب الحسد:</span>
...
_________
(¬١) المجموع شرح المهذب (١/ ٢٨).
(¬٢) اقتضاء الصراط المستقيم (١/ ٨٣).',NULL,'36',NULL,NULL,'0');
INSERT INTO [b60] VALUES (35,'وقد كانت الشكاية من حسد بعض أهل العلم لبعضٍ قديمة، فقد حسد قوم من أهل العلم الشافعي، فقال أحمد مدافعًا عن الشافعي: «والله، ما رأينا منه إلا خيرًا، ولا سمعنا إلا خيرًا، ثم قال أحمد لمن حوله: اعلموا - رحمكم الله تعالى - أن الرجل من أهل العلم إذا منحه الله شيئًا من العلم وحُرِمَه قرناؤُه وأشكاله، حسدوه فرموه بما ليس فيه، وبئست الخصلة في أهل العلم» (¬١).
...
(¬٤) سير أعلام النبلاء (١١/ ٢٨).',NULL,'37',NULL,NULL,'0');
INSERT INTO [b60] VALUES (36,'ثانيًا:<span data-type="title" id=toc-22> لا يبخل بإفادتهم ومعاونتهم:</span>
...
ثالثًا:<span data-type="title" id=toc-23> مذاكرة العلم:</span>
...
(¬٣) رواه البخاري (١/ ١٢) رقم (١٣)، ومسلم (١/ ٦٧) رقم (٤٥).',NULL,'38',NULL,NULL,'0');
INSERT INTO [b60] VALUES (37,'ومواضع الخلل، وينتفع بما عند غيره.
...
_________
(¬١) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (٢/ ٢٧٣) رقم (١٨٣٤).
(¬٢) الجامع لأخلاق الراوي وآداب السامع (٢/ ٢٦٩).
(¬٣) الجامع لأخلاق الراوي وآداب السامع (٢/ ٢٧٣).
(¬٤) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (٢/ ٢٧٣) رقم (١٨٣١).
(¬٥) أخرجه البيهقي في المدخل إلى السنن الكبرى ص (٢٩٣) رقم (٤٣٤)، والخطيب البغدادي في الجامع لأخلاق الراوي (٢/ ٢٦٩) رقم (١٨٢٧)، وابن عبد البر في جامع بيان العلم (١/ ٤٢٨) رقم (٦٣٧).
(¬٦) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (٢/ ٢٧٣) رقم (١٨٣٣).',NULL,'39',NULL,NULL,'0');
INSERT INTO [b60] VALUES (38,'<span data-type="title" id=toc-24>النوع الرابع: أدب طالب العلم مع عامة الناس:</span>
هنالك جملة من الآداب التي ينبغي لطالب العلم أن يتمثلها في تعامله مع الناس، وهي:
أولاً:<span data-type="title" id=toc-25> تعليمهم وبذل النصح لهم:</span>
...
_________
(¬١) تيسير الكريم الرحمن ص (٣٥٥).',NULL,'40',NULL,NULL,'0');
INSERT INTO [b60] VALUES (39,'ثانيًا:<span data-type="title" id=toc-26> أن يُحدِّث الناس بما يعرفون:</span>
...
(¬٤) ينظر: فتح الباري لابن حجر (١/ ٢٢٥).',NULL,'42',NULL,NULL,'0');
INSERT INTO [b60] VALUES (41,'ثالثًا:<span data-type="title" id=toc-27> الرحمة بهم وإظهار الشفقة عليهم:</span>
...
(¬٤) شرح البخاري للسَّفِيرِي (٢/ ٥٠).',NULL,'43',NULL,NULL,'0');
INSERT INTO [b60] VALUES (42,'قال شيخ الإسلام - رحمه الله - واصفًا أهل السنة-: «هم أعلم الناس بالحق، وأرحمهم بالخلق» (¬١).
...
رابعًا:<span data-type="title" id=toc-28> إلقاء السلام ورده والابتسامة في وجوه الآخرين:</span>
...
_________
(¬١) أخرجه مسلم (٤/ ١٧٠٨) رقم (٢١٦٨).
(¬٢) أخرجه الترمذي (٤/ ٣٤٠) رقم (١٩٥٦) من حديث أبي ذر - رضي الله عنه -، وقال: حديث حسن غريب.
(¬٣) مكارم الأخلاق للطبراني ص (٣١٩).
(¬٤) أخرجه مسلم (١/ ٤٦٣) رقم (٦٧٠).',NULL,'45',NULL,NULL,'0');
INSERT INTO [b60] VALUES (44,'من تلقاه بالبشر، ويلقاك بالعبوس، كأنه يُمُنُّ عليك بعمله، فلا أكثر الله في القراء مثله» (¬١).
خامسًا:<span data-type="title" id=toc-29> الحلم والرفق:</span>
...
(¬٥) أخرجه ابن أبي الدنيا في كتاب الحلم ص (٢٦) رقم (١٠).',NULL,'46',NULL,NULL,'0');
INSERT INTO [b60] VALUES (45,'وعن عطاء بن أبي رباح قال: «{يَمْشُونَ عَلَى الْأَرْضِ هَوْنًا} [الفرقان:٦٣] قال: حلماء علماء» (¬١).
وقديمًا قيل: «وما أُضيف شيءٌ إلى شيءٍ مثل حلمٍ إلى علمٍ» (¬٢).
سادسًا:<span data-type="title" id=toc-30> ألا يضع نفسه في موقف يُذل فيه العلم وأهله:</span>
...
قال يحيى بن محمد الشهيد - رحمه الله -: «ما رأيتُ محدثًا أورع من يحيى بن يحيى، ولا أحسن لباسًا منه» (¬٣).
قال علي بن أبي طالب - رضي الله عنه -:
أَجِدِ (¬٤) الثِّيَابَ إِذَا اكْتَسَيْتَ فَإِنَّهَا ... زَيْنُ الرِّجَالِ بِهَا تُعَزُّ وَتُكْرَمُ
_________
(¬١) أخرجه ابن أبي الدنيا في كتاب الحلم ص (٢٦) رقم (١١).
(¬٢) أخرجه ابن المبارك في الزهد والرقائق (١/ ٤٧٠) رقم (١٣٣٦)، وابن أبي الدنيا في الحلم ص (٢٨) رقم (١٤)، والخطيب البغدادي في الجامع لأخلاق الراوي (١/ ٩٤) رقم (٤٢).
(¬٣) أخرجه الخطيب البغدادي في الجامع لأخلاق الراوي وآداب السامع (١/ ٣٨١) رقم (٨٨٠).
(¬٤) أَجَدِ: فعل أمر من الفعل (جَدَّ)، (يَجِدُّ) إذا صار جديدًا. والجديد: صفة، والمصدر: الْجِدَة، والجمع: أَجِدَّةٌ، وجُدُدٌ، وجُدَدٌ. ينظر: لسان العرب (٣/ ١١١)، والمصباح المنير (١/ ٩٢).',NULL,'47',NULL,NULL,'0');
INSERT INTO [b60] VALUES (46,'وَدَعِ التَّوَاضُعَ فِي الثِّيَابِ تَحَوُّبًا ... فَاللَّهُ يَعْلَمُ مَا تُجِنُّ وَتَكْتُمُ
...
(¬٢) المجموع شرح المهذب (١/ ٣٦).',NULL,'48',NULL,NULL,'0');
INSERT INTO [b60] VALUES (47,'آيات الله والجدال الباطل والغيبة والنميمة والسب والقذف والاستهزاء، والغناء المحرم وشرب الخمر وفرش الحرير، والصور ونحو ذلك، وإذا كانوا لا يشهدون الزور فمن باب أولى وأحرى أن لا يقولوه ويفعلوه» (¬١).
قال - عز وجل -: {وَقَدْ نَزَّلَ عَلَيْكُمْ فِي الْكِتَابِ أَنْ إِذَا سَمِعْتُمْ آيَاتِ اللَّهِ يُكْفَرُ بِهَا وَيُسْتَهْزَأُ بِهَا فَلَا تَقْعُدُوا مَعَهُمْ حَتَّى يَخُوضُوا فِي حَدِيثٍ غَيْرِهِ إِنَّكُمْ إِذًا مِثْلُهُمْ} [النساء:١٤٠].
وخلاصة القول: أن عليك يا طالب العلم ألَاّ «تطأ بساط من يغشون في ناديهم المنكر، ويهتكون أستار الأدب، متغابيًا عن ذلك، فإن فعلت ذلك، فإن جنايتك على العلم وأهله عظيمة» (¬٢).
ثامنًا:<span data-type="title" id=toc-31> البعد عن الهيشات والفتن:</span>
...
فعن عبد الله بن مسعود، قال: قال رسول الله - صلى الله عليه وسلم -: «إِيَّاكُمْ وَهَيْشَاتِ الْأَسْوَاقِ» (¬٣).
«وَهَيْشَاتِ الْأَسْوَاقِ»: يعني اختلاطها وما يكون فيها من الفتن وارتفاع الأصوات، وأراد ألا يكونوا من أهلها، فإنه يخفى فيها الصواب، ولا يتضح فيها الحق، ويتقدم فيها كل مستحق للتأخير، ويتأخر كل مستحق للتقديم» (¬٤).
_________
(¬١) تيسير الكريم الرحمن ص (٥٨٧).
(¬٢) حلية طالب العلم ص (١٥١).
(¬٣) أخرجه مسلم في صحيحه (١/ ٣٢٣) رقم (٤٣٢).
(¬٤) الإفصاح عن معاني الصحاح (٢/ ١٠٩).',NULL,'49',NULL,NULL,'0');
INSERT INTO [b60] VALUES (48,'وقد قال الشيخ بكر أبو زيد - رحمه الله - في كتاب الحلية: (الإعراض عن الهيشات)، ثم أوصى: بـ «التصون من اللغط والهيشات، فإن الغلط تحت اللغط، وهذا ينافي أدب الطلب» (¬١).
...
يا طالب العلم احذر نواقض هذه الآداب، فإنها مع الإثم تقيم على نفسك شاهدًا على أن في العقل علة، وتدل على الحرمان من التوفيق، وإياك والخيلاء، فإنه نفاق وكبرياء، وقد بلغت شدة التوقي منه عند السلف مبلغًا كبيرًا، وشأوًا بعيدًا (¬٢).
...
•••
_________
(¬١) حلية طالب العلم ص (١٥٢).
(¬٢) حلية طالب العلم ص (١٤٥) بتصرف.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b60] VALUES (49,'<span data-type="title" id=toc-32>منهجية طالب العلم في الطلب:</span>
بعد ذكر آداب طالب العلم، يجدر بنا بيان المنهج السليم الذي ينبغي لطالب العلم السير عليه، ويتمثل ذلك فيما يلي:
أولاً:<span data-type="title" id=toc-33> إتقان الأصول:</span>
...
قال الله تعالى: {وَقُرْآنًا فَرَقْنَاهُ لِتَقْرَأَهُ عَلَى النَّاسِ عَلَى مُكْثٍ وَنَزَّلْنَاهُ تَنْزِيلًا} [الإسراء:١٠٦]، فأمر الله سبحانه في هذه الآية بأخذ القرآن على مكثٍ وبتؤدة. وهكذا أخذ العلم والتحصيل فيه ينبغي أن يكون كذلك.
فأمامك أمور لابد من مراعاتها في كل فن تطلبه:
١ - حفظ مختصر فيه.
٢ - ضبطه على شيخ متقن.
٣ - اتقان شرحه.
٤ - مراجعة ما حفظته وأتقنت شرحه باستمرار؛ فإن تكرار العلم ضمان ثباته.
ثانيًا:<span data-type="title" id=toc-34> تلقي العلم عن الأشياخ:</span>
الأصل في الطلب أن يكون بطريق التلقين والتلقي عن المشايخ، والأخذ من أفواه الرجال لا من الصحف وبطون الكتب.',NULL,'51',NULL,NULL,'0');
INSERT INTO [b60] VALUES (50,'وقد قيل: (من دخل في العلم وحده؛ خرج وحده)؛ أي: من دخل في طلب العلم بلا شيخ؛ خرج منه بلا علم، وهذا الكلام وإن لم يكن دقيقًا لكن فيه صواب كثير.
ثالثًا:<span data-type="title" id=toc-35> حفظ العلم كتابة:</span>
...
رابعًا:<span data-type="title" id=toc-36> تعاهد المحفوظات:</span>
...
(¬٣) التمهيد (١٤/ ١٣٣).',NULL,'52',NULL,NULL,'0');
INSERT INTO [b60] VALUES (51,'خامسًا:<span data-type="title" id=toc-37> اللجوء إلى الله تعالى في الطلب والتحصيل:</span>
لا تحزن إذا لم يفتح لك في علم من العلوم.
ضاعف الرغبة، وافزع إلى الله في الدعاء واللجوء إليه والانكسار بين يديه.
كان شيخ الإسلام ابن تيمية - رحمه الله - كثيرًا ما يقول في دعائه إذا استعصى عليه تفسير آية من كتاب الله تعالى: اللهم يا معلم آدم وإبراهيم علمني، ويا مفهم سليمان فهمني فيجد الفتح في ذلك.
سادسًا:<span data-type="title" id=toc-38> لا تكن أبا شبر:</span>
وذلك بأن تدعي العلم لما لم تعلم، أو إتقان ما لم تتقن، فإن فعلت، فهو حجاب كثيف عن العلم.
احذر أن تكون (أبا شبر)، فقد قيل: العلم ثلاثة أشبار، من دخل في الشبر الأول تكبر، ومن دخل في الشبر الثاني تواضع، ومن دخل في الشبر الثالث علم أنه لا يعلم.
سابعًا:<span data-type="title" id=toc-39> المحافظة على ساعات عمرك:</span>
يا طالب العلم «الوقت الوقت للتحصيل ... فالحفاظ على الوقت بالجد والاجتهاد، وملازمة الطلب، ومثافنة الأشياخ، والاشتغال بالعلم قراءة وإقراء ومطالعة وتدبرًا وحفظًا وبحثًا، لا سيما في أوقات شرخ الشباب ومقتبل العمر، ومعدن العاقبة، فاغتنم هذه الفرصة الغالية؛ لتنال رتب العلم العالية، فإنها (وقت جمع القلب، واجتماع الفكر)؛ لقلة الشواغل والصوارف عن التزامات الحياة والترؤس، ولخفة الظهر والعيال» (¬١).
_________
(¬١) حلية طالب العلم ص (١٨٤).',NULL,'53',NULL,NULL,'0');
INSERT INTO [b60] VALUES (52,'ثامنًا:<span data-type="title" id=toc-40> الحرص على العلوم النافعة:</span>
احرص على ما ينفعك ويقربك إلى الله من العلوم؛ فالعلوم كثيرة والأوقات شحيحة، والموفق من انشغل بما يعمق صلته بالله، ويزيد من إيمانه وتعلقه بمولاه، ولهذا كان من دعوات نبينا - صلى الله عليه وسلم - أنه كان يسأل الله العلم النافع، كما ثبت ذلك من حديث أم سلمة-رضي الله عنها-: «أَنَّ النَّبِيَّ - صلى الله عليه وسلم - كَانَ يَقُولُ: إِذَا صَلَّى الصُّبْحَ حِينَ يُسَلِّمُ اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا مُتَقَبَّلًا» (¬١).
...
_________
(¬١) رواه ابن ماجه (١/ ٢٩٨) رقم (٩٢٥).',NULL,'54',NULL,NULL,'0');
INSERT INTO [b60] VALUES (53,'<span data-type="title" id=toc-41>القسم الثاني
نبذة عن علوم الشريعة</span>',NULL,'55',NULL,NULL,'0');
INSERT INTO [b60] VALUES (54,'العلوم الشرعية هي العلوم المستمدة من الشرع الإسلامي ومن مصدريه الأساسين: القرآن الكريم، والسنة الشريفة، وهي تطلق على التفسير وعلوم القرآن, والحديث النبوي وعلومه, وعلم العقيدة, والفقه وأصوله وقواعده.
...
(¬٢) أخرجه البخاري في صحيحه (١/ ٢٥) رقم (٧١)، ومسلم في صحيحه (٢/ ٧١٩) رقم (١٠٣٧).',NULL,'58',NULL,NULL,'0');
INSERT INTO [b60] VALUES (57,'أريد به خيرًا. وفي ذلك بيان ظاهر لفضل العلماء على سائر الناس، ولفضل التفقه في الدين على سائر العلوم» (¬١).
وإليك يا طالب العلم نبذة عن علوم الشريعة وأصنافها وأبرز مصطلحات كُلِّ فن:
_________
(¬١) فتح الباري (١/ ١٦٥).',NULL,'59',NULL,NULL,'0');
INSERT INTO [b60] VALUES (58,'<span data-type="title" id=toc-42>أولاً: علم التفسير:</span>
...
<span data-type="title" id=toc-43>تعريف التفسير:</span>
...
<span data-type="title" id=toc-44>أقسام التفسير:</span>
...
_________
(¬١) نقله عنه ابن عبد الهادي في العقود الدرية ص (٤٤)، وابن رجب في ذيل طبقات الحنابلة (٤/ ٥١٩).',NULL,'60',NULL,NULL,'0');
INSERT INTO [b60] VALUES (59,'الأول: التفسير بالمأثور (التفسير بالرواية): وهو الذي يعتمد على تفسير القرآن بالقرآن، أو بالسٌّنَّة؛ أو بما رُوِي عن الصحابة؛ أو بما قاله كبار التابعين، وهو أفضل أقسام التفسير، إذا خلى من الأحاديث الضعيفة، والإسرائليات.
...
الثالث: التفسير الإشاري (تفسير بالإشارة): وهو تأويل القرآن بغير ظاهره لإشارة خفية يعتقد الباطنية والصوفية ظهور هذه الإشارة لهم، وهذا القسم من التفسير مردود وباطل.',NULL,'61',NULL,NULL,'0');
INSERT INTO [b60] VALUES (60,'ومن كتب التفسير الإشاري:
١) تفسير القرآن العظيم، لسهل بن عبد الله التُستري، المتوفى سنة (٢٨٣ هـ).
٢) حقائق التفسير، لمحمد بن الحسين السلمي، المتوفى سنة (٤١٢ هـ).
٣) البحر المديد، لأحمد بن محمد ابن عجيبة، المتوفى سنة (١٢٢٤ هـ).
ومن العلوم التي يقوم عليها تفسير القرآن: ما يعرف بعلوم القرآن: ويقصد بها مجموعة العلوم التى تتعلق مباحثها بالقرآن الكريم خاصة سواء ما يتعلق بنزوله، أو ترتيبه، أوجمعه، أو كتابته أو رسمه، أو قراءته، أو إعرابه، أو تفسيره، أو إعجازه، أو ناسخه، أو منسوخه، أو مكّيه ومدنيه، أو دفع الشبه عنه، إلى آخره.
<span data-type="title" id=toc-45>ثمرة دراسة علم التفسير وفوائده:</span>
لدراسة علم التفسير ثمار وفوائد كثيرة منها:
١) سد حاجة الناس إلى فهم القرآن، والعيش معه وتحقيق السعادة به.
٢) فهم الخطاب الشرعي الإلهي، ومعرفة الأحكام والحلال والحرام.
٣) يعين العبد على تدبر كتاب الله، قال ابن جرير الطبري: «إني لأعجب ممن قرأ القرآن ولم يعلم تأويله كيف يتلذذ بقراءته» (¬١).
٤) الوقوف على نشأة علم التفسير وتطوره، وجهود الصحابة والتابعين والعلماء من بعدهم في خدمة تفسير القرآن الكريم، وما تميز به كل جهد، وكيفية الاستفادة منه في سعة الإدراك لمعاني القرآن الكريم، والوقوف على أسراره العظيمة.
_________
(¬١) ينظر: معجم الأدباء (٦/ ٢٤٥٣).',NULL,'62',NULL,NULL,'0');
INSERT INTO [b60] VALUES (61,'٥) معرفة المنهج السليم، والطرق الصحيحة لتفسير القرآن الكريم، بما يراعي قواعد وضوابط السابقين، ويواكب روح عصرنا ومتطلباته.
...
<span data-type="title" id=toc-46>مصطلحات علم التفسير:</span>
...
القرآن المدني: هو كل ما نزل بعد الهجرة النبوية، ولو كان نزوله بمكة.',NULL,'63',NULL,NULL,'0');
INSERT INTO [b60] VALUES (62,'سبب النزول: هو الواقعة أو السؤال الذي نزلت الآية أو السورة عقبه بيانًا له. فهو إما حادثة تقع فينزل القرآن بسببها، أو سؤال يوجه للنبي - صلى الله عليه وسلم - فينزل القرآن ببيان الحكم فيه.
...
_________
(¬١) أخرجه مسلم في صحيحه (٢/ ١٠٧٥) رقم (١٤٥٢).',NULL,'64',NULL,NULL,'0');
INSERT INTO [b60] VALUES (63,'مثال ذلك: نسخ عدة المتوفى عنها زوجها من سنة كاملة إلى أربعة أشهر وعشرة أيام، قال تعالى: {وَالَّذِينَ يُتَوَفَّوْنَ مِنْكُمْ وَيَذَرُونَ أَزْوَاجًا وَصِيَّةً لِأَزْوَاجِهِمْ مَتَاعًا إِلَى الْحَوْلِ غَيْرَ إِخْرَاجٍ} ... [البقرة:٢٤٠]، ثم نسخ ذلك بقوله: {وَالَّذِينَ يُتَوَفَّوْنَ مِنْكُمْ وَيَذَرُونَ أَزْوَاجًا يَتَرَبَّصْنَ بِأَنْفُسِهِنَّ أَرْبَعَةَ أَشْهُرٍ وَعَشْرًا} [البقرة:٢٣٤].
٣) آيات نسخت تلاوتها وبقي حكمها.
مثال ذلك: آية الرجم «الشَّيْخُ وَالشَّيْخَةُ إِذَا زَنَيَا فَارْجُمُوهُمَا أَلْبَتَّةَ» نسخت تلاوتها وبقي حكمها، قال عمر بن الخطاب - رضي الله عنه -: «إِنَّ الله بَعَثَ مُحَمَّدًا - صلى الله عليه وسلم - بِالحَقِّ، وَأَنْزَلَ عَلَيْهِ الْكِتَابَ، فَكَانَ فِيمَا أُنْزِلَ عَلَيْهِ آيَةُ الرَّجْمِ، فَقَرَأْنَاهَا وَوَعَيْنَاهَا، وَرَجَمَ رَسُولُ الله - صلى الله عليه وسلم - وَرَجَمْنَا مِنْ بَعْدِهِ، وَإِنِّي خَشِيتُ إِنْ طَالَ بِالنَّاسِ الزَّمَانُ أَنْ يَقُولَ قَائِلٌ: مَا نَجِدُ آيَةَ الرَّجْمِ فِي كِتَابِ الله، فَيَضِلُّوا بِتَرْكِ فَرِيضَةٍ أَنْزَلَهَا الله تَعَالَى، فَالرَّجْمُ حَقٌّ عَلَى مَنْ زَنَى مِنَ الرِّجَالِ وَالنِّسَاءِ إِذَا كَانَ مُحْصَنًا، إِذَا قَامَتِ الْبَيِّنَةُ، أَوْ كَانَ حَمْلٌ، أَوِ اعْتِرَافٌ، وَايْمُ اللَّهِ، لَوْلَا أَنْ يَقُولَ النَّاسُ: زَادَ عُمَرُ فِي كِتَابِ الله - عز وجل -، لَكَتَبْتُهَا، الشَّيْخُ وَالشَّيْخَةُ إِذَا زَنَيَا فَارْجُمُوهُمَا أَلْبَتَّةَ» (¬١).
هذه أهم وأبرز المصطلحات المتعلقة بالتفسير.
_________
(¬١) أخرجه البخاري (٨/ ١٦٨) رقم (٦٨٢٩)، ومسلم (٣/ ١٣١٧) رقم (١٦٩١)، وأبو داود (٤/ ١٤٤) رقم (٤٤١٨)، واللفظ له.',NULL,'65',NULL,NULL,'0');
INSERT INTO [b60] VALUES (64,'<span data-type="title" id=toc-47>ثانيًا: الحديث وعلومه:</span>
...
<span data-type="title" id=toc-48>تعريف الحديث:</span>
...
_________
(¬١) شرح التبصرة (١/ ٩٧).
(¬٢) أخرجه مسلم في صحيحه (٢/ ٦١٥) رقم (٨٩٨).',NULL,'66',NULL,NULL,'0');
INSERT INTO [b60] VALUES (65,'<span data-type="title" id=toc-49>أقسام علم الحديث:</span>
ينقسم علم الحديث على وجه الإجمال إلى قسمين:
١ - علم رواية الحديث: وهو علم يُبحث فيه عن كيفية اتصال الأحاديث بالرسول - صلى الله عليه وسلم - من حيث أحوال رواته ضبطًا وعدالةً ومن حيث كيفية السند اتصالًا وانقطاعًا وغير ذلك.
٢ - علم دراية الحديث: وهو علم متعلق بفقه الحديث وما يخصه من معرفة الناسخ والمنسوخ والخاص والعام.
ويمكن تقسيمه تفصيلًا إلى:
١) علم المصطلح: وهو علم يعرف به حال الراوي والمروي من حيث القَبول والرد.
٢) علم التخريج: وهو علم يختص بالدلالة على موضع الحديث في مصادره الأصلية من كتب السنة وإبرازه للناس مع بيان مرتبة الحديث عند الحاجة.
٣) علم الرجال (الجرح والتعديل): هو العلم بأحوال رواة الحديث من حيث القبول والرد.
٤) علم العلل: هُوَ العلم الَّذِيْ ينقد أحاديث الثقات التي حصل فيها وهم أو غلط خفي، وهو من أدق العلوم وأشدها صعوبة.
<span data-type="title" id=toc-50>ثمرة دراسة علم الحديث وفوائده:</span>
١) معرفة منزلة السُّنة التي هي المصدر الثاني للتشريع، وهي المبيَّنة للقرآن؛ والمفصلة لمجمله.',NULL,'67',NULL,NULL,'0');
INSERT INTO [b60] VALUES (66,'٢) حفظ الدين الإسلامي من التحريف والتبديل , فقد نقلت الأمة الحديث النبوي بالأسانيد , وميزت به الصحيح من السقيم, ولولا هذا العلم لالتبس الحديث الصحيح بالضعيف و الموضوع, ولاختلط كلام الرسول بكلام غيره، وضاعت علوم الشريعة وأحكام الدين.
...
(¬٢) أخرجه البخاري في صحيحه (٢/ ٨٠) رقم (١٢٩١)، ومسلم في صحيحه (١/ ١٠) رقم (٤).',NULL,'68',NULL,NULL,'0');
INSERT INTO [b60] VALUES (67,'٩) علم الحديث يمتد تأثيره إلى العلوم الإسلامية الأخرى.
<span data-type="title" id=toc-51>مصطلحات علم الحديث:</span>
المتواتر: ما رواه جمع كثير عن جمع كثير بحيث تحيل العادة أو العقل تواطؤهم على الكذب.
الآحاد: ما فقد شرطًا من شروط التواتر.
الحديث القدسي: ما يرويه النبي - صلى الله عليه وسلم - عن ربه - عز وجل - لفظًا أو معنى سوى القرآن.
الحديث المرفوع: ما أضيف إلى النبي - صلى الله عليه وسلم - من قول أو فعل أو تقرير أو وصف.
الحديث الموقوف: ما أضيف إلى الصحابي من قول أو فعل أو تقرير متصلًا كان أو منقطعًا.
الحديث المقطوع: ما أضيف إلى التابعين فمن دونهم موقوفًا عليهم من أقوالهم وأفعالهم.
الصحيح لذاته: ما اتصل سنده بنقل العدل تام الضبط عن مثله إلى منتهاه من غير شذوذ ولا علة.
الصحيح لغيره: هو الحديث الحسن لذاته إذا روي من وجه آخر مثله أو أقوى منه.
الحسن لذاته: هو الحديث الذي اتصل سنده بنقل عدل خف ضبطه من غير شذوذ ولا علة.',NULL,'69',NULL,NULL,'0');
INSERT INTO [b60] VALUES (68,'الحسن لغيره: هو الحديث الضعيف إذا تعددت طرقه ويمكن أن ينجبر بغيره.
الحديث الضعيف: هو الحديث الذي فقد شرطًا من شروط الحديث المقبول، وقصر عن رتبة الحسن.
الحديث الموضوع: هو الخبر المكذوب المختلق الذي ينسب إلى رسول الله - صلى الله عليه وسلم - كذبًا.
الحديث المتروك: هو الحديث الذي في إسناده راوٍ متهم بالكذب ولا يعرف الحديث إلا من جهته.
الحديث الشاذ: ما رواه الراوي الثقة مخالفًا لمن هو أوثق منه.
الحديث المنكر: هو ما رواه الراوي الضعيف مخالفًا للثقة.
الحديث المُدْرَج: هو ما غير في سياق إسناده أو أدخل في متنه ما ليس منه.
الحديث المضطرب: هو الحديث الذي يروى على أوجه مختلفة لا مرجح بينها، ولا يمكن الجمع بينها.
الحديث المُصَحَّف: هو تغيير الكلمة في الحديث عن الهيئة الصحيحة إلى غيرها.
الحديث المتصل: هو الذي لم يسقط من إسناده أحد من رواته مرفوعًا كان أو موقوفًا.
المنقطع: هو ما سقط من إسناده قبل الصحابي راوٍ واحد أو أكثر لا على التوالي.',NULL,'70',NULL,NULL,'0');
INSERT INTO [b60] VALUES (69,'الحديث المعلق: ما حذف من أول إسناده راوٍ أو أكثر على التوالي، أو يحذف جميع الإسناد، أو يحذف كل الإسناد عدا الصحابي.
المعضل: هو ما سقط من إسناده راويان فأكثر على التوالي.
المرسل: ما رفعه التابعي صغيرًا كان أو كبيرًا إلى النبي - صلى الله عليه وسلم - بأن يقول: قال رسول الله - صلى الله عليه وسلم -، أو هو: ما سقط من آخر إسناده من بعد التابعي.
المدلس: وهو نوعان:
الأول: تدليس الإسناد: هو أن يروي الراوي عَمَّن لقيه ما لم يسمعه منه، موهمًا أنه سمعه منه.
والثاني: تدليس الشيوخ: هو أن يروى الراوي عن شيخ حديثًا سمعه منه، فيسميه، أو يكنيه، أو ينسبه، أو يصفه بما لا يعرف به؛ كيلا يُعْرَف لضعفه أو صغره أو نحو ذلك.
المرسل الخفي: هو الحديث الذي يرويه الراوي عَمَّن عاصره ولم يلقه.
هذه أبرز المصطلحات المتعلقة بعلم الحديث.

•••',NULL,'71',NULL,NULL,'0');
INSERT INTO [b60] VALUES (70,'<span data-type="title" id=toc-52>ثالثًا: علم العقيدة:</span>
علم العقيدة هو العلم الذي يبحث في العقيدة الإسلامية وبيان ما يضادها وينافيها وهو مستمد من الوحيين الكتاب والسنة، وبيان نهج أئمة الأمة من الصحابة والتابعين - رضي الله عنهم - في تعاملهم مع مسائل الاعتقاد.
وعلم العقيدة هو أصل العلوم؛ لأن سلامة المرء في دينه موقوف على سلامة عقيدته.
والعقيدة الإِسلاميَّة عند إطلاقها هي عقيدة أَهل السُّنَّة والجماعة؛ لأنَّها هي الإِسلام الذي ارتضاه الله دينا لعباده، وهي عقيدة القرون الثلاثة المفضَّلة من الصحابة والتابعين وتابعيهم بإِحسان إلى يوم الدين.
وكل ما خالف عقيدة أهل السنة والجماعة فهو من العقائد الباطلة، وصاحبها منحرف عن الاعتقاد الصحيح إلى العقائد البدعية الضالة.
والمراد بأهل السنة والجماعة: كل من اتبع سنة النبي - صلى الله عليه وسلم - وتمسك بها قولًا وعملًا واعتقادًا.
<span data-type="title" id=toc-53>تعريف العقيدة:</span>
العقيدة لغة: مأخوذة من العقد، وهو الشد والربط والثبوت والإحكام، يقال: عقد الحبل يعقده: شدّه، والعقدُ: ضد الحل.
والعقيدة تُطلق على الإيمان الجازم الذي لا يتطرق إليه شكٌّ، وهي ما يؤمن به الإنسانُ ويعقد عليه قلبَه، فإن كان ما يعتقده اعتقادًا صحيحًا جازمًا بربوبية اللّه تعالى وأُلوهيته وأَسمائه وصفاته، وملائكته، وكتبه، ورسله، واليوم الآخر، والقدر خيره وشره، وسائر ما ثَبَتَ من أُمور الغيب،',NULL,'72',NULL,NULL,'0');
INSERT INTO [b60] VALUES (71,'وأصول الدِّين، وما أَجمع عليه السَّلف الصَّالح، والتسليم التام لله تعالى في الأَمر والحكم والطاعة، والاتباع لرسوله، فهذه هي العقيدة السلفية الصحيحة، وإن كان ما يعتقده خلاف ذلك كانت عقيدة فاسدة.
<span data-type="title" id=toc-54>أقسام العقيدة:</span>
يؤخذ تقسيم العقيدة من أصول الإيمان الستة، وهي:
١) الإيمان بالله: ويتضمن: (الإيمان بوجوده، وربوبيته، وألوهيته، وأسمائه وصفاته).
٢) الإيمان بالملائكة: ويتضمن: (الإيمان بوجودهم، والإيمان بمن علمنا اسمه منهم، والإيمان بما علمنا من صفاتهم، والإيمان بما علمنا من أعمالهم).
٣) الإيمان بالكتب السماوية: ويتضمن: (الإيمان بأن نزولها من عند الله حقًا، والإيمان بما علمنا اسمه منها كالقرآن، والتوراة، والإنجيل، والزبور، مع تصديق ما صح من أخبارها، والعمل بأحكام ما لم ينسخ منها).
٤) الإيمان بالرسل: ويتضمن: (الإيمان بأن رسالتهم حق من عند الله، والإيمان بمن علمنا اسمه منهم باسمه، مع تصديق ما صح عنهم من أخبارهم، والعمل بشريعة من أرسل إلينا منهم، وهو خاتمهم محمد - صلى الله عليه وسلم -.',NULL,'73',NULL,NULL,'0');
INSERT INTO [b60] VALUES (72,'٥) الإيمان باليوم الآخر: ويتضمن: (الإيمان بعذاب القبر ونعيمه، والإيمان بالبعث، والإيمان بالحشر والحساب، والإيمان بالجنة والنار، وغيرها من أمور الآخرة).
٦) الإيمان بالقدر خيره وشره: ويتضمن: (الإيمان بأن الله تعالى عالم بكل شيء جملة وتفصيلًا، والإيمان بأن الله كتب ذلك في اللوح المحفوظ، وأن جميع الكائنات لا تكون إلا بمشيئة الله تعالى، والإيمان بأن جميع الكائنات مخلوقة لله تعالى).
- ويدخل في دراسة العقيدة بيان مذاهب الفرق التي خالفت اعتقاد أهل السنة والجماعة في هذه الأصول الستة.
<span data-type="title" id=toc-55>ثمرة دراسة علم العقيدة وفائدته:</span>
١. معرفة العقيدة الصحيحة التي هي أصل الدين، وأساسُ دعوة المرسلين، ولا يتم إيمان العبد ولا يقبل عند الله سبحانه وتعالى إلا بها، ولهذا يقول الله - عز وجل -: {وَمَنْ يَكْفُرْ بِالْإِيمَانِ فَقَدْ حَبِطَ عَمَلُهُ وَهُوَ فِي الْآخِرَةِ مِنَ الْخَاسِرِينَ} [المائدة:٥].
٢. معرفة أن العقيدة الصحيحة شرط لصحة الأعمال وقبولها.
٣. معرفة أعظم الواجبات وآكدها توحيد الله تعالى، والبعد عَمَّا يضاده من الشرك بالله ونحوه.
٤. العقيدة الصحيحة هي السبب في حصول التمكين في الأرض، وتوحيد صفوف المسلمين، وعليها تجتمع كلمتهم.
٥. بها يتحقق الأمن والاستقرار، وسعادة الدنيا والآخرة.',NULL,'74',NULL,NULL,'0');
INSERT INTO [b60] VALUES (73,'٦. معرفة مذاهب الفرق الضالة والتحذير منها.
٧. الحصانة ضد الفرق الضالة المبتدعة.
٨. دراسة العقيدة الصحيحة تزيد الإنسان خشية لله، وبعدًا عن المعاصي والموبقات.
٩. الحضارة الإسلامية لا تقوم إلا على العقيدة الصحيحة؛ لأنه لا بد لكل بناءٍ ماديًّا كان أو معنويًّا من أساس عقائدي يقوم عليه.
<span data-type="title" id=toc-56>مصطلحات في علم العقيدة:</span>
...
أصول الدين: هي الأسس التي يقوم وينبني عليها الدين الإسلامي، وتُعتبَر أصلًا له، وهي التي أجمع عليها سلف هذه الأمة.',NULL,'75',NULL,NULL,'0');
INSERT INTO [b60] VALUES (74,'السنة: تطلق عند السلف على ما يقابل البدعة، فمن اتبع سنة النبي - صلى الله عليه وسلم - وسنة الصحابة والتابعين ومن بعدهم، ونهج منهجهم يقال له: إنه من أهل السنة، ومن ترك منهجهم، واتبع أصحاب الأهواء يقال له: إنه من المبتدعة.
...
أهل الحديث: هم المنسوبون إلى حديث رسول الله - صلى الله عليه وسلم - بسبب اتباعهم له، فهم كل من جعل كلام رسول الله - صلى الله عليه وسلم - مصدرًا من مصادر التلقي يستفيدون منه عقائد الإسلام، سواءٌ كانوا علماء حديث أو فقه أو أصول فقه أو سوى ذلك.',NULL,'76',NULL,NULL,'0');
INSERT INTO [b60] VALUES (75,'يقول شيخ الإسلام ابن تيمية - رحمه الله -: «ونحن لا نعني بأهل الحديث المقتصرين على سماعه، أو كتابته، أو روايته، بل نعني بهم: كل من كان أحق بحفظه ومعرفته، وفهمه ظاهرًا وباطنًا، وإتباعه باطنًا وظاهرًا، وكذلك أهل القرآن» (¬١).
...
البدعة: طريقة في الدين مخترعة تضاهي الشرعية، يقصد بالسلوك عليها ما يقصد بالطريقة الشرعية (¬٢).

•••
_________
(¬١) مجموع الفتاوى (٤/ ٩٥).
(¬٢) عرفها بذلك الشاطبي في كتابه الاعتصام (١/ ٥١).',NULL,'77',NULL,NULL,'0');
INSERT INTO [b60] VALUES (76,'<span data-type="title" id=toc-57>رابعًا: الفقه:</span>
...
<span data-type="title" id=toc-58>تعريف الفقه:</span>
...
<span data-type="title" id=toc-59>أقسام الفقه:</span>
قسم العلماء الفقه إلى قسمين رئيسيين:
_________
(¬١) الأشباه والنظائر ص (١٣).
(¬٢) أخرجه البخاري (١/ ٢٥) رقم (٧١)، ومسلم (٢/ ٧١٩) رقم (١٠٣٧).',NULL,'78',NULL,NULL,'0');
INSERT INTO [b60] VALUES (77,'القسم الأول: فقه العبادات: ويشتمل على الأحكام العملية لأفعال المكلف المتعلقة بتنظيم علاقة الإنسان بربه، مثل: الطهارة، والصلاة، والزكاة، والصوم، والحج، والنذر، وغيرها.
...
خامسًا: أحكام السياسة الشرعية: وتشتمل على ثلاثة أنواع:',NULL,'79',NULL,NULL,'0');
INSERT INTO [b60] VALUES (78,'١ - الأحكام الدستورية: ويقصد بها تحديد علاقة الحاكم بالمحكوم، وتقرير ما للأفراد والجماعات من حقوق، وما عليهم من واجبات، وهي التي تتعلق بنظام الحكم وأصوله.
٢ - الأحكام الدولية: ويقصد بها تحديد نوع العلاقة والتعاون والاحترام المتبادل بين الدول، وهي تتعلق بتنظيم علاقة الدول الإسلامية بغيرها من الدول في السِّلم والحرب، وعلاقة غير المسلمين المواطنين بالدولة، وتشمل الجهاد والمعاهدات.
٣ - الأحكام الاقتصادية: ويقصد بها تنظيم العلاقات المالية بين الأغنياء والفقراء، وبين الدولة والأفراد، وهي تتعلق بحقوق الأفراد المالية والتزاماتهم في نظام المال، وحقوق الدولة وواجباتها المالية، وتنظيم موارد الخزينة ونفقاتها.
<span data-type="title" id=toc-60>ثمرة دراسة علم الفقه وفوائده:</span>
١ - نيل رضا الله تعالى وتوفيقه، والحصول على الخيرية في حديث: «مَنْ يُرِدِ الله بِهِ خَيْرًا يُفَقِّهْهُ فِي الدِّينِ» (¬١).
٢ - تنظيم حياة الأفراد والجماعات:
إن معرفة الأحكام الفقهية المتعلقة بأفعال الناس، تعين المسلم على الالتزام بتلك الأحكام، من حلال وحرام، وتضبط حياة الأفراد والجماعات بمنهج شرعي رشيد، بعيدًا عن التأثر بالأهواء والشهوات.
_________
(¬١) أخرجه البخاري في صحيح (١/ ٢٥) رقم (٧١)، ومسلم في صحيحه (٢/ ٧١٩) رقم (١٠٣٧).',NULL,'80',NULL,NULL,'0');
INSERT INTO [b60] VALUES (79,'٣ - حل المشكلات الإنسانية:
...
٥ - تأكيد صلاحية الإسلام لكل زمان ومكان:
...
<span data-type="title" id=toc-61>مصطلحات علم الفقه:</span>
...
المذاهب الأربعة: مذاهب فقهية معروفة انتشرت في القرن الثاني وما بعده، وهي مذهب الإمام أبي حنيفة النعمان، ومذهب الإمام مالك بن أنس، ومذهب الإمام الشافعي، ومذهب الإمام أحمد بن حنبل.',NULL,'81',NULL,NULL,'0');
INSERT INTO [b60] VALUES (80,'وفيما يلي نبذة مختصرة عن كلِّ واحدٍ منهم:
- الإمام أبو حنيفة، وهو: النعمان بن ثابت الكوفي التيمي الفقيه. ولد بالكوفة سنة (٨٠ هـ)، أصله من فارس، وإليه يُنسب المذهب الحنفي، والصحيح أنه ليس من تصنيفه، توفي بالعراق سنة (١٥٠ هـ).
- الإمام مالك، وهو: مالك بن أنس بن مالك بن أبي عامر الأصبحي، الحميري المدني أبو عبد الله، إمام دار الهجرة، ولد بالمدينة النبوية سنة (٩٣ هـ)، وإليه يُنسب المذهب المالكي، من مؤلفاته: الموطأ، توفي بالمدينة سنة (١٧٩ هـ).
- الإمام الشافعي، وهو: محمد بن إدريس بن العباس بن عثمان الشافعي المطلبي القرشي أبو عبد الله، ولد في غزة سنة (١٥٠ هـ)، إليه يُنسب المذهب الشافعي. من مؤلفاته (الرسالة)، و (كتاب الأم)، توفي بمصر سنة (٢٠٤ هـ).
- الإمام أحمد: أحمد بن محمد بن حنبل أبو عبد الله الشيباني الوائلي المحدث، إمام أهل السنة، إليه يُنسب المذهب الحنبلي، ولد في بغداد سنة (١٦٤ هـ). من مؤلفاته (المسند)، و (الرد على الجهمية والزنادقة)، توفي بمصر سنة (٢٠٤ هـ).
الظاهرية: مذهب فقهي معروف، وسمي بذلك نسبة للأخذ بظاهر النصوص وعدم النظر في التعليل والقياس، ومؤسس هذا المذهب هو داود بن علي الظاهري، وجاء من بعده ابن حزم الأندلسي فأصل لهذا المذهب ووضع قواعده.',NULL,'82',NULL,NULL,'0');
INSERT INTO [b60] VALUES (81,'الفرض: ما طلب الشرع فعله طلبًا جازمًا، بحيث يترتَّب على فعْله الثواب، كما يترتَّب على ترْكه العقاب.
...
الإعادة: فعْل العبادة في وقتها مرَّة ثانية لزيادة فضيلة.',NULL,'83',NULL,NULL,'0');
INSERT INTO [b60] VALUES (82,'<span data-type="title" id=toc-62>خامسًا: أصول الفقه:</span>
علم أصول الفقه: هو من أَجَلِّ العلوم قدرًا وأعظمها شأنًا، إذا هو العلم الذي يعتبره العلماء أصلًا لتقرير الدلائل، وتحرير المسائل، واستنباط الأحكام الشرعية، ومنزلته في علوم الشريعة كبيرة حيث يتعلق به فهم الأحكام ومعرفة عللها.
<span data-type="title" id=toc-63>تعريف أصول الفقه:</span>
الأصول: جمع أصل، والأصل في اللغة: ما يبنى عليه غيره.
وأصول الفقه اصطلاحًا: هو العلم الذي يبحث في أدلة الفقه الإجمالية، وكيفية الاستفادة منها، وحال المستفيد.
<span data-type="title" id=toc-64>أقسام أصول الفقه:</span>
تنقسم موضوعات أصول الفقه إلى أربعة أقسام رئيسية هي:
١. بيان الأحكام: وهي التحريم، والكراهة، والوجوب، والاستحباب، والإباحة، والشرط والمانع، والسبب. والصحة والفساد، وغير ذلك.
٢. دراسة الأدلة: وهي الكتاب، والسنة، والإجماع، والقياس، والاستحسان، والاستصحاب، وقول الصحابي، وسد الذريعة، والمصلحة المرسلة.
٣. وجوه دلالة الأدلة: الخاص والعام، والمجمل والمبين، والمطلق والمقيد، والأمر والنهي، والناسخ والمنسوخ، ونحو ذلك.
٤. حال المستدل والمستدل له: وهي أحوال المجتهد وشروط الاجتهاد، وأحكام الاتباع والمتبعين، وأحكام التقليد والمقلدين.',NULL,'84',NULL,NULL,'0');
INSERT INTO [b60] VALUES (83,'<span data-type="title" id=toc-65>ثمرة دراسة علم أصول الفقه وفوائده:</span>
١) يكسب المتعلم قوة في استنباط الأحكام الشرعية من الأدلة الفرعية.
٢) تيسير عملية الاجتهاد وإعطاء الحوادث الجديدة ما يناسبها من الأحكام.
٣) معرفة ضوابط الفتوى، وشروط المفتي وآدابه.
٤) صيانة الفقه الإسلامي من الانفتاح المترتب على وضع مصادر جديدة للتشريع، ومن الجمود المترتب على دعوى إغلاق باب الاجتهاد.
٥) ضبط قواعد الحوار والمناظرة، وذلك بالرجوع إلى الأدلة الصحيحة المعتبرة.
٦) الوقوف على سماحة الشريعة الإسلامية ويسرها، والاطلاع على محاسن هذا الدين.
٧) بيان طرق الجمع بين الأدلة التي ظاهرها التعارض، والرد على شبهات الطاعنين في ذلك.
٨) المحافظة على الشريعة الإسلامية، لأن علم أصول الفقه يصون أدلة التشريع حتى لا يتجاوزها الناس، كما يحفظ للأحكام حُجَجَها ومُستنداتها، كما يوضح المصادرَ الأصليةَ والفرعيةَ للتشريع حتى تحتفظَ الشريعةُ بقواعدِها.
٩) منع تفسير نصوص الكتاب والسنة حسب الرأي أو الهوى، فعلم أصول الفقه يضبط تفسير النصوص، ويحكمه بضوابط وقواعد كلية جامعة متفق عليها ترد على كل متجاوز.',NULL,'85',NULL,NULL,'0');
INSERT INTO [b60] VALUES (84,'١٠) فيه نجاة وعصمة من التفرق والاختلاف، الذي ينشأ عن الفهم المغلوط للقرآن والسنة، وبه تم الجمع بين مدرسة الحديث والأثر، ومدرسة أهل الرأي.
١١) اكتساب الْمَلَكَة الفقهية التي تمكن طالب العلم أو الفقيه من الفهم الصحيح، والإدراك الكامل والشامل للأحكام الفقهية، والاطلاع على طرق الاستنباط والاجتهاد للاستفادة منها، والقياس عليها إذا احتاج إلى ذلك.
١٢) إزالة التعصب المذهبي بين الفقهاء، حيث يستطيع طالب العلم من خلال دراسة أصول الفقه أن يوازن بين المذاهب والآراء الفقهية، ويعرف الأرجح والأصح، والأولى بالقبول، استنادًا إلى الدليل، والقواعد الأصولية.
<span data-type="title" id=toc-66>مصطلحات علم أصول الفقه:</span>
...
شرع من قبلنا: هو الأحكام التي نُقِلَت إلينا في القرآن أو السنة الثابتة أنها كانت شريعةً للأمم السابقة، كأهل الكتاب وغيرهم.',NULL,'86',NULL,NULL,'0');
INSERT INTO [b60] VALUES (85,'العُرف: هو ما يتعارفه أكثر الناس، ويتواضعون عليه من الأعمال، ولا يوجد في نفيه ولا إثباته دليل شرعي.
سد الذرائع: حسم مادة وسائل الفساد بمنع هذه الوسائل ودفعها.
مثال ذلك: نهى المسلمين عن سب آلهة المشركين مخافة أن يرد عليهم المشركين فيسبوا الله - عز وجل -، وقد جاء هذا النهي في قوله: {وَلَا تَسُبُّوا الَّذِينَ يَدْعُونَ مِنْ دُونِ اللَّهِ فَيَسُبُّوا اللَّهَ عَدْوًا بِغَيْرِ عِلْمٍ} [الأنعام:١٠٨].
...
فهو ما ارتبط به غيره عدمًا لا وجودًا، فإذا عدم الشرط عدم الحكم، لكن إن وجد الشرط قد يوجد الحكم وقد لا يوجد.',NULL,'87',NULL,NULL,'0');
INSERT INTO [b60] VALUES (86,'مثال ذلك: الطهارة شرط يلزم من عدمه عدم صحة الصلاة، ولا يلزم من وجوده صحة الصلاة؛ لأنه قد يرتفع الحدث لكن يتخلف شرط آخر يمنع من صحة الصلاة.
...
مثال ذلك: قوله تعالى: {يَاأَيُّهَا الَّذِينَ آمَنُوا لَا تَقْرَبُوا الصَّلَاةَ وَأَنْتُمْ سُكَارَى} [النساء:٤٣].
العام: هو اللفظ المستغرق لجميع أفراده بلا حصر.
الخاص: هو اللفظ الدال على محصور.
ومثال العام والخاص: {وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا} [آل عمران:٩٧]، فقوله: {وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ} عام يشمل جميع الناس،',NULL,'88',NULL,NULL,'0');
INSERT INTO [b60] VALUES (87,'وقوله: {مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا} خصص هذا العموم بالصفة، وهي صفة الاستطاعة.
...
ومثال المنطوق والمفهوم: {فَلَا تَقُلْ لَهُمَا أُفٍّ} [الإسراء:٢٣]، فمنطوق الآية حرمة التأفيف للوالدين، وهو التلفظ بأف، ومفهوم الآية حرمة الضرب والشتم.

هذه أبرز المصطلحات المتعلقة بعلم أصول الفقه.',NULL,'89',NULL,NULL,'0');
INSERT INTO [b60] VALUES (88,'وختامًا هذا ما تيسر كتابته على عجالة، سائلًا الله الكريم العون والتسديد والتوفيق للعلم النافع والعمل الصالح والإخلاص في القول والعمل.
...
د. عبد الرحمن بن عبد العزيز العقل
القصيم- بريدة
تمت مراجعته في ١٨/ ١١/١٤٣٦ هـ.',NULL,'90',NULL,NULL,'0');
