...
CREATE TABLE "b133363"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b133363
INSERT INTO [b133363] VALUES (1,'نقد
...
الثانية: أني افتقدت في الكتاب النهج العلمي الصريح لانتقاء الأحاديث وتخريجها، وتطبيق قواعد علم المصطلح عليها، وطالب الشريعة يجب أن يدرس دراسة علمية تطبيقية، لا دراسة نظرية محضة كما هي الحال في أكثر الكليات، وتبعًا لدراسته النظرية يتخرج ولا يكاد يشعر بثمرة الفرق بين',NULL,'5',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (5,'مصطلح وآخر، بين قول المحدث مثلًا «رواه البخاري» وقوله «رواه البخاري تعليقًا» (١) وقد يؤلف المخرج كتابًا أو يضع رسالة، يورد فيها ما شاء من الأحاديث وكثير منها ضعيف منكر أو موضوع لا يجوز روايته إلا مع بيان حاله، ثم هو يكتفي في كل ذلك بأن يقول في التخريج «رواه أبو داود وفلان» أو «رواه النسائي وفلان» دون أن يرجع إلى إسناده ويدرس أحوال رجاله وما قد يكون فيه من علة تقدح في ثبوته، كالانقطاع والتدليس والإرسال ونحوه، ومن العجيب أن الأستاذ الكتاني صنع هذا نفسه في كتابه، وهو يعلم أنه أستاذ مقتدى به، ينبغي أن يعلم طلابه التحفظ الدقيق في رواية حديث رسول الله صلى الله عليه وسلم بدليل قوله صلى الله عليه وسلم: «كفى بالمرء كذبًا أن يحدث بكل ما سمع» رواه مسلم في مقدمة "الصحيح" بإسناد صحيح.
* * *
...
٢ - أطلق العزو للبخاري في بعض الأحاديث، فقال "رواه البخاري" وهي عنده معلَّقة، وبعضها مما لا يصح إسناده، وبذلك يتوهم القراء أنها صحيحة على شرط البخاري في "الصحيح" وليست الحال كذلك، وعكس ذلك في بعض آخر، فقال «رواه البخاري معلقًا» وهو عنده موصول!
_________
(١) التخريج الأول معناه أن الحديث صحيح، والتخريج الآخر معناه أنه قد يكون صحيحًا، وقد يكون حسنًا، وقد يكون ضعيفًا لا يحتج به.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (6,'ومن المقرر في علم الحديث أن أحاديث "صحيح البخاري" تنقسم إلى قسمين:
...
قلت: ثم ذكر هذا الحديث. وإن مما يؤسف له أن الحديث المنكر الذي ضعفه الترمذي، هو أول حديث في كتاب الشيخ الكتاني تَوجهُ به!',NULL,'9',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (9,'<span data-type="title" id=toc-6>الحديث الثاني:</span>
...
قلت: وهذا إسناد ضعيف لإرساله، لأن زيد بن أسلم وهو مولى عمر، هو تابعي معروف، ولعل الشيخ توهم أنه صحابي، ولذلك ترضي عنه!',NULL,'11',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (11,'والعرف عند العلماء جرى على تخصيص الترضي بالصحابة، والترحم بمن بعدهم، دفعًا لمثل هذا الإيهام فيكون الحديث عن تابعي مرسلًا ضعيفًا، وبالترضي عنه يصير عند عامة الناس المتأثرين بذلك العرف، مسندًا موصولًا، فينبغي مراعاة العرف دفعًا للإيهام.
...
ثانيًا: الحديث عند الترمذي في أول «النكاح» باللفظ الثاني، مع شيء من التقديم والتأخير يأتي بيانه. وأما اللفظ الأول، فليس له أصل عند الترمذي، ولا عند غيره ممن أخرج الحديث كأحمد في "مسنده" (٥/ ٤٢١) فكيف عزاه المصنف للترمذي؟ ! ومن أين نقله؟ !',NULL,'12',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (12,'لقد ذكر في مقدمة الكتاب أنه انتقى أحاديثه من الكتب الستة، وهذا الحديث يصلح شاهدًا على أن الانتقاء لم يكن من الكتب الستة مباشرة، وإنما انتقى بعضها منها، والبعض الآخر من الكتب الأخرى التي تنقل من الكتب الستة وغيرها، وإلا فكيف نستطيع أن نقنع أنفسنا بأن المصنف نقلها كلها من الكتب الستة مباشرة، وهذا الحديث بلفظه الأول لا أصل له في شيء منها!
...
وسيأتي معنا أمثلة أخرى تؤكد أن النقل لم يكن من "الستة" مباشرة، فانتظر.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (13,'<span data-type="title" id=toc-9>الحديث الخامس:</span>
...
«عن عبد الله بن عمر بن الخطاب رضي الله عنهما أنه كان في سرية من سرايا رسول الله عليه وسلم، قال: فحاص الناس حيصة ... فلما خرج قمنا إليه، فقلنا نحن الفرارين، فأقبل علينا، وقال: لا بل أنتم العكارون، قال: فدنونا فقبلنا يده، فقال: أنا فئة المسلمين. أخرجه أبو داود والترمذي».',NULL,'14',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (14,'قلت: في إسناده عندهما يزيد بن أبي زياد وهو الهاشمي مولاهم الكوفي قال الحافظ: «ضعيف، كبر فتغير، فصار يتلقن، وكان شيعيًّا».
...
ثم إن سياق الحديث للنسائي، ولكنه مخالف في بعض الأحرف لما في كتابه، فقد أخرجه في «تحريم الدم» بلفظ: «فقبلوا يديه ورجليه» وكذا هو عند الترمذي في «التفسير» إلا أنه قال: «فقبلا» وعكس ذلك في «الاستئذان» فقال: «فقبلوا يده ورجله».',NULL,'15',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (15,'<span data-type="title" id=toc-12>الحديث الثامن: </span>(ص ٢٣)
...
قلت: كذا وقع الحديث عنده «من بطحان» والصواب «من بطن بطحان» كذا هو في أبي داود (١١٥٨) وغيره.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (16,'وإسناده ضعيف، فيه إسحاق بن سالم، قال الذهبي: «لا يعرف» وقال الحافظ: «مجهول».
...
الأمر الآخر: أنه ليس في الحديث عند أبي داود ولا عند غيره ممن',NULL,'17',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (17,'ذكرنا: «الإسلام يعلو ولا يعلى»، وإنما هذا حديث آخر، لم يخرجه أبو داود ولا غيره من الستة، وأنما روي عن غير معاذ (١)، اللهم إلا ما أشرت إليه آنفًا من أن بعض الضعفاء رواه عن شعبة في هذا الحديث، فكان المصنف اختلط عليه الأمر، فجعل الحديثين حديثًا واحدًا، ثم عزاه لأبي داود، ولا أصل لذلك عنده. بل إن الحديث الذي رواه أبو داود بدون الزيادة ليخالف سياقه سياق المصنف في بعض الأحرف، كقوله: «فورثه ابنًا له» وهذا لا يوجد عند أبي داود، فمن أين جاء به المصنف؟ ! وهل هذا يشهد لقوله في المقدمة أنه انتقاها من الكتب الستة؟ !
...
_________
(١) وهو عائذ ابن عمرو، وقد خرجت حديثه في "الإرواء" (١٢٥٥) محسنًا.',NULL,'18',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (18,'المتابعة، وإلا فلين الحديث عند التفرد كما هنا. وسلمة رماه الذهبي بالتدليس فقال: «روى حديث خصيلة بنت واثلة، فدلسه».
...
(٢) كذا في الأصل المطبوع، وهو خطأ، وصوابه في "سنن أبي داود": «امرأة آمت من وزجها». [معد الكتاب لبرنامج المكتبة الشاملة]',NULL,'19',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (19,'<span data-type="title" id=toc-19>الحديث الخامس عشر: </span>(ص ٤٢)
...
_________
(١) الأصل «عبد الجبير»!',NULL,'20',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (20,'الأولى: حذفه لكلام الترمذي الدال على ضعفه! فقد قال عقبه:
...
قلت: إسناده ضعيف، فيه عيسى بن ميمون الأنصاري ضعفه الترمذي نفسه في هذا الحديث، وكذلك البيهقي، وقد تفرد بقوله: «واجعلوه في المساجد»، فهو منكر، لتفرد الضعيف به، زد على ذلك أنه منكر من حيث المعنى، فإن معناه في سياق الحديث أن الضرب بالدفوف جائز في المسجد للإعلان، وذلك مما لا يجوز، دون خلاف أعلمه، فكان',NULL,'21',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (21,'في استطاعة المصنف أن يتحاشى هذا الحديث لضعفه وإيهامه ما لا يجوز شرعًا، إلى أحاديث أخرى ثابتة في الباب الذي ترجم له بـ «الدف والغناء في حفلات الزفاف»، وقد أوردت طائفة منها في كتابي "آداب الزفاف" (ص ١٠١ - ١٠٥)، فليراجعها من شاء.
...
_________
(١)',NULL,'23',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (23,'الذي في مأرب. فقطعه له، فلما أن ولى، قال رجل من المجلس: أتدري ما قطعت له يا رسول الله؟ إنما قطعت له الماء العِدَّ، فانتزعه منه، قال: وسألته عما يحمى من الأراك؟ قال: ما لم تنله أخفاف الإبل». أخرجه أبو داود والترمذي».
...
«عن أبي المليح عن أبيه رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم',NULL,'24',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (24,'«اعتموا تزدادوا حلمًا، وقال علي: العمائم تيجان العرب» أخرجه أبو داود».
...
قلت: وهي:',NULL,'25',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (25,'الأخرى: وهي الاختلاف على أبي حيان في وصله وإرساله، ورجح الدارقطني إرساله، وبيانه في "إرواء الغليل" (١٤٦١).
...
وهو معروف عن ابن مسعود موقوفًا عليه مختصرًا بلفظ:',NULL,'26',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (26,'«اغد عالمًا أو متعلمًا، ولا تغد إمعة بين ذلك».
...
_________
(١) والصواب في الموضوعين «أبو أمية الشعباني واسمه (يُحمِد)» بضم الياء وكسر الميم.',NULL,'27',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (27,'وهذا سند مسلسل بالعلل.
...
«كنا لا ندري ما نقول إذا جلسنا في الصلاة، وكان رسول الله صلى الله عليه وسلم قد عُلم ... فذكر نحوه».',NULL,'28',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (28,'قلت: يعني نحو حديث آخر قبله من طريق أخرى عن ابن مسعود فيه صيغة التشهد المعروف به. ثم قال شريك: وحدثنا جامع يعني ابن شداد عن أبي وائل عن عبد الله بمثله، قال: وكان يعلمنا كلمات ولم يكن يعلمناهن كما يعلمنا التشهد «اللهم ألف بين قلوبنا، وأصلح ذات بيننا ... » الخ.
...
«تابعي مشهور، اتهم بالكذب».',NULL,'29',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (29,'قلت: فمثله لا يحتج به ولا كرامة، لاسيما وهو شيعي يروي في فضل علي رضي الله عنه.
...
فدل ذلك كله على بطلان حديث الترمذي، إذ كيف يعقل أن تجيب',NULL,'30',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (30,'السيدة عائشة بجواب تخالف به جوابها الثابت عنها، وتخالف جواب رسول الله صلى الله عليه وسلم نفسه؟ !
...
«عن العباس بن عبد المطلب رضي الله عنه قال: قلت: يا رسول الله إن قريشًا جلسوا يتذاكرون أحسابهم بينهم، فجعلوا مثل ذلك كمثل نخلة',NULL,'31',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (31,'في كبوة من الأرض، فقال رسول الله صلى الله عليه وسلم: إن الله خلق الخلق فجعلني من خير فرقهم، وخير الفريقين، ثم خير القبائل، فجعلني في خير قبيلة، ثم تخير (الأصل: خير! ) البيوت فجعلني من خير بيوتهم، فأنا خيرهم نفسًا وخيرهم بيتًا. أخرجه الترمذي».
...
«ضعيف».',NULL,'32',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (32,'وعند أبي داود حديث آخر عن أنس: «أن ملك ذي يزن أهدى إلى رسول الله صلى الله عليه وسلم، حلة أخذ بثلاثة وثلاثين بعيرًا، أو ثلاث وثلاثين ناقة، فقبلها».
وإسناده ضعيف أيضًا.
...
«عن أبي الدرداء رضي الله عنه قال: قال رسول الله صلى الله عليه وسلم: كان من دعاء داود يقول: اللهم إني أسألك حبك وحب من يحبك، والعمل',NULL,'33',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (33,'الذي يُبلغني حبك، اللهم اجعل لي حبًّا أحب إلي من نفسي ومالي وأهلي ومن الماء البارد. قال: وكان رسول الله صلى الله عليه وسلم إذا ذكر داود يحدث عنه قال (الأصل: ويقول! ) كان أعبد البشر. أخرجه الترمذي».
...
وقد بينت وجه حسنه في "إرواء الغليل" (١٤٢٤).',NULL,'34',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (34,'<span data-type="title" id=toc-43>الحديث الثالث </span>(ص ١٧):
...
فقال البخاري في «الطب» من "صحيحه" (٤/ ٦١ - طبع أوربا): حدثني سِيدان بن مضارب أبو محمد الباهلي حدثنا أبو معشر يوسف بن',NULL,'35',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (35,'يزيد البراء حدثني عبيد الله بن الأخنس أبو مالك عن ابن أبي مليكة عن ابن عباس به. وفيه قصة.
...
«عن أبي هريرة رضي الله عنه أن رسول الله صلى الله عليه وسلم قال يومًا: «أتدرون ما الغيبة؟ قالوا: الله ورسوله أعلم. قال: ذكر أحدكم',NULL,'36',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (36,'أخاه بما يكره، فقال رجل: أرأيت إن كان في أخي ما أقول؟ قال إن كان فيه ما تقول فقد اغتبته، وإن لم يكن فيه ما تقول فقد بهته». أخرجه أبو داود والترمذي».
...
فكيف وقعت هذه الخطيئة؟ يبدو -والله أعلم- أن المحقق محمد فؤاد عبد الباقي رحمه الله كان ربط ورقة هذا التخريج بحديث المطلب الذي رواه مالك عنه مرسلًا كما ذكرنا، ليطبع تحته، فأخطأ الطابع فطبعه تحت قول عيسى عليه السلام، ثم انطلى ذلك على المصحح، ولا أستبعد',NULL,'37',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (37,'أن يكون هو المحقق نفسه، لأنه ليس من العلماء بالحديث ولا حفظ عنده فيه ولا عناية له به. وإنما هو مفهرس فقط، وليس كل من قال «أخرج فلان» أو «روى فلان» صار من أهل الحديث!
...
فاتصلت به هاتفيًّا، وذكرت له رأيي في الكتاب، وما فيه من مآخذ وأخطاء، أشدها هذا العزو، ثم قلت له: فمن أين لك هذا، فسكت برهة، ثم قال: اصبر قليلًا حتى آتي بالكتاب، ثم هتف إلي',NULL,'38',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (38,'قائلًا -ويا لهول ما قال-: إن الإمام مالك هو الذي عزى الحديث لمسلم في كتاب البر والصلة ... الخ! ! فقلت: ما هذا أيها الشيخ! ألا تعلم أن بين مسلم ومالك مفاوز، وأن مسلمًا متأخر عن مالك، فإن من شيوخ مسلم الإمام أحمد، ومن شيوخ هذا الإمام الشافعي، ومن شيوخ الشافعي مالك، فكيف يعزو مالك الحديث إلى مسلم، وهو قد مات قبله بسنين؟ ! ثم سكت متحيرًا، وتكلم بكلمات فهمت منها أن مالكًا قال ذلك في كتابه "الموطأ"! فقلت: هذا مستحيل، وسأدرس الموضوع، وأبين لك الحقيقة إن شاء الله تعالى.
...
قلت: قد أخرجه الشيخان من حديث أبي بكرة رضي الله عنه، فكان الواجب أن يعزو إليهما، ويذكره بلفظهما وهو قريب من هذا لا سيما وهو عند النسائي في «تحريم الدم» من طرق عن الحسن عن أبي موسى، والحسن هو البصري وهو مدلس عن الصحابة، وقد عنعنه في',NULL,'39',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (39,'جميع الطرق عنه، بل قال البزار وقد ذكر جماعة من الصحابة روى عنهم الحسن ولم يسمع منهم:
...
«لا تقوم الساعة حتى تعود أرض العرب مروجًا وأنهارًا، وحتى يسير الراكب بين العراق ومكة لا يخاف إلا ضلال الطريق، وحتى يكثر الهرج، قالوا: وما الهرج يا رسول الله؟ قال: القتل القتل. أخرجه أحمد في "المسند" والحاكم في "المستدرك"».',NULL,'40',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (40,'قلت: كذا وقع في الأصل، لم يذكر صحابي الحديث، وهو أبو هريرة رضي الله عنه. ولفظ الحديث لأحمد (٢/ ٣٧٠ - ٣٧١)، وليس للحاكم منه إلا الجملة الأولى، وقال (٤/ ٤٧٧) «صحيح على شرط مسلم ولم يخرجاه» ووافقه الذهبي.
...
أخرجه الإمام أحمد بتمامه، ومسلم دون الجملة الوسطى، واستدرك عليه الحاكم الجملة الأولى فوهم!',NULL,'41',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (41,'<span data-type="title" id=toc-50>الحديث السادس: </span>(ص ١١)
...
«خطبنا علي بن أبي طالب فقال: من زعم أن عندنا شيئًا نقرأه إلا كتاب الله وهذه الصحيفة (قال: وصحيفة معلقة في قراب سيفه) فقد كذب، فيها أسنان الإبل، وأشياء من الجراحات، وفيها قال النبي صلى الله عليه وسلم: المدينة حرم ما بين عير إلى ثور، فمن أحدث فيها حدثًا ... » الحديث.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (42,'أخرجه في «العتق» وهو عند البخاري أيضًا في «الفرائض» لكن ليس فيه ذكر القراب إلا أن موضع الشاهد منه موجود عنده أيضًا.
...
«عن بريدة رضي الله عنه أن النبي صلى الله عليه وسلم قال:',NULL,'43',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (43,'من قال حين يصبح أو حين يمسى: اللهم أنت ربي لا إله إلا أنت خلقتني ... دخل الجنة. أخرجه أبو داود».
...
ف<span data-type="title" id=toc-54>مثال الأولى: </span>(ص ٢٢): «عن عائشة رضي الله عنها قالت: ما رأيت أحدًا أشبه سمتًا ودلًّا وهديًا برسول الله صلى الله عليه وسلم في قيامه وقعوده من فاطمة بنت رسول الله صلى الله عليه وسلم، قالت: وكانت إذا دخلت على النبي صلى الله عليه وسلم قام إليها فقبلها وأجلسها في مجلسه، وكان النبي صلى الله عليه وسلم إذا دخل عليها قامت من مجلسها، وقبلته، وأجلسته في مجلسها، فلما مرض النبي صلى الله عليه وسلم دخلت فاطمة فأكبت عليه، فقبلته، ثم رفعت رأسها، فبكت ثم أكبت عليه، ثم رفعت رأسها، فضحكت، فقلت: إن كنت لأظن هذه من أعقل نسائنا، فإذا هي من النساء، فلما توفي رسول الله صلى الله عليه وسلم قلت لها: أرأيت حين أكببت على رسول الله صلى الله عليه وسلم، فرفعت رأسك فبكيت، ثم أكببت عليه، فرفعت رأسك فضحكت، ما حملك على ذلك؟ قالت: إني إذن لبذرة، أخبرني أنه ميت من وجعه هذا، فبكيت، ثم أخبرني أني',NULL,'44',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (44,'أسرع أهله لحوقًا به، فذاك حين ضحكت. أخرجه البخاري ومسلم وأبو داود والترمذي».
...
«أم لا؟ ».',NULL,'45',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (45,'ثم الحديث ضعيف الإسناد، لأنه من رواية كهمس بن الحسن عن عبد الله بن بريدة عن عائشة.
...
ويبدو مما ينقل العلماء عنه أنه وقع في كتابه كثير من الأحاديث والزيادة في المتون مما لا أصل له عند أحد من أئمة الحديث فضلًا عن الكتب الستة، من ذلك حديث صلاة الرغائب، ومنها حديث آخر في فضل الفقيه، بينت وضعه في تعليقي على "المشكاة" (١/ ٨٤/٢٥١) فراجعه إن شئت.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (46,'من أجل ذلك فلا غناء ولا فائدة من عزو الحديث إلى رزين، لا سيما إذا كان الحديث المنسوب إليه هو في بعض الأصول الستة، كهذا الحديث، فقد أخرجه أبو داود والنسائي وكذا الدارمي والحاكم وأحمد وغيرهم من حديث بهز بن حكيم عن أبيه عن جده معاوية بن حيدة. وإسناده حسن، وصححه الحاكم والذهبي. وجعله من حديث معاذ بن جبل وهم من المصنف أو رزين.
...
وجب الشكر علينا ... ما دعا لله داع',NULL,'47',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (47,'ثم اتفقا) فدخل أبو بكر وهي تضرب ... . أخرجه الترمذي.
...
_________
(١) انظر الكتاب المسمى "ردود على أباطيل" (ص ٥٥ - ٥٦ و ٧١ - ٧٢).',NULL,'48',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (48,'<span data-type="title" id=toc-60>ثانيًا - قال (ص ٨): «الأجرة على التعليم»</span>.
...
«من أخذ على تعليم القرآن قوسًا، قلده الله قوسًا من نار يوم القيامة».',NULL,'49',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (49,'أخرجه أبو محمد المخلدي في "الفوائد" والبيهقي بسند جيد كما قال ابن التركماني.
...
<span data-type="title" id=toc-63>خامسًا - قال (ص ٢٢): «كان رسول الله صلى الله عليه وسلم إذا دخلت عليه فاطمة قام لها وقبلها»</span>.
ثم ساق حديث عائشة «أن فاطمة كانت إذا دخلت على النبي قام إليها فقبلها وأجلسها في مجلسه، وكان النبي صلى الله عليه وسلم إذا دخل عليها ... » فذكره مثله وقد مضى بتمامه ص ٤٤ من رواية الترمذي.',NULL,'50',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (50,'قلت: فهذه الترجمة خطأ كما يظهر بأدنى تأمل، ذلك لأن الحديث يقول: «قام إليها»، ولم يقل: «قام لها» كما في الترجمة، والقيام إلى الشخص معناه الذهاب عنده والانتهاء إليه، بخلاف «القيام له» فهذا لا يستلزم سوى القيام، ورواية أبي داود أصرح في الدلالة على هذا المعنى، ولفظها:
...
قلت: الظاهر أن المصنف أراد بـ (العامل في الدولة) الموظف فيها أي موظف كان. و (العامل) بهذا المعنى مما لا نعرفه في اللغة، وإنما جاء فيها على ثلاثة معان:',NULL,'52',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (52,'الأول: الخليفة، كما في الحديث «ما تركت بعد نفقة عيالي، ومؤنة عاملي صدقة»، قال في "النهاية" و"اللسان":
...
ثم ذكر حديث بريدة الذي تكلمنا على الزيادة التي زادها رزين فيما تقدم (ص ٤٧)، وفيه إذن الرسول صلى الله عليه وسلم للمرأة التي كانت نذرت إن رد الله نبيه سالمًا أن تضرب بين يديه بالدف وتغني، فأذن صلى الله عليه وسلم لها.',NULL,'53',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (53,'فهذا خاص بضرب الدف والغناء بهذه الحال التي لن تتكرر، والترجمة أعم، فيخشى أن يتشبث بها بعض ذوي الأهواء، فيستدلون بها على الجواز مطلقًا فيضلون. وراجع "معالم السنن" (٤/ ٣٨٢).
...
قلت: هذا لا يدل على ما ترجم له، بل هي أعم منه، وإنما يدل على أنه لا حق له في فضل مال إذا كان هناك من هو في حاجة ملحة إليه، فيجب حينئذ أن يخرج عن هذا الفضل إليه، وهذا من حقوق المال التي تجب لعارض، مثل قوله صلى الله عليه وسلم: «فكوا العاني، وأطعموا الجائع».',NULL,'54',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (54,'رواه البخاري. وليس معنى ذلك أنه لا حق لأحد في فضل مال مطلقًا، وإلا تعارض ذلك مع النصوص القاطعة في عصمة المال وتحريمه على الغير إلا بطيب نفس صاحبه. وكيف يكون كذلك وكبار الصحابة ماتوا ولهم فضول أموال كثيرة، كما هو معروف من حال عثمان وعبد الرحمن بن عوف وغيرهم من الصحابة رضي الله عنهم، وقد أقرهم رسول الله صلى الله عليه وسلم على ذلك، ولم يوجب عليهم الخروج منها! !
...
على أن الاصطلاح المذكور لم يجر على تسميته البترول بـ (الذهب) مطلقًا، بل مقيدًا بالأسود، فلو جاز تفسير الحديث بالمصطلحات الحادثة',NULL,'55',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (55,'-وهذا باطل- لم يجز هذا التفسير هنا لأن الذهب مطلق في الحديث، والمطلق يجري على إطلاقه كما هي القاعدة عند العلماء.
...
فما هو الفائدة من تكرار هذه العناوين والتراجم في الوقت الذي لا يمكن اليوم التبرك بآثاره صلى الله عليه وسلم لعدم وجودها؟ ! وما يفعلونه في بعض البلاد من التبرك في بعض المناسبات بشعرة محفوظة في زجاجة فهو شيء لا أصل له في الشرع، ولا يثبت ذلك بطريق صحيح.',NULL,'56',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (56,'نعم إنما يستفيد من هذه التراجم بعض مشايخ الطرق كما سبق ذكره في المقدمة، ولعل المصنف وضع هذه التراجم مساعدة منه لهم على استعباد مريديهم وإخضاعهم لهم باسم التبرك بهم! والله المستعان.
...
ثم ذكر تحته حديثًا صحيحًا.',NULL,'57',NULL,NULL,'0');
INSERT INTO [b133363] VALUES (57,'ثم قال (ص ٥٦): «الجهاد واجب مع كل بر وفاجر».
...
وهذا آخر ما تيسر لنا ذكره والتنبيه عليه في هذه العجالة، راجين من الله تعالى أن ينفع بها المسلمين عامة، والطلاب خاصة، وأن يجعل أعمالنا لوجهه خالصة، ولهدى نبيه صلى الله عليه وسلم موافقة. إنه خير مسؤول.',NULL,'58',NULL,NULL,'0');
