...
CREATE TABLE "b527"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b527
INSERT INTO [b527] VALUES (1,'الجهاد سنام الدين
بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
[ل ٦٧] الحمدُ لله القادر القاهر، الحكيم العزيز الناصر، غالبِ من غالبَهَ، ومُهلِكِ من حاربه. أشهد أن لا إله إلا هو وحدَه لا شريكَ له، أذلَّ الجبابرة العُتاةَ، والفراعنةَ البُغاة. أحمَدُه على أن جَعَلنا مِن أُمَّةٍ أركانُ حَقِّها مُشَيَّدة، وأنصارُ هَدْيِها مؤيَّدة، وأصلِّي وأسلِّم على نبيّه محمدٍ الهادي إلى سبيل رشاده، والمبلِّغِ رسالتَه إلى عباده، والمجاهدِ فيه حقَّ جهادِه.
...
فأحببتُ (¬١) أن أسطِّر فيه نبذةً أستمطِرُ بها نَفَحاتِ الأماثل، وأُحرِّك بها نَخَواتِ الأفاضل، وإن لم يكن لي في هذه الحَلْبة مجال، ولا في هذا المقام مقال، ولا أُنكِرُ تقصيري في هذه المفاوز إذا لُزِزْتُ في قَرَنٍ مع الرِّجَال. وأستعين الله سبحانه وتعالى، وهو حسبي ونعم الوكيلُ.
_________
(¬١) جواب "لمّا" الواردة في الفقرة السابقة.','22','225',NULL,NULL,'0');
INSERT INTO [b527] VALUES (2,'اعلمْ أنَّ الجهاد ركنٌ من أركان الإسلام، وهو روحُه التي لا يحيا إذا فارقه، وهو أفضلُ الأعمال بعد الإيمان، وَعَدَ الله مَنْ قام به، وتوعَّد مَنْ تأخَّر عنه، وجعله سبباً لإعزازِ دينه وإكمالِه، وإخزاءِ عدوِّه وإذلالِه، وله في ذلك الحكمةُ الباهرةُ، منها: أنْ يَنْصرَ دينَه ويَخْذُل عدوَّه بلا سبب مُهلِكٍ في الِعيان، لا يتمكَّنون مِنْ دفاعه، كالخسفِ والمسخ والصواعقِ؛ وليفتخرَ المسلمون بغلبتهم ــ مع قلَّتِهم ــ أعداءَهم مع كثرتهم، ويُثِيب عليه (¬١) المجاهدين، ويُعاقِب القاعدين، ويَبتلي عباده، وهو أعلمُ بهم، إلى غير هذا.
...
_________
(¬١) في الأصل: "إليه"، وهو سهو.','22','226',NULL,NULL,'0');
INSERT INTO [b527] VALUES (3,'بالجهاد وغيره.
...
* * * *','22','227',NULL,NULL,'0');
INSERT INTO [b527] VALUES (4,'البحث الأوّل: في الجهاد بالنفس
...
فأين الإيمانُ؟ أين اليقين؟ أين التصديق بكلام الله تعالى؟ إنّا لله وإنّا إليه راجعون، لا حول ولا قوة إلا بالله. ما هذا الجهلُ الناشئ عن سوء اليقين؟ والخوف من القتل، الخوف من الشهادة، الخوف من بيع النفس لله تعالى وهي مِلْكُه، تفضَّل علينا بأن يشتري منّا مِلْكه بنعيم الآخرة الدائم، ثم نحن','22','228',NULL,NULL,'0');
INSERT INTO [b527] VALUES (5,'نمتنع عن بيعها له خوفًا من حُسنِ قبوله لها، وهربًا من الجنّة ونعيمها! نعوذ بالله.
...
* * * *','22','229',NULL,NULL,'0');
INSERT INTO [b527] VALUES (6,'البحث الثالث: في النصائح والتحريض والتشجيع وفضائل ثوابه،
...
(¬٢) في الأصل: "فعجة"، سبق قلم.','22','230',NULL,NULL,'0');
INSERT INTO [b527] VALUES (7,'إخوانهم، فعليه إخبارهم، فإن تركه أَثِمَ. وإن رأى أنّ ذلك يُثبِّطهم فليقتصر على التحريض والتحضيض، وحاصلُ مراعاةِ المصلحة بالجهاد لا بالقعود.
...
* * * *','22','231',NULL,NULL,'0');
INSERT INTO [b527] VALUES (8,'خاتمةٌ
...
_________
(¬١) لم أجده في مصادرنا بهذا اللفظ، وهو مشهور عند الشيعة، وقد ورد في كتاب "وسائل الشيعة" (١٥/ ١٢٠): "من قُتل دون عقالٍ فهو شهيد". وذكر أن في نسخة: "دون عياله".','22','232',NULL,NULL,'0');
INSERT INTO [b527] VALUES (9,'أوليائنا ويستحيي نساءنا، ويسترِقُّ أبناءنا.
...
تمّت.
عبد الرحمن بن يحيى بن علي المعلمي','22','233',NULL,NULL,'0');
