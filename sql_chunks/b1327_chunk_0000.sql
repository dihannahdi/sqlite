...
CREATE TABLE "b1327"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1327
INSERT INTO [b1327] VALUES (1,'بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
...
INSERT INTO [b1327] VALUES (2,'<span data-type="title" id=toc-1>من الأدب الرمزي</span>
قال حيران بن الأضعف:
عجبت من صديقي. ظلَّ يُصرُّ على عدم الزواج ويرفضه بشدة،
فلما تزوج عدد الزوجات!!
فماذا وجد صديقي في الزواج حتى عدَّد الزوجات؟ !!',NULL,'3',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (3,'بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
...
اختاروهم ليتمِّموا المسيرة. وينشروا دين الهوى، ويفسدوا دين الحق.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (4,'وسادتهم وقادتهم من ورائهم يسهرون، تفرَّغوا للدفاع عنهم باسم حريَّة الرأي.
...
سلطنة عمان - صلالة
ص ب: ٥٩٣
ليلة النصف من شعبان المبارك ١٤٢٣ هـ',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (5,'<span data-type="title" id=toc-2>تعدد الزوجات في الشرائع السابقة</span>
...
* ثم جاء الإسلامُ فلم ينشئ تعدُّد الزوجات ولكنه قيَّده، وأصلح ما دخل فيه من فساد بسبب الفوضى، وجعله حسب الضرورات، فلم يحرم الإسلام أمراً تدعو إليه الضرورة، ويجوز أن تكون إباحته خيراً من تحريمه في بعض الظروف الأُسْريَّة، وبعض الظروف الاجتماعيَّة العامة (٢) .
مدخل ومناقشة:
...
(٢) (إنجيل متى إصحاح. ١٧)',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (6,'وإن شاءت طلبت الخلع، وربما كانت الزوجة الأولى هي السبب في الزواج عليها. كما ستعرف.
...
لمصلحتها فعلاً، فقد يطلق الرجل زوجته ويتزوج غيرها، ثم يرى أن يعيدها لعصمته صيانةً لأولاده، وحفظاً لهم، أليس من الأفضل أن يراجعها؟ !
...
<span data-type="title" id=toc-3>حوار هادئ:</span>
...
فهل هذه الجريمة التي اهتزَّ لها القلب بسبب تعدُّد الزوجات؟ ؟ !!!.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (7,'وهل تريد قانونا يمنع الرجل الذي ماتت زوجته أو طلقها حرمان الزواج بامرأة جديدة تنجب له أولاداً أبوهم واحد وأمهاتهم مختلفات؟
...
والمرأة تكون معطلة عن الحياة الزوجية أيام الحيض، وقد تصل إلى عشرة أيام في الشهر، وتحرم على زوجها أيام الولادة والنفاس، وقد تصل إلى شهرين.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (8,'وبعض الرجال لا يقوى على تحمل هذا.
...
لا يستطيع أن يشرف على تربية أولاد أخيه. ولا يمكن التردد على بيته حذراً من الفتنة، أو من كلام الناس.
...
* * *
<span data-type="title" id=toc-4>هل تعدُّد الزوجات يمثل ظاهرة في بلادنا</span>؟
تقول الأرقام - وهي - إن لم تكن حسابية فهي بلاغية تقول: إن عدد الذين يجمعون أكثر من زوجة واحدة لا يزيد عن ٤%. ولا تكاد تذكر نسبة الذين يجمعون ثلاثة أو أربعة. وتقل النسبة كلما انتشر التعليم.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (9,'فالتعليم المتوسط حوالي ٢.٨% بينما تقل هذه النسبة لمن أتم التعليم العالي فتصبح ١.٤% ومن درس بعد الجامعة فالنسبة تصل إلى ثلاثة في الألف.
...
فما بال بعض الناس يعدِّد الزوجات؟',NULL,'10',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (10,'لابد من سرٍّ في الموضوع لا يعرفه الذين يعارضون تعدُّد الزوجات. والذين لم يدخلوا تجربة التعدُّد قالوا: إنها لإشباع الشهوة.
...
<span data-type="title" id=toc-5>الإسلام قيد التعدُّد:</span>
...
فالإسلام قيد المباح من ناحية العدد ,',NULL,'11',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (11,'وقيده من ناحية الواجبات التي فرضها على الزوج وحسب أنه لا يبيت حيث يريد: ولكن حيث يريد له الواجب.
...
وواحدة أفضل.
وإذا عجز عن العدل بين نفسه وبين زوجة واحدة فالأفضل عدم الزواج {فَانْكِحُوا مَا طَابَ لَكُمْ مِنَ النِّسَاءِ مَثْنَى وَثُلَاثَ وَرُبَاعَ فَإِنْ خِفْتُمْ أَلَّا تَعْدِلُوا فَوَاحِدَةً}',NULL,'12',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (12,'قال علماؤنا: من خاف على نفسه من الزنا إذا لم يتزوج، وخاف على المرأة من الظلم إذا تزوج فالأفضل عدم الزواج.
لأن الفاحشة يمكن دفعها بالصوم وزيادة نصيب النفس من مخافة الله. ولا يمكن إصلاح ظلم المرأة - كما قلت.
<span data-type="title" id=toc-6>(اعْدِلُوا هُوَ أَقْرَبُ لِلتَّقْوَى) :</span>
...
* وأفتى العلماء أن للزوجة الجديدة في أول الزواج ثلاثة أيام إذا كانت ثيِّباً، وسبعة أيام إن كانت بكراً، ثم يرجع إلى القسمة العادلة بين الزوجات.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (13,'ولم يقل أبو حنيفة بذلك، وقال: إن مكث عند الزوجة الجديدة أياما فلا بدَّ أن يبيت مثلها عند زوجاته.
...
<span data-type="title" id=toc-7>العرض المادي هل يُسقط القسمة</span>؟
الإسلام جعل موضوع العدل في القسمة موضوع عدل بين الناس. ومخالفة حاكم جائر {وَإِذَا حَكَمْتُمْ بَيْنَ النَّاسِ أَنْ تَحْكُمُوا بِالْعَدْلِ} وكثيراً ما استخدم القرآن كلمة العدل في موضوع النساء.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (14,'* فهل يجوز للرجل أن يدفع الظلم من نفسه في موضوع المبيت.... لصاحبة الحق؟
...
<span data-type="title" id=toc-8>المساواة في غير القسمة:</span>
...
أعني لكل حسب حاجتها.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (15,'ودعاؤنا للزوج بعد ذلك أن يكون الله معه فقد حمَّل نفسه كثيراً.
وهو وحده يدفع الثمن.
...
وقد ناقش الدكتور "أحمد علي طه ريَّان" الموضوع مناقشة واسعة في كتابه "تعدد الزوجات" وناقشتُه من قبل في "زواج النبي - صلى الله عليه وسلم - ١٩٧٣ م " مع طلاب جامعة القاهرة.',NULL,'16',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (16,'<span data-type="title" id=toc-9>متاعب التعدُّد وموضوع الغيرة:</span>
...
والوفاء من أخلاق الدين.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (17,'قالت عائشة: ما غرت على امرأة لرسول الله - صلى الله عليه وسلم - ما غرت على خديجة لكثرة ذكر النبي لها، وثنائه عليها.
...
<span data-type="title" id=toc-10>الغَيرةُ دليلٌ على الحبِّ</span>
...
بسبب الغيرة.
والنبي - صلى الله عليه وسلم - يصبر ويعالج ويقدر لهن الدافع على فعلهن. ولقد كان النبي - صلى الله عليه وسلم - غيوراً وكان الزبير - رضي الله عنه - معروفاُ بالغيرة، وكان عمر بن الخطاب - رضي الله عنه - مفرطاً ولكن الله أكثر غيرة من النبي"',NULL,'18',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (18,'إن الله - عز وجل - يغار، وإن المؤمن يغار، وغيرة الله أن يأتي المؤمن ما حرم الله عليه.
...
<span data-type="title" id=toc-11>التعدد حل لمشلكة طبيعية:</span>
...
أو يشترك كل مجموعة منهن في رجل واحد.',NULL,'19',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (19,'من باب "ما لايدرك كله لا يترك كله"
...
دع الله يُشرِّع لعباده، فهو أعلم بمصلحتهم.',NULL,'20',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (20,'وفي الحديث الصحيح الذي رواه البخاري عَنْ أَنَسِ بْنِ مَالِكٍ
...
قلنا: إن الله علم أنَّ المرأة لا تصلح إلا لزوج واحد، حتى يثبت نسب ولدها من أبيه. وحتى يتحمل مسؤولية التربية.',NULL,'21',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (21,'من هنا لم تعدُّد الزوجة الأزواج.
...
والآية الثانية {وَلَنْ تَسْتَطِيعُوا أَنْ تَعْدِلُوا بَيْنَ النِّسَاءِ وَلَوْ حَرَصْتُمْ}',NULL,'22',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (22,'وأخذ من ظاهر الآيتين صعوبة التعدد. وإن كان لم يمنعه ولم يحرمه.
...
{فَلَا تَمِيلُوا كُلَّ الْمَيْلِ} أي لا يفرط أحدكم بإظهار الميل إلى إحداهن أشد الميل حتى يسيء الأخرى بحيث تصير الأخرى كالمعلقة.',NULL,'23',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (23,'{كَالْمُعَلَّقَةِ} هي المرأة التي يهجرها زوجها جهرا طويلاً فلا هي مطلقة ولا هي زوجة.
...
كنت أريد أن أجمع دراستي لكتابه "الكتاب والقرآن ٨٢٠ صحيفة" لأخرجها في كتاب مستقل. ولكنني رأيت أن أنقل هنا بعض ما يتعلق بموضوع الأُسْرة والمرأة ليعلم القارئ المسلم ماذا يراد بالإسلام باسم حريَّة الفكر؟',NULL,'24',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (24,'وأوجز هذه السطور عن منهج د / شحرور في كتابه ليعلم القارئ المسلم أن جهوداً كبيرة تبذل لصرف المسلم عن حقائق الإسلام.
...
حاولوا بعد ذلك صنع عقول من أبناء البلاد والمنتسبين للإسلام لغسل عقول الأجيال مما بقى من العقيدة والحضارة الإسلامية والأخلاق الإسلامية.',NULL,'25',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (25,'فجنَّدوا لنفس الأمر مجموعة من أذكياء الشباب المنتسب للإسلام أصحاب القدرة على البيان، وصنعوا لهم مجداً علمياً زائفاً، ومؤهلات عالية، وسخَّروا لهم كل وسائل الإعلام في العالم، حتى يقوموا بما أعدُّوهم له من طعن الإسلام وتشوية صورته من الداخل.
...
وهدم لما أحدثه الإسلام من معاني.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (26,'وتجريد الساحة من المفاهيم الإسلامية:
...
واستمر الاستخدام القرآني للكلمة حتى آخر العهد المدني عندما نزلت سورة المائدة آية ١٨ - التي ذكرناها وسوف تبقى.
وقد فهم المشركون في مكة المقصود من كلمة الشريعة بمعناها الجديد.
فلم يقل أحد منهم للنبي - صلى الله عليه وسلم - أين الشرعة التي جعلك الله عليها. لتحول مكة إلى وادٍ ذي زرع.',NULL,'27',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (27,'ما دامت الشرعة هي مجرى الماء.
...
<span data-type="title" id=toc-12>نماذج من كتاب دكتور شحرور:</span>
...
أما المعنى الشرعي للعورة - للرجل أو للأنثى',NULL,'28',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (28,'يقول: هو كلام مردود. ص ٦١٢ وكما قال من قبل: ليس له علاقة بالحلال والحرام.
...
وفي صفحة ٦١٤ يقول: إن قوله تعالى: {يُدْنِينَ عَلَيْهِنَّ مِنْ جَلَابِيبِهِنَّ} يقول: هذه الآية للتعليم وليست للتشريع.
...
ثم يذكر قوله تعالى: {وَأَنْ يَسْتَعْفِفْنَ خَيْرٌ لَهُنَّ} صـ ٦١٦',NULL,'29',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (29,'هكذا يظهر لنا خطر المنهج العَلْماني في تفسير القرآن باللغة العربية فقط بعيداً عن التفسير بالمأثور وبمصطلحات فقهاء الأمة.
...
وما عدا ذلك وهو كل جسدها زينة ظاهرة كالشعر والبطن والظهر والفخذين ثم يقول: والله - سبحانه - قد خلق الرجلَ والمرأةَ عُراةً دون ملابس ص ٦٠٦.
* * *
<span data-type="title" id=toc-13>مفهوم العورة في السنة:</span>
...
وهي الأخف من العورتين - أن من نظر في العورة التي وراء الأبواب فرماه صاحب العورة ففقأ عينه لم يكن عليه شيء، وذهبت عينه هدراً بنص حديث الرسول - صلى الله عليه وسلم - المتفق',NULL,'30',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (30,'عليه عند البخاري ومسلم: "قَالَ مَنْ اطَّلَعَ فِي بَيْتِ قَوْمٍ بِغَيْرِ إِذْنِهِمْ فَقَدْ حَلَّ لَهُمْ أَنْ يَفْقَئُوا عَيْنَهُ".
...
ومرة ثانية نلتقي مع الدكتور ومنهجه في تحريف آيات الله باسم التفسير اللغوي للقرآن ودعوى تصحيح ما أخطأ علماء الإسلام فهمه.',NULL,'31',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (31,'أليس من العجيب أن المهندس شحرور يدعي أنه يصحح لعلماء الإسلام فهمهم؟!!
...
فيقول الدكتور شحرور:',NULL,'32',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (32,'إن القرآن استخدم كلمة النساء بمعنى أزواج الرجال {الرِّجَالُ قَوَّامُونَ عَلَى النِّسَاءِ}
...
وهو يعلم أن المرأة قد تشتهي إنجاب الولد وملك الذهب.',NULL,'33',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (33,'فزين للرجال ما يشتهون. وزين للنساء ما يشتهين.
...
منهجه في تعدُّد الزوجات أنه يقول بجواز الزوجة الثانية أو الثالثة بشرط أن تكون من الأرامل ذات اليتامى وحاول أن يستدل على ذلك بالآية الكريمة',NULL,'34',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (34,'{وَإِنْ خِفْتُمْ أَلَّا تُقْسِطُوا فِي الْيَتَامَى فَانْكِحُوا مَا طَابَ لَكُمْ مِنَ النِّسَاءِ مَثْنَى وَثُلَاثَ وَرُبَاعَ فَإِنْ خِفْتُمْ أَلَّا تَعْدِلُوا فَوَاحِدَةً}
...
وواضح مهن الآية (١٢٧ النساء) أنها تؤكد المعنى الذي ذكرناه في الآية الثالثة من السورة الكريمة - سورة النساء - تؤكد تحريم الوصي لليتيمة بالزواج منها من غير دفع المهر لها.
...
وليس بعد فتوى الله فتوى.',NULL,'35',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (35,'* <span data-type="title" id=toc-14>(فَمَاذَا بَعْدَ الْحَقِّ إِلَّا الضَّلَالُ)</span>
...
حرّم شحرور أن تكون البكر زوجة ثانية - كما قلنا - وحرّم أن تكون الأرملة بدون يتامى زوجة ثانية، وحرّم أن تكون المطلقة ذات الأطفال زوجة ثانية لأنهم',NULL,'36',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (36,'ليسوا يتامى فهو يحرم التعدُّد بغير الأرملة ذات اليتامى.
...
وشحرور يجعل المخالفة رشداً، والجريمة تشريعاً يجعل الزواج بالأرامل ذات اليتامى بدون مهر. {قُلْ أَأَنْتُمْ أَعْلَمُ أَمِ اللَّهُ} ويجعله كذلك بدون عدل بين',NULL,'37',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (37,'الزوجات، لأن العدل المطلوب عند شحرور هو العدل بين أطفالك وبين اليتامى أبناء الأرامل اللاتي سيتزوج بهن.
...
لأن العدل عنده بين أولادك وبين اليتامى!!',NULL,'38',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (38,'ولما علم المهندس شحرور أن زواج النبي - صلى الله عليه وسلم -
...
<span data-type="title" id=toc-15>العدل أم الإحسان</span>؟
ضيّع أولاده صغاراً عندما أعطى كلّه للزوجة الجديدة الحسناء أهملهم وأمَّهم. فشقوا طريقهم في حياة كالصخر حتى أتمُّوا دراستهم.',NULL,'39',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (39,'واليوم دارت الأيام، وولت الدنيا عنه، ولم يبق سوى بيوت أولاده.
...
* * *',NULL,'40',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (40,'<span data-type="title" id=toc-16>العدل بين الأولاد:</span>
...
وحديث نعمان بن بشير بطرقه المختلفة، ورواياته المتعددة هو الأصل في هذا الباب.',NULL,'41',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (41,'أراد والد النعمان أن يمنحه غلاماً هدية، فطلبت أمُّ النعمان - عمرة بنت رواحة - من الأب أن يُشهد رسول الله - صلى الله عليه وسلم -
...
قال: فإني لا أشهد.
* * *
*<span data-type="title" id=toc-17> الهبة لسبب:</span>
...
وقال: هو مسكين.',NULL,'42',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (42,'وإن كان العلماء لم يسلموا بصحة الرواية لأن في الرواية لهيعة.
وهو ساقط الحديث.
...
* * *',NULL,'43',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (43,'أخيراً: زواج النبي - صلى الله عليه وسلم -
...
لأن استكمال العدد كان قبل التحديد بأربع.',NULL,'44',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (44,'ثالثاً: عند نزول آية النساء التي حددت العدد المباح بأربع نساء فقط طلب النبي - صلى الله عليه وسلم - من كل رجل عنده أكثر من أربعة أن يمسك الأربع ويطلق الباقيات.
...
أعطى الأول ألف ريال. وقال له: ليس لك غير هذا المبلغ.',NULL,'45',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (45,'وأعطى أخاه مائة فقط. وقال له: لو أنفقتها خذ غيرها.
...
* * *
<span data-type="title" id=toc-18>خامساً: مراحل حياة النبي - صلى الله عليه وسلم - من ناحية الزواج </span>المرحلة الأولى وردة في الصحراء. عافٌّ في بيئة لا تهتم بالعفاف. وهذا من بدء حياته إلى الخامس والعشرين وقد عصمه الله شابًّا، والشباب صورة للإنسان يكشف معدنه.
...
وأضيف إلى أعبائه حملاً ثقيلاً، إِنه قيادة جيش ومستقبل دعوة.',NULL,'46',NULL,NULL,'0');
INSERT INTO [b1327] VALUES (46,'<span data-type="title" id=toc-19>ليله صلاة وعبادة ونهاره دعوة وجهاد</span>
...
* * *
تَمَّ الكتابُ ولله الحمدُ والمِنَّةُ',NULL,'47',NULL,NULL,'0');
