...
CREATE TABLE "b21816"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b21816
INSERT INTO [b21816] VALUES (1,'بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
...
<span data-type="title" id=toc-1>فتكبر وتقول: الله أكبر</span>.
...
ثم تخفض رأسك فلا ترفعه إلى السماء لأن النبي صلى الله عليه وسلم " نهى عن رفع البصر إلى السماء في الصلاة " رواه البخاري.',NULL,'1',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (2,'واشتد قوله في ذلك حتى قال: ((لينتهين أقوام يرفعون أبصارهم إلى السماء في الصلاة أو لا ترجع إليهم)) رواه البخاري ومسلم.
...
وقصاره من (الضحى) إلى آخر القرآن.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (4,'ولا بأس بل من السنة أن يقرأ الإنسان بطوال المفصل، فقد صح عن النبي صلى الله عليه وسلم أنه قرأ في المغرب بـ (الطور) و (المرسلات) رواه البخاري ومسلم.

وبعد أن يقرأ السورة مع الفاتحة.
<span data-type="title" id=toc-2>[[الركوع]]</span>
...
فهذه أربع صفات ولكن لا يقولها في آن واحد بل يقول هذا مرة وهذا مرة.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (5,'وهذه قاعدة ينبغي لطالب العلم أن يفهمها: أن العبادات إذا وردت على وجوه متنوعة فإنها تفعل على هذه الوجوه، على هذه مرة، وعلى هذه مرة، وفي ذلك ثلاث فوائد:
...
ويسجد على سبعة أعضاء لقول النبي صلى الله عليه وسلم:: ((أمرنا أن نسجد على سبعة أعظم" ثم فصلها النبي صلى الله عليه وسلم: " على الجبهة، والكفين، والركبتين، وأطراف القدمين)) رواه البخاري ومسلم فيسجد الإنسان على هذه الأعضاء.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (7,'وينصب ذراعيه فلا يضعهما على الأرض ولا على ركبتيه.
...
<span data-type="title" id=toc-4>[[بين السجدتين]]</span>
ويجلس بين السجدتين مفترشاً وكيفيته: أن يجعل الرجل اليسرى فراشاً له، وينصب الرجل اليمنى من الجانب الأيمن.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (8,'أما اليدان فيضع يده اليمين على فخذه اليمنى أو على رأس الركبة، ويده اليسرى على فخذه اليسرى أو يلقمها الركبة، فلتاهما صفات واردتان عن النبي صلى الله عليه وسلم.
...
ثم يسجد للسجدة الثانية كالسجدة الأولى في الكيفية وفيما يقال فيها.',NULL,'9',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (10,'ثم ينهض للركعة الثانية مكبراً معتمداً على ركبتيه قائماً بدون جلوس، وهذا هو المشهور من مذهب الإمام أحمد. وقيل بل يجلس ثم يقوم معتمداً على يديه، كما هو المشهور من مذهب الشافعي، وهذه الجلسة مشهورة عند العلماء باسم<span data-type="title" id=toc-5> جلسة الاستراحة</span>.
...
ويقول صاحب المغنى: إن هذا هو الذي تجتمع في الأدلة - أي التي فيها إثبات هذه الجلسة ونفيها.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (11,'والتفصيل هنا - عندي - أرجح من الإطلاق، وإن كان رجاحته - عندي - ليس بذلك الرجحان الجيد، لأنه لا يتعارض في فهمي مع الجلسة فالمراتب عندي ثلاث:
...
ويقرأ<span data-type="title" id=toc-6> التشهد </span>وقد ورد فيه صفات متعددة وقولنا فيه كقولنا في دعاء الاستفتاح، أي أن الإنسان ينبغي له أن يأتي مرة بتشهد ابن عباس ومرة بتشهد ابن مسعود، ومرة بما ورد عن النبي صلى الله عليه وسلم من غير هاتي الصفتين فيقول: ((التحيات لله والصلوات والطيبات، السلام عليك أيها النبي ورحمة الله وبركاته السلام علينا وعلى عباد الله الصالحين، أشهد أن لا إله إلا الله، وأشهد أن محمداً عبده ورسوله)) رواه البخاري.

وإن كان في ثلاثية أو رباعية قام بعد التشهد الأول رافعاً يده كما رفعها عند تكبيرة الإحرام، وصلى بقية الصلاة وتكون بالفاتحة فقط فلا يقرأ معها سورة أخرى، وإن قرأ أحياناً فلا بأس لوروده في ظاهر حديث أبي سعيد الخدري رضي الله عنه.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (12,'ثم يجلس إذا كان في ثلاثية أو رباعية للتشهد الثاني، وهذا التشهد يختلف عن التشهد الأول وفي كيفية الجلوس لأنه يجلس متوركاً والتورك له ثلاثة صفات:
...
هذه صفة الصلاة فيما نعلمه من سنة الرسول صلى الله عليه وسلم، فينبغي للإنسان أن يحرص على تطبيق ما ورد عن النبي صلى الله عليه وسلم في تطبيق كيفية الصلاة ليكون ممتثلاً لقوله: ((صلوا كما رأيتموني أصلي)) رواه البخاري وأحمد.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b21816] VALUES (14,'وأهم شيء بالنسبة للصلاة بعد أن يُجري الإنسان أفعاله على السنة فيما أراه: هو حضور القلب، لأن كثيراً من الناس الآن لا تتسلط عليه الهواجس والوساوس إلا إذا دخل في الصلاة، وبمجرد ما ينتهي من صلاته تطير عنه هذه الهواجس والوساوس.

والله أعلم وصلى الله على محمد وعلى آله وصحبه أجمعين.',NULL,'14',NULL,NULL,'0');
