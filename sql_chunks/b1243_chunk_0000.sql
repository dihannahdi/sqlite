...
CREATE TABLE "b1243"(id INTEGER PRIMARY KEY,content TEXT, part TEXT, page TEXT, number TEXT, services TEXT, is_deleted TEXT);

-- Insert data for b1243
INSERT INTO [b1243] VALUES (1,'نظرات استشرافية في فقه العلاقات الإنسانية بين المسلمين وغير المسلمين إعداد
د. حسن بن محمد سفر
أستاذ نظم الحكم الإسلامي والقضاء والمرافعات الشرعية المشارك
بجامعة الملك عبد العزيز بجدة
بسم الله الرحمن الرحيم<span data-type="title" id=toc-1> مقدمة </span>الحمد لله رب العالمين، والصلاة والسلام على أشرف الأنبياء وسيد المرسلين سيدنا محمد وعلى آله وصحبه أجمعين، وبعد:
...
وقد اقتضت طبيعته العلمية أن أقسمه إلى الترتيب المنهجي العلمي الآتي:',NULL,'2',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (3,'<span data-type="title" id=toc-2>أولا: مصطلحات البحث ومفاهيمه الشرعية والقانونية </span>جرت المنهجية العلمية عند أهل العلم أن يبدؤوا بتوضيح مفهوم ما يريدون التأليف والبحث فيه ومعناه من حيث المصطلح للعلم أو الموضوع الذي يكتبون فيه.
ومن هنا وجب إيضاح بعض مصطلحات البحث وهي:
<span data-type="title" id=toc-3>العنف</span>
في اللغة ضد الرفق، وعنفوان الشيء أوله وهو في عنفوان شبابه أي قوته وعنفه مما يعني أن العنف ضد الرأفة متمثلاً في استخدام القوة ضد شخص آخر (١) .
_________
(١) المصباح المنير في غريب الشرح الكبير، ج ٢، مادة عنف، ص ٥١٦.',NULL,'3',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (4,'<span data-type="title" id=toc-4>التطرف</span>
لغة من الطرف وهو عدم الثبوت على مرعى واحد. واصطلاحاً هو مجاوزة الاعتدال في الأمر ولزوم طرفه بعيداً عن جمهور الأمة ومنهجها الوسط (١) .
_________
(١) صحاح الجوهري، مادة طرف، ج ٤، ص ١٣٩٤.',NULL,'4',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (5,'<span data-type="title" id=toc-5>الاعتدال</span>
لغة التوسط في الأمر، واصطلاحاً هو لزوم التوسط في الأمر بعيداً عن الإفراط والتفريط (١) .
_________
(١) القاموس المحيط، مادة عدل، ج ٤، ص ١٤.',NULL,'5',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (6,'<span data-type="title" id=toc-6>التسامح</span>
هو التجاوز والعفو، وهو دعامة من دعائم العلاقات الإنسانية الإسلامية (١) . والتسامح في الفكر الغربي من المفاهيم والمصطلحات التي ولدت في عصور الإصلاح الديني التي أعقبت القرون الدموية (٢) .
وتشير دائرة المعارف البريطانية إلى أن مفهوم التسامح مرتبط بالتعددية وقبول الاختلاف والسماح بحرية الرأي، ثم يؤدي بعد ذلك إلى العفو والتجاوز (٣) .
_________
(١) انظر: دستور التسامح في الإسلام: المكي الناصري، ص٦٠.
(٢) انظر: التسامح والتعصب في فكر رواد عصر النهضة، ص١٥، تراث وأساطير، ٢٠٠٤م.
(٣) راجع دائرة المعارف البريطانية.',NULL,'6',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (7,'<span data-type="title" id=toc-7>الإرهاب</span>
كلمة تستخدم للرعب أو الخوف الذي يسببه فرد أو جماعة أو تنظيم سواء كان ذلك لأغراض سياسية أو شخصية أو غيرها (١) .
وقد عرّف مجمع الفقه الإسلامي الإرهاب بأنه " العدوان الذي يمارسه أفراد أو جماعات أو دول بغياً على الإنسان: دينه، ودمه، وعقله، وماله، وعرضه. ويشمل صنوف التخويف والأذى، والتهديد، والقتل بغير حق، وما يتصل بصور الحرابة، وإخافة السبيل، وقطع الطريق. وكل فعل يهدف إلى إلقاء العنف أو التهديد والرعب بين الناس وترويعهم وإلحاق الضرر بالبيئة أو المرافق العامة والخاصة. وكل هذا من صور الفساد في الأرض التي نهى الله سبحانه وتعالى المسلمين عنها " (٢) .
وهي لا شك تعريفات اجتهادية لكنها تؤدي إلى المفهوم العام للإرهاب.
_________
(١) انظر: الإرهاب السياسي: عبد الرحيم صدق، ص٨١، دار النهضة العربية، القاهرة، ١٩٨٥م.
(٢) راجع بيان مكة المكرمة، مجمع الفقه الإسلامي، ص٤، ١٤٢٢هـ.',NULL,'7',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (8,'<span data-type="title" id=toc-8>ثانياً: الشمولية لأحكام الشريعة الإسلامية </span>من المعلوم من أحكام الشريعة الإسلامية بالضرورة ومن خلال الاستقراء يتبين أن الهدف النهائي للإسلام هو هداية البشر إلى الصراط المستقيم والإيمان بالوحدانية والعمل الصالح. فقد أرسل صلى الله عليه وسلم بالهدى ودين الحق كما قال تعالى: {هُوَ الَّذِي أَرْسَلَ رَسُولَهُ بِالْهُدَى وَدِينِ الْحَقِّ} (١) .
فإذا تحقق هدف الإيمان بالله وقرن بالعمل الصالح عم الخير والسعادة والسلام البشر أفراداً وجماعات، فإذا سادت شريعة السماء التي تحمل الحق والعدل والمساواة والحرية والكرامة وتقمع الظلم فإن الحرب والقتال والاشتباكات تكون استثناء. كما قال تعالى: {كُتِبَ عَلَيْكُمُ الْقِتَالُ وَهُوَ كُرْهٌ لَكُمْ} (٢) .
...
_________
(١) سورة التوبة، الآية رقم: ٣٣.
(٢) سورة البقرة، الآية رقم: ٢١٦.',NULL,'8',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (9,'ولهذا فإن العلاقة بين مختلف تجمعات الأمة الإسلامية وإن تعددت كياناتها السياسية هي السلام الذي تحققه مبادئ السماء وكفالة الإسلام لحقوق غير المسلمين. ويتجلى ذلك فيما يأتي:',NULL,'9',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (10,'<span data-type="title" id=toc-10>أولاً: كفالة حقوق غير المسلمين</span>
...
(٤) انظر نظام الأمان في الشريعة الإسلامية وأوضاع المستأمنين: سامي الصقار، ص٦٩، جامعة محمد الخامس، الرباط، ١٩٧٧م.',NULL,'10',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (11,'<span data-type="title" id=toc-11>ثانياً: تميز الشريعة الإسلامية في كفالة حرية الاعتقاد</span>
في مجال العلاقات الدولية الإنسانية في شريعة الإسلام تميّزه في جعل حرية العقيدة لغير المسلمين أمراً مقرراً لأن الإسلام لا يكره أحداً على الدخول فيه ذلك لأن الله خلق الناس جميعاً مختلفين في أديانهم وألوانهم وعاداتهم وتقاليدهم ولا يزالون كذلك إلى يوم الدين يؤكد ذلك أن القرآن الكريم أنزل سورة كاملة تحتوي على هذا المفهوم الشامل. قال تعالى: {قُلْ يَاأَيُّهَا الْكَافِرُونَ} {لَا أَعْبُدُ مَا تَعْبُدُونَ} {وَلَا أَنْتُمْ عَابِدُونَ مَا أَعْبُدُ} {وَلَا أَنَا عَابِدٌ مَا عَبَدْتُمْ} {وَلَا أَنْتُمْ عَابِدُونَ مَا أَعْبُدُ} {لَكُمْ دِينُكُمْ وَلِيَ دِينِ} (١) .
_________
(١) سورة الكافرون، الآية رقم: ١ - ٦.',NULL,'11',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (12,'<span data-type="title" id=toc-12>ثالثاً: التعايش مع الأديان الأخرى</span>
...
(٥) انظر: القضاء في الإسلام وآداب القاضي: جبر محمود الفضيلات، ص١١٩، عمان، دار عمار، ١٤١٢هـ.',NULL,'13',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (14,'فمما سبق يتضح لنا أن الشريعة الإسلامية أقرت مبدأ أصول العلاقات الإنسانية بين المسلمين والأمم الأخرى وترسيخ احترام الحريات وذلك منذ أربعة عشر قرنا وعدم التضييق على المخالفين وإرهابهم وترويعهم وبذلك تندحر المقولة المزعومة والتي يتشدق بها الأعداء الحاقدون على نظم الإسلامي مرددين مقولة: إن الإسلام انتشر بالسيف ذلك أن الإسلامي انتشر عن طريق الدعوة بالتي هي أحسن والمجادلة المقنعة والحوار الهادف البناء والتسامح في المعاملة، ولم يعرف السيف إلا دفاعاً عن حرماته ومقدساته من أن تنتهك أو تمتهن من قبل أعداء الإسلام لأن الجهاد في الإسلام على ضربين:
الأول: جهاد الدفع، حماية لمقدسات المسلمين وأوطانهم أن تسلب أو أن تهان أو أن تغتصب.
الثاني: جهاد الطلب كما حصل في الفتوحات الإسلامية في عهد أبي بكر الصديق وعمر بن الخطاب والخلفاء الراشدين.',NULL,'14',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (15,'وكل هذا ليؤكد أن القواعد التشريعية الإسلامية في فقه العلاقات الدولية والتساكن والتعايش مع غير المسلمين قد سبقت كل قواعد القانون الدولي بأربعة عشر قرناً فيما يتعلق بالعلاقات الإسلامية (١) . ومن مظاهر التميز في صيانة الحقوق والأخلاق ما منحته الشريعة الإسلامية من مزايا وأمان للأجانب في ظل الدولة الإسلامية.
_________
(١) انظر: قواعد العلاقات الدولية في القانون الدولي وفي الشريعة الإسلامية: جعفر عبد السلام، ص٣١٥، مكتبة السلام العالمية، القاهرة، ١٤٠١هـ.',NULL,'15',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (16,'<span data-type="title" id=toc-14>خامساً: تمتع الأجنبي بالأمان</span>
...
(٣) انظر: شرح السير الكبير، ج٢، ص٢٢٦.',NULL,'17',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (18,'وقد أشار الإمام السرخسي [٤٨٣ هـ ت] في المبسوط: " أن أموالهم صارت مضمونة بحكم الأمان فلا يمكن أخذها، ولا تقيد حريتهم في الاعتقاد والتنقل والمسكن، ولا يزج بهم في السجون وتجب رعاية هذا الأمان ما دام ساري المفعول " (١) .
...
(٢) السرخسي، ج١٠، ص٩٢؛ المغني، ج٨، ص٤٠٠؛ اختلاف الفقهاء، ص٣٣.',NULL,'26',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (27,'وما يكشف عن نبل الإسلام وكريم أخلاق السياسة للدولة الإسلامية احترامها للوضع القانوني الخاص بمبعوثي الدول الأخرى، أنه في الوقت الذي كان يقابل فيه سفراء هذه الدول بالاحترام ويحاطون بالحماية الكاملة حتى ولو خرجوا على القواعد الدولية في مخاطبة رؤساء الدول كان سفراء الإسلام ورسل رسول السلام صلى الله عليه وسلم إلى الدول غير الدول الإسلامية يعاملون كقاعدة عامة أسوأ معاملة، من ذلك أن ملك الفرس خسرو قطع الخطاب الذي أرسله إليه الرسول صلى الله عليه وسلم وداسه بأقدامه ونجا حامله من القتل بأعجوبة، كما أن السفراء الذين أرسلهم الرسول صلى الله عليه وسلم إلى أميري الغساسنة عوملوا أسوأ معاملة، ومبعوث الرسول صلى الله عليه وسلم إلى حاكم باسورا الروماني قتل على يد هذا الأخير (١) .
_________
(١) انظر: زاد المعاد، ج١، ص٣٠؛ قانون العلاقات الديبلوماسية، ص١٩.',NULL,'27',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (28,'وفي مقابل هذه المعاملة الوحشية والسلوك المشين أكرم الرسول صلى الله عليه وسلم مبعوث المقوقس عظيم القبط وقبل هداياه، وأكرم رسول هرقل. وقد أثرت هذه المعاملة الحسنة في بعض الرسل فدخلوا في الإسلام لما يرونه من حُسن المعاملة مما يدل على التسامح، والأمان والرعاية التي جاء بها الإسلام وشموله وعدالته ووفائه بالعهود واحترامه للمواثيق وتكريمه للإنسان (١) .
وقرر الإمام السرخسي أن " الرسل والمبعوثين لم تزل آمنة في الجاهلية والإسلام وهذا لأن أمر القتال والصلح لا يتم إلا بالرسل فلا بد من أمان الرسل لتوصل إلى ما هو المقصود " (٢) . فتأمين الرسل ثابت في الشريعة الإسلامية ثبوتاً معلوماً.
_________
(١) انظر: أحكام القانون الدولي في الشريعة الإسلامية، ص٢٠٠.
(٢) انظر: المبسوط: السرخسي، ج١٠، ص٩٢ - ٩٣، دار المعرفة، بيروت، ط٢.',NULL,'28',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (29,'<span data-type="title" id=toc-16>سابعاً: الإخلال بالأمن القومي وعقوبته الشرعية والقانونية</span>
...
(٣) انظر: جرائم أمن الدولة وعقوبتها في الفقه الإسلامي: أستاذنا يوسف الشال رحمه الله، ص٩١، المختار الإسلامي.',NULL,'31',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (32,'<span data-type="title" id=toc-17>ثامناً: الوفاء بالعهد</span>
إذا أعطى المسلمون الأمان للحربيين وجب عليهم الالتزام بما يقتضيه عقد الأمان من عدم التعرض لمن ثبت له الأمان الخاص أو العام المؤقت أو المؤبد ما لم ينته أمانه إن كان مؤقتاً وإنما يجب الوفاء بالعهد مع الحربيين. فالمسلمون مطالبون بالوفاء بالعهود التي التزموا بها كما قال تعالى: {وَأَوْفُوا بِعَهْدِ اللَّهِ إِذَا عَاهَدْتُمْ} (١) ، وقوله - جل جلاله -: {وَأَوْفُوا بِالْعَهْدِ إِنَّ الْعَهْدَ كَانَ مَسْئُولًا} (٢) . ومما يدل على ضرورة الوفاء بالعهد ما ورد في بيان عظم الاعتداء على العهد والجناية عليه خلال مدته ما أخبرنا به النبي صلى الله عليه وسلم حيث قال: «من قتل نفساً معاهداً لم يرح رائحة الجنة» (٣) .
_________
(١) سورة النحل، الآية رقم: ٩١.
(٢) سورة الإسراء، الآية رقم: ٣٤.
(٣) أخرجه الترمذي، وأبو داود.',NULL,'32',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (33,'فالحديث النبوي الشريف يدل دلالة واضحة على وجوب الوفاء بالعهد وحرمة الاعتداء على المعاهد ما لم ينقض عهده بناقض. وحرصاً على هذه المصداقية فإنه يلزم على المسلمين إذا اضطروا لإنهاء عقد الأمان قبل انتهاء وقته لخوف خيانتهم للعهد أن يعلمونهم بنقض عهدهم قبل قتالهم ولا يجوز الاعتداء عليهم حتى يبلغهم خبر النقض (١) عملا بقوله تبارك وتعالى: {وَإِمَّا تَخَافَنَّ مِنْ قَوْمٍ خِيَانَةً فَانْبِذْ إِلَيْهِمْ عَلَى سَوَاءٍ إِنَّ اللَّهَ لَا يُحِبُّ الْخَائِنِينَ} (٢) . وقد التزم المسلمون طيلة المسيرة الجهادية والأحوال الحربية مع المخالفين بالعهود والمواثيق والمعاهدات، ولم تشهد العلاقات الدولية في الشريعة الإسلامية أي مبدء لنكث العهد والميثاق والإخلال بالعهود من قبل المسلمين حكاماً وقادة ومجاهدين ومعاهدين (٣) .
_________
(١) انظر: العلاقات الدولية في الشريعة الإسلامية: عباس شومان، ص١٠٣، الدار الثقافية للنشر.
(٢) سورة الأنفال، الآية رقم: ٥٨.
(٣) انظر: أحكام المعاهدات في الشريعة الإسلامية: محمد طلعت الغنيمي، ص١٥٧، منشأة المعارف، الإسكندرية.',NULL,'33',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (34,'<span data-type="title" id=toc-18>تاسعاً: المملكة العربية السعودية ومكافحة الإرهاب</span>
...
ولما كان الإرهاب والعنف بجميع أشكاله، وبمختلف صوره، والتطرف بمجاوزته الاعتدال ليس من الإسلام، والإسلام بريء منه وقفت المملكة وأشقاؤها من الدول العربية موقفاً قاطعاً وحاسماً من ظاهرة الإرهاب وناشدت العالم أجمع لتقويض ظواهره ومكافحته (١) .
_________
(١) انظر: المملكة العربية السعودية ومكافحة الإرهاب: عزت مراد، ص١٨٧، ط١، ١٤٢٣هـ / ٢٠٠٢م.',NULL,'34',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (35,'كما لعبت دوراً مهماً في صياغة الاتفاقية العربية لمكافحة الإرهاب ورأت أن ما يقوم به الإرهابيون من صور إجرامية وأفعال ترويعية وأخطار على الأمن والسلام العالميين يفوق أعمال المحاربين، وهو ضرب من ضروب الإفساد في الأرض يطبق فيه على الجاني إزاء ذلك أعلى درجات عقوبة الحرابة. وقد أصدر مجلس هيئة كبار العلماء بالمملكة العربية السعودية بياناً في دورته التاسعة والأربعين المنعقدة بالطائف ابتداء من تاريخ ٢ / ٤ / ١٤١٩هـ أشار فيه أن المجلس " درس ما يجري في كثير من البلاد الإسلامية وغيرها من التكفير والتفجير، وما ينشأ عنه من سفك للدماء وتخريب للمنشآت، ونظراً إلى خطورة هذا الأمر وما يترتب عليه من إزهاق أرواح بريئة، وإتلاف أموال معصومة، وإخافة للناس وزعزعة لأمنهم واستقرارهم فقد رأي المجلس أن ما نجم عن هذا من استباحة الدماء وانتهاك الأعراض وسلب الأموال الخاصة والعامة وتفجير المساكن والمركبات، وتخريب المنشآت، فهذه الأعمال وأمثالها محرمة شرعاً بإجماع المسلمين لما في ذلك من هتك لحرمة الأنفس المعصومة وهتك لحرمة الأموال وهتك لحرمات الأمن والاستقرار وحياة الناس الآمنين المطمئنين في مساكنهم ومعايشهم',NULL,'35',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (36,'وغدوهم ورواحهم وهتك للمصالح العامة التي لا غنى للناس في حياتهم عنها. وقد حفظ الإسلام للمسلمين أموالهم وأعراضهم وأبدانهم وحرم انتهاكها وشدّد في ذلك. وإن ما يجري في بعض البلدان من سفك للدماء البريئة وتفجير للمساكن والمركبات والمرافق العامة والخاصة وتخريب للمنشآت هو عمل إجرامي والإسلام بريء منه " (١) .
كما أكد علماء المسلمين في كل مكان عن شجبهم المطلق لما يرتكبه بعض المغامرين من جرائم إرهابية تسييء إلى الإسلام وتجعل المسلمين في كل مكان عرضة للانتقام والاضطهاد. وأكدوا في بيانات لهم صدرت عقب الأحداث الإرهابية التفجيرية أن من أعظم الكبائر المحرمة التي شددت الشريعة الإسلامية على حرمتها وأكدت على ضرورة اجتنابها سلب الأمن أو الراحة عن الناس وإرعابهم وإخافتهم سواء كانوا مسلمين أو غير مسلمين (٢) .
_________
(١) بيان مجلس هيئة كبار العلماء، مجلة البحوث الإسلامية، العدد ٥٦، ١٤١٩، ١٤٢٠، ص٣٥٧، تصدر عن رئاسة إدارة البحوث العلمية والإفتاء، الرياض.
(٢) انظر: البيان الختامي للمؤتمر الثاني عشر لمجمع البحوث الإسلامية بالأزهر الشريف، ص٣، كتيب البيان ملحق بمجلة الأزهر، الجزء الثالث، السنة الخامسة والسبعون، ربيع الأول ١٤٢٣هـ / يونيو ٢٠٠٢م.',NULL,'36',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (37,'فالشريعة الإسلامية والقانون الدولي يتبرآن من الإفساد والإجرام كما تأباه الفطرة السليمة. فكل من ثبت شرعاً أنه قام بعمل من أعمال التخريب والإفساد في الأرض التي تزعزع الأمن بالاعتداء على الأنفس والممتلكات الخاصة أو العامة كنسف المساكن أو المساجد أو المدارس أو المستشفيات والمصانع والجسور ومخازن الأسلحة والمياه والموارد العامة لبيت المال كأنابيب البترول ونسف الطائرات أو خطفها ونحو ذلك، فإن عقوبته القتل لدلالة الآيات المتقدمة على أن مثل هذا الإفساد في الأرض يقتضي إهدار دم المفسد، ولأن خطر وضرر الذي يقطع الطريق فيعتدي على شخص فيقتله أو يأخذ ماله، وقد حكم الله عليه بما ذكر في آية الحرابة (١) .
فأي إفساد وإجرام وترويع وإرهاب للناس تحرمه الشريعة الإسلامية والقانون الدولي.
_________
(١) راجع بيان مجلس هيئة كبار العلماء رقم ١٤٨، وتاريخ ١٢ / ١ / ١٤٠٩هـ، ص٣٨٤، مجلة البحوث الإسلامية، العدد ٢٤، ١٤٠٩، تصدر عن رئاسة إدارة البحوث العلمية والإفتاء، الرياض.',NULL,'37',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (38,'<span data-type="title" id=toc-19>الخاتمة </span>من خلال هذه النظرات الإنسانية للعلاقات بين المسلمين في الدولة الإسلامية وغير المسلمين يتضح لنا:
...
ثالثاً: الواقع التاريخي والسياسي يؤكد في جلاء وصدق ووضح أن الرسول صلى الله عليه وسلم هو مؤسس قواعد وأُسس السلم بين الأمم في تعامل إنساني وحوار هادف بناء على واضح في الغايات والوسائل والأهداف.',NULL,'38',NULL,NULL,'0');
INSERT INTO [b1243] VALUES (39,'رابعاً: تراعي العلاقات الإسلامية القيم والمبادئ المشتركة بين الأمم والشعوب والخصوصيات لكل جماعة، فلا جنوح إلى التعصب والتطرف والتزمت والانغلاق في الإسلام بل الاعتدال والوسطية والتسامح ومراعاة الكرامة الإنسانية، والتنوير الفكري بغية العيش بين الأمم والشعوب في سلام وأمان واستقرار وتعاون على الخير ونبذ للفرقة والشقاق والاختلاف.
والله الموفق. .',NULL,'39',NULL,NULL,'0');
